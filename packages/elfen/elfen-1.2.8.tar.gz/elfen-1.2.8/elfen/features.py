...
FUNCTION_MAP = {
    ...
    "min_concreteness": get_min_concreteness,
    "max_concreteness": get_max_concreteness,
    # AoA
    "avg_aoa": get_avg_aoa,
    ...
    "min_prevalence": get_min_prevalence,
    "max_prevalence": get_max_prevalence,
    # Socialness
    ...
    "min_socialness": get_min_socialness,
    "max_socialness": get_max_socialness,
    # Iconicity
    ...
    "min_iconicity": get_min_iconicity,
    "max_iconicity": get_max_iconicity,
    # Sensorimotor
    ...
    "min_sensorimotor": get_min_sensorimotor,
    "max_sensorimotor": get_max_sensorimotor,
...
FEATURE_LEXICON_MAP = {
    ...
    "n_controversial_concreteness": {"en": "concreteness_brysbaert",
                                     ...
                                     "de": "leipzig_affective_norms",
                                     "it": "affective_norms_montefinese"},
    "min_concreteness": {"en": "concreteness_brysbaert",
                         "fr": "concreteness_bonin",
                         "de": "leipzig_affective_norms",
                         "it": "affective_norms_montefinese"},
    "max_concreteness": {"en": "concreteness_brysbaert",
                         "fr": "concreteness_bonin",
                         "de": "leipzig_affective_norms",
                         "it": "affective_norms_montefinese"},
    ...
    "n_controversial_aoa": {"en": "aoa_kuperman",
                             "de": "aoa_schroeder",
                             "it": "aoa_montefinese"},
    "min_aoa": {"en": "aoa_kuperman",
                "de": "aoa_schroeder",
                "it": "aoa_montefinese"},
    "max_aoa": {"en": "aoa_kuperman",
                "de": "aoa_schroeder",
                "it": "aoa_montefinese"},
    "avg_prevalence": {"en": "prevalence_brysbaert"},
    "n_high_prevalence": {"en": "prevalence_brysbaert"},
    "n_low_prevalence": {"en": "prevalence_brysbaert"},
    "min_prevalence": {"en": "prevalence_brysbaert"},
    "max_prevalence": {"en": "prevalence_brysbaert"},
    ...
    "min_socialness": {"en": "socialness"},
    "max_socialness": {"en": "socialness"},
    ...
    "min_iconicity": {"en": "iconicity_winter"},
    "max_iconicity": {"en": "iconicity_winter"},
    ...
    "n_controversial_sensorimotor": {"en": "sensorimotor_lancaster",
                                     "it": "sensorimotor_vergallito"},
    "min_sensorimotor": {"en": "sensorimotor_lancaster",
                         "it": "sensorimotor_vergallito"},
    "max_sensorimotor": {"en": "sensorimotor_lancaster",
                         "it": "sensorimotor_vergallito"},
}
