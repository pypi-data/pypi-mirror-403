...
from parser.controls.controls import ControlsCreator
from parser.extras.per_goal_analysis import PerGoalAnalysis
from parser.json_parser.game import Game
from parser.json_parser.sanity_check.sanity_check import SanityChecker
...
def analyze_replay_file(replay_path: str, controls: ControlsCreator = None,
    ...
    if logging_level != logging.NOTSET:
        logging.getLogger('parser').setLevel(logging_level)
...
if __name__ == '__main__':
    from parser.tests.analysis_test import __test_replays
