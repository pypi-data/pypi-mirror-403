...
class Config:
    ...
    auth_url: str = "https://auth.mushucorp.com"
    core_url: str = "https://core.mushucorp.com"
    notify_url: str = "https://notify.mushucorp.com"
    pay_url: str = "https://pay.mushucorp.com"
