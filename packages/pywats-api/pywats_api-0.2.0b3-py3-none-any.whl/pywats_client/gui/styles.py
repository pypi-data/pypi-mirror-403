...
Cross-platform compatible with system font fallbacks.
"""
import sys
...
def get_system_font_family() -> str:
    ...
    Returns:
        CSS font-family string with platform-appropriate fallbacks
    """
    if sys.platform == "darwin":
        # macOS: SF Pro is the system font (10.11+), Helvetica Neue as fallback
        return '"-apple-system", "SF Pro Text", "Helvetica Neue", "Helvetica", sans-serif'
    elif sys.platform == "win32":
        # Windows: Segoe UI is the system font (Vista+)
        return '"Segoe UI", "Tahoma", "Arial", sans-serif'
    else:
        # Linux/Unix: Ubuntu, Cantarell, or DejaVu as common options
        return '"Ubuntu", "Cantarell", "DejaVu Sans", "Liberation Sans", sans-serif'


# Platform-aware font family
_FONT_FAMILY = get_system_font_family()
