# Asset Domain Usage Guide

## Overview

The Asset domain manages test fixtures, and other manufacturing assets in WATS. Assets can be hierarchical (e.g., stations containing instruments) and track calibration, maintenance, and usage history.
...
- [Product Domain](product-domain.md) - Managing products tested by assets
- [Production Domain](production-domain.md) - Manufacturing units at stations
- [Report Domain](report-domain.md) - Test reports from stations
