# Process Domain Usage Guide

## Overview

The Process domain provides access to process/operation definitions in WATS. Processes define the types of operations that can be performed during manufacturing:
...
- [Report Domain](report-domain.md) - Test reports using process codes
- [Production Domain](production-domain.md) - Production with process tracking
- [Software Domain](software-domain.md) - Software distribution
