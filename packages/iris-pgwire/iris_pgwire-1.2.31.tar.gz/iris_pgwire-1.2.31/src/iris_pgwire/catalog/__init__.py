...
- PgTypeEmulator: Data type catalog
...
def __getattr__(name: str):
    ...
    elif name in ("PgType", "PgTypeEmulator"):
        from .pg_type import PgType, PgTypeEmulator

        return PgType if name == "PgType" else PgTypeEmulator
