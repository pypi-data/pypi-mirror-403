...
setup(name='thefuck-ai',
      version=VERSION,
      description="AI-powered CLI that corrects errors and generates commands from natural language",
      long_description=long_description,
      author='fak111',
      author_email='zhuliderb@gmail.com',
      url='https://github.com/fak111/thefuck-AI',
      license='MIT',
