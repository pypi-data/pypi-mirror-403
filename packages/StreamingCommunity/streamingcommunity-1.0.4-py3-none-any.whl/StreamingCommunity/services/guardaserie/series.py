...
from StreamingCommunity.services._base.episode_manager import map_episode_title, dynamic_format_number
...
def download_video(index_season_selected: int, index_episode_selected: int, scrape_serie: GetSerieInfo) -> Tuple[str,bool]:
    ...
    console.print(f"\n[yellow]Download: [red]{site_constants.SITE_NAME} → [cyan]{scrape_serie.tv_name} [white]\\ [magenta]{obj_episode.get('name')} ([cyan]S{index_season_selected_formatted}E{index_episode_selected}) \n")
