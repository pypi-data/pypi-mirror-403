...
class Base(UUIDFixtureMixin, SlidgeTest):
    plugin = globals()
...
class TestMuc(Base):
    ...
    def test_join_group(self):
        ...
        participant.send_text("Hey", when=now, legacy_msg_id="legacy-hey-id")
    ...
    def test_newline_in_nick(self):
        part = self.get_participant("prout\nprout")
        part.send_text("hoy!")
        self.send(  # language=XML
            """
            <message xmlns="jabber:component:accept"
                     type="groupchat"
                     from="room-private@aim.shakespeare.lit/prout | prout"
                     to="romeo@montague.lit/gajim">
              <body>hoy!</body>
              <active xmlns="http://jabber.org/protocol/chatstates" />
              <markable xmlns="urn:xmpp:chat-markers:0" />
        ...
        self.send(  # language=XML
            ...
            <iq type="error"
              ...
              <error type="cancel">
                ...
                <text xmlns="urn:ietf:params:xml:ns:xmpp-stanzas">on_user_moderation is not implemented by the legacy module</text>
              </error>
            </iq>
            """
        )
    ...
    def test_request_remove_known_muc(self):
        ...
        self.send(  # language=XML
            ...
            <iq from="room-private@aim.shakespeare.lit"
              ...
              <error type="cancel">
                <feature-not-implemented xmlns="urn:ietf:params:xml:ns:xmpp-stanzas" />
                <text xmlns="urn:ietf:params:xml:ns:xmpp-stanzas">on_ibr_remove is not implemented by the legacy module</text>
              </error>
            </iq>
            """
        )
