...
.. container::
   ...
   .. table::
       ...
       +----------------------------------------------+-----------------------------------------------+----------------+
       | **filters_list**                             | **Description**                               | **Example**    |
       +==============================================+===============================================+================+
       | **Required**: :red:`True`                    | List of filters applied to the channel.       | [PoleZeroFilter|
       |                                              |                                               | , CoefficientFi|
       | **Type**: list[mt_metadata.timeseries.filters|                                               | lter]          |
       | .pole_zero_filter.PoleZeroFilter |           |                                               |                |
       | **Units**: None                              |                                               |                |
       |                                              |                                               |                |
       |                                              |                                               |                |
       |                                              |                                               |                |
...
.. container::
   ...
   .. table::
       ...
       | **Type**: numpy.ndarray | list[float]        |                                               | 0.001, 0.002,  |
       |                                              |                                               | 0.005, 0.001,  |
       | **Units**: hertz                             |                                               | ... 1, 2, 5,   |
       |                                              |                                               | 10]"           |
       |                                              |                                               |                |
