...
class TestCGGTF:
    ...
    def test_info(self, cgg_tf_edi_obj):
        ...
        info_list = [
            ...
            "    TEST01a.ex.negative.elevation_uncertainty=0.0\n",
            "    TEST01a.ex.negative.latitude_uncertainty=0.0\n",
            "    TEST01a.ex.negative.longitude_uncertainty=0.0\n",
            "    TEST01a.ex.negative.type=electric\n",
            "    TEST01a.ex.negative.x_uncertainty=0.0\n",
            "    TEST01a.ex.negative.y_uncertainty=0.0\n",
            "    TEST01a.ex.negative.z_uncertainty=0.0\n",
            "    TEST01a.ex.positive.datum=WGS 84\n",
            "    TEST01a.ex.positive.elevation_uncertainty=0.0\n",
            "    TEST01a.ex.positive.latitude_uncertainty=0.0\n",
            "    TEST01a.ex.positive.longitude_uncertainty=0.0\n",
            "    TEST01a.ex.positive.type=electric\n",
            "    TEST01a.ex.positive.x_uncertainty=0.0\n",
            "    TEST01a.ex.positive.y_uncertainty=0.0\n",
            "    TEST01a.ex.positive.z_uncertainty=0.0\n",
            ...
            "    TEST01a.ey.negative.elevation_uncertainty=0.0\n",
            "    TEST01a.ey.negative.latitude_uncertainty=0.0\n",
            "    TEST01a.ey.negative.longitude_uncertainty=0.0\n",
            "    TEST01a.ey.negative.type=electric\n",
            "    TEST01a.ey.negative.x_uncertainty=0.0\n",
            "    TEST01a.ey.negative.y_uncertainty=0.0\n",
            "    TEST01a.ey.negative.z_uncertainty=0.0\n",
            "    TEST01a.ey.positive.datum=WGS 84\n",
            "    TEST01a.ey.positive.elevation_uncertainty=0.0\n",
            "    TEST01a.ey.positive.latitude_uncertainty=0.0\n",
            "    TEST01a.ey.positive.longitude_uncertainty=0.0\n",
            "    TEST01a.ey.positive.type=electric\n",
            "    TEST01a.ey.positive.x_uncertainty=0.0\n",
            "    TEST01a.ey.positive.y_uncertainty=0.0\n",
            "    TEST01a.ey.positive.z_uncertainty=0.0\n",
            "    TEST01a.ey.type=electric\n",
            "    TEST01a.rrhx.channel_number=0\n",
            "    TEST01a.rrhx.component=rrhx\n",
            "    TEST01a.rrhx.filters=[]\n",
            ...
            "    TEST01a.rrhy.filters=[]\n",
            "    TEST01a.rrhy.location.datum=WGS 84\n",
            "    TEST01a.rrhy.measurement_azimuth=0.0\n",
