...
from sapiopycommons.ai.protoapi.primitives.refs_pb2 import BooleanRefPbo
...
class ProtobufUtils:
    ...
    def field_def_to_pbo(field: AbstractVeloxFieldDefinition) -> VeloxFieldDefPbo:
        ...
        return VeloxFieldDefPbo(
            ...
            editable=BooleanRefPbo(value=field.editable),
            visible=BooleanRefPbo(value=field.visible),
    ...
    def field_maps_to_pbo(field_maps: list[dict[str, FieldValue]]) -> list[FieldValueMapPbo]:
        ...
        for field_map in field_maps:
            ret_val.append(FieldValueMapPbo(ProtobufUtils.field_map_to_pbo(field_map)))
        return ret_val
