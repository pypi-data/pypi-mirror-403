...
class VeloxFieldDefPbo(_message.Message):
    __slots__ = ("data_field_type", "data_field_name", "display_name", "description", "required", "deprecated_editable", "deprecated_visible", "identifier", "identifier_order", "sort_direction", "sort_order", "tag", "approve_edit", "workflow_only_editing", "font_size", "bold_font", "italic_font", "text_decoration", "is_key_field", "key_field_order", "is_removable", "is_system_field", "is_restricted", "is_audit_logged", "is_active", "is_for_plugin_use_only", "default_table_column_width", "editable", "visible", "boolean_properties", "date_properties", "double_properties", "integer_properties", "long_properties", "selection_properties", "string_properties", "side_link_properties", "short_properties", "picklist_properties", "parent_link_properties", "multi_parent_properties", "identifier_properties", "file_blob_properties", "enum_properties", "date_range_properties", "child_link_properties", "action_string_properties", "action_properties", "accession_properties")
    DATA_FIELD_TYPE_FIELD_NUMBER: _ClassVar[int]
    DATA_FIELD_NAME_FIELD_NUMBER: _ClassVar[int]
    DISPLAY_NAME_FIELD_NUMBER: _ClassVar[int]
    DESCRIPTION_FIELD_NUMBER: _ClassVar[int]
    REQUIRED_FIELD_NUMBER: _ClassVar[int]
    DEPRECATED_EDITABLE_FIELD_NUMBER: _ClassVar[int]
    DEPRECATED_VISIBLE_FIELD_NUMBER: _ClassVar[int]
    ...
    description: str
    required: bool
    deprecated_editable: bool
    deprecated_visible: bool
    identifier: bool
    ...
    editable: _refs_pb2.BooleanRefPbo
    visible: _refs_pb2.BooleanRefPbo
