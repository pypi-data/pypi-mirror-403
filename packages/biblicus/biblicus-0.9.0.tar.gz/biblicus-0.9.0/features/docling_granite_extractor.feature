Feature: DoclingGranite extractor plugin
  The DoclingGranite extractor uses the Granite Docling-258M vision-language model for document understanding.

  Scenario: DoclingGranite extractor requires an optional dependency
  ...
  Scenario: DoclingGranite extractor skips text items
    Given I initialized a corpus at "corpus"
  ...
  Scenario: DoclingGranite extractor outputs HTML when configured
    Given I initialized a corpus at "corpus"
  ...
  Scenario: DoclingGranite extractor outputs plain text when configured
    Given I initialized a corpus at "corpus"
  ...
  Scenario: DoclingGranite extractor rejects invalid output format
    Given I initialized a corpus at "corpus"
    And a fake Docling library is available
    And a Portable Document Format file "doc.pdf" exists with text "Test"
    When I ingest the file "doc.pdf" into corpus "corpus"
