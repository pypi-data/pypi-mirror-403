...
class SearchResponseDeviceSessionsResponseV2(BaseModel):
    """
    ...
    """ # noqa: E501
    data: List[DeviceSessionsResponseV2] = Field(description="List of items that match the search request")
    metadata: Metadata
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchResponseDeviceSessionsResponseV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchResponseDeviceSessionsResponseV2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [DeviceSessionsResponseV2.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
