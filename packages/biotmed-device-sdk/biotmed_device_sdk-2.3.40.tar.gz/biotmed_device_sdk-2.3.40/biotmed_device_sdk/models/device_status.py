...
class DeviceStatus(BaseModel):
    ...
    """ # noqa: E501
    fw_version: Optional[StrictStr] = Field(default=None, alias="_fwVersion")
    hw_version: Optional[StrictStr] = Field(default=None, alias="_hwVersion")
    certificate_status: Optional[StrictStr] = Field(default=None, alias="_certificateStatus")
    boot_time: Optional[datetime] = Field(default=None, description="A UTC date in the ISO-8601 format", alias="_bootTime")
    connection: Optional[ConnectionStatus] = Field(default=None, alias="_connection")
    operational: Optional[DeviceOperationalStatusResponse] = Field(default=None, alias="_operational")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["_fwVersion", "_hwVersion", "_certificateStatus", "_bootTime", "_connection", "_operational"]
    ...
    def certificate_status_validate_enum(cls, value):
        ...
        if value not in set(['NOT_INSTALLED', 'BOOTSTRAP', 'PERMANENT']):
            raise ValueError("must be one of enum values ('NOT_INSTALLED', 'BOOTSTRAP', 'PERMANENT')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.connection:
            _dict['_connection'] = self.connection.to_dict()
        # override the default output from pydantic by calling `to_dict()` of operational
        if self.operational:
            _dict['_operational'] = self.operational.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_fwVersion": obj.get("_fwVersion"),
            "_hwVersion": obj.get("_hwVersion"),
            "_certificateStatus": obj.get("_certificateStatus"),
            "_bootTime": obj.get("_bootTime"),
            "_connection": ConnectionStatus.from_dict(obj["_connection"]) if obj.get("_connection") is not None else None,
            "_operational": DeviceOperationalStatusResponse.from_dict(obj["_operational"]) if obj.get("_operational") is not None else None
        })
