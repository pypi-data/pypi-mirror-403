...
class DeviceOperationalStatusResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default=None, description="Operational status of the device", alias="_status")
    message: Optional[StrictStr] = Field(default=None, description="Operational status message", alias="_message")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["_status", "_message"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['OK', 'MINOR', 'MAJOR', 'CRITICAL']):
            raise ValueError("must be one of enum values ('OK', 'MINOR', 'MAJOR', 'CRITICAL')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceOperationalStatusResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceOperationalStatusResponse from a dict"""
        if obj is None:
            return None
