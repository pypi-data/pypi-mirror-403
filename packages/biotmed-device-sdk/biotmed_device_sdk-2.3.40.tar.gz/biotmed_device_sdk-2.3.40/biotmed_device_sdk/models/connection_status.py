...
class ConnectionStatus(BaseModel):
    ...
    """ # noqa: E501
    connected: Optional[StrictBool] = Field(default=None, description="If the device is connected to the MQTT the value is true, otherwise false", alias="_connected")
    ip_address: Optional[StrictStr] = Field(default=None, description="The IP Address of the connected device", alias="_ipAddress")
    last_connected_time: Optional[datetime] = Field(default=None, description="The last time that the device was connected", alias="_lastConnectedTime")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["_connected", "_ipAddress", "_lastConnectedTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_connected": obj.get("_connected"),
            "_ipAddress": obj.get("_ipAddress"),
            "_lastConnectedTime": obj.get("_lastConnectedTime")
        })
