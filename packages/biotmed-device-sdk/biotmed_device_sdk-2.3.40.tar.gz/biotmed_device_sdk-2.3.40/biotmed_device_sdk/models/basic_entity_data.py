...
class BasicEntityData(BaseModel):
    """
    If count is 1 - holds the information about the single referencer
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="The id of the entity")
    name: StrictStr = Field(description="The name of the entity")
