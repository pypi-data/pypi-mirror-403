...
class DeviceOwnedAlertResponse(BaseModel):
    """
    ...
    alerts: List[DeviceAlertResponse] = Field(alias="_alerts")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["_device", "_alerts"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceOwnedAlertResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceOwnedAlertResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "_alerts": [DeviceAlertResponse.from_dict(_item) for _item in obj["_alerts"]] if obj.get("_alerts") is not None else None
        })
