...
class TempCredentialsForOrganizationClientResponse(BaseModel):
    """
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["endpoint", "credentials", "region", "topic"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TempCredentialsForOrganizationClientResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TempCredentialsForOrganizationClientResponse from a dict"""
        if obj is None:
            return None
