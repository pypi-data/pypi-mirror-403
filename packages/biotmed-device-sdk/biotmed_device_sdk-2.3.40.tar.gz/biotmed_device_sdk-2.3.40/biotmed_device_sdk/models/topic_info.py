...
class TopicInfo(BaseModel):
    ...
    """ # noqa: E501
    action_enum: Optional[StrictStr] = Field(default=None, alias="actionEnum")
    to_device: Optional[StrictStr] = Field(default=None, alias="toDevice")
    from_device: Optional[StrictStr] = Field(default=None, alias="fromDevice")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["actionEnum", "toDevice", "fromDevice"]

    @field_validator('action_enum')
    def action_enum_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['STATUS', 'MEASUREMENT', 'TOKEN']):
            raise ValueError("must be one of enum values ('STATUS', 'MEASUREMENT', 'TOKEN')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actionEnum": obj.get("actionEnum"),
            "toDevice": obj.get("toDevice"),
            "fromDevice": obj.get("fromDevice")
        })
