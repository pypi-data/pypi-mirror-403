...
class RegisterDeviceByTemplateNameRequest(BaseModel):
    """
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["_description", "_timezone", "_id", "_configuration", "_ownerOrganization", "_patient", "_registrationCode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RegisterDeviceByTemplateNameRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RegisterDeviceByTemplateNameRequest from a dict"""
        if obj is None:
            return None
