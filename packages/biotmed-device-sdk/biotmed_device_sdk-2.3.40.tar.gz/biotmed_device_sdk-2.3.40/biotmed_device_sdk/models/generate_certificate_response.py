...
class GenerateCertificateResponse(BaseModel):
    ...
    """ # noqa: E501
    certificate_id: Optional[StrictStr] = Field(default=None, description="The ID of the certificate", alias="certificateId")
    certificate: Optional[StrictStr] = Field(default=None, description="MQTT credentials - certificate")
    private_key: Optional[StrictStr] = Field(default=None, description="MQTT credentials -  private key", alias="privateKey")
    ca_certificate: Optional[StrictStr] = Field(default=None, description="MQTT credentials - CA Root certificate", alias="caCertificate")
    connection_client_id: Optional[StrictStr] = Field(default=None, description="MQTT client ID", alias="connectionClientId")
    end_point_url: Optional[StrictStr] = Field(default=None, description="MQTT endpoint", alias="endPointUrl")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["certificateId", "certificate", "privateKey", "caCertificate", "connectionClientId", "endPointUrl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "connectionClientId": obj.get("connectionClientId"),
