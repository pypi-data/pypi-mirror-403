...
class UpdateDeviceRequest(BaseModel):
    ...
    registration_code: Optional[ReferenceAttributeUUIDIdRequest] = Field(default=None, alias="_registrationCode")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["_description", "_timezone", "_configuration", "_ownerOrganization", "_patient", "_registrationCode"]
