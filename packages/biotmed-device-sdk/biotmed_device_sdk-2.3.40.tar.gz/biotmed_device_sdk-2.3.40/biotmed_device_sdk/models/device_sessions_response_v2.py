...
class DeviceSessionsResponseV2(BaseModel):
    """
    ...
    """ # noqa: E501
    device: DeviceResponse = Field(alias="_device")
    sessions: List[SessionResponseV2] = Field(alias="_sessions")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["_device", "_sessions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeviceSessionsResponseV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeviceSessionsResponseV2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "_device": DeviceResponse.from_dict(obj["_device"]) if obj.get("_device") is not None else None,
            "_sessions": [SessionResponseV2.from_dict(_item) for _item in obj["_sessions"]] if obj.get("_sessions") is not None else None
        })
