...
class UpdateSessionRequestV2(BaseModel):
    """
    ...
    summary: Optional[SessionSummaryUpdateRequest] = Field(default=None, alias="_summary")
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["_startTime", "_endTime", "_state", "_configuration", "_summary", "_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateSessionRequestV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateSessionRequestV2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "_summary": SessionSummaryUpdateRequest.from_dict(obj["_summary"]) if obj.get("_summary") is not None else None,
            "_name": obj.get("_name")
        })
