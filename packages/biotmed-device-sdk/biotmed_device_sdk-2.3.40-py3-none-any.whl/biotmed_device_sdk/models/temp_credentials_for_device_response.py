...
class TempCredentialsForDeviceResponse(BaseModel):
    """
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["endpoint", "credentials", "region", "connectionClientId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TempCredentialsForDeviceResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TempCredentialsForDeviceResponse from a dict"""
        if obj is None:
            return None
