...
class DeviceInfo(BaseModel):
    ...
    """ # noqa: E501
    connection_client_id: Optional[StrictStr] = Field(default=None, alias="connectionClientId")
    topic_info_list: Optional[List[TopicInfo]] = Field(default=None, alias="topicInfoList")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["connectionClientId", "topicInfoList"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in topic_info_list (list)
        _items = []
        if self.topic_info_list:
            for _item_topic_info_list in self.topic_info_list:
                if _item_topic_info_list:
                    _items.append(_item_topic_info_list.to_dict())
            _dict['topicInfoList'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "topicInfoList": [TopicInfo.from_dict(_item) for _item in obj["topicInfoList"]] if obj.get("topicInfoList") is not None else None
        })
