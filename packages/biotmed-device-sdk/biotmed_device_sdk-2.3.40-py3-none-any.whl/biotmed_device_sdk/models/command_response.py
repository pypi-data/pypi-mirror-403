...
class CommandResponse(BaseModel):
    ...
    """ # noqa: E501
    id: UUID = Field(description="A UUID formatted string", alias="_id")
    device: BasicReferencedEntityDataStringId = Field(alias="_device")
    ...
    state: StrictStr = Field(description="The Action state", alias="_state")
    error_message: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=255)]] = Field(default=None, description="Error message", alias="_errorMessage")
    support_stop: StrictBool = Field(description="Is the template support stop command", alias="_supportStop")
    timeout_in_seconds: StrictInt = Field(description="The timeout of the command in seconds", alias="_timeoutInSeconds")
    ...
    summary: Optional[Dict[str, Any]] = Field(default=None, alias="_summary")
    status: Optional[Dict[str, Any]] = Field(default=None, alias="_status")
    ...
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]] = Field(default=None, description="The name of the command", alias="_name")
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["_id", "_device", "_ownerOrganization", "_startTime", "_endTime", "_state", "_errorMessage", "_supportStop", "_timeoutInSeconds", "_template", "_referencers", "_configuration", "_summary", "_status", "_lastModifiedTime", "_creationTime", "_name", "_caption"]

    @field_validator('state')
    def state_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['STARTING', 'IN_PROGRESS', 'COMPLETED', 'FAILED', 'TIMEOUT', 'STOPPING', 'ABORTED']):
            raise ValueError("must be one of enum values ('STARTING', 'IN_PROGRESS', 'COMPLETED', 'FAILED', 'TIMEOUT', 'STOPPING', 'ABORTED')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "_errorMessage": obj.get("_errorMessage"),
            "_supportStop": obj.get("_supportStop"),
            "_timeoutInSeconds": obj.get("_timeoutInSeconds"),
            ...
            "_summary": obj.get("_summary"),
            "_status": obj.get("_status"),
