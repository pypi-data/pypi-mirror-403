...
class StartSessionRequestV2(BaseModel):
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["_templateId", "_configuration", "_name", "_patient"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartSessionRequestV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StartSessionRequestV2 from a dict"""
        if obj is None:
            return None
