...
class DeleteOrphanSessionsResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    deleted_sessions: List[SessionResponseV2] = Field(alias="deletedSessions")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["deletedSessions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DeleteOrphanSessionsResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in deleted_sessions (list)
        _items = []
        if self.deleted_sessions:
            for _item_deleted_sessions in self.deleted_sessions:
                if _item_deleted_sessions:
                    _items.append(_item_deleted_sessions.to_dict())
            _dict['deletedSessions'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DeleteOrphanSessionsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "deletedSessions": [SessionResponseV2.from_dict(_item) for _item in obj["deletedSessions"]] if obj.get("deletedSessions") is not None else None
        })
