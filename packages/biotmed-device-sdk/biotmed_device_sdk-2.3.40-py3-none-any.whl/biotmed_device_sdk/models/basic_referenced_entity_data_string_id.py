...
class BasicReferencedEntityDataStringId(BaseModel):
    """
    ...
    """ # noqa: E501
    id: StrictStr
    template_id: UUID = Field(description="The id of a template that is configured in the settings service.", alias="templateId")
    ...
    template: BasicTemplateData = Field(description="The referenced entity template")
    organization_id: UUID = Field(description="The id of the organization of the referenced entity.", alias="organizationId")
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["id", "templateId", "parentEntityId", "templateName", "template", "organizationId", "name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BasicReferencedEntityDataStringId from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BasicReferencedEntityDataStringId from a dict"""
        if obj is None:
            return None
