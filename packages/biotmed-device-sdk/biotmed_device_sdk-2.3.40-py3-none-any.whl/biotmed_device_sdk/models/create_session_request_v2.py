...
class CreateSessionRequestV2(BaseModel):
    ...
    summary: Optional[SessionSummary] = Field(default=None, alias="_summary")
    ...
    patient: Optional[ReferenceAttributeUUIDIdRequest] = Field(default=None, alias="_patient")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["_startTime", "_endTime", "_state", "_templateId", "_configuration", "_summary", "_name", "_patient"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateSessionRequestV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateSessionRequestV2 from a dict"""
        if obj is None:
            return None
