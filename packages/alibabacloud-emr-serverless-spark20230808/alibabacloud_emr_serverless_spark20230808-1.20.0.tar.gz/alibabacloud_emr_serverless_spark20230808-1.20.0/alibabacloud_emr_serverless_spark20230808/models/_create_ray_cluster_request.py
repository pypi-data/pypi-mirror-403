...
class CreateRayClusterRequest(DaraModel):
    def __init__(
        self,
        description: str = None,
        display_release_version: str = None,
        extra_param: str = None,
        head_spec: main_models.CreateRayClusterRequestHeadSpec = None,
        name: str = None,
    ...
    def from_map(self, m: dict = None):
        ...
        if m.get('headSpec') is not None:
            temp_model = main_models.CreateRayClusterRequestHeadSpec()
        ...
        if m.get('workerSpec') is not None:
            for k1 in m.get('workerSpec'):
                temp_model = main_models.CreateRayClusterRequestWorkerSpec()
                self.worker_spec.append(temp_model.from_map(k1))

        return self

class CreateRayClusterRequestWorkerSpec(DaraModel):
    def __init__(
        self,
        cpu: str = None,
        group_name: str = None,
...
class CreateRayClusterRequestHeadSpec(DaraModel):
    def __init__(
        self,
        cpu: str = None,
