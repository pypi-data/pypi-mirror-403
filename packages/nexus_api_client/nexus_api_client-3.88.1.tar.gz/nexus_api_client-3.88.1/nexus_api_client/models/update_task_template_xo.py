...
class UpdateTaskTemplateXO(BaseModel):
    """
    Task template for updating existing tasks (type field is immutable)
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["alertEmail", "enabled", "frequency", "name", "notificationCondition", "properties"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateTaskTemplateXO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateTaskTemplateXO from a dict"""
        if obj is None:
            return None
