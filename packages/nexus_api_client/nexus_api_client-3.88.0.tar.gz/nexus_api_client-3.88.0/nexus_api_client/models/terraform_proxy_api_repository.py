...
class TerraformProxyApiRepository(BaseModel):
    """
    Terraform proxy repository configuration
    """ # noqa: E501
    ...
    terraform: Optional[TerraformAttributes] = None
    type: Optional[StrictStr] = Field(default=None, description="Repository type")
    url: Optional[StrictStr] = Field(default=None, description="URL to the repository")
    __properties: ClassVar[List[str]] = ["cleanup", "format", "httpClient", "name", "negativeCache", "online", "proxy", "replication", "routingRuleName", "storage", "terraform", "type", "url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TerraformProxyApiRepository from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TerraformProxyApiRepository from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "terraform": TerraformAttributes.from_dict(obj["terraform"]) if obj.get("terraform") is not None else None,
            "type": obj.get("type"),
            "url": obj.get("url")
        })
        return _obj
