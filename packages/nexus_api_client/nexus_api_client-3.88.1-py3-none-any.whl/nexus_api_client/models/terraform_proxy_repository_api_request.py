...
class TerraformProxyRepositoryApiRequest(BaseModel):
    """
    Request body for creating or updating a Terraform proxy repository
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["cleanup", "httpClient", "name", "negativeCache", "online", "proxy", "replication", "routingRule", "storage", "terraform"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TerraformProxyRepositoryApiRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TerraformProxyRepositoryApiRequest from a dict"""
        if obj is None:
            return None
