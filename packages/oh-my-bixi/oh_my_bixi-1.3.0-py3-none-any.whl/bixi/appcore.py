...
class WorkspaceAppMixin(object):
    ...
    def workspace_init(self, *,
        ...
        Args:
            ...
            ws_dirpath: optional directory path for the workspace. 
                If provided, it will resuse the workspace at this path. Default is None.
                This can be useful when you want to setup workspace in non-primary processes in distributed
                settings. Note that when provided, `is_create_workspace` must be False.
        ...
        if ws_dirpath:
            if is_create_workspace:
                raise ValueError("When `ws_dirpath` is provided, `is_create_workspace` must be False.")
