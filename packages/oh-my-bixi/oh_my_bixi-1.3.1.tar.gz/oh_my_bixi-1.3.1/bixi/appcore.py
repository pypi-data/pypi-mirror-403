    ...
    def workspace_init(self, *,
        ...
        Args:
            ...
            ws_dirpath: optional directory path for the workspace if you want to reuse an existing workspace.
                If provided, it will resuse the workspace at this path if possible.
                Default is None.
                This can be useful when you want to setup workspace in non-primary processes in distributed
                settings. 
                Note that when it is provided, `is_create_workspace` will be ignored in non-primary processes,
                and will raise error in primary process.
        ...
        if os.path.abspath(ws_dirpath) != os.path.abspath(self.ws.rootpath):
            if is_create_workspace and is_main_process:
                raise ValueError("When `ws_dirpath` is provided, `is_create_workspace` must be False in the main process.")

            # Reuse existing workspace at the given path
            self.ws = Workspace.restore_workspace(ws_dirpath)
