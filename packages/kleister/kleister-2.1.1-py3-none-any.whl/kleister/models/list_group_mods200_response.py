...
class ListGroupMods200Response(BaseModel):
    """
    ...
    mods: List[GroupMod]
    __properties: ClassVar[List[str]] = ["total", "limit", "offset", "group", "mods"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mods": [GroupMod.from_dict(_item) for _item in obj["mods"]] if obj.get("mods") is not None else None
        })
        return _obj
