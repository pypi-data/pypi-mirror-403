...
class UserGroup(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["user_id", "user", "group_id", "group", "perm", "created_at", "updated_at"]
    ...
    def perm_validate_enum(cls, value):
        ...
        if value not in set(['owner', 'user', 'admin']):
            raise ValueError("must be one of enum values ('owner', 'user', 'admin')")
        return value
