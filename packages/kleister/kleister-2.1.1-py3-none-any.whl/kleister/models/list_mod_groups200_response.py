...
class ListModGroups200Response(BaseModel):
    """
    ...
    groups: List[GroupMod]
    __properties: ClassVar[List[str]] = ["total", "limit", "offset", "mod", "groups"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groups": [GroupMod.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj
