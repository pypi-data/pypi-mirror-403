...
class ListMods200Response(BaseModel):
    """
    ListMods200Response
    """ # noqa: E501
    total: StrictInt
    ...
    offset: StrictInt
    mods: List[Mod]
    __properties: ClassVar[List[str]] = ["total", "limit", "offset", "mods"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mods": [Mod.from_dict(_item) for _item in obj["mods"]] if obj.get("mods") is not None else None
        })
        return _obj
