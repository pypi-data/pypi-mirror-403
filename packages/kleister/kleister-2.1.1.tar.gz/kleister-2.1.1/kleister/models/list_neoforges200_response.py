...
class ListNeoforges200Response(BaseModel):
    """
    ...
    limit: StrictInt
    offset: StrictInt
    versions: List[Neoforge]
    __properties: ClassVar[List[str]] = ["total", "limit", "offset", "versions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "versions": [Neoforge.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
