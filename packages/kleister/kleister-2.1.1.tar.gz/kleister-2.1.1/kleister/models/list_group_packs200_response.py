...
class ListGroupPacks200Response(BaseModel):
    """
    ...
    packs: List[GroupPack]
    __properties: ClassVar[List[str]] = ["total", "limit", "offset", "group", "packs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "packs": [GroupPack.from_dict(_item) for _item in obj["packs"]] if obj.get("packs") is not None else None
        })
        return _obj
