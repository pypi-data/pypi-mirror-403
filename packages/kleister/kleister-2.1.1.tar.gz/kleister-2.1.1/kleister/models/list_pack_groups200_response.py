...
class ListPackGroups200Response(BaseModel):
    """
    ...
    groups: List[GroupPack]
    __properties: ClassVar[List[str]] = ["total", "limit", "offset", "pack", "groups"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "groups": [GroupPack.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj
