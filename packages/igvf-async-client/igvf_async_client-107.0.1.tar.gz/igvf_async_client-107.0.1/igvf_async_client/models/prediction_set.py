...
class PredictionSet(BaseModel):
    ...
    def file_set_type_validate_enum(cls, value):
        ...
        if value not in set(['activity level', 'binding effect', 'functional effect', 'protein-protein interaction', 'protein stability']):
            raise ValueError("must be one of enum values ('activity level', 'binding effect', 'functional effect', 'protein-protein interaction', 'protein stability')")
        return value
