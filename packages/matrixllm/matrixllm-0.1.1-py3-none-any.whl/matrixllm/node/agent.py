...
from matrixllm.node.runtime import LocalRuntime
...
async def run_cloud_device(config: CloudDeviceConfig) -> None:
    """
    Connect to MatrixLLM Cloud relay using Authorization: Bearer <device_token>
    ...
    async with websockets.connect(ws_url, extra_headers=headers, max_size=2**25) as ws:
        hello = {
            ...
            "client_version": "matrixllm-local-cloud-compat/0.1.0",
