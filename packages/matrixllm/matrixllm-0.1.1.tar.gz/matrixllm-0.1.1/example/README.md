# MatrixLLM Demo Client

> **A simple, beautiful web client demonstrating how to integrate with MatrixLLM in just 2 clicks!**

This demo showcases the **easiest way** to connect any web application to your local MatrixLLM instance, enabling you to use local LLMs with an OpenAI-compatible API.

[![MatrixLLM](https://img.shields.io/badge/MatrixLLM-Compatible-blue)](https://github.com/ruslanmv/matrixllm)
...
✅ **2-Click Setup** - Install MatrixLLM, connect from browser
✅ **Real Integration** - Actual API calls to MatrixLLM endpoints
...
./example/install-matrixllm.sh
```

#### **Windows (PowerShell):**
```powershell
cd ..  # Go to project root
.\example\install-matrixllm.ps1
```
...
```
┌─────────────────┐      ┌──────────────┐      ┌─────────────┐
│  Browser Client │ ───> │  MatrixLLM  │ ───> │   Ollama    │
...
| `OLLAMA_BASE_URL` | Where MatrixLLM finds Ollama | `http://localhost:11434` |
...
- Add your origin to `CORS_ORIGINS` in MatrixLLM `.env`
...
├── install-matrixllm.sh      # Mac/Linux installer
├── install-matrixllm.ps1     # Windows installer
...
- Check `CORS_ORIGINS` in MatrixLLM `.env` includes your origin
- Restart MatrixLLM after changing `.env`
...
**Solution:**
- Verify MatrixLLM is running: `curl http://localhost:11435/health`
...
- **MatrixLLM Docs:** [GitHub Repository](https://github.com/ruslanmv/matrixllm)
...
This example is part of the MatrixLLM project and is licensed under the MIT License.
...
- 📣 **Spread the word** about MatrixLLM

---

<div align="center">

**Made with ❤️ by the MatrixLLM Community**

[GitHub](https://github.com/ruslanmv/matrixllm) • [Issues](https://github.com/ruslanmv/matrixllm/issues) • [Discussions](https://github.com/ruslanmv/matrixllm/discussions)
