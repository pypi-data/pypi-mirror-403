...
* ✅ Installs `ytp-dl==0.5.7` into the virtualenv
...
#   - Installs ytp-dl==0.5.7 + gunicorn + gevent in that venv
...
pip install "ytp-dl==0.5.7" gunicorn gevent
deactivate
