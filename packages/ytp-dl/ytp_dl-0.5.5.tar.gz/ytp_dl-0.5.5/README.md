...
* ✅ Installs `ytp-dl==0.5.5` into the virtualenv
...
#   - Installs ytp-dl==0.5.5 + gunicorn + gevent in that venv
...
pip install "ytp-dl==0.5.5" gunicorn gevent
deactivate
