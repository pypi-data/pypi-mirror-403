...
* ✅ Installs `ytp-dl==0.5.6` into the virtualenv
...
#   - Installs ytp-dl==0.5.6 + gunicorn + gevent in that venv
...
pip install "ytp-dl==0.5.6" gunicorn gevent
deactivate
