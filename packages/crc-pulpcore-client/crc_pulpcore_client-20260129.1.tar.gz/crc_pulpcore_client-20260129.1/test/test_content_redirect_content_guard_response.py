...
class TestContentRedirectContentGuardResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ContentRedirectContentGuardResponse:
        """Test ContentRedirectContentGuardResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ContentRedirectContentGuardResponse`
        """
        model = ContentRedirectContentGuardResponse()
        if include_optional:
