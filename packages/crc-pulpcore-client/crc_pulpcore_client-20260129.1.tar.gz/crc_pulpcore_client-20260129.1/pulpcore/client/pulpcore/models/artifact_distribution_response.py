...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pulp_href", "pulp_last_updated", "base_url", "hidden", "base_path", "pulp_created", "name", "pulp_labels", "content_guard", "prn", "no_content_change_since"]
