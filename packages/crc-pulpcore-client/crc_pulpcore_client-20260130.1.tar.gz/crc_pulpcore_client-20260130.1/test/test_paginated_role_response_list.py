...
class TestPaginatedRoleResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginatedRoleResponseList:
        """Test PaginatedRoleResponseList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedRoleResponseList`
        """
        model = PaginatedRoleResponseList()
        if include_optional:
