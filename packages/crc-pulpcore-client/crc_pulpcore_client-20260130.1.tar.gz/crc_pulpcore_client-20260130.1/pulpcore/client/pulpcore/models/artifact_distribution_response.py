...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["no_content_change_since", "hidden", "prn", "base_path", "content_guard", "pulp_created", "name", "pulp_labels", "base_url", "pulp_last_updated", "pulp_href"]
