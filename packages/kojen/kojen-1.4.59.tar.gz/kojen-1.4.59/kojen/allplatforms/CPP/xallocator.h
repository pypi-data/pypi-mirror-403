...
// starts. 
#ifdef __FREERTOS__
  // In FreeRTOS, init is not really needed due to mechanism of critical section calls
  // (critical sections are usually a few lines of assembler, no need for a local variable, or initialization thereof etc.)
#else
