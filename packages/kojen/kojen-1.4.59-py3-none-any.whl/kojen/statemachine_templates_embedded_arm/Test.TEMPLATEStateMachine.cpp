...
struct s<<<STATEMACHINENAME>>>_Test_Suite_Fixture
{
    /// {{{USER_TEST_SUITE_FIXTURE_LOCALS}}}
    /// {{{USER_TEST_SUITE_FIXTURE_LOCALS}}}
    s<<<STATEMACHINENAME>>>_Test_Suite_Fixture(){
...
MU_TEST(Test<<<STATEMACHINENAME>>>_States)
{
...
MU_TEST_SUITE(<<<STATEMACHINENAME>>>_Suite) {
    MU_RUN_TEST(Test<<<STATEMACHINENAME>>>_States);
