...
class TestOutputConfig:
    ...
    def test_default_values(self) -> None:
        ...
        cfg = OutputConfig()
        assert cfg.directory == Path("haplophaser_output")
        assert cfg.prefix == "haplophaser"
...
class TestHaplophaserConfig:
    """Tests for main HaplophaserConfig."""

    def test_default_config(self, default_config: HaplophaserConfig) -> None:
    ...
    def test_custom_config(self, custom_config: HaplophaserConfig) -> None:
    ...
    def test_with_updates(self, default_config: HaplophaserConfig) -> None:
    ...
    def test_with_nested_updates(self, default_config: HaplophaserConfig) -> None:
    ...
    def test_immutable(self, default_config: HaplophaserConfig) -> None:
...
class TestConfigIO:
    ...
    def test_save_and_load_config(self, tmp_path: Path, custom_config: HaplophaserConfig) -> None:
...
class TestGetDefaultConfig:
    ...
    def test_returns_defaults(self) -> None:
        ...
        assert isinstance(cfg, HaplophaserConfig)
        assert cfg.ploidy == 2
