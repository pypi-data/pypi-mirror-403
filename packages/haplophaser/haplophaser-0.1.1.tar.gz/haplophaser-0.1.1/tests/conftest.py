"""Pytest configuration and fixtures for Haplophaser tests."""
...
from haplophaser.core.config import HaplophaserConfig
...
@pytest.fixture
def default_config() -> HaplophaserConfig:
    """Create default configuration."""
    return HaplophaserConfig()


@pytest.fixture
def custom_config() -> HaplophaserConfig:
