...
class VideoStreamServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamFrames = channel.stream_unary(
                '/VideoStreamService/StreamFrames',
                request_serializer=video__pb2.Frame.SerializeToString,
                response_deserializer=video__pb2.Response.FromString,
...
def add_VideoStreamServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StreamFrames': grpc.stream_unary_rpc_method_handler(
                    ...
                    response_serializer=video__pb2.Response.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'VideoStreamService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('VideoStreamService', rpc_method_handlers)
...
class VideoStreamService(object):
    ...
    def StreamFrames(request_iterator,
        ...
        return grpc.experimental.stream_unary(
            ...
            video__pb2.Response.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
