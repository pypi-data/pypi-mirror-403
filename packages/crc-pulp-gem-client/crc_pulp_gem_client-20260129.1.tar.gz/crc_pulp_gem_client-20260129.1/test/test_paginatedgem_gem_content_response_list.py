...
class TestPaginatedgemGemContentResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginatedgemGemContentResponseList:
        """Test PaginatedgemGemContentResponseList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedgemGemContentResponseList`
        """
        model = PaginatedgemGemContentResponseList()
        if include_optional:
