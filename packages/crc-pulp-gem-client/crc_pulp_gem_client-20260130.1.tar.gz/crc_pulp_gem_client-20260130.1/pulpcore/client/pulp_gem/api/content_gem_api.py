...
class ContentGemApi:
    ...
    def create(
        ...
        file: Annotated[Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]], Field(description="An uploaded file that should be turned into the artifact of the content unit.")] = None,
        ...
        :type artifact: str
        :param file: An uploaded file that should be turned into the artifact of the content unit.
        :type file: bytearray
    ...
    def _create_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/pulp/{pulp_domain}/api/v3/content/gem/gem/',
    ...
    def list(
        ...
        prerelease: Annotated[Optional[StrictBool], Field(description="Filter results where prerelease matches value")] = None,
        ...
        :param prerelease: Filter results where prerelease matches value
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedgemGemContentResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedgemGemContentResponseList]:
        """List gem contents
    ...
    def read(
        self,
        gem_gem_content_href: StrictStr,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to include in the response.")] = None,
        exclude_fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to exclude from the response.")] = None,
        _request_timeout: Union[
        ...
        :param gem_gem_content_href: (required)
        :type gem_gem_content_href: str
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param fields: A list of fields to include in the response.
        :type fields: List[str]
        ...
        _param = self._read_serialize(
            gem_gem_content_href=gem_gem_content_href,
            x_task_diagnostics=x_task_diagnostics,
            fields=fields,
            exclude_fields=exclude_fields,
            _request_auth=_request_auth,
    ...
    def read_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GemGemContentResponse]:
        """Inspect a gem content
    ...
    def _read_serialize(
        ...
        # process the path parameters
        if gem_gem_content_href is not None:
            _path_params['gem_gem_content_href'] = gem_gem_content_href
        # process the query parameters
        if fields is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{gem_gem_content_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _set_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{gem_gem_content_href}set_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _unset_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{gem_gem_content_href}unset_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
