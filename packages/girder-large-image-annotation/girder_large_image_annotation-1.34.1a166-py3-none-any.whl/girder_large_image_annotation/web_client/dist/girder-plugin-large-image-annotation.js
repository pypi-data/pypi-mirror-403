  ...
  (function(t) {
    ...
    u.prototype = {
      ...
      getLuminance: function() {
        var r = this.toRgb(), g, s, _, y, F, x;
        return g = r.r / 255, s = r.g / 255, _ = r.b / 255, g <= 0.03928 ? y = g / 12.92 : y = t.pow((g + 0.055) / 1.055, 2.4), s <= 0.03928 ? F = s / 12.92 : F = t.pow((s + 0.055) / 1.055, 2.4), _ <= 0.03928 ? x = _ / 12.92 : x = t.pow((_ + 0.055) / 1.055, 2.4), 0.2126 * y + 0.7152 * F + 0.0722 * x;
      },
      setAlpha: function(r) {
      ...
      toName: function() {
        return this._a === 0 ? "transparent" : this._a < 1 ? !1 : ae[M(this._r, this._g, this._b, !0)] || !1;
      },
      toFilter: function(r) {
    ...
    function h(r) {
      var g = { r: 0, g: 0, b: 0 }, s = 1, _ = null, y = null, F = null, x = !1, O = !1;
      return typeof r == "string" && (r = re(r)), typeof r == "object" && (B(r.r) && B(r.g) && B(r.b) ? (g = p(r.r, r.g, r.b), x = !0, O = String(r.r).substr(-1) === "%" ? "prgb" : "rgb") : B(r.h) && B(r.s) && B(r.v) ? (_ = ot(r.s), y = ot(r.v), g = L(r.h, _, y), x = !0, O = "hsv") : B(r.h) && B(r.s) && B(r.l) && (_ = ot(r.s), F = ot(r.l), g = b(r.h, _, F), x = !0, O = "hsl"), r.hasOwnProperty("a") && (s = r.a)), s = N(s), {
        ok: x,
        format: r.format || O,
        r: l(255, c(g.r, 0)),
        g: l(255, c(g.g, 0)),
    ...
    function f(r, g, s) {
      ...
      var _ = c(r, g, s), y = l(r, g, s), F, x, O = (_ + y) / 2;
      if (_ == y)
        F = x = 0;
      else {
        var I = _ - y;
    ...
    function b(r, g, s) {
      ...
      if (g === 0)
        ...
        _ = x(I, O, r + 1 / 3), y = x(I, O, r), F = x(I, O, r - 1 / 3);
      }
      return { r: _ * 255, g: y * 255, b: F * 255 };
    }
    function w(r, g, s) {
      r = j(r, 255), g = j(g, 255), s = j(s, 255);
      var _ = c(r, g, s), y = l(r, g, s), F, x, O = _, I = _ - y;
      if (x = _ === 0 ? 0 : I / _, _ == y)
        F = 0;
      else {
        switch (_) {
    ...
    function L(r, g, s) {
      ...
      var _ = t.floor(r), y = r - _, F = s * (1 - g), x = s * (1 - y * g), O = s * (1 - (1 - y) * g), I = _ % 6, P = [s, x, F, F, O, s][I], rt = [O, s, s, x, F, F][I], V = [F, F, O, s, s, x][I];
    ...
    function E(r, g, s) {
      g = g || 6, s = s || 30;
      var _ = u(r).toHsl(), y = 360 / s, F = [u(r)];
      for (_.h = (_.h - (y * g >> 1) + 720) % 360; --g; )
        _.h = (_.h + y) % 360, F.push(u(_));
      return F;
    }
    function Ft(r, g) {
      g = g || 6;
      for (var s = u(r).toHsv(), _ = s.h, y = s.s, F = s.v, x = [], O = 1 / g; g--; )
        x.push(u({ h: _, s: y, v: F })), F = (F + O) % 1;
      return x;
    }
    u.mix = function(r, g, s) {
      s = s === 0 ? 0 : s || 50;
      var _ = u(r).toRgb(), y = u(g).toRgb(), F = s / 100, x = {
        r: (y.r - _.r) * F + _.r,
        g: (y.g - _.g) * F + _.g,
        b: (y.b - _.b) * F + _.b,
        a: (y.a - _.a) * F + _.a
      ...
      var _ = u.readability(r, g), y, F;
      switch (F = !1, y = se(s), y.level + y.size) {
        case "AAsmall":
        case "AAAlarge":
          F = _ >= 4.5;
          break;
      ...
      var _ = null, y = 0, F, x, O, I;
      s = s || {}, x = s.includeFallbackColors, O = s.level, I = s.size;
      for (var P = 0; P < g.length; P++)
        F = u.readability(r, g[P]), F > y && (y = F, _ = u(g[P]));
...
function kt(a, t) {
  var n;
  const e = {};
  if (a.label && (e.label = a.label), a.fillColor && (n = Mt(a.fillColor), e.fillColor = n.rgb, e.fillOpacity = n.alpha), a.lineColor && (n = Mt(a.lineColor), e.strokeColor = n.rgb, e.strokeOpacity = n.alpha), a.lineWidth && (e.strokeWidth = a.lineWidth), a.pattern) {
    const i = "" + a.pattern;
    if (window.geo.markerFeature.symbols[i] !== void 0) {
      let o = 1;
      i.startsWith("flower") || i.startsWith("jack") ? o = 0.3 : i.startsWith("star") && (o = 0.6), t = void 0;
      const l = 48 / (t !== void 0 ? 2 ** t : 4);
      e.pattern = {
        symbol: window.geo.markerFeature.symbols[i],
        symbolValue: o,
        strokeWidth: 0,
        radius: l,
        rotation: -Math.PI / 2,
        scaleWithZoom: t !== void 0 ? window.geo.markerFeature.scaleMode.all : window.geo.markerFeature.scaleMode.none,
        spacing: -2.2 * l
      };
    }
  }
...
function Pe(a, t) {
  return function(n, e) {
    if (("" + e).startsWith("_"))
      return;
    const i = n.type;
    if (n = _t.defaults({}, n, Wt[i] || {}), !_t.has(xt, i))
      return;
    const o = xt[i](n);
    return {
      type: "Feature",
      id: n.id,
      geometry: { type: o.type, coordinates: o.coordinates },
      properties: _t.extend({ element: n, annotationType: o.annotationType }, a, kt(n, t))
    };
  };
}
function Zt(a, t = {}, n) {
  return {
    ...
    features: _t.chain(a).mapObject(Pe(t, n)).compact().value()
  };
}
function $t(a, t) {
...
function De(a, t, n) {
  const e = n.map(), i = e.createLayer("feature", { features: ["heatmap"] }), o = (a.origin || [0, 0, 0])[0] || 0, l = (a.origin || [0, 0, 0])[1] || 0, c = (a.origin || [0, 0, 0])[2] || 0, d = a.dx || 1, u = a.dy || 1, h = $t(a, a.values), p = e.layers().find((w) => w instanceof window.geo.tileLayer && w.options && w.options.maxLevel !== void 0), f = p ? 2 ** -p.options.maxLevel : 1, b = i.createFeature("heatmap", {
    style: {
...
function Jt(a, t = {}, n) {
  try {
    var e = [];
    return a.forEach((i) => {
      const o = Rt[i.type + "_" + i.interpretation] || Rt[i.type];
...
const st = Ve.extend({
  ...
  initialize() {
    !this.get("updated") && X() && (this.attributes.updated = (/* @__PURE__ */ new Date()).toISOString(), this.attributes.updatedId = X().id), this._region = {
    ...
    ), this._elements.annotation = this, this.bindListeners();
  },
  bindListeners: function() {
    this.listenTo(this._elements, "change add remove reset", this.handleChangeEvent), this.listenTo(this._elements, "change add", this.handleElementChanged), this.listenTo(this._elements, "remove", this.handleElementRemoved);
  },
  ...
  handleElementChanged: function(a, t, n) {
    ...
    for (i = 0; i < this._centroids.props.length; i += 1) {
      ...
      if (h.type === e.type && h.fillColor === e.fillColor && h.lineColor === e.lineColor && h.lineWidth === e.lineWidth && h.closed === e.closed && h.pattern === e.pattern)
        break;
    }
    ...
    if (a.get("center"))
      ...
      let p = h[0][0], f = h[0][0], b = h[0][1], w = h[0][1];
      for (const [L, M] of h)
        p = Math.min(p, L), b = Math.min(b, M), f = Math.max(f, L), w = Math.max(w, M);
      c = (f + p) / 2, d = (w + b) / 2, u = Math.max(1, ((f - p) ** 2 + (w - b) ** 2) ** 0.5);
    }
    if (l === this._centroids.centroids.id.length) {
      ...
      p.set(this._centroids.centroids.y), p[l] = d, this._centroids.centroids.y = p;
  ...
  fetchCentroids: function() {
    ...
    return (this.get("_elementQuery") || {}).count && (this.get("_elementQuery") || {}).count > this.get("maxCentroids") && (t.data.sort = "size", t.data.sortdir = -1, t.data.limit = this.get("maxCentroids")), gt(t).done((n) => {
      ...
      if (c.props = c._elementQuery.props.map((p) => {
        const f = {};
  ...
  delete(a) {
    ...
    let t = !1;
    return this.isNew() || (X() && (this.attributes.updated = (/* @__PURE__ */ new Date()).toISOString(), this.attributes.updatedId = X().id), t = gt({
  ...
  geojson() {
    ...
    let n;
    try {
      n = this.collection._viewer.metadata.levels;
    } catch {
    }
    return Zt(t, { annotation: this.id }, n);
  },
  /**
  ...
  non_geojson(a) {
    ...
    return Jt(n, { annotation: this.id }, a);
  },
  /**
  ...
  setView(a, t, n, e, i, o) {
    if (!(this._pageElements === !1 || this.isNew())) {
      var l = a.right - a.left, c = a.bottom - a.top, d = l * (this._viewArea - 1) / 2, u = c * (this._viewArea - 1) / 2, h = d / 2, p = u / 2, f = this._region.left !== void 0 && a.left >= this._region.left + h && a.top >= this._region.top + p && a.right <= this._region.right - h && a.bottom <= this._region.bottom - p && Math.abs(this._lastZoom - t) < 1;
      if (!(f && !this._inFetch)) {
...
var Ze = Object.prototype.hasOwnProperty, Je = /["&<>]/;
function Xt(a, t, n, e) {
  if (!(a instanceof Error)) throw a;
  if (!(typeof window > "u" && t || e)) throw a.message += " on line " + n, a;
  var i, o, l, c;
...
const z = girder.$, ct = girder._, { AccessType: Xe } = girder.constants, zt = girder.utilities.EventStream, { getCurrentUser: Ke } = girder.auth, { confirm: Dt } = girder.dialog, { getApiRoot: vt, restRequest: tn } = girder.rest, en = girder.views.widgets.AccessWidget, nn = girder.events, an = girder.collections.UserCollection, on = girder.views.widgets.UploadWidget, rn = girder.views.View, sn = rn.extend({
  ...
  setViewer(a) {
    return this._drawn.clear(), this._viewer = a, this.collection._viewer = a, this;
  },
...
function St(a) {
  ...
  const o = n[i % 4], l = n[(i + 1) % 4], c = n[(i + 2) % 4], d = n[(i + 3) % 4], u = [c.x - l.x, c.y - l.y], h = [l.x - o.x, l.y - o.y], p = Math.atan2(u[1], u[0]), f = Math.sqrt(h[0] * h[0] + h[1] * h[1]), b = Math.sqrt(u[0] * u[0] + u[1] * u[1]), w = [
...
const Tn = girder.$, k = girder._, Mn = girder.Backbone, tt = girder.events, { wrap: Rn } = girder.utilities.PluginUtils, { restRequest: Pn, getApiRoot: dt } = girder.rest;
function Vt() {
  function a() {
...
var zn = function(a) {
  return Rn(a, "initialize", function(t) {
    var n = arguments[1];
    ...
    _getOverlayTransformProjString: function(t) {
      ...
      let p = "+proj=longlat +axis=enu";
      return e !== 0 && (e = -1 * e, p = p + ` +xoff=${e}`), i !== 0 && (p = p + ` +yoff=${i}`), (l !== 1 || c !== 0 || d !== 0 || u !== 1) && (p = p + ` +s11=${1 / l} +s12=${c} +s21=${d} +s22=${1 / u}`), p;
    },
    /**
    ...
    _addPixelmapLayerParams(t, n, e, i) {
      ...
      return t.style = {
        color: (d, u) => {
          if (d < 0 || d >= l.length || d === void 0)
            return console.warn(`No category found at index ${d} in the category map.`), "rgba(0, 0, 0, 0)";
          let h;
          const p = l[d];
          return p ? (c ? h = u % 2 === 0 ? p.fillColor : p.strokeColor : h = p.fillColor, h) : "rgba(0, 0, 0, 0)";
        }
      }, t;
    },
    /**
    ...
    drawAnnotation: function(t, n) {
      ...
      let d = !1;
      if (l && (k.each(this._annotations[t.id].features, (h, p) => {
        p || !t._centroids || !h._centroidFeature ? h._ownLayer ? h.layer().map().deleteLayer(h.layer()) : (this.featureLayer.deleteFeature(h), d = !0) : c = h;
      }), this._annotations[t.id].overlays && k.each(this._annotations[t.id].overlays, (h) => {
        const p = this._annotations[t.id].overlays.map((b) => b.id), f = o.map((b) => b.id);
        k.each(p, (b) => {
          if (!f.includes(b)) {
        ...
        if (t._centroids && !c) {
          ...
          h._centroidFeature = !0, u.push(h), h.data(t._centroids.data).position((p, f) => ({
            ...
            stroke: (p, f) => !t._shownIds || t._centroids.centroids.id[f] && !t._shownIds.has(t._centroids.centroids.id[f]),
            strokeColor: (p, f) => {
            ...
            fill: (p, f) => !t._shownIds || t._centroids.centroids.id[f] && !t._shownIds.has(t._centroids.centroids.id[f]),
            fillColor: (p, f) => {
              const b = t._centroids.centroids.s[f];
            ...
            if (this.viewer.zoom() !== t._centroidLastZoom)
              if (t._centroidLastZoom = this.viewer.zoom(), h.verticesPerFeature) {
                const w = 2.5 * this.viewer.unitsPerPixel(this.viewer.zoom()), L = h.verticesPerFeature(), M = h.data().length, S = new Float32Array(L * M);
                for (var p = 0, f = 0; p < M; p += 1) {
                  let W = t._centroids.centroids.r[p];
                  W ? W /= w : W = 8;
        ...
        this.getUnclampBoundsForOverlay() && this._annotations[t.id].overlays.length > 0 && (this.viewer.clampBoundsY(!1), this.viewer.clampBoundsX(!1)), k.each(this._annotations[t.id].overlays, (h) => {
          ...
          Pn({
            ...
            b.length > 0 && k.each(b, (R) => {
              this.viewer.deleteLayer(R);
            });
            const w = this._generateOverlayLayerParams(f, p, h), L = h.type === "pixelmap" ? "pixelmap" : "osm", M = this._getOverlayTransformProjString(h), S = this.viewer.createLayer(L, Object.assign({}, w, { id: h.id, gcs: M }));
            ...
            S.geoOn(
              ...
              (R) => this._onMouseFeature(R, t.elements().get(h.id), S)
            ), this.viewer.scheduleAnimationFrame(this.viewer.draw, !0);
          }).fail((f) => {
            console.error(`There was an error overlaying image with ID ${p}`);
          });
          ...
          const p = u.find((f) => f._centroidFeature);
          t._centroids && p && (p.verticesPerFeature ? this.viewer.scheduleAnimationFrame(() => {
            if (!t._shownIds)
              return;
          ...
          }) : p.modified()), this.viewer.scheduleAnimationFrame(this.viewer.draw, !0);
    ...
    _mutateFeaturePropertiesForHighlight: function(t, n) {
      k.each(n, (i) => {
        ...
        for (let u = 0; u < o.length; u += 1) {
          const h = o[u].id, p = o[u].fillOpacity * this._globalAnnotationFillOpacity, f = o[u].strokeOpacity;
          this._hideAnnotation && t === this._hideAnnotation && h === this._hideElement ? (c[u] = 0, d[u] = 0) : !this._highlightAnnotation || !this._highlightElement && t === this._highlightAnnotation || this._highlightElement === h ? (c[u] = p, d[u] = f) : (c[u] = p * 0.25, d[u] = f * 0.25);
        }
    ...
    drawRegion: function(t, n, e) {
      let i, o;
      t && t.model && t.add !== void 0 && (n = t.mode, e = t.add, i = t.submitCtrl, o = t.event, t = t.model), t = t || new Mn.Model();
      ...
      return this.startDrawMode(l, { trigger: !1, signalModeChange: !0 }).then((c) => {
        ...
        switch (n) {
          case "point":
            ...
            break;
          case "line":
            u = d.points.map(([w, L, M]) => [Math.round(w), Math.round(L)]).flat(), u = u.slice(0, 4), u.push(-2), u.push(-2), u.push(-2), u.push(-2);
            break;
          case "polyline":
            for (u = d.points.map(([w, L, M]) => [Math.round(w), Math.round(L)]).flat(), u.push(-2), u.push(-2); u.length > 0 && u.length <= 6; )
              u.push(-2), u.push(-2);
            break;
          case "polygon":
            for (u = d.points.map(([w, L, M]) => [Math.round(w), Math.round(L)]).flat(); u.length > 0 && u.length <= 6; )
              u.push(u[0]), u.push(u[1]);
            break;
          default:
            var h = Math.round(d.center[0] - d.width / 2), p = Math.round(d.center[1] - d.height / 2), f = Math.round(d.width), b = Math.round(d.height);
            u = [h, p, f, b];
            break;
        }
