...
.. _ansible_collections.ieisystem.inmanage.system_lock_mode_info_module:
...
.. note::
    ...
    To use it in a playbook, specify: :code:`ieisystem.inmanage.system_lock_mode_info`.

.. version_added

.. versionadded:: 3.0.0 of ieisystem.inmanage
...
- Get system lock mode information on ieisystem Server.
...
.. code-block:: yaml+jinja
    ...
    - name: System lock mode test
      ...
      - name: "Get system lock mode information"
        ieisystem.inmanage.system_lock_mode_info:
          provider: "{{ inmanage }}"
