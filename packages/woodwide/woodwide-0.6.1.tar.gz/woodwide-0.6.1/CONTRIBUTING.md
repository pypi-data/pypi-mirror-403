...
modify the contents of the `src/woodwide/lib/` and `examples/` directories.
...
```sh
$ pip install git+ssh://git@github.com/Wood-Wide-AI/wwai-python-sdk.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/Wood-Wide-AI/wwai-python-sdk/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
