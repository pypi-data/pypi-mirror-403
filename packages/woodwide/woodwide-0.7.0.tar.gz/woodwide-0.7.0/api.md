...
- <code title="post /api/models/factors/{model_id}/infer">client.api.models.factors.<a href="./src/woodwide/resources/api/models/factors.py">infer</a>(model_id, \*\*<a href="src/woodwide/types/api/models/factor_infer_params.py">params</a>) -> <a href="./src/woodwide/types/api/models/factor_infer_response.py">FactorInferResponse</a></code>
- <code title="post /api/models/factors/train">client.api.models.factors.<a href="./src/woodwide/resources/api/models/factors.py">train</a>(\*\*<a href="src/woodwide/types/api/models/factor_train_params.py">params</a>) -> <a href="./src/woodwide/types/api/model_public.py">ModelPublic</a></code>
