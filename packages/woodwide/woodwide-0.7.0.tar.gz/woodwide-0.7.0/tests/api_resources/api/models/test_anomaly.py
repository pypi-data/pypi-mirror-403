...
class TestAnomaly:
    ...
    def test_method_infer(self, client: WoodWide) -> None:
        anomaly = client.api.models.anomaly.infer(
            model_id="model_id",
        )
        assert_matches_type(AnomalyInferResponse, anomaly, path=["response"])
    ...
    def test_raw_response_infer(self, client: WoodWide) -> None:
        response = client.api.models.anomaly.with_raw_response.infer(
            model_id="model_id",
        )
    ...
    def test_streaming_response_infer(self, client: WoodWide) -> None:
        with client.api.models.anomaly.with_streaming_response.infer(
            model_id="model_id",
        ) as response:
    ...
    def test_path_params_infer(self, client: WoodWide) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `model_id` but received ''"):
            client.api.models.anomaly.with_raw_response.infer(
                model_id="",
            )
    ...
    def test_method_train(self, client: WoodWide) -> None:
        anomaly = client.api.models.anomaly.train(
            model_name="model_name",
        )
        assert_matches_type(ModelPublic, anomaly, path=["response"])
    ...
    def test_raw_response_train(self, client: WoodWide) -> None:
        response = client.api.models.anomaly.with_raw_response.train(
            model_name="model_name",
        )
    ...
    def test_streaming_response_train(self, client: WoodWide) -> None:
        with client.api.models.anomaly.with_streaming_response.train(
            model_name="model_name",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncAnomaly:
    ...
    async def test_method_infer(self, async_client: AsyncWoodWide) -> None:
        anomaly = await async_client.api.models.anomaly.infer(
            model_id="model_id",
        )
        assert_matches_type(AnomalyInferResponse, anomaly, path=["response"])
    ...
    async def test_raw_response_infer(self, async_client: AsyncWoodWide) -> None:
        response = await async_client.api.models.anomaly.with_raw_response.infer(
            model_id="model_id",
        )
    ...
    async def test_streaming_response_infer(self, async_client: AsyncWoodWide) -> None:
        async with async_client.api.models.anomaly.with_streaming_response.infer(
            model_id="model_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_infer(self, async_client: AsyncWoodWide) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `model_id` but received ''"):
            await async_client.api.models.anomaly.with_raw_response.infer(
                model_id="",
            )
    ...
    async def test_method_train(self, async_client: AsyncWoodWide) -> None:
        anomaly = await async_client.api.models.anomaly.train(
            model_name="model_name",
        )
        assert_matches_type(ModelPublic, anomaly, path=["response"])
    ...
    async def test_raw_response_train(self, async_client: AsyncWoodWide) -> None:
        response = await async_client.api.models.anomaly.with_raw_response.train(
            model_name="model_name",
        )
    ...
    async def test_streaming_response_train(self, async_client: AsyncWoodWide) -> None:
        async with async_client.api.models.anomaly.with_streaming_response.train(
            model_name="model_name",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
