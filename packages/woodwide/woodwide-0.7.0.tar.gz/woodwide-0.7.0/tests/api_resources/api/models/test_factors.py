...
from woodwide.types.api.models import FactorInferResponse
...
class TestFactors:
    ...
    def test_method_infer(self, client: WoodWide) -> None:
        factor = client.api.models.factors.infer(
            model_id="model_id",
        )
        assert_matches_type(FactorInferResponse, factor, path=["response"])
    ...
    def test_raw_response_infer(self, client: WoodWide) -> None:
        response = client.api.models.factors.with_raw_response.infer(
            model_id="model_id",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        factor = response.parse()
        assert_matches_type(FactorInferResponse, factor, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_infer(self, client: WoodWide) -> None:
        with client.api.models.factors.with_streaming_response.infer(
            model_id="model_id",
        ) as response:
    ...
    def test_path_params_infer(self, client: WoodWide) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `model_id` but received ''"):
            client.api.models.factors.with_raw_response.infer(
                model_id="",
            )
    ...
    def test_method_train(self, client: WoodWide) -> None:
        factor = client.api.models.factors.train(
            model_name="model_name",
        )
        assert_matches_type(ModelPublic, factor, path=["response"])
    ...
    def test_raw_response_train(self, client: WoodWide) -> None:
        response = client.api.models.factors.with_raw_response.train(
            model_name="model_name",
        )
    ...
    def test_streaming_response_train(self, client: WoodWide) -> None:
        with client.api.models.factors.with_streaming_response.train(
            model_name="model_name",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncFactors:
    ...
    async def test_method_infer(self, async_client: AsyncWoodWide) -> None:
        factor = await async_client.api.models.factors.infer(
            model_id="model_id",
        )
        assert_matches_type(FactorInferResponse, factor, path=["response"])
    ...
    async def test_raw_response_infer(self, async_client: AsyncWoodWide) -> None:
        response = await async_client.api.models.factors.with_raw_response.infer(
            model_id="model_id",
        )

        assert response.is_closed is True
        assert response.http_request.headers.get("X-Stainless-Lang") == "python"
        factor = await response.parse()
        assert_matches_type(FactorInferResponse, factor, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_infer(self, async_client: AsyncWoodWide) -> None:
        async with async_client.api.models.factors.with_streaming_response.infer(
            model_id="model_id",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_infer(self, async_client: AsyncWoodWide) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `model_id` but received ''"):
            await async_client.api.models.factors.with_raw_response.infer(
                model_id="",
            )
    ...
    async def test_method_train(self, async_client: AsyncWoodWide) -> None:
        factor = await async_client.api.models.factors.train(
            model_name="model_name",
        )
        assert_matches_type(ModelPublic, factor, path=["response"])
    ...
    async def test_raw_response_train(self, async_client: AsyncWoodWide) -> None:
        response = await async_client.api.models.factors.with_raw_response.train(
            model_name="model_name",
        )
    ...
    async def test_streaming_response_train(self, async_client: AsyncWoodWide) -> None:
        async with async_client.api.models.factors.with_streaming_response.train(
            model_name="model_name",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
