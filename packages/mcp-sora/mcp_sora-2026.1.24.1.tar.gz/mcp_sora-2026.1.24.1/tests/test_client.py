...
def client():
    ...
    return SoraClient(api_token="test-token", base_url="https://api.test.com")


class TestSoraClient:
    """Tests for SoraClient class."""

    def test_init_with_params(self):
        """Test client initialization with explicit parameters."""
        client = SoraClient(api_token="my-token", base_url="https://custom.api.com")
    ...
    def test_get_headers_no_token(self):
        ...
        client = SoraClient(api_token="", base_url="https://api.test.com")
        with pytest.raises(SoraAuthError, match="not configured"):
            client._get_headers()
    ...
    async def test_request_success(self, client, mock_video_response):
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            result = await client.request("/sora/videos", {"prompt": "test"})
    ...
    async def test_request_auth_error_401(self, client):
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            with pytest.raises(SoraAuthError, match="Invalid API token"):
                await client.request("/sora/videos", {})
    ...
    async def test_request_timeout(self, client):
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            with pytest.raises(SoraTimeoutError, match="timed out"):
                await client.request("/sora/videos", {})
