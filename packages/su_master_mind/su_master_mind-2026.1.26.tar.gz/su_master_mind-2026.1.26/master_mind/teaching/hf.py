...
def _make_hf_resource(
    ...
    def download() -> str:
        ...
        save_path = _get_save_path("huggingface", "models", model_id)
...
def make_hf_processor_resource(
    ...
    Args:
        model_id: The HuggingFace model identifier (e.g., "openai/clip-vit-base-patch32")
        description: A short description of the processor. If None, uses a generic one.
        processor_class: Name of transformers processor class (e.g., "CLIPProcessor").
