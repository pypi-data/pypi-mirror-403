...
Usage in notebooks:
    from master_mind.teaching.hf import load_hf_dataset, load_hf_model, HFModel

    # Option 1: Direct loading
    tokenizer = load_hf_tokenizer("gpt2")
    model = load_hf_model("gpt2", GPT2LMHeadModel)

    # Option 2: Lazy loading with HFModel (cleaner for multiple models)
    hf_model = HFModel(GPT2Tokenizer, GPT2LMHeadModel, "gpt2")
...
class HFModel:
    ...
    def __init__(self, tokenizer_cls: Type, model_cls: Type, model_id: str):
