...
class TestHTMLScanner:
    """Tests for HTMLLanguage."""

    def test_get_extensions(self):
        """Test supported file extensions."""
        extensions = HTMLLanguage.get_extensions()
    ...
    def test_get_language_name(self):
        """Test language name."""
        assert HTMLLanguage.get_language_name() == "HTML"

    def test_should_skip_minified(self):
        """Test skipping minified files."""
        assert HTMLLanguage.should_skip("app.min.html") is True
        assert HTMLLanguage.should_skip("index.html") is False

    def test_scan_basic_doctype(self, html_language, basic_html):
        """Test DOCTYPE extraction."""
        structures = html_language.scan(basic_html)
    ...
    def test_scan_basic_sections(self, html_language, basic_html):
    ...
    def test_scan_basic_headings(self, html_language, basic_html):
    ...
    def test_scan_basic_forms(self, html_language, basic_html):
    ...
    def test_scan_basic_lists(self, html_language, basic_html):
    ...
    def test_scan_scripts_and_styles(self, html_language, basic_html):
    ...
    def test_scan_edge_cases_empty_heading(self, html_language, edge_cases_html):
    ...
    def test_scan_edge_cases_truncated_heading(self, html_language, edge_cases_html):
    ...
    def test_scan_edge_cases_nested_sections(self, html_language, edge_cases_html):
    ...
    def test_scan_edge_cases_multiple_forms(self, html_language, edge_cases_html):
    ...
    def test_scan_edge_cases_table(self, html_language, edge_cases_html):
    ...
    def test_scan_edge_cases_element_with_id(self, html_language, edge_cases_html):
    ...
    def test_scan_broken_html_fallback(self, html_language, broken_html):
        """Test fallback parsing for broken HTML."""
        # Should not crash and should extract what it can
        structures = html_language.scan(broken_html)
        assert structures is not None
...
class TestHTMLAnalyzer:
    ...
    def test_extract_imports_link(self, html_language, basic_html):
        """Test stylesheet and icon import extraction."""
        content = basic_html.decode("utf-8")
        imports = html_language.extract_imports("test.html", content)
    ...
    def test_extract_imports_script(self, html_language, basic_html):
    ...
    def test_extract_imports_css_import(self, html_language, basic_html):
    ...
    def test_extract_imports_ignores_external(self, html_language, edge_cases_html):
    ...
    def test_find_entry_points_index(self, html_language, basic_html):
        """Test entry point detection for index files."""
        content = basic_html.decode("utf-8")
        entry_points = html_language.find_entry_points("index.html", content)

        html_entries = [e for e in entry_points if e.type == "html_entry"]
        assert len(html_entries) >= 1

    def test_find_entry_points_doctype(self, html_language, basic_html):
        """Test DOCTYPE detection as entry point."""
        content = basic_html.decode("utf-8")
        entry_points = html_language.find_entry_points("page.html", content)

        doctypes = [e for e in entry_points if e.type == "html_document"]
        assert len(doctypes) >= 1

    def test_find_entry_points_viewport(self, html_language, basic_html):
    ...
    def test_classify_file_index(self, html_language):
        """Test file classification for index files."""
        cluster = html_language.classify_file("index.html", "<!DOCTYPE html>")
        assert cluster == "entry_points"

    def test_classify_file_error(self, html_language):
        """Test file classification for error pages."""
        cluster = html_language.classify_file("404.html", "<!DOCTYPE html>")
        assert cluster == "utilities"

    def test_should_analyze_normal(self, html_language):
        """Test normal files should be analyzed."""
        assert html_language.should_analyze("page.html") is True

    def test_should_analyze_minified(self, html_language):
        """Test minified files should be skipped."""
        assert html_language.should_analyze("app.min.html") is False

    def test_is_low_value_small_file(self, html_language):
        """Test small files are low value."""
        assert html_language.is_low_value_for_inventory("stub.html", 50) is True

    def test_is_low_value_error_page(self, html_language):
        """Test error pages are low value."""
        assert html_language.is_low_value_for_inventory("404.html", 500) is True
