...
import pytest
from scantool.analyzers.csharp_analyzer import CSharpAnalyzer
...
"""
    ...
    def test_extract_imports_static_using(self, analyzer):
...
"""
    ...
    def test_extract_imports_alias(self, analyzer):
...
"""
    ...
    def test_find_entry_points_main_void(self, analyzer):
...
"""
    ...
    def test_find_entry_points_main_async(self, analyzer):
...
"""
    ...
    def test_find_entry_points_main_int(self, analyzer):
...
"""
    ...
    def test_find_entry_points_controller(self, analyzer):
...
"""
    ...
    def test_find_entry_points_http_handlers(self, analyzer):
...
"""
    ...
    def test_find_entry_points_startup_class(self, analyzer):
...
"""
    ...
    def test_find_entry_points_minimal_api(self, analyzer):
...
"""
    ...
    def test_should_analyze_normal_file(self, analyzer):
        ...
        assert analyzer.should_analyze("Program.cs") == True
        assert analyzer.should_analyze("UserController.cs") == True

    def test_should_analyze_skip_designer(self, analyzer):
        """Test that designer files are skipped."""
        assert analyzer.should_analyze("Form1.Designer.cs") == False
        assert analyzer.should_analyze("MainWindow.designer.cs") == False

    def test_should_analyze_skip_generated(self, analyzer):
        """Test that generated files are skipped."""
        assert analyzer.should_analyze("Generated.g.cs") == False
        assert analyzer.should_analyze("Code.generated.cs") == False

    def test_should_analyze_skip_assemblyinfo(self, analyzer):
        """Test that AssemblyInfo.cs is skipped."""
        assert analyzer.should_analyze("AssemblyInfo.cs") == False
        assert analyzer.should_analyze("assemblyinfo.cs") == False

    def test_classify_file_entry_point_program(self, analyzer):
...
"""
        cluster = analyzer.classify_file("Program.cs", content)
        assert cluster == "entry_points"

    def test_classify_file_entry_point_startup(self, analyzer):
...
"""
        cluster = analyzer.classify_file("Startup.cs", content)
        assert cluster == "entry_points"
...
"""
        cluster = analyzer.classify_file("UserController.cs", content)
        assert cluster == "core_logic"

    def test_classify_file_controller_path(self, analyzer):
...
"""
        cluster = analyzer.classify_file("/api/Controllers/UserController.cs", content)
        assert cluster == "core_logic"
...
"""
        cluster = analyzer.classify_file("/api/Models/User.cs", content)
        assert cluster == "core_logic"
...
"""
        cluster = analyzer.classify_file("/api/Services/UserService.cs", content)
        assert cluster == "core_logic"

    def test_classify_file_extensions(self, analyzer):
...
"""
        cluster = analyzer.classify_file("StringExtensions.cs", content)
...
"""
        cluster = analyzer.classify_file("UserControllerTests.cs", content)
