"""Example using financial-datasets MCP to compare stocks.

Before running, set your API key:
    export CLAUDE_TRACES_API_KEY=ct_...

Or inline:
    CLAUDE_TRACES_API_KEY=ct_... uv run python examples/stocks.py
"""
    ...
    "mcpServers": {
        "financial-datasets-api": {
            ...
            "args": [
                ...
                "--header",
                "X-API-KEY: 00a2dcfc-9cc8-4a1a-9f5f-e4cfada28b57",
            ],
        }
    }
}
...
async def main():
    ...
    async for msg in traced(
        query(
            prompt="Is CoreWeave (CRWV) or Nebius (NBIS) the better buy right now? Compare their financials, recent performance, and give me a recommendation.",
