...
class TestBase(unittest.TestCase):
    ...
    _DIR_FILES_PDF_MULTI = os.path.join(_DIR_FILES_PDF, 'multi-load')
    _DIR_FILES_PPTX = os.path.join(_DIR_FILES, 'pptx')
    _DIR_FILES_PPTX_MULTI = os.path.join(_DIR_FILES_PPTX, 'multi-load')
    _DIR_FILES_TXT = os.path.join(_DIR_FILES, 'txt')
