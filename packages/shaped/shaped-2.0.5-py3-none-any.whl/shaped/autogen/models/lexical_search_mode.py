...
class LexicalSearchMode(BaseModel):
    ...
    LexicalSearchMode
    """ # noqa: E501
    fuzziness_edit_distance: Optional[StrictInt] = Field(default=0, description="Maximum edit distance for fuzzy text matching.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fuzziness_edit_distance": obj.get("fuzziness_edit_distance") if obj.get("fuzziness_edit_distance") is not None else 0,
