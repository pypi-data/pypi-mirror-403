...
from fury.optpkg import TripWire, TripWireError, is_tripwire, optional_package
from fury.testing import assert_false, assert_true
...
def test_tripwire():
    ...
    npt.assert_raises(TripWireError, getattr, silly_module_name, "do_silly_thing")
