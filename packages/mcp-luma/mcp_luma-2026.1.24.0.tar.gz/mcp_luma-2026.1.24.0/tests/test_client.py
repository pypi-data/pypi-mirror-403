...
def client():
    ...
    return LumaClient(api_token="test-token", base_url="https://api.test.com")


class TestLumaClient:
    """Tests for LumaClient class."""

    def test_init_with_params(self):
        """Test client initialization with explicit parameters."""
        client = LumaClient(api_token="my-token", base_url="https://custom.api.com")
    ...
    def test_get_headers_no_token(self):
        ...
        client = LumaClient(api_token="", base_url="https://api.test.com")
        with pytest.raises(LumaAuthError, match="not configured"):
            client._get_headers()
    ...
    async def test_request_success(self, client, mock_video_response):
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            result = await client.request("/luma/videos", {"action": "generate"})
    ...
    async def test_request_auth_error_401(self, client):
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            with pytest.raises(LumaAuthError, match="Invalid API token"):
                await client.request("/luma/videos", {})
    ...
    async def test_request_timeout(self, client):
        ...
        with patch("httpx.AsyncClient") as mock_client:
            ...
            with pytest.raises(LumaTimeoutError, match="timed out"):
                await client.request("/luma/videos", {})
