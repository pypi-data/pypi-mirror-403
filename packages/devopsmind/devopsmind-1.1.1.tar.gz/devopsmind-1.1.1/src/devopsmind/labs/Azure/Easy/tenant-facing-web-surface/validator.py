...
def validate():
    review = Path("surface-review.md")

    if not review.exists():
        return False, "surface-review.md not found"
    ...
    if hits < 3:
        return False, "Response lacks basic Azure architecture reasoning"

    return True, "Azure tenant-facing web surface review complete"
