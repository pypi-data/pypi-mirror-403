-- Unity Catalog Function: find_store_inventory_by_sku
-- Description: Retrieves detailed inventory information for products by SKU for a specific store
-- This function is designed for store-specific inventory management in retail applications
