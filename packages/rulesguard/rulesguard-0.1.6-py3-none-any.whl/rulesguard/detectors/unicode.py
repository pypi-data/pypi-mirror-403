...
exploits related to CVE-2021-42574 (Trojan Source).
"""
...
class UnicodeDetector(BaseDetector):
    ...
    DANGEROUS_CHARS: dict[str, tuple[str, str, Severity]] = {
        ...
        "\u202e": (
            ...
            "Strong directional override (can reverse text)",
            Severity.HIGH,
        ),
