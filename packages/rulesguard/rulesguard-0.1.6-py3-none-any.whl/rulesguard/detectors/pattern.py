...
class PatternDetector(BaseDetector):
    ...
    def detect(self, content: str, filepath: str) -> list[Finding]:
        ...
        for severity in [Severity.CRITICAL, Severity.HIGH, Severity.MEDIUM]:
            severity_findings = self._detect_severity_patterns(content, filepath, severity)
    ...
    def _detect_severity_patterns(
        ...
        for pattern, category, description, recommendation in self._compiled_patterns[severity]:
            # Find all matches
