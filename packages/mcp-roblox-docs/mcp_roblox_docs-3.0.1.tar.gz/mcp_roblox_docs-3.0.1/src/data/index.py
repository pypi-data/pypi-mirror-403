...
if TYPE_CHECKING:
    from src.data.loader import DataType, Library
...
class SearchIndex:
    ...
    def __init__(self):
        ...
        self._datatype_data: dict[str, Any] = {}  # v3.0.0: DataType storage
        self._library_data: dict[str, Any] = {}  # v3.0.0: Library storage
        self._built = False
