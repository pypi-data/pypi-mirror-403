...
class BezierCubicInterpolation(InterpolationFunction):
    ...
    def interpolate_autocalculated(
        ...
        point_start: Point,
        point_end: Point,
        curvature_mode: BezierCubicCurvatureMode = BezierCubicCurvatureMode.ARC_LEFT,
        curvature_parameters: BezierCubicCurvatureParameters = BezierCubicCurvatureParameters(0.3, 0, 0.8)
    ):
