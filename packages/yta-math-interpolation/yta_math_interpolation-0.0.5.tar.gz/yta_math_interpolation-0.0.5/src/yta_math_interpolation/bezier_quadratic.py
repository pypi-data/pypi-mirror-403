...
class BezierQuadraticInterpolation(InterpolationFunction):
    ...
    def interpolate_autocalculated(
        ...
        point_start: Point,
        point_end: Point,
        curvature_mode: BezierQuadraticCurvatureMode = BezierQuadraticCurvatureMode.ARC_LEFT,
        curvature_parameters: BezierQuadraticCurvatureParameters = BezierQuadraticCurvatureParameters(0.3)
    ):
