...
from ..types import file_list_params, file_delete_params, file_download_params
...
class FilesResource(SyncAPIResource):
    ...
    def list(
        self,
        *,
        file_type: Literal["audio", "image", "text", "document"] | Omit = omit,
        limit: int | Omit = omit,
    ...
    def delete(
        ...
        *,
        ...
        return self._delete(
            "/files",
            body=maybe_transform({"file_id": file_id}, file_delete_params.FileDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
        ...
        *,
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=maybe_transform({"return_url": return_url}, file_download_params.FileDownloadParams),
            ),
    ...
    async def delete(
        ...
        *,
        ...
        return await self._delete(
            "/files",
            body=await async_maybe_transform({"file_id": file_id}, file_delete_params.FileDeleteParams),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=FileDeleteResponse,
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"return_url": return_url}, file_download_params.FileDownloadParams),
            ),
            cast_to=FileDownloadResponse,
        )
