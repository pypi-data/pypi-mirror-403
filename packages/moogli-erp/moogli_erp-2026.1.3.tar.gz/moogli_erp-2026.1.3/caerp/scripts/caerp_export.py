...
def _get_query(model, where):
    ...
    from caerp.views.statistics import CRITERION_MODELS, get_inspector
...
def _stream_csv_rows(model, query, fields):
    ...
    from caerp.celery.tasks.export import _add_o2m_headers_to_writer
...
def _write_invoice_on_disk(request, document, destdir, prefix, key):
    ...
    from caerp.views.task.views import html
