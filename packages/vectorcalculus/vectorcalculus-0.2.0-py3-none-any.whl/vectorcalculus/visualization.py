...
def plot_vector_field_2d(field: Callable[[Sequence[float]], Sequence[float]],
                         xlim: Tuple[float, float],
                         ylim: Tuple[float, float],
                         nx: int = 20, ny: int = 20,
                         scale: Optional[float] = None,
                         ax=None,
                         save: Optional[str] = None) -> 'matplotlib.figure.Figure':
    ...
    q = ax.quiver(X, Y, U, V, scale=scale)
    ax.set_xlim(*xlim)
    ax.set_ylim(*ylim)
...
def plot_streamlines_2d(field: Callable[[Sequence[float]], Sequence[float]],
                        xlim: Tuple[float, float],
                        ylim: Tuple[float, float],
                        density: float = 1.0,
...
def plot_surface_parametric(param: Callable[[float, float], Sequence[float]],
