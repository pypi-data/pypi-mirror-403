"""
Module base pour les opérations de paiement Arzeka.

Ce module fournit la classe de base `BasePayment` qui gère toutes les interactions
avec l'API Arzeka Mobile Money Payment au Burkina Faso. Il inclut :
...
Classes:
    BasePayment: Classe de base pour toutes les opérations de paiement Arzeka.
                 Fournit les méthodes de bas niveau pour interagir avec l'API.

Exceptions:
    ArzekaPaymentError: Exception de base pour toutes les erreurs
...
Note:
    ...
    Pour une utilisation standard, utilisez plutôt la classe `ArzekaPayment`.
"""
