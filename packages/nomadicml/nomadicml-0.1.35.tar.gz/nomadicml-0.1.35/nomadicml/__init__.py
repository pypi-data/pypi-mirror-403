...
__version__ = "0.1.35"  # This will be the clean version for PyPI (Overwritten by CI)
__build__ = "21ec077"      # This will hold the commit hash or full build string, populated by CI
