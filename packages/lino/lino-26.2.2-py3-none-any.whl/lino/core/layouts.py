...
# from lino.core.actors import AbstractTable
from .vfields import FakeField
from .vfields import VirtualField, wildcard_data_elems, fields_list
...
class LayoutHandle:
    ...
    def desc2elem(self, elemname, desc, **kwargs):
        ...
        # from lino.core.elems import Panel as elems_Panel
                ...
                if de.name not in explicit_specs:
                    if self.use_as_wildcard(de):
                        ...
                        if len(explicit_specs) or (
                                isinstance(de, FakeField) and de.hide_unless_explicit):
    ...
    def add_data_elem(self, field):
        # if field in self._data_elems:
        #     raise Exception(f"20251007 {field} {self}")
...
class BaseLayout:
    ...
    window_size: None | tuple[int, str] = None
    ...
    :attr:`column_names
    <lino.core.actors.AbstractTable.column_names>`.
...
class ColumnsLayout(FieldLayout):
    ...
    <lino.core.actors.AbstractTable.column_names>` attribute.
    ...
    def params_store(self):
        ...
        if self._params_store is None:
            ...
            if lh is None:
                ...
                return None
            self._params_store = ParameterStore(lh, self.url_param_name)
