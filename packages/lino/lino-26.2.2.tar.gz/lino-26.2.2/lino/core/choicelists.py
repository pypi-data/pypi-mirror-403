...
class ChoiceList(AbstractTable, metaclass=ChoiceListMeta):
    """
    ...
    @vfields.virtualfield(VALUE_FIELD)
    def value(cls, choice, ar):
        return choice.value

    @vfields.virtualfield(models.CharField(_("text"), max_length=50))
    def text(cls, choice, ar):
        return choice.text

    @vfields.virtualfield(models.CharField(_("name"), max_length=20))
    def name(cls, choice, ar):
        return " ".join(choice.names)

    @vfields.displayfield(_("Remark"))
    def remark(cls, choice, ar):
        return choice.remark

    @vfields.displayfield(_("Type"))
