...
Přidán document_code **DD64** - Historické Potvrzení o výjimce z obchodování (v1)
Do třídy **CitesDocumentPrincipalTypeWrite** přidán atribut **conditions_legacy** obsahující podmínky pro 
historické výjimky DD64 **ConditionsLegacyType**
