"""
Publications__Slideshows Core Routes

Generated from Postman collection. Module: publications__slideshows, Submodule: core
"""
...
async def delete_publication(
    ...
    *,
    ...
    DELETE /api/content/v1/reports/{id}
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/content/v1/reports/{id}"
