...
Generated from Postman collection. Module: admin, Submodule: authentication
"""
...
@gd.route_function
async def update_otp_elevation_setting(
    auth: DomoAuth,
    ...
    *,
    ...
    PUT /api/customer/v1/properties/authentication.otp_elevation
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/customer/v1/properties/authentication.otp_elevation"
