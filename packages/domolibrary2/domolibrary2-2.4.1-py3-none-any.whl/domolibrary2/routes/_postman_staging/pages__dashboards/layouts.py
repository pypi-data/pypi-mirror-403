"""
Pages__Dashboards Layouts Routes

Generated from Postman collection. Module: pages__dashboards, Submodule: layouts
"""
...
async def delete_writelock(
    ...
    *,
    ...
    DELETE /api/content/v4/pages/layouts/{id}/writelock
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/content/v4/pages/layouts/{id}/writelock"
