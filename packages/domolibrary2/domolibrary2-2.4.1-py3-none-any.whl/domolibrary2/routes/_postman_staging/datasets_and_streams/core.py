"""
Datasets_And_Streams Core Routes

Generated from Postman collection. Module: datasets_and_streams, Submodule: core
"""
...
async def delete_check(
    ...
    *,
    ...
    POST /api/data/v1/ui/bulk/delete/check
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/data/v1/ui/bulk/delete/check"
