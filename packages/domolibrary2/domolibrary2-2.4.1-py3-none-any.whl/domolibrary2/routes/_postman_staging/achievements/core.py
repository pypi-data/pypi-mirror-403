"""
Achievements Core Routes

Generated from Postman collection. Module: achievements, Submodule: core
"""
...
async def delete_achievement_admin(
    ...
    *,
    ...
    DELETE /api/content/v1/achievements/{achievementId}/admins/{adminId}
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/content/v1/achievements/{achievementId}/admins/{adminId}"
