"""
Filesets Core Routes

Generated from Postman collection. Module: filesets, Submodule: core
"""
...
async def delete_fileset(
    ...
    *,
    ...
    DELETE /api/files/v1/filesets/{id}
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/files/v1/filesets/{id}"
