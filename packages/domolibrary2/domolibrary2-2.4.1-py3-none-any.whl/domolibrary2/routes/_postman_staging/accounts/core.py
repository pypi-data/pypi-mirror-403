"""
Accounts Core Routes

Generated from Postman collection. Module: accounts, Submodule: core
"""
...
async def delete_account(
    ...
    *,
    ...
    DELETE /api/data/v1/accounts/{id}
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/data/v1/accounts/{id}"
