...
Generated from Postman collection. Module: company, Submodule: core
"""
...
async def update_property(
    ...
    *,
    ...
    PUT /api/customer/v1/properties/{property}
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/customer/v1/properties/{property}"
