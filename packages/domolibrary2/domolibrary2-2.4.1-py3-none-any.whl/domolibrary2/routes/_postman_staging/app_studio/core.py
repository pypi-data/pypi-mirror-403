"""
App_Studio Core Routes

Generated from Postman collection. Module: app_studio, Submodule: core
"""
...
async def delete_app(
    ...
    *,
    ...
    DELETE /api/content/v1/dataapps/{appId}
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/content/v1/dataapps/{appId}"
