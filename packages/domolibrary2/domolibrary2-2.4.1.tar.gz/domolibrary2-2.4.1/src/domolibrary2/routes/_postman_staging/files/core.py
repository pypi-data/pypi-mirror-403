...
Generated from Postman collection. Module: files, Submodule: core
"""
...
async def update_file_card(
    ...
    *,
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/content/v1/cards/{id}"
