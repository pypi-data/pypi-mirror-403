"""
Pages__Dashboards Core Routes

Generated from Postman collection. Module: pages__dashboards, Submodule: core
"""
...
async def delete_page(
    ...
    *,
    ...
    DELETE /api/content/v1/pages/{id}
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/content/v1/pages/{id}"
