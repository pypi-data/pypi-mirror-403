"""
Elevation Core Routes

Generated from Postman collection. Module: elevation, Submodule: core
"""
...
async def authenticate_with_otp(
    ...
    *,
    ...
    PUT /api/identity/v1/authentication/elevations/{userId}
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/identity/v1/authentication/elevations/{userId}"
