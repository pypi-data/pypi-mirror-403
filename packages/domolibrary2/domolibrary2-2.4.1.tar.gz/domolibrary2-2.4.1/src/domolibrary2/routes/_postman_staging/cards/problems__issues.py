"""
Cards Problems__Issues Routes

Generated from Postman collection. Module: cards, Submodule: problems__issues
"""
...
async def resolve_problem(
    ...
    *,
    ...
    PUT /api/content/v1/badges/{cardId}/problems/{problemId}/states
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/content/v1/badges/{cardId}/problems/{problemId}/states"
