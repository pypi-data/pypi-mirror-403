"""
Pages__Dashboards Filter_Views Routes

Generated from Postman collection. Module: pages__dashboards, Submodule: filter_views
"""
...
async def delete_filter_view(
    ...
    *,
    ...
    DELETE /api/content/v3/pages/analyzer/{filterViewId}
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/content/v3/pages/analyzer/{filterViewId}"
