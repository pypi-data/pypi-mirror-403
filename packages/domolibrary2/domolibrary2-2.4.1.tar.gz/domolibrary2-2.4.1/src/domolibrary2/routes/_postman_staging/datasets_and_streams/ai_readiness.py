"""
Datasets_And_Streams Ai_Readiness Routes

Generated from Postman collection. Module: datasets_and_streams, Submodule: ai_readiness
"""
...
async def update_data_dictionary(
    ...
    *,
    ...
    PUT /api/ai/readiness/v1/data-dictionary/dataset/{id}
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/ai/readiness/v1/data-dictionary/dataset/{id}"
