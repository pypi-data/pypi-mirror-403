"""
Bricks_And_Pro-Code_Apps Core Routes

Generated from Postman collection. Module: bricks_and_pro-code_apps, Submodule: core
"""
...
async def delete_app_design(
    ...
    *,
    ...
    DELETE /api/domoapps/designs/{id}
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/domoapps/designs/{id}"
