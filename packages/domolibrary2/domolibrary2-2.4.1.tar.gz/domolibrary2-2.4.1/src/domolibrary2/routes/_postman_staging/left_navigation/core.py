"""
Left_Navigation Core Routes

Generated from Postman collection. Module: left_navigation, Submodule: core
"""
...
async def update_pins(
    ...
    *,
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/nav/v1/pins/append"
