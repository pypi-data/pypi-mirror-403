...
Generated from Postman collection. Module: toolkit, Submodule: core
"""
...
async def delete_job(
    ...
    *,
    ...
    DELETE /api/executor/v1/applications/{appId}/jobs/{jobId}
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/executor/v1/applications/{appId}/jobs/{jobId}"
