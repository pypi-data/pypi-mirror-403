"""
Brand_Kit Core Routes

Generated from Postman collection. Module: brand_kit, Submodule: core
"""
...
async def get_hot_url(
    ...
    *,
    ...
    GET /api/messaging/v1/email/configurations/backlink
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/messaging/v1/email/configurations/backlink"
