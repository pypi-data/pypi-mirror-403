...
Generated from Postman collection. Module: credits, Submodule: core
"""
...
@gd.route_function
async def get_credit_balancestatements(
    auth: DomoAuth,
    ...
    *,
    ...
    """Get Credit Balance/Statements

    GET /api/metrics/v1/usage/credits/reports/balance
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/metrics/v1/usage/credits/reports/balance"
