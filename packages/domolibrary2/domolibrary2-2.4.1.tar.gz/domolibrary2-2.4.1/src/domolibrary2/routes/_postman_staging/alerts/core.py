...
Generated from Postman collection. Module: alerts, Submodule: core
"""
...
async def unshare_alert(
    ...
    *,
    ...
    DELETE /api/social/v4/alerts/{id}/subscriptions?subscriberId=123456&type=USER
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/social/v4/alerts/{id}/subscriptions?subscriberId=123456&type=USER"
