...
Generated from Postman collection. Module: users, Submodule: core
"""
...
async def delete_user(
    ...
    *,
    ...
    DELETE /api/identity/v1/users/{id}
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/identity/v1/users/{id}"
