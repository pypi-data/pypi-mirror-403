...
Generated from Postman collection. Module: appdb, Submodule: core
"""
...
async def delete_documents(
    ...
    *,
    ...
    DELETE /api/datastores/v2/collections/{collectionId}/documents/bulk?ids=
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/datastores/v2/collections/{collectionId}/documents/bulk?ids="
