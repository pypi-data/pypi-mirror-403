...
Generated from Postman collection. Module: roles, Submodule: core
"""
...
async def get_role_grants(
    ...
    *,
    ...
    GET /api/authorization/v1/roles/{id}/authorities
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/authorization/v1/roles/{id}/authorities"
