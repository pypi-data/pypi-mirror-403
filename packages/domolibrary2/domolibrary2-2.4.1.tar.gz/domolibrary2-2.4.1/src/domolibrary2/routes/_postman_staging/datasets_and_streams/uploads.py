"""
Datasets_And_Streams Uploads Routes

Generated from Postman collection. Module: datasets_and_streams, Submodule: uploads
"""
...
async def commit_upload(
    ...
    *,
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/data/v3/datasources/{datasetId}/uploads/{uploadId}/commit"
