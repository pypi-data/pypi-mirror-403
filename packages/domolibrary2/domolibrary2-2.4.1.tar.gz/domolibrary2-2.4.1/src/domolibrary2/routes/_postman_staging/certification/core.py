"""
Certification Core Routes

Generated from Postman collection. Module: certification, Submodule: core
"""
...
async def remove_certification(
    ...
    *,
    ...
    POST /api/synapse/approval/graphql
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/synapse/approval/graphql"
