"""
Workflows Core Routes

Generated from Postman collection. Module: workflows, Submodule: core
"""
...
async def update_workflow(
    ...
    *,
    ...
    """
    url = f"https://{auth.domo_instance}.domo.com/api/workflow/v1/models/{id}"
