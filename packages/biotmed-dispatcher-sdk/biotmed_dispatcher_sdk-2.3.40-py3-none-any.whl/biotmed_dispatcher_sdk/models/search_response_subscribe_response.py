...
class SearchResponseSubscribeResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    data: List[SubscribeResponse] = Field(description="List of items that match the search request")
    metadata: Metadata
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchResponseSubscribeResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchResponseSubscribeResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [SubscribeResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
