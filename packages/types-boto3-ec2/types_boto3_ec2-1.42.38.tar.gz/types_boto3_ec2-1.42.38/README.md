...
Type annotations for [boto3 EC2 1.42.38](https://pypi.org/project/boto3/)
...
1. Run mypy-boto3-builder in your package root directory:
   `uvx --with 'boto3==1.42.38' mypy-boto3-builder`
...
search_transit_gateway_routes_paginator: SearchTransitGatewayRoutesPaginator = client.get_paginator(
