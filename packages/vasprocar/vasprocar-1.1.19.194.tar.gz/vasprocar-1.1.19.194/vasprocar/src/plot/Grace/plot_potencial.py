...
for l in range(1,(3+1)):
    ...
    for i in range(1,(ni+3)):
        ...
        if (i == 1): color = 4                                    # Blue color
        if (destaque == 1 and i > 1 and i <= (ni+1)): color = 7   # Gray color
        if (i > (ni+1)): color = 2                                # Red color
    ...
    # Highlighting the Fermi energy:
         
    if (l == 1): 
       potencial.write(f'{min(X)} {Efermi} \n')
       potencial.write(f'{max(X)} {Efermi} \n')
    if (l == 2): 
       potencial.write(f'{min(Y)} {Efermi} \n')
       potencial.write(f'{max(Y)} {Efermi} \n')
    if (l == 3): 
       potencial.write(f'{min(Z)} {Efermi} \n')
       potencial.write(f'{max(Z)} {Efermi} \n') 
    potencial.write(" \n")  
