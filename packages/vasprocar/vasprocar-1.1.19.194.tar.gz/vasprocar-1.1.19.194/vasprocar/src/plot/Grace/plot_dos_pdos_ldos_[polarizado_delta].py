...
for i in range (1,(loop+1)):     # Loop for DOS and pDOS analysis
    ...
    for k in range (1,(NEDOS+1)):
        ...
        #-------------------------------------------------------
        if (temp < dos_min): dos_min = temp
        if (temp > dos_max):   dos_max = temp
        #-------------------------------------------------------
    ...
    escala_x = ( dos_max + (dos_min*(-1)) )/5
    escala_y = (E_max - E_min)/5
    ...
    dos_pdos.write(f'@    world {dos_min}, {Emin}, {dos_max}, {Emax} \n')
    ...
    dos_pdos.write(" \n")
    dos_pdos.write(f'{dos_min} {dest_fermi} \n')
    dos_pdos.write(f'{dos_max} {dest_fermi} \n')
