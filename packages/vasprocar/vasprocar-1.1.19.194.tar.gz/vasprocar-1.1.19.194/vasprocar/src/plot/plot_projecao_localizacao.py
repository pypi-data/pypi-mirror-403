...
if (save_png == 1): plt.savefig(dir_output + 'Localizacao.png', dpi = 600, bbox_inches='tight', pad_inches = 0)
if (save_pdf == 1): plt.savefig(dir_output + 'Localizacao.pdf', dpi = 600, bbox_inches='tight', pad_inches = 0)
if (save_svg == 1): plt.savefig(dir_output + 'Localizacao.svg', dpi = 600, bbox_inches='tight', pad_inches = 0)
if (save_eps == 1): plt.savefig(dir_output + 'Localizacao.eps', dpi = 600, bbox_inches='tight', pad_inches = 0)
...
if (save_png == 1): plt.savefig(dir_output + 'Localizacao_[sum_colors].png', dpi = 600, bbox_inches='tight', pad_inches = 0)
if (save_pdf == 1): plt.savefig(dir_output + 'Localizacao_[sum_colors].pdf', dpi = 600, bbox_inches='tight', pad_inches = 0)
if (save_svg == 1): plt.savefig(dir_output + 'Localizacao_[sum_colors].svg', dpi = 600, bbox_inches='tight', pad_inches = 0)
if (save_eps == 1): plt.savefig(dir_output + 'Localizacao_[sum_colors].eps', dpi = 600, bbox_inches='tight', pad_inches = 0)
