...
for l in range (1,(loop+1)):     # Loop for analysis of projections
    ...
    if (l == 1):
       ...
       temp_DOS_u = []
       temp_DOS_d = []
       for l in range(len(energia)):
           if ((energia[l] >= E_min) and (energia[l] <= E_max)):
              temp_DOS_u.append(dos_u_tot[l])
              temp_DOS_d.append(dos_d_tot[l])
       dos_min = min(temp_DOS_d)
       dos_max = max(temp_DOS_u)
       #=============================================================================================================
    ...
    if (l == 2):
       ...
       for l in range(len(energia)):
           if ((energia[l] >= E_min) and (energia[l] <= E_max)):
              temp_DOS_u.append(pdos_u_P[l])
              temp_DOS_d.append(pdos_d_P[l])
       dos_min = min(temp_DOS_d)
       dos_max = max(temp_DOS_u)     
       #===============================================================================================================
    ...
    if (l == 3):
       ...
       for l in range(len(energia)):
           if ((energia[l] >= E_min) and (energia[l] <= E_max)):
              temp_DOS_u.append(pdos_u_D[l])
              temp_DOS_d.append(pdos_d_D[l])
       dos_min = min(temp_DOS_d)
       dos_max = max(temp_DOS_u) 
       #===============================================================================================================
    ...
    if (l == 4):
       ...
       for l in range(len(energia)):
           if ((energia[l] >= E_min) and (energia[l] <= E_max)):
              temp_DOS_u.append(pdos_u_F[l])
              temp_DOS_d.append(pdos_d_F[l])
       dos_min = min(temp_DOS_d)
       dos_max = max(temp_DOS_u) 
       #==========================================================================================================================
...
for l in range (1,(loop+1)):     # Loop for analysis of projections
    ...
    if (l == 1):
       ...
       for l in range(len(energia)):
           if ((energia[l] >= E_min) and (energia[l] <= E_max)):
              temp_DOS_u.append(dos_tot[l])
              temp_DOS_d.append(dos_tot[l])
       dos_min = min(temp_DOS_d)
       dos_max = max(temp_DOS_u)
       #-------------------------------------------------------------------------------------------------------------------------
    ...
    if (l == 2):
       ...
       for l in range(len(energia)):
           if ((energia[l] >= E_min) and (energia[l] <= E_max)):
              temp_DOS_u.append(pdos_P[l])
              temp_DOS_d.append(pdos_P[l])
       dos_min = min(temp_DOS_d)
       dos_max = max(temp_DOS_u)
       #-------------------------------------------------------------------------------------------------------------------------
    ...
    if (l == 3):
       ...
       for l in range(len(energia)):
           if ((energia[l] >= E_min) and (energia[l] <= E_max)):
              temp_DOS_u.append(pdos_D[l])
              temp_DOS_d.append(pdos_D[l])
       dos_min = min(temp_DOS_d)
       dos_max = max(temp_DOS_u)
       #-------------------------------------------------------------------------------------------------------------------------
    ...
    if (l == 4):
       ...
       for l in range(len(energia)):
           if ((energia[l] >= E_min) and (energia[l] <= E_max)):
              temp_DOS_u.append(pdos_F[l])
              temp_DOS_d.append(pdos_F[l])
       dos_min = min(temp_DOS_d)
       dos_max = max(temp_DOS_u)
       #-------------------------------------------------------------------------------------------------------------------------
