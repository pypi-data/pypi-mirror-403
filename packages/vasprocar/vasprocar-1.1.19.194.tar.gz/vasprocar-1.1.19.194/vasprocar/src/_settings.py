...
if (len(inputs) == 0 and DFT == '_VASP/'):
   ...
   print("## ======================================================== ##")
   print("## [7] Install/Update Python modules                        ##")
   print("## ======================================================== ##")
   print("## [8] SAMBA code:                                          ##")
   print("##     Generate Twisted homo- and hetero bilayers;          ##")
   print("##     DFT calculations via High-Throughput approach;       ##")
   print("##     Automate the analysis of results (via VASProcar)     ##")     
   print("## ======================================================== ##")
   print("## [9] DFT2kp: effective kp models from ab-initio data      ##")
   print("## ======================================================== ##")
   print("##############################################################")
   ...
   if (opcao > -10 and opcao < 10 and opcao != 6 and opcao != -6 and opcao != 7 and opcao != -7 and opcao != 8 and opcao != -8 and opcao != 9 and opcao != -9):
      print("##############################################################")
      print("####################### Choose option: #######################")
      print("##############################################################")
   ...
   if (opcao == 5 or opcao == -5):
      print("## ======================================================== ##")
      print("## [50] POSCAR - Coord. Conversion between Direct/Cartesian ##")
...
if (opcao == 0): execute_python_file(filename = '_settings.py')

if (opcao > -100 and opcao < 100 and opcao != 41 and opcao != -41 and opcao != 50 and opcao != 51 and opcao != -51 and opcao != 52 and opcao != -52 and opcao != 53 and opcao != -53 and opcao != 6 and opcao != -6 and opcao != 7 and opcao != -7 and opcao != 8 and opcao != -8 and opcao != 9 and opcao != -9):
...
if (opcao == 50 or opcao == -50):
   execute_python_file(filename = DFT + 'poscar_coord_conversion.py')
...
if (opcao == 7 or opcao == -7):
   execute_python_file(filename = '_update.py')

if (opcao == 8 or opcao == -8):
   execute_python_file(filename = '_samba.py')

if (opcao == 9 or opcao == -9):
