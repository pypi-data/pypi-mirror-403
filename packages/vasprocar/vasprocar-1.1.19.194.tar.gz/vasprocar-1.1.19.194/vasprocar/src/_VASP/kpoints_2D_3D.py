...
# ------------------------------------------------------------------------------
if os.path.isdir(dir_files + '/KPOINTS'):
    0 == 0
else:
    os.mkdir(dir_files + '/KPOINTS')
# ---------------------------------
...
#--------------------------------------------------
kpoints = open(dir_files + '/KPOINTS/KPOINTS', 'w')
#--------------------------------------------------
...
if (split == 1):
   ...
   #----------------------------------------------------
   r_kpoints = open(dir_files + '/KPOINTS/KPOINTS', 'r')
   #----------------------------------------------------
   ...
   for i in range(1,(passo+1)):
       #------------------------------------------------------------
       kpoints = open(dir_files + '/KPOINTS/KPOINTS.' + str(i), 'w')      
       #------------------------------------------------------------       
...
if (n_contcar != 0 and n_outcar != 0 and n_procar != 0): 
   ...
   if (coord == 1):
      #--------------------------------------------------------------------------
      pontos_k = open(dir_files + '/KPOINTS/k-points_Coord_Cartesianas.txt', 'w')
      #--------------------------------------------------------------------------
