...
print(" ")
print("============================================================")
print("Do you want to install/update the Python modules necessary  ")
print("for the correct execution of all VASProcar functionalities? ")
print("------------------------------------------------------------")
print("[1] YES                                                     ")
...
if (modulos == 0): execute_python_file(filename = '_settings.py')
