...
def unpack(func: Callable[[Unpack[Ts]], T]) -> Callable[[tuple[Unpack[Ts]]], T]:
    @wraps(func)
    def _wrapper(args: tuple[Unpack[Ts]]) -> T:
        return func(*args)
...
@overload
def zipped(
    func: Callable[[Unpack[Ts]], Result[U, AnyE]],
) -> Callable[[tuple[Unpack[Ts]]], Result[tuple[Unpack[Ts], U], AnyE]]: ...
@overload
def zipped(
    func: Callable[[Unpack[Ts]], Option[U]],
) -> Callable[[tuple[Unpack[Ts]]], Option[tuple[Unpack[Ts], U]]]: ...
