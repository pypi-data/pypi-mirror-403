...
class ListWorkspacesResponse(BaseModel):
    ...
    """ # noqa: E501
    workspaces: List[WorkspaceInfo] = Field(description="List of accessible workspaces.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workspaces": [WorkspaceInfo.from_dict(_item) for _item in obj["workspaces"]] if obj.get("workspaces") is not None else None
        })
        return _obj
