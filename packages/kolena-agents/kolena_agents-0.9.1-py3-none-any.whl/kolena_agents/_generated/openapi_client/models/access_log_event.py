...
class AccessLogEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["timestamp_millis", "workspace_id", "user", "client_ip", "operation", "http_path", "http_method", "http_status"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccessLogEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccessLogEvent from a dict"""
        if obj is None:
            return None
