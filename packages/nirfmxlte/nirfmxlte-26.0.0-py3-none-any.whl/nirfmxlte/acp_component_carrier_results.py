...
class AcpComponentCarrierResults(object):
    """"""
    ...
    def get_absolute_power(self, selector_string):
        r"""Gets the power measured over the integration bandwidth of the carrier. The carrier power is reported in dBm when you
        ...
        Returns:
            ...
            attr_val (float):
                Returns the power measured over the integration bandwidth of the carrier. The carrier power is reported in dBm when you
                set the :py:attr:`~nirfmxlte.attributes.AttributeID.ACP_POWER_UNITS` attribute to **dBm**, and in dBm/Hz when you set
                the ACP Pwr Units attribute to **dBm/Hz**.
        ...
        try:
            ...
            attr_val, error_code = self._interpreter.get_attribute_f64(
                ...
                attributes.AttributeID.ACP_RESULTS_COMPONENT_CARRIER_ABSOLUTE_POWER.value,
            )
        finally:
    ...
    def get_relative_power(self, selector_string):
        ...
        try:
            ...
            attr_val, error_code = self._interpreter.get_attribute_f64(
                updated_selector_string,
                attributes.AttributeID.ACP_RESULTS_COMPONENT_CARRIER_RELATIVE_POWER.value,
            )
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def fetch_measurement_array(self, selector_string, timeout):
        r"""Returns an array of the absolute and relative powers of the component carriers. The relative power is relative to the
        subblock power.
        ...
        try:
            ...
            absolute_power, relative_power, error_code = (
                self._interpreter.acp_fetch_measurement_array(updated_selector_string, timeout)
            )
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def fetch_measurement(self, selector_string, timeout):
        r"""Fetches the ACP component carrier measurement.
        ...
        try:
            ...
            absolute_power, relative_power, error_code = self._interpreter.acp_fetch_measurement(
