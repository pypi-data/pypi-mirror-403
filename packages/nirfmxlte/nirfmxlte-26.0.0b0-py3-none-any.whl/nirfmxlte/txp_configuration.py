...
class TxpConfiguration(object):
    ...
    def get_measurement_offset(self, selector_string):
        r"""Gets the measurement offset to skip from the start of acquired waveform for TXP measurement. This value is
        ...
        Returns:
            ...
            attr_val (float):
                Specifies the measurement offset to skip from the start of acquired waveform for TXP measurement. This value is
                expressed in seconds.
        ...
        try:
            ...
            attr_val, error_code = self._interpreter.get_attribute_f64(
                updated_selector_string, attributes.AttributeID.TXP_MEASUREMENT_OFFSET.value
            )
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def set_measurement_offset(self, selector_string, value):
        r"""Sets the measurement offset to skip from the start of acquired waveform for TXP measurement. This value is
        expressed in seconds.
        ...
        try:
            ...
            error_code = self._interpreter.set_attribute_f64(
                updated_selector_string, attributes.AttributeID.TXP_MEASUREMENT_OFFSET.value, value
            )
        finally:
            self._session_function_lock.exit_read_lock()
    ...
    def get_measurement_interval(self, selector_string):
        r"""Gets the measurement interval. This value is expressed in seconds.
    ...
    def set_measurement_interval(self, selector_string, value):
        r"""Sets the measurement interval. This value is expressed in seconds.
    ...
    def get_averaging_enabled(self, selector_string):
        r"""Gets whether to enable averaging for TXP measurement.
    ...
    def set_averaging_enabled(self, selector_string, value):
        r"""Sets whether to enable averaging for TXP measurement.
    ...
    def get_number_of_analysis_threads(self, selector_string):
        r"""Gets the maximum number of threads used for parallelism inside TXP measurement.
    ...
    def set_number_of_analysis_threads(self, selector_string, value):
        r"""Sets the maximum number of threads used for parallelism inside TXP measurement.
    ...
    def configure_averaging(self, selector_string, averaging_enabled, averaging_count):
        r"""Configures averaging for the TXP measurement.
    ...
    @_raise_if_disposed
    def configure_measurement_offset_and_interval(
        self, selector_string, measurement_offset, measurement_interval
    ):
        r"""Configures the measurement offset and measurement interval for the transmit power (TXP) measurement.
        ...
        Args:
            ...
            measurement_offset (float):
                This parameter specifies the offset to skip from the start of the acquired waveform for the measurement. The value is
                expressed in seconds.

            measurement_interval (float):
                This parameter specifies the measurement interval. This value is expressed in seconds.
        ...
        try:
            ...
            error_code = self._interpreter.txp_configure_measurement_offset_and_interval(
                updated_selector_string, measurement_offset, measurement_interval
            )
        finally:
            self._session_function_lock.exit_read_lock()
