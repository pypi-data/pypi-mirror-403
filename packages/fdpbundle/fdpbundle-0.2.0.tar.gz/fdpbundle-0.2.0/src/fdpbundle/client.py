...
class BundleClient:
    ...
    def __init__(self, base_url: str, session_cookie: Optional[str] = None):
        ...
        Args:
            ...
            session_cookie: Airflow session cookie value (from Cookie: session=xxx)
        """
        ...
        # Set authentication via Cookie
        if session_cookie:
            self.session.headers["Cookie"] = f"session={session_cookie}"
    ...
    def _request(self, method: str, endpoint: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                data = {"success": False, "error": f"Invalid JSON response: {response.text}"}
