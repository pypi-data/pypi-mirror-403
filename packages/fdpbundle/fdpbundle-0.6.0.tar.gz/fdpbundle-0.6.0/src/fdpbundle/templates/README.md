...
| `SERVICE_ACCOUNT_NAME_DEV` | Service account name DEV |
| `SERVICE_ACCOUNT_NAME_STG` | Service account name Staging |
| `SERVICE_ACCOUNT_NAME_PROD` | Service account name Production |
| `SERVICE_ACCOUNT_TOKEN_DEV` | Service account token DEV |
| `SERVICE_ACCOUNT_TOKEN_STG` | Service account token Staging |
| `SERVICE_ACCOUNT_TOKEN_PROD` | Service account token Production |
