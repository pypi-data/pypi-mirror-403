...
from svision.aircv.error import FileNotExistError
from svision.aircv.utils import cv2_2_pil, compress_image
...
def mask_image(img, mask, color=(255, 255, 255), linewidth=-1):
    ...
    return cv2.rectangle(
        img,
        (mask[0] - offset, mask[1] - offset),
        (mask[2] + linewidth, mask[3] + linewidth),
        color,
        linewidth,
    )
