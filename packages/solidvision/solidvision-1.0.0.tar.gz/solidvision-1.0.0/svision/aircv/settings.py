...
from svision.aircv.resolution import cocos_min_strategy
...
class Settings(object):
    ...
    # 兼容新版 OpenCV (4.4.0+ 没有 __version__ 属性)
    cv_version = getattr(cv2, "__version__", "4.5.0")
    if parse_version("3.4.2") < parse_version(cv_version) < parse_version("4.4.0"):
    ...
    SNAPSHOT_QUALITY = (
        10  # 1-100 https://pillow.readthedocs.io/en/5.1.x/handbook/image-file-formats.html#jpeg
    )
