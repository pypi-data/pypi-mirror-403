...
class QuantGoAPI:
    ...
    def daily_basic(s,ts_code='',trade_date='',start_date='',end_date='',fields=''):return s._req('daily_basic',ts_code=ts_code,trade_date=trade_date,start_date=start_date,end_date=end_date,fields=fields)
