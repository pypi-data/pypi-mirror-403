...
class CubitClient:
    ...
    def get_job(self, soc_code: str) -> JobProfile:
        """
        ...
        """
        response = self._client.get(f"/jobs/{soc_code}")
        return self._handle_response(response)
    ...
    def compare_jobs(self, soc_codes: List[str]) -> JobCompareResponse:
        """
        ...
        response = self._client.get(f"/jobs/compare", params={"socs": socs_str})
        return self._handle_response(response)
