...
class DynamicNestedSampler:
    ...
    def run(self, problem: Problem, initial: typing.Optional[typing.Sequence[builtins.float]] = None) -> NestedSamples: ...
    def init(self, initial: typing.Sequence[builtins.float], bounds: typing.Optional[typing.Sequence[tuple[builtins.float, builtins.float]]] = None) -> DynamicNestedSamplerState:
        r"""
...
class MetropolisHastings:
    ...
    def init(self, initial: typing.Sequence[builtins.float], bounds: typing.Optional[typing.Sequence[tuple[builtins.float, builtins.float]]] = None) -> MetropolisHastingsState:
        r"""
        Initialize ask-tell sampling state.
...
class NestedSamples:
    ...
    """
    @property
    def posterior(self) -> builtins.list[tuple[builtins.list[builtins.float], builtins.float, builtins.float]]: ...
    @property
    ...
    def __iter__(self) -> NestedSamplesIterator:
        ...
        """
    def __getitem__(self, idx: builtins.int) -> tuple[builtins.list[builtins.float], builtins.float, builtins.float]:
        r"""
...
class Samples:
    ...
    def __iter__(self) -> SamplesIterator:
        ...
        """
    def __getitem__(self, idx: builtins.int) -> builtins.list[builtins.list[builtins.float]]:
        r"""
