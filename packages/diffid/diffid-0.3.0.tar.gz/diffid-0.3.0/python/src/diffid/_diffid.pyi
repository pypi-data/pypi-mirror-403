...
class Adam:
    ...
    def run(self, problem: Problem, initial: typing.Sequence[builtins.float]) -> OptimisationResults:
        ...
        """
    def init(self, initial: typing.Sequence[builtins.float], bounds: typing.Optional[typing.Sequence[tuple[builtins.float, builtins.float]]] = None) -> AdamState:
        r"""
...
class AdamState:
    ...
    def ask(self) -> typing.Any:
        ...
        """
    def tell(self, result: tuple[builtins.float, typing.Sequence[builtins.float]]) -> None:
        r"""
    ...
    def evaluations(self) -> builtins.int:
        ...
        """
    def best(self) -> typing.Optional[tuple[builtins.list[builtins.float], builtins.float]]:
        r"""
...
class CMAES:
    ...
    def run(self, problem: Problem, initial: typing.Sequence[builtins.float]) -> OptimisationResults:
        ...
        """
    def init(self, initial: typing.Sequence[builtins.float], bounds: typing.Optional[typing.Sequence[tuple[builtins.float, builtins.float]]] = None) -> CMAESState:
        r"""
        Initialize ask-tell optimisation state.
...
class DiffsolBuilder:
    ...
    def with_backend(self, backend: builtins.str) -> DiffsolBuilder:
        ...
        """
    def with_parallel(self, parallel: typing.Optional[builtins.bool] = None) -> DiffsolBuilder:
        r"""
    ...
    def with_tolerances(self, rtol: builtins.float, atol: builtins.float) -> DiffsolBuilder:
        r"""
...
class Evaluate:
    ...
    def __new__(cls, points: typing.Sequence[typing.Sequence[builtins.float]]) -> Evaluate: ...
    def __repr__(self) -> builtins.str: ...
    def __str__(self) -> builtins.str: ...
...
class NelderMead:
    ...
    def run(self, problem: Problem, initial: typing.Sequence[builtins.float]) -> OptimisationResults:
        ...
        """
    def init(self, initial: typing.Sequence[builtins.float], bounds: typing.Optional[typing.Sequence[tuple[builtins.float, builtins.float]]] = None) -> NelderMeadState:
        r"""
        Initialize ask-tell optimisation state.
...
class NestedSamplesIterator:
    ...
    def __next__(self) -> typing.Optional[tuple[builtins.list[builtins.float], builtins.float, builtins.float]]: ...
...
class Problem:
    ...
    def evaluate_gradient(self, x: typing.Sequence[builtins.float]) -> typing.Optional[builtins.list[builtins.float]]:
        ...
        """
    def optimise(self, initial: typing.Optional[typing.Sequence[builtins.float]] = None, optimiser: typing.Optional[NelderMead | CMAES | Adam] = None) -> OptimisationResults:
        r"""
        Solve the problem starting from `initial` using the supplied optimiser.
        """
    def sample(self, initial: typing.Optional[typing.Sequence[builtins.float]] = None, sampler: typing.Optional[MetropolisHastings | DynamicNestedSampler] = None) -> typing.Any:
        r"""
...
class SamplesIterator:
    ...
    def __next__(self) -> typing.Optional[builtins.list[builtins.list[builtins.float]]]: ...
...
class ScalarBuilder:
    ...
    def with_gradient(self, obj: typing.Any) -> ScalarBuilder:
        ...
        """
    def with_parameter(self, name: builtins.str, initial_value: builtins.float, bounds: typing.Optional[tuple[builtins.float, builtins.float]] = None) -> ScalarBuilder:
        r"""
        Register a named optimisation variable in the order it appears in vectors.
        """
    def build(self) -> Problem:
...
class VectorBuilder:
    ...
    def with_data(self, data: numpy.typing.NDArray[numpy.float64]) -> VectorBuilder:
        ...
        """
    def with_parameter(self, name: builtins.str, initial_value: builtins.float, bounds: typing.Optional[tuple[builtins.float, builtins.float]] = None) -> VectorBuilder:
        r"""
        Register a named optimisation variable in the order it appears in vectors.
        """
...
def GaussianNLL(variance: builtins.float, weight: builtins.float = 1.0) -> CostMetric: ...
