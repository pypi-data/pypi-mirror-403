...
class EndfieldClient:
    ...
    def __init__(self, cookie: str, user_agent: Optional[str] = None, token: Optional[str] = None):
        """
    ...
    def _parse_response(self, data: dict, status_code: int = 200) -> SignInResult:
        ...
        elif code == 1001 or "already" in message.lower() or "do not sign in again" in message.lower() or status_code == 403:
            return SignInResult(
                success=True,
