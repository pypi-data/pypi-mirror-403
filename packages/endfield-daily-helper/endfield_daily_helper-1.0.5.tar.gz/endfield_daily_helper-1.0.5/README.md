...
4. **Reload the page** (F5) with DevTools open so the cookies appear
5. In the left sidebar, expand **Cookies** → click `.skport.com`
6. Find the cookie named `ACCOUNT_TOKEN` and copy its **Value**
