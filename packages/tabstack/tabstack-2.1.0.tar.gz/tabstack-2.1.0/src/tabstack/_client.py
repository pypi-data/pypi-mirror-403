...
from ._exceptions import TabstackError, APIStatusError
...
class Tabstack(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Tabstack client instance.

        This automatically infers the `api_key` argument from the `TABSTACK_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("TABSTACK_API_KEY")
        if api_key is None:
            raise TabstackError(
                "The api_key client option must be set either by passing api_key to the client or by setting the TABSTACK_API_KEY environment variable"
            )
        self.api_key = api_key

        if base_url is None:
            base_url = os.environ.get("TABSTACK_BASE_URL")
        if base_url is None:
    ...
    @cached_property
    def with_raw_response(self) -> TabstackWithRawResponse:
        return TabstackWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> TabstackWithStreamedResponse:
        return TabstackWithStreamedResponse(self)
...
class AsyncTabstack(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncTabstack client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncTabstackWithRawResponse:
        return AsyncTabstackWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncTabstackWithStreamedResponse:
        return AsyncTabstackWithStreamedResponse(self)
...
class TabstackWithRawResponse:
    _client: Tabstack

    def __init__(self, client: Tabstack) -> None:
        self._client = client
...
class AsyncTabstackWithRawResponse:
    _client: AsyncTabstack

    def __init__(self, client: AsyncTabstack) -> None:
        self._client = client
...
class TabstackWithStreamedResponse:
    _client: Tabstack
...
class AsyncTabstackWithStreamedResponse:
    _client: AsyncTabstack
