...
public class PythonFlaskRestServerCodegenTest {
    ...
    public PythonFlaskRestServerCodegenTest(String filePath, String yamlName) {
    ...
    public void generateCodegen() throws IOException {
        ...
        final CodegenConfigurator configurator = new CodegenConfigurator()
                .setGeneratorName("python-flask-rest-server-codegen")
