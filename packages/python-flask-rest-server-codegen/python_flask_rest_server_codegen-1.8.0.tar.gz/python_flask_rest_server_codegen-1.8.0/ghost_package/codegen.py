...
def get_codegen_path():
    return pkg_resources.path(__package__, "python-flask-rest-server-codegen.jar")
...
def execute_provider_codegen(openapi_codegen_java_classpath, codegen_name,
  ...
  properties = [
    "--package-name", package_name,
     "--model-package", api_name + '.models',
     "--api-package", api_name + '.controllers',  # api-package is used by client codegen
  ]
