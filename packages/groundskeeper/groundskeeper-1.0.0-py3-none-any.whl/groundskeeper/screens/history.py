...
class HistoryScreen(ModalScreen[None]):
    ...
    HistoryScreen .title { dock: top; height: 1; color: #666666; }
    HistoryScreen TextArea { height: 1fr; background: #1a1a1a; }
    HistoryScreen .hint { dock: bottom; height: 1; color: #666666; }
    """

    def __init__(self, content: str) -> None:
        super().__init__()
        self._content = content if content else "No history yet."
