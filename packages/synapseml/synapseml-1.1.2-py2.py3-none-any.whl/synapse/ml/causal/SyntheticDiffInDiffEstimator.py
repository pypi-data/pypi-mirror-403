...
@inherit_doc
class SyntheticDiffInDiffEstimator(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaEstimator):
    """
    Args:
    ...
    zeta = Param(Params._dummy(), "zeta", "The zeta value for regularization term when fitting unit weights. If not specified, a default value will be computed based on formula (2.2) specified in https://www.nber.org/system/files/working_papers/w25532/w25532.pdf. For large scale data, one may want to tune the zeta value, minimizing the loss of the unit weights regression.", typeConverter=TypeConverters.toFloat)
    ...
    def __init__(
        ...
        super(SyntheticDiffInDiffEstimator, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.causal.SyntheticDiffInDiffEstimator", self.uid)
        else:
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.causal.SyntheticDiffInDiffEstimator"

    @staticmethod
    def _from_java(java_stage):
        module_name=SyntheticDiffInDiffEstimator.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".SyntheticDiffInDiffEstimator"
    ...
    def getZeta(self):
        ...
        Returns:
            zeta: The zeta value for regularization term when fitting unit weights. If not specified, a default value will be computed based on formula (2.2) specified in https://www.nber.org/system/files/working_papers/w25532/w25532.pdf. For large scale data, one may want to tune the zeta value, minimizing the loss of the unit weights regression.
        """
        return self.getOrDefault(self.zeta)
