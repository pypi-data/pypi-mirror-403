...
class _DoubleMLModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaModel):
    ...
    rawTreatmentEffects = Param(Params._dummy(), "rawTreatmentEffects", "raw treatment effect results for all iterations", typeConverter=TypeConverters.toListFloat)
    ...
    def __init__(
        ...
        outcomeModel=None,
        parallelism=10,
        rawTreatmentEffects=None,
        sampleSplitRatio=[0.5,0.5],
        treatmentCol=None,
        treatmentModel=None,
        weightCol=None
        ):
        super(_DoubleMLModel, self).__init__()
        if java_obj is None:
            self._java_obj = self._new_java_obj("com.microsoft.azure.synapse.ml.causal.DoubleMLModel", self.uid)
        else:
    ...
    def getJavaPackage():
        ...
        return "com.microsoft.azure.synapse.ml.causal.DoubleMLModel"

    @staticmethod
    def _from_java(java_stage):
        module_name=_DoubleMLModel.__module__
        module_name=module_name.rsplit(".", 1)[0] + ".DoubleMLModel"
    ...
    def setRawTreatmentEffects(self, value):
        ...
        """
        self._set(rawTreatmentEffects=value)
        return self
    ...
    def getRawTreatmentEffects(self):
        ...
        Returns:
            rawTreatmentEffects: raw treatment effect results for all iterations
        """
        return self.getOrDefault(self.rawTreatmentEffects)
