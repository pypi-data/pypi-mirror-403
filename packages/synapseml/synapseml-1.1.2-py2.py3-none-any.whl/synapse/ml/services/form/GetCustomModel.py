...
class GetCustomModel(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GetCustomModel_b99d589ffe69_error",
        handler=None,
        includeKeys=None,
        includeKeysCol=None,
        modelId=None,
        modelIdCol=None,
        outputCol="GetCustomModel_b99d589ffe69_output",
        ...
        self._setDefault(errorCol="GetCustomModel_b99d589ffe69_error")
        self._setDefault(outputCol="GetCustomModel_b99d589ffe69_output")
