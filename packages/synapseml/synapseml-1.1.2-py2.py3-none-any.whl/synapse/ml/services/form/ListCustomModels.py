...
class ListCustomModels(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="ListCustomModels_b1268ec9f8a8_error",
        handler=None,
        op=None,
        opCol=None,
        outputCol="ListCustomModels_b1268ec9f8a8_output",
        ...
        self._setDefault(errorCol="ListCustomModels_b1268ec9f8a8_error")
        self._setDefault(outputCol="ListCustomModels_b1268ec9f8a8_output")
