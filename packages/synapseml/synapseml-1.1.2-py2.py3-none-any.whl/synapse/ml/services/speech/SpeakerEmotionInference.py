...
class SpeakerEmotionInference(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="SpeakerEmotionInference_e076716821cb_error",
        handler=None,
        locale=None,
        localeCol=None,
        outputCol="SpeakerEmotionInference_e076716821cb_output",
        ...
        self._setDefault(errorCol="SpeakerEmotionInference_e076716821cb_error")
        self._setDefault(outputCol="SpeakerEmotionInference_e076716821cb_output")
