...
class OpenAIPrompt(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    Args:
        ...
        apiType (str): The OpenAI API type to use: 'chat_completions' or 'responses'
        ...
        columnTypes (dict): A map from column names to their types. Supported types are 'text' and 'path'.
        ...
        fileSizeLimitMB (object): Maximum file size in megabytes for path columns. Files exceeding this limit will produce an error.
        ...
        previousResponseId (object): The ID of a previous response to use as context for chaining requests. Use this for multi-turn conversations or follow-up requests. Only applicable when using the 'responses' API type.
        ...
        responseFormat (object): Response format for the completion. One of 'text', 'json_object', or 'json_schema'.
        responseIdCol (str): Column to hold response ID when store=true. Auto-generated if not explicitly set.
        ...
        store (object): Whether to store the generated model response for later retrieval via API. Only applicable when using the 'responses' API type.
    ...
    apiType = Param(Params._dummy(), "apiType", "The OpenAI API type to use: 'chat_completions' or 'responses'", typeConverter=TypeConverters.toString)
    ...
    columnTypes = Param(Params._dummy(), "columnTypes", "A map from column names to their types. Supported types are 'text' and 'path'.")
    ...
    fileSizeLimitMB = Param(Params._dummy(), "fileSizeLimitMB", "Maximum file size in megabytes for path columns. Files exceeding this limit will produce an error.")
    ...
    previousResponseId = Param(Params._dummy(), "previousResponseId", "ServiceParam: The ID of a previous response to use as context for chaining requests. Use this for multi-turn conversations or follow-up requests. Only applicable when using the 'responses' API type.")
    ...
    responseFormat = Param(Params._dummy(), "responseFormat", "ServiceParam: Response format for the completion. One of 'text', 'json_object', or 'json_schema'.")
    
    responseIdCol = Param(Params._dummy(), "responseIdCol", "Column to hold response ID when store=true. Auto-generated if not explicitly set.", typeConverter=TypeConverters.toString)
    ...
    store = Param(Params._dummy(), "store", "ServiceParam: Whether to store the generated model response for later retrieval via API. Only applicable when using the 'responses' API type.")
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIPrompt_0c1c62cf0897_error",
        fileSizeLimitMB=None,
        ...
        maxTokens=None,
        maxTokensCol=None,
        messagesCol="OpenAIPrompt_0c1c62cf0897_messages",
        model=None,
        modelCol=None,
        n=None,
        nCol=None,
        outputCol="OpenAIPrompt_0c1c62cf0897_output",
        postProcessing="",
        ...
        responseIdCol="OpenAIPrompt_0c1c62cf0897_responseId",
        seed=None,
        seedCol=None,
        stop=None,
        stopCol=None,
        ...
        self._setDefault(apiType="chat_completions")
        self._setDefault(columnTypes={})
        self._setDefault(concurrency=1)
        self._setDefault(dropPrompt=True)
        self._setDefault(errorCol="OpenAIPrompt_0c1c62cf0897_error")
        self._setDefault(messagesCol="OpenAIPrompt_0c1c62cf0897_messages")
        self._setDefault(outputCol="OpenAIPrompt_0c1c62cf0897_output")
        self._setDefault(postProcessing="")
        self._setDefault(postProcessingOptions={})
        self._setDefault(responseIdCol="OpenAIPrompt_0c1c62cf0897_responseId")
    ...
    def setApiType(self, value):
        """
        Args:
            apiType: The OpenAI API type to use: 'chat_completions' or 'responses'
        """
        self._set(apiType=value)
        return self
    ...
    def setColumnTypes(self, value):
        """
        Args:
            columnTypes: A map from column names to their types. Supported types are 'text' and 'path'.
        """
        self._set(columnTypes=value)
        return self
    ...
    def setFileSizeLimitMB(self, value):
        """
        Args:
            fileSizeLimitMB: Maximum file size in megabytes for path columns. Files exceeding this limit will produce an error.
        """
        self._set(fileSizeLimitMB=value)
        return self
    ...
    def setPreviousResponseId(self, value):
        """
        Args:
            previousResponseId: The ID of a previous response to use as context for chaining requests. Use this for multi-turn conversations or follow-up requests. Only applicable when using the 'responses' API type.
        """
        if isinstance(value, list):
            value = SparkContext._active_spark_context._jvm.com.microsoft.azure.synapse.ml.param.ServiceParam.toSeq(value)
        elif isinstance(value, dict):
    ...
    def setResponseFormat(self, value):
        """
        Args:
            responseFormat: Response format for the completion. One of 'text', 'json_object', or 'json_schema'.
        """
        if isinstance(value, list):
            value = SparkContext._active_spark_context._jvm.com.microsoft.azure.synapse.ml.param.ServiceParam.toSeq(value)
        elif isinstance(value, dict):
    ...
    def setResponseIdCol(self, value):
        """
        Args:
            responseIdCol: Column to hold response ID when store=true. Auto-generated if not explicitly set.
        """
        self._set(responseIdCol=value)
        return self
    ...
    def setStore(self, value):
        """
        Args:
            store: Whether to store the generated model response for later retrieval via API. Only applicable when using the 'responses' API type.
        """
        if isinstance(value, list):
            value = SparkContext._active_spark_context._jvm.com.microsoft.azure.synapse.ml.param.ServiceParam.toSeq(value)
        elif isinstance(value, dict):
    ...
    def getApiType(self):
        ...
        Returns:
            apiType: The OpenAI API type to use: 'chat_completions' or 'responses'
        """
        return self.getOrDefault(self.apiType)
    ...
    def getColumnTypes(self):
        ...
        Returns:
            columnTypes: A map from column names to their types. Supported types are 'text' and 'path'.
        """
        return self.getOrDefault(self.columnTypes)
    ...
    def getFileSizeLimitMB(self):
        """
        Returns:
            fileSizeLimitMB: Maximum file size in megabytes for path columns. Files exceeding this limit will produce an error.
        """
        return self.getOrDefault(self.fileSizeLimitMB)
    ...
    def getResponseIdCol(self):
        """
        Returns:
            responseIdCol: Column to hold response ID when store=true. Auto-generated if not explicitly set.
        """
        return self.getOrDefault(self.responseIdCol)
