...
class DictionaryExamples(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="DictionaryExamples_ca4811174835_error",
        fromLanguage=None,
        fromLanguageCol=None,
        handler=None,
        outputCol="DictionaryExamples_ca4811174835_output",
        ...
        self._setDefault(errorCol="DictionaryExamples_ca4811174835_error")
        self._setDefault(outputCol="DictionaryExamples_ca4811174835_output")
