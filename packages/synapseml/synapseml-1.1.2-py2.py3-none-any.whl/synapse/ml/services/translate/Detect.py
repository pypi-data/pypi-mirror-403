...
class Detect(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Detect_e8d3e0f627cc_error",
        handler=None,
        outputCol="Detect_e8d3e0f627cc_output",
        ...
        self._setDefault(errorCol="Detect_e8d3e0f627cc_error")
        self._setDefault(outputCol="Detect_e8d3e0f627cc_output")
