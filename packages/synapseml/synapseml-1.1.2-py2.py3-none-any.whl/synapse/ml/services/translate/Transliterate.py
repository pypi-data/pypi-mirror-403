...
class Transliterate(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="Transliterate_ff08b056851b_error",
        fromScript=None,
        fromScriptCol=None,
        handler=None,
        language=None,
        languageCol=None,
        outputCol="Transliterate_ff08b056851b_output",
        ...
        self._setDefault(errorCol="Transliterate_ff08b056851b_error")
        self._setDefault(outputCol="Transliterate_ff08b056851b_output")
