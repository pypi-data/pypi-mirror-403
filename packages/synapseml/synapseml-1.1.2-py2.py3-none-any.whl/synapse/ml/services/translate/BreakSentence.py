...
class BreakSentence(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="BreakSentence_eff104334902_error",
        handler=None,
        language=None,
        languageCol=None,
        outputCol="BreakSentence_eff104334902_output",
        script=None,
        scriptCol=None,
        ...
        self._setDefault(errorCol="BreakSentence_eff104334902_error")
        self._setDefault(outputCol="BreakSentence_eff104334902_output")
