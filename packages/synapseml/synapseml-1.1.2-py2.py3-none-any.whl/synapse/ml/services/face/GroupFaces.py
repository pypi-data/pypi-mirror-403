...
class GroupFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="GroupFaces_09ad8fd2150e_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        outputCol="GroupFaces_09ad8fd2150e_output",
        ...
        self._setDefault(errorCol="GroupFaces_09ad8fd2150e_error")
        self._setDefault(outputCol="GroupFaces_09ad8fd2150e_output")
