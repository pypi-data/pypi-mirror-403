...
class IdentifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="IdentifyFaces_a34526700768_error",
        faceIds=None,
        faceIdsCol=None,
        handler=None,
        ...
        outputCol="IdentifyFaces_a34526700768_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="IdentifyFaces_a34526700768_error")
        self._setDefault(outputCol="IdentifyFaces_a34526700768_output")
