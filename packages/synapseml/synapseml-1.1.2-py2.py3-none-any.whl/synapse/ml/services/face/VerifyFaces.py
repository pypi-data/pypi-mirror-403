...
class VerifyFaces(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="VerifyFaces_b6a5ee19231b_error",
        faceId=None,
        faceIdCol=None,
        faceId1=None,
        faceId1Col=None,
        ...
        outputCol="VerifyFaces_b6a5ee19231b_output",
        personGroupId=None,
        ...
        self._setDefault(errorCol="VerifyFaces_b6a5ee19231b_error")
        self._setDefault(outputCol="VerifyFaces_b6a5ee19231b_output")
