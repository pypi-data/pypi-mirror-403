...
class AnalyzeImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        details=None,
        detailsCol=None,
        errorCol="AnalyzeImage_b561e12e3571_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="AnalyzeImage_b561e12e3571_output",
        ...
        self._setDefault(errorCol="AnalyzeImage_b561e12e3571_error")
        self._setDefault(outputCol="AnalyzeImage_b561e12e3571_output")
