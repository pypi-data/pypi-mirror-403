...
class OCR(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        errorCol="OCR_de72693b1102_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="OCR_de72693b1102_output",
        ...
        self._setDefault(errorCol="OCR_de72693b1102_error")
        self._setDefault(outputCol="OCR_de72693b1102_output")
