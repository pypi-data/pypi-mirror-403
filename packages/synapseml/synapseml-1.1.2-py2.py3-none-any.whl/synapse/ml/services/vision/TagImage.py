...
class TagImage(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        customUrlRoot=None,
        errorCol="TagImage_5ec21b1f18c4_error",
        handler=None,
        imageBytes=None,
        imageBytesCol=None,
        imageUrl=None,
        ...
        language=None,
        languageCol=None,
        outputCol="TagImage_5ec21b1f18c4_output",
        ...
        self._setDefault(errorCol="TagImage_5ec21b1f18c4_error")
        self._setDefault(outputCol="TagImage_5ec21b1f18c4_output")
