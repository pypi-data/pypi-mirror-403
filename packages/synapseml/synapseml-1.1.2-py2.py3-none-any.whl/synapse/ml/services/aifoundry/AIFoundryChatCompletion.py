...
class AIFoundryChatCompletion(ComplexParamsMixin, JavaMLReadable, JavaMLWritable, JavaTransformer):
    ...
    def __init__(
        ...
        echo=None,
        echoCol=None,
        errorCol="OpenAIChatCompletion_e944050f4d41_error",
        ...
        n=None,
        nCol=None,
        outputCol="OpenAIChatCompletion_e944050f4d41_output",
        ...
        self._setDefault(errorCol="OpenAIChatCompletion_e944050f4d41_error")
        self._setDefault(outputCol="OpenAIChatCompletion_e944050f4d41_output")
