...
if TYPE_CHECKING:
    from ..models.derive_query_params import DeriveQueryParams


T = TypeVar("T", bound="DeriveRequest")


@_attrs_define
class DeriveRequest:
    """Request to derive new columns using pandas eval expressions.

    Each expression creates a new column from existing data.

        Attributes:
            query (DeriveQueryParams):
            ...
            twin_artifact_id (None | Unset | UUID): The ID of a reference artifact, e.g. the right table in Deep Merge
                operation.
            task_type (Literal['derive'] | Unset):  Default: 'derive'.
    ...
    task_type: Literal["derive"] | Unset = "derive"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        query = DeriveQueryParams.from_dict(d.pop("query"))
        ...
        task_type = cast(Literal["derive"] | Unset, d.pop("task_type", UNSET))
        if task_type != "derive" and not isinstance(task_type, Unset):
            raise ValueError(f"task_type must match const 'derive', got '{task_type}'")
        ...
        derive_request.additional_properties = d
