...
if TYPE_CHECKING:
    from ..models.create_group_query_params import CreateGroupQueryParams
...
class CreateGroupRequest:
    """Request to create a group artifact from a list of data items.

    Attributes:
        query (CreateGroupQueryParams):
        ...
        twin_artifact_id (None | Unset | UUID): The ID of a reference artifact, e.g. the right table in Deep Merge
            operation.
        task_type (Literal['create_group'] | Unset):  Default: 'create_group'.
    ...
    task_type: Literal["create_group"] | Unset = "create_group"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        query = CreateGroupQueryParams.from_dict(d.pop("query"))
        ...
        task_type = cast(Literal["create_group"] | Unset, d.pop("task_type", UNSET))
        if task_type != "create_group" and not isinstance(task_type, Unset):
            raise ValueError(f"task_type must match const 'create_group', got '{task_type}'")
