...
T = TypeVar("T", bound="MapMultiAgentRequestParams")


@_attrs_define
class MapMultiAgentRequestParams:
    """
    Attributes:
        ...
        join_with_input (bool | Unset):  Default: False.
    """
    ...
    join_with_input: bool | Unset = False
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        map_multi_agent_request_params = cls(
            query=query,
        ...
        map_multi_agent_request_params.additional_properties = d
        return map_multi_agent_request_params
