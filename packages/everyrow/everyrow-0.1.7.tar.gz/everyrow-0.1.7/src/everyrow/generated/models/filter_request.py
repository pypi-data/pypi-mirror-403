...
if TYPE_CHECKING:
    from ..models.filter_query_params import FilterQueryParams
...
@_attrs_define
class FilterRequest:
    """Request to filter a group of artifacts based on a field.
    ...
    Attributes:
        ...
        twin_artifact_id (None | Unset | UUID): The ID of a reference artifact, e.g. the right table in Deep Merge
            operation.
        task_type (Literal['filter'] | Unset):  Default: 'filter'.
    ...
    task_type: Literal["filter"] | Unset = "filter"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        query = FilterQueryParams.from_dict(d.pop("query"))
        ...
        task_type = cast(Literal["filter"] | Unset, d.pop("task_type", UNSET))
        if task_type != "filter" and not isinstance(task_type, Unset):
            raise ValueError(f"task_type must match const 'filter', got '{task_type}'")
        ...
        filter_request.additional_properties = d
