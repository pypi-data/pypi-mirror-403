...
if TYPE_CHECKING:
    from ..models.drop_columns_query_params import DropColumnsQueryParams


T = TypeVar("T", bound="DropColumnsRequest")


@_attrs_define
class DropColumnsRequest:
    """Request to drop specific columns from each row in a group artifact.

    Attributes:
        query (DropColumnsQueryParams):
        ...
        twin_artifact_id (None | Unset | UUID): The ID of a reference artifact, e.g. the right table in Deep Merge
            operation.
        task_type (Literal['drop_columns'] | Unset):  Default: 'drop_columns'.
    ...
    task_type: Literal["drop_columns"] | Unset = "drop_columns"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        query = DropColumnsQueryParams.from_dict(d.pop("query"))
        ...
        task_type = cast(Literal["drop_columns"] | Unset, d.pop("task_type", UNSET))
        if task_type != "drop_columns" and not isinstance(task_type, Unset):
            raise ValueError(f"task_type must match const 'drop_columns', got '{task_type}'")
        ...
        drop_columns_request.additional_properties = d
        return drop_columns_request
