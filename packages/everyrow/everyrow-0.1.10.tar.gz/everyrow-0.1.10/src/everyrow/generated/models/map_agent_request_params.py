...
T = TypeVar("T", bound="MapAgentRequestParams")


@_attrs_define
class MapAgentRequestParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        map_agent_request_params.additional_properties = d
        return map_agent_request_params
