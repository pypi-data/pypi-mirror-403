...
if TYPE_CHECKING:
    from ..models.group_by_query_params import GroupByQueryParams


T = TypeVar("T", bound="GroupByRequest")


@_attrs_define
class GroupByRequest:
    """Request to group artifacts by specified field values into a hierarchical structure.

    Attributes:
        query (GroupByQueryParams): Parameters for grouping artifacts by specified fields.
        ...
        twin_artifact_id (None | Unset | UUID): The ID of a reference artifact, e.g. the right table in Deep Merge
            operation.
        task_type (Literal['group_by'] | Unset):  Default: 'group_by'.
        processing_mode (Literal['transform'] | Unset):  Default: 'transform'.
    """

    query: GroupByQueryParams
    ...
    task_type: Literal["group_by"] | Unset = "group_by"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        query = GroupByQueryParams.from_dict(d.pop("query"))
        ...
        task_type = cast(Literal["group_by"] | Unset, d.pop("task_type", UNSET))
        if task_type != "group_by" and not isinstance(task_type, Unset):
            raise ValueError(f"task_type must match const 'group_by', got '{task_type}'")
        ...
        group_by_request.additional_properties = d
        return group_by_request
