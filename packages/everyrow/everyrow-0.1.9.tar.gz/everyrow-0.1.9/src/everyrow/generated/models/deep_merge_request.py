...
if TYPE_CHECKING:
    from ..models.deep_merge_public_params import DeepMergePublicParams


T = TypeVar("T", bound="DeepMergeRequest")


@_attrs_define
class DeepMergeRequest:
    """
    Attributes:
        ...
        twin_artifact_id (None | Unset | UUID): The ID of a reference artifact, e.g. the right table in Deep Merge
            operation.
        task_type (Literal['deep_merge'] | Unset):  Default: 'deep_merge'.
    ...
    task_type: Literal["deep_merge"] | Unset = "deep_merge"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        query = DeepMergePublicParams.from_dict(d.pop("query"))
        ...
        task_type = cast(Literal["deep_merge"] | Unset, d.pop("task_type", UNSET))
        if task_type != "deep_merge" and not isinstance(task_type, Unset):
            raise ValueError(f"task_type must match const 'deep_merge', got '{task_type}'")
        ...
        deep_merge_request.additional_properties = d
        return deep_merge_request
