...
if TYPE_CHECKING:
    from ..models.create_query_params import CreateQueryParams
...
@_attrs_define
class CreateRequest:
    """Request to create a standalone artifact from provided data.
    ...
    Attributes:
        ...
        twin_artifact_id (None | Unset | UUID): The ID of a reference artifact, e.g. the right table in Deep Merge
            operation.
        task_type (Literal['create'] | Unset):  Default: 'create'.
    ...
    task_type: Literal["create"] | Unset = "create"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        query = CreateQueryParams.from_dict(d.pop("query"))
        ...
        task_type = cast(Literal["create"] | Unset, d.pop("task_type", UNSET))
        if task_type != "create" and not isinstance(task_type, Unset):
            raise ValueError(f"task_type must match const 'create', got '{task_type}'")
