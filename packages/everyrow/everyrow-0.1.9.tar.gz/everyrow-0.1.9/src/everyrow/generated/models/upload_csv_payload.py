...
if TYPE_CHECKING:
    from ..models.upload_csv_query_params import UploadCsvQueryParams


T = TypeVar("T", bound="UploadCsvPayload")


@_attrs_define
class UploadCsvPayload:
    """
    Attributes:
        query (UploadCsvQueryParams):
        ...
        task_type (Literal['upload_csv'] | Unset):  Default: 'upload_csv'.
    """
    ...
    task_type: Literal["upload_csv"] | Unset = "upload_csv"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        query = UploadCsvQueryParams.from_dict(d.pop("query"))
        ...
        task_type = cast(Literal["upload_csv"] | Unset, d.pop("task_type", UNSET))
        if task_type != "upload_csv" and not isinstance(task_type, Unset):
            raise ValueError(f"task_type must match const 'upload_csv', got '{task_type}'")

        upload_csv_payload = cls(
            query=query,
        ...
        upload_csv_payload.additional_properties = d
        return upload_csv_payload
