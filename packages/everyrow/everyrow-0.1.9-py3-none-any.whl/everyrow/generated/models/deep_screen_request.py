...
if TYPE_CHECKING:
    from ..models.deep_screen_public_params import DeepScreenPublicParams


T = TypeVar("T", bound="DeepScreenRequest")


@_attrs_define
class DeepScreenRequest:
    """
    Attributes:
        ...
        twin_artifact_id (None | Unset | UUID): The ID of a reference artifact, e.g. the right table in Deep Merge
            operation.
        task_type (Literal['deep_screen'] | Unset):  Default: 'deep_screen'.
    ...
    task_type: Literal["deep_screen"] | Unset = "deep_screen"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        query = DeepScreenPublicParams.from_dict(d.pop("query"))
        ...
        task_type = cast(Literal["deep_screen"] | Unset, d.pop("task_type", UNSET))
        if task_type != "deep_screen" and not isinstance(task_type, Unset):
            raise ValueError(f"task_type must match const 'deep_screen', got '{task_type}'")
        ...
        deep_screen_request.additional_properties = d
        return deep_screen_request
