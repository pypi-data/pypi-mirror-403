...
T = TypeVar("T", bound="ReduceAgentRequestParams")


@_attrs_define
class ReduceAgentRequestParams:
    ...
    Attributes:
        ...
        twin_artifact_id (None | Unset | UUID): The ID of a reference artifact, e.g. the right table in Deep Merge
            operation.
        task_type (Literal['agent'] | Unset):  Default: 'agent'.
    ...
    task_type: Literal["agent"] | Unset = "agent"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        task_type = cast(Literal["agent"] | Unset, d.pop("task_type", UNSET))
        if task_type != "agent" and not isinstance(task_type, Unset):
            raise ValueError(f"task_type must match const 'agent', got '{task_type}'")
        ...
        reduce_agent_request_params = cls(
            query=query,
        ...
        reduce_agent_request_params.additional_properties = d
        return reduce_agent_request_params
