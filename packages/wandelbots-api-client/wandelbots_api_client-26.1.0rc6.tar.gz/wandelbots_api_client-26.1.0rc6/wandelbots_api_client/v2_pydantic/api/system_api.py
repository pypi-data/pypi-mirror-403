...
class SystemApi:
    ...
    async def restore_configuration(
        ...
        resources: Annotated[Optional[List[StrictStr]], Field(description="List of resource identifiers to restore. If empty, all resources from the backup will be restored.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
