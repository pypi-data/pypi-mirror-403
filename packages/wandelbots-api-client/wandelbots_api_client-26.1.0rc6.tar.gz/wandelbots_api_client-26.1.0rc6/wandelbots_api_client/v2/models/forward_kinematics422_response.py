...
class ForwardKinematics422Response(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ForwardKinematics422Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ForwardKinematics422Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "detail": [
                ...
                ForwardKinematicsValidationError.from_dict(_item) if hasattr(ForwardKinematicsValidationError, 'from_dict') else _item
                # <<< End modification
