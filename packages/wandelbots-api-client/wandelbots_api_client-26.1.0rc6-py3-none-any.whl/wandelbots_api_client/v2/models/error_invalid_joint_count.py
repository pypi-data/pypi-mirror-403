...
class ErrorInvalidJointCount(BaseModel):
    ...
    def error_feedback_name_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['ErrorInvalidJointCount']):
            raise ValueError("must be one of enum values ('ErrorInvalidJointCount')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ErrorInvalidJointCount from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ErrorInvalidJointCount from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "expected_joint_count": obj.get("expected_joint_count"),
            "provided_joint_count": obj.get("provided_joint_count"),
