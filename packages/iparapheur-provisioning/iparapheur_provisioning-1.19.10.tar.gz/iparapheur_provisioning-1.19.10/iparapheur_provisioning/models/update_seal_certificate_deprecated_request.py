...
class UpdateSealCertificateDeprecatedRequest(BaseModel):
    """
    UpdateSealCertificateDeprecatedRequest
    """ # noqa: E501
    seal_certificate: SealCertificateDto = Field(alias="sealCertificate")
    certificate_file: Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]] = Field(default=None, description="Certificate file", alias="certificateFile")
    image_file: Optional[Union[StrictBytes, StrictStr, Tuple[StrictStr, StrictBytes]]] = Field(default=None, description="Image file", alias="imageFile")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateSealCertificateDeprecatedRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateSealCertificateDeprecatedRequest from a dict"""
        if obj is None:
            return None
