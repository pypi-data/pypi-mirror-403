...
class WorkflowDefinitionRepresentation(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "key", "name", "version"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowDefinitionRepresentation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowDefinitionRepresentation from a dict"""
        if obj is None:
            return None
