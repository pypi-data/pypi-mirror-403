...
class PageSecureMailServerRepresentation(BaseModel):
    """
    ...
    content: Optional[List[SecureMailServerRepresentation]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageSecureMailServerRepresentation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageSecureMailServerRepresentation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "content": [SecureMailServerRepresentation.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
