...
*AdminSecureMailApi* | [**create_server**](docs/AdminSecureMailApi.md#create_server) | **POST** /api/provisioning/v1/admin/tenant/{tenantId}/secure-mail-server | Create a secure mail server
*AdminSecureMailApi* | [**delete_server**](docs/AdminSecureMailApi.md#delete_server) | **DELETE** /api/provisioning/v1/admin/tenant/{tenantId}/secure-mail-server/{serverId} | Delete a secure mail server
*AdminSecureMailApi* | [**get_server**](docs/AdminSecureMailApi.md#get_server) | **GET** /api/provisioning/v1/admin/tenant/{tenantId}/secure-mail-server/{serverId} | Get a secure mail server
*AdminSecureMailApi* | [**list_servers**](docs/AdminSecureMailApi.md#list_servers) | **GET** /api/provisioning/v1/admin/tenant/{tenantId}/secure-mail-server | List secure mail servers
*AdminSecureMailApi* | [**update_server**](docs/AdminSecureMailApi.md#update_server) | **PUT** /api/provisioning/v1/admin/tenant/{tenantId}/secure-mail-server/{serverId} | Update a secure mail server
...
## Documentation For Models
 ...
 - [PageSecureMailServerRepresentation](docs/PageSecureMailServerRepresentation.md)
 ...
 - [SecureMailServerRepresentation](docs/SecureMailServerRepresentation.md)
