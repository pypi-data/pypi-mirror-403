...
class VVCM_ManualSimulation:
    ...
    def init(self, Rn_initial: Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='F')], Po_initial: Annotated[NDArray[numpy.float32], dict(shape=(3), order='C')] = ...) -> "std::__1::tuple<VVCM::VVCM_FK_Error, Eigen::Matrix<float, 3, 1, 0, 3, 1>>":
        """
        init the engine, all the unit of length is mm or s.
    ...
    def get_new_stable_solution(self, Rn: Annotated[NDArray[numpy.float32], dict(shape=(None, None), order='F')]) -> "std::__1::tuple<VVCM::VVCM_FK_Error, Eigen::Matrix<float, 3, 1, 0, 3, 1>>":
        """
