...
class RemoteExecutionClient:
    def __init__(
        ...
        # Track background bash processes for completion notification
    ...
    async def _on_background_process_complete(
        ...
        """Called when a background process completes. Sends notification to server."""
    ...
    async def _send_background_notification(
        ...
        """Send a background process completion notification to the server."""
    ...
    async def _setup_tasks(
        ...
        # Ten parallel executors to handle requests
    ...
    async def run_connection(
        ...
        try:
            ...
            # Stop tracking background processes (does not kill them)
