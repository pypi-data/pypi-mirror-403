...
"""
Split Learning adapter for RobustScaler
...
class SLRobustScaler:
    """
    Split Learning RobustScaler
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLRobustScaler initialized with JAX acceleration")
        else:
            logging.info("[SL] SLRobustScaler initialized with sklearn")
