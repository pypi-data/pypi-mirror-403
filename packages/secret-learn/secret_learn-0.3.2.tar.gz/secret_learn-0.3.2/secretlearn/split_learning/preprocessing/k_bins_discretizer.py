...
"""
Split Learning adapter for KBinsDiscretizer
...
class SLKBinsDiscretizer:
    """
    Split Learning KBinsDiscretizer
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLKBinsDiscretizer initialized with JAX acceleration")
        else:
            logging.info("[SL] SLKBinsDiscretizer initialized with sklearn")
