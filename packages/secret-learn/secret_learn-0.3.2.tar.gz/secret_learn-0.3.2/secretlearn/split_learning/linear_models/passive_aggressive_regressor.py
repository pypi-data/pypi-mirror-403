...
"""
Split Learning adapter for PassiveAggressiveRegressor
...
class SLPassiveAggressiveRegressor:
    """
    Split Learning PassiveAggressiveRegressor
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLPassiveAggressiveRegressor initialized with JAX acceleration")
        else:
            logging.info("[SL] SLPassiveAggressiveRegressor initialized with sklearn")
