...
"""
Split Learning adapter for ElasticNet
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLElasticNet initialized with JAX acceleration")
        else:
            logging.info("[SL] SLElasticNet initialized with sklearn")
