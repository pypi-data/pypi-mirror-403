...
"""
Split Learning adapter for ElasticNetCV
...
class SLElasticNetCV:
    """
    Split Learning ElasticNetCV
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLElasticNetCV initialized with JAX acceleration")
        else:
            logging.info("[SL] SLElasticNetCV initialized with sklearn")
