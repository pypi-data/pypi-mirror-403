...
"""
Split Learning adapter for MinCovDet
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLMinCovDet initialized with JAX acceleration")
        else:
            logging.info("[SL] SLMinCovDet initialized with sklearn")
