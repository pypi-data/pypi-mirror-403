...
"""
Split Learning adapter for SequentialFeatureSelector
...
class SLSequentialFeatureSelector:
    """
    Split Learning SequentialFeatureSelector
    ...
    **kwargs
    ...
    def __init__(self, devices: Dict[str, 'PYU'], heu: HEU = None, **kwargs):
        ...
        if USING_XLEARN:
            logging.info(f"[SL] SLSequentialFeatureSelector with JAX acceleration")
        else:
