...
"""
Split Learning adapter for KMeans
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLKMeans initialized with JAX acceleration")
        else:
            logging.info("[SL] SLKMeans initialized with sklearn")
