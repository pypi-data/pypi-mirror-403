...
"""
Split Learning adapter for NuSVC
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLNuSVC initialized with JAX acceleration")
        else:
            logging.info("[SL] SLNuSVC initialized with sklearn")
