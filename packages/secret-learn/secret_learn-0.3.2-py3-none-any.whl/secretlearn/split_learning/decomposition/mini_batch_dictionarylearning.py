...
"""
Split Learning adapter for MiniBatchDictionaryLearning
...
class SLMiniBatchDictionaryLearning:
    """
    Split Learning MiniBatchDictionaryLearning
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLMiniBatchDictionaryLearning initialized with JAX acceleration")
        else:
            logging.info("[SL] SLMiniBatchDictionaryLearning initialized with sklearn")
