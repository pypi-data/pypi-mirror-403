...
"""
Split Learning adapter for EmpiricalCovariance
...
class SLEmpiricalCovariance:
    """
    Split Learning EmpiricalCovariance
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLEmpiricalCovariance initialized with JAX acceleration")
        else:
            logging.info("[SL] SLEmpiricalCovariance initialized with sklearn")
