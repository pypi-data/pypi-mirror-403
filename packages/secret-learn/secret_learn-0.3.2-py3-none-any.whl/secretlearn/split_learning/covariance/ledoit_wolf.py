...
"""
Split Learning adapter for LedoitWolf
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLLedoitWolf initialized with JAX acceleration")
        else:
            logging.info("[SL] SLLedoitWolf initialized with sklearn")
