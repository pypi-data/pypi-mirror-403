...
"""
Split Learning adapter for FastICA
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLFastICA initialized with JAX acceleration")
        else:
            logging.info("[SL] SLFastICA initialized with sklearn")
