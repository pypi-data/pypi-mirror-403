...
"""
Split Learning adapter for KernelPCA
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLKernelPCA initialized with JAX acceleration")
        else:
            logging.info("[SL] SLKernelPCA initialized with sklearn")
