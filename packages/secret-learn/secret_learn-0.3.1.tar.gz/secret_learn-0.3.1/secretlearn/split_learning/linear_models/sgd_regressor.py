...
"""
Split Learning adapter for SGDRegressor
...
class SLSGDRegressor:
    """
    Split Learning SGDRegressor
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLSGDRegressor initialized with JAX acceleration")
        else:
            logging.info("[SL] SLSGDRegressor initialized with sklearn")
