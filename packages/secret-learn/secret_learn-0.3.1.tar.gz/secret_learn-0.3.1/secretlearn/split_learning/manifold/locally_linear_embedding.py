...
"""
Split Learning adapter for LocallyLinearEmbedding
...
class SLLocallyLinearEmbedding:
    """
    Split Learning LocallyLinearEmbedding
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLLocallyLinearEmbedding initialized with JAX acceleration")
        else:
            logging.info("[SL] SLLocallyLinearEmbedding initialized with sklearn")
