...
"""
Split Learning adapter for LassoCV
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLLassoCV initialized with JAX acceleration")
        else:
            logging.info("[SL] SLLassoCV initialized with sklearn")
