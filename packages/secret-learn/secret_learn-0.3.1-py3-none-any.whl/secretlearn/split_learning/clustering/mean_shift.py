...
"""
Split Learning adapter for MeanShift
    ...
    **kwargs
    ...
    def __init__(
        ...
        **kwargs
        ...
        if USING_XLEARN:
            logging.info("[SL] SLMeanShift initialized with JAX acceleration")
        else:
            logging.info("[SL] SLMeanShift initialized with sklearn")
