...
class TimeOfFlightAnalysis(ba.BaseAnalysis):
    ...
    def create_figures(self) -> None:
        ...
        self.dataset_processed.Magnitude.plot(ax=ax, color="mediumturquoise", zorder=100)
        ...
        qpl.plot_textbox(ax=ax, transform=ax.transAxes, text=self.quantities_of_interest["fit_msg"])
