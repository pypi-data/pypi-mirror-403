...
class ReferenceMagnitude:
    ...
    @classmethod
    def from_parameter(
        cls, parameter: ReferenceMagnitudeSubmodule | None
...
class ShiftClockPhase(Operation):
    ...
    def __init__(
        self,
        phase_shift: float | Expression,
        clock: str,
        t0: float | Expression = 0,
    ) -> None:
...
class ResetClockPhase(Operation):
    ...
    Bear in mind, that this might not reset the full phase,
    but only just the phase of one component of the frequency.
    ...
    def __init__(self, clock: str, t0: float | Expression = 0) -> None:
        super().__init__(name=self.__class__.__name__)
        self.data["pulse_info"] = {
            "wf_func": None,
            "clock": clock,
...
class SetClockFrequency(Operation):
    ...
    def __init__(
        self,
        clock: str,
        clock_freq_new: float | Expression | None,
        t0: float | Expression = 0,
    ) -> None:
        super().__init__(name=self.__class__.__name__)
        self.data["pulse_info"] = {
...
class VoltageOffset(Operation):
    ...
    def __init__(
        self,
        offset_path_I: float | Expression,
        offset_path_Q: float | Expression,
        port: str,
...
class IdlePulse(Operation):
    ...
    def __init__(self, duration: float | Expression) -> None:
        super().__init__(name=self.__class__.__name__)
        self.data["pulse_info"] = {
            "wf_func": None,
            "t0": 0,
...
class RampPulse(Operation):
    ...
    def __init__(
        ...
        duration: float | Expression,
        port: str,
        clock: str = BasebandClockResource.IDENTITY,
        reference_magnitude: ReferenceMagnitude | None = None,
        offset: float | Expression = 0,
        t0: float | Expression = 0,
    ) -> None:
        super().__init__(name=self.__class__.__name__)
        self.data["pulse_info"] = {
...
class StaircasePulse(Operation):
    ...
    def __init__(
        self,
        start_amp: float | Expression,
        final_amp: float | Expression,
        num_steps: int,
        duration: float | Expression,
        port: str,
        clock: str = BasebandClockResource.IDENTITY,
...
class MarkerPulse(Operation):
    ...
    def __init__(
        ...
        fine_start_delay: float | Expression = 0,
        fine_end_delay: float | Expression = 0,
    ) -> None:
        super().__init__(name=self.__class__.__name__)
        self.data["pulse_info"] = {
            "wf_func": None,
...
class SquarePulse(Operation):
    ...
    def __init__(
        self,
        amp: complex | float | Expression | Sequence[complex | float | Expression],
        duration: complex | float | Expression,
        port: str,
        clock: str = BasebandClockResource.IDENTITY,
        reference_magnitude: ReferenceMagnitude | None = None,
        t0: float | Expression = 0,
    ...
    def __str__(self) -> str:
        ...
        return self._get_signature(self.data["pulse_info"])
...
class SuddenNetZeroPulse(Operation):
    ...
    def __init__(
        self,
        amp_A: float | Expression,
        amp_B: float | Expression,
        net_zero_A_scale: float | Expression,
        t_pulse: float | Expression,
        t_phi: float | Expression,
        t_integral_correction: float | Expression,
        port: str,
        clock: str = BasebandClockResource.IDENTITY,
        reference_magnitude: ReferenceMagnitude | None = None,
        t0: float | Expression = 0,
...
class SoftSquarePulse(Operation):
    ...
    def __init__(
        self,
        amp: float | Expression | Sequence[float | Expression],
        duration: float | Expression,
        port: str,
        clock: str = BasebandClockResource.IDENTITY,
        reference_magnitude: ReferenceMagnitude | None = None,
...
class ChirpPulse(Operation):
    ...
    def __init__(
        ...
        port: str,
        clock: str,
        start_freq: float | Expression,
        end_freq: float | Expression,
        reference_magnitude: ReferenceMagnitude | None = None,
        t0: float | Expression = 0,
    ) -> None:
        super().__init__(name=self.__class__.__name__)
...
class DRAGPulse(Operation):
    ...
    def __init__(
        ...
        clock: str,
        reference_magnitude: ReferenceMagnitude | None = None,
        sigma: float | Expression | None = None,
        t0: float | Expression = 0,
    ) -> None:
        super().__init__(name=self.__class__.__name__)
        self.data["pulse_info"] = {
...
def create_dc_compensation_pulse(
    ...
    from qblox_scheduler.helpers.waveforms import area_pulses
    ...
    def _extract_pulses(pulses: list[Operation], port: str) -> list[dict[str, Any]]:
        ...
        for pulse in pulses:
            pulse_info = pulse["pulse_info"]
            if pulse_info["port"] == port and pulse_info["clock"] == BasebandClockResource.IDENTITY:
...
class WindowOperation(Operation):
    ...
    def window_name(self) -> str:
        ...
        return self.data["pulse_info"]["window_name"]
