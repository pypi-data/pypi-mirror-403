...
def rxy_drag_pulse(
    ...
    reference_magnitude : :class:`~qblox_scheduler.operations.pulse_library.ReferenceMagnitude`,
    ...
    """
    # amplitude is the gaussian amplitude introduced in
...
def composite_square_pulse(
    ...
    schedule = TimeableSchedule(pulse_library.SquarePulse.__name__)
    schedule.add(
...
def spin_init_pulse(
    ...
    spin_init_schedule = TimeableSchedule("spin_init")
...
def non_implemented_pulse(**kwargs) -> TimeableSchedule:
