...
from qcodes.parameters import InstrumentRefParameter, parameter
...
class InstrumentCoordinatorComponentBase(Instrument):
    ...
    _no_gc_instances: ClassVar[dict[str, InstrumentBase]] = {}

    def __new__(cls, instrument: InstrumentBase) -> Self:
        """
    ...
    def __init__(
        ...
        **kwargs: Any,  # noqa: ANN401 (complicated subclass overrides)
        ...
        self._no_gc_instances[instrument.name] = self

        self.instrument_ref = InstrumentRefParameter(
            "instrument_ref",
