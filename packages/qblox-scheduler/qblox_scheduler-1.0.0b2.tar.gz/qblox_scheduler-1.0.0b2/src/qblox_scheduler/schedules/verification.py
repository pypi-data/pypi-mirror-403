...
from qblox_scheduler import Operation, TimeableSchedule
from qblox_scheduler.operations.acquisition_library import SSBIntegrationComplex
from qblox_scheduler.operations.pulse_library import IdlePulse, SquarePulse
...
def acquisition_staircase_sched(
    ...
    """
    sched = TimeableSchedule(name="Acquisition staircase", repetitions=repetitions)
...
def awg_staircase_sched(
    ...
    """
    sched = TimeableSchedule(name="AWG staircase", repetitions=repetitions)
...
def multiplexing_staircase_sched(
    ...
    sched = TimeableSchedule(name="Multiplexing sched", repetitions=repetitions)
    ...
    for pulse_amp0, pulse_amp1 in zip(pulse_amps, pulse_amps_reversed, strict=False):
        add_staircase_step(
            sched,
            ref_pulse,
            pulse_amp0,
