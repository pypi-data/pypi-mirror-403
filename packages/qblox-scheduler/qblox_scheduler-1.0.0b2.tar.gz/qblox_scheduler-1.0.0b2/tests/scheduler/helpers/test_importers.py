...
def test_import_python_object_from_string_1():
    from qblox_scheduler.backends.qblox_backend import hardware_compile

    import_string = "qblox_scheduler.backends.qblox_backend.hardware_compile"
...
def test_import_python_object_from_string_2():
    ...
    import_string = "qblox_scheduler.operations.pulse_library.IdlePulse"
    obj = import_python_object_from_string(import_string)
...
def test_python_object_to_path_string_1():
    ...
    assert import_string == "qblox_scheduler.backends.qblox_backend.hardware_compile"
...
def test_python_object_to_path_string_2():
    ...
    assert import_string == "qblox_scheduler.operations.pulse_library.IdlePulse"
