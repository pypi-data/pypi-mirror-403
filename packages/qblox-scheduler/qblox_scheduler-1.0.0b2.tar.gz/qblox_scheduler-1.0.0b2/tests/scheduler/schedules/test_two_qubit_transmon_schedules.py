...
from qblox_scheduler.schedules import two_qubit_transmon_schedules as ts
...
class TestChevronCZSched:
    """
        Unit test for the
    :func:`~qblox_scheduler.schedules.two_qubit_transmon_schedules.chevron_cz_sched`
    ...
    def test_sweep(self) -> None:
        ...
        for i, schedulable in enumerate(self.uncomp_sched.schedulables.values()):
            ...
            if schedulable["label"].startswith("SquarePulse"):
                ...
                pulse = self.uncomp_sched.operations[op_hash]["pulse_info"]
    ...
    def test_custom_flux_port(
        ...
        for schedulable in compiled_sched.schedulables.values():
            if schedulable["label"].startswith("SquarePulse"):
                ...
                assert operation["pulse_info"]["port"] == "q1:fl"
