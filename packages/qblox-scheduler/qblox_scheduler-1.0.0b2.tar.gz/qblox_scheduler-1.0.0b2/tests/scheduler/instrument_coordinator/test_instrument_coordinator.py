...
from qblox_scheduler.instrument_coordinator.components import base as base_component
...
def test_add_component_failed_type_validation(instrument_coordinator):
    ...
    # Assert
    assert execinfo.value.args[0] == (
        "<DummyComponent> is not qblox_scheduler.instrument_coordinator."
...
def test_prepare(
    ...
    # Act
    test_sched = TimeableSchedule(name="test_schedule")
