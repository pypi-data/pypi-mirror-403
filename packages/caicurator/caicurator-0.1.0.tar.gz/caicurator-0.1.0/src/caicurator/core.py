...
def get_history_file_path():
    return pathlib.Path(constants.CONFIG["browser"]["HISTORY_FILE"]).expanduser()


def get_history_file_sql_con(history_file_path: pathlib.Path):
...
def get_filtered_urls(history_file_path: pathlib.Path) -> dict[str, tuple[str, ...]]:
    filtered_urls: dict[str, tuple[str, ...]] = {}
    con = get_history_file_sql_con(history_file_path)
    cur = con.cursor()
