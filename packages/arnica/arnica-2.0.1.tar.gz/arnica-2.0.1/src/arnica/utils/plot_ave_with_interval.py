"""
*Plot graphs from 1D average array with or without its confidence interval. Rotate the
graph from 90 deg.*
"""
...
def plot_ave_with_interval(
    x_arr, average, profile="average-interval", upper=None, lower=None, **kw_args
):
    """
