...
def compute_equilibrium(
    hot_t_ad, cold_t_ad, hot_h, cold_h, metal, ceram, ep_metal, ep_ceram
):
    """
    ...
    def estimate_phi_and_temps(t_ceram, t_metal):
        ...
        phi = (hot_t_ad - cold_t_ad) / (
            1.0 / hot_h + r_th_ceram + r_th_metal + 1.0 / cold_h
        )
    ...
    while cvgce > 1.0:
        ...
        t_ceram_hot, t_eq, t_metal_cold = estimate_phi_and_temps(
            t_ceram=0.5 * (t_ceram_hot + t_eq), t_metal=0.5 * (t_metal_cold + t_eq)
        )
