...
class RunsResource(SyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> SyncOffsetPagination[RunListResponse]:
        """
        ...
        return self._get_api_list(
            "/v0/runs",
            page=SyncOffsetPagination[RunListResponse],
            options=make_request_options(
...
class AsyncRunsResource(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        extra_body: Body | None = None,
        timeout: float | httpx.Timeout | None | NotGiven = not_given,
    ) -> AsyncPaginator[RunListResponse, AsyncOffsetPagination[RunListResponse]]:
        """
        Retrieves a paginated list of runs with optional filtering.
        ...
        return self._get_api_list(
            "/v0/runs",
            page=AsyncOffsetPagination[RunListResponse],
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
                extra_body=extra_body,
