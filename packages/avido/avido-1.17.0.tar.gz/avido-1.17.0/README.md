...
<!-- prettier-ignore -->
[![PyPI version](https://img.shields.io/pypi/v/avido.svg?label=pypi%20(stable))](https://pypi.org/project/avido/)

The Avido Python library provides convenient access to the Avido REST API from any Python 3.9+
...
import os
import asyncio
from avido import DefaultAioHttpClient
from avido import AsyncAvido
...
for application in first_page.data:
