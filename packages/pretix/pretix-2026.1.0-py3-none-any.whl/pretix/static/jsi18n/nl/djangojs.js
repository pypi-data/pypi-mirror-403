...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "MyBank": "MyBank",
    "No": "Nee",
    "No active check-in lists found.": "Geen actieve check-inlijsten gevonden.",
    ...
    "The request took too long. Please try again.": "De aanvraag duurde te lang. Probeer het opnieuw.",
    ...
    "You have unsaved changes!": "Sommige wijzigingen zijn nog niet opgeslagen!",
    ...
    "widget\u0004Redeem": "Inwisselen",
    "widget\u0004Redeem a voucher": "Voucher inwisselen",
    ...
    "widget\u0004The cart could not be created. Please try again later": "De winkelwagen kon niet aangemaakt worden. Probeer het later opnieuw.",
    ...
    "widget\u0004You currently have an active cart for this event. If you select more products, they will be added to your existing cart.": "U hebt momenteel een actieve winkelwagen voor dit evenement. Als u meer producten selecteert, worden deze toegevoegd aan uw bestaande winkelwagen.",
    ...
    "widget\u0004plus taxes": "plus belasting"
  };
