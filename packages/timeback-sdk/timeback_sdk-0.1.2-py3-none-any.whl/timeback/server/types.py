...
class SearchParams:
    """
    Query parameters accessor matching TS URLSearchParams interface.
...
class ParsedUrl:
    """
    Parsed URL object providing TS-like URL ergonomics.

    Matches the TS SDK's URL interface for searchParams access.
...
class TimebackConfig:
    ...
    All fields are required except config_path and hooks. This matches TS SDK behavior
    and prevents runtime errors in /activity and /user/me handlers.
