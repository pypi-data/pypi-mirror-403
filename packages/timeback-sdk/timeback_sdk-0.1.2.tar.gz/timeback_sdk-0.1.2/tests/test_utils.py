...
class TestSafeIdSegment:
    ...
    def test_matches_ts_behavior(self) -> None:
        """Should match TypeScript implementation: URL-encode then replace % with _."""
        # This test ensures parity with TS SDK
        test_cases = [
            ("simple", "simple"),
...
class TestGetIssuer:
    """Tests for get_issuer (matching TS SDK behavior)."""

    def test_local_raises_error(self) -> None:
        """Local environment should raise error (matches TS SDK behavior)."""
