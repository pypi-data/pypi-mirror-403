...
These tests verify that the Python SDK's identity handlers match the TS SDK's
behavior for state handling during SSO flows.
...
- Decode failure returns None (matching TS undefined)
"""
