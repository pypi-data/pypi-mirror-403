...
T = TypeVar("T", bound="SenderCustomsInfo")


@_attrs_define
class SenderCustomsInfo:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sender_customs_info = cls(
            eori_number=eori_number,
            vat_number=vat_number,
        )

        sender_customs_info.additional_properties = d
        return sender_customs_info
