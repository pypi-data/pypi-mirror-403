...
T = TypeVar("T", bound="InsertShipmentBodyQuote")


@_attrs_define
class InsertShipmentBodyQuote:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        insert_shipment_body_quote = cls(
            product=product,
        )

        insert_shipment_body_quote.additional_properties = d
        return insert_shipment_body_quote
