...
T = TypeVar("T", bound="UpdateShipmentBodyPackages")


@_attrs_define
class UpdateShipmentBodyPackages:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_shipment_body_packages = cls(
            package=package,
        )

        update_shipment_body_packages.additional_properties = d
        return update_shipment_body_packages
