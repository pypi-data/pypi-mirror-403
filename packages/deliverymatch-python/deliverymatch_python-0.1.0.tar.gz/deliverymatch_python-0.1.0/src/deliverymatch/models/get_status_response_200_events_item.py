...
T = TypeVar("T", bound="GetStatusResponse200EventsItem")


@_attrs_define
class GetStatusResponse200EventsItem:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_status_response_200_events_item = cls(
        ...
        get_status_response_200_events_item.additional_properties = d
        return get_status_response_200_events_item
