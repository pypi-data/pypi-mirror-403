...
T = TypeVar("T", bound="InsertShipmentsBodyQuote")


@_attrs_define
class InsertShipmentsBodyQuote:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        insert_shipments_body_quote = cls(
            product=product,
        )

        insert_shipments_body_quote.additional_properties = d
        return insert_shipments_body_quote
