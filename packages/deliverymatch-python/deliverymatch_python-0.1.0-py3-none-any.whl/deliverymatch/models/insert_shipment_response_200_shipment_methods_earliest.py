...
T = TypeVar("T", bound="InsertShipmentResponse200ShipmentMethodsEarliest")


@_attrs_define
class InsertShipmentResponse200ShipmentMethodsEarliest:
    """
    Attributes:
        price (float | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        insert_shipment_response_200_shipment_methods_earliest = cls(
            price=price,
            buy_price=buy_price,
            currency=currency,
        ...
        insert_shipment_response_200_shipment_methods_earliest.additional_properties = d
        return insert_shipment_response_200_shipment_methods_earliest
