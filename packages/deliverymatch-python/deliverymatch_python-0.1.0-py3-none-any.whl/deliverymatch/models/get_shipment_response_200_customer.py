...
T = TypeVar("T", bound="GetShipmentResponse200Customer")


@_attrs_define
class GetShipmentResponse200Customer:
    """
    Attributes:
        address (Address | Unset): General address information of a given individual
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_shipment_response_200_customer = cls(
            address=address,
            contact=contact,
        )

        get_shipment_response_200_customer.additional_properties = d
        return get_shipment_response_200_customer
