...
if TYPE_CHECKING:
    ...
    from ..models.insert_shipment_body_packages import InsertShipmentBodyPackages
    from ..models.insert_shipment_body_quote import InsertShipmentBodyQuote
    from ..models.sender import Sender
    from ..models.shipment import Shipment


T = TypeVar("T", bound="InsertShipmentBody")


@_attrs_define
class InsertShipmentBody:
    """
    Attributes:
        ...
        quote (InsertShipmentBodyQuote): Information about the items in the shipment
        ...
        packages (InsertShipmentBodyPackages | Unset): When given, DeliveryMatch does not use quote information to
            generate packages
    ...
    packages: InsertShipmentBodyPackages | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        quote = InsertShipmentBodyQuote.from_dict(d.pop("quote"))
        ...
        packages: InsertShipmentBodyPackages | Unset
        if isinstance(_packages, Unset):
            packages = UNSET
        else:
            packages = InsertShipmentBodyPackages.from_dict(_packages)
        ...
        insert_shipment_body.additional_properties = d
        return insert_shipment_body
