...
T = TypeVar("T", bound="UpdateShipmentBodyShipment")


@_attrs_define
class UpdateShipmentBodyShipment:
    """
    Attributes:
        ...
        id (int | Unset): ID of the shipment, usually received after calling /insertShipment
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_shipment_body_shipment = cls(
            status=status,
        ...
        update_shipment_body_shipment.additional_properties = d
        return update_shipment_body_shipment
