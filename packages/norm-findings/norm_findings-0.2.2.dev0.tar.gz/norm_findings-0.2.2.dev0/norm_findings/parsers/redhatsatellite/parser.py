    ...
    def get_findings(self, scan_file, test):
        ...
        for result in data['results']:
            ...
            if (installable is not True):
                fix_available = False
            find = Finding(title=title, test=test, description=description, severity=self.severity_mapping(severity_input=severity), mitigation=solution, dynamic_finding=True, fix_available=fix_available)
