...
'''
                ...
                if ('cert' in endpoints['details']):
                    ...
                    description = '{}Certifcate Subject: {}\n'.format(description, cert['subject'])
                    description = '{}Issuer Subject: {}\n'.format(description, cert['issuerSubject'])
                    description = '{}Signature Algorithm: {}\n'.format(description, cert['sigAlg'])
                else:
                ...
                for protocols in endpoints['details']['protocols']:
                    protoName = '{} {} {}\n'.format(protoName, protocols['name'], protocols['version'])
                ...
                if (dupe_key in dupes):
                    ...
                    find = Finding(title=title, cwe=310, test=test, description=description, severity=sev, mitigation=mitigation, impact=impact, references=references, date=find_date, dynamic_finding=True)
                    dupes[dupe_key] = find
