        ...
        for result in results:
            ...
            for field in result:
                ...
                if (field.tag == 'hostname'):
                    ...
                    if field.text:
                        unsaved_endpoint.host = field.text.strip()
                if (field.tag == 'host'):
                    title = ((title + '_') + field.text)
            ...
            finding = Finding(title=str(title), test=test, description='\n'.join(description), severity=severity, dynamic_finding=True, static_finding=False, vuln_id_from_tool=script_id)
