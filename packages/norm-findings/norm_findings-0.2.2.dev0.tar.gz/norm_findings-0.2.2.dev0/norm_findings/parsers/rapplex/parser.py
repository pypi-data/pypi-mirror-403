        ...
        for severity in severities:
            ...
            for main_issue_group in main_issue_groups:
                ...
                for issue in issues:
                    ...
                    finding = Finding(title=title, test=test, severity=severity_level, date=formatted_date, description=summary, mitigation=rem, cwe=cwe_val, references=ref, active=True)
