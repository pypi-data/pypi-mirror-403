...
class KubeAuditParser():
    ...
    def get_findings(self, scan_file, test):
        ...
        for line in lines:
            ...
            finding = Finding(title=((AuditResultName + '_') + ResourceName), test=test, description=description, severity=self.severity_mapping(level), mitigation=msg, static_finding=True, dynamic_finding=False)
            if msg:
