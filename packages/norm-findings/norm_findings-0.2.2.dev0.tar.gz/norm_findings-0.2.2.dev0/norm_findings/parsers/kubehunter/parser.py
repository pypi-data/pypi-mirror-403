...
class KubeHunterParser():
    ...
    def get_findings(self, scan_file, test):
        ...
        for item in vulnerabilities:
            ...
            finding = Finding(title=title, test=test, description=findingdetail, severity=severity, mitigation=mitigation, references=references, static_finding=False, dynamic_finding=True, duplicate=False, out_of_scope=False, vuln_id_from_tool=vulnerability_id, steps_to_reproduce=steps_to_reproduce)
