                        ...
                        for evaluation in images:
                            try:
                                ...
                                for row in rows:
                                    ...
                                    find = Finding(title=title, test=test, description=description, severity=severity, references=f'''Policy ID: {policyid}
Trigger ID: {triggerid}''', file_path=search_filepath(description), component_name=repo, component_version=tag, date=find_date, static_finding=True, dynamic_finding=False)
                                    if vulnerability_id:
