...
'''
    ...
    return Finding(title=title, date=datetime.fromtimestamp(int(test_end)), test=test, description=description, severity=severity, mitigation=mitigation, unique_id_from_tool=unique_id_from_tool, static_finding=True, dynamic_finding=False)
