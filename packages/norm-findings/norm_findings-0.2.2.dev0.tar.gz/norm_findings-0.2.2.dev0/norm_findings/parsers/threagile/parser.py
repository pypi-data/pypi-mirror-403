...
class ThreagileParser():
    ...
    def get_items(self, tree, test):
        ...
        for item in tree:
            ...
            finding = Finding(title=item.get('category'), cwe=RISK_TO_CWE_MAP.get(item.get('category')), description=item.get('title'), impact=item.get('exploitation_impact'), severity=severity, test=test, unique_id_from_tool=item.get('synthetic_id'))
