    ...
    def get_findings(self, scan_file, test):
        ...
        for alert in data:
            ...
            if (state == 'resolved'):
                ...
                severity = 'Medium'
            finding = Finding(title=title, test=test, description=description, severity=severity, static_finding=True, dynamic_finding=False, vuln_id_from_tool=(str(alert_number) if alert_number else None))
            if first_location:
