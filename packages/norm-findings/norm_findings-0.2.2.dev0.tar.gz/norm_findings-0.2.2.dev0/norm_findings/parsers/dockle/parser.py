...
class DockleParser():
    ...
    SEVERITY = {'INFO': 'Low', 'WARN': 'Medium', 'FATAL': 'High'}
    ...
    def get_findings(self, scan_file, test):
        ...
        for item in data['details']:
            ...
            if (dupe_key in dupes):
                ...
                finding = Finding(title=f'{code}: {title}', test=test, severity=severity, description=description, static_finding=True, dynamic_finding=False, nb_occurences=1, vuln_id_from_tool=code)
