...
class ComponentIdentifier():
    ...
    def __init__(self, component):
        ...
        if ('componentIdentifier' in component):
            ...
            if (componant_format in {'a-name', 'pypi', 'rpm', 'gem', 'golang', 'conan', 'conda', 'bower', 'composer', 'cran', 'cargo', 'cocoapods', 'drupal', 'pecoff', 'swift', 'generic', 'operating-system'}):
    ...
    def set_maven_component(self, component_coordinates):
        self._component_id = f"{component_coordinates['artifactId']} {component_coordinates['groupId']} {component_coordinates['version']}"
