...
import json
from norm_findings.parsers.awssecurityhub.compliance import Compliance
from norm_findings.parsers.awssecurityhub.guardduty import GuardDuty
from norm_findings.parsers.awssecurityhub.inspector import Inspector
...
class AwsSecurityHubParser():
    ...
    def get_tests(self, scan_type, scan):
        ...
        test = ParserTest(name=self.ID, parser_type=self.ID, version='')
