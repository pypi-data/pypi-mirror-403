...
class GitlabSecretDetectionReportParser():
    ...
    def get_findings(self, scan_file, test):
        ...
        for vulnerability in vulnerabilities:
            ...
            finding = Finding(test=test, title=title, description=description, date=date, severity=severity, static_finding=True, dynamic_finding=False, unique_id_from_tool=vulnerability['id'])
            if ('file' in location):
