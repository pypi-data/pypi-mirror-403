...
class CheckovParser():
    ...
    def get_fields(self) -> list[str]:
        ...
        return ['title', 'description', 'severity', 'mitigation', 'file_path', 'line', 'component_name', 'static_finding', 'dynamic_finding']
    ...
    def get_findings(self, scan_file, test):
        findings = []
        if scan_file:
            deserialized = self.parse_json(scan_file)
...
def get_item(vuln, test, check_type):
    title = vuln.get('check_name', 'check_name not found')
