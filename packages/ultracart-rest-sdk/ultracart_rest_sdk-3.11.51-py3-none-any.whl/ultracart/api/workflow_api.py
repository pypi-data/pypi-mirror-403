...
class WorkflowApi(object):
    ...
    def get_workflow_agent_websocket_authorization(self, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            return self.get_workflow_agent_websocket_authorization_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_workflow_agent_websocket_authorization_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_workflow_agent_websocket_authorization_with_http_info(self, **kwargs):  # noqa: E501
        """Get agent websocket authorization  # noqa: E501

        Retrieve a JWT to authorize an agent to make a websocket connection.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_workflow_agent_websocket_authorization_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_workflow_agent_websocket_authorization" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            response_type='WorkflowAgentAuthResponse',  # noqa: E501
    ...
    def get_workflow_task_open_count(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_workflow_task_open_count_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_workflow_task_open_count_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_workflow_task_open_count_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieve workflow task open count  # noqa: E501

        Retrieve workflow task open count   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_workflow_task_open_count_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_workflow_task_open_count" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='WorkflowTaskOpenCountResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
