...
class StorefrontApi(object):
    ...
    def get_email_commseq_editor_values(self, storefront_oid, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_email_commseq_editor_values_with_http_info(storefront_oid, **kwargs)  # noqa: E501
        else:
            (data) = self.get_email_commseq_editor_values_with_http_info(storefront_oid, **kwargs)  # noqa: E501
            return data

    def get_email_commseq_editor_values_with_http_info(self, storefront_oid, **kwargs):  # noqa: E501
        """Get email merchant specific editor values  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_email_commseq_editor_values_with_http_info(storefront_oid, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_email_commseq_editor_values" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'storefront_oid' is set
        if ('storefront_oid' not in params or
                params['storefront_oid'] is None):
            raise ValueError("Missing the required parameter `storefront_oid` when calling `get_email_commseq_editor_values`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='EmailEditorValuesResponse',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
