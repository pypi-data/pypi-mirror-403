# Copyright: Travis Jefferies 2025
...
def fit_ordinary_least_squares(
    ...
    2025-11-03 TAJ: We have to use normal equation because
                    `jnp.linalg.lstsq` throws a `NotImplementedError`:
                    MLIR translation rule for primitive 'eigh'
                    not found for platform METAL.

    TODO: Use `jnp.linalg.lstsq` instead.
