...
V2EarnPendleMarketsMinTvlUsdTypedDict = TypeAliasType(
    "V2EarnPendleMarketsMinTvlUsdTypedDict", Union[float, str]
)
r"""Minimum TVL in USD. Markets with TVL below this value will be excluded."""


V2EarnPendleMarketsMinTvlUsd = TypeAliasType(
    "V2EarnPendleMarketsMinTvlUsd", Union[float, str]
)
r"""Minimum TVL in USD. Markets with TVL below this value will be excluded."""
...
class V2EarnPendleMarketsRequestTypedDict(TypedDict):
    ...
    min_tvl_usd: NotRequired[Nullable[V2EarnPendleMarketsMinTvlUsdTypedDict]]
    r"""Minimum TVL in USD. Markets with TVL below this value will be excluded."""
...
class V2EarnPendleMarketsRequest(BaseModel):
    ...
    min_tvl_usd: Annotated[
        OptionalNullable[V2EarnPendleMarketsMinTvlUsd],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""Minimum TVL in USD. Markets with TVL below this value will be excluded."""
    ...
    def serialize_model(self, handler):
        ...
        nullable_fields = set(["chain", "underlying_symbol", "min_tvl_usd"])
