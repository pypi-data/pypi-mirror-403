...
class Wildcat(BaseSDK):
    def wildcat_market(
        self,
        *,
        chain: models.V1WildcatMarketChain,
        market_address: str,
    ...
    ) -> models.WildcatGetMarketResponse:
        ...
        :param chain:
        :param market_address: The market address of the desired market data.
        ...
        request = models.V1WildcatMarketRequest(
            chain=chain,
            block=block,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="v1_wildcat_market",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.WildcatGetMarketResponse, http_res)
    ...
    async def wildcat_market_async(
        self,
        *,
        chain: models.V1WildcatMarketChain,
        market_address: str,
