import{d as P,L as b,ez as G,I as r,aZ as L,c3 as j,c1 as O,c0 as q,c2 as _,b0 as k,aY as B,aV as a,aW as w,b7 as M,b8 as A,eA as T,bO as N,ba as H,e as X,f as Y,h as I}from"./index-DFmXBO_y.js";const V={success:r(_,null),error:r(q,null),warning:r(O,null),info:r(j,null)},E=P({name:"ProgressCircle",props:{clsPrefix:{type:String,required:!0},status:{type:String,required:!0},strokeWidth:{type:Number,required:!0},fillColor:[String,Object],railColor:String,railStyle:[String,Object],percentage:{type:Number,default:0},offsetDegree:{type:Number,default:0},showIndicator:{type:Boolean,required:!0},indicatorTextColor:String,unit:String,viewBoxWidth:{type:Number,required:!0},gapDegree:{type:Number,required:!0},gapOffsetDegree:{type:Number,default:0}},setup(e,{slots:u}){const c=b(()=>{const o="gradient",{fillColor:t}=e;return typeof t=="object"?`${o}-${G(JSON.stringify(t))}`:o});function y(o,t,n,g){const{gapDegree:p,viewBoxWidth:f,strokeWidth:h}=e,l=50,m=0,s=l,i=0,S=2*l,x=50+h/2,v=`M ${x},${x} m ${m},${s}
      a ${l},${l} 0 1 1 ${i},-100
