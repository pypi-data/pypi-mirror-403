...
#define GRIBJUMP_OS_NAME          "Linux-6.14.0-1014-azure"
#define GRIBJUMP_OS_BITS          64
#define GRIBJUMP_OS_BITS_STR      "64"
#define GRIBJUMP_OS_STR           "linux.64"
#define GRIBJUMP_OS_VERSION       "6.14.0-1014-azure"
#define GRIBJUMP_SYS_PROCESSOR    "aarch64"

#define GRIBJUMP_BUILD_TIMESTAMP  "20260126165241"
#define GRIBJUMP_BUILD_TYPE       "RelWithDebInfo"

#define GRIBJUMP_C_COMPILER_ID      "GNU"
#define GRIBJUMP_C_COMPILER_VERSION "14.2.1"

#define GRIBJUMP_CXX_COMPILER_ID      "GNU"
#define GRIBJUMP_CXX_COMPILER_VERSION "14.2.1"

#define GRIBJUMP_C_COMPILER       "/opt/rh/gcc-toolset-14/root/usr/bin/cc"
#define GRIBJUMP_C_FLAGS          " -pipe -O2 -g -DNDEBUG"

#define GRIBJUMP_CXX_COMPILER     "/opt/rh/gcc-toolset-14/root/usr/bin/c++"
