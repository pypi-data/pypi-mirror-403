...
class FaucetApi(object):
    ...
    @auto_fill
    @validate_call
    def request_testnet_tokens(self, x_request_id : Annotated[Optional[StrictStr], Field(description="Developer-provided parameter used to identify this request. Useful when communicating with Circle Support.")] = None, faucet_request : Optional[FaucetRequest] = None, **kwargs) -> None:  # noqa: E501
    ...
    @auto_fill
    @validate_call
    def request_testnet_tokens_with_http_info(self, x_request_id : Annotated[Optional[StrictStr], Field(description="Developer-provided parameter used to identify this request. Useful when communicating with Circle Support.")] = None, faucet_request : Optional[FaucetRequest] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Request testnet tokens  # noqa: E501
