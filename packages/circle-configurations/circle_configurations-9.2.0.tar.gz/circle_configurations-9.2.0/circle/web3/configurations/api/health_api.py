...
class HealthApi(object):
    ...
    @auto_fill
    @validate_call
    def ping(self, **kwargs) -> Ping:  # noqa: E501
        """Ping  # noqa: E501

        Checks that the service is running.  # noqa: E501
        ...
        if '_preload_content' in kwargs:
            raise ValueError("Error! Please call the ping_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data")
    ...
    def ping_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(Ping, status_code(int), headers(HTTPHeaderDict))
        """
