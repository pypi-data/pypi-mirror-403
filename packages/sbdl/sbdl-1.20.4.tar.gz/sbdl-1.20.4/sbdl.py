#!/usr/bin/python3
_Dl='SteeringFirmware::correctCourse'
_Dk='rocket_in_motion'
_Dj='rocket_ready'
_Di='correct_course'
_Dh='fire_booster'
_Dg='steering_requirement_1'
_Df='booster_requirement_1'
_De='steering_firmware'
_Dd='test/macro.py'
_Dc='--custom-mode'
_Db='--custom-directive'
_Da='template-fill'
_DZ='openfmea-csv'
_DY='skinparam linetype ortho\n'
_DX='{} .{}.{} {}{}\n'
_DW='\n{}{} "{}" as {} {}{}'
_DV='Not a file: {}'
_DU='Reading: {}'
...
_DE='redundancy'
_DD='radiation'
_DC='quality assurance'
_DB='proportional-integral-derivative'
_DA='performance'
_D9='parameter'
_D8='optimization'
_D7='operating system'
_D6='mechanism'
_D5='measurement'
_D4='manufacturing'
_D3='management'
...
_Cv='heat transfer'
_Cu='frequency'
_Ct='failure mode and effects analysis'
_Cs='evaluation'
_Cr='electromagnetic'
_Cq='electrical'
_Cp='efficiency'
_Co='dimension'
_Cn='development'
_Cm='degrees of freedom'
_Cl='data acquisition'
_Ck='correction'
_Cj='coordinate'
_Ci='controller'
_Ch='configuration'
...
_CU='customtype'
_CT='arguments'
_CS='skinparam NoteBackgroundColor LightSteelBlue\nskinparam ParticipantBackgroundColor LightGrey\nskinparam backgroundColor transparent'
_CR='multipartite'
_CQ='sbdl_unique_identifier_gen_alphabet'
_CP='sbdl_unique_identifier_gen_length'
_CO='profile_output'
_CN='fmea_cause_extension'
_CM='openfmea_complex_aspect'
_CL='openfmea_bidirectional_import_relations'
_CK='openfmea_include_in_template'
_CJ='openfmea_fmeadev_url'
_CI='openfmea_content_based_keys'
_CH='openfmea_include_cme_unlinked'
_CG='openfmea_include_cme_orphans'
_CF='openfmea_expand_compoundfields'
_CE='remote_procedure_call_api_endpoint'
_CD='remote_procedure_call_api_key'
_CC='remote_procedure_call_enable'
_CB='remote_resouce_fetch_enable'
_CA='sbdl_disable_pretty_print'
_C9='sbdl_disable_pretty_print_environ'
_C8='manual_command'
_C7='add_description_bsci_property'
_C6='elision_placeholder'
_C5='reference_maximum_length'
_C4='usecase_diagram_style'
_C3='state_diagram_descriptions'
_C2='state_diagram_style'
_C1='uml_text_block_wrap_element'
_C0='process_diagram_descriptions'
_B_='function_diagram_aspect'
_Bz='function_diagram_descriptions'
_By='aspect_diagram_descriptions'
_Bx='aspect_diagram_element'
_Bw='aspect_diagram_aspect'
_Bv='requirement_diagram_legend'
_Bu='requirement_diagram_style'
_Bt='requirement_diagram_title_node_always'
_Bs='requirement_diagram_toplevel_depth'
_Br='requirement_diagram_aspect_groups'
_Bq='network_diagram_hide_types'
_Bp='network_diagram_dpi'
_Bo='network_diagram_layout'
_Bn='network_diagram_labels'
_Bm='network_diagram_descriptions'
_Bl='network_diagram_height'
_Bk='network_diagram_width'
_Bj='parser_allow_load_config'
_Bi='parser_allow_custom_directive_import'
_Bh='parser_custom_attributes'
_Bg='parser_allow_preparse_directives'
_Bf='plantuml_generate_footer'
_Be='plantuml_output_type'
_Bd='plantuml_limit_size'
_Bc='plantuml_command'
_Bb='wsl_auto_correct_paths'
_Ba='sbdl_reference_prefix_strip'
_BZ='sbdl_caching_suffix'
_BY='sbdl_caching_enabled'
_BX='sbdl_import_allows_recurse'
_BW='sbdl_warn_new_config'
_BV='sbdl_update_package'
_BU='sbdl_hash_check'
_BT='sbdl_hash_length'
_BS='sbdl_ast_pre_hooks'
_BR='sbdl_attribute_passthrough'
_BQ='sbdl_file_extension'
_BP='sbdl_output_reference'
_BO='sbdl_element_color_map'
_BN='sbdl_grammar_write_statement_separator'
_BM='sbdl_grammar_write_attribute_separator'
_BL='sbdl_grammar_custom_comment'
_BK='sbdl_grammar_custom_noop'
_BJ='sbdl_grammar_custom_end'
_BI='sbdl_grammar_custom_begin'
_BH='sbdl_grammar_custom_suffix'
_BG='sbdl_grammar_custom_prefix'
_BF='tracemalloc'
_BE='rocket_launch'
_BD='launch_protocol'
_BC='system_requirement_1'
_BB='rocket_steering'
_BA='rocket_system'
_B9='test/function_test.sbdl'
_B8='from:yaml-tree'
_B7='usecase-diagram'
_B6='state-diagram'
_B5='function-process-diagram'
_B4='function-diagram'
_B3='network-diagram'
_B2='requirement-diagram'
_B1='element-diagram'
_B0='aspect-diagram'
_A_='from:openfmea'
_Az='openfmea-portfolio'
_Ay='yaml-tree'
_Ax='compile'
_Aw='format'
_Av='<<{}>>'
...
_Ai='reference'
_Ah='category'
_Ag='**LOCKED_CONFIG_KEYS'
_Af='linux'
_Ae='openfmea_compoundfield_separator'
_Ad='usecase_diagram_descriptions'
_Ac='function_diagram_style'
_Ab='aspect_diagram_style'
_Aa='network_diagram_node_size'
_AZ='parser_imported_files'
_AY='parser_allow_global_directive_definition'
_AX='parser_allow_directive_definition'
_AW='plantuml_ortho_line_routing'
_AV='plantuml_layout_tweaks'
_AU='plantuml_raw_output'
_AT='prolog_trace_file'
...
__LOGO=''
__HELP_TEXT=''
_CONFIG_DATA={_BG:'_sbdl\\s?\\(',_BH:'\\)$',_BI:'_sbdl_block_begin',_BJ:'_sbdl_block_end',_BK:'^\\.\\.\\.$',_BL:_B,_BM:_A,_BN:_C,_s:_A,_BO:{},_X:_C,_BP:_A,_BQ:'.sbdl',_BR:_P,_BS:[],_m:[],_BT:5,_BU:_A,_BV:'sbdl-package.tar.gz',_AR:_C,_A7:_C,_A8:_C,_BW:_A,_BX:_A,_BY:_C,_BZ:'.sbdlc',_AS:{},_Ba:'',_Bb:_A,_n:_A,_A9:_C,_AT:_B,_AU:_C,_Bc:'plantuml',_Bd:65536,_Be:'png',_Bf:_A,_AV:_C,_AW:_C,_AA:_A,_Bg:_A,_AX:_A,_AY:_A,_T:{},_Bh:_A,_Bi:_A,_Bj:_A,_AZ:{},_Bk:38,_Bl:22,_Bm:_C,_Bn:_A,_Aa:20000,_Bo:_CR,_Bp:200,_Bq:'',_Br:_C,_Bs:2,_Bt:_C,_Y:"!pragma layout newlayouter\nskinparam dpi 200\nskinparam backgroundColor transparent\n'skinparam monochrome reverse\n\n",_Bu:'\n<style>\n  node {\n      HorizontalAlignment center\n      MaximumWidth 150\n  }\n  wbsDiagram {\n    Linecolor black\n    arrow {\n      LineColor black\n    }\n    .toplevel {\n    }\n    .source {\n      LineStyle 2\n      RoundCorner 10\n    }\n    .aspect {\n      LineStyle 8.0;3.0\n      LineColor lightgray\n      BackgroundColor lightgray\n      LineThickness 1.0\n      RoundCorner 0\n      Shadowing 0.0\n    }\n  }\n</style>',_Bv:_B,_Ab:'hide circle',_Bw:'frame',_Bx:'class',_By:_C,_Ac:_CS,_Bz:_C,_B_:'participant','process_diagram_style':_CS,_C0:_C,_t:_C,_c:15,_C1:40,_C2:'',_C3:_C,_C4:'',_Ad:_C,_C5:0,_C6:'[...]',_C7:_C,_C8:'less -R'if os.name=='posix'else'',_C9:'SBDL_NO_PRETTY',_CA:_C,_CB:_A,_CC:_C,_CD:'1879da28-0fc2-4f1d-8ff1-407f4c070c44',_CE:'{base}/{endp}'.format(base=__URL,endp='rest.api'),_Ae:'; ',_CF:'',_CG:_A,_CH:_A,_CI:_C,_CJ:'https://fmea.dev',_CK:_A,_CL:_C,_CM:_C,_CN:_U,_CO:_B,_u:_B,_v:{},_CP:8,_CQ:'0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz'}
...
def allow_pretty_print():return not get_config_value(_C9)in os.environ and not get_config_value(_CA,number=_A)
...
def current_os():
	...
	elif sys.platform.startswith(_Af):return _Af
...
def get_config_value(key,raise_on_missing=_A,default=_B,number=_B):
	...
	return result
def config_key_locked(key):lock_key=_Ag;return key in get_config_value(lock_key,raise_on_missing=_C,default={})
...
def set_config_value(key,data,warn_on_new=_A):
	if not config_key_locked(key):
		if not key in _CONFIG_DATA and get_config_value(_BW,number=_A)and warn_on_new:f_print('WARNING: adding new key ({}) to config registry'.format(key),warning=_A)
...
def use_config_data(new_config_data,skip_keys=_B):
	global _CONFIG_DATA;lock_key=_Ag;skip_keys_l=list(get_config_value(lock_key,raise_on_missing=_C,default={}).keys())
...
def fix_wsl_path(path):
	result=path
	if get_config_value(_Bb,number=_A):
...
def rest_api_call(function_name,arguments_dict,print_l=print_null):
	D='result';C='api_version';B='errors';A='api_name';API_END_POINT=get_config_value(_CE);result_data={}
	def create_rest_object(command,arguments_dict):return{A:name(),C:version_rest_api(),'api_key':get_config_value(_CD),_AB:command,_CT:{**arguments_dict}}
	...
	if get_config_value(_CC,number=_A):
...
*Category*: **{SBDL_Semantics.type_information[element_identifier][_Ah]}**
...
class SBDL_Parser:
	class Statements:declaration='declaration';using='using';scope='scope';operator='operator';customtype=_CU
	...
	class Tokens:declaration='is';declaration_group_delimeters=['{','}'];declaration_attribute_assign=' {} '.format(declaration);declaration_attribute_delimeter='"';general_separator=';';raw_content_delimiters=['[[[',']]]'];declaration_attribute_separator=general_separator;statement_separator=general_separator;hashbang='#!sbdl';prefix='@sbdl\\s';prefix_block_start='@sbdl\\-begin';prefix_block_end='@sbdl\\-end';comment='#';using='using';scope='scope';customtype=_CU;line_continuation=_V;replacement_string_default='';replacement_map={_S:'，',';':'；'};declaration_token_rule='\\s+{}\\s+'.format(declaration);declaration_rule='^.+?{}\\S+\\s*{}.*?{}\\s*$'.format(declaration_token_rule,declaration_group_delimeters[0],declaration_group_delimeters[1]);using_rule=_CV.format(using,declaration_group_delimeters[0],declaration_group_delimeters[1]);scope_rule=_CV.format(scope,declaration_group_delimeters[0],declaration_group_delimeters[1]);customtype_rule='^\\s*{}\\s+{}'.format(customtype,declaration_rule.replace('^',''));macro_delimeters=[_f,']'];macro_variable='@';macro_defer='%';macro_rule='\\{}{}(?:[^\\]\\\\]|\\\\.)*\\{}'.format(macro_delimeters[0],macro_variable,macro_delimeters[1]);macro_index_separator=':';whitespace_list=list(string.whitespace);escape=_V;stereotype_separator='^';link_operator='||';source_link_operator='~|';operator_rule='\\s*({}|{})\\s*'.format(_V+_V.join(link_operator),_V+_V.join(source_link_operator));inherit='inherit';compose='compose';hash_separator='~';scope_prefix=_d;stdio_name='-';nested_elements_depth_pop='nest_elems_end'
	class Attributes:description=_N;detectability=_x;detectability_post=_AC;severity=_y;occurrence=_z;occurrence_post=_AD;separator=_S;parent='parent';child='child';related='related';pragma='pragma';remark='remark';reference=_Ai;identifier=_Aj;type=_K;types=_Z;stereotype='stereotype';actor=_Ak;tag='tag';description_bsci='description_bsci';precondition='precondition';postcondition='postcondition';invariant='invariant';output=_Al;input=_Am;custom_prefix='custom:';condition='condition';condition_alternative='alternative';custom_required_attr='property:required';custom_optional_attr='property:optional';custom_optional_link_types='relation:optional';custom_required_link_types='relation:required';custom_required_attr_old='required_property';custom_optional_attr_old='optional_property';custom_link_types_old='relation_type';color='color';control_only='control_only';return_control='return_control';raw_content='raw_content';loop_name='loop';parallel_name='parallel';port_name='port'
	...
	class Parser_Element(Parser_Hints):
		...
		def shorten_reference(self,reference):
			reference_result=reference.removeprefix(get_config_value(_Ba));max_length=get_config_value(_C5,number=_A)
			if max_length!=_B and max_length>0:reference_result=(reference_result[::-1][:max_length]+(reference_result[::-1][max_length:]and get_config_value(_C6)[::-1]))[::-1]
	...
	def builtin_directive_dict(self):
		...
		def extend_deeper_cause(macros,*inp):
			...
			if SBDL_Parser.Macros.cross_reference_available in macros:
				extend_symbol=get_config_value(_CN)
		...
		def prolog_startup(_,*inp):
			...
			def prolog_element_to_fact(element):
				...
				handle_link_list(links,_An);handle_link_list(parents,'parents');handle_link_list(children,'children');handle_link_list(related,'related');return prolog_attr(etype,prolog_separator.join(attr_list),quote=_C)
			...
			if not A in globals():
				...
				trace_file_path=get_config_value(_AT)
	...
	def sanitize(self,unclean_string):
		...
		return result.encode(_CW).decode(_Ao).replace('\\\\',_V)
	@classmethod
	def sanitize_escaped(self,unclean_string,reverse=_C):
		...
		return result
	@classmethod
	def remove_escape_chars(self,escaped_string):return escaped_string.encode(_o).decode(_CW)
	@classmethod
	def attribute_string(self,statement_object):
		indent_str='';newline_str='';spacing_str=_I
		if get_config_value(_X,number=_A):indent_str='    ';newline_str=(self.Tokens.line_continuation if not get_config_value(_s,number=_A)else'')+_E;spacing_str=''
		...
		for attr in sorted(statement_object.data()):
			...
			if len(content)>0:
				...
				attributes+='{indent}{attrname}{assign}{delimiter}{attrcontent}{delimiter}{separator}{newline}{spacing}'.format(attrname=attr,assign=SBDL_Parser.Tokens.declaration_attribute_assign,delimiter=delim,attrcontent=content,separator=SBDL_Parser.Tokens.declaration_attribute_separator if get_config_value(_BM,number=_A)else'',indent=indent_str,newline=newline_str,spacing=spacing_str)
		return attributes
	@classmethod
	def declaration_string(self,declaration_object):
		newline_str=''
		if get_config_value(_X,number=_A):newline_str=(self.Tokens.line_continuation if not get_config_value(_s,number=_A)else'')+_E
...
class SBDL_Semantics:
	...
	def get_language_information_struct(self):
		...
		for type_name in lang_type_struct:
			lang_type_struct[type_name][_An]=self.get_valid_link_type_for_type_name(type_name);valid_properties=list(self.global_properties.keys())
			if type_name in self.type_properties:valid_properties.extend(list(self.type_properties[type_name]))
			lang_type_struct[type_name][_A0]=[p for p in valid_properties if not p in skip_properties];category=lang_type_struct[type_name][_Ah]
		...
		lang_info_struct[_A0]=self.property_descriptions;lang_info_struct[_At]=dict.fromkeys([x for x in vars(SBDL_Parser.Macros).values()if isinstance(x,str)and x!=_b and x!=_AF],'No Description')
		for directive_description in self.directive_descriptons:lang_info_struct[_At][directive_description]=self.directive_descriptons[directive_description]
		lang_info_struct['CLI']=help_text();return lang_info_struct
	@classmethod
	def type_color(self,type_name):
		E='#FFFF00';D='#FF6347';C='#FF69B4';B='#9370DB';A='#1E90FF';color_list=['#FFC0CB','#FFA07A','#FFD700','#32CD32','#00FFFF',A,B,C,D,E,'#008000','#00FF7F','#00CED1','#00BFFF',A,B,C,D,'#FF4500',E,'#9ACD32','#ADFF2F','#7FFFD4','#AFEEEE','#ADD8E6','#87CEEB','#8A2BE2','#FF00FF','#FF1493'];color_index_map=get_config_value(_BO)
	...
	@classmethod
	def get_identifier_from_string_eng_standard_v2(self,input_string,aggressive_length=20,min_word_len=3,separator='',right_to_left=_A):stop_words={'the','and','of','to','in','a','on','for','with','at','by','an','shall','should','must','will','can','may','might','could','be','have','use','then'};stop_chars={'a','e','i','o','u'};abbreviations={_CX:'accel','actuator':'act',_CY:'aero','analysis':'anal',_CZ:'approx',_Ca:'arch','assembly':'assy',_Cb:'aux','battery':'batt',_Cc:'calc',_Cd:'cg',_Ce:'cm',_Cf:'coeff',_Cg:_Au,_Ch:_Au,_h:'ctrl',_Ci:'cntrlr',_Cj:'coord',_Ck:'corr','current':'curr',_Cl:'daq','decibel':'db',_Cm:'dof','define':'def','design':'des',_Cn:'dev','diameter':'dia',_Co:'dim','dynamic':'dyn',_Cp:'eff',_Cq:'elec',_Cr:'em','error':'err','estimate':'est',_Cs:'eval','execute':'exec',_Ct:_q,'fatigue':'fat','feature':'feat','feedback':'fb',_Cu:'freq',_AB:'func','gradient':'grad','hardware':'hw',_Cv:'ht',_Cw:'hv',_Aj:_r,_Cx:_r,_Cy:'impl',_Am:'in',_Cz:'insp',_C_:'instr',_D0:'intg',_w:'intf',_D1:'iter','load':'ld','logic':'log',_D2:'maint','manage':'mg',_D3:'mgmt',_D4:'mfg','material':'matl','maximum':'max',_D5:'meas',_D6:'mech','minimum':'min','model':'mdl','momentum':'mom','nominal':'nom',_D7:'os',_D8:'opt',_Al:'out',_D9:'param','perform':'perf',_DA:'perf','physics':'phys','position':'pos','power':'pwr','pressure':'pres','process':'proc',_DB:'pid',_DC:'qa',_DD:'rad',_DE:'redund',_Ai:'ref',_DF:'rel',_W:'req',_DG:'res',_DH:'resist','safety':'sfty','sensor':'sens',_DI:'sim','software':'sw',_DJ:'spec',_DK:'stab','static':'stat',_DL:'struc',_DM:'subsys',_A2:'sys',_DN:'temp','tension':'tens','testing':'test','thermal':'therm','torque':'torq',_DO:'trans',_DP:'uncert',_DQ:'val',_DR:'verif','voltage':'volt','weight':'wt','target':'targ'};return self.get_identifier_from_string(re.sub(_DS,'',input_string),aggressive_length,min_word_len,separator,stop_words=stop_words,stop_chars=stop_chars,abbreviations=abbreviations,right_to_left=right_to_left)
	@classmethod
	def get_identifier_from_string_eng_standard_v1(self,input_string,aggressive_length=20,min_word_len=3,separator='',right_to_left=_A):stop_words={'the','and','of','to','in','a','on','for','with','at','by','an',_A2,'shall','should','must','will','can','may','might','could','be','have','use','perform','execute','define',_Cg,'manage','then'};stop_chars={'a','e','i','o','u'};abbreviations={_CX:'accel','actuator':'act',_CY:'aero','analysis':'anal',_CZ:'approx',_Ca:'arch','assembly':'assy',_Cb:'aux','battery':'batt',_Cc:'calc',_Cd:'cg',_Ce:'cm',_Cf:'coeff',_Ch:_Au,_h:'ctrl',_Ci:'cntrlr',_Cj:'coord',_Ck:'corr','current':'curr',_Cl:'daq','decibel':'db',_Cm:'dof','design':'des',_Cn:'dev','diameter':'dia',_Co:'dim','dynamic':'dyn',_Cp:'eff',_Cq:'elec',_Cr:'em','error':'err','estimate':'est',_Cs:'eval',_Ct:_q,'fatigue':'fat','feature':'feat','feedback':'fb',_Cu:'freq',_AB:'func','gradient':'grad','hardware':'hw',_Cv:'ht',_Cw:'hv',_Aj:_r,_Cx:_r,_Cy:'impl',_Am:'in',_Cz:'insp',_C_:'instr',_D0:'intg',_w:'intf',_D1:'iter','load':'ld','logic':'log',_D2:'maint',_D3:'mgmt',_D4:'mfg','material':'matl','maximum':'max',_D5:'meas',_D6:'mech','minimum':'min','model':'mdl','momentum':'mom','nominal':'nom',_D7:'os',_D8:'opt',_Al:'out',_D9:'param',_DA:'perf','physics':'phys','position':'pos','power':'pwr','pressure':'pres','process':'proc',_DB:'pid',_DC:'qa',_DD:'rad',_DE:'redund',_Ai:'ref',_DF:'rel',_W:'req',_DG:'res',_DH:'resist','safety':'sfty','sensor':'sens',_DI:'sim','software':'sw',_DJ:'spec',_DK:'stab','static':'stat',_DL:'struc',_DM:'subsys',_A2:'sys',_DN:'temp','tension':'tens','testing':'test','thermal':'therm','torque':'torq',_DO:'trans',_DP:'uncert',_DQ:'val',_DR:'verif','voltage':'volt','weight':'wt','target':'targ'};return self.get_identifier_from_string(re.sub(_DS,'',input_string),aggressive_length,min_word_len,separator,stop_words=stop_words,stop_chars=stop_chars,abbreviations=abbreviations,right_to_left=right_to_left)
	@classmethod
	...
	def get_unique_id_from_string(self,input_string):
		digest=hashlib.sha256(input_string.encode('utf‑8')).digest();alphabet=get_config_value(_CQ);length=get_config_value(_CP,number=_A);num=int.from_bytes(digest,'big');base=len(alphabet);smart_key=[]
...
class SBDL_Element(SBDL_Parser.Parser_Hints):
	...
	class Element_Link:
		...
		def is_a(self,target):
			...
			if not result:
				if isinstance(target,type)and hasattr(target,_DT):
	...
	def hash(self):return hashlib.sha256(re.sub('\\s+',_I,self.definition().parser_element().content().strip()).encode()).hexdigest()[:get_config_value(_BT,number=_A)]
	@classmethod
...
class SBDL_AST:
	...
	def elements(self,print_l=print_null,prune_missing_references=_C):
				...
				if isinstance(parsed_object,SBDL_Using_Statement):print_l('USING+=: {}'.format(parsed_object.data()),debug=_A);handle_using(parsed_object.data(),inherit_data)
					...
					try:
						...
						if not statement_element.identifier()in sbdl_elements:
							if get_config_value(_C7,number=_A)and statement_element.description():statement_element.set_property(SBDL_Parser.Attributes.description_bsci,SBDL_Semantics.calc_bsci(statement_element.description(),'english'))
		...
		if get_config_value(_AA,number=_A):
			...
			if get_config_value(_AX,number=_A)and get_config_value(_AY,number=_A):crossref_dict.update(get_config_value(_T))
...
def make_remote_file_local(file_reference):
	...
	if parsed_file_reference.scheme in['http','https','ftp','file://']and get_config_value(_CB,number=_A):
...
def get_parser_elements_from_filepath(filepath,elements_list,print_l=print_null,file_opener=open_input_file,read_input_set=_B):
	...
	local_directives={}
	if get_config_value(_AY,number=_A):local_directives=get_config_value(_T)
	...
	file_name=os.path.basename(filepath);file_ext=os.path.splitext(filepath)[1:][0];dir_name=filepath.replace(file_name,'');abs_path=os.path.abspath(filepath);native_sbdl_file=_A if get_config_value(_BQ)==file_ext else _C;update_per_file_directives()
	...
	def import_directive(_,*inp):
		...
		try:
			print_l('Import: {}'.format(import_path));add_to_config_value(_AZ,{pathlib.Path(import_path).resolve():_A});read_elements,import_errors=aggregate_all_parser_elements_from_files([import_path],do_recurse=get_config_value(_BX,number=_A),do_hidden=_C,print_l=print_l,file_opener=file_opener,read_input_set=read_input_set);elements_list.extend(read_elements);errors+=import_errors
	...
	def strip_comments(line):
		result=line;comment_markers=[SBDL_Parser.Tokens.comment,get_config_value(_BL)]
	...
	def detect_block_start_end(line):
		...
		if re.search(SBDL_Parser.Tokens.prefix_block_start,line)or re.search(get_config_value(_BI),line):native_sbdl_file=_A;result=_A
		elif re.search(SBDL_Parser.Tokens.prefix_block_end,line)or re.search(get_config_value(_BJ),line):native_sbdl_file=_C;result=_A
		return result
	def extract_sbdl_line_non_native(line):
		nonlocal non_sbdl_line_prefix;result='';custom_prefix=get_config_value(_BG);custom_suffix=get_config_value(_BH);custom_noop=get_config_value(_BK)
...
def aggregate_all_parser_elements_from_files(input_list,do_recurse,do_hidden,print_l=print_null,file_opener=open_input_file,read_input_set=_B):
	...
	for afile in input_list:
		...
		else:errors+=1;print_l(_DV.format(afile),error=_A)
...
def plantuml_writer(file_opener,output_file,content,_):
	...
	if not get_config_value(_AU,number=_A):
		try:
			plantuml_env=os.environ.copy();plantuml_env.pop('LD_LIBRARY_PATH',_B);plantuml_env['PLANTUML_LIMIT_SIZE']=str(get_config_value(_Bd));plantuml_command=get_config_value(_Bc)
			if isinstance(plantuml_command,str):plantuml_command=shlex.split(plantuml_command)
			plantuml_command_full=plantuml_command+['-t',get_config_value(_Be),'-p'];debug_out('EXECUTE_PLANTUML: '+str(plantuml_command_full));exec_result=subprocess.run(plantuml_command_full,input=content.encode(),stdout=subprocess.PIPE,stderr=subprocess.STDOUT,env=plantuml_env,check=_C);content_to_output=exec_result.stdout
...
def write_requirement_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	...
	if len(top_level_requirements)==1 and not get_config_value(_Bt):root_requirement=requirements[top_level_requirements[0][A]]
	else:
	...
	def plantuml_requirement_diagram_wrap(content):
		header=plantuml_footer_generator();legend_text='';legend=get_config_value(_Bv)
		if legend!=_B:legend_text='legend\n{legend_content}\nendlegend\n'.format(legend_content=legend)
		plant_uml_prepost='@startwbs\n{style}\n\n{header}\n{content}\n{legend}@endwbs\n';return plant_uml_prepost.format(style=get_config_value(_Y)+get_config_value(_Bu),header=header,content=content,legend=legend_text)
...
def write_decomposition_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	...
	def plantuml_decomposition_diagram():
		header=plantuml_footer_generator();title=_A3.format(arguments.title)if arguments.title!=''else'';plant_uml_prepost=_A4;content='';notes='';note_count=0;interface_count=0;relations='';descriptions=get_config_value(_By,number=_A);interface_mem={};handled_elems=[];indentation_prefix=_M
			...
			if not elem_id in handled_elems and elements[elem_id].is_a(SBDL_Aspect):
				...
				for relation in related:
					if parent_id!=relation.identifier():
						...
						relations+=_DX.format(puml_id(elem_id),interface_rel_pos(interface_count),relation_end,puml_id(relation.identifier()),link_text);interface_count+=1
			else:0
		...
		return plant_uml_prepost.format(style=(_DY if get_config_value(_AW,number=_A)else'')+get_config_value(_Y)+get_config_value(_Ab),header=header+title,content=content+_E+relations+_E+(_E+notes if descriptions or arguments.source else''))
...
def write_element_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	...
	def plantuml_decomposition_diagram():
		...
		def puml_id(elem_id):return plantuml_identifier(elem_id).replace('(','').replace(')','').replace('[]','').replace(']','').replace(':',_U).encode(_Ao,_A6).decode(_Ao)
		def interface_rel_pos(posindex):positions={0:'up',1:'down',2:_AG,3:_AH};return positions[posindex%4]if get_config_value(_AV,number=_A)else''
		def detailed_content(elem_id):
			props=[];links={};result='\t{}: **{}**\n'.format(SBDL_Parser.Attributes.type,elements[elem_id].type());elem=elements[elem_id]
			for prop in elem.properties():props.append('\t{}:\n\t  {}'.format(prop,textwrap.shorten(elem.get_property(prop),width=get_config_value(_C1,number=_A),placeholder='...')))
		...
		def handle_elem(elem_id,pref='',_=_B):
			...
			if not elem_id in handled_elems:
				...
				aspect_stereotype=_Av.format(aspect_stereotype);content+=_DW.format(pref,get_config_value(_Bx),elem_id,puml_id(elem_id),aspect_stereotype,''if not SBDL_Parser.Attributes.color in elements[elem_id].properties()else' #'+elements[elem_id].get_property(SBDL_Parser.Attributes.color));content+='{{\n{}\n}}\n'.format(detailed_content(elem_id));related=elements[elem_id].related();related.extend([link for link in elements[elem_id].links()])
				for relation in related:
					relation_type=relation.stereotype();relation_type=relation_type if relation_type else'';link_text=': '+relation_type if relation_type else'';relation_end='>'
					if relation_type.startswith(SBDL_Parser.Tokens.inherit):relation_end='|>'
					elif elements[relation.identifier()].is_a(SBDL_Parser.Types.interface):relation_end='('
					elif relation_type.startswith(SBDL_Parser.Tokens.compose):relation_end=_P
					relations+=_DX.format(puml_id(elem_id),interface_rel_pos(interface_count),relation_end,puml_id(relation.identifier()),link_text)
			else:0
		elements_ordered=list(elements.keys())
		for elem in elements_ordered:handle_elem(elem)
		return plant_uml_prepost.format(style=(_DY if get_config_value(_AW,number=_A)else'')+get_config_value(_Y)+get_config_value(_Ab),header=header+title,content=content+_E+relations+_E+(_E+''))
	plantuml_writer(file_opener,output_file,plantuml_decomposition_diagram(),print_l);return errors
def write_function_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	elements,errors=sbdl_ast.elements(print_l,prune_missing_references=_A);show_descriptions=get_config_value(_Bz,number=_A);event_count=0;entities={}
	def puml_id(elem_id):return plantuml_identifier(elem_id)
	def plantuml_function_diagram():
		...
		def handle_func(func_id,depth=1):
			...
			def define_aspect(aspect_name):
				...
				if not aspect_name in entities:
					...
					aspect_stereotype=_Av.format(aspect_stereotype);aspect_color=''
					...
					content+='{}{} "{}{}" as {} {}{}\n'.format(_M*depth,get_config_value(_B_),aspect_name,_H+elements[aspect_name].reference()if arguments.source else'',puml_id(aspect_name),aspect_stereotype,aspect_color)
		...
		return plant_uml_prepost.format(style=get_config_value(_Y)+get_config_value(_Ac),header=header+title,content=content)
...
def write_process_graph_output(sbdl_ast,output_file,file_opener,_,print_l):
	errors=0;elements,errors=sbdl_ast.elements(print_l,prune_missing_references=_A);show_descriptions=get_config_value(_C0,number=_A);first_event=_A;g_process_elem=_B;note_stagger=_C
	def elem_colour_prefix(elem):
		colour=''
		if SBDL_Parser.Attributes.color in elem.properties():colour=f"#{elem.get_property(SBDL_Parser.Attributes.color)} "
		return colour
	...
	def plantuml_process_diagram():
		process_dia_cont='';process_dia_cont+='@startuml\n';process_dia_cont+=get_config_value(_Y)+get_config_value(_Ac)+_i
...
def write_state_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	elements,errors=sbdl_ast.elements(print_l,prune_missing_references=_A);show_descriptions=get_config_value(_C3,number=_A)
	def plantuml_state_diagram():
		...
		return plant_uml_prepost.format(style=get_config_value(_Y)+get_config_value(_C2),header=header+title,content=statedefs+content+_E+relations)
...
def write_usecase_graph_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	...
	def plantuml_usecase_diagram():
		...
		for usecase in[elements[elem]for elem in elements if elements[elem].is_a(SBDL_UseCase)]:
			actor=usecase.get_property(_Ak)if _Ak in usecase.properties()else'User';content+='actor "{}" as {}\n'.format(actor,puml_id(actor))
		...
		for aspect in aspects:
			...
			for usecase_tuple in aspects[aspect]:content+='  usecase "{}" as {}\n'.format('**{}**\\n{}{}'.format(usecase_tuple[3],_H.join(textwrap.wrap(usecase_tuple[4],get_config_value(_c,number=_A))),_H+usecase_tuple[6]if arguments.source else'')if get_config_value(_Ad,number=_A)else usecase_tuple[3],puml_id(usecase_tuple[3]));relations+='\n{} --> {}: {}{}\n'.format(puml_id(usecase_tuple[0]),puml_id(usecase_tuple[3]),'**{}**\\n{}'.format(usecase_tuple[1],_H.join(textwrap.wrap(usecase_tuple[2],get_config_value(_c,number=_A))))if get_config_value(_Ad,number=_A)else usecase_tuple[1],_H+usecase_tuple[5]if arguments.source else'')
			content+='}\n'
		content+=relations;return plant_uml_prepost.format(style=get_config_value(_Y)+get_config_value(_C4),header=header+title,content=content)
...
def write_network_graph_output(sbdl_ast,output_file,_,arguments,print_l):
	...
	elements,errors=sbdl_ast.elements(print_l,prune_missing_references=_A);sbdl_graph=nx.MultiDiGraph();skip_types={x for x in get_config_value(_Bq,number=_C).split(_S)};node_name_sep=_d;node_text_wrap_width=25
	def node_name(elem_id):
		...
		if get_config_value(_Bm,number=_A):node_text+=_i+_E.join(textwrap.wrap(elements[elem_id].description(),width=node_text_wrap_width))
	...
	def dot(graphin):return nx.nx_agraph.graphviz_layout(graphin,prog='dot',args='-Goverlap=false -Goverlap_scaling=1000000 -Gscale={} -Gsep=20 -Gdefaultdist=100000'.format(get_config_value(_Aa,number=_A)))
	def spring(graphin):return nx.spring_layout(graphin,k=1)
	layouts={_CR:mpl,'graphviz':dot,'spring':spring,'spiral':nx.spiral_layout,'random':nx.random_layout,'planar':nx.planar_layout};options={'font_size':10,'node_size':get_config_value(_Aa,number=_A),'edgecolors':'gray','edge_color':'darkgray','linewidths':1,'with_labels':get_config_value(_Bn,number=_A),'width':2,'node_color':colour_list,'node_shape':'s','pos':layouts[get_config_value(_Bo,number=_C)](sbdl_graph)};plt.figure(figsize=(get_config_value(_Bk,number=_A),get_config_value(_Bl,number=_A)));nx.draw_networkx(sbdl_graph,**options,alpha=1.);ax=plt.gca();ax.margins(.0);plt.axis('off');plt.tight_layout();plt.plot();plt.savefig(output_file,dpi=get_config_value(_Bp,number=_A));return errors
class OpenFMEA:
	@classmethod
	def generate_sbdl_table_from_ast(self,sbdl_ast,id_in_body=_C,source_in_body=_C,print_l=print_null,multi_field_separator=_B):
		A='key';complex_aspect=get_config_value(_CM,number=_A)
		if multi_field_separator is _B:multi_field_separator=get_config_value(_Ae)
		id_counter=0;sbdl_row={A:_B,_e:_B,_W:_B,_L:_B,_a:_B,_R:_B,_h:_B,_j:_B,_y:_B,_z:_B,_AD:_B,_x:_B,_AC:_B,_A5:_B,_k:_B}
		...
		def generate_table(element,row=_B,path=_B,add_single=_C):
			...
			def add_row():
				...
				rows_to_add=[row];expand_attrs=get_config_value(_CF)
			...
			if not element.identifier()in path:
				path[element.identifier()]=_A;custom_prop_prefix=SBDL_Parser.Attributes.custom_prefix+get_config_value(_BR)
				...
				if element.identifier()==start_node.identifier():recurse_links(SBDL_Failure_Cause)
					...
					if not is_fully_meta()and(get_config_value(_CH,number=_A)or not is_partly_meta()):add_row()
		...
		def get_orphans(elements_l):
			rows=[]
			if get_config_value(_CG,number=_A):
		...
		def apply_smart_keys(input_rows):
			if get_config_value(_CI,number=_A):
				for row in input_rows:
					join_props=[_W,_R,_L,_a];join_string=''
	...
	def struct_from_table(self,title,sbdl_table,open_fmea_type=_Q):
		result_struct={_Aw:_AI,'version':'1.0',_K:open_fmea_type,_l:{'title':title,'application':name(),'application_version':version(),'cmd_line':str(sys.argv),'date':get_date_string()},_q:sbdl_table,'layout':{}};result_struct[_l]['user']=get_user_string()
	...
	def read_struct_from_file(self,open_sbdl_file):
		...
		if not(_Aw in open_sbdl_content and open_sbdl_content[_Aw]==_AI):raise Exception('Not an OpenFMEA file')
	...
	def elements_from_table(self,sbdl_table,_):
		multi_field_separator=get_config_value(_Ae);elems_to_consider={_e:SBDL_Parser.Types.aspect,_W:SBDL_Parser.Types.requirement,_L:SBDL_Parser.Types.mode,_a:SBDL_Parser.Types.effect,_R:SBDL_Parser.Types.cause,_h:SBDL_Parser.Types.current_control,_j:SBDL_Parser.Types.current_detection,_A5:SBDL_Parser.Types.action_control,_k:SBDL_Parser.Types.action_detection};elem_rating={_a:_y,_R:_z,_L:_x};elem_rating_post={_R:_AD,_L:_AC};elem_link={_R:[_L,_h,_A5,_j,_k],_L:[_e,_a,_j,_W,_k,_R],_W:[_e,_L],_a:[_L],_h:[_R],_j:[_L],_A5:[_R],_k:[_L]};elem_present_every_row={_j,_k};replace_str=SBDL_Parser.Tokens.replacement_string_default;elements={};id_lookup={}
		if not get_config_value(_CL,number=_A):elem_link[_L].remove(_R);elem_link[_a].remove(_L)
	...
	def aggregate_all_parser_elements_from_files(self,source_files,recurse,hidden,print_l):
		...
		for input_file in source_files:
			...
			else:errors+=1;print_l(_DV.format(input_file),error=_A)
...
def write_aggregated_output(sbdl_ast,output_file,file_opener,__,print_l):
	print_l('Writing aggregate output: {}'.format(output_file),debug=_A);new_line_str=_i if get_config_value(_X,number=_A)else _E
	with file_opener(output_file)as fmfile:
		...
		for element in sbdl_elements:
			if not get_config_value(_BP,number=_A):element.delete_property(SBDL_Parser.Attributes.reference)
			print_l('Writing element: {}'.format(element.identifier()),debug=_A);fmfile.write('{}{} {}'.format(element.definition().string(),SBDL_Parser.Tokens.statement_separator if get_config_value(_BN,number=_A)else'',new_line_str))
	return errors
def write_rpc_output(sbdl_ast,output_file,file_opener,arguments,print_l):
	...
	if arguments.rpc==_B:errors+=1;print_l('RPC parameter required',error=_A)
		...
		rpc_result=rest_api_call(arguments.rpc,{_CT:str(sys.argv),A:sbdl_statement_strings},print_l)
...
def write_template_fill(sbdl_ast,output_file,file_opener,arguments,print_l):
	...
	if get_config_value(_CK,number=_A):openfmea,errors_fmea=OpenFMEA.generate_sbdl_table_from_ast(sbdl_ast,id_in_body=arguments.identifier,source_in_body=arguments.source,print_l=print_l);errors+=errors_fmea;template_context[_AK]=openfmea
...
def write_type_information(_,output_file,file_opener,____,_____):
	...
	with file_opener(output_file)as output_file:
		output_file.write('Types');output_file.write(_E);output_file.write('=====');output_file.write(_i)
		...
		output_file.write('Properties');output_file.write(_E);output_file.write('==========');output_file.write(_i)
...
def list_imports_from_files(_,output_file,file_opener,__,___):
	with file_opener(output_file)as output:
		for imported_file in sorted(get_config_value(_AZ).keys()):output.write(f"{imported_file}\n")
	return 0
...
def update_self(print_l,force=_C):
	print_l(f"Updating {__NAME}...");ret,stdout,stderr=exec_external([sys.executable,_G,'pip','install',*(['--trusted-host',f"{urllib.parse.urlparse(__URL).netloc}"]if force else[]),'--upgrade',urllib.parse.urljoin(url(),get_config_value(_BV)),*(['--break-system-packages']if force else[])]);print_l(stdout)
...
def initialise_dependencies(print_l):
	...
	if current_os()==_Af:errors+=install_package('PlantUML',urllib.parse.urljoin(__URL,'deps/plantuml-headless-jre-linux-x64.tar.bz2'),install_target,print_l)
...
def get_cache_file_path(input_file):
	cache_file_path=_B
	if input_file!=SBDL_Parser.Tokens.stdio_name:cache_file_path=f"{input_file}{get_config_value(_BZ)}"
...
def main(arguments):
	...
	operations={_Ax:write_aggregated_output,'aggregate':write_aggregated_output,'query':query_output,_AL:write_matrixcsv_output,'matrixcsv':write_matrixcsv_output,_AM:write_matrixjson_output,'matrixjson':write_matrixjson_output,_Ay:write_yaml_tree_output,_DZ:write_csv_output,'fmeacsv':write_csv_output,_AK:OpenFMEA.write_opensbdl_output,'openfmea-quickshare':OpenFMEA.write_quickshare_output,_Az:OpenFMEA.write_opensbdl_portfolio_output,A:write_aggregated_output,_A_:write_aggregated_output,B:write_aggregated_output,C:write_aggregated_output,_B0:write_decomposition_graph_output,_B1:write_element_graph_output,_B2:write_requirement_graph_output,_B3:write_network_graph_output,_B4:write_function_graph_output,_B5:write_process_graph_output,_B6:write_state_graph_output,_B7:write_usecase_graph_output,_Da:write_template_fill,'rpc':write_rpc_output,_AN:write_aggregated_output,_B8:write_aggregated_output,_AO:write_aggregated_output,'type-info':write_type_information,'lsp':lsp_start,'list-import':list_imports_from_files};macro_errors=0
	...
	aggregate_methods={_A_:OpenFMEA.aggregate_all_parser_elements_from_files,A:OpenFMEA.aggregate_all_parser_elements_from_quickshare,C:OpenFMEA.aggregate_all_parser_elements_from_files,B:OpenFMEA.aggregate_all_parser_elements_from_quickshare,_AN:aggregate_all_parser_elements_from_json,_B8:aggregate_all_parser_elements_from_yaml,_AO:aggregate_all_parser_elements_from_csv};aggregation_method=aggregate_all_parser_elements_from_files if not arguments.mode in aggregate_methods else aggregate_methods[arguments.mode];parser_elements,read_errors=aggregation_method([fix_wsl_path(x)for x in arguments.source_files],arguments.recurse,arguments.hidden,print_l);check_step('File reading',read_errors);sbdl_ast=load_ast_cache(parser_elements,get_config_value(_BY,number=_A),arguments.source_files,print_l);check_step('Parsing',sbdl_ast.check_parsing(print_l))
	for pre_hook in get_config_value(_BS):check_step('Pre Hook: {}'.format(pre_hook.__name__),pre_hook(sbdl_ast,print_l))
...
def show_manual(_):
	...
	sbdl_info_struct=SBDL_Semantics.get_language_information_struct();sbdl_properties=sbdl_info_struct[_A0];sbdl_types=sbdl_info_struct[_Z];sbdl_directives=sbdl_info_struct[_At]
	...
	try:
		manual_command=get_config_value(_C8)
...
class LanguageLevelTests(unittest.TestCase):
	...
	def testFunction(self):main(handle_arguments([_B9,_D,self.TEST_OUTPUT_FILE]))
	...
	def testLanguageExample(self):main(handle_arguments([_AP,_AQ,_D,self.TEST_OUTPUT_FILE]))
	...
	def testCustomDirective(self):main(handle_arguments([_J,_Db,_Dd,_D,self.TEST_OUTPUT_FILE]))
	def testCustomModes(self):main(handle_arguments([_J,'--mode','test_mode',_Dc,_Dd,_D,self.TEST_OUTPUT_FILE]))
	...
	def testGeneralAspectDiagram(self):main(handle_arguments([_J,_D,self.TEST_DIAGRAM_OUTPUT_FILE,_G,_B0]))
	def testGeneralElementDiagram(self):main(handle_arguments([_J,_D,self.TEST_DIAGRAM_OUTPUT_FILE,_G,_B1]))
	def testGeneralFunctionDiagram(self):main(handle_arguments([_B9,_D,self.TEST_DIAGRAM_OUTPUT_FILE,_G,_B4]))
	def testGeneralProcessDiagram(self):main(handle_arguments([_B9,_D,self.TEST_DIAGRAM_OUTPUT_FILE,_G,_B5]))
	def testGeneralStateDiagram(self):main(handle_arguments([_J,_D,self.TEST_DIAGRAM_OUTPUT_FILE,_G,_B6]))
	def testGeneralRequirementDiagram(self):main(handle_arguments([_J,_D,self.TEST_DIAGRAM_OUTPUT_FILE,_G,_B2]))
	def testGeneralUsercaseDiagram(self):main(handle_arguments([_J,_D,self.TEST_DIAGRAM_OUTPUT_FILE,_G,_B7]))
	def testGeneralNetworkDiagram(self):main(handle_arguments([_J,_D,self.TEST_DIAGRAM_OUTPUT_FILE,_G,_B3]))
	def testGeneralJSON(self):main(handle_arguments([_J,_D,self.TEST_OUTPUT_FILE,_G,_AM]))
	def testGeneralYAML(self):main(handle_arguments([_J,_D,self.TEST_OUTPUT_FILE,_G,_Ay]))
	def testGeneralCSV(self):main(handle_arguments([_J,_D,self.TEST_OUTPUT_FILE,_G,_AL]))
	def testGeneralOpenFMEA(self):main(handle_arguments([_J,_D,self.TEST_OUTPUT_FILE,_G,_AK]))
	def testGeneralOpenFMEAPortfolio(self):main(handle_arguments([_J,_D,self.TEST_OUTPUT_FILE,_G,_Az]))
	def testGeneralFMEACSV(self):main(handle_arguments([_J,_D,self.TEST_OUTPUT_FILE,_G,'fmeacsv']))
	def testFromJSON(self):main(handle_arguments([_AP,_AQ,_D,self.TEST_OUTPUT_FILE,_G,_AM]));reset();main(handle_arguments([self.TEST_OUTPUT_FILE,_D,self.TEST_OUTPUT_FILE2,_G,_AN]))
	def testFromCSV(self):main(handle_arguments([_AP,_AQ,_D,self.TEST_OUTPUT_FILE,_G,_AL]));reset();main(handle_arguments([self.TEST_OUTPUT_FILE,_D,self.TEST_OUTPUT_FILE2,_G,_AO]))
...
class LanguageSemanticTests(unittest.TestCase):
	...
	def test_existence_type_semantic_check(self):
		expected_elem_type={_BA:SBDL_Aspect,'rocket_booster':SBDL_Aspect,_BB:SBDL_Aspect,_De:SBDL_Aspect,_BC:SBDL_Requirement,_Df:SBDL_Requirement,_Dg:SBDL_Requirement,_BD:SBDL_Function,_Dh:SBDL_Event,_Di:SBDL_Event,_Dj:SBDL_State,_Dk:SBDL_State,_BE:SBDL_Transition,_Dl:SBDL_Event}
		for elem in expected_elem_type:0
	def test_existence_semantic_relation(self):
		relations_between={_De:_BB,_BC:_BA,_Df:_BC,_Dg:_BB,_BD:_BA,_Dh:_BD,_Di:_Dl,_Dj:_BE,_Dk:_BE}
...
def init_profiling():
	global main,main_original;profile_output=get_config_value(_CO);profile_output_mem=get_config_value(_u)
	def wrap_main(ARGS):
	...
	if profile_output_mem is not _B:f_print(f"Profiling memory to: {profile_output_mem}",warning=_A,do_warning=_A);lazy_import(_BF).start()
def add_profile_mem_snapshot(snapshot_name):
	if get_config_value(_u)is not _B:add_to_config_value(_v,{snapshot_name:lazy_import(_BF,'Tracemalloc not available').take_snapshot()})
...
def deinit_profiling():
	...
	if profile_output_mem is not _B:
		tracemalloc=lazy_import(_BF);current,peak=tracemalloc.get_traced_memory();tracemalloc.stop()
