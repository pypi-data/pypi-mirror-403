...
```python
from pytoolsbox.maillToPhone import send_email
...
你需要在下列任一位置创建 email_config.yaml：

1. 与脚本同目录  
2. 或用户目录：  
   - Windows: `C:\Users\<用户名>\.email_config.yaml`  
   - Linux/Mac: `~/.email_config.yaml`
