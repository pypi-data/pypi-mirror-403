...
3. For this project, commonly useful agents include:
   - **code-quality-pragmatist**: Run after implementing features to check for over-engineering
   - **claude-md-compliance-checker**: Run before committing to verify CLAUDE.md compliance
   - **task-completion-validator**: Verify implementations actually work
4. LogicMonitor MCP server is available for API schema lookups and direct portal queries
...
- Github repo: <https://github.com/ryanmat/quantum_mcp>
...
## Project Scope (Updated 2026-01-22)

This project focuses exclusively on:
- **Quantum Computing** - Azure Quantum integration (VQE, QAOA, Kernels, Q#)
- **Multi-Agent Orchestration** - Routing, consensus, task decomposition
- **Quantum-Enhanced Orchestration** - QUBO/QAOA-based agent routing

X-DEC metric intelligence has been migrated to the **predictive-insights** project,
which has a superior Temporal X-DEC implementation (BiGRU-XVAE-DEC).

See: /Users/ryan.matuszewski/dev/repositories/ai/predictive-insights

## Related Projects

- **predictive-insights** - Metric prediction with Temporal X-DEC (Phases 9-16)
- Future integration planned when predictive-insights reaches Phase 14 (MoE)
