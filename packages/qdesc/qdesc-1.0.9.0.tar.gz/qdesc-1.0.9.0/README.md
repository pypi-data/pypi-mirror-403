...
![Package Version](https://img.shields.io/badge/version-1.0.9.0-pink)
...
Version 1.0.9.0: Provided docstrings for descriptive statistics functions. See them via function? (i.e., qd.desc?)
