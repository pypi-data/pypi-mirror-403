...
![Package Version](https://img.shields.io/badge/version-1.0.8.9-pink)
...
Version 1.0.8.9: Provided docstrings for descriptive statistics functions. See them via function? (i.e., qd.desc?)
