...
from modelselect.graders.base_grader import BaseGrader, GraderMode, GraderScore
from modelselect.graders.multimodal._internal import MLLMImage, format_image_content
from modelselect.graders.schema import GraderScoreCallback
...
from modelselect.utils.utils import parse_structured_chat_response
...
class TextToImageGrader(BaseGrader):
    ...
    Example:
        >>> import asyncio
        >>> from modelselect.model.openai_llm import OpenAIChatModel
        >>> from modelselect.multimodal import TextToImageGrader, MLLMImage
        >>>
    ...
    async def aevaluate(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            from modelselect.graders.base_grader import GraderError
