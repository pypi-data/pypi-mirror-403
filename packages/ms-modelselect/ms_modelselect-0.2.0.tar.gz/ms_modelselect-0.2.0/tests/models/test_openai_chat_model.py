...
from modelselect.models.openai_chat_model import (
    OpenAIChatModel,
...
class TestOpenAIChatModel:
    ...
    def setup(self):
        ...
        with patch("modelselect.models.openai_chat_model.AsyncOpenAI"):
    ...
    @patch("modelselect.models.openai_chat_model.AsyncOpenAI")
    def test_achat_with_valid_messages(self, mock_async_openai):
        ...
        with patch(
            "modelselect.models.openai_chat_model.AsyncOpenAI",
