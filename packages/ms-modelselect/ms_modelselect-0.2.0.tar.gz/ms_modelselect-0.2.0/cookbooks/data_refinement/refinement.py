...
from modelselect.graders.schema import GraderMode, GraderResult
...
class LLMRefinement(ABC):
    ...
    Example:
        >>> from modelselect.graders import LLMPairwiseGrader
        >>> from modelselect.models import QwenChatModel
