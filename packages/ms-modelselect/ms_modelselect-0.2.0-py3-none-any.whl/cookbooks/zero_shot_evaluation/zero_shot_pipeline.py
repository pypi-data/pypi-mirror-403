...
of AI models without labeled data. It integrates with ModelSelect's core
...
# ModelSelect core components
from modelselect.analyzer import PairwiseAnalysisResult, PairwiseAnalyzer
...
from modelselect.graders.schema import GraderError, GraderResult
...
class ZeroShotPipeline:
    ...
    The pipeline integrates with ModelSelect's core components:
    - Uses TaskBasedRubricGenerator from modelselect.generator.simple_rubric for rubric generation
    - Uses PairwiseAnalyzer from modelselect.analyzer for result analysis
    ...
    async def generate_rubrics(
        ...
        """Step 3: Generate evaluation rubrics using ModelSelect's TaskBasedRubricGenerator."""
        ...
        # Use ModelSelect's TaskBasedRubricGenerator
    ...
    def _analyze_results(
        ...
        """Analyze pairwise comparison results using ModelSelect's PairwiseAnalyzer."""
        # Use ModelSelect's PairwiseAnalyzer for analysis
    ...
    async def evaluate(
        ...
        # Step 5: Analyze results using ModelSelect's PairwiseAnalyzer
