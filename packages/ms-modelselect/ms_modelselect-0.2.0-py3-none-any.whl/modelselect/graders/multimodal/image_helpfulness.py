...
from modelselect.graders.base_grader import GraderMode, GraderScore
from modelselect.graders.llm_grader import LLMGrader
from modelselect.graders.multimodal._internal import (
    MLLMImage,
...
class ImageHelpfulnessGrader(LLMGrader):
    ...
    Example:
        ...
        >>> from modelselect.multimodal import ImageHelpfulnessGrader, MLLMImage
        >>>
