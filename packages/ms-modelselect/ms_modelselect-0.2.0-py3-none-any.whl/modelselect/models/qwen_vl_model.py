...
from modelselect.models.schema.qwen.mllmImage import MLLMImage
...
class QwenVLModel(BaseChatModel):
    ...
    Example:
        >>> from modelselect.models import QwenVLModel
        >>> from modelselect.models.schema.qwen.mllmImage import MLLMImage
        >>>
        >>> # Initialize
        >>> model = QwenVLModel(
    ...
    def generate(
        ...
        try:
            ...
            if output_schema:
                from modelselect.utils.utils import trim_and_load_json
