...
from modelselect.analyzer.validation import AccuracyAnalyzer
from modelselect.graders.agent import ToolCallAccuracyGrader
...
class TestToolCallAccuracyGraderUnit:
    ...
    async def test_successful_evaluation_accurate_call(self):
        ...
        with patch("modelselect.graders.llm_grader.BaseChatModel.achat", new_callable=AsyncMock) as mock_achat:
