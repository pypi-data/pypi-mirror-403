...
For users comfortable with the command line. Handles Python detection and Claude Desktop configuration.

**macOS / Linux:**

```bash
curl -fsSL https://raw.githubusercontent.com/UNCTAD-eRegistrations/mcp-eregistrations-bpa/main/scripts/install.sh | bash
```

**Windows (PowerShell):**

```powershell
irm https://raw.githubusercontent.com/UNCTAD-eRegistrations/mcp-eregistrations-bpa/main/scripts/install.ps1 | iex
```
...
```bash
# macOS/Linux
curl -fsSL https://raw.githubusercontent.com/UNCTAD-eRegistrations/mcp-eregistrations-bpa/main/scripts/install.sh | bash -s -- --instance nigeria

# Windows
.\install.ps1 -Instance nigeria
```
