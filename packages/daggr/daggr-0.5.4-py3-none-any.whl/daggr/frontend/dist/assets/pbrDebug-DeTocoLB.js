import{G as e}from"./index-C7ioxznG.js";import"./mainUVVaryingDeclaration-DyTCb55a.js";import"./shadowsFragmentFunctions-BSqBDJBV.js";const t="pbrFragmentExtraDeclaration",g=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=D);const a="pbrDirectLightingFalloffFunctions",h=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=h);const l="pbrDirectLightingFunctions",L=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=L);const n="pbrIBLFunctions",A=`#if defined(REFLECTION) || defined(SS_REFRACTION)
