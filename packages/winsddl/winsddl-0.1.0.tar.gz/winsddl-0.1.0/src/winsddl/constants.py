...
WELL_KNOWN_SIDS = {
    ...
    "domain-522": "Cloneable Domain Controllers",
    ...
    # App Containers and Security Levels
...
REGISTRY_BASIC_RIGHTS = {
    983103: "Full Control",
    131097: "Read"
}

REGISTRY_ADVANCED_RIGHTS = {
    524288: "Write Owner",
    262144: "Write DAC",
    131072: "Read Control",
    65536: "Delete",
...
FILE_BASIC_RIGHTS = {
    ...
    1179785: "Read / List folder contents",
    1048854: "Write"
}

FILE_ADVANCED_RIGHTS = {
    ...
    128: "Read Attributes",
    64: "Delete Subfolders and Files",
...
FILE_GENERIC_TO_BASIC = {
    0x10000000: "Full Control",
    0xA0000000: "Read & Execute",
    0x80000000: "Read / List folder contents",
    0x40000000: "Write"
}
...
ADOBJECT_BASIC_RIGHTS = {
    983551: "Full Control",
    131092: "Read",
    256: "All extended rights",
    40: "Write",
    3: "Create/Delete child objects",
    2: "Delete all child objects",
    1: "Create all child objects"
}

ADOBJECT_ADVANCED_RIGHTS = {
    524288: "Modify owner",
    262144: "Modify permissions",
    131072: "Read permissions",
    65536: "Delete",
    64: "Delete subtree",
    32: "Write all properties",
    16: "Read all properties",
    8: "All validated writes",
    4: "List contents"
}

ADOBJECT_GENERIC_TO_BASIC = {
    0x10000000: "Full Control",
    0x20000000: "Execute",
    0x80000000: "Read",
    0x40000000: "Write"
...
FILE_INHERITANCE_MAP = {
    (True,  True,  True):  "This folder, subfolders and files",
    (True,  True,  False): "This folder and subfolders",
    (True,  False, True):  "This folder and files",
    (False, True,  True):  "Subfolders and files only",
    (False, True,  False): "Subfolders only",
    (False, False, True):  "Files only",
    (True,  False, False): "This folder only",
}
