...
class Error(Exception):
    """Base error class for RFmx WLAN."""
...
class DriverNotInstalledError(Error):
    ...
    def __init__(self):
        """An error due to using this module without the driver runtime installed."""
        super(DriverNotInstalledError, self).__init__("The RFmx WLAN runtime could not be loaded. Make sure it is installed and its bitness matches that of your Python interpreter. Please visit http://www.ni.com/downloads/drivers/ to download and install it.")  # type: ignore


class DriverTooOldError(Error):
    """An error due to using this module with an older version of the RFmx WLAN driver runtime."""

    def __init__(self):
        """An error due to using this module with an older version of the RFmx WLAN driver runtime."""
        super(DriverTooOldError, self).__init__("A function was not found in the RFmx WLAN runtime. Please visit http://www.ni.com/downloads/drivers/ to download a newer version and install it.")  # type: ignore


class DriverTooNewError(Error):
    """An error due to the RFmx WLAN driver runtime being too new for this module."""

    def __init__(self):
        """An error due to the RFmx WLAN driver runtime being too new for this module."""
        super(DriverTooNewError, self).__init__("The RFmx WLAN runtime returned an unexpected value. This can occur if it is too new for the nirfmxwlan Python module. Upgrade the nirfmxwlan Python module.")  # type: ignore
...
def handle_error(
    ...
    r"""Helper function for handling errors returned by RFmx WLAN Library.
