...
def build_gate_string(selector_string, gate_number):
    """Builds a gate string."""
    gate_number_string = append_number(gate_number_prefix, gate_number, selector_string)
    return gate_number_string
...
def build_stream_string(selector_string, stream_number):
    ...
    stream_number_string = append_number(stream_number_prefix, stream_number, selector_string)
    return stream_number_string
