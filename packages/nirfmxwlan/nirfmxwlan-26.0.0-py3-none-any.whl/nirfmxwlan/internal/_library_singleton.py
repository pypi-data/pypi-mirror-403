...
import nirfmxwlan.internal._library as _library

_instance = None
_instance_lock = threading.Lock()
_library_info = {"Windows": {"64bit": {"name": "niRFmxWLAN.dll", "type": "cdll"}}}
...
def get() -> Any:
    """Returns the library.Library singleton for nirfmxwlan."""
    global _instance
