...
# Import and add preferences subcommand group
try:
    from .config_cmd import app as prefs_app
except ImportError:
    from bpsai_pair.commands.config_cmd import app as prefs_app

app.add_typer(prefs_app, name="prefs", help="Manage global user preferences")
