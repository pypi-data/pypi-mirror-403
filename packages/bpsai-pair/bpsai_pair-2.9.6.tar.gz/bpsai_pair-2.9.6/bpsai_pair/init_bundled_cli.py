...
# Files that contain cookiecutter template variables and need special handling.
# These are skipped during bundled copy; ensure_v2_config() generates them properly.
SKIP_FILES = {"config.yaml", "config.yml"}
