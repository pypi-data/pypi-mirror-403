...
VALID_MODELS = {"claude-sonnet-4", "claude-opus-4", "claude-haiku"}
...
class BudgetConfigRequest(BaseModel):
    ...
    navigator_model: str = "claude-sonnet-4"
    driver_model: str = "claude-sonnet-4"
    reviewer_model: str = "claude-haiku"
