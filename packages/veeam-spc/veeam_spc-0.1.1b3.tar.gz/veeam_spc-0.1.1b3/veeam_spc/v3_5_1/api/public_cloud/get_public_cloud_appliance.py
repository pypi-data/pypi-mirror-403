...
) -> Union[Any, ErrorResponse, GetPublicCloudApplianceResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetPublicCloudApplianceResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetPublicCloudApplianceResponse200]]:
    """Get Veeam Backup for Public Clouds Appliance Registered on Veeam Cloud Connect Site
