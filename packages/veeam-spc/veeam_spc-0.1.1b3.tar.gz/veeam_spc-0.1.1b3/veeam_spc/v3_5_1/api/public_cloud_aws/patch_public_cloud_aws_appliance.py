...
from ...models.patch_public_cloud_aws_appliance_response_200 import PatchPublicCloudAwsApplianceResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/infrastructure/sites/{site_uid}/publicCloud/aws/appliances/{appliance_uid}",
    }
...
) -> Union[Any, ErrorResponse, PatchPublicCloudAwsApplianceResponse200]:
    if response.status_code == 200:
        response_200 = PatchPublicCloudAwsApplianceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchPublicCloudAwsApplianceResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchPublicCloudAwsApplianceResponse200]]:
    """Modify Veeam Backup for AWS Appliance
