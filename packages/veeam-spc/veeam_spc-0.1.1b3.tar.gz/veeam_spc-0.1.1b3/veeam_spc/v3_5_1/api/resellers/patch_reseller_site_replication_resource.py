...
from ...models.patch_reseller_site_replication_resource_response_200 import (
...
) -> Union[Any, ErrorResponse, PatchResellerSiteReplicationResourceResponse200]:
    if response.status_code == 200:
        response_200 = PatchResellerSiteReplicationResourceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchResellerSiteReplicationResourceResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchResellerSiteReplicationResourceResponse200]]:
    """Modify Reseller Replication Resource
