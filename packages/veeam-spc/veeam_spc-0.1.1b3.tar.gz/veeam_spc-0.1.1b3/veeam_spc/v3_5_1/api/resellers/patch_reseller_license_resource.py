...
from ...models.patch_reseller_license_resource_response_200 import PatchResellerLicenseResourceResponse200
...
) -> Union[Any, ErrorResponse, PatchResellerLicenseResourceResponse200]:
    if response.status_code == 200:
        response_200 = PatchResellerLicenseResourceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchResellerLicenseResourceResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchResellerLicenseResourceResponse200]]:
    """Modify License Management Resource Allocated to Reseller
