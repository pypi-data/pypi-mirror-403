...
) -> Union[Any, ErrorResponse, GetTimeZonesResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetTimeZonesResponse200]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Time Zones
     ...
     Returns a collection resource representation of all time zones.
...
def sync(
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetTimeZonesResponse200]]:
    """Get Time Zones
