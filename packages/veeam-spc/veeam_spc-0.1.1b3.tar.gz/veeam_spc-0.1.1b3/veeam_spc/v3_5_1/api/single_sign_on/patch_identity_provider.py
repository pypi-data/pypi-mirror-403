...
from ...models.patch_identity_provider_response_200 import PatchIdentityProviderResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/organizations/{organization_uid}/identityProviders/{identity_provider_name}",
    }
...
) -> Union[Any, ErrorResponse, PatchIdentityProviderResponse200]:
    if response.status_code == 200:
        response_200 = PatchIdentityProviderResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchIdentityProviderResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchIdentityProviderResponse200]]:
    """Modify Organization Identity Provider
