...
from ...models.patch_backup_agent_response_200 import PatchBackupAgentResponse200
...
) -> Union[Any, ErrorResponse, PatchBackupAgentResponse200]:
    if response.status_code == 200:
        response_200 = PatchBackupAgentResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchBackupAgentResponse200]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Modify Backup Agent
     ...
     Modifies Veeam backup agent with the specified UID.
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchBackupAgentResponse200]]:
    """Modify Backup Agent
