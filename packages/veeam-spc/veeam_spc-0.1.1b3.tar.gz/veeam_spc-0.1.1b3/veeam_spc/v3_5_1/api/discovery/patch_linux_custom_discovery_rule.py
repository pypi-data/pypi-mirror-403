...
from ...models.patch_linux_custom_discovery_rule_response_200 import PatchLinuxCustomDiscoveryRuleResponse200
...
) -> Union[Any, ErrorResponse, PatchLinuxCustomDiscoveryRuleResponse200]:
    if response.status_code == 200:
        response_200 = PatchLinuxCustomDiscoveryRuleResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchLinuxCustomDiscoveryRuleResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchLinuxCustomDiscoveryRuleResponse200]]:
    """Modify Import-Based Discovery Rule for Linux
