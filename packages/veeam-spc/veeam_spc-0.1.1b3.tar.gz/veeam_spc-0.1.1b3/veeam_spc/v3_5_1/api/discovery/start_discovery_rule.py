...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/discovery/rules/{rule_uid}/start",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Start Discovery Rule
     ...
     Run discovery by a discovery rule with the specified UID. Returns a positive response when the
    discovery task is added to the internal queue and not when the task is executed.
