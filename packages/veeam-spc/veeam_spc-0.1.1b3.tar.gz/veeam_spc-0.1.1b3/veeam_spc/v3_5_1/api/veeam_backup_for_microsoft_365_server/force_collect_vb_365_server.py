...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/vb365Servers/{vb_365_server_uid}/collect",
    }
...
def sync_detailed(
    ...
    *,
    ...
    > Returns a positive response when the collection task is added to the internal queue and not when
