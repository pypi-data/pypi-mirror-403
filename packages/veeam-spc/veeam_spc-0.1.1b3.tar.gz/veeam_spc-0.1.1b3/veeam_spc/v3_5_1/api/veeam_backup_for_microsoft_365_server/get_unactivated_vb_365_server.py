...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/infrastructure/unactivatedVb365Servers/{unique_uid}",
    }
...
) -> Union[Any, ErrorResponse, GetUnactivatedVb365ServerResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetUnactivatedVb365ServerResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetUnactivatedVb365ServerResponse200]]:
    """Get Unactivated Veeam Backup for Microsoft 365 Server
