...
from ...models.get_vb_365_copy_job_response_200 import GetVb365CopyJobResponse200
...
) -> Union[Any, ErrorResponse, GetVb365CopyJobResponse200]:
    if response.status_code == 200:
        response_200 = GetVb365CopyJobResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetVb365CopyJobResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetVb365CopyJobResponse200]]:
    """Get Veeam Backup for Microsoft 365 Backup Copy Job
