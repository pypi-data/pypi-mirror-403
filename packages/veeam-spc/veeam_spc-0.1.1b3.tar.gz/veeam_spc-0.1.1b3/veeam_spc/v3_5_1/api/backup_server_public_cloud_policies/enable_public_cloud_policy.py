...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/backupServers/publicCloud/policies/{policy_uid}/enable",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Enable Veeam Backup for Public Clouds Policy

     Enables a Veeam Backup for Public Clouds policy with the specified UID.
