...
from ...models.patch_backup_server_response_200 import PatchBackupServerResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/backupServers/{backup_server_uid}/patch",
    }
...
) -> Union[Any, ErrorResponse, PatchBackupServerResponse200]:
    if response.status_code == 200:
        response_200 = PatchBackupServerResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchBackupServerResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchBackupServerResponse200]]:
    """Patch Veeam Backup & Replication on Server
