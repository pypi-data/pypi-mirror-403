...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/organizations/companies/{company_uid}/usage",
        "params": params,
    }
...
) -> Union[Any, ErrorResponse, GetCompanyAggregatedUsageResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetCompanyAggregatedUsageResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetCompanyAggregatedUsageResponse200]]:
    """Get Services Usage by Company
