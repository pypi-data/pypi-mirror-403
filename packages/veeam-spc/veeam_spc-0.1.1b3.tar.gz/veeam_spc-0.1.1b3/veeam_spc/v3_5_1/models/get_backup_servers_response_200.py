...
T = TypeVar("T", bound="GetBackupServersResponse200")


@_attrs_define
class GetBackupServersResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, list['BackupServer']]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, list["BackupServer"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = BackupServer.from_dict(data_item_data)
        ...
        get_backup_servers_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_backup_servers_response_200.additional_properties = d
        return get_backup_servers_response_200
