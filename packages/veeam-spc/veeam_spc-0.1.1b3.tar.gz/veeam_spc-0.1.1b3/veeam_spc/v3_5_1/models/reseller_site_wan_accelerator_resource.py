...
T = TypeVar("T", bound="ResellerSiteWanAcceleratorResource")


@_attrs_define
class ResellerSiteWanAcceleratorResource:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        reseller_site_wan_accelerator_resource = cls(
        ...
        reseller_site_wan_accelerator_resource.additional_properties = d
        return reseller_site_wan_accelerator_resource
