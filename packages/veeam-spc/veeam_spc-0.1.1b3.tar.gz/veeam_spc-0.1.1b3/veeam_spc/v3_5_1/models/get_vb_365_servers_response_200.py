...
T = TypeVar("T", bound="GetVb365ServersResponse200")


@_attrs_define
class GetVb365ServersResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, list['Vb365Server']]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, list["Vb365Server"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = Vb365Server.from_dict(data_item_data)
        ...
        get_vb_365_servers_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_vb_365_servers_response_200.additional_properties = d
        return get_vb_365_servers_response_200
