...
T = TypeVar("T", bound="DownloadPulseLicenseResponse200")


@_attrs_define
class DownloadPulseLicenseResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        download_pulse_license_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        download_pulse_license_response_200.additional_properties = d
        return download_pulse_license_response_200
