...
T = TypeVar("T", bound="GetDeploymentLogResponse200")


@_attrs_define
class GetDeploymentLogResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, DeploymentLog]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, "DeploymentLog"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = DeploymentLog.from_dict(_data)
        ...
        get_deployment_log_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_deployment_log_response_200.additional_properties = d
        return get_deployment_log_response_200
