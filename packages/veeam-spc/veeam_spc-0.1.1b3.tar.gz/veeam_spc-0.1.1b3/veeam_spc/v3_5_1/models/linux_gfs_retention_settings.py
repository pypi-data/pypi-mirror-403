...
class LinuxGfsRetentionSettings:
    """
    Attributes:
        weekly (Union[Unset, LinuxGfsWeeklyRetentionSettings]):
        monthly (Union[Unset, LinuxGfsMonthlyRetentionSettings]):
        yearly (Union[Unset, LinuxGfsYearlyRetentionSettings]):
    """

    weekly: Union[Unset, "LinuxGfsWeeklyRetentionSettings"] = UNSET
    monthly: Union[Unset, "LinuxGfsMonthlyRetentionSettings"] = UNSET
    yearly: Union[Unset, "LinuxGfsYearlyRetentionSettings"] = UNSET
