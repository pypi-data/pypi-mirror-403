...
T = TypeVar("T", bound="EmbeddedForDiscoveryRuleChildren")


@_attrs_define
class EmbeddedForDiscoveryRuleChildren:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        embedded_for_discovery_rule_children = cls(
            discovery_rule=discovery_rule,
        )

        embedded_for_discovery_rule_children.additional_properties = d
        return embedded_for_discovery_rule_children
