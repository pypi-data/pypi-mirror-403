...
T = TypeVar("T", bound="GetLinuxDiscoveryRuleResponse200")


@_attrs_define
class GetLinuxDiscoveryRuleResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_linux_discovery_rule_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_linux_discovery_rule_response_200.additional_properties = d
        return get_linux_discovery_rule_response_200
