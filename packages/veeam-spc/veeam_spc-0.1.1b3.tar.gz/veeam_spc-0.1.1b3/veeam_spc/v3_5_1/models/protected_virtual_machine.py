...
class ProtectedVirtualMachine:
    """
    Attributes:
        instance_uid (Union[Unset, UUID]): UID assigned to a protected virtual machine.
        ...
        name (Union[Unset, str]): Virtual machine hostname.
        ...
        object_uid (Union[Unset, UUID]): UID assigned to a virtual machine as a job object.
