...
T = TypeVar("T", bound="PublicCloudAzureAddExistingApplianceInputNetwork")


@_attrs_define
class PublicCloudAzureAddExistingApplianceInputNetwork:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        public_cloud_azure_add_existing_appliance_input_network = cls(
            private_network_address=private_network_address,
        )

        public_cloud_azure_add_existing_appliance_input_network.additional_properties = d
        return public_cloud_azure_add_existing_appliance_input_network
