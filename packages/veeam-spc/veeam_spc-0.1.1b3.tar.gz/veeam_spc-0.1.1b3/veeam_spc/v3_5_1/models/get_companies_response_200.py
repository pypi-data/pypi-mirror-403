...
T = TypeVar("T", bound="GetCompaniesResponse200")


@_attrs_define
class GetCompaniesResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_companies_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_companies_response_200.additional_properties = d
        return get_companies_response_200
