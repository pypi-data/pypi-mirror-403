...
T = TypeVar("T", bound="CreatePublicCloudMultipartPatchResponse200")


@_attrs_define
class CreatePublicCloudMultipartPatchResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_public_cloud_multipart_patch_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        create_public_cloud_multipart_patch_response_200.additional_properties = d
        return create_public_cloud_multipart_patch_response_200
