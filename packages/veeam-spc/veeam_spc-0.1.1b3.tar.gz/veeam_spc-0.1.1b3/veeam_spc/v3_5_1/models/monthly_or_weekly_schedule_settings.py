...
class MonthlyOrWeeklyScheduleSettings:
    ...
    Attributes:
        ...
        weekly_on_days (Union[Unset, list[MonthlyOrWeeklyScheduleSettingsWeeklyOnDaysItem]]): Scheduling settings for
    ...
    weekly_on_days: Union[Unset, list[MonthlyOrWeeklyScheduleSettingsWeeklyOnDaysItem]] = UNSET
