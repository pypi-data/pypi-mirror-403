...
class ActiveAlarm:
    ...
    Example:
        {'instanceUid': '08b46982-1160-4804-bb12-6227b521972e', 'alarmTemplateUid':
            ...
            '86477f51-389e-49bb-9480-25dc9abc71d2', 'time': datetime.datetime(2020, 1, 13, 0, 20, 50, 520000,
            tzinfo=datetime.timezone(datetime.timedelta(seconds=3600), '+01:00')), 'status': 'Error', 'message': 'Free space
            (2.55%, 1.01 GB) is below the defined threshold (5%).\n\n', 'remark': '\n\n'}}
