...
T = TypeVar("T", bound="CompanySiteReplicationResourceHardwarePlan")


@_attrs_define
class CompanySiteReplicationResourceHardwarePlan:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_site_replication_resource_hardware_plan = cls(
        ...
        company_site_replication_resource_hardware_plan.additional_properties = d
        return company_site_replication_resource_hardware_plan
