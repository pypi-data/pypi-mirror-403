...
class CreateBackupServerStandardCredentialsResponse200:
    ...
    Attributes:
        ...
        data (Union[Unset, BackupServerCredentialsStandard]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, "BackupServerCredentialsStandard"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = BackupServerCredentialsStandard.from_dict(_data)
