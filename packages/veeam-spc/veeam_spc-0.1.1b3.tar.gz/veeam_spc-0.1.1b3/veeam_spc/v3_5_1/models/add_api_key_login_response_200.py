...
T = TypeVar("T", bound="AddApiKeyLoginResponse200")


@_attrs_define
class AddApiKeyLoginResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_api_key_login_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        add_api_key_login_response_200.additional_properties = d
        return add_api_key_login_response_200
