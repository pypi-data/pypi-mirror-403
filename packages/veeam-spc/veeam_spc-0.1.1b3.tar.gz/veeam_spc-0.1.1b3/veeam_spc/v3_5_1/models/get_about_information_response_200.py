...
T = TypeVar("T", bound="GetAboutInformationResponse200")


@_attrs_define
class GetAboutInformationResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, About]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, "About"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_about_information_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_about_information_response_200.additional_properties = d
        return get_about_information_response_200
