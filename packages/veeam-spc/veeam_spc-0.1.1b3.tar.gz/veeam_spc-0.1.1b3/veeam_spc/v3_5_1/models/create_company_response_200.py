...
T = TypeVar("T", bound="CreateCompanyResponse200")


@_attrs_define
class CreateCompanyResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, Company]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, "Company"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_company_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        create_company_response_200.additional_properties = d
        return create_company_response_200
