...
T = TypeVar("T", bound="CompanySiteReplicationResourceInput")


@_attrs_define
class CompanySiteReplicationResourceInput:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_site_replication_resource_input = cls(
        ...
        company_site_replication_resource_input.additional_properties = d
        return company_site_replication_resource_input
