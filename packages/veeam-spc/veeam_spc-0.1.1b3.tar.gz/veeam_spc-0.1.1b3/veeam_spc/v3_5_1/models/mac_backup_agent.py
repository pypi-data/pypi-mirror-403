...
T = TypeVar("T", bound="MacBackupAgent")


@_attrs_define
class MacBackupAgent:
    """
    Example:
    ...
    Attributes:
        instance_uid (Union[Unset, UUID]): UID assigned to a Veeam Agent for Mac.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mac_backup_agent = cls(
            instance_uid=instance_uid,
            management_agent_uid=management_agent_uid,
        )

        mac_backup_agent.additional_properties = d
        return mac_backup_agent
