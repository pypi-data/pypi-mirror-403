...
class AlarmKnowledge:
    ...
    Attributes:
        summary (Union[Unset, str]): General description of an alarm template.
        cause (Union[Unset, str]): Possible causes of an alarm trigger.
        resolution (Union[Unset, str]): Recommended solutions.
    """
