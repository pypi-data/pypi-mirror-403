...
T = TypeVar("T", bound="GetTenantsResponse200")


@_attrs_define
class GetTenantsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_tenants_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_tenants_response_200.additional_properties = d
        return get_tenants_response_200
