...
class BackupServerCloudDirectorBackupJobApplicationAwareProcessing:
    ...
    Attributes:
        ...
        app_settings (Union[Unset, list['BackupServerCloudDirectorBackupJobApplicationSettings']]): Array of VMware
            Cloud Director objects and their application settings.
    """

    is_enabled: Union[Unset, bool] = False
    app_settings: Union[Unset, list["BackupServerCloudDirectorBackupJobApplicationSettings"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for app_settings_item_data in _app_settings or []:
            app_settings_item = BackupServerCloudDirectorBackupJobApplicationSettings.from_dict(app_settings_item_data)
