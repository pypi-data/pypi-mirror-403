...
T = TypeVar("T", bound="WindowsNetworkBasedDiscoveryRuleInput")


@_attrs_define
class WindowsNetworkBasedDiscoveryRuleInput:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        windows_network_based_discovery_rule_input = cls(
            name=name,
        ...
        windows_network_based_discovery_rule_input.additional_properties = d
        return windows_network_based_discovery_rule_input
