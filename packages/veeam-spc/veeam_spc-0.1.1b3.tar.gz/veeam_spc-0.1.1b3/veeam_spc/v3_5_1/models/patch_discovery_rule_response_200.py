...
T = TypeVar("T", bound="PatchDiscoveryRuleResponse200")


@_attrs_define
class PatchDiscoveryRuleResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, DiscoveryRule]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, "DiscoveryRule"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = DiscoveryRule.from_dict(_data)
        ...
        patch_discovery_rule_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        patch_discovery_rule_response_200.additional_properties = d
        return patch_discovery_rule_response_200
