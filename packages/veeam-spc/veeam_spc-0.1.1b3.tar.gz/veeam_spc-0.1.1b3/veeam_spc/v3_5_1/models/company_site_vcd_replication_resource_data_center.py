...
T = TypeVar("T", bound="CompanySiteVcdReplicationResourceDataCenter")


@_attrs_define
class CompanySiteVcdReplicationResourceDataCenter:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_site_vcd_replication_resource_data_center = cls(
        ...
        company_site_vcd_replication_resource_data_center.additional_properties = d
        return company_site_vcd_replication_resource_data_center
