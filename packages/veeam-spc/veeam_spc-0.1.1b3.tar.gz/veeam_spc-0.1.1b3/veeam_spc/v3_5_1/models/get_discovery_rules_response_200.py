...
T = TypeVar("T", bound="GetDiscoveryRulesResponse200")


@_attrs_define
class GetDiscoveryRulesResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, list['DiscoveryRule']]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, list["DiscoveryRule"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = DiscoveryRule.from_dict(data_item_data)
        ...
        get_discovery_rules_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_discovery_rules_response_200.additional_properties = d
        return get_discovery_rules_response_200
