...
T = TypeVar("T", bound="PatchResellerResponse200")


@_attrs_define
class PatchResellerResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_reseller_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        patch_reseller_response_200.additional_properties = d
        return patch_reseller_response_200
