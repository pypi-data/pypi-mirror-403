...
T = TypeVar("T", bound="CreateResellerResponse200")


@_attrs_define
class CreateResellerResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, Reseller]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, "Reseller"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_reseller_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        create_reseller_response_200.additional_properties = d
        return create_reseller_response_200
