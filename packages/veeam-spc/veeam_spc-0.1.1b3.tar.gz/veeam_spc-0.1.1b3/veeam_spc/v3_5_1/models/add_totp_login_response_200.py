...
T = TypeVar("T", bound="AddTotpLoginResponse200")


@_attrs_define
class AddTotpLoginResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        add_totp_login_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        add_totp_login_response_200.additional_properties = d
        return add_totp_login_response_200
