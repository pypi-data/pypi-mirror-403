...
class BackupServerFileShareJobObjectLastSession:
    ...
    Attributes:
        ...
        source_files_count (Union[Unset, int]): Total number of files in all sources.
        changed_files_count (Union[Unset, int]): Number of processed files.
        ...
        transferred_size (Union[Unset, int]): Total size of backed up file share data, in bytes.
