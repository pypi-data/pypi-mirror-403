...
class PublicCloudFileSharePolicy:
    ...
    Attributes:
        ...
        organization_uid (Union[Unset, UUID]): UID assigned to mapped organization.
        location_uid (Union[Unset, UUID]): UID assigned to a cloud file share policy location.
        ...
        platform_type (Union[Unset, BackupServerPublicCloudAppliancePlatform]): Platform of a Veeam Backup for Public
            Clouds appliance.
        next_run (Union[Unset, datetime.datetime]): Date and time of the next scheduled policy run.
        backup_target_vault_name (Union[Unset, str]): Name of a vault that stores backups.
        backup_copy_target_vault_name (Union[Unset, str]): Name of a vault that stores backup copies.
    """
    ...
    backup_target_vault_name: Union[Unset, str] = UNSET
    backup_copy_target_vault_name: Union[Unset, str] = UNSET
