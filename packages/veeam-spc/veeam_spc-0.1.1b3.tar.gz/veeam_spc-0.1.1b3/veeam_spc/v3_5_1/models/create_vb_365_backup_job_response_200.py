...
T = TypeVar("T", bound="CreateVb365BackupJobResponse200")


@_attrs_define
class CreateVb365BackupJobResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, Vb365BackupJob]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, "Vb365BackupJob"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = Vb365BackupJob.from_dict(_data)
        ...
        create_vb_365_backup_job_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        create_vb_365_backup_job_response_200.additional_properties = d
        return create_vb_365_backup_job_response_200
