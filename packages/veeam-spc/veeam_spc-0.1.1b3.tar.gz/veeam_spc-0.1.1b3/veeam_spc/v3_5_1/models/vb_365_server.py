...
from ..models.vb_365_server_management_agent_status import Vb365ServerManagementAgentStatus
...
class Vb365Server:
    ...
    Attributes:
        ...
        management_agent_status (Union[Unset, Vb365ServerManagementAgentStatus]): Status of a management agent.
    """
    ...
    management_agent_status: Union[Unset, Vb365ServerManagementAgentStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        management_agent_status: Union[Unset, Vb365ServerManagementAgentStatus]
        if isinstance(_management_agent_status, Unset):
            management_agent_status = UNSET
        else:
            management_agent_status = Vb365ServerManagementAgentStatus(_management_agent_status)
