...
def _get_kwargs(
    alarm_uid: UUID,
    *,
    clone_name: Union[Unset, str] = UNSET,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/alarms/templates/{alarm_uid}/clone",
        "params": params,
    }
...
) -> Union[Any, CloneAlarmResponse200, ErrorResponse]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CloneAlarmResponse200, ErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, CloneAlarmResponse200, ErrorResponse]]:
    """Clone Alarm Template
