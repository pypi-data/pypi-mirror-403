...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/sites/{site_uid}/publicCloud/aws/appliances/validate",
    }
...
) -> Union[Any, ErrorResponse, ValidateExistingPublicCloudAwsApplianceConnectionResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, ValidateExistingPublicCloudAwsApplianceConnectionResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, ValidateExistingPublicCloudAwsApplianceConnectionResponse200]]:
    """Validate Veeam Backup for AWS Appliance
