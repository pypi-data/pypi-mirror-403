...
def _get_kwargs(
    *,
    available_to_assign_for_company_uid: Union[Unset, UUID] = UNSET,
    ...
    json_available_to_assign_for_company_uid: Union[Unset, str] = UNSET
...
) -> Union[Any, ErrorResponse, GetBackupPoliciesResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetBackupPoliciesResponse200]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        available_to_assign_for_company_uid (Union[Unset, UUID]):
...
def sync(
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetBackupPoliciesResponse200]]:
    """Get All Backup Policies
