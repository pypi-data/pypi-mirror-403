...
) -> Union[Any, ErrorResponse, GetResellerSiteResourcesResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetResellerSiteResourcesResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetResellerSiteResourcesResponse200]]:
    """Get All Site Resources Allocated to Reseller
