...
from ...models.get_resellers_aggregated_usage_response_200 import GetResellersAggregatedUsageResponse200
...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/organizations/resellers/usage",
        "params": params,
    }
...
) -> Union[Any, ErrorResponse, GetResellersAggregatedUsageResponse200]:
    if response.status_code == 200:
        response_200 = GetResellersAggregatedUsageResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetResellersAggregatedUsageResponse200]]:
    return Response(
...
def sync(
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetResellersAggregatedUsageResponse200]]:
    """Get Services Usage by All Resellers
