...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/infrastructure/backupServers/{backup_server_uid}/publicCloud/policies/databases/objects",
        "params": params,
    }
...
) -> Union[Any, ErrorResponse, GetPublicCloudDatabasePoliciesObjectsByServerResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetPublicCloudDatabasePoliciesObjectsByServerResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetPublicCloudDatabasePoliciesObjectsByServerResponse200]]:
    """Get Objects of All Veeam Backup for Public Clouds Database Policies Configured on Veeam Backup &
    Replication Server
