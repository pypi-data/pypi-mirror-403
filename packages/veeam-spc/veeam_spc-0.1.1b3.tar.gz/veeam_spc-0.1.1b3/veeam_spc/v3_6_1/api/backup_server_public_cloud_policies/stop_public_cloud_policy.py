...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/backupServers/publicCloud/policies/{policy_uid}/stop",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Stop Veeam Backup for Public Clouds Policy

     Stops a Veeam Backup for Public Clouds policy with the specified UID.
