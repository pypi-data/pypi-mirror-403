...
from ...models.patch_public_cloud_azure_appliance_response_200 import PatchPublicCloudAzureApplianceResponse200
...
) -> Union[Any, ErrorResponse, PatchPublicCloudAzureApplianceResponse200]:
    if response.status_code == 200:
        response_200 = PatchPublicCloudAzureApplianceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchPublicCloudAzureApplianceResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchPublicCloudAzureApplianceResponse200]]:
    """Modify Veeam Backup for Microsoft Azure Appliance
