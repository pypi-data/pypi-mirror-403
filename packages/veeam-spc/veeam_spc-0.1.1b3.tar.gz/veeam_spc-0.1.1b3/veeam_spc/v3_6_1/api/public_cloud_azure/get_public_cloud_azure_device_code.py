...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/infrastructure/sites/{site_uid}/publicCloud/azure/accounts/deviceCode",
        "params": params,
    }
...
) -> Union[Any, ErrorResponse, GetPublicCloudAzureDeviceCodeResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetPublicCloudAzureDeviceCodeResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetPublicCloudAzureDeviceCodeResponse200]]:
    """Get Device Authentication Code
