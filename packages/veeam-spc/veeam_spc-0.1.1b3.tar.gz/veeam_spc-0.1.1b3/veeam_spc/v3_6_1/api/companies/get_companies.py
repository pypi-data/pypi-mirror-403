...
) -> Union[Any, ErrorResponse, GetCompaniesResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetCompaniesResponse200]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get All Companies
     ...
     Returns a collection resource representation of all companies managed in Veeam Service Provider
    Console.
...
def sync(
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetCompaniesResponse200]]:
    """Get All Companies
