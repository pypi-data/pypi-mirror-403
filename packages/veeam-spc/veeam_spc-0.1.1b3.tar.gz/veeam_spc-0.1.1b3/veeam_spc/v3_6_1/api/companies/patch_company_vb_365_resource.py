...
from ...models.patch_company_vb_365_resource_response_200 import PatchCompanyVb365ResourceResponse200
...
) -> Union[Any, ErrorResponse, PatchCompanyVb365ResourceResponse200]:
    if response.status_code == 200:
        response_200 = PatchCompanyVb365ResourceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchCompanyVb365ResourceResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchCompanyVb365ResourceResponse200]]:
    """Modify Company Veeam Backup for Microsoft 365 Resource
