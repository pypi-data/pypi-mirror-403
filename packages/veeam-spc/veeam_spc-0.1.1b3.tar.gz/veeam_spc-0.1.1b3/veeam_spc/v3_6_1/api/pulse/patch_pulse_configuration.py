...
from ...models.patch_pulse_configuration_response_200 import PatchPulseConfigurationResponse200
...
) -> Union[Any, ErrorResponse, PatchPulseConfigurationResponse200]:
    if response.status_code == 200:
        response_200 = PatchPulseConfigurationResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchPulseConfigurationResponse200]]:
    return Response(
...
def sync(
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchPulseConfigurationResponse200]]:
    """Modify VCSP Pulse Configuration
