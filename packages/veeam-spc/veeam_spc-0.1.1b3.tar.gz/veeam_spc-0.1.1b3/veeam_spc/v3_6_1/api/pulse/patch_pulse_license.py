...
from ...models.patch_pulse_license_response_200 import PatchPulseLicenseResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/pulse/licenses/{license_uid}",
    }
...
) -> Union[Any, ErrorResponse, PatchPulseLicenseResponse200]:
    if response.status_code == 200:
        response_200 = PatchPulseLicenseResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchPulseLicenseResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchPulseLicenseResponse200]]:
    """Modify License Managed in VCSP Pulse
