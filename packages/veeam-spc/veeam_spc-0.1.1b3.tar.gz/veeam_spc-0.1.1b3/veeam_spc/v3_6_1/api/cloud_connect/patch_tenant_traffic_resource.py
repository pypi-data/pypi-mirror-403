...
from ...models.patch_tenant_traffic_resource_response_200 import PatchTenantTrafficResourceResponse200
...
) -> Union[Any, ErrorResponse, PatchTenantTrafficResourceResponse200]:
    if response.status_code == 200:
        response_200 = PatchTenantTrafficResourceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchTenantTrafficResourceResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchTenantTrafficResourceResponse200]]:
    """Modify Tenant Traffic Resource
