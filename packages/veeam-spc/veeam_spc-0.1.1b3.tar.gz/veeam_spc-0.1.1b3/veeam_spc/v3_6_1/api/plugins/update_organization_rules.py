...
from ...models.update_plugin_organization_rules_request import UpdatePluginOrganizationRulesRequest
...
def _get_kwargs(
    plugin_id: UUID,
    *,
    body: UpdatePluginOrganizationRulesRequest,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/plugins/{plugin_id}/organizations",
    }
