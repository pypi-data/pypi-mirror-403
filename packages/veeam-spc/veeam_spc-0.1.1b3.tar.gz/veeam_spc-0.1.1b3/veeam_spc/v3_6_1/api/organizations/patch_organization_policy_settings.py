...
from ...models.patch_organization_policy_settings_response_200 import PatchOrganizationPolicySettingsResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/organizations/{organization_uid}/configuration/policy",
    }
...
) -> Union[Any, ErrorResponse, PatchOrganizationPolicySettingsResponse200]:
    if response.status_code == 200:
        response_200 = PatchOrganizationPolicySettingsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchOrganizationPolicySettingsResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchOrganizationPolicySettingsResponse200]]:
    """Modify Organization Policy Settings
