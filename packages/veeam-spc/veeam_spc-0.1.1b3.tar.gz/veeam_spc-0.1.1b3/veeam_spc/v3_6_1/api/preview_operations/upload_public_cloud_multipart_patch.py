...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/sites/{site_uid}/publicCloud/appliances/patches/upload/multipart/uploadPart",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Upload Patch File Chunk to Veeam Backup for Public Clouds Appliances Registered on Veeam Cloud
    Connect Site

     Uploads a patch file chunk to Veeam Backup for Public Clouds appliances registered on a Veeam Cloud
