...
) -> Union[Any, CreatePublicCloudGoogleAccountResponse200, ErrorResponse]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CreatePublicCloudGoogleAccountResponse200, ErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, CreatePublicCloudGoogleAccountResponse200, ErrorResponse]]:
    """Create Google Cloud Account
