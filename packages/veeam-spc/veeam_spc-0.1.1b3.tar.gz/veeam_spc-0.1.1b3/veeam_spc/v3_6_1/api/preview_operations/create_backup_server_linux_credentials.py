...
def _get_kwargs(
    ...
    *,
    body: Union["BackupServerCredentialsLinuxInputType0", None],
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/backupServers/{backup_server_uid}/credentials/linux",
    }
...
) -> Union[Any, CreateBackupServerLinuxCredentialsResponse200, ErrorResponse]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CreateBackupServerLinuxCredentialsResponse200, ErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, CreateBackupServerLinuxCredentialsResponse200, ErrorResponse]]:
    """Add Veeam Backup & Replication Server Linux Credentials
