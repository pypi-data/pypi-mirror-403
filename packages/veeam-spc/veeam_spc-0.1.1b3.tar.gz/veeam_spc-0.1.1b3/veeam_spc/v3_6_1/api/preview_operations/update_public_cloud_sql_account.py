...
from ...models.update_public_cloud_sql_account_response_200 import UpdatePublicCloudSqlAccountResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/infrastructure/sites/publicCloud/sqlAccounts/{sql_account_id}",
    }
...
) -> Union[Any, ErrorResponse, UpdatePublicCloudSqlAccountResponse200]:
    if response.status_code == 200:
        response_200 = UpdatePublicCloudSqlAccountResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, UpdatePublicCloudSqlAccountResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, UpdatePublicCloudSqlAccountResponse200]]:
    """Modify Public Cloud SQL Account
