...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/backupAgents/{backup_agent_uid}/deactivate",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Deactivate Backup Agent

     Changes management mode of Veeam backup agent with the specified UID to UnManaged and deletes
    management agent from the agent computer.
