...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/sites/{site_uid}/publicCloud/appliances/{appliance_uid}/upgrade",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Upgrade Veeam Backup for Public Clouds Appliance Registered on Veeam Cloud Connect Site

     Upgrades a Veeam Backup for Public Clouds appliance with the specified UID registered on a Veeam
    Cloud Connect site.
