...
def _get_kwargs(
    ...
    *,
    ...
    json_mapped_organization_uid: Union[None, Unset, str]
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/backupServers/{backup_server_uid}/jobs/backupVmJobs/vSphere",
        "params": params,
    }
...
) -> Union[Any, CreateBackupServerBackupVmVSphereJobResponse200, ErrorResponse]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CreateBackupServerBackupVmVSphereJobResponse200, ErrorResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        backup_server_uid (UUID):
        mapped_organization_uid (Union[None, UUID, Unset]):
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, CreateBackupServerBackupVmVSphereJobResponse200, ErrorResponse]]:
    """Create VMware vSphere VM Backup Job
