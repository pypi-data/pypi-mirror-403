...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/voneServers/{v_one_server_uid}/scheduledTasks/upgrade",
    }
...
) -> Union[Any, ErrorResponse, ScheduleUpgradeVOneServerResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, ScheduleUpgradeVOneServerResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, ScheduleUpgradeVOneServerResponse200]]:
    """Schedule Veeam ONE Update
