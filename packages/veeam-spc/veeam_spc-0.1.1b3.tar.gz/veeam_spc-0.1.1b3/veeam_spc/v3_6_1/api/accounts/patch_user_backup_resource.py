...
from ...models.patch_user_backup_resource_response_200 import PatchUserBackupResourceResponse200
...
) -> Union[Any, ErrorResponse, PatchUserBackupResourceResponse200]:
    if response.status_code == 200:
        response_200 = PatchUserBackupResourceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchUserBackupResourceResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchUserBackupResourceResponse200]]:
    """Modify User Backup Resource
