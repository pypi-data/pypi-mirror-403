...
from ..models.mac_gfs_weekly_retention_settings_use_full_backup_from import (
    MacGfsWeeklyRetentionSettingsUseFullBackupFrom,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="MacGfsWeeklyRetentionSettings")


@_attrs_define
class MacGfsWeeklyRetentionSettings:
    """
    Attributes:
        keep_weekly_backups_for_weeks (int): Number of weeks during which restore points must not be modified or
            deleted. Default: 1.
        use_full_backup_from (Union[Unset, MacGfsWeeklyRetentionSettingsUseFullBackupFrom]): Week day when Veeam Backup
            & Replication must assign the weekly GFS flag to a full restore point. Default:
            MacGfsWeeklyRetentionSettingsUseFullBackupFrom.SUNDAY.
    """

    keep_weekly_backups_for_weeks: int = 1
    use_full_backup_from: Union[Unset, MacGfsWeeklyRetentionSettingsUseFullBackupFrom] = (
        MacGfsWeeklyRetentionSettingsUseFullBackupFrom.SUNDAY
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_use_full_backup_from, Unset):
            ...
            use_full_backup_from = MacGfsWeeklyRetentionSettingsUseFullBackupFrom(_use_full_backup_from)

        mac_gfs_weekly_retention_settings = cls(
            keep_weekly_backups_for_weeks=keep_weekly_backups_for_weeks,
            use_full_backup_from=use_full_backup_from,
        )

        mac_gfs_weekly_retention_settings.additional_properties = d
        return mac_gfs_weekly_retention_settings
