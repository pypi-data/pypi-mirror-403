...
from ..models.linux_gfs_yearly_retention_settings_use_monthly_full_backup_for_the_following_month import (
    LinuxGfsYearlyRetentionSettingsUseMonthlyFullBackupForTheFollowingMonth,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="LinuxGfsYearlyRetentionSettings")


@_attrs_define
class LinuxGfsYearlyRetentionSettings:
    """
    Attributes:
        ...
        use_monthly_full_backup_for_the_following_month (Union[Unset,
            LinuxGfsYearlyRetentionSettingsUseMonthlyFullBackupForTheFollowingMonth]): Month when Veeam Backup & Replication
            must assign the yearly GFS flag to a full restore point. Default:
            LinuxGfsYearlyRetentionSettingsUseMonthlyFullBackupForTheFollowingMonth.JAN.
    """

    keep_yearly_backups_for_years: int = 1
    use_monthly_full_backup_for_the_following_month: Union[
        Unset, LinuxGfsYearlyRetentionSettingsUseMonthlyFullBackupForTheFollowingMonth
    ] = LinuxGfsYearlyRetentionSettingsUseMonthlyFullBackupForTheFollowingMonth.JAN
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linux_gfs_yearly_retention_settings = cls(
        ...
        linux_gfs_yearly_retention_settings.additional_properties = d
        return linux_gfs_yearly_retention_settings
