...
class GetSiteWanAcceleratorResourceResponse200:
    """
    Attributes:
        data (SiteWanAcceleratorResource):  Example: {'instanceUid': '447AC327-3D08-4F51-9D36-ECA703D4565A', 'name':
            'BACKUPWANACC01', 'backupServerUid': 'DF997BD3-4AE9-4841-8152-8FF5CC703EAB'}.
        meta (Union['ResponseMetadataType0', None, Unset]):
        errors (Union[None, Unset, list['ResponseError']]):
    """

    data: "SiteWanAcceleratorResource"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = SiteWanAcceleratorResource.from_dict(d.pop("data"))
