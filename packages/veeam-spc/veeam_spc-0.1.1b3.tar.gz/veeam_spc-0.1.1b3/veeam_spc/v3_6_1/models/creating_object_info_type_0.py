...
T = TypeVar("T", bound="CreatingObjectInfoType0")


@_attrs_define
class CreatingObjectInfoType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        creating_object_info_type_0 = cls(
            state=state,
            message=message,
        )

        creating_object_info_type_0.additional_properties = d
        return creating_object_info_type_0
