...
class GetLinuxBackupAgentResponse200:
    """
    Attributes:
        data (LinuxBackupAgent):  Example: {'instanceUid': '82b693e8-2d33-40f3-8991-a26e8bd86158', 'managementAgentUid':
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = LinuxBackupAgent.from_dict(d.pop("data"))
