...
from ..models.mac_synthetic_full_settings_weekly_on_days_type_0_item import (
...
class MacSyntheticFullSettings:
    """
    Attributes:
        schedule_type (Union[Unset, MacSyntheticFullSettingsScheduleType]): Type of periodicity. Default:
            MacSyntheticFullSettingsScheduleType.NOTSCHEDULED.
        monthly (Union[Unset, MacMonthlyScheduleSettings]):
        weekly_on_days (Union[None, Unset, list[MacSyntheticFullSettingsWeeklyOnDaysType0Item]]): Array of the week days
            on which synthetic full backups must be created.
    """

    schedule_type: Union[Unset, MacSyntheticFullSettingsScheduleType] = (
        MacSyntheticFullSettingsScheduleType.NOTSCHEDULED
    )
    monthly: Union[Unset, "MacMonthlyScheduleSettings"] = UNSET
    weekly_on_days: Union[None, Unset, list[MacSyntheticFullSettingsWeeklyOnDaysType0Item]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_weekly_on_days(
            data: object,
        ) -> Union[None, Unset, list[MacSyntheticFullSettingsWeeklyOnDaysType0Item]]:
            if data is None:
                return data
            ...
            try:
                ...
                for weekly_on_days_type_0_item_data in _weekly_on_days_type_0:
                    weekly_on_days_type_0_item = MacSyntheticFullSettingsWeeklyOnDaysType0Item(
                ...
                pass
            return cast(Union[None, Unset, list[MacSyntheticFullSettingsWeeklyOnDaysType0Item]], data)
