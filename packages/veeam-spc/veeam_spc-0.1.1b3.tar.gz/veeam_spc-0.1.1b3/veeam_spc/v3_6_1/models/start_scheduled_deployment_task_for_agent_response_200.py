...
T = TypeVar("T", bound="StartScheduledDeploymentTaskForAgentResponse200")


@_attrs_define
class StartScheduledDeploymentTaskForAgentResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        start_scheduled_deployment_task_for_agent_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        start_scheduled_deployment_task_for_agent_response_200.additional_properties = d
        return start_scheduled_deployment_task_for_agent_response_200
