...
from ..models.backup_server_object_storage_backup_copy_job_retention_unit import (
...
T = TypeVar("T", bound="BackupServerObjectStorageBackupCopyJob")


@_attrs_define
class BackupServerObjectStorageBackupCopyJob:
    """
    Attributes:
        ...
        source_object_storage_backup_job_uid (Union[Unset, UUID]): UID assigned to a source object storage backup job.
        ...
        retention_unit (Union[Unset, BackupServerObjectStorageBackupCopyJobRetentionUnit]): Measurement units of backup
    ...
    source_object_storage_backup_job_uid: Union[Unset, UUID] = UNSET
    target_repository_uid: Union[Unset, UUID] = UNSET
    retention: Union[Unset, int] = UNSET
    retention_unit: Union[Unset, BackupServerObjectStorageBackupCopyJobRetentionUnit] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        source_object_storage_backup_job_uid: Union[Unset, str] = UNSET
        if not isinstance(self.source_object_storage_backup_job_uid, Unset):
            source_object_storage_backup_job_uid = str(self.source_object_storage_backup_job_uid)
        ...
        if source_object_storage_backup_job_uid is not UNSET:
            field_dict["sourceObjectStorageBackupJobUid"] = source_object_storage_backup_job_uid
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _source_object_storage_backup_job_uid = d.pop("sourceObjectStorageBackupJobUid", UNSET)
        source_object_storage_backup_job_uid: Union[Unset, UUID]
        if isinstance(_source_object_storage_backup_job_uid, Unset):
            source_object_storage_backup_job_uid = UNSET
        else:
            source_object_storage_backup_job_uid = UUID(_source_object_storage_backup_job_uid)
        ...
        retention_unit: Union[Unset, BackupServerObjectStorageBackupCopyJobRetentionUnit]
        if isinstance(_retention_unit, Unset):
            retention_unit = UNSET
        else:
            retention_unit = BackupServerObjectStorageBackupCopyJobRetentionUnit(_retention_unit)
        ...
        backup_server_object_storage_backup_copy_job = cls(
            instance_uid=instance_uid,
            unique_uid=unique_uid,
            source_object_storage_backup_job_uid=source_object_storage_backup_job_uid,
        ...
        backup_server_object_storage_backup_copy_job.additional_properties = d
        return backup_server_object_storage_backup_copy_job
