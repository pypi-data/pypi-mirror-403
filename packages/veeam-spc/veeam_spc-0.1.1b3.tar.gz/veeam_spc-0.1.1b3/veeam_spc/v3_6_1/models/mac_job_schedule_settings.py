...
if TYPE_CHECKING:
    ...
    from ..models.mac_synthetic_full_settings import MacSyntheticFullSettings
...
class MacJobScheduleSettings:
    ...
    Attributes:
        ...
        synthetic_full_settings (Union[Unset, MacSyntheticFullSettings]):
    """
    ...
    synthetic_full_settings: Union[Unset, "MacSyntheticFullSettings"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_synthetic_full_settings, Unset):
            ...
            synthetic_full_settings = MacSyntheticFullSettings.from_dict(_synthetic_full_settings)
