...
T = TypeVar("T", bound="BackupServerCloudDirectorBackupJobApplicationSettingsType0")


@_attrs_define
class BackupServerCloudDirectorBackupJobApplicationSettingsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_cloud_director_backup_job_application_settings_type_0 = cls(
            vm_object=vm_object,
            vss=vss,
        ...
        backup_server_cloud_director_backup_job_application_settings_type_0.additional_properties = d
        return backup_server_cloud_director_backup_job_application_settings_type_0
