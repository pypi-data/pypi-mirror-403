...
class GetCloudGatewayResponse200:
    """
    Attributes:
        data (CloudGateway):  Example: {'instanceUid': '81536849-36C5-4044-9DC5-D1393062ADA8', 'name': 'BACKUPCGW01',
            'backupServerUid': 'DF997BD3-4AE9-4841-8152-8FF5CC703EAB', 'port': 10001, 'isOutOfDate': False, 'isDisabled':
            False, 'status': 'Healthy', 'externalPort': 666, 'externalIp': '10.17.26.1'}.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = CloudGateway.from_dict(d.pop("data"))
