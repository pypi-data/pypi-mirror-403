...
from ..models.backup_server_simple_backup_copy_job_retention_policy_type import (
    BackupServerSimpleBackupCopyJobRetentionPolicyType,
)
from ..models.backup_server_simple_backup_copy_job_rpo_options_unit import BackupServerSimpleBackupCopyJobRpoOptionsUnit
...
@_attrs_define
class BackupServerSimpleBackupCopyJob:
    """
    Attributes:
        ...
        yearly_restore_points_to_keep (Union[Unset, int]): Number of years during which the yearly backup must be stored
            on the target repository.
        retention_policy_type (Union[Unset, BackupServerSimpleBackupCopyJobRetentionPolicyType]): Type of a retention
            policy of a backup copy job.
        ...
        rpo_options_unit (Union[Unset, BackupServerSimpleBackupCopyJobRpoOptionsUnit]): Measurement units of a desired
            RPO interval value.
    ...
    retention_policy_type: Union[Unset, BackupServerSimpleBackupCopyJobRetentionPolicyType] = UNSET
    is_rpo_options_enabled: Union[Unset, bool] = UNSET
    rpo_options_value: Union[Unset, int] = UNSET
    rpo_options_unit: Union[Unset, BackupServerSimpleBackupCopyJobRpoOptionsUnit] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        retention_policy_type: Union[Unset, BackupServerSimpleBackupCopyJobRetentionPolicyType]
        if isinstance(_retention_policy_type, Unset):
            retention_policy_type = UNSET
        else:
            retention_policy_type = BackupServerSimpleBackupCopyJobRetentionPolicyType(_retention_policy_type)
        ...
        rpo_options_unit: Union[Unset, BackupServerSimpleBackupCopyJobRpoOptionsUnit]
        ...
        backup_server_simple_backup_copy_job.additional_properties = d
        return backup_server_simple_backup_copy_job
