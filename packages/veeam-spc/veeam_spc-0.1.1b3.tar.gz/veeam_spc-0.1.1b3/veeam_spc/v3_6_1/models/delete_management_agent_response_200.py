...
T = TypeVar("T", bound="DeleteManagementAgentResponse200")
...
class DeleteManagementAgentResponse200:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        data: Union[None, list[dict[str, Any]]]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> Union[None, list["Warning_"]]:
            if data is None:
                return data
            try:
                ...
                pass
            return cast(Union[None, list["Warning_"]], data)
        ...
        delete_management_agent_response_200.additional_properties = d
        return delete_management_agent_response_200
