...
class CloneAlarmResponse200:
    """
    Attributes:
        data (Alarm):  Example: {'instanceUid': 'fcdb7145-3634-4d34-99fd-138879cd9c2c', 'name': 'Job state', 'category':
            'BackupVmJob', 'organizationUid': '39f65b4c-a7d2-451e-936d-aeae418b53e1', 'internalId': 1, 'knowledge':
            {'summary': 'Job is in a disabled state for more than an allowed time period.', 'cause': 'Veeam Backup &
            Replication server allows to disable scheduled backup jobs during maintenance windows. If backup job stays in a
            disabled state for more than an allowed time period, it should be enabled back.', 'resolution': 'Open Veeam
            Backup & Replication console and enable all disabled backup jobs.'}, 'isPredifined': True, 'isEnabled': False}.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = Alarm.from_dict(d.pop("data"))
