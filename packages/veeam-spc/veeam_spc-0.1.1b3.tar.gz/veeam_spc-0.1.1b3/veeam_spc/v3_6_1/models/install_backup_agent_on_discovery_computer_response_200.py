...
T = TypeVar("T", bound="InstallBackupAgentOnDiscoveryComputerResponse200")


@_attrs_define
class InstallBackupAgentOnDiscoveryComputerResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        install_backup_agent_on_discovery_computer_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        install_backup_agent_on_discovery_computer_response_200.additional_properties = d
        return install_backup_agent_on_discovery_computer_response_200
