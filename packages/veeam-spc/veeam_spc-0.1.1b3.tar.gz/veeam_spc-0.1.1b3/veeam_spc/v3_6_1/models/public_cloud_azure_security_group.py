...
T = TypeVar("T", bound="PublicCloudAzureSecurityGroup")


@_attrs_define
class PublicCloudAzureSecurityGroup:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        public_cloud_azure_security_group = cls(
            security_group_id=security_group_id,
            security_group_name=security_group_name,
        )

        public_cloud_azure_security_group.additional_properties = d
        return public_cloud_azure_security_group
