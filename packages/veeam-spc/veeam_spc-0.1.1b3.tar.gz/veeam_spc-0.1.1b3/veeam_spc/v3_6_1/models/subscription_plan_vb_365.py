...
class SubscriptionPlanVb365:
    ...
    Attributes:
        ...
        remote_free_standard_storage_used_space (Union[None, Unset, int]): Amount of disk space consumed by remote
            Microsoft 365 backups that is processed for free.
        ...
        remote_free_archive_storage_used_space (Union[None, Unset, int]): Amount of remote archive repository disk space
        ...
        hosted_free_standard_storage_used_space (Union[None, Unset, int]): Amount of disk space consumed by hosted
            Microsoft 365 backups that is processed for free.
            > Maximum value is `1048576` for GB and `1024` for TB.
        ...
        hosted_free_archive_storage_used_space (Union[None, Unset, int]): Amount of hosted archive repository disk space
            consumed by Microsoft 365 backup copies that is processed for free.
            > Maximum value is `1048576` for GB and `1024` for TB.
    ...
    remote_free_standard_storage_used_space: Union[None, Unset, int] = UNSET
    ...
    remote_free_archive_storage_used_space: Union[None, Unset, int] = UNSET
    ...
    hosted_free_standard_storage_used_space: Union[None, Unset, int] = UNSET
    ...
    hosted_free_archive_storage_used_space: Union[None, Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        remote_free_standard_storage_used_space: Union[None, Unset, int]
        ...
        remote_free_archive_storage_used_space: Union[None, Unset, int]
        ...
        hosted_free_standard_storage_used_space: Union[None, Unset, int]
        ...
        hosted_free_archive_storage_used_space: Union[None, Unset, int]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_remote_free_standard_storage_used_space(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
        ...
        def _parse_remote_free_archive_storage_used_space(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_hosted_free_standard_storage_used_space(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_hosted_free_archive_storage_used_space(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
