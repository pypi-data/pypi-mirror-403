...
class PublicCloudGoogleNewApplianceInput:
    ...
    Attributes:
        ...
        network (Union['PublicCloudGoogleNewApplianceInputNetworkType0', None, Unset]): Veeam Backup for Google Cloud
    ...
    ip_address: "PublicCloudGoogleNewApplianceInputIpAddress"
    guest_os_credentials: "PublicCloudGoogleNewApplianceInputGuestOsCredentials"
    network: Union["PublicCloudGoogleNewApplianceInputNetworkType0", None, Unset] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_network(data: object) -> Union["PublicCloudGoogleNewApplianceInputNetworkType0", None, Unset]:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(Union["PublicCloudGoogleNewApplianceInputNetworkType0", None, Unset], data)
