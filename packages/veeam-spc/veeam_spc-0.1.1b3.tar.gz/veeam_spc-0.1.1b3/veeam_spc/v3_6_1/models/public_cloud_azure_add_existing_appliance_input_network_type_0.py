...
T = TypeVar("T", bound="PublicCloudAzureAddExistingApplianceInputNetworkType0")


@_attrs_define
class PublicCloudAzureAddExistingApplianceInputNetworkType0:
    """
    Attributes:
        private_network_address (Union[None, Unset, str]): Private IP address or DNS name of a network.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        public_cloud_azure_add_existing_appliance_input_network_type_0 = cls(
            private_network_address=private_network_address,
        )

        public_cloud_azure_add_existing_appliance_input_network_type_0.additional_properties = d
        return public_cloud_azure_add_existing_appliance_input_network_type_0
