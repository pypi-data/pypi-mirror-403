...
from ..models.mac_backup_health_check_schedule_settings_weekly_on_days_type_0_item import (
...
class MacBackupHealthCheckScheduleSettings:
    ...
    Attributes:
        ...
        weekly_on_days (Union[None, Unset, list[MacBackupHealthCheckScheduleSettingsWeeklyOnDaysType0Item]]): Scheduling
    ...
    weekly_on_days: Union[None, Unset, list[MacBackupHealthCheckScheduleSettingsWeeklyOnDaysType0Item]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_weekly_on_days(
            data: object,
        ) -> Union[None, Unset, list[MacBackupHealthCheckScheduleSettingsWeeklyOnDaysType0Item]]:
            if data is None:
                return data
            ...
            try:
                ...
                for weekly_on_days_type_0_item_data in _weekly_on_days_type_0:
                    weekly_on_days_type_0_item = MacBackupHealthCheckScheduleSettingsWeeklyOnDaysType0Item(
                ...
                pass
            return cast(Union[None, Unset, list[MacBackupHealthCheckScheduleSettingsWeeklyOnDaysType0Item]], data)
