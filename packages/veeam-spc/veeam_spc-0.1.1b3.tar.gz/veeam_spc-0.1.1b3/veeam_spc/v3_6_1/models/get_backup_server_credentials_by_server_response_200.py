...
if TYPE_CHECKING:
    from ..models.backup_server_credentials_record_type_0 import BackupServerCredentialsRecordType0
    from ..models.response_error import ResponseError
    from ..models.response_metadata_type_0 import ResponseMetadataType0


T = TypeVar("T", bound="GetBackupServerCredentialsByServerResponse200")


@_attrs_define
class GetBackupServerCredentialsByServerResponse200:
    """
    Attributes:
        data (list[Union['BackupServerCredentialsRecordType0', None]]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        for data_item_data in self.data:
            data_item: Union[None, dict[str, Any]]
            if isinstance(data_item_data, BackupServerCredentialsRecordType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            ...
            def _parse_data_item(data: object) -> Union["BackupServerCredentialsRecordType0", None]:
                if data is None:
                    return data
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    componentsschemas_backup_server_credentials_record_type_0 = (
                        BackupServerCredentialsRecordType0.from_dict(data)
                    )

                    return componentsschemas_backup_server_credentials_record_type_0
                except:  # noqa: E722
                    pass
                return cast(Union["BackupServerCredentialsRecordType0", None], data)
        ...
        get_backup_server_credentials_by_server_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_backup_server_credentials_by_server_response_200.additional_properties = d
        return get_backup_server_credentials_by_server_response_200
