...
class ResellerSiteReplicationResourceInput:
    ...
    Attributes:
        ...
        tenants_per_plan_quota (Union[None, Unset, int]): Maximum number of companies that a reseller can subscribe to a
            hardware plan.
    ...
    tenants_per_plan_quota: Union[None, Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        tenants_per_plan_quota: Union[None, Unset, int]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_tenants_per_plan_quota(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
