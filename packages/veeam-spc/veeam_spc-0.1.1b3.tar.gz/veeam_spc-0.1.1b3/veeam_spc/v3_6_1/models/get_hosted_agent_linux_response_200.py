...
if TYPE_CHECKING:
    from ..models.hosted_agent_linux_save_params import HostedAgentLinuxSaveParams
    from ..models.response_error import ResponseError
    from ..models.response_metadata_type_0 import ResponseMetadataType0


T = TypeVar("T", bound="GetHostedAgentLinuxResponse200")


@_attrs_define
class GetHostedAgentLinuxResponse200:
    """
    Attributes:
        data (HostedAgentLinuxSaveParams):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = HostedAgentLinuxSaveParams.from_dict(d.pop("data"))
        ...
        get_hosted_agent_linux_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_hosted_agent_linux_response_200.additional_properties = d
        return get_hosted_agent_linux_response_200
