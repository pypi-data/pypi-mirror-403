...
class ResellerSiteResource:
    ...
    Attributes:
        ...
        tenants_quota (Union[None, Unset, int]): Maximum number of tenants that a reseller can manage on a Veeam Cloud
            Connect site. Default: 20.
        used_tenants_quota (Union[Unset, int]): Number of tenants that a reseller manages on a Veeam Cloud Connect site.
        is_tenants_quota_unlimited (Union[Unset, bool]): Indicates whether a reseller can manage an unlimited number of
            tenants. Default: False.
    """

    site_uid: UUID
    reseller_uid: Union[Unset, UUID] = UNSET
    tenants_quota: Union[None, Unset, int] = 20
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        tenants_quota: Union[None, Unset, int]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_tenants_quota(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
