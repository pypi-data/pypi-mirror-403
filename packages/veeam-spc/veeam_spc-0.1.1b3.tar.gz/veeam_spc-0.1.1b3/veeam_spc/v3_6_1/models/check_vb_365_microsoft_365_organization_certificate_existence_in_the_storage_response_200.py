...
T = TypeVar("T", bound="CheckVb365Microsoft365OrganizationCertificateExistenceInTheStorageResponse200")


@_attrs_define
class CheckVb365Microsoft365OrganizationCertificateExistenceInTheStorageResponse200:
    """
    Attributes:
        data (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        check_vb_365_microsoft_365_organization_certificate_existence_in_the_storage_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        check_vb_365_microsoft_365_organization_certificate_existence_in_the_storage_response_200.additional_properties = d
        return check_vb_365_microsoft_365_organization_certificate_existence_in_the_storage_response_200
