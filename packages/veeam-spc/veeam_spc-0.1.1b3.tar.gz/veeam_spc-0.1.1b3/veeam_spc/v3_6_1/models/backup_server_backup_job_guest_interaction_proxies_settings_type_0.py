...
T = TypeVar("T", bound="BackupServerBackupJobGuestInteractionProxiesSettingsType0")


@_attrs_define
class BackupServerBackupJobGuestInteractionProxiesSettingsType0:
    ...
    Attributes:
        auto_selection (bool): Indicates whether Veeam Backup & Replication automatically selects the guest interaction
            proxy.
        proxy_ids (Union[None, Unset, list[UUID]]): Array of UIDs assigned to servers that you want to use as
            interaction proxies.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_backup_job_guest_interaction_proxies_settings_type_0 = cls(
            auto_selection=auto_selection,
            proxy_ids=proxy_ids,
        )

        backup_server_backup_job_guest_interaction_proxies_settings_type_0.additional_properties = d
        return backup_server_backup_job_guest_interaction_proxies_settings_type_0
