...
T = TypeVar("T", bound="DisableTenantResponse200")


@_attrs_define
class DisableTenantResponse200:
    """
    Attributes:
        data (CloudTenant):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = CloudTenant.from_dict(d.pop("data"))
        ...
        disable_tenant_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        disable_tenant_response_200.additional_properties = d
        return disable_tenant_response_200
