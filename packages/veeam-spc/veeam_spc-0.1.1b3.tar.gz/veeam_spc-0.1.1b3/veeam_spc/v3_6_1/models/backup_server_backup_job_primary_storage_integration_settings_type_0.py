...
T = TypeVar("T", bound="BackupServerBackupJobPrimaryStorageIntegrationSettingsType0")


@_attrs_define
class BackupServerBackupJobPrimaryStorageIntegrationSettingsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_backup_job_primary_storage_integration_settings_type_0 = cls(
        ...
        backup_server_backup_job_primary_storage_integration_settings_type_0.additional_properties = d
        return backup_server_backup_job_primary_storage_integration_settings_type_0
