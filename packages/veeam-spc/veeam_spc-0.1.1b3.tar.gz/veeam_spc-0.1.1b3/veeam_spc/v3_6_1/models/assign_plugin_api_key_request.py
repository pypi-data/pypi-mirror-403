...
T = TypeVar("T", bound="AssignPluginApiKeyRequest")
...
class AssignPluginApiKeyRequest:
    """
    Attributes:
        api_key (Union[None, Unset, str]): API key that must be assigned to a plugin.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        assign_plugin_api_key_request.additional_properties = d
        return assign_plugin_api_key_request
