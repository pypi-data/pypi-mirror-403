...
T = TypeVar("T", bound="GetTenantReplicationResourcesNetworkApplianceResponse200")


@_attrs_define
class GetTenantReplicationResourcesNetworkApplianceResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_tenant_replication_resources_network_appliance_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_tenant_replication_resources_network_appliance_response_200.additional_properties = d
        return get_tenant_replication_resources_network_appliance_response_200
