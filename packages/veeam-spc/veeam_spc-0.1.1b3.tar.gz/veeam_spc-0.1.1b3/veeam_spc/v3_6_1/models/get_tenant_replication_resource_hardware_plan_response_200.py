...
T = TypeVar("T", bound="GetTenantReplicationResourceHardwarePlanResponse200")


@_attrs_define
class GetTenantReplicationResourceHardwarePlanResponse200:
    """
    Attributes:
        data (TenantReplicationResourceHardwarePlan):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = TenantReplicationResourceHardwarePlan.from_dict(d.pop("data"))
        ...
        get_tenant_replication_resource_hardware_plan_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_tenant_replication_resource_hardware_plan_response_200.additional_properties = d
        return get_tenant_replication_resource_hardware_plan_response_200
