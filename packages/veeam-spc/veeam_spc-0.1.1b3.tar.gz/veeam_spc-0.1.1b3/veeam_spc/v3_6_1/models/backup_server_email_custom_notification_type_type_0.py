...
T = TypeVar("T", bound="BackupServerEmailCustomNotificationTypeType0")


@_attrs_define
class BackupServerEmailCustomNotificationTypeType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_email_custom_notification_type_type_0 = cls(
            subject=subject,
        ...
        backup_server_email_custom_notification_type_type_0.additional_properties = d
        return backup_server_email_custom_notification_type_type_0
