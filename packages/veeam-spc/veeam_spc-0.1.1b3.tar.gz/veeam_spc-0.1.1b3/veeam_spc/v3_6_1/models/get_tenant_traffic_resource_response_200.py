...
T = TypeVar("T", bound="GetTenantTrafficResourceResponse200")


@_attrs_define
class GetTenantTrafficResourceResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_tenant_traffic_resource_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_tenant_traffic_resource_response_200.additional_properties = d
        return get_tenant_traffic_resource_response_200
