...
class WindowsBackupAgentJob:
    ...
    Example:
        {'backupAgentUid': 'CCEB5975-B409-49B5-8ECE-FFFECB13494F', 'name': 'VAW job 2 Cloud', 'configUid':
            ...
            'destination': '\\\\share\\backup\\test', 'restorePoints': 4, 'lastRun': '2018-11-01T10:35:00.0000000+00:00',
            'lastEndTime': '2018-11-01T10:45:00.0000000+00:00', 'lastDuration': 600, 'nextRun':
            '2018-12-01T10:35:00.0000000+00:00', 'avgDuration': 575, 'targetType': 'Local', 'isEnabled': True,
            'schedulingType': 'Periodically', 'failureMessage': '', 'lastModifiedDate': '2018-11-01T10:45:00.0000000+00:00',
            'lastModifiedBy': 'someuser', 'backedUpSize': 12550788}
    ...
    Attributes:
        ...
        name (Union[None, Unset, str]): Name of a Veeam Agent for Microsoft Windows job.
        description (Union[None, Unset, str]): Description of a Veeam Agent for Microsoft Windows job.
        ...
        last_end_time (Union[None, Unset, datetime.datetime]): Date and time when the latest job session finished.
        ...
        schedule_events (Union[Unset, list[WindowsBackupAgentJobScheduleEventsItem]]): Events that trigger the backup
            job launch.
        last_modified_date (Union[None, Unset, datetime.datetime]): Date and time when settings of the backup job were
            last modified.
