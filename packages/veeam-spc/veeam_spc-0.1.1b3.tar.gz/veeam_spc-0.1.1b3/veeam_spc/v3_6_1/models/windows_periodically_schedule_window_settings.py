...
class WindowsPeriodicallyScheduleWindowSettings:
    """
    Attributes:
        schedule_window (Union[None, Unset, list['JobScheduleWindowDay']]): Permitted time window for a job.
    ...
    schedule_window: Union[None, Unset, list["JobScheduleWindowDay"]] = UNSET
    shift_for_minutes: Union[Unset, int] = 0
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        schedule_window: Union[None, Unset, list[dict[str, Any]]]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_schedule_window(data: object) -> Union[None, Unset, list["JobScheduleWindowDay"]]:
            if data is None:
                return data
