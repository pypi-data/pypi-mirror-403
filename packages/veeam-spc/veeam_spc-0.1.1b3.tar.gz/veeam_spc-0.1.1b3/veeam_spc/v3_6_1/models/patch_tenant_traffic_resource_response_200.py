...
if TYPE_CHECKING:
    ...
    from ..models.tenant_traffic_resource import TenantTrafficResource


T = TypeVar("T", bound="PatchTenantTrafficResourceResponse200")


@_attrs_define
class PatchTenantTrafficResourceResponse200:
    """
    Attributes:
        data (TenantTrafficResource):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = TenantTrafficResource.from_dict(d.pop("data"))
        ...
        patch_tenant_traffic_resource_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        patch_tenant_traffic_resource_response_200.additional_properties = d
        return patch_tenant_traffic_resource_response_200
