...
class BackupServerBackupJobGuestProcessing:
    ...
    Attributes:
        app_aware_processing (Union[Unset, BackupServerBackupJobApplicationAwareProcessing]): Application-aware
            processing settings.
        guest_fs_indexing (Union[Unset, BackupServerBackupJobGuestFileSystemIndexing]): Guest OS file indexing.
    ...
    app_aware_processing: Union[Unset, "BackupServerBackupJobApplicationAwareProcessing"] = UNSET
    guest_fs_indexing: Union[Unset, "BackupServerBackupJobGuestFileSystemIndexing"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        app_aware_processing: Union[Unset, BackupServerBackupJobApplicationAwareProcessing]
        ...
        guest_fs_indexing: Union[Unset, BackupServerBackupJobGuestFileSystemIndexing]
