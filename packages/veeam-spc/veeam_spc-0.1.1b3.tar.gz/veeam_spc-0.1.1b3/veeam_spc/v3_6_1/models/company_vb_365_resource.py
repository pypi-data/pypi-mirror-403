...
T = TypeVar("T", bound="CompanyVb365Resource")


@_attrs_define
class CompanyVb365Resource:
    """
    Attributes:
        vb_365_server_uid (UUID): UID assigned to a Veeam Backup for Microsoft 365 server.
        friendly_name (Union[None, str]): Friendly name of a Veeam Backup for Microsoft 365 resource.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_friendly_name(data: object) -> Union[None, str]:
            if data is None:
                return data
        ...
        company_vb_365_resource.additional_properties = d
        return company_vb_365_resource
