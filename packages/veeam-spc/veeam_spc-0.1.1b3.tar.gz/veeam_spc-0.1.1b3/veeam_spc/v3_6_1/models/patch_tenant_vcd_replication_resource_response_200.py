...
T = TypeVar("T", bound="PatchTenantVcdReplicationResourceResponse200")


@_attrs_define
class PatchTenantVcdReplicationResourceResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_tenant_vcd_replication_resource_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        patch_tenant_vcd_replication_resource_response_200.additional_properties = d
        return patch_tenant_vcd_replication_resource_response_200
