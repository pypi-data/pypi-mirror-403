...
T = TypeVar("T", bound="PatchResellerVbrResourceResponse200")


@_attrs_define
class PatchResellerVbrResourceResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_reseller_vbr_resource_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        patch_reseller_vbr_resource_response_200.additional_properties = d
        return patch_reseller_vbr_resource_response_200
