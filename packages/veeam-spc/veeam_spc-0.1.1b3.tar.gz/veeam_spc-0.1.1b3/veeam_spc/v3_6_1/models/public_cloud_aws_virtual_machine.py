...
T = TypeVar("T", bound="PublicCloudAwsVirtualMachine")


@_attrs_define
class PublicCloudAwsVirtualMachine:
    """
    Attributes:
        virtual_machine_id (Union[Unset, str]): ID assigned to an EC2 instance.
        virtual_machine_name (Union[Unset, str]): Name of an EC2 instance.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        public_cloud_aws_virtual_machine = cls(
            virtual_machine_id=virtual_machine_id,
            virtual_machine_name=virtual_machine_name,
        )

        public_cloud_aws_virtual_machine.additional_properties = d
        return public_cloud_aws_virtual_machine
