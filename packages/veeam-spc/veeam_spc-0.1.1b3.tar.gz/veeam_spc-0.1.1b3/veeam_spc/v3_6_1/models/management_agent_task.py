...
class ManagementAgentTask:
    ...
    Attributes:
        ...
        start_time (Union[None, Unset, datetime.datetime]): Start date and time of a management agent task.
        end_time (Union[None, Unset, datetime.datetime]): End date and time of a management agent task.
    """
