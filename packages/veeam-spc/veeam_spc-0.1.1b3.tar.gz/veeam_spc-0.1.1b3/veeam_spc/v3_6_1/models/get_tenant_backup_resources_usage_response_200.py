...
T = TypeVar("T", bound="GetTenantBackupResourcesUsageResponse200")


@_attrs_define
class GetTenantBackupResourcesUsageResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_tenant_backup_resources_usage_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_tenant_backup_resources_usage_response_200.additional_properties = d
        return get_tenant_backup_resources_usage_response_200
