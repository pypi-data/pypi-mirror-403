...
class BackupServerLicense:
    ...
    Attributes:
        ...
        monitoring (Union[None, Unset, bool]): Monitoring status.
        ...
        cloud_connect (Union[Unset, BackupServerLicenseCloudConnect]): Indicates whether Veeam Cloud Connect is included
            in a license.
        sockets (Union[None, Unset, float]): Number of licensed sockets.
        used_sockets (Union[None, Unset, float]): Number of used sockets.
        capacity (Union[None, Unset, float]): Available protected capacity for NAS backup.
        used_capacity (Union[None, Unset, float]): Consumed capacity for NAS backup.
    ...
    sockets: Union[None, Unset, float] = UNSET
    used_sockets: Union[None, Unset, float] = UNSET
    capacity: Union[None, Unset, float] = UNSET
    used_capacity: Union[None, Unset, float] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_sockets(data: object) -> Union[None, Unset, float]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_used_sockets(data: object) -> Union[None, Unset, float]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_capacity(data: object) -> Union[None, Unset, float]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_used_capacity(data: object) -> Union[None, Unset, float]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
