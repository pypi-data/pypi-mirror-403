...
class About:
    ...
    Attributes:
        ...
        actual_vaw_version (Union[None, Unset, str]): Current version of Veeam Agent for Windows.
        actual_val_version (Union[None, Unset, str]): Current version of Veeam Agent for Linux.
        actual_vam_version (Union[None, Unset, str]): Current version of Veeam Agent for Mac.
    ...
    actual_vaw_version: Union[None, Unset, str] = UNSET
    actual_val_version: Union[None, Unset, str] = UNSET
    actual_vam_version: Union[None, Unset, str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_actual_vaw_version(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
        ...
        def _parse_actual_val_version(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_actual_vam_version(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
