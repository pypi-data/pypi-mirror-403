...
class BackupAgentSettings:
    ...
    Attributes:
        ...
        bandwidth_speed_limit (Union[None, Unset, int]): Value of maximum speed for transferring backed-up data.
    ...
    bandwidth_speed_limit: Union[None, Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        bandwidth_speed_limit: Union[None, Unset, int]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_bandwidth_speed_limit(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
