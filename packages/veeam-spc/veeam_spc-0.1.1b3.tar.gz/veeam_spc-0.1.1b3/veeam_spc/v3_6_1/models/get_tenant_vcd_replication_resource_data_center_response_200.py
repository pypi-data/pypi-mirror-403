...
T = TypeVar("T", bound="GetTenantVcdReplicationResourceDataCenterResponse200")


@_attrs_define
class GetTenantVcdReplicationResourceDataCenterResponse200:
    """
    Attributes:
        data (TenantVcdReplicationResourceDataCenter):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = TenantVcdReplicationResourceDataCenter.from_dict(d.pop("data"))
        ...
        get_tenant_vcd_replication_resource_data_center_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_tenant_vcd_replication_resource_data_center_response_200.additional_properties = d
        return get_tenant_vcd_replication_resource_data_center_response_200
