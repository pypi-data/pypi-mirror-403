...
T = TypeVar("T", bound="CreateResellerVbrResourceResponse200")


@_attrs_define
class CreateResellerVbrResourceResponse200:
    """
    Attributes:
        data (ResellerVbrResource):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = ResellerVbrResource.from_dict(d.pop("data"))
        ...
        create_reseller_vbr_resource_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        create_reseller_vbr_resource_response_200.additional_properties = d
        return create_reseller_vbr_resource_response_200
