...
class BackupServerMultipartPatchFileInput:
    ...
    Attributes:
        ...
        target_directory (Union[None, Unset, str]): Path to a target directory under %VBR_ROOT%.
    """

    name: str
    file_size: int
    target_directory: Union[None, Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        target_directory: Union[None, Unset, str]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_target_directory(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
