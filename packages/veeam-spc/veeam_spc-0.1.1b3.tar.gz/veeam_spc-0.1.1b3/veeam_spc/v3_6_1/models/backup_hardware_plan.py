...
class BackupHardwarePlan:
    ...
    Attributes:
        ...
        backup_server_uid (Union[Unset, UUID]): UID assigned to a Veeam Backup & Replication server on which a hardware
            plan is configured.
        cpu_quota (Union[None, Unset, int]): Maximum CPU resources that VM replicas can utilize, in MHz.
        is_cpu_quota_unlimited (Union[Unset, bool]): Indicates whether CPU resources that VM replicas can utilize are
            unlimited.
        memory_quota (Union[None, Unset, int]): Maximum RAM resources that VM replicas can utilize, in bytes.
    ...
    cpu_quota: Union[None, Unset, int] = UNSET
    is_cpu_quota_unlimited: Union[Unset, bool] = UNSET
    memory_quota: Union[None, Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        cpu_quota: Union[None, Unset, int]
        ...
        memory_quota: Union[None, Unset, int]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_cpu_quota(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
        ...
        def _parse_memory_quota(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
