...
class PublicCloudAwsAccount:
    ...
    Attributes:
        ...
        secret_key (Union[None, Unset, str]): AWS access secret key.
        description (Union[None, Unset, str]): Description of an AWS account.
        ...
        appliances (Union[None, Unset, list[UUID]]): Array of UIDs assigned to associated Veeam Backup for Public Clouds
            appliances.
    """
    ...
    secret_key: Union[None, Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        secret_key: Union[None, Unset, str]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_secret_key(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
