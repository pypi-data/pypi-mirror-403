...
class PublicCloudRepository:
    ...
    Attributes:
        ...
        creating_state (Union['CreatingObjectInfoType0', None]): Status of a repository creation.
        is_encrypted (Union[None, Unset, bool]): Indicates whether stored data encryption is enabled.
        immutability_enabled (Union[None, Unset, bool]): Indicates whether immutability is enabled.
    """
    ...
    site_name: str
    site_uid: UUID
    creating_state: Union["CreatingObjectInfoType0", None]
    is_encrypted: Union[None, Unset, bool] = UNSET
    immutability_enabled: Union[None, Unset, bool] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        creating_state: Union[None, dict[str, Any]]
        ...
        is_encrypted: Union[None, Unset, bool]
        if isinstance(self.is_encrypted, Unset):
            is_encrypted = UNSET
        else:
            is_encrypted = self.is_encrypted

        immutability_enabled: Union[None, Unset, bool]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_creating_state(data: object) -> Union["CreatingObjectInfoType0", None]:
            if data is None:
                return data
            try:
                ...
                pass
            return cast(Union["CreatingObjectInfoType0", None], data)

        creating_state = _parse_creating_state(d.pop("creatingState"))

        def _parse_is_encrypted(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
        ...
        def _parse_immutability_enabled(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
