...
class GetBackupWanAcceleratorResponse200:
    """
    Attributes:
        data (BackupWanAccelerator):  Example: {'instanceUid': '7eced22b-5e67-45e1-bc00-37e399903bed', 'name':
            'BACKUPWAN01', 'backupServerUid': 'DF997BD3-4AE9-4841-8152-8FF5CC703EAB'}.
        meta (Union['ResponseMetadataType0', None, Unset]):
        errors (Union[None, Unset, list['ResponseError']]):
    """

    data: "BackupWanAccelerator"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = BackupWanAccelerator.from_dict(d.pop("data"))
