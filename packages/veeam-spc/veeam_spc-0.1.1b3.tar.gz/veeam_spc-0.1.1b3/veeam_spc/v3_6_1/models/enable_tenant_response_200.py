...
T = TypeVar("T", bound="EnableTenantResponse200")


@_attrs_define
class EnableTenantResponse200:
    """
    Attributes:
        data (CloudTenant):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        enable_tenant_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        enable_tenant_response_200.additional_properties = d
        return enable_tenant_response_200
