...
class BackupAgentAssignedBackupPolicy:
    ...
    Attributes:
        ...
        backup_policy_id (Union[Unset, int]): System ID assigned to a backup policy.
        ...
        backup_policy_failure_message (Union[Unset, str]): Message that is displayed in case backup policy assignment
            fails.
        backup_policy_revision (Union[None, Unset, int]): Revision of a backup policy.
        assigned_date (Union[None, Unset, datetime.datetime]): Date of the policy assignment.
            > If the backup policy is assigned to a Linux or Mac computer, the value of this property is `null`.
        assigned_by (Union[None, Unset, str]): Organization or user who assigned a backup policy.
            > If the backup policy is assigned to a Linux or Mac computer, the value of this property is `null`.
    """
    ...
    backup_policy_id: Union[Unset, int] = UNSET
    ...
    backup_policy_revision: Union[None, Unset, int] = UNSET
    assigned_date: Union[None, Unset, datetime.datetime] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        backup_policy_revision: Union[None, Unset, int]
        ...
        assigned_date: Union[None, Unset, str]
        ...
        if backup_policy_id is not UNSET:
            field_dict["backupPolicyId"] = backup_policy_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_policy_id = d.pop("backupPolicyId", UNSET)
        ...
        def _parse_backup_policy_revision(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
        ...
        def _parse_assigned_date(data: object) -> Union[None, Unset, datetime.datetime]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
