...
if TYPE_CHECKING:
    from ..models.job_session_heatmap import JobSessionHeatmap
    from ..models.response_error import ResponseError
    from ..models.response_metadata_type_0 import ResponseMetadataType0


T = TypeVar("T", bound="GetJobSessionHeatmapResponse200")


@_attrs_define
class GetJobSessionHeatmapResponse200:
    """
    Attributes:
        data (JobSessionHeatmap):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = JobSessionHeatmap.from_dict(d.pop("data"))
        ...
        get_job_session_heatmap_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_job_session_heatmap_response_200.additional_properties = d
        return get_job_session_heatmap_response_200
