...
T = TypeVar("T", bound="ScheduleInstallVOneServerOnDiscoveryComputerResponse200")


@_attrs_define
class ScheduleInstallVOneServerOnDiscoveryComputerResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        schedule_install_v_one_server_on_discovery_computer_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        schedule_install_v_one_server_on_discovery_computer_response_200.additional_properties = d
        return schedule_install_v_one_server_on_discovery_computer_response_200
