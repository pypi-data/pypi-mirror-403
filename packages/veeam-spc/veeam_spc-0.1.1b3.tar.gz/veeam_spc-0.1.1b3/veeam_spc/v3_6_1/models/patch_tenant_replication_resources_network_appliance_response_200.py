...
T = TypeVar("T", bound="PatchTenantReplicationResourcesNetworkApplianceResponse200")


@_attrs_define
class PatchTenantReplicationResourcesNetworkApplianceResponse200:
    """
    Attributes:
        data (TenantReplicationResourceNetworkAppliance):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = TenantReplicationResourceNetworkAppliance.from_dict(d.pop("data"))
        ...
        patch_tenant_replication_resources_network_appliance_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        patch_tenant_replication_resources_network_appliance_response_200.additional_properties = d
        return patch_tenant_replication_resources_network_appliance_response_200
