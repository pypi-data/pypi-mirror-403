...
if TYPE_CHECKING:
    ...
    from ..models.linux_backup_health_check_schedule_settings import LinuxBackupHealthCheckScheduleSettings
    from ..models.linux_daily_schedule_settings import LinuxDailyScheduleSettings
    from ..models.linux_monthly_schedule_settings_with_time import LinuxMonthlyScheduleSettingsWithTime
    ...
    from ..models.linux_synthetic_full_settings import LinuxSyntheticFullSettings
...
class LinuxJobScheduleSettings:
    ...
    Attributes:
        schedule_type (Union[Unset, LinuxJobScheduleSettingsScheduleType]): Type of periodicity. Default:
            LinuxJobScheduleSettingsScheduleType.NOTSCHEDULED.
        daily_schedule_settings (Union[Unset, LinuxDailyScheduleSettings]):
        monthly_schedule_settings (Union[Unset, LinuxMonthlyScheduleSettingsWithTime]):
        ...
        backup_health_check_schedule_settings (Union[Unset, LinuxBackupHealthCheckScheduleSettings]):
        synthetic_full_settings (Union[Unset, LinuxSyntheticFullSettings]):
    """
    ...
    monthly_schedule_settings: Union[Unset, "LinuxMonthlyScheduleSettingsWithTime"] = UNSET
    ...
    backup_health_check_schedule_settings: Union[Unset, "LinuxBackupHealthCheckScheduleSettings"] = UNSET
    synthetic_full_settings: Union[Unset, "LinuxSyntheticFullSettings"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_monthly_schedule_settings, Unset):
            ...
            monthly_schedule_settings = LinuxMonthlyScheduleSettingsWithTime.from_dict(_monthly_schedule_settings)
        ...
        if isinstance(_backup_health_check_schedule_settings, Unset):
            ...
            backup_health_check_schedule_settings = LinuxBackupHealthCheckScheduleSettings.from_dict(
        ...
        if isinstance(_synthetic_full_settings, Unset):
            ...
            synthetic_full_settings = LinuxSyntheticFullSettings.from_dict(_synthetic_full_settings)
