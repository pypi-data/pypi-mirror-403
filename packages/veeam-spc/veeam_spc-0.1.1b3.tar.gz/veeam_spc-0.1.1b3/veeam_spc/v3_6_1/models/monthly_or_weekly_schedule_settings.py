...
if TYPE_CHECKING:
    from ..models.windows_monthly_schedule_calendar_settings import WindowsMonthlyScheduleCalendarSettings


T = TypeVar("T", bound="MonthlyOrWeeklyScheduleSettings")


@_attrs_define
class MonthlyOrWeeklyScheduleSettings:
    """
    Attributes:
        monthly_settings (Union[Unset, WindowsMonthlyScheduleCalendarSettings]):
        weekly_on_days (Union[None, Unset, list[MonthlyOrWeeklyScheduleSettingsWeeklyOnDaysType0Item]]): Scheduling
            settings for weekly full backup creation.
            > If the `monthlySettings` property is also provided, it is ignored.
    """

    monthly_settings: Union[Unset, "WindowsMonthlyScheduleCalendarSettings"] = UNSET
    weekly_on_days: Union[None, Unset, list[MonthlyOrWeeklyScheduleSettingsWeeklyOnDaysType0Item]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_weekly_on_days(
            data: object,
        ) -> Union[None, Unset, list[MonthlyOrWeeklyScheduleSettingsWeeklyOnDaysType0Item]]:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(Union[None, Unset, list[MonthlyOrWeeklyScheduleSettingsWeeklyOnDaysType0Item]], data)
        ...
        monthly_or_weekly_schedule_settings.additional_properties = d
        return monthly_or_weekly_schedule_settings
