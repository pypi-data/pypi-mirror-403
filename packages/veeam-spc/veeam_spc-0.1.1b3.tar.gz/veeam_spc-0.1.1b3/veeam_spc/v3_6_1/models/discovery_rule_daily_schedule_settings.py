...
class DiscoveryRuleDailyScheduleSettings:
    ...
    Attributes:
        ...
        specific_days (Union[None, Unset, list[DiscoveryRuleDailyScheduleSettingsSpecificDaysType0Item]]): Array of week
            days on which discovery must be performed.
            > Required for the `SpecificDay` schedule type.
    """

    time: Union[Unset, str] = "0:30"
    specific_days: Union[None, Unset, list[DiscoveryRuleDailyScheduleSettingsSpecificDaysType0Item]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_specific_days(
            data: object,
        ) -> Union[None, Unset, list[DiscoveryRuleDailyScheduleSettingsSpecificDaysType0Item]]:
            if data is None:
                return data
            ...
            try:
                ...
                pass
            return cast(Union[None, Unset, list[DiscoveryRuleDailyScheduleSettingsSpecificDaysType0Item]], data)
