...
if TYPE_CHECKING:
    from ..models.entity_permissions import EntityPermissions
    from ..models.response_error import ResponseError
    from ..models.response_metadata_type_0 import ResponseMetadataType0


T = TypeVar("T", bound="PatchEntityPermissionsResponse200")


@_attrs_define
class PatchEntityPermissionsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = EntityPermissions.from_dict(d.pop("data"))
        ...
        patch_entity_permissions_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        patch_entity_permissions_response_200.additional_properties = d
        return patch_entity_permissions_response_200
