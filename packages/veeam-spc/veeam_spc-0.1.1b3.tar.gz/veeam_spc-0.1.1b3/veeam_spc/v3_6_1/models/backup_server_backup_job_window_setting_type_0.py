...
T = TypeVar("T", bound="BackupServerBackupJobWindowSettingType0")


@_attrs_define
class BackupServerBackupJobWindowSettingType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_backup_job_window_setting_type_0 = cls(
            days=days,
        )

        backup_server_backup_job_window_setting_type_0.additional_properties = d
        return backup_server_backup_job_window_setting_type_0
