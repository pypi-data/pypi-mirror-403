...
if TYPE_CHECKING:
    from ..models.backup_server_cloud_director_backup_job_indexing_settings import (
        BackupServerCloudDirectorBackupJobIndexingSettings,
    )


T = TypeVar("T", bound="BackupServerCloudDirectorBackupJobGuestFileSystemIndexing")


@_attrs_define
class BackupServerCloudDirectorBackupJobGuestFileSystemIndexing:
    """Guest OS file indexing.

    Attributes:
        is_enabled (Union[Unset, bool]): Indicates whether file indexing is enabled. Default: False.
        indexing_settings (Union[None, Unset, list['BackupServerCloudDirectorBackupJobIndexingSettings']]): Array of VMs
            with guest OS file indexing options.
    """

    is_enabled: Union[Unset, bool] = False
    indexing_settings: Union[None, Unset, list["BackupServerCloudDirectorBackupJobIndexingSettings"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_indexing_settings(
            data: object,
        ) -> Union[None, Unset, list["BackupServerCloudDirectorBackupJobIndexingSettings"]]:
            if data is None:
                return data
            ...
            try:
                ...
                for indexing_settings_type_0_item_data in _indexing_settings_type_0:
                    indexing_settings_type_0_item = BackupServerCloudDirectorBackupJobIndexingSettings.from_dict(
                ...
                pass
            return cast(Union[None, Unset, list["BackupServerCloudDirectorBackupJobIndexingSettings"]], data)

        indexing_settings = _parse_indexing_settings(d.pop("indexingSettings", UNSET))

        backup_server_cloud_director_backup_job_guest_file_system_indexing = cls(
            is_enabled=is_enabled,
            indexing_settings=indexing_settings,
        )

        backup_server_cloud_director_backup_job_guest_file_system_indexing.additional_properties = d
        return backup_server_cloud_director_backup_job_guest_file_system_indexing
