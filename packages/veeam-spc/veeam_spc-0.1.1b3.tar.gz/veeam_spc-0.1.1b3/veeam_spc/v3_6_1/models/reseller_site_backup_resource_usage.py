...
class ResellerSiteBackupResourceUsage:
    ...
    Attributes:
        ...
        archive_tier_usage (Union[None, Unset, int]): Amount of archive tier space consumed by all companies of a
            reseller, in bytes.
        capacity_tier_usage (Union[None, Unset, int]): Amount of capacity tier space consumed by all company backups
            excluding backup copies, in bytes.
        performance_tier_usage (Union[None, Unset, int]): Amount of performance tier space consumed by all companies of
            a reseller, in bytes.
    ...
    archive_tier_usage: Union[None, Unset, int] = UNSET
    capacity_tier_usage: Union[None, Unset, int] = UNSET
    performance_tier_usage: Union[None, Unset, int] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_archive_tier_usage(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
        ...
        def _parse_capacity_tier_usage(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_performance_tier_usage(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
