...
T = TypeVar("T", bound="GetMacBackupPolicyResponse200")


@_attrs_define
class GetMacBackupPolicyResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_mac_backup_policy_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_mac_backup_policy_response_200.additional_properties = d
        return get_mac_backup_policy_response_200
