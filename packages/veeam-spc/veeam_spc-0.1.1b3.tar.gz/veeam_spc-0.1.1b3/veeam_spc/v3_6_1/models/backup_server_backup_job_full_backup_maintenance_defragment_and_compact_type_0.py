...
T = TypeVar("T", bound="BackupServerBackupJobFullBackupMaintenanceDefragmentAndCompactType0")


@_attrs_define
class BackupServerBackupJobFullBackupMaintenanceDefragmentAndCompactType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_backup_job_full_backup_maintenance_defragment_and_compact_type_0 = cls(
            is_enabled=is_enabled,
            weekly=weekly,
            monthly=monthly,
        )

        backup_server_backup_job_full_backup_maintenance_defragment_and_compact_type_0.additional_properties = d
        return backup_server_backup_job_full_backup_maintenance_defragment_and_compact_type_0
