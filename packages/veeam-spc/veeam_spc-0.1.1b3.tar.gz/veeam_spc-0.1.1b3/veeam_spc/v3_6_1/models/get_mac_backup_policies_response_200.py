...
if TYPE_CHECKING:
    from ..models.mac_backup_policy import MacBackupPolicy
    from ..models.response_error import ResponseError
    from ..models.response_metadata_type_0 import ResponseMetadataType0


T = TypeVar("T", bound="GetMacBackupPoliciesResponse200")


@_attrs_define
class GetMacBackupPoliciesResponse200:
    """
    Attributes:
        data (list['MacBackupPolicy']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = MacBackupPolicy.from_dict(data_item_data)
        ...
        get_mac_backup_policies_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_mac_backup_policies_response_200.additional_properties = d
        return get_mac_backup_policies_response_200
