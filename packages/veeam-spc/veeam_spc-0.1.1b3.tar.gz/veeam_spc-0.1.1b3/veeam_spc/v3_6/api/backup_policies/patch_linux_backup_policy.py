...
from ...models.patch_linux_backup_policy_response_200 import PatchLinuxBackupPolicyResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/configuration/backupPolicies/linux/{policy_uid}",
    }
...
) -> Union[Any, ErrorResponse, PatchLinuxBackupPolicyResponse200]:
    if response.status_code == 200:
        response_200 = PatchLinuxBackupPolicyResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchLinuxBackupPolicyResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchLinuxBackupPolicyResponse200]]:
    """Modify Backup Policy for Linux Computers
