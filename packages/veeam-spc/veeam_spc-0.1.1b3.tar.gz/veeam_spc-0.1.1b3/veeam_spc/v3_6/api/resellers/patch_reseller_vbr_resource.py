...
from ...models.patch_reseller_vbr_resource_response_200 import PatchResellerVbrResourceResponse200
...
) -> Union[Any, ErrorResponse, PatchResellerVbrResourceResponse200]:
    if response.status_code == 200:
        response_200 = PatchResellerVbrResourceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchResellerVbrResourceResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchResellerVbrResourceResponse200]]:
    """Modify Reseller Veeam Backup & Replication Server Resource
