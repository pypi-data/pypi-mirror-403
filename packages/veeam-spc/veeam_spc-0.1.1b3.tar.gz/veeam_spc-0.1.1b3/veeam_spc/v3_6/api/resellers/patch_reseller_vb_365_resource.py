...
from ...models.patch_reseller_vb_365_resource_response_200 import PatchResellerVb365ResourceResponse200
...
) -> Union[Any, ErrorResponse, PatchResellerVb365ResourceResponse200]:
    if response.status_code == 200:
        response_200 = PatchResellerVb365ResourceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchResellerVb365ResourceResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchResellerVb365ResourceResponse200]]:
    """Modify Reseller Veeam Backup for Microsoft 365 Resource
