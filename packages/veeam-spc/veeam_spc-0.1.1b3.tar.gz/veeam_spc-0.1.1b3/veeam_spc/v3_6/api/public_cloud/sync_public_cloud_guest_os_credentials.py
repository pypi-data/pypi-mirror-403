...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/infrastructure/sites/publicCloud/guestOsCredentials/sync",
    }
...
def sync_detailed(
    *,
    ...
    """Synchronize Public Cloud Guest OS Credentials

     Initiates synchronization of public cloud guest OS credentials data in Veeam Service Provider
    Console with Veeam Backup for Public Cloud.
