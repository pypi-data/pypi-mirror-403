...
def sync_detailed(
    ...
    *,
    ...
    """Delete Veeam Backup for Public Clouds Appliance Mapping

     Deletes an organization mapping of a Veeam Backup for Public Clouds appliance with the specified
    UID.
