...
def _get_kwargs(
    ...
    appliance_uid: UUID,
    *,
    full_recollect: Union[Unset, bool] = False,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/backupServers/{backup_server_uid}/publicCloud/appliances/{appliance_uid}/collect",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Collect Data From Veeam Backup for Public Clouds Appliance
    ...
    Args:
        backup_server_uid (UUID):
        appliance_uid (UUID):
        full_recollect (Union[Unset, bool]):  Default: False.
