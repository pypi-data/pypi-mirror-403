...
from ...models.patch_local_user_rule_response_200 import PatchLocalUserRuleResponse200
...
) -> Union[Any, ErrorResponse, PatchLocalUserRuleResponse200]:
    if response.status_code == 200:
        response_200 = PatchLocalUserRuleResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchLocalUserRuleResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchLocalUserRuleResponse200]]:
    """Modify Administrator Portal User or Group
