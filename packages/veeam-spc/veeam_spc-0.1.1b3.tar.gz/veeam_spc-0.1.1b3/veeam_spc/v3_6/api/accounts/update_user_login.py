...
from ...models.update_user_login_response_200 import UpdateUserLoginResponse200
...
) -> Union[Any, ErrorResponse, UpdateUserLoginResponse200]:
    if response.status_code == 200:
        response_200 = UpdateUserLoginResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, UpdateUserLoginResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, UpdateUserLoginResponse200]]:
    """Modify User Identity
