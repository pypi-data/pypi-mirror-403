...
from ...models.patch_identity_provider_rule_response_200 import PatchIdentityProviderRuleResponse200
...
) -> Union[Any, ErrorResponse, PatchIdentityProviderRuleResponse200]:
    if response.status_code == 200:
        response_200 = PatchIdentityProviderRuleResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchIdentityProviderRuleResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchIdentityProviderRuleResponse200]]:
    """Modify Organization Identity Provider Mapping Rule
