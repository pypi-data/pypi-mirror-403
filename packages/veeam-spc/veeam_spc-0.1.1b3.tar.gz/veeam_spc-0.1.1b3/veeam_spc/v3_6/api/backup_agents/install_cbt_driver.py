...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/backupAgents/windows/{backup_agent_uid}/installCbtDriver",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Install CBT Driver
     ...
     Installs the Veeam CBT driver on a Windows computer that runs Veeam Agent with the specified UID.
