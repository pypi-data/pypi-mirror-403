...
def _get_kwargs(
    ...
    *,
    ...
    json_policy_uid = str(policy_uid)
    params["policyUid"] = json_policy_uid
...
def sync_detailed(
    ...
    *,
    ...
    """Assign Policy to Veeam Agent for Microsoft Windows

     Assigns a backup policy to a Veeam Agent for Microsoft Windows with the specified UID. Returns a
    positive response when the management agent receives the task and not when the task is executed.
