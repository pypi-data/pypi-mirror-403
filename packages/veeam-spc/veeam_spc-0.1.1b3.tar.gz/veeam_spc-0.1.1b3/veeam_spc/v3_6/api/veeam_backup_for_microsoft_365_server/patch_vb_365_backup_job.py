...
from ...models.patch_vb_365_backup_job_response_200 import PatchVb365BackupJobResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/infrastructure/vb365Servers/{vb_365_server_uid}/organizations/jobs/backup/{vb_365_backup_job_uid}",
    }
...
) -> Union[Any, ErrorResponse, PatchVb365BackupJobResponse200]:
    if response.status_code == 200:
        response_200 = PatchVb365BackupJobResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchVb365BackupJobResponse200]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    users must not modify the `schedulePolicy` property. Otherwise the operation will result in error.
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchVb365BackupJobResponse200]]:
    """Modify Veeam Backup for Microsoft 365 Backup Job
