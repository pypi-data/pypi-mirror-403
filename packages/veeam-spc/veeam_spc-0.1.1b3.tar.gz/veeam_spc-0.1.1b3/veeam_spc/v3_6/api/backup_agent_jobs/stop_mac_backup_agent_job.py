...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/backupAgents/mac/{backup_agent_uid}/jobs/{backup_agent_job_uid}/stop",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Stop Job for Veeam Agent for Mac
     ...
     Stops a Veeam Agent for Mac job with the specified UID. Returns a positive response if the task is
