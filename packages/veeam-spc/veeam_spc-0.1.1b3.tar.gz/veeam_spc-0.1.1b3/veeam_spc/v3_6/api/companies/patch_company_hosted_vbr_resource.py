...
from ...models.patch_company_hosted_vbr_resource_response_200 import PatchCompanyHostedVbrResourceResponse200
...
) -> Union[Any, ErrorResponse, PatchCompanyHostedVbrResourceResponse200]:
    if response.status_code == 200:
        response_200 = PatchCompanyHostedVbrResourceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchCompanyHostedVbrResourceResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchCompanyHostedVbrResourceResponse200]]:
    """Modify Company Hosted Server Resource
