...
from ...models.get_backup_repositories_by_server_response_200 import GetBackupRepositoriesByServerResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/infrastructure/backupServers/{backup_server_uid}/repositories",
        "params": params,
    }
...
) -> Union[Any, ErrorResponse, GetBackupRepositoriesByServerResponse200]:
    if response.status_code == 200:
        response_200 = GetBackupRepositoriesByServerResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetBackupRepositoriesByServerResponse200]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get All Backup Repositories Connected to Backup Server

     Returns a collection resource representation of all backup repositories connected to a Veeam Backup
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetBackupRepositoriesByServerResponse200]]:
    """Get All Backup Repositories Connected to Backup Server
