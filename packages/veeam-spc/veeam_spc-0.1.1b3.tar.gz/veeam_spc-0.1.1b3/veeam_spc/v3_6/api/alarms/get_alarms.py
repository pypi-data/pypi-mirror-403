...
from ...models.get_alarms_response_200 import GetAlarmsResponse200
...
) -> Union[Any, ErrorResponse, GetAlarmsResponse200]:
    if response.status_code == 200:
        response_200 = GetAlarmsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetAlarmsResponse200]]:
    return Response(
...
def sync(
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetAlarmsResponse200]]:
    """Get All Alarm Templates
