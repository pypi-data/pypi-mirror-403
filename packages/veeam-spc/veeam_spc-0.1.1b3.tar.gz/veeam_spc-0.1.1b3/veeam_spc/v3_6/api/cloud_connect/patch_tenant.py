...
from ...models.patch_tenant_response_200 import PatchTenantResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/infrastructure/sites/tenants/{tenant_uid}",
    }
...
) -> Union[Any, ErrorResponse, PatchTenantResponse200]:
    if response.status_code == 200:
        response_200 = PatchTenantResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchTenantResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchTenantResponse200]]:
    """Modify Tenant
