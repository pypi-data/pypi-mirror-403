...
from ...models.patch_tenant_vcd_replication_resource_response_200 import PatchTenantVcdReplicationResourceResponse200
...
) -> Union[Any, ErrorResponse, PatchTenantVcdReplicationResourceResponse200]:
    if response.status_code == 200:
        response_200 = PatchTenantVcdReplicationResourceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchTenantVcdReplicationResourceResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchTenantVcdReplicationResourceResponse200]]:
    """Modify Tenant VMware Cloud Director Replication Resource
