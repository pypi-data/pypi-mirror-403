...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/sites/{site_uid}/publicCloud/azure/appliances/deploy",
    }
...
) -> Union[Any, CreateNewPublicCloudAzureApplianceResponse200, ErrorResponse]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CreateNewPublicCloudAzureApplianceResponse200, ErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, CreateNewPublicCloudAzureApplianceResponse200, ErrorResponse]]:
    """Create Veeam Backup for Microsoft Azure Appliance
