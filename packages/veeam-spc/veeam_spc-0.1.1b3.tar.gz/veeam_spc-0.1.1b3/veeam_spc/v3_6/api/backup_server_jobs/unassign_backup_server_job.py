...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "delete",
        "url": f"/infrastructure/backupServers/jobs/{job_uid}/assign",
    }
...
def sync_detailed(
    ...
    *,
    ...
    >Returns a positive response when the task is added to the internal queue and not when the task is
    executed.
