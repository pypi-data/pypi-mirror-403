...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/backupServers/failoverplans/{plan_uid}/undo",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Undo Failover Plan
     ...
     Undoes a failover plan with the specified UID. Returns a positive response when the undo task is
