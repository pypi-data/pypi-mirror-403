...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/discovery/computers/{computer_uid}/scheduledDeploymentTasks/{task_uid}/start",
    }
...
) -> Union[Any, ErrorResponse, StartScheduledDeploymentTaskForComputerResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, StartScheduledDeploymentTaskForComputerResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, StartScheduledDeploymentTaskForComputerResponse200]]:
    """Start Computer Scheduled Deployment Task
