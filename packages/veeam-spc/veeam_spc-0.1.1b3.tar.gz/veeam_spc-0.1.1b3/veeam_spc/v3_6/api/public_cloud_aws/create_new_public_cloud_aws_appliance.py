...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/sites/{site_uid}/publicCloud/aws/appliances/deploy",
    }
...
) -> Union[Any, CreateNewPublicCloudAwsApplianceResponse200, ErrorResponse]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CreateNewPublicCloudAwsApplianceResponse200, ErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, CreateNewPublicCloudAwsApplianceResponse200, ErrorResponse]]:
    """Create Veeam Backup for AWS Appliance
