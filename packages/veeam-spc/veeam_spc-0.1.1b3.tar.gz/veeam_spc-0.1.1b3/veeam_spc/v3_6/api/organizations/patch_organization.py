...
from ...models.patch_organization_response_200 import PatchOrganizationResponse200
...
) -> Union[Any, ErrorResponse, PatchOrganizationResponse200]:
    if response.status_code == 200:
        response_200 = PatchOrganizationResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchOrganizationResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchOrganizationResponse200]]:
    """Modify Organization
