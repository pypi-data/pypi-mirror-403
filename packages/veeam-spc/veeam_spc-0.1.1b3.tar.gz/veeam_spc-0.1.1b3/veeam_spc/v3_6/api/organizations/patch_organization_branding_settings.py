...
from ...models.patch_organization_branding_settings_response_200 import PatchOrganizationBrandingSettingsResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/organizations/{organization_uid}/configuration/branding",
    }
...
) -> Union[Any, ErrorResponse, PatchOrganizationBrandingSettingsResponse200]:
    if response.status_code == 200:
        response_200 = PatchOrganizationBrandingSettingsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchOrganizationBrandingSettingsResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchOrganizationBrandingSettingsResponse200]]:
    """Modify Organization Branding Settings
