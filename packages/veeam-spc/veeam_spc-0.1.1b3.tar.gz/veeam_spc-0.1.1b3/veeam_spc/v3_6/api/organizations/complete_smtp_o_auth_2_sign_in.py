...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/organizations/{organization_uid}/configuration/notification/oauth2/signin/completion",
        "params": params,
    }
...
) -> Union[Any, CompleteSmtpOAuth2SignInResponse200, ErrorResponse]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CompleteSmtpOAuth2SignInResponse200, ErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, CompleteSmtpOAuth2SignInResponse200, ErrorResponse]]:
    """Obtain SMTP Server OAuth 2.0 Authorization Tokens
