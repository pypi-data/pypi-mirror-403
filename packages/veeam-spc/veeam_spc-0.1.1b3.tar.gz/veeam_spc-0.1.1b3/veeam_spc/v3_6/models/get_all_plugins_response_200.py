...
T = TypeVar("T", bound="GetAllPluginsResponse200")


@_attrs_define
class GetAllPluginsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = PluginInfo.from_dict(data_item_data)
        ...
        get_all_plugins_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_all_plugins_response_200.additional_properties = d
        return get_all_plugins_response_200
