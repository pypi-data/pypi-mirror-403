...
T = TypeVar("T", bound="ReplaceOrganizationLoginUrlResponse200")


@_attrs_define
class ReplaceOrganizationLoginUrlResponse200:
    """
    Attributes:
        data (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        replace_organization_login_url_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        replace_organization_login_url_response_200.additional_properties = d
        return replace_organization_login_url_response_200
