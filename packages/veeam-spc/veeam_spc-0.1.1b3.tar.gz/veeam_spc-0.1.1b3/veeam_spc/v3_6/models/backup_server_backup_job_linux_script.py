...
T = TypeVar("T", bound="BackupServerBackupJobLinuxScript")


@_attrs_define
class BackupServerBackupJobLinuxScript:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_backup_job_linux_script = cls(
            pre_freeze_script=pre_freeze_script,
            post_thaw_script=post_thaw_script,
        )

        backup_server_backup_job_linux_script.additional_properties = d
        return backup_server_backup_job_linux_script
