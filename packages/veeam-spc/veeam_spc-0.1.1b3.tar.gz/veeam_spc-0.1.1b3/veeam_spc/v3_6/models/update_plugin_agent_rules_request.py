...
class UpdatePluginAgentRulesRequest:
    """
    Attributes:
        allow_agemt_ids (Union[Unset, list[str]]): Array of IDs assigned to management agents that are permitted to
            access plugin.
        deny_agent_ids (Union[Unset, list[str]]): Array of IDs assigned to management agents that are not permitted to
            access plugin.
        allow_agents_by_default (Union[Unset, bool]): Defines whether all other management agents are permitted to
            access plugin by default.
            > Provide the `null` value to keep the current settings.
    """

    allow_agemt_ids: Union[Unset, list[str]] = UNSET
    deny_agent_ids: Union[Unset, list[str]] = UNSET
    allow_agents_by_default: Union[Unset, bool] = UNSET
