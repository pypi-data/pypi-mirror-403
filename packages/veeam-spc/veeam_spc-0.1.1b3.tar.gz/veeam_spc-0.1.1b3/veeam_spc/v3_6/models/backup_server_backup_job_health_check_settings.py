...
T = TypeVar("T", bound="BackupServerBackupJobHealthCheckSettings")


@_attrs_define
class BackupServerBackupJobHealthCheckSettings:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_backup_job_health_check_settings = cls(
            is_enabled=is_enabled,
            weekly=weekly,
            monthly=monthly,
        )

        backup_server_backup_job_health_check_settings.additional_properties = d
        return backup_server_backup_job_health_check_settings
