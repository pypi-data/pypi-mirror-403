...
T = TypeVar("T", bound="GetActiveProxySessionsResponse200")


@_attrs_define
class GetActiveProxySessionsResponse200:
    """
    Attributes:
        data (list['ProxySession']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = ProxySession.from_dict(data_item_data)
        ...
        get_active_proxy_sessions_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_active_proxy_sessions_response_200.additional_properties = d
        return get_active_proxy_sessions_response_200
