...
class OAuth2ClientSettings:
    ...
    Attributes:
        ...
        client_secret (Union[Unset, str]): Client secret.
        scope (Union[Unset, str]): Access token scope.
            > Leave empty to use default scope.
        tenant_id (Union[Unset, str]): Tenant ID for Azure OAuth 2.0 service provider.
    """
