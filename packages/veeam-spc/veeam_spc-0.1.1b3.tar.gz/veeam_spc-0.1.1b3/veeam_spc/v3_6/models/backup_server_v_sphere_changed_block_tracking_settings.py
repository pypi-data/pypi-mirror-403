...
T = TypeVar("T", bound="BackupServerVSphereChangedBlockTrackingSettings")


@_attrs_define
class BackupServerVSphereChangedBlockTrackingSettings:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_v_sphere_changed_block_tracking_settings = cls(
            is_enabled=is_enabled,
            enable_cbt_automatically=enable_cbt_automatically,
            reset_cbt_on_active_full=reset_cbt_on_active_full,
        )

        backup_server_v_sphere_changed_block_tracking_settings.additional_properties = d
        return backup_server_v_sphere_changed_block_tracking_settings
