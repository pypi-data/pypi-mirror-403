...
class SubscriptionPlanFileShareBackup:
    ...
    Attributes:
        ...
        free_file_share_remote_backup_used_space (Union[Unset, int]): Amount of backup repository space that can be
        ...
        free_file_share_remote_archive_used_space (Union[Unset, int]): Amount of archive repository space that can be
            consumed by file share backups for free.
            > Maximum value is `1048576` for GB and `1024` for TB.
        ...
        free_source_remote_amount_of_data (Union[Unset, int]): Amount of source data that is processed for free.
            > Maximum value is `1048576` for GB and `1024` for TB.
        ...
        free_file_share_hosted_backup_used_space (Union[Unset, int]): Amount of backup repository space that can be
            consumed by file share backups for free.
            > Maximum value is `1048576` for GB and `1024` for TB.
        ...
        free_file_share_hosted_archive_used_space (Union[Unset, int]): Amount of archive repository space that can be
            consumed by file share backups for free.
            > Maximum value is `1048576` for GB and `1024` for TB.
        ...
        free_source_hosted_amount_of_data (Union[Unset, int]): Amount of source data that is processed for free.
            > Maximum value is `1048576` for GB and `1024` for TB.
    ...
    free_file_share_remote_backup_used_space: Union[Unset, int] = UNSET
    ...
    free_file_share_remote_archive_used_space: Union[Unset, int] = UNSET
    ...
    free_source_remote_amount_of_data: Union[Unset, int] = UNSET
    ...
    free_file_share_hosted_backup_used_space: Union[Unset, int] = UNSET
    ...
    free_file_share_hosted_archive_used_space: Union[Unset, int] = UNSET
    ...
    free_source_hosted_amount_of_data: Union[Unset, int] = UNSET
