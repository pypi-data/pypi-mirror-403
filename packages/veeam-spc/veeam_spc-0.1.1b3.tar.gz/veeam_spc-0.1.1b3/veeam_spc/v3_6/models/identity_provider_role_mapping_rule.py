...
class IdentityProviderRoleMappingRule:
    ...
    Attributes:
        ...
        description (Union[Unset, str]): Mapping rule description.
        enabled (Union[Unset, bool]): Indicates whether a mapping rule is enabled. Default: True.
        managed_companies_uids (Union[Unset, list[UUID]]): Array of UIDs assigned to companies managed by a user.
        ...
        has_access_to_provider (Union[Unset, bool]): Indicates whether a user is permitted to view service provider
            organization resources.
            >Required for the `PortalOperator` and `PortalReadonlyOperator` user roles.
        locations_mapping_source_claim_type (Union[Unset, str]): Location mapping claim containing user locations in the
        ...
        company_tenant_mapping_claims (Union[Unset, IdentityProviderCompanyTenantMappingParameters]): Parameters
            required to create a mapping rule for users with `CompanyTenant` role.
        additional_mappings (Union[Unset, list['IdentityProviderClaimMatchRule']]): Array of additional mappings
            required for rule selection.
        attribute_mappings (Union[Unset, list['IdentityProviderAttributeMapping']]): Array of mapping claims attributed
            to user parameters.
    ...
    managed_companies_uids: Union[Unset, list[UUID]] = UNSET
    manage_all_companies: Union[Unset, bool] = True
    has_access_to_provider: Union[Unset, bool] = UNSET
    locations_mapping_source_claim_type: Union[Unset, str] = UNSET
    company_tenant_mapping_claims: Union[Unset, "IdentityProviderCompanyTenantMappingParameters"] = UNSET
    additional_mappings: Union[Unset, list["IdentityProviderClaimMatchRule"]] = UNSET
    attribute_mappings: Union[Unset, list["IdentityProviderAttributeMapping"]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        managed_companies_uids: Union[Unset, list[str]] = UNSET
        ...
        company_tenant_mapping_claims: Union[Unset, dict[str, Any]] = UNSET
        ...
        additional_mappings: Union[Unset, list[dict[str, Any]]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for managed_companies_uids_item_data in _managed_companies_uids or []:
        ...
        company_tenant_mapping_claims: Union[Unset, IdentityProviderCompanyTenantMappingParameters]
        ...
        for additional_mappings_item_data in _additional_mappings or []:
