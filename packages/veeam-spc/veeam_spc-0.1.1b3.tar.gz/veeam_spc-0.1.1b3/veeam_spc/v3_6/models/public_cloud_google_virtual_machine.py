...
T = TypeVar("T", bound="PublicCloudGoogleVirtualMachine")


@_attrs_define
class PublicCloudGoogleVirtualMachine:
    """
    Attributes:
        virtual_machine_name (Union[Unset, str]): Name of a Google Cloud VM.
        virtual_machine_id (Union[Unset, str]): ID assigned to a Google Cloud VM.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        public_cloud_google_virtual_machine = cls(
            virtual_machine_name=virtual_machine_name,
            virtual_machine_id=virtual_machine_id,
            availability_zone_id=availability_zone_id,
        )

        public_cloud_google_virtual_machine.additional_properties = d
        return public_cloud_google_virtual_machine
