...
T = TypeVar("T", bound="BackupServerBackupJobIndexingSettings")


@_attrs_define
class BackupServerBackupJobIndexingSettings:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_backup_job_indexing_settings.additional_properties = d
        return backup_server_backup_job_indexing_settings
