...
T = TypeVar("T", bound="CreateTenantResponse200")


@_attrs_define
class CreateTenantResponse200:
    """
    Attributes:
        data (CloudTenant):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_tenant_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        create_tenant_response_200.additional_properties = d
        return create_tenant_response_200
