...
T = TypeVar("T", bound="GetCurrenciesResponse200")


@_attrs_define
class GetCurrenciesResponse200:
    """
    Attributes:
        data (list['Currency']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_currencies_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_currencies_response_200.additional_properties = d
        return get_currencies_response_200
