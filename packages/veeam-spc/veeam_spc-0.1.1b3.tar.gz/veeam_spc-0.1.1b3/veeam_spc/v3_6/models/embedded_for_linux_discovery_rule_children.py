...
T = TypeVar("T", bound="EmbeddedForLinuxDiscoveryRuleChildren")


@_attrs_define
class EmbeddedForLinuxDiscoveryRuleChildren:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        embedded_for_linux_discovery_rule_children = cls(
            discovery_rule=discovery_rule,
            linux_discovery_rule=linux_discovery_rule,
        )

        embedded_for_linux_discovery_rule_children.additional_properties = d
        return embedded_for_linux_discovery_rule_children
