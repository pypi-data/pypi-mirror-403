...
T = TypeVar("T", bound="GetUsersByOrganizationResponse200")


@_attrs_define
class GetUsersByOrganizationResponse200:
    """
    Attributes:
        data (list['User']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_users_by_organization_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_users_by_organization_response_200.additional_properties = d
        return get_users_by_organization_response_200
