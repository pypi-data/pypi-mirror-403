...
T = TypeVar("T", bound="BackupServerBackupJobApplicationSettings")


@_attrs_define
class BackupServerBackupJobApplicationSettings:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_backup_job_application_settings = cls(
            vm_object=vm_object,
            vss=vss,
        ...
        backup_server_backup_job_application_settings.additional_properties = d
        return backup_server_backup_job_application_settings
