...
from ..models.protected_computer_managed_by_backup_server_backup_job_kind import (
    ProtectedComputerManagedByBackupServerBackupJobKind,
)
from ..models.protected_computer_managed_by_backup_server_backup_target_type import (
    ProtectedComputerManagedByBackupServerBackupTargetType,
)
from ..models.sobr_repository_tier import SobrRepositoryTier
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProtectedComputerManagedByBackupServerBackup")


@_attrs_define
class ProtectedComputerManagedByBackupServerBackup:
    """
    Attributes:
        ...
        job_kind (Union[Unset, ProtectedComputerManagedByBackupServerBackupJobKind]): Job type.
        ...
        target_type (Union[Unset, ProtectedComputerManagedByBackupServerBackupTargetType]): Type of a target repository.
    ...
    job_kind: Union[Unset, ProtectedComputerManagedByBackupServerBackupJobKind] = UNSET
    ...
    target_type: Union[Unset, ProtectedComputerManagedByBackupServerBackupTargetType] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.job_kind, Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _job_kind = d.pop("jobKind", UNSET)
        job_kind: Union[Unset, ProtectedComputerManagedByBackupServerBackupJobKind]
        if isinstance(_job_kind, Unset):
            job_kind = UNSET
        else:
            job_kind = ProtectedComputerManagedByBackupServerBackupJobKind(_job_kind)
        ...
        target_type: Union[Unset, ProtectedComputerManagedByBackupServerBackupTargetType]
        if isinstance(_target_type, Unset):
            target_type = UNSET
        else:
            target_type = ProtectedComputerManagedByBackupServerBackupTargetType(_target_type)
        ...
        protected_computer_managed_by_backup_server_backup = cls(
        ...
        protected_computer_managed_by_backup_server_backup.additional_properties = d
        return protected_computer_managed_by_backup_server_backup
