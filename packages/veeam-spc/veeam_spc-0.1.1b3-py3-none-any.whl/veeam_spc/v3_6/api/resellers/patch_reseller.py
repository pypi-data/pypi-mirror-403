...
from ...models.patch_reseller_response_200 import PatchResellerResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/organizations/resellers/{reseller_uid}",
    }
...
) -> Union[Any, ErrorResponse, PatchResellerResponse200]:
    if response.status_code == 200:
        response_200 = PatchResellerResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchResellerResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchResellerResponse200]]:
    """Modify Reseller
