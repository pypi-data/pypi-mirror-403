...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/sites/{site_uid}/publicCloud/aws/connection",
        "params": params,
    }
...
) -> Union[Any, CreatePublicCloudAwsConnectionResponse200, ErrorResponse]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CreatePublicCloudAwsConnectionResponse200, ErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, CreatePublicCloudAwsConnectionResponse200, ErrorResponse]]:
    """Add Amazon Connection
