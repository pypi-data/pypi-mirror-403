...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/backupServers/{backup_server_uid}/upgrade",
    }
...
) -> Union[Any, ErrorResponse, UpgradeBackupServerResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, UpgradeBackupServerResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, UpgradeBackupServerResponse200]]:
    """Update Veeam Backup & Replication on Server
