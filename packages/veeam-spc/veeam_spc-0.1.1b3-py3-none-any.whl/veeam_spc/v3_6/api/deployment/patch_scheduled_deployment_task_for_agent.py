...
from ...models.patch_scheduled_deployment_task_for_agent_response_200 import (
...
) -> Union[Any, ErrorResponse, PatchScheduledDeploymentTaskForAgentResponse200]:
    if response.status_code == 200:
        response_200 = PatchScheduledDeploymentTaskForAgentResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchScheduledDeploymentTaskForAgentResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchScheduledDeploymentTaskForAgentResponse200]]:
    """Modify Management Agent Scheduled Deployment Task
