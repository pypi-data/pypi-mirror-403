...
def _get_kwargs(
    ...
    *,
    ...
    name_sorting_direction: Union[
        Unset, GetBackupServerVirtualServerTagVirtualMachinesNameSortingDirection
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/infrastructure/backupServers/{backup_server_uid}/servers/virtualCenter/{virtual_center_uid}/tags/{tag_urn}/virtualMachines",
        "params": params,
    }
...
) -> Union[Any, ErrorResponse, GetBackupServerVirtualServerTagVirtualMachinesResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetBackupServerVirtualServerTagVirtualMachinesResponse200]]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        name_sorting_direction (Union[Unset,
            GetBackupServerVirtualServerTagVirtualMachinesNameSortingDirection]):  Default:
            GetBackupServerVirtualServerTagVirtualMachinesNameSortingDirection.ASCENDING.
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetBackupServerVirtualServerTagVirtualMachinesResponse200]]:
    """Get All VMs Marked With vCenter Server Tag
