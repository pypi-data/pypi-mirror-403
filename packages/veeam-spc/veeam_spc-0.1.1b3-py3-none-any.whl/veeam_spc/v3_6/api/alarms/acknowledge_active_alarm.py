...
def _get_kwargs(
    ...
    *,
    ...
    params["resolveOnClients"] = resolve_on_clients

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/alarms/active/{active_alarm_uid}/acknowledge",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    kwargs = _get_kwargs(
        ...
        comment=comment,
        resolve_on_clients=resolve_on_clients,
