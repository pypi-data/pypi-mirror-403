...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/organizations/companies/billing/invoices/",
        "params": params,
    }
...
) -> Union[Any, ErrorResponse, GetInvoicesResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetInvoicesResponse200]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get All Company Invoices
     ...
     Returns a collection resource representation of invoices generated for all companies.
...
def sync(
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetInvoicesResponse200]]:
    """Get All Company Invoices
