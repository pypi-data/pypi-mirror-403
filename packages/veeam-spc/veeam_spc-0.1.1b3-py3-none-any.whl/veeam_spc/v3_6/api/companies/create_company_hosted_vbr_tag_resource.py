...
) -> Union[Any, CreateCompanyHostedVbrTagResourceResponse200, ErrorResponse]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CreateCompanyHostedVbrTagResourceResponse200, ErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, CreateCompanyHostedVbrTagResourceResponse200, ErrorResponse]]:
    """Create Tag Resource on Company Hosted Server Resource
