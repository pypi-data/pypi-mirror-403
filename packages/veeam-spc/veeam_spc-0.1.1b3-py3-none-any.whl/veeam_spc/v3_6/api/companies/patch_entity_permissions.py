...
from ...models.patch_entity_permissions_response_200 import PatchEntityPermissionsResponse200
...
) -> Union[Any, ErrorResponse, PatchEntityPermissionsResponse200]:
    if response.status_code == 200:
        response_200 = PatchEntityPermissionsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchEntityPermissionsResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchEntityPermissionsResponse200]]:
    """Modify Veeam Service Provider Console Entity Permissions
