...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/backupAgents/{backup_agent_uid}/restart",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Restart Backup Agent
     ...
     Restarts Veeam backup agent with the specified UID. Returns a positive response if the restart task
