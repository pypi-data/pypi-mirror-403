...
) -> Union[Any, CreateWindowsCustomDiscoveryRuleResponse200, ErrorResponse]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CreateWindowsCustomDiscoveryRuleResponse200, ErrorResponse]]:
    return Response(
...
def sync(
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, CreateWindowsCustomDiscoveryRuleResponse200, ErrorResponse]]:
    """Create Import-Based Discovery Rule for Windows
