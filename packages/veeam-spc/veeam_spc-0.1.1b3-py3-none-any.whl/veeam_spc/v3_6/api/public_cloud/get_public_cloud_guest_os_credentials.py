...
def _get_kwargs(
    *,
    ...
    json_site_uid: Union[Unset, str] = UNSET
...
) -> Union[Any, ErrorResponse, GetPublicCloudGuestOsCredentialsResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetPublicCloudGuestOsCredentialsResponse200]]:
    return Response(
...
def sync(
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetPublicCloudGuestOsCredentialsResponse200]]:
    """Get All Guest OS Credentials
