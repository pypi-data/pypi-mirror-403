...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/infrastructure/sites/publicCloud/accounts/sync",
    }
...
def sync_detailed(
    *,
    ...
    """Synchronize Public Cloud Accounts

     Initiates synchronization of public cloud account data between Veeam Service Provider Console and
