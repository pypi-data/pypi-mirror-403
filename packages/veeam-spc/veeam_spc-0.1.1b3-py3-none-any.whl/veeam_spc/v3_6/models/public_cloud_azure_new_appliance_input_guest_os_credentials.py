...
T = TypeVar("T", bound="PublicCloudAzureNewApplianceInputGuestOsCredentials")


@_attrs_define
class PublicCloudAzureNewApplianceInputGuestOsCredentials:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        public_cloud_azure_new_appliance_input_guest_os_credentials = cls(
            guest_os_credentials_uid=guest_os_credentials_uid,
            key_pair_name=key_pair_name,
            time_zone_id=time_zone_id,
        )

        public_cloud_azure_new_appliance_input_guest_os_credentials.additional_properties = d
        return public_cloud_azure_new_appliance_input_guest_os_credentials
