...
T = TypeVar("T", bound="SetUserToLocationResponse200")


@_attrs_define
class SetUserToLocationResponse200:
    """
    Attributes:
        data (User):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = User.from_dict(d.pop("data"))
        ...
        set_user_to_location_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        set_user_to_location_response_200.additional_properties = d
        return set_user_to_location_response_200
