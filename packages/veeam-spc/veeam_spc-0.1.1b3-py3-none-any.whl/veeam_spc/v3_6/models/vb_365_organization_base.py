...
class Vb365OrganizationBase:
    ...
    Attributes:
        ...
        is_job_scheduling_enabled (Union[Unset, bool]): Indicates whether the current user can apply changes to a
            Microsoft organization job schedule.
        mapped_organization_uid (Union[Unset, UUID]): UID assigned to an organization that is mapped to a Microsoft
            organization.
        mapped_organization_name (Union[Unset, str]): Name of an organization that is mapped to a Microsoft
            organization.
