...
T = TypeVar("T", bound="VOneServerMultipartPatchFile")


@_attrs_define
class VOneServerMultipartPatchFile:
    """
    Attributes:
        name (Union[Unset, str]): Name of a file included in a Veeam ONE server patch upload.
        file_stream_uid (Union[Unset, UUID]): UID assigned to a file included in a Veeam ONE server patch upload.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v_one_server_multipart_patch_file = cls(
            name=name,
            file_stream_uid=file_stream_uid,
        )

        v_one_server_multipart_patch_file.additional_properties = d
        return v_one_server_multipart_patch_file
