...
T = TypeVar("T", bound="PatchIdentityProviderRuleResponse200")


@_attrs_define
class PatchIdentityProviderRuleResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_identity_provider_rule_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        patch_identity_provider_rule_response_200.additional_properties = d
        return patch_identity_provider_rule_response_200
