...
T = TypeVar("T", bound="UpgradeBackupServerResponse200")


@_attrs_define
class UpgradeBackupServerResponse200:
    """
    Attributes:
        data (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        upgrade_backup_server_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        upgrade_backup_server_response_200.additional_properties = d
        return upgrade_backup_server_response_200
