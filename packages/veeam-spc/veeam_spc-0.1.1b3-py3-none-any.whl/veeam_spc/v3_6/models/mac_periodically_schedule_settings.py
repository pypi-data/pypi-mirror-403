...
T = TypeVar("T", bound="MacPeriodicallyScheduleSettings")


@_attrs_define
class MacPeriodicallyScheduleSettings:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mac_periodically_schedule_settings = cls(
            interval_in_minutes=interval_in_minutes,
        )

        mac_periodically_schedule_settings.additional_properties = d
        return mac_periodically_schedule_settings
