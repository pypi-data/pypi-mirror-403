...
T = TypeVar("T", bound="InstallBackupServerLicenseResponse200")


@_attrs_define
class InstallBackupServerLicenseResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        install_backup_server_license_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        install_backup_server_license_response_200.additional_properties = d
        return install_backup_server_license_response_200
