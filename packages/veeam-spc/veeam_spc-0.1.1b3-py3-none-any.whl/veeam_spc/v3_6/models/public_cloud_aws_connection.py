...
T = TypeVar("T", bound="PublicCloudAwsConnection")


@_attrs_define
class PublicCloudAwsConnection:
    """
    Attributes:
        connection_uid (Union[Unset, UUID]): UID assigned to an Amazon connection.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        public_cloud_aws_connection = cls(
            connection_uid=connection_uid,
        )

        public_cloud_aws_connection.additional_properties = d
        return public_cloud_aws_connection
