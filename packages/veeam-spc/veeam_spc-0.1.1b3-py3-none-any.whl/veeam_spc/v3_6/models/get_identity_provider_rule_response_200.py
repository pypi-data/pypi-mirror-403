...
T = TypeVar("T", bound="GetIdentityProviderRuleResponse200")


@_attrs_define
class GetIdentityProviderRuleResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_identity_provider_rule_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_identity_provider_rule_response_200.additional_properties = d
        return get_identity_provider_rule_response_200
