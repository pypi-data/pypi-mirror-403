...
T = TypeVar("T", bound="BackupServerCredentialsStandard")


@_attrs_define
class BackupServerCredentialsStandard:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_credentials_standard = cls(
        ...
        backup_server_credentials_standard.additional_properties = d
        return backup_server_credentials_standard
