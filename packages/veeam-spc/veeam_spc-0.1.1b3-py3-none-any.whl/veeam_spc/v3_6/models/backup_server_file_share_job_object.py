...
if TYPE_CHECKING:
    ...
    from ..models.backup_server_file_share_job_object_last_session import BackupServerFileShareJobObjectLastSession


T = TypeVar("T", bound="BackupServerFileShareJobObject")


@_attrs_define
class BackupServerFileShareJobObject:
    """
    Attributes:
        ...
        last_session (Union[Unset, BackupServerFileShareJobObjectLastSession]):
    """
    ...
    last_session: Union[Unset, "BackupServerFileShareJobObjectLastSession"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_last_session, Unset):
            ...
            last_session = BackupServerFileShareJobObjectLastSession.from_dict(_last_session)

        backup_server_file_share_job_object = cls(
            job_uid=job_uid,
        ...
        backup_server_file_share_job_object.additional_properties = d
        return backup_server_file_share_job_object
