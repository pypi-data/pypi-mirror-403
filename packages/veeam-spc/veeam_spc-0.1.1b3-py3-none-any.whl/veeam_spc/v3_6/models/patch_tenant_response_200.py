...
T = TypeVar("T", bound="PatchTenantResponse200")


@_attrs_define
class PatchTenantResponse200:
    """
    Attributes:
        data (CloudTenant):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_tenant_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        patch_tenant_response_200.additional_properties = d
        return patch_tenant_response_200
