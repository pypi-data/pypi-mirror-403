...
T = TypeVar("T", bound="GetUsersByLocationResponse200")


@_attrs_define
class GetUsersByLocationResponse200:
    """
    Attributes:
        data (list['User']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_users_by_location_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_users_by_location_response_200.additional_properties = d
        return get_users_by_location_response_200
