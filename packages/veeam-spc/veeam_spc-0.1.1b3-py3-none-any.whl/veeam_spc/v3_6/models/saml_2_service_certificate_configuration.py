...
class Saml2ServiceCertificateConfiguration:
    ...
    Attributes:
        ...
        private_key_content (Union[Unset, str]): Private key content in base64 format.
        ...
        certificate_thumbprint (Union[Unset, str]): Thumbprint of a currently used certificate.
        store_name (Union[Unset, str]): Name of a certificate store.
        store_location (Union[Unset, str]): Location of a certificate store.
        x_509_find_type (Union[Unset, str]): Type of an expression used to serch for a certificate according to
    ...
    private_key_content: Union[Unset, str] = UNSET
    certificate_thumbprint: Union[Unset, str] = UNSET
    store_name: Union[Unset, str] = UNSET
    store_location: Union[Unset, str] = UNSET
    x_509_find_type: Union[Unset, str] = UNSET
