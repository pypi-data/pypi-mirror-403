...
T = TypeVar("T", bound="PublicCloudAwsAccountInput")


@_attrs_define
class PublicCloudAwsAccountInput:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        public_cloud_aws_account_input.additional_properties = d
        return public_cloud_aws_account_input
