...
T = TypeVar("T", bound="GetSiteVcdServerResponse200")


@_attrs_define
class GetSiteVcdServerResponse200:
    """
    Attributes:
        data (VcdServer):  Example: {'instanceUid': 'EDEB5975-B409-49B5-8ECE-FFFECB13494F', 'backupServerUid':
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = VcdServer.from_dict(d.pop("data"))
        ...
        get_site_vcd_server_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_site_vcd_server_response_200.additional_properties = d
        return get_site_vcd_server_response_200
