...
T = TypeVar("T", bound="LinuxConnectionSettings")


@_attrs_define
class LinuxConnectionSettings:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linux_connection_settings = cls(
            server_name=server_name,
            server_port=server_port,
        )

        linux_connection_settings.additional_properties = d
        return linux_connection_settings
