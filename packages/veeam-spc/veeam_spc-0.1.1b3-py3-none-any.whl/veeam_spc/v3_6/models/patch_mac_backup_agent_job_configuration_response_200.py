...
T = TypeVar("T", bound="PatchMacBackupAgentJobConfigurationResponse200")


@_attrs_define
class PatchMacBackupAgentJobConfigurationResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_mac_backup_agent_job_configuration_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        patch_mac_backup_agent_job_configuration_response_200.additional_properties = d
        return patch_mac_backup_agent_job_configuration_response_200
