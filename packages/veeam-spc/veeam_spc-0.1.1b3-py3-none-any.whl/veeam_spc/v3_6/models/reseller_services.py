...
class ResellerServices:
    ...
    Attributes:
        ...
        cloud_connect_quota (Union[Unset, ResellerCloudConnectQuota]): Veeam Cloud Connect resources provided to a
            reseller.
    ...
    cloud_connect_quota: Union[Unset, "ResellerCloudConnectQuota"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        cloud_connect_quota: Union[Unset, dict[str, Any]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        cloud_connect_quota: Union[Unset, ResellerCloudConnectQuota]
