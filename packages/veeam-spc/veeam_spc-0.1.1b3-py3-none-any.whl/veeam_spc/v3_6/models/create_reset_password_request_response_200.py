...
T = TypeVar("T", bound="CreateResetPasswordRequestResponse200")


@_attrs_define
class CreateResetPasswordRequestResponse200:
    """
    Attributes:
        data (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_reset_password_request_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        create_reset_password_request_response_200.additional_properties = d
        return create_reset_password_request_response_200
