...
from ..models.windows_daily_schedule_settings_specific_days_item import WindowsDailyScheduleSettingsSpecificDaysItem
...
class WindowsDailyScheduleSettings:
    ...
    Attributes:
        ...
        specific_days (Union[Unset, list[WindowsDailyScheduleSettingsSpecificDaysItem]]): Array of the week days on
    ...
    specific_days: Union[Unset, list[WindowsDailyScheduleSettingsSpecificDaysItem]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for specific_days_item_data in _specific_days or []:
            specific_days_item = WindowsDailyScheduleSettingsSpecificDaysItem(specific_days_item_data)
