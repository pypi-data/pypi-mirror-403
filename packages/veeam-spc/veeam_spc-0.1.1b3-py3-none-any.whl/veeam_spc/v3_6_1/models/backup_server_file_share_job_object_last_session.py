...
class BackupServerFileShareJobObjectLastSession:
    """
    Attributes:
        backup_status (Union[Unset, BackupServerFileShareJobObjectLastSessionBackupStatus]): Status of a job.
        source_files_count (Union[None, Unset, int]): Total number of files in all sources.
        changed_files_count (Union[None, Unset, int]): Number of processed files.
        ...
        transferred_size (Union[None, Unset, int]): Total size of backed up file share data, in bytes.
    ...
    backup_status: Union[Unset, BackupServerFileShareJobObjectLastSessionBackupStatus] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_status: Union[Unset, BackupServerFileShareJobObjectLastSessionBackupStatus]
