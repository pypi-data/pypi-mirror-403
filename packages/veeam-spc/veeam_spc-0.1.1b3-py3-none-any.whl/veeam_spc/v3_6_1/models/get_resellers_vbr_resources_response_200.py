...
if TYPE_CHECKING:
    from ..models.reseller_vbr_resource import ResellerVbrResource
    from ..models.response_error import ResponseError
    from ..models.response_metadata_type_0 import ResponseMetadataType0


T = TypeVar("T", bound="GetResellersVbrResourcesResponse200")


@_attrs_define
class GetResellersVbrResourcesResponse200:
    """
    Attributes:
        data (list['ResellerVbrResource']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = ResellerVbrResource.from_dict(data_item_data)
        ...
        get_resellers_vbr_resources_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_resellers_vbr_resources_response_200.additional_properties = d
        return get_resellers_vbr_resources_response_200
