...
T = TypeVar("T", bound="InstallVOneServerOnDiscoveryComputerResponse200")


@_attrs_define
class InstallVOneServerOnDiscoveryComputerResponse200:
    """
    Attributes:
        data (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        install_v_one_server_on_discovery_computer_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        install_v_one_server_on_discovery_computer_response_200.additional_properties = d
        return install_v_one_server_on_discovery_computer_response_200
