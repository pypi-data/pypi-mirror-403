...
T = TypeVar("T", bound="PatchTenantReplicationResourceResponse200")


@_attrs_define
class PatchTenantReplicationResourceResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_tenant_replication_resource_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        patch_tenant_replication_resource_response_200.additional_properties = d
        return patch_tenant_replication_resource_response_200
