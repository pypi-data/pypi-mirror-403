...
class ResellerLicenseResource:
    ...
    Attributes:
        ...
        license_contract_id (Union[None, Unset, str]): ID assigned to a license rental agreement contract.
        license_points_quota (Union[None, Unset, int]): Number of license points available to a reseller.
    ...
    license_contract_id: Union[None, Unset, str] = UNSET
    license_points_quota: Union[None, Unset, int] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_license_contract_id(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
        ...
        def _parse_license_points_quota(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
