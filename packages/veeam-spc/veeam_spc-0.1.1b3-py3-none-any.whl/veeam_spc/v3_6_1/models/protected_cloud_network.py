...
class ProtectedCloudNetwork:
    ...
    Attributes:
        ...
        account_uid (Union[None, UUID, Unset]): UID assigned to a public cloud account.
        account_name (Union[Unset, str]): Name of a public cloud account.
        subscription_uid (Union[None, UUID, Unset]): UID assigned to a cloud subscription.
    ...
    subscription_uid: Union[None, UUID, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        subscription_uid: Union[None, Unset, str]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_subscription_uid(data: object) -> Union[None, UUID, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
