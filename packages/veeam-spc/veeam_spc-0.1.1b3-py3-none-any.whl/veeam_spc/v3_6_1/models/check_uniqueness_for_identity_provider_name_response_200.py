...
T = TypeVar("T", bound="CheckUniquenessForIdentityProviderNameResponse200")


@_attrs_define
class CheckUniquenessForIdentityProviderNameResponse200:
    """
    Attributes:
        data (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        check_uniqueness_for_identity_provider_name_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        check_uniqueness_for_identity_provider_name_response_200.additional_properties = d
        return check_uniqueness_for_identity_provider_name_response_200
