...
class WindowsPersonalFilesBackupAdvancedSettings:
    """
    Attributes:
        inclusions (list[WindowsPersonalFilesBackupAdvancedSettingsInclusionsItem]): Profile folders that must be
            included in the backup scope.
        exclude_network_account (Union[Unset, bool]): Indicates whether roaming user profiles must be excluded from the
            backup scope. Default: False.
    """

    inclusions: list[WindowsPersonalFilesBackupAdvancedSettingsInclusionsItem]
