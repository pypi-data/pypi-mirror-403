...
class GetBackupServerResponse200:
    """
    Attributes:
        data (BackupServer):  Example: {'instanceUid': 'DF997BD3-4AE9-4841-8152-8FF5CC703EAB', 'name': 'VBR',
            'managementAgentUid': '8BDD0D87-D160-40B5-88D3-E77A6F912AF6', 'version': '9.5.4.1000', 'installationUid':
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = BackupServer.from_dict(d.pop("data"))
