...
T = TypeVar("T", bound="GetResellerVbrResourceResponse200")


@_attrs_define
class GetResellerVbrResourceResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_reseller_vbr_resource_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_reseller_vbr_resource_response_200.additional_properties = d
        return get_reseller_vbr_resource_response_200
