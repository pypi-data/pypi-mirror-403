...
class BackupAgentJob:
    ...
    Attributes:
        ...
        original_uid (Union[None, UUID, Unset]): UID assigned to a job on Veeam backup agent side.
        ...
        name (Union[None, Unset, str]): Name of a Veeam backup agent job.
        description (Union[None, Unset, str]): Description of a Veeam backup agent job.
        ...
        last_modified_date (Union[None, Unset, datetime.datetime]): Date and time when settings of a backup job were
            last modified.
        last_modified_by (Union[None, Unset, str]): Name of a user who last modified job settings.
    ...
    original_uid: Union[None, UUID, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        original_uid: Union[None, Unset, str]
        if isinstance(self.original_uid, Unset):
            original_uid = UNSET
        elif isinstance(self.original_uid, UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_original_uid(data: object) -> Union[None, UUID, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, str):
                    raise TypeError()
                original_uid_type_0 = UUID(data)

                return original_uid_type_0
            except:  # noqa: E722
                pass
            return cast(Union[None, UUID, Unset], data)

        original_uid = _parse_original_uid(d.pop("originalUid", UNSET))
