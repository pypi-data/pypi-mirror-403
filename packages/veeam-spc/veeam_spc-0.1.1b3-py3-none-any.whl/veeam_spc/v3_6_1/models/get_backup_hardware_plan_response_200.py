...
class GetBackupHardwarePlanResponse200:
    """
    Attributes:
        data (BackupHardwarePlan):  Example: {'instanceUid': '8db62bf7-581b-437b-b640-76212ff40b3a', 'name': 'Silver
            Hardware Plan', 'backupServerUid': 'DF997BD3-4AE9-4841-8152-8FF5CC703EAB', 'CpuQuota': 7770, 'MemoryQuota':
            7368000, 'NetworkQuota': 3}.
        meta (Union['ResponseMetadataType0', None, Unset]):
        errors (Union[None, Unset, list['ResponseError']]):
    """

    data: "BackupHardwarePlan"
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = BackupHardwarePlan.from_dict(d.pop("data"))
