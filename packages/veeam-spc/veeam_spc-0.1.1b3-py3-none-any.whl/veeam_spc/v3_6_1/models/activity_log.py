...
class ActivityLog:
    ...
    Attributes:
        ...
        user_uid (Union[None, UUID, Unset]): UID assigned to a user that initiated an activity.
        organization_uid (Union[None, UUID, Unset]): UID assigned to an organization.
    """
