...
class CreateBackupServerStandardCredentialsResponse200:
    """
    Attributes:
        data (Union['BackupServerCredentialsStandardType0', None]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> Union["BackupServerCredentialsStandardType0", None]:
            if data is None:
                return data
            try:
                ...
                pass
            return cast(Union["BackupServerCredentialsStandardType0", None], data)
        ...
        create_backup_server_standard_credentials_response_200.additional_properties = d
        return create_backup_server_standard_credentials_response_200
