...
class PublicCloudGoogleAccount:
    ...
    Attributes:
        ...
        description (Union[None, Unset, str]): Description of a Google Cloud account.
        ...
        json_configuration (Union[None, Unset, str]): Configuration file of a Google Cloud account in the `JSON` format.
    """
    ...
    json_configuration: Union[None, Unset, str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_json_configuration(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
