...
T = TypeVar("T", bound="InstallLinuxBackupAgentOnDiscoveryComputerResponse200")


@_attrs_define
class InstallLinuxBackupAgentOnDiscoveryComputerResponse200:
    """
    Attributes:
        data (Union[None, UUID]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> Union[None, UUID]:
            if data is None:
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                data_type_0 = UUID(data)
        ...
        install_linux_backup_agent_on_discovery_computer_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        install_linux_backup_agent_on_discovery_computer_response_200.additional_properties = d
        return install_linux_backup_agent_on_discovery_computer_response_200
