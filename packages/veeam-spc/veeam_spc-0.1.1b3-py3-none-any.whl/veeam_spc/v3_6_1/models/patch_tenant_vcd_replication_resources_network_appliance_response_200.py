...
T = TypeVar("T", bound="PatchTenantVcdReplicationResourcesNetworkApplianceResponse200")


@_attrs_define
class PatchTenantVcdReplicationResourcesNetworkApplianceResponse200:
    """
    Attributes:
        data (TenantReplicationResourceVcdNetworkAppliance):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = TenantReplicationResourceVcdNetworkAppliance.from_dict(d.pop("data"))
        ...
        patch_tenant_vcd_replication_resources_network_appliance_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        patch_tenant_vcd_replication_resources_network_appliance_response_200.additional_properties = d
        return patch_tenant_vcd_replication_resources_network_appliance_response_200
