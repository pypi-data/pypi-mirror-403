...
T = TypeVar("T", bound="PublicCloudAwsNewApplianceInputAccount")


@_attrs_define
class PublicCloudAwsNewApplianceInputAccount:
    """
    Attributes:
        connection_uid (UUID): UID assigned to an AWS connection.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        public_cloud_aws_new_appliance_input_account = cls(
        ...
        public_cloud_aws_new_appliance_input_account.additional_properties = d
        return public_cloud_aws_new_appliance_input_account
