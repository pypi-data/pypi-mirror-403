...
class Vb365Server:
    """
    Attributes:
        instance_uid (Union[None, UUID, Unset]): UID assigned to a Veeam Backup for Microsoft 365 server.
        ...
        installation_uid (Union[None, UUID, Unset]): UID assigned to a Veeam Backup for Microsoft 365 server
            installation.
    ...
    installation_uid: Union[None, UUID, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        installation_uid: Union[None, Unset, str]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_installation_uid(data: object) -> Union[None, UUID, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
