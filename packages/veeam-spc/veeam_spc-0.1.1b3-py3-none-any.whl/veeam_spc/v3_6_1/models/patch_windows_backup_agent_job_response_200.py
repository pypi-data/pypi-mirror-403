...
class PatchWindowsBackupAgentJobResponse200:
    r"""
    Attributes:
        data (WindowsBackupAgentJob):  Example: {'backupAgentUid': 'CCEB5975-B409-49B5-8ECE-FFFECB13494F', 'name': 'VAW
            job 2 Cloud', 'configUid': 'AF097BD3-4AE9-4841-8152-8FF5CC703EAB', 'status': 'Success', 'operationMode':
            'Server', 'backupMode': 'File', 'destination': '\\\\share\\backup\\test', 'restorePoints': 4, 'lastRun':
            '2018-11-01T10:35:00.0000000+00:00', 'lastEndTime': '2018-11-01T10:45:00.0000000+00:00', 'lastDuration': 600,
            'nextRun': '2018-12-01T10:35:00.0000000+00:00', 'avgDuration': 575, 'targetType': 'Local', 'isEnabled': True,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = WindowsBackupAgentJob.from_dict(d.pop("data"))
