...
T = TypeVar("T", bound="IdentityProviderCompanyTenantMappingParametersType0")


@_attrs_define
class IdentityProviderCompanyTenantMappingParametersType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        identity_provider_company_tenant_mapping_parameters_type_0 = cls(
            site_name_source_claim_type=site_name_source_claim_type,
            tenant_name_source_claim_type=tenant_name_source_claim_type,
        )

        identity_provider_company_tenant_mapping_parameters_type_0.additional_properties = d
        return identity_provider_company_tenant_mapping_parameters_type_0
