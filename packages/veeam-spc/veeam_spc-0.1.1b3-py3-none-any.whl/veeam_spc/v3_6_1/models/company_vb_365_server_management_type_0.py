...
T = TypeVar("T", bound="CompanyVb365ServerManagementType0")


@_attrs_define
class CompanyVb365ServerManagementType0:
    """Managed Veeam Backup for Microsoft 365 server quota.

    Attributes:
        backup_server_quota (Union[None, Unset, int]): Number of Veeam Backup for Microsoft 365 servers that a company
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_vb_365_server_management_type_0 = cls(
            backup_server_quota=backup_server_quota,
        )

        company_vb_365_server_management_type_0.additional_properties = d
        return company_vb_365_server_management_type_0
