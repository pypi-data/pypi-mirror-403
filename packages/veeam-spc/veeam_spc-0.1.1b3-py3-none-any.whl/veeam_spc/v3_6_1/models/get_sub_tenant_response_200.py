...
class GetSubTenantResponse200:
    """
    Attributes:
        data (CloudSubTenant):  Example: {'instanceUid': '1111568E-F90F-4702-8151-CBE3CE2A8C10', 'tenantUid':
            '0000568E-F90F-4702-8151-CBE3CE2A8C10', 'name': 'SubTenant01', 'description': 'SubTenant X for Agent X',
            'backupServerUid': 'DF997BD3-4AE9-4841-8152-8FF5CC703EAB', 'isEnabled': True}.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = CloudSubTenant.from_dict(d.pop("data"))
