...
class TenantReplicationResourceInput:
    ...
    Attributes:
        ...
        is_public_allocation_enabled (Union[None, Unset, bool]): Indicates whether public IP addresses are allocated to
            a company. Default: False.
        number_of_public_ips (Union[None, Unset, int]): Number of allocated public IP addresses. Default: 0.
    """
    ...
    is_public_allocation_enabled: Union[None, Unset, bool] = False
    number_of_public_ips: Union[None, Unset, int] = 0
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        is_public_allocation_enabled: Union[None, Unset, bool]
        ...
        number_of_public_ips: Union[None, Unset, int]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_is_public_allocation_enabled(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
        ...
        def _parse_number_of_public_ips(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
