...
if TYPE_CHECKING:
    ...
    from ..models.tenant_vcd_replication_resource_usage import TenantVcdReplicationResourceUsage


T = TypeVar("T", bound="GetTenantsVcdReplicationResourcesUsagesResponse200")


@_attrs_define
class GetTenantsVcdReplicationResourcesUsagesResponse200:
    """
    Attributes:
        data (list['TenantVcdReplicationResourceUsage']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = TenantVcdReplicationResourceUsage.from_dict(data_item_data)
        ...
        get_tenants_vcd_replication_resources_usages_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_tenants_vcd_replication_resources_usages_response_200.additional_properties = d
        return get_tenants_vcd_replication_resources_usages_response_200
