...
if TYPE_CHECKING:
    ...
    from ..models.tenant_replication_resource_network_appliance import TenantReplicationResourceNetworkAppliance


T = TypeVar("T", bound="GetTenantReplicationResourcesNetworkAppliancesResponse200")


@_attrs_define
class GetTenantReplicationResourcesNetworkAppliancesResponse200:
    """
    Attributes:
        data (list['TenantReplicationResourceNetworkAppliance']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = TenantReplicationResourceNetworkAppliance.from_dict(data_item_data)
        ...
        get_tenant_replication_resources_network_appliances_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_tenant_replication_resources_network_appliances_response_200.additional_properties = d
        return get_tenant_replication_resources_network_appliances_response_200
