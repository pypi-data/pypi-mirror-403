...
class OrganizationCurrentLicenseUsage:
    ...
    Attributes:
        ...
        provider_uid (Union[None, UUID, Unset]): UID assigned to a provider organization.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        provider_uid: Union[None, Unset, str]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_provider_uid(data: object) -> Union[None, UUID, Unset]:
            if data is None:
                return data
