...
T = TypeVar("T", bound="GetWindowsBackupAgentJobsByAgentResponse200")


@_attrs_define
class GetWindowsBackupAgentJobsByAgentResponse200:
    """
    Attributes:
        data (list['WindowsBackupAgentJob']):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_windows_backup_agent_jobs_by_agent_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        get_windows_backup_agent_jobs_by_agent_response_200.additional_properties = d
        return get_windows_backup_agent_jobs_by_agent_response_200
