...
class TenantBackupResourceUsage:
    ...
    Attributes:
        ...
        archive_tier_usage (Union[None, Unset, int]): Amount of archive tier space consumed by a company, in bytes.
        ...
        performance_tier_usage (Union[None, Unset, int]): Amount of performance tier space consumed by a company, in
            bytes.
