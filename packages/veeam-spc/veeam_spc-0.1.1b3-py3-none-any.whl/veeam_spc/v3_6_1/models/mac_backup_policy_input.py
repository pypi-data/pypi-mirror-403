...
T = TypeVar("T", bound="MacBackupPolicyInput")


@_attrs_define
class MacBackupPolicyInput:
    """
    Attributes:
        ...
        description (Union[Unset, str]): Description of a backup policy. Default: ''.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mac_backup_policy_input.additional_properties = d
        return mac_backup_policy_input
