...
T = TypeVar("T", bound="BackupServerBackupJobWindowsScriptType0")


@_attrs_define
class BackupServerBackupJobWindowsScriptType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_backup_job_windows_script_type_0 = cls(
            pre_freeze_script=pre_freeze_script,
            post_thaw_script=post_thaw_script,
        )

        backup_server_backup_job_windows_script_type_0.additional_properties = d
        return backup_server_backup_job_windows_script_type_0
