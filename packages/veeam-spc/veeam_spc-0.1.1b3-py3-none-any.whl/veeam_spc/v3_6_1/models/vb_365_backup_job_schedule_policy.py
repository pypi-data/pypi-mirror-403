...
class Vb365BackupJobSchedulePolicy:
    ...
    Attributes:
        ...
        periodically_window_enabled (Union[None, Unset, bool]): Indicates whether backup window is enabled for
            periodically running jobs.
        periodically_offset_minutes (Union[None, Unset, int]): Number of minutes that must be skipped after specified
            job starting time. Default: 0.
        daily_time (Union[None, Unset, str]): Time of day when job must start in the `hh:mm` format.
        retry_enabled (Union[Unset, bool]): Indicates whether job retry is enabled. Default: False.
        retry_number (Union[None, Unset, int]): Number of allowed retries.
        retry_wait_interval (Union[None, Unset, int]): Time interval between job retries.
    """
    ...
    periodically_window_enabled: Union[None, Unset, bool] = UNSET
    periodically_offset_minutes: Union[None, Unset, int] = 0
    daily_time: Union[None, Unset, str] = UNSET
    retry_enabled: Union[Unset, bool] = False
    retry_number: Union[None, Unset, int] = UNSET
    retry_wait_interval: Union[None, Unset, int] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        periodically_window_enabled: Union[None, Unset, bool]
        ...
        periodically_offset_minutes: Union[None, Unset, int]
        ...
        retry_number: Union[None, Unset, int]
        if isinstance(self.retry_number, Unset):
            retry_number = UNSET
        else:
            retry_number = self.retry_number

        retry_wait_interval: Union[None, Unset, int]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_periodically_window_enabled(data: object) -> Union[None, Unset, bool]:
            if data is None:
                return data
        ...
        def _parse_periodically_offset_minutes(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_retry_number(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        def _parse_retry_wait_interval(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
