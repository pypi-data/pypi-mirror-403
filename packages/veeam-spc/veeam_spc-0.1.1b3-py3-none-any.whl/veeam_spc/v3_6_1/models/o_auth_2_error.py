...
class OAuth2Error:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        error_uri: Union[None, Unset, str]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_error_uri(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
