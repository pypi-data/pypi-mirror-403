...
class SubscriptionPlan:
    ...
    Attributes:
        ...
        organization_uid (Union[None, UUID, Unset]): Name of an organization whose user created a subscription plan.
        type_ (Union[Unset, SubscriptionPlanType]): Type of subscription plan.
        description (Union[None, Unset, str]): Description of a subscription plan.
