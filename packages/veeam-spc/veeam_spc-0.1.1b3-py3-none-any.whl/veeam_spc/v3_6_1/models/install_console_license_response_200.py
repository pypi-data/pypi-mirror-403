...
T = TypeVar("T", bound="InstallConsoleLicenseResponse200")


@_attrs_define
class InstallConsoleLicenseResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        install_console_license_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        install_console_license_response_200.additional_properties = d
        return install_console_license_response_200
