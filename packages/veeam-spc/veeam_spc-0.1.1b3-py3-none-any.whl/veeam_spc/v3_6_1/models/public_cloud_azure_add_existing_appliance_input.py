...
if TYPE_CHECKING:
    ...
    from ..models.public_cloud_azure_add_existing_appliance_input_network_type_0 import (
...
class PublicCloudAzureAddExistingApplianceInput:
    ...
    Attributes:
        ...
        network (Union['PublicCloudAzureAddExistingApplianceInputNetworkType0', None, Unset]):
    """

    account: "PublicCloudAzureAddExistingApplianceInputAccount"
    virtual_machine: "PublicCloudAzureAddExistingApplianceInputVirtualMachine"
    guest_os_credentials: "PublicCloudAzureAddExistingApplianceInputGuestOsCredentials"
    network: Union["PublicCloudAzureAddExistingApplianceInputNetworkType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.network, Unset):
            network = UNSET
        elif isinstance(self.network, PublicCloudAzureAddExistingApplianceInputNetworkType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_network(data: object) -> Union["PublicCloudAzureAddExistingApplianceInputNetworkType0", None, Unset]:
            if data is None:
                return data
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                network_type_0 = PublicCloudAzureAddExistingApplianceInputNetworkType0.from_dict(data)

                return network_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PublicCloudAzureAddExistingApplianceInputNetworkType0", None, Unset], data)
