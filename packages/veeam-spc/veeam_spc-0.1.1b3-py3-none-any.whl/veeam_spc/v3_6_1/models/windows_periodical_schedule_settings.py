...
T = TypeVar("T", bound="WindowsPeriodicalScheduleSettings")


@_attrs_define
class WindowsPeriodicalScheduleSettings:
    """
    Attributes:
        interval_in_minutes (int): Time interval for a periodically running job, in minutes.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        interval_in_minutes = d.pop("intervalInMinutes")
        ...
        windows_periodical_schedule_settings = cls(
            interval_in_minutes=interval_in_minutes,
            backup_window_settings=backup_window_settings,
        )

        windows_periodical_schedule_settings.additional_properties = d
        return windows_periodical_schedule_settings
