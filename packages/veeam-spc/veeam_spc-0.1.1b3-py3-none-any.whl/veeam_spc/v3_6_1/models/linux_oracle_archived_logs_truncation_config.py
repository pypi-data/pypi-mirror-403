...
class LinuxOracleArchivedLogsTruncationConfig:
    ...
    Attributes:
        ...
        size_gb (Union[None, Unset, int]): Maximum threshold for archived log file size, in GB. If an archived log file
            exceeds the limitation, it is deleted.
            > For the `TruncateBySize` archived log processing mode the property value must not be `0`.
             Default: 10.
        life_time_hours (Union[None, Unset, int]): Amount of time after which archived logs must be deleted, in hours.
    ...
    size_gb: Union[None, Unset, int] = 10
    life_time_hours: Union[None, Unset, int] = 24
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        size_gb: Union[None, Unset, int]
        if isinstance(self.size_gb, Unset):
            size_gb = UNSET
        else:
            size_gb = self.size_gb

        life_time_hours: Union[None, Unset, int]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_size_gb(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
        ...
        def _parse_life_time_hours(data: object) -> Union[None, Unset, int]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
