...
class TenantReplicationResourceNetworkAppliance:
    ...
    Attributes:
        ...
        host_name (Union[None, Unset, str]): Name of a host on which network extension appliance is deployed.
        root_host_name (Union[None, Unset, str]): Name of a root host on which network extension appliance is deployed.
    ...
    root_host_name: Union[None, Unset, str] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        root_host_name: Union[None, Unset, str]
        if isinstance(self.root_host_name, Unset):
            root_host_name = UNSET
        else:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_root_host_name(data: object) -> Union[None, Unset, str]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        root_host_name = _parse_root_host_name(d.pop("rootHostName", UNSET))
