...
class CreateResetPasswordRequestBody:
    ...
    Attributes:
        ...
        return_url (Union[None, Unset, str]): Relative URL that contains the password reset code in query parameters.
            The URL is send to the user email address provided in the `email` property.
    """
