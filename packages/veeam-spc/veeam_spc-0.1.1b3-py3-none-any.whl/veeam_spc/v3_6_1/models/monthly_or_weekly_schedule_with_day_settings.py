...
from ..models.monthly_or_weekly_schedule_with_day_settings_weekly_on_days_type_0_item import (
...
T = TypeVar("T", bound="MonthlyOrWeeklyScheduleWithDaySettings")


@_attrs_define
class MonthlyOrWeeklyScheduleWithDaySettings:
    """
    Attributes:
        monthly_settings (Union[Unset, WindowsMonthlyScheduleCalendarWithDaySettings]):
        weekly_on_days (Union[None, Unset, list[MonthlyOrWeeklyScheduleWithDaySettingsWeeklyOnDaysType0Item]]):
            Scheduling settings for weekly full backup creation.
            > If the `monthlySettings` property is also provided, it is ignored.
    """

    monthly_settings: Union[Unset, "WindowsMonthlyScheduleCalendarWithDaySettings"] = UNSET
    weekly_on_days: Union[None, Unset, list[MonthlyOrWeeklyScheduleWithDaySettingsWeeklyOnDaysType0Item]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_monthly_settings, Unset):
            ...
            monthly_settings = WindowsMonthlyScheduleCalendarWithDaySettings.from_dict(_monthly_settings)

        def _parse_weekly_on_days(
            data: object,
        ) -> Union[None, Unset, list[MonthlyOrWeeklyScheduleWithDaySettingsWeeklyOnDaysType0Item]]:
            if data is None:
                return data
            ...
            try:
                ...
                for weekly_on_days_type_0_item_data in _weekly_on_days_type_0:
                    weekly_on_days_type_0_item = MonthlyOrWeeklyScheduleWithDaySettingsWeeklyOnDaysType0Item(
                ...
                pass
            return cast(Union[None, Unset, list[MonthlyOrWeeklyScheduleWithDaySettingsWeeklyOnDaysType0Item]], data)

        weekly_on_days = _parse_weekly_on_days(d.pop("weeklyOnDays", UNSET))

        monthly_or_weekly_schedule_with_day_settings = cls(
            monthly_settings=monthly_settings,
            weekly_on_days=weekly_on_days,
        )

        monthly_or_weekly_schedule_with_day_settings.additional_properties = d
        return monthly_or_weekly_schedule_with_day_settings
