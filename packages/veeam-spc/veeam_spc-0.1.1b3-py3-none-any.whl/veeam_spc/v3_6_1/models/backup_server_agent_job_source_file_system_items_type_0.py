...
T = TypeVar("T", bound="BackupServerAgentJobSourceFileSystemItemsType0")


@_attrs_define
class BackupServerAgentJobSourceFileSystemItemsType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_agent_job_source_file_system_items_type_0 = cls(
            volumes=volumes,
            files_and_folders=files_and_folders,
        )

        backup_server_agent_job_source_file_system_items_type_0.additional_properties = d
        return backup_server_agent_job_source_file_system_items_type_0
