...
T = TypeVar("T", bound="UpgradeVOneServerResponse200")


@_attrs_define
class UpgradeVOneServerResponse200:
    """
    Attributes:
        data (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        upgrade_v_one_server_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        upgrade_v_one_server_response_200.additional_properties = d
        return upgrade_v_one_server_response_200
