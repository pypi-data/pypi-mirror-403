...
T = TypeVar("T", bound="EmbeddedForWindowsDiscoveryRuleChildrenType0")


@_attrs_define
class EmbeddedForWindowsDiscoveryRuleChildrenType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        embedded_for_windows_discovery_rule_children_type_0 = cls(
            discovery_rule=discovery_rule,
            windows_discovery_rule=windows_discovery_rule,
        )

        embedded_for_windows_discovery_rule_children_type_0.additional_properties = d
        return embedded_for_windows_discovery_rule_children_type_0
