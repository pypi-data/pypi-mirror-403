...
class UnactivatedVb365Server:
    """
    Attributes:
        unique_uid (Union[None, UUID, Unset]): Temporary UID assigned to an unactivated Veeam Backup for Microsoft 365
            server.
    ...
    unique_uid: Union[None, UUID, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        unique_uid: Union[None, Unset, str]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_unique_uid(data: object) -> Union[None, UUID, Unset]:
            if data is None:
                return data
