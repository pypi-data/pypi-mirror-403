...
T = TypeVar("T", bound="CreateTenantVcdReplicationResourceResponse200")


@_attrs_define
class CreateTenantVcdReplicationResourceResponse200:
    """
    Attributes:
        data (TenantVcdReplicationResource):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = TenantVcdReplicationResource.from_dict(d.pop("data"))
        ...
        create_tenant_vcd_replication_resource_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        create_tenant_vcd_replication_resource_response_200.additional_properties = d
        return create_tenant_vcd_replication_resource_response_200
