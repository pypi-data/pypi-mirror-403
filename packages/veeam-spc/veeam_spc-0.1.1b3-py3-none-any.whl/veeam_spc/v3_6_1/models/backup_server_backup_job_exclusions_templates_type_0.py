...
T = TypeVar("T", bound="BackupServerBackupJobExclusionsTemplatesType0")


@_attrs_define
class BackupServerBackupJobExclusionsTemplatesType0:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_backup_job_exclusions_templates_type_0 = cls(
            is_enabled=is_enabled,
            exclude_from_incremental=exclude_from_incremental,
        )

        backup_server_backup_job_exclusions_templates_type_0.additional_properties = d
        return backup_server_backup_job_exclusions_templates_type_0
