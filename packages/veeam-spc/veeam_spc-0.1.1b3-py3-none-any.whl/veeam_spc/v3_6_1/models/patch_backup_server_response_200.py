...
T = TypeVar("T", bound="PatchBackupServerResponse200")


@_attrs_define
class PatchBackupServerResponse200:
    """
    Attributes:
        data (UUID):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_backup_server_response_200 = cls(
            data=data,
            meta=meta,
            errors=errors,
        )

        patch_backup_server_response_200.additional_properties = d
        return patch_backup_server_response_200
