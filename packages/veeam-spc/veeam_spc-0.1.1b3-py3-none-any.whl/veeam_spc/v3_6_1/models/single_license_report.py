...
class SingleLicenseReport:
    ...
    Attributes:
        ...
        report_parameters (Union[Unset, LicenseReportParameters]):
    ...
    report_parameters: Union[Unset, "LicenseReportParameters"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        report_parameters: Union[Unset, dict[str, Any]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_report_parameters, Unset):
            ...
            report_parameters = LicenseReportParameters.from_dict(_report_parameters)
