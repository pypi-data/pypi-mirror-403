...
class BackupServerCloudDirectorBackupJobConfiguration:
    ...
    Attributes:
        ...
        mapped_organization_uid (Union[None, UUID, Unset]): UID assigned to an organization to which a backup job
            belongs.
        mapped_organization_name (Union[None, Unset, str]): Name of an organization to which a backup job belongs.
        backup_server_uid (Union[Unset, UUID]): UID of a Veeam Backup & Replication server.
        backup_server_name (Union[Unset, str]): Name of a Veeam Backup & Replication server.
        guest_processing (Union[Unset, BackupServerCloudDirectorBackupJobGuestProcessing]): Guest processing settings.
    ...
    guest_processing: Union[Unset, "BackupServerCloudDirectorBackupJobGuestProcessing"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        guest_processing: Union[Unset, BackupServerCloudDirectorBackupJobGuestProcessing]
