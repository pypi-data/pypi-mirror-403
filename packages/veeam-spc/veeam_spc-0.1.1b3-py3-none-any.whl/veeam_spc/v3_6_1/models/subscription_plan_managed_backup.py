...
class SubscriptionPlanManagedBackup:
    ...
    Attributes:
        ...
        remote_free_backup_used_space (Union[None, Unset, int]): Amount of backup repository space that can be consumed
            by all remote non-cloud backups for free.
        ...
        hosted_free_backup_used_space (Union[None, Unset, int]): Amount of backup repository space that can be consumed
            by all non-cloud backups for free.
            > Maximum value is `1048576` for GB and `1024` for TB.
