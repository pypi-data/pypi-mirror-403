...
class BackupServerBackupJobConfiguration:
    ...
    Attributes:
        ...
        mapped_organization_uid (Union[None, UUID, Unset]): UID assigned to an organization that is mapped to a backup
            job on a hosted Veeam Backup & Replication server.
        mapped_organization_name (Union[None, Unset, str]): Name of an organization that is mapped to a backup job on a
