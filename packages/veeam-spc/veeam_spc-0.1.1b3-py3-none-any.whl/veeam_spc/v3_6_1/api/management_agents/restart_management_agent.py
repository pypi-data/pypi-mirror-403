...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/managementAgents/{management_agent_uid}/restart",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Restart Management Agent
     ...
     Restarts a management agent with the specified UID. Returns a positive response when the management
    agent receives the restart task and not when the task is executed.
