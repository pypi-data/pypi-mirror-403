...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/managementAgents/{management_agent_uid}/reboot",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Reboot System on Managed Computer
     ...
     Runs system reboot on a computer where management agent with the specified UID is installed. Returns
    a positive response when the management agent receives the reboot task and not when the task is
    executed.
