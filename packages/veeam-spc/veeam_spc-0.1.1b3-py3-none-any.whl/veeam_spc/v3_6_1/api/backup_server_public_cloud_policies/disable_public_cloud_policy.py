...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/backupServers/publicCloud/policies/{policy_uid}/disable",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Disable Veeam Backup for Public Clouds Policy

     Disables a Veeam Backup for Public Clouds policy with the specified UID.
