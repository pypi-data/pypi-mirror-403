...
from ...models.patch_tenant_replication_resource_response_200 import PatchTenantReplicationResourceResponse200
...
) -> Union[Any, ErrorResponse, PatchTenantReplicationResourceResponse200]:
    if response.status_code == 200:
        response_200 = PatchTenantReplicationResourceResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchTenantReplicationResourceResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchTenantReplicationResourceResponse200]]:
    """Modify Tenant Replication Resource
