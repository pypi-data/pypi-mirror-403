...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/infrastructure/sites/{site_uid}/vcdServers/vcdOrganizations/{vcd_organization_uid}/vDCs",
        "params": params,
    }
...
) -> Union[Any, ErrorResponse, GetSitesVcdOrganizationVDCsByOrganizationResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetSitesVcdOrganizationVDCsByOrganizationResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetSitesVcdOrganizationVDCsByOrganizationResponse200]]:
    """Get All VDCs Providing Resources to VMware Cloud Director Organization Managed by Veeam Cloud
    Connect Site
