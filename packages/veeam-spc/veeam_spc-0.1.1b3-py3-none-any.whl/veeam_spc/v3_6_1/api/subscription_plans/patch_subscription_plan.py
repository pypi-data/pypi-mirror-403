...
from ...models.patch_subscription_plan_response_200 import PatchSubscriptionPlanResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/subscriptionPlans/{subscription_plan_uid}",
    }
...
) -> Union[Any, ErrorResponse, PatchSubscriptionPlanResponse200]:
    if response.status_code == 200:
        response_200 = PatchSubscriptionPlanResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchSubscriptionPlanResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchSubscriptionPlanResponse200]]:
    """Modify Subscription Plan
