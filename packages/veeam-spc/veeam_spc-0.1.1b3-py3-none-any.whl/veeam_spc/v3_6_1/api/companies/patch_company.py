...
from ...models.patch_company_response_200 import PatchCompanyResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/organizations/companies/{company_uid}",
    }
...
) -> Union[Any, ErrorResponse, PatchCompanyResponse200]:
    if response.status_code == 200:
        response_200 = PatchCompanyResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchCompanyResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchCompanyResponse200]]:
    """Modify Company
