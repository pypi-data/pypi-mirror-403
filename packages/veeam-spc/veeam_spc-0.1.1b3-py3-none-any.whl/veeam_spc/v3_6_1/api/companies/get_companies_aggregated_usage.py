...
) -> Union[Any, ErrorResponse, GetCompaniesAggregatedUsageResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetCompaniesAggregatedUsageResponse200]]:
    return Response(
...
def sync(
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetCompaniesAggregatedUsageResponse200]]:
    """Get Services Usage by All Companies
