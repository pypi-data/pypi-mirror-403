...
from ...models.patch_windows_discovery_rule_response_200 import PatchWindowsDiscoveryRuleResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/discovery/rules/windows/{rule_uid}",
    }
...
) -> Union[Any, ErrorResponse, PatchWindowsDiscoveryRuleResponse200]:
    if response.status_code == 200:
        response_200 = PatchWindowsDiscoveryRuleResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchWindowsDiscoveryRuleResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchWindowsDiscoveryRuleResponse200]]:
    """Modify Discovery Rule for Windows
