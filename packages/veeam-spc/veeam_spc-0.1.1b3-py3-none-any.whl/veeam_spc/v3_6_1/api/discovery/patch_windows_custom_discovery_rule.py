...
from ...models.patch_windows_custom_discovery_rule_response_200 import PatchWindowsCustomDiscoveryRuleResponse200
...
) -> Union[Any, ErrorResponse, PatchWindowsCustomDiscoveryRuleResponse200]:
    if response.status_code == 200:
        response_200 = PatchWindowsCustomDiscoveryRuleResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchWindowsCustomDiscoveryRuleResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchWindowsCustomDiscoveryRuleResponse200]]:
    """Modify Import-Based Discovery Rule for Windows
