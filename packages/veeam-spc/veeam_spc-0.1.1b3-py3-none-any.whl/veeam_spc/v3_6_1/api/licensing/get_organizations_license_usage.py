...
def _get_kwargs(
    *,
    ...
    organization_type: Union[Unset, GetOrganizationsLicenseUsageOrganizationType] = UNSET,
    provider_uid: Union[None, UUID, Unset] = UNSET,
    server_uid: Union[None, UUID, Unset] = UNSET,
    server_type: Union[Unset, GetOrganizationsLicenseUsageServerType] = UNSET,
    ...
    json_provider_uid: Union[None, Unset, str]
    ...
    json_server_uid: Union[None, Unset, str]
    ...
    json_server_type: Union[Unset, str] = UNSET
...
) -> Union[Any, ErrorResponse, GetOrganizationsLicenseUsageResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetOrganizationsLicenseUsageResponse200]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        organization_uid (Union[None, UUID, Unset]):
        organization_type (Union[Unset, GetOrganizationsLicenseUsageOrganizationType]):
        provider_uid (Union[None, UUID, Unset]):
        server_uid (Union[None, UUID, Unset]):
        server_type (Union[Unset, GetOrganizationsLicenseUsageServerType]):
...
def sync(
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetOrganizationsLicenseUsageResponse200]]:
    """Get License Usage by All Organizations
