...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/backupAgents/windows/{backup_agent_uid}/uninstallCbtDriver",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Uninstall CBT Driver

     Uninstalls the Veeam CBT driver from a Windows computer that runs Veeam Agent with the specified
    UID.
