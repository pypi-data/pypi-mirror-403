...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/infrastructure/vb365Servers/{vb_365_server_uid}/organizations/jobs/backup/{vb_365_backup_job_uid}/availableBackupRepositories",
        "params": params,
    }
...
) -> Union[Any, ErrorResponse, GetVb365BackupJobAvailableBackupRepositoriesResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetVb365BackupJobAvailableBackupRepositoriesResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetVb365BackupJobAvailableBackupRepositoriesResponse200]]:
    """Get Available Backup Repositories for Veeam Backup for Microsoft 365 Backup Job
