...
def _get_kwargs(
    *,
    ...
    object_name_filter: Union[None, Unset, str] = UNSET,
    object_type_filter: Union[None, Unset, list[Vb365ProtectedObjectType]] = UNSET,
    skip_cache: Union[None, Unset, bool] = UNSET,
    ...
    json_object_name_filter: Union[None, Unset, str]
    ...
    json_object_type_filter: Union[None, Unset, list[str]]
    ...
    json_skip_cache: Union[None, Unset, bool]
    ...
    *,
    ...
    Args:
        ...
        order_direction (Union[Unset, GetVb365ProtectedObjectsOrderDirection]):  Default:
            GetVb365ProtectedObjectsOrderDirection.ASCENDING.
        object_name_filter (Union[None, Unset, str]):
        object_type_filter (Union[None, Unset, list[Vb365ProtectedObjectType]]):
        skip_cache (Union[None, Unset, bool]):
