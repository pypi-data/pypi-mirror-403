...
from ...models.get_reseller_aggregated_usage_response_200 import GetResellerAggregatedUsageResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/organizations/resellers/{reseller_uid}/usage",
        "params": params,
    }
...
) -> Union[Any, ErrorResponse, GetResellerAggregatedUsageResponse200]:
    if response.status_code == 200:
        response_200 = GetResellerAggregatedUsageResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetResellerAggregatedUsageResponse200]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Services Usage by Reseller
     ...
     Returns a collection resource representation of services consumed by a reseller with the specified
    UID.
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetResellerAggregatedUsageResponse200]]:
    """Get Services Usage by Reseller
