...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/organizations/{organization_uid}/identityProviders/saml2/{identity_provider_name}/metadata",
    }
...
) -> Union[Any, ErrorResponse, GetSaml2IdentityProviderClientMetadataResponse200]:
    if response.status_code == 200:
        response_200 = GetSaml2IdentityProviderClientMetadataResponse200.from_dict(response.content)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetSaml2IdentityProviderClientMetadataResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetSaml2IdentityProviderClientMetadataResponse200]]:
    """Get Metadata for Organization Identity Provider.
