...
from ...models.patch_mac_backup_policy_response_200 import PatchMacBackupPolicyResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/configuration/backupPolicies/mac/{policy_uid}",
    }
...
) -> Union[Any, ErrorResponse, PatchMacBackupPolicyResponse200]:
    if response.status_code == 200:
        response_200 = PatchMacBackupPolicyResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchMacBackupPolicyResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchMacBackupPolicyResponse200]]:
    """Modify Backup Policy for Mac Computers
