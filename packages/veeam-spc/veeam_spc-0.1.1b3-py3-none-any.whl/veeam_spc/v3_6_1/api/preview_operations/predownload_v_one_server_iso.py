...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/voneServers/{v_one_server_uid}/upgrade/iso/predownload",
    }
...
) -> Union[Any, ErrorResponse, PredownloadVOneServerIsoResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PredownloadVOneServerIsoResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PredownloadVOneServerIsoResponse200]]:
    """Download Veeam ONE Upgrade Setup File
