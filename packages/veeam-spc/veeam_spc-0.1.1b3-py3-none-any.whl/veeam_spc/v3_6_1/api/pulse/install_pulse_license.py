...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/pulse/licenses/{license_uid}/install",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    >License must be issued to a company on whose server it will be installed. It also must not be
    installed on any other server.
