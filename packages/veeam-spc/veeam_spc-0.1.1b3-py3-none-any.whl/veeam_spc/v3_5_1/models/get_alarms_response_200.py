...
T = TypeVar("T", bound="GetAlarmsResponse200")


@_attrs_define
class GetAlarmsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_alarms_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_alarms_response_200.additional_properties = d
        return get_alarms_response_200
