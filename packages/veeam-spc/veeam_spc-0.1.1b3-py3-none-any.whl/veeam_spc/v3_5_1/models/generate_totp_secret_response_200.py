...
T = TypeVar("T", bound="GenerateTotpSecretResponse200")


@_attrs_define
class GenerateTotpSecretResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, TotpSecret]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, "TotpSecret"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = TotpSecret.from_dict(_data)
        ...
        generate_totp_secret_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        generate_totp_secret_response_200.additional_properties = d
        return generate_totp_secret_response_200
