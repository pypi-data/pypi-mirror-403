...
if TYPE_CHECKING:
    ...
    from ..models.subscription_plan_public_cloud_licenses import SubscriptionPlanPublicCloudLicenses
...
class SubscriptionPlanLicenses:
    ...
    Attributes:
        ...
        public_cloud_licenses (Union[Unset, SubscriptionPlanPublicCloudLicenses]):
    ...
    public_cloud_licenses: Union[Unset, "SubscriptionPlanPublicCloudLicenses"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        public_cloud_licenses: Union[Unset, dict[str, Any]] = UNSET
        if not isinstance(self.public_cloud_licenses, Unset):
            public_cloud_licenses = self.public_cloud_licenses.to_dict()
        ...
        if public_cloud_licenses is not UNSET:
            field_dict["publicCloudLicenses"] = public_cloud_licenses
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        _public_cloud_licenses = d.pop("publicCloudLicenses", UNSET)
        public_cloud_licenses: Union[Unset, SubscriptionPlanPublicCloudLicenses]
        if isinstance(_public_cloud_licenses, Unset):
            public_cloud_licenses = UNSET
        else:
            public_cloud_licenses = SubscriptionPlanPublicCloudLicenses.from_dict(_public_cloud_licenses)
        ...
        subscription_plan_licenses = cls(
            ...
            public_cloud_licenses=public_cloud_licenses,
