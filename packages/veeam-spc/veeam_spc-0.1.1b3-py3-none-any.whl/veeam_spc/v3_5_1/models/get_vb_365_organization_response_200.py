...
T = TypeVar("T", bound="GetVb365OrganizationResponse200")


@_attrs_define
class GetVb365OrganizationResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, Vb365OrganizationBase]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, "Vb365OrganizationBase"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = Vb365OrganizationBase.from_dict(_data)
        ...
        get_vb_365_organization_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_vb_365_organization_response_200.additional_properties = d
        return get_vb_365_organization_response_200
