...
T = TypeVar("T", bound="GetBackupPoliciesResponse200")


@_attrs_define
class GetBackupPoliciesResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, list['BackupPolicy']]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, list["BackupPolicy"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = BackupPolicy.from_dict(data_item_data)
        ...
        get_backup_policies_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_backup_policies_response_200.additional_properties = d
        return get_backup_policies_response_200
