...
T = TypeVar("T", bound="GetResellersResponse200")


@_attrs_define
class GetResellersResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, list['Reseller']]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, list["Reseller"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = Reseller.from_dict(data_item_data)
        ...
        get_resellers_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_resellers_response_200.additional_properties = d
        return get_resellers_response_200
