...
T = TypeVar("T", bound="BackupServerBackupJobActiveFullSettings")


@_attrs_define
class BackupServerBackupJobActiveFullSettings:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_backup_job_active_full_settings = cls(
            is_enabled=is_enabled,
            weekly=weekly,
            monthly=monthly,
        )

        backup_server_backup_job_active_full_settings.additional_properties = d
        return backup_server_backup_job_active_full_settings
