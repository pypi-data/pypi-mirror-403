...
from ..models.linux_gfs_monthly_retention_settings_use_weekly_full_backup_for_the_following_week_of_month import (
    LinuxGfsMonthlyRetentionSettingsUseWeeklyFullBackupForTheFollowingWeekOfMonth,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="LinuxGfsMonthlyRetentionSettings")


@_attrs_define
class LinuxGfsMonthlyRetentionSettings:
    """
    Attributes:
        ...
        use_weekly_full_backup_for_the_following_week_of_month (Union[Unset,
            LinuxGfsMonthlyRetentionSettingsUseWeeklyFullBackupForTheFollowingWeekOfMonth]): Week when Veeam Backup &
            Replication must assign the monthly GFS flag to a full restore point. Default:
            LinuxGfsMonthlyRetentionSettingsUseWeeklyFullBackupForTheFollowingWeekOfMonth.FIRST.
    """

    keep_monthly_backups_for_months: int = 1
    use_weekly_full_backup_for_the_following_week_of_month: Union[
        Unset, LinuxGfsMonthlyRetentionSettingsUseWeeklyFullBackupForTheFollowingWeekOfMonth
    ] = LinuxGfsMonthlyRetentionSettingsUseWeeklyFullBackupForTheFollowingWeekOfMonth.FIRST
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linux_gfs_monthly_retention_settings = cls(
        ...
        linux_gfs_monthly_retention_settings.additional_properties = d
        return linux_gfs_monthly_retention_settings
