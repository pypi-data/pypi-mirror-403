...
T = TypeVar("T", bound="SmtpSettingsServerCertificate")


@_attrs_define
class SmtpSettingsServerCertificate:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        smtp_settings_server_certificate = cls(
        ...
        smtp_settings_server_certificate.additional_properties = d
        return smtp_settings_server_certificate
