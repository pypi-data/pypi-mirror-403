...
T = TypeVar("T", bound="LinuxNetworkBasedDiscoveryRule")


@_attrs_define
class LinuxNetworkBasedDiscoveryRule:
    """
    Attributes:
        ...
        field_embedded (Union[Unset, EmbeddedForLinuxDiscoveryRuleChildren]): Resource representation of the related
            Linux discovery rule entity.
    """

    networks: list["DiscoveryRuleNetwork"]
    instance_uid: Union[Unset, UUID] = UNSET
    field_embedded: Union[Unset, "EmbeddedForLinuxDiscoveryRuleChildren"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        field_embedded: Union[Unset, EmbeddedForLinuxDiscoveryRuleChildren]
        if isinstance(_field_embedded, Unset):
            field_embedded = UNSET
        else:
            field_embedded = EmbeddedForLinuxDiscoveryRuleChildren.from_dict(_field_embedded)

        linux_network_based_discovery_rule = cls(
            networks=networks,
            instance_uid=instance_uid,
            field_embedded=field_embedded,
        )

        linux_network_based_discovery_rule.additional_properties = d
        return linux_network_based_discovery_rule
