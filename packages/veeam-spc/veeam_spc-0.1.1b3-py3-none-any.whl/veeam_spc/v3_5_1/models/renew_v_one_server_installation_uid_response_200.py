...
T = TypeVar("T", bound="RenewVOneServerInstallationUidResponse200")


@_attrs_define
class RenewVOneServerInstallationUidResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, UUID]): Veeam ONE installation UID.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        renew_v_one_server_installation_uid_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        renew_v_one_server_installation_uid_response_200.additional_properties = d
        return renew_v_one_server_installation_uid_response_200
