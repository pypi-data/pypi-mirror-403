...
class CloudGateway:
    ...
    Attributes:
        ...
        gateway_pool_uid (Union[Unset, UUID]): UID assigned to a cloud gateway pool that includes the cloud gateway.
        ...
        external_ip_list (Union[Unset, list[str]]): List of available network interface cards.
    ...
    external_ip_list: Union[Unset, list[str]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        gateway_pool_uid: Union[Unset, str] = UNSET
