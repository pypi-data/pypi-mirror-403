...
if TYPE_CHECKING:
    from ..models.backup_server_file_tape_job_object_source import BackupServerFileTapeJobObjectSource
    from ..models.backup_server_job_object_last_session import BackupServerJobObjectLastSession


T = TypeVar("T", bound="BackupServerFileTapeJobObject")


@_attrs_define
class BackupServerFileTapeJobObject:
    """
    Attributes:
        ...
        host_name (Union[Unset, str]): Host name of a server, on which protected files and folders reside.
        sources (Union[Unset, list['BackupServerFileTapeJobObjectSource']]): Array of protected files and folders.
    ...
    sources: Union[Unset, list["BackupServerFileTapeJobObjectSource"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for sources_item_data in _sources or []:
            sources_item = BackupServerFileTapeJobObjectSource.from_dict(sources_item_data)
        ...
        backup_server_file_tape_job_object = cls(
            job_uid=job_uid,
        ...
        backup_server_file_tape_job_object.additional_properties = d
        return backup_server_file_tape_job_object
