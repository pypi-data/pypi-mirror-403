...
T = TypeVar("T", bound="GetVb365CopyJobsResponse200")


@_attrs_define
class GetVb365CopyJobsResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, list['Vb365CopyJob']]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, list["Vb365CopyJob"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = Vb365CopyJob.from_dict(data_item_data)
        ...
        get_vb_365_copy_jobs_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_vb_365_copy_jobs_response_200.additional_properties = d
        return get_vb_365_copy_jobs_response_200
