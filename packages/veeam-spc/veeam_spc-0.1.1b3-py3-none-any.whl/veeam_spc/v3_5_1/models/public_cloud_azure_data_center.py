...
T = TypeVar("T", bound="PublicCloudAzureDataCenter")


@_attrs_define
class PublicCloudAzureDataCenter:
    """
    Attributes:
        data_center_id (Union[Unset, str]): ID assigned to a Microsoft Azure datacenter.
        data_center_name (Union[Unset, str]): Name of a Microsoft Azure datacenter.
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        public_cloud_azure_data_center = cls(
            data_center_id=data_center_id,
            data_center_name=data_center_name,
        )

        public_cloud_azure_data_center.additional_properties = d
        return public_cloud_azure_data_center
