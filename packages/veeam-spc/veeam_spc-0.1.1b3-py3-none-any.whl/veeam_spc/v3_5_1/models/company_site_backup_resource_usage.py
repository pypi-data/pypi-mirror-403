...
T = TypeVar("T", bound="CompanySiteBackupResourceUsage")


@_attrs_define
class CompanySiteBackupResourceUsage:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_site_backup_resource_usage = cls(
        ...
        company_site_backup_resource_usage.additional_properties = d
        return company_site_backup_resource_usage
