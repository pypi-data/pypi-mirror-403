...
T = TypeVar("T", bound="GetProviderResponse200")


@_attrs_define
class GetProviderResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, Provider]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, "Provider"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_provider_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_provider_response_200.additional_properties = d
        return get_provider_response_200
