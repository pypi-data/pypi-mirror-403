...
T = TypeVar("T", bound="GetActiveAlarmsResponse200")


@_attrs_define
class GetActiveAlarmsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_active_alarms_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_active_alarms_response_200.additional_properties = d
        return get_active_alarms_response_200
