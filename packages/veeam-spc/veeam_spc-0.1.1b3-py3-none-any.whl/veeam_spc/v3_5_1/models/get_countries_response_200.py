...
T = TypeVar("T", bound="GetCountriesResponse200")


@_attrs_define
class GetCountriesResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, list['Country']]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, list["Country"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_countries_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_countries_response_200.additional_properties = d
        return get_countries_response_200
