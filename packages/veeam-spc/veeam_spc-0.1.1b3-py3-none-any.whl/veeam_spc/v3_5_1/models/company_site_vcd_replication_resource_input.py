...
T = TypeVar("T", bound="CompanySiteVcdReplicationResourceInput")


@_attrs_define
class CompanySiteVcdReplicationResourceInput:
    """
    Attributes:
        data_centers (Union[Unset, list['CompanySiteVcdReplicationResourceDataCenter']]): Array of organization VDCs.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        company_site_vcd_replication_resource_input = cls(
            data_centers=data_centers,
            is_failover_capabilities_enabled=is_failover_capabilities_enabled,
        )

        company_site_vcd_replication_resource_input.additional_properties = d
        return company_site_vcd_replication_resource_input
