...
T = TypeVar("T", bound="RevokeAuthenticationTokenResponse200")


@_attrs_define
class RevokeAuthenticationTokenResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        revoke_authentication_token_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        revoke_authentication_token_response_200.additional_properties = d
        return revoke_authentication_token_response_200
