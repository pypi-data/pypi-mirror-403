...
T = TypeVar("T", bound="GetCompanyResponse200")


@_attrs_define
class GetCompanyResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_company_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_company_response_200.additional_properties = d
        return get_company_response_200
