...
T = TypeVar("T", bound="UpdateUserLoginResponse200")


@_attrs_define
class UpdateUserLoginResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_user_login_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        update_user_login_response_200.additional_properties = d
        return update_user_login_response_200
