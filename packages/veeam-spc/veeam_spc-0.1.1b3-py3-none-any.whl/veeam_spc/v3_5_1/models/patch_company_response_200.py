...
T = TypeVar("T", bound="PatchCompanyResponse200")


@_attrs_define
class PatchCompanyResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_company_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        patch_company_response_200.additional_properties = d
        return patch_company_response_200
