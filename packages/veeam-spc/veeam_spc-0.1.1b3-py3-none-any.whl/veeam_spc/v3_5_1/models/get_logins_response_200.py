...
T = TypeVar("T", bound="GetLoginsResponse200")


@_attrs_define
class GetLoginsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_logins_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_logins_response_200.additional_properties = d
        return get_logins_response_200
