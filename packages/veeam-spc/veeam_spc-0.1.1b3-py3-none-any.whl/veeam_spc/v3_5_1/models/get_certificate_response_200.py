...
T = TypeVar("T", bound="GetCertificateResponse200")


@_attrs_define
class GetCertificateResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_certificate_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_certificate_response_200.additional_properties = d
        return get_certificate_response_200
