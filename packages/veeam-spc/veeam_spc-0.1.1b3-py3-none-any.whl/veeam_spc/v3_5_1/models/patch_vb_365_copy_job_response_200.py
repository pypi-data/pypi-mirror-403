...
T = TypeVar("T", bound="PatchVb365CopyJobResponse200")


@_attrs_define
class PatchVb365CopyJobResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_vb_365_copy_job_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        patch_vb_365_copy_job_response_200.additional_properties = d
        return patch_vb_365_copy_job_response_200
