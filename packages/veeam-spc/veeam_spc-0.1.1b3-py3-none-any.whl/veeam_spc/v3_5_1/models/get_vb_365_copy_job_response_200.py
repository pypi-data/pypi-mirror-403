...
T = TypeVar("T", bound="GetVb365CopyJobResponse200")


@_attrs_define
class GetVb365CopyJobResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_vb_365_copy_job_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_vb_365_copy_job_response_200.additional_properties = d
        return get_vb_365_copy_job_response_200
