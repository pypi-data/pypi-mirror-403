...
class PublicCloudDatabasePolicy:
    """
    Attributes:
        instance_uid (Union[Unset, UUID]): UID assigned to a cloud database policy.
        name (Union[Unset, str]): Name of cloud database policy.
        ...
        location_uid (Union[Unset, UUID]): UID assigned to a cloud database policy location.
        instances_count (Union[Unset, int]): Number of cloud databases included in a policy.
