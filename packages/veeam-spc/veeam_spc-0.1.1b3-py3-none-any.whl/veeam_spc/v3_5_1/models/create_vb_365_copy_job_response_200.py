...
T = TypeVar("T", bound="CreateVb365CopyJobResponse200")


@_attrs_define
class CreateVb365CopyJobResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, Vb365CopyJob]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, "Vb365CopyJob"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = Vb365CopyJob.from_dict(_data)
        ...
        create_vb_365_copy_job_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        create_vb_365_copy_job_response_200.additional_properties = d
        return create_vb_365_copy_job_response_200
