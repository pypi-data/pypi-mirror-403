...
T = TypeVar("T", bound="CompleteResetPasswordRequestResponse200")


@_attrs_define
class CompleteResetPasswordRequestResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        complete_reset_password_request_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        complete_reset_password_request_response_200.additional_properties = d
        return complete_reset_password_request_response_200
