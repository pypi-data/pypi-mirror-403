...
T = TypeVar("T", bound="GetResellerResponse200")


@_attrs_define
class GetResellerResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_reseller_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_reseller_response_200.additional_properties = d
        return get_reseller_response_200
