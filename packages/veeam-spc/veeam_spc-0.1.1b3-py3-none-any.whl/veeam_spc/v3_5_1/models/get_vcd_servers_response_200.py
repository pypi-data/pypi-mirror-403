...
T = TypeVar("T", bound="GetVcdServersResponse200")


@_attrs_define
class GetVcdServersResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_vcd_servers_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_vcd_servers_response_200.additional_properties = d
        return get_vcd_servers_response_200
