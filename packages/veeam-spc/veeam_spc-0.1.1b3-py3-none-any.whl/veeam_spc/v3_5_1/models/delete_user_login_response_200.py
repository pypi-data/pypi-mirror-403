...
T = TypeVar("T", bound="DeleteUserLoginResponse200")


@_attrs_define
class DeleteUserLoginResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        delete_user_login_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        delete_user_login_response_200.additional_properties = d
        return delete_user_login_response_200
