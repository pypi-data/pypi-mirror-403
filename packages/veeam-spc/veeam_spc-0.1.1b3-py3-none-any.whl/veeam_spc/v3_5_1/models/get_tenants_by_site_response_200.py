...
T = TypeVar("T", bound="GetTenantsBySiteResponse200")


@_attrs_define
class GetTenantsBySiteResponse200:
    """
    Attributes:
        meta (Union[Unset, ResponseMetadata]):
        data (Union[Unset, list['CloudTenant']]):
        errors (Union[Unset, list['ResponseError']]):
    """

    meta: Union[Unset, "ResponseMetadata"] = UNSET
    data: Union[Unset, list["CloudTenant"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = CloudTenant.from_dict(data_item_data)
        ...
        get_tenants_by_site_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_tenants_by_site_response_200.additional_properties = d
        return get_tenants_by_site_response_200
