...
T = TypeVar("T", bound="RefreshTokenAuthenticateResponse200")


@_attrs_define
class RefreshTokenAuthenticateResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        refresh_token_authenticate_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        refresh_token_authenticate_response_200.additional_properties = d
        return refresh_token_authenticate_response_200
