...
T = TypeVar("T", bound="GetUserLoginResponse200")


@_attrs_define
class GetUserLoginResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_user_login_response_200 = cls(
            meta=meta,
            data=data,
            errors=errors,
        )

        get_user_login_response_200.additional_properties = d
        return get_user_login_response_200
