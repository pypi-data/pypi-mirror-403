...
T = TypeVar("T", bound="BackupServerBackupJobFullBackupMaintenanceRemoveData")


@_attrs_define
class BackupServerBackupJobFullBackupMaintenanceRemoveData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        backup_server_backup_job_full_backup_maintenance_remove_data = cls(
            is_enabled=is_enabled,
            after_days=after_days,
        )

        backup_server_backup_job_full_backup_maintenance_remove_data.additional_properties = d
        return backup_server_backup_job_full_backup_maintenance_remove_data
