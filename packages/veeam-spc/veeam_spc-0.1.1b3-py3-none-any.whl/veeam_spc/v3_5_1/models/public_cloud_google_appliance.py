...
class PublicCloudGoogleAppliance:
    ...
    Attributes:
        ...
        description (Union[Unset, str]): Description of a Veeam Backup for Google Cloud appliance.
        ...
        private_network_address (Union[Unset, str]): Private IP address or DNS name of a Google Cloud network.
