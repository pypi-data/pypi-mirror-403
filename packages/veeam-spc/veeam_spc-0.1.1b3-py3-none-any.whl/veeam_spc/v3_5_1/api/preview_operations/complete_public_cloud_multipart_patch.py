...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/sites/{site_uid}/publicCloud/appliances/patches/upload/multipart/complete",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Complete Patch Upload to Veeam Backup for Public Clouds Appliances registered on Veeam Cloud Connect
    Site

     Finalizes an upload of a patch to Veeam Backup for Public Clouds appliances registered on a Veeam
