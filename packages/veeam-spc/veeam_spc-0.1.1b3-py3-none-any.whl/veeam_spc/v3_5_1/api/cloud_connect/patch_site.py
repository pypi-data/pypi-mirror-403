...
from ...models.patch_site_response_200 import PatchSiteResponse200
...
) -> Union[Any, ErrorResponse, PatchSiteResponse200]:
    if response.status_code == 200:
        response_200 = PatchSiteResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchSiteResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchSiteResponse200]]:
    """Modify Site
