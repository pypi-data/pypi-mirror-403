...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/infrastructure/sites/{site_uid}/tenants/subtenants",
        "params": params,
    }
...
) -> Union[Any, ErrorResponse, GetSubTenantsBySiteResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetSubTenantsBySiteResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetSubTenantsBySiteResponse200]]:
    """Get All Subtenants Registered on Site
