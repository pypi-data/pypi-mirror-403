...
def _get_kwargs(
    ...
    *,
    ...
    vb_365_backup_repository_uid: Union[Unset, UUID] = UNSET,
    ...
    json_vb_365_backup_repository_uid: Union[Unset, str] = UNSET
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        vb_365_protected_object_id (str):
        vb_365_server_uid (UUID):
        vb_365_backup_repository_uid (Union[Unset, UUID]):
