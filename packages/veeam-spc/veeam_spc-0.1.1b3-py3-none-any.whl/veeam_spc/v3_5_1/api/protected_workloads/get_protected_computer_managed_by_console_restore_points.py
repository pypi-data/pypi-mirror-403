...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/protectedWorkloads/computersManagedByConsole/{backup_agent_uid}/restorePoints",
        "params": params,
    }
...
) -> Union[Any, ErrorResponse, GetProtectedComputerManagedByConsoleRestorePointsResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetProtectedComputerManagedByConsoleRestorePointsResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetProtectedComputerManagedByConsoleRestorePointsResponse200]]:
    """Get All Restore Points of Protected Computer Managed by Veeam Service Provider Console
