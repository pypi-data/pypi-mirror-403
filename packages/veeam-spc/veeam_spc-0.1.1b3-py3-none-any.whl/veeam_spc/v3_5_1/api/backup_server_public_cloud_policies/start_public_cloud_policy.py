...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/backupServers/publicCloud/policies/{policy_uid}/start",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Start Veeam Backup for Public Clouds Policy

     Starts a Veeam Backup for Public Clouds policy with the specified UID.
