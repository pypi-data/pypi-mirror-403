...
def _get_kwargs(
    ...
    *,
    region: Union[Unset, CreateAzureDeviceCodeRegion] = CreateAzureDeviceCodeRegion.DEFAULT,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/vb365Servers/{vb_365_server_uid}/organizations/deviceCode",
        "params": params,
    }
...
) -> Union[Any, CreateAzureDeviceCodeResponse200, ErrorResponse]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CreateAzureDeviceCodeResponse200, ErrorResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        vb_365_server_uid (UUID):
        region (Union[Unset, CreateAzureDeviceCodeRegion]):  Default:
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, CreateAzureDeviceCodeResponse200, ErrorResponse]]:
    """Create Device Code
