...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/sites/{site_uid}/publicCloud/azure/appliances/connect",
    }
...
) -> Union[AddExistingPublicCloudAzureApplianceResponse200, Any, ErrorResponse]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AddExistingPublicCloudAzureApplianceResponse200, Any, ErrorResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[AddExistingPublicCloudAzureApplianceResponse200, Any, ErrorResponse]]:
    """Connect Veeam Backup for Microsoft Azure Appliance
