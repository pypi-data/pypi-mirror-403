...
def _get_kwargs(
    plan_uid: UUID,
    *,
    date_time: Union[Unset, datetime.date] = UNSET,
    ...
    params["date-time"] = json_date_time
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/backupServers/failoverplans/{plan_uid}/start",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Start Failover Plan
     ...
     Starts a failover plan with the specified UID. Returns a positive response when the task is added to
    the internal queue and not when the task is executed.

    Args:
        plan_uid (UUID):
        date_time (Union[Unset, datetime.date]):
