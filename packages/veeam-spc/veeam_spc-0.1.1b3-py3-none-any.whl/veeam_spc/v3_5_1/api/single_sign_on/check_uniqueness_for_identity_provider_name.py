...
) -> Union[Any, CheckUniquenessForIdentityProviderNameResponse200, ErrorResponse]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, CheckUniquenessForIdentityProviderNameResponse200, ErrorResponse]]:
    return Response(
...
def sync(
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, CheckUniquenessForIdentityProviderNameResponse200, ErrorResponse]]:
    """Check Uniqueness of Identity Provider Name.
