...
from ...models.download_windows_management_package_os_type import DownloadWindowsManagementPackageOsType
from ...models.download_windows_management_package_package_type import DownloadWindowsManagementPackagePackageType
...
def _get_kwargs(
    *,
    ...
    package_type: Union[
        Unset, DownloadWindowsManagementPackagePackageType
    ] = DownloadWindowsManagementPackagePackageType.EXE,
    os_type: Union[Unset, DownloadWindowsManagementPackageOsType] = DownloadWindowsManagementPackageOsType.X64,
    ...
    json_os_type: Union[Unset, str] = UNSET
    if not isinstance(os_type, Unset):
        json_os_type = os_type.value

    params["osType"] = json_os_type

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/infrastructure/managementAgents/packages/windows",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    """Download Management Agent Setup File for Windows
     ...
     Returns a download link to a management agent setup file in the `EXE` or `MSI` format for Microsoft
    Windows computers.
    ...
    Args:
        ...
        package_type (Union[Unset, DownloadWindowsManagementPackagePackageType]):  Default:
            DownloadWindowsManagementPackagePackageType.EXE.
        os_type (Union[Unset, DownloadWindowsManagementPackageOsType]):  Default:
            DownloadWindowsManagementPackageOsType.X64.
