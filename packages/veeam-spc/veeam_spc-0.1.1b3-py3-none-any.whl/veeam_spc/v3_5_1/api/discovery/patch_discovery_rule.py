...
from ...models.patch_discovery_rule_response_200 import PatchDiscoveryRuleResponse200
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": f"/discovery/rules/{rule_uid}",
    }
...
) -> Union[Any, ErrorResponse, PatchDiscoveryRuleResponse200]:
    if response.status_code == 200:
        response_200 = PatchDiscoveryRuleResponse200.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, PatchDiscoveryRuleResponse200]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, PatchDiscoveryRuleResponse200]]:
    """Modify Discovery Rule
