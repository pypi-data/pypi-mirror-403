...
from ...models.change_invoice_paid_state_status import ChangeInvoicePaidStateStatus
...
def _get_kwargs(
    invoice_uid: UUID,
    *,
    status: ChangeInvoicePaidStateStatus,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/organizations/companies/billing/invoices/{invoice_uid}/changePaidState",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Change Invoice Payment Status
     ...
     Changes payment status of an invoice with the specified UID.
