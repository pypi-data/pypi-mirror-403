...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/infrastructure/backupAgents/{backup_agent_uid}/jobs/{backup_agent_job_uid}/stop",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Stop Veeam Backup Agent Job
     ...
     Stops a Veeam backup agent job with the specified UID. Returns a positive response when the
