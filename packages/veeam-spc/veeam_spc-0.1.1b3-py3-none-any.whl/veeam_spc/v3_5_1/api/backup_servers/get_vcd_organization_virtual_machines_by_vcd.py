...
def _get_kwargs(
    ...
    *,
    ...
    vcd_organization_uid_filter: Union[Unset, UUID] = UNSET,
    name_sorting_direction: Union[
        Unset, GetVcdOrganizationVirtualMachinesByVcdNameSortingDirection
    ] = GetVcdOrganizationVirtualMachinesByVcdNameSortingDirection.ASCENDING,
    ...
    json_vcd_organization_uid_filter: Union[Unset, str] = UNSET
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/infrastructure/backupServers/{backup_server_uid}/vcdServers/{vcd_server_uid}/vcdOrganizations/vDCs/virtualMachines",
        "params": params,
    }
...
) -> Union[Any, ErrorResponse, GetVcdOrganizationVirtualMachinesByVcdResponse200]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, ErrorResponse, GetVcdOrganizationVirtualMachinesByVcdResponse200]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        vcd_organization_uid_filter (Union[Unset, UUID]):
        name_sorting_direction (Union[Unset,
            GetVcdOrganizationVirtualMachinesByVcdNameSortingDirection]):  Default:
            GetVcdOrganizationVirtualMachinesByVcdNameSortingDirection.ASCENDING.
...
def sync(
    ...
    *,
    ...
    x_request_id: Union[Unset, UUID] = UNSET,
    x_client_version: Union[Unset, str] = UNSET,
) -> Optional[Union[Any, ErrorResponse, GetVcdOrganizationVirtualMachinesByVcdResponse200]]:
    """Get VMs Configured on VMware Cloud Director Server
