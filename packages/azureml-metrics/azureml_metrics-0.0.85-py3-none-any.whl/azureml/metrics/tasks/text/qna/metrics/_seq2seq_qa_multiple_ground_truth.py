...
class MacroAveragedExactMatch(Seq2SeqQAMetric, ScalarMetric):
    ...
    def compute(self) -> Any:
        ...
        return AzureMLOutput(
            {'metrics': {constants.Metric.QAMacroAveragedExactMatch: exact_match_score}, 'artifacts': {}})
...
class MacroAveragedF1(Seq2SeqQAMetric, ScalarMetric):
    ...
    def compute(self) -> Any:
        ...
        return AzureMLOutput({'metrics': {constants.Metric.QAMacroAveragedF1: f1_score}, 'artifacts': {}})
