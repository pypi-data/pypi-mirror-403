...
"""Command-line interface for schwi."""
...
import schwi.commands  # noqa: F401
from schwi.app import app
from schwi.runtime import get_app_version, load_settings
from schwi.runtime.project import get_project_info
