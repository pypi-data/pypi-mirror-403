...
class SearchRequestTokenBased(BaseModel):
    """
    ...
    next_token: Optional[StrictStr] = Field(default=None, description="Token for the next page", alias="nextToken")
    limit_per_page: Optional[StrictInt] = Field(default=None, description="Maximum results per page", alias="limitPerPage")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["filter", "sort", "nextToken", "limitPerPage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchRequestTokenBased from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchRequestTokenBased from a dict"""
        if obj is None:
            return None
