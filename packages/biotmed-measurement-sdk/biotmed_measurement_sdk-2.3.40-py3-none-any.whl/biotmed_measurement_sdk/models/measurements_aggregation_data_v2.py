...
class MeasurementsAggregationDataV2(BaseModel):
    """
    ...
    data: Optional[Dict[str, MeasurementAggregationData]] = None
    example_measure1: Optional[MeasurementAggregationData] = Field(default=None, alias="exampleMeasure1")
    example_measure2: Optional[MeasurementAggregationData] = Field(default=None, alias="exampleMeasure2")
    example_measure3: Optional[MeasurementAggregationData] = Field(default=None, alias="exampleMeasure3")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["timestamp", "data", "exampleMeasure1", "exampleMeasure2", "exampleMeasure3"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MeasurementsAggregationDataV2 from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of example_measure1
        if self.example_measure1:
            _dict['exampleMeasure1'] = self.example_measure1.to_dict()
        # override the default output from pydantic by calling `to_dict()` of example_measure2
        if self.example_measure2:
            _dict['exampleMeasure2'] = self.example_measure2.to_dict()
        # override the default output from pydantic by calling `to_dict()` of example_measure3
        if self.example_measure3:
            _dict['exampleMeasure3'] = self.example_measure3.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MeasurementsAggregationDataV2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "timestamp": TimestampRange.from_dict(obj["timestamp"]) if obj.get("timestamp") is not None else None,
            "data": dict(
                (_k, MeasurementAggregationData.from_dict(_v))
                for _k, _v in obj["data"].items()
            )
            if obj.get("data") is not None
            else None,
            "exampleMeasure1": MeasurementAggregationData.from_dict(obj["exampleMeasure1"]) if obj.get("exampleMeasure1") is not None else None,
            "exampleMeasure2": MeasurementAggregationData.from_dict(obj["exampleMeasure2"]) if obj.get("exampleMeasure2") is not None else None,
            "exampleMeasure3": MeasurementAggregationData.from_dict(obj["exampleMeasure3"]) if obj.get("exampleMeasure3") is not None else None
        })
