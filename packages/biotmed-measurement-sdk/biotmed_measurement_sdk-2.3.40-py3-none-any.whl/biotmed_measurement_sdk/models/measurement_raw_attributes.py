...
class MeasurementRawAttributes(BaseModel):
    """
    ...
    sources: List[MeasurementRawSource]
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["attributeName", "sources"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MeasurementRawAttributes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MeasurementRawAttributes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "sources": [MeasurementRawSource.from_dict(_item) for _item in obj["sources"]] if obj.get("sources") is not None else None
        })
