...
class MeasurementBulkResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    metadata: Optional[MeasurementBulkMetadata] = None
    failed_measures: Optional[List[FailedMeasurementMessageFromDevice]] = Field(default=None, description="List of measurement sent by the user and failed to be written to the DB", alias="failedMeasures")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["metadata", "failedMeasures"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MeasurementBulkResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in failed_measures (list)
        _items = []
        if self.failed_measures:
            for _item_failed_measures in self.failed_measures:
                if _item_failed_measures:
                    _items.append(_item_failed_measures.to_dict())
            _dict['failedMeasures'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MeasurementBulkResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "metadata": MeasurementBulkMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "failedMeasures": [FailedMeasurementMessageFromDevice.from_dict(_item) for _item in obj["failedMeasures"]] if obj.get("failedMeasures") is not None else None
        })
