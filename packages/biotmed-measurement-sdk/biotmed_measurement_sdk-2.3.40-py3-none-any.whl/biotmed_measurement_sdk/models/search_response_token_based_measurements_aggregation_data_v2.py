...
class SearchResponseTokenBasedMeasurementsAggregationDataV2(BaseModel):
    """
    ...
    """ # noqa: E501
    data: List[MeasurementsAggregationDataV2] = Field(description="List of items that match the search request")
    metadata: Optional[MetadataTokenBased] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchResponseTokenBasedMeasurementsAggregationDataV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchResponseTokenBasedMeasurementsAggregationDataV2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [MeasurementsAggregationDataV2.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "metadata": MetadataTokenBased.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
