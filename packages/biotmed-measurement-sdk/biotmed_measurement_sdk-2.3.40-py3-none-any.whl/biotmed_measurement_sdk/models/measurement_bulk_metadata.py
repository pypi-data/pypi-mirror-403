...
class MeasurementBulkMetadata(BaseModel):
    """
    ...
    """ # noqa: E501
    number_of_measures_saved: Optional[StrictInt] = Field(default=None, description="The number of measurement successfully written to the DB", alias="numberOfMeasuresSaved")
    number_of_measures_failed: Optional[StrictInt] = Field(default=None, description="The number of measurement failed to be written to the DB", alias="numberOfMeasuresFailed")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["numberOfMeasuresSaved", "numberOfMeasuresFailed"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MeasurementBulkMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MeasurementBulkMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "numberOfMeasuresSaved": obj.get("numberOfMeasuresSaved"),
            "numberOfMeasuresFailed": obj.get("numberOfMeasuresFailed")
        })
