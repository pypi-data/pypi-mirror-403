...
class RawMeasurementV2(BaseModel):
    """
    RawMeasurementV2
    ...
    source_entity_id: Optional[StrictStr] = Field(default=None, alias="sourceEntityId")
    timestamp: Optional[datetime] = None
    data: Optional[Dict[str, Any]] = None
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["patientId", "sessionId", "sourceEntityId", "timestamp", "data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RawMeasurementV2 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RawMeasurementV2 from a dict"""
        if obj is None:
            return None
