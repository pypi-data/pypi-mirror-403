...
class MeasurementSource(BaseModel):
    ...
    measurement_sessions: List[MeasurementSession] = Field(alias="measurementSessions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MeasurementSource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "measurementSessions": [MeasurementSession.from_dict(_item) for _item in obj["measurementSessions"]] if obj.get("measurementSessions") is not None else None
        })
