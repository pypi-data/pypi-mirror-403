...
class RawMeasurementSessions(BaseModel):
    """
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["sessionId", "measurements"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RawMeasurementSessions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RawMeasurementSessions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "measurements": [RawMeasurement.from_dict(_item) for _item in obj["measurements"]] if obj.get("measurements") is not None else None
        })
