...
class RawMeasurement(BaseModel):
    ...
    timestamp: datetime
    frequency: StrictInt
    number_of_sample: StrictInt = Field(alias="numberOfSample")
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["timestamp", "frequency", "numberOfSample", "data"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RawMeasurement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RawMeasurement from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "numberOfSample": obj.get("numberOfSample"),
            "data": obj.get("data")
        })
