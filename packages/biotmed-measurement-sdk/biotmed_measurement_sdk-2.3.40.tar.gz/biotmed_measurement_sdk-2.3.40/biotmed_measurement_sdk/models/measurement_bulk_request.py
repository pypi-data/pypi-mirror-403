...
class MeasurementBulkRequest(BaseModel):
    ...
    """ # noqa: E501
    measures: Optional[List[MeasurementMessageFromDevice]] = Field(default=None, description="List of measurement to be written to  the DB")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["measures"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MeasurementBulkRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MeasurementBulkRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "measures": [MeasurementMessageFromDevice.from_dict(_item) for _item in obj["measures"]] if obj.get("measures") is not None else None
        })
