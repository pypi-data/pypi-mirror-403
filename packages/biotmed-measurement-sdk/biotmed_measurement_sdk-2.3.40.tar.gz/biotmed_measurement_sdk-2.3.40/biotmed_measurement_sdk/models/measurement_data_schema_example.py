...
class MeasurementDataSchemaExample(BaseModel):
    """
    Json that contains the Observations (key - measurement name, Value - measurement value) that should be saved to DB.
    ...
    """ # noqa: E501
    measurement1: Optional[Any] = None
    measurement2: Optional[Any] = None
    measurement3: Optional[Any] = None
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["measurement1", "measurement2", "measurement3"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MeasurementDataSchemaExample from a JSON string"""
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.additional_properties is not None:
            for _key, _value in self.additional_properties.items():
                _dict[_key] = _value
        # BioT Code End
        # set to None if measurement1 (nullable) is None
        # and model_fields_set contains the field
        if self.measurement1 is None and "measurement1" in self.model_fields_set:
            _dict['measurement1'] = None

        # set to None if measurement2 (nullable) is None
        # and model_fields_set contains the field
        if self.measurement2 is None and "measurement2" in self.model_fields_set:
            _dict['measurement2'] = None

        # set to None if measurement3 (nullable) is None
        # and model_fields_set contains the field
        if self.measurement3 is None and "measurement3" in self.model_fields_set:
            _dict['measurement3'] = None

        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MeasurementDataSchemaExample from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "measurement1": obj.get("measurement1"),
            "measurement2": obj.get("measurement2"),
            "measurement3": obj.get("measurement3")
        })
