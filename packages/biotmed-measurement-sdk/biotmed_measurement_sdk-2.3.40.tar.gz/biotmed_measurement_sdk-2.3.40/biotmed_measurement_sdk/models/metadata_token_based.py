...
class MetadataTokenBased(BaseModel):
    """
    MetadataTokenBased
    ...
    next_token: Optional[StrictStr] = Field(default=None, description="Next token that should be supplied when requesting a new page, empty of there are no next page", alias="nextToken")
    limit_per_page: Optional[StrictInt] = Field(default=None, description="Limit of items", alias="limitPerPage")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["sort", "filter", "nextToken", "limitPerPage"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MetadataTokenBased from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MetadataTokenBased from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "limitPerPage": obj.get("limitPerPage")
        })
