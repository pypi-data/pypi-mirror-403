...
class MeasurementRawSource(BaseModel):
    """
    ...
    measurement_sessions: List[RawMeasurementSessions] = Field(alias="measurementSessions")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["sourceEntityId", "measurementSessions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MeasurementRawSource from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in measurement_sessions (list)
        _items = []
        if self.measurement_sessions:
            for _item_measurement_sessions in self.measurement_sessions:
                if _item_measurement_sessions:
                    _items.append(_item_measurement_sessions.to_dict())
            _dict['measurementSessions'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MeasurementRawSource from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "measurementSessions": [RawMeasurementSessions.from_dict(_item) for _item in obj["measurementSessions"]] if obj.get("measurementSessions") is not None else None
        })
