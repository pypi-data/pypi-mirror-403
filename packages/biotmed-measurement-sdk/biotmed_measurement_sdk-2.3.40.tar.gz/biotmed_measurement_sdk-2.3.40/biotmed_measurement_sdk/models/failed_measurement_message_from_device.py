...
class FailedMeasurementMessageFromDevice(BaseModel):
    """
    ...
    """ # noqa: E501
    metadata: Optional[MeasurementFromDeviceMetadata] = None
    data: Optional[Dict[str, Any]] = None
    failure_data: Optional[List[FailureData]] = Field(default=None, alias="failureData")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["metadata", "data", "failureData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FailedMeasurementMessageFromDevice from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in failure_data (list)
        _items = []
        if self.failure_data:
            for _item_failure_data in self.failure_data:
                if _item_failure_data:
                    _items.append(_item_failure_data.to_dict())
            _dict['failureData'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FailedMeasurementMessageFromDevice from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "metadata": MeasurementFromDeviceMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "data": obj.get("data"),
            "failureData": [FailureData.from_dict(_item) for _item in obj["failureData"]] if obj.get("failureData") is not None else None
        })
