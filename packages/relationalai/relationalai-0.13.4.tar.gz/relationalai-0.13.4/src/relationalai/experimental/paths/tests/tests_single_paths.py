...
path_1 = single_shortest_path(grid, Source_1, Target_1)
...
path_2 = single_shortest_path(grid, Source_1, Target_2)
...
path_3 = single_shortest_path(grid, Source_3, Target_3)
...
path_4 = single_shortest_path(grid, Source_4, Target_4)
...
path_5 = single_shortest_path(grid, Source_1, Target_5)
