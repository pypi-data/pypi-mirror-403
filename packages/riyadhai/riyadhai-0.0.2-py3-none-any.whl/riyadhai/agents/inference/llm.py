...
class LLM(llm.LLM):
    def __init__(
        ...
        *,
        ...
        lk_base_url = (
            base_url if base_url else os.environ.get("RIYADHAI_INFERENCE_URL", DEFAULT_BASE_URL)
        )
...
class LLMStream(llm.LLMStream):
    ...
    async def _run(self) -> None:
        ...
        try:
            ...
            if self._provider:
                ...
                headers["X-RiyadhAI-Inference-Provider"] = self._provider
    ...
    def _parse_choice(
        ...
        # https://github.com/riyadhai/agents/issues/688
