...
from riyadhai.agents import APIConnectionError, llm, utils
from riyadhai.agents.metrics import RealtimeModelMetrics
from riyadhai.agents.metrics.base import Metadata
from riyadhai.agents.types import (
    DEFAULT_API_CONNECT_OPTIONS,
    NOT_GIVEN,
    APIConnectOptions,
    NotGivenOr,
)
from riyadhai.agents.utils import audio as audio_utils, images, is_given
from riyadhai.plugins.google.realtime.api_proto import ClientEvents, LiveAPIModels, Voice
...
class RealtimeSession(llm.RealtimeSession):
    def __init__(self, realtime_model: RealtimeModel) -> None:
        ...
        http_options.headers["x-goog-api-client"] = f"riyadhai-agents/{__version__}"
