...
from riyadhai.agents import APIConnectOptions, APIStatusError, APITimeoutError, tokenize, tts, utils
from riyadhai.agents.types import DEFAULT_API_CONNECT_OPTIONS, NOT_GIVEN, NotGivenOr
from riyadhai.agents.utils import is_given
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            tokenizer (tokenize.SentenceTokenizer, optional): Tokenizer for the TTS. Defaults to `riyadhai.agents.tokenize.blingfire.SentenceTokenizer`.
