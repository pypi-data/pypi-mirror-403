...
from riyadhai.protocol.room import RoomConfiguration
...
class AccessToken:
    ...
    def __init__(
        ...
        api_key = api_key or os.getenv("RIYADHAI_API_KEY")
        api_secret = api_secret or os.getenv("RIYADHAI_API_SECRET")
