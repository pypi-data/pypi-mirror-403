...
from riyadhai.protocol.models import Room, ParticipantInfo
...
class RoomService(Service):
    """Client for RiyadhAI RoomService API

    Recommended way to use this service is via `riyadhai.api.RiyadhAIAPI`:

    ```python
    from riyadhai import api
    lkapi = api.RiyadhAIAPI()
    room_service = lkapi.room
    ```

    Also see https://docs.riyadhai.io/home/server/managing-rooms/ and https://docs.riyadhai.io/home/server/managing-participants/
    """
    ...
    async def update_room_metadata(self, update: UpdateRoomMetadataRequest) -> Room:
        """Updates a room's [metadata](https://docs.riyadhai.io/home/client/data/room-metadata/).
    ...
    async def forward_participant(self, forward: ForwardParticipantRequest) -> None:
        ...
        This feature is only available for RiyadhAI Cloud/Private Cloud.
