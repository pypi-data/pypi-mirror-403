...
from riyadhai.protocol import agent_pb, metrics as proto_metrics
...
tracer: _DynamicTracer = _DynamicTracer("riyadhai-agents")
...
def set_tracer_provider(
    ...
    """Set the tracer provider for the riyadhai-agents.
...
async def _upload_session_report(
    *,
    ...
    logger.debug("uploading session report to RiyadhAI Cloud")
