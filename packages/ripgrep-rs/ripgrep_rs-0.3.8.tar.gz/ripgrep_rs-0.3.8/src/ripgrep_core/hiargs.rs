...
impl HiArgs {
    ...
    pub(crate) fn printer_no_color<W: std::io::Write>(
        &self,
        wtr: W,
    ) -> Printer<termcolor::NoColor<W>> {
        Printer::Standard(self.printer_standard_no_color(wtr))
    }
    ...
    pub fn printer_standard_no_color<W: std::io::Write>(
        &self,
        wtr: W,
    ) -> grep::printer::Standard<termcolor::NoColor<W>> {
