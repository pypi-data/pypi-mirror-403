...
def make_public(
    ctx: typer.Context,
    collection_id: Annotated[str, typer.Argument(help="The ID of the collection to make public.")],
    ...
    try:
        ...
        logger.exception("An unexpected error occurred in 'collection make-public'")
