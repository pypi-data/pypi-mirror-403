...
class Ksu(KaitaiStruct):
    ...
    def _read(self):
        self.ax25_frame = Ksu.Ax25Frame(self._io, self, self._root)
    ...
    class Ax25Frame(KaitaiStruct):
        ...
        def _read(self):
            self.ax25_header = Ksu.Ax25Header(self._io, self, self._root)
            _on = (self.ax25_header.ctl & 19)
            if _on == 0:
                self.payload = Ksu.IFrame(self._io, self, self._root)
            elif _on == 3:
                self.payload = Ksu.UiFrame(self._io, self, self._root)
            elif _on == 19:
                self.payload = Ksu.UiFrame(self._io, self, self._root)
            elif _on == 16:
                self.payload = Ksu.IFrame(self._io, self, self._root)
    ...
    class Ax25Header(KaitaiStruct):
        ...
        def _read(self):
            self.dest_callsign_raw = Ksu.CallsignRaw(self._io, self, self._root)
            self.dest_ssid_raw = Ksu.SsidMask(self._io, self, self._root)
            self.src_callsign_raw = Ksu.CallsignRaw(self._io, self, self._root)
            self.src_ssid_raw = Ksu.SsidMask(self._io, self, self._root)
            if (self.src_ssid_raw.ssid_mask & 1) == 0:
                self.repeater = Ksu.Repeater(self._io, self, self._root)
    ...
    class UiFrame(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.ax25_info = Ksu.Tlm(_io__raw_ax25_info, self, self._root)
    ...
    class Beacon(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.rssirx = self._io.read_u1()
            self.rssiidle = self._io.read_u1()
    ...
    class Repeaters(KaitaiStruct):
        ...
        def _read(self):
            self.rpt_callsign_raw = Ksu.CallsignRaw(self._io, self, self._root)
            self.rpt_ssid_raw = Ksu.SsidMask(self._io, self, self._root)
    ...
    class Repeater(KaitaiStruct):
        ...
        def _read(self):
            ...
            i = 0
            while True:
                _ = Ksu.Repeaters(self._io, self, self._root)
    ...
    class CallsignRaw(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.callsign_ror = Ksu.Callsign(_io__raw_callsign_ror, self, self._root)
    ...
    class Tlm(KaitaiStruct):
        ...
        def _read(self):
            ...
            if _on == 22:
                self.body = Ksu.Beacon(self._io, self, self._root)
            elif _on == 23:
                self.body = Ksu.Extendedbeacon(self._io, self, self._root)
