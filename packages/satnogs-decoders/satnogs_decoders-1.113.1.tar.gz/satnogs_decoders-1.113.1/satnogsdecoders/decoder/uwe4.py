...
class Uwe4(KaitaiStruct):
    ...
    class HskpPayload(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.beacon_payload_timestamp_raw = []
            for i in range(6):
                self.beacon_payload_timestamp_raw.append(self._io.read_u1())
        ...
        def beacon_payload_timestamp(self):
            if hasattr(self, '_m_beacon_payload_timestamp'):
                return self._m_beacon_payload_timestamp
            ...
            return getattr(self, '_m_beacon_payload_timestamp', None)
