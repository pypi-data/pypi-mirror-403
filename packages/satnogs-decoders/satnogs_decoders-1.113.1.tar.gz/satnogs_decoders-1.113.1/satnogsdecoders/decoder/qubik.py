...
class Qubik(KaitaiStruct):
    ...
    :field trx_delay_ms: osdlp_tm_frame.tm_tf_data_field.payload.trx_delay_ms
    """
    ...
    class VcidTmT(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.trx_delay_ms = self._io.read_u2be()
