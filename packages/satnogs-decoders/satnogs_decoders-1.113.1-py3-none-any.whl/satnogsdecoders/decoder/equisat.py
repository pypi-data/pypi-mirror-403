...
class Equisat(KaitaiStruct):
    ...
    class CompressedMagnetometerT(KaitaiStruct):
        ...
        def int16(self):
            if hasattr(self, '_m_int16'):
                return self._m_int16

            self._m_int16 = ((self.cint16 << 8) // 11 - 2800)
            return getattr(self, '_m_int16', None)
    ...
    class AttitudeBatchT(KaitaiStruct):
        ...
        def pd_flash(self):
            if hasattr(self, '_m_pd_flash'):
                return self._m_pd_flash

            self._m_pd_flash = ((self.pd_1 >> 6) & 3)
            return getattr(self, '_m_pd_flash', None)

        @property
        def pd_access(self):
            if hasattr(self, '_m_pd_access'):
                return self._m_pd_access

            self._m_pd_access = ((self.pd_1 >> 0) & 3)
            return getattr(self, '_m_pd_access', None)

        @property
        def pd_top2(self):
            if hasattr(self, '_m_pd_top2'):
                return self._m_pd_top2

            self._m_pd_top2 = ((self.pd_2 >> 4) & 3)
            return getattr(self, '_m_pd_top2', None)

        @property
        def pd_top1(self):
            if hasattr(self, '_m_pd_top1'):
                return self._m_pd_top1

            self._m_pd_top1 = ((self.pd_2 >> 6) & 3)
            return getattr(self, '_m_pd_top1', None)

        @property
        def pd_side2(self):
            if hasattr(self, '_m_pd_side2'):
                return self._m_pd_side2

            self._m_pd_side2 = ((self.pd_1 >> 2) & 3)
            return getattr(self, '_m_pd_side2', None)

        @property
        def pd_side1(self):
            if hasattr(self, '_m_pd_side1'):
                return self._m_pd_side1

            self._m_pd_side1 = ((self.pd_1 >> 4) & 3)
            return getattr(self, '_m_pd_side1', None)
    ...
    class PreambleT(KaitaiStruct):
        ...
        def satellite_state(self):
            ...
            return getattr(self, '_m_satellite_state', None)

        @property
        def flash_killed(self):
            if hasattr(self, '_m_flash_killed'):
                return self._m_flash_killed

            self._m_flash_killed = (self.msg_op_states & (1 << 6)) // (1 << 6)
            return getattr(self, '_m_flash_killed', None)
        ...
        def mram_killed(self):
            if hasattr(self, '_m_mram_killed'):
                return self._m_mram_killed

            self._m_mram_killed = (self.msg_op_states & (1 << 7)) // (1 << 7)
            return getattr(self, '_m_mram_killed', None)
        ...
        def callsign(self):
            ...
            return getattr(self, '_m_callsign', None)
