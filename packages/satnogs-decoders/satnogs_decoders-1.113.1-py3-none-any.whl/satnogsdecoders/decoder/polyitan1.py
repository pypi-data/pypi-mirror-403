...
class Polyitan1(KaitaiStruct):
    ...
    class Beacon2(KaitaiStruct):
        ...
        def temp2(self):
            ...
            if hasattr(self, '_m_temp2'):
                return self._m_temp2

            self._m_temp2 = (self.temp2_raw * 0.1)
            return getattr(self, '_m_temp2', None)

        @property
        def temp1(self):
            """value [В°C]."""
            if hasattr(self, '_m_temp1'):
                return self._m_temp1

            self._m_temp1 = (self.temp1_raw * 0.1)
            return getattr(self, '_m_temp1', None)
    ...
    class Beacon0(KaitaiStruct):
        ...
        def _read(self):
            self.body = (self._io.read_bytes_full()).decode(u"ASCII")
