...
class Minxss(KaitaiStruct):
    ...
    class HskpData(KaitaiStruct):
        ...
        def _read(self):
            self.res_1 = []
            for i in range(10):
                self.res_1.append(self._io.read_u1())
            ...
            self.res_9 = []
            for i in range(12):
                self.res_9.append(self._io.read_u1())
            ...
            self.res_b = []
            for i in range(16):
                self.res_b.append(self._io.read_u1())

            self.xp = self._io.read_u4le()
            self.res_c = []
            for i in range(10):
                self.res_c.append(self._io.read_u1())
