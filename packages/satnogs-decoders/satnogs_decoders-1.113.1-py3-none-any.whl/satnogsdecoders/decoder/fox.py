...
class Fox(KaitaiStruct):
    ...
    class Hdr(KaitaiStruct):
        ...
        def id(self):
            ...
            return getattr(self, '_m_id', None)
        ...
        def frm_type(self):
            if hasattr(self, '_m_frm_type'):
                return self._m_frm_type

            self._m_frm_type = ((self.b[5] >> 4) & 15)
            return getattr(self, '_m_frm_type', None)
