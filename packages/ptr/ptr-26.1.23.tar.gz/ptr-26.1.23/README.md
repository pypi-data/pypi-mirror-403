...
[![Actions Status](https://github.com/cooperlees/ptr/workflows/ptr_ci/badge.svg)](https://github.com/cooperlees/ptr/actions)
...
Please refer to [`ptrconfig.sample`](http://github.com/cooperlees/ptr/blob/master/ptrconfig.sample) for the options available.
...
Please refer to [`pyproject.toml`](http://github.com/cooperlees/ptr/blob/master/pyproject.toml)
...
Please refer to [`setup.cfg.sample`](http://github.com/cooperlees/ptr/blob/master/setup.cfg.sample)
for the options available + format.
...
- An example `setup.cfg` can be seen [here](http://github.com/cooperlees/ptr/blob/master/mypy.ini).
