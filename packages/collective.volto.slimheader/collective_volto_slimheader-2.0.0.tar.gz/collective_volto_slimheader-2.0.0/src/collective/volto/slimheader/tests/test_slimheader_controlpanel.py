...
from collective.volto.slimheader.testing import (
    COLLECTIVE_VOLTO_SLIMHEADER_API_FUNCTIONAL_TESTING,
)


class SlimHeaderServiceTest(unittest.TestCase):

    layer = COLLECTIVE_VOLTO_SLIMHEADER_API_FUNCTIONAL_TESTING
    ...
    def setUp(self):
        ...
        self.controlpanel_url = "/@controlpanels/slimheader-settings"
    ...
    def test_controlpanel_listed(self):
        ...
        self.assertIn("Slim Header Settings", titles)

    def test_route_exists(self):
        response = self.api_session.get("/@controlpanels/slimheader-settings")
...
class SlimHeaderServiceDeserializerTest(BaseTestWithFolders):
    ...
    def test_deserializer_convert_linkUrl_into_uids(self):
        ...
        self.api_session.patch(
            ...
            json={"slimheader_configuration": json.dumps(data)},
        )
        commit()
    ...
    def test_deserializer_convert_linkUrl_into_uids_and_skip_wrong_paths(self):
        ...
        self.assertEqual(record[0]["items"][0]["linkUrl"], [self.folder_a.UID()])
    ...
    def test_deserializer_convert_navigationRoot_into_uids_and_skip_wrong_paths(  # noqa
        ...
        self.assertEqual(record[0]["items"][0]["navigationRoot"], [self.folder_a.UID()])
    ...
    def test_deserializer_convert_showMoreLink_into_uids_and_skip_wrong_paths(  # noqa
        ...
        self.assertEqual(record[0]["items"][0]["showMoreLink"], [self.folder_a.UID()])


class SlimHeaderServiceSerializerTest(BaseTestWithFolders):
    ...
    def test_serializer_convert_linkUrl_from_uid_to_summary(self):
        ...
        result = json.loads(response.json()["data"]["slimheader_configuration"])
