# -*- coding: utf-8 -*-
"""Installer for the collective.volto.slimheader package."""
...
setup(
    ...
    url="https://github.com/collective/collective.volto.slimheader",
    project_urls={
        ...
        # 'Documentation': 'https://collective.volto.slimheader.readthedocs.io/en/latest/',
    },
    ...
    target = plone
    [console_scripts]
    update_locale = collective.volto.slimheader.locales.update:update_locale
    """,
)
