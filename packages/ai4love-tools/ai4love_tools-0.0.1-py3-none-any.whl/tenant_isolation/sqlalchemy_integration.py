...
from tenant_isolation.exceptions import TenantIdMissingError
...
def enable_sqlalchemy_tenant_isolation(
    engine_or_session_factory: Engine | sessionmaker | Type[Session],
    *,
    ...
    Args:
        engine_or_session_factory: SQLAlchemy Engine、sessionmaker 或 Session 类
    ...
    try:
        ...
        def _do_orm_execute(state: ORMExecuteState) -> None:
            ...
            # 获取查询涉及的模型
            # 对于简单的单表查询，可以从 statement 中提取模型
            # 对于复杂的多表查询，可能需要更复杂的逻辑
