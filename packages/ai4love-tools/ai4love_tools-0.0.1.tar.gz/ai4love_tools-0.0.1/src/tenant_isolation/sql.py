...
from tenant_isolation.context import get_tenant_id
from tenant_isolation.exceptions import SQLRewriteError, TenantIdMissingError
...
def build_tenant_sql(
    ...
    *,
    ...
    # 处理 INSERT
        ...
        # 或 INSERT INTO table VALUES (val1, val2)
...
def build_tenant_params(
    ...
    *,
    ...
    elif placeholder_style in ["qmark", "numeric"]:
    ...
    *,
    ...
    if rewritten_sql != sql:
        rewritten_params = build_tenant_params(
            params, tenant_id, placeholder_style=placeholder_style, tenant_column=tenant_column
        )
    else:
