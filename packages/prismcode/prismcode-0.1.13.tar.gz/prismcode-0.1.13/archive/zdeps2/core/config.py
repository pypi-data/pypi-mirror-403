...
CONFIG_FILE = Path(__file__).parent.parent / "zdeps2_config.json"
...
def load_raw_config() -> Dict[str, Any]:
    ...
    default_project = str(Path(__file__).parent.parent.parent.parent)
    default_config = {
...
def load_config() -> Dict[str, Any]:
    ...
    # None means "exclude all submodules" (default), list means "exclude only these"
