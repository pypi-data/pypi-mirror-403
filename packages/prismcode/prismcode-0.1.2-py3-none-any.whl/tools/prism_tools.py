...
def _get_available_context_budget() -> int:
    ...
    """
    try:
        from core.context_management.tokens import ModelProfile, CharCounter
        ...
        # Budget is 70% of context window (leaving room for response + buffer)
        total_budget = profile.budget(utilization=0.70)
        ...
        if history_path.exists():
            ...
            counter = CharCounter(chars_per_token=3.3)
