...
**If using .env (recommended):**
```bash
source .env && export TWINE_USERNAME=$PYPI_USERNAME && export TWINE_PASSWORD=$PYPI_TOKEN && twine upload dist/*
```

**If using environment variables or .pypirc:**
```bash
twine upload dist/*
```
