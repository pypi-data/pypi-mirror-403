...
from pysmbserver import smb, smb3, smb3structs, nmb, nt_errors, LOG
from pysmbserver.ntlm import compute_lmhash, compute_nthash

# Propagated imports to clients.
## Dialects.
from pysmbserver.smb import SMB_DIALECT
from pysmbserver.smb3structs import SMB2_DIALECT_002, SMB2_DIALECT_21, SMB2_DIALECT_30, SMB2_DIALECT_311

## Create Disposition.
from pysmbserver.smb import FILE_OPEN, FILE_OVERWRITE, FILE_OVERWRITE_IF
from pysmbserver.smb3structs import FILE_OPEN_REPARSE_POINT

## Create Options.
from pysmbserver.smb import FILE_NON_DIRECTORY_FILE
from pysmbserver.smb3structs import FILE_ATTRIBUTE_NORMAL, FILE_SYNCHRONOUS_IO_NONALERT

## Access Mask.
from pysmbserver.smb import FILE_READ_DATA , FILE_WRITE_DATA, GENERIC_READ, GENERIC_WRITE, GENERIC_ALL, READ_CONTROL, \
                         FILE_READ_ATTRIBUTES, FILE_READ_EA, SYNCHRONIZE

## Share Access Modes.
from pysmbserver.smb import FILE_SHARE_READ, FILE_SHARE_WRITE, FILE_SHARE_DELETE
...
class SMBConnection:
    ...
    def kerberosLogin(self, user, password, domain='', lmhash='', nthash='', aesKey='', kdcHost=None, TGT=None,
        ...
        :raise SessionError: If encountered an error.
        """
        from pysmbserver.krb5.ccache import CCache
        from pysmbserver.krb5.kerberosv5 import KerberosError
        from pysmbserver.krb5 import constants
    ...
    def listShares(self):
        ...
        from pysmbserver.dcerpc.v5 import transport, srvs
