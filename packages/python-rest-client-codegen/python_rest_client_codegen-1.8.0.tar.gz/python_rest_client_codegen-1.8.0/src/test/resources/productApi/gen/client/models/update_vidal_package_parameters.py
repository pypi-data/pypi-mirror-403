...
class UpdateVidalPackageParameters(BaseModel):
    """
    UpdateVidalPackageParameters
    """ # noqa: E501
    vidal_package_id: Optional[StrictInt] = Field(default=None, description="Vidal package to set", alias="vidalPackageId")
    __properties: ClassVar[List[str]] = ["vidalPackageId"]
