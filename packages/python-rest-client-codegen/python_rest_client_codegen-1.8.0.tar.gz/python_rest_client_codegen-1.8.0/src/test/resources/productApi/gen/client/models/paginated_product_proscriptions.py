...
class PaginatedProductProscriptions(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metadata": PagingMetadata.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None,
            "records": [ProductProscription.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
