...
class CustomApiClient(ApiClient):
    ...
    # SearchUserApi
    GET_USER_URI = {'uri': '/v1/users/{userId}', 'method': 'GET'}
    # SearchUserFeatureApi
    GET_USER_FEATURES_URI = {'uri': '/v1/users/features', 'method': 'GET'}
...
def create_search_user_api(configurations=None, client_settings=None):
    """
    ...
    return SearchUserApi(custom_api_client)


def create_search_user_feature_api(configurations=None, client_settings=None):
    """
        Create client with configuration
    ...
    return SearchUserFeatureApi(custom_api_client)
