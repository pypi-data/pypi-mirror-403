...
class SearchUserApi:
    ...
    def get_user(
        self,
        user_id: Annotated[StrictInt, Field(description="The id of the user concerned by the request")],
        ...
        :param user_id: The id of the user concerned by the request (required)
        :type user_id: int
