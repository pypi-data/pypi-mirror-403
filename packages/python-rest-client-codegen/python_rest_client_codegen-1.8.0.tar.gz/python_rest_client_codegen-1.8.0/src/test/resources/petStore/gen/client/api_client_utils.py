...
class CustomApiClient(ApiClient):
    SERVICE_NAME = 'Swagger Petstore'
    
    # PetsApi
    CREATE_PETS_URI = {'uri': '/v1/pets', 'method': 'POST'}
    LIST_PETS_URI = {'uri': '/v1/pets', 'method': 'GET'}
    SHOW_PET_BY_ID_URI = {'uri': '/v1/pets/{petId}', 'method': 'GET'}
...
def create_pets_api(configurations=None, client_settings=None):
    """
    ...
    return PetsApi(custom_api_client)
