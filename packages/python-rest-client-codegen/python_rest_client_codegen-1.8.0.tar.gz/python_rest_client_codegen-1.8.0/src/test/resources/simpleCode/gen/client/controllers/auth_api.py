...
class AuthApi:
    ...
    def login(
        self,
        credential: Annotated[Credential, Field(description="Credentials to use in order to create the session")],
        ...
        :param credential: Credentials to use in order to create the session (required)
    ...
    def logout(
        self,
        session_id: Annotated[StrictInt, Field(description="Session id to delete")],
        ...
        :param session_id: Session id to delete (required)
        :type session_id: int
        :param authorization:
