...
class CustomApiClient(ApiClient):
    ...
    # AuthApi
    DELETE_ROUTE_URI = {'uri': '/v1/route', 'method': 'DELETE'}
    GET_ROUTE_URI = {'uri': '/v1/route', 'method': 'GET'}
    POST_ROUTE_URI = {'uri': '/v1/route', 'method': 'POST'}
...
def create_auth_api(configurations=None, client_settings=None):
    """
    ...
    return AuthApi(custom_api_client)
