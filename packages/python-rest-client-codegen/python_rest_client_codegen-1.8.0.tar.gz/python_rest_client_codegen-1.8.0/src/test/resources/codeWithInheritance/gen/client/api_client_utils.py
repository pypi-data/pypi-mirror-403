...
class CustomApiClient(ApiClient):
    ...
    # NotificationApi
    GET_NOTIFICATIONS_URI = {'uri': '/v1/notification', 'method': 'GET'}
...
def create_notification_api(configurations=None, client_settings=None):
    """
    ...
    return NotificationApi(custom_api_client)
