...
class NotificationApi:
    ...
    def get_notifications(
        ...
        number: Annotated[Optional[Annotated[int, Field(le=10, strict=True, ge=1)]], Field(description="Number of notifications")] = None,
        page: Annotated[Optional[Annotated[int, Field(le=10, strict=True, ge=1)]], Field(description="Page number to search for")] = None,
    ...
    def get_notifications_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[NotificationSending]]:
        """Request all notifications
