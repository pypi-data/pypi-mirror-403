...
class LOrderNotificationSending(BaseModel):
    """
    LOrderNotificationSending
    """ # noqa: E501
    notification: Optional[Notification] = None
    ad: Optional[LOrder] = None
    __properties: ClassVar[List[str]] = ["notification", "ad"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ad": LOrder.from_dict(obj["ad"]) if obj.get("ad") is not None else None
        })
        return _obj
