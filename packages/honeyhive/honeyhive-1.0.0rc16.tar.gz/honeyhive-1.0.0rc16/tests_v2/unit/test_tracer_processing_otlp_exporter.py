...
# Use HH_API_URL environment variable for test endpoint
_BASE_URL = os.getenv("HH_API_URL", "https://api.testing-dp-1.honeyhive.ai")
TEST_OTLP_ENDPOINT = f"{_BASE_URL}/opentelemetry/v1/traces"
...
def default_endpoint() -> str:
    """Default OTLP endpoint for tests.
    
    Returns:
        OTLP endpoint URL from HH_API_URL env var
    """
    return TEST_OTLP_ENDPOINT
...
class TestHoneyHiveOTLPExporterExport:
    ...
    def test_export_success(
        ...
        exporter = HoneyHiveOTLPExporter(tracer_instance=mock_tracer, endpoint=TEST_OTLP_ENDPOINT)
