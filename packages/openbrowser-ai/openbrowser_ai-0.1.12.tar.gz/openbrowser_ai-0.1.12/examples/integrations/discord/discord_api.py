...
from openbrowser.llm import BaseChatModel


class DiscordBot(commands.Bot):
	"""Discord bot implementation for OpenBrowser tasks.
	...
	async def run_agent(self, task: str) -> str:
		try:
			...
			if agent_message is None:
				agent_message = 'Oops! Something went wrong while running OpenBrowser.'

			return agent_message

		except Exception as e:
			raise Exception(f'OpenBrowser task failed: {str(e)}')
