...
Example 1: Using OpenAI (default), with default task: 'go to reddit and search for posts about openbrowser'
python command_line.py

Example 2: Using OpenAI with a Custom Query
python command_line.py --query "go to google and search for openbrowser"
...
def parse_arguments():
	...
	parser.add_argument(
		'--query', type=str, help='The query to process', default='go to reddit and search for posts about openbrowser'
	)
	parser.add_argument(
		'--provider',
		type=str,
