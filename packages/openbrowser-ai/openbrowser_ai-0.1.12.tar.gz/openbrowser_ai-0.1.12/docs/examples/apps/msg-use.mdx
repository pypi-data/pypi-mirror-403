...
Full implementation: [https://github.com/billy-enrizky/openbrowser-ai/tree/main/examples/apps/msg-use](https://github.com/billy-enrizky/openbrowser-ai/tree/main/examples/apps/msg-use)
