...
<Note>
This demo requires openbrowser v0.7.6+.
</Note>
...
Full implementation: [https://github.com/billy-enrizky/openbrowser-ai/tree/main/examples/apps/ad-use](https://github.com/billy-enrizky/openbrowser-ai/tree/main/examples/apps/ad-use)
