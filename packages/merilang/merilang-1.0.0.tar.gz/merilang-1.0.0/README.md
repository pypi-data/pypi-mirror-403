...
[![Version](https://img.shields.io/badge/version-1.0.0-blue.svg)](https://github.com/MeriLang/MeriLang)
...
```bash
git clone https://github.com/MeriLang/MeriLang.git
cd MeriLang
pip install -e .
```
...
```bash
python -m MeriLang run hello.dl
```
...
```bash
# Run a script
python -m MeriLang run script.dl

# Run with debug output
python -m MeriLang run script.dl --debug
