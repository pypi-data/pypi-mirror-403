...
class AnthropicMessagesWrapper:
    ...
    def __init__(self, original_messages: Any, observ_instance: Observ) -> None:
        self._original_messages = original_messages
        self._wt = observ_instance
        self._metadata: Dict[str, Any] = {}
        self._session_id: Optional[str] = None

    def with_metadata(self, metadata: Dict[str, Any]) -> AnthropicMessagesWrapper:
        """Set metadata for the next API call."""
        self._metadata = metadata
        return self

    def with_session_id(self, session_id: str) -> AnthropicMessagesWrapper:
        ...
        try:
            ...
            if gateway_response.get("action") == "cache_hit":
                ...
                return type(
                    ...
                    {
                        "content": [
                            type("TextBlock", (), {"text": cached_content, "type": "text"})()
                        ],
                        "role": "assistant",
                        "model": model,
