...
import nirfmxnr.internal._library as _library

_instance = None
_instance_lock = threading.Lock()
_library_info = {"Windows": {"64bit": {"name": "niRFmxNR.dll", "type": "cdll"}}}
...
def get() -> Any:
    """Returns the library.Library singleton for nirfmxnr."""
    global _instance
