...
bwp_number_prefix = "bwp"
carrier_number_prefix = "carrier"
coresetcluster_number_prefix = "coresetcluster"
coreset_number_prefix = "coreset"
offset_number_prefix = "offset"
pdcch_number_prefix = "pdcch"
pdschcluster_number_prefix = "pdschcluster"
pdsch_number_prefix = "pdsch"
puschcluster_number_prefix = "puschcluster"
pusch_number_prefix = "pusch"
subblock_number_prefix = "subblock"
user_number_prefix = "user"
layer_number_prefix = "layer"
chain_number_prefix = "chain"
...
def build_bandwidth_part_string(selector_string, bandwidth_part_number):
    """Builds a bandwidth_part string."""
    bwp_number_string = append_number(bwp_number_prefix, bandwidth_part_number, selector_string)
    return bwp_number_string
...
def build_coreset_cluster_string(selector_string, coreset_cluster_number):
    """Builds a coreset_cluster string."""
    coresetcluster_number_string = append_number(
        coresetcluster_number_prefix, coreset_cluster_number, selector_string
    )
    return coresetcluster_number_string


def build_coreset_string(selector_string, coreset_number):
    """Builds a coreset string."""
    coreset_number_string = append_number(coreset_number_prefix, coreset_number, selector_string)
    return coreset_number_string
...
def build_pdcch_string(selector_string, pdcch_number):
    """Builds a pdcch string."""
    pdcch_number_string = append_number(pdcch_number_prefix, pdcch_number, selector_string)
    return pdcch_number_string


def build_pdsch_cluster_string(selector_string, pdsch_cluster_number):
    """Builds a pdsch_cluster string."""
    pdschcluster_number_string = append_number(
        pdschcluster_number_prefix, pdsch_cluster_number, selector_string
    )
    return pdschcluster_number_string
...
def build_pusch_cluster_string(selector_string, pusch_cluster_number):
    """Builds a pusch_cluster string."""
    puschcluster_number_string = append_number(
        puschcluster_number_prefix, pusch_cluster_number, selector_string
    )
    return puschcluster_number_string


def build_pusch_string(selector_string, pusch_number):
    """Builds a pusch string."""
    pusch_number_string = append_number(pusch_number_prefix, pusch_number, selector_string)
    return pusch_number_string
...
def build_user_string(selector_string, user_number):
    """Builds a user string."""
    user_number_string = append_number(user_number_prefix, user_number, selector_string)
    return user_number_string


def build_layer_string(selector_string, layer_number):
    """Builds a layer string."""
    layer_number_string = append_number(layer_number_prefix, layer_number, selector_string)
    return layer_number_string


def build_chain_string(selector_string, chain_number):
    """Builds a chain string."""
    chain_number_string = append_number(chain_number_prefix, chain_number, selector_string)
    return chain_number_string
