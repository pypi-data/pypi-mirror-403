...
class AcpComponentCarrierConfiguration(object):
    """"""
    ...
    @_raise_if_disposed
    def set_integration_bandwidth(self, selector_string, value):
        r"""Sets the integration bandwidth of the component carrier (CC). This value is expressed in Hz.
