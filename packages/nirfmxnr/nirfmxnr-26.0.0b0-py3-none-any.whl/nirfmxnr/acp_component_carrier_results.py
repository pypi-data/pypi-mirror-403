...
class AcpComponentCarrierResults(object):
    ...
    def get_absolute_power(self, selector_string):
        r"""Gets the power measured over the integration bandwidth of the component carrier. The carrier power is reported in
        ...
        Returns:
            ...
            attr_val (float):
                Returns the power measured over the integration bandwidth of the component carrier. The carrier power is reported in
                dBm when you set the :py:attr:`~nirfmxnr.attributes.AttributeID.ACP_POWER_UNITS` attribute to **dBm**, and in dBm/Hz
                when you set the ACP Pwr Units attribute to **dBm/Hz**.
    ...
    def fetch_measurement_array(self, selector_string, timeout):
        ...
        Returns:
            ...
            absolute_power (float):
                ...
                value is expressed in dBm. The carrier power is reported in dBm when you set the
    ...
    def fetch_measurement(self, selector_string, timeout):
        ...
        Returns:
            ...
            absolute_power (float):
                ...
                expressed in dBm. The carrier power is reported in dBm when you set the
                :py:attr:`~nirfmxnr.attributes.AttributeID.ACP_POWER_UNITS` attribute to **dBm**, and in dBm/Hz when you set the ACP
                Pwr Units attribute to **dBm/Hz**.
