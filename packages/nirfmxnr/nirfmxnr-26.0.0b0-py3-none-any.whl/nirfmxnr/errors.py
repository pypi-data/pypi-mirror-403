...
class DriverNotInstalledError(Error):
    ...
    def __init__(self):
        """An error due to using this module without the driver runtime installed."""
        super(DriverNotInstalledError, self).__init__("The RFmx NR runtime could not be loaded. Make sure it is installed and its bitness matches that of your Python interpreter. Please visit http://www.ni.com/downloads/drivers/ to download and install it.")  # type: ignore


class DriverTooOldError(Error):
    """An error due to using this module with an older version of the RFmx NR driver runtime."""

    def __init__(self):
        """An error due to using this module with an older version of the RFmx NR driver runtime."""
        super(DriverTooOldError, self).__init__("A function was not found in the RFmx NR runtime. Please visit http://www.ni.com/downloads/drivers/ to download a newer version and install it.")  # type: ignore


class DriverTooNewError(Error):
    """An error due to the RFmx NR driver runtime being too new for this module."""

    def __init__(self):
        """An error due to the RFmx NR driver runtime being too new for this module."""
        super(DriverTooNewError, self).__init__("The RFmx NR runtime returned an unexpected value. This can occur if it is too new for the nirfmxnr Python module. Upgrade the nirfmxnr Python module.")  # type: ignore
...
def handle_error(
    ...
    r"""Helper function for handling errors returned by RFmx NR Library.
