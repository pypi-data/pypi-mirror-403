...
from nirfmxnr.attributes import *  # noqa: F403
from nirfmxnr.enums import *  # noqa: F403
from nirfmxnr.grpc_session_options import *  # noqa: F403
from nirfmxnr.nr import NR, _NRSignalConfiguration
...
def get_diagnostic_information():
    ...
    if platform.system() == "Windows":
        ...
        os_name = "Windows"
        try:
            driver_version_key = winreg.OpenKey(winreg.HKEY_LOCAL_MACHINE, r"SOFTWARE\National Instruments\RFmx\NR\C Runtime Support")  # type: ignore
    ...
    info["driver"]["name"] = "RFmx NR"
    info["driver"]["version"] = driver_version
    info["module"]["name"] = "nirfmxnr"
