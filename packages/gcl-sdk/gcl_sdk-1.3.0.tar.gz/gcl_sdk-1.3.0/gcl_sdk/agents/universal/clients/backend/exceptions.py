...
class BackendClientException(exceptions.UniversalAgentException):
    __template__ = "An unknown backend client exception occurred."


class ResourceAlreadyExists(BackendClientException):
