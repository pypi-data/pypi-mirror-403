...
### Fixed
- **CI Test Collection** - Fixed `ModuleNotFoundError: No module named 'redis'` in CI
  - Made redis import conditional in integration test conftest.py
  - Integration tests now skip gracefully when redis module is not installed
  - Fixes GitHub Actions test workflow that was failing since v0.2.0

### Changed
- **Code Formatting** - Applied Black formatting to provider modules

## [0.2.2] - 2026-01-24

### Added
- **Trust & Quality Badges** - Visual indicators of code quality and security
  - PyPI badges: version, Python versions, downloads, license
  - CI/CD badges: GitHub Actions status, Codecov coverage
  - Code style badges: Ruff, Black, pre-commit, mypy
  - Security badge: OpenSSF Scorecard

- **OpenSSF Scorecard Integration** - Automated security best practices assessment
  - New `.github/workflows/scorecard.yml` workflow
  - Weekly security scans with results published to OpenSSF
  - SARIF results uploaded to GitHub Security tab

- **Badge Documentation** - `docs/BADGES.md` with implementation plan
  - Tiered badge implementation strategy
  - Links to badge services and setup guides
  - Recommended badge order for README

### Changed
- **CI Workflow** - Updated Codecov integration with token support
- **Release Process** - Added GitHub release template with CHANGELOG link
...
[Unreleased]: https://github.com/ShadNygren/bffauth/compare/v0.2.3...HEAD
[0.2.3]: https://github.com/ShadNygren/bffauth/compare/v0.2.2...v0.2.3
[0.2.2]: https://github.com/ShadNygren/bffauth/compare/v0.2.1...v0.2.2
