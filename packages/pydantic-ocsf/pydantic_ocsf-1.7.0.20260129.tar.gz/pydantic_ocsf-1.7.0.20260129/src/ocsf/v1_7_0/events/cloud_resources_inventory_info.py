"""Cloud Resources Inventory Info event class."""
...
class CloudResourcesInventoryInfo(OCSFBaseModel):
    ...
    # Class identifiers
    class_uid: Literal[23] = Field(
        default=23, description="The unique identifier of the event class."
    )
    ...
    cloud: Cloud | None = Field(
        default=None,
        description="Cloud service provider or SaaS platform metadata about the cloud resource(s) that are being discovered by an inventory process. [Recommended]",
    )
    container: Container | None = Field(
        default=None,
        description="A cloud-based container image or running container discovered by an inventory process. [Recommended]",
    )
    ...
    database: Database | None = Field(
        default=None,
        description="A cloud-based database discovered by an inventory process. [Recommended]",
    )
    databucket: Databucket | None = Field(
        default=None,
        description="A cloud-based data bucket or other object storage discovered by an inventory process. [Recommended]",
    )
    ...
    idp: Idp | None = Field(
        default=None,
        description="The Identity Provider that is being discovered by an inventory process, or that is related to the cloud resource(s) being discovered by an inventory process. [Recommended]",
    )
    ...
    region: str | None = Field(
        default=None,
        description="The cloud region where the resource is located, e.g., <code>us-isof-south-1</code>, <code>eastus2</code>, <code>us-central1</code>, etc. [Recommended]",
    )
    resources: list[ResourceDetails] | None = Field(
        default=None,
        description="The cloud resource(s) that are being discovered by an inventory process. Use this object if there is not a direct object match in the class. [Recommended]",
    )
    ...
    table: Table | None = Field(
        default=None,
        description="A cloud-based database table discovered by an inventory process. [Recommended]",
    )
