...
class GroupManagement(OCSFBaseModel):
    ...
    group: Group = Field(..., description="Group that was the target of the event.")
    ...
    privileges: list[str] | None = Field(
        default=None, description="A list of privileges assigned to the group. [Recommended]"
    )
    ...
    resource: ResourceDetails | None = Field(
        default=None, description="Resource that the privileges give access to. [Recommended]"
    )
    ...
    subgroup: Group | None = Field(
        default=None,
        description="A subgroup that was added to or removed from the group. [Recommended]",
    )
    ...
    user: User | None = Field(
        default=None,
        description="A user that was added to or removed from the group. [Recommended]",
    )
