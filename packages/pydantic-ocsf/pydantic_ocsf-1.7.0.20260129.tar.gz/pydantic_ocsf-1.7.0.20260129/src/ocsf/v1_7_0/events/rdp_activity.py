...
class RdpActivity(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.7.0/classes/rdp_activity
    """
    ...
    connection_info: NetworkConnectionInfo | None = Field(
        default=None,
        description="The remote desktop connection details, either connection-based or connectionless. [Recommended]",
    )
    ...
    user: User | None = Field(
        default=None, description="The target user associated with the RDP activity. [Recommended]"
    )
