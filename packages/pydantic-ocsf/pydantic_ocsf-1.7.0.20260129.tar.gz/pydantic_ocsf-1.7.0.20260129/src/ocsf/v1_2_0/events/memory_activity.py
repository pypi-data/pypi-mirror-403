...
class MemoryActivity(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.2.0/classes/memory_activity
    """
    ...
    actual_permissions: int | None = Field(
        default=None,
        description="The permissions that were granted to the in a platform-native format. [Recommended]",
    )
    base_address: str | None = Field(
        default=None, description="The memory address that was access or requested. [Recommended]"
    )
    ...
    requested_permissions: int | None = Field(
        default=None,
        description="The permissions mask that were requested by the process. [Recommended]",
    )
    ...
    size: int | None = Field(
        default=None, description="The memory size that was access or requested."
    )
