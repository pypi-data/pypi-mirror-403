...
class SecurityFinding(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.2.0/classes/security_finding
    """
    ...
    risk_level: str | None = Field(
        default=None,
        description="The risk level, normalized to the caption of the risk_level_id value. In the case of 'Other', it is defined by the event source. [Recommended]",
    )
