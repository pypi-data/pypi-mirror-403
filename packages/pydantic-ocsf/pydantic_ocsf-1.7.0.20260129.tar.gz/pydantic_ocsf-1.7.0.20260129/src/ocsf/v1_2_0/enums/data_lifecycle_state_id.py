...
class DataLifecycleStateId(IntEnum):
    ...
    See: https://schema.ocsf.io/1.2.0/data_types/data_lifecycle_state_id
    """

    VALUE_0 = 0  # The type is not mapped. See the <code>data_lifecycle_state</code> attribute, which contains a data source specific value.
    VALUE_1 = 1  # The data was stored on physical or logcial media and was not actively moving through the network nor was being processed. E.g., data stored in a database, PDF files in a file share, or EHR records in object storage.
