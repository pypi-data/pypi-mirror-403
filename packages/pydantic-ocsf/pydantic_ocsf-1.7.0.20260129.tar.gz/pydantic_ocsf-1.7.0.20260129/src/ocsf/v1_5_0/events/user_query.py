...
class UserQuery(OCSFBaseModel):
    ...
    # Class identifiers
    class_uid: Literal[18] = Field(
        default=18, description="The unique identifier of the event class."
    )
    ...
    user: User = Field(..., description="The user that pertains to the event or object.")
