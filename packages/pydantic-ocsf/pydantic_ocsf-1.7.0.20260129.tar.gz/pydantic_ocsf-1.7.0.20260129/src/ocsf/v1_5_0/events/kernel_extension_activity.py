"""Kernel Extension Activity event class."""
...
class KernelExtensionActivity(OCSFBaseModel):
    """Kernel Extension events report when a driver/extension is loaded or unloaded into the kernel

    OCSF Class UID: 2
    Category:

    See: https://schema.ocsf.io/1.5.0/classes/kernel_extension_activity
    """
