...
class ModuleQuery(OCSFBaseModel):
    ...
    module: Module = Field(..., description="The module that pertains to the event.")
    process: Process = Field(..., description="The process that loaded the module.")
