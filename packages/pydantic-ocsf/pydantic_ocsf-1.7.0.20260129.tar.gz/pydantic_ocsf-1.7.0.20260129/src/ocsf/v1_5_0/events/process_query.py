...
class ProcessQuery(OCSFBaseModel):
    ...
    # Class identifiers
    class_uid: Literal[15] = Field(
        default=15, description="The unique identifier of the event class."
    )
    category_uid: Literal[0] = Field(default=0, description="The category unique identifier.")
    metadata: Metadata = Field(
        ..., description="The metadata associated with the event or a finding."
    )
    process: Process = Field(..., description="The process object.")
