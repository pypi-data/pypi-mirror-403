...
if TYPE_CHECKING:
    from ocsf.v1_5_0.enums.depth import Depth
    from ocsf.v1_5_0.objects.metric import Metric


class Cvss(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.5.0/objects/cvss
    """
    ...
    overall_score: float | None = Field(
        default=None,
        description="The CVSS overall score, impacted by base, temporal, and environmental metrics. For example: <code>9.1</code>. [Recommended]",
    )
    ...
    vendor_name: str | None = Field(
        default=None,
        description="The vendor that provided the CVSS score. For example: <code>NVD, REDHAT</code> etc. [Recommended]",
    )
