...
class ServiceQuery(OCSFBaseModel):
    """Service Query events report information about running services.

    OCSF Class UID: 16
    Category:

    See: https://schema.ocsf.io/1.6.0/classes/service_query
    """

    # Class identifiers
    class_uid: Literal[16] = Field(
        default=16, description="The unique identifier of the event class."
    )
    ...
    service: Service = Field(..., description="The service that pertains to the event.")
