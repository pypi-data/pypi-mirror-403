...
class EntityManagement(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.0.0/classes/entity_management
    """
    ...
    comment: str | None = Field(
        default=None, description="The user provided comment about why the entity was changed."
    )
    ...
    entity_result: ManagedEntity | None = Field(
        default=None, description="The updated managed entity."
    )
