...
class LogonTypeId(IntEnum):
    ...
    See: https://schema.ocsf.io/1.0.0/data_types/logon_type_id
    """

    VALUE_0 = 0  # Used only by the System account, for example at system startup.
