...
class Tactic(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.1.0/objects/tactic
    """
    ...
    uid: str | None = Field(
        default=None,
        description="The tactic ID that is associated with the attack technique, as defined by <a target='_blank' href='https://attack.mitre.org/wiki/ATT&CK_Matrix'>ATT&CK Matrix<sup>TM</sup></a>. For example: <code>TA0043</code>. [Recommended]",
    )
