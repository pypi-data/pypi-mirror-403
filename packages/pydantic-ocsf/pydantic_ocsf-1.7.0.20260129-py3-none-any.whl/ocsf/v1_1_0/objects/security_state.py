...
class SecurityState(OCSFBaseModel):
    ...
    state_id: StateId | None = Field(
        default=None, description="The security state of the managed entity."
    )
