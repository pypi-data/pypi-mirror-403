...
class HttpActivity(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.1.0/classes/http_activity
    """
    ...
    http_cookies: list[HttpCookie] | None = Field(
        default=None, description="The cookies object describes details about HTTP cookies"
    )
