...
class ScriptActivity(OCSFBaseModel):
    """Script Activity events report when a process executes a script.

    OCSF Class UID: 9
    Category:

    See: https://schema.ocsf.io/1.7.0/classes/script_activity
    """
    ...
    script: Script = Field(..., description="The script that was the target of the activity.")
