...
class AccessAnalysisResult(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.7.0/objects/access_analysis_result
    """

    accessors: list[User] = Field(
        ...,
    ...
    access_level: str | None = Field(
        default=None,
        description="The generalized access level or permission scope granted to the identity through the analyzed policy configuration. Common examples include Read, Write, List, Delete, Admin, or custom permission levels. [Recommended]",
    )
    ...
    additional_restrictions: list[AdditionalRestriction] | None = Field(
        default=None,
