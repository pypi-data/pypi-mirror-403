...
if TYPE_CHECKING:
    from ocsf.v1_5_0.enums.flag_ids import FlagIds
...
class DnsAnswer(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.5.0/objects/dns_answer
    """
    ...
    type_: str | None = Field(
        default=None,
        description="The type of data contained in this resource record. See <a target='_blank' href='https://www.rfc-editor.org/rfc/rfc1035.txt'>RFC1035</a>. For example: <code>CNAME</code>. [Recommended]",
    )
