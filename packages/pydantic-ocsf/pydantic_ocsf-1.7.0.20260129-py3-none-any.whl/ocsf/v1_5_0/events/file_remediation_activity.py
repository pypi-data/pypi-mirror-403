"""File Remediation Activity event class."""
...
class FileRemediationActivity(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.5.0/classes/file_remediation_activity
    """
    ...
    file: File = Field(..., description="The file that pertains to the remediation event.")
