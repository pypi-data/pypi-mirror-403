...
class ConfigState(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.5.0/classes/config_state
    """
    ...
    assessments: list[Assessment] | None = Field(
        default=None, description="A list of assessments associated with the device."
    )
    ...
    cis_benchmark_result: CisBenchmarkResult | None = Field(
        default=None,
        description="The CIS Benchmark Result object captures results generated from benchmark evaluations as defined by the Center for Internet Security (<a target='_blank' href='https://www.cisecurity.org/cis-benchmarks/'>CIS</a>). [Recommended]",
    )
