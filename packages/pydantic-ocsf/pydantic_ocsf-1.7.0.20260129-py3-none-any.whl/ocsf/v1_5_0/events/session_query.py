"""User Session Query event class."""
...
class SessionQuery(OCSFBaseModel):
    ...
    # Class identifiers
    class_uid: Literal[17] = Field(
        default=17, description="The unique identifier of the event class."
    )
    ...
    session: Session = Field(..., description="The authenticated user or service session.")
