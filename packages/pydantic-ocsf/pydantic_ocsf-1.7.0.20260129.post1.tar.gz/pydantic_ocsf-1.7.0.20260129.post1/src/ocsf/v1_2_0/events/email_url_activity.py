"""Email URL Activity event class."""
...
class EmailUrlActivity(OCSFBaseModel):
    """Email URL Activity events report URLs within an email.

    OCSF Class UID: 12
    Category: network

    See: https://schema.ocsf.io/1.2.0/classes/email_url_activity
    """
    ...
    url: Url = Field(..., description="The URL included in the email content.")
