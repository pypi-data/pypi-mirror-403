...
from ocsf.v1_7_0.objects._dns import Dns
from ocsf.v1_7_0.objects._entity import Entity
from ocsf.v1_7_0.objects._resource import Resource
from ocsf.v1_7_0.objects.access_analysis_result import AccessAnalysisResult
from ocsf.v1_7_0.objects.account import Account
from ocsf.v1_7_0.objects.actor import Actor
from ocsf.v1_7_0.objects.additional_restriction import AdditionalRestriction
from ocsf.v1_7_0.objects.advisory import Advisory
from ocsf.v1_7_0.objects.affected_code import AffectedCode
from ocsf.v1_7_0.objects.affected_package import AffectedPackage
from ocsf.v1_7_0.objects.agent import Agent
from ocsf.v1_7_0.objects.aircraft import Aircraft
...
from ocsf.v1_7_0.objects.api import Api
from ocsf.v1_7_0.objects.application import Application
...
from ocsf.v1_7_0.objects.authorization import Authorization
from ocsf.v1_7_0.objects.autonomous_system import AutonomousSystem
from ocsf.v1_7_0.objects.baseline import Baseline
from ocsf.v1_7_0.objects.campaign import Campaign
from ocsf.v1_7_0.objects.certificate import Certificate
from ocsf.v1_7_0.objects.check import Check
from ocsf.v1_7_0.objects.cis_benchmark import CisBenchmark
from ocsf.v1_7_0.objects.cis_benchmark_result import CisBenchmarkResult
from ocsf.v1_7_0.objects.cis_control import CisControl
from ocsf.v1_7_0.objects.cis_csc import CisCsc
from ocsf.v1_7_0.objects.classifier_details import ClassifierDetails
from ocsf.v1_7_0.objects.cloud import Cloud
from ocsf.v1_7_0.objects.compliance import Compliance
from ocsf.v1_7_0.objects.container import Container
from ocsf.v1_7_0.objects.cve import Cve
from ocsf.v1_7_0.objects.cvss import Cvss
from ocsf.v1_7_0.objects.cwe import Cwe
from ocsf.v1_7_0.objects.d3f_tactic import D3fTactic
from ocsf.v1_7_0.objects.d3f_technique import D3fTechnique
from ocsf.v1_7_0.objects.d3fend import D3fend
from ocsf.v1_7_0.objects.data_classification import DataClassification
from ocsf.v1_7_0.objects.data_security import DataSecurity
from ocsf.v1_7_0.objects.database import Database
from ocsf.v1_7_0.objects.databucket import Databucket
from ocsf.v1_7_0.objects.dce_rpc import DceRpc
...
from ocsf.v1_7_0.objects.display import Display
from ocsf.v1_7_0.objects.dns_answer import DnsAnswer
from ocsf.v1_7_0.objects.dns_query import DnsQuery
from ocsf.v1_7_0.objects.domain_contact import DomainContact
...
from ocsf.v1_7_0.objects.endpoint import Endpoint
...
from ocsf.v1_7_0.objects.firewall_rule import FirewallRule
...
from ocsf.v1_7_0.objects.hassh import Hassh
from ocsf.v1_7_0.objects.http_cookie import HttpCookie
from ocsf.v1_7_0.objects.http_header import HttpHeader
from ocsf.v1_7_0.objects.http_request import HttpRequest
from ocsf.v1_7_0.objects.http_response import HttpResponse
from ocsf.v1_7_0.objects.identity_activity_metrics import IdentityActivityMetrics
from ocsf.v1_7_0.objects.idp import Idp
from ocsf.v1_7_0.objects.image import Image
...
from ocsf.v1_7_0.objects.kernel import Kernel
...
from ocsf.v1_7_0.objects.managed_entity import ManagedEntity
from ocsf.v1_7_0.objects.metadata import Metadata
from ocsf.v1_7_0.objects.metric import Metric
from ocsf.v1_7_0.objects.mitigation import Mitigation
...
from ocsf.v1_7_0.objects.occurrence_details import OccurrenceDetails
from ocsf.v1_7_0.objects.organization import Organization
from ocsf.v1_7_0.objects.os import Os
from ocsf.v1_7_0.objects.osint import Osint
from ocsf.v1_7_0.objects.package import Package
from ocsf.v1_7_0.objects.parameter import Parameter
from ocsf.v1_7_0.objects.peripheral_device import PeripheralDevice
from ocsf.v1_7_0.objects.permission_analysis_result import PermissionAnalysisResult
...
from ocsf.v1_7_0.objects.query_evidence import QueryEvidence
from ocsf.v1_7_0.objects.query_info import QueryInfo
...
from ocsf.v1_7_0.objects.request import Request
from ocsf.v1_7_0.objects.resource_details import ResourceDetails
from ocsf.v1_7_0.objects.response import Response
from ocsf.v1_7_0.objects.rpc_interface import RpcInterface
from ocsf.v1_7_0.objects.rule import Rule
from ocsf.v1_7_0.objects.san import San
from ocsf.v1_7_0.objects.sbom import Sbom
from ocsf.v1_7_0.objects.scan import Scan
from ocsf.v1_7_0.objects.scim import Scim
from ocsf.v1_7_0.objects.script import Script
from ocsf.v1_7_0.objects.security_state import SecurityState
...
from ocsf.v1_7_0.objects.span import Span
from ocsf.v1_7_0.objects.sso import Sso
from ocsf.v1_7_0.objects.startup_item import StartupItem
from ocsf.v1_7_0.objects.sub_technique import SubTechnique
from ocsf.v1_7_0.objects.table import Table
from ocsf.v1_7_0.objects.tactic import Tactic
from ocsf.v1_7_0.objects.technique import Technique
from ocsf.v1_7_0.objects.threat_actor import ThreatActor
...
from ocsf.v1_7_0.objects.tls_extension import TlsExtension
from ocsf.v1_7_0.objects.trace import Trace
from ocsf.v1_7_0.objects.trait import Trait
from ocsf.v1_7_0.objects.transformation_info import TransformationInfo
from ocsf.v1_7_0.objects.unmanned_aerial_system import UnmannedAerialSystem
from ocsf.v1_7_0.objects.unmanned_system_operating_area import UnmannedSystemOperatingArea
...
from ocsf.v1_7_0.objects.web_resource import WebResource
from ocsf.v1_7_0.objects.whois import Whois
