...
class EntityManagement(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.7.0/classes/entity_management
    """
    ...
    entity: ManagedEntity = Field(..., description="The managed entity that is being acted upon.")
    ...
    comment: str | None = Field(
        default=None,
        description="The user provided comment about why the entity was changed. [Recommended]",
    )
    ...
    entity_result: ManagedEntity | None = Field(
        default=None, description="The updated managed entity. [Recommended]"
    )
