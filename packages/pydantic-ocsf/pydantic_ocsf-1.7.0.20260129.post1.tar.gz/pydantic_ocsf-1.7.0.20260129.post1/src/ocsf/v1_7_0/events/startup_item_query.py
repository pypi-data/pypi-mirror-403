"""Startup Item Query event class."""
...
class StartupItemQuery(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.7.0/classes/startup_item_query
    """

    # Class identifiers
    class_uid: Literal[22] = Field(
        default=22, description="The unique identifier of the event class."
    )
    ...
    startup_item: StartupItem = Field(
        ...,
