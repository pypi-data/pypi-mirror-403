"""OSINT Inventory Info event class."""
...
class OsintInventoryInfo(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.7.0/classes/osint_inventory_info
    """

    # Class identifiers
    class_uid: Literal[21] = Field(
        default=21, description="The unique identifier of the event class."
    )
    category_uid: Literal[0] = Field(default=0, description="The category unique identifier.")
    metadata: Metadata = Field(
        ..., description="The metadata associated with the event or a finding."
    )
    osint: list[Osint] = Field(
