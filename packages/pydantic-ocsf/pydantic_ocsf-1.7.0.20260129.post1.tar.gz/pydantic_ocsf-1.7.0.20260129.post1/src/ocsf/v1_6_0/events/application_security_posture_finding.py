"""Application Security Posture Finding event class."""
...
class ApplicationSecurityPostureFinding(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.6.0/classes/application_security_posture_finding
    """
    ...
    compliance: Compliance | None = Field(
        default=None,
        description="Provides compliance context to vulnerabilities and other weaknesses that are reported as part of an Application Security or Vulnerability Management tool's built-in compliance framework mapping. [Recommended]",
    )
    ...
    remediation: Remediation | None = Field(
        default=None,
        description="Describes the recommended remediation steps to address identified vulnerabilities or weaknesses. [Recommended]",
    )
    resources: list[ResourceDetails] | None = Field(
        default=None,
        description="Describes details about the resource/resources that are affected by the vulnerability/vulnerabilities. [Recommended]",
    )
    ...
    vulnerabilities: list[Vulnerability] | None = Field(
        default=None,
        description="This object describes vulnerabilities reported in a security finding. [Recommended]",
    )
