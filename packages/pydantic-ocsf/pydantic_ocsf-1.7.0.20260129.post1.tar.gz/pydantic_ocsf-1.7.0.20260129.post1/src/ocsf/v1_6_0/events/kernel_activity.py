...
class KernelActivity(OCSFBaseModel):
    """Kernel Activity events report when an process creates, reads, or deletes a kernel resource.

    OCSF Class UID: 3
    Category:

    See: https://schema.ocsf.io/1.6.0/classes/kernel_activity
    """
    ...
    kernel: Kernel = Field(..., description="The target kernel resource.")
