...
class JobQuery(OCSFBaseModel):
    """Job Query events report information about scheduled jobs.

    OCSF Class UID: 10
    Category:

    See: https://schema.ocsf.io/1.5.0/classes/job_query
    """
    ...
    job: Job = Field(..., description="The job object that pertains to the event.")
