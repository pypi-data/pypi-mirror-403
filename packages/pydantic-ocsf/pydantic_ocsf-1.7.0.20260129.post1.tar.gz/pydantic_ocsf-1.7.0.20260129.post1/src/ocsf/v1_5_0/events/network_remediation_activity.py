"""Network Remediation Activity event class."""
...
class NetworkRemediationActivity(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.5.0/classes/network_remediation_activity
    """
