"""Peripheral Device Query event class."""
...
class PeripheralDeviceQuery(OCSFBaseModel):
    """Peripheral Device Query events report information about peripheral devices.

    OCSF Class UID: 14
    Category:

    See: https://schema.ocsf.io/1.5.0/classes/peripheral_device_query
    """
    ...
    peripheral_device: PeripheralDevice = Field(
