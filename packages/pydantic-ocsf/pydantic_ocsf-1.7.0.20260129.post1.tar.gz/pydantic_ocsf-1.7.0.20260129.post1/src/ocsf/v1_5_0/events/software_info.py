"""Software Inventory Info event class."""
...
class SoftwareInfo(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.5.0/classes/software_info
    """

    # Class identifiers
    class_uid: Literal[20] = Field(
        default=20, description="The unique identifier of the event class."
    )
    ...
    package: Package | None = Field(
        default=None,
        description="The device software that is being discovered by an inventory process. [Recommended]",
    )
    ...
    sbom: Sbom | None = Field(
        default=None,
        description="The Software Bill of Materials (SBOM) of the device software that is being discovered by an inventory process. [Recommended]",
    )
