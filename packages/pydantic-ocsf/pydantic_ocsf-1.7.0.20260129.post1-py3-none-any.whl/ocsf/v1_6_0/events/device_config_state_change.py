...
class DeviceConfigStateChange(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.6.0/classes/device_config_state_change
    """
    ...
    prev_security_level: str | None = Field(
        default=None, description="The previous security level of the entity [Recommended]"
    )
    prev_security_level_id: PrevSecurityLevelId | None = Field(
        default=None, description="The previous security level of the entity [Recommended]"
    )
    prev_security_states: list[SecurityState] | None = Field(
        default=None, description="The previous security states of the device. [Recommended]"
    )
    ...
    security_level: str | None = Field(
        default=None, description="The current security level of the entity [Recommended]"
    )
    security_level_id: SecurityLevelId | None = Field(
        default=None, description="The current security level of the entity [Recommended]"
    )
    security_states: list[SecurityState] | None = Field(
        default=None, description="The current security states of the device. [Recommended]"
    )
    ...
    state_id: StateId | None = Field(
        default=None, description="The Config Change State of the managed entity. [Recommended]"
    )
