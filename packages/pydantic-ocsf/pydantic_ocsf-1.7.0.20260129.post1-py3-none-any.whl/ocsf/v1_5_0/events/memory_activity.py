...
class MemoryActivity(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.5.0/classes/memory_activity
    """
    ...
    actual_permissions: int | None = Field(
        default=None,
        description="The permissions that were granted to access memory. [Recommended]",
    )
    ...
    requested_permissions: int | None = Field(
        default=None,
        description="The permissions mask that was requested to access memory. [Recommended]",
    )
    ...
    size: int | None = Field(
        default=None, description="The memory size that was access or requested. [Recommended]"
    )
