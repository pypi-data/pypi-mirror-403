...
if TYPE_CHECKING:
    ...
    from ocsf.v1_5_0.enums.query_result_id import QueryResultId
...
class AdminGroupQuery(OCSFBaseModel):
    """Admin Group Query events report information about administrative groups.

    OCSF Class UID: 9
    Category:

    See: https://schema.ocsf.io/1.5.0/classes/admin_group_query
    """
    ...
    group: Group = Field(..., description="The administrative group.")
    ...
    users: list[User] | None = Field(
        default=None, description="The users that belong to the administrative group. [Recommended]"
    )
