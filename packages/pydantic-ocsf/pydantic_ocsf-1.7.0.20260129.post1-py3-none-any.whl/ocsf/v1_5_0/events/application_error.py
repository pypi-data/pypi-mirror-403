...
class ApplicationError(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.5.0/classes/application_error
    """
    ...
    message: str | None = Field(
        default=None, description="The error message as reported by the application."
    )
