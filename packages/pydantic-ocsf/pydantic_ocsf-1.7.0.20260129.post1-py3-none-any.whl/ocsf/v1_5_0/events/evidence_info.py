"""Live Evidence Info event class."""
...
class EvidenceInfo(OCSFBaseModel):
    ...
    # Class identifiers
    class_uid: Literal[40] = Field(
        default=40, description="The unique identifier of the event class."
    )
    ...
    query_evidence: QueryEvidence = Field(
        ...,
