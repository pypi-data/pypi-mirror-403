...
class ModuleActivity(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.7.0/classes/module_activity
    """
    ...
    actor: Actor = Field(
        ...,
        description="The actor that performed the activity on the target <code>module</code>. For example, the process that loaded a module into memory.",
    )
    device: Device = Field(..., description="An addressable device, computer system or host.")
    metadata: Metadata = Field(
        ..., description="The metadata associated with the event or a finding."
    )
    module: Module = Field(..., description="The module that was loaded, unloaded, or invoked.")
