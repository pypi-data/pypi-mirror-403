...
class ManagedEntity(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.7.0/objects/managed_entity
    """
    ...
    org: Organization | None = Field(
        default=None,
        description="The Organization object containing details about the managed organizational entity. This object includes properties such as the organization name, unique identifier, type, and other organizational metadata. This attribute should be populated when <code>type_id</code> is <code>4</code> (Organization). [Recommended]",
    )
