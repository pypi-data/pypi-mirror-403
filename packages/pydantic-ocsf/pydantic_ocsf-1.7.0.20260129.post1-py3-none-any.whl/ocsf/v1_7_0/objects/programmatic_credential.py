...
class ProgrammaticCredential(OCSFBaseModel):
    ...
    See: https://schema.ocsf.io/1.7.0/objects/programmatic_credential
    """
    ...
    type_: str | None = Field(
        default=None,
        description="The type or category of programmatic credential, normalized to the caption of the type_id value. In the case of 'Other', it is defined by the event source. Examples include 'API Key', 'Service Account Key', 'Access Token', 'Client Certificate', 'OAuth Token', 'Personal Access Token', etc. [Recommended]",
    )
