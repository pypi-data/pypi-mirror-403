...
class DeleteContextResponse:
    """Structured response object for delete context operation"""
    ...
    def __init__(
        ...
        """
        Initialize DeleteContextResponse
    ...
    def from_http_response(
        ...
        """
        Create DeleteContextResponse from HTTP client returned dictionary
