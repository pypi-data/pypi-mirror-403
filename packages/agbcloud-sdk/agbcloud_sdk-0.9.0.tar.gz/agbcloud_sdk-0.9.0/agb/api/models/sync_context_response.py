"""
Sync context response model
"""

from typing import Any, Dict, Optional


class SyncContextResponse:
    """Structured response object for sync context operation"""
    ...
    def __init__(
        ...
        """
        Initialize SyncContextResponse
    ...
    @classmethod
    def from_http_response(cls, response_dict: Dict[str, Any]) -> "SyncContextResponse":
        """
        Create SyncContextResponse from HTTP client returned dictionary
