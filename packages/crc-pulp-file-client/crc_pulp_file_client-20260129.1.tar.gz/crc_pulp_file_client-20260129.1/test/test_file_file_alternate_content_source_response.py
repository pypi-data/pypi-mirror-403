...
class TestFileFileAlternateContentSourceResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FileFileAlternateContentSourceResponse:
        """Test FileFileAlternateContentSourceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileFileAlternateContentSourceResponse`
        """
        model = FileFileAlternateContentSourceResponse()
        if include_optional:
