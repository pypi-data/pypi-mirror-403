...
from nancal_langchain_base.error.ckassifier import ErrorClassifier
from nancal_langchain_base.error.codes import get_error_description
...
def main():
    ...
    if not log_path.exists():
        # 尝试其他路径
        log_path = Path("/Users/zsq/PycharmProjects/nancal-coding/err_log.txt")
