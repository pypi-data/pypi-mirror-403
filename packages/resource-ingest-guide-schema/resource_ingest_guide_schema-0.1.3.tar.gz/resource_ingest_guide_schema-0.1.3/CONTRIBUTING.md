# Contributing to resource-ingest-guide-schema

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
resource-ingest-guide-schema. These guidelines are not strict rules.
...
The resource-ingest-guide-schema team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the resource-ingest-guide-schema technical leads
...
[issues]: https://github.com/biolink/resource-ingest-guide-schema/issues/
[pulls]: https://github.com/biolink/resource-ingest-guide-schema/pulls/
