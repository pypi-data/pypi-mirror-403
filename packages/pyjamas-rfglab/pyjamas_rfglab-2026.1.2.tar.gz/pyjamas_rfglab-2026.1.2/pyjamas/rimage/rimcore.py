...
class rimage:
    ...
    def livewire(self, thesrc, thedst, margin, xy=False, smooth_factor=0.0, shortest_path_fn_name: Optional='Dijkstra') -> List:
        ...
        # Find shortest path.
        shortest_path_fn = self.livewire_shortest_path_fns.get(shortest_path_fn_name)
