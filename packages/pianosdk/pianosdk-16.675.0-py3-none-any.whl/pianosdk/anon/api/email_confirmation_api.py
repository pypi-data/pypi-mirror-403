...
class EmailConfirmationApi(BaseApi):
    def __init__(self, config: Configuration, http_callback: HttpCallBack = None) -> None:
        super().__init__(config, http_callback)

    def check_confirmed(self, aid: str, user_token: str = None, user_provider: str = None, user_ref: str = None) -> ApiResponse[bool]:
        _url_path = '/api/v3/email/confirmation/check'
