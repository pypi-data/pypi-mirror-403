...
class PublisherLicensingScheduleApi(BaseApi):
    def __init__(self, config: Configuration, http_callback: HttpCallBack = None) -> None:
        super().__init__(config, http_callback)

    def get_contracts_by_schedule(self, aid: str, schedule_id: str) -> ApiResponse[List[Contract]]:
        _url_path = '/api/v3/publisher/licensing/schedule/contracts'
