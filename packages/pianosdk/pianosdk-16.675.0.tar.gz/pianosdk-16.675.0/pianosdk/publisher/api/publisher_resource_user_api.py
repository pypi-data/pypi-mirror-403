...
class PublisherResourceUserApi(BaseApi):
    def __init__(self, config: Configuration, http_callback: HttpCallBack = None) -> None:
        super().__init__(config, http_callback)

    def list_users(self, aid: str, rid: str, offset: int = 0, limit: int = 100, q: str = None, order_by: str = None, order_direction: str = None) -> ApiResponse[List[User]]:
        _url_path = '/api/v3/publisher/resource/user/list'
