...
class ErrorResponse(object):
    ...
    """
    openapi_types = {"error_code": "int", "message": "str"}

    attribute_map = {"error_code": "errorCode", "message": "message"}

    def __init__(
        self, error_code=None, message=None, local_vars_configuration=None
    ):  # noqa: E501
    ...
    def error_code(self, error_code):
        ...
        """
        if (
            self.local_vars_configuration.client_side_validation and error_code is None
        ):  # noqa: E501
            raise ValueError(
