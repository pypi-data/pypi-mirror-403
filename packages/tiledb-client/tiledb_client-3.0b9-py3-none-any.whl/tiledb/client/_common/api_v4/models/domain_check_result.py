...
class DomainCheckResult(object):
    ...
    """
    openapi_types = {"status": "str", "time": "datetime"}

    attribute_map = {"status": "status", "time": "time"}

    def __init__(
        self, status=None, time=None, local_vars_configuration=None
    ):  # noqa: E501
    ...
    def status(self):
        ...
        The status of the domain check  # noqa: E501
    ...
    def status(self, status):
        ...
        allowed_values = ["verified", "error", "failed"]  # noqa: E501
        if (
