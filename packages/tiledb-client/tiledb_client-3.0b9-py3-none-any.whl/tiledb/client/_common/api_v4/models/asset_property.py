...
class AssetProperty(object):
    ...
    def __init__(
        ...
        """AssetProperty - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def key(self):
        """Gets the key of this AssetProperty.  # noqa: E501
        ...
        :return: The key of this AssetProperty.  # noqa: E501
        :rtype: str
        """
        return self._key
    ...
    @key.setter
    def key(self, key):
        """Sets the key of this AssetProperty.

        The key property of property pair: * `image` - Image name to launch the notebook * `image_size` - Image size to launch the notebook * `default_region` - Default region to start the notebook server * `default_view` - Default view to open the asset in the UI * `version_pruning_limit` - The maximum number of versions to keep for a notebook * `version_pruning_enabled` - Flag indicating whether automatic version pruning is enabled for a notebook   # noqa: E501

        :param key: The key of this AssetProperty.  # noqa: E501
        :type: str
        """
        if (
    ...
    @property
    def value(self):
        """Gets the value of this AssetProperty.  # noqa: E501

        The value property of property pair.  # noqa: E501

        :return: The value of this AssetProperty.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    @property
    def id(self):
        """Gets the id of this AssetProperty.  # noqa: E501

        The id of the asset property  # noqa: E501

        :return: The id of this AssetProperty.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this AssetProperty.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AssetProperty):
            return False
