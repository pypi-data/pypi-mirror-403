...
class VersionsApi(object):
    ...
    def get_versions(self, **kwargs):  # noqa: E501
        """Get Server versions  # noqa: E501

        This endpoint returns various version numbers pertaining to the server.   # noqa: E501
    ...
    def get_versions_with_http_info(self, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(VersionsResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        return self.api_client.call_api(
            ...
            response_type="VersionsResponse",  # noqa: E501
