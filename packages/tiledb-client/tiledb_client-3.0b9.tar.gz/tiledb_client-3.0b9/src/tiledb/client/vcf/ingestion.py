...
from tiledb.client.client import get_workspace_id
from tiledb.client.rest_api.models import RetryStrategy
from tiledb.client.utilities import Profiler
from tiledb.client.utilities import as_batch
from tiledb.client.utilities import consolidate_fragments
from tiledb.client.utilities import create_log_array
from tiledb.client.utilities import get_logger
from tiledb.client.utilities import max_memory_usage
from tiledb.client.utilities import process_stream
from tiledb.client.utilities import read_file
from tiledb.client.utilities import run_dag
from tiledb.client.utilities import set_aws_context
from tiledb.client.utilities import write_log_event
...
def get_logger_wrapper(
    ...
    logger.debug(
        "tiledb.client=%s, tiledb=%s, libtiledb=%s",
        tiledb.client.version.version,
        tiledb.version(),
...
def register_dataset_udf(
    ...
    *,
    ...
    :param teamspace: TileDB-Cloud teamspace, defaults to None
    :param config: config dictionary, defaults to None
    :param verbose: verbose logging, defaults to False
    """
    ...
    workspace: str = get_workspace_id()

    tiledb_uri = f"tiledb://{workspace}/{teamspace}/{register_name}"
    logger.info("Registering dataset at %r.", tiledb_uri)

    assets.register_asset(dataset_uri, tiledb_uri, acn=acn)
...
def ingest_samples_dag(
    ...
    *,
    ...
    logger.info(
        "VCF samples ingestion submitted -" " https://%s/activity/taskgraphs/%s/%s",
...
def ingest_vcf_annotations(
    ...
    *,
    ...
    :param consolidate_resources: manual override for consolidate UDF resources,
        defaults to None
    :param vcf_image_name: udf image name to use, useful for testing beta features
    """
