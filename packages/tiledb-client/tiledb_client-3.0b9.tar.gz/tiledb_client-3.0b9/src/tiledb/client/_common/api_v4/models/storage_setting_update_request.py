...
class StorageSettingUpdateRequest(object):
    ...
    def test_settings(self):
        """Gets the test_settings of this StorageSettingUpdateRequest.  # noqa: E501

        If set to true (the default), the server will test the storage settings before completing the update by writing a small test file to the storage path, using the given credentials. This test file will be deleted after the test is complete. If the test fails, the storage settings will not be updated and an error will be returned. The test should only be disabled during tests.   # noqa: E501

        :return: The test_settings of this StorageSettingUpdateRequest.  # noqa: E501
        :rtype: bool
        """
    ...
    def test_settings(self, test_settings):
        """Sets the test_settings of this StorageSettingUpdateRequest.

        If set to true (the default), the server will test the storage settings before completing the update by writing a small test file to the storage path, using the given credentials. This test file will be deleted after the test is complete. If the test fails, the storage settings will not be updated and an error will be returned. The test should only be disabled during tests.   # noqa: E501

        :param test_settings: The test_settings of this StorageSettingUpdateRequest.  # noqa: E501
        :type: bool
        """
