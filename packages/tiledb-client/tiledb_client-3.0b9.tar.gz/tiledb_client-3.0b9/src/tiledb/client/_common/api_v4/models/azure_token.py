...
class AzureToken(object):
    ...
    """
    openapi_types = {"blob_endpoint": "str", "account_name": "str", "sas_token": "str"}
    ...
    def blob_endpoint(self, blob_endpoint):
        """Sets the blob_endpoint of this AzureToken.

        The Blob Storage endpoint used for this credential. Defaults to 'https://<account_name>.blob.core.windows.net'  # noqa: E501

        :param blob_endpoint: The blob_endpoint of this AzureToken.  # noqa: E501
        :type: str
        """
