...
class DataChangeFileAdd(object):
    ...
    def __init__(
        ...
        """DataChangeFileAdd - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def url(self):
        """Gets the url of this DataChangeFileAdd.  # noqa: E501
        ...
        :return: The url of this DataChangeFileAdd.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this DataChangeFileAdd.

        An https url that a client can use to read the file directly. The same file in different responses may have different urls.  # noqa: E501

        :param url: The url of this DataChangeFileAdd.  # noqa: E501
        :type: str
        """
        if (
    ...
    @property
    def id(self):
        """Gets the id of this DataChangeFileAdd.  # noqa: E501
        ...
        :return: The id of this DataChangeFileAdd.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DataChangeFileAdd.

        A unique string for the file in a table. The same file is guaranteed to have the same id across multiple requests. A client may cache the file content and use this id as a key to decide whether to use the cached file content.  # noqa: E501

        :param id: The id of this DataChangeFileAdd.  # noqa: E501
        :type: str
        """
        if (
    ...
    def partition_values(self):
        """Gets the partition_values of this DataChangeFileAdd.  # noqa: E501
        ...
        :return: The partition_values of this DataChangeFileAdd.  # noqa: E501
    ...
    def partition_values(self, partition_values):
        """Sets the partition_values of this DataChangeFileAdd.

        A map from partition column to value for this file. See Partition Value Serialization for how to parse the partition values. When the table doesn't have partition columns, this will be an empty map.  # noqa: E501

        :param partition_values: The partition_values of this DataChangeFileAdd.  # noqa: E501
    ...
    @property
    def size(self):
        """Gets the size of this DataChangeFileAdd.  # noqa: E501

        The size of this file in bytes.  # noqa: E501

        :return: The size of this DataChangeFileAdd.  # noqa: E501
        :rtype: int
        """
        return self._size
    ...
    @size.setter
    def size(self, size):
        """Sets the size of this DataChangeFileAdd.

        The size of this file in bytes.  # noqa: E501

        :param size: The size of this DataChangeFileAdd.  # noqa: E501
        :type: int
        """
        if (
    ...
    @property
    def timestamp(self):
        """Gets the timestamp of this DataChangeFileAdd.  # noqa: E501

        The timestamp of the file in milliseconds from epoch.  # noqa: E501

        :return: The timestamp of this DataChangeFileAdd.  # noqa: E501
        :rtype: int
        """
    ...
    def timestamp(self, timestamp):
        """Sets the timestamp of this DataChangeFileAdd.

        The timestamp of the file in milliseconds from epoch.  # noqa: E501

        :param timestamp: The timestamp of this DataChangeFileAdd.  # noqa: E501
        :type: int
        """
        if (
    ...
    @property
    def version(self):
        """Gets the version of this DataChangeFileAdd.  # noqa: E501

        The table version of this file.  # noqa: E501

        :return: The version of this DataChangeFileAdd.  # noqa: E501
        :rtype: int
        """
    ...
    def version(self, version):
        """Sets the version of this DataChangeFileAdd.

        The table version of this file.  # noqa: E501

        :param version: The version of this DataChangeFileAdd.  # noqa: E501
        :type: int
        """
        if (
    ...
    @property
    def stats(self):
        """Gets the stats of this DataChangeFileAdd.  # noqa: E501
        ...
        :return: The stats of this DataChangeFileAdd.  # noqa: E501
        :rtype: str
        """
        return self._stats
    ...
    def stats(self, stats):
        """Sets the stats of this DataChangeFileAdd.

        Contains statistics (e.g., count, min/max values for columns) about the data in this file. This field may be missing. A file may or may not have stats. This is a serialized JSON string which can be deserialized to a Statistics Struct. A client can decide whether to use stats or drop it.  # noqa: E501

        :param stats: The stats of this DataChangeFileAdd.  # noqa: E501
        :type: str
        """
    ...
    def expiration_timestamp(self):
        """Gets the expiration_timestamp of this DataChangeFileAdd.  # noqa: E501
        ...
        :return: The expiration_timestamp of this DataChangeFileAdd.  # noqa: E501
        :rtype: int
        """
    ...
    def expiration_timestamp(self, expiration_timestamp):
        """Sets the expiration_timestamp of this DataChangeFileAdd.

        The unix timestamp corresponding to the expiration of the url, in milliseconds, returned when the server supports the feature.  # noqa: E501

        :param expiration_timestamp: The expiration_timestamp of this DataChangeFileAdd.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DataChangeFileAdd):
            return False
