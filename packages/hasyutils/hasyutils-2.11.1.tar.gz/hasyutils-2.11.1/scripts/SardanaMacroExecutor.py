...
import sys, os
import HasyUtils
import tngGui.lib.macroExecutorClass
import argparse

def parseCLI():
    parser = argparse.ArgumentParser( 
        formatter_class = argparse.RawDescriptionHelpFormatter,
        description="SardanaMacroExecutor", 
        epilog='''\
Examples:
  SardanaMacroExecutor.py   
    ''')
    #
...
def main():
    ...
    mainW = tngGui.lib.macroExecutorClass.MacroExecutor( args, None, app)
