...
class FanDataCreationRequest(google.protobuf.message.Message):
...
global___FanDataCreationRequest = FanDataCreationRequest

class FanDataConvertToUserRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
...
global___FanDataConvertToUserRequest = FanDataConvertToUserRequest

class FanDataCreationResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    DATA_RESPONSE_FIELD_NUMBER: builtins.int
    ENGINEERING_DATA_FIELD_NUMBER: builtins.int
    @property
    def data_response(self) -> ansys.api.discovery.v1.commonmessages_pb2.CreationResponse: ...
    @property
    def engineering_data(self) -> global___FanDataDefinition: ...
    def __init__(self,
        *,
        data_response : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.CreationResponse] = ...,
...
global___FanDataCreationResponse = FanDataCreationResponse
...
class FanDataProperties(google.protobuf.message.Message):
    ...
    @property
    def constant_pressure_rise(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    @property
    def volume_flow_rate_vs_pressure_table(self) -> ansys.api.discovery.v1.commonmessages_pb2.QuantityPairTable: ...
    @property
    def velocity_vs_pressure_table(self) -> ansys.api.discovery.v1.commonmessages_pb2.QuantityPairTable: ...
    @property
    ...
    def __init__(self,
        *,
        ...
        fan_name : typing.Text = ...,
        fan_specification : global___FanSpecification.ValueType = ...,
        constant_pressure_rise : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        volume_flow_rate_vs_pressure_table : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.QuantityPairTable] = ...,
        velocity_vs_pressure_table : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.QuantityPairTable] = ...,
...
class FanManufacturerData(google.protobuf.message.Message):
    ...
    @property
    def outer_radius(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    @property
    def inner_radius(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    notes: typing.Text = ...
    ...
    def __init__(self,
        *,
        manufacturer : typing.Text = ...,
        model_number : typing.Text = ...,
        outer_radius : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        inner_radius : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        notes : typing.Text = ...,
        disclaimer : typing.Text = ...,
        is_user_defined : builtins.bool = ...,
        ) -> None: ...
...
class SetFanDataSpecificationRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    OBJECT_ID_FIELD_NUMBER: builtins.int
    FAN_SPECIFICATION_FIELD_NUMBER: builtins.int
    @property
    ...
    def HasField(self, field_name: typing_extensions.Literal["object_id",b"object_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["fan_specification",b"fan_specification","object_id",b"object_id"]) -> None: ...
global___SetFanDataSpecificationRequest = SetFanDataSpecificationRequest
