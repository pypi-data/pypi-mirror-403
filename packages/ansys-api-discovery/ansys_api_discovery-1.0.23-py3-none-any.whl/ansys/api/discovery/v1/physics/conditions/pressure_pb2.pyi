...
class PressureProperties(google.protobuf.message.Message):
    ...
    @property
    def pressure_magnitude(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    def __init__(self,
        *,
        pressure_magnitude : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        ) -> None: ...
...
class GetAllResponse(google.protobuf.message.Message):
    """Response for GetAll"""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    PRESSURE_CONDITIONS_FIELD_NUMBER: builtins.int
    SUCCESS_FIELD_NUMBER: builtins.int
    MESSAGE_FIELD_NUMBER: builtins.int
    @property
    def pressure_conditions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___PressureDefinition]: ...
    success: builtins.bool = ...
    message: typing.Text = ...
    def __init__(self,
        *,
        pressure_conditions : typing.Optional[typing.Iterable[global___PressureDefinition]] = ...,
        success : builtins.bool = ...,
        message : typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["message",b"message","pressure_conditions",b"pressure_conditions","success",b"success"]) -> None: ...
