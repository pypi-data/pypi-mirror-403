...
import ansys.api.discovery.v1.engineeringdata.boltdata_pb2
...
class BoltAssignmentCreationRequest(google.protobuf.message.Message):
    ...
    CREATE_LONG_BOLTS_FIELD_NUMBER: builtins.int
    @property
    ...
    create_long_bolts: builtins.bool = ...
    def __init__(self,
        *,
    ...
    def ClearField(self, field_name: typing_extensions.Literal["bolt_assignment_properties",b"bolt_assignment_properties","create_long_bolts",b"create_long_bolts","creation_data",b"creation_data"]) -> None: ...
...
class BoltAssignmentProperties(google.protobuf.message.Message):
    ...
    @property
    def definition(self) -> ansys.api.discovery.v1.engineeringdata.boltdata_pb2.BoltDataDefinition: ...
    def __init__(self,
        *,
        definition : typing.Optional[ansys.api.discovery.v1.engineeringdata.boltdata_pb2.BoltDataDefinition] = ...,
        ) -> None: ...
...
class SetBoltLocationRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    SET_LOCATION_REQUEST_FIELD_NUMBER: builtins.int
    CREATE_LONG_BOLTS_FIELD_NUMBER: builtins.int
    @property
    def set_location_request(self) -> ansys.api.discovery.v1.commonmessages_pb2.SetLocationRequest: ...
    create_long_bolts: builtins.bool = ...
    def __init__(self,
        *,
        set_location_request : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.SetLocationRequest] = ...,
        create_long_bolts : builtins.bool = ...,
        ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["set_location_request",b"set_location_request"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["create_long_bolts",b"create_long_bolts","set_location_request",b"set_location_request"]) -> None: ...
global___SetBoltLocationRequest = SetBoltLocationRequest
