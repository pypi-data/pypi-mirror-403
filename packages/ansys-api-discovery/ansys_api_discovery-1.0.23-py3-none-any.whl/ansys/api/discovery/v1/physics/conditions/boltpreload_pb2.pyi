...
class SetBoltPreloadSpecificationRequest(google.protobuf.message.Message):
    """Other requests
...
global___SetBoltPreloadSpecificationRequest = SetBoltPreloadSpecificationRequest
...
class BoltPreloadClampForceProperties(google.protobuf.message.Message):
    ...
    @property
    def clamp_force(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    def __init__(self,
        *,
        clamp_force : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        ) -> None: ...
...
class BoltPreloadGripLengthProperties(google.protobuf.message.Message):
    ...
    @property
    def grip_length(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    def __init__(self,
        *,
        grip_length : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        ) -> None: ...
...
class BoltPreloadTorqueProperties(google.protobuf.message.Message):
    ...
    @property
    def torque(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    torque_coefficient: builtins.float = ...
    @property
    def boltdiameter(self) -> ansys.api.discovery.v1.commonmessages_pb2.OptionalQuantity: ...
    def __init__(self,
        *,
        torque : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        torque_coefficient : builtins.float = ...,
        boltdiameter : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.OptionalQuantity] = ...,
        ) -> None: ...
...
class GetAllResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    BOLT_PRELOADS_FIELD_NUMBER: builtins.int
    SUCCESS_FIELD_NUMBER: builtins.int
    MESSAGE_FIELD_NUMBER: builtins.int
    @property
    def bolt_preloads(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___BoltPreloadDefinition]: ...
    success: builtins.bool = ...
    message: typing.Text = ...
    def __init__(self,
        *,
        bolt_preloads : typing.Optional[typing.Iterable[global___BoltPreloadDefinition]] = ...,
        success : builtins.bool = ...,
        message : typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["bolt_preloads",b"bolt_preloads","message",b"message","success",b"success"]) -> None: ...
