...
class SetMomentSpecificationRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
...
global___SetMomentSpecificationRequest = SetMomentSpecificationRequest
...
class MomentProperties(google.protobuf.message.Message):
    ...
    @property
    def moment(self) -> ansys.api.discovery.v1.commonmessages_pb2.QuantityVector: ...
    def __init__(self,
        *,
        moment : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.QuantityVector] = ...,
        ) -> None: ...
...
class GetAllResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    MOMENT_CONDITIONS_FIELD_NUMBER: builtins.int
    SUCCESS_FIELD_NUMBER: builtins.int
    MESSAGE_FIELD_NUMBER: builtins.int
    @property
    def moment_conditions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MomentDefinition]: ...
    success: builtins.bool = ...
    message: typing.Text = ...
    def __init__(self,
        *,
        moment_conditions : typing.Optional[typing.Iterable[global___MomentDefinition]] = ...,
        success : builtins.bool = ...,
        message : typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["message",b"message","moment_conditions",b"moment_conditions","success",b"success"]) -> None: ...
