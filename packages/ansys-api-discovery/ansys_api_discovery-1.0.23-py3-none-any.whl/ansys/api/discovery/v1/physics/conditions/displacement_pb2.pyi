...
class DisplacementTranslationProperties(google.protobuf.message.Message):
    ...
    @property
    def displacement(self) -> ansys.api.discovery.v1.commonmessages_pb2.VectorOfOptionalQuantities: ...
    @property
    def remote_point(self) -> ansys.api.discovery.v1.commonmessages_pb2.OptionalVector: ...
    def __init__(self,
        *,
        displacement : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.VectorOfOptionalQuantities] = ...,
...
class DisplacementRotationProperties(google.protobuf.message.Message):
    ...
    REMOTE_POINT_FIELD_NUMBER: builtins.int
    @property
    def rotation(self) -> ansys.api.discovery.v1.commonmessages_pb2.VectorOfOptionalQuantities: ...
    @property
    def remote_point(self) -> ansys.api.discovery.v1.commonmessages_pb2.OptionalVector: ...
    def __init__(self,
        *,
        rotation : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.VectorOfOptionalQuantities] = ...,
        remote_point : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.OptionalVector] = ...,
        ) -> None: ...
...
class GetAllResponse(google.protobuf.message.Message):
    ...
    @property
    def displacements(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___DisplacementDefinition]: ...
    success: builtins.bool = ...
    message: typing.Text = ...
    def __init__(self,
        *,
        displacements : typing.Optional[typing.Iterable[global___DisplacementDefinition]] = ...,
        success : builtins.bool = ...,
        message : typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["displacements",b"displacements","message",b"message","success",b"success"]) -> None: ...
