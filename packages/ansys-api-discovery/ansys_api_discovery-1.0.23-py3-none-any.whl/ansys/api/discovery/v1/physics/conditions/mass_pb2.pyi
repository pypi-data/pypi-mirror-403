...
class MassProperties(google.protobuf.message.Message):
    ...
    @property
    def mass_magnitude(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    @property
    def remote_point(self) -> ansys.api.discovery.v1.commonmessages_pb2.OptionalVector: ...
    def __init__(self,
        *,
        mass_magnitude : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
...
class GetAllResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    MASS_CONDITIONS_FIELD_NUMBER: builtins.int
    SUCCESS_FIELD_NUMBER: builtins.int
    MESSAGE_FIELD_NUMBER: builtins.int
    @property
    def mass_conditions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___MassDefinition]: ...
    success: builtins.bool = ...
    message: typing.Text = ...
    def __init__(self,
        *,
        mass_conditions : typing.Optional[typing.Iterable[global___MassDefinition]] = ...,
        success : builtins.bool = ...,
        message : typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["mass_conditions",b"mass_conditions","message",b"message","success",b"success"]) -> None: ...
