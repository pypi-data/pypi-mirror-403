...
class VelocityProperties(google.protobuf.message.Message):
    ...
    @property
    def velocity(self) -> ansys.api.discovery.v1.commonmessages_pb2.VectorOfOptionalQuantities: ...
    @property
    def remote_point(self) -> ansys.api.discovery.v1.commonmessages_pb2.OptionalVector: ...
    def __init__(self,
        *,
        velocity : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.VectorOfOptionalQuantities] = ...,
...
class GetAllResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    VELOCITY_CONDITIONS_FIELD_NUMBER: builtins.int
    SUCCESS_FIELD_NUMBER: builtins.int
    MESSAGE_FIELD_NUMBER: builtins.int
    @property
    def velocity_conditions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___VelocityDefinition]: ...
    success: builtins.bool = ...
    message: typing.Text = ...
    def __init__(self,
        *,
        velocity_conditions : typing.Optional[typing.Iterable[global___VelocityDefinition]] = ...,
        success : builtins.bool = ...,
        message : typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["message",b"message","success",b"success","velocity_conditions",b"velocity_conditions"]) -> None: ...
