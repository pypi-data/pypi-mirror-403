...
class SetSupportSpecificationRequest(google.protobuf.message.Message):
    """Support"""
...
global___SetSupportSpecificationRequest = SetSupportSpecificationRequest
...
class SupportDisplacedDefinition(google.protobuf.message.Message):
    ...
    support_type: global___SupportSpecification.ValueType = ...
    @property
    def displacement(self) -> ansys.api.discovery.v1.commonmessages_pb2.TensorOfOptionalQuantities: ...
    def __init__(self,
        *,
        id : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.GuidEntityIdentifier] = ...,
        parent_id : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.GuidEntityIdentifier] = ...,
        ...
        suppressed : builtins.bool = ...,
        support_type : global___SupportSpecification.ValueType = ...,
        displacement : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.TensorOfOptionalQuantities] = ...,
        ) -> None: ...
...
class GetAllResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["message",b"message","success",b"success","supports_displaced",b"supports_displaced","supports_general",b"supports_general"]) -> None: ...
