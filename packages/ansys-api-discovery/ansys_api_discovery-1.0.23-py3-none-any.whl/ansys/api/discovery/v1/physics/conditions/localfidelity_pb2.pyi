...
class LocalFidelityProperties(google.protobuf.message.Message):
    ...
    @property
    def local_fidelity_magnitude(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    def __init__(self,
        *,
        local_fidelity_magnitude : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        ) -> None: ...
