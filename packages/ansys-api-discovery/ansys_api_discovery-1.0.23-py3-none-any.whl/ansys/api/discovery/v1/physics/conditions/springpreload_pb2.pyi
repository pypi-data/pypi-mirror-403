...
class SetSpringPreloadSpecificationRequest(google.protobuf.message.Message):
    """Other requests"""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
...
global___SetSpringPreloadSpecificationRequest = SetSpringPreloadSpecificationRequest

class SetSpringPreloadTypeRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    OBJECT_ID_FIELD_NUMBER: builtins.int
...
global___SetSpringPreloadTypeRequest = SetSpringPreloadTypeRequest
...
class SpringPreloadLongitudinalStiffnessProperties(google.protobuf.message.Message):
    ...
    @property
    def longitudinal_stiffness(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    def __init__(self,
        *,
        longitudinal_stiffness : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        ) -> None: ...
...
class SpringPreloadTorsionalStiffnessProperties(google.protobuf.message.Message):
    ...
    @property
    def torsional_stiffness(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    def __init__(self,
        *,
        torsional_stiffness : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        ) -> None: ...
...
class SpringPreloadProperties(google.protobuf.message.Message):
    ...
    type: global___SpringPreloadType.ValueType = ...
    @property
    def preload_force(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    @property
    def preload_length(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    @property
    def preload_torque(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    @property
    def preload_rotation(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    def __init__(self,
        *,
        type : global___SpringPreloadType.ValueType = ...,
        preload_force : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        preload_length : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        preload_torque : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        preload_rotation : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        ) -> None: ...
...
class GetAllResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    SPRING_PRELOAD_CONDITIONS_FIELD_NUMBER: builtins.int
    SUCCESS_FIELD_NUMBER: builtins.int
    MESSAGE_FIELD_NUMBER: builtins.int
    @property
    def spring_preload_conditions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___SpringPreloadDefinition]: ...
    success: builtins.bool = ...
    message: typing.Text = ...
    def __init__(self,
        *,
        spring_preload_conditions : typing.Optional[typing.Iterable[global___SpringPreloadDefinition]] = ...,
        success : builtins.bool = ...,
        message : typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["message",b"message","spring_preload_conditions",b"spring_preload_conditions","success",b"success"]) -> None: ...
