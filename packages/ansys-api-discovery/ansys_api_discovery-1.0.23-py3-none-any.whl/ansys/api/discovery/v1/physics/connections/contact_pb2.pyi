...
class ContactCreationRequest(google.protobuf.message.Message):
    ...
    @property
    def contact_properties(self) -> ansys.api.discovery.v1.physics.physicsmessages_pb2.ContactProperties: ...
    def __init__(self,
        *,
        creation_data : typing.Optional[ansys.api.discovery.v1.physics.physicsmessages_pb2.DoubleSidedScopedCreationData] = ...,
        contact_properties : typing.Optional[ansys.api.discovery.v1.physics.physicsmessages_pb2.ContactProperties] = ...,
        ) -> None: ...
