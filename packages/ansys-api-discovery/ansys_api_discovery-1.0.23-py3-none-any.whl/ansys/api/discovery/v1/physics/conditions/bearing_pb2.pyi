...
class BearingProperties(google.protobuf.message.Message):
    ...
    @property
    def radial_force(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    @property
    def thrust_force(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    @property
    def angle(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    def __init__(self,
        *,
        radial_force : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        thrust_force : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
...
class GetAllResponse(google.protobuf.message.Message):
    ...
    @property
    def conditions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___BearingDefinition]: ...
    success: builtins.bool = ...
    message: typing.Text = ...
    def __init__(self,
        *,
        conditions : typing.Optional[typing.Iterable[global___BearingDefinition]] = ...,
        success : builtins.bool = ...,
        message : typing.Text = ...,
        ) -> None: ...
