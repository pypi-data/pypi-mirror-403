...
class SetWallSpecificationRequest(google.protobuf.message.Message):
    """enum commands"""
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
...
global___SetWallSpecificationRequest = SetWallSpecificationRequest

class SetWallThermalOptionRequest(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    OBJECT_ID_FIELD_NUMBER: builtins.int
...
global___SetWallThermalOptionRequest = SetWallThermalOptionRequest
...
class RotationProperties(google.protobuf.message.Message):
    ...
    WALL_THERMAL_PROPERTIES_FIELD_NUMBER: builtins.int
    @property
    def rotational_velocity(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    wall_thermal_option_enabled: builtins.bool = ...
    @property
    def wall_thermal_properties(self) -> global___WallThermalProperties: ...
    def __init__(self,
        *,
        rotational_velocity : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        wall_thermal_option_enabled : builtins.bool = ...,
        wall_thermal_properties : typing.Optional[global___WallThermalProperties] = ...,
        ) -> None: ...
...
class TranslationProperties(google.protobuf.message.Message):
    ...
    wall_thermal_option_enabled: builtins.bool = ...
    @property
    def translational_velocity(self) -> ansys.api.discovery.v1.commonmessages_pb2.QuantityVector: ...
    @property
    def wall_thermal_properties(self) -> global___WallThermalProperties: ...
    def __init__(self,
        *,
        wall_thermal_option_enabled : builtins.bool = ...,
        translational_velocity : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.QuantityVector] = ...,
        wall_thermal_properties : typing.Optional[global___WallThermalProperties] = ...,
        ) -> None: ...
...
class WallThermalProperties(google.protobuf.message.Message):
    ...
    wall_thermal_option: global___WallThermalOption.ValueType = ...
    @property
    def internal_emissivity(self) -> ansys.api.discovery.v1.commonmessages_pb2.OptionalQuantity: ...
    @property
    def external_temperature(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    @property
    def convection_coefficient(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    @property
    def heatflux(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    @property
    def heatflow(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    @property
    def temperature(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    @property
    def external_emissivity(self) -> ansys.api.discovery.v1.commonmessages_pb2.OptionalQuantity: ...
    def __init__(self,
        *,
        wall_thermal_option : global___WallThermalOption.ValueType = ...,
        internal_emissivity : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.OptionalQuantity] = ...,
        external_temperature : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        convection_coefficient : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        heatflux : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        heatflow : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        temperature : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        external_emissivity : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.OptionalQuantity] = ...,
        ) -> None: ...
...
class GetAllResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    WALL_FREE_SLIP_CONDITIONS_FIELD_NUMBER: builtins.int
    WALL_STATIONARY_CONDITIONS_FIELD_NUMBER: builtins.int
    WALL_ROTATION_CONDITIONS_FIELD_NUMBER: builtins.int
    WALL_TRANSLATION_CONDITIONS_FIELD_NUMBER: builtins.int
    SUCCESS_FIELD_NUMBER: builtins.int
    MESSAGE_FIELD_NUMBER: builtins.int
    @property
    def wall_free_slip_conditions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___WallFreeSlipDefinition]: ...
    @property
    def wall_stationary_conditions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___WallStationaryDefinition]: ...
    @property
    def wall_rotation_conditions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___WallRotationDefinition]: ...
    @property
    def wall_translation_conditions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___WallTranslationDefinition]: ...
    success: builtins.bool = ...
    message: typing.Text = ...
    def __init__(self,
        *,
        wall_free_slip_conditions : typing.Optional[typing.Iterable[global___WallFreeSlipDefinition]] = ...,
        wall_stationary_conditions : typing.Optional[typing.Iterable[global___WallStationaryDefinition]] = ...,
        wall_rotation_conditions : typing.Optional[typing.Iterable[global___WallRotationDefinition]] = ...,
        wall_translation_conditions : typing.Optional[typing.Iterable[global___WallTranslationDefinition]] = ...,
        success : builtins.bool = ...,
        message : typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["message",b"message","success",b"success","wall_free_slip_conditions",b"wall_free_slip_conditions","wall_rotation_conditions",b"wall_rotation_conditions","wall_stationary_conditions",b"wall_stationary_conditions","wall_translation_conditions",b"wall_translation_conditions"]) -> None: ...
