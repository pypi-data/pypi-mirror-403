...
class TemperatureDefinition(google.protobuf.message.Message):
    ...
    @property
    def magnitude(self) -> ansys.api.discovery.v1.commonmessages_pb2.Quantity: ...
    def __init__(self,
        *,
        ...
        suppressed : builtins.bool = ...,
        magnitude : typing.Optional[ansys.api.discovery.v1.commonmessages_pb2.Quantity] = ...,
        ) -> None: ...
...
class GetAllResponse(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor = ...
    TEMPERATURE_CONDITIONS_FIELD_NUMBER: builtins.int
    SUCCESS_FIELD_NUMBER: builtins.int
    MESSAGE_FIELD_NUMBER: builtins.int
    @property
    def temperature_conditions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___TemperatureDefinition]: ...
    success: builtins.bool = ...
    message: typing.Text = ...
    def __init__(self,
        *,
        temperature_conditions : typing.Optional[typing.Iterable[global___TemperatureDefinition]] = ...,
        success : builtins.bool = ...,
        message : typing.Text = ...,
        ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["message",b"message","success",b"success","temperature_conditions",b"temperature_conditions"]) -> None: ...
