...
class GetAllResponse(google.protobuf.message.Message):
    ...
    @property
    def conditions(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___AccelerationDefinition]: ...
    success: builtins.bool = ...
    message: typing.Text = ...
    def __init__(self,
        *,
        conditions : typing.Optional[typing.Iterable[global___AccelerationDefinition]] = ...,
        success : builtins.bool = ...,
        message : typing.Text = ...,
        ) -> None: ...
