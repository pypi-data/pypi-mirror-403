...
class GetMonitorValuesResponse(google.protobuf.message.Message):
    ...
    @property
    def monitor_values(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[ansys.api.discovery.v0.discoverymodels_pb2.Quantity]: ...
    def __init__(self,
        *,
        monitor_values : typing.Optional[typing.Iterable[ansys.api.discovery.v0.discoverymodels_pb2.Quantity]] = ...,
        ) -> None: ...
