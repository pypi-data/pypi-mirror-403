...
class KakaoService(PopbillBase):
    ...
    # 강조표기형 추가
    def sendATS( self, CorpNum, TemplateCode, Sender, Content, AltContent, AltSendType, SndDT, Receiver, ReceiverName, UserID=None, RequestNum=None, ButtonList=None, AltSubject=None, EmphasizeTitle=None):
        ...
        return self.sendATS_same( CorpNum, TemplateCode, Sender, "", "", AltSendType, SndDT, KakaoMessages, UserID, RequestNum, ButtonList, None, None)

    # 대체문자 제목 추가
    def sendATS_multi( self, CorpNum, TemplateCode, Sender, Content, AltContent, AltSendType, SndDT, KakaoMessages, UserID=None, RequestNum=None, ButtonList=None, AltSubject=None):
        return self.sendATS_same( CorpNum, TemplateCode, Sender, "", "", AltSendType, SndDT, KakaoMessages, UserID, RequestNum, ButtonList, AltSubject, None)

    # 강조표기형 추가
    def sendATS_same( self, CorpNum, TemplateCode, Sender, Content, AltContent, AltSendType, SndDT, KakaoMessages, UserID=None, RequestNum=None, ButtonList=None, AltSubject=None, EmphasizeTitle=None):
        ...
        if EmphasizeTitle is not None or EmphasizeTitle != "":
            req["emphasizeTitle"] = EmphasizeTitle
    ...
    def search(
        ...
        if PlusFriendID is not None and PlusFriendID != "":
            uri += "&PlusFriendID=" + parse.quote(PlusFriendID)
...
class KakaoReceiver(object):
    def __init__(self, **kwargs):
        self.__dict__ = dict.fromkeys(
            ["rcv", "rcvnm", "msg", "altsjt", "altmsg", "btns", "interOPRefKey","emphasizeTitle"]
        )
