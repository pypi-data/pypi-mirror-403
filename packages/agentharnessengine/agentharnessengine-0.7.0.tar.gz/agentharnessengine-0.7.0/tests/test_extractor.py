...
from governance.extractor import RuleBasedExtractor
...
class TestRuleBasedExtractor:
    ...
    def test_stagnation_control_loss_spike(self, extractor):
        """Test control loss spike after STAGNATION_STEPS."""
        obs = Observation(
