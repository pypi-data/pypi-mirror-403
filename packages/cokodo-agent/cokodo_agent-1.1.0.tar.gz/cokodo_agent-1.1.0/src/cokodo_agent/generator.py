...
""",
    ...
    recommendations = stack_recommendations.get(stack_key, """
## Recommended Tools
...
def _generate_adapters(target_path: Path, config: Dict[str, Any]) -> None:
    ...
    for tool_key in ai_tools:
        ...
        adapter_file = target_path / tool_info["file"]
...
"""
    ...
    project_rule.write_text("""# Project Context
...
""", encoding="utf-8")
    ...
    readme.write_text(f"""# Antigravity Rules for {project_name}
