...
- scrollIntoViewOptions (dict; optional):
    ...
    - block (a value equal to: 'center', 'end', 'start', 'nearest'; optional)

    - inline (a value equal to: 'center', 'end', 'start', 'nearest'; optional)

    - behavior (a value equal to: 'auto', 'instant', 'smooth'; optional)
...
- w (string | number | dict; optional):
    ...
    ScrollIntoViewOptions = TypedDict(
        "ScrollIntoViewOptions",
            {
            "block": NotRequired[Literal["center", "end", "start", "nearest"]],
            "inline": NotRequired[Literal["center", "end", "start", "nearest"]],
            "behavior": NotRequired[Literal["auto", "instant", "smooth"]]
        }
    )
    ...
    def __init__(
        ...
        minDepthToOffset: typing.Optional[NumberType] = None,
        depthOffset: typing.Optional[typing.Union[str, NumberType]] = None,
        radius: typing.Optional[typing.Union[str, NumberType]] = None,
        offset: typing.Optional[NumberType] = None,
        scrollIntoViewOptions: typing.Optional["ScrollIntoViewOptions"] = None,
        reinitialize: typing.Optional[bool] = None,
        ...
        **kwargs
        ...
        self._prop_names = ['id', 'aria-*', 'attributes', 'autoContrast', 'bd', 'bdrs', 'bg', 'bga', 'bgp', 'bgr', 'bgsz', 'bottom', 'c', 'className', 'classNames', 'color', 'darkHidden', 'data-*', 'depthOffset', 'display', 'ff', 'flex', 'fs', 'fw', 'fz', 'h', 'hiddenFrom', 'inset', 'left', 'lh', 'lightHidden', 'loading_state', 'lts', 'm', 'mah', 'maw', 'mb', 'me', 'mih', 'minDepthToOffset', 'miw', 'ml', 'mod', 'mr', 'ms', 'mt', 'mx', 'my', 'offset', 'opacity', 'p', 'pb', 'pe', 'pl', 'pos', 'pr', 'ps', 'pt', 'px', 'py', 'radius', 'reinitialize', 'right', 'scrollIntoViewOptions', 'selector', 'size', 'style', 'styles', 'ta', 'tabIndex', 'target_id', 'td', 'top', 'tt', 'unstyled', 'variant', 'visibleFrom', 'w']
...
setattr(TableOfContents, "__init__", _explicitize_args(TableOfContents.__init__))
