...
- withKeyboardEvents (boolean; optional):
    ...
    def __init__(
        ...
        controlsOffset: typing.Optional[typing.Union[str, NumberType]] = None,
        slideSize: typing.Optional[typing.Union[str, NumberType]] = None,
        slideGap: typing.Optional[typing.Union[str, NumberType, typing.Dict[str, typing.Any]]] = None,
        ...
        autoplay: typing.Optional[typing.Union[bool]] = None,
        autoScroll: typing.Optional[typing.Union[bool]] = None,
