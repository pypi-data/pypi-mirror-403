...
- withTableBorder (boolean; optional):
    ...
    def __init__(
        ...
        borderColor: typing.Optional[typing.Optional[str]] = None,
        ...
        striped: typing.Optional[typing.Union[bool, Literal["odd"], Literal["even"]]] = None,
        stripedColor: typing.Optional[typing.Optional[str]] = None,
        highlightOnHover: typing.Optional[bool] = None,
        highlightOnHoverColor: typing.Optional[typing.Optional[str]] = None,
