...
- w (string | number | dict; optional):
    ...
    def __init__(
        ...
        scrollbars: typing.Optional[typing.Union[bool, Literal["x"], Literal["y"], Literal["xy"]]] = None,
        offsetScrollbars: typing.Optional[typing.Union[bool, Literal["x"], Literal["y"], Literal["present"]]] = None,
        ...
        bga: typing.Optional[typing.Union[dict, Literal["scroll"], Literal["-moz-initial"], Literal["inherit"], Literal["initial"], Literal["revert"], Literal["revert-layer"], Literal["unset"], Literal["fixed"], Literal["local"]]] = None,
