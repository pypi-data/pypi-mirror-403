...
- w (string | number | dict; optional):
    ...
    def __init__(
        ...
        ta: typing.Optional[typing.Union[dict, Literal["right"], Literal["left"], Literal["end"], Literal["start"], Literal["-moz-initial"], Literal["inherit"], Literal["initial"], Literal["revert"], Literal["revert-layer"], Literal["unset"], Literal["center"], Literal["-webkit-match-parent"], Literal["justify"], Literal["match-parent"]]] = None,
