...
- wrap (dict; optional):
    ...
    def __init__(
        ...
        gap: typing.Optional[typing.Union[str, NumberType, dict]] = None,
        rowGap: typing.Optional[typing.Union[str, NumberType, dict]] = None,
        columnGap: typing.Optional[typing.Union[str, NumberType, dict]] = None,
        align: typing.Optional[typing.Union[dict, Literal["-moz-initial"], Literal["inherit"], Literal["initial"], Literal["revert"], Literal["revert-layer"], Literal["unset"], Literal["normal"], Literal["center"], Literal["end"], Literal["start"], Literal["flex-end"], Literal["flex-start"], Literal["self-end"], Literal["self-start"], Literal["baseline"], Literal["stretch"]]] = None,
        justify: typing.Optional[typing.Union[dict, Literal["left"], Literal["right"], Literal["-moz-initial"], Literal["inherit"], Literal["initial"], Literal["revert"], Literal["revert-layer"], Literal["unset"], Literal["normal"], Literal["center"], Literal["end"], Literal["start"], Literal["flex-end"], Literal["flex-start"], Literal["stretch"], Literal["space-around"], Literal["space-between"], Literal["space-evenly"]]] = None,
        wrap: typing.Optional[typing.Union[dict, Literal["-moz-initial"], Literal["inherit"], Literal["initial"], Literal["revert"], Literal["revert-layer"], Literal["unset"], Literal["nowrap"], Literal["wrap"], Literal["wrap-reverse"]]] = None,
        direction: typing.Optional[typing.Union[dict, Literal["-moz-initial"], Literal["inherit"], Literal["initial"], Literal["revert"], Literal["revert-layer"], Literal["unset"], Literal["column"], Literal["column-reverse"], Literal["row"], Literal["row-reverse"]]] = None,
