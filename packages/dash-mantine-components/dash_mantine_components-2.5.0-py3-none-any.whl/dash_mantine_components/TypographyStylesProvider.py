...
- w (string | number | dict; optional):
    ...
    def __init__(
        ...
        fw: typing.Optional[typing.Union[NumberType, dict, Literal["bold"], Literal["-moz-initial"], Literal["inherit"], Literal["initial"], Literal["revert"], Literal["revert-layer"], Literal["unset"], Literal["normal"], Literal["bolder"], Literal["lighter"]]] = None,
        ...
        bgr: typing.Optional[typing.Union[dict, Literal["repeat"], Literal["-moz-initial"], Literal["inherit"], Literal["initial"], Literal["revert"], Literal["revert-layer"], Literal["unset"], Literal["no-repeat"], Literal["repeat-x"], Literal["repeat-y"], Literal["round"], Literal["space"]]] = None,
        bga: typing.Optional[typing.Union[dict, Literal["local"], Literal["fixed"], Literal["-moz-initial"], Literal["inherit"], Literal["initial"], Literal["revert"], Literal["revert-layer"], Literal["unset"], Literal["scroll"]]] = None,
