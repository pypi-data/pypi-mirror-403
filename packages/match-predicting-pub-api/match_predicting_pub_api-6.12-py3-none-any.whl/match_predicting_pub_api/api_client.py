...
from match_predicting_pub_api.configuration import Configuration
from match_predicting_pub_api.api_response import ApiResponse
import match_predicting_pub_api.models
from match_predicting_pub_api import rest
from match_predicting_pub_api.exceptions import ApiValueError, ApiException
...
class ApiClient:
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None,
        ...
        self.user_agent = 'OpenAPI-Generator/6.12/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(match_predicting_pub_api.models, klass)
