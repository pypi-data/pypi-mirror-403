...
from match_predicting_pub_api.models.training_request_dto import TrainingRequestDTO  # noqa: E501

class TestTrainingRequestDTO(unittest.TestCase):
    """TrainingRequestDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrainingRequestDTO:
        """Test TrainingRequestDTO
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrainingRequestDTO`
        """
        model = TrainingRequestDTO()  # noqa: E501
        if include_optional:
    ...
    def testTrainingRequestDTO(self):
        """Test TrainingRequestDTO"""
