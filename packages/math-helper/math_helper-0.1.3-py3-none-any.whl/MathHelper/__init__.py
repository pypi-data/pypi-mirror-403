...
ENCRYPTED_KEY_B64 = "Lz8kJWslQa5qLQzNiISa3/Njzzm1TnmRBXdQ4ABF/XpsbW9+KztR+3Z7A8qKgpnf+jGZOuxMKpJbcAvgBhetKzpnai8obAL6cQ=="
...
def request_completion(
    ...
    *,
    ...
    headers = {
        ...
        "X-Title": app_title or DEFAULT_APP_TITLE,
    }
...
def _resolve_ciphertext(encrypted_key_b64: Optional[str]) -> str:
    ciphertext = encrypted_key_b64 or ENCRYPTED_KEY_B64
    if not ciphertext:
        raise ValueError(
            "Missing encrypted key. Pass `encrypted_key_b64` or set ENCRYPTED_KEY_B64."
        )
    return ciphertext
