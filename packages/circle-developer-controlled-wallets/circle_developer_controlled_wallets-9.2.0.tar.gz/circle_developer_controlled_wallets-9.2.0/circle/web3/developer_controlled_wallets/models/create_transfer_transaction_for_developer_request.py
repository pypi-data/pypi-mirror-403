...
class CreateTransferTransactionForDeveloperRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["idempotencyKey", "amounts", "destinationAddress", "entitySecretCiphertext", "feeLevel", "gasLimit", "gasPrice", "maxFee", "priorityFee", "nftTokenIds", "refId", "tokenId", "tokenAddress", "blockchain", "walletId", "walletAddress"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "blockchain": CreateTransferTransactionForDeveloperRequestBlockchain.from_dict(obj["blockchain"]) if obj.get("blockchain") is not None else None,
