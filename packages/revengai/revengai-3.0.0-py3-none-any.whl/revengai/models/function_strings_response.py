...
class FunctionStringsResponse(BaseModel):
    """
    Response for listing all the strings of a function.
    """ # noqa: E501
    strings: List[FunctionString] = Field(description="The strings associated with this function")
    total_strings: StrictInt = Field(description="The total number of strings associated with this function")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "strings": [FunctionString.from_dict(_item) for _item in obj["strings"]] if obj.get("strings") is not None else None,
