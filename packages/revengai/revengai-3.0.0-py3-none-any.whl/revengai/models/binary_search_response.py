...
class BinarySearchResponse(BaseModel):
    ...
    """ # noqa: E501
    results: List[BinarySearchResult] = Field(description="The results of the search")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [BinarySearchResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
