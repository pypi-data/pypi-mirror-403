...
class BaseResponseChildBinariesResponse(BaseModel):
    """
    ...
    data: Optional[ChildBinariesResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": ChildBinariesResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
