...
class BaseResponseCalleesCallerFunctionsResponse(BaseModel):
    """
    ...
    data: Optional[CalleesCallerFunctionsResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": CalleesCallerFunctionsResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
