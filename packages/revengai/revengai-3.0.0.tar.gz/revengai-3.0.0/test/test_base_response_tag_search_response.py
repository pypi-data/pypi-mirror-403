...
class TestBaseResponseTagSearchResponse(unittest.TestCase):
    """BaseResponseTagSearchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseResponseTagSearchResponse:
        """Test BaseResponseTagSearchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseResponseTagSearchResponse`
        """
    ...
    def testBaseResponseTagSearchResponse(self):
        """Test BaseResponseTagSearchResponse"""
