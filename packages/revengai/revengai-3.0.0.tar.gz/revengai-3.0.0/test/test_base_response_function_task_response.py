...
class TestBaseResponseFunctionTaskResponse(unittest.TestCase):
    """BaseResponseFunctionTaskResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseResponseFunctionTaskResponse:
        """Test BaseResponseFunctionTaskResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseResponseFunctionTaskResponse`
        """
    ...
    def testBaseResponseFunctionTaskResponse(self):
        """Test BaseResponseFunctionTaskResponse"""
