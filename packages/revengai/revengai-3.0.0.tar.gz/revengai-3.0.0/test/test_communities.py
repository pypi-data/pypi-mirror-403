...
class TestCommunities(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Communities:
        """Test Communities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Communities`
        """
        model = Communities()
        if include_optional:
            return Communities(
