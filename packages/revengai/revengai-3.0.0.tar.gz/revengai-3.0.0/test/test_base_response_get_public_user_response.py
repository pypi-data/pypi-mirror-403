...
class TestBaseResponseGetPublicUserResponse(unittest.TestCase):
    """BaseResponseGetPublicUserResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseResponseGetPublicUserResponse:
        """Test BaseResponseGetPublicUserResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseResponseGetPublicUserResponse`
        """
    ...
    def testBaseResponseGetPublicUserResponse(self):
        """Test BaseResponseGetPublicUserResponse"""
