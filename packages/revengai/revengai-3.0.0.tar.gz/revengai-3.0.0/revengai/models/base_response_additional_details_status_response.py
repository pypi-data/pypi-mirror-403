...
class BaseResponseAdditionalDetailsStatusResponse(BaseModel):
    """
    ...
    data: Optional[AdditionalDetailsStatusResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": AdditionalDetailsStatusResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
