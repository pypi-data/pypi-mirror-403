...
class BaseResponseListDieMatch(BaseModel):
    """
    ...
    data: Optional[List[DieMatch]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": [DieMatch.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
