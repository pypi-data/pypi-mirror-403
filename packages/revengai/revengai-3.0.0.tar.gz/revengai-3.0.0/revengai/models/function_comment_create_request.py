...
class FunctionCommentCreateRequest(BaseModel):
    """
    FunctionCommentCreateRequest
    """ # noqa: E501
    content: StrictStr = Field(description="Comment text content")
    context: Optional[DecompilationCommentContext] = Field(default=None, description="Comment context for a function decompilation")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "context": DecompilationCommentContext.from_dict(obj["context"]) if obj.get("context") is not None else None
        })
        return _obj
