...
class NetworkOverviewResponse(BaseModel):
    ...
    """ # noqa: E501
    dns: List[NetworkOverviewDns]
    metadata: List[NetworkOverviewMetadata]
    __properties: ClassVar[List[str]] = ["dns", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dns": [NetworkOverviewDns.from_dict(_item) for _item in obj["dns"]] if obj.get("dns") is not None else None,
            "metadata": [NetworkOverviewMetadata.from_dict(_item) for _item in obj["metadata"]] if obj.get("metadata") is not None else None
        })
        return _obj
