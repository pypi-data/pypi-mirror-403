...
class BaseResponseFunctionTaskResponse(BaseModel):
    """
    ...
    data: Optional[FunctionTaskResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": FunctionTaskResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
