...
class BaseResponseAnalysisFunctionsList(BaseModel):
    """
    ...
    data: Optional[AnalysisFunctionsList] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": AnalysisFunctionsList.from_dict(obj["data"]) if obj.get("data") is not None else None,
