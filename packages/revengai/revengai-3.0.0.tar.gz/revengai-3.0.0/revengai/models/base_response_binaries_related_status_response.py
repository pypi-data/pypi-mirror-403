...
class BaseResponseBinariesRelatedStatusResponse(BaseModel):
    """
    ...
    data: Optional[BinariesRelatedStatusResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "data": BinariesRelatedStatusResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
