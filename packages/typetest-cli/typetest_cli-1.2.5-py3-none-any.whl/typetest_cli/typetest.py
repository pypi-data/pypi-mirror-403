...
MAX_SUBSEQUENT_ERRORS: Final[int] = 3
...
def main() -> None:
    parser = argparse.ArgumentParser(
        ...
        epilog="Will display typing speed and accuracy upon completion of the text.",
    )
    ...
    parser.add_argument(
        ...
        "-n",
        action="store_false",
        help="Do not block input after 3 failed attempts",
    )
