...
def checkEqualityDb(
    ...
    return checkEqualityVectors(
        db[name1], db[name2], tolerance, flagRelative, flagAbsolute, message
    )


def checkEqualityValues(
    vec1,
    vec2,
    tolerance=gl.EPSILON6,
    flagRelative=True,
