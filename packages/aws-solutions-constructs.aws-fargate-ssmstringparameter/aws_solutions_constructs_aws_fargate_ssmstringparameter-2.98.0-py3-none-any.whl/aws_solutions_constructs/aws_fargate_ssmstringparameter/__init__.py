...
class FargateToSsmstringparameter(
    ...
    def __init__(
        ...
        *,
        ...
        :param existing_vpc: An existing VPC in which to deploy the construct. Providing both this and vpcProps causes an error. If the client provides an existing Fargate service, this value must be the VPC where the service is running. An SSM Interface endpoint will be added to this VPC. Default: - none
        ...
        :param vpc_props: Optional custom properties for a VPC the construct will create. This VPC will be used by the new Fargate service the construct creates (that's why targetGroupProps can't include a VPC). Providing both this and existingVpc causes an error. An SSM Interface endpoint will be included in this VPC. Default: - none
        '''
        if __debug__:
...
class FargateToSsmstringparameterProps:
    ...
    def vpc_props(self) -> typing.Optional[_aws_cdk_aws_ec2_ceddda9d.VpcProps]:
        ...
        both this and existingVpc causes an error. An SSM Interface
