...
from ast import Add,Sub,Mult,Div,Mod,Pow
from ast import LShift,RShift,BitOr,BitXor,BitAnd,FloorDiv
from ast import Eq,NotEq,Lt,LtE,Gt,GtE,Is,IsNot,In,NotIn,If
from ast import And,Or,Invert,Not,UAdd,USub
