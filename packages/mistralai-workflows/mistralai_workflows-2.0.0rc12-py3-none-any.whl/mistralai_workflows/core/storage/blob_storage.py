...
from mistralai_workflows.core.config.config import BlobStorageConfig
from mistralai_workflows.core.storage.blob_storage_impl import BlobStorage, blob_storage_factory
...
async def get_blob_storage(blob_storage_config: BlobStorageConfig) -> AsyncGenerator[BlobStorage, None]:
    ...
    if blob_storage_config.storage_provider.value == "azure":
        ...
        aws_access_key = (
            blob_storage_config.aws_access_key_id.get_secret_value() if blob_storage_config.aws_access_key_id else None
        )
        aws_secret_key = (
