...
class Font:
    ...
    def color(self) -> Optional[str]:
        ...
        Can be set with a hex string:
            font.color = "FF0000"
            font.color = "#00FF00"  # Leading # is stripped

        For python-pptx style access, use font.color_format:
            font.color_format.rgb = RGBColor(255, 0, 0)
        """
    ...
    @property
    def color_format(self) -> _FontColorFormat:
        """
        Font color as a ColorFormat object (python-pptx style).

        Use font.color_format.rgb = RGBColor(r, g, b) to set the color.
        """
