...
class ContractDeploymentRequest(BaseModel):
    ...
    abi_json: StrictStr = Field(description="The contract's ABI in a JSON stringified format.", alias="abiJson")
    ...
    __properties: ClassVar[List[str]] = ["idempotencyKey", "name", "description", "walletId", "abiJson", "bytecode", "entitySecretCiphertext", "blockchain", "constructorParameters", "feeLevel", "gasLimit", "gasPrice", "maxFee", "priorityFee", "refId"]
