...
class AbiParametersInner(BaseModel):
    ...
    anyof_schema_4_validator: Optional[List[Any]] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[List[object], bool, int, str]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "List[object]", "bool", "int", "str" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = AbiParametersInner.model_construct()
        error_messages = []
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], List[object], bool, int, str]]:
