...
PyCBC, MBTA, CWB, and Mly) upload candidates in real time to GraceDB, the
central database and web portal for low-latency LIGO/Virgo analyses. Whenever
an event is uploaded or altered, GraceDB pushes machine-readable notifications
through :doc:`IGWN Alert <igwn-alert:index>`, a pubsub system based on Kafka_.
...
7.  **External Trigger Worker**
    ...
    from GRB alerts received from Fermi, Swift, SVOM and
