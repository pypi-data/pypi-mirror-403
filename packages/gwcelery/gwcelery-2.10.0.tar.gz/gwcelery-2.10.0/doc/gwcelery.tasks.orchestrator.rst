...
* :meth:`~gwcelery.tasks.orchestrator.handle_match_filter_cbc_event` is called for each CBC
...
.. digraph:: earlywarning_preliminary_alert
    ...
    subgraph cluster_handle_match_filter_cbc_event {
        href = "../gwcelery.tasks.orchestrator.html#gwcelery.tasks.orchestrator.handle_match_filter_cbc_event"
        label = <<B><FONT face="monospace">handle_match_filter_cbc_event</FONT></B>>
    ...
    cbc_event -> which_file [lhead = cluster_handle_match_filter_cbc_event]
