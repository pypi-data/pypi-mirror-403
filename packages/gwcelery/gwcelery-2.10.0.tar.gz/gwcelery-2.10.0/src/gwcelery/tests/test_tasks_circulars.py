...
def test_create_emcoinc_circular(monkeypatch):
    ...
    mock_compose_emcoinc_circular.assert_called_once_with(
        'S1234', gw_is_subthreshold=False, client=gracedb.client,
        remove_text_wrap=True)
