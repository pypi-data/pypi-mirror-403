...
class ZeroLengthResponse(Exception):
    """Exception for zero length responses.

    GraceDB does not accept zero-length uploads, but sometimes appears to
    send zero-length content when downloading files.
