...
@pytest.mark.parametrize('error', [20., 10., 3.])
def test_create_offset_external_skymap(error):
    """Test designed to validate the creation of offset sky maps."""
    skymap = external_skymaps.create_offset_external_skymap(
                 0, 90, error, 'Fermi',
                 notice_type=gcn.NoticeType.FERMI_GBM_FLT_POS)
