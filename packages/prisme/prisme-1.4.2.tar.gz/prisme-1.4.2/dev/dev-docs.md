...
- **Version**: 1.1.1
- **Generators**: 23 classes (9 backend, 10 frontend, 2 testing, 2 base/support)
- **CLI Commands**: 64+ across 15 command groups
- **Tests**: 721+ test functions in 58 files
- **Templates**: 220+ Jinja2 templates
- **GitHub Issues**: 11 open, 40 closed
- **Open PRs**: 0
- **Plans**: 7 feature plans in `plans/`
...
├── plans/           # Implementation plans for features (7 plans)
│   ├── index.md
