...
class LimitMessageLength(logging.Filter):
    ...
    def filter(self, record: logging.LogRecord) -> bool:
        if (msg := getattr(record, "msg", None)) and isinstance(msg, str) and len(msg) > self.length:
...
def setup_logging(handler_dict: dict | None = None, disable_stream_handler: bool = False):
