...
set_target_properties(CURL::libcurl_shared PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libcurl.so.4.8.0"
  IMPORTED_SONAME_RELEASE "libcurl.so.4"
  )

list(APPEND _cmake_import_check_targets CURL::libcurl_shared )
list(APPEND _cmake_import_check_files_for_CURL::libcurl_shared "${_IMPORT_PREFIX}/lib64/libcurl.so.4.8.0" )
