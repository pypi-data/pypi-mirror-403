...
class Notification(BaseModel):
    ...
    def name_validate_enum(cls, value):
        ...
        if value not in ('ORDER_CREATED_SELLER', 'ORDER_CREATED_BUYER', 'ORDER_ACCEPTED', 'ORDER_SENT_BUYER', 'ORDER_RECEIVED', 'ORDER_ARCHIVED_BUYER', 'ORDER_VALIDATED_SELLER', 'ORDER_VALIDATED_BUYER', 'ORDER_CANCELED_BUYER', 'AD_ARCHIVED', 'AD_ARCHIVED_BY_ADMIN', 'AD_VALIDATED', 'AD_EXPIRED', 'AD_MANIFESTATION_INTERET', 'AD_SOLD_OUT', 'AD_PRICE_UPDATE_REFUSED', 'AD_PRICE_UPDATE_ACCEPTED', 'AD_WISHLIST_LINE', 'ORDER_ACCEPTATION_DELAY', 'ORDER_SENDING_DELAY', 'CLIENT_SUBSCRIPTION_STEP_4_VALIDATED', 'CLIENT_SUBSCRIPTION_VALIDATED', 'CLIENT_TEST_ACCOUNT_EXPIRED', 'CLIENT_KYC_LIMITED', 'CLIENT_CREDIT_CARD_EXPIRATION', 'CLIENT_FIRST_SALE', 'CLIENT_FIRST_BUY', 'CLIENT_FIRST_AD', 'DAILY_MAIL', 'AD_DAILY_MAIL', 'ORDER_DAILY_MAIL', 'ORDER_TWICE_DAILY_MAIL', 'CLIENT_HAS_A_REQUEST', 'DOCUMENT_EXPIRE', 'GLOBAL_COMMISSION_INVOICE', 'PHARMAIDE_FIRST_SUBSCRIPTION', 'PHARMAIDE_TEST_TEST_EXPIRATION', 'PHARMAIDE_SB_TEST_EXPIRATION'):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.notification_sendings:
            for _item in self.notification_sendings:
                if _item:
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "notificationSendings": [NotificationSending.from_dict(_item) for _item in obj.get("notificationSendings")] if obj.get("notificationSendings") is not None else None
        })
        return _obj
