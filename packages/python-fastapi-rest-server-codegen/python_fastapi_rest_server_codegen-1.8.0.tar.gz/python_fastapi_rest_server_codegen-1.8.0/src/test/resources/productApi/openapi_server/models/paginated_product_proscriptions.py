...
class PaginatedProductProscriptions(BaseModel):
    """
    PaginatedProductProscriptions
    """ # noqa: E501
    metadata: PagingMetadata
    records: List[ProductProscription]
    __properties: ClassVar[List[str]] = ["metadata", "records"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "metadata": PagingMetadata.from_dict(obj.get("metadata")) if obj.get("metadata") is not None else None,
            "records": [ProductProscription.from_dict(_item) for _item in obj.get("records")] if obj.get("records") is not None else None
        })
        return _obj
