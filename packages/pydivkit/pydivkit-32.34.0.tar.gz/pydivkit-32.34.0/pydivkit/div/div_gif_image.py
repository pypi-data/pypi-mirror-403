...
class DivGifImage(BaseDiv):
    ...
    def __init__(
        ...
        preview_url: typing.Optional[typing.Union[Expr, str]] = None,
    ...
    preview_url: typing.Optional[typing.Union[Expr, str]] = Field(
        format="uri", 
        description=(
            "Direct URL to an image for loading preview. When both "
            "`preview` and `preview_url`are used, `preview` will be "
            "used."
        ),
    )
