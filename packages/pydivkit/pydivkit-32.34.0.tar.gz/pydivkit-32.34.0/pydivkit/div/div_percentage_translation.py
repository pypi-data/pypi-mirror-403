...
# size.
class DivPercentageTranslation(BaseDiv):

    def __init__(
        self, *,
        type: str = "translation-percentage",
    ...
    type: str = Field(default="translation-percentage")
    value: typing.Union[Expr, float] = Field(
        description="Coordinate value as a percentage.",
    )


DivPercentageTranslation.update_forward_refs()
