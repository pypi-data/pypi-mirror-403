...
class TestEye(object):
    ...
    def test_load_file(self, mocker, qtbot, qapp, spectral_filenames,
        ...
        qtbot.keyClick(app.view.loaded_files_table,
                       PyQt6.QtCore.Qt.Key.Key_Return)
    ...
    def test_change_limits(self, loaded_eye, qtbot):
        ...
        for widget, value in widgets:
            with qtbot.wait_signals(signals):
                qtbot.mouseClick(widget, PyQt6.QtCore.Qt.MouseButton.LeftButton)
    ...
    @pytest.mark.parametrize(
        ...
        [(PyQt6.QtCore.Qt.Key.Key_X, 'x_zoom', [1 / 4, 3 / 4], [1 / 2, 1 / 2],
          [0], [1], 1),
         (PyQt6.QtCore.Qt.Key.Key_Y, 'y_zoom', [1 / 2, 1 / 2], [1 / 4, 3 / 4],
          [1], [0], 1),
         (PyQt6.QtCore.Qt.Key.Key_Z, 'b_zoom', [1 / 4, 3 / 4], [1 / 4, 3 / 4],
          [0, 1], [], 2)])
    ...
    def test_fit(self, loaded_eye, qtbot, caplog, mocker,
        ...
        qtbot.keyClick(loaded_eye.view.figure_widget, PyQt6.QtCore.Qt.Key.Key_F)
