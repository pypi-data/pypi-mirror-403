...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.last_fit_frame = QtWidgets.QWidget(parent=self.splitter)
        ...
        self.last_fit_values = QtWidgets.QTextEdit(parent=self.last_fit_frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.last_fit_values.setTextInteractionFlags(QtCore.Qt.TextInteractionFlag.TextSelectableByKeyboard|QtCore.Qt.TextInteractionFlag.TextSelectableByMouse)
        self.last_fit_values.setObjectName("last_fit_values")
        self.gridLayout_2.addWidget(self.last_fit_values, 1, 1, 1, 1)
        self.last_fit_widget = MplWidget(parent=self.last_fit_frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.table_frame = QtWidgets.QFrame(parent=self.splitter)
        self.table_frame.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        ...
        self.table_widget = QtWidgets.QTableWidget(parent=self.table_frame)
        ...
        self.table_widget.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.table_widget.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        ...
        self.clear_button = QtWidgets.QPushButton(parent=Dialog)
