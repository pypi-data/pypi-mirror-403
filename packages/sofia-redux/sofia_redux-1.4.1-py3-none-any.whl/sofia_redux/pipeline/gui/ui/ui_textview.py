...
class Ui_TextWindow(object):
    def setupUi(self, TextWindow):
        ...
        self.findText = QtWidgets.QLineEdit(parent=TextWindow)
        self.findText.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        self.findText.setObjectName("findText")
        self.horizontalLayout.addWidget(self.findText)
        self.findButton = QtWidgets.QPushButton(parent=TextWindow)
        self.findButton.setFocusPolicy(QtCore.Qt.FocusPolicy.ClickFocus)
        self.findButton.setObjectName("findButton")
        self.horizontalLayout.addWidget(self.findButton)
        self.filterButton = QtWidgets.QPushButton(parent=TextWindow)
        self.filterButton.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        self.filterButton.setObjectName("filterButton")
        self.horizontalLayout.addWidget(self.filterButton)
        self.tableButton = QtWidgets.QPushButton(parent=TextWindow)
        self.tableButton.setFocusPolicy(QtCore.Qt.FocusPolicy.StrongFocus)
        self.tableButton.setObjectName("tableButton")
        self.horizontalLayout.addWidget(self.tableButton)
        self.saveButton = QtWidgets.QPushButton(parent=TextWindow)
        ...
        self.textEdit = QtWidgets.QTextEdit(parent=TextWindow)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Expanding)
        sizePolicy.setHorizontalStretch(1)
        sizePolicy.setVerticalStretch(1)
