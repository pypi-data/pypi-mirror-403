...
class RelationNodeVector(google.protobuf.message.Message):
    ...
    NODE_VALUE_FIELD_NUMBER: builtins.int
    VECTOR_FIELD_NUMBER: builtins.int
    node_value: builtins.str
    @property
    def vector(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.float]: ...
    def __init__(
        self,
    ...
    def ClearField(self, field_name: typing.Literal["node_value", b"node_value", "vector", b"vector"]) -> None: ...
...
class RelationEdgeVector(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["relation_label", b"relation_label", "vector", b"vector"]) -> None: ...

global___RelationEdgeVector = RelationEdgeVector

@typing.final
class RelationNodeVectors(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    VECTORS_FIELD_NUMBER: builtins.int
    @property
    def vectors(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___RelationNodeVector]: ...
    def __init__(
        self,
        *,
        vectors: collections.abc.Iterable[global___RelationNodeVector] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["vectors", b"vectors"]) -> None: ...

global___RelationNodeVectors = RelationNodeVectors

@typing.final
class RelationEdgeVectors(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    VECTORS_FIELD_NUMBER: builtins.int
    @property
    def vectors(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___RelationEdgeVector]: ...
    def __init__(
        self,
        *,
        vectors: collections.abc.Iterable[global___RelationEdgeVector] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["vectors", b"vectors"]) -> None: ...

global___RelationEdgeVectors = RelationEdgeVectors
