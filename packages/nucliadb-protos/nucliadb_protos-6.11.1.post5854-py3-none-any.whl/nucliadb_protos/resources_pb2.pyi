...
class SyncMetadata(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["auth_provider", b"auth_provider", "content_hash", b"content_hash", "file_id", b"file_id"]) -> None: ...
...
@typing.final
class SemanticGraphVectors(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    FIELD_FIELD_NUMBER: builtins.int
    VECTORSET_ID_FIELD_NUMBER: builtins.int
    NODE_VECTORS_FIELD_NUMBER: builtins.int
    NODE_FILE_FIELD_NUMBER: builtins.int
    EDGE_VECTORS_FIELD_NUMBER: builtins.int
    EDGE_FILE_FIELD_NUMBER: builtins.int
    vectorset_id: builtins.str
    @property
    def field(self) -> global___FieldID: ...
    @property
    def node_vectors(self) -> nucliadb_protos.utils_pb2.RelationNodeVectors: ...
    @property
    def node_file(self) -> global___CloudFile: ...
    @property
    def edge_vectors(self) -> nucliadb_protos.utils_pb2.RelationEdgeVectors: ...
    @property
    def edge_file(self) -> global___CloudFile: ...
    def __init__(
        self,
        *,
        field: global___FieldID | None = ...,
        vectorset_id: builtins.str = ...,
        node_vectors: nucliadb_protos.utils_pb2.RelationNodeVectors | None = ...,
        node_file: global___CloudFile | None = ...,
        edge_vectors: nucliadb_protos.utils_pb2.RelationEdgeVectors | None = ...,
        edge_file: global___CloudFile | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["edge_data", b"edge_data", "edge_file", b"edge_file", "edge_vectors", b"edge_vectors", "field", b"field", "node_data", b"node_data", "node_file", b"node_file", "node_vectors", b"node_vectors"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["edge_data", b"edge_data", "edge_file", b"edge_file", "edge_vectors", b"edge_vectors", "field", b"field", "node_data", b"node_data", "node_file", b"node_file", "node_vectors", b"node_vectors", "vectorset_id", b"vectorset_id"]) -> None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["edge_data", b"edge_data"]) -> typing.Literal["edge_vectors", "edge_file"] | None: ...
    @typing.overload
    def WhichOneof(self, oneof_group: typing.Literal["node_data", b"node_data"]) -> typing.Literal["node_vectors", "node_file"] | None: ...

global___SemanticGraphVectors = SemanticGraphVectors
