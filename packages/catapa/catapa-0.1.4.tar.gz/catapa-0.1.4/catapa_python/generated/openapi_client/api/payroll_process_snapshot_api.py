...
class PayrollProcessSnapshotApi:
    ...
    def find_payroll_process_snapshots(
        ...
        query: Annotated[Optional[StrictStr], Field(description="### Search query   | Supported Keys | Supported Operators | Notes                                             | |----------------|---------------------|---------------------------------------------------| | effectiveDate  | `<` `>`             | Greater than or equal to<br>Less than or equal to | | process        | `:`                 | Equal to                                          | | employeeId     | `:`                 | Equal to                                          | ")] = None,
        ...
        :type size: int
        :param query: ### Search query   | Supported Keys | Supported Operators | Notes                                             | |----------------|---------------------|---------------------------------------------------| | effectiveDate  | `<` `>`             | Greater than or equal to<br>Less than or equal to | | process        | `:`                 | Equal to                                          | | employeeId     | `:`                 | Equal to                                          | 
        :type query: str
        ...
        _param = self._find_payroll_process_snapshots_serialize(
            page=page,
            size=size,
            query=query,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PayrollProcessSnapshotPageResponse",
            '400': None,
        }
    ...
    @validate_call
    def find_payroll_process_snapshots_with_http_info(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Page number")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Page size")] = None,
        query: Annotated[Optional[StrictStr], Field(description="### Search query   | Supported Keys | Supported Operators | Notes                                             | |----------------|---------------------|---------------------------------------------------| | effectiveDate  | `<` `>`             | Greater than or equal to<br>Less than or equal to | | process        | `:`                 | Equal to                                          | | employeeId     | `:`                 | Equal to                                          | ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PayrollProcessSnapshotPageResponse]:
        """Find all payroll process snapshots
    ...
    @validate_call
    def find_payroll_process_snapshots_without_preload_content(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Page number")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Page size")] = None,
        query: Annotated[Optional[StrictStr], Field(description="### Search query   | Supported Keys | Supported Operators | Notes                                             | |----------------|---------------------|---------------------------------------------------| | effectiveDate  | `<` `>`             | Greater than or equal to<br>Less than or equal to | | process        | `:`                 | Equal to                                          | | employeeId     | `:`                 | Equal to                                          | ")] = None,
    ...
    def _find_payroll_process_snapshots_serialize(
        self,
        page,
        size,
        query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/payroll-process-snapshots',
