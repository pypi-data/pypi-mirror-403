...
class SalaryCalculationApi:
    ...
    def get_salary_calculation(
        ...
        _param = self._get_salary_calculation_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SalaryCalculationPageResponse",
            '400': None,
        }
    ...
    @validate_call
    def get_salary_calculation_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SalaryCalculationPageResponse]:
        """Get Salary Calculation
    ...
    @validate_call
    def get_salary_calculation_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_salary_calculation_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/salary-calculations',
    ...
    @validate_call
    def get_salary_calculation_details(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._get_salary_calculation_details_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SalaryCalculationDetailPageResponse",
            '400': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_salary_calculation_details_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SalaryCalculationDetailPageResponse]:
        """Get Salary Calculation Details
    ...
    @validate_call
    def get_salary_calculation_details_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_salary_calculation_details_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/salary-calculations/details',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_time_allowance_details_by_salary_calculation_detail(
        ...
        _param = self._get_time_allowance_details_by_salary_calculation_detail_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TimeAllowanceDetailsResponse",
            '400': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_time_allowance_details_by_salary_calculation_detail_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TimeAllowanceDetailsResponse]:
        """Get Time Allowance Details By Salary Calculation Detail
    ...
    @validate_call
    def get_time_allowance_details_by_salary_calculation_detail_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_time_allowance_details_by_salary_calculation_detail_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/salary-calculations/details/{id}/time-allowance-details',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_salary_calculation_detail(
        ...
        id: StrictStr,
        code: StrictStr,
        amount_request: Optional[AmountRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param code: (required)
        :type code: str
        :param amount_request:
        :type amount_request: AmountRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_salary_calculation_detail_serialize(
            id=id,
            code=code,
    ...
    @validate_call
    def update_salary_calculation_detail_with_http_info(
        self,
        id: StrictStr,
        code: StrictStr,
        amount_request: Optional[AmountRequest] = None,
    ...
    @validate_call
    def update_salary_calculation_detail_without_preload_content(
        self,
        id: StrictStr,
        code: StrictStr,
        amount_request: Optional[AmountRequest] = None,
    ...
    def _update_salary_calculation_detail_serialize(
        self,
        id,
        code,
        amount_request,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/core/v1/salary-calculations/{id}/details/salaryItemCode={code}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
