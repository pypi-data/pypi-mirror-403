...
class CompanySuperiorResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "code", "website", "siup", "tdp", "logo", "logoOriginalFilename", "logoFileMetadata", "timeZone", "email", "location"]
