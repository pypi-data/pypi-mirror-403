...
class SalaryPaymentEmployeeResponse(BaseModel):
    """
    ...
    employment_status: Optional[SalaryPaymentEmploymentStatusResponse] = Field(default=None, alias="employmentStatus")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "employmentStatus": SalaryPaymentEmploymentStatusResponse.from_dict(obj["employmentStatus"]) if obj.get("employmentStatus") is not None else None
        })
        return _obj
