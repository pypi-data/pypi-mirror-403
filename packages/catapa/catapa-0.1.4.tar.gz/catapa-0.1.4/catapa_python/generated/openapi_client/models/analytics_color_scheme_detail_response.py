...
class AnalyticsColorSchemeDetailResponse(BaseModel):
    """
    AnalyticsColorSchemeDetailResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    hex_color: Optional[StrictStr] = Field(default=None, alias="hexColor")
    sequence: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["id", "hexColor", "sequence"]
