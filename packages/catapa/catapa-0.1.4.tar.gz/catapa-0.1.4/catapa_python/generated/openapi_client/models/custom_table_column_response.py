...
class CustomTableColumnResponse(BaseModel):
    """
    CustomTableColumnResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the column")
    column_name: Optional[StrictStr] = Field(default=None, description="Technical name of the column", alias="columnName")
    field_name: Optional[StrictStr] = Field(default=None, description="CamelCase version of columnName", alias="fieldName")
    display_name: Optional[StrictStr] = Field(default=None, description="Display name of the column", alias="displayName")
    field_order: Optional[StrictInt] = Field(default=None, description="Order of the field in the table", alias="fieldOrder")
    data_type: Optional[StrictStr] = Field(default=None, description="Data type of the column", alias="dataType")
    is_required: Optional[StrictBool] = Field(default=None, description="Whether the column is required", alias="isRequired")
    is_reference: Optional[StrictBool] = Field(default=None, description="Whether the column is a reference to another entity", alias="isReference")
    column_metadata: Optional[Dict[str, Any]] = Field(default=None, description="Additional metadata for the column", alias="columnMetadata")
    tooltip: Optional[StrictStr] = Field(default=None, description="Optional custom tooltip to be shown to the user")
    __properties: ClassVar[List[str]] = ["id", "columnName", "fieldName", "displayName", "fieldOrder", "dataType", "isRequired", "isReference", "columnMetadata", "tooltip"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if column_metadata (nullable) is None
        # and model_fields_set contains the field
        if self.column_metadata is None and "column_metadata" in self.model_fields_set:
            _dict['columnMetadata'] = None
