...
class FormerEmployeeIncomePageResponse(BaseModel):
    """
    ...
    content: Optional[List[FormerEmployeeIncomeResponse]] = Field(default=None, description="List of former employee incomes")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": [FormerEmployeeIncomeResponse.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None
        })
        return _obj
