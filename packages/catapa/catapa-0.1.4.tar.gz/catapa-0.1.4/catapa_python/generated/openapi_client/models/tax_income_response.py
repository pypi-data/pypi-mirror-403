...
class TaxIncomeResponse(BaseModel):
    """
    TaxIncomeResponse
    """ # noqa: E501
    ...
    irregular_bonus: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="irregularBonus")
    bonus_allowance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="bonusAllowance")
    ...
    irregular_other_allowance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="irregularOtherAllowance")
    retirement_contribution: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="retirementContribution")
    religion_allowance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="religionAllowance")
    __properties: ClassVar[List[str]] = ["basicSalary", "taxAllowance", "bonus", "irregularBonus", "bonusAllowance", "honorarium", "insurancePremium", "enjoymentRevenue", "otherAllowance", "irregularOtherAllowance", "retirementContribution", "religionAllowance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bonus": obj.get("bonus"),
            "irregularBonus": obj.get("irregularBonus"),
            "bonusAllowance": obj.get("bonusAllowance"),
            ...
            "irregularOtherAllowance": obj.get("irregularOtherAllowance"),
            "retirementContribution": obj.get("retirementContribution"),
            "religionAllowance": obj.get("religionAllowance")
        })
        return _obj
