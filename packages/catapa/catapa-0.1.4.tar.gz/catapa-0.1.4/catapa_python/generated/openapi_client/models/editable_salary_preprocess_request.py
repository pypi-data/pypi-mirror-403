...
class EditableSalaryPreprocessRequest(BaseModel):
    """
    EditableSalaryPreprocessRequest
    """ # noqa: E501
    employee_identification_number: Optional[StrictStr] = Field(default=None, description="Employee identification number", alias="employeeIdentificationNumber")
    salary_item_code: Optional[StrictStr] = Field(default=None, description="Salary item code", alias="salaryItemCode")
    ...
    __properties: ClassVar[List[str]] = ["employeeIdentificationNumber", "salaryItemCode", "amount", "period", "year"]
