...
class FormerEmployeeIncomeResponse(BaseModel):
    """
    FormerEmployeeIncomeResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Former employee income ID")
    item_name: Optional[StrictStr] = Field(default=None, description="Income item name", alias="itemName")
    item_type: Optional[StrictStr] = Field(default=None, description="Income item type", alias="itemType")
    reference_date: Optional[date] = Field(default=None, description="Reference date", alias="referenceDate")
    pph21_method: Optional[StrictStr] = Field(default=None, description="PPH21 calculation method", alias="pph21Method")
    minimum_last_working_date: Optional[date] = Field(default=None, description="Minimum last working date", alias="minimumLastWorkingDate")
    proportional_method: Optional[StrictStr] = Field(default=None, description="Proportional calculation method", alias="proportionalMethod")
    proportional_days: Optional[StrictInt] = Field(default=None, description="Number of proportional days", alias="proportionalDays")
    formula: Optional[StrictStr] = Field(default=None, description="Calculation formula")
    __properties: ClassVar[List[str]] = ["id", "itemName", "itemType", "referenceDate", "pph21Method", "minimumLastWorkingDate", "proportionalMethod", "proportionalDays", "formula"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "minimumLastWorkingDate": obj.get("minimumLastWorkingDate"),
            "proportionalMethod": obj.get("proportionalMethod"),
            "proportionalDays": obj.get("proportionalDays"),
