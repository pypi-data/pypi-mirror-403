...
class CreateCityRequest(BaseModel):
    ...
    state: CreateCityRequestState
    __properties: ClassVar[List[str]] = ["code", "name", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "name": obj.get("name"),
            "state": CreateCityRequestState.from_dict(obj["state"]) if obj.get("state") is not None else None
        })
        return _obj
