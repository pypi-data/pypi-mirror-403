...
class EmploymentTypeRequest(BaseModel):
    ...
    employment_group_code: Annotated[str, Field(min_length=1, strict=True, max_length=3)] = Field(alias="employmentGroupCode")
    month_duration: Annotated[int, Field(le=60, strict=True, ge=0)] = Field(alias="monthDuration")
    permanent: Optional[StrictBool] = False
    __properties: ClassVar[List[str]] = ["name", "employmentGroupCode", "monthDuration", "permanent"]

    @field_validator('employment_group_code')
    def employment_group_code_validate_regular_expression(cls, value):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "employmentGroupCode": obj.get("employmentGroupCode"),
            "monthDuration": obj.get("monthDuration"),
