...
class TaxReport1721VIDetailResponse(BaseModel):
    """
    ...
    year: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Tax report year")
    month: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Tax report month")
    sequence_number: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Report sequence number", alias="sequenceNumber")
    npwp_number: Optional[StrictStr] = Field(default=None, description="NPWP (Tax identification number)", alias="npwpNumber")
    monthly_gross_income: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Monthly gross income amount", alias="monthlyGrossIncome")
    tax: Optional[TaxCalculationResponse] = None
    total_gross_income: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total gross income amount", alias="totalGrossIncome")
    pkp: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="PKP (Penghasilan Kena Pajak) value")
    __properties: ClassVar[List[str]] = ["id", "employee", "kpp", "year", "month", "sequenceNumber", "npwpNumber", "monthlyGrossIncome", "tax", "totalGrossIncome", "pkp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tax": TaxCalculationResponse.from_dict(obj["tax"]) if obj.get("tax") is not None else None,
