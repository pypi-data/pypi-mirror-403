...
class UserAndRoleResponse(BaseModel):
    """
    UserAndRoleResponse
    """ # noqa: E501
    id: StrictStr
    ...
    employee: Optional[EmployeeIdNameResponse] = None
    roles: List[RoleResponse]
    __properties: ClassVar[List[str]] = ["id", "username", "email", "employee", "roles"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "email": obj.get("email"),
            "employee": EmployeeIdNameResponse.from_dict(obj["employee"]) if obj.get("employee") is not None else None,
