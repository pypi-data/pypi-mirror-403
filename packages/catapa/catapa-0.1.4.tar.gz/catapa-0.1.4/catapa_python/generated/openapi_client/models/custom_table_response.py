...
class CustomTableResponse(BaseModel):
    ...
    CustomTableResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier of the custom table")
    table_name: Optional[StrictStr] = Field(default=None, description="Technical name of the custom table", alias="tableName")
    display_name: Optional[StrictStr] = Field(default=None, description="Display name of the custom table", alias="displayName")
    menu_location: Optional[StrictStr] = Field(default=None, description="Location of the table in menu hierarchy", alias="menuLocation")
    historical_type: Optional[StrictStr] = Field(default=None, description="Type of historical tracking for the table", alias="historicalType")
    parent_entity: Optional[StrictStr] = Field(default=None, description="Parent entity reference", alias="parentEntity")
    parent_reference_field: Optional[StrictStr] = Field(default=None, description="Field used for parent entity reference", alias="parentReferenceField")
    columns: Optional[List[CustomTableColumnResponse]] = Field(default=None, description="List of columns in the table")
    __properties: ClassVar[List[str]] = ["id", "tableName", "displayName", "menuLocation", "historicalType", "parentEntity", "parentReferenceField", "columns"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if parent_reference_field (nullable) is None
        # and model_fields_set contains the field
        if self.parent_reference_field is None and "parent_reference_field" in self.model_fields_set:
            _dict['parentReferenceField'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "menuLocation": obj.get("menuLocation"),
            "historicalType": obj.get("historicalType"),
            "parentEntity": obj.get("parentEntity"),
            "parentReferenceField": obj.get("parentReferenceField"),
            "columns": [CustomTableColumnResponse.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None
        })
        return _obj
