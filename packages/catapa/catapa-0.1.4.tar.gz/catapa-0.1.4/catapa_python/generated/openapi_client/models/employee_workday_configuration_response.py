...
class EmployeeWorkdayConfigurationResponse(BaseModel):
    """
    ...
    include_missing_shift: Optional[StrictBool] = Field(default=None, alias="includeMissingShift")
    employee: Optional[EmployeeSimpleResponse] = None
    __properties: ClassVar[List[str]] = ["id", "startDate", "endDate", "shiftPatternTemplate", "workdayConfigurationDetails", "startSequence", "startShift", "includeHoliday", "includeMissingShift", "employee"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "includeMissingShift": obj.get("includeMissingShift"),
