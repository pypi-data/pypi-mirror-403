...
class AnalyticsChartDataResponse(BaseModel):
    ...
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="Title of the analytics chart")
    size: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Size of the chart")
    options: Optional[StrictStr] = Field(default=None, description="Additional chart options")
    chart_type: Optional[StrictStr] = Field(default=None, description="Type of the chart (e.g., BAR_VERTICAL_GROUPED_CHART)", alias="chartType")
    yaxis_title: Optional[StrictStr] = Field(default=None, description="Title for Y-axis", alias="yaxisTitle")
    ycolumn_type: Optional[StrictStr] = Field(default=None, description="Data type of Y-axis column", alias="ycolumnType")
    xaxis_title: Optional[StrictStr] = Field(default=None, description="Title for X-axis", alias="xaxisTitle")
    xcolumn_type: Optional[StrictStr] = Field(default=None, description="Data type of X-axis column", alias="xcolumnType")
    series_axis_title: Optional[StrictStr] = Field(default=None, description="Title for series axis", alias="seriesAxisTitle")
    series_column_type: Optional[StrictStr] = Field(default=None, description="Data type of series column", alias="seriesColumnType")
    categories: Optional[List[StrictStr]] = Field(default=None, description="Chart categories")
    series: Optional[List[AnalyticsChartDataSeriesResponse]] = Field(default=None, description="Chart series data")
    color_scheme: Optional[AnalyticsColorSchemeResponse] = Field(default=None, alias="colorScheme")
    chart_filters: Optional[List[ChartFilterResponse]] = Field(default=None, description="Chart filter configurations", alias="chartFilters")
    __properties: ClassVar[List[str]] = ["title", "size", "options", "chartType", "yaxisTitle", "ycolumnType", "xaxisTitle", "xcolumnType", "seriesAxisTitle", "seriesColumnType", "categories", "series", "colorScheme", "chartFilters"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if series_column_type (nullable) is None
        # and model_fields_set contains the field
        if self.series_column_type is None and "series_column_type" in self.model_fields_set:
            _dict['seriesColumnType'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ycolumnType": obj.get("ycolumnType"),
            "xaxisTitle": obj.get("xaxisTitle"),
            "xcolumnType": obj.get("xcolumnType"),
            "seriesAxisTitle": obj.get("seriesAxisTitle"),
            "seriesColumnType": obj.get("seriesColumnType"),
            "categories": obj.get("categories"),
            "series": [AnalyticsChartDataSeriesResponse.from_dict(_item) for _item in obj["series"]] if obj.get("series") is not None else None,
