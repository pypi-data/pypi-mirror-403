...
class EmploymentTypeResponse(BaseModel):
    ...
    employment_group_code: Optional[StrictStr] = Field(default=None, alias="employmentGroupCode")
    month_duration: Optional[StrictInt] = Field(default=None, alias="monthDuration")
    permanent: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "name", "employmentGroupCode", "monthDuration", "permanent"]
