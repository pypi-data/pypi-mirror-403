...
class TerminationReasonDetailResponse(BaseModel):
    """
    TerminationReasonDetailResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    termination_pph21_reason: Optional[StrictStr] = Field(default=None, description="Use taxReason instead", alias="terminationPph21Reason")
    termination_bpjs_manpower_reason: Optional[StrictStr] = Field(default=None, description="Use bpjsManpowerReason instead", alias="terminationBpjsManpowerReason")
    termination_reason_category: Optional[StrictStr] = Field(default=None, description="Use reasonCategory instead", alias="terminationReasonCategory")
    tax_reason: Optional[TerminationTaxReasonResponse] = Field(default=None, alias="taxReason")
    bpjs_manpower_reason: Optional[TerminationBPJSManpowerReasonResponse] = Field(default=None, alias="bpjsManpowerReason")
    reason_category: Optional[TerminationReasonCategoryResponse] = Field(default=None, alias="reasonCategory")
    severance: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "name", "terminationPph21Reason", "terminationBpjsManpowerReason", "terminationReasonCategory", "taxReason", "bpjsManpowerReason", "reasonCategory", "severance"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of tax_reason
        if self.tax_reason:
            _dict['taxReason'] = self.tax_reason.to_dict()
        # override the default output from pydantic by calling `to_dict()` of bpjs_manpower_reason
        if self.bpjs_manpower_reason:
            _dict['bpjsManpowerReason'] = self.bpjs_manpower_reason.to_dict()
        # override the default output from pydantic by calling `to_dict()` of reason_category
        if self.reason_category:
            _dict['reasonCategory'] = self.reason_category.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "terminationPph21Reason": obj.get("terminationPph21Reason"),
            "terminationBpjsManpowerReason": obj.get("terminationBpjsManpowerReason"),
            "terminationReasonCategory": obj.get("terminationReasonCategory"),
            "taxReason": TerminationTaxReasonResponse.from_dict(obj["taxReason"]) if obj.get("taxReason") is not None else None,
            "bpjsManpowerReason": TerminationBPJSManpowerReasonResponse.from_dict(obj["bpjsManpowerReason"]) if obj.get("bpjsManpowerReason") is not None else None,
            "reasonCategory": TerminationReasonCategoryResponse.from_dict(obj["reasonCategory"]) if obj.get("reasonCategory") is not None else None,
            "severance": obj.get("severance")
        })
        return _obj
