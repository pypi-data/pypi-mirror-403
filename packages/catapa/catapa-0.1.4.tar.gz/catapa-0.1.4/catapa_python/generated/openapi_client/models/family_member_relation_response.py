...
class FamilyMemberRelationResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "code", "relationType"]
    ...
    def relation_type_validate_enum(cls, value):
        ...
        if value not in set(['MOTHER', 'FATHER', 'SPOUSE', 'FIRST_CHILD', 'SECOND_CHILD', 'THIRD_CHILD', 'OTHER_CHILD', 'OTHER']):
            raise ValueError("must be one of enum values ('MOTHER', 'FATHER', 'SPOUSE', 'FIRST_CHILD', 'SECOND_CHILD', 'THIRD_CHILD', 'OTHER_CHILD', 'OTHER')")
        return value
