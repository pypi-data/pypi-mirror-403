...
class EmployeeSalaryTemplateRequest(BaseModel):
    """
    EmployeeSalaryTemplateRequest
    """ # noqa: E501
    effective_date: StrictStr = Field(alias="effectiveDate")
    employee_salaries: List[EmployeeSalaryRequest] = Field(alias="employeeSalaries")
    proportional: StrictBool
    retroactive: StrictBool
    salary_decree_number: StrictStr = Field(alias="salaryDecreeNumber")
    salary_template_id: StrictStr = Field(alias="salaryTemplateId")
    __properties: ClassVar[List[str]] = ["effectiveDate", "employeeSalaries", "proportional", "retroactive", "salaryDecreeNumber", "salaryTemplateId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "employeeSalaries": [EmployeeSalaryRequest.from_dict(_item) for _item in obj["employeeSalaries"]] if obj.get("employeeSalaries") is not None else None,
