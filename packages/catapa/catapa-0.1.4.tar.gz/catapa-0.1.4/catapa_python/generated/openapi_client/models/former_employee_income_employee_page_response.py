...
class FormerEmployeeIncomeEmployeePageResponse(BaseModel):
    """
    ...
    content: Optional[List[FormerEmployeeIncomeEmployeeResponse]] = Field(default=None, description="List of former employee income employees")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": [FormerEmployeeIncomeEmployeeResponse.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None
        })
        return _obj
