...
class ContactInformationRequest(BaseModel):
    """
    ContactInformationRequest
    """ # noqa: E501
    email: Optional[StrictStr] = None
    mobile_phone: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="e.g. `+6281234567890`", alias="mobilePhone")
    original_address: Optional[StrictStr] = Field(default=None, alias="originalAddress")
    __properties: ClassVar[List[str]] = ["email", "mobilePhone", "originalAddress"]
