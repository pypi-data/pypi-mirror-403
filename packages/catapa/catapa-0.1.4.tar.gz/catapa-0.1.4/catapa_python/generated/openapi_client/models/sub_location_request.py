...
class SubLocationRequest(BaseModel):
    """
    SubLocationRequest
    """ # noqa: E501
    code: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    location_id: StrictStr = Field(description="Parent location ID", alias="locationId")
    __properties: ClassVar[List[str]] = ["code", "name", "locationId"]
