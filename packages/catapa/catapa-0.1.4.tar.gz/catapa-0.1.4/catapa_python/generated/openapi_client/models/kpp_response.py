...
class KppResponse(BaseModel):
    """
    KppResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="KPP unique identifier")
    code: Optional[StrictStr] = Field(default=None, description="KPP code")
    name: Optional[StrictStr] = Field(default=None, description="KPP name")
    address: Optional[StrictStr] = Field(default=None, description="KPP address")
    responsible_person_name: Optional[StrictStr] = Field(default=None, description="Name of the responsible person", alias="responsiblePersonName")
    responsible_person_npwp: Optional[StrictStr] = Field(default=None, description="NPWP of the responsible person", alias="responsiblePersonNpwp")
    responsible_person_job_title: Optional[StrictStr] = Field(default=None, description="Job title of the responsible person", alias="responsiblePersonJobTitle")
    kpp_status: Optional[StrictStr] = Field(default=None, description="Status of the KPP", alias="kppStatus")
    __properties: ClassVar[List[str]] = ["id", "code", "name", "address", "responsiblePersonName", "responsiblePersonNpwp", "responsiblePersonJobTitle", "kppStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "responsiblePersonName": obj.get("responsiblePersonName"),
            "responsiblePersonNpwp": obj.get("responsiblePersonNpwp"),
            "responsiblePersonJobTitle": obj.get("responsiblePersonJobTitle"),
            "kppStatus": obj.get("kppStatus")
        })
        return _obj
