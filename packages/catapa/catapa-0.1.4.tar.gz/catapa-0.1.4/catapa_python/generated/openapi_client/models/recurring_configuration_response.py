...
class RecurringConfigurationResponse(BaseModel):
    """
    RecurringConfigurationResponse
    """ # noqa: E501
    month_interval: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="monthInterval")
    recurring_end_type: Optional[StrictStr] = Field(default=None, alias="recurringEndType")
    max_recurring_times: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="maxRecurringTimes")
    recurring_period_end: Optional[RecurringPeriodEndResponse] = Field(default=None, alias="recurringPeriodEnd")
    __properties: ClassVar[List[str]] = ["monthInterval", "recurringEndType", "maxRecurringTimes", "recurringPeriodEnd"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of recurring_period_end
        if self.recurring_period_end:
            _dict['recurringPeriodEnd'] = self.recurring_period_end.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "monthInterval": obj.get("monthInterval"),
            "recurringEndType": obj.get("recurringEndType"),
            "maxRecurringTimes": obj.get("maxRecurringTimes"),
            "recurringPeriodEnd": RecurringPeriodEndResponse.from_dict(obj["recurringPeriodEnd"]) if obj.get("recurringPeriodEnd") is not None else None
        })
        return _obj
