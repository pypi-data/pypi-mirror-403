...
class OrganizationHistoryResponse(BaseModel):
    ...
    organization: Optional[IdCodeNameResponse] = None
    company: Optional[IdCodeNameResponse] = None
    type: Optional[StrictStr] = None
    organization_hierarchy: Optional[OrganizationHistoryHierarchyResponse] = Field(default=None, alias="organizationHierarchy")
    ...
    __properties: ClassVar[List[str]] = ["id", "code", "name", "organization", "company", "type", "organizationHierarchy", "organizationGroup", "effectiveDate", "endDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "name": obj.get("name"),
            "organization": IdCodeNameResponse.from_dict(obj["organization"]) if obj.get("organization") is not None else None,
            "company": IdCodeNameResponse.from_dict(obj["company"]) if obj.get("company") is not None else None,
            "type": obj.get("type"),
            "organizationHierarchy": OrganizationHistoryHierarchyResponse.from_dict(obj["organizationHierarchy"]) if obj.get("organizationHierarchy") is not None else None,
