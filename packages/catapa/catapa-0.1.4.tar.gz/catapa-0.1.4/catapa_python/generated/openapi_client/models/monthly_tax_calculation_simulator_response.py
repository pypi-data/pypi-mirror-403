...
class MonthlyTaxCalculationSimulatorResponse(BaseModel):
    """
    ...
    type: StrictStr
    __properties: ClassVar[List[str]] = ["monthlyGrossIncome", "percentage", "monthlyTax", "nettoTax", "type"]
    ...
    __discriminator_value_class_map: ClassVar[Dict[str, str]] = {
        'NON_EMPLOYEE': 'NonEmployeeMonthlyTaxCalculationSimulatorResponse','PERMANENT': 'PermanentMonthlyTaxCalculationSimulatorResponse','TEMPORARY': 'TemporaryMonthlyTaxCalculationSimulatorResponse'
    }
    ...
    @classmethod
    def from_json(cls, json_str: str) -> Optional[Union[NonEmployeeMonthlyTaxCalculationSimulatorResponse, PermanentMonthlyTaxCalculationSimulatorResponse, TemporaryMonthlyTaxCalculationSimulatorResponse]]:
    ...
    @classmethod
    def from_dict(cls, obj: Dict[str, Any]) -> Optional[Union[NonEmployeeMonthlyTaxCalculationSimulatorResponse, PermanentMonthlyTaxCalculationSimulatorResponse, TemporaryMonthlyTaxCalculationSimulatorResponse]]:
        """Create an instance of MonthlyTaxCalculationSimulatorResponse from a dict"""
        # look up the object type based on discriminator mapping
        object_type = cls.get_discriminator_value(obj)
        if object_type ==  'NonEmployeeMonthlyTaxCalculationSimulatorResponse':
            return import_module("openapi_client.models.non_employee_monthly_tax_calculation_simulator_response").NonEmployeeMonthlyTaxCalculationSimulatorResponse.from_dict(obj)
        if object_type ==  'PermanentMonthlyTaxCalculationSimulatorResponse':
            return import_module("openapi_client.models.permanent_monthly_tax_calculation_simulator_response").PermanentMonthlyTaxCalculationSimulatorResponse.from_dict(obj)
        if object_type ==  'TemporaryMonthlyTaxCalculationSimulatorResponse':
            return import_module("openapi_client.models.temporary_monthly_tax_calculation_simulator_response").TemporaryMonthlyTaxCalculationSimulatorResponse.from_dict(obj)

        raise ValueError("MonthlyTaxCalculationSimulatorResponse failed to lookup discriminator value from " +
