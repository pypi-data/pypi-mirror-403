...
class ShiftPatternTemplateRequest(BaseModel):
    """
    ShiftPatternTemplateRequest
    """ # noqa: E501
    name: StrictStr
    shift_pattern_template_details: List[ShiftPatternTemplateDetailItemRequest] = Field(alias="shiftPatternTemplateDetails")
    __properties: ClassVar[List[str]] = ["name", "shiftPatternTemplateDetails"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "shiftPatternTemplateDetails": [ShiftPatternTemplateDetailItemRequest.from_dict(_item) for _item in obj["shiftPatternTemplateDetails"]] if obj.get("shiftPatternTemplateDetails") is not None else None
        })
        return _obj
