...
class TransitionCalculationDetailsRequest(BaseModel):
    """
    TransitionCalculationDetailsRequest
    """ # noqa: E501
    transition_id: StrictStr = Field(alias="transitionId")
    details: List[TransitionCalculationDetailsAmountRequest]
    __properties: ClassVar[List[str]] = ["transitionId", "details"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "details": [TransitionCalculationDetailsAmountRequest.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
        return _obj
