...
class ProrateDetailSalaryTemplateDetailResponse(BaseModel):
    """
    ProrateDetailSalaryTemplateDetailResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    salary_item: Optional[ProrateDetailSalaryTemplateDetailSalaryItemResponse] = Field(default=None, alias="salaryItem")
    salary_item_type: Optional[StrictStr] = Field(default=None, alias="salaryItemType")
    __properties: ClassVar[List[str]] = ["id", "salaryItem", "salaryItemType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "salaryItem": ProrateDetailSalaryTemplateDetailSalaryItemResponse.from_dict(obj["salaryItem"]) if obj.get("salaryItem") is not None else None,
            "salaryItemType": obj.get("salaryItemType")
        })
        return _obj
