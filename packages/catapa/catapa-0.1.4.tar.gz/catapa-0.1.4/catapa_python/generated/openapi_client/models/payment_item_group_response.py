...
class PaymentItemGroupResponse(BaseModel):
    """
    PaymentItemGroupResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    payment_type: Optional[StrictStr] = Field(default=None, alias="paymentType")
    start_process_date: Optional[StrictStr] = Field(default=None, alias="startProcessDate")
    end_process_date: Optional[StrictStr] = Field(default=None, alias="endProcessDate")
    job_level: Optional[IdCodeNameResponse] = Field(default=None, alias="jobLevel")
    location: Optional[IdCodeNameResponse] = None
    payment_item_details: Optional[List[PaymentItemDetailResponse]] = Field(default=None, alias="paymentItemDetails")
    __properties: ClassVar[List[str]] = ["id", "paymentType", "startProcessDate", "endProcessDate", "jobLevel", "location", "paymentItemDetails"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in payment_item_details (list)
        _items = []
        if self.payment_item_details:
            for _item_payment_item_details in self.payment_item_details:
                if _item_payment_item_details:
                    _items.append(_item_payment_item_details.to_dict())
            _dict['paymentItemDetails'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "startProcessDate": obj.get("startProcessDate"),
            "endProcessDate": obj.get("endProcessDate"),
            "jobLevel": IdCodeNameResponse.from_dict(obj["jobLevel"]) if obj.get("jobLevel") is not None else None,
            "location": IdCodeNameResponse.from_dict(obj["location"]) if obj.get("location") is not None else None,
            "paymentItemDetails": [PaymentItemDetailResponse.from_dict(_item) for _item in obj["paymentItemDetails"]] if obj.get("paymentItemDetails") is not None else None
        })
        return _obj
