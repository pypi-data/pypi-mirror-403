...
class SalaryTemplateResponse(BaseModel):
    ...
    salary_template_details: Optional[List[SalaryTemplateDetailResponse]] = Field(default=None, alias="salaryTemplateDetails")
    __properties: ClassVar[List[str]] = ["id", "code", "name", "salaryTemplateDetails"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in salary_template_details (list)
        _items = []
        if self.salary_template_details:
            for _item_salary_template_details in self.salary_template_details:
                if _item_salary_template_details:
                    _items.append(_item_salary_template_details.to_dict())
            _dict['salaryTemplateDetails'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "name": obj.get("name"),
            "salaryTemplateDetails": [SalaryTemplateDetailResponse.from_dict(_item) for _item in obj["salaryTemplateDetails"]] if obj.get("salaryTemplateDetails") is not None else None
        })
        return _obj
