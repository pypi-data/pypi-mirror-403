...
class TerminationTaxReasonResponse(BaseModel):
    """
    TerminationTaxReasonResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    tax_annualized: Optional[StrictBool] = Field(default=None, alias="taxAnnualized")
    __properties: ClassVar[List[str]] = ["id", "name", "taxAnnualized"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "taxAnnualized": obj.get("taxAnnualized")
        })
        return _obj
