...
class BpjsHealthcarePremiumDetailsResponse(BaseModel):
    """
    ...
    current_month_detail: Optional[BpjsHealthcareCurrentMonthDetailResponse] = Field(default=None, alias="currentMonthDetail")
    details: Optional[List[BpjsHealthcarePremiumDetailsItemResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "currentMonthDetail": BpjsHealthcareCurrentMonthDetailResponse.from_dict(obj["currentMonthDetail"]) if obj.get("currentMonthDetail") is not None else None,
            "details": [BpjsHealthcarePremiumDetailsItemResponse.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
        return _obj
