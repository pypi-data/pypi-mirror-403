...
class SalaryPaymentDetailResponse(BaseModel):
    """
    ...
    bank_account_priority: Optional[StrictInt] = Field(default=None, alias="bankAccountPriority")
    currency_code: Optional[StrictStr] = Field(default=None, alias="currencyCode")
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    exchanged_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="exchangedAmount")
    company_bank_account: Optional[SalaryPaymentDetailCompanyBankAccountResponse] = Field(default=None, alias="companyBankAccount")
    __properties: ClassVar[List[str]] = ["id", "bankCode", "bankName", "accountName", "accountNumber", "bankAccountPriority", "currencyCode", "amount", "exchangedAmount", "companyBankAccount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bankAccountPriority": obj.get("bankAccountPriority"),
            "currencyCode": obj.get("currencyCode"),
            "amount": obj.get("amount"),
            "exchangedAmount": obj.get("exchangedAmount"),
            "companyBankAccount": SalaryPaymentDetailCompanyBankAccountResponse.from_dict(obj["companyBankAccount"]) if obj.get("companyBankAccount") is not None else None
        })
        return _obj
