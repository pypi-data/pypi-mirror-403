...
class SalaryItemAddOnRequest(BaseModel):
    """
    SalaryItemAddOnRequest
    """ # noqa: E501
    amount: Union[StrictFloat, StrictInt]
    var_date: StrictStr = Field(alias="date")
    employee: SalaryItemAddOnEmployeeRequest
    salary_item: SalaryItemAddOnSalaryItemRequest = Field(alias="salaryItem")
    __properties: ClassVar[List[str]] = ["amount", "date", "employee", "salaryItem"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "date": obj.get("date"),
            "employee": SalaryItemAddOnEmployeeRequest.from_dict(obj["employee"]) if obj.get("employee") is not None else None,
            "salaryItem": SalaryItemAddOnSalaryItemRequest.from_dict(obj["salaryItem"]) if obj.get("salaryItem") is not None else None
        })
        return _obj
