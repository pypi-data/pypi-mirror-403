...
class OtherLeaveBalanceRequest(BaseModel):
    """
    OtherLeaveBalanceRequest
    """ # noqa: E501
    identification_number: StrictStr = Field(alias="identificationNumber")
    other_leave_status_code: StrictStr = Field(alias="otherLeaveStatusCode")
    ...
    __properties: ClassVar[List[str]] = ["identificationNumber", "otherLeaveStatusCode", "year", "balance", "givenDate", "startDate", "endDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "otherLeaveStatusCode": obj.get("otherLeaveStatusCode"),
            "year": obj.get("year"),
