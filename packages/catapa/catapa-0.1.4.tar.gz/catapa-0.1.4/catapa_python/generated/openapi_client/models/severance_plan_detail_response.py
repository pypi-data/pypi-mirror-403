...
class SeverancePlanDetailResponse(BaseModel):
    """
    ...
    pph21_item_method: Optional[StrictStr] = Field(default=None, alias="pph21ItemMethod")
    __properties: ClassVar[List[str]] = ["code", "name", "category", "amount", "pph21ItemMethod"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pph21ItemMethod": obj.get("pph21ItemMethod")
        })
        return _obj
