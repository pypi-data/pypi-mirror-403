...
class BpjsHealthcareMembershipAdditionalFamilyMembership(BaseModel):
    """
    ...
    family_member_relation_id: StrictStr = Field(alias="familyMemberRelationId")
    first_level_healthcare_facility: Optional[StrictStr] = Field(default=None, alias="firstLevelHealthcareFacility")
    id: StrictStr
    __properties: ClassVar[List[str]] = ["dentalHealthcareFacility", "familyMemberName", "familyMemberRelationId", "firstLevelHealthcareFacility", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "familyMemberRelationId": obj.get("familyMemberRelationId"),
