...
class MonthlyTaxDetailResponse(BaseModel):
    """
    MonthlyTaxDetailResponse
    """ # noqa: E501
    annual_calculation: Optional[StrictBool] = Field(default=None, alias="annualCalculation")
    ...
    npwp_number: Optional[StrictStr] = Field(default=None, alias="npwpNumber")
    npwp_address: Optional[StrictStr] = Field(default=None, alias="npwpAddress")
    ptkp_category_code: Optional[StrictStr] = Field(default=None, alias="ptkpCategoryCode")
    ter_category: Optional[StrictStr] = Field(default=None, alias="terCategory")
    percentage: Optional[Union[StrictFloat, StrictInt]] = None
    monthly_gross_income: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="monthlyGrossIncome")
    tax: Optional[TaxAmountResponse] = None
    regular_tax: Optional[TaxAmountResponse] = Field(default=None, alias="regularTax")
    bonus_tax: Optional[TaxAmountResponse] = Field(default=None, alias="bonusTax")
    income: Optional[TaxIncomeResponse] = None
    ...
    __properties: ClassVar[List[str]] = ["annualCalculation", "taxObject", "year", "month", "employeeId", "npwpNumber", "npwpAddress", "ptkpCategoryCode", "terCategory", "percentage", "monthlyGrossIncome", "tax", "regularTax", "bonusTax", "income", "positionalAllowance", "baseIncomeTaxDeduction"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of regular_tax
        if self.regular_tax:
            _dict['regularTax'] = self.regular_tax.to_dict()
        # override the default output from pydantic by calling `to_dict()` of bonus_tax
        if self.bonus_tax:
            _dict['bonusTax'] = self.bonus_tax.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "annualCalculation": obj.get("annualCalculation"),
            ...
            "ptkpCategoryCode": obj.get("ptkpCategoryCode"),
            "terCategory": obj.get("terCategory"),
            "percentage": obj.get("percentage"),
            "monthlyGrossIncome": obj.get("monthlyGrossIncome"),
            "tax": TaxAmountResponse.from_dict(obj["tax"]) if obj.get("tax") is not None else None,
            "regularTax": TaxAmountResponse.from_dict(obj["regularTax"]) if obj.get("regularTax") is not None else None,
            "bonusTax": TaxAmountResponse.from_dict(obj["bonusTax"]) if obj.get("bonusTax") is not None else None,
            "income": TaxIncomeResponse.from_dict(obj["income"]) if obj.get("income") is not None else None,
