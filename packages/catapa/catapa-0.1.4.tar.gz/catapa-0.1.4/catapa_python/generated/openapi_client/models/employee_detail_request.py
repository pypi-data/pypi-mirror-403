...
class EmployeeDetailRequest(BaseModel):
    """
    EmployeeDetailRequest
    """ # noqa: E501
    blood_type: Optional[StrictStr] = Field(default=None, alias="bloodType")
    citizenship_id: StrictStr = Field(description="Country ID", alias="citizenshipId")
    ...
    place_of_birth_id: Optional[StrictStr] = Field(default=None, description="City ID", alias="placeOfBirthId")
    religion_id: StrictStr = Field(alias="religionId")
    __properties: ClassVar[List[str]] = ["bloodType", "citizenshipId", "dateOfBirth", "foreignLabour", "gender", "maritalStatus", "name", "placeOfBirthId", "religionId"]
