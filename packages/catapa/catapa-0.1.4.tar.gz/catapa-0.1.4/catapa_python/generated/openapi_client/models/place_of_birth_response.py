...
class PlaceOfBirthResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "code", "name", "state"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "name": obj.get("name"),
            "state": StateResponse.from_dict(obj["state"]) if obj.get("state") is not None else None
        })
        return _obj
