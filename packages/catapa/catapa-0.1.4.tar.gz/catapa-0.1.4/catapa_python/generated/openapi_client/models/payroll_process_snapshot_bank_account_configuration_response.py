...
class PayrollProcessSnapshotBankAccountConfigurationResponse(BaseModel):
    """
    ...
    bank_accounts: Optional[List[PayrollProcessSnapshotBankAccountResponse]] = Field(default=None, alias="bankAccounts")
    __properties: ClassVar[List[str]] = ["effectiveDate", "bankAccounts"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bankAccounts": [PayrollProcessSnapshotBankAccountResponse.from_dict(_item) for _item in obj["bankAccounts"]] if obj.get("bankAccounts") is not None else None
        })
        return _obj
