...
class BankAccountConfigurationRequest(BaseModel):
    """
    BankAccountConfigurationRequest
    """ # noqa: E501
    id: Optional[StrictStr] = None
    company_bank_account: Optional[IdRequest] = Field(default=None, alias="companyBankAccount")
    bank_id: StrictStr = Field(alias="bankId")
    bank_branch_id: Optional[StrictStr] = Field(default=None, alias="bankBranchId")
    account_number: StrictStr = Field(description="Numeric", alias="accountNumber")
    account_name: Annotated[str, Field(min_length=3, strict=True, max_length=255)] = Field(alias="accountName")
    beneficiary_id: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, alias="beneficiaryId")
    ...
    __properties: ClassVar[List[str]] = ["id", "companyBankAccount", "bankId", "bankBranchId", "accountNumber", "accountName", "beneficiaryId", "priority", "currency", "percentage", "amount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "companyBankAccount": IdRequest.from_dict(obj["companyBankAccount"]) if obj.get("companyBankAccount") is not None else None,
            ...
            "currency": IdRequest.from_dict(obj["currency"]) if obj.get("currency") is not None else None,
