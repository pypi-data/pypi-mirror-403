...
class MonthlyRecapitulationItemDetailResponse(BaseModel):
    """
    MonthlyRecapitulationItemDetailResponse
    """ # noqa: E501
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    salary_item: Optional[SalaryItemWithSalaryItemTypeResponse] = Field(default=None, alias="salaryItem")
    __properties: ClassVar[List[str]] = ["amount", "salaryItem"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "salaryItem": SalaryItemWithSalaryItemTypeResponse.from_dict(obj["salaryItem"]) if obj.get("salaryItem") is not None else None
        })
        return _obj
