...
class EmployeeBpjsMembershipApi:
    ...
    def get_bpjs_healthcare_membership(
        ...
        _param = self._get_bpjs_healthcare_membership_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BpjsHealthcareMembershipResponse",
            '400': None,
        }
    ...
    @validate_call
    def get_bpjs_healthcare_membership_with_http_info(
        self,
        employee_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BpjsHealthcareMembershipResponse]:
        """Get BPJS Healthcare Membership
    ...
    @validate_call
    def get_bpjs_healthcare_membership_without_preload_content(
        self,
        employee_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_bpjs_healthcare_membership_serialize(
        self,
        employee_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/employees/{employeeId}/bpjs-healthcare-memberships',
    ...
    def get_bpjs_manpower_membership(
        ...
        _param = self._get_bpjs_manpower_membership_serialize(
            employee_id=employee_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "BpjsManpowerMembershipResponse",
            '400': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_bpjs_manpower_membership_with_http_info(
        self,
        employee_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BpjsManpowerMembershipResponse]:
        """Get BPJS Manpower Membership
    ...
    @validate_call
    def get_bpjs_manpower_membership_without_preload_content(
        self,
        employee_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_bpjs_manpower_membership_serialize(
        self,
        employee_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/employees/{employeeId}/bpjs-manpower-memberships',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_bpjs_healthcare_membership(
        self,
        employee_id: StrictStr,
        bpjs_healthcare_membership_request: Optional[BpjsHealthcareMembershipRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param employee_id: (required)
        :type employee_id: str
        :param bpjs_healthcare_membership_request:
        :type bpjs_healthcare_membership_request: BpjsHealthcareMembershipRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_bpjs_healthcare_membership_serialize(
            employee_id=employee_id,
            bpjs_healthcare_membership_request=bpjs_healthcare_membership_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_bpjs_healthcare_membership_with_http_info(
        self,
        employee_id: StrictStr,
        bpjs_healthcare_membership_request: Optional[BpjsHealthcareMembershipRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_bpjs_healthcare_membership_without_preload_content(
        self,
        employee_id: StrictStr,
        bpjs_healthcare_membership_request: Optional[BpjsHealthcareMembershipRequest] = None,
        _request_timeout: Union[
    ...
    def _update_bpjs_healthcare_membership_serialize(
        self,
        employee_id,
        ...
        # process the form parameters
        # process the body parameter
        if bpjs_healthcare_membership_request is not None:
            _body_params = bpjs_healthcare_membership_request
    ...
    def update_bpjs_manpower_membership(
        self,
        employee_id: StrictStr,
        bpjs_manpower_membership_request: Optional[BpjsManpowerMembershipRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param employee_id: (required)
        :type employee_id: str
        :param bpjs_manpower_membership_request:
        :type bpjs_manpower_membership_request: BpjsManpowerMembershipRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_bpjs_manpower_membership_serialize(
            employee_id=employee_id,
            bpjs_manpower_membership_request=bpjs_manpower_membership_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_bpjs_manpower_membership_with_http_info(
        self,
        employee_id: StrictStr,
        bpjs_manpower_membership_request: Optional[BpjsManpowerMembershipRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_bpjs_manpower_membership_without_preload_content(
        self,
        employee_id: StrictStr,
        bpjs_manpower_membership_request: Optional[BpjsManpowerMembershipRequest] = None,
        _request_timeout: Union[
    ...
    def _update_bpjs_manpower_membership_serialize(
        self,
        employee_id,
        ...
        # process the form parameters
        # process the body parameter
        if bpjs_manpower_membership_request is not None:
            _body_params = bpjs_manpower_membership_request
