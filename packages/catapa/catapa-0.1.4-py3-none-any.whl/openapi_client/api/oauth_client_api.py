...
class OauthClientApi:
    ...
    def get_o_auth_client_by_id(
        self,
        id: Annotated[StrictStr, Field(description="OAuth Client ID")],
        ...
        _param = self._get_o_auth_client_by_id_serialize(
            id=id,
    ...
    @validate_call
    def get_o_auth_client_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="OAuth Client ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_o_auth_client_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="OAuth Client ID")],
        _request_timeout: Union[
            None,
    ...
    def _get_o_auth_client_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/oauth-clients/{id}',
    ...
    def list_all_o_auth_clients(
        ...
        _param = self._list_all_o_auth_clients_serialize(
            page=page,
            size=size,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def list_all_o_auth_clients_with_http_info(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Page number")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Page size")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OAuthClientPageResponse]:
        """List All OAuth Clients
    ...
    @validate_call
    def list_all_o_auth_clients_without_preload_content(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Page number")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Page size")] = None,
        _request_timeout: Union[
    ...
    def _list_all_o_auth_clients_serialize(
        self,
        page,
        size,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/oauth-clients',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
