...
class CustomTableApi:
    ...
    def find_all_custom_tables(
        ...
        _param = self._find_all_custom_tables_serialize(
            page=page,
            size=size,
            query=query,
    ...
    @validate_call
    def find_all_custom_tables_with_http_info(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Page number")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Page size")] = None,
        query: Annotated[Optional[StrictStr], Field(description="### Search Query | Supported Keys      | Supported Operators | Notes                                                                                     | |---------------------|---------------------|-------------------------------------------------------------------------------------------| | id                  | `:`                 | Equal operator<br/>Support multiple values with each value separated by the `;` delimiter | | tableName           | `:`                 | Like operator                                                                             | | displayName         | `:`                 | Like operator                                                                             | | menuLocation        | `:`                 | Like operator                                                                             | | historicalType      | `:`                 | Like operator                                                                             | | parentEntity        | `:`                 | Like operator                                                                             | | parentEntityIsNull  | `:`                 | Equal operator<br/>Boolean                                                                | | parentReferenceField| `:`                 | Like operator                                                                             | ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CustomTablePageResponse]:
        """Retrieve all custom tables
    ...
    @validate_call
    def find_all_custom_tables_without_preload_content(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Page number")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Page size")] = None,
        query: Annotated[Optional[StrictStr], Field(description="### Search Query | Supported Keys      | Supported Operators | Notes                                                                                     | |---------------------|---------------------|-------------------------------------------------------------------------------------------| | id                  | `:`                 | Equal operator<br/>Support multiple values with each value separated by the `;` delimiter | | tableName           | `:`                 | Like operator                                                                             | | displayName         | `:`                 | Like operator                                                                             | | menuLocation        | `:`                 | Like operator                                                                             | | historicalType      | `:`                 | Like operator                                                                             | | parentEntity        | `:`                 | Like operator                                                                             | | parentEntityIsNull  | `:`                 | Equal operator<br/>Boolean                                                                | | parentReferenceField| `:`                 | Like operator                                                                             | ")] = None,
    ...
    def _find_all_custom_tables_serialize(
        self,
        page,
        size,
        query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/custom-tables',
    ...
    def find_custom_table_by_id(
        ...
        _param = self._find_custom_table_by_id_serialize(
            table_id=table_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def find_custom_table_by_id_with_http_info(
        self,
        table_id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CustomTableResponse]:
        """Find Custom Table by Table ID
    ...
    @validate_call
    def find_custom_table_by_id_without_preload_content(
        self,
        table_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _find_custom_table_by_id_serialize(
        self,
        table_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/custom-tables/{tableId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
