...
class AnomalyDetectionApi:
    ...
    def read_anomaly_suspect(
        ...
        _param = self._read_anomaly_suspect_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AnomalySuspectPageResponse",
            '400': None,
        }
    ...
    @validate_call
    def read_anomaly_suspect_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AnomalySuspectPageResponse]:
        """Read Anomaly Suspects
    ...
    @validate_call
    def read_anomaly_suspect_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _read_anomaly_suspect_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/anomalydetection/v1/anomaly-detection-types/MEDICAL_CLAIM/anomaly-suspects',
    ...
    @validate_call
    def read_anomaly_suspect_by_id(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _param = self._read_anomaly_suspect_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def read_anomaly_suspect_by_id_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AnomalySuspectResponse]:
        """Read Anomaly Suspect By Id
    ...
    @validate_call
    def read_anomaly_suspect_by_id_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _read_anomaly_suspect_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/anomalydetection/v1/anomaly-detection-types/MEDICAL_CLAIM/anomaly-suspects/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
