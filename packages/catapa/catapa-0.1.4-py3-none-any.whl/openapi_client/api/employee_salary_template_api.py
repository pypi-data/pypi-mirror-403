...
class EmployeeSalaryTemplateApi:
    ...
    def createor_update_employee_salary_template(
        self,
        id: StrictStr,
        employee_salary_template_request: Optional[EmployeeSalaryTemplateRequest] = None,
        ...
        :param id: (required)
        :type id: str
        :param employee_salary_template_request:
        :type employee_salary_template_request: EmployeeSalaryTemplateRequest
        ...
        _param = self._createor_update_employee_salary_template_serialize(
            id=id,
            employee_salary_template_request=employee_salary_template_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "EmployeeSalaryTemplateUpdateResponse",
            '400': None,
        }
    ...
    @validate_call
    def createor_update_employee_salary_template_with_http_info(
        self,
        id: StrictStr,
        employee_salary_template_request: Optional[EmployeeSalaryTemplateRequest] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EmployeeSalaryTemplateUpdateResponse]:
        """Create or Update Employee Salary Template
    ...
    @validate_call
    def createor_update_employee_salary_template_without_preload_content(
        self,
        id: StrictStr,
        employee_salary_template_request: Optional[EmployeeSalaryTemplateRequest] = None,
        _request_timeout: Union[
    ...
    def _createor_update_employee_salary_template_serialize(
        self,
        id,
        ...
        if employee_salary_template_request is not None:
            _body_params = employee_salary_template_request
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/core/v1/employees/{id}/employee-salary-templates',
    ...
    def get_effective_employee_salary_template(
        ...
        _param = self._get_effective_employee_salary_template_serialize(
            id=id,
            year=year,
            month=month,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "EmployeeSalaryTemplatePageResponse",
            '400': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_effective_employee_salary_template_with_http_info(
        self,
        id: StrictStr,
        year: Optional[Union[StrictFloat, StrictInt]] = None,
        month: Optional[Union[StrictFloat, StrictInt]] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EmployeeSalaryTemplatePageResponse]:
        """Get Effective Employee Salary Template
    ...
    @validate_call
    def get_effective_employee_salary_template_without_preload_content(
        self,
        id: StrictStr,
        year: Optional[Union[StrictFloat, StrictInt]] = None,
        month: Optional[Union[StrictFloat, StrictInt]] = None,
    ...
    def _get_effective_employee_salary_template_serialize(
        self,
        id,
        year,
        month,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/employees/{id}/employee-salary-templates/effective',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_latest_employee_salary_template(
        ...
        _param = self._get_latest_employee_salary_template_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "EmployeeSalaryTemplateResponse",
            '400': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_latest_employee_salary_template_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EmployeeSalaryTemplateResponse]:
        """Get Latest Employee Salary Template
    ...
    @validate_call
    def get_latest_employee_salary_template_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_latest_employee_salary_template_serialize(
        self,
        id,
        _request_auth,
        _content_type,
