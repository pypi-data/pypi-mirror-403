...
class CustomTableEntryApi:
    ...
    def _create_entry_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/core/v1/custom-tables/{tableId}/entries',
    ...
    def find_all_entries(
        self,
        table_id: StrictStr,
        query: Annotated[Optional[StrictStr], Field(description="Filter entries based on specific criteria, depending on the custom table's schema.")] = None,
        ...
        :param table_id: (required)
        :type table_id: str
        :param query: Filter entries based on specific criteria, depending on the custom table's schema.
        :type query: str
        ...
        _param = self._find_all_entries_serialize(
            table_id=table_id,
            query=query,
            page=page,
            size=size,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CustomTableEntryPageResponse",
            '400': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def find_all_entries_with_http_info(
        self,
        table_id: StrictStr,
        query: Annotated[Optional[StrictStr], Field(description="Filter entries based on specific criteria, depending on the custom table's schema.")] = None,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Page number")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CustomTableEntryPageResponse]:
        """Retrieve all entries for a custom table, with response structure varying based on the custom table columns
    ...
    @validate_call
    def find_all_entries_without_preload_content(
        self,
        table_id: StrictStr,
        query: Annotated[Optional[StrictStr], Field(description="Filter entries based on specific criteria, depending on the custom table's schema.")] = None,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Page number")] = None,
    ...
    def _find_all_entries_serialize(
        self,
        table_id,
        query,
        page,
    ...
    def _update_entry_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/core/v1/custom-tables/{tableId}/entries/{entryId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
