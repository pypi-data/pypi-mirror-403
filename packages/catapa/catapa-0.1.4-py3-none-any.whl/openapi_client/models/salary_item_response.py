...
class SalaryItemResponse(BaseModel):
    ...
    payslip_name: Optional[StrictStr] = Field(default=None, alias="payslipName")
    ...
    pph21_item: Optional[StrictStr] = Field(default=None, alias="pph21Item")
    __properties: ClassVar[List[str]] = ["id", "code", "name", "payslipName", "salaryItemCategory", "pph21Method", "pph21Item"]
