...
class BpjsManpowerMembershipResponse(BaseModel):
    """
    BpjsManpowerMembershipResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="ID of the BPJS Manpower Membership")
    ...
    pension_end: Optional[StrictStr] = Field(default=None, alias="pensionEnd")
    bpjs_manpower_provider: Optional[BpjsManpowerProviderResponse] = Field(default=None, alias="bpjsManpowerProvider")
    bpjs_manpower_template: Optional[BpjsManpowerTemplateResponse] = Field(default=None, alias="bpjsManpowerTemplate")
    __properties: ClassVar[List[str]] = ["id", "membershipNumber", "startDate", "endDate", "effectiveDate", "pensionEnd", "bpjsManpowerProvider", "bpjsManpowerTemplate"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of bpjs_manpower_provider
        if self.bpjs_manpower_provider:
            _dict['bpjsManpowerProvider'] = self.bpjs_manpower_provider.to_dict()
        # override the default output from pydantic by calling `to_dict()` of bpjs_manpower_template
        if self.bpjs_manpower_template:
            _dict['bpjsManpowerTemplate'] = self.bpjs_manpower_template.to_dict()
        # set to None if end_date (nullable) is None
        # and model_fields_set contains the field
        if self.end_date is None and "end_date" in self.model_fields_set:
            _dict['endDate'] = None

        # set to None if pension_end (nullable) is None
        # and model_fields_set contains the field
        if self.pension_end is None and "pension_end" in self.model_fields_set:
            _dict['pensionEnd'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pensionEnd": obj.get("pensionEnd"),
            "bpjsManpowerProvider": BpjsManpowerProviderResponse.from_dict(obj["bpjsManpowerProvider"]) if obj.get("bpjsManpowerProvider") is not None else None,
            "bpjsManpowerTemplate": BpjsManpowerTemplateResponse.from_dict(obj["bpjsManpowerTemplate"]) if obj.get("bpjsManpowerTemplate") is not None else None
        })
        return _obj
