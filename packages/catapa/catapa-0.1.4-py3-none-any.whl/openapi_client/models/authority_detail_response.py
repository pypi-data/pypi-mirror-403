...
class AuthorityDetailResponse(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Authority identifier")
    code: Optional[StrictStr] = Field(default=None, description="Authority code")
    name: Optional[StrictStr] = Field(default=None, description="Authority name")
    description: Optional[StrictStr] = Field(default=None, description="Authority description")
    module_name: Optional[StrictStr] = Field(default=None, description="Module name this authority belongs to", alias="moduleName")
    __properties: ClassVar[List[str]] = ["id", "code", "name", "description", "moduleName"]
