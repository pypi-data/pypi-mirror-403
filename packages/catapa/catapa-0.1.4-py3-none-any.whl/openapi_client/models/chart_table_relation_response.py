...
class ChartTableRelationResponse(BaseModel):
    """
    ChartTableRelationResponse
    """ # noqa: E501
    chart_table_relation_id: Optional[StrictStr] = Field(default=None, alias="chartTableRelationId")
    sequence: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["chartTableRelationId", "sequence"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "chartTableRelationId": obj.get("chartTableRelationId"),
