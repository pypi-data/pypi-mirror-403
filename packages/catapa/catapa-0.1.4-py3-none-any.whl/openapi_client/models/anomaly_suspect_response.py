...
class AnomalySuspectResponse(BaseModel):
    """
    AnomalySuspectResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the anomaly suspect")
    identifier: Optional[StrictStr] = Field(default=None, description="Anomaly suspect identifier")
    file: Optional[AnomalySuspectFileResponse] = None
    anomaly_suspect_attribute_values: Optional[List[AnomalySuspectAttributeValueResponse]] = Field(default=None, description="List of anomaly suspect attribute values", alias="anomalySuspectAttributeValues")
    __properties: ClassVar[List[str]] = ["id", "identifier", "file", "anomalySuspectAttributeValues"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in anomaly_suspect_attribute_values (list)
        _items = []
        if self.anomaly_suspect_attribute_values:
            for _item_anomaly_suspect_attribute_values in self.anomaly_suspect_attribute_values:
                if _item_anomaly_suspect_attribute_values:
                    _items.append(_item_anomaly_suspect_attribute_values.to_dict())
            _dict['anomalySuspectAttributeValues'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "file": AnomalySuspectFileResponse.from_dict(obj["file"]) if obj.get("file") is not None else None,
            "anomalySuspectAttributeValues": [AnomalySuspectAttributeValueResponse.from_dict(_item) for _item in obj["anomalySuspectAttributeValues"]] if obj.get("anomalySuspectAttributeValues") is not None else None
        })
        return _obj
