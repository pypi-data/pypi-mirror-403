...
class SalaryCalculationResponse(BaseModel):
    ...
    """ # noqa: E501
    cost_center_code: Optional[StrictStr] = Field(default=None, alias="costCenterCode")
    daily_workday_end_date: Optional[StrictStr] = Field(default=None, alias="dailyWorkdayEndDate")
    daily_workday_start_date: Optional[StrictStr] = Field(default=None, alias="dailyWorkdayStartDate")
    ...
    location_group_code: Optional[StrictStr] = Field(default=None, alias="locationGroupCode")
    normal_workday: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="normalWorkday")
    previous_period_employee_workday: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="previousPeriodEmployeeWorkday")
    previous_period_normal_workday: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="previousPeriodNormalWorkday")
    __properties: ClassVar[List[str]] = ["costCenterCode", "dailyWorkdayEndDate", "dailyWorkdayStartDate", "employeeId", "employeeIdentificationNumber", "employeeName", "employeeWorkday", "id", "locationGroupCode", "normalWorkday", "previousPeriodEmployeeWorkday", "previousPeriodNormalWorkday"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "costCenterCode": obj.get("costCenterCode"),
            "dailyWorkdayEndDate": obj.get("dailyWorkdayEndDate"),
            "dailyWorkdayStartDate": obj.get("dailyWorkdayStartDate"),
            ...
            "id": obj.get("id"),
            "locationGroupCode": obj.get("locationGroupCode"),
            "normalWorkday": obj.get("normalWorkday"),
            "previousPeriodEmployeeWorkday": obj.get("previousPeriodEmployeeWorkday"),
            "previousPeriodNormalWorkday": obj.get("previousPeriodNormalWorkday")
        })
        return _obj
