...
class AdditionalAssignmentResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "employmentStatusType", "employmentType", "effectiveDate", "endDate", "signDate", "createdBy", "createdDate", "updatedBy", "updatedDate", "organization", "position", "jobLevel", "jobTitle", "location", "costCenter", "employee", "subLocation", "operationalGroup"]
