...
class JobTitleResponse(BaseModel):
    ...
    min_job_level: Optional[JobLevelResponse] = Field(default=None, alias="minJobLevel")
    max_job_level: Optional[JobLevelResponse] = Field(default=None, alias="maxJobLevel")
    __properties: ClassVar[List[str]] = ["id", "name", "code", "minJobLevel", "maxJobLevel"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of min_job_level
        if self.min_job_level:
            _dict['minJobLevel'] = self.min_job_level.to_dict()
        # override the default output from pydantic by calling `to_dict()` of max_job_level
        if self.max_job_level:
            _dict['maxJobLevel'] = self.max_job_level.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "code": obj.get("code"),
            "minJobLevel": JobLevelResponse.from_dict(obj["minJobLevel"]) if obj.get("minJobLevel") is not None else None,
            "maxJobLevel": JobLevelResponse.from_dict(obj["maxJobLevel"]) if obj.get("maxJobLevel") is not None else None
        })
        return _obj
