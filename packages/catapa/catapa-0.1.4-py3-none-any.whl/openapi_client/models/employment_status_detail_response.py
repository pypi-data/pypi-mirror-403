...
class EmploymentStatusDetailResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "contractStart", "contractEnd", "costCenter", "effectiveDate", "createdBy", "createdDate", "updatedBy", "updatedDate", "employmentStatusNumber", "employmentStatusType", "employmentType", "jobLevel", "jobTitle", "location", "organization", "permanentDate", "signDate", "subLocation", "operationalGroup", "position"]
