...
class BpjsManpowerMembershipRequest(BaseModel):
    """
    BpjsManpowerMembershipRequest
    """ # noqa: E501
    bpjs_manpower_provider_id: StrictStr = Field(alias="bpjsManpowerProviderId")
    bpjs_manpower_template_id: StrictStr = Field(alias="bpjsManpowerTemplateId")
    membership_number: Optional[StrictStr] = Field(default=None, alias="membershipNumber")
    start_date: StrictStr = Field(alias="startDate")
    effective_date: Optional[StrictStr] = Field(default=None, description="Effective Date of the BPJS Manpower Membership default value is start date", alias="effectiveDate")
    __properties: ClassVar[List[str]] = ["bpjsManpowerProviderId", "bpjsManpowerTemplateId", "membershipNumber", "startDate", "effectiveDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bpjsManpowerProviderId": obj.get("bpjsManpowerProviderId"),
            "bpjsManpowerTemplateId": obj.get("bpjsManpowerTemplateId"),
