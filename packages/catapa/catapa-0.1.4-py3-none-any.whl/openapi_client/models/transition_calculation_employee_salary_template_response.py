...
class TransitionCalculationEmployeeSalaryTemplateResponse(BaseModel):
    """
    ...
    salary_template: Optional[NameResponse] = Field(default=None, alias="salaryTemplate")
    __properties: ClassVar[List[str]] = ["effectiveDate", "salaryDecreeNumber", "salaryTemplate"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of salary_template
        if self.salary_template:
            _dict['salaryTemplate'] = self.salary_template.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "salaryTemplate": NameResponse.from_dict(obj["salaryTemplate"]) if obj.get("salaryTemplate") is not None else None
        })
        return _obj
