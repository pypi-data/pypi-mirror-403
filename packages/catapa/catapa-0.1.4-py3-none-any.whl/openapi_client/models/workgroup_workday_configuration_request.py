...
class WorkgroupWorkdayConfigurationRequest(BaseModel):
    """
    ...
    workgroup: IdRequest
    __properties: ClassVar[List[str]] = ["shiftPatternTemplate", "startDate", "endDate", "includeHoliday", "startSequence", "workgroup"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workgroup": IdRequest.from_dict(obj["workgroup"]) if obj.get("workgroup") is not None else None
        })
        return _obj
