...
class PermanentMonthlyTaxCalculationSimulatorResponse(MonthlyTaxCalculationSimulatorResponse):
    """
    PermanentMonthlyTaxCalculationSimulatorResponse
    """ # noqa: E501
    type: StrictStr
    basic_salary: Union[StrictFloat, StrictInt] = Field(alias="basicSalary")
    tax_allowance: Union[StrictFloat, StrictInt] = Field(alias="taxAllowance")
    other_allowance: Union[StrictFloat, StrictInt] = Field(alias="otherAllowance")
    honorarium: Union[StrictFloat, StrictInt]
    insurance_premium: Union[StrictFloat, StrictInt] = Field(alias="insurancePremium")
    enjoyment_revenue: Union[StrictFloat, StrictInt] = Field(alias="enjoymentRevenue")
    bonus: Union[StrictFloat, StrictInt]
    monthly_retirement_contribution: Union[StrictFloat, StrictInt] = Field(alias="monthlyRetirementContribution")
    monthly_religion_allowance: Union[StrictFloat, StrictInt] = Field(alias="monthlyReligionAllowance")
