...
class TerminationReasonRequest(BaseModel):
    """
    TerminationReasonRequest
    """ # noqa: E501
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    tax_reason: IdRequest = Field(alias="taxReason")
    bpjs_manpower_reason: IdRequest = Field(alias="bpjsManpowerReason")
    reason_category: IdRequest = Field(alias="reasonCategory")
    severance: Optional[StrictBool] = False
    __properties: ClassVar[List[str]] = ["name", "taxReason", "bpjsManpowerReason", "reasonCategory", "severance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "taxReason": IdRequest.from_dict(obj["taxReason"]) if obj.get("taxReason") is not None else None,
            "bpjsManpowerReason": IdRequest.from_dict(obj["bpjsManpowerReason"]) if obj.get("bpjsManpowerReason") is not None else None,
            "reasonCategory": IdRequest.from_dict(obj["reasonCategory"]) if obj.get("reasonCategory") is not None else None,
            "severance": obj.get("severance") if obj.get("severance") is not None else False
        })
        return _obj
