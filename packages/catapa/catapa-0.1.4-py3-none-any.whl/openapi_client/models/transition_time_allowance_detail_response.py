...
class TransitionTimeAllowanceDetailResponse(BaseModel):
    """
    ...
    salary_template_detail_id: Optional[StrictStr] = Field(default=None, alias="salaryTemplateDetailId")
    __properties: ClassVar[List[str]] = ["amount", "date", "salaryDecreeNumber", "salaryTemplateDetailId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "salaryTemplateDetailId": obj.get("salaryTemplateDetailId")
        })
        return _obj
