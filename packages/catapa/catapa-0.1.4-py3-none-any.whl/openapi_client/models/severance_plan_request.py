...
class SeverancePlanRequest(BaseModel):
    """
    SeverancePlanRequest
    """ # noqa: E501
    pph21_method: StrictStr = Field(alias="pph21Method")
    details: List[SeverancePlanDetailItemRequest]
    payment_plans: List[SeverancePlanPaymentPlanItemRequest] = Field(alias="paymentPlans")
    __properties: ClassVar[List[str]] = ["pph21Method", "details", "paymentPlans"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "details": [SeverancePlanDetailItemRequest.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None,
            "paymentPlans": [SeverancePlanPaymentPlanItemRequest.from_dict(_item) for _item in obj["paymentPlans"]] if obj.get("paymentPlans") is not None else None
        })
        return _obj
