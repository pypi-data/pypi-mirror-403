...
class SalaryPaymentResponse(BaseModel):
    ...
    organization: Optional[PositionHistoryOrganizationResponse] = None
    job_level: Optional[NameResponse] = Field(default=None, alias="jobLevel")
    job_title: Optional[NameResponse] = Field(default=None, alias="jobTitle")
    location: Optional[NameResponse] = None
    cost_center: Optional[CostCenterSimpleResponse] = Field(default=None, alias="costCenter")
    employee: Optional[SalaryPaymentEmployeeResponse] = None
    salary_payment_details: Optional[List[SalaryPaymentDetailResponse]] = Field(default=None, alias="salaryPaymentDetails")
    __properties: ClassVar[List[str]] = ["id", "paymentMethod", "paymentDate", "organization", "jobLevel", "jobTitle", "location", "costCenter", "employee", "salaryPaymentDetails"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in salary_payment_details (list)
        _items = []
        if self.salary_payment_details:
            for _item_salary_payment_details in self.salary_payment_details:
                if _item_salary_payment_details:
                    _items.append(_item_salary_payment_details.to_dict())
            _dict['salaryPaymentDetails'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organization": PositionHistoryOrganizationResponse.from_dict(obj["organization"]) if obj.get("organization") is not None else None,
            "jobLevel": NameResponse.from_dict(obj["jobLevel"]) if obj.get("jobLevel") is not None else None,
            ...
            "costCenter": CostCenterSimpleResponse.from_dict(obj["costCenter"]) if obj.get("costCenter") is not None else None,
            "employee": SalaryPaymentEmployeeResponse.from_dict(obj["employee"]) if obj.get("employee") is not None else None,
            "salaryPaymentDetails": [SalaryPaymentDetailResponse.from_dict(_item) for _item in obj["salaryPaymentDetails"]] if obj.get("salaryPaymentDetails") is not None else None
        })
        return _obj
