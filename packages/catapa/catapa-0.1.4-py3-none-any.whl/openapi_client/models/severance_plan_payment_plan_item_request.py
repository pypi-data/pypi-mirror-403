...
class SeverancePlanPaymentPlanItemRequest(BaseModel):
    """
    SeverancePlanPaymentPlanItemRequest
    """ # noqa: E501
    planned_date: StrictStr = Field(alias="plannedDate")
    payment_date: StrictStr = Field(alias="paymentDate")
    amount: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["plannedDate", "paymentDate", "amount"]
