...
class PtkpCategoryResponse(BaseModel):
    """
    ...
    max_dependent: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="maxDependent")
    formula: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "code", "name", "maxDependent", "formula"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "name": obj.get("name"),
            "maxDependent": obj.get("maxDependent"),
