...
class AnomalySuspectAttributeValueChildResponse(BaseModel):
    """
    AnomalySuspectAttributeValueChildResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the child attribute value")
    attribute_value: Optional[StrictStr] = Field(default=None, description="Value of the child attribute", alias="attributeValue")
    anomaly_suspect_attribute: Optional[AnomalySuspectAttributeResponse] = Field(default=None, alias="anomalySuspectAttribute")
    __properties: ClassVar[List[str]] = ["id", "attributeValue", "anomalySuspectAttribute"]
