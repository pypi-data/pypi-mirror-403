...
class CostCenterPageResponse(BaseModel):
    """
    ...
    content: Optional[List[CostCenterListItemResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": [CostCenterListItemResponse.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None
        })
        return _obj
