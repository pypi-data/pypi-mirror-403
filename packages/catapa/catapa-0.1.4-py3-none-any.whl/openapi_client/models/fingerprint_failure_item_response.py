...
class FingerprintFailureItemResponse(BaseModel):
    """
    FingerprintFailureItemResponse
    """ # noqa: E501
    code: Optional[StrictStr] = None
    message: Optional[StrictStr] = None
    params: Optional[EmployeeIdentificationNumberResponse] = None
    __properties: ClassVar[List[str]] = ["code", "message", "params"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": EmployeeIdentificationNumberResponse.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
