...
class EmployeeHiringDataRequest(BaseModel):
    """
    ...
    point_of_hire_id: Optional[StrictStr] = Field(default=None, alias="pointOfHireId")
    __properties: ClassVar[List[str]] = ["identificationNumber", "joinDate", "name", "startDate", "pointOfHireId"]
