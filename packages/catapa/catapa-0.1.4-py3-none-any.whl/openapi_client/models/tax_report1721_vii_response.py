...
class TaxReport1721VIIResponse(BaseModel):
    """
    ...
    income: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total income amount")
    tax: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Tax amount")
    __properties: ClassVar[List[str]] = ["id", "employee", "kpp", "year", "month", "sequenceNumber", "npwpNumber", "income", "tax"]
