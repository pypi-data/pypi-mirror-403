...
class RoleDetailResponse(BaseModel):
    ...
    RoleDetailResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Role identifier")
    ...
    role_type: Optional[StrictStr] = Field(default=None, description="Type of role", alias="roleType")
    cascade_organization_permission: Optional[StrictBool] = Field(default=None, description="Whether organization permissions cascade to child organizations", alias="cascadeOrganizationPermission")
    authorities: Optional[List[AuthorityDetailResponse]] = Field(default=None, description="List of authorities assigned to this role")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "roleType", "cascadeOrganizationPermission", "authorities"]
    ...
    def role_type_validate_enum(cls, value):
        ...
        if value not in set(['ADMIN', 'DEFAULT', 'OTHERS']):
            raise ValueError("must be one of enum values ('ADMIN', 'DEFAULT', 'OTHERS')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "cascadeOrganizationPermission": obj.get("cascadeOrganizationPermission"),
            "authorities": [AuthorityDetailResponse.from_dict(_item) for _item in obj["authorities"]] if obj.get("authorities") is not None else None
        })
        return _obj
