...
class ErrorResponse(BaseModel):
    ...
    timestamp: Optional[StrictStr] = Field(default=None, description="Timestamp when the error occurred")
    __properties: ClassVar[List[str]] = ["code", "message", "status", "timestamp"]
