...
class PayrollProcessSnapshotResponse(BaseModel):
    """
    ...
    termination_date: Optional[date] = Field(default=None, alias="terminationDate")
    employment_status: Optional[PayrollProcessSnapshotEmploymentStatusResponse] = Field(default=None, alias="employmentStatus")
    kpp: Optional[IdResponse] = None
    paygroup: Optional[IdCodeNameResponse] = None
    payroll_sequence_number: Optional[StrictInt] = Field(default=None, alias="payrollSequenceNumber")
    previous_payroll_sequence_number: Optional[StrictInt] = Field(default=None, alias="previousPayrollSequenceNumber")
    payment_item_group: Optional[IdResponse] = Field(default=None, alias="paymentItemGroup")
    bank_account_configuration: Optional[PayrollProcessSnapshotBankAccountConfigurationResponse] = Field(default=None, alias="bankAccountConfiguration")
    workflow_activities: Optional[List[PayrollProcessSnapshotWorkflowActivityResponse]] = Field(default=None, alias="workflowActivities")
    __properties: ClassVar[List[str]] = ["employeeId", "effectiveDate", "terminationDate", "employmentStatus", "kpp", "paygroup", "payrollSequenceNumber", "previousPayrollSequenceNumber", "paymentItemGroup", "bankAccountConfiguration", "workflowActivities"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.employment_status:
            _dict['employmentStatus'] = self.employment_status.to_dict()
        # override the default output from pydantic by calling `to_dict()` of kpp
        if self.kpp:
            _dict['kpp'] = self.kpp.to_dict()
        # override the default output from pydantic by calling `to_dict()` of paygroup
        if self.paygroup:
            _dict['paygroup'] = self.paygroup.to_dict()
        # override the default output from pydantic by calling `to_dict()` of payment_item_group
        if self.payment_item_group:
            _dict['paymentItemGroup'] = self.payment_item_group.to_dict()
        # override the default output from pydantic by calling `to_dict()` of bank_account_configuration
        if self.bank_account_configuration:
            _dict['bankAccountConfiguration'] = self.bank_account_configuration.to_dict()
        ...
        if self.workflow_activities:
            for _item_workflow_activities in self.workflow_activities:
                if _item_workflow_activities:
                    _items.append(_item_workflow_activities.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "employmentStatus": PayrollProcessSnapshotEmploymentStatusResponse.from_dict(obj["employmentStatus"]) if obj.get("employmentStatus") is not None else None,
            "kpp": IdResponse.from_dict(obj["kpp"]) if obj.get("kpp") is not None else None,
            "paygroup": IdCodeNameResponse.from_dict(obj["paygroup"]) if obj.get("paygroup") is not None else None,
            "payrollSequenceNumber": obj.get("payrollSequenceNumber"),
            "previousPayrollSequenceNumber": obj.get("previousPayrollSequenceNumber"),
            "paymentItemGroup": IdResponse.from_dict(obj["paymentItemGroup"]) if obj.get("paymentItemGroup") is not None else None,
            "bankAccountConfiguration": PayrollProcessSnapshotBankAccountConfigurationResponse.from_dict(obj["bankAccountConfiguration"]) if obj.get("bankAccountConfiguration") is not None else None,
            "workflowActivities": [PayrollProcessSnapshotWorkflowActivityResponse.from_dict(_item) for _item in obj["workflowActivities"]] if obj.get("workflowActivities") is not None else None
        })
        return _obj
