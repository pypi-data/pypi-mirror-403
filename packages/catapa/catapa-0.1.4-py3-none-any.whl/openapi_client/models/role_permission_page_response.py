...
class RolePermissionPageResponse(BaseModel):
    """
    ...
    content: Optional[List[RolePermissionResponse]] = Field(default=None, description="List of role permissions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": [RolePermissionResponse.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None
        })
        return _obj
