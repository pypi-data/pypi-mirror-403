...
class EmploymentDataPositionResponse(BaseModel):
    """
    ...
    max_employees: Optional[StrictInt] = Field(default=None, alias="maxEmployees")
    ...
    __properties: ClassVar[List[str]] = ["id", "code", "name", "assigned", "effectiveDate", "endDate", "maxEmployees", "createdBy", "createdDate", "updatedBy", "updatedDate"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if max_employees (nullable) is None
        # and model_fields_set contains the field
        if self.max_employees is None and "max_employees" in self.model_fields_set:
            _dict['maxEmployees'] = None
