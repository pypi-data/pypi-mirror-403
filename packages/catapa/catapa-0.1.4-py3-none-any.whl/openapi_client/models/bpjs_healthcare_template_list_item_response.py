...
class BpjsHealthcareTemplateListItemResponse(BaseModel):
    """
    ...
    salary_type: Optional[StrictStr] = Field(default=None, alias="salaryType")
    link_to_payroll: Optional[StrictBool] = Field(default=None, alias="linkToPayroll")
    __properties: ClassVar[List[str]] = ["id", "code", "name", "salaryType", "linkToPayroll"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BpjsHealthcareTemplateListItemResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BpjsHealthcareTemplateListItemResponse from a dict"""
        if obj is None:
            return None
