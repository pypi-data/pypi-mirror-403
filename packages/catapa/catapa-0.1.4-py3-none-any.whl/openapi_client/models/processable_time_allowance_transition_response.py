...
class ProcessableTimeAllowanceTransitionResponse(BaseModel):
    """
    ProcessableTimeAllowanceTransitionResponse
    """ # noqa: E501
    daily_end_date: Optional[StrictStr] = Field(default=None, alias="dailyEndDate")
    daily_start_date: Optional[StrictStr] = Field(default=None, alias="dailyStartDate")
    employee: Optional[ProcessableTimeAllowanceTransitionEmployeeResponse] = None
    id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["dailyEndDate", "dailyStartDate", "employee", "id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dailyEndDate": obj.get("dailyEndDate"),
            "dailyStartDate": obj.get("dailyStartDate"),
            "employee": ProcessableTimeAllowanceTransitionEmployeeResponse.from_dict(obj["employee"]) if obj.get("employee") is not None else None,
            "id": obj.get("id")
        })
        return _obj
