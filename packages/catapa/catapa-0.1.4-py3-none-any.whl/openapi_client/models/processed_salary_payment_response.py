...
class ProcessedSalaryPaymentResponse(BaseModel):
    """
    ...
    salary_payment_details: Optional[List[ProcessedSalaryPaymentDetailResponse]] = Field(default=None, alias="salaryPaymentDetails")
    total_thp: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalThp")
    __properties: ClassVar[List[str]] = ["employeeId", "locationGroupCode", "paymentDate", "salaryPaymentDetails", "totalThp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "salaryPaymentDetails": [ProcessedSalaryPaymentDetailResponse.from_dict(_item) for _item in obj["salaryPaymentDetails"]] if obj.get("salaryPaymentDetails") is not None else None,
