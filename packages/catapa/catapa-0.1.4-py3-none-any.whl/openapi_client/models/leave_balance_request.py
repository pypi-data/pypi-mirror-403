...
class LeaveBalanceRequest(BaseModel):
    ...
    accrual_frequency_type: StrictStr = Field(alias="accrualFrequencyType")
    monthly_accrual_include_bonus: StrictBool = Field(alias="monthlyAccrualIncludeBonus")
    given_date: StrictStr = Field(alias="givenDate")
    ...
    debt: Union[StrictFloat, StrictInt]
    extended: StrictBool
    maximum_extended_duration: Union[StrictFloat, StrictInt] = Field(alias="maximumExtendedDuration")
    maximum_extended_balance: Union[StrictFloat, StrictInt] = Field(alias="maximumExtendedBalance")
    extended_balance_include_bonus: StrictBool = Field(alias="extendedBalanceIncludeBonus")
    __properties: ClassVar[List[str]] = ["identificationNumber", "year", "accrualFrequencyType", "monthlyAccrualIncludeBonus", "givenDate", "startDate", "endDate", "balance", "bonus", "debt", "extended", "maximumExtendedDuration", "maximumExtendedBalance", "extendedBalanceIncludeBonus"]
