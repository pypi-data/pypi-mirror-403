...
class BpjsManpowerPremiumDetailsItemResponse(BaseModel):
    """
    BpjsManpowerPremiumDetailsItemResponse
    """ # noqa: E501
    start_cutoff_date: Optional[StrictStr] = Field(default=None, alias="startCutoffDate")
    end_cutoff_date: Optional[StrictStr] = Field(default=None, alias="endCutoffDate")
    jkk_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Amount can be null because the date period is not processed yet", alias="jkkAmount")
    jkm_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Amount can be null because the date period is not processed yet", alias="jkmAmount")
    jhtpk_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Amount can be null because the date period is not processed yet", alias="jhtpkAmount")
    jhtp_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Amount can be null because the date period is not processed yet", alias="jhtpAmount")
    jppk_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Amount can be null because the date period is not processed yet", alias="jppkAmount")
    jpp_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Amount can be null because the date period is not processed yet", alias="jppAmount")
    jkp_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="jkpAmount")
    __properties: ClassVar[List[str]] = ["startCutoffDate", "endCutoffDate", "jkkAmount", "jkmAmount", "jhtpkAmount", "jhtpAmount", "jppkAmount", "jppAmount", "jkpAmount"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if jkk_amount (nullable) is None
        # and model_fields_set contains the field
        if self.jkk_amount is None and "jkk_amount" in self.model_fields_set:
            _dict['jkkAmount'] = None

        # set to None if jkm_amount (nullable) is None
        # and model_fields_set contains the field
        if self.jkm_amount is None and "jkm_amount" in self.model_fields_set:
            _dict['jkmAmount'] = None

        # set to None if jhtpk_amount (nullable) is None
        # and model_fields_set contains the field
        if self.jhtpk_amount is None and "jhtpk_amount" in self.model_fields_set:
            _dict['jhtpkAmount'] = None

        # set to None if jhtp_amount (nullable) is None
        # and model_fields_set contains the field
        if self.jhtp_amount is None and "jhtp_amount" in self.model_fields_set:
            _dict['jhtpAmount'] = None

        # set to None if jppk_amount (nullable) is None
        # and model_fields_set contains the field
        if self.jppk_amount is None and "jppk_amount" in self.model_fields_set:
            _dict['jppkAmount'] = None

        # set to None if jpp_amount (nullable) is None
        # and model_fields_set contains the field
        if self.jpp_amount is None and "jpp_amount" in self.model_fields_set:
            _dict['jppAmount'] = None

        # set to None if jkp_amount (nullable) is None
        # and model_fields_set contains the field
        if self.jkp_amount is None and "jkp_amount" in self.model_fields_set:
            _dict['jkpAmount'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "startCutoffDate": obj.get("startCutoffDate"),
            "endCutoffDate": obj.get("endCutoffDate"),
            "jkkAmount": obj.get("jkkAmount"),
            "jkmAmount": obj.get("jkmAmount"),
            "jhtpkAmount": obj.get("jhtpkAmount"),
            "jhtpAmount": obj.get("jhtpAmount"),
            "jppkAmount": obj.get("jppkAmount"),
            "jppAmount": obj.get("jppAmount"),
            "jkpAmount": obj.get("jkpAmount")
        })
        return _obj
