...
class PositionCostCenterResponse(BaseModel):
    """
    PositionCostCenterResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    effective_date: Optional[StrictStr] = Field(default=None, alias="effectiveDate")
    cost_center: Optional[IdCodeNameResponse] = Field(default=None, alias="costCenter")
    ...
    __properties: ClassVar[List[str]] = ["id", "effectiveDate", "costCenter", "position", "createdBy", "createdDate", "updatedBy", "updatedDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "costCenter": IdCodeNameResponse.from_dict(obj["costCenter"]) if obj.get("costCenter") is not None else None,
