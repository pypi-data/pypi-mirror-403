...
class FingerprintResponse(BaseModel):
    ...
    FingerprintResponse
    """ # noqa: E501
    successes: Optional[List[FingerprintSuccessItemResponse]] = None
    failures: Optional[List[FingerprintFailureItemResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "successes": [FingerprintSuccessItemResponse.from_dict(_item) for _item in obj["successes"]] if obj.get("successes") is not None else None,
            "failures": [FingerprintFailureItemResponse.from_dict(_item) for _item in obj["failures"]] if obj.get("failures") is not None else None
        })
        return _obj
