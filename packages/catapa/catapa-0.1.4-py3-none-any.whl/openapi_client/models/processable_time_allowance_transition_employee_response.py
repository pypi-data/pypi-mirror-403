...
class ProcessableTimeAllowanceTransitionEmployeeResponse(BaseModel):
    """
    ...
    employment_status: Optional[ProcessableTimeAllowanceTransitionEmploymentStatusResponse] = Field(default=None, alias="employmentStatus")
    __properties: ClassVar[List[str]] = ["id", "identificationNumber", "name", "employmentStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "employmentStatus": ProcessableTimeAllowanceTransitionEmploymentStatusResponse.from_dict(obj["employmentStatus"]) if obj.get("employmentStatus") is not None else None
        })
        return _obj
