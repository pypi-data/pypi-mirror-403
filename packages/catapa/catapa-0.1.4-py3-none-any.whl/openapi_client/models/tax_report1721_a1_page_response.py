...
class TaxReport1721A1PageResponse(BaseModel):
    """
    ...
    content: Optional[List[TaxReport1721A1Response]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": [TaxReport1721A1Response.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None
        })
        return _obj
