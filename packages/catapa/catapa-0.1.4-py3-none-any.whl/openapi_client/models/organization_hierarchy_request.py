...
class OrganizationHierarchyRequest(BaseModel):
    """
    OrganizationHierarchyRequest
    """ # noqa: E501
    code: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    color: Optional[Annotated[str, Field(min_length=7, strict=True, max_length=7)]] = Field(default=None, description="Hexadecimal color code, e.g. `#62A4D5`")
    level: Union[Annotated[float, Field(le=99, strict=True, ge=1)], Annotated[int, Field(le=99, strict=True, ge=1)]]
    __properties: ClassVar[List[str]] = ["code", "name", "color", "level"]
