...
class PaygroupResponse(BaseModel):
    """
    PaygroupResponse
    """ # noqa: E501
    ...
    cutoff_type: Optional[StrictStr] = Field(default=None, alias="cutoffType")
    cutoff_day_of_week: Optional[StrictStr] = Field(default=None, alias="cutoffDayOfWeek")
    daily_cutoff_date: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="dailyCutoffDate")
    daily_cutoff_base: Optional[StrictStr] = Field(default=None, alias="dailyCutoffBase")
    default_paygroup: Optional[StrictBool] = Field(default=None, alias="defaultPaygroup")
    monthly_cutoff_date: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="monthlyCutoffDate")
    __properties: ClassVar[List[str]] = ["id", "code", "name", "cutoffType", "cutoffDayOfWeek", "dailyCutoffDate", "dailyCutoffBase", "defaultPaygroup", "monthlyCutoffDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "name": obj.get("name"),
            "cutoffType": obj.get("cutoffType"),
            "cutoffDayOfWeek": obj.get("cutoffDayOfWeek"),
            "dailyCutoffDate": obj.get("dailyCutoffDate"),
            "dailyCutoffBase": obj.get("dailyCutoffBase"),
            "defaultPaygroup": obj.get("defaultPaygroup"),
            "monthlyCutoffDate": obj.get("monthlyCutoffDate")
        })
        return _obj
