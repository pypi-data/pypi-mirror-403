...
class EmployeeVariableMetadataRequest(BaseModel):
    """
    ...
    validations: Optional[List[EmployeeVariableValidationRequest]] = None
    __properties: ClassVar[List[str]] = ["name", "type", "periodic", "description", "validations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "validations": [EmployeeVariableValidationRequest.from_dict(_item) for _item in obj["validations"]] if obj.get("validations") is not None else None
        })
        return _obj
