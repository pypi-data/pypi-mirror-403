...
class SeverancePaymentPlanResponse(BaseModel):
    """
    SeverancePaymentPlanResponse
    """ # noqa: E501
    id: Optional[UUID] = None
    termination_entry_id: Optional[UUID] = Field(default=None, alias="terminationEntryId")
    termination_entry_code: Optional[StrictStr] = Field(default=None, alias="terminationEntryCode")
    employee_id: Optional[UUID] = Field(default=None, alias="employeeId")
    employee_identification_number: Optional[StrictStr] = Field(default=None, alias="employeeIdentificationNumber")
    employee_name: Optional[StrictStr] = Field(default=None, alias="employeeName")
    termination_reason_id: Optional[UUID] = Field(default=None, alias="terminationReasonId")
    termination_reason_name: Optional[StrictStr] = Field(default=None, alias="terminationReasonName")
    ...
    non_taxable_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="nonTaxableAmount")
    thp_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="thpAmount")
    pph_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="pphAmount")
    tax_allowance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="taxAllowance")
    __properties: ClassVar[List[str]] = ["id", "terminationEntryId", "terminationEntryCode", "employeeId", "employeeIdentificationNumber", "employeeName", "terminationReasonId", "terminationReasonName", "terminationDate", "plannedDate", "paymentDate", "paymentMethod", "paymentOption", "amount", "nonTaxableAmount", "thpAmount", "pphAmount", "taxAllowance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "terminationEntryId": obj.get("terminationEntryId"),
            "terminationEntryCode": obj.get("terminationEntryCode"),
            "employeeId": obj.get("employeeId"),
            "employeeIdentificationNumber": obj.get("employeeIdentificationNumber"),
            "employeeName": obj.get("employeeName"),
            "terminationReasonId": obj.get("terminationReasonId"),
            "terminationReasonName": obj.get("terminationReasonName"),
            "terminationDate": obj.get("terminationDate"),
            "plannedDate": obj.get("plannedDate"),
            "paymentDate": obj.get("paymentDate"),
            "paymentMethod": obj.get("paymentMethod"),
            "paymentOption": obj.get("paymentOption"),
            "amount": obj.get("amount"),
            "nonTaxableAmount": obj.get("nonTaxableAmount"),
            "thpAmount": obj.get("thpAmount"),
            "pphAmount": obj.get("pphAmount"),
