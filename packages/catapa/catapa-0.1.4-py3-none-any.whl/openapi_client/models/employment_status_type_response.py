...
class EmploymentStatusTypeResponse(BaseModel):
    """
    EmploymentStatusTypeResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    default_data: Optional[StrictBool] = Field(default=None, alias="defaultData")
    employment_status_number_type: Optional[StrictStr] = Field(default=None, alias="employmentStatusNumberType")
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "defaultData", "employmentStatusNumberType", "name"]

    @field_validator('employment_status_number_type')
    def employment_status_number_type_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['PKWT_NUMBER', 'EMPLOYMENT_STATUS_CHANGE_NUMBER']):
            raise ValueError("must be one of enum values ('PKWT_NUMBER', 'EMPLOYMENT_STATUS_CHANGE_NUMBER')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "employmentStatusNumberType": obj.get("employmentStatusNumberType"),
            "name": obj.get("name")
        })
        return _obj
