...
class WidgetContentResponse(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Content identifier")
    title: Optional[StrictStr] = Field(default=None, description="Content title")
    size: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Content size")
    __properties: ClassVar[List[str]] = ["id", "title", "size"]
