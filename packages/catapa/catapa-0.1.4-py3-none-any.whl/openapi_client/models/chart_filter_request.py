...
class ChartFilterRequest(BaseModel):
    ...
    chart_filter_type: Optional[StrictStr] = Field(default=None, alias="chartFilterType")
    chart_value_collection_filters: Optional[List[ChartValueCollectionFilterRequest]] = Field(default=None, alias="chartValueCollectionFilters")
    ...
    __properties: ClassVar[List[str]] = ["columnId", "chartFilterType", "chartValueCollectionFilters", "startDate", "endDate", "timeFrame", "timeUnit", "duration"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in chart_value_collection_filters (list)
        _items = []
        if self.chart_value_collection_filters:
            for _item_chart_value_collection_filters in self.chart_value_collection_filters:
                if _item_chart_value_collection_filters:
                    _items.append(_item_chart_value_collection_filters.to_dict())
            _dict['chartValueCollectionFilters'] = _items
        # set to None if chart_value_collection_filters (nullable) is None
        # and model_fields_set contains the field
        if self.chart_value_collection_filters is None and "chart_value_collection_filters" in self.model_fields_set:
            _dict['chartValueCollectionFilters'] = None
        ...
        # set to None if time_frame (nullable) is None
        # and model_fields_set contains the field
        if self.time_frame is None and "time_frame" in self.model_fields_set:
            _dict['timeFrame'] = None

        # set to None if time_unit (nullable) is None
        # and model_fields_set contains the field
        if self.time_unit is None and "time_unit" in self.model_fields_set:
            _dict['timeUnit'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "chartFilterType": obj.get("chartFilterType"),
            "chartValueCollectionFilters": [ChartValueCollectionFilterRequest.from_dict(_item) for _item in obj["chartValueCollectionFilters"]] if obj.get("chartValueCollectionFilters") is not None else None,
