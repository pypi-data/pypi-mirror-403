...
class CalculationScenarioPreviousJobComponent(BaseModel):
    """
    CalculationScenarioPreviousJobComponent
    """ # noqa: E501
    net_income: Optional[Union[StrictFloat, StrictInt]] = Field(default=0, alias="netIncome")
    tax: Optional[Union[StrictFloat, StrictInt]] = 0
    __properties: ClassVar[List[str]] = ["netIncome", "tax"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "netIncome": obj.get("netIncome") if obj.get("netIncome") is not None else 0,
            "tax": obj.get("tax") if obj.get("tax") is not None else 0
        })
        return _obj
