...
class EmploymentDataResponse(BaseModel):
    ...
    position: Optional[EmploymentDataPositionResponse] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "contractStart", "contractEnd", "costCenter", "effectiveDate", "employmentStatusNumber", "employmentStatusType", "employmentType", "jobLevel", "jobTitle", "location", "organization", "position", "permanentDate", "signDate", "subLocation", "operationalGroup"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "position": EmploymentDataPositionResponse.from_dict(obj["position"]) if obj.get("position") is not None else None,
