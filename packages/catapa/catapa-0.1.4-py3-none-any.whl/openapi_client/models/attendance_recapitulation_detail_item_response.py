...
class AttendanceRecapitulationDetailItemResponse(BaseModel):
    """
    ...
    overtime: Optional[AttendanceRecapitulationDetailOvertimeResponse] = None
    attendances: Optional[List[AttendanceRecapitulationDetailAttendanceItemResponse]] = None
    __properties: ClassVar[List[str]] = ["employee", "date", "shift", "overtime", "attendances"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of overtime
        if self.overtime:
            _dict['overtime'] = self.overtime.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "date": obj.get("date"),
            "shift": ShiftResponse.from_dict(obj["shift"]) if obj.get("shift") is not None else None,
            "overtime": AttendanceRecapitulationDetailOvertimeResponse.from_dict(obj["overtime"]) if obj.get("overtime") is not None else None,
            "attendances": [AttendanceRecapitulationDetailAttendanceItemResponse.from_dict(_item) for _item in obj["attendances"]] if obj.get("attendances") is not None else None
        })
        return _obj
