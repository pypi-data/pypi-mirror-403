...
class EditableSalaryPreprocessApi:
    ...
    def preprocess_editable_salary(
        self,
        editable_salary_preprocess_request: Annotated[List[EditableSalaryPreprocessRequest], Field(min_length=1, max_length=50)],
        ...
        :param editable_salary_preprocess_request: (required)
        :type editable_salary_preprocess_request: List[EditableSalaryPreprocessRequest]
        ...
        _param = self._preprocess_editable_salary_serialize(
            editable_salary_preprocess_request=editable_salary_preprocess_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "EditableSalaryPreprocessResponse",
            '400': None,
        }
    ...
    @validate_call
    def preprocess_editable_salary_with_http_info(
        self,
        editable_salary_preprocess_request: Annotated[List[EditableSalaryPreprocessRequest], Field(min_length=1, max_length=50)],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EditableSalaryPreprocessResponse]:
        """Preprocess editable salary
    ...
    @validate_call
    def preprocess_editable_salary_without_preload_content(
        self,
        editable_salary_preprocess_request: Annotated[List[EditableSalaryPreprocessRequest], Field(min_length=1, max_length=50)],
        _request_timeout: Union[
            None,
    ...
    def _preprocess_editable_salary_serialize(
        self,
        editable_salary_preprocess_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if editable_salary_preprocess_request is not None:
            _body_params = editable_salary_preprocess_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/core/v1/editable-salary-preprocess',
