...
class AnalyticsApi:
    ...
    def create_analytics_chart(
        self,
        analytics_chart_request: Optional[AnalyticsChartRequest] = None,
        ...
        :param analytics_chart_request:
        :type analytics_chart_request: AnalyticsChartRequest
        ...
        _param = self._create_analytics_chart_serialize(
    ...
    @validate_call
    def create_analytics_chart_with_http_info(
        self,
        analytics_chart_request: Optional[AnalyticsChartRequest] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AnalyticsChartResponse]:
        """Create Analytics Chart
    ...
    @validate_call
    def create_analytics_chart_without_preload_content(
        self,
        analytics_chart_request: Optional[AnalyticsChartRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_analytics_chart_serialize(
        self,
        ...
        if analytics_chart_request is not None:
            _body_params = analytics_chart_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/core/v1/analytics/charts',
    ...
    def get_analytics_chart(
        ...
        _param = self._get_analytics_chart_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AnalyticsChartPageResponse",
            '400': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_analytics_chart_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AnalyticsChartPageResponse]:
        """Get Analytics Chart Data
    ...
    @validate_call
    def get_analytics_chart_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_analytics_chart_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def get_analytics_data_by_chart_id_and_current_user(
        ...
        _param = self._get_analytics_data_by_chart_id_and_current_user_serialize(
            tenant=tenant,
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "AnalyticsChartDataResponse",
            '400': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_analytics_data_by_chart_id_and_current_user_with_http_info(
        self,
        tenant: StrictStr,
        id: StrictStr,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AnalyticsChartDataResponse]:
        """Get Analytics Data by Chart ID and Current User
    ...
    @validate_call
    def get_analytics_data_by_chart_id_and_current_user_without_preload_content(
        self,
        tenant: StrictStr,
        id: StrictStr,
        _request_timeout: Union[
    ...
    def _get_analytics_data_by_chart_id_and_current_user_serialize(
        self,
        tenant,
        id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/users/me/analytics/charts/{id}/data',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
