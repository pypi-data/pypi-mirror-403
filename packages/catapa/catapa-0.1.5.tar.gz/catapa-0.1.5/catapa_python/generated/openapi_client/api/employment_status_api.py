...
class EmploymentStatusApi:
    ...
    def get_employment_status_by_employee(
        ...
        query: Annotated[Optional[StrictStr], Field(description="### Search query | Supported Keys | Supported Operators | Notes                                                                                                                                | |----------------|---------------------|--------------------------------------------------------------------------------------------------------------------------------------| | effectiveDate  | `>`<br/>`<`         | Greater than or equal operator<br/>Less than or equal operator<br/><br/>Use the `YYYY-MM-DD` format, e.g. `effectiveDate>2023-09-20` | ")] = None,
        ...
        """(Deprecated) Get Employment Status by Employee
        ...
        :param query: ### Search query | Supported Keys | Supported Operators | Notes                                                                                                                                | |----------------|---------------------|--------------------------------------------------------------------------------------------------------------------------------------| | effectiveDate  | `>`<br/>`<`         | Greater than or equal operator<br/>Less than or equal operator<br/><br/>Use the `YYYY-MM-DD` format, e.g. `effectiveDate>2023-09-20` | 
        :type query: str
        ...
        """ # noqa: E501
        warnings.warn("GET /core/v1/employees/{employeeId}/employment-data is deprecated.", DeprecationWarning)

        _param = self._get_employment_status_by_employee_serialize(
    ...
    @validate_call
    def get_employment_status_by_employee_with_http_info(
        self,
        employee_id: StrictStr,
        query: Annotated[Optional[StrictStr], Field(description="### Search query | Supported Keys | Supported Operators | Notes                                                                                                                                | |----------------|---------------------|--------------------------------------------------------------------------------------------------------------------------------------| | effectiveDate  | `>`<br/>`<`         | Greater than or equal operator<br/>Less than or equal operator<br/><br/>Use the `YYYY-MM-DD` format, e.g. `effectiveDate>2023-09-20` | ")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EmploymentDataResponse]:
        """(Deprecated) Get Employment Status by Employee
    ...
    @validate_call
    def get_employment_status_by_employee_without_preload_content(
        self,
        employee_id: StrictStr,
        query: Annotated[Optional[StrictStr], Field(description="### Search query | Supported Keys | Supported Operators | Notes                                                                                                                                | |----------------|---------------------|--------------------------------------------------------------------------------------------------------------------------------------| | effectiveDate  | `>`<br/>`<`         | Greater than or equal operator<br/>Less than or equal operator<br/><br/>Use the `YYYY-MM-DD` format, e.g. `effectiveDate>2023-09-20` | ")] = None,
        _request_timeout: Union[
    ...
    def _get_employment_status_by_employee_serialize(
        self,
        employee_id,
        query,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/employees/{employeeId}/employment-data',
    ...
    def get_employment_status_histories(
        ...
        _param = self._get_employment_status_histories_serialize(
            page=page,
            size=size,
            query=query,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "EmploymentStatusHistoryPageResponse",
            '400': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_employment_status_histories_with_http_info(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Page number")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Page size")] = None,
        query: Annotated[Optional[StrictStr], Field(description="### Search Query | Supported Keys     | Supported Operators | Notes                                                                                     | |--------------------|---------------------|-------------------------------------------------------------------------------------------| | id                 | `:`                 | Equal operator<br/>Support multiple values with each value separated by the `;` delimiter | | employee.id        | `:`                 | Equal operator<br/>Support multiple values with each value separated by the `;` delimiter | | effectiveDate      | `<`                 | Less than or equal to<br/><br/>Use `yyyy-MM-dd` format, e.g. `effectiveDate<2025-01-31  ` | ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EmploymentStatusHistoryPageResponse]:
        """Get Employment Status Histories
    ...
    @validate_call
    def get_employment_status_histories_without_preload_content(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Page number")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Page size")] = None,
        query: Annotated[Optional[StrictStr], Field(description="### Search Query | Supported Keys     | Supported Operators | Notes                                                                                     | |--------------------|---------------------|-------------------------------------------------------------------------------------------| | id                 | `:`                 | Equal operator<br/>Support multiple values with each value separated by the `;` delimiter | | employee.id        | `:`                 | Equal operator<br/>Support multiple values with each value separated by the `;` delimiter | | effectiveDate      | `<`                 | Less than or equal to<br/><br/>Use `yyyy-MM-dd` format, e.g. `effectiveDate<2025-01-31  ` | ")] = None,
    ...
    def _get_employment_status_histories_serialize(
        self,
        page,
        size,
        query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/employment-status-histories',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_employment_statuses(
        ...
        _param = self._get_employment_statuses_serialize(
            page=page,
            size=size,
            query=query,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "EmploymentStatusPageResponse",
            '400': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_employment_statuses_with_http_info(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Page number")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Page size")] = None,
        query: Annotated[Optional[StrictStr], Field(description="### Search Query | Supported Keys     | Supported Operators | Notes                                                                                     | |--------------------|---------------------|-------------------------------------------------------------------------------------------| | id                 | `:`                 | Equal operator<br/>Support multiple values with each value separated by the `;` delimiter | | employee.id        | `:`                 | Equal operator<br/>Support multiple values with each value separated by the `;` delimiter | ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EmploymentStatusPageResponse]:
        """Get Employment Statuses
    ...
    @validate_call
    def get_employment_statuses_without_preload_content(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Page number")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Page size")] = None,
        query: Annotated[Optional[StrictStr], Field(description="### Search Query | Supported Keys     | Supported Operators | Notes                                                                                     | |--------------------|---------------------|-------------------------------------------------------------------------------------------| | id                 | `:`                 | Equal operator<br/>Support multiple values with each value separated by the `;` delimiter | | employee.id        | `:`                 | Equal operator<br/>Support multiple values with each value separated by the `;` delimiter | ")] = None,
    ...
    def _get_employment_statuses_serialize(
        self,
        page,
        size,
        query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/employment-statuses',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_employment_status_by_employee(
        self,
        employee_id: StrictStr,
        employment_data_request: Optional[EmploymentDataRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param employee_id: (required)
        :type employee_id: str
        :param employment_data_request:
        :type employment_data_request: EmploymentDataRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_employment_status_by_employee_serialize(
            employee_id=employee_id,
            employment_data_request=employment_data_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_employment_status_by_employee_with_http_info(
        self,
        employee_id: StrictStr,
        employment_data_request: Optional[EmploymentDataRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_employment_status_by_employee_without_preload_content(
        self,
        employee_id: StrictStr,
        employment_data_request: Optional[EmploymentDataRequest] = None,
        _request_timeout: Union[
    ...
    def _update_employment_status_by_employee_serialize(
        self,
        employee_id,
        ...
        # process the form parameters
        # process the body parameter
        if employment_data_request is not None:
            _body_params = employment_data_request
