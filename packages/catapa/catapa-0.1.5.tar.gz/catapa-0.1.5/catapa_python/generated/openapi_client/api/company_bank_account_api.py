...
class CompanyBankAccountApi:
    ...
    def get_company_bank_accounts(
        ...
        _param = self._get_company_bank_accounts_serialize(
            page=page,
            size=size,
            query=query,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CompanyBankAccountPageResponse",
            '400': None,
        }
    ...
    @validate_call
    def get_company_bank_accounts_with_http_info(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Page number")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Page size")] = None,
        query: Annotated[Optional[StrictStr], Field(description="### Search query   | Supported Keys         | Supported Operators | Notes                                                         | |------------------------|---------------------|---------------------------------------------------------------| | id                     | `:`                 | Equal operator with multiple values. Each value should separated with delimiters `;` |                                                | ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CompanyBankAccountPageResponse]:
        """Get Company Bank Accounts
    ...
    @validate_call
    def get_company_bank_accounts_without_preload_content(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Page number")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Page size")] = None,
        query: Annotated[Optional[StrictStr], Field(description="### Search query   | Supported Keys         | Supported Operators | Notes                                                         | |------------------------|---------------------|---------------------------------------------------------------| | id                     | `:`                 | Equal operator with multiple values. Each value should separated with delimiters `;` |                                                | ")] = None,
    ...
    def _get_company_bank_accounts_serialize(
        self,
        page,
        size,
        query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/company-bank-accounts',
