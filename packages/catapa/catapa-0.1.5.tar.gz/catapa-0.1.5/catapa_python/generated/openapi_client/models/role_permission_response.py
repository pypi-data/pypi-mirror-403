...
class RolePermissionResponse(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Permission identifier")
    data_id: Optional[StrictStr] = Field(default=None, description="Data identifier (e.g., organization ID, location ID, or \"ALL\")", alias="dataId")
    data_type: Optional[StrictStr] = Field(default=None, description="Type of data this permission applies to", alias="dataType")
    role: Optional[RoleIdNameResponse] = Field(default=None, description="Role associated with this permission")
    __properties: ClassVar[List[str]] = ["id", "dataId", "dataType", "role"]
    ...
    def data_type_validate_enum(cls, value):
        ...
        if value not in set(['ORGANIZATION', 'LOCATION', 'OTHER']):
            raise ValueError("must be one of enum values ('ORGANIZATION', 'LOCATION', 'OTHER')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "role": RoleIdNameResponse.from_dict(obj["role"]) if obj.get("role") is not None else None
        })
        return _obj
