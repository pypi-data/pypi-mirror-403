...
class AnomalySuspectFileResponse(BaseModel):
    """
    ...
    url: Optional[StrictStr] = Field(default=None, description="URL to access the file")
    __properties: ClassVar[List[str]] = ["filename", "path", "url"]
