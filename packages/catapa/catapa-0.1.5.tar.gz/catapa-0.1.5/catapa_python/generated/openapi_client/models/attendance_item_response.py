...
class AttendanceItemResponse(BaseModel):
    ...
    time_in: Optional[StrictStr] = Field(default=None, alias="timeIn")
    time_out: Optional[StrictStr] = Field(default=None, alias="timeOut")
    attendance_status_in: Optional[AttendanceStatusResponse] = Field(default=None, alias="attendanceStatusIn")
    __properties: ClassVar[List[str]] = ["id", "employee", "date", "timeIn", "timeOut", "attendanceStatusIn"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of attendance_status_in
        if self.attendance_status_in:
            _dict['attendanceStatusIn'] = self.attendance_status_in.to_dict()
        # set to None if time_in (nullable) is None
        # and model_fields_set contains the field
        if self.time_in is None and "time_in" in self.model_fields_set:
            _dict['timeIn'] = None

        # set to None if time_out (nullable) is None
        # and model_fields_set contains the field
        if self.time_out is None and "time_out" in self.model_fields_set:
            _dict['timeOut'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "date": obj.get("date"),
            "timeIn": obj.get("timeIn"),
            "timeOut": obj.get("timeOut"),
            "attendanceStatusIn": AttendanceStatusResponse.from_dict(obj["attendanceStatusIn"]) if obj.get("attendanceStatusIn") is not None else None
        })
        return _obj
