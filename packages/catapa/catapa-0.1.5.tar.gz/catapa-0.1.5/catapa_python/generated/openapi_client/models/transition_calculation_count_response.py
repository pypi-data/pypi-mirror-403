...
class TransitionCalculationCountResponse(BaseModel):
    """
    TransitionCalculationCountResponse
    """ # noqa: E501
    processed_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="processedCount")
    unprocessed_count: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="unprocessedCount")
    __properties: ClassVar[List[str]] = ["processedCount", "unprocessedCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unprocessedCount": obj.get("unprocessedCount")
        })
        return _obj
