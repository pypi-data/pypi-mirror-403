...
class KppPageResponse(BaseModel):
    """
    KppPageResponse
    """ # noqa: E501
    ...
    content: Optional[List[KppResponse]] = Field(default=None, description="List of KPPs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": [KppResponse.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None
        })
        return _obj
