...
class JobLevelRequest(BaseModel):
    """
    JobLevelRequest
    """ # noqa: E501
    code: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    level: Union[Annotated[float, Field(le=99, strict=True, ge=1)], Annotated[int, Field(le=99, strict=True, ge=1)]]
    job_position_id: Optional[StrictStr] = Field(default=None, alias="jobPositionId")
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    __properties: ClassVar[List[str]] = ["code", "level", "jobPositionId", "name"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if job_position_id (nullable) is None
        # and model_fields_set contains the field
        if self.job_position_id is None and "job_position_id" in self.model_fields_set:
            _dict['jobPositionId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "level": obj.get("level"),
            "jobPositionId": obj.get("jobPositionId"),
            "name": obj.get("name")
        })
        return _obj
