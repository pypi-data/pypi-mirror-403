...
class TaxMembershipPeriodResponse(BaseModel):
    """
    TaxMembershipPeriodResponse
    """ # noqa: E501
    month: Optional[Annotated[int, Field(le=12, strict=True, ge=1)]] = Field(default=None, description="Month of membership start period")
    year: Optional[Annotated[int, Field(strict=True, ge=1970)]] = Field(default=None, description="Year of membership start period")
