...
class CompanyDetailTimeZoneRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    code: StrictStr
    offset: Annotated[str, Field(strict=True)] = Field(description="The `offset` must be between `-18` and `+18` hours, e.g. `+07:00`")
    __properties: ClassVar[List[str]] = ["code", "offset"]
