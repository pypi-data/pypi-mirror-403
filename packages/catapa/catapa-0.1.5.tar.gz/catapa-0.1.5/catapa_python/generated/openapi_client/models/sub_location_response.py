...
class SubLocationResponse(BaseModel):
    ...
    location: Optional[SubLocationLocationResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "name": obj.get("name"),
            "location": SubLocationLocationResponse.from_dict(obj["location"]) if obj.get("location") is not None else None
        })
        return _obj
