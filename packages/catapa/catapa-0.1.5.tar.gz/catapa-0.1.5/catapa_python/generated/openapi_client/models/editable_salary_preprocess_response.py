...
class EditableSalaryPreprocessResponse(BaseModel):
    """
    EditableSalaryPreprocessResponse
    """ # noqa: E501
    successes: Optional[List[EditableSalaryPreprocessSuccess]] = None
    failures: Optional[List[BulkOperationFailureResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "successes": [EditableSalaryPreprocessSuccess.from_dict(_item) for _item in obj["successes"]] if obj.get("successes") is not None else None,
            "failures": [BulkOperationFailureResponse.from_dict(_item) for _item in obj["failures"]] if obj.get("failures") is not None else None
        })
        return _obj
