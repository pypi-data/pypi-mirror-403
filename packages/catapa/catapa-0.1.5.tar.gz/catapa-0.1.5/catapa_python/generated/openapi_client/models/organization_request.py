...
class OrganizationRequest(BaseModel):
    ...
    organization_hierarchy_id: StrictStr = Field(alias="organizationHierarchyId")
    organization_parent_id: Optional[StrictStr] = Field(default=None, alias="organizationParentId")
    name: Annotated[str, Field(min_length=3, strict=True, max_length=255)]
    type: StrictStr
    organization_group_id: Optional[StrictStr] = Field(default=None, alias="organizationGroupId")
    company_id: Optional[StrictStr] = Field(default=None, description="If the request is null, then it will default to the earliest company created in the system.", alias="companyId")
    __properties: ClassVar[List[str]] = ["code", "organizationHierarchyId", "organizationParentId", "name", "type", "organizationGroupId", "companyId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if organization_parent_id (nullable) is None
        # and model_fields_set contains the field
        if self.organization_parent_id is None and "organization_parent_id" in self.model_fields_set:
            _dict['organizationParentId'] = None

        # set to None if organization_group_id (nullable) is None
        # and model_fields_set contains the field
        if self.organization_group_id is None and "organization_group_id" in self.model_fields_set:
            _dict['organizationGroupId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "organizationHierarchyId": obj.get("organizationHierarchyId"),
            "organizationParentId": obj.get("organizationParentId"),
            "name": obj.get("name"),
            "type": obj.get("type"),
            "organizationGroupId": obj.get("organizationGroupId"),
