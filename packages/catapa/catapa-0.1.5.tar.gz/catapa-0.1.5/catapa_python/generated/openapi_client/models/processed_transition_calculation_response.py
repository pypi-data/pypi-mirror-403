...
class ProcessedTransitionCalculationResponse(BaseModel):
    """
    ...
    messages: Optional[List[UnprocessableMessage]] = None
    ...
    __properties: ClassVar[List[str]] = ["costCenter", "employee", "employeeSalaryTemplateHistory", "employeeWorkday", "employmentType", "endDate", "id", "jobTitle", "location", "messages", "normalWorkday", "organization", "paymentProcess", "startDate", "totalThp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "messages": [UnprocessableMessage.from_dict(_item) for _item in obj["messages"]] if obj.get("messages") is not None else None,
