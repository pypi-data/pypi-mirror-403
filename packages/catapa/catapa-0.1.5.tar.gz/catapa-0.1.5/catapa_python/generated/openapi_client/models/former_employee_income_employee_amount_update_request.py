...
class FormerEmployeeIncomeEmployeeAmountUpdateRequest(BaseModel):
    """
    FormerEmployeeIncomeEmployeeAmountUpdateRequest
    """ # noqa: E501
    id: StrictStr = Field(description="Employee income ID")
    amount: Union[StrictFloat, StrictInt] = Field(description="Updated amount")
