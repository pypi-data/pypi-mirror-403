...
class EmployeeCreateResponse(BaseModel):
    ...
    citizenship: Optional[Dict[str, Any]] = None
    ...
    join_date: Optional[StrictStr] = Field(default=None, alias="joinDate")
    start_date: Optional[StrictStr] = Field(default=None, alias="startDate")
    gender: Optional[StrictStr] = None
    point_of_hire: Optional[PointOfHireResponse] = Field(default=None, alias="pointOfHire")
    ...
    contract_start: Optional[StrictStr] = Field(default=None, alias="contractStart")
    contract_end: Optional[StrictStr] = Field(default=None, alias="contractEnd")
    identity_card_number: Optional[StrictStr] = Field(default=None, alias="identityCardNumber")
    identity_card_expired_date: Optional[date] = Field(default=None, alias="identityCardExpiredDate")
    email: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "maritalStatus", "religion", "foreignLabour", "citizenship", "identificationNumber", "name", "dateOfBirth", "placeOfBirth", "joinDate", "startDate", "gender", "pointOfHire", "employmentStatusNumber", "organization", "jobTitle", "jobLevel", "location", "employmentType", "contractStart", "contractEnd", "identityCardNumber", "identityCardExpiredDate", "email"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of point_of_hire
        if self.point_of_hire:
            _dict['pointOfHire'] = self.point_of_hire.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pointOfHire": PointOfHireResponse.from_dict(obj["pointOfHire"]) if obj.get("pointOfHire") is not None else None,
