...
class CalculationScenarioComponent(BaseModel):
    """
    CalculationScenarioComponent
    """ # noqa: E501
    first_component: Optional[CalculationScenarioSalaryComponent] = Field(default=None, alias="firstComponent")
    second_component: Optional[CalculationScenarioSalaryComponent] = Field(default=None, alias="secondComponent")
    __properties: ClassVar[List[str]] = ["firstComponent", "secondComponent"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of first_component
        if self.first_component:
            _dict['firstComponent'] = self.first_component.to_dict()
        # override the default output from pydantic by calling `to_dict()` of second_component
        if self.second_component:
            _dict['secondComponent'] = self.second_component.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "firstComponent": CalculationScenarioSalaryComponent.from_dict(obj["firstComponent"]) if obj.get("firstComponent") is not None else None,
            "secondComponent": CalculationScenarioSalaryComponent.from_dict(obj["secondComponent"]) if obj.get("secondComponent") is not None else None
        })
        return _obj
