...
class EmployeeIdentityCardRequest(BaseModel):
    """
    EmployeeIdentityCardRequest
    """ # noqa: E501
    identity_card_id: StrictStr = Field(alias="identityCardId")
    identity_card_number: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(description="Alphanumeric", alias="identityCardNumber")
    expired_date: Optional[date] = Field(default=None, alias="expiredDate")
    __properties: ClassVar[List[str]] = ["identityCardId", "identityCardNumber", "expiredDate"]

    @field_validator('identity_card_number')
    def identity_card_number_validate_regular_expression(cls, value):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "identityCardId": obj.get("identityCardId"),
