...
class SeverancePlanResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "kpp", "paymentMethod", "pph21Method", "paymentOption", "total", "totalThp", "totalPph", "taxAllowance"]
