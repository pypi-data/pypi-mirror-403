...
class CurrencyResponse(BaseModel):
    ...
    payroll_rate: Optional[Dict[str, Any]] = Field(default=None, alias="payrollRate")
    tax_rate: Optional[Dict[str, Any]] = Field(default=None, alias="taxRate")
    base_currency: Optional[StrictBool] = Field(default=None, alias="baseCurrency")
    __properties: ClassVar[List[str]] = ["id", "createdBy", "createdDate", "updatedBy", "updatedDate", "code", "name", "payrollRate", "taxRate", "baseCurrency"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if payroll_rate (nullable) is None
        # and model_fields_set contains the field
        if self.payroll_rate is None and "payroll_rate" in self.model_fields_set:
            _dict['payrollRate'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "name": obj.get("name"),
            "payrollRate": obj.get("payrollRate"),
