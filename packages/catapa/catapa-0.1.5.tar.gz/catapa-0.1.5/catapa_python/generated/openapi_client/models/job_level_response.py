...
class JobLevelResponse(BaseModel):
    ...
    job_position: Optional[IdCodeNameResponse] = Field(default=None, alias="jobPosition")
    level: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["id", "code", "name", "jobPosition", "level"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of job_position
        if self.job_position:
            _dict['jobPosition'] = self.job_position.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "name": obj.get("name"),
            "jobPosition": IdCodeNameResponse.from_dict(obj["jobPosition"]) if obj.get("jobPosition") is not None else None,
            "level": obj.get("level")
        })
        return _obj
