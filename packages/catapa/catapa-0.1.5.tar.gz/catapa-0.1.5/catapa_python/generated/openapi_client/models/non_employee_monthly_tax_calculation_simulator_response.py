...
class NonEmployeeMonthlyTaxCalculationSimulatorResponse(MonthlyTaxCalculationSimulatorResponse):
    """
    ...
    base_income: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="baseIncome")
    ...
    __properties: ClassVar[List[str]] = ["monthlyGrossIncome", "percentage", "monthlyTax", "nettoTax", "type", "basicSalary", "taxAllowance", "baseIncome", "baseIncomeTaxDeduction", "baseIncomeTax"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['NON_EMPLOYEE']):
            raise ValueError("must be one of enum values ('NON_EMPLOYEE')")
        return value
