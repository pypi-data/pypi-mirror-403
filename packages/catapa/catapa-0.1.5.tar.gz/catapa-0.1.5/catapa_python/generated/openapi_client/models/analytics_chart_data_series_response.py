...
class AnalyticsChartDataSeriesResponse(BaseModel):
    """
    AnalyticsChartDataSeriesResponse
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Series name")
    data: Optional[List[Union[StrictFloat, StrictInt]]] = Field(default=None, description="Series data points")
