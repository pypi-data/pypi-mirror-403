...
class HolidayItemResponse(BaseModel):
    """
    HolidayItemResponse
    """ # noqa: E501
    holiday_date: Optional[date] = Field(default=None, description="Date of the holiday", alias="holidayDate")
    name: Optional[StrictStr] = Field(default=None, description="Name of the holiday")
    __properties: ClassVar[List[str]] = ["holidayDate", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "holidayDate": obj.get("holidayDate"),
            "name": obj.get("name")
        })
        return _obj
