...
class EmployeeVariableMetadataResponse(BaseModel):
    """
    ...
    periodic: Optional[StrictBool] = None
    description: Optional[StrictStr] = None
    validations: Optional[List[EmployeeVariableValidationResponse]] = None
    __properties: ClassVar[List[str]] = ["id", "name", "type", "periodic", "description", "validations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "validations": [EmployeeVariableValidationResponse.from_dict(_item) for _item in obj["validations"]] if obj.get("validations") is not None else None
        })
        return _obj
