...
class EmployeeFullResponse(BaseModel):
    ...
    join_date: Optional[date] = Field(default=None, description="YYYY-MM-DD", alias="joinDate")
    start_date: Optional[date] = Field(default=None, description="YYYY-MM-DD", alias="startDate")
    active: Optional[StrictBool] = None
    point_of_hire: Optional[PointOfHireResponse] = Field(default=None, alias="pointOfHire")
    photo: Optional[PhotoResponse] = None
    manager: Optional[EmployeeManagerResponse] = None
    __properties: ClassVar[List[str]] = ["id", "identificationNumber", "name", "joinDate", "startDate", "active", "pointOfHire", "photo", "manager"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "photo": PhotoResponse.from_dict(obj["photo"]) if obj.get("photo") is not None else None,
            "manager": EmployeeManagerResponse.from_dict(obj["manager"]) if obj.get("manager") is not None else None
        })
        return _obj
