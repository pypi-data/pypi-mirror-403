...
class ShiftPatternTemplateListItemResponse(BaseModel):
    """
    ShiftPatternTemplateListItemResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    shift_pattern_template_details: Optional[List[ShiftPatternTemplateDetailResponse]] = Field(default=None, alias="shiftPatternTemplateDetails")
    __properties: ClassVar[List[str]] = ["id", "name", "shiftPatternTemplateDetails"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in shift_pattern_template_details (list)
        _items = []
        if self.shift_pattern_template_details:
            for _item_shift_pattern_template_details in self.shift_pattern_template_details:
                if _item_shift_pattern_template_details:
                    _items.append(_item_shift_pattern_template_details.to_dict())
            _dict['shiftPatternTemplateDetails'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "shiftPatternTemplateDetails": [ShiftPatternTemplateDetailResponse.from_dict(_item) for _item in obj["shiftPatternTemplateDetails"]] if obj.get("shiftPatternTemplateDetails") is not None else None
        })
        return _obj
