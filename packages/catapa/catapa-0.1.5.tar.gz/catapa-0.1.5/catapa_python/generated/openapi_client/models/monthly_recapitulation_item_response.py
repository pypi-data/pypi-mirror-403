...
class MonthlyRecapitulationItemResponse(BaseModel):
    """
    ...
    details: Optional[List[MonthlyRecapitulationItemDetailResponse]] = None
    __properties: ClassVar[List[str]] = ["code", "id", "month", "name", "totalThp", "year", "details"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "year": obj.get("year"),
            "details": [MonthlyRecapitulationItemDetailResponse.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
        return _obj
