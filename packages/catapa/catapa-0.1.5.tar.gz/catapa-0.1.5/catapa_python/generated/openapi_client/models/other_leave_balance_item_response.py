...
class OtherLeaveBalanceItemResponse(BaseModel):
    """
    OtherLeaveBalanceItemResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    employee: Optional[EmployeeSimpleResponse] = None
    other_leave_status: Optional[OtherLeaveStatusResponse] = Field(default=None, alias="otherLeaveStatus")
    ...
    used_balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="usedBalance")
    pending_balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="pendingBalance")
    approved_balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="approvedBalance")
    remaining: Optional[Union[StrictFloat, StrictInt]] = None
    min_leave_date: Optional[StrictStr] = Field(default=None, alias="minLeaveDate")
    max_leave_date: Optional[StrictStr] = Field(default=None, alias="maxLeaveDate")
    active: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "employee", "otherLeaveStatus", "year", "givenDate", "startDate", "endDate", "balance", "usedBalance", "pendingBalance", "approvedBalance", "remaining", "minLeaveDate", "maxLeaveDate", "active"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of other_leave_status
        if self.other_leave_status:
            _dict['otherLeaveStatus'] = self.other_leave_status.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "otherLeaveStatus": OtherLeaveStatusResponse.from_dict(obj["otherLeaveStatus"]) if obj.get("otherLeaveStatus") is not None else None,
            "year": obj.get("year"),
            ...
            "approvedBalance": obj.get("approvedBalance"),
            "remaining": obj.get("remaining"),
            "minLeaveDate": obj.get("minLeaveDate"),
            "maxLeaveDate": obj.get("maxLeaveDate"),
