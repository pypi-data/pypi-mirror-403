...
class TemporaryMonthlyTaxCalculationSimulatorResponse(MonthlyTaxCalculationSimulatorResponse):
    """
    ...
    __properties: ClassVar[List[str]] = ["monthlyGrossIncome", "percentage", "monthlyTax", "nettoTax", "type", "basicSalary", "taxAllowance", "bonus"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['TEMPORARY']):
            raise ValueError("must be one of enum values ('TEMPORARY')")
        return value
