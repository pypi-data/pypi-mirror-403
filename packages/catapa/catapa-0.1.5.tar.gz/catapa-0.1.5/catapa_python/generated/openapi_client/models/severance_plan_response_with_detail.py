...
class SeverancePlanResponseWithDetail(BaseModel):
    """
    ...
    total_pph: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalPph")
    tax_allowance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="taxAllowance")
    details: Optional[List[SeverancePlanDetailResponse]] = None
    payment_plans: Optional[List[SeverancePaymentPlanResponse]] = Field(default=None, alias="paymentPlans")
    __properties: ClassVar[List[str]] = ["id", "kpp", "paymentMethod", "pph21Method", "paymentOption", "total", "totalThp", "totalPph", "taxAllowance", "details", "paymentPlans"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.payment_plans:
            for _item_payment_plans in self.payment_plans:
                if _item_payment_plans:
                    _items.append(_item_payment_plans.to_dict())
            _dict['paymentPlans'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "totalPph": obj.get("totalPph"),
            "taxAllowance": obj.get("taxAllowance"),
            "details": [SeverancePlanDetailResponse.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None,
            "paymentPlans": [SeverancePaymentPlanResponse.from_dict(_item) for _item in obj["paymentPlans"]] if obj.get("paymentPlans") is not None else None
        })
        return _obj
