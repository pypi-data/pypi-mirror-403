...
class FamilyHistoricalResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "gender", "dateOfBirth", "familyRelation", "effectiveDate", "endDate", "createdBy", "createdDate", "updatedBy", "updatedDate"]
