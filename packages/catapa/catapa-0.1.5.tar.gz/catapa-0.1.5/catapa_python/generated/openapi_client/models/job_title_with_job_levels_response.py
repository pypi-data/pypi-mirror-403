...
class JobTitleWithJobLevelsResponse(BaseModel):
    """
    ...
    job_levels: Optional[List[JobLevelResponse]] = Field(default=None, alias="jobLevels")
    __properties: ClassVar[List[str]] = ["id", "code", "name", "jobLevels"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in job_levels (list)
        _items = []
        if self.job_levels:
            for _item_job_levels in self.job_levels:
                if _item_job_levels:
                    _items.append(_item_job_levels.to_dict())
            _dict['jobLevels'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "name": obj.get("name"),
            "jobLevels": [JobLevelResponse.from_dict(_item) for _item in obj["jobLevels"]] if obj.get("jobLevels") is not None else None
        })
        return _obj
