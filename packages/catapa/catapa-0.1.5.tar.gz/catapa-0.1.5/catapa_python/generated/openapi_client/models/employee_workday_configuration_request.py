...
class EmployeeWorkdayConfigurationRequest(BaseModel):
    """
    EmployeeWorkdayConfigurationRequest
    """ # noqa: E501
    start_date: StrictStr = Field(alias="startDate")
    end_date: StrictStr = Field(alias="endDate")
    shift_pattern_template: IdRequest = Field(alias="shiftPatternTemplate")
    start_sequence: Union[StrictFloat, StrictInt] = Field(alias="startSequence")
    include_holiday: StrictBool = Field(alias="includeHoliday")
    include_missing_shift: StrictBool = Field(alias="includeMissingShift")
    employee: IdRequest
    __properties: ClassVar[List[str]] = ["startDate", "endDate", "shiftPatternTemplate", "startSequence", "includeHoliday", "includeMissingShift", "employee"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shiftPatternTemplate": IdRequest.from_dict(obj["shiftPatternTemplate"]) if obj.get("shiftPatternTemplate") is not None else None,
