...
class TaxCalculationResponse(BaseModel):
    ...
    """ # noqa: E501
    original: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Original tax amount")
    penalty: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Penalty tax amount")
    total: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total tax amount including penalty")
    __properties: ClassVar[List[str]] = ["original", "penalty", "total"]
