...
class CountryResponse(BaseModel):
    ...
    tax_treaty: Optional[StrictBool] = Field(default=None, alias="taxTreaty")
    __properties: ClassVar[List[str]] = ["id", "code", "name", "callingCode", "taxTreaty"]
