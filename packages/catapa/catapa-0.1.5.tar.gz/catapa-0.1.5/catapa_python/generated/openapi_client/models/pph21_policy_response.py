...
class Pph21PolicyResponse(BaseModel):
    """
    Pph21PolicyResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    link_to_payroll: Optional[StrictBool] = Field(default=None, alias="linkToPayroll")
    pph21_form_format_number: Optional[StrictStr] = Field(default=None, alias="pph21FormFormatNumber")
    pph21_method: Optional[StrictStr] = Field(default=None, alias="pph21Method")
    __properties: ClassVar[List[str]] = ["id", "linkToPayroll", "pph21FormFormatNumber", "pph21Method"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pph21FormFormatNumber": obj.get("pph21FormFormatNumber"),
