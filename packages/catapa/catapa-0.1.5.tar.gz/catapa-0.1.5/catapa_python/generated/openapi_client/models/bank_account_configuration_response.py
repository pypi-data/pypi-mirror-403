...
class BankAccountConfigurationResponse(BaseModel):
    """
    ...
    distribution_method: Optional[StrictStr] = Field(default=None, alias="distributionMethod")
    default_bank_account: Optional[BankAccountResponse] = Field(default=None, alias="defaultBankAccount")
    bank_accounts: Optional[List[BankAccountResponse]] = Field(default=None, alias="bankAccounts")
    source: Optional[BankAccountConfigurationResponseSource] = None
    approval_status: Optional[StrictStr] = Field(default=None, alias="approvalStatus")
    __properties: ClassVar[List[str]] = ["id", "employee", "paymentMethod", "updatedDate", "effectiveDate", "distributionMethod", "defaultBankAccount", "bankAccounts", "source", "approvalStatus"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if distribution_method (nullable) is None
        # and model_fields_set contains the field
        if self.distribution_method is None and "distribution_method" in self.model_fields_set:
            _dict['distributionMethod'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "employee": EmployeeResponse.from_dict(obj["employee"]) if obj.get("employee") is not None else None,
            "paymentMethod": obj.get("paymentMethod"),
            "updatedDate": obj.get("updatedDate"),
            "effectiveDate": obj.get("effectiveDate"),
            "distributionMethod": obj.get("distributionMethod"),
            "defaultBankAccount": BankAccountResponse.from_dict(obj["defaultBankAccount"]) if obj.get("defaultBankAccount") is not None else None,
            "bankAccounts": [BankAccountResponse.from_dict(_item) for _item in obj["bankAccounts"]] if obj.get("bankAccounts") is not None else None,
            "source": BankAccountConfigurationResponseSource.from_dict(obj["source"]) if obj.get("source") is not None else None,
