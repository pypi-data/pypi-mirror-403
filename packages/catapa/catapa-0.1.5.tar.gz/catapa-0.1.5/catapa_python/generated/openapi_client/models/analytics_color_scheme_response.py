...
class AnalyticsColorSchemeResponse(BaseModel):
    """
    AnalyticsColorSchemeResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    color_scheme_details: Optional[List[AnalyticsColorSchemeDetailResponse]] = Field(default=None, alias="colorSchemeDetails")
    __properties: ClassVar[List[str]] = ["id", "colorSchemeDetails"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in color_scheme_details (list)
        _items = []
        if self.color_scheme_details:
            for _item_color_scheme_details in self.color_scheme_details:
                if _item_color_scheme_details:
                    _items.append(_item_color_scheme_details.to_dict())
            _dict['colorSchemeDetails'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "colorSchemeDetails": [AnalyticsColorSchemeDetailResponse.from_dict(_item) for _item in obj["colorSchemeDetails"]] if obj.get("colorSchemeDetails") is not None else None
        })
        return _obj
