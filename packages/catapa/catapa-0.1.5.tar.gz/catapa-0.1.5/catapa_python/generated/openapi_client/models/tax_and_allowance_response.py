...
class TaxAndAllowanceResponse(BaseModel):
    """
    TaxAndAllowanceResponse
    """ # noqa: E501
    original: Optional[Union[StrictFloat, StrictInt]] = None
    ...
    __properties: ClassVar[List[str]] = ["original", "penalty", "tax", "allowance"]
