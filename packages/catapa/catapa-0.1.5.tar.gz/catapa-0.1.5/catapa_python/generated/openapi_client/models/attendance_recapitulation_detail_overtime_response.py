...
class AttendanceRecapitulationDetailOvertimeResponse(BaseModel):
    """
    AttendanceRecapitulationDetailOvertimeResponse
    """ # noqa: E501
    requested: Optional[Union[StrictFloat, StrictInt]] = None
    paid: Optional[Union[StrictFloat, StrictInt]] = None
    description: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["requested", "paid", "description"]
