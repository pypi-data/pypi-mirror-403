...
class EmployeeVariableResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "employeeId", "employee", "name", "date", "value", "createdBy", "createdDate", "updatedBy", "updatedDate"]
