...
class PointOfHireResponse(BaseModel):
    """
    PointOfHireResponse
    """ # noqa: E501
    ...
    location_group: Optional[IdCodeNameResponse] = Field(default=None, alias="locationGroup")
    ...
    headquarter: Optional[StrictBool] = None
    company: Optional[IdCodeNameResponse] = None
    __properties: ClassVar[List[str]] = ["id", "code", "name", "locationGroup", "city", "latitude", "longitude", "address", "phone", "zipCode", "headquarter", "company"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "name": obj.get("name"),
            "locationGroup": IdCodeNameResponse.from_dict(obj["locationGroup"]) if obj.get("locationGroup") is not None else None,
            "city": CityResponse.from_dict(obj["city"]) if obj.get("city") is not None else None,
