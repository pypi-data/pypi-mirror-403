...
class AnnualTaxCalculationSimulatorResponse(BaseModel):
    """
    AnnualTaxCalculationSimulatorResponse
    """ # noqa: E501
    monthly_tax_reports: Optional[List[AnnualTaxCalculationSimulatorMonthlyTaxReportsResponse]] = Field(default=None, alias="monthlyTaxReports")
    annual_tax_report: Optional[AnnualTaxCalculationSimulatorResultResponse] = Field(default=None, alias="annualTaxReport")
    __properties: ClassVar[List[str]] = ["monthlyTaxReports", "annualTaxReport"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in monthly_tax_reports (list)
        _items = []
        if self.monthly_tax_reports:
            for _item_monthly_tax_reports in self.monthly_tax_reports:
                if _item_monthly_tax_reports:
                    _items.append(_item_monthly_tax_reports.to_dict())
            _dict['monthlyTaxReports'] = _items
        # override the default output from pydantic by calling `to_dict()` of annual_tax_report
        if self.annual_tax_report:
            _dict['annualTaxReport'] = self.annual_tax_report.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "monthlyTaxReports": [AnnualTaxCalculationSimulatorMonthlyTaxReportsResponse.from_dict(_item) for _item in obj["monthlyTaxReports"]] if obj.get("monthlyTaxReports") is not None else None,
            "annualTaxReport": AnnualTaxCalculationSimulatorResultResponse.from_dict(obj["annualTaxReport"]) if obj.get("annualTaxReport") is not None else None
        })
        return _obj
