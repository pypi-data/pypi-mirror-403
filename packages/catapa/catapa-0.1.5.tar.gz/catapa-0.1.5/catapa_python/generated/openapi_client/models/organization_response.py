...
class OrganizationResponse(BaseModel):
    ...
    organization_hierarchy: Optional[OrganizationHierarchyResponse] = Field(default=None, alias="organizationHierarchy")
    organization_group: Optional[IdCodeNameResponse] = Field(default=None, alias="organizationGroup")
    organization_parent: Optional[OrganizationParentResponse] = Field(default=None, alias="organizationParent")
    company: Optional[IdCodeNameResponse] = None
    __properties: ClassVar[List[str]] = ["id", "code", "name", "type", "effectiveDate", "endDate", "createdBy", "createdDate", "updatedBy", "updatedDate", "organizationHierarchy", "organizationGroup", "organizationParent", "company"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['STRUCTURAL', 'FUNCTIONAL']):
            raise ValueError("must be one of enum values ('STRUCTURAL', 'FUNCTIONAL')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of organization_hierarchy
        if self.organization_hierarchy:
            _dict['organizationHierarchy'] = self.organization_hierarchy.to_dict()
        # override the default output from pydantic by calling `to_dict()` of organization_group
        if self.organization_group:
            _dict['organizationGroup'] = self.organization_group.to_dict()
        # override the default output from pydantic by calling `to_dict()` of organization_parent
        if self.organization_parent:
            _dict['organizationParent'] = self.organization_parent.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organizationHierarchy": OrganizationHierarchyResponse.from_dict(obj["organizationHierarchy"]) if obj.get("organizationHierarchy") is not None else None,
            "organizationGroup": IdCodeNameResponse.from_dict(obj["organizationGroup"]) if obj.get("organizationGroup") is not None else None,
            "organizationParent": OrganizationParentResponse.from_dict(obj["organizationParent"]) if obj.get("organizationParent") is not None else None,
            "company": IdCodeNameResponse.from_dict(obj["company"]) if obj.get("company") is not None else None
        })
        return _obj
