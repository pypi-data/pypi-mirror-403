...
class AdditionalAssignmentApprovalResponse(BaseModel):
    """
    ...
    sign_date: Optional[StrictStr] = Field(default=None, alias="signDate")
    ...
    cost_center: Optional[CostCenterResponse] = Field(default=None, alias="costCenter")
    employee: Optional[EmployeeSimpleResponse] = None
    sub_location: Optional[AdditionalAssignmentApprovaleSubLocationResponse] = Field(default=None, alias="subLocation")
    operational_group: Optional[IdCodeNameResponse] = Field(default=None, alias="operationalGroup")
    additional_assignment: Optional[AdditionalAssignmentResponse] = Field(default=None, alias="additionalAssignment")
    __properties: ClassVar[List[str]] = ["id", "action", "approvalStatus", "rejectionReason", "employmentStatusType", "employmentType", "effectiveDate", "endDate", "signDate", "createdBy", "createdDate", "updatedBy", "updatedDate", "organization", "position", "jobLevel", "jobTitle", "location", "costCenter", "employee", "subLocation", "operationalGroup", "additionalAssignment"]
    ...
    def action_validate_enum(cls, value):
        ...
        if value not in set(['NONE', 'ADD', 'EDIT', 'DELETE', 'DELETE_ALL']):
            raise ValueError("must be one of enum values ('NONE', 'ADD', 'EDIT', 'DELETE', 'DELETE_ALL')")
        return value
    ...
    def approval_status_validate_enum(cls, value):
        ...
        if value not in set(['APPROVED', 'REJECTED', 'OPEN', 'WAITING_FOR_APPROVAL']):
            raise ValueError("must be one of enum values ('APPROVED', 'REJECTED', 'OPEN', 'WAITING_FOR_APPROVAL')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of additional_assignment
        if self.additional_assignment:
            _dict['additionalAssignment'] = self.additional_assignment.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "position": PositionResponse.from_dict(obj["position"]) if obj.get("position") is not None else None,
            ...
            "costCenter": CostCenterResponse.from_dict(obj["costCenter"]) if obj.get("costCenter") is not None else None,
            "employee": EmployeeSimpleResponse.from_dict(obj["employee"]) if obj.get("employee") is not None else None,
            "subLocation": AdditionalAssignmentApprovaleSubLocationResponse.from_dict(obj["subLocation"]) if obj.get("subLocation") is not None else None,
            "operationalGroup": IdCodeNameResponse.from_dict(obj["operationalGroup"]) if obj.get("operationalGroup") is not None else None,
            "additionalAssignment": AdditionalAssignmentResponse.from_dict(obj["additionalAssignment"]) if obj.get("additionalAssignment") is not None else None
        })
        return _obj
