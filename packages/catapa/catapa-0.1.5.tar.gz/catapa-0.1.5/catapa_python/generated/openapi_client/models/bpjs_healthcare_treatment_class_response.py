...
class BpjsHealthcareTreatmentClassResponse(BaseModel):
    """
    BpjsHealthcareTreatmentClassResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    min_salary_type: Optional[StrictStr] = Field(default=None, alias="minSalaryType")
    min_salary_value: Optional[StrictStr] = Field(default=None, alias="minSalaryValue")
    max_salary_type: Optional[StrictStr] = Field(default=None, alias="maxSalaryType")
    max_salary_value: Optional[StrictStr] = Field(default=None, alias="maxSalaryValue")
    __properties: ClassVar[List[str]] = ["id", "name", "minSalaryType", "minSalaryValue", "maxSalaryType", "maxSalaryValue"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if min_salary_value (nullable) is None
        # and model_fields_set contains the field
        if self.min_salary_value is None and "min_salary_value" in self.model_fields_set:
            _dict['minSalaryValue'] = None

        # set to None if max_salary_value (nullable) is None
        # and model_fields_set contains the field
        if self.max_salary_value is None and "max_salary_value" in self.model_fields_set:
            _dict['maxSalaryValue'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "minSalaryType": obj.get("minSalaryType"),
            "minSalaryValue": obj.get("minSalaryValue"),
            "maxSalaryType": obj.get("maxSalaryType"),
            "maxSalaryValue": obj.get("maxSalaryValue")
        })
        return _obj
