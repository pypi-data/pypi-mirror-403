...
class PaymentItemGroupLastSequenceResponse(BaseModel):
    """
    PaymentItemGroupLastSequenceResponse
    """ # noqa: E501
    employee_id: Optional[StrictStr] = Field(default=None, alias="employeeId")
    last_sequence: Optional[StrictInt] = Field(default=None, alias="lastSequence")
    __properties: ClassVar[List[str]] = ["employeeId", "lastSequence"]
