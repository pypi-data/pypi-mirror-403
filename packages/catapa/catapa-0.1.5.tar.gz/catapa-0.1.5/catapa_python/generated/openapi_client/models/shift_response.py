...
class ShiftResponse(BaseModel):
    ...
    time_in_utc: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="timeInUtc")
    time_out_utc: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="timeOutUtc")
    break_start_utc: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="breakStartUtc")
    break_end_utc: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="breakEndUtc")
    color: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["id", "code", "name", "timeIn", "timeOut", "timeInUtc", "timeOutUtc", "breakStartUtc", "breakEndUtc", "color"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "timeInUtc": obj.get("timeInUtc"),
            "timeOutUtc": obj.get("timeOutUtc"),
            "breakStartUtc": obj.get("breakStartUtc"),
            "breakEndUtc": obj.get("breakEndUtc"),
            "color": obj.get("color")
        })
        return _obj
