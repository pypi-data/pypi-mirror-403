...
class EducationResponse(BaseModel):
    ...
    field_of_study: Optional[FieldOfStudyResponse] = Field(default=None, alias="fieldOfStudy")
    country: Optional[CountryResponse] = None
    institution: Optional[InstitutionResponse] = None
    start_date: Optional[StrictStr] = Field(default=None, alias="startDate")
    graduation_date: Optional[StrictStr] = Field(default=None, alias="graduationDate")
    ...
    __properties: ClassVar[List[str]] = ["id", "educationLevel", "fieldOfStudy", "country", "institution", "startDate", "graduationDate", "createdBy", "createdDate", "updatedBy", "updatedDate"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.field_of_study:
            _dict['fieldOfStudy'] = self.field_of_study.to_dict()
        ...
        # set to None if graduation_date (nullable) is None
        # and model_fields_set contains the field
        if self.graduation_date is None and "graduation_date" in self.model_fields_set:
            _dict['graduationDate'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fieldOfStudy": FieldOfStudyResponse.from_dict(obj["fieldOfStudy"]) if obj.get("fieldOfStudy") is not None else None,
            "country": CountryResponse.from_dict(obj["country"]) if obj.get("country") is not None else None,
            "institution": InstitutionResponse.from_dict(obj["institution"]) if obj.get("institution") is not None else None,
