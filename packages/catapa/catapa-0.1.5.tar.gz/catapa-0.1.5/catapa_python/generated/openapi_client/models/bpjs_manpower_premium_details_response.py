...
class BpjsManpowerPremiumDetailsResponse(BaseModel):
    """
    ...
    monthly_wage: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="monthlyWage")
    current_month_detail: Optional[BpjsManpowerCurrentMonthDetailResponse] = Field(default=None, alias="currentMonthDetail")
    details: Optional[List[BpjsManpowerPremiumDetailsItemResponse]] = Field(default=None, description="Possible empty list")
    __properties: ClassVar[List[str]] = ["employeeId", "employeeIdentificationNumber", "employeeName", "monthlyWage", "currentMonthDetail", "details"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of current_month_detail
        if self.current_month_detail:
            _dict['currentMonthDetail'] = self.current_month_detail.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "monthlyWage": obj.get("monthlyWage"),
            "currentMonthDetail": BpjsManpowerCurrentMonthDetailResponse.from_dict(obj["currentMonthDetail"]) if obj.get("currentMonthDetail") is not None else None,
            "details": [BpjsManpowerPremiumDetailsItemResponse.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
        return _obj
