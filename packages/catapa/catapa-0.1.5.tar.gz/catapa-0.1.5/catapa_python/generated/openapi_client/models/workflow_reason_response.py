...
class WorkflowReasonResponse(BaseModel):
    ...
    category: Optional[WorkflowReasonCategoryResponse] = None
    __properties: ClassVar[List[str]] = ["id", "createdDate", "updatedDate", "code", "name", "category"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "name": obj.get("name"),
            "category": WorkflowReasonCategoryResponse.from_dict(obj["category"]) if obj.get("category") is not None else None
        })
        return _obj
