...
class LeaveBalanceItemResponse(BaseModel):
    """
    LeaveBalanceItemResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    year: Optional[Union[StrictFloat, StrictInt]] = None
    accrual_frequency_type: Optional[StrictStr] = Field(default=None, alias="accrualFrequencyType")
    monthly_accrual_include_bonus: Optional[StrictBool] = Field(default=None, alias="monthlyAccrualIncludeBonus")
    given_date: Optional[StrictStr] = Field(default=None, alias="givenDate")
    ...
    expected_balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="expectedBalance")
    ...
    maximum_extended_duration: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="maximumExtendedDuration")
    maximum_extended_balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="maximumExtendedBalance")
    extended_balance_include_bonus: Optional[StrictBool] = Field(default=None, alias="extendedBalanceIncludeBonus")
    total_balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="totalBalance")
    used_leave: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="usedLeave")
    active: Optional[StrictBool] = None
    employee: Optional[EmployeeSimpleResponse] = None
    approved_leave: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="approvedLeave")
    pending_leave: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="pendingLeave")
    collective_leave: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="collectiveLeave")
    remaining: Optional[Union[StrictFloat, StrictInt]] = None
    extended_date: Optional[StrictStr] = Field(default=None, alias="extendedDate")
    extended_balance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="extendedBalance")
    extended_used_leave: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="extendedUsedLeave")
    extended_collective_leave: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="extendedCollectiveLeave")
    extended_available: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="extendedAvailable")
    extended_remaining: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="extendedRemaining")
    extended_approved_leave: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="extendedApprovedLeave")
    extended_pending_leave: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="extendedPendingLeave")
    __properties: ClassVar[List[str]] = ["id", "year", "accrualFrequencyType", "monthlyAccrualIncludeBonus", "givenDate", "startDate", "endDate", "expectedBalance", "balance", "bonus", "debt", "extended", "maximumExtendedDuration", "maximumExtendedBalance", "extendedBalanceIncludeBonus", "totalBalance", "usedLeave", "active", "employee", "approvedLeave", "pendingLeave", "collectiveLeave", "remaining", "extendedDate", "extendedBalance", "extendedUsedLeave", "extendedCollectiveLeave", "extendedAvailable", "extendedRemaining", "extendedApprovedLeave", "extendedPendingLeave"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "year": obj.get("year"),
            "accrualFrequencyType": obj.get("accrualFrequencyType"),
            "monthlyAccrualIncludeBonus": obj.get("monthlyAccrualIncludeBonus"),
            "givenDate": obj.get("givenDate"),
            "startDate": obj.get("startDate"),
            "endDate": obj.get("endDate"),
            "expectedBalance": obj.get("expectedBalance"),
            "balance": obj.get("balance"),
            "bonus": obj.get("bonus"),
            "debt": obj.get("debt"),
            "extended": obj.get("extended"),
            "maximumExtendedDuration": obj.get("maximumExtendedDuration"),
            "maximumExtendedBalance": obj.get("maximumExtendedBalance"),
            "extendedBalanceIncludeBonus": obj.get("extendedBalanceIncludeBonus"),
            "totalBalance": obj.get("totalBalance"),
            "usedLeave": obj.get("usedLeave"),
            "active": obj.get("active"),
            "employee": EmployeeSimpleResponse.from_dict(obj["employee"]) if obj.get("employee") is not None else None,
            "approvedLeave": obj.get("approvedLeave"),
            "pendingLeave": obj.get("pendingLeave"),
            "collectiveLeave": obj.get("collectiveLeave"),
            "remaining": obj.get("remaining"),
            "extendedDate": obj.get("extendedDate"),
            "extendedBalance": obj.get("extendedBalance"),
            "extendedUsedLeave": obj.get("extendedUsedLeave"),
            "extendedCollectiveLeave": obj.get("extendedCollectiveLeave"),
            "extendedAvailable": obj.get("extendedAvailable"),
            "extendedRemaining": obj.get("extendedRemaining"),
            "extendedApprovedLeave": obj.get("extendedApprovedLeave"),
            "extendedPendingLeave": obj.get("extendedPendingLeave")
        })
        return _obj
