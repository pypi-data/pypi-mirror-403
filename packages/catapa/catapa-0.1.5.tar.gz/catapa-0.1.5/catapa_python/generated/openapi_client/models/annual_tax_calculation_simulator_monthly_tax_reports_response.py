...
class AnnualTaxCalculationSimulatorMonthlyTaxReportsResponse(BaseModel):
    """
    ...
    monthly_tax: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="monthlyTax")
    netto_tax: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="nettoTax")
    type: StrictStr
    basic_salary: Optional[Union[StrictFloat, StrictInt]] = Field(default=0, alias="basicSalary")
    tax_allowance: Optional[Union[StrictFloat, StrictInt]] = Field(default=0, alias="taxAllowance")
    other_allowance: Optional[Union[StrictFloat, StrictInt]] = Field(default=0, alias="otherAllowance")
    honorarium: Optional[Union[StrictFloat, StrictInt]] = 0
    insurance_premium: Optional[Union[StrictFloat, StrictInt]] = Field(default=0, alias="insurancePremium")
    enjoyment_revenue: Optional[Union[StrictFloat, StrictInt]] = Field(default=0, alias="enjoymentRevenue")
    bonus: Optional[Union[StrictFloat, StrictInt]] = 0
    monthly_retirement_contribution: Optional[Union[StrictFloat, StrictInt]] = Field(default=0, alias="monthlyRetirementContribution")
    monthly_religion_allowance: Optional[Union[StrictFloat, StrictInt]] = Field(default=0, alias="monthlyReligionAllowance")
    __properties: ClassVar[List[str]] = ["monthlyGrossIncome", "percentage", "monthlyTax", "nettoTax", "type", "basicSalary", "taxAllowance", "otherAllowance", "honorarium", "insurancePremium", "enjoymentRevenue", "bonus", "monthlyRetirementContribution", "monthlyReligionAllowance"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "monthlyTax": obj.get("monthlyTax"),
            "nettoTax": obj.get("nettoTax"),
            "type": obj.get("type"),
            "basicSalary": obj.get("basicSalary") if obj.get("basicSalary") is not None else 0,
            "taxAllowance": obj.get("taxAllowance") if obj.get("taxAllowance") is not None else 0,
            "otherAllowance": obj.get("otherAllowance") if obj.get("otherAllowance") is not None else 0,
            "honorarium": obj.get("honorarium") if obj.get("honorarium") is not None else 0,
            "insurancePremium": obj.get("insurancePremium") if obj.get("insurancePremium") is not None else 0,
            "enjoymentRevenue": obj.get("enjoymentRevenue") if obj.get("enjoymentRevenue") is not None else 0,
            "bonus": obj.get("bonus") if obj.get("bonus") is not None else 0,
            "monthlyRetirementContribution": obj.get("monthlyRetirementContribution") if obj.get("monthlyRetirementContribution") is not None else 0,
            "monthlyReligionAllowance": obj.get("monthlyReligionAllowance") if obj.get("monthlyReligionAllowance") is not None else 0
        })
        return _obj
