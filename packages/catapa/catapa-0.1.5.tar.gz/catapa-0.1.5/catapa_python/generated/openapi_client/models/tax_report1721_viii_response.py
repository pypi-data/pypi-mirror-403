...
class TaxReport1721VIIIResponse(BaseModel):
    """
    ...
    monthly_tax: Optional[TaxAmountResponse] = Field(default=None, alias="monthlyTax")
    __properties: ClassVar[List[str]] = ["id", "employee", "kpp", "year", "month", "sequenceNumber", "npwpNumber", "address", "monthlyGrossIncome", "monthlyTax"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of monthly_tax
        if self.monthly_tax:
            _dict['monthlyTax'] = self.monthly_tax.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "monthlyTax": TaxAmountResponse.from_dict(obj["monthlyTax"]) if obj.get("monthlyTax") is not None else None
        })
        return _obj
