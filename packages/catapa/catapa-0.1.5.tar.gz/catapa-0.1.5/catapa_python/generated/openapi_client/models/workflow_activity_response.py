...
class WorkflowActivityResponse(BaseModel):
    ...
    workflow_template: Optional[WorkflowTemplateResponse] = Field(default=None, alias="workflowTemplate")
    effective_date: Optional[StrictStr] = Field(default=None, alias="effectiveDate")
    workflow_reason: Optional[WorkflowReasonResponse] = Field(default=None, alias="workflowReason")
    employee: Optional[EmployeeSimpleResponse] = None
    __properties: ClassVar[List[str]] = ["id", "createdDate", "updatedDate", "workflowTemplate", "effectiveDate", "workflowReason", "employee"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workflowTemplate": WorkflowTemplateResponse.from_dict(obj["workflowTemplate"]) if obj.get("workflowTemplate") is not None else None,
            "effectiveDate": obj.get("effectiveDate"),
            "workflowReason": WorkflowReasonResponse.from_dict(obj["workflowReason"]) if obj.get("workflowReason") is not None else None,
