...
class SalaryPaymentSummaryResponse(BaseModel):
    """
    ...
    number_of_processed_employees: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="numberOfProcessedEmployees")
    number_of_transferred_employees: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="numberOfTransferredEmployees")
    payment_date: Optional[StrictStr] = Field(default=None, alias="paymentDate")
    transferred_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="transferredAmount")
    company_bank_account: Optional[SalaryPaymentSummaryCompanyBankAccountResponse] = Field(default=None, alias="companyBankAccount")
    __properties: ClassVar[List[str]] = ["accountNumber", "amount", "id", "numberOfProcessedEmployees", "numberOfTransferredEmployees", "paymentDate", "transferredAmount", "companyBankAccount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "numberOfProcessedEmployees": obj.get("numberOfProcessedEmployees"),
            "numberOfTransferredEmployees": obj.get("numberOfTransferredEmployees"),
            "paymentDate": obj.get("paymentDate"),
            "transferredAmount": obj.get("transferredAmount"),
            "companyBankAccount": SalaryPaymentSummaryCompanyBankAccountResponse.from_dict(obj["companyBankAccount"]) if obj.get("companyBankAccount") is not None else None
        })
        return _obj
