...
class WidgetResponse(BaseModel):
    ...
    WidgetResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the widget")
    position: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Position of the widget in the layout")
    widget_type: Optional[StrictStr] = Field(default=None, description="Type of the widget", alias="widgetType")
    content: Optional[WidgetContentResponse] = None
    __properties: ClassVar[List[str]] = ["id", "position", "widgetType", "content"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": WidgetContentResponse.from_dict(obj["content"]) if obj.get("content") is not None else None
        })
        return _obj
