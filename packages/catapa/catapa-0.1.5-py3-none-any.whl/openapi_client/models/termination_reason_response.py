...
class TerminationReasonResponse(BaseModel):
    """
    TerminationReasonResponse
    """ # noqa: E501
    id: Optional[UUID] = None
    name: Optional[StrictStr] = None
    termination_pph21_reason: Optional[StrictStr] = Field(default=None, alias="terminationPph21Reason")
    termination_bpjs_manpower_reason: Optional[StrictStr] = Field(default=None, alias="terminationBpjsManpowerReason")
    termination_reason_category: Optional[StrictStr] = Field(default=None, alias="terminationReasonCategory")
    severance: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "name", "terminationPph21Reason", "terminationBpjsManpowerReason", "terminationReasonCategory", "severance"]
