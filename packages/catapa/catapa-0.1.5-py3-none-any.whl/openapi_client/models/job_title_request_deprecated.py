...
class JobTitleRequestDeprecated(BaseModel):
    """
    JobTitleRequestDeprecated
    """ # noqa: E501
    code: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    min_job_level_id: Optional[StrictStr] = Field(default=None, alias="minJobLevelId")
    max_job_level_id: Optional[StrictStr] = Field(default=None, alias="maxJobLevelId")
    __properties: ClassVar[List[str]] = ["code", "name", "minJobLevelId", "maxJobLevelId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if min_job_level_id (nullable) is None
        # and model_fields_set contains the field
        if self.min_job_level_id is None and "min_job_level_id" in self.model_fields_set:
            _dict['minJobLevelId'] = None

        # set to None if max_job_level_id (nullable) is None
        # and model_fields_set contains the field
        if self.max_job_level_id is None and "max_job_level_id" in self.model_fields_set:
            _dict['maxJobLevelId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "name": obj.get("name"),
            "minJobLevelId": obj.get("minJobLevelId"),
            "maxJobLevelId": obj.get("maxJobLevelId")
        })
        return _obj
