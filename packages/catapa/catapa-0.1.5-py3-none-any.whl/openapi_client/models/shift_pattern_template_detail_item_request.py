...
class ShiftPatternTemplateDetailItemRequest(BaseModel):
    """
    ShiftPatternTemplateDetailItemRequest
    """ # noqa: E501
    shift: ShiftPatternTemplateDetailItemRequestShift
    sequence: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["shift", "sequence"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "shift": ShiftPatternTemplateDetailItemRequestShift.from_dict(obj["shift"]) if obj.get("shift") is not None else None,
