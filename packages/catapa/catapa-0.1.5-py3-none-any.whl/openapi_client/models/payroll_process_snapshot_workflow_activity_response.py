...
class PayrollProcessSnapshotWorkflowActivityResponse(BaseModel):
    """
    ...
    workflow_template: Optional[PayrollProcessSnapshotWorkflowTemplateResponse] = Field(default=None, alias="workflowTemplate")
    workflow_reason: Optional[PayrollProcessSnapshotWorkflowReasonResponse] = Field(default=None, alias="workflowReason")
    __properties: ClassVar[List[str]] = ["id", "effectiveDate", "createdDate", "updatedDate", "workflowTemplate", "workflowReason"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of workflow_template
        if self.workflow_template:
            _dict['workflowTemplate'] = self.workflow_template.to_dict()
        # override the default output from pydantic by calling `to_dict()` of workflow_reason
        if self.workflow_reason:
            _dict['workflowReason'] = self.workflow_reason.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "workflowTemplate": PayrollProcessSnapshotWorkflowTemplateResponse.from_dict(obj["workflowTemplate"]) if obj.get("workflowTemplate") is not None else None,
            "workflowReason": PayrollProcessSnapshotWorkflowReasonResponse.from_dict(obj["workflowReason"]) if obj.get("workflowReason") is not None else None
        })
        return _obj
