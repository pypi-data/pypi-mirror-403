...
class AnomalySuspectAttributeResponse(BaseModel):
    """
    AnomalySuspectAttributeResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the attribute")
    attribute_key: Optional[StrictStr] = Field(default=None, description="Key/name of the attribute", alias="attributeKey")
    __properties: ClassVar[List[str]] = ["id", "attributeKey"]
