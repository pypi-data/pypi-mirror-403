...
class MonthlyTaxReportResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "year", "month", "pph21Method", "membershipNumber", "membershipAddress", "totalMonthlyGrossIncome", "totalTaxAndAllowance", "paidTaxAndAllowance", "taxObject", "sequenceNumber", "migrated", "employee", "kpp"]
