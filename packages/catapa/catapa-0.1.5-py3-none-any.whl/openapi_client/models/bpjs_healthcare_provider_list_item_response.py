...
class BpjsHealthcareProviderListItemResponse(BaseModel):
    """
    ...
    report_signatory_name: Optional[StrictStr] = Field(default=None, alias="reportSignatoryName")
    report_signatory_job_title: Optional[StrictStr] = Field(default=None, alias="reportSignatoryJobTitle")
    __properties: ClassVar[List[str]] = ["id", "code", "name", "address", "registrationNumber", "reportSignatoryName", "reportSignatoryJobTitle"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reportSignatoryName": obj.get("reportSignatoryName"),
            "reportSignatoryJobTitle": obj.get("reportSignatoryJobTitle")
        })
        return _obj
