...
class SalaryCalculationDetailResponse(BaseModel):
    """
    SalaryCalculationDetailResponse
    """ # noqa: E501
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    id: Optional[StrictStr] = None
    salary_item_category: Optional[StrictStr] = Field(default=None, alias="salaryItemCategory")
    salary_item_code: Optional[StrictStr] = Field(default=None, alias="salaryItemCode")
    salary_item_name: Optional[StrictStr] = Field(default=None, alias="salaryItemName")
    salary_item_type: Optional[StrictStr] = Field(default=None, alias="salaryItemType")
    thp: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["amount", "id", "salaryItemCategory", "salaryItemCode", "salaryItemName", "salaryItemType", "thp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "salaryItemCategory": obj.get("salaryItemCategory"),
            "salaryItemCode": obj.get("salaryItemCode"),
            "salaryItemName": obj.get("salaryItemName"),
