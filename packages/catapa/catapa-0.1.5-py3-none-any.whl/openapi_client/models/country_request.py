...
class CountryRequest(BaseModel):
    ...
    calling_code: Annotated[str, Field(min_length=1, strict=True, max_length=5)] = Field(description="e.g. `+62`", alias="callingCode")
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    tax_treaty: Optional[StrictBool] = Field(default=False, alias="taxTreaty")
    __properties: ClassVar[List[str]] = ["code", "callingCode", "name", "taxTreaty"]

    @field_validator('calling_code')
    def calling_code_validate_regular_expression(cls, value):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "taxTreaty": obj.get("taxTreaty") if obj.get("taxTreaty") is not None else False
        })
        return _obj
