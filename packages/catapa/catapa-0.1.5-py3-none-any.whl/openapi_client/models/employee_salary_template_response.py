...
class EmployeeSalaryTemplateResponse(BaseModel):
    """
    EmployeeSalaryTemplateResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    effective_date: Optional[StrictStr] = Field(default=None, alias="effectiveDate")
    proportional: Optional[StrictBool] = None
    retroactive: Optional[StrictBool] = None
    salary_decree_number: Optional[StrictStr] = Field(default=None, alias="salaryDecreeNumber")
    salary_template_id: Optional[StrictStr] = Field(default=None, alias="salaryTemplateId")
    employee_salaries: Optional[List[EmployeeSalaryResponse]] = Field(default=None, alias="employeeSalaries")
    __properties: ClassVar[List[str]] = ["id", "effectiveDate", "proportional", "retroactive", "salaryDecreeNumber", "salaryTemplateId", "employeeSalaries"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in employee_salaries (list)
        _items = []
        if self.employee_salaries:
            for _item_employee_salaries in self.employee_salaries:
                if _item_employee_salaries:
                    _items.append(_item_employee_salaries.to_dict())
            _dict['employeeSalaries'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "proportional": obj.get("proportional"),
            "retroactive": obj.get("retroactive"),
            "salaryDecreeNumber": obj.get("salaryDecreeNumber"),
            "salaryTemplateId": obj.get("salaryTemplateId"),
            "employeeSalaries": [EmployeeSalaryResponse.from_dict(_item) for _item in obj["employeeSalaries"]] if obj.get("employeeSalaries") is not None else None
        })
        return _obj
