...
class CalculationScenarioSalaryComponent(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["basicSalary", "taxAllowance", "otherAllowance", "honorarium", "insurancePremium", "enjoymentRevenue", "bonus", "monthlyRetirementContribution", "monthlyReligionAllowance"]
