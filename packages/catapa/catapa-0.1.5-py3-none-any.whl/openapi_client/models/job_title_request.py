...
class JobTitleRequest(BaseModel):
    ...
    job_levels: Optional[List[IdRequest]] = Field(default=None, alias="jobLevels")
    __properties: ClassVar[List[str]] = ["code", "name", "jobLevels"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if job_levels (nullable) is None
        # and model_fields_set contains the field
        if self.job_levels is None and "job_levels" in self.model_fields_set:
            _dict['jobLevels'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "name": obj.get("name"),
            "jobLevels": [IdRequest.from_dict(_item) for _item in obj["jobLevels"]] if obj.get("jobLevels") is not None else None
        })
        return _obj
