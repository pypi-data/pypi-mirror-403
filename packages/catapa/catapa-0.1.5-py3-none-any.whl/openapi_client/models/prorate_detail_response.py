...
class ProrateDetailResponse(BaseModel):
    """
    ...
    prorated_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="proratedAmount")
    salary_decree_number: Optional[StrictStr] = Field(default=None, alias="salaryDecreeNumber")
    salary_template_detail: Optional[ProrateDetailSalaryTemplateDetailResponse] = Field(default=None, alias="salaryTemplateDetail")
    __properties: ClassVar[List[str]] = ["amount", "effectiveDate", "formula", "proratedAmount", "salaryDecreeNumber", "salaryTemplateDetail"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of salary_template_detail
        if self.salary_template_detail:
            _dict['salaryTemplateDetail'] = self.salary_template_detail.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "proratedAmount": obj.get("proratedAmount"),
            "salaryDecreeNumber": obj.get("salaryDecreeNumber"),
            "salaryTemplateDetail": ProrateDetailSalaryTemplateDetailResponse.from_dict(obj["salaryTemplateDetail"]) if obj.get("salaryTemplateDetail") is not None else None
        })
        return _obj
