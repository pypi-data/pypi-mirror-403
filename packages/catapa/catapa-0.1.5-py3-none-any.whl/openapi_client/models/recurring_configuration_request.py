...
class RecurringConfigurationRequest(BaseModel):
    """
    RecurringConfigurationRequest
    """ # noqa: E501
    max_recurring_times: Union[StrictFloat, StrictInt] = Field(alias="maxRecurringTimes")
    period_interval: Union[StrictFloat, StrictInt] = Field(alias="periodInterval")
    recurring_end_type: StrictStr = Field(alias="recurringEndType")
    recurring_period_end: RecurringPeriodEndRequest = Field(alias="recurringPeriodEnd")
    __properties: ClassVar[List[str]] = ["maxRecurringTimes", "periodInterval", "recurringEndType", "recurringPeriodEnd"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "periodInterval": obj.get("periodInterval"),
            "recurringEndType": obj.get("recurringEndType"),
            "recurringPeriodEnd": RecurringPeriodEndRequest.from_dict(obj["recurringPeriodEnd"]) if obj.get("recurringPeriodEnd") is not None else None
        })
        return _obj
