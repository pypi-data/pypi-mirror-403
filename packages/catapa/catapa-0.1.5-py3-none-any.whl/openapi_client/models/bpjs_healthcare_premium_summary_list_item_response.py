...
class BpjsHealthcarePremiumSummaryListItemResponse(BaseModel):
    """
    ...
    company_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="companyAmount")
    employee_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="employeeAmount")
    __properties: ClassVar[List[str]] = ["id", "employeeIdentificationNumber", "employeeName", "monthlyWage", "companyAmount", "employeeAmount"]
