...
class SalaryTemplateDetailResponse(BaseModel):
    """
    SalaryTemplateDetailResponse
    """ # noqa: E501
    id: Optional[UUID] = None
    salary_item: Optional[IdCodeNameResponse] = Field(default=None, alias="salaryItem")
    __properties: ClassVar[List[str]] = ["id", "salaryItem"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "salaryItem": IdCodeNameResponse.from_dict(obj["salaryItem"]) if obj.get("salaryItem") is not None else None
        })
        return _obj
