...
class EmployeeVariableValidationResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["type", "value", "options"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['MIN', 'MAX', 'OPTION']):
            raise ValueError("must be one of enum values ('MIN', 'MAX', 'OPTION')")
        return value
