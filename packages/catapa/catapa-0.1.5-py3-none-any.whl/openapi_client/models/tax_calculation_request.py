...
class TaxCalculationRequest(BaseModel):
    ...
    incomes: List[TaxCalculationIncomeRequest]
    ...
    calculation_type: StrictStr = Field(alias="calculationType")
    working_days: Union[StrictFloat, StrictInt] = Field(alias="workingDays")
    __properties: ClassVar[List[str]] = ["employeeId", "incomes", "referenceDate", "paymentMethod", "externalId", "multiplier", "paymentDate", "calculationType", "workingDays"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "incomes": [TaxCalculationIncomeRequest.from_dict(_item) for _item in obj["incomes"]] if obj.get("incomes") is not None else None,
            ...
            "workingDays": obj.get("workingDays")
        })
        return _obj
