...
class TransitionCalculationResponse(BaseModel):
    """
    ...
    transition_calculation_details: Optional[List[TransitionCalculationSalaryTemplateDetailResponse]] = Field(default=None, alias="transitionCalculationDetails")
    __properties: ClassVar[List[str]] = ["costCenter", "employee", "employeeSalaryTemplateHistory", "employeeWorkday", "employmentType", "endDate", "id", "jobTitle", "location", "normalWorkday", "organization", "paymentProcess", "startDate", "totalThp", "transitionCalculationDetails"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in transition_calculation_details (list)
        _items = []
        if self.transition_calculation_details:
            for _item_transition_calculation_details in self.transition_calculation_details:
                if _item_transition_calculation_details:
                    _items.append(_item_transition_calculation_details.to_dict())
            _dict['transitionCalculationDetails'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "transitionCalculationDetails": [TransitionCalculationSalaryTemplateDetailResponse.from_dict(_item) for _item in obj["transitionCalculationDetails"]] if obj.get("transitionCalculationDetails") is not None else None
        })
        return _obj
