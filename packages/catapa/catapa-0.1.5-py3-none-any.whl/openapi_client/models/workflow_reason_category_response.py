...
class WorkflowReasonCategoryResponse(BaseModel):
    """
    ...
    restrict_duplicate_effective_date: Optional[StrictBool] = Field(default=None, alias="restrictDuplicateEffectiveDate")
    __properties: ClassVar[List[str]] = ["id", "code", "name", "restrictDuplicateEffectiveDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "name": obj.get("name"),
            "restrictDuplicateEffectiveDate": obj.get("restrictDuplicateEffectiveDate")
        })
        return _obj
