...
class TerminationEntryResponse(BaseModel):
    """
    TerminationEntryResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    termination_code: Optional[StrictStr] = Field(default=None, alias="terminationCode")
    effective_date: Optional[StrictStr] = Field(default=None, alias="effectiveDate")
    payroll_method: Optional[StrictStr] = Field(default=None, alias="payrollMethod")
    termination_reason: Optional[TerminationReasonResponse] = Field(default=None, alias="terminationReason")
    bpjs_manpower_end_date: Optional[StrictStr] = Field(default=None, alias="bpjsManpowerEndDate")
    bpjs_healthcare_end_date: Optional[StrictStr] = Field(default=None, alias="bpjsHealthcareEndDate")
    pph21_membership_end_date: Optional[StrictStr] = Field(default=None, alias="pph21MembershipEndDate")
    request_date: Optional[StrictStr] = Field(default=None, alias="requestDate")
    service_period_by: Optional[StrictStr] = Field(default=None, alias="servicePeriodBy")
    rehire: Optional[StrictBool] = None
    approval_status: Optional[StrictStr] = Field(default=None, alias="approvalStatus")
    __properties: ClassVar[List[str]] = ["id", "terminationCode", "effectiveDate", "payrollMethod", "terminationReason", "bpjsManpowerEndDate", "bpjsHealthcareEndDate", "pph21MembershipEndDate", "requestDate", "servicePeriodBy", "rehire", "approvalStatus"]
    ...
    def approval_status_validate_enum(cls, value):
        ...
        if value not in set(['APPROVED', 'REJECTED', 'WAITING_FOR_APPROVAL']):
            raise ValueError("must be one of enum values ('APPROVED', 'REJECTED', 'WAITING_FOR_APPROVAL')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.termination_reason:
            _dict['terminationReason'] = self.termination_reason.to_dict()
        # set to None if termination_code (nullable) is None
        # and model_fields_set contains the field
        if self.termination_code is None and "termination_code" in self.model_fields_set:
            _dict['terminationCode'] = None

        # set to None if service_period_by (nullable) is None
        # and model_fields_set contains the field
        if self.service_period_by is None and "service_period_by" in self.model_fields_set:
            _dict['servicePeriodBy'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "terminationCode": obj.get("terminationCode"),
            "effectiveDate": obj.get("effectiveDate"),
            "payrollMethod": obj.get("payrollMethod"),
            "terminationReason": TerminationReasonResponse.from_dict(obj["terminationReason"]) if obj.get("terminationReason") is not None else None,
            "bpjsManpowerEndDate": obj.get("bpjsManpowerEndDate"),
            "bpjsHealthcareEndDate": obj.get("bpjsHealthcareEndDate"),
            "pph21MembershipEndDate": obj.get("pph21MembershipEndDate"),
            "requestDate": obj.get("requestDate"),
            "servicePeriodBy": obj.get("servicePeriodBy"),
            "rehire": obj.get("rehire"),
