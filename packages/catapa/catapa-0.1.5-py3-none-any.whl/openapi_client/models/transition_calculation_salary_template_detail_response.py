...
class TransitionCalculationSalaryTemplateDetailResponse(BaseModel):
    """
    TransitionCalculationSalaryTemplateDetailResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    salary_item: Optional[SalaryItemResponseWithCategory] = Field(default=None, alias="salaryItem")
    salary_item_type: Optional[StrictStr] = Field(default=None, alias="salaryItemType")
    thp: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["id", "salaryItem", "salaryItemType", "thp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "salaryItem": SalaryItemResponseWithCategory.from_dict(obj["salaryItem"]) if obj.get("salaryItem") is not None else None,
