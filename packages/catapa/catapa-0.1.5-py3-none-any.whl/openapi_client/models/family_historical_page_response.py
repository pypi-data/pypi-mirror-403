...
class FamilyHistoricalPageResponse(BaseModel):
    """
    ...
    content: Optional[List[FamilyHistoricalResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": [FamilyHistoricalResponse.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None
        })
        return _obj
