...
class BpjsHealthcarePremiumDetailsItemResponse(BaseModel):
    """
    ...
    company_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Value can be null if the date period is not processed yet", alias="companyAmount")
    employee_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Value can be null if the date period is not processed yet", alias="employeeAmount")
    __properties: ClassVar[List[str]] = ["startCutoffDate", "endCutoffDate", "companyAmount", "employeeAmount"]
