...
class AdditionalFamilyMembershipResponse(BaseModel):
    """
    AdditionalFamilyMembershipResponse
    """ # noqa: E501
    id: StrictStr
    family_member_name: StrictStr = Field(alias="familyMemberName")
    family_member_relation: FamilyMemberRelationResponse = Field(alias="familyMemberRelation")
    ...
    __properties: ClassVar[List[str]] = ["id", "familyMemberName", "familyMemberRelation", "firstLevelHealthcareFacility", "dentalHealthcareFacility"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of family_member_relation
        if self.family_member_relation:
            _dict['familyMemberRelation'] = self.family_member_relation.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "familyMemberName": obj.get("familyMemberName"),
            "familyMemberRelation": FamilyMemberRelationResponse.from_dict(obj["familyMemberRelation"]) if obj.get("familyMemberRelation") is not None else None,
