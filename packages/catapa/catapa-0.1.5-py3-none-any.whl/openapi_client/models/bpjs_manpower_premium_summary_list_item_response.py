...
class BpjsManpowerPremiumSummaryListItemResponse(BaseModel):
    """
    ...
    jkk_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="jkkAmount")
    jkm_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="jkmAmount")
    jhtpk_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="jhtpkAmount")
    jhtp_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="jhtpAmount")
    jppk_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="jppkAmount")
    jpp_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="jppAmount")
    jkp_amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="jkpAmount")
    __properties: ClassVar[List[str]] = ["id", "employeeIdentificationNumber", "employeeName", "monthlyWage", "jkkAmount", "jkmAmount", "jhtpkAmount", "jhtpAmount", "jppkAmount", "jppAmount", "jkpAmount"]
