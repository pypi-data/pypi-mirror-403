...
class OAuthClientResponse(BaseModel):
    ...
    OAuthClientResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="OAuth client unique identifier")
    client_id: Optional[StrictStr] = Field(default=None, description="OAuth client ID used for authentication", alias="clientId")
    scope: Optional[StrictStr] = Field(default=None, description="OAuth scopes granted to this client")
    authorized_grant_types: Optional[StrictStr] = Field(default=None, description="Comma-separated list of authorized grant types (e.g., client_credentials, authorization_code, refresh_token)", alias="authorizedGrantTypes")
    authorities: Optional[StrictStr] = Field(default=None, description="Authorities granted to this client")
    web_server_redirect_uri: Optional[StrictStr] = Field(default=None, description="Redirect URI for web server flow", alias="webServerRedirectUri")
    authorize_all_endpoints: Optional[StrictBool] = Field(default=None, description="Whether this client is authorized to access all endpoints", alias="authorizeAllEndpoints")
    __properties: ClassVar[List[str]] = ["id", "clientId", "scope", "authorizedGrantTypes", "authorities", "webServerRedirectUri", "authorizeAllEndpoints"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scope": obj.get("scope"),
            "authorizedGrantTypes": obj.get("authorizedGrantTypes"),
            "authorities": obj.get("authorities"),
            "webServerRedirectUri": obj.get("webServerRedirectUri"),
            "authorizeAllEndpoints": obj.get("authorizeAllEndpoints")
        })
        return _obj
