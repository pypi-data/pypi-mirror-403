...
class MonthlyTaxCalculationSimulatorRequest(BaseModel):
    """
    ...
    component: CalculationScenarioComponent
    __properties: ClassVar[List[str]] = ["taxObject", "taxMethod", "ptkpCategory", "component"]

    @field_validator('tax_object')
    def tax_object_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['PERMANENT', 'TEMPORARY', 'EXPERT_CONTINUOUS', 'EXPERT_NON_CONTINUOUS', 'CONTINUOUS', 'NON_CONTINUOUS', 'COMMISSIONER', 'EVENT_PARTICIPANT', 'EXPATRIATE']):
            raise ValueError("must be one of enum values ('PERMANENT', 'TEMPORARY', 'EXPERT_CONTINUOUS', 'EXPERT_NON_CONTINUOUS', 'CONTINUOUS', 'NON_CONTINUOUS', 'COMMISSIONER', 'EVENT_PARTICIPANT', 'EXPATRIATE')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "component": CalculationScenarioComponent.from_dict(obj["component"]) if obj.get("component") is not None else None
        })
        return _obj
