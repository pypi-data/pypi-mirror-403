...
class BankBranchSimpleResponse(BaseModel):
    """
    BankBranchSimpleResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    bank: Optional[IdCodeNameResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "bank": IdCodeNameResponse.from_dict(obj["bank"]) if obj.get("bank") is not None else None
        })
        return _obj
