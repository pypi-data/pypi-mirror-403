...
class OrganizationParentResponse(BaseModel):
    """
    ...
    organization_parent: Optional[Dict[str, Any]] = Field(default=None, alias="organizationParent")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if organization_parent (nullable) is None
        # and model_fields_set contains the field
        if self.organization_parent is None and "organization_parent" in self.model_fields_set:
            _dict['organizationParent'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "organizationParent": obj.get("organizationParent"),
