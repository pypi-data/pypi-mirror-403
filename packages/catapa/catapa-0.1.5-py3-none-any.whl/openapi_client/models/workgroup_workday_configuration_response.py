...
class WorkgroupWorkdayConfigurationResponse(BaseModel):
    """
    ...
    shift_pattern_template: Optional[ShiftPatternTemplateSimpleResponse] = Field(default=None, alias="shiftPatternTemplate")
    workday_configuration_details: Optional[List[WorkdayConfigurationDetailResponse]] = Field(default=None, alias="workdayConfigurationDetails")
    start_sequence: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="startSequence")
    start_shift: Optional[ShiftResponse] = Field(default=None, alias="startShift")
    include_holiday: Optional[StrictBool] = Field(default=None, alias="includeHoliday")
    workgroup: Optional[IdCodeNameResponse] = None
    __properties: ClassVar[List[str]] = ["id", "startDate", "endDate", "shiftPatternTemplate", "workdayConfigurationDetails", "startSequence", "startShift", "includeHoliday", "workgroup"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of shift_pattern_template
        if self.shift_pattern_template:
            _dict['shiftPatternTemplate'] = self.shift_pattern_template.to_dict()
        # override the default output from pydantic by calling `to_dict()` of each item in workday_configuration_details (list)
        _items = []
        if self.workday_configuration_details:
            for _item_workday_configuration_details in self.workday_configuration_details:
                if _item_workday_configuration_details:
                    _items.append(_item_workday_configuration_details.to_dict())
            _dict['workdayConfigurationDetails'] = _items
        # override the default output from pydantic by calling `to_dict()` of start_shift
        if self.start_shift:
            _dict['startShift'] = self.start_shift.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shiftPatternTemplate": ShiftPatternTemplateSimpleResponse.from_dict(obj["shiftPatternTemplate"]) if obj.get("shiftPatternTemplate") is not None else None,
            "workdayConfigurationDetails": [WorkdayConfigurationDetailResponse.from_dict(_item) for _item in obj["workdayConfigurationDetails"]] if obj.get("workdayConfigurationDetails") is not None else None,
            "startSequence": obj.get("startSequence"),
            "startShift": ShiftResponse.from_dict(obj["startShift"]) if obj.get("startShift") is not None else None,
            "includeHoliday": obj.get("includeHoliday"),
            "workgroup": IdCodeNameResponse.from_dict(obj["workgroup"]) if obj.get("workgroup") is not None else None
        })
        return _obj
