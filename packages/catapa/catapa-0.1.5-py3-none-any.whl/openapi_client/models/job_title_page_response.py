...
class JobTitlePageResponse(BaseModel):
    """
    ...
    content: Optional[List[JobTitleResponse]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JobTitlePageResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JobTitlePageResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "content": [JobTitleResponse.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None
        })
        return _obj
