...
class FormerEmployeeIncomeEmployeeResponse(BaseModel):
    """
    FormerEmployeeIncomeEmployeeResponse
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Former employee income employee ID")
    former_employee_income: Optional[FormerEmployeeIncomeResponse] = Field(default=None, alias="formerEmployeeIncome")
    employee: Optional[EmployeeSimpleResponse] = None
    amount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Income amount")
    last_working_date: Optional[date] = Field(default=None, description="Last working date", alias="lastWorkingDate")
    ...
    total_thp: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Total take home pay", alias="totalThp")
    original_tax: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Original tax amount", alias="originalTax")
    penalty_tax: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Penalty tax amount", alias="penaltyTax")
    tax_allowance: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Tax allowance amount", alias="taxAllowance")
    __properties: ClassVar[List[str]] = ["id", "formerEmployeeIncome", "employee", "amount", "lastWorkingDate", "paymentDate", "paymentMethod", "totalThp", "originalTax", "penaltyTax", "taxAllowance"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of former_employee_income
        if self.former_employee_income:
            _dict['formerEmployeeIncome'] = self.former_employee_income.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "formerEmployeeIncome": FormerEmployeeIncomeResponse.from_dict(obj["formerEmployeeIncome"]) if obj.get("formerEmployeeIncome") is not None else None,
            "employee": EmployeeSimpleResponse.from_dict(obj["employee"]) if obj.get("employee") is not None else None,
            "amount": obj.get("amount"),
            "lastWorkingDate": obj.get("lastWorkingDate"),
            "paymentDate": obj.get("paymentDate"),
            "paymentMethod": obj.get("paymentMethod"),
            "totalThp": obj.get("totalThp"),
            "originalTax": obj.get("originalTax"),
            "penaltyTax": obj.get("penaltyTax"),
