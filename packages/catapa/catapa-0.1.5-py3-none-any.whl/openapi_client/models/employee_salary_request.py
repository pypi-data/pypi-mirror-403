...
class EmployeeSalaryRequest(BaseModel):
    """
    EmployeeSalaryRequest
    """ # noqa: E501
    salary_item_id: StrictStr = Field(alias="salaryItemId")
    amount: Union[StrictFloat, StrictInt]
    formula: StrictStr
    recurring_configuration: RecurringConfigurationRequest = Field(alias="recurringConfiguration")
    __properties: ClassVar[List[str]] = ["salaryItemId", "amount", "formula", "recurringConfiguration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recurringConfiguration": RecurringConfigurationRequest.from_dict(obj["recurringConfiguration"]) if obj.get("recurringConfiguration") is not None else None
        })
        return _obj
