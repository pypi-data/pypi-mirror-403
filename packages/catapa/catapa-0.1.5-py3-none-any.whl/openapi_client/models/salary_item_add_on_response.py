...
class SalaryItemAddOnResponse(BaseModel):
    """
    SalaryItemAddOnResponse
    """ # noqa: E501
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    var_date: Optional[StrictStr] = Field(default=None, alias="date")
    employee: Optional[SalaryItemAddOnEmployeeResponse] = None
    salary_calculation_processed: Optional[StrictBool] = Field(default=None, alias="salaryCalculationProcessed")
    salary_item: Optional[SalaryItemSimpleResponse] = Field(default=None, alias="salaryItem")
    __properties: ClassVar[List[str]] = ["amount", "date", "employee", "salaryCalculationProcessed", "salaryItem"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of salary_item
        if self.salary_item:
            _dict['salaryItem'] = self.salary_item.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "date": obj.get("date"),
            "employee": SalaryItemAddOnEmployeeResponse.from_dict(obj["employee"]) if obj.get("employee") is not None else None,
            "salaryCalculationProcessed": obj.get("salaryCalculationProcessed"),
            "salaryItem": SalaryItemSimpleResponse.from_dict(obj["salaryItem"]) if obj.get("salaryItem") is not None else None
        })
        return _obj
