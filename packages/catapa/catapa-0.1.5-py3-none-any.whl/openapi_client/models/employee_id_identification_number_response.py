...
class EmployeeIdIdentificationNumberResponse(BaseModel):
    """
    EmployeeIdIdentificationNumberResponse
    """ # noqa: E501
    id: StrictStr
    identification_number: StrictStr = Field(alias="identificationNumber")
    __properties: ClassVar[List[str]] = ["id", "identificationNumber"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmployeeIdIdentificationNumberResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmployeeIdIdentificationNumberResponse from a dict"""
        if obj is None:
            return None
