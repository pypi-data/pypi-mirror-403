...
class BulkOperationFailureResponse(BaseModel):
    """
    BulkOperationFailureResponse
    """ # noqa: E501
    code: Optional[StrictStr] = None
    message: Optional[StrictStr] = None
    params: Optional[BulkOperationFailureParamResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "params": BulkOperationFailureParamResponse.from_dict(obj["params"]) if obj.get("params") is not None else None
        })
        return _obj
