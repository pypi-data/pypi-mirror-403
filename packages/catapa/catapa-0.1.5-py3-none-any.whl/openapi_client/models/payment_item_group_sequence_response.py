...
class PaymentItemGroupSequenceResponse(BaseModel):
    """
    PaymentItemGroupSequenceResponse
    """ # noqa: E501
    employee_id: Optional[StrictStr] = Field(default=None, alias="employeeId")
    payment_item_group_id: Optional[StrictStr] = Field(default=None, alias="paymentItemGroupId")
    sequence: Optional[StrictInt] = None
    previous_sequence: Optional[StrictInt] = Field(default=None, alias="previousSequence")
    __properties: ClassVar[List[str]] = ["employeeId", "paymentItemGroupId", "sequence", "previousSequence"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "paymentItemGroupId": obj.get("paymentItemGroupId"),
            "sequence": obj.get("sequence"),
            "previousSequence": obj.get("previousSequence")
        })
        return _obj
