...
class PaymentItemDetailResponse(BaseModel):
    """
    PaymentItemDetailResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    salary_item: Optional[PaymentItemDetailSalaryItemResponse] = Field(default=None, alias="salaryItem")
    __properties: ClassVar[List[str]] = ["id", "amount", "salaryItem"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "salaryItem": PaymentItemDetailSalaryItemResponse.from_dict(obj["salaryItem"]) if obj.get("salaryItem") is not None else None
        })
        return _obj
