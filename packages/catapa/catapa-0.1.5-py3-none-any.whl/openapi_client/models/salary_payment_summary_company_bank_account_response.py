...
class SalaryPaymentSummaryCompanyBankAccountResponse(BaseModel):
    """
    ...
    bank_branch: Optional[BankBranchSimpleResponse] = Field(default=None, alias="bankBranch")
    __properties: ClassVar[List[str]] = ["id", "accountNumber", "bankBranch"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bankBranch": BankBranchSimpleResponse.from_dict(obj["bankBranch"]) if obj.get("bankBranch") is not None else None
        })
        return _obj
