...
class EmployeeSalaryTemplatePageResponse(BaseModel):
    """
    ...
    content: Optional[List[EmployeeSalaryTemplateResponse]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "content": [EmployeeSalaryTemplateResponse.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None
        })
        return _obj
