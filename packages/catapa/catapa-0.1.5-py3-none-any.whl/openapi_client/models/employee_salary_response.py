...
class EmployeeSalaryResponse(BaseModel):
    ...
    """ # noqa: E501
    salary_item_id: Optional[StrictStr] = Field(default=None, alias="salaryItemId")
    salary_item_code: Optional[StrictStr] = Field(default=None, alias="salaryItemCode")
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    recurring_configuration: Optional[RecurringConfigurationResponse] = Field(default=None, alias="recurringConfiguration")
    __properties: ClassVar[List[str]] = ["salaryItemId", "salaryItemCode", "amount", "recurringConfiguration"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of recurring_configuration
        if self.recurring_configuration:
            _dict['recurringConfiguration'] = self.recurring_configuration.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "salaryItemId": obj.get("salaryItemId"),
            "salaryItemCode": obj.get("salaryItemCode"),
            "amount": obj.get("amount"),
            "recurringConfiguration": RecurringConfigurationResponse.from_dict(obj["recurringConfiguration"]) if obj.get("recurringConfiguration") is not None else None
        })
        return _obj
