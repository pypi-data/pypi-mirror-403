...
class BankAccountResponse(BaseModel):
    ...
    bank_branch_id: Optional[StrictStr] = Field(default=None, alias="bankBranchId")
    bank_branch: Optional[BankBranchResponse] = Field(default=None, alias="bankBranch")
    ...
    beneficiary_id: Optional[StrictStr] = Field(default=None, alias="beneficiaryId")
    priority: Optional[Union[StrictFloat, StrictInt]] = None
    currency: Optional[CurrencySimpleResponse] = None
    percentage: Optional[Union[StrictFloat, StrictInt]] = None
    amount: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["id", "bankId", "bank", "bankBranchId", "bankBranch", "accountNumber", "accountName", "beneficiaryId", "priority", "currency", "percentage", "amount"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of bank_branch
        if self.bank_branch:
            _dict['bankBranch'] = self.bank_branch.to_dict()
        # override the default output from pydantic by calling `to_dict()` of currency
        if self.currency:
            _dict['currency'] = self.currency.to_dict()
        # set to None if bank_branch_id (nullable) is None
        # and model_fields_set contains the field
        if self.bank_branch_id is None and "bank_branch_id" in self.model_fields_set:
            _dict['bankBranchId'] = None

        # set to None if beneficiary_id (nullable) is None
        # and model_fields_set contains the field
        if self.beneficiary_id is None and "beneficiary_id" in self.model_fields_set:
            _dict['beneficiaryId'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bank": BankResponse.from_dict(obj["bank"]) if obj.get("bank") is not None else None,
            "bankBranchId": obj.get("bankBranchId"),
            "bankBranch": BankBranchResponse.from_dict(obj["bankBranch"]) if obj.get("bankBranch") is not None else None,
            "accountNumber": obj.get("accountNumber"),
            "accountName": obj.get("accountName"),
            "beneficiaryId": obj.get("beneficiaryId"),
            "priority": obj.get("priority"),
            "currency": CurrencySimpleResponse.from_dict(obj["currency"]) if obj.get("currency") is not None else None,
