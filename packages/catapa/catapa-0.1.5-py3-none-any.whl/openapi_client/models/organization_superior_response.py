...
class OrganizationSuperiorResponse(BaseModel):
    """
    OrganizationSuperiorResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    organization: Optional[IdCodeNameResponse] = None
    superior: Optional[IdCodeNameResponse] = None
    effective_date: Optional[date] = Field(default=None, alias="effectiveDate")
    __properties: ClassVar[List[str]] = ["id", "organization", "superior", "effectiveDate"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of superior
        if self.superior:
            _dict['superior'] = self.superior.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "superior": IdCodeNameResponse.from_dict(obj["superior"]) if obj.get("superior") is not None else None,
