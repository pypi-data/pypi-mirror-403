...
class PositionVacancyStatusResponse(BaseModel):
    """
    PositionVacancyStatusResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    effective_date: Optional[StrictStr] = Field(default=None, alias="effectiveDate")
    vacancy_status: Optional[StrictStr] = Field(default=None, alias="vacancyStatus")
    position: Optional[IdCodeNameResponse] = None
    ...
    __properties: ClassVar[List[str]] = ["id", "effectiveDate", "vacancyStatus", "position", "createdBy", "createdDate", "updatedBy", "updatedDate"]

    @field_validator('vacancy_status')
    def vacancy_status_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['VACANT', 'FILLED']):
            raise ValueError("must be one of enum values ('VACANT', 'FILLED')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vacancyStatus": obj.get("vacancyStatus"),
            "position": IdCodeNameResponse.from_dict(obj["position"]) if obj.get("position") is not None else None,
