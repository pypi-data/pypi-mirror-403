...
class LocationCreateRequest(BaseModel):
    ...
    location_group: Optional[IdRequest] = Field(default=None, alias="locationGroup")
    city: Dict[str, Any]
    latitude: Optional[Union[StrictFloat, StrictInt]] = None
    longitude: Optional[Union[StrictFloat, StrictInt]] = None
    address: Optional[Annotated[str, Field(strict=True, max_length=65535)]] = None
    phone: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="e.g. `+6281234567890`")
    zip_code: Optional[Annotated[str, Field(strict=True, max_length=5)]] = Field(default=None, description="Numeric", alias="zipCode")
    headquarter: StrictBool = Field(description="If value is true, will automatically update headquarter in company profile")
    __properties: ClassVar[List[str]] = ["code", "name", "locationGroup", "city", "latitude", "longitude", "address", "phone", "zipCode", "headquarter"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "name": obj.get("name"),
            "locationGroup": IdRequest.from_dict(obj["locationGroup"]) if obj.get("locationGroup") is not None else None,
            "city": IdRequest.from_dict(obj["city"]) if obj.get("city") is not None else None,
