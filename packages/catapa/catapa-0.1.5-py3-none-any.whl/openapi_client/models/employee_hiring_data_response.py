...
class EmployeeHiringDataResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "identificationNumber", "joinDate", "name", "startDate", "pointOfHire", "photo", "manager"]
