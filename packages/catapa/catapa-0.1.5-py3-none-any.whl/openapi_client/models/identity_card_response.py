...
class IdentityCardResponse(BaseModel):
    ...
    identity_card_type: Optional[StrictStr] = Field(default=None, alias="identityCardType")
    __properties: ClassVar[List[str]] = ["id", "code", "name", "identityCardType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "name": obj.get("name"),
            "identityCardType": obj.get("identityCardType")
        })
        return _obj
