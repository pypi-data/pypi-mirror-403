...
class BpjsHealthcareMembershipRequest(BaseModel):
    """
    BpjsHealthcareMembershipRequest
    """ # noqa: E501
    additional_family_memberships: List[BpjsHealthcareMembershipAdditionalFamilyMembership] = Field(alias="additionalFamilyMemberships")
    bpjs_healthcare_provider_id: StrictStr = Field(alias="bpjsHealthcareProviderId")
    bpjs_healthcare_template_id: StrictStr = Field(alias="bpjsHealthcareTemplateId")
    bpjs_healthcare_treatment_class_id: Optional[StrictStr] = Field(default=None, alias="bpjsHealthcareTreatmentClassId")
    ...
    membership_number: StrictStr = Field(alias="membershipNumber")
    start_date: StrictStr = Field(alias="startDate")
    effective_date: Optional[StrictStr] = Field(default=None, description="Effective Date of the BPJS Healthcare Membership default to start date", alias="effectiveDate")
    __properties: ClassVar[List[str]] = ["additionalFamilyMemberships", "bpjsHealthcareProviderId", "bpjsHealthcareTemplateId", "bpjsHealthcareTreatmentClassId", "dentalHealthcareFacility", "firstLevelHealthcareFacility", "membershipNumber", "startDate", "effectiveDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "additionalFamilyMemberships": [BpjsHealthcareMembershipAdditionalFamilyMembership.from_dict(_item) for _item in obj["additionalFamilyMemberships"]] if obj.get("additionalFamilyMemberships") is not None else None,
            "bpjsHealthcareProviderId": obj.get("bpjsHealthcareProviderId"),
            "bpjsHealthcareTemplateId": obj.get("bpjsHealthcareTemplateId"),
            "bpjsHealthcareTreatmentClassId": obj.get("bpjsHealthcareTreatmentClassId"),
