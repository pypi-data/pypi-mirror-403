...
class TimeAllowanceDetailsResponse(BaseModel):
    """
    TimeAllowanceDetailsResponse
    """ # noqa: E501
    salary_calculation_detail: Optional[IdResponse] = Field(default=None, alias="salaryCalculationDetail")
    time_allowance_details: Optional[List[TimeAllowanceDetailResponse]] = Field(default=None, alias="timeAllowanceDetails")
    __properties: ClassVar[List[str]] = ["salaryCalculationDetail", "timeAllowanceDetails"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of salary_calculation_detail
        if self.salary_calculation_detail:
            _dict['salaryCalculationDetail'] = self.salary_calculation_detail.to_dict()
        # override the default output from pydantic by calling `to_dict()` of each item in time_allowance_details (list)
        _items = []
        if self.time_allowance_details:
            for _item_time_allowance_details in self.time_allowance_details:
                if _item_time_allowance_details:
                    _items.append(_item_time_allowance_details.to_dict())
            _dict['timeAllowanceDetails'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "salaryCalculationDetail": IdResponse.from_dict(obj["salaryCalculationDetail"]) if obj.get("salaryCalculationDetail") is not None else None,
            "timeAllowanceDetails": [TimeAllowanceDetailResponse.from_dict(_item) for _item in obj["timeAllowanceDetails"]] if obj.get("timeAllowanceDetails") is not None else None
        })
        return _obj
