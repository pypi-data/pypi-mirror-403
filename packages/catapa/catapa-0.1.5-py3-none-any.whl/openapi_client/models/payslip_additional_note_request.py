...
class PayslipAdditionalNoteRequest(BaseModel):
    """
    PayslipAdditionalNoteRequest
    """ # noqa: E501
    payment_date: StrictStr = Field(alias="paymentDate")
    note: Annotated[str, Field(strict=True, max_length=150)] = Field(description="Max length 150")
    __properties: ClassVar[List[str]] = ["paymentDate", "note"]
