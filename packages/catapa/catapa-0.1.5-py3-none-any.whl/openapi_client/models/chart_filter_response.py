...
class ChartFilterResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "chartFilterType", "column", "values", "startDate", "endDate", "timeFrame", "timeUnit", "duration"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "column": AnalyticsColumnResponse.from_dict(obj["column"]) if obj.get("column") is not None else None,
