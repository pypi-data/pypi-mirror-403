...
class CompanyDetailResponse(BaseModel):
    ...
    siup: Optional[StrictStr] = None
    tdp: Optional[StrictStr] = None
    logo: Optional[StrictStr] = None
    logo_original_filename: Optional[StrictStr] = Field(default=None, alias="logoOriginalFilename")
    logo_file_metadata: Optional[LogoFileMetadataResponse] = Field(default=None, alias="logoFileMetadata")
    time_zone: Optional[TimeZoneResponse] = Field(default=None, alias="timeZone")
    email: Optional[StrictStr] = None
    company_superior: Optional[CompanySuperiorResponse] = Field(default=None, alias="companySuperior")
    location: Optional[LocationResponse] = None
    company_group: Optional[IdCodeNameResponse] = Field(default=None, alias="companyGroup")
    __properties: ClassVar[List[str]] = ["id", "name", "code", "website", "siup", "tdp", "logo", "logoOriginalFilename", "logoFileMetadata", "timeZone", "email", "companySuperior", "location", "companyGroup"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of logo_file_metadata
        if self.logo_file_metadata:
            _dict['logoFileMetadata'] = self.logo_file_metadata.to_dict()
        ...
        # override the default output from pydantic by calling `to_dict()` of company_group
        if self.company_group:
            _dict['companyGroup'] = self.company_group.to_dict()
        ...
        # set to None if logo_original_filename (nullable) is None
        # and model_fields_set contains the field
        if self.logo_original_filename is None and "logo_original_filename" in self.model_fields_set:
            _dict['logoOriginalFilename'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tdp": obj.get("tdp"),
            "logo": obj.get("logo"),
            "logoOriginalFilename": obj.get("logoOriginalFilename"),
            "logoFileMetadata": LogoFileMetadataResponse.from_dict(obj["logoFileMetadata"]) if obj.get("logoFileMetadata") is not None else None,
            "timeZone": TimeZoneResponse.from_dict(obj["timeZone"]) if obj.get("timeZone") is not None else None,
            "email": obj.get("email"),
            "companySuperior": CompanySuperiorResponse.from_dict(obj["companySuperior"]) if obj.get("companySuperior") is not None else None,
            "location": LocationResponse.from_dict(obj["location"]) if obj.get("location") is not None else None,
            "companyGroup": IdCodeNameResponse.from_dict(obj["companyGroup"]) if obj.get("companyGroup") is not None else None
        })
        return _obj
