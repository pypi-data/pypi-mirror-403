...
class EmployeeIdentityCardResponse(BaseModel):
    """
    EmployeeIdentityCardResponse
    """ # noqa: E501
    id: Optional[StrictStr] = None
    identity_card: Optional[IdentityCardResponse] = Field(default=None, alias="identityCard")
    identity_card_number: Optional[StrictStr] = Field(default=None, alias="identityCardNumber")
    expired_date: Optional[StrictStr] = Field(default=None, alias="expiredDate")
    __properties: ClassVar[List[str]] = ["id", "identityCard", "identityCardNumber", "expiredDate"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of identity_card
        if self.identity_card:
            _dict['identityCard'] = self.identity_card.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "identityCard": IdentityCardResponse.from_dict(obj["identityCard"]) if obj.get("identityCard") is not None else None,
