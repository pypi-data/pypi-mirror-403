...
class TaxMembershipHistoryApi:
    ...
    def get_tax_membership_history(
        self,
        employee_id: Annotated[StrictStr, Field(description="Unique identifier for the employee")],
        year: Annotated[int, Field(strict=True, ge=1970, description="Year for which to retrieve tax membership history")],
        month: Annotated[Optional[Annotated[int, Field(le=12, strict=True, ge=1)]], Field(description="Month for which to retrieve tax membership history (defaults to December)")] = None,
        ...
        :param employee_id: Unique identifier for the employee (required)
        :type employee_id: str
        :param year: Year for which to retrieve tax membership history (required)
        :type year: int
        :param month: Month for which to retrieve tax membership history (defaults to December)
        :type month: int
        ...
        _param = self._get_tax_membership_history_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "TaxMembershipHistoryResponse",
            '400': "ErrorResponse",
            '404': "ErrorResponse",
        }
    ...
    @validate_call
    def get_tax_membership_history_with_http_info(
        self,
        employee_id: Annotated[StrictStr, Field(description="Unique identifier for the employee")],
        year: Annotated[int, Field(strict=True, ge=1970, description="Year for which to retrieve tax membership history")],
        month: Annotated[Optional[Annotated[int, Field(le=12, strict=True, ge=1)]], Field(description="Month for which to retrieve tax membership history (defaults to December)")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TaxMembershipHistoryResponse]:
        """Get Tax Membership History
    ...
    @validate_call
    def get_tax_membership_history_without_preload_content(
        self,
        employee_id: Annotated[StrictStr, Field(description="Unique identifier for the employee")],
        year: Annotated[int, Field(strict=True, ge=1970, description="Year for which to retrieve tax membership history")],
        month: Annotated[Optional[Annotated[int, Field(le=12, strict=True, ge=1)]], Field(description="Month for which to retrieve tax membership history (defaults to December)")] = None,
    ...
    def _get_tax_membership_history_serialize(
        self,
        employee_id,
        year,
        month,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/employees/{employeeId}/tax-membership-histories',
    ...
    @validate_call
    def get_tax_membership_history_by_id(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier for the tax membership history record")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Unique identifier for the tax membership history record (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_tax_membership_history_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_tax_membership_history_by_id_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier for the tax membership history record")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_tax_membership_history_by_id_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier for the tax membership history record")],
        _request_timeout: Union[
            None,
    ...
    def _get_tax_membership_history_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/tax-membership-histories/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_tax_membership_history_tax_subject(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier for the tax membership history record")],
        tax_membership_tax_subject_request: Annotated[TaxMembershipTaxSubjectRequest, Field(description="Tax subject information to update for the history record")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Unique identifier for the tax membership history record (required)
        :type id: str
        :param tax_membership_tax_subject_request: Tax subject information to update for the history record (required)
        :type tax_membership_tax_subject_request: TaxMembershipTaxSubjectRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_tax_membership_history_tax_subject_serialize(
            id=id,
            tax_membership_tax_subject_request=tax_membership_tax_subject_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_tax_membership_history_tax_subject_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier for the tax membership history record")],
        tax_membership_tax_subject_request: Annotated[TaxMembershipTaxSubjectRequest, Field(description="Tax subject information to update for the history record")],
        _request_timeout: Union[
    ...
    @validate_call
    def update_tax_membership_history_tax_subject_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Unique identifier for the tax membership history record")],
        tax_membership_tax_subject_request: Annotated[TaxMembershipTaxSubjectRequest, Field(description="Tax subject information to update for the history record")],
        _request_timeout: Union[
    ...
    def _update_tax_membership_history_tax_subject_serialize(
        self,
        id,
        tax_membership_tax_subject_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if tax_membership_tax_subject_request is not None:
            _body_params = tax_membership_tax_subject_request
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/core/v1/tax-membership-histories/{id}/tax-subjects',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
