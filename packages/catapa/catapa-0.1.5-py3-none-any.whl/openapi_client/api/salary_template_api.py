...
class SalaryTemplateApi:
    ...
    def add_salary_item_add_on(
        self,
        salary_item_add_on_request: Optional[SalaryItemAddOnRequest] = None,
        ...
        :param salary_item_add_on_request:
        :type salary_item_add_on_request: SalaryItemAddOnRequest
        ...
        _param = self._add_salary_item_add_on_serialize(
            salary_item_add_on_request=salary_item_add_on_request,
    ...
    @validate_call
    def add_salary_item_add_on_with_http_info(
        self,
        salary_item_add_on_request: Optional[SalaryItemAddOnRequest] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SalaryItemAddOnResponse]:
        """Add Salary Item Add On
    ...
    @validate_call
    def add_salary_item_add_on_without_preload_content(
        self,
        salary_item_add_on_request: Optional[SalaryItemAddOnRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _add_salary_item_add_on_serialize(
        self,
        ...
        if salary_item_add_on_request is not None:
            _body_params = salary_item_add_on_request
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/core/v1/salary-item-add-on/add',
    ...
    def delete_salary_item_add_on(
        self,
        tenant: StrictStr,
        employee_identification_number: StrictStr,
        var_date: StrictStr,
        salary_item_code: StrictStr,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type tenant: str
        :param employee_identification_number: (required)
        :type employee_identification_number: str
        :param var_date: (required)
        :type var_date: str
        :param salary_item_code: (required)
        :type salary_item_code: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_salary_item_add_on_serialize(
            tenant=tenant,
            employee_identification_number=employee_identification_number,
            var_date=var_date,
            salary_item_code=salary_item_code,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def delete_salary_item_add_on_with_http_info(
        self,
        tenant: StrictStr,
        employee_identification_number: StrictStr,
        var_date: StrictStr,
    ...
    @validate_call
    def delete_salary_item_add_on_without_preload_content(
        self,
        tenant: StrictStr,
        employee_identification_number: StrictStr,
        var_date: StrictStr,
    ...
    def _delete_salary_item_add_on_serialize(
        self,
        tenant,
        ...
        if employee_identification_number is not None:
            ...
            _query_params.append(('employeeIdentificationNumber', employee_identification_number))
            
        if var_date is not None:
            
            _query_params.append(('date', var_date))
            
        if salary_item_code is not None:
            
            _query_params.append(('salaryItemCode', salary_item_code))
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/core/v1/salary-item-add-on',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_salary_item_add_on(
        ...
        _param = self._get_salary_item_add_on_serialize(
            employee_identification_number=employee_identification_number,
            var_date=var_date,
            salary_item_code=salary_item_code,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_salary_item_add_on_with_http_info(
        self,
        employee_identification_number: StrictStr,
        var_date: StrictStr,
        salary_item_code: StrictStr,
    ...
    @validate_call
    def get_salary_item_add_on_without_preload_content(
        self,
        employee_identification_number: StrictStr,
        var_date: StrictStr,
        salary_item_code: StrictStr,
    ...
    def _get_salary_item_add_on_serialize(
        self,
        employee_identification_number,
        var_date,
        salary_item_code,
    ...
    def get_salary_template_by_id(
        ...
        _param = self._get_salary_template_by_id_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_salary_template_by_id_with_http_info(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SalaryTemplateResponse]:
        """Get Salary Template by ID
    ...
    @validate_call
    def get_salary_template_by_id_without_preload_content(
        self,
        id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_salary_template_by_id_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/salary-templates/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_salary_templates(
        ...
        _param = self._get_salary_templates_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "SalaryTemplatePageResponse",
            '400': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_salary_templates_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SalaryTemplatePageResponse]:
        """Get Salary Templates
    ...
    @validate_call
    def get_salary_templates_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_salary_templates_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/salary-templates',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def subtract_salary_item_add_on(
        ...
        _param = self._subtract_salary_item_add_on_serialize(
            salary_item_add_on_request=salary_item_add_on_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def subtract_salary_item_add_on_with_http_info(
        self,
        salary_item_add_on_request: Optional[SalaryItemAddOnRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def subtract_salary_item_add_on_without_preload_content(
        self,
        salary_item_add_on_request: Optional[SalaryItemAddOnRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _subtract_salary_item_add_on_serialize(
        self,
        salary_item_add_on_request,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/core/v1/salary-item-add-on/subtract',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_salary_item_add_on(
        ...
        _param = self._update_salary_item_add_on_serialize(
            salary_item_add_on_request=salary_item_add_on_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def update_salary_item_add_on_with_http_info(
        self,
        salary_item_add_on_request: Optional[SalaryItemAddOnRequest] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def update_salary_item_add_on_without_preload_content(
        self,
        salary_item_add_on_request: Optional[SalaryItemAddOnRequest] = None,
        _request_timeout: Union[
            None,
    ...
    def _update_salary_item_add_on_serialize(
        self,
        salary_item_add_on_request,
        _request_auth,
        _content_type,
