...
class TaxMembershipApi:
    ...
    def get_tax_membership(
        ...
        _param = self._get_tax_membership_serialize(
    ...
    @validate_call
    def get_tax_membership_with_http_info(
        self,
        employee_id: Annotated[StrictStr, Field(description="Unique identifier for the employee")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TaxMembershipResponse]:
        """Get Tax Membership
    ...
    @validate_call
    def get_tax_membership_without_preload_content(
        self,
        employee_id: Annotated[StrictStr, Field(description="Unique identifier for the employee")],
        _request_timeout: Union[
            None,
    ...
    def _get_tax_membership_serialize(
        self,
        employee_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/employees/{employeeId}/tax-memberships',
    ...
    def update_tax_membership(
        self,
        employee_id: Annotated[StrictStr, Field(description="Unique identifier for the employee")],
        tax_membership_response: Optional[TaxMembershipResponse] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param employee_id: Unique identifier for the employee (required)
        :type employee_id: str
        :param tax_membership_response:
        :type tax_membership_response: TaxMembershipResponse
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_tax_membership_serialize(
            employee_id=employee_id,
            tax_membership_response=tax_membership_response,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def update_tax_membership_with_http_info(
        self,
        employee_id: Annotated[StrictStr, Field(description="Unique identifier for the employee")],
        tax_membership_response: Optional[TaxMembershipResponse] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_tax_membership_without_preload_content(
        self,
        employee_id: Annotated[StrictStr, Field(description="Unique identifier for the employee")],
        tax_membership_response: Optional[TaxMembershipResponse] = None,
        _request_timeout: Union[
    ...
    def _update_tax_membership_serialize(
        self,
        employee_id,
        ...
        # process the form parameters
        # process the body parameter
        if tax_membership_response is not None:
            _body_params = tax_membership_response
    ...
    def update_tax_membership_tax_subject(
        self,
        employee_id: Annotated[StrictStr, Field(description="Unique identifier for the employee")],
        tax_membership_tax_subject_request: Annotated[TaxMembershipTaxSubjectRequest, Field(description="Tax subject information to update")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param employee_id: Unique identifier for the employee (required)
        :type employee_id: str
        :param tax_membership_tax_subject_request: Tax subject information to update (required)
        ...
        _param = self._update_tax_membership_tax_subject_serialize(
            employee_id=employee_id,
    ...
    @validate_call
    def update_tax_membership_tax_subject_with_http_info(
        self,
        employee_id: Annotated[StrictStr, Field(description="Unique identifier for the employee")],
        tax_membership_tax_subject_request: Annotated[TaxMembershipTaxSubjectRequest, Field(description="Tax subject information to update")],
        _request_timeout: Union[
    ...
    @validate_call
    def update_tax_membership_tax_subject_without_preload_content(
        self,
        employee_id: Annotated[StrictStr, Field(description="Unique identifier for the employee")],
        tax_membership_tax_subject_request: Annotated[TaxMembershipTaxSubjectRequest, Field(description="Tax subject information to update")],
        _request_timeout: Union[
    ...
    def _update_tax_membership_tax_subject_serialize(
        self,
        employee_id,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/core/v1/employees/{employeeId}/tax-memberships/tax-subjects',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
