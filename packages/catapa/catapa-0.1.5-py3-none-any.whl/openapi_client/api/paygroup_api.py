...
class PaygroupApi:
    ...
    def get_paygroup(
        ...
        _param = self._get_paygroup_serialize(
    ...
    @validate_call
    def get_paygroup_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaygroupPageResponse]:
        """Get Paygroup
    ...
    @validate_call
    def get_paygroup_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_paygroup_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/paygroups',
