...
class WidgetsApi:
    ...
    @validate_call
    def get_widgets_by_current_user(
        self,
        ...
        _param = self._get_widgets_by_current_user_serialize(
    ...
    @validate_call
    def get_widgets_by_current_user_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WidgetPageResponse]:
        """Get Widgets by Current User
    ...
    @validate_call
    def get_widgets_by_current_user_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_widgets_by_current_user_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/users/me/widgets',
