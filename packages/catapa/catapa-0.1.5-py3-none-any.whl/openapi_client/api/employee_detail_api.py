...
class EmployeeDetailApi:
    ...
    def get_employee_detail(
        ...
        _param = self._get_employee_detail_serialize(
    ...
    @validate_call
    def get_employee_detail_with_http_info(
        self,
        employee_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_employee_detail_without_preload_content(
        self,
        employee_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _get_employee_detail_serialize(
        self,
        employee_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/employees/{employeeId}/employee-details',
    ...
    def get_historical_employee_details(
        ...
        _param = self._get_historical_employee_details_serialize(
            page=page,
            size=size,
            query=query,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "EmployeeDetailPageResponse",
            '400': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_historical_employee_details_with_http_info(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Page number")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Page size")] = None,
        query: Annotated[Optional[StrictStr], Field(description="### Search Query | Supported Keys     | Supported Operators | Notes                                                                                     | |--------------------|---------------------|-------------------------------------------------------------------------------------------| | id                 | `:`                 | Equal operator<br/>Support multiple values with each value separated by the `;` delimiter | | employee.id        | `:`                 | Equal operator<br/>Support multiple values with each value separated by the `;` delimiter | | effectiveDate      | `<`                 | Less than or equal to<br/><br/>Use `yyyy-MM-dd` format, e.g. `effectiveDate<2025-01-31  ` | ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EmployeeDetailPageResponse]:
        """Get Historical Employee Details
    ...
    @validate_call
    def get_historical_employee_details_without_preload_content(
        self,
        page: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Page number")] = None,
        size: Annotated[Optional[Annotated[int, Field(le=50, strict=True, ge=1)]], Field(description="Page size")] = None,
        query: Annotated[Optional[StrictStr], Field(description="### Search Query | Supported Keys     | Supported Operators | Notes                                                                                     | |--------------------|---------------------|-------------------------------------------------------------------------------------------| | id                 | `:`                 | Equal operator<br/>Support multiple values with each value separated by the `;` delimiter | | employee.id        | `:`                 | Equal operator<br/>Support multiple values with each value separated by the `;` delimiter | | effectiveDate      | `<`                 | Less than or equal to<br/><br/>Use `yyyy-MM-dd` format, e.g. `effectiveDate<2025-01-31  ` | ")] = None,
    ...
    def _get_historical_employee_details_serialize(
        self,
        page,
        size,
        query,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/core/v1/employee-details',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_employee_detail(
        self,
        employee_id: StrictStr,
        employee_detail_request: Optional[EmployeeDetailRequest] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param employee_id: (required)
        :type employee_id: str
        :param employee_detail_request:
        :type employee_detail_request: EmployeeDetailRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_employee_detail_serialize(
            employee_id=employee_id,
    ...
    @validate_call
    def update_employee_detail_with_http_info(
        self,
        employee_id: StrictStr,
        employee_detail_request: Optional[EmployeeDetailRequest] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_employee_detail_without_preload_content(
        self,
        employee_id: StrictStr,
        employee_detail_request: Optional[EmployeeDetailRequest] = None,
        _request_timeout: Union[
    ...
    def _update_employee_detail_serialize(
        self,
        employee_id,
        ...
        # process the form parameters
        # process the body parameter
        if employee_detail_request is not None:
            _body_params = employee_detail_request
