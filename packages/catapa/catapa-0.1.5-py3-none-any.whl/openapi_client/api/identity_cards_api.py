...
class IdentityCardsApi:
    ...
    def create_employee_identity_cards(
        ...
        employee_identity_card_request: Optional[EmployeeIdentityCardRequest] = None,
        ...
        :param employee_identity_card_request:
        :type employee_identity_card_request: EmployeeIdentityCardRequest
        ...
        _param = self._create_employee_identity_cards_serialize(
            employee_id=employee_id,
            employee_identity_card_request=employee_identity_card_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "EmployeeIdentityCardResponse",
            '400': None,
        }
    ...
    @validate_call
    def create_employee_identity_cards_with_http_info(
        self,
        employee_id: StrictStr,
        employee_identity_card_request: Optional[EmployeeIdentityCardRequest] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EmployeeIdentityCardResponse]:
        """Create Employee Identity Cards
    ...
    @validate_call
    def create_employee_identity_cards_without_preload_content(
        self,
        employee_id: StrictStr,
        employee_identity_card_request: Optional[EmployeeIdentityCardRequest] = None,
        _request_timeout: Union[
    ...
    def _create_employee_identity_cards_serialize(
        self,
        employee_id,
        ...
        if employee_identity_card_request is not None:
            _body_params = employee_identity_card_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/core/v1/employees/{employeeId}/employee-identity-cards',
    ...
    def delete_employee_identity_cards(
        self,
        employee_id: StrictStr,
        employee_identity_card_id: StrictStr,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param employee_id: (required)
        :type employee_id: str
        :param employee_identity_card_id: (required)
        :type employee_identity_card_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_employee_identity_cards_serialize(
            employee_id=employee_id,
            employee_identity_card_id=employee_identity_card_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def delete_employee_identity_cards_with_http_info(
        self,
        employee_id: StrictStr,
        employee_identity_card_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def delete_employee_identity_cards_without_preload_content(
        self,
        employee_id: StrictStr,
        employee_identity_card_id: StrictStr,
        _request_timeout: Union[
    ...
    def _delete_employee_identity_cards_serialize(
        self,
        employee_id,
        employee_identity_card_id,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if employee_id is not None:
            _path_params['employeeId'] = employee_id
        if employee_identity_card_id is not None:
            _path_params['employeeIdentityCardId'] = employee_identity_card_id
        # process the query parameters
        # process the header parameters
        # process the form parameters
        # process the body parameter
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/core/v1/employees/{employeeId}/employee-identity-cards/{employeeIdentityCardId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_employee_identity_cards(
        self,
        employee_id: StrictStr,
        query: Annotated[Optional[StrictStr], Field(description="### Search Query | Supported Keys     | Supported Operators | Notes                                                                                     | |--------------------|---------------------|-------------------------------------------------------------------------------------------| | effectiveDate      | `<`                 | Less than or equal to<br/><br/>Use `yyyy-MM-dd` format, e.g. `effectiveDate<2025-01-31  ` | ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param employee_id: (required)
        :type employee_id: str
        :param query: ### Search Query | Supported Keys     | Supported Operators | Notes                                                                                     | |--------------------|---------------------|-------------------------------------------------------------------------------------------| | effectiveDate      | `<`                 | Less than or equal to<br/><br/>Use `yyyy-MM-dd` format, e.g. `effectiveDate<2025-01-31  ` | 
        :type query: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_employee_identity_cards_serialize(
            employee_id=employee_id,
            query=query,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "EmployeeIdentityCardPageResponse",
            '400': None,
        }
        response_data = self.api_client.call_api(
            *_param,
    ...
    @validate_call
    def get_employee_identity_cards_with_http_info(
        self,
        employee_id: StrictStr,
        query: Annotated[Optional[StrictStr], Field(description="### Search Query | Supported Keys     | Supported Operators | Notes                                                                                     | |--------------------|---------------------|-------------------------------------------------------------------------------------------| | effectiveDate      | `<`                 | Less than or equal to<br/><br/>Use `yyyy-MM-dd` format, e.g. `effectiveDate<2025-01-31  ` | ")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EmployeeIdentityCardPageResponse]:
        """Get Employee Identity Cards
    ...
    @validate_call
    def get_employee_identity_cards_without_preload_content(
        self,
        employee_id: StrictStr,
        query: Annotated[Optional[StrictStr], Field(description="### Search Query | Supported Keys     | Supported Operators | Notes                                                                                     | |--------------------|---------------------|-------------------------------------------------------------------------------------------| | effectiveDate      | `<`                 | Less than or equal to<br/><br/>Use `yyyy-MM-dd` format, e.g. `effectiveDate<2025-01-31  ` | ")] = None,
        _request_timeout: Union[
    ...
    def _get_employee_identity_cards_serialize(
        self,
        employee_id,
        query,
        _request_auth,
    ...
    def update_employee_identity_cards(
        ...
        _param = self._update_employee_identity_cards_serialize(
            employee_id=employee_id,
            employee_identity_card_id=employee_identity_card_id,
            employee_identity_card_request=employee_identity_card_request,
            _request_auth=_request_auth,
    ...
    @validate_call
    def update_employee_identity_cards_with_http_info(
        self,
        employee_id: StrictStr,
        employee_identity_card_id: StrictStr,
        employee_identity_card_request: Optional[EmployeeIdentityCardRequest] = None,
    ...
    @validate_call
    def update_employee_identity_cards_without_preload_content(
        self,
        employee_id: StrictStr,
        employee_identity_card_id: StrictStr,
        employee_identity_card_request: Optional[EmployeeIdentityCardRequest] = None,
    ...
    def _update_employee_identity_cards_serialize(
        self,
        employee_id,
        employee_identity_card_id,
        employee_identity_card_request,
