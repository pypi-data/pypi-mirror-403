...
# Custom Trained Trajectory
  load_traj <json_path>   Load custom trajectory from a JSON file. Returns TID.
  act_traj <tid>          ActivateCustomTrainedTraj(tid)
  unload_traj <tid>       UnloadCustomTrainedTraj(tid)
    ...
    while True:
        ...
        try:
            ...
            # ===== Custom Trained Trajectory =====
                ...
                if len(args) != 1:
                    print("Usage: load_traj <json_file_path>")
                    continue
                json_path = args[0]
                ...
                try:
                    traj_obj = b1.CustomTrainedTraj.from_json_str(content)
                    tid = client.LoadCustomTrainedTraj(traj_obj)
                    print(f"Trajectory loaded successfully. TID: {tid}")
                ...
                print(f"Activated trajectory: {tid}")
                ...
                print(f"Unloaded trajectory: {tid}")
