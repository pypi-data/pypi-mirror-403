...
/*!
 * @brief This class represents the structure PoseStamped defined by the user in
 * the IDL file.
 * @ingroup PoseStamped
 */
class PoseStamped : public eprosima::fastdds::dds::TopicDataType {
 public:
  /*!
   * @brief Copy constructor.
   * @param x Reference to the object geometry_msgs::msg::PoseStamped that will
   * be copied.
   */
   ...
   * be copied.
   */
  eProsima_user_DllExport PoseStamped(PoseStamped&& x) noexcept;
   ...
   * be copied.
   */
  eProsima_user_DllExport PoseStamped& operator=(PoseStamped&& x) noexcept;

  /*!
   * @brief Comparison operator.
   * @param x geometry_msgs::msg::PoseStamped object to compare.
   */
  eProsima_user_DllExport bool operator==(const PoseStamped& x) const;
 ...
 public:
  ...
  eProsima_user_DllExport ~PoseStamped() override;
