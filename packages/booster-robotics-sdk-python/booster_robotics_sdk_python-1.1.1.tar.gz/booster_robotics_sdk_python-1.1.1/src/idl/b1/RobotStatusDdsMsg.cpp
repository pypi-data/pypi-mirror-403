...
RobotStatusDdsMsg::RobotStatusDdsMsg(const RobotStatusDdsMsg& x)
    : RobotStatusDdsMsg() {
  m_joint_vec = x.m_joint_vec;
  m_imu_vec = x.m_imu_vec;
  m_battery_vec = x.m_battery_vec;
}

RobotStatusDdsMsg::RobotStatusDdsMsg(RobotStatusDdsMsg&& x) noexcept
    : RobotStatusDdsMsg() {
  m_joint_vec = std::move(x.m_joint_vec);
  m_imu_vec = std::move(x.m_imu_vec);
  m_battery_vec = std::move(x.m_battery_vec);
}

RobotStatusDdsMsg& RobotStatusDdsMsg::operator=(const RobotStatusDdsMsg& x) {
  m_joint_vec = x.m_joint_vec;
  m_imu_vec = x.m_imu_vec;
  m_battery_vec = x.m_battery_vec;
  return *this;
...
RobotStatusDdsMsg& RobotStatusDdsMsg::operator=(
...
bool RobotStatusDdsMsg::operator==(const RobotStatusDdsMsg& x) const {
  return (m_joint_vec == x.m_joint_vec && m_imu_vec == x.m_imu_vec &&
          m_battery_vec == x.m_battery_vec);
}
...
void RobotStatusDdsMsg::joint_vec(
  ...
  m_joint_vec = std::move(_joint_vec);
}
 ...
 */
const std::vector<booster_interface::msg::RobotDdsJointStatus>&
RobotStatusDdsMsg::joint_vec() const {
  return m_joint_vec;
}
 ...
 */
void RobotStatusDdsMsg::imu_vec(
 ...
 */
const std::vector<booster_interface::msg::RobotDdsImuStatus>&
RobotStatusDdsMsg::imu_vec() const {
  return m_imu_vec;
}
 ...
 */
void RobotStatusDdsMsg::battery_vec(
    const std::vector<booster_interface::msg::RobotDdsBatteryStatus>&
        _battery_vec) {
  m_battery_vec = _battery_vec;
}
 ...
 */
void RobotStatusDdsMsg::battery_vec(
    std::vector<booster_interface::msg::RobotDdsBatteryStatus>&& _battery_vec) {
  m_battery_vec = std::move(_battery_vec);
}
 ...
 */
const std::vector<booster_interface::msg::RobotDdsBatteryStatus>&
RobotStatusDdsMsg::battery_vec() const {
  return m_battery_vec;
}
...
constexpr uint32_t booster_interface_msg_RobotStatusDdsMsg_max_cdr_typesize{
    84828UL};
constexpr uint32_t booster_interface_msg_RobotStatusDdsMsg_max_key_cdr_typesize{
    0UL};
#include <fastcdr/Cdr.h>
#include <fastcdr/exceptions/BadParamException.h>
...
calculate_serialized_size(eprosima::fastcdr::CdrSizeCalculator& calculator,
                          const booster_interface::msg::RobotStatusDdsMsg& data,
  ...
  calculated_size += calculator.calculate_member_serialized_size(
      eprosima::fastcdr::MemberId(0), data.joint_vec(), current_alignment);

  calculated_size += calculator.calculate_member_serialized_size(
      eprosima::fastcdr::MemberId(1), data.imu_vec(), current_alignment);

  calculated_size += calculator.calculate_member_serialized_size(
      eprosima::fastcdr::MemberId(2), data.battery_vec(), current_alignment);
...
eProsima_user_DllExport void serialize(
  ...
  scdr << eprosima::fastcdr::MemberId(0) << data.joint_vec()
       << eprosima::fastcdr::MemberId(1) << data.imu_vec()
       << eprosima::fastcdr::MemberId(2) << data.battery_vec();
...
eProsima_user_DllExport void deserialize(
    ...
    booster_interface::msg::RobotStatusDdsMsg& data) {
  using namespace booster_interface::msg;
...
RobotStatusDdsMsg::RobotStatusDdsMsg() {
  setName("booster_interface::msg::dds_::RobotStatusDdsMsg_");
  uint32_t type_size =
#if FASTCDR_VERSION_MAJOR == 1
      static_cast<uint32_t>(RobotStatusDdsMsg::getMaxCdrSerializedSize());
#else
      booster_interface_msg_RobotStatusDdsMsg_max_cdr_typesize;
#endif
  ...
  uint32_t keyLength =
      booster_interface_msg_RobotStatusDdsMsg_max_key_cdr_typesize > 16
          ? booster_interface_msg_RobotStatusDdsMsg_max_key_cdr_typesize
          : 16;
...
bool RobotStatusDdsMsg::serialize(void* data, SerializedPayload_t* payload,
                                  DataRepresentationId_t data_representation) {
  RobotStatusDdsMsg* p_type = static_cast<RobotStatusDdsMsg*>(data);
...
bool RobotStatusDdsMsg::deserialize(SerializedPayload_t* payload, void* data) {
  try {
  ...
  return [data, data_representation]() -> uint32_t {
    ...
    try {
      ...
      return static_cast<uint32_t>(calculator.calculate_serialized_size(
                 *static_cast<RobotStatusDdsMsg*>(data), current_alignment)) +
             4u /*encapsulation*/;
    } catch (eprosima::fastcdr::exception::Exception& /*exception*/) {
      return 0;
    }
...
void* RobotStatusDdsMsg::createData() {
  return reinterpret_cast<void*>(new RobotStatusDdsMsg());
}

void RobotStatusDdsMsg::deleteData(void* data) {
  delete (reinterpret_cast<RobotStatusDdsMsg*>(data));
}

bool RobotStatusDdsMsg::getKey(void* data, InstanceHandle_t* handle,
                               bool force_md5) {
