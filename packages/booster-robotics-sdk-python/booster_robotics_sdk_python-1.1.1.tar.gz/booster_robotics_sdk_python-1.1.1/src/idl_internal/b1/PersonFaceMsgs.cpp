...
#include <booster_internal/idl/b1/PersonFaceMsgs.h>
...
PersonFaceMsgs::PersonFaceMsgs(const PersonFaceMsgs &x) :
    PersonFaceMsgs() {
    m_header = x.m_header;
    m_objects = x.m_objects;
}

PersonFaceMsgs::PersonFaceMsgs(PersonFaceMsgs &&x) noexcept :
    PersonFaceMsgs() {
    m_header = std::move(x.m_header);
    m_objects = std::move(x.m_objects);
}

PersonFaceMsgs &PersonFaceMsgs::operator=(const PersonFaceMsgs &x) {
    m_header = x.m_header;
    m_objects = x.m_objects;
    return *this;
}

PersonFaceMsgs &PersonFaceMsgs::operator=(PersonFaceMsgs &&x) noexcept {
    m_header = std::move(x.m_header);
    m_objects = std::move(x.m_objects);
    return *this;
}

bool PersonFaceMsgs::operator==(const PersonFaceMsgs &x) const {
 ...
 */
void PersonFaceMsgs::header(const std_msgs::msg::Header &_header) {
    m_header = _header;
}
 ...
 */
void PersonFaceMsgs::header(std_msgs::msg::Header &&_header) {
 ...
 */
const std_msgs::msg::Header &PersonFaceMsgs::header() const {
    return m_header;
}
 ...
 */
std_msgs::msg::Header &PersonFaceMsgs::header() {
    return m_header;
}
 ...
 */
const std::vector<detection::msg::PersonFace> &
PersonFaceMsgs::objects() const {
    return m_objects;
}
 ...
 */
std::vector<detection::msg::PersonFace> &PersonFaceMsgs::objects() {
    return m_objects;
}
...
constexpr uint32_t detection_msg_PersonFaceMsgs_max_cdr_typesize{
    70688UL};
constexpr uint32_t
    detection_msg_PersonFaceMsgs_max_key_cdr_typesize{0UL};
#include <fastcdr/Cdr.h>
#include <fastcdr/exceptions/BadParamException.h>
...
eProsima_user_DllExport size_t calculate_serialized_size(
    ...
    const detection::msg::PersonFaceMsgs &data,
    ...
    calculated_size += calculator.calculate_member_serialized_size(
        eprosima::fastcdr::MemberId(1), data.objects(), current_alignment);
...
eProsima_user_DllExport void deserialize(
    ...
    detection::msg::PersonFaceMsgs &data) {
    using namespace detection::msg;
...
PersonFaceMsgs::PersonFaceMsgs() {
    setName("detection::msg::dds_::PersonFaceMsgs_");
    uint32_t type_size =
#if FASTCDR_VERSION_MAJOR == 1
        static_cast<uint32_t>(PersonFaceMsgs::getMaxCdrSerializedSize());
#else
        detection_msg_PersonFaceMsgs_max_cdr_typesize;
#endif
    ...
    uint32_t keyLength =
        detection_msg_PersonFaceMsgs_max_key_cdr_typesize > 16 ? detection_msg_PersonFaceMsgs_max_key_cdr_typesize : 16;
...
bool PersonFaceMsgs::serialize(void *data, SerializedPayload_t *payload,
                               DataRepresentationId_t data_representation) {
    PersonFaceMsgs *p_type = static_cast<PersonFaceMsgs *>(data);
...
bool PersonFaceMsgs::deserialize(SerializedPayload_t *payload, void *data) {
    try {
    ...
    return [data, data_representation]() -> uint32_t {
        ...
        try {
            ...
            return static_cast<uint32_t>(calculator.calculate_serialized_size(
                       *static_cast<PersonFaceMsgs *>(data), current_alignment))
                   + 4u /*encapsulation*/;
        } catch (eprosima::fastcdr::exception::Exception & /*exception*/) {
            return 0;
        }
...
void *PersonFaceMsgs::createData() {
    return reinterpret_cast<void *>(new PersonFaceMsgs());
}

void PersonFaceMsgs::deleteData(void *data) {
    delete (reinterpret_cast<PersonFaceMsgs *>(data));
}

bool PersonFaceMsgs::getKey(void *data, InstanceHandle_t *handle,
                            bool force_md5) {
    ...
    eprosima::fastcdr::FastBuffer fastbuffer(
        ...
        detection_msg_PersonFaceMsgs_max_key_cdr_typesize);
...
#endif // FASTCDR_VERSION_MAJOR == 1
    if (force_md5 || detection_msg_PersonFaceMsgs_max_key_cdr_typesize > 16) {
        m_md5.init();
#if FASTCDR_VERSION_MAJOR == 1
