...
#include <booster_internal/idl/tf2_msgs/TFMessage.h>
...
TFMessage::TFMessage(const TFMessage& x) : TFMessage() {
  m_transforms = x.m_transforms;
}

TFMessage::TFMessage(TFMessage&& x) noexcept : TFMessage() {
  m_transforms = std::move(x.m_transforms);
}

TFMessage& TFMessage::operator=(const TFMessage& x) {
  m_transforms = x.m_transforms;
  return *this;
}

TFMessage& TFMessage::operator=(TFMessage&& x) noexcept {
  m_transforms = std::move(x.m_transforms);
  return *this;
}

bool TFMessage::operator==(const TFMessage& x) const {
  return (m_transforms == x.m_transforms);
}

bool TFMessage::operator!=(const TFMessage& x) const { return !(*this == x); }
 ...
 */
const std::vector<geometry_msgs::msg::TransformStamped>& TFMessage::transforms()
    const {
  return m_transforms;
}
...
constexpr uint32_t tf2_msgs_msg_TFMessage_max_cdr_typesize{61608UL};
...
eProsima_user_DllExport size_t calculate_serialized_size(
    ...
    const tf2_msgs::msg::TFMessage& data, size_t& current_alignment) {
  ...
  calculated_size += calculator.calculate_member_serialized_size(
      eprosima::fastcdr::MemberId(0), data.transforms(), current_alignment);
...
eProsima_user_DllExport void serialize(eprosima::fastcdr::Cdr& scdr,
  ...
  scdr << eprosima::fastcdr::MemberId(0) << data.transforms();
...
TFMessage::TFMessage() {
  ...
  uint32_t type_size =
      ...
      static_cast<uint32_t>(TFMessage::getMaxCdrSerializedSize());
#else
      tf2_msgs_msg_TFMessage_max_cdr_typesize;
#endif
  type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(
      type_size, 4));         /* possible submessage alignment */
  m_typeSize = type_size + 4; /*encapsulation*/
  m_isGetKeyDefined = false;
  uint32_t keyLength = tf2_msgs_msg_TFMessage_max_key_cdr_typesize > 16
...
bool TFMessage::serialize(void* data, SerializedPayload_t* payload,
...
bool TFMessage::deserialize(SerializedPayload_t* payload, void* data) {
  try {
...
std::function<uint32_t()> TFMessage::getSerializedSizeProvider(
    void* data, DataRepresentationId_t data_representation) {
  return [data, data_representation]() -> uint32_t {
#if FASTCDR_VERSION_MAJOR == 1
    static_cast<void>(data_representation);
    return static_cast<uint32_t>(
               type::getCdrSerializedSize(*static_cast<TFMessage*>(data))) +
           4u /*encapsulation*/;
#else
    try {
      eprosima::fastcdr::CdrSizeCalculator calculator(
      ...
      return static_cast<uint32_t>(calculator.calculate_serialized_size(
                 *static_cast<TFMessage*>(data), current_alignment)) +
             4u /*encapsulation*/;
    } catch (eprosima::fastcdr::exception::Exception& /*exception*/) {
      return 0;
    }
...
void* TFMessage::createData() {
  return reinterpret_cast<void*>(new TFMessage());
}

void TFMessage::deleteData(void* data) {
  delete (reinterpret_cast<TFMessage*>(data));
}

bool TFMessage::getKey(void* data, InstanceHandle_t* handle, bool force_md5) {
