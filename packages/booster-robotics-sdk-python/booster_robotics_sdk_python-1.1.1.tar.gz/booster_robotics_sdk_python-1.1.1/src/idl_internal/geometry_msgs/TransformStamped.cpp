...
#include <booster_internal/idl/geometry_msgs/TransformStamped.h>
...
TransformStamped::TransformStamped(const TransformStamped& x)
    : TransformStamped() {
  m_header = x.m_header;
...
TransformStamped::TransformStamped(TransformStamped&& x) noexcept
    : TransformStamped() {
...
TransformStamped& TransformStamped::operator=(const TransformStamped& x) {
  m_header = x.m_header;
  m_child_frame_id = x.m_child_frame_id;
  m_transform = x.m_transform;
  return *this;
...
TransformStamped& TransformStamped::operator=(TransformStamped&& x) noexcept {
  m_header = std::move(x.m_header);
  m_child_frame_id = std::move(x.m_child_frame_id);
  m_transform = std::move(x.m_transform);
  return *this;
...
bool TransformStamped::operator==(const TransformStamped& x) const {
  return (m_header == x.m_header && m_child_frame_id == x.m_child_frame_id &&
          m_transform == x.m_transform);
}
 ...
 */
void TransformStamped::header(const std_msgs::msg::Header& _header) {
  m_header = _header;
}
 ...
 */
void TransformStamped::header(std_msgs::msg::Header&& _header) {
 ...
 */
std_msgs::msg::Header& TransformStamped::header() { return m_header; }
 ...
 */
void TransformStamped::child_frame_id(const std::string& _child_frame_id) {
 ...
 */
void TransformStamped::child_frame_id(std::string&& _child_frame_id) {
 ...
 */
std::string& TransformStamped::child_frame_id() { return m_child_frame_id; }
...
constexpr uint32_t geometry_msgs_msg_TransformStamped_max_cdr_typesize{616UL};
...
calculate_serialized_size(eprosima::fastcdr::CdrSizeCalculator& calculator,
  ...
  calculated_size += calculator.calculate_member_serialized_size(
      eprosima::fastcdr::MemberId(1), data.child_frame_id(), current_alignment);

  calculated_size += calculator.calculate_member_serialized_size(
      eprosima::fastcdr::MemberId(2), data.transform(), current_alignment);
...
eProsima_user_DllExport void deserialize(
    eprosima::fastcdr::Cdr& cdr, geometry_msgs::msg::TransformStamped& data) {
  using namespace geometry_msgs::msg;
...
TransformStamped::TransformStamped() {
  ...
  uint32_t type_size =
      ...
      static_cast<uint32_t>(TransformStamped::getMaxCdrSerializedSize());
#else
      geometry_msgs_msg_TransformStamped_max_cdr_typesize;
#endif
  ...
  uint32_t keyLength =
      geometry_msgs_msg_TransformStamped_max_key_cdr_typesize > 16
...
bool TransformStamped::serialize(void* data, SerializedPayload_t* payload,
...
bool TransformStamped::deserialize(SerializedPayload_t* payload, void* data) {
  try {
...
void* TransformStamped::createData() {
  return reinterpret_cast<void*>(new TransformStamped());
}

void TransformStamped::deleteData(void* data) {
  delete (reinterpret_cast<TransformStamped*>(data));
}

bool TransformStamped::getKey(void* data, InstanceHandle_t* handle,
                              bool force_md5) {
