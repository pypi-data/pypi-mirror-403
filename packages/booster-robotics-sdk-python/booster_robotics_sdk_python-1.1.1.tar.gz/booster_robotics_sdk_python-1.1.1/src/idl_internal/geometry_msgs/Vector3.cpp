...
#include <booster_internal/idl/geometry_msgs/Vector3.h>
...
Vector3::Vector3(const Vector3& x) : Vector3() {
  m_x = x.m_x;
  m_y = x.m_y;
  m_z = x.m_z;
}

Vector3::Vector3(Vector3&& x) noexcept : Vector3() {
  m_x = x.m_x;
  m_y = x.m_y;
  m_z = x.m_z;
}
...
Vector3& Vector3::operator=(Vector3&& x) noexcept {
  m_x = x.m_x;
  m_y = x.m_y;
  m_z = x.m_z;
  return *this;
...
bool Vector3::operator!=(const Vector3& x) const { return !(*this == x); }

/*!
 * @brief This function sets a value in member x
 * @param _x New value for member x
 */
void Vector3::x(double _x) { m_x = _x; }

/*!
 * @brief This function returns the value of member x
 * @return Value of member x
 */
double Vector3::x() const { return m_x; }

/*!
 * @brief This function returns a reference to member x
 * @return Reference to member x
 */
double& Vector3::x() { return m_x; }

/*!
 * @brief This function sets a value in member y
 * @param _y New value for member y
 */
void Vector3::y(double _y) { m_y = _y; }

/*!
 * @brief This function returns the value of member y
 * @return Value of member y
 */
double Vector3::y() const { return m_y; }

/*!
 * @brief This function returns a reference to member y
 * @return Reference to member y
 */
double& Vector3::y() { return m_y; }

/*!
 * @brief This function sets a value in member z
 * @param _z New value for member z
 */
void Vector3::z(double _z) { m_z = _z; }

/*!
 * @brief This function returns the value of member z
 * @return Value of member z
 */
double Vector3::z() const { return m_z; }

/*!
 * @brief This function returns a reference to member z
 * @return Reference to member z
 */
double& Vector3::z() { return m_z; }

}  // namespace msg

}  // namespace geometry_msgs
// Include auxiliary functions like for serializing/deserializing.
constexpr uint32_t geometry_msgs_msg_Vector3_max_cdr_typesize{32UL};
...
eProsima_user_DllExport size_t calculate_serialized_size(
    ...
    const geometry_msgs::msg::Vector3& data, size_t& current_alignment) {
...
eProsima_user_DllExport void serialize(
    eprosima::fastcdr::Cdr& scdr, const geometry_msgs::msg::Vector3& data) {
  using namespace geometry_msgs::msg;
...
Vector3::Vector3() {
  ...
  uint32_t type_size =
      ...
      static_cast<uint32_t>(Vector3::getMaxCdrSerializedSize());
#else
  ...
  uint32_t keyLength = geometry_msgs_msg_Vector3_max_key_cdr_typesize > 16
...
bool Vector3::serialize(void* data, SerializedPayload_t* payload,
...
bool Vector3::deserialize(SerializedPayload_t* payload, void* data) {
  try {
...
std::function<uint32_t()> Vector3::getSerializedSizeProvider(
    void* data, DataRepresentationId_t data_representation) {
  return [data, data_representation]() -> uint32_t {
#if FASTCDR_VERSION_MAJOR == 1
    static_cast<void>(data_representation);
    return static_cast<uint32_t>(
               type::getCdrSerializedSize(*static_cast<Vector3*>(data))) +
           4u /*encapsulation*/;
#else
    try {
      eprosima::fastcdr::CdrSizeCalculator calculator(
...
void* Vector3::createData() { return reinterpret_cast<void*>(new Vector3()); }

void Vector3::deleteData(void* data) {
  delete (reinterpret_cast<Vector3*>(data));
}

bool Vector3::getKey(void* data, InstanceHandle_t* handle, bool force_md5) {
