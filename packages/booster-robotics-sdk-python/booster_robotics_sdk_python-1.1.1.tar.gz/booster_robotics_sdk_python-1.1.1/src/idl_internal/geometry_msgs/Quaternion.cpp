...
#include <booster_internal/idl/geometry_msgs/Quaternion.h>
...
Quaternion::Quaternion(const Quaternion& x) : Quaternion() {
  m_x = x.m_x;
  m_y = x.m_y;
  m_z = x.m_z;
  m_w = x.m_w;
...
Quaternion::Quaternion(Quaternion&& x) noexcept : Quaternion() {
  m_x = x.m_x;
  m_y = x.m_y;
  m_z = x.m_z;
  m_w = x.m_w;
...
Quaternion& Quaternion::operator=(Quaternion&& x) noexcept {
  m_x = x.m_x;
  m_y = x.m_y;
  m_z = x.m_z;
  m_w = x.m_w;
...
bool Quaternion::operator==(const Quaternion& x) const {
  return (m_x == x.m_x && m_y == x.m_y && m_z == x.m_z && m_w == x.m_w);
}

bool Quaternion::operator!=(const Quaternion& x) const { return !(*this == x); }

/*!
 * @brief This function sets a value in member x
 * @param _x New value for member x
 */
void Quaternion::x(double _x) { m_x = _x; }
 ...
 */
double& Quaternion::x() { return m_x; }

/*!
 * @brief This function sets a value in member y
 * @param _y New value for member y
 */
void Quaternion::y(double _y) { m_y = _y; }
 ...
 */
double& Quaternion::y() { return m_y; }

/*!
 * @brief This function sets a value in member z
 * @param _z New value for member z
 */
void Quaternion::z(double _z) { m_z = _z; }
 ...
 */
double& Quaternion::w() { return m_w; }

}  // namespace msg

}  // namespace geometry_msgs
// Include auxiliary functions like for serializing/deserializing.
constexpr uint32_t geometry_msgs_msg_Quaternion_max_cdr_typesize{40UL};
...
eProsima_user_DllExport size_t calculate_serialized_size(
    ...
    const geometry_msgs::msg::Quaternion& data, size_t& current_alignment) {
  ...
  calculated_size += calculator.calculate_member_serialized_size(
      eprosima::fastcdr::MemberId(2), data.z(), current_alignment);

  calculated_size += calculator.calculate_member_serialized_size(
      eprosima::fastcdr::MemberId(3), data.w(), current_alignment);
...
eProsima_user_DllExport void serialize(
    eprosima::fastcdr::Cdr& scdr, const geometry_msgs::msg::Quaternion& data) {
  using namespace geometry_msgs::msg;
...
Quaternion::Quaternion() {
  ...
  uint32_t type_size =
      ...
      static_cast<uint32_t>(Quaternion::getMaxCdrSerializedSize());
#else
      geometry_msgs_msg_Quaternion_max_cdr_typesize;
#endif
  type_size += static_cast<uint32_t>(eprosima::fastcdr::Cdr::alignment(
      type_size, 4));         /* possible submessage alignment */
  m_typeSize = type_size + 4; /*encapsulation*/
  m_isGetKeyDefined = false;
  uint32_t keyLength = geometry_msgs_msg_Quaternion_max_key_cdr_typesize > 16
...
bool Quaternion::serialize(void* data, SerializedPayload_t* payload,
...
bool Quaternion::deserialize(SerializedPayload_t* payload, void* data) {
  try {
...
std::function<uint32_t()> Quaternion::getSerializedSizeProvider(
    void* data, DataRepresentationId_t data_representation) {
  return [data, data_representation]() -> uint32_t {
#if FASTCDR_VERSION_MAJOR == 1
    static_cast<void>(data_representation);
    return static_cast<uint32_t>(
               type::getCdrSerializedSize(*static_cast<Quaternion*>(data))) +
           4u /*encapsulation*/;
#else
    try {
      eprosima::fastcdr::CdrSizeCalculator calculator(
...
void* Quaternion::createData() {
  return reinterpret_cast<void*>(new Quaternion());
}

void Quaternion::deleteData(void* data) {
  delete (reinterpret_cast<Quaternion*>(data));
}

bool Quaternion::getKey(void* data, InstanceHandle_t* handle, bool force_md5) {
