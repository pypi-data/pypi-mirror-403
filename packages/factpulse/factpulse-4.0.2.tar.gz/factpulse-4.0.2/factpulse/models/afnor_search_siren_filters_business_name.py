...
class AFNORSearchSirenFiltersBusinessName(BaseModel):
    """
    AFNORSearchSirenFiltersBusinessName
    """ # noqa: E501
    op: Optional[AFNORContainsOperator] = None
    value: Optional[Annotated[str, Field(strict=True, max_length=150)]] = Field(default=None, description="Business name")
