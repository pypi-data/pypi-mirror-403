...
class GetChorusProIdResponse(BaseModel):
    """
    Found Chorus Pro ID.
    """ # noqa: E501
    structure_id: StrictInt = Field(description="Chorus Pro ID (0 if not found)", alias="structureId")
    structure_identifier: StrictStr = Field(description="Searched SIRET/SIREN", alias="structureIdentifier")
    ...
    __properties: ClassVar[List[str]] = ["structureId", "structureIdentifier", "structureName", "message"]
