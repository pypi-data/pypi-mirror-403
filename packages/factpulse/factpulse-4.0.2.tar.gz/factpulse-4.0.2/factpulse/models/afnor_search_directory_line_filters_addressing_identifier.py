...
class AFNORSearchDirectoryLineFiltersAddressingIdentifier(BaseModel):
    """
    AFNORSearchDirectoryLineFiltersAddressingIdentifier
    """ # noqa: E501
    op: Optional[AFNORContainsOperator] = None
    value: Optional[Annotated[str, Field(strict=True, max_length=125)]] = Field(default=None, description="Addressing identifier of the directory line.")
