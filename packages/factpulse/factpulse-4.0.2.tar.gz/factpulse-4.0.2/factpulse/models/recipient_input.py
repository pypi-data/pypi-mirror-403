...
class RecipientInput(BaseModel):
    ...
    role: Optional[StrictStr] = Field(default='BY', description="Code rôle (BY, SE, WK, etc.)")
    email: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["siren", "siret", "name", "role", "email"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "siret": obj.get("siret"),
            "name": obj.get("name"),
            "role": obj.get("role") if obj.get("role") is not None else 'BY',
            "email": obj.get("email")
        })
        return _obj
