...
class SubmitCDARResponse(BaseModel):
    """
    Réponse de soumission CDAR.
    """ # noqa: E501
    flow_id: StrictStr = Field(description="Identifiant du flux AFNOR", alias="flowId")
    status: StrictStr = Field(description="Statut de la soumission")
    message: Optional[StrictStr] = None
    document_id: Optional[StrictStr] = Field(default=None, alias="documentId")
    __properties: ClassVar[List[str]] = ["flowId", "status", "message", "documentId"]
