...
class SubmitFlowResponse(BaseModel):
    """
    Response after submitting a flow.
    """ # noqa: E501
    flow_id: StrictStr = Field(description="Unique flow identifier generated by the PDP")
    tracking_id: Optional[StrictStr] = None
    name: StrictStr = Field(description="Flow name")
    flow_syntax: StrictStr = Field(description="Flow syntax (CII, UBL, etc.)")
    flow_profile: Optional[StrictStr] = None
    sha256: StrictStr = Field(description="SHA256 hash of the submitted file")
    message: StrictStr = Field(description="Confirmation message")
    __properties: ClassVar[List[str]] = ["flow_id", "tracking_id", "name", "flow_syntax", "flow_profile", "sha256", "message"]
