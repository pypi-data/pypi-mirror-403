...
class AFNORDirectoryLinePayloadHistoryLegalUnitFacilityRoutingCodeRoutingCode(BaseModel):
    """
    ...
    manages_legal_commitment: Optional[StrictBool] = Field(default=None, description="Indicates whether the public structure requires a legal commitment number. This attribute is only returned if the directory line is defined for a public structure at the SIREN / SIRET or SIREN / SIRET / Routing code level.", alias="managesLegalCommitment")
    administrative_status: Optional[AFNORRoutingCodeAdministrativeStatus] = Field(default=None, alias="administrativeStatus")
    address: Optional[AFNORAddressRead] = None
    __properties: ClassVar[List[str]] = ["routingIdentifier", "routingIdentifierType", "routingCodeName", "managesLegalCommitment", "administrativeStatus", "address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "managesLegalCommitment": obj.get("managesLegalCommitment"),
