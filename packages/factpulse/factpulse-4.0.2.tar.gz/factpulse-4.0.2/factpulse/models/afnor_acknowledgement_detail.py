...
class AFNORAcknowledgementDetail(BaseModel):
    """
    AFNORAcknowledgementDetail
    """ # noqa: E501
    level: StrictStr
    item: StrictStr = Field(description="Item on which the error refers")
    reason_code: AFNORReasonCode = Field(alias="reasonCode")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "level": obj.get("level"),
            "item": obj.get("item"),
            "reasonCode": AFNORReasonCode.from_dict(obj["reasonCode"]) if obj.get("reasonCode") is not None else None,
