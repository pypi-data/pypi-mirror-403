...
class AFNORReasonCodeEnum(str, Enum):
    """
    ...
    allowed enum values
    """
    EMPTYATTACHEMENT = 'EmptyAttachement'
    ATTACHMENTTYPEERROR = 'AttachmentTypeError'
    EMPTYFLOW = 'EmptyFlow'
    OTHERTECHNICALERROR = 'OtherTechnicalError'
    INVALIDSCHEMA = 'InvalidSchema'
    FILESIZEEXCEEDED = 'FileSizeExceeded'
    FLOWTYPEERROR = 'FlowTypeError'
    ALREADYEXISTINGFLOW = 'AlreadyExistingFlow'
    VIRUSFOUND = 'VirusFound'
    CHECKSUMMISMATCH = 'ChecksumMismatch'
    INVOICELCINVALIDSTATUS = 'InvoiceLCInvalidStatus'
    INVOICELCSTATUSERROR = 'InvoiceLCStatusError'
    INVOICELCRULEERROR = 'InvoiceLCRuleError'
    INVOICELCACCESSDENIED = 'InvoiceLCAccessDenied'
    INVOICELCAMOUNTERROR = 'InvoiceLCAmountError'

    @classmethod
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AFNORReasonCodeEnum from a JSON string"""
