...
class IncomingSupplier(BaseModel):
    """
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Supplier business name (BT-27)")
    ...
    __properties: ClassVar[List[str]] = ["name", "siren", "siret", "vatNumber", "postalAddress", "electronicAddress", "email", "phone"]
