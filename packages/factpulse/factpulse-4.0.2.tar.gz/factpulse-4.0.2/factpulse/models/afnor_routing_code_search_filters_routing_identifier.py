...
class AFNORRoutingCodeSearchFiltersRoutingIdentifier(BaseModel):
    """
    AFNORRoutingCodeSearchFiltersRoutingIdentifier
    """ # noqa: E501
    op: Optional[AFNORContainsOperator] = None
    value: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="Routing identifier for a routing code.")
