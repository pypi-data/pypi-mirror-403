...
class AFNORCreateDirectoryLineBodyAddressingInformation(BaseModel):
    """
    AFNORCreateDirectoryLineBodyAddressingInformation
    """ # noqa: E501
    siren: Annotated[str, Field(strict=True, max_length=9)] = Field(description="SIREN number")
    ...
    __properties: ClassVar[List[str]] = ["siren", "siret", "routingIdentifier", "addressingSuffix"]
