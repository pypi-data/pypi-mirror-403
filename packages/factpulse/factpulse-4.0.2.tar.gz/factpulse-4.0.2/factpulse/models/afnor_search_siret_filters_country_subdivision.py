...
class AFNORSearchSiretFiltersCountrySubdivision(BaseModel):
    """
    AFNORSearchSiretFiltersCountrySubdivision
    """ # noqa: E501
    op: Optional[AFNORContainsOperator] = None
    value: Optional[Annotated[str, Field(strict=True, max_length=255)]] = Field(default=None, description="Subdivision of the country")
