...
class AFNORDirectoryLinePost201Response(BaseModel):
    """
    AFNORDirectoryLinePost201Response
    """ # noqa: E501
    id_instance: Optional[StrictInt] = Field(default=None, description="Platform instance identifier in the directory", alias="idInstance")
    ...
    date_from: Optional[date] = Field(default=None, description="Effective start date of the directory line..", alias="dateFrom")
    __properties: ClassVar[List[str]] = ["idInstance", "addressingIdentifier", "dateFrom"]
