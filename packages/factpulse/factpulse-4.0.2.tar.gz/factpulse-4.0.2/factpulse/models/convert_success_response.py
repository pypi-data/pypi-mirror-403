...
class ConvertSuccessResponse(BaseModel):
    ...
    """ # noqa: E501
    status: Optional[StrictStr] = Field(default='success', description="Statut de la conversion")
    conversion_id: StrictStr = Field(description="Identifiant unique de conversion")
    document_type: DocumentTypeInfo
    invoice: Dict[str, Any] = Field(description="Donnees facture au format FacturXInvoice (cf. models.py)")
    extraction: ExtractionInfo
    validation: ValidationInfo
    files: FilesInfo
    processing_time_ms: StrictInt = Field(description="Temps de traitement en ms")
    pdf_regenerated: Optional[StrictBool] = Field(default=False, description="True si le PDF a ete regenere (source non exploitable)")
    pdf_regenerated_reason: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["status", "conversion_id", "document_type", "invoice", "extraction", "validation", "files", "processing_time_ms", "pdf_regenerated", "pdf_regenerated_reason"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if pdf_regenerated_reason (nullable) is None
        # and model_fields_set contains the field
        if self.pdf_regenerated_reason is None and "pdf_regenerated_reason" in self.model_fields_set:
            _dict['pdf_regenerated_reason'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "document_type": DocumentTypeInfo.from_dict(obj["document_type"]) if obj.get("document_type") is not None else None,
            ...
            "files": FilesInfo.from_dict(obj["files"]) if obj.get("files") is not None else None,
            "processing_time_ms": obj.get("processing_time_ms"),
            "pdf_regenerated": obj.get("pdf_regenerated") if obj.get("pdf_regenerated") is not None else False,
            "pdf_regenerated_reason": obj.get("pdf_regenerated_reason")
        })
        return _obj
