...
class AFNORSearchSiretFiltersSiret(BaseModel):
    """
    AFNORSearchSiretFiltersSiret
    """ # noqa: E501
    op: Optional[AFNORContainsOperator] = None
    value: Optional[Annotated[str, Field(strict=True, max_length=14)]] = Field(default=None, description="SIRET number to search for.")
