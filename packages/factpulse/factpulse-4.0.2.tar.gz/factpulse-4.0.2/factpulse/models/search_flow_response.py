...
class SearchFlowResponse(BaseModel):
    ...
    """ # noqa: E501
    total: StrictInt = Field(description="Total number of results")
    offset: StrictInt = Field(description="Applied offset")
    limit: StrictInt = Field(description="Results limit")
    results: List[FlowSummary] = Field(description="List of found flows")
    __properties: ClassVar[List[str]] = ["total", "offset", "limit", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "limit": obj.get("limit"),
            "results": [FlowSummary.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
