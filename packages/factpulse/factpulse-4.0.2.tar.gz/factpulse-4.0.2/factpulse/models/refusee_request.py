...
class RefuseeRequest(BaseModel):
    """
    ...
    invoice_seller_siren: StrictStr = Field(description="SIREN du vendeur (destinataire du statut, MDT-129)", alias="invoiceSellerSiren")
    invoice_seller_electronic_address: StrictStr = Field(description="Adresse électronique du vendeur (MDT-73)", alias="invoiceSellerElectronicAddress")
    reason_code: StrictStr = Field(description="Code motif du refus (obligatoire). Valeurs: TX_TVA_ERR, MONTANTTOTAL_ERR, CALCUL_ERR, NON_CONFORME, DOUBLON, DEST_ERR, TRANSAC_INC, EMMET_INC, CONTRAT_TERM, DOUBLE_FACT, CMD_ERR, ADR_ERR, REF_CT_ABSENT", alias="reasonCode")
    reason_text: Optional[StrictStr] = Field(default=None, alias="reasonText")
    sender_siren: Optional[StrictStr] = Field(default=None, alias="senderSiren")
    flow_type: Optional[StrictStr] = Field(default='SupplierInvoiceLC', description="Type de flux (SupplierInvoiceLC pour facture reçue)", alias="flowType")
    ...
    __properties: ClassVar[List[str]] = ["invoiceId", "invoiceIssueDate", "invoiceSellerSiren", "invoiceSellerElectronicAddress", "reasonCode", "reasonText", "senderSiren", "flowType", "pdpFlowServiceUrl", "pdpTokenUrl", "pdpClientId", "pdpClientSecret"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if sender_siren (nullable) is None
        # and model_fields_set contains the field
        if self.sender_siren is None and "sender_siren" in self.model_fields_set:
            _dict['senderSiren'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoiceSellerElectronicAddress": obj.get("invoiceSellerElectronicAddress"),
            "reasonCode": obj.get("reasonCode"),
            "reasonText": obj.get("reasonText"),
            "senderSiren": obj.get("senderSiren"),
            "flowType": obj.get("flowType") if obj.get("flowType") is not None else 'SupplierInvoiceLC',
