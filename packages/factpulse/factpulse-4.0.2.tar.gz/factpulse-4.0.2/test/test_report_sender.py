...
class TestReportSender(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReportSender:
        """Test ReportSender
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportSender`
        """
        model = ReportSender()
        if include_optional:
            return ReportSender(
