...
class TestSubmitCDARRequest(unittest.TestCase):
    """SubmitCDARRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubmitCDARRequest:
        """Test SubmitCDARRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubmitCDARRequest`
        """
        model = SubmitCDARRequest()
        if include_optional:
    ...
    def testSubmitCDARRequest(self):
        """Test SubmitCDARRequest"""
