...
class TestPDPConfigResponse(unittest.TestCase):
    """PDPConfigResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PDPConfigResponse:
        """Test PDPConfigResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PDPConfigResponse`
        """
        model = PDPConfigResponse()
        if include_optional:
    ...
    def testPDPConfigResponse(self):
        """Test PDPConfigResponse"""
