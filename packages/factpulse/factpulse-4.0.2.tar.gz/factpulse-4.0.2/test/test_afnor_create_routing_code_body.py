...
class TestAFNORCreateRoutingCodeBody(unittest.TestCase):
    """AFNORCreateRoutingCodeBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AFNORCreateRoutingCodeBody:
        """Test AFNORCreateRoutingCodeBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AFNORCreateRoutingCodeBody`
        """
        model = AFNORCreateRoutingCodeBody()
        if include_optional:
            return AFNORCreateRoutingCodeBody(
                facility_nature = 'Privée',
                ...
                address = factpulse.models.afnor_address_edit.AFNOR_addressEdit(
    ...
    def testAFNORCreateRoutingCodeBody(self):
        """Test AFNORCreateRoutingCodeBody"""
