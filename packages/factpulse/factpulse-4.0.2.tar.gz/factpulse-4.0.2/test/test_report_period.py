...
class TestReportPeriod(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ReportPeriod:
        """Test ReportPeriod
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReportPeriod`
        """
        model = ReportPeriod()
        if include_optional:
            return ReportPeriod(
