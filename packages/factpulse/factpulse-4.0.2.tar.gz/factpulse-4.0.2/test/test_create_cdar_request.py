...
class TestCreateCDARRequest(unittest.TestCase):
    """CreateCDARRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCDARRequest:
        """Test CreateCDARRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCDARRequest`
        """
        model = CreateCDARRequest()
        if include_optional:
            return CreateCDARRequest(
                document_id = '',
    ...
    def testCreateCDARRequest(self):
        """Test CreateCDARRequest"""
