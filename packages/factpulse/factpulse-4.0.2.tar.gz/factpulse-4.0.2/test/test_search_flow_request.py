...
class TestSearchFlowRequest(unittest.TestCase):
    """SearchFlowRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchFlowRequest:
        """Test SearchFlowRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchFlowRequest`
        """
        model = SearchFlowRequest()
        if include_optional:
    ...
    def testSearchFlowRequest(self):
        """Test SearchFlowRequest"""
