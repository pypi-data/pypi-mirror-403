...
class StatusCodesResponse(BaseModel):
    ...
    """ # noqa: E501
    codes: List[StatusCodeInfo] = Field(description="Liste des codes statut")
    count: StrictInt = Field(description="Nombre de codes")
    source: Optional[StrictStr] = Field(default='BR-FR-CDV-CL-06', description="Règle source")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "codes": [StatusCodeInfo.from_dict(_item) for _item in obj["codes"]] if obj.get("codes") is not None else None,
            "count": obj.get("count"),
            "source": obj.get("source") if obj.get("source") is not None else 'BR-FR-CDV-CL-06'
        })
        return _obj
