...
class ValidationInfo(BaseModel):
    ...
    """ # noqa: E501
    profile: StrictStr = Field(description="Profil Factur-X utilise")
    schematron_rules_passed: StrictInt = Field(description="Regles passees")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "schematron_rules_passed": obj.get("schematron_rules_passed"),
