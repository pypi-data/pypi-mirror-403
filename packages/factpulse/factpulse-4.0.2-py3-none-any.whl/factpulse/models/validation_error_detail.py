...
class ValidationErrorDetail(BaseModel):
    ...
    """ # noqa: E501
    level: Optional[ErrorLevel] = Field(default=None, description="Severity level: 'Error' or 'Warning'")
    item: StrictStr = Field(description="Identifier of the concerned element (XPath, field, BR-FR rule, etc.)")
    reason: StrictStr = Field(description="Error description")
