...
class AFNORWebhookCallbackContent(BaseModel):
    """
    
    """ # noqa: E501
    flow_info: Optional[AFNORFlow] = Field(default=None, alias="flowInfo")
    __properties: ClassVar[List[str]] = ["flowInfo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "flowInfo": AFNORFlow.from_dict(obj["flowInfo"]) if obj.get("flowInfo") is not None else None
        })
        return _obj
