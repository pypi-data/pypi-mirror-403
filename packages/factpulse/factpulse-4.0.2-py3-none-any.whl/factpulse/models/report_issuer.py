...
class ReportIssuer(BaseModel):
    ...
    """ # noqa: E501
    siren: Annotated[str, Field(min_length=9, strict=True, max_length=14)] = Field(description="SIREN or SIRET of the declarant (French company)")
    name: Optional[StrictStr] = None
    vat_id: Optional[StrictStr] = Field(default=None, alias="vatId")
    role_code: Optional[IssuerRoleCode] = Field(default=None, description="Role of the declarant (TT-15). SE=Seller (B2Bi: French seller to foreign buyer). BY=Buyer (Bi2B: French buyer from foreign seller).", alias="roleCode")
    __properties: ClassVar[List[str]] = ["siren", "name", "vatId", "roleCode"]
