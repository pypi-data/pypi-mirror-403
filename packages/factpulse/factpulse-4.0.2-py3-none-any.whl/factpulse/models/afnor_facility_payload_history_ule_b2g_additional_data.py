...
class AFNORFacilityPayloadHistoryUleB2gAdditionalData(BaseModel):
    ...
    manages_legal_commitment_or_service_code: Optional[StrictBool] = Field(default=None, description="Indicates whether the public structure requires a service code or a commitment code in its exchanges. This attribute is only returned if the directory line is defined for a public structure at the SIREN / SIRET or SIREN / SIRET / Routing code level.", alias="managesLegalCommitmentOrServiceCode")
    service_code_status: Optional[StrictBool] = Field(default=None, description="Indicates whether the structure requires a service code. This attribute is only returned if the directory line is defined for a public structure at the SIREN / SIRET or SIREN / SIRET / Routing code level.", alias="serviceCodeStatus")
    __properties: ClassVar[List[str]] = ["pm", "pmOnly", "managesPaymentStatus", "managesLegalCommitmentCode", "managesLegalCommitmentOrServiceCode", "serviceCodeStatus"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pm": obj.get("pm"),
            "pmOnly": obj.get("pmOnly"),
            "managesPaymentStatus": obj.get("managesPaymentStatus"),
            "managesLegalCommitmentCode": obj.get("managesLegalCommitmentCode"),
            "managesLegalCommitmentOrServiceCode": obj.get("managesLegalCommitmentOrServiceCode"),
            "serviceCodeStatus": obj.get("serviceCodeStatus")
        })
        return _obj
