...
class AFNORCreateDirectoryLineBodyPeriod(BaseModel):
    """
    AFNORCreateDirectoryLineBodyPeriod
    """ # noqa: E501
    date_from: date = Field(description="Effective start date of the directory line..", alias="dateFrom")
    date_to: Optional[date] = Field(default=None, description="Effective end date of the directory line.", alias="dateTo")
    __properties: ClassVar[List[str]] = ["dateFrom", "dateTo"]
