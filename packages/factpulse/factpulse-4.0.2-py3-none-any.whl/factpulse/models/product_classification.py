...
class ProductClassification(BaseModel):
    ...
    """ # noqa: E501
    class_code: StrictStr = Field(description="Classification code (BT-158).")
    list_id: Optional[StrictStr] = None
    list_version_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["class_code", "list_id", "list_version_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if list_version_id (nullable) is None
        # and model_fields_set contains the field
        if self.list_version_id is None and "list_version_id" in self.model_fields_set:
            _dict['list_version_id'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "list_version_id": obj.get("list_version_id")
        })
        return _obj
