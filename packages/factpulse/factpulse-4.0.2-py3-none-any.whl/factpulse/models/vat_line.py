...
class VATLine(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.taxable_amount:
            _dict['taxable_amount'] = self.taxable_amount.to_dict()
        # override the default output from pydantic by calling `to_dict()` of vat_amount
        if self.vat_amount:
            _dict['vat_amount'] = self.vat_amount.to_dict()
        # override the default output from pydantic by calling `to_dict()` of manual_rate
        if self.manual_rate:
            _dict['manual_rate'] = self.manual_rate.to_dict()
        ...
        # set to None if vatex_code (nullable) is None
        # and model_fields_set contains the field
        if self.vatex_code is None and "vatex_code" in self.model_fields_set:
            _dict['vatex_code'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "taxable_amount": TaxableAmount.from_dict(obj["taxable_amount"]) if obj.get("taxable_amount") is not None else None,
