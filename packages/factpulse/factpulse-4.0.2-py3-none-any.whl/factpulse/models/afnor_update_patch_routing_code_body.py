...
class AFNORUpdatePatchRoutingCodeBody(BaseModel):
    """
    ...
    address: Optional[AFNORAddressPatch] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": AFNORAddressPatch.from_dict(obj["address"]) if obj.get("address") is not None else None
        })
        return _obj
