...
class AFNORSearchFlowParams(BaseModel):
    """
    AFNORSearchFlowParams
    """ # noqa: E501
    limit: Optional[Annotated[int, Field(le=100, strict=True)]] = Field(default=25, description="Maximum number of results that may be returned")
    where: AFNORSearchFlowFilters
    __properties: ClassVar[List[str]] = ["limit", "where"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "where": AFNORSearchFlowFilters.from_dict(obj["where"]) if obj.get("where") is not None else None
        })
        return _obj
