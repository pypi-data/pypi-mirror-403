...
class AFNORUpdatePutRoutingCodeBody(BaseModel):
    """
    AFNORUpdatePutRoutingCodeBody
    """ # noqa: E501
    routing_identifier_type: Annotated[str, Field(strict=True, max_length=4)] = Field(description="Routing Identifier type.", alias="routingIdentifierType")
    ...
    address: Optional[AFNORAddressPut] = None
    __properties: ClassVar[List[str]] = ["routingIdentifierType", "routingCodeName", "administrativeStatus", "address"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "address": AFNORAddressPut.from_dict(obj["address"]) if obj.get("address") is not None else None
        })
        return _obj
