...
class AFNORRoutingCodeSearchSortingInner(BaseModel):
    """
    A sort criteria composed of a field and an order (ascending or descending).
    """ # noqa: E501
    var_field: Optional[AFNORRoutingCodeField] = Field(default=None, alias="field")
    order: Optional[AFNORSortingOrder] = None
