...
class AFNORSearchSirenFiltersSiren(BaseModel):
    """
    AFNORSearchSirenFiltersSiren
    """ # noqa: E501
    op: Optional[AFNORContainsOperator] = None
    value: Optional[Annotated[str, Field(strict=True, max_length=9)]] = Field(default=None, description="SIREN number to search for.")
