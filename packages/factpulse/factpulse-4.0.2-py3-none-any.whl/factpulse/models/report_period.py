...
class ReportPeriod(BaseModel):
    ...
    Reporting period.
    """ # noqa: E501
    start_date: date = Field(description="Period start date (YYYY-MM-DD)", alias="startDate")
    end_date: date = Field(description="Period end date (YYYY-MM-DD)", alias="endDate")
