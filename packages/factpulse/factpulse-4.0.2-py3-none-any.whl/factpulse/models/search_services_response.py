...
class SearchServicesResponse(BaseModel):
    ...
    services: Optional[List[StructureService]] = Field(default=None, description="List of services")
    total: Optional[StrictInt] = Field(default=0, description="Number of services")
    __properties: ClassVar[List[str]] = ["returnCode", "message", "services", "total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "services": [StructureService.from_dict(_item) for _item in obj["services"]] if obj.get("services") is not None else None,
