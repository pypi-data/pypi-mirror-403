...
class AllowanceCharge(BaseModel):
    ...
    reason_code: Optional[AllowanceChargeReasonCode] = None
    vat_category: Optional[VATCategory] = None
    vat_rate: Optional[VatRate] = None
    __properties: ClassVar[List[str]] = ["is_charge", "amount", "base_amount", "percentage", "reason", "reason_code", "vat_category", "vat_rate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vat_rate": VatRate.from_dict(obj["vat_rate"]) if obj.get("vat_rate") is not None else None
        })
        return _obj
