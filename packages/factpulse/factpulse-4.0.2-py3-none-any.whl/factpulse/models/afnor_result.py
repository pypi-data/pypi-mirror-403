...
class AFNORResult(BaseModel):
    """
    Result of submission to AFNOR PDP.
    """ # noqa: E501
    flow_id: StrictStr = Field(description="Submitted flow identifier", alias="flowId")
    tracking_id: Optional[StrictStr] = Field(default=None, alias="trackingId")
    sha256: StrictStr = Field(description="SHA-256 hash of submitted file")
    flow_syntax: StrictStr = Field(description="Flow syntax", alias="flowSyntax")
    flow_profile: Optional[StrictStr] = Field(default=None, alias="flowProfile")
    flow_type: Optional[StrictStr] = Field(default=None, alias="flowType")
    processing_rule: Optional[StrictStr] = Field(default=None, alias="processingRule")
    processing_rule_source: Optional[StrictStr] = Field(default=None, alias="processingRuleSource")
    __properties: ClassVar[List[str]] = ["flowId", "trackingId", "sha256", "flowSyntax", "flowProfile", "flowType", "processingRule", "processingRuleSource"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if processing_rule_source (nullable) is None
        # and model_fields_set contains the field
        if self.processing_rule_source is None and "processing_rule_source" in self.model_fields_set:
            _dict['processingRuleSource'] = None
