...
class GetStructureResponse(BaseModel):
    ...
    structure_id: Optional[StrictInt] = Field(default=None, alias="structureId")
    structure_identifier: Optional[StrictStr] = Field(default=None, alias="structureIdentifier")
    structure_label: Optional[StrictStr] = Field(default=None, alias="structureLabel")
    company_name: Optional[StrictStr] = Field(default=None, alias="companyName")
    vat_number: Optional[StrictStr] = Field(default=None, alias="vatNumber")
    structure_email: Optional[StrictStr] = Field(default=None, alias="structureEmail")
    parameters: Optional[StructureParameters] = None
    __properties: ClassVar[List[str]] = ["returnCode", "message", "structureId", "structureIdentifier", "structureLabel", "companyName", "vatNumber", "structureEmail", "parameters"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if structure_label (nullable) is None
        # and model_fields_set contains the field
        if self.structure_label is None and "structure_label" in self.model_fields_set:
            _dict['structureLabel'] = None
        ...
        # set to None if structure_email (nullable) is None
        # and model_fields_set contains the field
        if self.structure_email is None and "structure_email" in self.model_fields_set:
            _dict['structureEmail'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "structureLabel": obj.get("structureLabel"),
            "companyName": obj.get("companyName"),
            "vatNumber": obj.get("vatNumber"),
            "structureEmail": obj.get("structureEmail"),
            "parameters": StructureParameters.from_dict(obj["parameters"]) if obj.get("parameters") is not None else None
        })
        return _obj
