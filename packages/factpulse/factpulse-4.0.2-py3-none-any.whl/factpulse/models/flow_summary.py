...
class FlowSummary(BaseModel):
    ...
    """ # noqa: E501
    flow_id: StrictStr = Field(description="Unique flow identifier")
    tracking_id: Optional[StrictStr] = None
    name: StrictStr = Field(description="Flow name")
    flow_type: Optional[StrictStr] = None
    flow_direction: Optional[StrictStr] = None
    acknowledgment_status: Optional[StrictStr] = None
    created_at: Optional[StrictStr] = None
    updated_at: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["flow_id", "tracking_id", "name", "flow_type", "flow_direction", "acknowledgment_status", "created_at", "updated_at"]
