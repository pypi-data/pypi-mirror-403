...
class MissingField(BaseModel):
    ...
    """ # noqa: E501
    var_field: StrictStr = Field(description="Nom du champ", alias="field")
    bt_code: StrictStr = Field(description="Code Business Term (BT-XX)")
    description: StrictStr = Field(description="Description du champ")
    required_for: List[StrictStr] = Field(description="Profils necessitant ce champ")
    suggested_value: Optional[StrictStr] = None
    confidence: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["field", "bt_code", "description", "required_for", "suggested_value", "confidence"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "required_for": obj.get("required_for"),
