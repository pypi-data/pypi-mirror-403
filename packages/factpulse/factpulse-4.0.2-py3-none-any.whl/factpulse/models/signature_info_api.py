...
class SignatureInfoAPI(BaseModel):
    """
    Information about an electronic signature in a PDF.
    """ # noqa: E501
    field_name: StrictStr = Field(description="Signature field name in the PDF", alias="fieldName")
    signer: Optional[StrictStr] = None
    signing_date: Optional[StrictStr] = Field(default=None, alias="signingDate")
    reason: Optional[StrictStr] = None
    location: Optional[StrictStr] = None
    is_valid: Optional[StrictBool] = Field(default=None, alias="isValid")
    __properties: ClassVar[List[str]] = ["fieldName", "signer", "signingDate", "reason", "location", "isValid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "signingDate": obj.get("signingDate"),
