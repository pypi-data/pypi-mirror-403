...
class AFNORRoutingCodeSearchFilters(BaseModel):
    """
    AFNORRoutingCodeSearchFilters
    """ # noqa: E501
    routing_identifier: Optional[AFNORRoutingCodeSearchFiltersRoutingIdentifier] = Field(default=None, alias="routingIdentifier")
    siret: Optional[AFNORSearchSiretFiltersSiret] = None
    routing_code_name: Optional[AFNORRoutingCodeSearchFiltersRoutingCodeName] = Field(default=None, alias="routingCodeName")
    administrative_status: Optional[AFNORRoutingCodeSearchFiltersAdministrativeStatus] = Field(default=None, alias="administrativeStatus")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "routingIdentifier": AFNORRoutingCodeSearchFiltersRoutingIdentifier.from_dict(obj["routingIdentifier"]) if obj.get("routingIdentifier") is not None else None,
            "siret": AFNORSearchSiretFiltersSiret.from_dict(obj["siret"]) if obj.get("siret") is not None else None,
            "routingCodeName": AFNORRoutingCodeSearchFiltersRoutingCodeName.from_dict(obj["routingCodeName"]) if obj.get("routingCodeName") is not None else None,
            "administrativeStatus": AFNORRoutingCodeSearchFiltersAdministrativeStatus.from_dict(obj["administrativeStatus"]) if obj.get("administrativeStatus") is not None else None,
