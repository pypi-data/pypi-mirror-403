...
class DiscussionScreen(PymordialScreen):
    """Discussion Screen for Revomon app.

    Note: The in-game title is 'Chat' not 'Discussion'.
    """
    ...
    def __init__(self):
        ...
        self.expected_title = "chat"  # In-game title is "Chat"

    def is_current_screen(self, pymordial_controller: "PymordialController") -> bool:
        """Check if on the discussion screen via OCR text detection."""
