...
from bdat.entities.patterns import CPChargeQOCVEval
...
class CPChargeQOCV(EvalPattern):
    ...
    def pattern(self, species: BatterySpecies) -> SteplistPattern:
        ...
        chargePower = make_range(
            [self.chargePower, (0.0, 0.2 * species.capacity)],
            (0.95, 1.05),
        )
        ...
        self.chargeStep = CPProperties(power=chargePower, voltageEnd=eocVoltage)
