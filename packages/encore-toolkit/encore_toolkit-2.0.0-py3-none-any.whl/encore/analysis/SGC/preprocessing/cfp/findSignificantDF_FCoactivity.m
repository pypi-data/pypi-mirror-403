function [ sig_dF_F_activity , sig_dF_F_coactivity_threshold , sig_dF_F_coactivity_peaks ] = findSignificantDF_FCoactivity(dF_F, pars)
...
CONST.STD_SIG_THRESHOLD = pars.standard_deviations_threshold;
...
CONST.SHUFFLE_ROUNDS = pars.shuffling_rounds;
% \_ CONST.SHUFFLE_ROUNDS: rounds of shuffling for coactivity null model
CONST.SIGNIFICANCE_P = pars.coactivity_significance_level;
