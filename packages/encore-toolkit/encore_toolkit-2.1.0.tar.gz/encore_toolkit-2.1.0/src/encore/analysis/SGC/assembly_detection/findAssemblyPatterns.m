function [ output_args ] = findAssemblyPatterns( activityPatterns, pars)
...
%% > ANALYSE COMMUNITY STRUCTURE IN SIMILARITY GRAPH
	...
	N_ITERATIONS = pars.montecarlo_rounds;
	N_MONTECARLOSTEPS = pars.montecarlo_steps;
...
%% > INFER ASSEMBLY PATTERNS
	...
	[ assemblyPatterns , iAssemblyPatterns ] = inferAssemblyPatterns( activityPatterns , patternSimilarityAnalysis, pars.affinity_threshold);
