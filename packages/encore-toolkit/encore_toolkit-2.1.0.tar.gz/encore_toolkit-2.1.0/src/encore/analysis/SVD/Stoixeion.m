...
% sec_Pk_Frame = sec_Pk_frames;   % Legacy reasons 
% save("TimeCourse", "sec_Pk_Frame", "Pks_Frame");
...
stoixeion_results.tf_idf_norm = tf_idf_norm;
stoixeion_results.state_cut = state_cut;
