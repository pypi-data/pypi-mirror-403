...
def get_snmp(network_id: Optional[_builtins.str] = None,
...
def get_snmp_output(network_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:networks/getSnmp:getSnmp', __args__, opts=opts, typ=GetSnmpResult)
