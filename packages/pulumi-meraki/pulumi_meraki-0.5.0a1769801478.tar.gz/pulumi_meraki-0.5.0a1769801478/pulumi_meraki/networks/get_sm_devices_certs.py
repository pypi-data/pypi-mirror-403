...
__all__ = [
    'GetSmDevicesCertsResult',
    'AwaitableGetSmDevicesCertsResult',
    'get_sm_devices_certs',
    'get_sm_devices_certs_output',
]

@pulumi.output_type
class GetSmDevicesCertsResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSmDevicesCertsItemResult']:
        """
...
class AwaitableGetSmDevicesCertsResult(GetSmDevicesCertsResult):
...
def get_sm_devices_certs(device_id: Optional[_builtins.str] = None,
                         network_id: Optional[_builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmDevicesCertsResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getSmDevicesCerts:getSmDevicesCerts', __args__, opts=opts, typ=GetSmDevicesCertsResult).value
...
def get_sm_devices_certs_output(device_id: Optional[pulumi.Input[_builtins.str]] = None,
