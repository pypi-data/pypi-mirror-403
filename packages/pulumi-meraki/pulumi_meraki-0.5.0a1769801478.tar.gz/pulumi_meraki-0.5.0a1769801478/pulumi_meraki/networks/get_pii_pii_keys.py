...
__all__ = [
    'GetPiiPiiKeysResult',
    'AwaitableGetPiiPiiKeysResult',
    'get_pii_pii_keys',
    'get_pii_pii_keys_output',
]

@pulumi.output_type
class GetPiiPiiKeysResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetPiiPiiKeysItemResult':
...
class AwaitableGetPiiPiiKeysResult(GetPiiPiiKeysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPiiPiiKeysResult(
...
def get_pii_pii_keys(bluetooth_mac: Optional[_builtins.str] = None,
                     ...
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPiiPiiKeysResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getPiiPiiKeys:getPiiPiiKeys', __args__, opts=opts, typ=GetPiiPiiKeysResult).value

    return AwaitableGetPiiPiiKeysResult(
...
def get_pii_pii_keys_output(bluetooth_mac: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            ...
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPiiPiiKeysResult]:
    """
    ## Example Usage
