...
class SmUserAccessDevicesDeleteArgs:
    ...
    def user_access_device_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def user_access_device_id(self, value: pulumi.Input[_builtins.str]):
...
@pulumi.type_token("meraki:networks/smUserAccessDevicesDelete:SmUserAccessDevicesDelete")
class SmUserAccessDevicesDelete(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="userAccessDeviceId")
    def user_access_device_id(self) -> pulumi.Output[_builtins.str]:
        """
        userAccessDeviceId path parameter. User access device ID
        """
        return pulumi.get(self, "user_access_device_id")
