...
class GetWirelessLatencyStatsResult:
    ...
    """
    def __init__(__self__, ap_tag=None, band=None, fields=None, id=None, item=None, network_id=None, ssid=None, t0=None, t1=None, timespan=None, vlan=None):
...
def get_wireless_latency_stats(ap_tag: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getWirelessLatencyStats:getWirelessLatencyStats', __args__, opts=opts, typ=GetWirelessLatencyStatsResult).value
...
def get_wireless_latency_stats_output(ap_tag: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:networks/getWirelessLatencyStats:getWirelessLatencyStats', __args__, opts=opts, typ=GetWirelessLatencyStatsResult)
