...
__all__ = [
    'GetAlertsHistoryResult',
    'AwaitableGetAlertsHistoryResult',
    'get_alerts_history',
    'get_alerts_history_output',
]

@pulumi.output_type
class GetAlertsHistoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetAlertsHistoryItemResult']:
        """
...
class AwaitableGetAlertsHistoryResult(GetAlertsHistoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetAlertsHistoryResult(
...
def get_alerts_history(ending_before: Optional[_builtins.str] = None,
                       network_id: Optional[_builtins.str] = None,
                       per_page: Optional[_builtins.int] = None,
                       starting_after: Optional[_builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetAlertsHistoryResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getAlertsHistory:getAlertsHistory', __args__, opts=opts, typ=GetAlertsHistoryResult).value

    return AwaitableGetAlertsHistoryResult(
...
def get_alerts_history_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              ...
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAlertsHistoryResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:networks/getAlertsHistory:getAlertsHistory', __args__, opts=opts, typ=GetAlertsHistoryResult)
    return __ret__.apply(lambda __response__: GetAlertsHistoryResult(
