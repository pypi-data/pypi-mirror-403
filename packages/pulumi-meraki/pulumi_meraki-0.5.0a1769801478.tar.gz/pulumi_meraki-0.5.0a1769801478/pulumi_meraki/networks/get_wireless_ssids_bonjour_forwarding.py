...
__all__ = [
    'GetWirelessSsidsBonjourForwardingResult',
    'AwaitableGetWirelessSsidsBonjourForwardingResult',
    'get_wireless_ssids_bonjour_forwarding',
    'get_wireless_ssids_bonjour_forwarding_output',
]

@pulumi.output_type
class GetWirelessSsidsBonjourForwardingResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetWirelessSsidsBonjourForwardingItemResult':
...
class AwaitableGetWirelessSsidsBonjourForwardingResult(GetWirelessSsidsBonjourForwardingResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWirelessSsidsBonjourForwardingResult(
            id=self.id,
            item=self.item,
...
def get_wireless_ssids_bonjour_forwarding(network_id: Optional[_builtins.str] = None,
                                          number: Optional[_builtins.str] = None,
                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWirelessSsidsBonjourForwardingResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getWirelessSsidsBonjourForwarding:getWirelessSsidsBonjourForwarding', __args__, opts=opts, typ=GetWirelessSsidsBonjourForwardingResult).value

    return AwaitableGetWirelessSsidsBonjourForwardingResult(
