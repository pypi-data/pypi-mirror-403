...
__all__ = [
    'GetSwitchStacksResult',
    'AwaitableGetSwitchStacksResult',
    'get_switch_stacks',
    'get_switch_stacks_output',
]

@pulumi.output_type
class GetSwitchStacksResult:
    """
    A collection of values returned by getSwitchStacks.
    """
    def __init__(__self__, id=None, item=None, items=None, network_id=None, switch_stack_id=None):
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetSwitchStacksItemResult':
        return pulumi.get(self, "item")

    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSwitchStacksItemResult']:
        """
...
class AwaitableGetSwitchStacksResult(GetSwitchStacksResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSwitchStacksResult(
            id=self.id,
            item=self.item,
            items=self.items,
...
def get_switch_stacks(network_id: Optional[_builtins.str] = None,
                      switch_stack_id: Optional[_builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSwitchStacksResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getSwitchStacks:getSwitchStacks', __args__, opts=opts, typ=GetSwitchStacksResult).value

    return AwaitableGetSwitchStacksResult(
        id=pulumi.get(__ret__, 'id'),
        item=pulumi.get(__ret__, 'item'),
        items=pulumi.get(__ret__, 'items'),
        network_id=pulumi.get(__ret__, 'network_id'),
        switch_stack_id=pulumi.get(__ret__, 'switch_stack_id'))
def get_switch_stacks_output(network_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
