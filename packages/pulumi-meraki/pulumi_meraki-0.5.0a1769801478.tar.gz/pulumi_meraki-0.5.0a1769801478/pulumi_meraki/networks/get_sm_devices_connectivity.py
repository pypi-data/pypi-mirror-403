...
__all__ = [
    'GetSmDevicesConnectivityResult',
    'AwaitableGetSmDevicesConnectivityResult',
    'get_sm_devices_connectivity',
    'get_sm_devices_connectivity_output',
]

@pulumi.output_type
class GetSmDevicesConnectivityResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSmDevicesConnectivityItemResult']:
        """
...
class AwaitableGetSmDevicesConnectivityResult(GetSmDevicesConnectivityResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSmDevicesConnectivityResult(
...
def get_sm_devices_connectivity(device_id: Optional[_builtins.str] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmDevicesConnectivityResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getSmDevicesConnectivity:getSmDevicesConnectivity', __args__, opts=opts, typ=GetSmDevicesConnectivityResult).value

    return AwaitableGetSmDevicesConnectivityResult(
...
def get_sm_devices_connectivity_output(device_id: Optional[pulumi.Input[_builtins.str]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSmDevicesConnectivityResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:networks/getSmDevicesConnectivity:getSmDevicesConnectivity', __args__, opts=opts, typ=GetSmDevicesConnectivityResult)
    return __ret__.apply(lambda __response__: GetSmDevicesConnectivityResult(
