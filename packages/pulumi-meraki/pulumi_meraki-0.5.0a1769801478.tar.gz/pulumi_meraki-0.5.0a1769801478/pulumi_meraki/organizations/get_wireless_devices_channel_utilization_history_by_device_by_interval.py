...
__all__ = [
    'GetWirelessDevicesChannelUtilizationHistoryByDeviceByIntervalResult',
    'AwaitableGetWirelessDevicesChannelUtilizationHistoryByDeviceByIntervalResult',
    'get_wireless_devices_channel_utilization_history_by_device_by_interval',
    'get_wireless_devices_channel_utilization_history_by_device_by_interval_output',
]

@pulumi.output_type
class GetWirelessDevicesChannelUtilizationHistoryByDeviceByIntervalResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetWirelessDevicesChannelUtilizationHistoryByDeviceByIntervalItemResult']:
        """
...
class AwaitableGetWirelessDevicesChannelUtilizationHistoryByDeviceByIntervalResult(GetWirelessDevicesChannelUtilizationHistoryByDeviceByIntervalResult):
...
def get_wireless_devices_channel_utilization_history_by_device_by_interval(ending_before: Optional[_builtins.str] = None,
                                                                           ...
                                                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWirelessDevicesChannelUtilizationHistoryByDeviceByIntervalResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getWirelessDevicesChannelUtilizationHistoryByDeviceByInterval:getWirelessDevicesChannelUtilizationHistoryByDeviceByInterval', __args__, opts=opts, typ=GetWirelessDevicesChannelUtilizationHistoryByDeviceByIntervalResult).value
...
def get_wireless_devices_channel_utilization_history_by_device_by_interval_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                                                  ...
                                                                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWirelessDevicesChannelUtilizationHistoryByDeviceByIntervalResult]:
    """
    ## Example Usage
