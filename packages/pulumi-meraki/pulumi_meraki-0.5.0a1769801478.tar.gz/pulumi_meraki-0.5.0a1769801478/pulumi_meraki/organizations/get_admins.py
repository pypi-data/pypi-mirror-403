...
class GetAdminsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetAdminsItemResult']:
        """
...
def get_admins(organization_id: Optional[_builtins.str] = None,
...
def get_admins_output(organization_id: Optional[pulumi.Input[_builtins.str]] = None,
