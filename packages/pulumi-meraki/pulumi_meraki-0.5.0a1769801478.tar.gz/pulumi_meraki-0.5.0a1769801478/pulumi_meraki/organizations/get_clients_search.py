...
__all__ = [
    ...
    'AwaitableGetClientsSearchResult',
    'get_clients_search',
    'get_clients_search_output',
]

@pulumi.output_type
class GetClientsSearchResult:
    """
    A collection of values returned by getClientsSearch.
    """
    def __init__(__self__, ending_before=None, id=None, item=None, mac=None, organization_id=None, per_page=None, starting_after=None):
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetClientsSearchItemResult':
...
class AwaitableGetClientsSearchResult(GetClientsSearchResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetClientsSearchResult(
...
def get_clients_search(ending_before: Optional[_builtins.str] = None,
                       mac: Optional[_builtins.str] = None,
                       organization_id: Optional[_builtins.str] = None,
                       per_page: Optional[_builtins.int] = None,
                       starting_after: Optional[_builtins.str] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetClientsSearchResult:
    """
    ## Example Usage
    ...
    :param _builtins.str mac: mac query parameter. The MAC address of the client. Required.
    :param _builtins.str organization_id: organizationId path parameter. Organization ID
    :param _builtins.int per_page: perPage query parameter. The number of entries per page returned. Acceptable range is 3 5. Default is 5.
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getClientsSearch:getClientsSearch', __args__, opts=opts, typ=GetClientsSearchResult).value

    return AwaitableGetClientsSearchResult(
...
def get_clients_search_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:organizations/getClientsSearch:getClientsSearch', __args__, opts=opts, typ=GetClientsSearchResult)
    return __ret__.apply(lambda __response__: GetClientsSearchResult(
