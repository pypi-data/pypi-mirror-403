...
class GetOrganizationsResult:
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetOrganizationsItemResult':
        return pulumi.get(self, "item")

    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetOrganizationsItemResult']:
        """
...
def get_organizations(ending_before: Optional[_builtins.str] = None,
    ...
    :param _builtins.int per_page: perPage query parameter. The number of entries per page returned. Acceptable range is 3 9000. Default is 9000.
    ...
    __ret__ = pulumi.runtime.invoke('meraki:index/getOrganizations:getOrganizations', __args__, opts=opts, typ=GetOrganizationsResult).value
...
def get_organizations_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
