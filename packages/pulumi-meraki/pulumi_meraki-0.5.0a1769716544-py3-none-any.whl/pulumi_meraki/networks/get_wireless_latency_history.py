...
__all__ = [
    'GetWirelessLatencyHistoryResult',
    'AwaitableGetWirelessLatencyHistoryResult',
    'get_wireless_latency_history',
    'get_wireless_latency_history_output',
]

@pulumi.output_type
class GetWirelessLatencyHistoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter(name="accessCategory")
    def access_category(self) -> Optional[_builtins.str]:
        """
        accessCategory query parameter. Filter by access category.
        """
        return pulumi.get(self, "access_category")
...
class AwaitableGetWirelessLatencyHistoryResult(GetWirelessLatencyHistoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWirelessLatencyHistoryResult(
...
def get_wireless_latency_history(access_category: Optional[_builtins.str] = None,
                                 ap_tag: Optional[_builtins.str] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWirelessLatencyHistoryResult:
    """
    ## Example Usage
    ...
    :param _builtins.str access_category: accessCategory query parameter. Filter by access category.
    ...
    """
    __args__ = dict()
    __args__['accessCategory'] = access_category
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getWirelessLatencyHistory:getWirelessLatencyHistory', __args__, opts=opts, typ=GetWirelessLatencyHistoryResult).value

    return AwaitableGetWirelessLatencyHistoryResult(
        access_category=pulumi.get(__ret__, 'access_category'),
...
def get_wireless_latency_history_output(access_category: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                        ap_tag: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
