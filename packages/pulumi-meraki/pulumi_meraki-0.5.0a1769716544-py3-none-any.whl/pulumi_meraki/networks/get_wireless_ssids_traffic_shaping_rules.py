...
__all__ = [
    'GetWirelessSsidsTrafficShapingRulesResult',
    'AwaitableGetWirelessSsidsTrafficShapingRulesResult',
    'get_wireless_ssids_traffic_shaping_rules',
    'get_wireless_ssids_traffic_shaping_rules_output',
]

@pulumi.output_type
class GetWirelessSsidsTrafficShapingRulesResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetWirelessSsidsTrafficShapingRulesItemResult':
...
class AwaitableGetWirelessSsidsTrafficShapingRulesResult(GetWirelessSsidsTrafficShapingRulesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWirelessSsidsTrafficShapingRulesResult(
            id=self.id,
            item=self.item,
...
def get_wireless_ssids_traffic_shaping_rules(network_id: Optional[_builtins.str] = None,
                                             number: Optional[_builtins.str] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWirelessSsidsTrafficShapingRulesResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getWirelessSsidsTrafficShapingRules:getWirelessSsidsTrafficShapingRules', __args__, opts=opts, typ=GetWirelessSsidsTrafficShapingRulesResult).value

    return AwaitableGetWirelessSsidsTrafficShapingRulesResult(
        id=pulumi.get(__ret__, 'id'),
        item=pulumi.get(__ret__, 'item'),
        network_id=pulumi.get(__ret__, 'network_id'),
        number=pulumi.get(__ret__, 'number'))
def get_wireless_ssids_traffic_shaping_rules_output(network_id: Optional[pulumi.Input[_builtins.str]] = None,
