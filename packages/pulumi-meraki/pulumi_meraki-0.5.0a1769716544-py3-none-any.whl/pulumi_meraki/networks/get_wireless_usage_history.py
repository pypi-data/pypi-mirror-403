...
__all__ = [
    ...
    'AwaitableGetWirelessUsageHistoryResult',
    'get_wireless_usage_history',
    'get_wireless_usage_history_output',
]

@pulumi.output_type
class GetWirelessUsageHistoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetWirelessUsageHistoryItemResult']:
        """
...
class AwaitableGetWirelessUsageHistoryResult(GetWirelessUsageHistoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWirelessUsageHistoryResult(
            ap_tag=self.ap_tag,
...
def get_wireless_usage_history(ap_tag: Optional[_builtins.str] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWirelessUsageHistoryResult:
    """
    ## Example Usage
    ...
    :param _builtins.str client_id: clientId query parameter. Filter results by network client to return per-device AP usage over time inner joined by the queried client's connection history.
    :param _builtins.str device_serial: deviceSerial query parameter. Filter results by device. Requires :band.
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getWirelessUsageHistory:getWirelessUsageHistory', __args__, opts=opts, typ=GetWirelessUsageHistoryResult).value

    return AwaitableGetWirelessUsageHistoryResult(
...
def get_wireless_usage_history_output(ap_tag: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWirelessUsageHistoryResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:networks/getWirelessUsageHistory:getWirelessUsageHistory', __args__, opts=opts, typ=GetWirelessUsageHistoryResult)
    return __ret__.apply(lambda __response__: GetWirelessUsageHistoryResult(
