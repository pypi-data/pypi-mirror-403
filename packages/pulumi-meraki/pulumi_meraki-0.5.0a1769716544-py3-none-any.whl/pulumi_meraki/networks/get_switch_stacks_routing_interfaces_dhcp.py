...
__all__ = [
    ...
    'AwaitableGetSwitchStacksRoutingInterfacesDhcpResult',
    'get_switch_stacks_routing_interfaces_dhcp',
    'get_switch_stacks_routing_interfaces_dhcp_output',
]

@pulumi.output_type
class GetSwitchStacksRoutingInterfacesDhcpResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetSwitchStacksRoutingInterfacesDhcpItemResult':
    ...
    def switch_stack_id(self) -> _builtins.str:
        """
...
class AwaitableGetSwitchStacksRoutingInterfacesDhcpResult(GetSwitchStacksRoutingInterfacesDhcpResult):
...
def get_switch_stacks_routing_interfaces_dhcp(interface_id: Optional[_builtins.str] = None,
                                              network_id: Optional[_builtins.str] = None,
                                              switch_stack_id: Optional[_builtins.str] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSwitchStacksRoutingInterfacesDhcpResult:
    """
    ## Example Usage
