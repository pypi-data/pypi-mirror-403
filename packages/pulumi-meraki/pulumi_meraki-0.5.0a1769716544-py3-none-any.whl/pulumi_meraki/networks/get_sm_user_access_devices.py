...
__all__ = [
    'GetSmUserAccessDevicesResult',
    'AwaitableGetSmUserAccessDevicesResult',
    'get_sm_user_access_devices',
    'get_sm_user_access_devices_output',
]

@pulumi.output_type
class GetSmUserAccessDevicesResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSmUserAccessDevicesItemResult']:
        """
...
class AwaitableGetSmUserAccessDevicesResult(GetSmUserAccessDevicesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSmUserAccessDevicesResult(
...
def get_sm_user_access_devices(ending_before: Optional[_builtins.str] = None,
                               network_id: Optional[_builtins.str] = None,
                               per_page: Optional[_builtins.int] = None,
                               starting_after: Optional[_builtins.str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmUserAccessDevicesResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getSmUserAccessDevices:getSmUserAccessDevices', __args__, opts=opts, typ=GetSmUserAccessDevicesResult).value

    return AwaitableGetSmUserAccessDevicesResult(
...
def get_sm_user_access_devices_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSmUserAccessDevicesResult]:
    """
    ## Example Usage
