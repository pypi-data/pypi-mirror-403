...
__all__ = [
    ...
    'AwaitableGetSwitchPortSchedulesResult',
    'get_switch_port_schedules',
    'get_switch_port_schedules_output',
]

@pulumi.output_type
class GetSwitchPortSchedulesResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSwitchPortSchedulesItemResult']:
        """
...
class AwaitableGetSwitchPortSchedulesResult(GetSwitchPortSchedulesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSwitchPortSchedulesResult(
            id=self.id,
            items=self.items,
            network_id=self.network_id)


def get_switch_port_schedules(network_id: Optional[_builtins.str] = None,
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSwitchPortSchedulesResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getSwitchPortSchedules:getSwitchPortSchedules', __args__, opts=opts, typ=GetSwitchPortSchedulesResult).value

    return AwaitableGetSwitchPortSchedulesResult(
        id=pulumi.get(__ret__, 'id'),
        items=pulumi.get(__ret__, 'items'),
        network_id=pulumi.get(__ret__, 'network_id'))
def get_switch_port_schedules_output(network_id: Optional[pulumi.Input[_builtins.str]] = None,
