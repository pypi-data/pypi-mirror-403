...
__all__ = [
    'GetWirelessDataRateHistoryResult',
    'AwaitableGetWirelessDataRateHistoryResult',
    'get_wireless_data_rate_history',
    'get_wireless_data_rate_history_output',
]

@pulumi.output_type
class GetWirelessDataRateHistoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetWirelessDataRateHistoryItemResult']:
        """
...
class AwaitableGetWirelessDataRateHistoryResult(GetWirelessDataRateHistoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWirelessDataRateHistoryResult(
            ap_tag=self.ap_tag,
...
def get_wireless_data_rate_history(ap_tag: Optional[_builtins.str] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWirelessDataRateHistoryResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getWirelessDataRateHistory:getWirelessDataRateHistory', __args__, opts=opts, typ=GetWirelessDataRateHistoryResult).value

    return AwaitableGetWirelessDataRateHistoryResult(
...
def get_wireless_data_rate_history_output(ap_tag: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                          ...
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWirelessDataRateHistoryResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:networks/getWirelessDataRateHistory:getWirelessDataRateHistory', __args__, opts=opts, typ=GetWirelessDataRateHistoryResult)
    return __ret__.apply(lambda __response__: GetWirelessDataRateHistoryResult(
