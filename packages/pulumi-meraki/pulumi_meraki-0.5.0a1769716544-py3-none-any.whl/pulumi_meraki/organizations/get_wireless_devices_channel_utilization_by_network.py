...
__all__ = [
    ...
    'AwaitableGetWirelessDevicesChannelUtilizationByNetworkResult',
    'get_wireless_devices_channel_utilization_by_network',
    'get_wireless_devices_channel_utilization_by_network_output',
]

@pulumi.output_type
class GetWirelessDevicesChannelUtilizationByNetworkResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetWirelessDevicesChannelUtilizationByNetworkItemResult']:
        """
...
class AwaitableGetWirelessDevicesChannelUtilizationByNetworkResult(GetWirelessDevicesChannelUtilizationByNetworkResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWirelessDevicesChannelUtilizationByNetworkResult(
...
def get_wireless_devices_channel_utilization_by_network(ending_before: Optional[_builtins.str] = None,
                                                        ...
                                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWirelessDevicesChannelUtilizationByNetworkResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getWirelessDevicesChannelUtilizationByNetwork:getWirelessDevicesChannelUtilizationByNetwork', __args__, opts=opts, typ=GetWirelessDevicesChannelUtilizationByNetworkResult).value

    return AwaitableGetWirelessDevicesChannelUtilizationByNetworkResult(
...
def get_wireless_devices_channel_utilization_by_network_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                               ...
                                                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWirelessDevicesChannelUtilizationByNetworkResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:organizations/getWirelessDevicesChannelUtilizationByNetwork:getWirelessDevicesChannelUtilizationByNetwork', __args__, opts=opts, typ=GetWirelessDevicesChannelUtilizationByNetworkResult)
    return __ret__.apply(lambda __response__: GetWirelessDevicesChannelUtilizationByNetworkResult(
