...
__all__ = [
    ...
    'AwaitableGetSmSentryPoliciesAssignmentsByNetworkResult',
    'get_sm_sentry_policies_assignments_by_network',
    'get_sm_sentry_policies_assignments_by_network_output',
]

@pulumi.output_type
class GetSmSentryPoliciesAssignmentsByNetworkResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSmSentryPoliciesAssignmentsByNetworkItemResult']:
        """
...
class AwaitableGetSmSentryPoliciesAssignmentsByNetworkResult(GetSmSentryPoliciesAssignmentsByNetworkResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSmSentryPoliciesAssignmentsByNetworkResult(
...
def get_sm_sentry_policies_assignments_by_network(ending_before: Optional[_builtins.str] = None,
                                                  ...
                                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmSentryPoliciesAssignmentsByNetworkResult:
    """
    ## Example Usage
    ...
    :param Sequence[_builtins.str] network_ids: networkIds query parameter. Optional parameter to filter Sentry Policies by Network Id
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getSmSentryPoliciesAssignmentsByNetwork:getSmSentryPoliciesAssignmentsByNetwork', __args__, opts=opts, typ=GetSmSentryPoliciesAssignmentsByNetworkResult).value

    return AwaitableGetSmSentryPoliciesAssignmentsByNetworkResult(
...
def get_sm_sentry_policies_assignments_by_network_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
