...
__all__ = [
    'GetWirelessDevicesPacketLossByDeviceResult',
    'AwaitableGetWirelessDevicesPacketLossByDeviceResult',
    'get_wireless_devices_packet_loss_by_device',
    'get_wireless_devices_packet_loss_by_device_output',
]

@pulumi.output_type
class GetWirelessDevicesPacketLossByDeviceResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetWirelessDevicesPacketLossByDeviceItemResult']:
        """
...
class AwaitableGetWirelessDevicesPacketLossByDeviceResult(GetWirelessDevicesPacketLossByDeviceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWirelessDevicesPacketLossByDeviceResult(
            bands=self.bands,
...
def get_wireless_devices_packet_loss_by_device(bands: Optional[Sequence[_builtins.str]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWirelessDevicesPacketLossByDeviceResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getWirelessDevicesPacketLossByDevice:getWirelessDevicesPacketLossByDevice', __args__, opts=opts, typ=GetWirelessDevicesPacketLossByDeviceResult).value

    return AwaitableGetWirelessDevicesPacketLossByDeviceResult(
...
def get_wireless_devices_packet_loss_by_device_output(bands: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                                      ...
                                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWirelessDevicesPacketLossByDeviceResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:organizations/getWirelessDevicesPacketLossByDevice:getWirelessDevicesPacketLossByDevice', __args__, opts=opts, typ=GetWirelessDevicesPacketLossByDeviceResult)
    return __ret__.apply(lambda __response__: GetWirelessDevicesPacketLossByDeviceResult(
