...
__all__ = [
    'GetSummaryTopDevicesByUsageResult',
    'AwaitableGetSummaryTopDevicesByUsageResult',
    'get_summary_top_devices_by_usage',
    'get_summary_top_devices_by_usage_output',
]

@pulumi.output_type
class GetSummaryTopDevicesByUsageResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSummaryTopDevicesByUsageItemResult']:
        """
...
class AwaitableGetSummaryTopDevicesByUsageResult(GetSummaryTopDevicesByUsageResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSummaryTopDevicesByUsageResult(
            id=self.id,
            items=self.items,
...
def get_summary_top_devices_by_usage(organization_id: Optional[_builtins.str] = None,
                                     t0: Optional[_builtins.str] = None,
                                     t1: Optional[_builtins.str] = None,
                                     timespan: Optional[_builtins.float] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSummaryTopDevicesByUsageResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getSummaryTopDevicesByUsage:getSummaryTopDevicesByUsage', __args__, opts=opts, typ=GetSummaryTopDevicesByUsageResult).value

    return AwaitableGetSummaryTopDevicesByUsageResult(
...
def get_summary_top_devices_by_usage_output(organization_id: Optional[pulumi.Input[_builtins.str]] = None,
                                            ...
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSummaryTopDevicesByUsageResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:organizations/getSummaryTopDevicesByUsage:getSummaryTopDevicesByUsage', __args__, opts=opts, typ=GetSummaryTopDevicesByUsageResult)
    return __ret__.apply(lambda __response__: GetSummaryTopDevicesByUsageResult(
