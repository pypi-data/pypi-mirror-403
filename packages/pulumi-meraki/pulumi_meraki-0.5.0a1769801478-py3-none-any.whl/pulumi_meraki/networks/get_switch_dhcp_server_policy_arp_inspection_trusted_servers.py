...
__all__ = [
    ...
    'AwaitableGetSwitchDhcpServerPolicyArpInspectionTrustedServersResult',
    'get_switch_dhcp_server_policy_arp_inspection_trusted_servers',
    'get_switch_dhcp_server_policy_arp_inspection_trusted_servers_output',
]

@pulumi.output_type
class GetSwitchDhcpServerPolicyArpInspectionTrustedServersResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSwitchDhcpServerPolicyArpInspectionTrustedServersItemResult']:
        """
...
class AwaitableGetSwitchDhcpServerPolicyArpInspectionTrustedServersResult(GetSwitchDhcpServerPolicyArpInspectionTrustedServersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSwitchDhcpServerPolicyArpInspectionTrustedServersResult(
...
def get_switch_dhcp_server_policy_arp_inspection_trusted_servers(ending_before: Optional[_builtins.str] = None,
                                                                 network_id: Optional[_builtins.str] = None,
                                                                 per_page: Optional[_builtins.int] = None,
                                                                 starting_after: Optional[_builtins.str] = None,
                                                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSwitchDhcpServerPolicyArpInspectionTrustedServersResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getSwitchDhcpServerPolicyArpInspectionTrustedServers:getSwitchDhcpServerPolicyArpInspectionTrustedServers', __args__, opts=opts, typ=GetSwitchDhcpServerPolicyArpInspectionTrustedServersResult).value

    return AwaitableGetSwitchDhcpServerPolicyArpInspectionTrustedServersResult(
...
def get_switch_dhcp_server_policy_arp_inspection_trusted_servers_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                                        ...
                                                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSwitchDhcpServerPolicyArpInspectionTrustedServersResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:networks/getSwitchDhcpServerPolicyArpInspectionTrustedServers:getSwitchDhcpServerPolicyArpInspectionTrustedServers', __args__, opts=opts, typ=GetSwitchDhcpServerPolicyArpInspectionTrustedServersResult)
    return __ret__.apply(lambda __response__: GetSwitchDhcpServerPolicyArpInspectionTrustedServersResult(
