...
__all__ = [
    ...
    'AwaitableGetSmUsersSoftwaresResult',
    'get_sm_users_softwares',
    'get_sm_users_softwares_output',
]

@pulumi.output_type
class GetSmUsersSoftwaresResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSmUsersSoftwaresItemResult']:
        """
...
class AwaitableGetSmUsersSoftwaresResult(GetSmUsersSoftwaresResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSmUsersSoftwaresResult(
            id=self.id,
            items=self.items,
...
def get_sm_users_softwares(network_id: Optional[_builtins.str] = None,
                           user_id: Optional[_builtins.str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmUsersSoftwaresResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getSmUsersSoftwares:getSmUsersSoftwares', __args__, opts=opts, typ=GetSmUsersSoftwaresResult).value

    return AwaitableGetSmUsersSoftwaresResult(
