...
def get_appliance_security_intrusion(network_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getApplianceSecurityIntrusion:getApplianceSecurityIntrusion', __args__, opts=opts, typ=GetApplianceSecurityIntrusionResult).value

    return AwaitableGetApplianceSecurityIntrusionResult(
        id=pulumi.get(__ret__, 'id'),
        item=pulumi.get(__ret__, 'item'),
        network_id=pulumi.get(__ret__, 'network_id'))
def get_appliance_security_intrusion_output(network_id: Optional[pulumi.Input[_builtins.str]] = None,
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetApplianceSecurityIntrusionResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:networks/getApplianceSecurityIntrusion:getApplianceSecurityIntrusion', __args__, opts=opts, typ=GetApplianceSecurityIntrusionResult)
    return __ret__.apply(lambda __response__: GetApplianceSecurityIntrusionResult(
