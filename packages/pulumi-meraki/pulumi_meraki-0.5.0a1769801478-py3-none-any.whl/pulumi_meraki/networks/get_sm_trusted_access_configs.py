...
__all__ = [
    ...
    'AwaitableGetSmTrustedAccessConfigsResult',
    'get_sm_trusted_access_configs',
    'get_sm_trusted_access_configs_output',
]

@pulumi.output_type
class GetSmTrustedAccessConfigsResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSmTrustedAccessConfigsItemResult']:
        """
...
class AwaitableGetSmTrustedAccessConfigsResult(GetSmTrustedAccessConfigsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSmTrustedAccessConfigsResult(
...
def get_sm_trusted_access_configs(ending_before: Optional[_builtins.str] = None,
                                  network_id: Optional[_builtins.str] = None,
                                  per_page: Optional[_builtins.int] = None,
                                  starting_after: Optional[_builtins.str] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmTrustedAccessConfigsResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getSmTrustedAccessConfigs:getSmTrustedAccessConfigs', __args__, opts=opts, typ=GetSmTrustedAccessConfigsResult).value

    return AwaitableGetSmTrustedAccessConfigsResult(
...
def get_sm_trusted_access_configs_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
