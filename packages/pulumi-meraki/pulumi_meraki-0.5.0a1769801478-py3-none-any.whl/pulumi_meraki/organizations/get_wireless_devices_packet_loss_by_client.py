...
__all__ = [
    ...
    'AwaitableGetWirelessDevicesPacketLossByClientResult',
    'get_wireless_devices_packet_loss_by_client',
    'get_wireless_devices_packet_loss_by_client_output',
]

@pulumi.output_type
class GetWirelessDevicesPacketLossByClientResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetWirelessDevicesPacketLossByClientItemResult']:
        """
...
class AwaitableGetWirelessDevicesPacketLossByClientResult(GetWirelessDevicesPacketLossByClientResult):
...
def get_wireless_devices_packet_loss_by_client(bands: Optional[Sequence[_builtins.str]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWirelessDevicesPacketLossByClientResult:
    """
    ## Example Usage
    ...
    :param Sequence[_builtins.str] macs: macs query parameter. Filter results by client mac address(es).
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getWirelessDevicesPacketLossByClient:getWirelessDevicesPacketLossByClient', __args__, opts=opts, typ=GetWirelessDevicesPacketLossByClientResult).value
...
def get_wireless_devices_packet_loss_by_client_output(bands: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                                      ...
                                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWirelessDevicesPacketLossByClientResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:organizations/getWirelessDevicesPacketLossByClient:getWirelessDevicesPacketLossByClient', __args__, opts=opts, typ=GetWirelessDevicesPacketLossByClientResult)
