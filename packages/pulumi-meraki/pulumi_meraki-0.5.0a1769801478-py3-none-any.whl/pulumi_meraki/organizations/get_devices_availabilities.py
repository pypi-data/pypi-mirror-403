...
__all__ = [
    'GetDevicesAvailabilitiesResult',
    'AwaitableGetDevicesAvailabilitiesResult',
    'get_devices_availabilities',
    'get_devices_availabilities_output',
]

@pulumi.output_type
class GetDevicesAvailabilitiesResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetDevicesAvailabilitiesItemResult']:
        """
...
class AwaitableGetDevicesAvailabilitiesResult(GetDevicesAvailabilitiesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDevicesAvailabilitiesResult(
...
def get_devices_availabilities(ending_before: Optional[_builtins.str] = None,
                               ...
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDevicesAvailabilitiesResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getDevicesAvailabilities:getDevicesAvailabilities', __args__, opts=opts, typ=GetDevicesAvailabilitiesResult).value

    return AwaitableGetDevicesAvailabilitiesResult(
...
def get_devices_availabilities_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
