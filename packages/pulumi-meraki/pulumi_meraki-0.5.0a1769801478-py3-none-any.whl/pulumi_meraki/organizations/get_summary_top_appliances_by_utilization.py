...
__all__ = [
    'GetSummaryTopAppliancesByUtilizationResult',
    'AwaitableGetSummaryTopAppliancesByUtilizationResult',
    'get_summary_top_appliances_by_utilization',
    'get_summary_top_appliances_by_utilization_output',
]

@pulumi.output_type
class GetSummaryTopAppliancesByUtilizationResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSummaryTopAppliancesByUtilizationItemResult']:
        """
...
class AwaitableGetSummaryTopAppliancesByUtilizationResult(GetSummaryTopAppliancesByUtilizationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSummaryTopAppliancesByUtilizationResult(
            id=self.id,
            items=self.items,
...
def get_summary_top_appliances_by_utilization(organization_id: Optional[_builtins.str] = None,
                                              t0: Optional[_builtins.str] = None,
                                              t1: Optional[_builtins.str] = None,
                                              timespan: Optional[_builtins.float] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSummaryTopAppliancesByUtilizationResult:
    """
    ## Example Usage
    ...
    :param _builtins.float timespan: timespan query parameter. The timespan for which the information will be fetched. If specifying timespan, do not specify parameters t0 and t1. The value must be in seconds and be greater than or equal to 25 minutes and be less than or equal to 31 days. The default is 1 day.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getSummaryTopAppliancesByUtilization:getSummaryTopAppliancesByUtilization', __args__, opts=opts, typ=GetSummaryTopAppliancesByUtilizationResult).value

    return AwaitableGetSummaryTopAppliancesByUtilizationResult(
...
def get_summary_top_appliances_by_utilization_output(organization_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                     ...
                                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSummaryTopAppliancesByUtilizationResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:organizations/getSummaryTopAppliancesByUtilization:getSummaryTopAppliancesByUtilization', __args__, opts=opts, typ=GetSummaryTopAppliancesByUtilizationResult)
    return __ret__.apply(lambda __response__: GetSummaryTopAppliancesByUtilizationResult(
