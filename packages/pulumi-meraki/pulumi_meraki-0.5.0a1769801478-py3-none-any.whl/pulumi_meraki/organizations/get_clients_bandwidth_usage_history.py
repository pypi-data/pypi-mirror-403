...
__all__ = [
    'GetClientsBandwidthUsageHistoryResult',
    'AwaitableGetClientsBandwidthUsageHistoryResult',
    'get_clients_bandwidth_usage_history',
    'get_clients_bandwidth_usage_history_output',
]

@pulumi.output_type
class GetClientsBandwidthUsageHistoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetClientsBandwidthUsageHistoryItemResult']:
        """
...
class AwaitableGetClientsBandwidthUsageHistoryResult(GetClientsBandwidthUsageHistoryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetClientsBandwidthUsageHistoryResult(
            id=self.id,
            items=self.items,
...
def get_clients_bandwidth_usage_history(organization_id: Optional[_builtins.str] = None,
                                        t0: Optional[_builtins.str] = None,
                                        t1: Optional[_builtins.str] = None,
                                        timespan: Optional[_builtins.float] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetClientsBandwidthUsageHistoryResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getClientsBandwidthUsageHistory:getClientsBandwidthUsageHistory', __args__, opts=opts, typ=GetClientsBandwidthUsageHistoryResult).value

    return AwaitableGetClientsBandwidthUsageHistoryResult(
...
def get_clients_bandwidth_usage_history_output(organization_id: Optional[pulumi.Input[_builtins.str]] = None,
                                               ...
                                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetClientsBandwidthUsageHistoryResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:organizations/getClientsBandwidthUsageHistory:getClientsBandwidthUsageHistory', __args__, opts=opts, typ=GetClientsBandwidthUsageHistoryResult)
    return __ret__.apply(lambda __response__: GetClientsBandwidthUsageHistoryResult(
