...
__all__ = [
    'GetDevicesProvisioningStatusesResult',
    'AwaitableGetDevicesProvisioningStatusesResult',
    'get_devices_provisioning_statuses',
    'get_devices_provisioning_statuses_output',
]

@pulumi.output_type
class GetDevicesProvisioningStatusesResult:
    """
    A collection of values returned by getDevicesProvisioningStatuses.
    """
    def __init__(__self__, ending_before=None, id=None, items=None, network_ids=None, organization_id=None, per_page=None, product_types=None, serials=None, starting_after=None, status=None, tags=None, tags_filter_type=None):
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetDevicesProvisioningStatusesItemResult']:
        """
...
class AwaitableGetDevicesProvisioningStatusesResult(GetDevicesProvisioningStatusesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDevicesProvisioningStatusesResult(
...
def get_devices_provisioning_statuses(ending_before: Optional[_builtins.str] = None,
                                      ...
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDevicesProvisioningStatusesResult:
    """
    ## Example Usage
    ...
    :param Sequence[_builtins.str] network_ids: networkIds query parameter. Optional parameter to filter device by network ID. This filter uses multiple exact matches.
    ...
    :param Sequence[_builtins.str] product_types: productTypes query parameter. Optional parameter to filter device by device product types. This filter uses multiple exact matches.
    ...
    :param _builtins.str status: status query parameter. An optional parameter to filter devices by the provisioning status. Accepted statuses: unprovisioned, incomplete, complete.
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getDevicesProvisioningStatuses:getDevicesProvisioningStatuses', __args__, opts=opts, typ=GetDevicesProvisioningStatusesResult).value

    return AwaitableGetDevicesProvisioningStatusesResult(
...
def get_devices_provisioning_statuses_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                             ...
                                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDevicesProvisioningStatusesResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:organizations/getDevicesProvisioningStatuses:getDevicesProvisioningStatuses', __args__, opts=opts, typ=GetDevicesProvisioningStatusesResult)
    return __ret__.apply(lambda __response__: GetDevicesProvisioningStatusesResult(
