...
__all__ = [
    'GetSummaryTopSsidsByUsageResult',
    'AwaitableGetSummaryTopSsidsByUsageResult',
    'get_summary_top_ssids_by_usage',
    'get_summary_top_ssids_by_usage_output',
]

@pulumi.output_type
class GetSummaryTopSsidsByUsageResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSummaryTopSsidsByUsageItemResult']:
        """
...
class AwaitableGetSummaryTopSsidsByUsageResult(GetSummaryTopSsidsByUsageResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSummaryTopSsidsByUsageResult(
            id=self.id,
            items=self.items,
...
def get_summary_top_ssids_by_usage(organization_id: Optional[_builtins.str] = None,
                                   t0: Optional[_builtins.str] = None,
                                   t1: Optional[_builtins.str] = None,
                                   timespan: Optional[_builtins.float] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSummaryTopSsidsByUsageResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getSummaryTopSsidsByUsage:getSummaryTopSsidsByUsage', __args__, opts=opts, typ=GetSummaryTopSsidsByUsageResult).value

    return AwaitableGetSummaryTopSsidsByUsageResult(
...
def get_summary_top_ssids_by_usage_output(organization_id: Optional[pulumi.Input[_builtins.str]] = None,
