...
class GetSamlResult:
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetSamlItemResult':
...
def get_saml(organization_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getSaml:getSaml', __args__, opts=opts, typ=GetSamlResult).value

    return AwaitableGetSamlResult(
        id=pulumi.get(__ret__, 'id'),
        item=pulumi.get(__ret__, 'item'),
        organization_id=pulumi.get(__ret__, 'organization_id'))
def get_saml_output(organization_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:organizations/getSaml:getSaml', __args__, opts=opts, typ=GetSamlResult)
