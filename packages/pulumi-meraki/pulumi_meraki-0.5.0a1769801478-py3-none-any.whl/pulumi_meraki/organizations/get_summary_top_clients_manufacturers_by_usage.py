...
__all__ = [
    'GetSummaryTopClientsManufacturersByUsageResult',
    'AwaitableGetSummaryTopClientsManufacturersByUsageResult',
    'get_summary_top_clients_manufacturers_by_usage',
    'get_summary_top_clients_manufacturers_by_usage_output',
]

@pulumi.output_type
class GetSummaryTopClientsManufacturersByUsageResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSummaryTopClientsManufacturersByUsageItemResult']:
        """
...
class AwaitableGetSummaryTopClientsManufacturersByUsageResult(GetSummaryTopClientsManufacturersByUsageResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSummaryTopClientsManufacturersByUsageResult(
            id=self.id,
            items=self.items,
...
def get_summary_top_clients_manufacturers_by_usage(organization_id: Optional[_builtins.str] = None,
                                                   t0: Optional[_builtins.str] = None,
                                                   t1: Optional[_builtins.str] = None,
                                                   timespan: Optional[_builtins.float] = None,
                                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSummaryTopClientsManufacturersByUsageResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getSummaryTopClientsManufacturersByUsage:getSummaryTopClientsManufacturersByUsage', __args__, opts=opts, typ=GetSummaryTopClientsManufacturersByUsageResult).value

    return AwaitableGetSummaryTopClientsManufacturersByUsageResult(
...
def get_summary_top_clients_manufacturers_by_usage_output(organization_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                          ...
                                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSummaryTopClientsManufacturersByUsageResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:organizations/getSummaryTopClientsManufacturersByUsage:getSummaryTopClientsManufacturersByUsage', __args__, opts=opts, typ=GetSummaryTopClientsManufacturersByUsageResult)
    return __ret__.apply(lambda __response__: GetSummaryTopClientsManufacturersByUsageResult(
