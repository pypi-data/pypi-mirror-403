...
class GetPolicyObjectsGroupsResult:
    ...
    def policy_object_group_id(self) -> Optional[_builtins.str]:
        """
...
def get_policy_objects_groups(ending_before: Optional[_builtins.str] = None,
                              organization_id: Optional[_builtins.str] = None,
                              per_page: Optional[_builtins.int] = None,
                              policy_object_group_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.int per_page: perPage query parameter. The number of entries per page returned. Acceptable range is 10 1000. Default is 1000.
    :param _builtins.str policy_object_group_id: policyObjectGroupId path parameter. Policy object group ID
...
def get_policy_objects_groups_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                     ...
                                     policy_object_group_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                     starting_after: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPolicyObjectsGroupsResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:organizations/getPolicyObjectsGroups:getPolicyObjectsGroups', __args__, opts=opts, typ=GetPolicyObjectsGroupsResult)
    return __ret__.apply(lambda __response__: GetPolicyObjectsGroupsResult(
        ending_before=pulumi.get(__response__, 'ending_before'),
        id=pulumi.get(__response__, 'id'),
        item=pulumi.get(__response__, 'item'),
        organization_id=pulumi.get(__response__, 'organization_id'),
        per_page=pulumi.get(__response__, 'per_page'),
        policy_object_group_id=pulumi.get(__response__, 'policy_object_group_id'),
