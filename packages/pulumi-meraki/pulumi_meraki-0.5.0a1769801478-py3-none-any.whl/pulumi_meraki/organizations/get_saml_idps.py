...
__all__ = [
    'GetSamlIdpsResult',
    'AwaitableGetSamlIdpsResult',
    'get_saml_idps',
    'get_saml_idps_output',
]

@pulumi.output_type
class GetSamlIdpsResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetSamlIdpsItemResult':
        return pulumi.get(self, "item")

    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSamlIdpsItemResult']:
        """
...
class AwaitableGetSamlIdpsResult(GetSamlIdpsResult):
...
def get_saml_idps(idp_id: Optional[_builtins.str] = None,
                  organization_id: Optional[_builtins.str] = None,
                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSamlIdpsResult:
    """
    ## Example Usage


    :param _builtins.str idp_id: idpId path parameter. Idp ID
