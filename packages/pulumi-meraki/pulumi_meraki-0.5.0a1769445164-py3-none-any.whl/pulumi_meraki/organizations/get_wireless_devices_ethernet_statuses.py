...
__all__ = [
    'GetWirelessDevicesEthernetStatusesResult',
    'AwaitableGetWirelessDevicesEthernetStatusesResult',
    'get_wireless_devices_ethernet_statuses',
    'get_wireless_devices_ethernet_statuses_output',
]

@pulumi.output_type
class GetWirelessDevicesEthernetStatusesResult:
    """
    A collection of values returned by getWirelessDevicesEthernetStatuses.
    """
    def __init__(__self__, ending_before=None, id=None, items=None, network_ids=None, organization_id=None, per_page=None, starting_after=None):
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetWirelessDevicesEthernetStatusesItemResult']:
        """
...
class AwaitableGetWirelessDevicesEthernetStatusesResult(GetWirelessDevicesEthernetStatusesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWirelessDevicesEthernetStatusesResult(
...
def get_wireless_devices_ethernet_statuses(ending_before: Optional[_builtins.str] = None,
                                           ...
                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWirelessDevicesEthernetStatusesResult:
    """
    ## Example Usage
    ...
    :param Sequence[_builtins.str] network_ids: networkIds query parameter. A list of Meraki network IDs to filter results to contain only specified networks. E.g.: networkIds[]=N*12345678&networkIds[]=L*3456
    :param _builtins.str organization_id: organizationId path parameter. Organization ID
    :param _builtins.int per_page: perPage query parameter. The number of entries per page returned. Acceptable range is 3 1000. Default is 100.
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getWirelessDevicesEthernetStatuses:getWirelessDevicesEthernetStatuses', __args__, opts=opts, typ=GetWirelessDevicesEthernetStatusesResult).value

    return AwaitableGetWirelessDevicesEthernetStatusesResult(
...
def get_wireless_devices_ethernet_statuses_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                  ...
                                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWirelessDevicesEthernetStatusesResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:organizations/getWirelessDevicesEthernetStatuses:getWirelessDevicesEthernetStatuses', __args__, opts=opts, typ=GetWirelessDevicesEthernetStatusesResult)
    return __ret__.apply(lambda __response__: GetWirelessDevicesEthernetStatusesResult(
