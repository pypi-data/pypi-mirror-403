...
__all__ = [
    'GetSummaryTopSwitchesByEnergyUsageResult',
    'AwaitableGetSummaryTopSwitchesByEnergyUsageResult',
    'get_summary_top_switches_by_energy_usage',
    'get_summary_top_switches_by_energy_usage_output',
]

@pulumi.output_type
class GetSummaryTopSwitchesByEnergyUsageResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSummaryTopSwitchesByEnergyUsageItemResult']:
        """
...
class AwaitableGetSummaryTopSwitchesByEnergyUsageResult(GetSummaryTopSwitchesByEnergyUsageResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSummaryTopSwitchesByEnergyUsageResult(
            id=self.id,
            items=self.items,
...
def get_summary_top_switches_by_energy_usage(organization_id: Optional[_builtins.str] = None,
                                             t0: Optional[_builtins.str] = None,
                                             t1: Optional[_builtins.str] = None,
                                             timespan: Optional[_builtins.float] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSummaryTopSwitchesByEnergyUsageResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getSummaryTopSwitchesByEnergyUsage:getSummaryTopSwitchesByEnergyUsage', __args__, opts=opts, typ=GetSummaryTopSwitchesByEnergyUsageResult).value

    return AwaitableGetSummaryTopSwitchesByEnergyUsageResult(
...
def get_summary_top_switches_by_energy_usage_output(organization_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                    ...
                                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSummaryTopSwitchesByEnergyUsageResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:organizations/getSummaryTopSwitchesByEnergyUsage:getSummaryTopSwitchesByEnergyUsage', __args__, opts=opts, typ=GetSummaryTopSwitchesByEnergyUsageResult)
    return __ret__.apply(lambda __response__: GetSummaryTopSwitchesByEnergyUsageResult(
