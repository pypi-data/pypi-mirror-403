...
__all__ = [
    'GetSmDevicesDesktopLogsResult',
    'AwaitableGetSmDevicesDesktopLogsResult',
    'get_sm_devices_desktop_logs',
    'get_sm_devices_desktop_logs_output',
]

@pulumi.output_type
class GetSmDevicesDesktopLogsResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSmDevicesDesktopLogsItemResult']:
        """
...
class AwaitableGetSmDevicesDesktopLogsResult(GetSmDevicesDesktopLogsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSmDevicesDesktopLogsResult(
...
def get_sm_devices_desktop_logs(device_id: Optional[_builtins.str] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSmDevicesDesktopLogsResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getSmDevicesDesktopLogs:getSmDevicesDesktopLogs', __args__, opts=opts, typ=GetSmDevicesDesktopLogsResult).value

    return AwaitableGetSmDevicesDesktopLogsResult(
...
def get_sm_devices_desktop_logs_output(device_id: Optional[pulumi.Input[_builtins.str]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSmDevicesDesktopLogsResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:networks/getSmDevicesDesktopLogs:getSmDevicesDesktopLogs', __args__, opts=opts, typ=GetSmDevicesDesktopLogsResult)
    return __ret__.apply(lambda __response__: GetSmDevicesDesktopLogsResult(
