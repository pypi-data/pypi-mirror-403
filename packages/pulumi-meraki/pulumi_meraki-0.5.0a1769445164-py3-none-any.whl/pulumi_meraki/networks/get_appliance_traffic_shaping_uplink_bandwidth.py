...
def get_appliance_traffic_shaping_uplink_bandwidth(network_id: Optional[_builtins.str] = None,
...
def get_appliance_traffic_shaping_uplink_bandwidth_output(network_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetApplianceTrafficShapingUplinkBandwidthResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:networks/getApplianceTrafficShapingUplinkBandwidth:getApplianceTrafficShapingUplinkBandwidth', __args__, opts=opts, typ=GetApplianceTrafficShapingUplinkBandwidthResult)
    return __ret__.apply(lambda __response__: GetApplianceTrafficShapingUplinkBandwidthResult(
