...
__all__ = [
    ...
    'AwaitableGetWebhooksPayloadTemplatesResult',
    'get_webhooks_payload_templates',
    'get_webhooks_payload_templates_output',
]

@pulumi.output_type
class GetWebhooksPayloadTemplatesResult:
    """
    A collection of values returned by getWebhooksPayloadTemplates.
    """
    def __init__(__self__, id=None, item=None, items=None, network_id=None, payload_template_id=None):
        ...
        if payload_template_id and not isinstance(payload_template_id, str):
            raise TypeError("Expected argument 'payload_template_id' to be a str")
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetWebhooksPayloadTemplatesItemResult':
        return pulumi.get(self, "item")

    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetWebhooksPayloadTemplatesItemResult']:
        """
...
class AwaitableGetWebhooksPayloadTemplatesResult(GetWebhooksPayloadTemplatesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWebhooksPayloadTemplatesResult(
            id=self.id,
            item=self.item,
            items=self.items,
...
def get_webhooks_payload_templates(network_id: Optional[_builtins.str] = None,
                                   payload_template_id: Optional[_builtins.str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWebhooksPayloadTemplatesResult:
    """
    ## Example Usage


    :param _builtins.str network_id: networkId path parameter. Network ID
    :param _builtins.str payload_template_id: payloadTemplateId path parameter. Payload template ID
    """
    __args__ = dict()
    __args__['networkId'] = network_id
    __args__['payloadTemplateId'] = payload_template_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('meraki:networks/getWebhooksPayloadTemplates:getWebhooksPayloadTemplates', __args__, opts=opts, typ=GetWebhooksPayloadTemplatesResult).value

    return AwaitableGetWebhooksPayloadTemplatesResult(
