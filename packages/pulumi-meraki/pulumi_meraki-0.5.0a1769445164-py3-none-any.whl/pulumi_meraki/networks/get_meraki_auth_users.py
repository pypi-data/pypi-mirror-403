...
__all__ = [
    'GetMerakiAuthUsersResult',
    'AwaitableGetMerakiAuthUsersResult',
    'get_meraki_auth_users',
    'get_meraki_auth_users_output',
]

@pulumi.output_type
class GetMerakiAuthUsersResult:
    """
    ...
    def __init__(__self__, id=None, item=None, items=None, meraki_auth_user_id=None, network_id=None):
        ...
        if meraki_auth_user_id and not isinstance(meraki_auth_user_id, str):
            raise TypeError("Expected argument 'meraki_auth_user_id' to be a str")
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetMerakiAuthUsersItemResult':
        return pulumi.get(self, "item")

    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetMerakiAuthUsersItemResult']:
        """
    ...
    def meraki_auth_user_id(self) -> Optional[_builtins.str]:
        """
...
class AwaitableGetMerakiAuthUsersResult(GetMerakiAuthUsersResult):
...
def get_meraki_auth_users(meraki_auth_user_id: Optional[_builtins.str] = None,
                          network_id: Optional[_builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetMerakiAuthUsersResult:
    """
    ## Example Usage


    :param _builtins.str meraki_auth_user_id: merakiAuthUserId path parameter. Meraki auth user ID
...
def get_meraki_auth_users_output(meraki_auth_user_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
