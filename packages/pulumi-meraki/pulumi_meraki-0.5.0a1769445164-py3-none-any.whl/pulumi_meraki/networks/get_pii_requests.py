...
def get_pii_requests(network_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str request_id: requestId path parameter. Request ID
    """
    __args__ = dict()
...
def get_pii_requests_output(network_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            request_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetPiiRequestsResult]:
    """
    ## Example Usage
