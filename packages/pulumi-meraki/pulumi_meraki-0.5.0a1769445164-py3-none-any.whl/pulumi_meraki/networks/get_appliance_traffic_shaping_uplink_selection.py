...
def get_appliance_traffic_shaping_uplink_selection(network_id: Optional[_builtins.str] = None,
...
def get_appliance_traffic_shaping_uplink_selection_output(network_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetApplianceTrafficShapingUplinkSelectionResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:networks/getApplianceTrafficShapingUplinkSelection:getApplianceTrafficShapingUplinkSelection', __args__, opts=opts, typ=GetApplianceTrafficShapingUplinkSelectionResult)
    return __ret__.apply(lambda __response__: GetApplianceTrafficShapingUplinkSelectionResult(
