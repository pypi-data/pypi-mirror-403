...
__all__ = [
    'GetWirelessClientsLatencyStatsResult',
    'AwaitableGetWirelessClientsLatencyStatsResult',
    'get_wireless_clients_latency_stats',
    'get_wireless_clients_latency_stats_output',
]

@pulumi.output_type
class GetWirelessClientsLatencyStatsResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetWirelessClientsLatencyStatsItemResult':
...
class AwaitableGetWirelessClientsLatencyStatsResult(GetWirelessClientsLatencyStatsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWirelessClientsLatencyStatsResult(
            ap_tag=self.ap_tag,
            band=self.band,
...
def get_wireless_clients_latency_stats(ap_tag: Optional[_builtins.str] = None,
                                       ...
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWirelessClientsLatencyStatsResult:
    """
    ## Example Usage
    ...
    :param _builtins.str fields: fields query parameter. Partial selection: If present, this call will return only the selected fields of ["rawDistribution", "avg"]. All fields will be returned by default. Selected fields must be entered as a comma separated string.
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getWirelessClientsLatencyStats:getWirelessClientsLatencyStats', __args__, opts=opts, typ=GetWirelessClientsLatencyStatsResult).value

    return AwaitableGetWirelessClientsLatencyStatsResult(
...
def get_wireless_clients_latency_stats_output(ap_tag: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                              ...
                                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWirelessClientsLatencyStatsResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:networks/getWirelessClientsLatencyStats:getWirelessClientsLatencyStats', __args__, opts=opts, typ=GetWirelessClientsLatencyStatsResult)
    return __ret__.apply(lambda __response__: GetWirelessClientsLatencyStatsResult(
