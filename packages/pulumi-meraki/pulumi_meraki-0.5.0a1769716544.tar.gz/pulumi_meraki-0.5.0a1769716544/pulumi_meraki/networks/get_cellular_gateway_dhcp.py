...
def get_cellular_gateway_dhcp(network_id: Optional[_builtins.str] = None,
...
def get_cellular_gateway_dhcp_output(network_id: Optional[pulumi.Input[_builtins.str]] = None,
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCellularGatewayDhcpResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:networks/getCellularGatewayDhcp:getCellularGatewayDhcp', __args__, opts=opts, typ=GetCellularGatewayDhcpResult)
    return __ret__.apply(lambda __response__: GetCellularGatewayDhcpResult(
