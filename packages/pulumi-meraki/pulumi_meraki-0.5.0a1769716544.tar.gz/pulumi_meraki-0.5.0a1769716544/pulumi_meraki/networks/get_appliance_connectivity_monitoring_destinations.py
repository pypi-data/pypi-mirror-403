...
def get_appliance_connectivity_monitoring_destinations(network_id: Optional[_builtins.str] = None,
...
def get_appliance_connectivity_monitoring_destinations_output(network_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetApplianceConnectivityMonitoringDestinationsResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:networks/getApplianceConnectivityMonitoringDestinations:getApplianceConnectivityMonitoringDestinations', __args__, opts=opts, typ=GetApplianceConnectivityMonitoringDestinationsResult)
    return __ret__.apply(lambda __response__: GetApplianceConnectivityMonitoringDestinationsResult(
