...
__all__ = [
    'GetWirelessSsidsVpnResult',
    'AwaitableGetWirelessSsidsVpnResult',
    'get_wireless_ssids_vpn',
    'get_wireless_ssids_vpn_output',
]

@pulumi.output_type
class GetWirelessSsidsVpnResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetWirelessSsidsVpnItemResult':
...
class AwaitableGetWirelessSsidsVpnResult(GetWirelessSsidsVpnResult):
...
def get_wireless_ssids_vpn(network_id: Optional[_builtins.str] = None,
                           number: Optional[_builtins.str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWirelessSsidsVpnResult:
    """
    ## Example Usage
...
def get_wireless_ssids_vpn_output(network_id: Optional[pulumi.Input[_builtins.str]] = None,
