...
def get_wireless_status(serial: Optional[_builtins.str] = None,
...
def get_wireless_status_output(serial: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:devices/getWirelessStatus:getWirelessStatus', __args__, opts=opts, typ=GetWirelessStatusResult)
    return __ret__.apply(lambda __response__: GetWirelessStatusResult(
