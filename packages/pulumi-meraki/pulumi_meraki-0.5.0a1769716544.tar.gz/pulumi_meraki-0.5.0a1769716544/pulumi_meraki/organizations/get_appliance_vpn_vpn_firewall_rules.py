...
__all__ = [
    'GetApplianceVpnVpnFirewallRulesResult',
    'AwaitableGetApplianceVpnVpnFirewallRulesResult',
    'get_appliance_vpn_vpn_firewall_rules',
    'get_appliance_vpn_vpn_firewall_rules_output',
]

@pulumi.output_type
class GetApplianceVpnVpnFirewallRulesResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetApplianceVpnVpnFirewallRulesItemResult':
...
class AwaitableGetApplianceVpnVpnFirewallRulesResult(GetApplianceVpnVpnFirewallRulesResult):
...
def get_appliance_vpn_vpn_firewall_rules(organization_id: Optional[_builtins.str] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetApplianceVpnVpnFirewallRulesResult:
    """
    ## Example Usage
