...
__all__ = [
    'GetBrandingPoliciesResult',
    'AwaitableGetBrandingPoliciesResult',
    'get_branding_policies',
    'get_branding_policies_output',
]

@pulumi.output_type
class GetBrandingPoliciesResult:
    """
    ...
    def branding_policy_id(self) -> Optional[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetBrandingPoliciesItemResult':
        return pulumi.get(self, "item")

    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetBrandingPoliciesItemResult']:
        """
...
class AwaitableGetBrandingPoliciesResult(GetBrandingPoliciesResult):
...
def get_branding_policies(branding_policy_id: Optional[_builtins.str] = None,
                          organization_id: Optional[_builtins.str] = None,
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetBrandingPoliciesResult:
    """
    ## Example Usage


    :param _builtins.str branding_policy_id: brandingPolicyId path parameter. Branding policy ID
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getBrandingPolicies:getBrandingPolicies', __args__, opts=opts, typ=GetBrandingPoliciesResult).value
...
def get_branding_policies_output(branding_policy_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
