...
__all__ = [
    'GetDevicesPowerModulesStatusesByDeviceResult',
    'AwaitableGetDevicesPowerModulesStatusesByDeviceResult',
    'get_devices_power_modules_statuses_by_device',
    'get_devices_power_modules_statuses_by_device_output',
]

@pulumi.output_type
class GetDevicesPowerModulesStatusesByDeviceResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetDevicesPowerModulesStatusesByDeviceItemResult']:
        """
...
class AwaitableGetDevicesPowerModulesStatusesByDeviceResult(GetDevicesPowerModulesStatusesByDeviceResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDevicesPowerModulesStatusesByDeviceResult(
...
def get_devices_power_modules_statuses_by_device(ending_before: Optional[_builtins.str] = None,
                                                 ...
                                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDevicesPowerModulesStatusesByDeviceResult:
    """
    ## Example Usage
    ...
    :param Sequence[_builtins.str] network_ids: networkIds query parameter. Optional parameter to filter device availabilities by network ID. This filter uses multiple exact matches.
    ...
    :param Sequence[_builtins.str] product_types: productTypes query parameter. Optional parameter to filter device availabilities by device product types. This filter uses multiple exact matches.
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getDevicesPowerModulesStatusesByDevice:getDevicesPowerModulesStatusesByDevice', __args__, opts=opts, typ=GetDevicesPowerModulesStatusesByDeviceResult).value

    return AwaitableGetDevicesPowerModulesStatusesByDeviceResult(
...
def get_devices_power_modules_statuses_by_device_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                        ...
                                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDevicesPowerModulesStatusesByDeviceResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:organizations/getDevicesPowerModulesStatusesByDevice:getDevicesPowerModulesStatusesByDevice', __args__, opts=opts, typ=GetDevicesPowerModulesStatusesByDeviceResult)
    return __ret__.apply(lambda __response__: GetDevicesPowerModulesStatusesByDeviceResult(
