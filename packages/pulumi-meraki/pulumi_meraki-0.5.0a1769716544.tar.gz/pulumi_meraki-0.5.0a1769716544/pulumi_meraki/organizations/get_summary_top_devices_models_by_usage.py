...
__all__ = [
    ...
    'AwaitableGetSummaryTopDevicesModelsByUsageResult',
    'get_summary_top_devices_models_by_usage',
    'get_summary_top_devices_models_by_usage_output',
]

@pulumi.output_type
class GetSummaryTopDevicesModelsByUsageResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSummaryTopDevicesModelsByUsageItemResult']:
        """
...
class AwaitableGetSummaryTopDevicesModelsByUsageResult(GetSummaryTopDevicesModelsByUsageResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetSummaryTopDevicesModelsByUsageResult(
            id=self.id,
            items=self.items,
...
def get_summary_top_devices_models_by_usage(organization_id: Optional[_builtins.str] = None,
                                            t0: Optional[_builtins.str] = None,
                                            t1: Optional[_builtins.str] = None,
                                            timespan: Optional[_builtins.float] = None,
                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSummaryTopDevicesModelsByUsageResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getSummaryTopDevicesModelsByUsage:getSummaryTopDevicesModelsByUsage', __args__, opts=opts, typ=GetSummaryTopDevicesModelsByUsageResult).value

    return AwaitableGetSummaryTopDevicesModelsByUsageResult(
...
def get_summary_top_devices_models_by_usage_output(organization_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                   ...
                                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSummaryTopDevicesModelsByUsageResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:organizations/getSummaryTopDevicesModelsByUsage:getSummaryTopDevicesModelsByUsage', __args__, opts=opts, typ=GetSummaryTopDevicesModelsByUsageResult)
    return __ret__.apply(lambda __response__: GetSummaryTopDevicesModelsByUsageResult(
