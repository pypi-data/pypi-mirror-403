...
def get_cellular_gateway_uplink_statuses(ending_before: Optional[_builtins.str] = None,
...
def get_cellular_gateway_uplink_statuses_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
