...
__all__ = [
    ...
    'AwaitableGetSensorReadingsHistoryResult',
    'get_sensor_readings_history',
    'get_sensor_readings_history_output',
]

@pulumi.output_type
class GetSensorReadingsHistoryResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetSensorReadingsHistoryItemResult']:
        """
...
class AwaitableGetSensorReadingsHistoryResult(GetSensorReadingsHistoryResult):
...
def get_sensor_readings_history(ending_before: Optional[_builtins.str] = None,
                                ...
                                opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSensorReadingsHistoryResult:
    """
    ## Example Usage
    ...
    :param Sequence[_builtins.str] metrics: metrics query parameter. Types of sensor readings to retrieve. If no metrics are supplied, all available types of readings will be retrieved. Allowed values are apparentPower, battery, button, co2, current, door, downstreamPower, frequency, humidity, indoorAirQuality, noise, pm25, powerFactor, realPower, remoteLockoutSwitch, temperature, tvoc, voltage, and water.
    :param Sequence[_builtins.str] network_ids: networkIds query parameter. Optional parameter to filter readings by network.
    ...
    :param Sequence[_builtins.str] serials: serials query parameter. Optional parameter to filter readings by sensor.
    :param _builtins.str starting_after: startingAfter query parameter. A token used by the server to indicate the start of the page. Often this is a timestamp or an ID but it is not limited to those. This parameter should not be defined by client applications. The link for the first, last, prev, or next page in the HTTP Link header should define it.
    :param _builtins.str t0: t0 query parameter. The beginning of the timespan for the data. The maximum lookback period is 365 days and 6 hours from today.
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getSensorReadingsHistory:getSensorReadingsHistory', __args__, opts=opts, typ=GetSensorReadingsHistoryResult).value
...
def get_sensor_readings_history_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                       metrics: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSensorReadingsHistoryResult]:
    """
    ## Example Usage
