...
__all__ = [
    'GetConfigTemplatesResult',
    'AwaitableGetConfigTemplatesResult',
    'get_config_templates',
    'get_config_templates_output',
]

@pulumi.output_type
class GetConfigTemplatesResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetConfigTemplatesItemResult':
        return pulumi.get(self, "item")

    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetConfigTemplatesItemResult']:
        """
...
class AwaitableGetConfigTemplatesResult(GetConfigTemplatesResult):
...
def get_config_templates(config_template_id: Optional[_builtins.str] = None,
                         organization_id: Optional[_builtins.str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetConfigTemplatesResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:organizations/getConfigTemplates:getConfigTemplates', __args__, opts=opts, typ=GetConfigTemplatesResult).value
