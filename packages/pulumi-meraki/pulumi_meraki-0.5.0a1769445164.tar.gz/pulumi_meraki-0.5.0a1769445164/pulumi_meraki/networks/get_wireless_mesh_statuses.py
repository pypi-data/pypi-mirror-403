...
__all__ = [
    ...
    'AwaitableGetWirelessMeshStatusesResult',
    'get_wireless_mesh_statuses',
    'get_wireless_mesh_statuses_output',
]

@pulumi.output_type
class GetWirelessMeshStatusesResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def items(self) -> Sequence['outputs.GetWirelessMeshStatusesItemResult']:
        """
...
class AwaitableGetWirelessMeshStatusesResult(GetWirelessMeshStatusesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWirelessMeshStatusesResult(
...
def get_wireless_mesh_statuses(ending_before: Optional[_builtins.str] = None,
                               network_id: Optional[_builtins.str] = None,
                               per_page: Optional[_builtins.int] = None,
                               starting_after: Optional[_builtins.str] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetWirelessMeshStatusesResult:
    """
    ## Example Usage
    ...
    :param _builtins.int per_page: perPage query parameter. The number of entries per page returned. Acceptable range is 3 500. Default is 50.
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getWirelessMeshStatuses:getWirelessMeshStatuses', __args__, opts=opts, typ=GetWirelessMeshStatusesResult).value

    return AwaitableGetWirelessMeshStatusesResult(
...
def get_wireless_mesh_statuses_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                      ...
                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetWirelessMeshStatusesResult]:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:networks/getWirelessMeshStatuses:getWirelessMeshStatuses', __args__, opts=opts, typ=GetWirelessMeshStatusesResult)
    return __ret__.apply(lambda __response__: GetWirelessMeshStatusesResult(
