...
def get_wireless_channel_utilization_history(ap_tag: Optional[_builtins.str] = None,
    ...
    :param _builtins.str ap_tag: apTag query parameter. Filter results by AP tag to return AP channel utilization metrics for devices labeled with the given tag; either :clientId or :deviceSerial must be jointly specified.
    ...
    :param _builtins.str client_id: clientId query parameter. Filter results by network client to return per-device, per-band AP channel utilization metrics inner joined by the queried client's connection history.
    :param _builtins.str device_serial: deviceSerial query parameter. Filter results by device to return AP channel utilization metrics for the queried device; either :band or :clientId must be jointly specified.
    :param _builtins.str network_id: networkId path parameter. Network ID
    :param _builtins.int resolution: resolution query parameter. The time resolution in seconds for returned data. The valid resolutions are: 600, 1200, 3600, 14400, 86400. The default is 86400.
...
def get_wireless_channel_utilization_history_output(ap_tag: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:networks/getWirelessChannelUtilizationHistory:getWirelessChannelUtilizationHistory', __args__, opts=opts, typ=GetWirelessChannelUtilizationHistoryResult)
    return __ret__.apply(lambda __response__: GetWirelessChannelUtilizationHistoryResult(
