...
class GetSmProfilesResult:
    ...
    def payload_types(self) -> Optional[Sequence[_builtins.str]]:
        """
...
def get_sm_profiles(network_id: Optional[_builtins.str] = None,
                    payload_types: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] payload_types: payloadTypes query parameter. Filter by payload types
    """
    __args__ = dict()
