...
class GetWebhooksHttpServersResult:
    ...
    def http_server_id(self) -> Optional[_builtins.str]:
        """
...
def get_webhooks_http_servers(http_server_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str http_server_id: httpServerId path parameter. Http server ID
