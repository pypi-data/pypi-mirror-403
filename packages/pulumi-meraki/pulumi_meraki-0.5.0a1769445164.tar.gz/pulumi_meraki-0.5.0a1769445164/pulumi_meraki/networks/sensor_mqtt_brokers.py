...
class SensorMqttBrokersArgs:
    def __init__(__self__, *,
                 mqtt_broker_id: pulumi.Input[_builtins.str],
    ...
    def mqtt_broker_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def mqtt_broker_id(self, value: pulumi.Input[_builtins.str]):
...
class SensorMqttBrokers(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            enabled: Optional[pulumi.Input[_builtins.bool]] = None,
            mqtt_broker_id: Optional[pulumi.Input[_builtins.str]] = None,
            network_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'SensorMqttBrokers':
        """
