...
@pulumi.type_token("meraki:networks/smDevicesReboot:SmDevicesReboot")
class SmDevicesReboot(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        example = meraki.networks.SmDevicesReboot("example",
            network_id="string",
            parameters={
                "ids": [
                    "1284392014819",
        ...
        pulumi.export("merakiNetworksSmDevicesRebootExample", example)
        ```
