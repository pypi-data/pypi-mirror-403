...
__all__ = [
    'GetPiiSmOwnersForKeyResult',
    'AwaitableGetPiiSmOwnersForKeyResult',
    'get_pii_sm_owners_for_key',
    'get_pii_sm_owners_for_key_output',
]

@pulumi.output_type
class GetPiiSmOwnersForKeyResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetPiiSmOwnersForKeyItemResult':
...
class AwaitableGetPiiSmOwnersForKeyResult(GetPiiSmOwnersForKeyResult):
...
def get_pii_sm_owners_for_key(bluetooth_mac: Optional[_builtins.str] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetPiiSmOwnersForKeyResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:networks/getPiiSmOwnersForKey:getPiiSmOwnersForKey', __args__, opts=opts, typ=GetPiiSmOwnersForKeyResult).value
...
def get_pii_sm_owners_for_key_output(bluetooth_mac: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
