...
__all__ = [
    'GetLiveToolsPingResult',
    'AwaitableGetLiveToolsPingResult',
    'get_live_tools_ping',
    'get_live_tools_ping_output',
]

@pulumi.output_type
class GetLiveToolsPingResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def item(self) -> 'outputs.GetLiveToolsPingItemResult':
...
class AwaitableGetLiveToolsPingResult(GetLiveToolsPingResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetLiveToolsPingResult(
            id=self.id,
            item=self.item,
            serial=self.serial)


def get_live_tools_ping(id: Optional[_builtins.str] = None,
                        serial: Optional[_builtins.str] = None,
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetLiveToolsPingResult:
    """
    ## Example Usage
    ...
    __ret__ = pulumi.runtime.invoke('meraki:devices/getLiveToolsPing:getLiveToolsPing', __args__, opts=opts, typ=GetLiveToolsPingResult).value

    return AwaitableGetLiveToolsPingResult(
        id=pulumi.get(__ret__, 'id'),
        item=pulumi.get(__ret__, 'item'),
        serial=pulumi.get(__ret__, 'serial'))
def get_live_tools_ping_output(id: Optional[pulumi.Input[_builtins.str]] = None,
