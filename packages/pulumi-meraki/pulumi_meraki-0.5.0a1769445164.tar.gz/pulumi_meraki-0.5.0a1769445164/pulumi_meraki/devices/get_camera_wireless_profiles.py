...
def get_camera_wireless_profiles(serial: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('meraki:devices/getCameraWirelessProfiles:getCameraWirelessProfiles', __args__, opts=opts, typ=GetCameraWirelessProfilesResult).value

    return AwaitableGetCameraWirelessProfilesResult(
        id=pulumi.get(__ret__, 'id'),
        item=pulumi.get(__ret__, 'item'),
        serial=pulumi.get(__ret__, 'serial'))
def get_camera_wireless_profiles_output(serial: Optional[pulumi.Input[_builtins.str]] = None,
