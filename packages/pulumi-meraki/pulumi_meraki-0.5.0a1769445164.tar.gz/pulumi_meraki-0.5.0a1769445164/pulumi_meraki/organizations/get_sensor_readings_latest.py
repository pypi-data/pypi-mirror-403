...
def get_sensor_readings_latest(ending_before: Optional[_builtins.str] = None,
...
def get_sensor_readings_latest_output(ending_before: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
