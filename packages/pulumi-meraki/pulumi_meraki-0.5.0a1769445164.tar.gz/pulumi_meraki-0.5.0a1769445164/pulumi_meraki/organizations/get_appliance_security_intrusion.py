...
def get_appliance_security_intrusion(organization_id: Optional[_builtins.str] = None,
...
def get_appliance_security_intrusion_output(organization_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('meraki:organizations/getApplianceSecurityIntrusion:getApplianceSecurityIntrusion', __args__, opts=opts, typ=GetApplianceSecurityIntrusionResult)
