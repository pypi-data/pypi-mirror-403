    ...
    def validate_pgn(pgn_path: str) -> bool:
        ...
        try:
            ...
            with open(path, 'r', encoding='utf-8') as pgn_file:
                ...
                # Valid PGN should have either headers in brackets or move notation
                has_headers = '[' in content and ']' in content
                has_move_numbers = any(char.isdigit() and '.' in content for char in content)
                
                # If it doesn't look like PGN at all, reject it
                if not has_headers and not has_move_numbers:
                    return False
                ...
                # A valid PGN should have at least headers or moves
                has_valid_headers = len(game.headers) > 0
                ...
                return has_valid_headers or has_moves
