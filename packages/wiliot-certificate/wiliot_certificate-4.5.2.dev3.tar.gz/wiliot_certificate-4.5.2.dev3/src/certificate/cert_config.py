...
def create_gw_downlink_pkt(test, raw_tx_data="", is_ota=False, version="", max_duration=100, max_retries=8, target=DUT):
    ...
    if is_ota == False:
        ...
        if test.wpr:
            prefix = "https://api.us-central1.wmt-prod.gcp.wiliot.cloud"
        else:
            prefix = "https://api.us-east-2.prod.wiliot.cloud"
        ret[IMG_DIR_URL] = f"{prefix}/v1/bridge/type/{brg.board_type}/version/{version}/binary/"
