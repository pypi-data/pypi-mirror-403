...
class CertificateCLI:
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--single_polarization_antenna', '-spa', default=False, action='store_true',
                                 help="Declare DUT has a single polarization antenna, needed for signal indicator tests")
        ...
        self.parser.add_argument('--wpr', default=False, action='store_true', help='Send a heartbeat packet from each simulated bridge before sending simulated bridge packets and use gcp endpoint' + argparse.SUPPRESS)
