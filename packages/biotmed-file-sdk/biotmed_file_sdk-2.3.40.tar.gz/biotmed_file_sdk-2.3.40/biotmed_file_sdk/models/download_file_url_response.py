...
class DownloadFileUrlResponse(BaseModel):
    """
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["name", "mimeType", "id", "signedUrl"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DownloadFileUrlResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DownloadFileUrlResponse from a dict"""
        if obj is None:
            return None
