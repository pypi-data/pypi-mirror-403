...
class MultiplePartUploadFileUrlRequest(BaseModel):
    """
    ...
    parts: Annotated[int, Field(le=10000, strict=True, ge=1)] = Field(description="For how many parts to initially generate links, not all must be used and more can be generated later")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["name", "mimeType", "parts"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MultiplePartUploadFileUrlRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MultiplePartUploadFileUrlRequest from a dict"""
        if obj is None:
            return None
