...
class MultiplePartUploadFileGenerateSignedUrlsRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    from_part: Annotated[int, Field(le=10000, strict=True, ge=1)] = Field(description="The part number to generate from, inclusive", alias="fromPart")
    to_part: Annotated[int, Field(le=10000, strict=True, ge=1)] = Field(description="The part number to generate to, inclusive", alias="toPart")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["fromPart", "toPart"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MultiplePartUploadFileGenerateSignedUrlsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MultiplePartUploadFileGenerateSignedUrlsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "fromPart": obj.get("fromPart"),
            "toPart": obj.get("toPart")
        })
