...
class MultiplePartUploadFileSaveETagRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    parts: List[MultiplePartFileUploadPart]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MultiplePartUploadFileSaveETagRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MultiplePartUploadFileSaveETagRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "parts": [MultiplePartFileUploadPart.from_dict(_item) for _item in obj["parts"]] if obj.get("parts") is not None else None
        })
