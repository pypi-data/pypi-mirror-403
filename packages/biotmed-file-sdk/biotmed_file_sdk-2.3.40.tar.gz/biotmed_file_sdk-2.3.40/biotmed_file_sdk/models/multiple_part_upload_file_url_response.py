...
class MultiplePartUploadFileUrlResponse(BaseModel):
    """
    ...
    mime_type: Annotated[str, Field(min_length=0, strict=True, max_length=100)] = Field(alias="mimeType")
    id: UUID = Field(description="A UUID formatted string")
    parts: StrictInt = Field(description="The total number of parts currently requested for this multiple part file upload. More can be requested")
    signed_urls: List[MultiplePartSignedUrl] = Field(alias="signedUrls")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["name", "mimeType", "id", "parts", "signedUrls"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MultiplePartUploadFileUrlResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MultiplePartUploadFileUrlResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "parts": obj.get("parts"),
            "signedUrls": [MultiplePartSignedUrl.from_dict(_item) for _item in obj["signedUrls"]] if obj.get("signedUrls") is not None else None
        })
