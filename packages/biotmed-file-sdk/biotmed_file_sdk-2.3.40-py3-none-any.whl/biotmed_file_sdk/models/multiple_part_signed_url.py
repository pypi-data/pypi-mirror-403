...
class MultiplePartSignedUrl(BaseModel):
    """
    ...
    """ # noqa: E501
    signed_url: StrictStr = Field(description="The URL for which to send a PUT request with the file data as a binary stream, for the file part specified in partNumber", alias="signedUrl")
    part_number: StrictInt = Field(description="The part number for this URL", alias="partNumber")
    expiration_time: datetime = Field(description="The expiration time for this URL, after which it is unusable. It is possible to request a new URL. A UTC date-time in the ISO-8601 format", alias="expirationTime")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["signedUrl", "partNumber", "expirationTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MultiplePartSignedUrl from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MultiplePartSignedUrl from a dict"""
        if obj is None:
            return None
