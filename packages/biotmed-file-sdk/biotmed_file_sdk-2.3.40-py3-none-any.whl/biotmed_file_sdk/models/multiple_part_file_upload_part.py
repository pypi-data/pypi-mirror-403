...
class MultiplePartFileUploadPart(BaseModel):
    """
    ...
    """ # noqa: E501
    part_number: StrictInt = Field(description="The part number for which to save the eTag", alias="partNumber")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MultiplePartFileUploadPart from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MultiplePartFileUploadPart from a dict"""
        if obj is None:
            return None
