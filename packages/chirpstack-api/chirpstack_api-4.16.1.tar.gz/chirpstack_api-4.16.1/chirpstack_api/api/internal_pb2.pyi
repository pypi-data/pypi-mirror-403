...
class RegionChannel(_message.Message):
    __slots__ = ("frequency", "data_rates")
    FREQUENCY_FIELD_NUMBER: _ClassVar[int]
    DATA_RATES_FIELD_NUMBER: _ClassVar[int]
    frequency: int
    data_rates: _containers.RepeatedScalarFieldContainer[int]
    def __init__(self, frequency: _Optional[int] = ..., data_rates: _Optional[_Iterable[int]] = ...) -> None: ...
