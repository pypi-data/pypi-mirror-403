import click
from releases1c.request1c import Request1C, AuthenticationErrpr, DDOSProtectionError
...
def prepare_executors(parameters,flush_cookie,error_code=0):
    ...
    if lpr == 0:
        ...
        try:
            ...
            print("Available filetypes for this version are:", err.matches)
...
def info(parameters,flush_cookie,error_code) -> None:
    ...
    except DDOSProtectionError as err:
        print('Version:',__version__)
        print("Error:",err.message)
...
def download_cmd(ctx,parameters,filepath,flush_cookie):
    ...
    try:
        ...
        print('Version:',__version__)
        print("Error:",err.message)
        quit(error_codes.ddos_protection)
