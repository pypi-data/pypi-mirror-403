...
# from lino_xl.lib.trading.mixins import TradingVoucher, ProductDocItem
from lino_xl.lib.excerpts.mixins import Certifiable
...
#
# class Order(TradingVoucher, UserAuthored, UploadController, RecurrenceSet, EventGenerator, Clonable):
# class Order(TradingVoucher, Voucher, RecurrenceSet, EventGenerator, Clonable):
# class Order(Registrable, Certifiable, Voucher, RecurrenceSet, EventGenerator, Clonable, ProjectRelated):
class Order(Certifiable, LedgerRegistrable, Voucher, RecurrenceSet,
            EventGenerator, Clonable, ProjectRelated, ContactRelated,
            InvoiceGenerator):
