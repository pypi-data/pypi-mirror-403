...
class CountryCity(dd.Model):
    ...
    def create_city_choice(self, text, ar=None):
        ...
        return rt.models.countries.Place.lookup_or_create('name',
                                                          text,
    ...
    @dd.virtualfield(
        dd.ForeignKey("countries.Place", verbose_name=_("Municipality")))
...
class AddressLocation(CountryRegionCity, Addressable):
    ...
    addr1 = models.CharField(_("Address line before street"),
                             max_length=200,
                             blank=True)
    street_prefix = models.CharField(_("Street prefix"),
                                     max_length=200,
                                     blank=True)
    ...
    def address_location_lines(self):
        ...
        if self.country is not None:
            if self.country.isocode != dd.plugins.countries.country_code:
