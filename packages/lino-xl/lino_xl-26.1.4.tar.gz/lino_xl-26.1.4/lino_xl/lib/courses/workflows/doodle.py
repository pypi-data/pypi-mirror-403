...
class ResetEvent(dd.ChangeStateAction):
    ...
    def get_action_permission(self, ar, obj, state):
        if obj.auto_type is None:
            return False
        return super(ResetEvent, self).get_action_permission(ar, obj, state)
    ...
    def run_from_ui(self, ar, **kw):
        ...
        ar.confirm(
            ...
            _("Any manual changes to your event "
              "will get lost upon next update "), _("Are you sure?"))
...
EntryStates.suggested.add_transition(ResetEvent, name='reset_event')
# "\u2610",  # BALLOT BOX
# required_states='suggested took_place cancelled')
