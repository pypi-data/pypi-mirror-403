...
from lino_xl.lib.accounting.mixins import Matching, AccountVoucherItem
from lino_xl.lib.accounting.models import Voucher
from lino_xl.lib.accounting.choicelists import VoucherTypes
from lino_xl.lib.accounting.ui import AccountBalances
...
# from lino_xl.lib.accounting.utils import DC.debit
...
class InvoicesByJournal(ByJournal, Invoices):
    ...
    :attr:`voucher_type<lino_xl.lib.accounting.models.Journal.voucher_type>`
...
dd.inject_field('accounting.Movement', 'ana_account',
                dd.ForeignKey('ana.Account', blank=True, null=True))

dd.inject_field('accounting.Account', 'ana_account',
                dd.ForeignKey('ana.Account', blank=True, null=True))

dd.inject_field(
    'accounting.Account', 'needs_ana',
