...
class TimLoader(TimLoader):
    ...
    def objects(self):
        ...
        self.PROD_617010 = Product(name="Edasimüük remondikulud", id=40)
    ...
    def after_gen_load(self):
        ...
        self.PROD_617010.sales_account = Account.objects.get(ref='617010')
    ...
    def load_mbr(self, row, **kw):
        ...
        if p1 is None:
            dd.logger.debug("Failed to load MBR %s : "
                            "No idpar", row)
            return
