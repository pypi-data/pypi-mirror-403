...
class EnrolmentState(RegistrableState):
    # avoid "Invalid choicelist courses.EnrolmentStates for
    # lino_medico.lib.courses.models.Enrolment state"
    pass


class EnrolmentStates(dd.Workflow):
    item_class = EnrolmentState
