...
class Adder(object):
    ...
    def add_account(self, bic, iban, remark=''):
        iban = iban.replace(' ', '')
        acc = Account(self.current_partner,
                      bic,
                      iban,
                      remark,
...
def objects():
    ...
    yield C('AS Express Post',
            'http://www.expresspost.ee/',
            country="EE",
            vat_id="EE100041561",
    ...
    yield C('AS Matsalu Veevärk',
            'http://www.matsaluvv.ee',
            country="EE",
            vat_id="EE100920666")
    yield A('HABAEE2X', 'EE732200221045112758')

    yield C('Eesti Energia AS',
            "http://www.energia.ee",
            country="EE",
            vat_id="EE100366327")
    ...
    yield C('IIZI kindlustusmaakler AS',
            "http://www.iizi.ee",
            country="EE",
            vat_id="EE100598027")
    yield A('HABAEE2X', 'EE382200221013987931')

    yield C('Maksu- ja Tolliamet',
            "http://www.emta.ee",
            street="Lõõtsa 8a",
            country="EE",
            zip_code="15176",
    ...
    yield C("Niederau Eupen AG",
            "https://www.niederau.be",
            vat_id="BE 0419.897.855",
            email="info@niederau.be",
            phone="+32 (0)87 59 57 57",
