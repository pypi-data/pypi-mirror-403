...
from ..enums import ApiKeyKeyType, ServiceStatus
...
class ServiceDetail(BaseModel):
    ...
    is_enabled: bool | None = Field(None, description='Whether service is enabled')
    auto_restart: bool | None = Field(None, description='Auto-restart on crash')
    ...
    ssh_enabled: bool | None = Field(None, description='SSH control enabled')
