# fitz_pgserver/_commands.py
"""
Command wrappers for PostgreSQL binaries.

Modified from pgserver to support configurable binary path.
"""
...
# Use pgserver's bundled PostgreSQL binaries
# We depend on pgserver just for its binaries, our Python code replaces its logic
import pgserver as _upstream_pgserver
POSTGRES_BIN_PATH = Path(_upstream_pgserver.__file__).parent / "pginstall" / "bin"
