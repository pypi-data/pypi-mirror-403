...
## Migration Documentation Indexed by `search_migration`

| Source Document | Best For |
|----------------|----------|
| CSMR 2013: COBOL-to-Java Migration (Sneed) | Academic research on automated migration approaches |
| Language Migration FAQ | Common questions and strategies for language migration |
| COBOL-to-Java Conversion Guide | Step-by-step conversion techniques and patterns |
| Ispirer Java Framework Guide for COBOL Conversion | Tool-assisted conversion using Ispirer framework |

## Tool Selection Guide

| Tool | Use When |
|------|----------|
| `search` | Looking up COBOL syntax, semantics, dialect differences, or language reference |
| `search_migration` | Researching migration strategy, methodology, tooling, or conversion approaches |
| `translate_reference` | Need curated construct-by-construct COBOL-to-Java mappings |
| `check` | Analyzing a COBOL source file for common issues and defects |
