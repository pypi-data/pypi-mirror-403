...
class UpdateRDBMSDataSourceRequest(UpdateDataSourceRequest):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> UpdateRDBMSDataSourceRequest:
        """Create an instance of UpdateRDBMSDataSourceRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> UpdateRDBMSDataSourceRequest:
        """Create an instance of UpdateRDBMSDataSourceRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return UpdateRDBMSDataSourceRequest.parse_obj(obj)

        _obj = UpdateRDBMSDataSourceRequest.parse_obj(
            {
                "type": obj.get("type"),
                "id": obj.get("id"),
