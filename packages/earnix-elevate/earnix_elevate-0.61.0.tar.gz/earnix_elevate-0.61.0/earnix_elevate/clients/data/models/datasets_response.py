...
class DatasetsResponse(BaseModel):
    ...
    items: conlist(DatasetResponse) = Field(
        default=..., description="list of Datasets in current result set"
    )
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatasetsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatasetsResponse:
        """Create an instance of DatasetsResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatasetsResponse.parse_obj(obj)

        _obj = DatasetsResponse.parse_obj(
            {
                "offset": obj.get("offset"),
                "limit": obj.get("limit"),
                "total": obj.get("total"),
                "items": [
                    DatasetResponse.from_dict(_item) for _item in obj.get("items")
                ]
