...
class CreateDataTableRequest(BaseModel):
    ...
    __properties = ["name", "description", "tags", "dataSourceId", "dataVersionExist"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateDataTableRequest:
        """Create an instance of CreateDataTableRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateDataTableRequest:
        """Create an instance of CreateDataTableRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateDataTableRequest.parse_obj(obj)

        _obj = CreateDataTableRequest.parse_obj(
            {
                "name": obj.get("name"),
