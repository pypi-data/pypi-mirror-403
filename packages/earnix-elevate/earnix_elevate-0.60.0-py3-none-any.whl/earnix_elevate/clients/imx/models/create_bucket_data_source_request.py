...
class CreateBucketDataSourceRequest(CreateDataSourceRequest):
    """
    ...
    __properties = ["type", "name", "description", "tags", "connectionId", "path"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateBucketDataSourceRequest:
        """Create an instance of CreateBucketDataSourceRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateBucketDataSourceRequest:
        """Create an instance of CreateBucketDataSourceRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateBucketDataSourceRequest.parse_obj(obj)

        _obj = CreateBucketDataSourceRequest.parse_obj(
            {
                "type": obj.get("type"),
                "name": obj.get("name"),
