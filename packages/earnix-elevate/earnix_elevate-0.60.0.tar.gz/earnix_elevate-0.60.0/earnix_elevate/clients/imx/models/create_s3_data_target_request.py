...
class CreateS3DataTargetRequest(CreateDataTargetRequest):
    """
    `CreateS3DataTargetRequest`

    Request to create an Data Target for exporting data to S3.
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CreateS3DataTargetRequest:
        """Create an instance of CreateS3DataTargetRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CreateS3DataTargetRequest:
        """Create an instance of CreateS3DataTargetRequest from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CreateS3DataTargetRequest.parse_obj(obj)

        _obj = CreateS3DataTargetRequest.parse_obj(
            {
                "name": obj.get("name"),
