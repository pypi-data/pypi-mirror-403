...
import earnix_elevate.clients.data.models
from earnix_elevate.clients.data import rest
...
from earnix_elevate.clients.data.exceptions import ApiException, ApiValueError
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(earnix_elevate.clients.data.models, klass)
