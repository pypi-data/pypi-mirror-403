"""
Interactive CLI for GeoPipeline
...
class InteractiveCLI:
    """
    Interactive command-line interface for GeoPipeline
    ...
    def _display_welcome(self) -> None:
        ...
        console.print(Panel(
            Text.from_markup(
                "[bold cyan]GeoPipeline Interactive CLI[/bold cyan]\n\n"
                "[white]Automated GitLab CI/CD pipeline generation from declarative configuration[/white]\n"
                "[dim]Version: " + self.current_version + "[/dim]"
            ),
            border_style="cyan",
            padding=(1, 2)
        ))
    ...
    def _show_main_menu(self) -> str:
        ...
        """
        choices = [
            questionary.Choice("📝 Create new configuration", value="create"),
            questionary.Choice("✏️  Edit existing configuration", value="edit"),
            questionary.Choice("✓  Validate configuration", value="validate"),
            questionary.Choice("⚙️  Generate .gitlab-ci.yml", value="generate"),
            questionary.Choice("🚀 Deploy to environment", value="deploy"),
            questionary.Choice("👁️  View current configuration", value="view"),
