...
session = Session(alpn=ALPN.HTTP20, rand_tls=False)
...
session.set_timeout()
for bs in session.open_stream('https://m.so.com/', Method.GET):
    print(len(bs))
...
# reqrio.get('https://www.baidu.com', headers, params={'s':'233'})
