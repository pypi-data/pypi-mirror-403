...
import nirfmxbluetooth.internal._library as _library

_instance = None
_instance_lock = threading.Lock()
_library_info = {"Windows": {"64bit": {"name": "niRFmxBT.dll", "type": "cdll"}}}
...
def get() -> Any:
    """Returns the library.Library singleton for nirfmxbluetooth."""
    global _instance
