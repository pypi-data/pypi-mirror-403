...
#![warn(missing_docs)]
//! # Nearest Python-exposed Interpolation Module
//!
//! This module provides Python bindings for nearest interpolation functionality.
//!
//! ## Key Features
//!
//! - **Python-exposed interpolator**: Provides a Python class for nearest
...
//! from gridr.cdylib import NearestInterpolator
//!
...
/// A Python-exposed class representing a `GxNearestInterpolator` interpolator
///
/// This class provides a Python interface to the nearest interpolation functionality
/// implemented in the Rust `GxNearestInterpolator` struct. It enables seamless integration
...
#[pyclass(name = "NearestInterpolator")]
#[derive(Clone, Debug)]
pub struct PyNearestInterpolator {
    /// Inner interpolator wrapped in Arc<RwLock> for thread-safe shared ownership
    pub inner: Arc<RwLock<GxNearestInterpolator>>,
}

#[pymethods]
impl PyNearestInterpolator {
    ...
    ///
    /// # Returns
    /// A new instance of the `PyNearestInterpolator` class
    ///
    /// # Examples
    /// ```python
    /// # Create a new nearest interpolator
    /// interp = NearestInterpolator()
    /// ```
    #[new]
    pub fn new() -> Self {
        Self { inner: Arc::new(RwLock::new(GxNearestInterpolator::new(&GxArrayViewInterpolatorNoArgs{}))) }
    }
    ...
    /// Initializes the nearest interpolator.
    ///
    /// This method prepares the interpolator for use. For nearest interpolation,
    /// this does nothing.
    ///
    /// # Returns
