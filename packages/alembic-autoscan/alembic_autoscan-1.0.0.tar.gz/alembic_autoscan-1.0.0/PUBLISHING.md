...
This repository is configured with a GitHub Action to publish to PyPI automatically when a new tag is pushed.
...
2. Push a new tag:
   ...
   ```
3. The "Publish to PyPI" workflow will trigger, run tests, build the package, and upload it to PyPI using Trusted Publishing (OIDC).
