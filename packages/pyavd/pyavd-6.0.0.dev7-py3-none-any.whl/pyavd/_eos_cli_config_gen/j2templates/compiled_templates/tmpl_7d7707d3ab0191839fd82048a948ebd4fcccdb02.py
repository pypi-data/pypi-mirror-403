...
def root(context, missing=missing):
    ...
    pass
    for l_1_standard_access_list in t_1((undefined(name='standard_access_lists') if l_0_standard_access_lists is missing else l_0_standard_access_lists), sort_key='name', ignore_case=False):
        _loop_vars = {}
        pass
