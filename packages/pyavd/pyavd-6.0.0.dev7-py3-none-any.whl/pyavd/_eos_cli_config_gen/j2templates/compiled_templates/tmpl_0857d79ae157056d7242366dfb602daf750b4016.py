...
def root(context, missing=missing):
    ...
    pass
    for l_1_access_list in t_1((undefined(name='access_lists') if l_0_access_lists is missing else l_0_access_lists), sort_key='name', ignore_case=False):
        _loop_vars = {}
        pass
        yield '!\nip access-list '
...
blocks = {}
debug_info = '7=24&9=28&10=30&13=33&14=37&16=42&17=45'