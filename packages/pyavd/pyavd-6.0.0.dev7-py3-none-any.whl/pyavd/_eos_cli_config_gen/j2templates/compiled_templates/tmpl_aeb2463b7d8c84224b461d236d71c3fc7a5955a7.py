...
def root(context, missing=missing):
    ...
    pass
    for l_1_ipv6_access_list in t_1((undefined(name='ipv6_access_lists') if l_0_ipv6_access_lists is missing else l_0_ipv6_access_lists), sort_key='name', ignore_case=False):
        _loop_vars = {}
        pass
        yield '!\nipv6 access-list '
