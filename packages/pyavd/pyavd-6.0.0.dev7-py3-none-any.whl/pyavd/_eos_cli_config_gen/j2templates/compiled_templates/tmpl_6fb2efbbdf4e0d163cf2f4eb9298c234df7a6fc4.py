...
def root(context, missing=missing):
    ...
    if t_3((undefined(name='ip_radius_source_interfaces') if l_0_ip_radius_source_interfaces is missing else l_0_ip_radius_source_interfaces)):
        ...
        for l_1_ip_radius_source_interface in t_2((undefined(name='ip_radius_source_interfaces') if l_0_ip_radius_source_interfaces is missing else l_0_ip_radius_source_interfaces), sort_key='name'):
            _loop_vars = {}
            pass
            yield '| '
