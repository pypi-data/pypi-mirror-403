...
#let horizontalrule = [
  #v(2em)
  #line(start: (20%,0%), end: (80%,0%), stroke: 0.2pt + black)
  #v(2em)
]
...
#let conf(
  ...
  let font = "Helvetica Neue"  //Source Han Sans SC
...
//  set list(block: true)
  ...
  show heading.where(level: 3
        ...
        #set text(font: font, weight: "semibold", size: 14pt, fill: rgb("#00008B"))
        #block(it.body) 
      ])
