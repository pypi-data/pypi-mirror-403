...
PATH_TASK_MODIN = "artifacts/1_attributes/modin-task-instances_attribute.jsonl"

# Get raw matplotlib dataset
data_tasks = get_instances(PATH_TASK_MODIN)
...
VERSION_TAG_PATTERN = r"^(\d+\.\d+\.\d+)(?:rc\d+)?$"
...
new_file_name = Path(PATH_TASK_MODIN).stem + "_versions.json"
