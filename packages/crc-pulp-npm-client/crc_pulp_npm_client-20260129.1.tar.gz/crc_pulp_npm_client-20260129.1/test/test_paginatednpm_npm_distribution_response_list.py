...
class TestPaginatednpmNpmDistributionResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginatednpmNpmDistributionResponseList:
        """Test PaginatednpmNpmDistributionResponseList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatednpmNpmDistributionResponseList`
        """
        model = PaginatednpmNpmDistributionResponseList()
        if include_optional:
