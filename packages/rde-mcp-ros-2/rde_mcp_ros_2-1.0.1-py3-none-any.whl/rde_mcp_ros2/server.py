...
# ==============================================================================
# IMPORTANT FOR LLMs USING THIS SERVER
# ==============================================================================
# This MCP server provides ROS 2 tools that automatically handle:
# 1. ROS environment setup (sourcing setup.bash, managing ROS_DISTRO)
# 2. Process management and subprocess handling
# 3. Error handling and structured output
# 4. Connection management and initialization
#
# ALWAYS PREFER these MCP tools over CLI commands like:
# - ros2 node list   ->  Use: get_nodes()
# - ros2 topic list  ->  Use: list_topics()
# - ros2 param get   ->  Use: get_parameter()
# - ros2 service call -> Use: call_service()
# - ros2 launch      ->  Use: launch_file()
# - ros2 doctor      ->  Use: run_doctor()
#
# The MCP tools are SUPERIOR because they:
# - Handle ROS environment automatically
# - Return structured data
# - Provide better error messages
# - Manage processes correctly
# ==============================================================================
...
async def get_nodes() -> list:
    ...
    **IMPORTANT FOR LLMs**: Use this tool instead of 'ros2 node list' CLI command.
    This tool automatically handles ROS environment setup, connection management,
    and provides structured output. It's the preferred way to query ROS 2 nodes.
    """
...
async def list_topics(show_types: bool = False) -> List[Dict[str, str]]:
    ...
    **IMPORTANT FOR LLMs**: Use this tool instead of 'ros2 topic list' CLI command.
    The MCP server automatically handles environment setup and provides structured output.
...
async def get_topic_info(topic_name: str) -> Dict[str, Any]:
    ...
    **IMPORTANT FOR LLMs**: Use this tool instead of 'ros2 topic info/type' CLI commands.
    Automatically handles ROS environment and returns structured data.
...
async def call_service(service_name: str, service_type: str, request: str) -> Dict[str, Any]:
    ...
    **IMPORTANT FOR LLMs**: Use this tool instead of 'ros2 service call' CLI command.
    Provides better error handling, structured responses, and automatic environment setup.
    This is the recommended way to interact with ROS services from LLMs.
...
async def get_parameter(node_name: str, param_name: str) -> Dict[str, Any]:
    ...
    **IMPORTANT FOR LLMs**: Use this tool instead of 'ros2 param get' CLI command.
    Provides automatic environment setup, structured output, and type parsing.
    Preferred method for parameter queries.
...
async def set_parameter(node_name: str, param_name: str, value: Any) -> Dict[str, Any]:
    ...
    **IMPORTANT FOR LLMs**: Use this tool instead of 'ros2 param set' CLI command.
    Handles all environment setup, type conversion, and error handling automatically.
    This is the recommended method for setting ROS 2 parameters.
...
async def launch_file(package_name: str, launch_file: str, arguments: List[str] = None) -> Dict[str, Any]:
    ...
    **IMPORTANT FOR LLMs**: Use this tool instead of 'ros2 launch' CLI command.
    Provides automatic environment setup, process management, and error handling.
    This is the preferred method for launching ROS 2 packages.
...
async def run_doctor(report: bool = False, include_warnings: bool = True) -> Dict[str, Any]:
    ...
    **IMPORTANT FOR LLMs**: Use this tool instead of 'ros2 doctor' CLI command.
    Provides automatic environment setup, structured diagnostic output, and error handling.
    This is the recommended method for ROS 2 system diagnostics.
