...
from gardening_tools.functional.transforms.spatial import numpy_spatial, torch_spatial


class Numpy_Spatial(BaseTransform):
    def __init__(
        self,
        data_key="image",
        label_key="label",
...
class Torch_Spatial(BaseTransform):
    def __init__(
        self,
        data_key="image",
        label_key="label",
