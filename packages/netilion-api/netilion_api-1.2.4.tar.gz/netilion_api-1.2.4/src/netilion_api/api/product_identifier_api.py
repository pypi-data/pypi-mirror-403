...
class ProductIdentifierApi(object):
    ...
    def get_product_identifiers_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['page', 'per_page', 'include_total_count', 'include', 'organization_name', 'protocol', 'protocol_version', 'product_identifier', 'tenant_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_product_identifiers_of_product_with_http_info(self, product_id, **kwargs):  # noqa: E501
        ...
        all_params = ['product_id', 'page', 'per_page', 'include_total_count', 'include']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_products_of_product_identifier_with_http_info(self, product_identifier_id, **kwargs):  # noqa: E501
        ...
        all_params = ['product_identifier_id', 'page', 'per_page', 'include_total_count', 'include', 'product_code', 'name', 'manufacturer_id', 'status_id', 'category_id', 'parent_id', 'tenant_id', 'specifications_key', 'specifications_value', 'order_by', 'accept_language']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
