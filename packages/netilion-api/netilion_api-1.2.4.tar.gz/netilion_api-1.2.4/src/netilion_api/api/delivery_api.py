...
class DeliveryApi(object):
    ...
    def get_deliveries_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['page', 'per_page', 'include_total_count', 'number', 'name', 'status_id', 'date_of_shipment', 'date_of_shipment_from', 'date_of_shipment_to', 'sender_id', 'receiver_id', 'customer_number', 'order_by']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_documents_of_delivery_with_http_info(self, delivery_id, **kwargs):  # noqa: E501
        ...
        all_params = ['delivery_id', 'page', 'per_page', 'include_total_count', 'include', 'name', 'document_version', 'number', 'status_id', 'classification_id', 'tenant_id', 'category_id', 'valid_from', 'valid_until', 'valid_at', 'order_by', 'accept_language']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_purchase_orders_of_delivery_with_http_info(self, delivery_id, **kwargs):  # noqa: E501
        ...
        all_params = ['delivery_id', 'page', 'per_page', 'include_total_count', 'name', 'number', 'status_id', '_date', 'date_from', 'date_to', 'sender_id', 'receiver_id', 'quotation_id', 'customer_number', 'order_by']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
