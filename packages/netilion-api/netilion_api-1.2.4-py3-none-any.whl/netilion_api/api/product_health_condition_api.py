...
class ProductHealthConditionApi(object):
    ...
    def get_product_health_conditions_with_http_info(self, product_id, **kwargs):  # noqa: E501
        ...
        all_params = ['product_id', 'page', 'per_page', 'include_total_count', 'include', 'health_condition_id', 'diagnosis_code', 'device_ident', 'product_identifier', 'protocol', 'order_by', 'accept_language']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
