...
class DeliveryStatusApi(object):
    ...
    def get_delivery_statuses_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['page', 'per_page', 'include_total_count', 'code', 'name', 'tenant_id', 'order_by', 'accept_language']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def update_delivery_statuses(self, body, id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_delivery_statuses(body, id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_delivery_statuses_with_http_info(body, id, **kwargs)  # noqa: E501
        else:
            (data) = self.update_delivery_statuses_with_http_info(body, id, **kwargs)  # noqa: E501
            return data

    def update_delivery_statuses_with_http_info(self, body, id, **kwargs):  # noqa: E501
        """Update an delivery status  # noqa: E501

        Update accessible parameters of the requested resource. Parameters supporting translation: ```name, description```. To add a translation set Content-Language.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_delivery_statuses_with_http_info(body, id, async_req=True)
        >>> result = thread.get()
