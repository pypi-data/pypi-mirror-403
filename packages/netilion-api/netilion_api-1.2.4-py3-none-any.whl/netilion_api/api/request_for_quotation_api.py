...
class RequestForQuotationApi(object):
    ...
    def get_bill_of_materials_of_request_for_quotation_with_http_info(self, request_for_quotation_id, **kwargs):  # noqa: E501
        ...
        all_params = ['request_for_quotation_id', 'page', 'per_page', 'include_total_count', 'name', 'author', '_date', 'date_from', 'date_to', 'order_by']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_documents_of_request_for_quotation_with_http_info(self, request_for_quotation_id, **kwargs):  # noqa: E501
        ...
        all_params = ['request_for_quotation_id', 'page', 'per_page', 'include_total_count', 'include', 'name', 'document_version', 'number', 'status_id', 'classification_id', 'tenant_id', 'category_id', 'valid_from', 'valid_until', 'valid_at', 'order_by', 'accept_language']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_quotations_of_request_for_quotation_with_http_info(self, request_for_quotation_id, **kwargs):  # noqa: E501
        ...
        all_params = ['request_for_quotation_id', 'page', 'per_page', 'include_total_count', 'name', 'number', 'status_id', '_date', 'date_from', 'date_to', 'sender_id', 'receiver_id', 'order_by']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_request_for_quotations_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['page', 'per_page', 'include_total_count', 'name', 'number', 'status_id', '_date', 'date_from', 'date_to', 'sender_id', 'receiver_id', 'author', 'order_by']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
