...
class VoyageEMInvoker(BaseEMInvoker):
    ...
    Vector fusion:
        The `VoyageEMInvoker` supports vector fusion, which allows fusing multiple results into a single vector.
        Since Voyage supports embedding mixed modality contents natively, this feature is optional
        and will take precedence over Voyage\'s built-in mixed modality handling if provided.
