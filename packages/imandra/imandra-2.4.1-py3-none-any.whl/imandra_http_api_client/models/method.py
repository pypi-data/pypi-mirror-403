...
class Method(BaseModel):
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Method:
        """Create an instance of Method from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Method.parse_obj(obj)

        _obj = Method.parse_obj({
            "type": obj.get("type"),
            "body": MethodBody.from_dict(obj.get("body")) if obj.get("body") is not None else None
        })
        return _obj
