...
class WithInstanceBody(BaseModel):
    """
    WithInstanceBody
    """
    instance: ResponseInstance = Field(...)
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WithInstanceBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WithInstanceBody:
        """Create an instance of WithInstanceBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WithInstanceBody.parse_obj(obj)

        _obj = WithInstanceBody.parse_obj({
            "instance": ResponseInstance.from_dict(obj.get("instance")) if obj.get("instance") is not None else None
        })
        return _obj
