...
from imandra_http_api_client.exceptions import ApiException, UnauthorizedException, ForbiddenException, NotFoundException, ServiceException, ApiValueError, BadRequestException
...
class RESTClientObject(object):
    ...
    def request(self, method, url, query_params=None, headers=None,
        ...
        if r.status != 422 and not 200 <= r.status <= 299:
            if r.status == 400:
