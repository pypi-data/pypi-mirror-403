...
from imandra_http_api_client.models.induct_type import InductType  # noqa: E501
from imandra_http_api_client.rest import ApiException

class TestInductType(unittest.TestCase):
    """InductType unit test stubs"""
