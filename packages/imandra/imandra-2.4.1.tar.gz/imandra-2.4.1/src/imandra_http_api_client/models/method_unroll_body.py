...
class MethodUnrollBody(BaseModel):
    """
    MethodUnrollBody
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MethodUnrollBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MethodUnrollBody:
        """Create an instance of MethodUnrollBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MethodUnrollBody.parse_obj(obj)

        _obj = MethodUnrollBody.parse_obj({
            "steps": obj.get("steps")
        })
        return _obj
