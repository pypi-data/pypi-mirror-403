...
class VerifyRequestName(BaseModel):
    """
    VerifyRequestName
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VerifyRequestName:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VerifyRequestName:
        """Create an instance of VerifyRequestName from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VerifyRequestName.parse_obj(obj)

        _obj = VerifyRequestName.parse_obj({
            "name": obj.get("name"),
