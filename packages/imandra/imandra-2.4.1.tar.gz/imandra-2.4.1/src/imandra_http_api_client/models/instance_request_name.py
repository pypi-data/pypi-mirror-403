...
class InstanceRequestName(BaseModel):
    """
    InstanceRequestName
    """
    name: StrictStr = Field(..., description="Example: my_fn_name ")
    instance_printer: Optional[PrinterDetails] = None
    hints: Optional[Hints] = None
    __properties = ["name", "instance_printer", "hints"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InstanceRequestName:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InstanceRequestName:
        """Create an instance of InstanceRequestName from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InstanceRequestName.parse_obj(obj)

        _obj = InstanceRequestName.parse_obj({
            "name": obj.get("name"),
