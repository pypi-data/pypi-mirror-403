...
class InductFunctionalBody(BaseModel):
    """
    InductFunctionalBody
    """
    f_name: StrictStr = Field(...)
    __properties = ["f_name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> InductFunctionalBody:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> InductFunctionalBody:
        """Create an instance of InductFunctionalBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return InductFunctionalBody.parse_obj(obj)

        _obj = InductFunctionalBody.parse_obj({
            "f_name": obj.get("f_name")
        })
        return _obj
