...
class EvalResponse(BaseModel):
    ...
    __properties = ["success", "stdout", "stderr"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> EvalResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> EvalResponse:
        """Create an instance of EvalResponse from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return EvalResponse.parse_obj(obj)

        _obj = EvalResponse.parse_obj({
