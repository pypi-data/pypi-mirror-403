...
def detect_change_points(the_time, data):
    ...
    likelihood = _compute_likelihood_criteria(change_points[0], change_points[1], the_time, data)
...
def _find_candidate_detection(i, j, the_time, data):
    ...
    for k in range(i+2, j-2):
        ...
        likelihood_first_segment = _compute_likelihood_criteria(i, k, the_time, data)
        likelihood_second_segment = _compute_likelihood_criteria(k+1, j, the_time, data)
