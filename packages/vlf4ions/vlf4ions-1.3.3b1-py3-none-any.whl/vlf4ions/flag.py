...
def flags(amp_NS, amp_EW, previous_nb_points, today, path, this_receiver):
    ...
    if daytime:
        ...
        if data_last_min < this_receiver.threshold and flag != 1: # If the amplitude is too low, the station is not transmitting
            flag = 2
    else:
        flag = 3
