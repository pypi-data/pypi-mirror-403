...
def LMP_findminimum(station, amp, phase, quiet_A, quiet_P, sza, pathtoCSVfiles):
    ...
    # Correct the values of DA and DP to match the quiet background
    DA_q = quiet_A - A_quiet
    DP_q = quiet_P - P_quiet
    DA = amp - DA_q
    DP = phase - DP_q
