...
[![pipeline status](https://gitlab.obspm.fr/vlf/vlf4ions_library/badges/main/pipeline.svg)](https://gitlab.obspm.fr/vlf/vlf4ions_library/-/commits/main) 
[![coverage report](https://gitlab.obspm.fr/vlf/vlf4ions_library/badges/main/coverage.svg)](https://gitlab.obspm.fr/vlf/vlf4ions_library/-/commits/main) 
...
## 1st option: re-make the `html` file from the `.rst` files
Run in a terminal if this is the first time reading them:

```ruby
pip install sphinx # to create the docs
pip install pydata-sphinx-theme # To install the theme for the documentation
```
...
## 2nd option: read the `html` files directly from the `docs/build/html` folder
