...
def plot_map(stations_l, thisreceiver, today, path_to_results, Nemax=1e11):
    ...
    :param Ne_max: Maximum possible electron density to ajust the colorbar (default, 1e11 m^-3)'''
