...
def test_flags():
    ...
    flag_1, data_length_1, data_1 = flags(amp_NS, amp_EW, previous_nb_points, today, path_to_files, Nancay)
    ...
    # Test antenna down
    flag_2, data_length_2, data_2 = flags(amp_NS, amp_EW, data_length_1, today, path_to_files, Nancay)
    ...
    flag_3, data_length_3, data_3 = flags(amp_NS, amp_EW, previous_nb_points, night, path_to_files, Nancay)

    # Test transmetter down
    Nancay.threshold = 400
    flag_4, data_length_4, data_4 = flags(amp_NS, amp_EW, previous_nb_points, today, path_to_files, Nancay)

    assert((flag_1 == 0) and (flag_2 == 1) and (flag_3 == 3) and (flag_4 == 2) and (data_1 == data_1_exp) and (data_4 == 30))
