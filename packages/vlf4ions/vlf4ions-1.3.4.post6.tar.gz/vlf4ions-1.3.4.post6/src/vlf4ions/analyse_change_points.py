...
def analyse_breakpoint(
    ...
    Several cases can occur:
        ...
        5) It's been more than 2h that there was a quiet time. It is very likely that this is a technical problem. Everything is set to 0 in this case
    ...
    # Case 5)
    if current_time - quiet_breakpoint > 3 and current_p1 < detection_threshold:
