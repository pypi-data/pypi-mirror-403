...
class AuthDatabaseGenerator:
    ...
    def _generate_docs_router(self):
        """
        Genera el router de documentación protegida
        """
        # Cargar el template Jinja2
        template = self.jinja_env.get_template("docs_router.py.j2")
        ...
        # Escribir archivo
        output_file = os.path.join(self.output_dir, "docs_router.py")
        with open(output_file, 'w', encoding='utf-8') as f:
            f.write(content)
