...
enum VLogLevel : int {
  ...
  VL_HYPER_OFFLOAD_DEBUG,                       // Hyper offload debug log
  VL_HYPER_OFFLOAD_INFO,                        // Hyper offload info log
  VL_HYPER_OFFLOAD_WARNING,                     // Hyper offload warning log
};
