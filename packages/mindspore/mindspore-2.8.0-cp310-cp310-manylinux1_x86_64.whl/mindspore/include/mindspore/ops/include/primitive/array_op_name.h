...
#ifndef MINDSPORE_OPS_PRIMITIVE_ARRAY_OP_NAME_H_
#define MINDSPORE_OPS_PRIMITIVE_ARRAY_OP_NAME_H_
...
constexpr auto kZerosLikeExtOpName = "ZerosLikeExt";
constexpr auto kOnesOpName = "Ones";
constexpr auto kOnesLikeOpName = "OnesLike";
constexpr auto kOnesLikeExtOpName = "OnesLikeExt";
...
#endif  // MINDSPORE_OPS_PRIMITIVE_ARRAY_OP_NAME_H_
