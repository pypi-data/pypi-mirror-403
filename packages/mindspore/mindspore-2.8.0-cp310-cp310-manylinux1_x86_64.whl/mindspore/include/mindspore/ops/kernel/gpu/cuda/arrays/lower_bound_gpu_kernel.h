...
#include <functional>
#include <map>
#include "mindspore/ops/infer/lower_bound.h"
#include "include/runtime/hardware_abstract/kernel_base/ms_factory.h"
#include "kernel/gpu/gpu_kernel.h"
#include "kernel/gpu/gpu_kernel_factory.h"
#include "kernel/gpu/cuda_impl/cuda_ops/upper_bound_lower_bound_impl.cuh"
...
class LowerBoundGpuKernelMod : public NativeGpuKernelMod {
 ...
 private:
  ...
  using LowerBoundFunc =
    std::function<bool(LowerBoundGpuKernelMod *, const std::vector<kernel::KernelTensor *> &,
