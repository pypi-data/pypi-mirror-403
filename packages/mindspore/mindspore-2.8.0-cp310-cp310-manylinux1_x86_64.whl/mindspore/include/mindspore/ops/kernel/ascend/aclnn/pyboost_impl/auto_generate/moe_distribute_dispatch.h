...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_MOEDISTRIBUTEDISPATCH_ASCEND_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_MOEDISTRIBUTEDISPATCH_ASCEND_H_
...
namespace kernel {
namespace pyboost {
class OPS_ASCEND_API MoeDistributeDispatchAscend : public pyboost::MoeDistributeDispatch {
 public:
  MoeDistributeDispatchAscend(PrimitivePtr primitive, const DeviceContext *device_context)
      : MoeDistributeDispatch(std::move(primitive), device_context) {}
  ~MoeDistributeDispatchAscend() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_MOEDISTRIBUTEDISPATCH_ASCEND_H_
