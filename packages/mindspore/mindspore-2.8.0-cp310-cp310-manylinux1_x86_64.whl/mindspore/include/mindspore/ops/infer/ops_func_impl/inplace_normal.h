...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_INPLACE_NORMAL_H_
...
namespace mindspore {
namespace ops {
class OPS_API InplaceNormalFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_INPLACE_NORMAL_H_
