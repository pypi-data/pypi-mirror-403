...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_LEAKYRELUEXT_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_LEAKYRELUEXT_H_
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_LEAKY_RELU_EXT_H_
