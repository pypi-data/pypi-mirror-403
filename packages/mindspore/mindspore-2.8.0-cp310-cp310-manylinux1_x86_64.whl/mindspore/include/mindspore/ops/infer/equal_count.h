...
#ifndef MINDSPORE_CORE_OPS_EQUAL_COUNT_H_
#define MINDSPORE_CORE_OPS_EQUAL_COUNT_H_
#include <memory>
#include <vector>
...
class OPS_API EqualCount : public BaseOperator {
 public:
  ...
  /// \brief Constructor.
  EqualCount() : BaseOperator(kNameEqualCount) { InitIOName({"x", "y"}, {"output"}); }
  /// \brief Init. Refer to the parameters of Python API @ref mindspore.ops.EqualCount for the inputs.
  void Init() const {}
};
...
#endif  // MINDSPORE_CORE_OPS_EQUAL_COUNT_H_
