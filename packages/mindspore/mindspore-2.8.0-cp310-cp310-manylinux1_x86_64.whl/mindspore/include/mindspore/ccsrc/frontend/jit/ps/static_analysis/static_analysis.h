...
#ifndef MINDSPORE_CCSRC_FRONTEND_JIT_STATIC_ANALYSIS_STATIC_ANALYSIS_H_
#define MINDSPORE_CCSRC_FRONTEND_JIT_STATIC_ANALYSIS_STATIC_ANALYSIS_H_
...
class AnalysisEngine : public std::enable_shared_from_this<AnalysisEngine> {
 ...
 private:
  ...
  bool IsNoSideEffectGetAttrNode(const CNodePtr &cnode);
...
#endif  // MINDSPORE_CCSRC_FRONTEND_JIT_STATIC_ANALYSIS_STATIC_ANALYSIS_H_
