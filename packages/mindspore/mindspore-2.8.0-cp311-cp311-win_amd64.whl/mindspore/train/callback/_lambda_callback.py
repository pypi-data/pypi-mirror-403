...
class LambdaCallback(Callback):
    ...
    Args:
        on_train_epoch_begin (Function, optional): called at each train epoch begin. Default: ``None`` .
        on_train_epoch_end (Function, optional): called at each train epoch end. Default: ``None`` .
        on_train_step_begin (Function, optional): called at each train step begin. Default: ``None`` .
        on_train_step_end (Function, optional): called at each train step end. Default: ``None`` .
        on_train_begin (Function, optional): called at the beginning of model train. Default: ``None`` .
        on_train_end (Function, optional): called at the end of model train. Default: ``None`` .
        on_eval_epoch_begin (Function, optional): called at each eval epoch begin. Default: ``None`` .
        on_eval_epoch_end (Function, optional): called at each eval epoch end. Default: ``None`` .
        on_eval_step_begin (Function, optional): called at each eval step begin. Default: ``None`` .
        on_eval_step_end (Function, optional): called at each eval step end. Default: ``None`` .
        on_eval_begin (Function, optional): called at the beginning of model eval. Default: ``None`` .
        on_eval_end (Function, optional): called at the end of model eval. Default: ``None`` .
