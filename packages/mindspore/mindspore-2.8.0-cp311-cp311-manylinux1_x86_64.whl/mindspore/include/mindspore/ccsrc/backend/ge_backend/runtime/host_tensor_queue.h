...
#ifndef MINDSPORE_CCSRC_BACKEND_GEBACKEND_RUNTIME_HOST_QUEUE_STORE_H_
#define MINDSPORE_CCSRC_BACKEND_GEBACKEND_RUNTIME_HOST_QUEUE_STORE_H_
...
#endif  // MINDSPORE_CCSRC_BACKEND_GEBACKEND_RUNTIME_HOST_QUEUE_STORE_H_
