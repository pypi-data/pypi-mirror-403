...
#ifndef MINDSPORE_CORE_OPS_CONJUGATETRANSPOSE_H_
#define MINDSPORE_CORE_OPS_CONJUGATETRANSPOSE_H_
#include <memory>
#include <vector>
...
class OPS_API ConjugateTranspose : public BaseOperator {
 public:
  ...
  /// \brief Constructor.
  ConjugateTranspose() : BaseOperator(kNameConjugateTranspose) { InitIOName({"x", "perm"}, {"y"}); }
  /// \brief Init.
  void Init() const {}
};
...
#endif  // MINDSPORE_CORE_OPS_CONJUGATETRANSPOSE_H_
