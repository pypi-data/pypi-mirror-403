...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_MOEDISTRIBUTECOMBINE_GPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_MOEDISTRIBUTECOMBINE_GPU_H_

#include "include/pynative/utils/pyboost/auto_generate/moe_distribute_combine.h"
#include "ir/tensor.h"
#include "ir/scalar.h"
...
namespace kernel {
namespace pyboost {
class MoeDistributeCombineGPU : public pyboost::MoeDistributeCombine {
 public:
  MoeDistributeCombineGPU(PrimitivePtr primitive, const DeviceContext *device_context)
    : MoeDistributeCombine(std::move(primitive), device_context) {}
  ~MoeDistributeCombineGPU() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_MOEDISTRIBUTECOMBINE_GPU_H_
