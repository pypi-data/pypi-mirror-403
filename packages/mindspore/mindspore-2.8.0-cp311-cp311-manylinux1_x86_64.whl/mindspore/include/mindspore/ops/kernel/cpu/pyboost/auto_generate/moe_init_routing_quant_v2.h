...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_MOEINITROUTINGQUANTV2_CPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_MOEINITROUTINGQUANTV2_CPU_H_
...
namespace kernel {
namespace pyboost {
class MoeInitRoutingQuantV2CPU : public pyboost::MoeInitRoutingQuantV2 {
 public:
  MoeInitRoutingQuantV2CPU(PrimitivePtr primitive, const DeviceContext *device_context)
    : MoeInitRoutingQuantV2(std::move(primitive), device_context) {}
  ~MoeInitRoutingQuantV2CPU() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_MOEINITROUTINGQUANTV2_CPU_H_
