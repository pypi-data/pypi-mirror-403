...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_PUTMEMSIGNAL_CPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_PUTMEMSIGNAL_CPU_H_
...
namespace kernel {
namespace pyboost {
class PutMemSignalCPU : public pyboost::PutMemSignal {
 public:
  PutMemSignalCPU(PrimitivePtr primitive, const DeviceContext *device_context)
    : PutMemSignal(std::move(primitive), device_context) {}
  ~PutMemSignalCPU() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_PUTMEMSIGNAL_CPU_H_
