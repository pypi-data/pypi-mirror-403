...
#ifndef MS_KERNELS_SYMMETRIC_MEMORY_KERNEL_BASE_TYPE_H_
#define MS_KERNELS_SYMMETRIC_MEMORY_KERNEL_BASE_TYPE_H_
...
enum SymmetricMemoryStatus {
  kSymmetricMemoryOk = 0,
  kSymmetricMemoryError,
};
...
#endif  // MS_KERNELS_SYMMETRIC_MEMORY_KERNEL_BASE_TYPE_H_
