...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_MOEDISTRIBUTEDISPATCH_GPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_MOEDISTRIBUTEDISPATCH_GPU_H_
...
namespace kernel {
namespace pyboost {
class MoeDistributeDispatchGPU : public pyboost::MoeDistributeDispatch {
 public:
  MoeDistributeDispatchGPU(PrimitivePtr primitive, const DeviceContext *device_context)
    : MoeDistributeDispatch(std::move(primitive), device_context) {}
  ~MoeDistributeDispatchGPU() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_MOEDISTRIBUTEDISPATCH_GPU_H_
