...
#ifndef MINDSPORE_MINDSPORE_CCSRC_BACKEND_COMMON_SESSION_JIT_JIT_CALL_GRAPH_H_
#define MINDSPORE_MINDSPORE_CCSRC_BACKEND_COMMON_SESSION_JIT_JIT_CALL_GRAPH_H_
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_BACKEND_COMMON_SESSION_JIT_JIT_CALL_GRAPH_H_
