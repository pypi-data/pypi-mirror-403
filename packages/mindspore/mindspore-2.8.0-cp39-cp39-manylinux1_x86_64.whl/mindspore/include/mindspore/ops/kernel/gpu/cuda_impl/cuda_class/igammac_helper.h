...
#ifndef MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_CUDA_IMPL_CUDA_CLASS_IGAMMAC_HELPER_H_
#define MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_CUDA_IMPL_CUDA_CLASS_IGAMMAC_HELPER_H_
#include <memory>
#include <string>
#include <vector>
...
template <typename T>
class IgammacHelperGpuKernel : public GpuKernelHelperBase {
 public:
  explicit IgammacHelperGpuKernel(const std::string &kernel_name, const uint32_t &device_id)
  ...
  virtual ~IgammacHelperGpuKernel() = default;
...
#endif  // MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_CUDA_IMPL_CUDA_CLASS_IGAMMAC_HELPER_H_
