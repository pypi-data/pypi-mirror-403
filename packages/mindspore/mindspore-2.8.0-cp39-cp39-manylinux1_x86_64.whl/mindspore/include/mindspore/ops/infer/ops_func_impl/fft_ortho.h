 ...
 */
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_FFT_ORTHO_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_FFT_ORTHO_H_
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_FFT_ORTHO_H_
