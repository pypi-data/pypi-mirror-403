...
#ifndef MINDSPORE_OPS_PRIMITIVE_SPARSE_TENSOR_OPS_H_
#define MINDSPORE_OPS_PRIMITIVE_SPARSE_TENSOR_OPS_H_
...
#endif  // MINDSPORE_OPS_PRIMITIVE_SPARSE_TENSOR_OPS_H_
