...
#ifndef MINDSPORE_CCSRC_INCLUDE_RUNTIMR_HARDWARE_ABSTRACT_DATA_QUEUE_DATA_QUEUE_H
#define MINDSPORE_CCSRC_INCLUDE_RUNTIMR_HARDWARE_ABSTRACT_DATA_QUEUE_DATA_QUEUE_H
...
class RUNTIME_HARDWARE_EXPORT DataQueue {
 public:
...
#endif  // MINDSPORE_CCSRC_INCLUDE_RUNTIMR_HARDWARE_ABSTRACT_DATA_QUEUE_DATA_QUEUE_H
