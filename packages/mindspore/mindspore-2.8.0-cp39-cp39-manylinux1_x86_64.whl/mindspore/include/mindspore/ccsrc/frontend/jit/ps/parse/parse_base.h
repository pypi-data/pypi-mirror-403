...
#ifndef MINDSPORE_CCSRC_FRONTEND_JIT_PARSE_PARSE_BASE_H_
#define MINDSPORE_CCSRC_FRONTEND_JIT_PARSE_PARSE_BASE_H_
#include <string>
#include <memory>
...
#endif  // MINDSPORE_CCSRC_FRONTEND_JIT_PARSE_PARSE_BASE_H_
