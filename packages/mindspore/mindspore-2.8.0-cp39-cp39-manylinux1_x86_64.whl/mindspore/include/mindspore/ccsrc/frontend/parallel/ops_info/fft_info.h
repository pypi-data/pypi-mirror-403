...
FFT_REGISTER(RFFT2Info, FFTTupleDim);
FFT_REGISTER(IRFFT2Info, FFTTupleDim);
FFT_REGISTER(RFFTNInfo, FFTTupleDim);
FFT_REGISTER(IRFFTNInfo, FFTTupleDim);
FFT_REGISTER(HFFTInfo, FFTIntDim);
FFT_REGISTER(IHFFTInfo, FFTIntDim);
FFT_REGISTER(HFFT2Info, FFTTupleDim);
FFT_REGISTER(IHFFT2Info, FFTTupleDim);
FFT_REGISTER(HFFTNInfo, FFTTupleDim);
FFT_REGISTER(IHFFTNInfo, FFTTupleDim);
