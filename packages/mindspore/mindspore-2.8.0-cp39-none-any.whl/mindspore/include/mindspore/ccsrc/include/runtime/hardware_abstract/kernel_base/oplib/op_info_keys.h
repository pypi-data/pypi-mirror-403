...
#ifndef MINDSPORE_OPS_COMMON_OP_INFO_KEYS_H_
#define MINDSPORE_OPS_COMMON_OP_INFO_KEYS_H_
#include <set>
#include <string>
#include <map>
...
enum OpImplyType { kImplyAKG = 0, kImplyTBE, kImplyAICPU, kImplyCPU, kImplyGPU, kImplyBISHENG, kImplyDynamicAKG };
...
#endif  // MINDSPORE_OPS_COMMON_OP_INFO_KEYS_H_
