 ...
 */
#ifndef MINDSPORE_CCSRC_BACKEND_OPTIMIZER_PASS_DYNAMIC_SEQUENCE_OPS_ADAPTATION_H_
#define MINDSPORE_CCSRC_BACKEND_OPTIMIZER_PASS_DYNAMIC_SEQUENCE_OPS_ADAPTATION_H_
...
class BACKEND_COMMON_EXPORT DynamicSequenceOpsAdaptation : public PatternProcessPass {
 public:
  ...
  ~DynamicSequenceOpsAdaptation() override = default;
  const AnfNodePtr Process(const FuncGraphPtr &, const AnfNodePtr &node, const EquivPtr &) const override;
};
}  // namespace opt
}  // namespace mindspore

#endif  // MINDSPORE_CCSRC_BACKEND_OPTIMIZER_PASS_DYNAMIC_SEQUENCE_OPS_ADAPTATION_H_
