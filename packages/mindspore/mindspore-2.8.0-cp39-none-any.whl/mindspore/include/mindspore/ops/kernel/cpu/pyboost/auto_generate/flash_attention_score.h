...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_FLASHATTENTIONSCORE_CPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_FLASHATTENTIONSCORE_CPU_H_

#include "include/pynative/utils/pyboost/auto_generate/flash_attention_score.h"
#include "ir/tensor.h"
#include "ir/scalar.h"
...
namespace kernel {
namespace pyboost {
class FlashAttentionScoreCPU : public pyboost::FlashAttentionScore {
 public:
  FlashAttentionScoreCPU(PrimitivePtr primitive, const DeviceContext *device_context)
    : FlashAttentionScore(std::move(primitive), device_context) {}
  ~FlashAttentionScoreCPU() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_FLASHATTENTIONSCORE_CPU_H_
