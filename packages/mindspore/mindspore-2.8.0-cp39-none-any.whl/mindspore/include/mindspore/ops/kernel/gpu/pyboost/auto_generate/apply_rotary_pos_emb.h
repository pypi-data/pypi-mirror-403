...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_APPLYROTARYPOSEMB_GPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_APPLYROTARYPOSEMB_GPU_H_
...
namespace kernel {
namespace pyboost {
class ApplyRotaryPosEmbGPU : public pyboost::ApplyRotaryPosEmb {
 public:
  ApplyRotaryPosEmbGPU(PrimitivePtr primitive, const DeviceContext *device_context)
    : ApplyRotaryPosEmb(std::move(primitive), device_context) {}
  ~ApplyRotaryPosEmbGPU() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_APPLYROTARYPOSEMB_GPU_H_
