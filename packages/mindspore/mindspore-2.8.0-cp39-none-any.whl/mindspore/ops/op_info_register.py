...
class DataType:
    ...
    BF16_None = ("bfloat16", "")
    BF16_Default = ("bfloat16", "DefaultFormat")
    BF16_5HD = ("bfloat16", "NC1HWC0")
    BF16_FracZ = ("bfloat16", "FRACTAL_Z")
    BF16_FracNZ = ("bfloat16", "FRACTAL_NZ")
    BF16_C1HWNCoC0 = ("bfloat16", "C1HWNCoC0")
    BF16_NCHW = ("bfloat16", "NCHW")
    BF16_NHWC = ("bfloat16", "NHWC")
    BF16_HWCN = ("bfloat16", "HWCN")
    BF16_NDHWC = ("bfloat16", "NDHWC")
    BF16_NCDHW = ("bfloat16", "NCDHW")
    BF16_DHWCN = ("bfloat16", "DHWCN")
    BF16_NDC1HWC0 = ("bfloat16", "NDC1HWC0")
    BF16_FRACTAL_Z_3D = ("bfloat16", "FRACTAL_Z_3D")
    BF16_FracZNLSTM = ("bfloat16", "FRACTAL_ZN_LSTM")
    BF16_FracZNRNN = ("bfloat16", "FRACTAL_ZN_RNN")
    BF16_ND_RNNBIAS = ("bfloat16", "ND_RNN_BIAS")
    BF16_ChannelLast = ("bfloat16", "ChannelLast")
    BF16_Default_Tuple = ("bfloat16", "DefaultFormat", "tuple")
    BF16_Default_List = ("bfloat16", "DefaultFormat", "list")
