 ...
 */
#ifndef MINDSPORE_CORE_OPS_SYMBOL_OPS_IMPL_SCALAR_ADD_H_
#define MINDSPORE_CORE_OPS_SYMBOL_OPS_IMPL_SCALAR_ADD_H_
...
namespace symshape {
namespace ops {
class OPS_API ScalarAdd : public ScalarIntOp {
 public:
...
#endif  // MINDSPORE_CORE_OPS_SYMBOL_OPS_IMPL_SCALAR_ADD_H_
