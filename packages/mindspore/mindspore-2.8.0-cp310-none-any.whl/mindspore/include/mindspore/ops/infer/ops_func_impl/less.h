...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_LESS_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_LESS_H_
...
namespace mindspore {
namespace ops {
class OPS_API LessFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_LESS_H_
