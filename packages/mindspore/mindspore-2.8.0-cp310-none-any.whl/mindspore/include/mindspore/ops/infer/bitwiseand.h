...
class OPS_API BitwiseAnd : public BaseOperator {
 public:
...
OPS_API abstract::AbstractBasePtr BitwiseAndInfer(const abstract::AnalysisEnginePtr &, const PrimitivePtr &primitive,
