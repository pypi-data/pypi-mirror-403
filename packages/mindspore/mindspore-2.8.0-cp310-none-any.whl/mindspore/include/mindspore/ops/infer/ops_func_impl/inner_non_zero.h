...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_INNER_NON_ZERO_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_INNER_NON_ZERO_H_
...
namespace mindspore {
namespace ops {
class OPS_API InnerNonZeroFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_INNER_NON_ZERO_H_
