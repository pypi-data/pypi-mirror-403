...
#ifndef MINDSPORE_CORE_OPS_OP_FUNC_IMPL_TRACE_EXT_H
#define MINDSPORE_CORE_OPS_OP_FUNC_IMPL_TRACE_EXT_H
...
using TraceExtFuncImplPtr = std::shared_ptr<TraceExtFuncImpl>;
}  // namespace mindspore::ops
#endif  // MINDSPORE_CORE_OPS_OP_FUNC_IMPL_TRACE_EXT_H
