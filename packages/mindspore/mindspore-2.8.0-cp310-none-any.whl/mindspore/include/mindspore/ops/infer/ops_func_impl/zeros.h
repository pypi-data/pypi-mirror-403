...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ZEROS_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ZEROS_H_
...
namespace mindspore {
namespace ops {
class OPS_API ZerosFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_ZEROS_H_
