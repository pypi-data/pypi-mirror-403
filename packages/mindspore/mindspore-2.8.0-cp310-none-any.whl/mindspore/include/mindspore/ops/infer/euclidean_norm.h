...
class OPS_API EuclideanNorm : public BaseOperator {
 public:
...
OPS_API abstract::AbstractBasePtr EuclideanNormInfer(const abstract::AnalysisEnginePtr &, const PrimitivePtr &primitive,
