...
class OPS_API BesselY1 : public BaseOperator {
 public:
...
OPS_API abstract::AbstractBasePtr BesselY1Infer(const abstract::AnalysisEnginePtr &, const PrimitivePtr &primitive,
