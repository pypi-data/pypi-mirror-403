 ...
 */
#ifndef MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_OPAPI_ACLNN_STACK_EXT_ACLNN_KERNEL_H_
...
#endif  // MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_OPAPI_ACLNN_STACK_EXT_ACLNN_KERNEL_H_
