...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_NSASELECTATTENTIONGRAD_CPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_NSASELECTATTENTIONGRAD_CPU_H_
...
namespace kernel {
namespace pyboost {
class NsaSelectAttentionGradCPU : public pyboost::NsaSelectAttentionGrad {
 public:
  NsaSelectAttentionGradCPU(PrimitivePtr primitive, const DeviceContext *device_context)
    : NsaSelectAttentionGrad(std::move(primitive), device_context) {}
  ~NsaSelectAttentionGradCPU() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_NSASELECTATTENTIONGRAD_CPU_H_
