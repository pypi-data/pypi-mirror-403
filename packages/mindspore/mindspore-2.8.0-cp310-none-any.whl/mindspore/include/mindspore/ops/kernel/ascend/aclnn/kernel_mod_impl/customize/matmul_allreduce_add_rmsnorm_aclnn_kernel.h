 ...
 */
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_MATMUL_ALLREDUCE_ADD_RMSNORM_ACLNN_KERNEL_MOD_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_MATMUL_ALLREDUCE_ADD_RMSNORM_ACLNN_KERNEL_MOD_H_
#include <vector>
#include <utility>
#include <string>
