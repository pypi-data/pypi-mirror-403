...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_APPLYROTARYPOSEMB_CPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_APPLYROTARYPOSEMB_CPU_H_
...
namespace kernel {
namespace pyboost {
class ApplyRotaryPosEmbCPU : public pyboost::ApplyRotaryPosEmb {
 public:
  ApplyRotaryPosEmbCPU(PrimitivePtr primitive, const DeviceContext *device_context)
    : ApplyRotaryPosEmb(std::move(primitive), device_context) {}
  ~ApplyRotaryPosEmbCPU() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_APPLYROTARYPOSEMB_CPU_H_
