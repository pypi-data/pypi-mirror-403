...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_ADDMM_CPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_ADDMM_CPU_H_
...
namespace kernel {
namespace pyboost {
class AddmmCPU : public pyboost::Addmm {
 public:
  AddmmCPU(PrimitivePtr primitive, const DeviceContext *device_context)
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_ADDMM_CPU_H_
