...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_PUTMEMSIGNAL_ASCEND_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_PUTMEMSIGNAL_ASCEND_H_
...
namespace kernel {
namespace pyboost {
class OPS_ASCEND_API PutMemSignalAscend : public pyboost::PutMemSignal {
 public:
  PutMemSignalAscend(PrimitivePtr primitive, const DeviceContext *device_context)
      : PutMemSignal(std::move(primitive), device_context) {}
  ~PutMemSignalAscend() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_PUTMEMSIGNAL_ASCEND_H_
