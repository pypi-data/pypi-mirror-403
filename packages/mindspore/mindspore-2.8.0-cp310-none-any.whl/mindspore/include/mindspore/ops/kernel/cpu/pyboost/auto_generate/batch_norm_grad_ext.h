...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_BATCHNORMGRADEXT_CPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_BATCHNORMGRADEXT_CPU_H_
...
namespace kernel {
namespace pyboost {
class BatchNormGradExtCPU : public pyboost::BatchNormGradExt {
 public:
  BatchNormGradExtCPU(PrimitivePtr primitive, const DeviceContext *device_context)
    : BatchNormGradExt(std::move(primitive), device_context) {}
  ~BatchNormGradExtCPU() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_BATCHNORMGRADEXT_CPU_H_
