...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_CROSSENTROPYLOSS_GPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_CROSSENTROPYLOSS_GPU_H_
...
namespace kernel {
namespace pyboost {
class CrossEntropyLossGPU : public pyboost::CrossEntropyLoss {
 public:
  CrossEntropyLossGPU(PrimitivePtr primitive, const DeviceContext *device_context)
    : CrossEntropyLoss(std::move(primitive), device_context) {}
  ~CrossEntropyLossGPU() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_CROSSENTROPYLOSS_GPU_H_
