...
class ApplyMomentumCpuKernelMod : public NativeCpuKernelMod {
 ...
 private:
  template <typename T>
  void LaunchApplyMomentum(const std::vector<KernelTensor *> &inputs, const std::vector<KernelTensor *> &outputs);
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_APPLY_MOMENTUM_CPU_KERNEL_H_
