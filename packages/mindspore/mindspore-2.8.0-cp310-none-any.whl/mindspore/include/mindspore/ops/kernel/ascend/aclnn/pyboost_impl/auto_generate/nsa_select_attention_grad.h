...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_NSASELECTATTENTIONGRAD_ASCEND_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_NSASELECTATTENTIONGRAD_ASCEND_H_
...
namespace kernel {
namespace pyboost {
class OPS_ASCEND_API NsaSelectAttentionGradAscend : public pyboost::NsaSelectAttentionGrad {
 public:
  NsaSelectAttentionGradAscend(PrimitivePtr primitive, const DeviceContext *device_context)
      : NsaSelectAttentionGrad(std::move(primitive), device_context) {}
  ~NsaSelectAttentionGradAscend() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_NSASELECTATTENTIONGRAD_ASCEND_H_
