...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_MLA_GPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_MLA_GPU_H_
...
namespace kernel {
namespace pyboost {
class MlaGPU : public pyboost::Mla {
 public:
  MlaGPU(PrimitivePtr primitive, const DeviceContext *device_context)
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_MLA_GPU_H_
