...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_DEQUANTSWIGLUQUANT_GPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_DEQUANTSWIGLUQUANT_GPU_H_
...
namespace kernel {
namespace pyboost {
class DequantSwigluQuantGPU : public pyboost::DequantSwigluQuant {
 public:
  DequantSwigluQuantGPU(PrimitivePtr primitive, const DeviceContext *device_context)
    : DequantSwigluQuant(std::move(primitive), device_context) {}
  ~DequantSwigluQuantGPU() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_GPU_KERNEL_PYBOOST_DEQUANTSWIGLUQUANT_GPU_H_
