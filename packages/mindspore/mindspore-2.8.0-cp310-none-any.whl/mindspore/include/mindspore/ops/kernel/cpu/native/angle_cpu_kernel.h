...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_ANGLE_CPU_KERNEL_H_
...
class AngleCpuKernelMod : public NativeCpuKernelMod {
 public:
  ...
  ~AngleCpuKernelMod() override = default;
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_ANGLE_CPU_KERNEL_H_
