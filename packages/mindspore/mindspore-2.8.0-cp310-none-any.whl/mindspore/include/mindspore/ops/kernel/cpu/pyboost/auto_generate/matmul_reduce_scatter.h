...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_MATMULREDUCESCATTER_CPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_MATMULREDUCESCATTER_CPU_H_
...
namespace kernel {
namespace pyboost {
class MatmulReduceScatterCPU : public pyboost::MatmulReduceScatter {
 public:
  MatmulReduceScatterCPU(PrimitivePtr primitive, const DeviceContext *device_context)
    : MatmulReduceScatter(std::move(primitive), device_context) {}
  ~MatmulReduceScatterCPU() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_MATMULREDUCESCATTER_CPU_H_
