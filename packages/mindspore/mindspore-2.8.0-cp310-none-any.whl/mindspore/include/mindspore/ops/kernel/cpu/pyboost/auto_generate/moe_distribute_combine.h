...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_MOEDISTRIBUTECOMBINE_CPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_MOEDISTRIBUTECOMBINE_CPU_H_
...
namespace kernel {
namespace pyboost {
class MoeDistributeCombineCPU : public pyboost::MoeDistributeCombine {
 public:
  MoeDistributeCombineCPU(PrimitivePtr primitive, const DeviceContext *device_context)
    : MoeDistributeCombine(std::move(primitive), device_context) {}
  ~MoeDistributeCombineCPU() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_MOEDISTRIBUTECOMBINE_CPU_H_
