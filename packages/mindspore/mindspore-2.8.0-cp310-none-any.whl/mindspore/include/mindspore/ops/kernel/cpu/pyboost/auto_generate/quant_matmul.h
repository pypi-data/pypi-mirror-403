...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_QUANTMATMUL_CPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_QUANTMATMUL_CPU_H_
...
namespace kernel {
namespace pyboost {
class QuantMatmulCPU : public pyboost::QuantMatmul {
 public:
  QuantMatmulCPU(PrimitivePtr primitive, const DeviceContext *device_context)
    : QuantMatmul(std::move(primitive), device_context) {}
  ~QuantMatmulCPU() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_QUANTMATMUL_CPU_H_
