...
#include "kernel/gpu/cuda_impl/cuda_class/layer_norm_grad_grad_helper.h"

namespace mindspore {
namespace kernel {
class LayerNormGradGradGpuKernelMod : public NativeGpuKernelMod {
 public:
  LayerNormGradGradGpuKernelMod() { attr_ptr_ = std::make_shared<cukernel::LayerNormGradGradAttr>(); }
 ...
 private:
  ...
  std::shared_ptr<cukernel::LayerNormGradGradAttr> attr_ptr_{nullptr};
};
}  // namespace kernel
}  // namespace mindspore
