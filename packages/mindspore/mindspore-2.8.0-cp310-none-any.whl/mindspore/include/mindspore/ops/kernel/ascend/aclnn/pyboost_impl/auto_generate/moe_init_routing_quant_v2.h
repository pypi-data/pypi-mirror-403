...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_MOEINITROUTINGQUANTV2_ASCEND_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_MOEINITROUTINGQUANTV2_ASCEND_H_

#include "include/pynative/utils/pyboost/auto_generate/moe_init_routing_quant_v2.h"
#include "ir/tensor.h"
#include "ir/scalar.h"
...
namespace kernel {
namespace pyboost {
class OPS_ASCEND_API MoeInitRoutingQuantV2Ascend : public pyboost::MoeInitRoutingQuantV2 {
 public:
  MoeInitRoutingQuantV2Ascend(PrimitivePtr primitive, const DeviceContext *device_context)
      : MoeInitRoutingQuantV2(std::move(primitive), device_context) {}
  ~MoeInitRoutingQuantV2Ascend() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_MOEINITROUTINGQUANTV2_ASCEND_H_
