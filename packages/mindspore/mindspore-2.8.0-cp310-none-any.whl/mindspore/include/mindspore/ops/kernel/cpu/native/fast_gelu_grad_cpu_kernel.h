...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_FAST_GELU_GRAD_CPU_KERNEL_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_FAST_GELU_GRAD_CPU_KERNEL_H_
...
class FastGeLUGradCpuKernelMod : public NativeCpuKernelMod, public MatchKernelHelper<FastGeLUGradCpuKernelMod> {
 public:
  ...
  ~FastGeLUGradCpuKernelMod() override = default;
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CPU_FAST_GELU_GRAD_CPU_KERNEL_H_
