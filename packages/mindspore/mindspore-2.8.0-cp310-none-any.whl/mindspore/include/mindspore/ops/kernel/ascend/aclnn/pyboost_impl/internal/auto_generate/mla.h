...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_INTERNAL_MLA_ASCEND_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_INTERNAL_MLA_ASCEND_H_
...
namespace kernel {
namespace pyboost {
class OPS_ASCEND_API InternalMlaAscend : public pyboost::Mla {
 public:
  InternalMlaAscend(PrimitivePtr primitive, const DeviceContext *device_context)
      : Mla(std::move(primitive), device_context) {}
  ~InternalMlaAscend() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_ASCEND_KERNEL_PYBOOST_INTERNAL_MLA_ASCEND_H_
