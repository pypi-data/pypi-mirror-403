 ...
 */
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CONV1D_EXT_ACLNN_KERNEL_MOD_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CONV1D_EXT_ACLNN_KERNEL_MOD_H_
#include <vector>
#include <memory>
#include <utility>
...
class Conv1DExtAscend : public AclnnKernelMod {
 public:
  Conv1DExtAscend() : AclnnKernelMod(std::move("aclnnConvolution")) {}
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_CONV1D_EXT_ACLNN_KERNEL_MOD_H_
