...
#ifndef MINDSPORE_OPS_PRIMITIVE_CONV_POOL_OP_NAME_H_
#define MINDSPORE_OPS_PRIMITIVE_CONV_POOL_OP_NAME_H_
...
constexpr auto kConv2DExtGradOpName = "ConvolutionGrad";
...
#endif  // MINDSPORE_OPS_PRIMITIVE_CONV_POOL_OP_NAME_H_
