...
DECLARE_OP_ADAPTER(LayerNormV4)
DECLARE_OP_USE_INPUT_ATTR(LayerNormV4)
DECLARE_OP_USE_OUTPUT(LayerNormV4)
...
DECLARE_OP_ADAPTER(AddRmsNorm)
DECLARE_OP_USE_OUTPUT(AddRmsNorm)
