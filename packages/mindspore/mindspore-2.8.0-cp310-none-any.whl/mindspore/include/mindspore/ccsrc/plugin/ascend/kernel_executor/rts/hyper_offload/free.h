...
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_RTS_FREE_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_RTS_FREE_H_
#include <memory>
#include <vector>
...
namespace mindspore {
namespace kernel {
class FreeKernel : public RtKernel {
 public:
  FreeKernel() = default;
  ~FreeKernel() override {}
...
MS_REG_RTKERNEL(free, FreeKernel);
}  // namespace kernel
}  // namespace mindspore
