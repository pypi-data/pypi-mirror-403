...
#ifndef MINDSPORE_OPS_KERNEL_COMMON_MS_FACTORY_H_
#define MINDSPORE_OPS_KERNEL_COMMON_MS_FACTORY_H_
...
#include <utility>
#include <vector>
#include "include/runtime/hardware_abstract/kernel_base/kernel_factory.h"
...
#define MS_KERNEL_FACTORY_REG(BASE_CLASS, NAME, DERIVE_CLASS)                                                          \
  ...
  static const kernel::KernelRegistrar<BASE_CLASS> g_##NAME##_##BASE_CLASS##_reg(                                      \
    #NAME, []() { return std::make_shared<DERIVE_CLASS>(); })

#define MS_KERNEL_FACTORY_REG_BY_CREATOR(BASE_CLASS, NAME, CREATOR) \
  static const kernel::KernelRegistrar<BASE_CLASS> g_##NAME##_##BASE_CLASS##_reg(#NAME, CREATOR)
...
#endif  // MINDSPORE_OPS_KERNEL_COMMON_MS_FACTORY_H_
