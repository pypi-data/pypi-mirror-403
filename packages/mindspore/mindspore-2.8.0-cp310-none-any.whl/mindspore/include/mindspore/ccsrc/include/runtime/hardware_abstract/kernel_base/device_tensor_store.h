...
#ifndef MINDSPORE_CCSRC_INCLUDE_RUNTIMR_HARDWARE_ABSTRACT_KERNEL_BASE_DEVICE_TENSOR_STORE_H_
#define MINDSPORE_CCSRC_INCLUDE_RUNTIMR_HARDWARE_ABSTRACT_KERNEL_BASE_DEVICE_TENSOR_STORE_H_
...
class RUNTIME_HARDWARE_EXPORT DeviceTensorStore {
 public:
