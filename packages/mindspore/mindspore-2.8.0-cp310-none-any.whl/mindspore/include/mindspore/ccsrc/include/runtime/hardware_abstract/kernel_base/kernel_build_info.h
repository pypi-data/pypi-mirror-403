...
#ifndef MINDSPORE_OPS_COMMON_KERNEL_BUILD_INFO_H_
#define MINDSPORE_OPS_COMMON_KERNEL_BUILD_INFO_H_
#include <iostream>
#include <vector>
#include <memory>
#include <string>
...
class RUNTIME_HARDWARE_EXPORT KernelBuildInfo::KernelBuildInfoBuilder {
 public:
...
#endif  // MINDSPORE_OPS_COMMON_KERNEL_BUILD_INFO_H_
