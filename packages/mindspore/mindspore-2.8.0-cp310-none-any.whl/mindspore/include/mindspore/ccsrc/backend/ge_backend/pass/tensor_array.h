...
#ifndef MINDSPORE_CCSRC_BACKEND_GE_BACKEND_PASS_TENSOR_ARRAY_H_
#define MINDSPORE_CCSRC_BACKEND_GE_BACKEND_PASS_TENSOR_ARRAY_H_
...
#endif  // MINDSPORE_CCSRC_BACKEND_GE_BACKEND_PASS_TENSOR_ARRAY_H_
