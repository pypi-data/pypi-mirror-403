...
#ifndef MINDSPORE_CCSRC_BACKEND_GE_BACKEND_PASS_CENTRALIZATION_MINDIR_H_
#define MINDSPORE_CCSRC_BACKEND_GE_BACKEND_PASS_CENTRALIZATION_MINDIR_H_
...
#endif  // MINDSPORE_CCSRC_BACKEND_GE_BACKEND_PASS_CENTRALIZATION_MINDIR_H_
