 ...
 */
#ifndef MINDSPORE_CCSRC_BACKEND_GE_BACKEND_PASS_MAKETUPLE_DEPEND_REMOVER_H_
...
namespace mindspore {
namespace opt {
class MakeTupleDependRemover : public PatternToPatternPass {
 public:
  MakeTupleDependRemover() : PatternToPatternPass("maketuple_depend_remover", true) {}
  ~MakeTupleDependRemover() override = default;
...
#endif  // MINDSPORE_CCSRC_BACKEND_GE_BACKEND_PASS_MAKETUPLE_DEPEND_REMOVER_H_
