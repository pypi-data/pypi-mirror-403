 ...
 */
#ifndef MINDSPORE_CCSRC_FRONTEND_JIT_PI_GRAPH_CAPTURE_LOCAL_LIVENESS_H
#define MINDSPORE_CCSRC_FRONTEND_JIT_PI_GRAPH_CAPTURE_LOCAL_LIVENESS_H

#include <vector>
#include "frontend/jit/pi/utils/bitmap.h"
