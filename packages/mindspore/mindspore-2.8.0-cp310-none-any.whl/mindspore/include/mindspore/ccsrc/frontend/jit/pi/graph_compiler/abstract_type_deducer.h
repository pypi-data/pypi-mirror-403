 ...
 */
#ifndef MINDSPORE_CCSRC_FRONTEND_JIT_PI_ABSTRACT_TYPE_DEDUCER_H_
#define MINDSPORE_CCSRC_FRONTEND_JIT_PI_ABSTRACT_TYPE_DEDUCER_H_
...
#endif  // MINDSPORE_CCSRC_FRONTEND_JIT_PI_ABSTRACT_TYPE_DEDUCER_H_
