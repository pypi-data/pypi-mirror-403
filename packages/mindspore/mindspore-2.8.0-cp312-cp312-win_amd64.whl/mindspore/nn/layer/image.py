...
class ImageGradients(Cell):
    r"""
    `nn.ImageGradients` is deprecated from version 2.8.0
    and will be removed in a future version, please use :func:`mindspore.ops.conv2d` instead.
    ...
    Examples:
        ...
        [[[[1, 0],
           [1, 0]]]]))
    """
    @deprecated("2.8.0", "ops.conv2d", False)
    def __init__(self):
        super().__init__()
