 ...
 */
#ifndef MINDSPORE_CCSRC_FRONTEND_JIT_PI_OPCODE_DECLARE_H
#define MINDSPORE_CCSRC_FRONTEND_JIT_PI_OPCODE_DECLARE_H
...
#endif  // MINDSPORE_CCSRC_FRONTEND_JIT_PI_OPCODE_DECLARE_H
