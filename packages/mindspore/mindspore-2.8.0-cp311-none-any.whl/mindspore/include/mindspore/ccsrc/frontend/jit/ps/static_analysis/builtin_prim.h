...
#ifndef MINDSPORE_CCSRC_FRONTEND_JIT_STATIC_ANALYSIS_BUILTIN_PRIM_H_
#define MINDSPORE_CCSRC_FRONTEND_JIT_STATIC_ANALYSIS_BUILTIN_PRIM_H_
...
#endif  // MINDSPORE_CCSRC_FRONTEND_JIT_STATIC_ANALYSIS_BUILTIN_PRIM_H_
