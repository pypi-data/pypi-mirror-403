 ...
 */
#ifndef MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_SYMMETRIC_MEMORY_KERNEL_SYMMETRIC_MEMORY_OP_CACHE_H_
#define MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_SYMMETRIC_MEMORY_KERNEL_SYMMETRIC_MEMORY_OP_CACHE_H_
...
struct TilingCacheItem {
  ...
  symmetricmemory::TilingInfoPtr tiling_info_;
  void *host_addr_;
  size_t size_;

  TilingCacheItem(const symmetricmemory::TilingInfoPtr &tiling_info, void *host_addr, size_t size)
...
class SymmetricMemoryTilingCache {
 public:
  SymmetricMemoryTilingCache() = default;
  ~SymmetricMemoryTilingCache() = default;

  static SymmetricMemoryTilingCache &GetInstance() {
    static SymmetricMemoryTilingCache tiling_cache;
    return tiling_cache;
  }
...
#endif  // MINDSPORE_CCSRC_BACKEND_KERNEL_COMPILER_SYMMETRIC_MEMORY_KERNEL_SYMMETRIC_MEMORY_OP_CACHE_H_
