...
class OPS_API MaxUnpool2D : public BaseOperator {
 public:
...
OPS_API abstract::AbstractBasePtr MaxUnpool2DInfer(const abstract::AnalysisEnginePtr &, const PrimitivePtr &primitive,
