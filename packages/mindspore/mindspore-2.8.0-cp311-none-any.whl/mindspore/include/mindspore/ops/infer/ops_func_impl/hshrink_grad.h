...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_HSHRINK_GRAD_H_
#define MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_HSHRINK_GRAD_H_
...
namespace mindspore {
namespace ops {
class OPS_API HShrinkGradFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_HSHRINK_GRAD_H_
