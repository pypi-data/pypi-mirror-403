...
#ifndef MINDSPORE_CORE_OPS_SPARSE_MATRIX_NNZ_H_
#define MINDSPORE_CORE_OPS_SPARSE_MATRIX_NNZ_H_
#include <memory>
#include <vector>
...
class OPS_API SparseMatrixNNZ : public BaseOperator {
 public:
  ...
  /// \brief Constructor.
  SparseMatrixNNZ() : BaseOperator(kNameSparseMatrixNNZ) {
...
#endif  // MINDSPORE_CORE_OPS_SPARSE_MATRIX_NNZ_H_
