...
#ifndef MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_NORMAL_FLOAT_FLOAT_H_
...
namespace mindspore {
namespace ops {
class OPS_API NormalFloatFloatFuncImpl : public OpFuncImpl {
 public:
...
#endif  // MINDSPORE_CORE_OPS_OPS_FUNC_IMPL_NORMAL_FLOAT_FLOAT_H_
