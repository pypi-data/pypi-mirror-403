...
#ifndef MS_KERNELS_SYMMETRIC_MEMORY_KERNEL_TILING_INFO_H_
#define MS_KERNELS_SYMMETRIC_MEMORY_KERNEL_TILING_INFO_H_
...
#endif  // MS_KERNELS_SYMMETRIC_MEMORY_KERNEL_TILING_INFO_H_
