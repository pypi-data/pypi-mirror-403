 ...
 */
#ifndef MINDSPORE_CCSRC_BACKEND_COMMON_PASS_REPLACE_ADDN_FUSION_H_
#define MINDSPORE_CCSRC_BACKEND_COMMON_PASS_REPLACE_ADDN_FUSION_H_
...
#endif  // MINDSPORE_CCSRC_BACKEND_COMMON_PASS_REPLACE_ADDN_FUSION_H_
