 ...
 */
#ifndef MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_IGAMMA_CPU_KERNEL_H_
#define MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_IGAMMA_CPU_KERNEL_H_
#include <map>
#include <vector>
#include <array>
#include <cmath>
...
class IgammaCpuKernelMod : public NativeCpuKernelMod {
 public:
...
#endif  // MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_IGAMMA_CPU_KERNEL_H_
