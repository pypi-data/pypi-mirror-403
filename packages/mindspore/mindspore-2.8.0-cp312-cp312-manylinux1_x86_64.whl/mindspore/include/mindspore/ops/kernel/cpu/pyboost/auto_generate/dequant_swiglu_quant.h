...
#ifndef MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_DEQUANTSWIGLUQUANT_CPU_H_
#define MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_DEQUANTSWIGLUQUANT_CPU_H_
...
namespace kernel {
namespace pyboost {
class DequantSwigluQuantCPU : public pyboost::DequantSwigluQuant {
 public:
  DequantSwigluQuantCPU(PrimitivePtr primitive, const DeviceContext *device_context)
    : DequantSwigluQuant(std::move(primitive), device_context) {}
  ~DequantSwigluQuantCPU() = default;
...
#endif  // MINDSPORE_MINDSPORE_CCSRC_PLUGIN_DEVICE_CPU_KERNEL_PYBOOST_DEQUANTSWIGLUQUANT_CPU_H_
