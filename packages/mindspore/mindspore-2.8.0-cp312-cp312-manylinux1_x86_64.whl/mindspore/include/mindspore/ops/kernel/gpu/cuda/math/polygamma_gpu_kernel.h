...
#include <functional>
#include <map>
#include "mindspore/ops/infer/polygamma.h"
...
namespace mindspore {
namespace kernel {
class PolygammaGpuKernelMod : public NativeGpuKernelMod {
 public:
  PolygammaGpuKernelMod() { ResetResource(); }
  ~PolygammaGpuKernelMod() override = default;
 ...
 private:
  ...
  using PolygammaFunc =
    std::function<bool(PolygammaGpuKernelMod *, const std::vector<kernel::KernelTensor *> &,
