...
#ifndef MINDSPORE_OPS_PRIMITIVE_NN_OPTIMIZER_OP_NAME_H_
#define MINDSPORE_OPS_PRIMITIVE_NN_OPTIMIZER_OP_NAME_H_
...
#endif  // MINDSPORE_OPS_PRIMITIVE_NN_OPTIMIZER_OP_NAME_H_
