...
ENVIRONMENTS: Dict[str, str] = {
    "production": "https://api.webit.live",
    "staging": "https://api.staging.webit.live",
}
...
class Nimbleway(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        This automatically infers the `api_key` argument from the `WEBIT_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("WEBIT_API_KEY")
