...
Install kitconcept.contactblock with uv.

```shell
uv add kitconcept.contactblock
```
...
- [Issue tracker](https://github.com/kitconcept/volto-contact-block/issues)
- [Source code](https://github.com/kitconcept/volto-contact-block/)
...
1.  Clone this repository.
    ...
    cd volto-contact-block/backend
    ```
...
Generated from the [`cookieplone-templates`  template](https://github.com/plone/cookieplone-templates/tree/main/) on 2025-12-08 13:50:17.. A special thanks to all contributors and supporters!
