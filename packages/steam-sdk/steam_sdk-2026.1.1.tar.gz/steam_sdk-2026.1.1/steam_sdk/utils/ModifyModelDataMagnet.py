...
=======
    ...
    #    Path(__file__).parent.parent.parent.parent, "steam_models/magnets")
...
>>>>>>> Stashed changes
    ...
    for model_name in model_names:
        ...
        if os.path.isfile(yaml_file):
            ...
            model_data.Options_FiQuS.multipole.geometry.electromagnetics.with_iron_yoke = True

            
            model_data.Options_FiQuS.multipole.geometry.electromagnetics.with_wedges = True

            model_data.Options_FiQuS.multipole.mesh.electromagnetics.iron_field.enabled = True

            model_data.Options_FiQuS.multipole.mesh.electromagnetics.bore_field.enabled = True

            model_data.Options_FiQuS.multipole.geometry.thermal.correct_block_coil_tsa_checkered_scheme = True
