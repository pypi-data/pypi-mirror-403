...
class CACStrandSolveFormulationparameters(BaseModel):
    ...
    formulation: Literal['CATI', 'AI_uncoupled'] = Field(
        default='CATI',
        description="Which formulation? CATI is the default and usual choice (was named CATI before -> to be changed from now on) to model hysteresis/coupling/eddy currents with the CATI method."
