...
To install pySimpleMask, run this command in your terminal:

.. code-block:: console

    $ pip install pysimplemask

This is the preferred method to install pySimpleMask, as it will always install the most recent stable release.
...
The sources for pySimpleMask can be downloaded from the `Github repo`_.
