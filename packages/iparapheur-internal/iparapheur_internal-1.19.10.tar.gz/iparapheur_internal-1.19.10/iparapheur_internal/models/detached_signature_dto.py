...
class DetachedSignatureDto(BaseModel):
    """
    ...
    signature_info: Optional[ValidatedSignatureInformationDto] = Field(default=None, alias="signatureInfo")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DetachedSignatureDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DetachedSignatureDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "signatureInfo": ValidatedSignatureInformationDto.from_dict(obj["signatureInfo"]) if obj.get("signatureInfo") is not None else None
        })
        return _obj
