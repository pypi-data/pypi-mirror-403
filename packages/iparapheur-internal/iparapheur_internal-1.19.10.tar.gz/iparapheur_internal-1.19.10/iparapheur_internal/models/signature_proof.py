...
class SignatureProof(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "index", "pageCount", "contentLength", "mediaType", "pagesProperties", "documentType", "pdfVisualId", "signaturePlacementAnnotations", "signatureTags", "sealTags", "detachedSignatures", "embeddedSignatureInfos", "proofTargetTaskId", "errorMessage", "internal", "deletable"]
