...
class TransferTaskParams(BaseModel):
    """
    Target desk ID that will have to perform the action.
    """ # noqa: E501
    ...
    target_desk_id: Optional[StrictStr] = Field(default=None, alias="targetDeskId")
    __properties: ClassVar[List[str]] = ["publicAnnotation", "privateAnnotation", "metadata", "targetDeskId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransferTaskParams from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransferTaskParams from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "targetDeskId": obj.get("targetDeskId")
        })
        return _obj
