...
class MetadataRepresentation(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "key", "index", "type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MetadataRepresentation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MetadataRepresentation from a dict"""
        if obj is None:
            return None
