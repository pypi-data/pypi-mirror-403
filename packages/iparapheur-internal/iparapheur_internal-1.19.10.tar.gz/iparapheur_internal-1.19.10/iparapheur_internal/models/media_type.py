...
class MediaType(BaseModel):
    ...
    quality_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="qualityValue")
    ...
    subtype_suffix: Optional[StrictStr] = Field(default=None, alias="subtypeSuffix")
    charset: Optional[StrictStr] = None
    concrete: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["type", "subtype", "parameters", "qualityValue", "wildcardType", "wildcardSubtype", "subtypeSuffix", "charset", "concrete"]
