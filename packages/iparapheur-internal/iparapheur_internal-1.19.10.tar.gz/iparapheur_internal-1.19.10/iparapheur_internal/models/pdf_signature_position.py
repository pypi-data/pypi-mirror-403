...
class PdfSignaturePosition(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["x", "y", "page", "pageHeight", "pageWidth"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PdfSignaturePosition from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PdfSignaturePosition from a dict"""
        if obj is None:
            return None
