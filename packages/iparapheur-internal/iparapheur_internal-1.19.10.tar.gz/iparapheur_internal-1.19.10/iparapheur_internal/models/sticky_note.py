...
class StickyNote(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "page", "width", "height", "x", "y", "pageRotation", "pageWidth", "pageHeight", "rectangleOrigin", "content"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StickyNote from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StickyNote from a dict"""
        if obj is None:
            return None
