...
class PasswordResetRequest(BaseModel):
    ...
    """ # noqa: E501
    previous_password: Optional[StrictStr] = Field(default=None, alias="previousPassword")
    new_password: Optional[StrictStr] = Field(default=None, alias="newPassword")
    __properties: ClassVar[List[str]] = ["previousPassword", "newPassword"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "previousPassword": obj.get("previousPassword"),
