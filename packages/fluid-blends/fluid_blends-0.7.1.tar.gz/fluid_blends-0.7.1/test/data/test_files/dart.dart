...
void main() {
  ...
  final inputStream = InputFileStream(param1);
...
String message = 'The word $text has ${text.length} letters';

Function mapOp(int addBy) {
...
final handler = const Pipeline()
    ...
    .addHandler(_yourHandlerFunction);

Future<Response> handler(Request req) async {
  final userPath = req.url.queryParameters['fileName'];
  final file = LocalFileSystem().file(userPath);
}
