...
class MCPSubServerBinding(BaseModel):
    """
    Represents a binding between an MCP server and an MCP sub server
    """ # noqa: E501
    subserver_id: StrictStr
    capabilities: List[MCPCapabilityBinding]
    __properties: ClassVar[List[str]] = ["subserver_id", "capabilities"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subserver_id": obj.get("subserver_id"),
            "capabilities": [MCPCapabilityBinding.from_dict(_item) for _item in obj["capabilities"]] if obj.get("capabilities") is not None else None
        })
        return _obj
