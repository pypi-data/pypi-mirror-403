...
class FlowSessionTaskResponseMetadata(BaseModel):
    ...
    task_input: StrictStr = Field(description="Task input")
    agent: StrictStr = Field(description="Agent that executed the task")
    task_response: StrictStr = Field(description="Task response")
