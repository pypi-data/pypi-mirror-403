...
class JiraAssigneesResponse(BaseModel):
    """
    JiraAssigneesResponse
    """ # noqa: E501
    assignees: List[JiraAssigneeResponse]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignees": [JiraAssigneeResponse.from_dict(_item) for _item in obj["assignees"]] if obj.get("assignees") is not None else None
        })
        return _obj
