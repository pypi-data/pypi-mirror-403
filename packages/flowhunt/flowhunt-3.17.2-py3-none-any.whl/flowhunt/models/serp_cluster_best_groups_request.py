...
class SerpClusterBestGroupsRequest(BaseModel):
    ...
    min_queries_count: Optional[StrictInt] = Field(default=3, description="Minimum queries count")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "min_queries_count": obj.get("min_queries_count") if obj.get("min_queries_count") is not None else 3
        })
        return _obj
