...
class FlowVersionHistoryResponse(BaseModel):
    ...
    version_nr: Optional[StrictInt] = Field(default=None, description="version number")
    ...
    user: Optional[UserResponse] = Field(default=None, description="User details")
    branch: StrictStr = Field(description="Agent branch")
    created_at: Optional[datetime] = Field(default=None, description="Created at")
    commit_title: Optional[StrictStr] = Field(default=None, description="Commit title")
