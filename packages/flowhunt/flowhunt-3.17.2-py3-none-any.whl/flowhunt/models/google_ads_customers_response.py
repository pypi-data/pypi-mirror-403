...
class GoogleAdsCustomersResponse(BaseModel):
    """
    GoogleAdsCustomersResponse
    """ # noqa: E501
    customers: List[GoogleAdsCustomerResponse] = Field(description="List of Google Ads Customers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customers": [GoogleAdsCustomerResponse.from_dict(_item) for _item in obj["customers"]] if obj.get("customers") is not None else None
        })
        return _obj
