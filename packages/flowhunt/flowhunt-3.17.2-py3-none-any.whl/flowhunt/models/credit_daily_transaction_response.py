...
class CreditDailyTransactionResponse(BaseModel):
    """
    CreditDailyTransactionResponse
    """ # noqa: E501
    created_at: datetime = Field(description="Transactions from date")
    workspace_id: StrictStr = Field(description="Workspace ID")
    transaction_type: TransactionType = Field(description="Transaction type")
    amount: StrictInt = Field(description="Amount of credits")
    cnt: StrictInt = Field(description="Number of transactions")
    __properties: ClassVar[List[str]] = ["created_at", "workspace_id", "transaction_type", "amount", "cnt"]
