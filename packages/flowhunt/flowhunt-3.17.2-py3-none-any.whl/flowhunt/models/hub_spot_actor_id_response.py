...
class HubSpotActorIdResponse(BaseModel):
    """
    HubSpotActorIdResponse
    """ # noqa: E501
    actor_id: StrictStr = Field(description="Actor ID")
    actor_email: StrictStr = Field(description="Actor Email")
    __properties: ClassVar[List[str]] = ["actor_id", "actor_email"]
