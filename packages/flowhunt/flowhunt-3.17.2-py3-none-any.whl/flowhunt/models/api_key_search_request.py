...
class ApiKeySearchRequest(BaseModel):
    ...
    ApiKeySearchRequest
    """ # noqa: E501
    api_key_id: Optional[StrictStr] = Field(default=None, description="API Key ID - not the same as api key")
    display_name: Optional[StrictStr] = Field(default=None, description="User defined name of the API key")
    mask: Optional[StrictStr] = Field(default=None, description="Masked API key")
