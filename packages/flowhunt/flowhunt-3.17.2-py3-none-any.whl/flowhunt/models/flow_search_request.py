...
class FlowSearchRequest(BaseModel):
    ...
    FlowSearchRequest
    """ # noqa: E501
    flow_type: Optional[FlowType] = Field(default=None, description="The agent type")
    name: Optional[StrictStr] = Field(default=None, description="The agent name")
    category_id: Optional[StrictStr] = Field(default=None, description="The category ID")
    limit: Optional[StrictInt] = Field(default=100, description="The maximum number of agents to return")
