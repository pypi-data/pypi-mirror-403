...
class MicrosoftPowerBiDatasetsResponse(BaseModel):
    """
    MicrosoftPowerBiDatasetsResponse
    """ # noqa: E501
    datasets: List[MicrosoftPowerBiDatasetResponse]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "datasets": [MicrosoftPowerBiDatasetResponse.from_dict(_item) for _item in obj["datasets"]] if obj.get("datasets") is not None else None
        })
        return _obj
