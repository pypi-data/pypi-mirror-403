...
class WixMembersResponse(BaseModel):
    """
    WixMembersResponse
    """ # noqa: E501
    members: List[WixMemberResponse]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "members": [WixMemberResponse.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None
        })
        return _obj
