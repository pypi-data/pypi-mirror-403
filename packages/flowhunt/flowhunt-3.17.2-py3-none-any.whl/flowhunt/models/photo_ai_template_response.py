...
class PhotoAITemplateResponse(BaseModel):
    """
    PhotoAITemplateResponse
    """ # noqa: E501
    name: StrictStr
    cover_image: StrictStr
    prompt: StrictStr
    model: StrictStr
    styles: List[StrictStr]
    effects: List[StrictStr]
    __properties: ClassVar[List[str]] = ["name", "cover_image", "prompt", "model", "styles", "effects"]
