...
class JiraTransitionsResponse(BaseModel):
    ...
    """ # noqa: E501
    transitions: List[JiraTransitionResponse]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "transitions": [JiraTransitionResponse.from_dict(_item) for _item in obj["transitions"]] if obj.get("transitions") is not None else None
        })
        return _obj
