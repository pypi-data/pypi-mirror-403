...
class TrackingEventCreateRequests(BaseModel):
    ...
    with_address: Optional[StrictBool] = Field(default=False, description="The flag to indicate if the source should be created with the address")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "with_address": obj.get("with_address") if obj.get("with_address") is not None else False,
            "ga": obj.get("ga")
        })
        return _obj
