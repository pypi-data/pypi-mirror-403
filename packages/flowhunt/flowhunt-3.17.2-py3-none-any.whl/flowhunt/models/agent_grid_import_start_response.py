...
class AgentGridImportStartResponse(BaseModel):
    """
    Schema for CSV import start response.
    """ # noqa: E501
    import_id: StrictStr = Field(description="Unique identifier for tracking the import")
    total_rows: StrictInt = Field(description="Total number of rows to import")
    message: StrictStr = Field(description="Status message")
    __properties: ClassVar[List[str]] = ["import_id", "total_rows", "message"]
