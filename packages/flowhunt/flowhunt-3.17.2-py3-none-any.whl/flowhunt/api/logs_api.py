...
class LogsApi:
    ...
    def search_logs(
        ...
        logs_search_request: LogsSearchRequest,
        ...
        :param logs_search_request: (required)
        :type logs_search_request: LogsSearchRequest
        ...
        _param = self._search_logs_serialize(
            ...
            logs_search_request=logs_search_request,
    ...
    def _search_logs_serialize(
        ...
        if logs_search_request is not None:
            _body_params = logs_search_request
