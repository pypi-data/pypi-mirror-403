...
class TestTrackingEventResponse(unittest.TestCase):
    """TrackingEventResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrackingEventResponse:
        """Test TrackingEventResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrackingEventResponse`
        """
        model = TrackingEventResponse()
        if include_optional:
    ...
    def testTrackingEventResponse(self):
        """Test TrackingEventResponse"""
