...
------------ | ------------- | ------------- | -------------
*AgentGridsApi* | [**create_agent_grid**](docs/AgentGridsApi.md#create_agent_grid) | **POST** /v2/agent_grids/ | Create a Flow Table
*AgentGridsApi* | [**delete_agent_grid**](docs/AgentGridsApi.md#delete_agent_grid) | **DELETE** /v2/agent_grids/{agent_grid_id} | Delete a Flow Table
*AgentGridsApi* | [**delete_row**](docs/AgentGridsApi.md#delete_row) | **DELETE** /v2/agent_grids/{agent_grid_id}/rows/{row_id} | Delete a row
*AgentGridsApi* | [**get_agent_grid**](docs/AgentGridsApi.md#get_agent_grid) | **GET** /v2/agent_grids/{agent_grid_id} | Get a Flow Table
*AgentGridsApi* | [**get_agent_grid_preview**](docs/AgentGridsApi.md#get_agent_grid_preview) | **GET** /v2/agent_grids/{agent_grid_id}/preview | Get Flow Table preview
*AgentGridsApi* | [**get_import_status**](docs/AgentGridsApi.md#get_import_status) | **GET** /v2/agent_grids/{agent_grid_id}/import-status/{import_id} | Get import status
*AgentGridsApi* | [**import_csv**](docs/AgentGridsApi.md#import_csv) | **POST** /v2/agent_grids/{agent_grid_id}/import-csv | Import CSV
*AgentGridsApi* | [**insert_row**](docs/AgentGridsApi.md#insert_row) | **POST** /v2/agent_grids/{agent_grid_id}/rows | Insert a row
*AgentGridsApi* | [**insert_rows_bulk**](docs/AgentGridsApi.md#insert_rows_bulk) | **POST** /v2/agent_grids/{agent_grid_id}/rows/bulk | Bulk insert rows
*AgentGridsApi* | [**list_agent_grids**](docs/AgentGridsApi.md#list_agent_grids) | **GET** /v2/agent_grids/ | List all Flow Tables
*AgentGridsApi* | [**search_rows**](docs/AgentGridsApi.md#search_rows) | **POST** /v2/agent_grids/{agent_grid_id}/search | Search rows
*AirtableApi* | [**get_airtable_bases**](docs/AirtableApi.md#get_airtable_bases) | **GET** /v2/integrations/airtable/ | Get Airtable Bases
*AirtableApi* | [**get_airtable_tables**](docs/AirtableApi.md#get_airtable_tables) | **GET** /v2/integrations/airtable/bases/{base_id}/tables | Get Airtable Tables
...
*AtlassianApi* | [**get_confluence_pages**](docs/AtlassianApi.md#get_confluence_pages) | **GET** /v2/integrations/atlassian/confluence/spaces/{space_key}/pages | Get Confluence Pages
*AtlassianApi* | [**get_confluence_spaces**](docs/AtlassianApi.md#get_confluence_spaces) | **GET** /v2/integrations/atlassian/confluence/spaces | Get Confluence Spaces
*AtlassianApi* | [**get_jira_assignees**](docs/AtlassianApi.md#get_jira_assignees) | **GET** /v2/integrations/atlassian/jira/projects/{project_key}/assignees | Get Jira Assignees
*AtlassianApi* | [**get_jira_issues**](docs/AtlassianApi.md#get_jira_issues) | **GET** /v2/integrations/atlassian/jira/projects/{project_key}/issues | Get Jira Issues
*AtlassianApi* | [**get_jira_projects**](docs/AtlassianApi.md#get_jira_projects) | **GET** /v2/integrations/atlassian/jira/projects | Get Jira Projects
*AtlassianApi* | [**get_jira_transitions**](docs/AtlassianApi.md#get_jira_transitions) | **GET** /v2/integrations/atlassian/jira/issues/{issue_key}/transitions | Get Jira Transitions
...
*CreditsApi* | [**get_daily_chart_data**](docs/CreditsApi.md#get_daily_chart_data) | **POST** /v2/credits/daily/chart | Get Daily Chart Data
...
*FlowAssistantV3Api* | [**create_v3_flow_assistant_session**](docs/FlowAssistantV3Api.md#create_v3_flow_assistant_session) | **POST** /v3/flow-assistants/create | Create V3 Flow Assistant Session
*FlowAssistantV3Api* | [**invoke_v3_flow_assistant_response**](docs/FlowAssistantV3Api.md#invoke_v3_flow_assistant_response) | **POST** /v3/flow-assistants/{session_id}/invoke | Invoke V3 Flow Assistant Response
*FlowAssistantV3Api* | [**poll_v3_flow_assistant_response**](docs/FlowAssistantV3Api.md#poll_v3_flow_assistant_response) | **POST** /v3/flow-assistants/{session_id}/invocation_response/{from_timestamp} | Poll V3 Flow Assistant Response
...
*FlowSessionsApi* | [**search_flow_event**](docs/FlowSessionsApi.md#search_flow_event) | **POST** /v2/chatbots/sessions/search_event | Search Flow Event
...
*FlowWebhooksApi* | [**get_installation_metadata**](docs/FlowWebhooksApi.md#get_installation_metadata) | **GET** /v2/flows/webhooks/third_party_integrations/installation_metadata | Get Installation Metadata
...
*FlowsApi* | [**download_attachment**](docs/FlowsApi.md#download_attachment) | **GET** /v2/flows/sessions/{session_id}/attachments/{file_id} | Download attachment
...
*FlowsApi* | [**get_artefact_content**](docs/FlowsApi.md#get_artefact_content) | **GET** /v2/flows/sessions/{session_id}/artefacts/{artefact_id} | Get artefact content
...
*GitHubApi* | [**get_repos**](docs/GitHubApi.md#get_repos) | **GET** /v2/integrations/github/repos | Get Repos
...
*IntegrationsApi* | [**get_airtable_bases**](docs/IntegrationsApi.md#get_airtable_bases) | **GET** /v2/integrations/airtable/ | Get Airtable Bases
*IntegrationsApi* | [**get_airtable_tables**](docs/IntegrationsApi.md#get_airtable_tables) | **GET** /v2/integrations/airtable/bases/{base_id}/tables | Get Airtable Tables
...
*IntegrationsApi* | [**get_confluence_pages**](docs/IntegrationsApi.md#get_confluence_pages) | **GET** /v2/integrations/atlassian/confluence/spaces/{space_key}/pages | Get Confluence Pages
*IntegrationsApi* | [**get_confluence_spaces**](docs/IntegrationsApi.md#get_confluence_spaces) | **GET** /v2/integrations/atlassian/confluence/spaces | Get Confluence Spaces
...
*IntegrationsApi* | [**get_jira_assignees**](docs/IntegrationsApi.md#get_jira_assignees) | **GET** /v2/integrations/atlassian/jira/projects/{project_key}/assignees | Get Jira Assignees
*IntegrationsApi* | [**get_jira_issues**](docs/IntegrationsApi.md#get_jira_issues) | **GET** /v2/integrations/atlassian/jira/projects/{project_key}/issues | Get Jira Issues
*IntegrationsApi* | [**get_jira_projects**](docs/IntegrationsApi.md#get_jira_projects) | **GET** /v2/integrations/atlassian/jira/projects | Get Jira Projects
*IntegrationsApi* | [**get_jira_transitions**](docs/IntegrationsApi.md#get_jira_transitions) | **GET** /v2/integrations/atlassian/jira/issues/{issue_key}/transitions | Get Jira Transitions
*IntegrationsApi* | [**get_members**](docs/IntegrationsApi.md#get_members) | **GET** /v2/integrations/wix/members | Get Members
...
*IntegrationsApi* | [**get_repos**](docs/IntegrationsApi.md#get_repos) | **GET** /v2/integrations/github/repos | Get Repos
...
*MemoryApi* | [**get_offloaded_content**](docs/MemoryApi.md#get_offloaded_content) | **POST** /v2/memory/node/{node_id}/offload/{offload_id} | Get Offloaded Content
...
*MemoryApi* | [**upload_memory_node_document**](docs/MemoryApi.md#upload_memory_node_document) | **POST** /v2/memory/upload/{cat_id} | Upload Memory Node Document
...
*PromptsApi* | [**optimize_prompt**](docs/PromptsApi.md#optimize_prompt) | **POST** /v2/prompts/optimize | Optimize Prompt
...
*SchedulesApi* | [**delete_schedule_url**](docs/SchedulesApi.md#delete_schedule_url) | **DELETE** /v2/schedules/{schedule_id}/urls/{domain_id}/{url_id} | Delete Schedule Url
...
*WixApi* | [**get_members**](docs/WixApi.md#get_members) | **GET** /v2/integrations/wix/members | Get Members
...
*WorkspacesApi* | [**transfer_workspace_ownership**](docs/WorkspacesApi.md#transfer_workspace_ownership) | **POST** /v2/workspaces/{workspace_id}/transfer-ownership/{new_owner_user_id} | Transfer Workspace Ownership
...
*V3Api* | [**check_migration_readiness**](docs/V3Api.md#check_migration_readiness) | **GET** /v3/flows/{flow_id}/migration-readiness | Check Migration Readiness
*V3Api* | [**create_v3_flow_assistant_session**](docs/V3Api.md#create_v3_flow_assistant_session) | **POST** /v3/flow-assistants/create | Create V3 Flow Assistant Session
*V3Api* | [**get_all_components_v3**](docs/V3Api.md#get_all_components_v3) | **GET** /v3/flows/components/all | Get All Components V3
*V3Api* | [**get_tool**](docs/V3Api.md#get_tool) | **GET** /v3/tools/{step_name} | Get Tool
*V3Api* | [**get_v3_components**](docs/V3Api.md#get_v3_components) | **GET** /v3/flows/components/v3 | Get V3 Components
*V3Api* | [**invoke_v3_flow_assistant_response**](docs/V3Api.md#invoke_v3_flow_assistant_response) | **POST** /v3/flow-assistants/{session_id}/invoke | Invoke V3 Flow Assistant Response
*V3Api* | [**list_tools**](docs/V3Api.md#list_tools) | **GET** /v3/tools | List Tools
*V3Api* | [**migrate_flow_to_v3**](docs/V3Api.md#migrate_flow_to_v3) | **POST** /v3/flows/{flow_id}/migrate-to-v3 | Migrate Flow To V3
*V3Api* | [**poll_v3_flow_assistant_response**](docs/V3Api.md#poll_v3_flow_assistant_response) | **POST** /v3/flow-assistants/{session_id}/invocation_response/{from_timestamp} | Poll V3 Flow Assistant Response
*V3Api* | [**validate_component**](docs/V3Api.md#validate_component) | **POST** /v3/flows/components/{component_id}/validate | Validate Component
*V3Api* | [**validate_flow**](docs/V3Api.md#validate_flow) | **POST** /v3/flows/validate | Validate Flow
