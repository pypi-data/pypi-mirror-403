...
class MicrosoftPowerBiTablesResponse(BaseModel):
    """
    MicrosoftPowerBiTablesResponse
    """ # noqa: E501
    tables: List[MicrosoftPowerBiTableResponse]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tables": [MicrosoftPowerBiTableResponse.from_dict(_item) for _item in obj["tables"]] if obj.get("tables") is not None else None
        })
        return _obj
