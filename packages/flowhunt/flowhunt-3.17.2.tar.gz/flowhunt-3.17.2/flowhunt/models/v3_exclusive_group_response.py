...
class V3ExclusiveGroupResponse(BaseModel):
    """
    Response schema for an exclusive group definition.
    """ # noqa: E501
    name: StrictStr = Field(description="Exclusive group identifier")
    ...
    __properties: ClassVar[List[str]] = ["name", "display_name", "description"]
