...
class ChatbotUpdateRequest(BaseModel):
    ...
    chatbot_position: Optional[Annotated[str, Field(strict=True, max_length=2)]] = Field(default=None, description="Chatbot position (BR, BL, TR, TL)")
    text_direction: Optional[Annotated[str, Field(strict=True, max_length=1)]] = Field(default=None, description="Text direction (A=Auto, L=LTR, R=RTL)")
