...
class GoogleAdsCampaignsResponse(BaseModel):
    """
    GoogleAdsCampaignsResponse
    """ # noqa: E501
    campaigns: List[GoogleAdsCampaignResponse] = Field(description="List of Google Ads Campaigns")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "campaigns": [GoogleAdsCampaignResponse.from_dict(_item) for _item in obj["campaigns"]] if obj.get("campaigns") is not None else None
        })
        return _obj
