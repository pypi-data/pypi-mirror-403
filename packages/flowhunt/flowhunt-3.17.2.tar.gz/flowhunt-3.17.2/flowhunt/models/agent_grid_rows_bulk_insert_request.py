...
class AgentGridRowsBulkInsertRequest(BaseModel):
    """
    Schema for bulk inserting rows into an agent grid.
    """ # noqa: E501
    rows: Annotated[List[Dict[str, Any]], Field(min_length=1, max_length=1000)] = Field(description="List of rows to insert")
