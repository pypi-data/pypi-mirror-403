...
class CreditDailyChartDataRow(BaseModel):
    """
    ...
    transaction_types: Dict[str, StrictInt] = Field(description="Dictionary of transaction type codes to their total amounts")
    __properties: ClassVar[List[str]] = ["date", "transaction_types"]
