...
class GoogleAdsRecommendationsRequest(BaseModel):
    ...
    campaign_id: Optional[StrictStr] = Field(default=None, description="Campaign id to get recommendations for")
    group_id: Optional[StrictStr] = Field(default=None, description="Group id to get recommendations for")
