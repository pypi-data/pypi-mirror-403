...
class PerDaySessionDurationResponse(BaseModel):
    """
    PerDaySessionDurationResponse
    """ # noqa: E501
    var_date: StrictStr = Field(description="Date in YYYY-MM-DD format", alias="date")
    average_duration: Optional[Union[StrictFloat, StrictInt]] = Field(default=0.0, description="Average session duration in seconds")
    session_count: Optional[StrictInt] = Field(default=0, description="Count of unique sessions (visitor count)")
    __properties: ClassVar[List[str]] = ["date", "average_duration", "session_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "date": obj.get("date"),
            "average_duration": obj.get("average_duration") if obj.get("average_duration") is not None else 0.0,
