...
class GoogleSheetsResponse(BaseModel):
    ...
    """ # noqa: E501
    sheets: List[GoogleSheetResponse]
    __properties: ClassVar[List[str]] = ["sheets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sheets": [GoogleSheetResponse.from_dict(_item) for _item in obj["sheets"]] if obj.get("sheets") is not None else None
        })
        return _obj
