...
class GoogleCalendarsResponse(BaseModel):
    ...
    """ # noqa: E501
    calendars: List[GoogleCalendarResponse]
    __properties: ClassVar[List[str]] = ["calendars"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "calendars": [GoogleCalendarResponse.from_dict(_item) for _item in obj["calendars"]] if obj.get("calendars") is not None else None
        })
        return _obj
