...
class DocumentSearchRequest(BaseModel):
    ...
    doc_name: Optional[StrictStr] = Field(default=None, description="Document name")
    doc_type: Optional[DocumentType] = Field(default=None, description="Document type")
    status: Optional[DocumentStatus] = Field(default=None, description="System status")
    user_status: Optional[UserDocumentStatus] = Field(default=None, description="User defined status of document")
    updated_at_from: Optional[datetime] = Field(default=None, description="Updated at from")
    updated_at_to: Optional[datetime] = Field(default=None, description="Updated at to")
