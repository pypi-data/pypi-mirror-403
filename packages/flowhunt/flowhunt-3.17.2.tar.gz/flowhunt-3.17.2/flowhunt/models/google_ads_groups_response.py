...
class GoogleAdsGroupsResponse(BaseModel):
    """
    GoogleAdsGroupsResponse
    """ # noqa: E501
    groups: List[GoogleAdsGroupResponse] = Field(description="List of Google Ads Groups")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [GoogleAdsGroupResponse.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj
