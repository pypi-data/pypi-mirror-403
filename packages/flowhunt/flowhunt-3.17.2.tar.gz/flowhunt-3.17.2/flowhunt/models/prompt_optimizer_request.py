...
class PromptOptimizerRequest(BaseModel):
    ...
    """ # noqa: E501
    prompt_text: StrictStr = Field(description="The prompt text to be optimized")
    user_instructions: Optional[StrictStr] = Field(default=None, description="Instructions for optimization")
    __properties: ClassVar[List[str]] = ["prompt_text", "user_instructions"]
