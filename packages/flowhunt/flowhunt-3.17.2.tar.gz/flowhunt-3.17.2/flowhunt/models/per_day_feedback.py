...
class PerDayFeedback(BaseModel):
    """
    PerDayFeedback
    """ # noqa: E501
    var_date: StrictStr = Field(description="Date in YYYY-MM-DD format", alias="date")
    positive: Optional[StrictInt] = Field(default=0, description="Count of positive feedback")
    negative: Optional[StrictInt] = Field(default=0, description="Count of negative feedback")
