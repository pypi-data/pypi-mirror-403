...
class SerpClusterGroupSearchRequest(BaseModel):
    ...
    """ # noqa: E501
    search: Optional[StrictStr] = Field(default=None, description="Search string for group name")
    ...
    include_negative_keywords: Optional[StrictBool] = Field(default=None, description="Include negative keywords")
