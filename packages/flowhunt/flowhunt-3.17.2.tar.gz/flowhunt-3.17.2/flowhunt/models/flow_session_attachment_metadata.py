...
class FlowSessionAttachmentMetadata(BaseModel):
    """
    FlowSessionAttachmentMetadata
    """ # noqa: E501
    file_id: StrictStr = Field(description="File ID")
    ...
    __properties: ClassVar[List[str]] = ["file_id", "file_name", "file_type", "document_type"]
