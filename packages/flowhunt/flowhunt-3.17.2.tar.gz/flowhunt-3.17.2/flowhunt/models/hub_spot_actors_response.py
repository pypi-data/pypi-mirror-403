...
class HubSpotActorsResponse(BaseModel):
    """
    HubSpotActorsResponse
    """ # noqa: E501
    actors: List[HubSpotActorIdResponse]
    __properties: ClassVar[List[str]] = ["actors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actors": [HubSpotActorIdResponse.from_dict(_item) for _item in obj["actors"]] if obj.get("actors") is not None else None
        })
        return _obj
