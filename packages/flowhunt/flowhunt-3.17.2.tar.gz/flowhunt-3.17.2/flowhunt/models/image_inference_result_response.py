...
class ImageInferenceResultResponse(BaseModel):
    ...
    """ # noqa: E501
    result: Optional[ImageInferenceResponse] = Field(default=None, description="The list of inference results")
    status: StrictStr = Field(description="Whether the inference is completed")
    error_message: Optional[StrictStr] = Field(default=None, description="The error message if the inference failed")
