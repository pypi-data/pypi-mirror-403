...
class FlowMessageFeedbackResponse(BaseModel):
    """
    FlowMessageFeedbackResponse
    """ # noqa: E501
    response_message: StrictStr = Field(description="Response message")
    __properties: ClassVar[List[str]] = ["response_message"]
