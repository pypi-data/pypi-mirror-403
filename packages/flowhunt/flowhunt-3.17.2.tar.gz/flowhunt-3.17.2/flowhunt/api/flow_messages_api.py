...
class FlowMessagesApi:
    ...
    def search_flow_messages(
        ...
        _param = self._search_flow_messages_serialize(
    ...
    @validate_call
    def search_flow_messages_with_http_info(
        self,
        session_id: StrictStr,
        workspace_id: StrictStr,
        _request_timeout: Union[
    ...
    @validate_call
    def search_flow_messages_without_preload_content(
        self,
        session_id: StrictStr,
        workspace_id: StrictStr,
        _request_timeout: Union[
    ...
    def _search_flow_messages_serialize(
        self,
        session_id,
        workspace_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v2/chatbots/search/{session_id}',
