...
class ChromeFlagsManager(BlinkFlagsManager):
	...
	def set_arguments(self, arguments: ChromeArguments):
		...
		Args:
			arguments (ChromeArguments): A dictionary of arguments to set.
	...
	def set_attributes(self, attributes: ChromeAttributes):
		"""
		Clears existing and sets new browser attributes from a dictionary.

		Args:
			attributes (ChromeAttributes): A dictionary of attributes to set.
	...
	def set_experimental_options(self, experimental_options: ChromeExperimentalOptions):
		...
		Args:
			experimental_options (ChromeExperimentalOptions): A dictionary of experimental options to set.
	...
	def set_flags(self, flags: ChromeFlags):
		"""
		Clears all existing flags and sets new ones, including Chrome features.
	...
	def update_blink_features(self, blink_features: BlinkFeatures):
		"""
		Updates Chrome features from a dictionary without clearing existing ones.

		Args:
			blink_features (BlinkFeatures): A dictionary of Chrome features to set or update.
