...
"""Framework plugin registry for the Passwordless module."""
...
PLUGIN_ENTRYPOINT_GROUP = "rapidkit.modules.free.auth.passwordless.plugins"
...
def register_plugin(plugin_class: Type[FrameworkPlugin]) -> None:
    """Register a framework plugin for the Passwordless module."""
