"""Framework plugin registry for the Api Keys module."""
...
PLUGIN_ENTRYPOINT_GROUP = "rapidkit.modules.free.auth.api_keys.plugins"
...
def register_plugin(plugin_class: Type[FrameworkPlugin]) -> None:
    """Register a framework plugin for the Api Keys module."""
