#!/usr/bin/env python3
"""Generate a small demo project for Passwordless.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/passwordless-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/passwordless-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("passwordless-" + args.variant)
