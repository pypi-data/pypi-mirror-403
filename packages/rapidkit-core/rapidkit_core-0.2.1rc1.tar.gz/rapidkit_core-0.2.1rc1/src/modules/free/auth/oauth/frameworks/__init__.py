...
"""Framework plugin registry for the OAuth module."""
...
PLUGIN_ENTRYPOINT_GROUP = "rapidkit.modules.free.auth.oauth.plugins"
...
def register_plugin(plugin_class: Type[FrameworkPlugin]) -> None:
    """Register a framework plugin for the Oauth module."""
