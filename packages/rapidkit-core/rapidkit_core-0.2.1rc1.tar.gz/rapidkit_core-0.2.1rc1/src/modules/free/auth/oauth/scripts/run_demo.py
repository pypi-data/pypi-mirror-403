#!/usr/bin/env python3
"""Generate a small demo project for Oauth.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/oauth-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/oauth-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("oauth-" + args.variant)
