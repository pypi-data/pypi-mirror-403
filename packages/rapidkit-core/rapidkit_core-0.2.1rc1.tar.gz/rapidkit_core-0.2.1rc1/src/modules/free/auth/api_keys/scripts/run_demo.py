#!/usr/bin/env python3
"""Generate a small demo project for API Keys.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/api_keys-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/api_keys-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("api_keys-" + args.variant)
