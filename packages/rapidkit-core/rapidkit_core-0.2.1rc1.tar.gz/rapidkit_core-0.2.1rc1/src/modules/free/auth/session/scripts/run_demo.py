#!/usr/bin/env python3
"""Generate a small demo project for Session.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/session-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/session-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("session-" + args.variant)
