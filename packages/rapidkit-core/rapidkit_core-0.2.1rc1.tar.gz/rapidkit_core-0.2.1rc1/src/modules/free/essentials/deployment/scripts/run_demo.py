#!/usr/bin/env python3
"""Generate a small demo project for Deployment.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/deployment-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/deployment-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("deployment-" + args.variant)
