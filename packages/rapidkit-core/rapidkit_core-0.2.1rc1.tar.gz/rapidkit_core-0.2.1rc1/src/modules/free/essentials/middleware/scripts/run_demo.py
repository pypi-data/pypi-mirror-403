#!/usr/bin/env python3
"""Generate a small demo project for Middleware.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/middleware-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/middleware-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("middleware-" + args.variant)
