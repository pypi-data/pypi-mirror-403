#!/usr/bin/env python3
"""Generate a small demo project for Logging.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/logging-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/logging-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("logging-" + args.variant)
