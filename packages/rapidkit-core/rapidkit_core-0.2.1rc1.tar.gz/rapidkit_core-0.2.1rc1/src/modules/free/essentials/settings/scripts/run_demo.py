#!/usr/bin/env python3
"""Generate a small demo project for Settings.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/settings-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/settings-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("settings-" + args.variant)
