#!/usr/bin/env python3
"""Generate a small demo project for Rate Limiting.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/rate_limiting-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/rate_limiting-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("rate_limiting-" + args.variant)
