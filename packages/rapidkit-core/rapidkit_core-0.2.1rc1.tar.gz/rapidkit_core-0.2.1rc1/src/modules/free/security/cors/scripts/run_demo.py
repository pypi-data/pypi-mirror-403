#!/usr/bin/env python3
"""Generate a small demo project for Cors.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/cors-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/cors-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("cors-" + args.variant)
