"""Framework plugin registry for the Observability Core module."""
...
PLUGIN_ENTRYPOINT_GROUP = "rapidkit.modules.free.observability.observability_core.plugins"
...
def register_plugin(plugin_class: Type[FrameworkPlugin]) -> None:
    """Register a framework plugin for Observability Core."""
