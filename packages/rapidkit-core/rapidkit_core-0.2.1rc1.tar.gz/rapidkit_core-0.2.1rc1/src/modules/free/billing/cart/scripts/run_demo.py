#!/usr/bin/env python3
"""Generate a small demo project for Cart.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/cart-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/cart-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("cart-" + args.variant)
