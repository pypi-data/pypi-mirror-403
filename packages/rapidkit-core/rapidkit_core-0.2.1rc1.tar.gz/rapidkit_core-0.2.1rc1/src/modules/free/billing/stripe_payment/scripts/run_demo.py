#!/usr/bin/env python3
"""Generate a small demo project for Stripe Payment.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/stripe_payment-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/stripe_payment-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("stripe_payment-" + args.variant)
