#!/usr/bin/env python3
"""Generate a small demo project for Users Core.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/users_core-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/users_core-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("users_core-" + args.variant)
