#!/usr/bin/env python3
"""Generate a small demo project for PostgreSQL.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/db_postgres-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/db_postgres-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("db_postgres-" + args.variant)
