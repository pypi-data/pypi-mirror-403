"""Framework plugin registry for the Db Sqlite module."""
...
PLUGIN_ENTRYPOINT_GROUP = "rapidkit.modules.free.database.db_sqlite.plugins"
...
def register_plugin(plugin_class: Type[FrameworkPlugin]) -> None:
    """Register a framework plugin for Db Sqlite."""
