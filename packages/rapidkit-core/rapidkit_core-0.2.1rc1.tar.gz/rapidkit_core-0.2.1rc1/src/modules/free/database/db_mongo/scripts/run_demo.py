#!/usr/bin/env python3
"""Generate a small demo project for Db Mongo.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/db_mongo-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/db_mongo-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("db_mongo-" + args.variant)
