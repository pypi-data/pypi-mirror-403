#!/usr/bin/env python3
"""Generate a small demo project for Redis.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/redis-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/redis-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("redis-" + args.variant)
