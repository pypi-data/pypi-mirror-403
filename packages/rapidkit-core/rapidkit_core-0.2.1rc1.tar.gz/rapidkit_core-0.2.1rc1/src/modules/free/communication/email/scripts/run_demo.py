#!/usr/bin/env python3
"""Generate a small demo project for Email.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/email-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/email-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("email-" + args.variant)
