#!/usr/bin/env python3
"""Generate a small demo project for Notifications.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/notifications-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/notifications-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("notifications-" + args.variant)
