#!/usr/bin/env python3
"""Generate a small demo project for Security Headers.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/security_headers-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/security_headers-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("security_headers-" + args.variant)
