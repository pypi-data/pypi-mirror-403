# Cors Module Documentation

This directory contains the canonical documentation set for the cors module. Keep guidance concise,
actionable, and synchronised with the generator outputs.
