...
"""Framework plugin registry for the Cors module."""
...
PLUGIN_ENTRYPOINT_GROUP = "rapidkit.modules.free.security.cors.plugins"
...
def register_plugin(plugin_class: Type[FrameworkPlugin]) -> None:
    """Register a framework plugin for the Cors module."""
...
# Populate the registry with built-in plugins on import to ensure availability for generator CLI.
