...
"""Framework plugin registry for the Rate Limiting module."""
...
PLUGIN_ENTRYPOINT_GROUP = "rapidkit.modules.free.security.rate_limiting.plugins"
...
def register_plugin(plugin_class: Type[FrameworkPlugin]) -> None:
    """Register a framework plugin for the Rate Limiting module."""
