#!/usr/bin/env python3
"""Generate a small demo project for Users Profiles.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/users_profiles-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/users_profiles-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("users_profiles-" + args.variant)
