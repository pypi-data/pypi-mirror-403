...
"""FastAPI framework plugin for the Session module."""
...
class FastAPIPlugin(FrameworkPlugin):
    """Plugin for generating FastAPI-oriented session management integrations."""
    ...
    def pre_generation_hook(self, output_dir: Path) -> None:
        ...
        (output_dir / "tests" / "modules" / "integration" / "auth" / "session").mkdir(
        ...
        ensure_health_package(
            output_dir,
            extra_imports=[("src.health.session", "register_session_health")],
        )
