#!/usr/bin/env python3
"""Generate a small demo project for Inventory.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/inventory-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/inventory-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("inventory-" + args.variant)
