"""Framework plugin registry for the Stripe Payment module."""
...
PLUGIN_ENTRYPOINT_GROUP = "rapidkit.modules.free.billing.stripe_payment.plugins"
...
def refresh_plugin_registry(*, auto_discover: bool = True) -> None:
    """Repopulate the plugin registry with builtins and discovered entry points."""
