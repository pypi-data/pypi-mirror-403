...
"""Framework plugin registry for the Storage module."""
...
PLUGIN_ENTRYPOINT_GROUP = "rapidkit.modules.free.business.storage.plugins"
...
def register_plugin(plugin_class: Type[FrameworkPlugin]) -> None:
    """Register a framework plugin for the Storage module."""
