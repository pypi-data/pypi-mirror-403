...
"""Framework plugin registry for the Celery module."""
...
PLUGIN_ENTRYPOINT_GROUP = "rapidkit.modules.free.tasks.celery.plugins"
...
def register_plugin(plugin_class: Type[FrameworkPlugin]) -> None:
    """Register a framework plugin for the Celery module."""
