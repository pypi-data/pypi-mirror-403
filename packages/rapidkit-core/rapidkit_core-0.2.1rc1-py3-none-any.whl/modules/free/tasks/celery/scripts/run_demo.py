#!/usr/bin/env python3
"""Generate a small demo project for Celery.
...
Usage:
  ...
  python scripts/run_demo.py fastapi ./tmp/celery-fastapi
"""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        nargs="?",
        default=None,
        help="Target output directory (default: ./tmp/celery-<variant>)",
    )
    ...
    default_out = project_root / "tmp" / ("celery-" + args.variant)
