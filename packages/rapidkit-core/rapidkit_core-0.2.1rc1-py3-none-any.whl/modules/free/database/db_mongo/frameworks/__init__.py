"""Framework plugin registry for the Db Mongo module."""
...
PLUGIN_ENTRYPOINT_GROUP = "rapidkit.modules.free.database.db_mongo.plugins"
...
def register_plugin(plugin_class: Type[FrameworkPlugin]) -> None:
    """Register a framework plugin for Db Mongo."""
