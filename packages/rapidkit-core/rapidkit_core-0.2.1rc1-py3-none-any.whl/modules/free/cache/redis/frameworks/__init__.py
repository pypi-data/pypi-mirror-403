...
"""Framework plugin registry for the Redis module."""
...
PLUGIN_ENTRYPOINT_GROUP = "rapidkit.modules.free.cache.redis.plugins"
...
def register_plugin(plugin_class: Type[FrameworkPlugin]) -> None:
    """Register a framework plugin for the Redis module."""
