...
class OutputCreater:
  """
  OutputCreater is used to create output object.
  """

  @classmethod
  def reject(cls,message:str)->STDOut:
    return STDOut(500,f'ability plan execute error: {message}')

  @classmethod
  def resolve(cls,results:list[Any]|dict[str,Any])->STDOut:
