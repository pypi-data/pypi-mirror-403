...
def pdl_match(matched, root, pattern_name, *, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(PDLMatchOp(matched=matched, root=root, pattern_name=pattern_name, loc=loc, ip=ip))
...
def with_pdl_patterns(*, root=None, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(WithPDLPatternsOp(root=root, loc=loc, ip=ip))
