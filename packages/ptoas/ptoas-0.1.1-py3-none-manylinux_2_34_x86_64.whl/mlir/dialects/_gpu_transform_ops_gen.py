...
def apply_patterns_gpu_gpu_rewrite_patterns(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ApplyGPURewritePatternsOp(loc=loc, ip=ip))
...
def apply_conversion_patterns_gpu_gpu_subgroup_reduce_to_nvvm(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ApplyGPUSubgroupReduceToNVVMConversionPatternsOp(loc=loc, ip=ip))
...
def apply_conversion_patterns_gpu_gpu_to_nvvm(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ApplyGPUToNVVMConversionPatternsOp(loc=loc, ip=ip))
...
def apply_conversion_patterns_gpu_gpu_wmma_to_nvvm(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ApplyGPUWwmaToNVVMConversionPatternsOp(loc=loc, ip=ip))
...
def apply_patterns_gpu_unroll_vectors_subgroup_mma(m, n, k, *, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(ApplyUnrollVectorsSubgroupMmaOp(m=m, n=n, k=k, loc=loc, ip=ip))
...
def apply_patterns_gpu_eliminate_barriers(*, loc=None, ip=None) -> _ods_ir.Operation:
  return _get_op_result_or_op_results(EliminateBarriersOp(loc=loc, ip=ip))
...
def gpu_map_forall_to_blocks(result, target, *, grid_dims=None, generate_gpu_launch=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(MapForallToBlocks(result=result, target=target, grid_dims=grid_dims, generate_gpu_launch=generate_gpu_launch, loc=loc, ip=ip))
...
def gpu_map_nested_forall_to_threads(result, target, *, block_dims=None, sync_after_distribute=None, warp_size=None, loc=None, ip=None) -> _ods_ir.Value:
  return _get_op_result_or_op_results(MapNestedForallToThreads(result=result, target=target, block_dims=block_dims, sync_after_distribute=sync_after_distribute, warp_size=warp_size, loc=loc, ip=ip))
