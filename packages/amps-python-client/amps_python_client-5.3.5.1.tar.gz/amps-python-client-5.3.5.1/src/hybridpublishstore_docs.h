...
static const char* hybridpublishstore_class_doc = R"docstring(HybridPublishStore(filename, maxMemoryCapacity, errorOnPublishGap, blockSize)
...
:type maxMemoryCapacity: unsigned long
