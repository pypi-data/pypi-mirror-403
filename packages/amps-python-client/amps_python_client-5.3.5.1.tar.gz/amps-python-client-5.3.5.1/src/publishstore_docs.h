...
////////////////////////////////////////////////////////////////////////////
//
static const char* publishstore_class_doc = R"docstring("PublishStore
A publish store that keeps messages on disk.
...
static const char*  truncate_on_close_doc  = R"docstring(truncate_on_close()
Sets if the :class:`PublishStore` should truncate the file to initial capacity when it closes if it is empty.
)docstring";
