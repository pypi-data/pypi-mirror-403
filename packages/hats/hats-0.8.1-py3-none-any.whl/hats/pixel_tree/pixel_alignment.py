...
def _add_pixels_until(
    ...
    ----------
    add_from : int
        The pixel number to add pixels from
    add_to : int
        The pixel number to add pixels to
    matching_pix : np.ndarray
        The matching pixel from the side of the catalog that exists to map the new pixels
        to in the mapping
    is_left_pixel : bool
        Is the matching pixel from the left side of the alignment
    mapping : list[np.ndarray]
        The List mapping left, right, and aligned pixels to add the new pixels to
    """
...
def _add_remaining_pixels(
    ...
    ----------
    added_until : int
        Where the alignment has been added until
    pixel_list : np.ndarray
        The list of pixels from the side of the alignment to add the remaining
        pixels of
    index : int
        The index of the pixel list to add the pixels from
    is_left_pixel : bool
        Is the pixel list from left side of the alignment
    mapping : list[np.ndarray]
        The List mapping left, right, and aligned pixels to add the new pixels to
    """
