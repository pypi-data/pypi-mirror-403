...
from vlm2vec_for_pyserini.data.dataset.base_pair_dataset import AutoPairDataset, add_metainfo_hook, RESOLUTION_MAPPING, MULTIMODAL_FEATURES
from vlm2vec_for_pyserini.data.eval_dataset.video_classification_utils import DATASET_INSTRUCTION
