...
from axe_cli.soul.kimisoul import AxeSoul
from axe_cli.ui.shell.console import console
from axe_cli.utils.changelog import CHANGELOG
...
def _ensure_kimi_soul(app: Shell) -> AxeSoul | None:
...
def feedback(app: Shell, args: str):
    """Submit feedback to make Axe Code CLI better"""
    import webbrowser
