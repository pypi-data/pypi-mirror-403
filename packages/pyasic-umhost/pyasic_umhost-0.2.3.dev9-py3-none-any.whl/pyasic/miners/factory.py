...
from pyasic.miners.antminer.bosminer.X19.S19 import BOSMinerS19XPPlusHud
from pyasic.miners.antminer.epic.X19.S19 import ePICSS19XPPlusHyd
from pyasic.miners.antminer.hiveon.X19.S19 import HiveonS19XPPlusHyd
from pyasic.miners.antminer.luxos.X19.S19 import LUXMinerS19XPPlusHud
...
MINER_CLASSES: dict[MinerTypes, dict[str | None, Any]] = {
    MinerTypes.ANTMINER: {
        ...
        "ANTMINER S19 XP+ HYD.": BMMinerS19XPPlusHydro,
    ...
    MinerTypes.BRAIINS_OS: {
        ...
        "ANTMINER S19 XP PLUS HYD": BOSMinerS19XPPlusHud,
    },
    MinerTypes.VNISH: {
        None: VNish,
        "L3+": VNishL3Plus,
        ...
        "ANTMINER S19 XP PLUS HYD": VNishS19XPPlusHyd,
        ...
        "ANTMINER S21 XP HYD.": VNishS21XPHydro,
        "ANTMINER S21 XP HYDRO": VNishS21XPHydro,
    },
    MinerTypes.EPIC: {
        None: ePIC,
        ...
        "ANTMINER S19 XP PLUS HYD": ePICSS19XPPlusHyd,
    ...
    MinerTypes.HIVEON: {
        ...
        "ANTMINER S19XP PLUS HYD": HiveonS19XPPlusHyd,
    },
    MinerTypes.MSKMINER: {
        None: MSKMiner,
    ...
    MinerTypes.LUX_OS: {
        ...
        "ANTMINER S19 XP PLUS HYD": LUXMinerS19XPPlusHud,
...
class MinerFactory:
    ...
    async def get_miner_model_whatsminer(self, ip: str) -> str | None:
        ...
        if sock_json_data is not None and "DEVDETAILS" in sock_json_data:
            try:
