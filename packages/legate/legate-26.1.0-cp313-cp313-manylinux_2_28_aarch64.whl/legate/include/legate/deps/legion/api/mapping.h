...
namespace Legion {
  ...
  namespace Mapping {
    ...
    private:
      ...
      friend std::ostream& operator<<(
          std::ostream& os, const CollectiveView& p);
    };
    ...
    class MapperEvent {
    public:
      MapperEvent(void) : impl(Internal::RtUserEvent()) { }
      FRIEND_ALL_RUNTIME_CLASSES
    public:
    ...
    public:  // Task mapping calls
      ...
      virtual void select_task_options(
          MapperContext ctx, const Task& task, TaskOptions& output) = 0;
      //------------------------------------------------------------------------
      ...
      virtual void premap_task(
          MapperContext ctx, const Task& task, const PremapTaskInput& input,
      ...
      public:
        TaskSlice(void)
          : domain_is(IndexSpace::NO_SPACE), domain(Domain::NO_DOMAIN),
            proc(Processor::NO_PROC), recurse(false), stealable(false),
            take_ownership(false)
        { }
        TaskSlice(
            const Domain& d, Processor p, bool r, bool s, bool own = false)
          : domain_is(IndexSpace::NO_SPACE), domain(d), proc(p), recurse(r),
            stealable(s), take_ownership(own)
        { }
        TaskSlice(IndexSpace is, Processor p, bool r, bool s)
          : domain_is(is), domain(Domain::NO_DOMAIN), proc(p), recurse(r),
            stealable(s), take_ownership(false)
        { }
      public:
      ...
      virtual void slice_task(
          MapperContext ctx, const Task& task, const SliceTaskInput& input,
       ...
       * memories visible to all the target processors or the variant must
       * speicfy 'no_access' specialized constraints for such region
       * requirements. The mapper can specify a priority for the task with the
       * 'task_priority' field. This will allow the task to be re-ordered ahead
       * of lower priority tasks and behind higher priority tasks by the runtime
      ...
      virtual void map_task(
          MapperContext ctx, const Task& task, const MapTaskInput& input,
      ...
      //------------------------------------------------------------------------
      virtual void replicate_task(
          MapperContext ctx, const Task& task, const ReplicateTaskInput& input,
      ...
      virtual void select_task_variant(
          MapperContext ctx, const Task& task, const SelectVariantInput& input,
      ...
      virtual void postmap_task(
          MapperContext ctx, const Task& task, const PostMapInput& input,
      ...
      virtual void select_task_sources(
          MapperContext ctx, const Task& task, const SelectTaskSrcInput& input,
    ...
    public:  // Inline mapping
      ...
      virtual void map_inline(
          ...
          const MapInlineInput& input, MapInlineOutput& output) = 0;
      //------------------------------------------------------------------------
      ...
      virtual void select_inline_sources(
          MapperContext ctx, const InlineMapping& inline_op,
          const SelectInlineSrcInput& input, SelectInlineSrcOutput& output) = 0;
      //------------------------------------------------------------------------
    ...
    public:  // Region-to-region copies
      ...
      struct MapCopyOutput {
        ...
        std::vector<std::vector<PhysicalInstance> >
            src_indirect_source_instances;
        std::vector<std::vector<PhysicalInstance> >
            dst_indirect_source_instances;
      ...
      virtual void map_copy(
          MapperContext ctx, const Copy& copy, const MapCopyInput& input,
      ...
      virtual void select_copy_sources(
          MapperContext ctx, const Copy& copy, const SelectCopySrcInput& input,
    ...
    public:  // Close operations
      ...
      virtual void select_close_sources(
          ...
          const SelectCloseSrcInput& input, SelectCloseSrcOutput& output) = 0;
      //------------------------------------------------------------------------
    ...
    public:  // Acquire operations
      ...
      virtual void map_acquire(
          MapperContext ctx, const Acquire& acquire,
          const MapAcquireInput& input, MapAcquireOutput& output) = 0;
      //------------------------------------------------------------------------
    ...
    public:  // Release operations
      ...
      virtual void map_release(
          ...
          const MapReleaseInput& input, MapReleaseOutput& output) = 0;
      //------------------------------------------------------------------------
    ...
    public:  // Partition Operations
      ...
      virtual void select_partition_projection(
          MapperContext ctx, const Partition& partition,
      ...
      virtual void map_partition(
          MapperContext ctx, const Partition& partition,
          const MapPartitionInput& input, MapPartitionOutput& output) = 0;
      //------------------------------------------------------------------------
    ...
    public:  // Fill Operations
      ...
      //------------------------------------------------------------------------
      virtual void select_sharding_functor(
          MapperContext ctx, const Fill& fill,
          const SelectShardingFunctorInput& input,
          SelectShardingFunctorOutput& output) = 0;
      //------------------------------------------------------------------------
    public:  // Future Map Reductions
      ...
      virtual void map_future_map_reduction(
          MapperContext ctx, const FutureMapReductionInput& input,
    ...
    public:  // Single Task Context
      ...
      virtual void configure_context(
          MapperContext ctx, const Task& task, ContextConfigOutput& output) = 0;
      //------------------------------------------------------------------------
      ...
      virtual void select_tunable_value(
          MapperContext ctx, const Task& task, const SelectTunableInput& input,
    ...
    public:  // Mapping collections of operations
      ...
      //------------------------------------------------------------------------
      virtual void select_sharding_functor(
          MapperContext ctx, const MustEpoch& epoch,
          const SelectShardingFunctorInput& input,
      ...
      virtual void map_must_epoch(
          MapperContext ctx, const MapMustEpochInput& input,
      ...
      virtual void map_dataflow_graph(
          MapperContext ctx, const MapDataflowGraphInput& input,
    ...
    public:  // Memoizing physical analyses of operations
      ...
      virtual void memoize_operation(
          MapperContext ctx, const Mappable& mappable,
          const MemoizeInput& input, MemoizeOutput& output) = 0;
      //------------------------------------------------------------------------
    public:  // Mapping control
      ...
      virtual void select_tasks_to_map(
          MapperContext ctx, const SelectMappingInput& input,
    ...
    public:  // Stealing
      ...
      virtual void select_steal_targets(
          MapperContext ctx, const SelectStealingInput& input,
      ...
      virtual void permit_steal_request(
          MapperContext ctx, const StealRequestInput& input,
    ...
    public:  // Handling
      ...
      virtual void handle_message(
          MapperContext ctx, const MapperMessage& message) = 0;
      //------------------------------------------------------------------------
      ...
      virtual void handle_task_result(
          MapperContext ctx, const MapperTaskResult& result) = 0;
      //------------------------------------------------------------------------
       ...
       */
      //------------------------------------------------------------------------
      virtual void handle_instance_collection(
          const MapperContext ctx, const PhysicalInstance& inst)
      { }
      //------------------------------------------------------------------------
    };
    ...
    public:
      ...
      void stop_profiling_range(
          MapperContext ctx, const char* provenance) const;
    public:
      //------------------------------------------------------------------------
    ...
    public:
      ...
      bool has_mapper_event_triggered(
    ...
    public:
      ...
      bool do_constraints_entail(
          MapperContext ctx, LayoutConstraintID source,
          LayoutConstraintID target,
          const LayoutConstraint** failed_constraint = nullptr) const;
    public:
      //------------------------------------------------------------------------
      ...
      void find_generator_variants(
          MapperContext ctx, TaskID task_id,
          std::vector<std::pair<TaskID, VariantID> >& generator_variants,
          Processor::Kind kind = Processor::NO_KIND) const;
      VariantID find_or_create_variant(
          MapperContext ctx, TaskID task_id,
      ...
      const char* find_task_variant_name(
          MapperContext ctx, TaskID task_id, VariantID vid) const;
      bool is_leaf_variant(
          MapperContext ctx, TaskID task_id, VariantID variant_id) const;
      bool is_inner_variant(
          MapperContext ctx, TaskID task_id, VariantID variant_id) const;
      bool is_idempotent_variant(
          MapperContext ctx, TaskID task_id, VariantID variant_id) const;
      bool is_replicable_variant(
          MapperContext ctx, TaskID task_id, VariantID variant_id) const;
    public:
      //------------------------------------------------------------------------
      ...
      template<
          ...
          T (*TASK_PTR)(
              const Task*, const std::vector<PhysicalRegion>&, Context,
              Runtime*, const UDT&)>
      VariantID register_task_variant(
      ...
      VariantID register_task_variant(
          MapperContext ctx, const TaskVariantRegistrar& registrar,
          const CodeDescriptor& codedesc, const void* user_data = nullptr,
          size_t user_len = 0, size_t return_type_size = LEGION_MAX_RETURN_SIZE,
    ...
    public:
      ...
      bool create_physical_instance(
          ...
          bool tight_region_bounds = false, size_t* footprint = nullptr,
      ...
      bool find_or_create_physical_instance(
          ...
          const LayoutConstraintSet& constraints,
          const std::vector<LogicalRegion>& regions, PhysicalInstance& result,
          bool& created, bool acquire = true, GCPriority priority = 0,
          bool tight_region_bounds = false, size_t* footprint = nullptr,
          const LayoutConstraint** unsat = nullptr) const;
      bool find_or_create_physical_instance(
          MapperContext ctx, Memory target_memory, LayoutConstraintID layout_id,
      ...
      bool find_physical_instance(
          ...
          const LayoutConstraintSet& constraints,
          const std::vector<LogicalRegion>& regions, PhysicalInstance& result,
          bool acquire = true, bool tight_region_bounds = false) const;
      bool find_physical_instance(
          MapperContext ctx, Memory target_memory, LayoutConstraintID layout_id,
          const std::vector<LogicalRegion>& regions, PhysicalInstance& result,
          bool acquire = true, bool tight_region_bounds = false) const;
      void find_physical_instances(
          ...
          std::vector<PhysicalInstance>& results, bool acquire = false,
      ...
      bool acquire_instance(
          MapperContext ctx, const PhysicalInstance& instance) const;
      bool acquire_instances(
          MapperContext ctx, const std::vector<PhysicalInstance>& insts) const;
      bool acquire_and_filter_instances(
      ...
      bool collect_instance(
          MapperContext ctx, const PhysicalInstance& inst) const;
      ...
      bool redistrict_instance(
          MapperContext ctx, PhysicalInstance& instance,
          const LayoutConstraintSet& constraints,
          const std::vector<LogicalRegion>& regions, bool acquire = true,
          GCPriority priority = 0, bool tight_region_bounds = false);
      bool redistrict_instance(
          MapperContext ctx, PhysicalInstance& instance,
    ...
    public:
      ...
      IndexSpace create_index_space(
          MapperContext ctx, const Domain& bounds, TypeTag type_tag = 0,
          const char* provenance = nullptr, bool take_ownership = false) const;
      // Template version
      template<int DIM, typename COORD_T>
      IndexSpaceT<DIM, COORD_T> create_index_space(
          MapperContext ctx, Rect<DIM, COORD_T> bounds,
      ...
      template<int DIM, typename COORD_T>
      IndexSpaceT<DIM, COORD_T> create_index_space(
          MapperContext ctx, const std::vector<Point<DIM, COORD_T> >& points,
          const char* provenance = nullptr) const;
      ...
      template<int DIM, typename COORD_T>
      IndexSpaceT<DIM, COORD_T> create_index_space(
          MapperContext ctx, const std::vector<Rect<DIM, COORD_T> >& rects,
          const char* provenance = nullptr) const;
      ...
      IndexSpaceT<DIM, COORD_T> subtract_index_spaces(
          MapperContext ctx, IndexSpaceT<DIM, COORD_T> left,
    ...
    public:
      ...
      template<int DIM, typename COORD_T>
      bool is_index_space_empty(
          MapperContext ctx, IndexSpaceT<DIM, COORD_T> handle) const;

      bool index_spaces_overlap(
          MapperContext ctx, IndexSpace one, IndexSpace two) const;
      template<int DIM, typename COORD_T>
      bool index_spaces_overlap(
          MapperContext ctx, IndexSpaceT<DIM, COORD_T> one,
          IndexSpaceT<DIM, COORD_T> two) const;

      bool index_space_dominates(
          MapperContext ctx, IndexSpace test, IndexSpace dominator) const;
      template<int DIM, typename COORD_T>
      bool index_space_dominates(
          MapperContext ctx, IndexSpaceT<DIM, COORD_T> test,
    ...
    public:
      ...
      bool has_index_partition(
          MapperContext ctx, IndexSpace parent, Color c) const;
      ...
      Domain get_index_partition_color_space(
      ...
      void get_index_space_partition_colors(
          MapperContext ctx, IndexSpace sp, std::set<Color>& colors) const;

      bool is_index_partition_disjoint(
          MapperContext ctx, IndexPartition p) const;

      bool is_index_partition_complete(
          MapperContext ctx, IndexPartition p) const;

      Color get_index_space_color(MapperContext ctx, IndexSpace handle) const;

      DomainPoint get_index_space_color_point(
          MapperContext ctx, IndexSpace handle) const;

      Color get_index_partition_color(
          MapperContext ctx, IndexPartition handle) const;

      IndexSpace get_parent_index_space(
          MapperContext ctx, IndexPartition handle) const;

      bool has_parent_index_partition(
          MapperContext ctx, IndexSpace handle) const;

      IndexPartition get_parent_index_partition(
          MapperContext ctx, IndexSpace handle) const;

      unsigned get_index_space_depth(
          MapperContext ctx, IndexSpace handle) const;

      unsigned get_index_partition_depth(
          MapperContext ctx, IndexPartition handle) const;
    public:
      //------------------------------------------------------------------------
    ...
    public:
      ...
      LogicalPartition get_logical_partition_by_color(
          MapperContext ctx, LogicalRegion parent,
          const DomainPoint& color) const;

      LogicalPartition get_logical_partition_by_tree(
          MapperContext ctx, IndexPartition handle, FieldSpace fspace,
      ...
      LogicalRegion get_logical_subregion_by_color(
          MapperContext ctx, LogicalPartition parent, Color color) const;
      LogicalRegion get_logical_subregion_by_color(
          MapperContext ctx, LogicalPartition parent,
          const DomainPoint& color) const;
    ...
    public:
      ...
      bool retrieve_semantic_information(
          MapperContext ctx, TaskID task_id, SemanticTag tag,
          const void*& result, size_t& size, bool can_fail = false,
      ...
      void retrieve_name(
          MapperContext ctx, LogicalPartition handle,
          const char*& result) const;
    public:
      //------------------------------------------------------------------------
      ...
      const std::map<int /*rank*/, AddressSpace>& find_forward_MPI_mapping(
          MapperContext ctx) const;

      const std::map<AddressSpace, int /*rank*/>& find_reverse_MPI_mapping(
          MapperContext ctx) const;
    ...
    public:
      ...
      template<typename T>
      void pack_tunable(
          const T& result, Mapper::SelectTunableOutput& output) const
      {
        static_assert(
...
#include "legion/api/mapping.inl"
