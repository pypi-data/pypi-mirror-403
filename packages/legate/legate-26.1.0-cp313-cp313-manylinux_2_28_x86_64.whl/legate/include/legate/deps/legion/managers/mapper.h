...
#ifndef __LEGION_MAPPER_MANAGER_H__
...
namespace Legion {
  namespace Internal {
    ...
    public:
      MapperManager(
          Mapping::Mapper* mapper, MapperID map_id, Processor p,
          bool is_default);
    ...
    public:  // Inline mapper calls
      ...
      void invoke_select_inline_sources(
          ...
          Mapper::SelectInlineSrcOutput& output);
      void invoke_inline_report_profiling(
          MapOp* op, Mapper::InlineProfilingInfo& input);
    public:  // Copy mapper calls
      void invoke_map_copy(
          CopyOp* op, Mapper::MapCopyInput& input,
          Mapper::MapCopyOutput& output);
      void invoke_select_copy_sources(
    ...
    protected:
      ...
      virtual void begin_mapper_call(
          MappingCallInfo* info, bool prioritize = false) = 0;
    ...
    public:
      SerializingManager(
          Mapping::Mapper* mapper, MapperID map_id, Processor p, bool reentrant,
    ...
    public:
      MappingCallInfo(
          MapperManager* man, MappingCallKind k, Operation* op,
    ...
    public:
      ...
      inline bool is_locked(void) { return manager->is_locked(this); }
      inline void lock_mapper(bool read_only)
      {
        manager->lock_mapper(this, read_only);
      }
      inline void unlock_mapper(void) { manager->unlock_mapper(this); }
      inline bool is_reentrant(void) { return manager->is_reentrant(this); }
      inline void enable_reentrant(void) { manager->enable_reentrant(this); }
      inline void disable_reentrant(void) { manager->disable_reentrant(this); }
...
#endif  // __LEGION_MAPPER_MANAGER_H__
