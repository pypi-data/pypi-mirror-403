...
#define NEW_POINT_TYPE(DIM)                \
  typedef struct legion_point_##DIM##d_t { \
    coord_t x[DIM];                        \
  } legion_point_##DIM##d_t;
  LEGION_FOREACH_N(NEW_POINT_TYPE)
#undef NEW_POINT_TYPE

#define NEW_RECT_TYPE(DIM)                \
  typedef struct legion_rect_##DIM##d_t { \
    legion_point_##DIM##d_t lo, hi;       \
  } legion_rect_##DIM##d_t;
  LEGION_FOREACH_N(NEW_RECT_TYPE)
#undef NEW_RECT_TYPE

#define NEW_BLOCKIFY_TYPE(DIM)                \
  typedef struct legion_blockify_##DIM##d_t { \
    legion_point_##DIM##d_t block_size;       \
    legion_point_##DIM##d_t offset;           \
  } legion_blockify_##DIM##d_t;
  LEGION_FOREACH_N(NEW_BLOCKIFY_TYPE)
#undef NEW_BLOCKIFY_TYPE

#define NEW_TRANSFORM_TYPE(D1, D2)                  \
  typedef struct legion_transform_##D1##x##D2##_t { \
    coord_t trans[D1][D2];                          \
  } legion_transform_##D1##x##D2##_t;
...
#define NEW_AFFINE_TRANSFORM_TYPE(D1, D2)                  \
  typedef struct legion_affine_transform_##D1##x##D2##_t { \
    legion_transform_##D1##x##D2##_t transform;            \
    legion_point_##D1##d_t offset;                         \
...
#endif
#if MAX_MATRIX_DIM != \
    LEGION_MAX_POINT_DIM * LEGION_MAX_POINT_DIM  // sanity check
...
#undef MAX_MATRIX_DIM
   ...
   */
  typedef void (*legion_registration_callback_pointer_t)(
      legion_machine_t /* machine */, legion_runtime_t /* runtime */,
   ...
   * upper bound).
   */
  typedef legion_logical_region_t (*legion_projection_functor_logical_region_t)(
      legion_runtime_t /* runtime */, legion_logical_region_t /* upper_bound */,
      legion_domain_point_t /* point */, legion_domain_t /* launch domain */);

  /**
   * Interface for a Legion C projection functor (Logical Partition
   * upper bound).
   */
  typedef legion_logical_region_t (
  ...
  typedef legion_logical_region_t (
      *legion_projection_functor_logical_region_mappable_t)(
      legion_runtime_t /* runtime */, legion_mappable_t /* mappable */,
      unsigned /* index */, legion_logical_region_t /* upper_bound */,
  ...
  typedef legion_logical_region_t (
      *legion_projection_functor_logical_partition_mappable_t)(
      legion_runtime_t /* runtime */, legion_mappable_t /* mappable */,
      unsigned /* index */, legion_logical_partition_t /* upper_bound */,
      legion_domain_point_t /* point */);
  ...
  legion_ptr_t legion_ptr_safe_cast(
      legion_runtime_t runtime, legion_context_t ctx, legion_ptr_t pointer,
...
#define FROM_RECT(DIM) \
  legion_domain_t legion_domain_from_rect_##DIM##d(legion_rect_##DIM##d_t r);
...
#undef FROM_RECT
  ...
  legion_domain_t legion_domain_from_index_space(
      legion_runtime_t runtime, legion_index_space_t is);

  /**
   * @see Legion::Domain::get_rect()
   */
#define GET_RECT(DIM) \
  legion_rect_##DIM##d_t legion_domain_get_rect_##DIM##d(legion_domain_t d);
...
#define GET_BOUNDS(DIM) \
  legion_rect_##DIM##d_t legion_domain_get_bounds_##DIM##d(legion_domain_t d);
...
#define FROM_TRANSFORM(D1, D2)                                        \
  legion_domain_transform_t legion_domain_transform_from_##D1##x##D2( \
      legion_transform_##D1##x##D2##_t t);
...
#define FROM_AFFINE(D1, D2)                            \
  legion_domain_affine_transform_t                     \
      legion_domain_affine_transform_from_##D1##x##D2( \
          legion_affine_transform_##D1##x##D2##_t t);
...
#undef GET_POINT
  ...
  legion_domain_point_t legion_domain_point_safe_cast(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_domain_point_t point, legion_logical_region_t region);
  ...
  void legion_domain_point_iterator_destroy(
      legion_domain_point_iterator_t handle);
...
#define ITERATOR_OP(DIM)                                                   \
  legion_rect_##DIM##d_t legion_rect_in_domain_iterator_get_rect_##DIM##d( \
      legion_rect_in_domain_iterator_##DIM##d_t handle);
...
#undef ITERATOR_OP
  ...
  void legion_coloring_ensure_color(
      legion_coloring_t handle, legion_color_t color);

  /**
   * @see Legion::Coloring
   */
  void legion_coloring_add_point(
      legion_coloring_t handle, legion_color_t color, legion_ptr_t point);
  ...
  void legion_coloring_add_range(
      legion_coloring_t handle, legion_color_t color, legion_ptr_t start,
  ...
  void legion_domain_coloring_color_domain(
      legion_domain_coloring_t handle, legion_color_t color,
      legion_domain_t domain);
  ...
  legion_domain_t legion_domain_coloring_get_color_space(
      legion_domain_coloring_t handle);
  ...
  void legion_point_coloring_add_point(
      legion_point_coloring_t handle, legion_domain_point_t color,
      legion_ptr_t point);
  ...
  void legion_domain_point_coloring_color_domain(
      legion_domain_point_coloring_t handle, legion_domain_point_t color,
      legion_domain_t domain);
  ...
  void legion_multi_domain_point_coloring_color_domain(
      legion_multi_domain_point_coloring_t handle, legion_domain_point_t color,
      legion_domain_t domain);
  ...
  legion_index_space_t legion_index_space_create(
      legion_runtime_t runtime, legion_context_t ctx, size_t max_num_elmts);
  ...
  legion_index_space_t legion_index_space_create_domain(
      legion_runtime_t runtime, legion_context_t ctx, legion_domain_t domain);
  ...
  legion_index_space_t legion_index_space_create_future(
      legion_runtime_t runtime, legion_context_t ctx, size_t dimensions,
      legion_future_t future, legion_type_tag_t type_tag /*=0*/);
  ...
  legion_index_space_t legion_index_space_union(
      legion_runtime_t runtime, legion_context_t ctx,
      const legion_index_space_t* spaces, size_t num_spaces);
  ...
  legion_index_space_t legion_index_space_subtraction(
      legion_runtime_t runtime, legion_context_t ctx, legion_index_space_t left,
  ...
  bool legion_index_space_has_multiple_domains(
      legion_runtime_t runtime, legion_index_space_t handle);
  ...
  void legion_index_space_destroy_unordered(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_space_t handle, bool unordered);
  ...
  void legion_index_space_attach_name(
      legion_runtime_t runtime, legion_index_space_t handle, const char* name,
      bool is_mutable /* = false */);
  ...
  legion_index_partition_t legion_index_partition_create_coloring(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_space_t parent, legion_coloring_t coloring, bool disjoint,
  ...
  legion_index_partition_t legion_index_partition_create_domain_coloring(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_space_t parent, legion_domain_t color_space,
      legion_domain_coloring_t coloring, bool disjoint,
      legion_color_t part_color /* = AUTO_GENERATE_ID */);
   ...
   *
   * @see Legion::Runtime::create_index_partition(
   *        Context, IndexSpace, Domain, DomainPointColoring, PartitionKind,
   * int)
   */
   ...
   *
   * @see Legion::Runtime::create_index_partition(
   *        Context, IndexSpace, Domain, MultiDomainPointColoring,
   * PartitionKind, int)
   */
  legion_index_partition_t
...
#define CREATE_BLOCKIFY(DIM)                                                \
  legion_index_partition_t legion_index_partition_create_blockify_##DIM##d( \
      legion_runtime_t runtime, legion_context_t ctx,                       \
      legion_index_space_t parent, legion_blockify_##DIM##d_t blockify,     \
      legion_color_t part_color /* = AUTO_GENERATE_ID */);
...
#undef CREATE_BLOCKIFY
  ...
  legion_index_partition_t legion_index_partition_create_equal(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_space_t parent, legion_index_space_t color_space,
  ...
  legion_index_partition_t legion_index_partition_create_by_weights(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_space_t parent, legion_domain_point_t* colors, int* weights,
      size_t num_colors, legion_index_space_t color_space,
  ...
  legion_index_partition_t legion_index_partition_create_by_weights_future_map(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_space_t parent, legion_future_map_t future_map,
      legion_index_space_t color_space, size_t granularity /* = 1 */,
      legion_color_t color /* = AUTO_GENERATE_ID */);
  ...
  legion_index_partition_t legion_index_partition_create_by_union(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_space_t parent, legion_index_partition_t handle1,
      legion_index_partition_t handle2, legion_index_space_t color_space,
      legion_partition_kind_t part_kind /* = COMPUTE_KIND */,
      legion_color_t color /* = AUTO_GENERATE_ID */);
  ...
  legion_index_partition_t legion_index_partition_create_by_intersection_mirror(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_space_t parent, legion_index_partition_t handle,
      legion_partition_kind_t part_kind /* = COMPUTE_KIND */,
      legion_color_t color /* = AUTO_GENERATE_ID */,
  ...
  legion_index_partition_t legion_index_partition_create_by_domain(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_space_t parent, legion_domain_point_t* colors,
      legion_domain_t* domains, size_t num_color_domains,
      legion_index_space_t color_space, bool perform_intersections /* = true */,
      legion_partition_kind_t part_kind /* = COMPUTE_KIND */,
      legion_color_t color /* = AUTO_GENERATE_ID */);
  ...
  legion_index_partition_t legion_index_partition_create_by_field(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_logical_region_t handle, legion_logical_region_t parent,
      legion_field_id_t fid, legion_index_space_t color_space,
      legion_color_t color /* = AUTO_GENERATE_ID */,
  ...
  legion_index_partition_t legion_index_partition_create_by_image(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_space_t handle, legion_logical_partition_t projection,
      legion_logical_region_t parent, legion_field_id_t fid,
  ...
  legion_index_partition_t legion_index_partition_create_by_preimage(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_partition_t projection, legion_logical_region_t handle,
      legion_logical_region_t parent, legion_field_id_t fid,
      legion_index_space_t color_space,
      legion_partition_kind_t part_kind /* = COMPUTE_KIND */,
      legion_color_t color /* = AUTO_GENERATE_ID */,
  ...
  legion_index_partition_t legion_index_partition_create_by_restriction(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_space_t parent, legion_index_space_t color_space,
      legion_domain_transform_t transform, legion_domain_t extent,
      legion_partition_kind_t part_kind /* = COMPUTE_KIND */,
      legion_color_t color /* = AUTO_GENERATE_ID */);
  ...
  legion_index_space_t legion_index_partition_create_index_space_union_spaces(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_partition_t parent, legion_domain_point_t color,
      const legion_index_space_t* spaces, size_t num_spaces);
  ...
  legion_index_space_t legion_index_partition_create_index_space_difference(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_partition_t parent, legion_domain_point_t color,
      legion_index_space_t initial, const legion_index_space_t* spaces,
      size_t num_spaces);
  ...
  bool legion_index_partition_is_disjoint(
      legion_runtime_t runtime, legion_index_partition_t handle);
  ...
  void legion_index_partition_destroy_unordered(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_partition_t handle, bool unordered /* = false */,
      bool recurse /* = true */);
  ...
  legion_field_space_t legion_field_space_create_with_fields(
      legion_runtime_t runtime, legion_context_t ctx, size_t* field_sizes,
  ...
  void legion_field_space_destroy_unordered(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_field_space_t handle, bool unordered);

  /**
   * @see Legion::Runtime::attach_semantic_information()
   */
  void legion_field_space_attach_semantic_information(
      legion_runtime_t runtime, legion_field_space_t handle,
      legion_semantic_tag_t tag, const void* buffer, size_t size,
      bool is_mutable /* = false */);
  ...
  legion_field_id_t* legion_field_space_get_fields(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_field_space_t handle, size_t* size);
  ...
  bool legion_field_space_has_fields(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_field_space_t handle, const legion_field_id_t* fields,
      size_t fields_size);
  ...
  void legion_field_space_attach_name(
      legion_runtime_t runtime, legion_field_space_t handle, const char* name,
      bool is_mutable /* = false */);
  ...
  size_t legion_field_id_get_size(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_field_space_t handle, legion_field_id_t id);
  ...
  legion_logical_region_t legion_logical_region_create(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_space_t index, legion_field_space_t fields, bool task_local);
  ...
  void legion_logical_region_destroy_unordered(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_logical_region_t handle, bool unordered);

  /**
   * @see Legion::Runtime::get_logical_region_color()
   */
  legion_color_t legion_logical_region_get_color(
      legion_runtime_t runtime, legion_logical_region_t handle);
  ...
  legion_logical_partition_t legion_logical_partition_create(
      legion_runtime_t runtime, legion_logical_region_t parent,
      legion_index_partition_t handle);
  ...
  legion_logical_partition_t legion_logical_partition_create_by_tree(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_partition_t handle, legion_field_space_t fspace,
  ...
  void legion_logical_partition_destroy_unordered(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_logical_partition_t handle, bool unordered);
  ...
  legion_logical_region_t legion_logical_partition_get_logical_subregion(
      legion_runtime_t runtime, legion_logical_partition_t parent,
      legion_index_space_t handle);
   ...
   */
  void legion_reset_equivalence_sets(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_logical_region_t parent, legion_logical_region_t region,
      int num_fields, legion_field_id_t* fields);
  ...
  legion_region_requirement_t legion_region_requirement_create_logical_region(
      legion_logical_region_t handle, legion_privilege_mode_t priv,
      legion_coherence_property_t prop, legion_logical_region_t parent,
  ...
  legion_region_requirement_t
      legion_region_requirement_create_logical_region_projection(
          legion_logical_region_t handle, legion_projection_id_t proj /* = 0 */,
          legion_privilege_mode_t priv, legion_coherence_property_t prop,
          legion_logical_region_t parent, legion_mapping_tag_id_t tag /* = 0 */,
          bool verified /* = false*/);
  ...
  void legion_region_requirement_add_field(
      legion_region_requirement_t handle, legion_field_id_t field,
      bool instance_field);
  ...
  void legion_region_requirement_add_flags(
      legion_region_requirement_t handle, legion_region_flags_t flags);
  ...
  void legion_region_requirement_get_privilege_fields(
      legion_region_requirement_t handle, legion_field_id_t* fields,
  ...
  legion_field_id_t legion_region_requirement_get_privilege_field(
      legion_region_requirement_t handle, unsigned idx);
  ...
  legion_output_requirement_t legion_output_requirement_create(
      legion_field_space_t field_space, legion_field_id_t* fields,
  ...
  void legion_output_requirement_add_field(
      legion_output_requirement_t handle, legion_field_id_t field,
      bool instance);
  ...
  legion_logical_region_t legion_output_requirement_get_region(
      legion_output_requirement_t handle);
  ...
  legion_field_id_t legion_field_allocator_allocate_field(
      legion_field_allocator_t allocator, size_t field_size,
  ...
  legion_field_id_t legion_field_allocator_allocate_field_future(
      legion_field_allocator_t allocator, legion_future_t field_size,
      legion_field_id_t desired_fieldid /* = AUTO_GENERATE_ID */);
  ...
  void legion_field_allocator_free_field(
      legion_field_allocator_t allocator, legion_field_id_t fid);
  ...
  legion_argument_map_t legion_argument_map_from_future_map(
      legion_future_map_t map);

  /**
   * @see Legion::ArgumentMap::set_point()
   */
  void legion_argument_map_set_point(
      legion_argument_map_t map, legion_domain_point_t dp,
      legion_untyped_buffer_t arg, bool replace /* = true */);
  ...
  void legion_argument_map_set_future(
      legion_argument_map_t map, legion_domain_point_t dp,
      legion_future_t future, bool replace /* = true */);
  ...
  legion_predicate_t legion_predicate_create(
      legion_runtime_t runtime, legion_context_t ctx, legion_future_t f);
  ...
  legion_phase_barrier_t legion_phase_barrier_create(
      legion_runtime_t runtime, legion_context_t ctx, unsigned arrivals);
  ...
  legion_phase_barrier_t legion_phase_barrier_alter_arrival_count(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_phase_barrier_t handle, int delta);
  ...
  void legion_phase_barrier_arrive(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_phase_barrier_t handle, unsigned count /* = 1 */);
  ...
  legion_dynamic_collective_t legion_dynamic_collective_alter_arrival_count(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_dynamic_collective_t handle, int delta);
  ...
  void legion_dynamic_collective_arrive(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_dynamic_collective_t handle, const void* buffer, size_t size,
      unsigned count /* = 1 */);
  ...
  void legion_dynamic_collective_defer_arrival(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_dynamic_collective_t handle, legion_future_t f,
      unsigned count /* = 1 */);
  ...
  legion_future_t legion_future_from_untyped_pointer(
      legion_runtime_t runtime, const void* buffer, size_t size);
  ...
  void legion_future_wait(
      legion_future_t handle, bool silence_warnings /* = false */,
      const char* warning_string /* = nullptr */);

  /**
   * @see Legion::Future::is_empty()
   */
  bool legion_future_is_empty(legion_future_t handle, bool block /* = false */);
   ...
   */
  const void* legion_future_get_metadata(
      legion_future_t handle, size_t* size /*=nullptr*/);
  ...
  legion_future_t legion_future_map_get_future(
      legion_future_map_t handle, legion_domain_point_t point);
  ...
  legion_future_t legion_future_map_reduce(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_future_map_t handle, legion_reduction_op_id_t redop,
      bool deterministic, legion_mapper_id_t map_id,
  ...
  legion_future_t legion_future_map_reduce_with_initial_value(
      ...
      legion_future_map_t handle, legion_reduction_op_id_t redop,
      bool deterministic, legion_mapper_id_t map_id,
      legion_mapping_tag_id_t tag, const char* provenance,
  ...
  legion_future_map_t legion_future_map_construct_from_buffers(
      legion_runtime_t runtime, legion_context_t ctx, legion_domain_t domain,
      legion_domain_point_t* points, legion_untyped_buffer_t* buffers,
  ...
  legion_future_map_t legion_future_map_construct_from_futures(
      legion_runtime_t runtime, legion_context_t ctx, legion_domain_t domain,
      legion_domain_point_t* points, legion_future_t* futures,
  ...
  legion_future_map_t legion_future_map_transform(
      legion_runtime_t runtime, legion_context_t ctx, legion_future_map_t fm,
      legion_index_space_t new_domain, legion_point_transform_functor_t functor,
      bool take_ownership);
...
#define BUFFER_CREATE(DIM)                                          \
  legion_deferred_buffer_char_##DIM##d_t                            \
      legion_deferred_buffer_char_##DIM##d_create(                  \
          legion_rect_##DIM##d_t bounds, legion_memory_kind_t kind, \
          char* initial_value);
...
#undef BUFFER_DESTROY
  ...
  legion_task_launcher_t legion_task_launcher_create(
      legion_task_id_t tid, legion_untyped_buffer_t arg,
  ...
  legion_future_t legion_task_launcher_execute_outputs(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_task_launcher_t launcher, legion_output_requirement_t* reqs,
      size_t reqs_size);
  ...
  unsigned legion_task_launcher_add_region_requirement_logical_region(
      legion_task_launcher_t launcher, legion_logical_region_t handle,
      legion_privilege_mode_t priv, legion_coherence_property_t prop,
      legion_logical_region_t parent, legion_mapping_tag_id_t tag /* = 0 */,
      bool verified /* = false*/);
  ...
  void legion_task_launcher_set_region_requirement_logical_region(
      legion_task_launcher_t launcher, unsigned idx,
      legion_logical_region_t handle, legion_privilege_mode_t priv,
      legion_coherence_property_t prop, legion_logical_region_t parent,
      legion_mapping_tag_id_t tag /* = 0 */, bool verified /* = false*/);
  ...
  void legion_task_launcher_set_region_requirement_logical_region_reduction(
      legion_task_launcher_t launcher, unsigned idx,
      legion_logical_region_t handle, legion_reduction_op_id_t redop,
      legion_coherence_property_t prop, legion_logical_region_t parent,
      legion_mapping_tag_id_t tag /* = 0 */, bool verified /* = false*/);
  ...
  void legion_task_launcher_add_field(
      legion_task_launcher_t launcher, unsigned idx, legion_field_id_t fid,
      bool inst /* = true */);
  ...
  const void* legion_index_launcher_get_projection_args(
      legion_region_requirement_t requirement, size_t* size);
  ...
  unsigned legion_task_launcher_add_index_requirement(
      legion_task_launcher_t launcher, legion_index_space_t handle,
      legion_allocate_mode_t priv, legion_index_space_t parent,
      bool verified /* = false*/);
  ...
  void legion_task_launcher_add_future(
      legion_task_launcher_t launcher, legion_future_t future);

  /**
   * @see Legion::TaskLauncher::add_wait_barrier()
   */
  void legion_task_launcher_add_wait_barrier(
      legion_task_launcher_t launcher, legion_phase_barrier_t bar);
  ...
  void legion_task_launcher_set_mapper(
      legion_task_launcher_t launcher, legion_mapper_id_t mapper_id);

  /**
   * @see Legion::TaskLauncher::tag
   */
  void legion_task_launcher_set_mapping_tag(
      legion_task_launcher_t launcher, legion_mapping_tag_id_t tag);
  ...
  legion_index_launcher_t legion_index_launcher_create(
      legion_task_id_t tid, legion_domain_t domain,
      legion_untyped_buffer_t global_arg, legion_argument_map_t map,
      legion_predicate_t pred /* = legion_predicate_true() */,
  ...
  legion_index_launcher_t legion_index_launcher_create_from_buffer(
      legion_task_id_t tid, legion_domain_t domain, const void* buffer,
      size_t buffer_size, legion_argument_map_t map,
      legion_predicate_t pred /* = legion_predicate_true() */,
      bool must /* = false */, legion_mapper_id_t id /* = 0 */,
      legion_mapping_tag_id_t tag /* = 0 */);
  ...
  legion_future_t legion_index_launcher_execute_reduction(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_launcher_t launcher, legion_reduction_op_id_t redop);

  /**
   * @return Caller takes ownership of return value.
   *
   * @see Legion::Runtime::execute_index_space(Context, const IndexTaskLauncher
   * &, std::vector<OutputRequirement>*)
   */
  legion_future_map_t legion_index_launcher_execute_outputs(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_launcher_t launcher, legion_output_requirement_t* reqs,
      size_t reqs_size);
  ...
  unsigned legion_index_launcher_add_region_requirement_logical_partition(
      legion_index_launcher_t launcher, legion_logical_partition_t handle,
      legion_projection_id_t proj /* = 0 */, legion_privilege_mode_t priv,
      legion_coherence_property_t prop, legion_logical_region_t parent,
      legion_mapping_tag_id_t tag /* = 0 */, bool verified /* = false*/);
  ...
  void legion_index_launcher_set_region_requirement_logical_region(
      legion_index_launcher_t launcher, unsigned idx,
      legion_logical_region_t handle, legion_projection_id_t proj /* = 0 */,
      legion_privilege_mode_t priv, legion_coherence_property_t prop,
      legion_logical_region_t parent, legion_mapping_tag_id_t tag /* = 0 */,
      bool verified /* = false*/);
  ...
  void legion_index_launcher_set_region_requirement_logical_partition(
      legion_index_launcher_t launcher, unsigned idx,
      legion_logical_partition_t handle, legion_projection_id_t proj /* = 0 */,
      legion_privilege_mode_t priv, legion_coherence_property_t prop,
      legion_logical_region_t parent, legion_mapping_tag_id_t tag /* = 0 */,
      bool verified /* = false*/);
  ...
  void legion_index_launcher_add_field(
      legion_index_launcher_t launcher, unsigned idx, legion_field_id_t fid,
      bool inst /* = true */);
  ...
  unsigned legion_index_launcher_add_index_requirement(
      legion_index_launcher_t launcher, legion_index_space_t handle,
      legion_allocate_mode_t priv, legion_index_space_t parent,
      bool verified /* = false*/);
  ...
  void legion_index_launcher_add_future(
      legion_index_launcher_t launcher, legion_future_t future);

  /**
   * @see Legion::IndexTaskLauncher::add_wait_barrier()
   */
  void legion_index_launcher_add_wait_barrier(
      legion_index_launcher_t launcher, legion_phase_barrier_t bar);
  ...
  void legion_inline_launcher_add_field(
      legion_inline_launcher_t launcher, legion_field_id_t fid,
      bool inst /* = true */);
  ...
  void legion_inline_launcher_set_mapper_arg(
      legion_inline_launcher_t launcher, legion_untyped_buffer_t arg);

  /**
   * @see Legion::InlineLauncher::provenance
   */
  void legion_inline_launcher_set_provenance(
      legion_inline_launcher_t launcher, const char* provenance);
  ...
  void legion_runtime_fill_field_future(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_logical_region_t handle, legion_logical_region_t parent,
      legion_field_id_t fid, legion_future_t f,
      legion_predicate_t pred /* = legion_predicate_true() */);
  ...
  void legion_fill_launcher_add_field(
      legion_fill_launcher_t handle, legion_field_id_t fid);
  ...
  void legion_fill_launcher_set_point(
      legion_fill_launcher_t launcher, legion_domain_point_t point);

  /**
   * @see Legion::FillLauncher::sharding_space
   */
  void legion_fill_launcher_set_sharding_space(
      legion_fill_launcher_t launcher, legion_index_space_t space);

  /**
   * @see Legion::FillLauncher::map_arg
   */
  void legion_fill_launcher_set_mapper_arg(
      legion_fill_launcher_t launcher, legion_untyped_buffer_t arg);

  /**
   * @see Legion::FillLauncher::provenance
   */
  void legion_fill_launcher_set_provenance(
      legion_fill_launcher_t launcher, const char* provenance);
  ...
  void legion_runtime_index_fill_field(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_logical_partition_t handle, legion_logical_region_t parent,
      legion_field_id_t fid, const void* value, size_t value_size,
  ...
  void legion_runtime_index_fill_field_with_space(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_space_t space, legion_logical_partition_t handle,
      legion_logical_region_t parent, legion_field_id_t fid, const void* value,
  ...
  void legion_runtime_index_fill_field_future_with_space(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_index_space_t space, legion_logical_partition_t handle,
      legion_logical_region_t parent, legion_field_id_t fid, legion_future_t f,
      legion_projection_id_t proj /* = 0 */,
      legion_predicate_t pred /* = legion_predicate_true() */,
      legion_mapper_id_t id /* = 0 */,
      legion_mapping_tag_id_t launcher_tag /* = 0 */);
  ...
  legion_index_fill_launcher_t legion_index_fill_launcher_create_with_domain(
      legion_domain_t domain, legion_logical_partition_t handle,
      legion_logical_region_t parent, legion_field_id_t fid, const void* value,
      size_t value_size, legion_projection_id_t proj /* = 0 */,
      legion_predicate_t pred /* = legion_predicate_true() */,
      legion_mapper_id_t id /* = 0 */,
  ...
  legion_index_fill_launcher_t
      legion_index_fill_launcher_create_from_future_with_space(
          legion_index_space_t space, legion_logical_partition_t handle,
          legion_logical_region_t parent, legion_field_id_t fid,
          legion_future_t future, legion_projection_id_t proj /* = 0 */,
          legion_predicate_t pred /* = legion_predicate_true() */,
          legion_mapper_id_t id /* = 0 */,
          legion_mapping_tag_id_t launcher_tag /* = 0 */);
  ...
  void legion_index_fill_launcher_set_sharding_space(
      legion_index_fill_launcher_t launcher, legion_index_space_t space);

  /**
   * @see Legion::IndexFillLauncher::map_arg
   */
  void legion_index_fill_launcher_set_mapper_arg(
      legion_index_fill_launcher_t launcher, legion_untyped_buffer_t arg);

  /**
   * @see Legion::IndexFillLauncher::provenance
   */
  void legion_index_fill_launcher_set_provenance(
      legion_index_fill_launcher_t launcher, const char* provenance);
  ...
  void legion_discard_launcher_add_field(
      legion_discard_launcher_t handle, legion_field_id_t fid);
  ...
  void legion_discard_launcher_set_provenance(
      legion_discard_launcher_t launcher, const char* provenance);
  ...
  void legion_field_map_insert(
      legion_field_map_t handle, legion_field_id_t key, const char* value);
  ...
  legion_physical_region_t legion_runtime_attach_hdf5(
      legion_runtime_t runtime, legion_context_t ctx, const char* filename,
      legion_logical_region_t handle, legion_logical_region_t parent,
      legion_field_map_t field_map, legion_file_mode_t mode);
  ...
  unsigned legion_copy_launcher_add_src_region_requirement_logical_region(
      legion_copy_launcher_t launcher, legion_logical_region_t handle,
      legion_privilege_mode_t priv, legion_coherence_property_t prop,
      legion_logical_region_t parent, legion_mapping_tag_id_t tag /* = 0 */,
      bool verified /* = false*/);
  ...
  void legion_copy_launcher_add_src_field(
      legion_copy_launcher_t launcher, unsigned idx, legion_field_id_t fid,
      bool inst /* = true */);
  ...
  void legion_copy_launcher_add_wait_barrier(
      legion_copy_launcher_t launcher, legion_phase_barrier_t bar);
  ...
  void legion_copy_launcher_set_point(
      legion_copy_launcher_t launcher, legion_domain_point_t point);

  /**
   * @see Legion::CopyLauncher::sharding_space
   */
  void legion_copy_launcher_set_sharding_space(
      legion_copy_launcher_t launcher, legion_index_space_t space);

  /**
   * @see Legion::CopyLauncher::map_arg
   */
  void legion_copy_launcher_set_mapper_arg(
      legion_copy_launcher_t launcher, legion_untyped_buffer_t arg);

  /**
   * @see Legion::CopyLauncher::provenance
   */
  void legion_copy_launcher_set_provenance(
      legion_copy_launcher_t launcher, const char* provenance);
  ...
  legion_region_requirement_t legion_copy_get_requirement(
      legion_copy_t copy, unsigned idx);
  ...
  unsigned legion_index_copy_launcher_add_src_region_requirement_logical_region(
      legion_index_copy_launcher_t launcher, legion_logical_region_t handle,
      legion_projection_id_t proj /* = 0 */, legion_privilege_mode_t priv,
      legion_coherence_property_t prop, legion_logical_region_t parent,
      legion_mapping_tag_id_t tag /* = 0 */, bool verified /* = false*/);
  ...
  void legion_index_copy_launcher_add_src_field(
      legion_index_copy_launcher_t launcher, unsigned idx,
      legion_field_id_t fid, bool inst /* = true */);
  ...
  void legion_index_copy_launcher_add_wait_barrier(
      legion_index_copy_launcher_t launcher, legion_phase_barrier_t bar);
  ...
  void legion_index_copy_launcher_set_sharding_space(
      legion_index_copy_launcher_t launcher, legion_index_space_t is);

  /**
   * @see Legion::IndexCopyLauncher::map_arg
   */
  void legion_index_copy_launcher_set_mapper_arg(
      legion_index_copy_launcher_t launcher, legion_untyped_buffer_t arg);

  /**
   * @see Legion::IndexCopyLauncher::provenance
   */
  void legion_index_copy_launcher_set_provenance(
      legion_index_copy_launcher_t launcher, const char* provenance);
  ...
  void legion_acquire_launcher_add_field(
      legion_acquire_launcher_t launcher, legion_field_id_t fid);

  /**
   * @see Legion::AcquireLauncher::add_wait_barrier()
   */
  void legion_acquire_launcher_add_wait_barrier(
      legion_acquire_launcher_t launcher, legion_phase_barrier_t bar);
   ...
   */
  void legion_acquire_launcher_set_sharding_space(
      legion_acquire_launcher_t launcher, legion_index_space_t space);

  /**
   * @see Legion::AcquireLauncher::map_arg
   */
  void legion_acquire_launcher_set_mapper_arg(
      legion_acquire_launcher_t launcher, legion_untyped_buffer_t arg);

  /**
   * @see Legion::AcquireLauncher::provenance
   */
  void legion_acquire_launcher_set_provenance(
      legion_acquire_launcher_t launcher, const char* provenance);
  ...
  void legion_release_launcher_add_field(
      legion_release_launcher_t launcher, legion_field_id_t fid);

  /**
   * @see Legion::ReleaseLauncher::add_wait_barrier()
   */
  void legion_release_launcher_add_wait_barrier(
      legion_release_launcher_t launcher, legion_phase_barrier_t bar);
   ...
   */
  void legion_release_launcher_set_sharding_space(
      legion_release_launcher_t launcher, legion_index_space_t space);

  /**
   * @see Legion::ReleaseLauncher::map_arg
   */
  void legion_release_launcher_set_mapper_arg(
      legion_release_launcher_t launcher, legion_untyped_buffer_t arg);

  /**
   * @see Legion::ReleaseLauncher::provenance
   */
  void legion_release_launcher_set_provenance(
      legion_release_launcher_t launcher, const char* provenance);
  ...
  void legion_attach_launcher_attach_hdf5(
      legion_attach_launcher_t handle, const char* filename,
      legion_field_map_t field_map, legion_file_mode_t mode);
  ...
  void legion_attach_launcher_add_cpu_soa_field(
      legion_attach_launcher_t launcher, legion_field_id_t fid, void* base_ptr,
      bool column_major);
  ...
  void legion_attach_launcher_set_footprint(
      legion_attach_launcher_t launcher, size_t footprint);
  ...
  legion_future_t legion_flush_detach_external_resource(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_physical_region_t handle, bool flush);
  ...
  legion_future_t legion_unordered_detach_external_resource(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_physical_region_t handle, bool flush, bool unordered);
  ...
  legion_index_attach_launcher_t legion_index_attach_launcher_create(
      legion_logical_region_t parent_region,
      legion_external_resource_t resource, bool restricted /*=true*/);
  ...
  void legion_index_attach_launcher_attach_file(
      legion_index_attach_launcher_t handle, legion_logical_region_t region,
      const char* filename, const legion_field_id_t* fields, size_t num_fields,
  ...
  void legion_index_attach_launcher_attach_hdf5(
      legion_index_attach_launcher_t handle, legion_logical_region_t region,
      const char* filename, legion_field_map_t field_map,
      legion_file_mode_t mode);
  ...
  void legion_index_attach_launcher_attach_array_soa(
      legion_index_attach_launcher_t handle, legion_logical_region_t region,
      void* base_ptr, bool column_major, const legion_field_id_t* fields,
      size_t num_fields, legion_memory_t memory);
  ...
  void legion_index_attach_launcher_destroy(
      legion_index_attach_launcher_t handle);
  ...
  legion_future_t legion_detach_external_resources(
      legion_runtime_t runtime, legion_context_t ctx,
      legion_external_resources_t, bool flush, bool unordered);
  ...
  void legion_must_epoch_launcher_add_single_task(
      legion_must_epoch_launcher_t launcher, legion_domain_point_t point,
  ...
  void legion_must_epoch_launcher_add_index_task(
      legion_must_epoch_launcher_t launcher, legion_index_launcher_t handle);

  /**
   * @see Legion::Must_EpochLauncher::launch_domain
   */
  void legion_must_epoch_launcher_set_launch_domain(
      legion_must_epoch_launcher_t launcher, legion_domain_t domain);

  /**
   * @see Legion::Must_EpochLauncher::launch_space
   */
  void legion_must_epoch_launcher_set_launch_space(
      legion_must_epoch_launcher_t launcher, legion_index_space_t is);
  ...
  void legion_runtime_begin_trace(
      legion_runtime_t runtime, legion_context_t ctx, legion_trace_id_t tid,
      bool logical_only);
  ...
  legion_future_t legion_runtime_select_tunable_value(
      legion_runtime_t runtime, legion_context_t ctx, legion_tunable_id_t tid,
  ...
  /**
   * IMPORTANT: This method is ONLY for use with contexts obtained via
  ...
  legion_shard_id_t legion_sharding_functor_shard(
      legion_sharding_id_t sid, legion_domain_point_t point,
      legion_domain_t full_space, size_t total_shards);
  ...
  void legion_sharding_functor_invert(
      ...
      legion_domain_t shard_domain, legion_domain_t full_domain,
      size_t total_shards, legion_domain_point_t* points, size_t* points_size);
  ...
  void legion_runtime_print_once(
      legion_runtime_t runtime, legion_context_t ctx, FILE* f,
      const char* message);
  /**
   * @see Legion::Runtime::print_once()
   */
  void legion_runtime_print_once_fd(
      legion_runtime_t runtime, legion_context_t ctx, int fd, const char* mode,
      const char* message);
   ...
   */
  size_t legion_physical_region_get_field_count(
      legion_physical_region_t handle);
  legion_field_id_t legion_physical_region_get_field_id(
      legion_physical_region_t handle, size_t index);

  /**
   * @see Legion::PhysicalRegion::get_memories()
   */
  size_t legion_physical_region_get_memory_count(
      legion_physical_region_t handle);
...
#define ACCESSOR_ARRAY(DIM)                                     \
  legion_accessor_array_##DIM##d_t                              \
      legion_physical_region_get_field_accessor_array_##DIM##d( \
          legion_physical_region_t handle, legion_field_id_t fid);
...
#define RAW_PTR(DIM)                                                        \
  void* legion_accessor_array_##DIM##d_raw_rect_ptr(                        \
      legion_accessor_array_##DIM##d_t handle, legion_rect_##DIM##d_t rect, \
      legion_rect_##DIM##d_t* subrect, legion_byte_offset_t* offsets);
  LEGION_FOREACH_N(RAW_PTR)
#undef RAW_PTR

  // Read
  void legion_accessor_array_1d_read(
      legion_accessor_array_1d_t handle, legion_ptr_t ptr, void* dst,
      size_t bytes);

#define READ_ARRAY(DIM)                                                       \
  void legion_accessor_array_##DIM##d_read_point(                             \
      legion_accessor_array_##DIM##d_t handle, legion_point_##DIM##d_t point, \
...
#undef READ_ARRAY
  ...
  void legion_accessor_array_1d_write(
      legion_accessor_array_1d_t handle, legion_ptr_t ptr, const void* src,
      size_t bytes);
...
#undef WRITE_ARRAY
  ...
  void* legion_accessor_array_1d_ref(
      legion_accessor_array_1d_t handle, legion_ptr_t ptr);
...
#define DESTROY_ARRAY(DIM)                     \
  void legion_accessor_array_##DIM##d_destroy( \
      legion_accessor_array_##DIM##d_t handle);
...
#undef DESTROY_ARRAY
  ...
  legion_physical_region_t legion_external_resources_get_region(
      legion_external_resources_t handle, unsigned index);
  ...
  void legion_task_id_attach_semantic_information(
      legion_runtime_t runtime, legion_task_id_t task_id,
      legion_semantic_tag_t tag, const void* buffer, size_t size,
      bool is_mutable /* = false */);
  ...
  void legion_task_id_attach_name(
      legion_runtime_t runtime, legion_task_id_t task_id, const char* name,
      bool is_mutable /* = false */);
  ...
  void legion_task_id_retrieve_name(
      legion_runtime_t runtime, legion_task_id_t task_id, const char** result);
   ...
   */
  legion_execution_constraint_set_t legion_execution_constraint_set_create(
      void);
  ...
  void legion_execution_constraint_set_add_isa_constraint(
      legion_execution_constraint_set_t handle, uint64_t prop);
  ...
  void legion_execution_constraint_set_add_launch_constraint(
      legion_execution_constraint_set_t handle, legion_launch_constraint_t kind,
      size_t value);
  ...
  void legion_execution_constraint_set_add_colocation_constraint(
      legion_execution_constraint_set_t handle, const unsigned* indexes,
  ...
  legion_layout_constraint_id_t legion_layout_constraint_set_register(
      legion_runtime_t runtime, legion_field_space_t fspace,
      legion_layout_constraint_set_t handle,
  ...
  void legion_layout_constraint_set_release(
      legion_runtime_t runtime, legion_layout_constraint_id_t handle);
  ...
  void legion_layout_constraint_set_add_memory_constraint(
      legion_layout_constraint_set_t handle, legion_memory_kind_t kind);
  ...
  void legion_layout_constraint_set_add_field_constraint(
      legion_layout_constraint_set_t handle, const legion_field_id_t* fields,
  ...
  void legion_layout_constraint_set_add_ordering_constraint(
      legion_layout_constraint_set_t handle,
      const legion_dimension_kind_t* dims, size_t num_dims, bool contiguous);
  ...
  void legion_layout_constraint_set_add_tiling_constraint(
      legion_layout_constraint_set_t handle, legion_dimension_kind_t dim,
  ...
  void legion_layout_constraint_set_add_alignment_constraint(
      legion_layout_constraint_set_t handle, legion_field_id_t field,
  ...
  void legion_layout_constraint_set_add_pointer_constraint(
      legion_layout_constraint_set_t handle, legion_memory_t memory,
      uintptr_t ptr);
  ...
  void legion_task_layout_constraint_set_add_layout_constraint(
      legion_task_layout_constraint_set_t handle, unsigned idx,
  ...
  legion_mapper_id_t legion_runtime_generate_library_mapper_ids(
      legion_runtime_t runtime, const char* library_name, size_t count);

  /**
   * @see Legion::Runtime::replace_default_mapper()
   */
  void legion_runtime_replace_default_mapper(
      legion_runtime_t runtime, legion_mapper_t mapper,
      legion_processor_t proc);
  ...
  void legion_runtime_register_projection_functor(
      legion_runtime_t runtime, legion_projection_id_t id, bool exclusive,
      unsigned depth,
  ...
  legion_task_variant_registrar_t legion_task_variant_registrar_create(
      legion_task_id_t tid, bool global, const char* variant_name);
  ...
  void legion_task_variant_registrar_set_leaf_memory_pool_bounds(
      legion_task_variant_registrar_t registrar, legion_memory_kind_t kind,
  ...
  legion_variant_id_t legion_runtime_register_task_variant_fnptr_with_registrar(
      legion_runtime_t runtime, legion_task_variant_registrar_t registrar,
  ...
  legion_task_id_t legion_runtime_register_task_variant_fnptr(
      legion_runtime_t runtime, legion_task_id_t id /* = AUTO_GENERATE_ID */,
  ...
  legion_task_id_t legion_runtime_register_task_variant_python_source_qualname(
      ...
      legion_task_layout_constraint_set_t layout_constraints,
      legion_task_config_options_t options, const char* module_name,
      const char** function_qualname, size_t function_qualname_len,
  ...
  void legion_task_preamble(
      const void* data, size_t datalen, realm_id_t proc_id,
  ...
  void legion_task_postamble(
      legion_runtime_t runtime, legion_context_t ctx, const void* retval,
      size_t retsize);
  ...
  void legion_machine_get_all_processors(
      legion_machine_t machine, legion_processor_t* processors,
  ...
  void legion_machine_get_all_memories(
      legion_machine_t machine, legion_memory_t* memories,
   ...
   */
  legion_address_space_t legion_processor_address_space(
      legion_processor_t proc);
  ...
  legion_processor_query_t legion_processor_query_create_copy(
      legion_processor_query_t query);
  ...
  void legion_processor_query_only_kind(
      legion_processor_query_t query, legion_processor_kind_t kind);
   ...
   */
  void legion_processor_query_local_address_space(
      legion_processor_query_t query);
  ...
  void legion_processor_query_same_address_space_as_processor(
      legion_processor_query_t query, legion_processor_t proc);
  ...
  void legion_processor_query_same_address_space_as_memory(
      legion_processor_query_t query, legion_memory_t mem);
   ...
   */
  legion_processor_t legion_processor_query_first(
      legion_processor_query_t query);
  ...
  legion_processor_t legion_processor_query_next(
      legion_processor_query_t query, legion_processor_t after);
  ...
  void legion_memory_query_only_kind(
      legion_memory_query_t query, legion_memory_kind_t kind);
  ...
  void legion_memory_query_same_address_space_as_processor(
      legion_memory_query_t query, legion_processor_t proc);
  ...
  void legion_memory_query_same_address_space_as_memory(
      legion_memory_query_t query, legion_memory_t mem);
  ...
  legion_memory_t legion_memory_query_next(
      legion_memory_query_t query, legion_memory_t after);
  ...
  void legion_slice_task_output_slices_add(
      legion_slice_task_output_t output, legion_task_slice_t slice);

  /**
   * @see Legion::Mapping::Mapper::SliceTaskOutput:verify_correctness
   */
  void legion_slice_task_output_verify_correctness_set(
      legion_slice_task_output_t output, bool verify_correctness);
  ...
  void legion_map_task_output_chosen_instances_clear_each(
      legion_map_task_output_t output, size_t idx);

  /**
   * @see Legion::Mapping::Mapper::MapTaskOutput:chosen_instances
   */
  void legion_map_task_output_chosen_instances_add(
      legion_map_task_output_t output, legion_physical_instance_t* instances,
  ...
  void legion_map_task_output_chosen_instances_set(
      legion_map_task_output_t output, size_t idx,
      legion_physical_instance_t* instances, size_t instances_size);

  /**
   * @see Legion::Mapping::Mapper::MapTaskOutput:target_procs
   */
  void legion_map_task_output_target_procs_clear(
      legion_map_task_output_t output);
  ...
  void legion_map_task_output_target_procs_add(
      legion_map_task_output_t output, legion_processor_t proc);
  ...
  void legion_map_task_output_task_priority_set(
      legion_map_task_output_t output, legion_task_priority_t priority);
  ...
  bool legion_mapper_runtime_create_physical_instance_layout_constraint(
      legion_mapper_runtime_t runtime, legion_mapper_context_t ctx,
      legion_memory_t target_memory, legion_layout_constraint_set_t constraints,
      const legion_logical_region_t* regions, size_t regions_size,
      legion_physical_instance_t* result, bool acquire,
  ...
  bool legion_mapper_runtime_create_physical_instance_layout_constraint_id(
      legion_mapper_runtime_t runtime, legion_mapper_context_t ctx,
      legion_memory_t target_memory, legion_layout_constraint_id_t layout_id,
      const legion_logical_region_t* regions, size_t regions_size,
      legion_physical_instance_t* result, bool acquire,
      legion_garbage_collection_priority_t priority);
  ...
  bool legion_mapper_runtime_find_or_create_physical_instance_layout_constraint(
      ...
      legion_memory_t target_memory, legion_layout_constraint_set_t constraints,
      const legion_logical_region_t* regions, size_t regions_size,
      legion_physical_instance_t* result, bool* created, bool acquire,
      legion_garbage_collection_priority_t priority, bool tight_region_bounds);
  ...
  legion_shard_id_t legion_context_get_shard_id(
      legion_runtime_t /*runtime*/, legion_context_t /*context*/,
  ...
  legion_future_t legion_context_consensus_match(
      legion_runtime_t /*runtime*/, legion_context_t /*context*/,
      const void* /*input*/, void* /*output*/, size_t /*num elements*/,
      size_t /*element size*/);
