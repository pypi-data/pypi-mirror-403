...
namespace Realm {
  ...
  public:
    ExecutionException(int _error_code, const void *_detail_data, size_t _detail_size,
    ...
    virtual void
    populate_profiling_measurements(ProfilingMeasurementCollection &pmc) const;
