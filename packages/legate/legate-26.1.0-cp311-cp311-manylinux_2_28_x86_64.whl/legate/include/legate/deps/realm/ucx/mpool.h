...
namespace Realm {
  ...
  namespace UCP {
    ...
    class MPool {
    public:
      MPool(std::string name_, bool leak_check_, size_t obj_size_, size_t alignment_,
            size_t alignment_offset_, size_t objs_per_chunk_ = 1024,
            size_t init_num_objs_ = 1024, size_t max_objs_ = UINT_MAX,
            ...
            void *chunk_release_arg_ = nullptr, obj_init_t obj_init_ = nullptr,
            void *obj_init_arg_ = nullptr, obj_cleanup_t obj_cleanup_ = nullptr,
    ...
    class VMPool {
    public:
      VMPool(std::string name_, bool leak_check_, size_t max_obj_size_, size_t alignment_,
