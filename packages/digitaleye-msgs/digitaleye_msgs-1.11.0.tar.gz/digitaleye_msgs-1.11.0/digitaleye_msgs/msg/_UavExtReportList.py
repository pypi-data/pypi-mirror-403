...
"""autogenerated by genpy from digitaleye_msgs/UavExtReportList.msg. Do not edit."""
import codecs
import sys
...
class UavExtReportList(genpy.Message):
  _md5sum = "aacf9157467c7eba909d0d79ea6f9df7"
  _type = "digitaleye_msgs/UavExtReportList"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# List of external generic UAV report(s)
...
"""
  ...
  _slot_types = ['std_msgs/Header','digitaleye_msgs/UavExtReport[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(UavExtReportList, self).__init__(*args, **kwds)
