...
"""autogenerated by genpy from digitaleye_msgs/PolePose.msg. Do not edit."""
import codecs
import sys
...
class PolePose(genpy.Message):
  _md5sum = "87336c53ecd1e8e4bf6f2281de1abdb2"
  _type = "digitaleye_msgs/PolePose"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Pose of a PORTAL pole
...
float64 y
float64 z"""
  __slots__ = ['perception_id','pose','orientation','height','diameter','imu']
  _slot_types = ['uint32','geometry_msgs/Pose','float32','float32','float32','digitaleye_msgs/IMUValue']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       perception_id,pose,orientation,height,diameter,imu
    ...
    """
    if args or kwds:
      super(PolePose, self).__init__(*args, **kwds)
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_I7d4f().pack(_x.perception_id, _x.pose.position.x, _x.pose.position.y, _x.pose.position.z, _x.pose.orientation.x, _x.pose.orientation.y, _x.pose.orientation.z, _x.pose.orientation.w, _x.orientation, _x.height, _x.diameter, _x.imu.heading))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.perception_id, _x.pose.position.x, _x.pose.position.y, _x.pose.position.z, _x.pose.orientation.x, _x.pose.orientation.y, _x.pose.orientation.z, _x.pose.orientation.w, _x.orientation, _x.height, _x.diameter, _x.imu.heading,) = _get_struct_I7d4f().unpack(str[start:end])
      start = end
      end += 4
...
def _get_struct_9d():
    ...
    return _struct_9d
_struct_I7d4f = None
def _get_struct_I7d4f():
    global _struct_I7d4f
    if _struct_I7d4f is None:
        _struct_I7d4f = struct.Struct("<I7d4f")
    return _struct_I7d4f
