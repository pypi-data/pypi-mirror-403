...
"""autogenerated by genpy from digitaleye_msgs/Pole.msg. Do not edit."""
import codecs
import sys
...
class Pole(genpy.Message):
  _md5sum = "60fa932c11b542fac4b97c819c73e6bc"
  _type = "digitaleye_msgs/Pole"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Description of the position and status of
...
float64 y
float64 z"""
  __slots__ = ['id','ip_address','mvc','iot','position_frame','position','orientation_frame','orientation','height','state','settings']
  _slot_types = ['uint32','string','string','string','uint32','geometry_msgs/Point','uint32','float32','float32','digitaleye_msgs/ComponentState','digitaleye_msgs/Metric[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       id,ip_address,mvc,iot,position_frame,position,orientation_frame,orientation,height,state,settings
    ...
    if args or kwds:
      ...
      if self.orientation_frame is None:
        self.orientation_frame = 0
      if self.orientation is None:
        self.orientation = 0.
      if self.height is None:
        self.height = 0.
      if self.state is None:
        self.state = digitaleye_msgs.msg.ComponentState()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_I3dI2f3I().pack(_x.position_frame, _x.position.x, _x.position.y, _x.position.z, _x.orientation_frame, _x.orientation, _x.height, _x.state.component.id, _x.state.component.state, _x.state.component.status))
      _x = self.state.component.description
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.state.component.lastChange
      buff.write(_get_struct_I().pack(_x))
      length = len(self.state.component.metrics)
      buff.write(_struct_I.pack(length))
      for val1 in self.state.component.metrics:
        _x = val1.name
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
        ...
        if python3 or type(_x) == unicode:
          ...
          length = len(_x)
        buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      length = len(self.state.sensors)
      buff.write(_struct_I.pack(length))
      for val1 in self.state.sensors:
        _x = val1.sensor_id
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.mvc = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.mvc = str[start:end]
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.iot = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.iot = str[start:end]
      _x = self
      start = end
      end += 52
      (_x.position_frame, _x.position.x, _x.position.y, _x.position.z, _x.orientation_frame, _x.orientation, _x.height, _x.state.component.id, _x.state.component.state, _x.state.component.status,) = _get_struct_I3dI2f3I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.state.component.description = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.state.component.description = str[start:end]
      start = end
      end += 4
      (self.state.component.lastChange,) = _get_struct_I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.state.component.metrics = []
      for i in range(0, length):
        ...
        self.state.component.metrics.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.state.sensors = []
      for i in range(0, length):
        ...
        self.state.sensors.append(val1)
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.settings = []
...
def _get_struct_9d():
    ...
    return _struct_9d
_struct_I3dI2f3I = None
def _get_struct_I3dI2f3I():
    global _struct_I3dI2f3I
    if _struct_I3dI2f3I is None:
        _struct_I3dI2f3I = struct.Struct("<I3dI2f3I")
    return _struct_I3dI2f3I
_struct_f = None
def _get_struct_f():
    global _struct_f
