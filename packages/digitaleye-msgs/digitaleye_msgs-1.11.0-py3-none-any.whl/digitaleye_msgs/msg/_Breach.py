...
"""autogenerated by genpy from digitaleye_msgs/Breach.msg. Do not edit."""
import codecs
import sys
...
class Breach(genpy.Message):
  _md5sum = "13df670a4b5bc2b0bc10eb8fc20a6cb5"
  _type = "digitaleye_msgs/Breach"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """# Breach definition
uint64 entity_id
...
uint32[] sector_ids
"""
  __slots__ = ['entity_id','x','y','z','conf_status','sector_ids']
  _slot_types = ['uint64','float64','float64','float64','uint32','uint32[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       entity_id,x,y,z,conf_status,sector_ids
    ...
    """
    if args or kwds:
      super(Breach, self).__init__(*args, **kwds)
