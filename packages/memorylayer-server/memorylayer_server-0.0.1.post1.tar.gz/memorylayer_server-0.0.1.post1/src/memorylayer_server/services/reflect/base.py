...
class ReflectServicePluginBase(Plugin):
    """Base plugin for reflect service - allows SaaS to extend/override."""
    ...
    def is_enabled(self, v: Variables) -> bool:
        return enabled_option_pattern(self, v, MEMORYLAYER_REFLECT_SERVICE,
                                      default=DEFAULT_MEMORYLAYER_REFLECT_SERVICE,
                                      self_attr='PROVIDER_NAME')

    def get_dependencies(self, v: Variables):
        return EXT_STORAGE, EXT_MEMORY_SERVICE
