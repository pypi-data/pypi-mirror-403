...
# User authentication token from stocxer.in
AUTH_TOKEN = os.getenv("STOCXER_AUTH_TOKEN", "")
logger.info(f"🌐 Using API: {API_BASE_URL}")
if not AUTH_TOKEN:
    logger.warning("⚠️  No STOCXER_AUTH_TOKEN set. You need to authenticate at stocxer.in and add your token.")
