...
**Or see detailed guide**: [WINDOWS_INSTALL.md](WINDOWS_INSTALL.md)
...
**Automatic**: Just login to [https://stocxer.in](https://stocxer.in) in your browser!
...
1. **Login to stocxer.in** in your browser (one time)
2. **Install and run MCP** - it auto-detects your session
3. **Start using** - no manual token copying needed!
