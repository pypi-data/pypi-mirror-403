...
class TrainingDataRow(google.protobuf.message.Message):
    ...
    FEATURE_TIMESTAMPS_FIELD_NUMBER: builtins.int
    LABEL_TIMESTAMP_FIELD_NUMBER: builtins.int
    @property
    ...
    @property
    def feature_timestamps(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[google.protobuf.timestamp_pb2.Timestamp]:
        """Timestamps for training sets - parallel to features array
        Nil values indicate no timestamp for that feature
        """

    @property
    def label_timestamp(self) -> google.protobuf.timestamp_pb2.Timestamp:
        """Label timestamp (optional - only present if label has timestamp column)"""
    ...
    def __init__(
        ...
        *,
        ...
        feature_timestamps: collections.abc.Iterable[google.protobuf.timestamp_pb2.Timestamp] | None = ...,
        label_timestamp: google.protobuf.timestamp_pb2.Timestamp | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["entity", b"entity", "label", b"label", "label_timestamp", b"label_timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["entity", b"entity", "feature_timestamps", b"feature_timestamps", "features", b"features", "label", b"label", "label_timestamp", b"label_timestamp"]) -> None: ...
...
class TrainingColumns(google.protobuf.message.Message):
    ...
    label: builtins.str
    entity: builtins.str
    label_timestamp: builtins.str
    """Label timestamp column name (empty if label has no timestamp)"""
    @property
    def features(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]: ...
    @property
    def feature_timestamps(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
        """Timestamp column names for features - parallel to features array
        Empty string indicates no timestamp for that feature
        """
    ...
    def __init__(
        ...
        *,
        ...
        label: builtins.str = ...,
        entity: builtins.str = ...,
        feature_timestamps: collections.abc.Iterable[builtins.str] | None = ...,
        label_timestamp: builtins.str = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["entity", b"entity", "feature_timestamps", b"feature_timestamps", "features", b"features", "label", b"label", "label_timestamp", b"label_timestamp"]) -> None: ...
