...
# 168 surnames of famous scientists, hackers, engineers, mathematicians, and ML/AI researchers
right = [
    ...
    "bell",
    # Yoshua Bengio - Canadian computer scientist, known for his work in artificial neural networks and deep learning. He is a co-recipient of the 2018 ACM A.M. Turing Award. https://en.wikipedia.org/wiki/Yoshua_Bengio
    "bengio",
    ...
    "brattain",
    # Cynthia Breazeal - Pioneer of Social Robotics and Human Robot Interaction. https://en.wikipedia.org/wiki/Cynthia_Breazeal
    "breazeal",
    ...
    "hamilton",
    # Demis Hassabis - British artificial intelligence researcher, neuroscientist, video game designer, entrepreneur, and world-class games player. https://en.wikipedia.org/wiki/Demis_Hassabis
    "hassabis",
    ...
    "heyrovsky",
    # Geoffrey Hinton - English Canadian cognitive psychologist and computer scientist, most noted for his work on artificial neural networks. He is often called the "Godfather of Deep Learning". https://en.wikipedia.org/wiki/Geoffrey_Hinton
    "hinton",
    ...
    "kare",
    # Andrej Karpathy - Director of artificial intelligence and Autopilot Vision at Tesla. He specializes in deep learning and image recognition. https://en.wikipedia.org/wiki/Andrej_Karpathy
    "karpathy",
    ...
    "knuth",
    # Daphne Koller - Israeli-American Professor in the Department of Computer Science at Stanford University and a MacArthur Fellowship recipient. She is one of the founders of Coursera, an online education platform. https://en.wikipedia.org/wiki/Daphne_Koller
    "koller",
    ...
    "lewin",
    # Fei-Fei Li - Chinese-born American computer scientist, non-profit executive, and writer. She is known for her work in computer vision and cognitive and computational neuroscience. She co-led the creation of the ImageNet database. https://en.wikipedia.org/wiki/Fei-Fei_Li
    "li",
    ...
    "northcutt",
    # Peter Norvig - American computer scientist known for his work in artificial intelligence. https://en.wikipedia.org/wiki/Peter_Norvig
    "norvig",
