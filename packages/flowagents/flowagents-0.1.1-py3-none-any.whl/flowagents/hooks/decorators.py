"""
FlowAgent Hook Decorators - One-click logging and tracing for agents
...
def logged(
    ...
    *,
    ...
    Args:
        ...
        logger_name: Custom logger name (default: flowagent.agents.<class_name>)
    ...
    def decorator(cls: AgentClass) -> AgentClass:
        ...
        _logger_name = logger_name or f"flowagent.agents.{cls.__name__}"
...
def traced(
    ...
    *,
    ...
    def decorator(cls: AgentClass) -> AgentClass:
        ...
        _service = service_name or f"flowagent.{cls.__name__}"
        ...
        async def new_reply(self, msg=None):
            ...
            try:
                ...
                logging.getLogger("flowagent.tracing").debug(
                ...
                logging.getLogger("flowagent.tracing").error(
