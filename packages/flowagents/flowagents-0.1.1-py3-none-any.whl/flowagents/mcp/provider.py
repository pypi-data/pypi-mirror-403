"""
MCP Tool Provider - Bridge between MCP servers and FlowAgent ToolRegistry

Automatically converts MCP tools to FlowAgent tools and registers them.
"""
...
class MCPToolProvider:
    """
    Bridges MCP servers to FlowAgent's ToolRegistry

    Converts MCP tools to FlowAgent ToolDefinitions and registers them.
    ...
    def _make_tool_name(self, mcp_tool: MCPTool) -> str:
        """Generate FlowAgent tool name from MCP tool"""
