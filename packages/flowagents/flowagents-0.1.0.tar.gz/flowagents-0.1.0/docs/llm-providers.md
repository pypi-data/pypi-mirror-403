...
FlowAgent supports multiple LLM providers out of the box.

## Supported Providers

| Provider | Install | Models |
|----------|---------|--------|
| OpenAI | `pip install flowagent[openai]` | GPT-4, GPT-3.5 |
| Anthropic | `pip install flowagent[anthropic]` | Claude 3 Opus/Sonnet/Haiku |
| Azure OpenAI | `pip install flowagent[openai]` | GPT-4, GPT-3.5 |
| DashScope | `pip install flowagent[dashscope]` | Qwen |
| Google Gemini | `pip install flowagent[gemini]` | Gemini Pro |
| Ollama | `pip install flowagent[ollama]` | Llama, Mistral, etc. |
...
```python
from flowagent import AnthropicClient
...
```python
from flowagent import AzureOpenAIClient
...
```python
from flowagent import DashScopeClient
...
```python
from flowagent import GeminiClient
...
```python
from flowagent import OllamaClient
...
```python
from flowagent import LLMClientProtocol, LLMResponse
...
```python
from flowagent import LLMRegistry
