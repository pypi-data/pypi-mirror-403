...
Build your first AI agent with FlowAgent in 5 minutes.
...
pip install flowagent[openai]

# With all providers
pip install flowagent[all]
```
...
```python
import asyncio
from flowagent import flowagent, StandardAgent, InputField, AgentStatus, Orchestrator
...
Or configure via YAML (`config/flowagent.yaml`):
