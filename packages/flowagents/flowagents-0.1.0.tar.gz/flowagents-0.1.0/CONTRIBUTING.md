...
Thanks for your interest in contributing to FlowAgent!

## Development Setup

```bash
# Clone the repo
git clone https://github.com/xiaoyu-work/flowagent.git
cd flowagent
...
```bash
# Format code
black flowagent tests

# Lint
ruff check flowagent tests
