"""
MCP Integration Example - Using MCP tools with FlowAgent
...
async def example_mixed_tools():
    ...
    # Register a regular FlowAgent tool
...
To implement a real MCP client, extend MCPClient or implement MCPClientProtocol:
    ...
    from flowagent.mcp import MCPClient, MCPServerConfig, MCPTool
