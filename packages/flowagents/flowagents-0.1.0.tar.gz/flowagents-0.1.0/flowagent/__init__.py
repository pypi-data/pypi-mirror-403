"""
FlowAgent - A zero-code AI workflow orchestration framework

FlowAgent provides a simple yet powerful framework for building conversational AI agents
...
Quick Start (Recommended):
    from flowagent import flowagent, StandardAgent, InputField, OutputField, AgentStatus
...
Built-in LLM Client:
    from flowagent.llm import OpenAIClient, AnthropicClient
...
One-click Logging:
    from flowagent.hooks import logged
