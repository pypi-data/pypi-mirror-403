...
Usage:
    from flowagent import flowagent, StandardAgent, InputField, OutputField
...
class AgentMetadata:
    ...
    # LLM provider name (references flowagent.yaml llms section)
...
def flowagent(
    ...
    *,
    ...
    Args:
        ...
        llm: LLM provider name from flowagent.yaml (optional, uses default_llm if not specified)
        capabilities: What this agent can do (for routing decisions)
