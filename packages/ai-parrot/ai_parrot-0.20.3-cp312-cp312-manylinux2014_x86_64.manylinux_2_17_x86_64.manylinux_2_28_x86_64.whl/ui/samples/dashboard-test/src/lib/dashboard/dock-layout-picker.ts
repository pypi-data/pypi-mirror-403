...
export class DockLayoutPicker {
    ...
    constructor(private dockLayout: DockLayout) { }
    ...
    private createTemplateCard(template: PaneLayoutTemplate, isActive: boolean): HTMLElement {
    ...
    private createLayoutPreview(template: PaneLayoutTemplate): HTMLElement {
    ...
    private buildPreviewStructure(structure: import("./types.js").PaneStructure, container: HTMLElement): void {
...
export function showLayoutPicker(dockLayout: DockLayout): DockLayoutPicker {
