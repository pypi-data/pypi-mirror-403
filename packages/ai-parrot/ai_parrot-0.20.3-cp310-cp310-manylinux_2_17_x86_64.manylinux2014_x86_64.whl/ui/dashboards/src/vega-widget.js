...
export class VegaWidget extends Widget {
    ...
    async renderChart() {
        ...
        try {
            ...
            // @ts-ignore
            if (!window.vega)
                await import("https://cdn.jsdelivr.net/npm/vega@5.30.0/+esm");
            // @ts-ignore
            if (!window.vegaLite)
                await import("https://cdn.jsdelivr.net/npm/vega-lite@5.19.0/+esm");
            // @ts-ignore
...
//# sourceMappingURL=vega-widget.js.map