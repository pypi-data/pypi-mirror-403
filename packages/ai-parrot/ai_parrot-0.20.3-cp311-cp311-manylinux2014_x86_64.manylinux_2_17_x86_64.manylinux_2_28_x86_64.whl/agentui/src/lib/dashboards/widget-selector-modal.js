...
export class WidgetSelectorModal {
    ...
    nameInput = null;
    selectedType = null;
    constructor(widgetTypes) {
        this.widgetTypes = widgetTypes;
    }
    static async select(widgetTypes) {
    ...
    cleanup() {
        if (this.modal) {
            ...
            const m = this.modal.querySelector(".widget-modal");
            if (m)
...
//# sourceMappingURL=widget-selector-modal.js.map