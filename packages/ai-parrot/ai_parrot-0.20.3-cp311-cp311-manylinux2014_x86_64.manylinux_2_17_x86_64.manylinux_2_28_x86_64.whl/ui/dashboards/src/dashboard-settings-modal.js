...
export class DashboardSettingsModal {
    ...
    show() {
        ...
        // Event handlers
        this.disposers.push(on(closeBtn, "click", () => this.hide()), on(closeFooterBtn, "click", () => this.hide()), on(overlay, "click", (ev) => {
 ...
 */
export function openDashboardSettings(dashboard) {
    const modal = new DashboardSettingsModal(dashboard);
    modal.show();
    return modal;
}
//# sourceMappingURL=dashboard-settings-modal.js.map