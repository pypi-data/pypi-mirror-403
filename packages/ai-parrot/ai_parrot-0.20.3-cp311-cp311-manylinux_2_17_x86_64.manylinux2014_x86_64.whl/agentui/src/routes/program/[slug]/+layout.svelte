			...
			>
				...
				<div class="px-2 py-3">
					<button
						...
						class="hover:bg-base-200 flex w-full items-center gap-3 rounded-lg px-3 py-2.5 transition-colors {!currentModule
					...
					{#each modules as module, moduleIndex (module.id)}
						...
						{#each module.submodules as submodule (submodule.id)}
							<button
								...
								class="hover:bg-base-200 mb-0.5 flex w-full items-center gap-3 rounded-lg px-3 py-2 transition-colors
