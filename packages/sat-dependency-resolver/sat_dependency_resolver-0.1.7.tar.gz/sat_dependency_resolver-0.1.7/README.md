...
[![Live API](https://img.shields.io/badge/API-Live-green.svg)](https://sat-dependency-resolver.shehan.io)

[Live Demo](https://sat-dependency-resolver.shehan.io) • [Installation](#-installation) • [Quick Start](#-quick-start) • [API Reference](#-api-reference) • [Examples](#-examples)
...
| **Live demo** | Try instantly at [Heroku](https://sat-dependency-resolver.shehan.io) |
...
- **Live (Production)**: `https://sat-dependency-resolver.shehan.io`
