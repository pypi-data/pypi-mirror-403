...
def format_report(conflicts: dict[str, list[Path]]) -> str:
...
def format_json(conflicts: dict[str, list[Path]]) -> str:
    ...
    return json.dumps({"shadowed": shadowed}, indent=2)
