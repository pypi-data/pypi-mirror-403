...
class ChatGPTProvider(LLMProvider):
    ...
    def _initiate_login_flow(self):
        try:
            ...
            self._delayed_click(self.selectors["landing_login_btn"])
        except Exception as e:
    ...
    def _perform_google_login(self, email, password):
        ...
        self._delayed_click('button:has-text("Next")')
    ...
    def _handle_otp_challenge(self):
        ...
        self._delayed_click(self.selectors["otp_validate"])
    ...
    def _click_send(self):
        ...
        self._delayed_click(self.selectors["send_btn"])
    ...
    def _dismiss_upsell_modal(self):
        try:
            ...
            self._delayed_click(self.selectors["upsell_maybe_later"])
    ...
    def _dismiss_temp_chat_notice(self):
        try:
            if self.page.is_visible('h2:has-text("Temporary Chat")'):
                self._delayed_click(self.selectors["temp_chat_continue"])
                self.page.wait_for_timeout(500)
        except:
            pass