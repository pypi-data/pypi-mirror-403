...
AZUREML_FLAVORS_SUPPORTED = [
    "sklearn",
    "hftransformers"
]

__all__ = ["get_portal_url", "register_model"] + AZUREML_FLAVORS_SUPPORTED
...
from azureml.evaluate.mlflow.models import evaluate
import azureml.evaluate.mlflow._loader_modules as _loader_modules
...
try:
    ...
    import azureml.evaluate.mlflow.hftransformers as hftransformers
    ...
    import azureml.evaluate.mlflow.aml as aml
    ...
    # workaround : gluon is removed in mlflow 2.20.0 ; Need to remove post impact assesment
    # same with fastai and mleap for mlflow 3.x
