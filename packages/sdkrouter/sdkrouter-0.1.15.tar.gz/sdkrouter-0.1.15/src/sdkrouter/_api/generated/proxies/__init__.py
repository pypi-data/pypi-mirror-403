...
from .enums import (
    PatchedProxyRequestProxyMode,
    PatchedProxyRequestProxyType,
    PatchedProxyRequestStatus,
    PatchedProxyTestRequestTestType,
)
...
class API:
    ...
    @property
    def proxies_proxies(self) -> ProxiesProxiesAPI:
        """Access Proxies endpoints."""
        return self._client.proxies_proxies
