...
from .enums import (
    CapabilitiesListResponseCapabilitiesItems,
    CategorySlug,
    PresetSlug,
    PresetSortBy,
)
...
class API:
    ...
    @property
    def models_llm_models(self) -> ModelsLlmModelsAPI:
        """Access llm_models endpoints."""
        return self._client.models_llm_models
