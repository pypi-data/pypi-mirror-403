...
class SyncCleanerCleanerAPI:
    ...
    def retrieve(self, uuid: str) -> CleaningRequestDetail:
        """
    ...
    def cancel_create(self, uuid: str) -> None:
        """
    ...
    def patterns_retrieve(self, uuid: str) -> PatternsResponse:
        """
    ...
    def clean_async_create(self, data: CleanAsyncRequestRequest) -> CleanAsyncResponse:
        """
