...
class SyncPaymentsPaymentsAPI:
    ...
    def credentials_retrieve(self, id: str) -> ProviderCredentialDetail:
        """
    ...
    def credentials_destroy(self, id: str) -> None:
        """
    ...
    def credentials_set_default_create(self, id: str) -> ProviderCredentialDetail:
        """
    ...
    def currencies_retrieve(self, code: str) -> Currency:
        """
    ...
    def currencies_estimate_retrieve(
        self,
        code: str,
        amount_usd: float,
    ) -> CurrencyEstimateResponse:
        ...
        response = self._client.get(url, params={"amount_usd": amount_usd})
        if not response.is_success:
            try:
                error_body = response.json()
            except Exception:
    ...
    def currencies_withdrawal_estimate_retrieve(
        self,
        code: str,
        amount_usd: float,
    ) -> CurrencyEstimateResponse:
    ...
    def payments_create(self) -> PaymentList:
        """
        ViewSet for payment operations.
        """
        url = "/api/payments/payments/"
    ...
    def payments_cancel_create(self, id: str, data: PaymentStatusRequest) -> PaymentStatus:
        """
    ...
    def payments_status_retrieve(
        ...
        response = self._client.get(url, params={"refresh": refresh if refresh is not None else None})
        if not response.is_success:
            try:
                error_body = response.json()
            except Exception:
    ...
    def payments_create_create(self, data: PaymentCreateRequest) -> PaymentCreateResponse:
        """
    ...
    def withdrawals_create(self) -> WithdrawalList:
        """
        ViewSet for withdrawal operations.
        """
        url = "/api/payments/withdrawals/"
    ...
    def withdrawals_retrieve(self, id: str) -> WithdrawalDetail:
        """
