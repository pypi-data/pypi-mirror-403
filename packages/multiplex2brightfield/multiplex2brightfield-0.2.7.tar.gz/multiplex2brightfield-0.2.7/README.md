...
- `components` (dictionary): A dictionary where each key is the name of a stain component (e.g., "haematoxylin", "eosinophilic", etc.). Each component defines:
    - `component_name` (str): The name of the component.
        ...
        - `sharpen_filter_radius` (int): Defines the size of the sharpen filter (if >0).
        - `sharpen_filter_amount` (float): Determines how much to sharpen the image.
...
Below are visual examples of how individual configuration parameters affect the rendered brightfield output.
All examples show the same cropped region of the image for direct comparison.
...
![Baseline](https://raw.githubusercontent.com/TristanWhitmarsh/multiplex2brightfield/main/images/examples_baseline.jpg)

---

#### `intensity`

Controls the overall strength of the stain component.
Higher values make the component color stronger, while lower values make it lighter.

![Intensity](https://raw.githubusercontent.com/TristanWhitmarsh/multiplex2brightfield/main/images/examples_intensity.jpg)
...
![Median filter](https://raw.githubusercontent.com/TristanWhitmarsh/multiplex2brightfield/main/images/examples_median_filter_size.jpg)
...
![Gaussian smoothing](https://raw.githubusercontent.com/TristanWhitmarsh/multiplex2brightfield/main/images/examples_gaussian_filter.jpg)
...
- `sharpen_filter_radius` controls the spatial scale of sharpening.
- `sharpen_filter_amount` controls how strong the sharpening effect is.

![Sharpening](https://raw.githubusercontent.com/TristanWhitmarsh/multiplex2brightfield/main/images/examples_sharpen_filter.jpg)
...
![Histogram normalisation](https://raw.githubusercontent.com/TristanWhitmarsh/multiplex2brightfield/main/images/examples_histogram_normalisation.jpg)
...
- Increasing `normalize_percentage_min` suppresses dim signal.
- Decreasing `normalize_percentage_max` can prevent high value pixles, such as hotspots, from dominating.

![Percentile normalisation](https://raw.githubusercontent.com/TristanWhitmarsh/multiplex2brightfield/main/images/examples_normalize_percentage.jpg)
...
![clip](https://raw.githubusercontent.com/TristanWhitmarsh/multiplex2brightfield/main/images/examples_clip.jpg)
