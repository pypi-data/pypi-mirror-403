...
from panic.gui.utils import getThemeIcon, SNAP_ALLOWED, get_snap_api
...
class snapWidget(QtGui.QWidget):
    ...
    def initContexts(self, attrlist=None, sid=None):
        if attrlist is None:
            attrlist = []
...
class alarmhistoryForm(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(
            QtGui.QApplication.translate("Form", "Alarm History Viewer", None))
        ...
        self.viewButton.setText(
            QtGui.QApplication.translate("Form", "Open Snapshot", None))
    ...
    def buildList(self):
        ...
        try:
            ...
            if rows:
                self.tableWidget.setHorizontalHeaderLabels(["Date", "Alarm", "Comment"])
            else:
