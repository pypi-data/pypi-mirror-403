...
class IDiagnosticsBuilder:
    ...
    def add_metrics(self) -> aspose.html.diagnostics.IDiagnosticsBuilder:
        '''Enables metrics collection.
        
        :returns: The :py:class:`aspose.html.diagnostics.IDiagnosticsBuilder` so that additional calls can be chained.'''
        ...
    
    def add_tracing(self) -> aspose.html.diagnostics.IDiagnosticsBuilder:
