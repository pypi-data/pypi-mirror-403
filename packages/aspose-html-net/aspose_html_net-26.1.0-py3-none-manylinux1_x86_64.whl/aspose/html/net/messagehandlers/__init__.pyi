...
class FileProtocolMessageHandler(aspose.html.net.MessageHandler):
...
class FtpProtocolMessageHandler(aspose.html.net.MessageHandler):
...
class HttpProtocolMessageHandler(aspose.html.net.MessageHandler):
