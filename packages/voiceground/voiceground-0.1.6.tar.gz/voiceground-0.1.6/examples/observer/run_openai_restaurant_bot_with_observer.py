#!/usr/bin/env python3
"""Run the restaurant bot with OpenAI services (STT, LLM, TTS).

This example demonstrates the restaurant booking bot using OpenAI for all services.
...
async def main():
    """Run the restaurant bot with OpenAI services."""
    # Validate API keys
