...
def bypass(agent=user_agent):
    ...
    r = session.get("https://forum.rodina-rp.com/", timeout=3)
...
async def bypass_async(agent=user_agent, proxy=""):
    ...
    if len(proxy) > 1:
        ...
        async with aiohttp.ClientSession(connector=connector) as session:
            ...
            async with session.get("https://forum.rodina-rp.com/") as resp:
...
def main():
    ...
    cookies += code[0]
    r = requests.get("https://forum.rodina-rp.com/account/account-details", headers={"cookie": cookies, "user-agent": code[1]})
