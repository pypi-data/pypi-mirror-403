...
from rodina_forum_async.consts import MAIN_URL

if TYPE_CHECKING:
    from rodina_forum_async import RodinaAPI
    from rodina_forum_async.models import Member, Thread


class Post:
    def __init__(self, API: 'RodinaAPI', id: int, creator: 'Member', thread: 'Thread', create_date: int, html_content: str, text_content: str) -> None:
        self.API = API
        self.id = id
        """**ID сообщения**"""
...
class ProfilePost:
    def __init__(self, API: 'RodinaAPI', id: int, creator: 'Member', profile: 'Member', create_date: int, html_content: str, text_content: str) -> None:
        self.API = API
        self.id = id
