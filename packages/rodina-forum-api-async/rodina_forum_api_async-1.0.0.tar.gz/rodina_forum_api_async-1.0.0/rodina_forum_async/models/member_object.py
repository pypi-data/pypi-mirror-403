...
if TYPE_CHECKING:
    from rodina_forum_async.api import RodinaAPI


class Member:
    def __init__(self, API : 'RodinaAPI', id: int, username: str, user_title: str, avatar: str, roles: list, activity: str, messages_count: int, reactions_count: int, trophies_count: int, username_color: str) -> None:
        self.API = API
        self.id = id
        """**ID пользователя**"""
