...
class CSSEvents:
    ...
    Fires whenever a web font is updated.  A non-empty font parameter indicates a successfully loaded web font.    
        Args:
            callback (callable, optional): Function called when the event is fired. 
                The callback receives (params: fontsUpdatedEvent, session_id: Optional[str]).
        """
    ...
    Fires whenever a MediaQuery result changes (for example, after a browser window has been resized.) The current implementation considers only viewport-dependent media features.    
        Args:
            callback (callable, optional): Function called when the event is fired. 
                The callback receives (params: mediaQueryResultChangedEvent, session_id: Optional[str]).
        """
    ...
    Fired whenever an active document stylesheet is added.    
        Args:
            callback (callable, optional): Function called when the event is fired. 
                The callback receives (params: styleSheetAddedEvent, session_id: Optional[str]).
        """
    ...
    Fired whenever a stylesheet is changed as a result of the client operation.    
        Args:
            callback (callable, optional): Function called when the event is fired. 
                The callback receives (params: styleSheetChangedEvent, session_id: Optional[str]).
        """
    ...
    Fired whenever an active document stylesheet is removed.    
        Args:
            callback (callable, optional): Function called when the event is fired. 
                The callback receives (params: styleSheetRemovedEvent, session_id: Optional[str]).
        """
    ...
    No description available for computedStyleUpdated.    
        Args:
            callback (callable, optional): Function called when the event is fired. 
                The callback receives (params: computedStyleUpdatedEvent, session_id: Optional[str]).
        """
