...
class CSSMethods:
    ...
    Returns the values of the default UA-defined environment variables used in env()    
        Args:
            params (None, optional): Parameters for the getEnvironmentVariables method.
            session_id (str, optional): Target session ID for flat protocol usage.
    ...
    Returns all media queries parsed by the rendering engine.    
        Args:
            params (None, optional): Parameters for the getMediaQueries method.
            session_id (str, optional): Target session ID for flat protocol usage.
    ...
    Polls the next batch of computed style updates.    
        Args:
            params (None, optional): Parameters for the takeComputedStyleUpdates method.
            session_id (str, optional): Target session ID for flat protocol usage.
    ...
    Enables the selector recording.    
        Args:
            params (None, optional): Parameters for the startRuleUsageTracking method.
            session_id (str, optional): Target session ID for flat protocol usage.
    ...
    Stop tracking rule usage and return the list of rules that were used since last call to `takeCoverageDelta` (or since start of coverage instrumentation).    
        Args:
            params (None, optional): Parameters for the stopRuleUsageTracking method.
            session_id (str, optional): Target session ID for flat protocol usage.
    ...
    Obtain list of rules that became used since last call to this method (or since start of coverage instrumentation).    
        Args:
            params (None, optional): Parameters for the takeCoverageDelta method.
            session_id (str, optional): Target session ID for flat protocol usage.
