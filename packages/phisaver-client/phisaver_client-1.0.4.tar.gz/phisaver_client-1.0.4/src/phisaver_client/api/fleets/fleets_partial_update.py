...
from ...models.patched_fleet import PatchedFleet
...
def _get_kwargs(
    ref: str,
    *,
    body: PatchedFleet | PatchedFleet | PatchedFleet | Unset = UNSET,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/fleets/{ref}/".format(
            ref=quote(str(ref), safe=""),
        ),
    }

    if isinstance(body, PatchedFleet):
