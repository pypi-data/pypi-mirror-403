...
from ...models.patched_vpn_client import PatchedVPNClient
...
def _get_kwargs(
    id: int,
    *,
    body: PatchedVPNClient | PatchedVPNClient | PatchedVPNClient | Unset = UNSET,
) -> dict[str, Any]:
    ...
    if isinstance(body, PatchedVPNClient):
