...
* [`aveytense.Tense.reverse()`](https://aveyzan.xyz/aveytense#aveytense.Tense.reverse) - A pure, extended version of `list.reverse()` that reverses
...
setup(
    ...
    entry_points = {
        "console_scripts": [
            "aveytense-update = aveytense._collection._console:upgrade",
            "aveytense-version = aveytense._collection._console:version"
        ],
    }
)