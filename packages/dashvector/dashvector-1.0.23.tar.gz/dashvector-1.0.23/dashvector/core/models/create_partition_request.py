...
class CreatePartitionRequest(RPCRequest):
    def __init__(self, *, collection_name: str, partition_name: str):
        ...
        partition_name: str
        """
        self._partition_name = Validator.validate_partition_name(partition_name, doc_op="CreatePartitionRequest")

        """
        CreatePartitionRequest: google.protobuf.Message
        """
        create_request = dashvector_pb2.CreatePartitionRequest(name=self._partition_name)
