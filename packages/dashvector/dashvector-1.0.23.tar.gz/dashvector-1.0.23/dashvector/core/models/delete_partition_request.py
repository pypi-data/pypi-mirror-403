...
class DeletePartitionRequest(RPCRequest):
    def __init__(self, *, collection_name: str, partition_name: str):
        ...
        partition_name: str
        """
        self._partition_name = Validator.validate_partition_name(partition_name, doc_op="DeletePartitionRequest")

        """
        DropPartitionRequest: google.protobuf.Message
        """
        drop_request = dashvector_pb2.DeletePartitionRequest(name=self._partition_name)
