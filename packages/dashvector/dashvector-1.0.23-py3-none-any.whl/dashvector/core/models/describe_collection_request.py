...
class DescribeCollectionRequest(RPCRequest):
    def __init__(self, *, name: str):
        ...
        name: str
        """
        self._name = Validator.validate_collection_name(name, doc_op="DescribeCollectionRequest")

        """
        DescribeCollectionRequest: google.protobuf.Message
        """
        describe_request = dashvector_pb2.DescribeCollectionRequest(name=self._name)
