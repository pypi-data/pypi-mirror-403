...
def server_picker(root, MainSettings):
    ...
    """
    # Setting MainSettings['SETUP']['localhost']=hostname runs code(s) locally
    # Tested with GACODE suite on Intel i7/Ubuntu22.04/SLURM/OpenMPI
    localhost = MainSettings['SETUP']['localhost']
    if localhost != 'localhost' and is_localhost(localhost, looseCheck=False):
        return 'localhost'
    ...
    elif is_localhost(['pppl_sunfire', 'nx', 'flux', 'portal', 'sunfire', 'transp-srv-stag'], looseCheck=True):
