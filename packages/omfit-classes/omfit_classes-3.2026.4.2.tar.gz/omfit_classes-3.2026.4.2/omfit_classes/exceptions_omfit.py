...
class OMFITmissingDataException(OMFITexception, doNotReportException):
    """
    Class used to raise an exception in user script
    to distinguish an error due to missing data as
    opposed to generic logic error.
    """
