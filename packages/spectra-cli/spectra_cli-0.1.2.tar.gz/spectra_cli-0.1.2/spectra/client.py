...
# Default is the stable production domain (Render) to make the CLI work out-of-the-box.
...
def get_api_url() -> str:
    ...
    Defaults to the stable production URL (Render) so the CLI works without extra setup.
    For local development, set SPECTRA_API_URL to http://127.0.0.1:8000/.
    """
    url = os.getenv("SPECTRA_API_URL", "https://spectra-cli-f7h0.onrender.com/")
