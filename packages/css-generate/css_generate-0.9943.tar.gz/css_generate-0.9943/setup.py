from setuptools import setup, find_packages;setup(name='css_generate',version='0.9943',entry_points={'console_scripts':['css-generate=css_generate.__main__:main']},license='Apache 2',platforms='any',url='https://ssb22.user.srcf.net/css',author='Silas S. Brown',author_email='ssb22@cam.ac.uk',description='Low-vision stylesheet generator',long_description=r'''# css-generate
...
You can adjust the Python code to your needs:
...
your profile directory (if no `chrome` subdirectory exists, create it).
  ...
  * You have to restart Firefox when changing userContent.css; on
    ...
    script](https://ssb22.user.srcf.net/css/togglecss.sh) to toggle the presence of userContent.css
    and restart Firefox.
