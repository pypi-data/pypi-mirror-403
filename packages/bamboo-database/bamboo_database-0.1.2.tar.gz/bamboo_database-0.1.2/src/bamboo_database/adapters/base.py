...
class DatabaseAdapter(ABC):
    ...
    def execute_script(self, sql: str) -> None:
        ...
        This method is used for migration files that contain multiple
    ...
    def placeholder(self) -> str:
        """Return the placeholder style for parameterized queries.
        ...
        Returns:
            The placeholder string for this database
        """
        ...
