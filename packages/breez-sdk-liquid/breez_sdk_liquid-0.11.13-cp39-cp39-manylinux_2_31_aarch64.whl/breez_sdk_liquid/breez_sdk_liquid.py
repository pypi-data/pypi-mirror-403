...
class Config:
    ...
    def __init__(self, *, liquid_explorer: "BlockchainExplorer", bitcoin_explorer: "BlockchainExplorer", working_dir: "str", network: "LiquidNetwork", payment_timeout_sec: "int", sync_service_url: "typing.Optional[str]", breez_api_key: "typing.Optional[str]", zero_conf_max_amount_sat: "typing.Optional[int]", use_default_external_input_parsers: "bool" = _DEFAULT, use_magic_routing_hints: "bool" = _DEFAULT, external_input_parsers: "typing.Optional[typing.List[ExternalInputParser]]" = _DEFAULT, onchain_fee_rate_leeway_sat: "typing.Optional[int]" = _DEFAULT, asset_metadata: "typing.Optional[typing.List[AssetMetadata]]" = _DEFAULT, sideswap_api_key: "typing.Optional[str]" = _DEFAULT, onchain_sync_period_sec: "int", onchain_sync_request_timeout_sec: "int"):
        ...
        self.onchain_sync_period_sec = onchain_sync_period_sec
        self.onchain_sync_request_timeout_sec = onchain_sync_request_timeout_sec

    def __str__(self):
        return "Config(liquid_explorer={}, bitcoin_explorer={}, working_dir={}, network={}, payment_timeout_sec={}, sync_service_url={}, breez_api_key={}, zero_conf_max_amount_sat={}, use_default_external_input_parsers={}, use_magic_routing_hints={}, external_input_parsers={}, onchain_fee_rate_leeway_sat={}, asset_metadata={}, sideswap_api_key={}, onchain_sync_period_sec={}, onchain_sync_request_timeout_sec={})".format(self.liquid_explorer, self.bitcoin_explorer, self.working_dir, self.network, self.payment_timeout_sec, self.sync_service_url, self.breez_api_key, self.zero_conf_max_amount_sat, self.use_default_external_input_parsers, self.use_magic_routing_hints, self.external_input_parsers, self.onchain_fee_rate_leeway_sat, self.asset_metadata, self.sideswap_api_key, self.onchain_sync_period_sec, self.onchain_sync_request_timeout_sec)
    ...
    def __eq__(self, other):
        ...
        if self.sideswap_api_key != other.sideswap_api_key:
            return False
        if self.onchain_sync_period_sec != other.onchain_sync_period_sec:
            return False
        if self.onchain_sync_request_timeout_sec != other.onchain_sync_request_timeout_sec:
            return False
        return True
...
class _UniffiConverterTypeConfig(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return Config(
            ...
            onchain_sync_period_sec=_UniffiConverterUInt32.read(buf),
            onchain_sync_request_timeout_sec=_UniffiConverterUInt32.read(buf),
        )
    ...
    def check_lower(value):
        ...
        _UniffiConverterUInt32.check_lower(value.onchain_sync_period_sec)
        _UniffiConverterUInt32.check_lower(value.onchain_sync_request_timeout_sec)
    ...
    def write(value, buf):
        ...
        _UniffiConverterUInt32.write(value.onchain_sync_period_sec, buf)
        _UniffiConverterUInt32.write(value.onchain_sync_request_timeout_sec, buf)
