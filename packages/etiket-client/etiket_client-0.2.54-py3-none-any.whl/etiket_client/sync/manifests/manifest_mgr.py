from etiket_client.sync.manifests.v1.manifest_mgr import ManifestStateV1
from etiket_client.sync.manifests.v2.manifest_mgr import ManifestStateV2
...
class manifest_manager:
    ...
    def __init__(self, name : str,
                        ...
                        current_manifest : Optional[Dict[str, float]] = None, 
                        level : int = -1,
                        is_NFS : bool = False,
