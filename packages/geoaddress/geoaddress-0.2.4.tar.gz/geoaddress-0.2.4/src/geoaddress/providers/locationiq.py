...
class LocationIQProvider(GeoaddressProvider):
    ...
    def search_addresses(self, query: str, *args: Any, **kwargs: Any) -> list[dict[str, Any]]:  # noqa: C901, ARG002
        ...
        response = requests.get(f"{self._base_url}/search.php", params=params, timeout=self.geoaddress_timeout)
    ...
    def reverse_geocode(self, latitude: float | None = None, longitude: float | None = None, *args: Any, **kwargs: Any) -> list[dict[str, Any]]:  # noqa: C901, ARG002
        ...
        response = requests.get(f"{self._base_url}/reverse.php", params=params, timeout=self.geoaddress_timeout)
        response.raise_for_status()
