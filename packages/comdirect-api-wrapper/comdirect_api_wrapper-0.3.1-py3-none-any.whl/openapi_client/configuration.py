...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "ResourceOwnerPasswordCredentials": OAuth2AuthSetting,
    },
    total=False,
)
...
class Configuration:
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor"""
        self._base_path = "https://api.comdirect.de/api" if host is None else host
        """Default Base url
        """
    ...
    def auth_settings(self) -> AuthSettings:
        ...
        if self.access_token is not None:
            auth["ResourceOwnerPasswordCredentials"] = {
                "type": "oauth2",
                "in": "header",
                "key": "Authorization",
