...
class ListResourceAccountBalance(BaseModel):
    ...
    values: Optional[List[AccountBalance]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListResourceAccountBalance from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListResourceAccountBalance from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "values": (
                    [AccountBalance.from_dict(_item) for _item in obj["values"]]
