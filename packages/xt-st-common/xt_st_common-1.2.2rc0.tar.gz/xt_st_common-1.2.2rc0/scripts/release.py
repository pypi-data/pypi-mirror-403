#!/usr/bin/env python3
"""
Release tag creation utility minimally adapted from xt-workbench.
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description="Create release tags for xt-st-common",
...
Examples:
  ...
  python scripts/release.py --force   # Skip safety checks
    ...
    print_header("xt-st-common Release Manager")
