...
def main():
    ...
    dd.html_figure(file_name='plot_line_x_y_datex_test.svg')
    # Example 2
    ...
    dd.html_figure(file_name='plot_line_x_y_intx_test.svg')
    # Example 3
    ...
    dd.html_figure(file_name='plot_line_x_y_uniformx_test.svg')
    # Example 4
    ...
    dd.html_figure(file_name='plot_line_x_y_normx_test.svg')
    dd.html_end(
