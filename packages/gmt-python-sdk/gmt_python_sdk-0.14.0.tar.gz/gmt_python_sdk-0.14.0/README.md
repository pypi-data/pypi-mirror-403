# Gmt Python API library

<!-- prettier-ignore -->
[![PyPI version](https://img.shields.io/pypi/v/gmt-python-sdk.svg?label=pypi%20(stable))](https://pypi.org/project/gmt-python-sdk/)
...
The REST API documentation can be found on [api.getmytg.com](https://api.getmytg.com/docs). The full API of this library can be found in [api.md](api.md).
...
to add `x-api-key="My API Key"` to your `.env` file
