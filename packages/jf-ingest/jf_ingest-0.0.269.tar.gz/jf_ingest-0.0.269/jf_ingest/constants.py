class Constants:
    ...
    # Everyone should have this set to True eventually,
    # but the feature came out right before DFO due date
    # so we guarded it behind a feature flag for extreme
    # safety purposes
    USE_PROJECTS_PAGINATION = 'makara-use-projects-pagination-2025Q3'
