...
class PermissionsEnum(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): * `view` - view * `change` - change * `add` - add * `delete` - delete., must be one of ["view", "change", "add", "delete", ]  # noqa: E501

        Keyword Args:
            value (str): * `view` - view * `change` - change * `add` - add * `delete` - delete., must be one of ["view", "change", "add", "delete", ]  # noqa: E501
