...
class NestedDevice(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, sn_or_name, part, location, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            is_wstk (bool): [optional] if omitted the server will use the default value of False  # noqa: E501
            online (bool): [optional] if omitted the server will use the default value of True  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, sn_or_name, part, location, *args, **kwargs):  # noqa: E501
        """NestedDevice - a model defined in OpenAPI
