...
class ApiRequestCreateNewNestedGroup(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'devices': ([NestedDevice],),  # noqa: E501
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, devices, *args, **kwargs):  # noqa: E501
        """ApiRequestCreateNewNestedGroup - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, devices, *args, **kwargs):  # noqa: E501
        """ApiRequestCreateNewNestedGroup - a model defined in OpenAPI
