...
class GroupLocation(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, rooms, device_group, *args, **kwargs):  # noqa: E501
        """GroupLocation - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, device_group, *args, **kwargs):  # noqa: E501
        """GroupLocation - a model defined in OpenAPI
