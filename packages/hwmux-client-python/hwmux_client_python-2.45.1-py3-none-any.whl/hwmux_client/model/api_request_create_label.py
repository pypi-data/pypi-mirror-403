...
class ApiRequestCreateLabel(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, name, device_groups, *args, **kwargs):  # noqa: E501
        """ApiRequestCreateLabel - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, device_groups, *args, **kwargs):  # noqa: E501
        """ApiRequestCreateLabel - a model defined in OpenAPI
