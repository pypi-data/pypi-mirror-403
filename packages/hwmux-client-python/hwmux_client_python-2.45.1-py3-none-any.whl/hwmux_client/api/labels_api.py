...
class LabelsApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.labels_analytics_batch_get_create_endpoint = _Endpoint(
            settings={
                'response_type': (MLAnalyticsWithMeta,),
                'auth': [
                    'cookieAuth',
                    'tokenAuth'
                ],
                'endpoint_path': '/api/labels/analytics-batch-get/',
                'operation_id': 'labels_analytics_batch_get_create',
                'http_method': 'POST',
                'servers': None,
            },
            params_map={
        ...
        self.labels_analytics_retrieve_endpoint = _Endpoint(
            settings={
                'response_type': (SLAnalyticsWithMeta,),
                'auth': [
                    'cookieAuth',
                    'tokenAuth'
                ],
                'endpoint_path': '/api/labels/{id}/analytics/',
                'operation_id': 'labels_analytics_retrieve',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def labels_analytics_batch_get_create(
        self,
        label_id_list,
        **kwargs
    ):
        """labels_analytics_batch_get_create  # noqa: E501

        Get usage analytics for multiple labels.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.labels_analytics_batch_get_create(label_id_list, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['label_id_list'] = \
            label_id_list
        return self.labels_analytics_batch_get_create_endpoint.call_with_http_info(**kwargs)

    def labels_analytics_retrieve(
        self,
        id,
        **kwargs
    ):
        """labels_analytics_retrieve  # noqa: E501

        Get usage analytics for a label.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.labels_analytics_retrieve(id, async_req=True)
        >>> result = thread.get()

        Args:
            id (int): A unique integer value identifying this label analytics.
        ...
        kwargs['id'] = \
            id
        return self.labels_analytics_retrieve_endpoint.call_with_http_info(**kwargs)
    ...
    def labels_create(
        ...
        **kwargs
        ...
        Viewset for Label model  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def labels_list(
        ...
        **kwargs
        ...
        Keyword Args:
            ...
            regex_search (str): Regex pattern to search across Name, Metadata, Device Name, and Group Name.. [optional]
