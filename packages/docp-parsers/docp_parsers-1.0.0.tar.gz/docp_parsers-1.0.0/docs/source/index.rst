...
Installation
------------
To install ``docp-parsers``, first activate your target virtual environment,
then use ``pip``::
...
.. _GitHub Releases: https://github.com/s3dev/docp-parsers/releases
.. _GitHub: https://github.com/s3dev/docp-parsers
.. _PyPI: https://pypi.org/project/docp-parsers/#history
