...
class FirmwareInfoProvider:
    ...
    def get_aiclk(self) -> int | None: ...

    def get_axiclk(self) -> int | None: ...

    def get_arcclk(self) -> int | None: ...

    def get_fan_speed(self) -> int | None: ...

    def get_tdp(self) -> int | None: ...

    def get_tdc(self) -> int | None: ...

    def get_vcore(self) -> int | None: ...

    def get_board_temperature(self) -> float | None: ...
...
class SocDescriptor:
    ...
    def get_cores(self, core_type: CoreType, coord_system: CoordSystem = CoordSystem.NOC0, channel: int | None = None) -> list[CoreCoord]:
