...
def raiseless(function_or_coroutine: typing.Callable | None = None, *, display_error_mode: typing.Literal["full", "small", None] = None):
    """Decorator, allows to catch raised function exception as return result instead of using of try-except block."""

    # If display error mode value if invalid
    if display_error_mode is not None and display_error_mode not in (allowed_literals := typing.get_args(raiseless.__annotations__["display_error_mode"])):
        raise Exception("display error mode argument is invalid, have to be of: `%s` values" % ", ".join(allowed_literals))
    ...
    def decorator(function: typing.Callable):
        ...
        async def async_wrapper(*args: typing.Any, **kwargs: typing.Any) -> tuple[typing.Any, BaseException]:
            ...
            try:
                ...
                match display_error_mode:

                    case "full": traceback.print_exc()
                    case "small": print(str(error))
...
def threaded(function: typing.Callable | None = None, *, name: str | None = None, daemon: bool | None = None, immediate_start: bool = False):
    ...
    def decorator(function: typing.Callable):
        ...
        def wrapper(*args: typing.Any, **kwargs: typing.Any) -> threading.Thread:
            ...
            return thread.start() if immediate_start else thread
