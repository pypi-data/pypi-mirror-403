...
class ReportsResource(ResourceBase):
    ...
    def list(
        ...
        response = self._require_transport().request(
            method="GET",
            url=routes.reports(self.workspace_id),
            options=opts,
            session=session,
        )
    ...
    def create(
        self,
        payload: report_models.CreateReportRequest,
        options: Optional[RequestOptions] = None,
        session: Optional[requests.Session] = None,
    ) -> Item:
    ...
    def get(
        ...
        response = self._require_transport().request(
            method="GET",
            url=routes.report(self.workspace_id, report_id),
            options=opts,
            session=session,
        )
        return self._handle_response(response, opts)
    ...
    def update(
        self,
        report_id: str,
        payload: report_models.UpdateReportRequest,
        options: Optional[RequestOptions] = None,
        session: Optional[requests.Session] = None,
    ) -> Item:
        opts = options or RequestOptions()
    ...
    def get_definition(
        ...
        response = self._require_transport().request(
            method="POST",
            url=routes.report_definition(self.workspace_id, report_id),
            options=opts,
            session=session,
        )
        return self._handle_response(response, opts)
    ...
    def update_definition(
        self,
        report_id: str,
        payload: report_models.UpdateReportDefinitionRequest,
        ...
        response = self._require_transport().request(
            method="POST",
            url=routes.report_definition_update(
                self.workspace_id, report_id, update_metadata
            ),
            json=payload,
            options=opts,
            session=session,
