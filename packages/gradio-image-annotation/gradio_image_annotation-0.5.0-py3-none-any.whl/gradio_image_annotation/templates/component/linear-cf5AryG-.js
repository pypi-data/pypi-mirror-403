import { aJ as j, aK as p, aL as w, aM as k, aN as q } from "./mermaid.core-CMO0znjE.js";
...
function R(n) {
  let r, t, e;
  n.length !== 2 ? (r = g, t = (o, c) => g(n(o), c), e = (o, c) => n(o) - c) : (r = n === g || n === I ? n : P, t = n, e = n);
...
const $ = R(g), x = $.right;
R(V).center;
const J = Math.sqrt(50), K = Math.sqrt(10), L = Math.sqrt(2);
function v(n, r, t) {
  const e = (r - n) / Math.max(0, t), u = Math.floor(Math.log10(e)), f = e / Math.pow(10, u), a = f >= J ? 10 : f >= K ? 5 : f >= L ? 2 : 1;
  let o, c, i;
...
function d(n, r) {
  var t = typeof r, e;
  return r == null || t === "boolean" ? j(r) : (t === "number" ? p : t === "string" ? (e = w(r)) ? (r = e, k) : q : r instanceof w ? k : r instanceof Date ? H : E(r) ? C : Array.isArray(r) ? G : typeof r.valueOf != "function" && typeof r.toString != "function" || isNaN(r) ? Q : p)(n, r);
}
function U(n, r) {
...
function on(n) {
  ...
  return n.ticks = function(t) {
    var e = r();
    return O(e[0], e[e.length - 1], t ?? 10);
