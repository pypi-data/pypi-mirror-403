...
class DpoJobListParams(TypedDict, total=False):
    ...
    """The maximum number of dpo jobs to return.
    ...
    """A page token, received from a previous ListDpoJobs call.

    Provide this to retrieve the subsequent page. When paginating, all other
    parameters provided to ListDpoJobs must match the call that provided the page
    token.
    """
