...
__all__ = ["ReinforcementFineTuningJobListParams"]


class ReinforcementFineTuningJobListParams(TypedDict, total=False):
    account_id: str
    ...
    """
    A page token, received from a previous ListReinforcementLearningFineTuningJobs
