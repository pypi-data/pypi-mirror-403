...
- **Use UV for Tool Execution**
  ...
  - Execute tools like pyright, ruff, and raindropio-mcp through UV: `uv run pyright`
...
- **Code Quality Validation**
  ...
  - Code should pass all quality checks when run through raindropio-mcp
  - The ultimate goal is to run `python -m raindropio-mcp -x -t` without any errors
...
- **MCP Server Integration**
  ...
  - MCP tools: `execute_raindropio-mcp`, `get_job_progress`, `get_comprehensive_status`
...
- **Quality Standards Maintenance**
  ...
  - Test all documentation updates by running `python -m raindropio-mcp --comprehensive`
