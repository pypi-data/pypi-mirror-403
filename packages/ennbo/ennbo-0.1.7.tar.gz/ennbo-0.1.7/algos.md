...
- **Incumbent Selection**: Uses a "Top-K" denoising algorithm. It raw-filters the top $K$ observations and then selects the best among them using the ENN posterior mean to ensure noise robustness and O(N).
