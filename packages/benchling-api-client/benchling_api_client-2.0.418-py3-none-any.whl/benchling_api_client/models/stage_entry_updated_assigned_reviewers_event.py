...
from ..models.stage_entry_updated_assigned_reviewers_event_event_type import (
    StageEntryUpdatedAssignedReviewersEventEventType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="StageEntryUpdatedAssignedReviewersEvent")


@attr.s(auto_attribs=True, repr=False)
class StageEntryUpdatedAssignedReviewersEvent:
    """  """

    _entry: Union[Unset, StageEntry] = UNSET
    _event_type: Union[Unset, StageEntryUpdatedAssignedReviewersEventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "StageEntryUpdatedAssignedReviewersEvent({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> Union[Unset, StageEntryUpdatedAssignedReviewersEventEventType]:
            event_type = UNSET
            _event_type = d.pop("eventType")
            if _event_type is not None and _event_type is not UNSET:
                try:
                    event_type = StageEntryUpdatedAssignedReviewersEventEventType(_event_type)
                except ValueError:
                    event_type = StageEntryUpdatedAssignedReviewersEventEventType.of_unknown(_event_type)
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(Union[Unset, StageEntryUpdatedAssignedReviewersEventEventType], UNSET)
        ...
        stage_entry_updated_assigned_reviewers_event = cls(
            entry=entry,
        ...
        stage_entry_updated_assigned_reviewers_event.additional_properties = d
        return stage_entry_updated_assigned_reviewers_event
    ...
    @property
    def event_type(self) -> StageEntryUpdatedAssignedReviewersEventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: StageEntryUpdatedAssignedReviewersEventEventType) -> None:
