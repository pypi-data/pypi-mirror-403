...
from ...models.app_config_items_bulk_create_request import AppConfigItemsBulkCreateRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: AppConfigItemsBulkCreateRequest,
) -> Dict[str, Any]:
    url = "{}/app-configuration-items:bulk-create".format(client.base_url)
