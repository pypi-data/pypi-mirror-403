...
from ...models.assay_results_bulk_create_in_table_request import AssayResultsBulkCreateInTableRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: AssayResultsBulkCreateInTableRequest,
) -> Dict[str, Any]:
    url = "{}/assay-results:bulk-create".format(client.base_url)
