...
) -> Optional[Union[PlatesArchivalChange, BadRequestError, ForbiddenRestrictedSampleError]]:
    if response.status_code == 200:
        response_200 = PlatesArchivalChange.from_dict(response.json(), strict=False)
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[PlatesArchivalChange, BadRequestError, ForbiddenRestrictedSampleError]]:
    return Response(
