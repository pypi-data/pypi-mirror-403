...
class V2WorkflowTaskUpdatedScheduledOnEvent:
    ...
    _event_type: V2WorkflowTaskUpdatedScheduledOnEventEventType
    _deprecated: bool
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> V2WorkflowTaskUpdatedScheduledOnEventEventType:
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(V2WorkflowTaskUpdatedScheduledOnEventEventType, UNSET)
