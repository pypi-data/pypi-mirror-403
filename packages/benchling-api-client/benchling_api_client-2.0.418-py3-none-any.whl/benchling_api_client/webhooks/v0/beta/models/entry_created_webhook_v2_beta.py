...
from ..models.entry_created_webhook_v2_beta_type import EntryCreatedWebhookV2BetaType
from ..models.event_resource_schema import EventResourceSchema
from ..types import UNSET, Unset

T = TypeVar("T", bound="EntryCreatedWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class EntryCreatedWebhookV2Beta:
    """  """

    _type: EntryCreatedWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "EntryCreatedWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> EntryCreatedWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = EntryCreatedWebhookV2BetaType(_type)
            except ValueError:
                type = EntryCreatedWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(EntryCreatedWebhookV2BetaType, UNSET)
        ...
        entry_created_webhook_v2_beta = cls(
            type=type,
        ...
        entry_created_webhook_v2_beta.additional_properties = d
        return entry_created_webhook_v2_beta
    ...
    @property
    def type(self) -> EntryCreatedWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: EntryCreatedWebhookV2BetaType) -> None:
        self._type = value
