...
from ..models.request_created_webhook_v2_beta_type import RequestCreatedWebhookV2BetaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="RequestCreatedWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class RequestCreatedWebhookV2Beta:
    """  """

    _type: RequestCreatedWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "RequestCreatedWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> RequestCreatedWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = RequestCreatedWebhookV2BetaType(_type)
            except ValueError:
                type = RequestCreatedWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(RequestCreatedWebhookV2BetaType, UNSET)
        ...
        request_created_webhook_v2_beta = cls(
            type=type,
        ...
        request_created_webhook_v2_beta.additional_properties = d
        return request_created_webhook_v2_beta
    ...
    @property
    def type(self) -> RequestCreatedWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: RequestCreatedWebhookV2BetaType) -> None:
        self._type = value
