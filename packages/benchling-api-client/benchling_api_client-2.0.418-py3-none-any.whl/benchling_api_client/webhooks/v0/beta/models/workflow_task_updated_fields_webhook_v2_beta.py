...
from ..models.workflow_task_updated_fields_webhook_v2_beta_type import (
    WorkflowTaskUpdatedFieldsWebhookV2BetaType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskUpdatedFieldsWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class WorkflowTaskUpdatedFieldsWebhookV2Beta:
    """  """

    _type: WorkflowTaskUpdatedFieldsWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskUpdatedFieldsWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowTaskUpdatedFieldsWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = WorkflowTaskUpdatedFieldsWebhookV2BetaType(_type)
            except ValueError:
                type = WorkflowTaskUpdatedFieldsWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowTaskUpdatedFieldsWebhookV2BetaType, UNSET)
        ...
        workflow_task_updated_fields_webhook_v2_beta = cls(
            type=type,
        ...
        workflow_task_updated_fields_webhook_v2_beta.additional_properties = d
        return workflow_task_updated_fields_webhook_v2_beta
    ...
    @property
    def type(self) -> WorkflowTaskUpdatedFieldsWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowTaskUpdatedFieldsWebhookV2BetaType) -> None:
        self._type = value
