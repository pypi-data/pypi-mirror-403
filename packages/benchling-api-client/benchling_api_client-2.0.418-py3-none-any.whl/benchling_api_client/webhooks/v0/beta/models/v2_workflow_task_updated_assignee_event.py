...
class V2WorkflowTaskUpdatedAssigneeEvent:
    ...
    _event_type: V2WorkflowTaskUpdatedAssigneeEventEventType
    _deprecated: bool
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> V2WorkflowTaskUpdatedAssigneeEventEventType:
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(V2WorkflowTaskUpdatedAssigneeEventEventType, UNSET)
