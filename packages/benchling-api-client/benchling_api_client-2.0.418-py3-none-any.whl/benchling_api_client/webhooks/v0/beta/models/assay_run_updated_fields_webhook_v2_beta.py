...
from ..models.assay_run_updated_fields_webhook_v2_beta_type import AssayRunUpdatedFieldsWebhookV2BetaType
from ..models.event_resource_schema import EventResourceSchema
from ..types import UNSET, Unset

T = TypeVar("T", bound="AssayRunUpdatedFieldsWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class AssayRunUpdatedFieldsWebhookV2Beta:
    """  """

    _type: AssayRunUpdatedFieldsWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "AssayRunUpdatedFieldsWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> AssayRunUpdatedFieldsWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = AssayRunUpdatedFieldsWebhookV2BetaType(_type)
            except ValueError:
                type = AssayRunUpdatedFieldsWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(AssayRunUpdatedFieldsWebhookV2BetaType, UNSET)
        ...
        assay_run_updated_fields_webhook_v2_beta = cls(
            type=type,
        ...
        assay_run_updated_fields_webhook_v2_beta.additional_properties = d
        return assay_run_updated_fields_webhook_v2_beta
    ...
    @property
    def type(self) -> AssayRunUpdatedFieldsWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: AssayRunUpdatedFieldsWebhookV2BetaType) -> None:
        self._type = value
