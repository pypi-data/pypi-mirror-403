...
from ..models.rna_oligo_updated_webhook_v3_type import RnaOligoUpdatedWebhookV3Type
from ..models.v3_event_base_stability import V3EventBaseStability
from ..types import UNSET, Unset

T = TypeVar("T", bound="RnaOligoUpdatedWebhookV3")


@attr.s(auto_attribs=True, repr=False)
class RnaOligoUpdatedWebhookV3:
    """  """

    _type: RnaOligoUpdatedWebhookV3Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "RnaOligoUpdatedWebhookV3({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> RnaOligoUpdatedWebhookV3Type:
            _type = d.pop("type")
            try:
                type = RnaOligoUpdatedWebhookV3Type(_type)
            except ValueError:
                type = RnaOligoUpdatedWebhookV3Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(RnaOligoUpdatedWebhookV3Type, UNSET)
        ...
        rna_oligo_updated_webhook_v3 = cls(
            type=type,
        ...
        rna_oligo_updated_webhook_v3.additional_properties = d
        return rna_oligo_updated_webhook_v3
    ...
    @property
    def type(self) -> RnaOligoUpdatedWebhookV3Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: RnaOligoUpdatedWebhookV3Type) -> None:
        self._type = value
