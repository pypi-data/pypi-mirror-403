...
from ..models.project_created_webhook_v3_type import ProjectCreatedWebhookV3Type
from ..models.v3_event_base_stability import V3EventBaseStability
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectCreatedWebhookV3")


@attr.s(auto_attribs=True, repr=False)
class ProjectCreatedWebhookV3:
    """  """

    _type: ProjectCreatedWebhookV3Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "ProjectCreatedWebhookV3({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> ProjectCreatedWebhookV3Type:
            _type = d.pop("type")
            try:
                type = ProjectCreatedWebhookV3Type(_type)
            except ValueError:
                type = ProjectCreatedWebhookV3Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(ProjectCreatedWebhookV3Type, UNSET)
        ...
        project_created_webhook_v3 = cls(
            type=type,
        ...
        project_created_webhook_v3.additional_properties = d
        return project_created_webhook_v3
    ...
    @property
    def type(self) -> ProjectCreatedWebhookV3Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: ProjectCreatedWebhookV3Type) -> None:
        self._type = value
