...
from ..models.custom_entity_updated_webhook_v3_type import CustomEntityUpdatedWebhookV3Type
from ..models.v3_event_base_stability import V3EventBaseStability
from ..types import UNSET, Unset

T = TypeVar("T", bound="CustomEntityUpdatedWebhookV3")


@attr.s(auto_attribs=True, repr=False)
class CustomEntityUpdatedWebhookV3:
    """  """

    _type: CustomEntityUpdatedWebhookV3Type
    _deprecated: bool
    _properties: Union[Unset, List[str]] = UNSET
    ...
    def __repr__(self):
        ...
        fields.append("properties={}".format(repr(self._properties)))
        ...
        return "CustomEntityUpdatedWebhookV3({})".format(", ".join(fields))
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self._properties, Unset):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> CustomEntityUpdatedWebhookV3Type:
            _type = d.pop("type")
            try:
                type = CustomEntityUpdatedWebhookV3Type(_type)
            except ValueError:
                type = CustomEntityUpdatedWebhookV3Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(CustomEntityUpdatedWebhookV3Type, UNSET)
        ...
        def get_properties() -> Union[Unset, List[str]]:
        ...
        try:
            ...
            if strict:
                raise
            properties = cast(Union[Unset, List[str]], UNSET)
        ...
        custom_entity_updated_webhook_v3 = cls(
            type=type,
        ...
        custom_entity_updated_webhook_v3.additional_properties = d
        return custom_entity_updated_webhook_v3
    ...
    @property
    def type(self) -> CustomEntityUpdatedWebhookV3Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: CustomEntityUpdatedWebhookV3Type) -> None:
        self._type = value
    ...
    def properties(self) -> List[str]:
        ...
        if isinstance(self._properties, Unset):
            raise NotPresentError(self, "properties")
