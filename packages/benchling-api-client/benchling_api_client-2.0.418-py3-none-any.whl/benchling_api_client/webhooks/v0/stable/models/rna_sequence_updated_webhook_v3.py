...
from ..models.rna_sequence_updated_webhook_v3_type import RnaSequenceUpdatedWebhookV3Type
from ..models.v3_event_base_stability import V3EventBaseStability
from ..types import UNSET, Unset

T = TypeVar("T", bound="RnaSequenceUpdatedWebhookV3")


@attr.s(auto_attribs=True, repr=False)
class RnaSequenceUpdatedWebhookV3:
    """  """

    _type: RnaSequenceUpdatedWebhookV3Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "RnaSequenceUpdatedWebhookV3({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> RnaSequenceUpdatedWebhookV3Type:
            _type = d.pop("type")
            try:
                type = RnaSequenceUpdatedWebhookV3Type(_type)
            except ValueError:
                type = RnaSequenceUpdatedWebhookV3Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(RnaSequenceUpdatedWebhookV3Type, UNSET)
        ...
        rna_sequence_updated_webhook_v3 = cls(
            type=type,
        ...
        rna_sequence_updated_webhook_v3.additional_properties = d
        return rna_sequence_updated_webhook_v3
    ...
    @property
    def type(self) -> RnaSequenceUpdatedWebhookV3Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: RnaSequenceUpdatedWebhookV3Type) -> None:
        self._type = value
