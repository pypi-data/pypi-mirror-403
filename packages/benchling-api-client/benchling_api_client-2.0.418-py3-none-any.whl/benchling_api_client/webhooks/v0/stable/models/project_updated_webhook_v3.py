...
from ..models.project_updated_webhook_v3_type import ProjectUpdatedWebhookV3Type
from ..models.v3_event_base_stability import V3EventBaseStability
from ..types import UNSET, Unset

T = TypeVar("T", bound="ProjectUpdatedWebhookV3")


@attr.s(auto_attribs=True, repr=False)
class ProjectUpdatedWebhookV3:
    """  """

    _type: ProjectUpdatedWebhookV3Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "ProjectUpdatedWebhookV3({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> ProjectUpdatedWebhookV3Type:
            _type = d.pop("type")
            try:
                type = ProjectUpdatedWebhookV3Type(_type)
            except ValueError:
                type = ProjectUpdatedWebhookV3Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(ProjectUpdatedWebhookV3Type, UNSET)
        ...
        project_updated_webhook_v3 = cls(
            type=type,
        ...
        project_updated_webhook_v3.additional_properties = d
        return project_updated_webhook_v3
    ...
    @property
    def type(self) -> ProjectUpdatedWebhookV3Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: ProjectUpdatedWebhookV3Type) -> None:
        self._type = value
