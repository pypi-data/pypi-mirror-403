...
from ..models.dna_sequence_updated_webhook_v3_type import DnaSequenceUpdatedWebhookV3Type
from ..models.v3_event_base_stability import V3EventBaseStability
from ..types import UNSET, Unset

T = TypeVar("T", bound="DnaSequenceUpdatedWebhookV3")


@attr.s(auto_attribs=True, repr=False)
class DnaSequenceUpdatedWebhookV3:
    """  """

    _type: DnaSequenceUpdatedWebhookV3Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "DnaSequenceUpdatedWebhookV3({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> DnaSequenceUpdatedWebhookV3Type:
            _type = d.pop("type")
            try:
                type = DnaSequenceUpdatedWebhookV3Type(_type)
            except ValueError:
                type = DnaSequenceUpdatedWebhookV3Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(DnaSequenceUpdatedWebhookV3Type, UNSET)
        ...
        dna_sequence_updated_webhook_v3 = cls(
            type=type,
        ...
        dna_sequence_updated_webhook_v3.additional_properties = d
        return dna_sequence_updated_webhook_v3
    ...
    @property
    def type(self) -> DnaSequenceUpdatedWebhookV3Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: DnaSequenceUpdatedWebhookV3Type) -> None:
        self._type = value
