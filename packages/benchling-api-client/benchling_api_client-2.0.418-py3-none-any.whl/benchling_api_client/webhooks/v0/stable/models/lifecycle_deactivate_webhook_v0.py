...
from ..models.lifecycle_deactivate_webhook_v0_type import LifecycleDeactivateWebhookV0Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="LifecycleDeactivateWebhookV0")


@attr.s(auto_attribs=True, repr=False)
class LifecycleDeactivateWebhookV0:
    """Sent when a user initiates app deactivation on a tenant.
    Please migrate to AppDeactivatedWebhookV2."""

    _type: LifecycleDeactivateWebhookV0Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "LifecycleDeactivateWebhookV0({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> LifecycleDeactivateWebhookV0Type:
            _type = d.pop("type")
            try:
                type = LifecycleDeactivateWebhookV0Type(_type)
            except ValueError:
                type = LifecycleDeactivateWebhookV0Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(LifecycleDeactivateWebhookV0Type, UNSET)
        ...
        lifecycle_deactivate_webhook_v0 = cls(
            type=type,
            deprecated=deprecated,
            excluded_properties=excluded_properties,
        )

        return lifecycle_deactivate_webhook_v0

    @property
    def type(self) -> LifecycleDeactivateWebhookV0Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: LifecycleDeactivateWebhookV0Type) -> None:
        self._type = value
