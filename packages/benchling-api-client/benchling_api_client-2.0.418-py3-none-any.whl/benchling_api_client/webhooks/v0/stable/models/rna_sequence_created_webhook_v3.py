...
from ..models.rna_sequence_created_webhook_v3_type import RnaSequenceCreatedWebhookV3Type
from ..models.v3_event_base_stability import V3EventBaseStability
from ..types import UNSET, Unset

T = TypeVar("T", bound="RnaSequenceCreatedWebhookV3")


@attr.s(auto_attribs=True, repr=False)
class RnaSequenceCreatedWebhookV3:
    """  """

    _type: RnaSequenceCreatedWebhookV3Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "RnaSequenceCreatedWebhookV3({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> RnaSequenceCreatedWebhookV3Type:
            _type = d.pop("type")
            try:
                type = RnaSequenceCreatedWebhookV3Type(_type)
            except ValueError:
                type = RnaSequenceCreatedWebhookV3Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(RnaSequenceCreatedWebhookV3Type, UNSET)
        ...
        rna_sequence_created_webhook_v3 = cls(
            type=type,
        ...
        rna_sequence_created_webhook_v3.additional_properties = d
        return rna_sequence_created_webhook_v3
    ...
    @property
    def type(self) -> RnaSequenceCreatedWebhookV3Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: RnaSequenceCreatedWebhookV3Type) -> None:
        self._type = value
