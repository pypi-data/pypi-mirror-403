...
T = TypeVar("T", bound="EventBaseWebhookV2Schematized")


@attr.s(auto_attribs=True, repr=False)
class EventBaseWebhookV2Schematized:
    """  """

    _deprecated: bool
    _schema: Optional[EventResourceSchema]
    ...
    def __repr__(self):
        ...
        return "EventBaseWebhookV2Schematized({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_schema() -> Optional[EventResourceSchema]:
            schema = None
        ...
        try:
            ...
            if strict:
                raise
            schema = cast(Optional[EventResourceSchema], UNSET)
        ...
        event_base_webhook_v2_schematized = cls(
        ...
        event_base_webhook_v2_schematized.additional_properties = d
        return event_base_webhook_v2_schematized
