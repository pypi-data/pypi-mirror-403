...
from ..models.custom_entity_created_webhook_v3_type import CustomEntityCreatedWebhookV3Type
from ..models.v3_event_base_stability import V3EventBaseStability
from ..types import UNSET, Unset

T = TypeVar("T", bound="CustomEntityCreatedWebhookV3")


@attr.s(auto_attribs=True, repr=False)
class CustomEntityCreatedWebhookV3:
    """  """

    _type: CustomEntityCreatedWebhookV3Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "CustomEntityCreatedWebhookV3({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> CustomEntityCreatedWebhookV3Type:
            _type = d.pop("type")
            try:
                type = CustomEntityCreatedWebhookV3Type(_type)
            except ValueError:
                type = CustomEntityCreatedWebhookV3Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(CustomEntityCreatedWebhookV3Type, UNSET)
        ...
        custom_entity_created_webhook_v3 = cls(
            type=type,
        ...
        custom_entity_created_webhook_v3.additional_properties = d
        return custom_entity_created_webhook_v3
    ...
    @property
    def type(self) -> CustomEntityCreatedWebhookV3Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: CustomEntityCreatedWebhookV3Type) -> None:
        self._type = value
