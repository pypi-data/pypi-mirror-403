...
from ..models.workflow_task_group_updated_watchers_webhook_v2_type import (
    WorkflowTaskGroupUpdatedWatchersWebhookV2Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskGroupUpdatedWatchersWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class WorkflowTaskGroupUpdatedWatchersWebhookV2:
    """  """

    _type: WorkflowTaskGroupUpdatedWatchersWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskGroupUpdatedWatchersWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowTaskGroupUpdatedWatchersWebhookV2Type:
            _type = d.pop("type")
            try:
                type = WorkflowTaskGroupUpdatedWatchersWebhookV2Type(_type)
            except ValueError:
                type = WorkflowTaskGroupUpdatedWatchersWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowTaskGroupUpdatedWatchersWebhookV2Type, UNSET)
        ...
        workflow_task_group_updated_watchers_webhook_v2 = cls(
            type=type,
        ...
        workflow_task_group_updated_watchers_webhook_v2.additional_properties = d
        return workflow_task_group_updated_watchers_webhook_v2
    ...
    @property
    def type(self) -> WorkflowTaskGroupUpdatedWatchersWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowTaskGroupUpdatedWatchersWebhookV2Type) -> None:
        self._type = value
