...
from ..models.dna_oligo_updated_webhook_v3_type import DnaOligoUpdatedWebhookV3Type
from ..models.v3_event_base_stability import V3EventBaseStability
from ..types import UNSET, Unset

T = TypeVar("T", bound="DnaOligoUpdatedWebhookV3")


@attr.s(auto_attribs=True, repr=False)
class DnaOligoUpdatedWebhookV3:
    """  """

    _type: DnaOligoUpdatedWebhookV3Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "DnaOligoUpdatedWebhookV3({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> DnaOligoUpdatedWebhookV3Type:
            _type = d.pop("type")
            try:
                type = DnaOligoUpdatedWebhookV3Type(_type)
            except ValueError:
                type = DnaOligoUpdatedWebhookV3Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(DnaOligoUpdatedWebhookV3Type, UNSET)
        ...
        dna_oligo_updated_webhook_v3 = cls(
            type=type,
        ...
        dna_oligo_updated_webhook_v3.additional_properties = d
        return dna_oligo_updated_webhook_v3
    ...
    @property
    def type(self) -> DnaOligoUpdatedWebhookV3Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: DnaOligoUpdatedWebhookV3Type) -> None:
        self._type = value
