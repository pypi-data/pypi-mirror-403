...
from ..models.workflow_task_updated_assignee_webhook_v2_type import WorkflowTaskUpdatedAssigneeWebhookV2Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskUpdatedAssigneeWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class WorkflowTaskUpdatedAssigneeWebhookV2:
    """  """

    _type: WorkflowTaskUpdatedAssigneeWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskUpdatedAssigneeWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowTaskUpdatedAssigneeWebhookV2Type:
            _type = d.pop("type")
            try:
                type = WorkflowTaskUpdatedAssigneeWebhookV2Type(_type)
            except ValueError:
                type = WorkflowTaskUpdatedAssigneeWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowTaskUpdatedAssigneeWebhookV2Type, UNSET)
        ...
        workflow_task_updated_assignee_webhook_v2 = cls(
            type=type,
        ...
        workflow_task_updated_assignee_webhook_v2.additional_properties = d
        return workflow_task_updated_assignee_webhook_v2
    ...
    @property
    def type(self) -> WorkflowTaskUpdatedAssigneeWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowTaskUpdatedAssigneeWebhookV2Type) -> None:
        self._type = value
