...
from ..models.workflow_output_created_webhook_v2_type import WorkflowOutputCreatedWebhookV2Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowOutputCreatedWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class WorkflowOutputCreatedWebhookV2:
    """  """

    _type: WorkflowOutputCreatedWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowOutputCreatedWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowOutputCreatedWebhookV2Type:
            _type = d.pop("type")
            try:
                type = WorkflowOutputCreatedWebhookV2Type(_type)
            except ValueError:
                type = WorkflowOutputCreatedWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowOutputCreatedWebhookV2Type, UNSET)
        ...
        workflow_output_created_webhook_v2 = cls(
            type=type,
        ...
        workflow_output_created_webhook_v2.additional_properties = d
        return workflow_output_created_webhook_v2
    ...
    @property
    def type(self) -> WorkflowOutputCreatedWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowOutputCreatedWebhookV2Type) -> None:
        self._type = value
