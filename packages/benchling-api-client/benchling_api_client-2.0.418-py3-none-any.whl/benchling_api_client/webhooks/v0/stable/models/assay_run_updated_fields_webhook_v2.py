...
from ..models.assay_run_updated_fields_webhook_v2_type import AssayRunUpdatedFieldsWebhookV2Type
from ..models.event_resource_schema import EventResourceSchema
from ..types import UNSET, Unset

T = TypeVar("T", bound="AssayRunUpdatedFieldsWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class AssayRunUpdatedFieldsWebhookV2:
    """  """

    _type: AssayRunUpdatedFieldsWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "AssayRunUpdatedFieldsWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> AssayRunUpdatedFieldsWebhookV2Type:
            _type = d.pop("type")
            try:
                type = AssayRunUpdatedFieldsWebhookV2Type(_type)
            except ValueError:
                type = AssayRunUpdatedFieldsWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(AssayRunUpdatedFieldsWebhookV2Type, UNSET)
        ...
        assay_run_updated_fields_webhook_v2 = cls(
            type=type,
        ...
        assay_run_updated_fields_webhook_v2.additional_properties = d
        return assay_run_updated_fields_webhook_v2
    ...
    @property
    def type(self) -> AssayRunUpdatedFieldsWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: AssayRunUpdatedFieldsWebhookV2Type) -> None:
        self._type = value
