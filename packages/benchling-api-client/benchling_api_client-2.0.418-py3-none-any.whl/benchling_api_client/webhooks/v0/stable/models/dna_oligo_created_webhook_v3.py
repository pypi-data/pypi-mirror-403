...
from ..models.dna_oligo_created_webhook_v3_type import DnaOligoCreatedWebhookV3Type
from ..models.v3_event_base_stability import V3EventBaseStability
from ..types import UNSET, Unset

T = TypeVar("T", bound="DnaOligoCreatedWebhookV3")


@attr.s(auto_attribs=True, repr=False)
class DnaOligoCreatedWebhookV3:
    """  """

    _type: DnaOligoCreatedWebhookV3Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "DnaOligoCreatedWebhookV3({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> DnaOligoCreatedWebhookV3Type:
            _type = d.pop("type")
            try:
                type = DnaOligoCreatedWebhookV3Type(_type)
            except ValueError:
                type = DnaOligoCreatedWebhookV3Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(DnaOligoCreatedWebhookV3Type, UNSET)
        ...
        dna_oligo_created_webhook_v3 = cls(
            type=type,
        ...
        dna_oligo_created_webhook_v3.additional_properties = d
        return dna_oligo_created_webhook_v3
    ...
    @property
    def type(self) -> DnaOligoCreatedWebhookV3Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: DnaOligoCreatedWebhookV3Type) -> None:
        self._type = value
