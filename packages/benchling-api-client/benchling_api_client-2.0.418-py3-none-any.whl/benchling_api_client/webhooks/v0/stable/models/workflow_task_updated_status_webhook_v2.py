...
from ..models.workflow_task_updated_status_webhook_v2_type import WorkflowTaskUpdatedStatusWebhookV2Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskUpdatedStatusWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class WorkflowTaskUpdatedStatusWebhookV2:
    """  """

    _type: WorkflowTaskUpdatedStatusWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskUpdatedStatusWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowTaskUpdatedStatusWebhookV2Type:
            _type = d.pop("type")
            try:
                type = WorkflowTaskUpdatedStatusWebhookV2Type(_type)
            except ValueError:
                type = WorkflowTaskUpdatedStatusWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowTaskUpdatedStatusWebhookV2Type, UNSET)
        ...
        workflow_task_updated_status_webhook_v2 = cls(
            type=type,
        ...
        workflow_task_updated_status_webhook_v2.additional_properties = d
        return workflow_task_updated_status_webhook_v2
    ...
    @property
    def type(self) -> WorkflowTaskUpdatedStatusWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowTaskUpdatedStatusWebhookV2Type) -> None:
        self._type = value
