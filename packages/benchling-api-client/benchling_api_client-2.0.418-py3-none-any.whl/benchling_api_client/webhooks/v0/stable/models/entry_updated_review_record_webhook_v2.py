...
from ..models.entry_updated_review_record_webhook_v2_type import EntryUpdatedReviewRecordWebhookV2Type
from ..models.event_resource_schema import EventResourceSchema
from ..types import UNSET, Unset

T = TypeVar("T", bound="EntryUpdatedReviewRecordWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class EntryUpdatedReviewRecordWebhookV2:
    """  """

    _type: EntryUpdatedReviewRecordWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "EntryUpdatedReviewRecordWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> EntryUpdatedReviewRecordWebhookV2Type:
            _type = d.pop("type")
            try:
                type = EntryUpdatedReviewRecordWebhookV2Type(_type)
            except ValueError:
                type = EntryUpdatedReviewRecordWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(EntryUpdatedReviewRecordWebhookV2Type, UNSET)
        ...
        entry_updated_review_record_webhook_v2 = cls(
            type=type,
        ...
        entry_updated_review_record_webhook_v2.additional_properties = d
        return entry_updated_review_record_webhook_v2
    ...
    @property
    def type(self) -> EntryUpdatedReviewRecordWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: EntryUpdatedReviewRecordWebhookV2Type) -> None:
        self._type = value
