...
T = TypeVar("T", bound="V2UpdateEventBaseSchematized")


@attr.s(auto_attribs=True, repr=False)
class V2UpdateEventBaseSchematized:
    """  """
    ...
    def __repr__(self):
        ...
        return "V2UpdateEventBaseSchematized({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        v2_update_event_base_schematized = cls(
        ...
        v2_update_event_base_schematized.additional_properties = d
        return v2_update_event_base_schematized
