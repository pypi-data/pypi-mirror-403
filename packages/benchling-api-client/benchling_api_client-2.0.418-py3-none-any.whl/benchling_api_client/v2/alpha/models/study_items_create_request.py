...
T = TypeVar("T", bound="StudyItemsCreateRequest")


@attr.s(auto_attribs=True, repr=False)
class StudyItemsCreateRequest:
    """  """
    ...
    def __repr__(self):
        ...
        return "StudyItemsCreateRequest({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        study_items_create_request = cls(
            item_ids=item_ids,
        )

        return study_items_create_request
