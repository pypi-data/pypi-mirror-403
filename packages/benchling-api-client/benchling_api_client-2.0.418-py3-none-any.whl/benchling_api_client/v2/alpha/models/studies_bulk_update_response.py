...
T = TypeVar("T", bound="StudiesBulkUpdateResponse")


@attr.s(auto_attribs=True, repr=False)
class StudiesBulkUpdateResponse:
    """  """
    ...
    def __repr__(self):
        ...
        return "StudiesBulkUpdateResponse({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        studies_bulk_update_response = cls(
            studies=studies,
        )

        studies_bulk_update_response.additional_properties = d
        return studies_bulk_update_response
