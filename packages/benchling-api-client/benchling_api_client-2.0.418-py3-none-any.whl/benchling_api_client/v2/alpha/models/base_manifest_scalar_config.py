...
T = TypeVar("T", bound="BaseManifestScalarConfig")


@attr.s(auto_attribs=True, repr=False)
class BaseManifestScalarConfig:
    """  """
    ...
    def __repr__(self):
        ...
        return "BaseManifestScalarConfig({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        base_manifest_scalar_config = cls(
            name=name,
            description=description,
            required_config=required_config,
        )

        base_manifest_scalar_config.additional_properties = d
        return base_manifest_scalar_config
