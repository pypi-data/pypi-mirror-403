...
from ..models.assembly_gibson_existing_homology_regions_params_fragment_production_method import (
    AssemblyGibsonExistingHomologyRegionsParamsFragmentProductionMethod,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="AssemblyGibsonExistingHomologyRegionsParams")


@attr.s(auto_attribs=True, repr=False)
class AssemblyGibsonExistingHomologyRegionsParams:
    """  """

    _fragment_production_method: AssemblyGibsonExistingHomologyRegionsParamsFragmentProductionMethod
    ...
    def __repr__(self):
        ...
        return "AssemblyGibsonExistingHomologyRegionsParams({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_fragment_production_method() -> AssemblyGibsonExistingHomologyRegionsParamsFragmentProductionMethod:
            ...
            try:
                ...
                fragment_production_method = (
                    AssemblyGibsonExistingHomologyRegionsParamsFragmentProductionMethod.of_unknown(
                        _fragment_production_method
                    )
                )
        ...
        try:
            ...
            fragment_production_method = cast(
                AssemblyGibsonExistingHomologyRegionsParamsFragmentProductionMethod, UNSET
            )
        ...
        assembly_gibson_existing_homology_regions_params = cls(
        ...
        return assembly_gibson_existing_homology_regions_params
    ...
    def fragment_production_method(
        self, value: AssemblyGibsonExistingHomologyRegionsParamsFragmentProductionMethod
    ) -> None:
