...
) -> Optional[Union[Container, BadRequestError, ForbiddenRestrictedSampleError, NotFoundError]]:
...
def _build_response(
    *, response: httpx.Response
) -> Response[Union[Container, BadRequestError, ForbiddenRestrictedSampleError, NotFoundError]]:
    return Response(
