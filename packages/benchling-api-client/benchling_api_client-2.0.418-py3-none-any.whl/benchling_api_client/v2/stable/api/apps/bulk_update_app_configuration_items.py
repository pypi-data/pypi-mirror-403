...
from ...models.app_config_items_bulk_update_request import AppConfigItemsBulkUpdateRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: AppConfigItemsBulkUpdateRequest,
) -> Dict[str, Any]:
    url = "{}/app-configuration-items:bulk-update".format(client.base_url)
