...
from ..models.automation_transform_status_succeeded_event_v2_event_event_type import (
...
T = TypeVar("T", bound="AutomationTransformStatusSucceededEventV2Event")


@attr.s(auto_attribs=True, repr=False)
class AutomationTransformStatusSucceededEventV2Event:
    """  """

    _automation_file_transform: Union[Unset, LabAutomationTransform] = UNSET
    _event_type: Union[Unset, AutomationTransformStatusSucceededEventV2EventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "AutomationTransformStatusSucceededEventV2Event({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> Union[Unset, AutomationTransformStatusSucceededEventV2EventEventType]:
            event_type = UNSET
            _event_type = d.pop("eventType")
            if _event_type is not None and _event_type is not UNSET:
                try:
                    event_type = AutomationTransformStatusSucceededEventV2EventEventType(_event_type)
                except ValueError:
                    event_type = AutomationTransformStatusSucceededEventV2EventEventType.of_unknown(
                        _event_type
                    )
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(Union[Unset, AutomationTransformStatusSucceededEventV2EventEventType], UNSET)
        ...
        automation_transform_status_succeeded_event_v2_event = cls(
        ...
        automation_transform_status_succeeded_event_v2_event.additional_properties = d
        return automation_transform_status_succeeded_event_v2_event
    ...
    @property
    def event_type(self) -> AutomationTransformStatusSucceededEventV2EventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: AutomationTransformStatusSucceededEventV2EventEventType) -> None:
