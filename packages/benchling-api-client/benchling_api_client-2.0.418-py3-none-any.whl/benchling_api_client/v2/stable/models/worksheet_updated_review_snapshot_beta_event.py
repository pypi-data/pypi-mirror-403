...
from ..models.worksheet_updated_review_snapshot_beta_event_event_type import (
    WorksheetUpdatedReviewSnapshotBetaEventEventType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorksheetUpdatedReviewSnapshotBetaEvent")


@attr.s(auto_attribs=True, repr=False)
class WorksheetUpdatedReviewSnapshotBetaEvent:
    """  """

    _entry: Union[Unset, WorksheetReviewChanges] = UNSET
    _event_type: Union[Unset, WorksheetUpdatedReviewSnapshotBetaEventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "WorksheetUpdatedReviewSnapshotBetaEvent({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_entry() -> Union[Unset, WorksheetReviewChanges]:
            entry: Union[Unset, Union[Unset, WorksheetReviewChanges]] = UNSET
            _entry = d.pop("entry")

            if not isinstance(_entry, Unset):
                entry = WorksheetReviewChanges.from_dict(_entry)
        ...
        try:
            ...
            if strict:
                raise
            entry = cast(Union[Unset, WorksheetReviewChanges], UNSET)

        def get_event_type() -> Union[Unset, WorksheetUpdatedReviewSnapshotBetaEventEventType]:
            event_type = UNSET
            _event_type = d.pop("eventType")
            if _event_type is not None and _event_type is not UNSET:
                try:
                    event_type = WorksheetUpdatedReviewSnapshotBetaEventEventType(_event_type)
                except ValueError:
                    event_type = WorksheetUpdatedReviewSnapshotBetaEventEventType.of_unknown(_event_type)
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(Union[Unset, WorksheetUpdatedReviewSnapshotBetaEventEventType], UNSET)
        ...
        worksheet_updated_review_snapshot_beta_event = cls(
            entry=entry,
        ...
        worksheet_updated_review_snapshot_beta_event.additional_properties = d
        return worksheet_updated_review_snapshot_beta_event
    ...
    @property
    def entry(self) -> WorksheetReviewChanges:
    ...
    @entry.setter
    def entry(self, value: WorksheetReviewChanges) -> None:
        self._entry = value
    ...
    @property
    def event_type(self) -> WorksheetUpdatedReviewSnapshotBetaEventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: WorksheetUpdatedReviewSnapshotBetaEventEventType) -> None:
