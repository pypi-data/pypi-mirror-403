...
from ..models.automation_transform_status_pending_event_v2_event_event_type import (
...
T = TypeVar("T", bound="AutomationTransformStatusPendingEventV2Event")


@attr.s(auto_attribs=True, repr=False)
class AutomationTransformStatusPendingEventV2Event:
    """  """

    _automation_file_transform: Union[Unset, LabAutomationTransform] = UNSET
    _event_type: Union[Unset, AutomationTransformStatusPendingEventV2EventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "AutomationTransformStatusPendingEventV2Event({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> Union[Unset, AutomationTransformStatusPendingEventV2EventEventType]:
            event_type = UNSET
            _event_type = d.pop("eventType")
            if _event_type is not None and _event_type is not UNSET:
                try:
                    event_type = AutomationTransformStatusPendingEventV2EventEventType(_event_type)
                except ValueError:
                    event_type = AutomationTransformStatusPendingEventV2EventEventType.of_unknown(_event_type)
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(Union[Unset, AutomationTransformStatusPendingEventV2EventEventType], UNSET)
        ...
        automation_transform_status_pending_event_v2_event = cls(
        ...
        automation_transform_status_pending_event_v2_event.additional_properties = d
        return automation_transform_status_pending_event_v2_event
    ...
    @property
    def event_type(self) -> AutomationTransformStatusPendingEventV2EventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: AutomationTransformStatusPendingEventV2EventEventType) -> None:
