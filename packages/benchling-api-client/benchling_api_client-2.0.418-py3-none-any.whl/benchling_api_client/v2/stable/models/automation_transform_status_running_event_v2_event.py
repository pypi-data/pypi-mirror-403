...
from ..models.automation_transform_status_running_event_v2_event_event_type import (
...
T = TypeVar("T", bound="AutomationTransformStatusRunningEventV2Event")


@attr.s(auto_attribs=True, repr=False)
class AutomationTransformStatusRunningEventV2Event:
    """  """

    _automation_file_transform: Union[Unset, LabAutomationTransform] = UNSET
    _event_type: Union[Unset, AutomationTransformStatusRunningEventV2EventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "AutomationTransformStatusRunningEventV2Event({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> Union[Unset, AutomationTransformStatusRunningEventV2EventEventType]:
            event_type = UNSET
            _event_type = d.pop("eventType")
            if _event_type is not None and _event_type is not UNSET:
                try:
                    event_type = AutomationTransformStatusRunningEventV2EventEventType(_event_type)
                except ValueError:
                    event_type = AutomationTransformStatusRunningEventV2EventEventType.of_unknown(_event_type)
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(Union[Unset, AutomationTransformStatusRunningEventV2EventEventType], UNSET)
        ...
        automation_transform_status_running_event_v2_event = cls(
        ...
        automation_transform_status_running_event_v2_event.additional_properties = d
        return automation_transform_status_running_event_v2_event
    ...
    @property
    def event_type(self) -> AutomationTransformStatusRunningEventV2EventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: AutomationTransformStatusRunningEventV2EventEventType) -> None:
