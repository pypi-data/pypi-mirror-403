...
T = TypeVar("T", bound="FileUploadUiBlock")


@attr.s(auto_attribs=True, repr=False)
class FileUploadUiBlock:
    """  """

    _type: FileUploadUiBlockType
    _id: str
    ...
    def __repr__(self):
        ...
        return "FileUploadUiBlock({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> FileUploadUiBlockType:
            _type = d.pop("type")
            try:
        ...
        try:
            ...
            if strict:
                raise
            type = cast(FileUploadUiBlockType, UNSET)
        ...
        file_upload_ui_block.additional_properties = d
        return file_upload_ui_block
