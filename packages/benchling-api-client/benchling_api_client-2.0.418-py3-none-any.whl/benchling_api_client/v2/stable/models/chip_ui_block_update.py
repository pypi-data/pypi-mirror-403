...
T = TypeVar("T", bound="ChipUiBlockUpdate")
...
class ChipUiBlockUpdate:
    ...
    def __repr__(self):
        ...
        return "ChipUiBlockUpdate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        chip_ui_block_update = cls(
            id=id,
            type=type,
            value=value,
        )

        chip_ui_block_update.additional_properties = d
        return chip_ui_block_update
