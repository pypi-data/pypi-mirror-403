...
def sync(
    *,
    ...
    """ Create a dataset. Note that a data frame must already exist to create a dataset. The data frame id is required in this request in order to create a dataset. """
