...
from ..models.manifest_float_scalar_config_type import ManifestFloatScalarConfigType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ManifestFloatScalarConfig")


@attr.s(auto_attribs=True, repr=False)
class ManifestFloatScalarConfig:
    """  """

    _type: ManifestFloatScalarConfigType
    _name: str
    _enum: Union[Unset, List[float]] = UNSET
    ...
    def __repr__(self):
        ...
        return "ManifestFloatScalarConfig({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> ManifestFloatScalarConfigType:
            _type = d.pop("type")
            try:
                type = ManifestFloatScalarConfigType(_type)
            except ValueError:
                type = ManifestFloatScalarConfigType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(ManifestFloatScalarConfigType, UNSET)
        ...
        def get_enum() -> Union[Unset, List[float]]:
            enum = cast(List[float], d.pop("enum"))
        ...
        try:
            ...
            if strict:
                raise
            enum = cast(Union[Unset, List[float]], UNSET)
        ...
        manifest_float_scalar_config = cls(
            type=type,
            name=name,
            enum=enum,
        ...
        return manifest_float_scalar_config

    @property
    def type(self) -> ManifestFloatScalarConfigType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: ManifestFloatScalarConfigType) -> None:
        self._type = value
