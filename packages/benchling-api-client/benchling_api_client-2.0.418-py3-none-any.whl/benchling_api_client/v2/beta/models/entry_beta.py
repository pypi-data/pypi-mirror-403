...
from ..models.entry_beta_review_record import EntryBetaReviewRecord
...
class EntryBeta:
    ...
    *Note:* the current Entry resource has a few limitations:
    ...
    _review_record: Union[Unset, None, EntryBetaReviewRecord] = UNSET
    ...
    def __repr__(self):
        ...
        return "EntryBeta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_review_record() -> Union[Unset, None, EntryBetaReviewRecord]:
            review_record = None
            _review_record = d.pop("reviewRecord")

            if _review_record is not None and not isinstance(_review_record, Unset):
                review_record = EntryBetaReviewRecord.from_dict(_review_record)
        ...
        try:
            ...
            if strict:
                raise
            review_record = cast(Union[Unset, None, EntryBetaReviewRecord], UNSET)
        ...
        entry_beta.additional_properties = d
        return entry_beta
    ...
    @property
    def review_record(self) -> Optional[EntryBetaReviewRecord]:
    ...
    def review_record(self, value: Optional[EntryBetaReviewRecord]) -> None:
