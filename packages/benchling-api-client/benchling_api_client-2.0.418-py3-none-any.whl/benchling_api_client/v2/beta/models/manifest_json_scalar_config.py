...
from ..models.manifest_json_scalar_config_type import ManifestJsonScalarConfigType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ManifestJsonScalarConfig")


@attr.s(auto_attribs=True, repr=False)
class ManifestJsonScalarConfig:
    """  """

    _type: ManifestJsonScalarConfigType
    _name: str
    ...
    def __repr__(self):
        ...
        return "ManifestJsonScalarConfig({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> ManifestJsonScalarConfigType:
            _type = d.pop("type")
            try:
                type = ManifestJsonScalarConfigType(_type)
            except ValueError:
                type = ManifestJsonScalarConfigType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(ManifestJsonScalarConfigType, UNSET)
        ...
        manifest_json_scalar_config = cls(
            type=type,
            name=name,
        ...
        return manifest_json_scalar_config

    @property
    def type(self) -> ManifestJsonScalarConfigType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: ManifestJsonScalarConfigType) -> None:
        self._type = value
