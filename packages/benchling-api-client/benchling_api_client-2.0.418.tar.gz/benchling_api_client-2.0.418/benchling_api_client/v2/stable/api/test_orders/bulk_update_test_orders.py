...
from ...models.test_orders_bulk_update_request import TestOrdersBulkUpdateRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: TestOrdersBulkUpdateRequest,
) -> Dict[str, Any]:
    url = "{}/test-orders:bulk-update".format(client.base_url)
