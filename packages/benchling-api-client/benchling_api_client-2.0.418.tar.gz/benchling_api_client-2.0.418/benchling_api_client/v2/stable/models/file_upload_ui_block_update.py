...
T = TypeVar("T", bound="FileUploadUiBlockUpdate")


@attr.s(auto_attribs=True, repr=False)
class FileUploadUiBlockUpdate:
    """  """
    ...
    def __repr__(self):
        ...
        return "FileUploadUiBlockUpdate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        file_upload_ui_block_update = cls(
            id=id,
        ...
        file_upload_ui_block_update.additional_properties = d
        return file_upload_ui_block_update
