...
from ..models.entry_updated_review_snapshot_beta_event_event_type import (
    EntryUpdatedReviewSnapshotBetaEventEventType,
)
from ..models.event_base_schema import EventBaseSchema
from ..types import UNSET, Unset

T = TypeVar("T", bound="EntryUpdatedReviewSnapshotBetaEvent")


@attr.s(auto_attribs=True, repr=False)
class EntryUpdatedReviewSnapshotBetaEvent:
    """  """

    _entry: Union[Unset, Entry] = UNSET
    _event_type: Union[Unset, EntryUpdatedReviewSnapshotBetaEventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "EntryUpdatedReviewSnapshotBetaEvent({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> Union[Unset, EntryUpdatedReviewSnapshotBetaEventEventType]:
            event_type = UNSET
            _event_type = d.pop("eventType")
            if _event_type is not None and _event_type is not UNSET:
                try:
                    event_type = EntryUpdatedReviewSnapshotBetaEventEventType(_event_type)
                except ValueError:
                    event_type = EntryUpdatedReviewSnapshotBetaEventEventType.of_unknown(_event_type)
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(Union[Unset, EntryUpdatedReviewSnapshotBetaEventEventType], UNSET)
        ...
        entry_updated_review_snapshot_beta_event = cls(
            entry=entry,
        ...
        entry_updated_review_snapshot_beta_event.additional_properties = d
        return entry_updated_review_snapshot_beta_event
    ...
    @property
    def event_type(self) -> EntryUpdatedReviewSnapshotBetaEventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: EntryUpdatedReviewSnapshotBetaEventEventType) -> None:
