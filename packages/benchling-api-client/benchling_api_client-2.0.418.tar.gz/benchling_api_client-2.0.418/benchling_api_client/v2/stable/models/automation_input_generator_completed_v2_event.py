...
from ..models.automation_input_generator_completed_v2_event_event_type import (
    AutomationInputGeneratorCompletedV2EventEventType,
)
from ..models.event_base_schema import EventBaseSchema
from ..types import UNSET, Unset

T = TypeVar("T", bound="AutomationInputGeneratorCompletedV2Event")


@attr.s(auto_attribs=True, repr=False)
class AutomationInputGeneratorCompletedV2Event:
    """  """

    _automation_input_generator: Union[Unset, AutomationFile] = UNSET
    _event_type: Union[Unset, AutomationInputGeneratorCompletedV2EventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "AutomationInputGeneratorCompletedV2Event({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> Union[Unset, AutomationInputGeneratorCompletedV2EventEventType]:
            event_type = UNSET
            _event_type = d.pop("eventType")
            if _event_type is not None and _event_type is not UNSET:
                try:
                    event_type = AutomationInputGeneratorCompletedV2EventEventType(_event_type)
                except ValueError:
                    event_type = AutomationInputGeneratorCompletedV2EventEventType.of_unknown(_event_type)
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(Union[Unset, AutomationInputGeneratorCompletedV2EventEventType], UNSET)
        ...
        automation_input_generator_completed_v2_event = cls(
        ...
        automation_input_generator_completed_v2_event.additional_properties = d
        return automation_input_generator_completed_v2_event
    ...
    @property
    def event_type(self) -> AutomationInputGeneratorCompletedV2EventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: AutomationInputGeneratorCompletedV2EventEventType) -> None:
