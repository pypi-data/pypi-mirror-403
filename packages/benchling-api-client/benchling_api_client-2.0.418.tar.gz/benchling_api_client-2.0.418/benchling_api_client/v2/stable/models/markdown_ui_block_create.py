...
T = TypeVar("T", bound="MarkdownUiBlockCreate")
...
class MarkdownUiBlockCreate:
    ...
    def __repr__(self):
        ...
        return "MarkdownUiBlockCreate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        markdown_ui_block_create = cls(
            type=type,
            value=value,
            id=id,
        )

        markdown_ui_block_create.additional_properties = d
        return markdown_ui_block_create
