...
T = TypeVar("T", bound="TableUiBlockCreate")
...
class TableUiBlockCreate:
    ...
    def __repr__(self):
        ...
        return "TableUiBlockCreate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        table_ui_block_create.additional_properties = d
        return table_ui_block_create
