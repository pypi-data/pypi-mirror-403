...
from ..models.dataset_creator import DatasetCreator
...
class Dataset:
    ...
    _creator: Union[Unset, DatasetCreator] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_creator() -> Union[Unset, DatasetCreator]:
            creator: Union[Unset, Union[Unset, DatasetCreator]] = UNSET
            _creator = d.pop("creator")

            if not isinstance(_creator, Unset):
                creator = DatasetCreator.from_dict(_creator)
        ...
        try:
            ...
            if strict:
                raise
            creator = cast(Union[Unset, DatasetCreator], UNSET)
    ...
    @property
    def creator(self) -> DatasetCreator:
        if isinstance(self._creator, Unset):
            raise NotPresentError(self, "creator")
        return self._creator

    @creator.setter
    def creator(self, value: DatasetCreator) -> None:
        self._creator = value
    ...
    def data_frame_id(self) -> str:
        """ ID of the data frame to link to this dataset """
    ...
    def display_id(self) -> str:
        """ User-friendly ID of the dataset """
