...
from ..models.manifest_text_scalar_config_type import ManifestTextScalarConfigType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ManifestTextScalarConfig")


@attr.s(auto_attribs=True, repr=False)
class ManifestTextScalarConfig:
    """  """

    _type: ManifestTextScalarConfigType
    _name: str
    _enum: Union[Unset, List[str]] = UNSET
    ...
    def __repr__(self):
        ...
        return "ManifestTextScalarConfig({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> ManifestTextScalarConfigType:
            _type = d.pop("type")
            try:
                type = ManifestTextScalarConfigType(_type)
            except ValueError:
                type = ManifestTextScalarConfigType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(ManifestTextScalarConfigType, UNSET)
        ...
        def get_enum() -> Union[Unset, List[str]]:
            enum = cast(List[str], d.pop("enum"))
        ...
        try:
            ...
            if strict:
                raise
            enum = cast(Union[Unset, List[str]], UNSET)
        ...
        manifest_text_scalar_config = cls(
            type=type,
            name=name,
            enum=enum,
        ...
        return manifest_text_scalar_config

    @property
    def type(self) -> ManifestTextScalarConfigType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: ManifestTextScalarConfigType) -> None:
        self._type = value
