...
from ..models.manifest_secure_text_scalar_config_type import ManifestSecureTextScalarConfigType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ManifestSecureTextScalarConfig")


@attr.s(auto_attribs=True, repr=False)
class ManifestSecureTextScalarConfig:
    """  """

    _type: ManifestSecureTextScalarConfigType
    _name: str
    ...
    def __repr__(self):
        ...
        return "ManifestSecureTextScalarConfig({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> ManifestSecureTextScalarConfigType:
            _type = d.pop("type")
            try:
                type = ManifestSecureTextScalarConfigType(_type)
            except ValueError:
                type = ManifestSecureTextScalarConfigType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(ManifestSecureTextScalarConfigType, UNSET)
        ...
        manifest_secure_text_scalar_config = cls(
            type=type,
            name=name,
        ...
        return manifest_secure_text_scalar_config

    @property
    def type(self) -> ManifestSecureTextScalarConfigType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: ManifestSecureTextScalarConfigType) -> None:
        self._type = value
