...
from ..models.manifest_date_scalar_config_type import ManifestDateScalarConfigType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ManifestDateScalarConfig")


@attr.s(auto_attribs=True, repr=False)
class ManifestDateScalarConfig:
    """  """

    _type: ManifestDateScalarConfigType
    _name: str
    ...
    def __repr__(self):
        ...
        return "ManifestDateScalarConfig({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> ManifestDateScalarConfigType:
            _type = d.pop("type")
            try:
                type = ManifestDateScalarConfigType(_type)
            except ValueError:
                type = ManifestDateScalarConfigType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(ManifestDateScalarConfigType, UNSET)
        ...
        manifest_date_scalar_config = cls(
            type=type,
            name=name,
        ...
        return manifest_date_scalar_config

    @property
    def type(self) -> ManifestDateScalarConfigType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: ManifestDateScalarConfigType) -> None:
        self._type = value
