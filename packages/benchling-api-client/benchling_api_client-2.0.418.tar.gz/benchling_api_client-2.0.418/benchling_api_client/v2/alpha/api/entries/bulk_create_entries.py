...
from ...models.bulk_create_entries_request import BulkCreateEntriesRequest
...
def _get_kwargs(
    *,
    client: Client,
    json_body: BulkCreateEntriesRequest,
) -> Dict[str, Any]:
    url = "{}/entries:bulk-create".format(client.base_url)
...
def sync(
    *,
    ...
    """Bulk create notebook entries with optional attachments. Limit of 100 Entries per request. Attachments will be placed into the entry body in the order they are specified."""
