...
def sync(
    *,
    ...
    """Returns information about collaborations on the specified Folders. Collaboration endpoints are moving to beta. Visit the [beta v2 docs](https://benchling.com/api/v2-beta/reference?showLA=true#/Folders)."""
