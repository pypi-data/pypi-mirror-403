...
from ...models.create_and_finalize_assembly_json_body import CreateAndFinalizeAssemblyJsonBody
...
def _get_kwargs(
    *,
    client: Client,
    json_body: CreateAndFinalizeAssemblyJsonBody,
) -> Dict[str, Any]:
    url = "{}/assemblies:create-and-finalize".format(client.base_url)
