...
from ..models.workflow_output_updated_fields_webhook_v2_beta_type import (
    WorkflowOutputUpdatedFieldsWebhookV2BetaType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowOutputUpdatedFieldsWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class WorkflowOutputUpdatedFieldsWebhookV2Beta:
    """  """

    _type: WorkflowOutputUpdatedFieldsWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowOutputUpdatedFieldsWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowOutputUpdatedFieldsWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = WorkflowOutputUpdatedFieldsWebhookV2BetaType(_type)
            except ValueError:
                type = WorkflowOutputUpdatedFieldsWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowOutputUpdatedFieldsWebhookV2BetaType, UNSET)
        ...
        workflow_output_updated_fields_webhook_v2_beta = cls(
            type=type,
        ...
        workflow_output_updated_fields_webhook_v2_beta.additional_properties = d
        return workflow_output_updated_fields_webhook_v2_beta
    ...
    @property
    def type(self) -> WorkflowOutputUpdatedFieldsWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowOutputUpdatedFieldsWebhookV2BetaType) -> None:
        self._type = value
