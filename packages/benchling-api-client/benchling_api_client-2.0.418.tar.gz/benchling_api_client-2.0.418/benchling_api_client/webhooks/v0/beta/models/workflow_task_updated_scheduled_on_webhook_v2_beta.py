...
from ..models.workflow_task_updated_scheduled_on_webhook_v2_beta_type import (
    WorkflowTaskUpdatedScheduledOnWebhookV2BetaType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskUpdatedScheduledOnWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class WorkflowTaskUpdatedScheduledOnWebhookV2Beta:
    """  """

    _type: WorkflowTaskUpdatedScheduledOnWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskUpdatedScheduledOnWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowTaskUpdatedScheduledOnWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = WorkflowTaskUpdatedScheduledOnWebhookV2BetaType(_type)
            except ValueError:
                type = WorkflowTaskUpdatedScheduledOnWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowTaskUpdatedScheduledOnWebhookV2BetaType, UNSET)
        ...
        workflow_task_updated_scheduled_on_webhook_v2_beta = cls(
            type=type,
        ...
        workflow_task_updated_scheduled_on_webhook_v2_beta.additional_properties = d
        return workflow_task_updated_scheduled_on_webhook_v2_beta
    ...
    @property
    def type(self) -> WorkflowTaskUpdatedScheduledOnWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowTaskUpdatedScheduledOnWebhookV2BetaType) -> None:
        self._type = value
