...
from ..models.assay_run_created_webhook_v2_beta_type import AssayRunCreatedWebhookV2BetaType
from ..models.event_resource_schema import EventResourceSchema
from ..types import UNSET, Unset

T = TypeVar("T", bound="AssayRunCreatedWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class AssayRunCreatedWebhookV2Beta:
    """  """

    _type: AssayRunCreatedWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "AssayRunCreatedWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> AssayRunCreatedWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = AssayRunCreatedWebhookV2BetaType(_type)
            except ValueError:
                type = AssayRunCreatedWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(AssayRunCreatedWebhookV2BetaType, UNSET)
        ...
        assay_run_created_webhook_v2_beta = cls(
            type=type,
        ...
        assay_run_created_webhook_v2_beta.additional_properties = d
        return assay_run_created_webhook_v2_beta
    ...
    @property
    def type(self) -> AssayRunCreatedWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: AssayRunCreatedWebhookV2BetaType) -> None:
        self._type = value
