...
from ..models.entry_updated_fields_webhook_v2_beta_type import EntryUpdatedFieldsWebhookV2BetaType
from ..models.event_resource_schema import EventResourceSchema
from ..types import UNSET, Unset

T = TypeVar("T", bound="EntryUpdatedFieldsWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class EntryUpdatedFieldsWebhookV2Beta:
    """  """

    _type: EntryUpdatedFieldsWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "EntryUpdatedFieldsWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> EntryUpdatedFieldsWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = EntryUpdatedFieldsWebhookV2BetaType(_type)
            except ValueError:
                type = EntryUpdatedFieldsWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(EntryUpdatedFieldsWebhookV2BetaType, UNSET)
        ...
        entry_updated_fields_webhook_v2_beta = cls(
            type=type,
        ...
        entry_updated_fields_webhook_v2_beta.additional_properties = d
        return entry_updated_fields_webhook_v2_beta
    ...
    @property
    def type(self) -> EntryUpdatedFieldsWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: EntryUpdatedFieldsWebhookV2BetaType) -> None:
        self._type = value
