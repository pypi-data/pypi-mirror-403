...
from ..models.workflow_task_group_updated_watchers_webhook_v2_beta_type import (
    WorkflowTaskGroupUpdatedWatchersWebhookV2BetaType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskGroupUpdatedWatchersWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class WorkflowTaskGroupUpdatedWatchersWebhookV2Beta:
    """  """

    _type: WorkflowTaskGroupUpdatedWatchersWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskGroupUpdatedWatchersWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowTaskGroupUpdatedWatchersWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = WorkflowTaskGroupUpdatedWatchersWebhookV2BetaType(_type)
            except ValueError:
                type = WorkflowTaskGroupUpdatedWatchersWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowTaskGroupUpdatedWatchersWebhookV2BetaType, UNSET)
        ...
        workflow_task_group_updated_watchers_webhook_v2_beta = cls(
            type=type,
        ...
        workflow_task_group_updated_watchers_webhook_v2_beta.additional_properties = d
        return workflow_task_group_updated_watchers_webhook_v2_beta
    ...
    @property
    def type(self) -> WorkflowTaskGroupUpdatedWatchersWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowTaskGroupUpdatedWatchersWebhookV2BetaType) -> None:
        self._type = value
