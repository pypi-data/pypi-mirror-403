...
from ..models.workflow_task_updated_assignee_webhook_v2_beta_type import (
    WorkflowTaskUpdatedAssigneeWebhookV2BetaType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskUpdatedAssigneeWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class WorkflowTaskUpdatedAssigneeWebhookV2Beta:
    """  """

    _type: WorkflowTaskUpdatedAssigneeWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskUpdatedAssigneeWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowTaskUpdatedAssigneeWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = WorkflowTaskUpdatedAssigneeWebhookV2BetaType(_type)
            except ValueError:
                type = WorkflowTaskUpdatedAssigneeWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowTaskUpdatedAssigneeWebhookV2BetaType, UNSET)
        ...
        workflow_task_updated_assignee_webhook_v2_beta = cls(
            type=type,
        ...
        workflow_task_updated_assignee_webhook_v2_beta.additional_properties = d
        return workflow_task_updated_assignee_webhook_v2_beta
    ...
    @property
    def type(self) -> WorkflowTaskUpdatedAssigneeWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowTaskUpdatedAssigneeWebhookV2BetaType) -> None:
        self._type = value
