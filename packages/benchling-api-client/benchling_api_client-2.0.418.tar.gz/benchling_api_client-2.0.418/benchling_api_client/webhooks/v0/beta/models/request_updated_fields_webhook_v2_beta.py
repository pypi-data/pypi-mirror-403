...
from ..models.request_updated_fields_webhook_v2_beta_type import RequestUpdatedFieldsWebhookV2BetaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="RequestUpdatedFieldsWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class RequestUpdatedFieldsWebhookV2Beta:
    """  """

    _type: RequestUpdatedFieldsWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "RequestUpdatedFieldsWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> RequestUpdatedFieldsWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = RequestUpdatedFieldsWebhookV2BetaType(_type)
            except ValueError:
                type = RequestUpdatedFieldsWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(RequestUpdatedFieldsWebhookV2BetaType, UNSET)
        ...
        request_updated_fields_webhook_v2_beta = cls(
            type=type,
        ...
        request_updated_fields_webhook_v2_beta.additional_properties = d
        return request_updated_fields_webhook_v2_beta
    ...
    @property
    def type(self) -> RequestUpdatedFieldsWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: RequestUpdatedFieldsWebhookV2BetaType) -> None:
        self._type = value
