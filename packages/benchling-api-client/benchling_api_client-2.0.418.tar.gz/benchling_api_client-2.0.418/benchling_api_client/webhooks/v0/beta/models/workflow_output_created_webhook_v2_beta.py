...
from ..models.workflow_output_created_webhook_v2_beta_type import WorkflowOutputCreatedWebhookV2BetaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowOutputCreatedWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class WorkflowOutputCreatedWebhookV2Beta:
    """  """

    _type: WorkflowOutputCreatedWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowOutputCreatedWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowOutputCreatedWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = WorkflowOutputCreatedWebhookV2BetaType(_type)
            except ValueError:
                type = WorkflowOutputCreatedWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowOutputCreatedWebhookV2BetaType, UNSET)
        ...
        workflow_output_created_webhook_v2_beta = cls(
            type=type,
        ...
        workflow_output_created_webhook_v2_beta.additional_properties = d
        return workflow_output_created_webhook_v2_beta
    ...
    @property
    def type(self) -> WorkflowOutputCreatedWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowOutputCreatedWebhookV2BetaType) -> None:
        self._type = value
