...
class V2EntryUpdatedFieldsEvent:
    ...
    _event_type: V2EntryUpdatedFieldsEventEventType
    _deprecated: bool
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> V2EntryUpdatedFieldsEventEventType:
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(V2EntryUpdatedFieldsEventEventType, UNSET)
