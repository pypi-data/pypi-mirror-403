...
from ..models.workflow_task_created_webhook_v2_beta_type import WorkflowTaskCreatedWebhookV2BetaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskCreatedWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class WorkflowTaskCreatedWebhookV2Beta:
    """  """

    _type: WorkflowTaskCreatedWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskCreatedWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowTaskCreatedWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = WorkflowTaskCreatedWebhookV2BetaType(_type)
            except ValueError:
                type = WorkflowTaskCreatedWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowTaskCreatedWebhookV2BetaType, UNSET)
        ...
        workflow_task_created_webhook_v2_beta = cls(
            type=type,
        ...
        workflow_task_created_webhook_v2_beta.additional_properties = d
        return workflow_task_created_webhook_v2_beta
    ...
    @property
    def type(self) -> WorkflowTaskCreatedWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowTaskCreatedWebhookV2BetaType) -> None:
        self._type = value
