...
from ..models.entity_registered_webhook_v2_beta_type import EntityRegisteredWebhookV2BetaType
from ..models.event_resource_schema import EventResourceSchema
from ..types import UNSET, Unset

T = TypeVar("T", bound="EntityRegisteredWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class EntityRegisteredWebhookV2Beta:
    """  """

    _type: EntityRegisteredWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "EntityRegisteredWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> EntityRegisteredWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = EntityRegisteredWebhookV2BetaType(_type)
            except ValueError:
                type = EntityRegisteredWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(EntityRegisteredWebhookV2BetaType, UNSET)
        ...
        entity_registered_webhook_v2_beta = cls(
            type=type,
        ...
        entity_registered_webhook_v2_beta.additional_properties = d
        return entity_registered_webhook_v2_beta
    ...
    @property
    def type(self) -> EntityRegisteredWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: EntityRegisteredWebhookV2BetaType) -> None:
        self._type = value
