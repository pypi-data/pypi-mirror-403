...
from ..models.entry_updated_review_record_webhook_v2_beta_type import (
    EntryUpdatedReviewRecordWebhookV2BetaType,
)
from ..models.event_resource_schema import EventResourceSchema
from ..types import UNSET, Unset

T = TypeVar("T", bound="EntryUpdatedReviewRecordWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class EntryUpdatedReviewRecordWebhookV2Beta:
    """  """

    _type: EntryUpdatedReviewRecordWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "EntryUpdatedReviewRecordWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> EntryUpdatedReviewRecordWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = EntryUpdatedReviewRecordWebhookV2BetaType(_type)
            except ValueError:
                type = EntryUpdatedReviewRecordWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(EntryUpdatedReviewRecordWebhookV2BetaType, UNSET)
        ...
        entry_updated_review_record_webhook_v2_beta = cls(
            type=type,
        ...
        entry_updated_review_record_webhook_v2_beta.additional_properties = d
        return entry_updated_review_record_webhook_v2_beta
    ...
    @property
    def type(self) -> EntryUpdatedReviewRecordWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: EntryUpdatedReviewRecordWebhookV2BetaType) -> None:
        self._type = value
