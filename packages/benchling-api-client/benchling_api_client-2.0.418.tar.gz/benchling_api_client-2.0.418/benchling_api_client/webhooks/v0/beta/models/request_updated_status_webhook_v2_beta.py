...
from ..models.request_updated_status_webhook_v2_beta_type import RequestUpdatedStatusWebhookV2BetaType
from ..types import UNSET, Unset

T = TypeVar("T", bound="RequestUpdatedStatusWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class RequestUpdatedStatusWebhookV2Beta:
    """  """

    _type: RequestUpdatedStatusWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "RequestUpdatedStatusWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> RequestUpdatedStatusWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = RequestUpdatedStatusWebhookV2BetaType(_type)
            except ValueError:
                type = RequestUpdatedStatusWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(RequestUpdatedStatusWebhookV2BetaType, UNSET)
        ...
        request_updated_status_webhook_v2_beta = cls(
            type=type,
        ...
        request_updated_status_webhook_v2_beta.additional_properties = d
        return request_updated_status_webhook_v2_beta
    ...
    @property
    def type(self) -> RequestUpdatedStatusWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: RequestUpdatedStatusWebhookV2BetaType) -> None:
        self._type = value
