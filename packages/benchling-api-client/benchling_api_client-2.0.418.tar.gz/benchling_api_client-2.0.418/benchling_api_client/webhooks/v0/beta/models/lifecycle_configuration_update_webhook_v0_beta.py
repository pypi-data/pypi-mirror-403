...
from ..models.lifecycle_configuration_update_webhook_v0_beta_type import (
    LifecycleConfigurationUpdateWebhookV0BetaType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="LifecycleConfigurationUpdateWebhookV0Beta")


@attr.s(auto_attribs=True, repr=False)
class LifecycleConfigurationUpdateWebhookV0Beta:
    """ Sent when the configuration of a Benchling App is updated """

    _type: LifecycleConfigurationUpdateWebhookV0BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "LifecycleConfigurationUpdateWebhookV0Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> LifecycleConfigurationUpdateWebhookV0BetaType:
            _type = d.pop("type")
            try:
                type = LifecycleConfigurationUpdateWebhookV0BetaType(_type)
            except ValueError:
                type = LifecycleConfigurationUpdateWebhookV0BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(LifecycleConfigurationUpdateWebhookV0BetaType, UNSET)
        ...
        lifecycle_configuration_update_webhook_v0_beta = cls(
            type=type,
            deprecated=deprecated,
            excluded_properties=excluded_properties,
        )

        return lifecycle_configuration_update_webhook_v0_beta

    @property
    def type(self) -> LifecycleConfigurationUpdateWebhookV0BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: LifecycleConfigurationUpdateWebhookV0BetaType) -> None:
        self._type = value
