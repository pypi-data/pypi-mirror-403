...
from ..models.workflow_task_updated_status_webhook_v2_beta_type import (
    WorkflowTaskUpdatedStatusWebhookV2BetaType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskUpdatedStatusWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class WorkflowTaskUpdatedStatusWebhookV2Beta:
    """  """

    _type: WorkflowTaskUpdatedStatusWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskUpdatedStatusWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowTaskUpdatedStatusWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = WorkflowTaskUpdatedStatusWebhookV2BetaType(_type)
            except ValueError:
                type = WorkflowTaskUpdatedStatusWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowTaskUpdatedStatusWebhookV2BetaType, UNSET)
        ...
        workflow_task_updated_status_webhook_v2_beta = cls(
            type=type,
        ...
        workflow_task_updated_status_webhook_v2_beta.additional_properties = d
        return workflow_task_updated_status_webhook_v2_beta
    ...
    @property
    def type(self) -> WorkflowTaskUpdatedStatusWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowTaskUpdatedStatusWebhookV2BetaType) -> None:
        self._type = value
