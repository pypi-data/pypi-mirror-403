...
from ..models.workflow_task_group_created_webhook_v2_beta_type import (
    WorkflowTaskGroupCreatedWebhookV2BetaType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskGroupCreatedWebhookV2Beta")


@attr.s(auto_attribs=True, repr=False)
class WorkflowTaskGroupCreatedWebhookV2Beta:
    """  """

    _type: WorkflowTaskGroupCreatedWebhookV2BetaType
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskGroupCreatedWebhookV2Beta({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowTaskGroupCreatedWebhookV2BetaType:
            _type = d.pop("type")
            try:
                type = WorkflowTaskGroupCreatedWebhookV2BetaType(_type)
            except ValueError:
                type = WorkflowTaskGroupCreatedWebhookV2BetaType.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowTaskGroupCreatedWebhookV2BetaType, UNSET)
        ...
        workflow_task_group_created_webhook_v2_beta = cls(
            type=type,
        ...
        workflow_task_group_created_webhook_v2_beta.additional_properties = d
        return workflow_task_group_created_webhook_v2_beta
    ...
    @property
    def type(self) -> WorkflowTaskGroupCreatedWebhookV2BetaType:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowTaskGroupCreatedWebhookV2BetaType) -> None:
        self._type = value
