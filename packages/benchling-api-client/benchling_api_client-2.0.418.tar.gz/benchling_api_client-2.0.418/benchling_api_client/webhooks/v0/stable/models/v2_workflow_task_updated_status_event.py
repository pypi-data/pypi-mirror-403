...
class V2WorkflowTaskUpdatedStatusEvent:
    ...
    _event_type: V2WorkflowTaskUpdatedStatusEventEventType
    _deprecated: bool
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> V2WorkflowTaskUpdatedStatusEventEventType:
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(V2WorkflowTaskUpdatedStatusEventEventType, UNSET)
