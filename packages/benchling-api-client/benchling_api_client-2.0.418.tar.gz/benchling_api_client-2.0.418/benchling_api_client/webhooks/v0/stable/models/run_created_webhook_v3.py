...
from ..models.run_created_webhook_v3_type import RunCreatedWebhookV3Type
from ..models.v3_event_base_stability import V3EventBaseStability
from ..types import UNSET, Unset

T = TypeVar("T", bound="RunCreatedWebhookV3")


@attr.s(auto_attribs=True, repr=False)
class RunCreatedWebhookV3:
    """  """

    _type: RunCreatedWebhookV3Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "RunCreatedWebhookV3({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> RunCreatedWebhookV3Type:
            _type = d.pop("type")
            try:
                type = RunCreatedWebhookV3Type(_type)
            except ValueError:
                type = RunCreatedWebhookV3Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(RunCreatedWebhookV3Type, UNSET)
        ...
        run_created_webhook_v3.additional_properties = d
        return run_created_webhook_v3
    ...
    @property
    def type(self) -> RunCreatedWebhookV3Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: RunCreatedWebhookV3Type) -> None:
        self._type = value
