...
from ..models.entry_created_webhook_v2_type import EntryCreatedWebhookV2Type
from ..models.event_resource_schema import EventResourceSchema
from ..types import UNSET, Unset

T = TypeVar("T", bound="EntryCreatedWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class EntryCreatedWebhookV2:
    """  """

    _type: EntryCreatedWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "EntryCreatedWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> EntryCreatedWebhookV2Type:
            _type = d.pop("type")
            try:
                type = EntryCreatedWebhookV2Type(_type)
            except ValueError:
                type = EntryCreatedWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(EntryCreatedWebhookV2Type, UNSET)
        ...
        entry_created_webhook_v2.additional_properties = d
        return entry_created_webhook_v2
    ...
    @property
    def type(self) -> EntryCreatedWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: EntryCreatedWebhookV2Type) -> None:
        self._type = value
