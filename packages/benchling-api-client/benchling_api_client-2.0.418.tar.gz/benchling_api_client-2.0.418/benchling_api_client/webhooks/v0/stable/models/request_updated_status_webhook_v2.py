...
from ..models.request_updated_status_webhook_v2_type import RequestUpdatedStatusWebhookV2Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="RequestUpdatedStatusWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class RequestUpdatedStatusWebhookV2:
    """  """

    _type: RequestUpdatedStatusWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "RequestUpdatedStatusWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> RequestUpdatedStatusWebhookV2Type:
            _type = d.pop("type")
            try:
                type = RequestUpdatedStatusWebhookV2Type(_type)
            except ValueError:
                type = RequestUpdatedStatusWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(RequestUpdatedStatusWebhookV2Type, UNSET)
        ...
        request_updated_status_webhook_v2 = cls(
            type=type,
        ...
        request_updated_status_webhook_v2.additional_properties = d
        return request_updated_status_webhook_v2
    ...
    @property
    def type(self) -> RequestUpdatedStatusWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: RequestUpdatedStatusWebhookV2Type) -> None:
        self._type = value
