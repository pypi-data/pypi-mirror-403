...
T = TypeVar("T", bound="EventBaseWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class EventBaseWebhookV2:
    """  """
    ...
    def __repr__(self):
        ...
        return "EventBaseWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        event_base_webhook_v2.additional_properties = d
        return event_base_webhook_v2
