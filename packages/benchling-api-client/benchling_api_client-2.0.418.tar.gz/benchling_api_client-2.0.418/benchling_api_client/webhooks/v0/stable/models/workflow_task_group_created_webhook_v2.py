...
from ..models.workflow_task_group_created_webhook_v2_type import WorkflowTaskGroupCreatedWebhookV2Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskGroupCreatedWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class WorkflowTaskGroupCreatedWebhookV2:
    """  """

    _type: WorkflowTaskGroupCreatedWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskGroupCreatedWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowTaskGroupCreatedWebhookV2Type:
            _type = d.pop("type")
            try:
                type = WorkflowTaskGroupCreatedWebhookV2Type(_type)
            except ValueError:
                type = WorkflowTaskGroupCreatedWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowTaskGroupCreatedWebhookV2Type, UNSET)
        ...
        workflow_task_group_created_webhook_v2 = cls(
            type=type,
        ...
        workflow_task_group_created_webhook_v2.additional_properties = d
        return workflow_task_group_created_webhook_v2
    ...
    @property
    def type(self) -> WorkflowTaskGroupCreatedWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowTaskGroupCreatedWebhookV2Type) -> None:
        self._type = value
