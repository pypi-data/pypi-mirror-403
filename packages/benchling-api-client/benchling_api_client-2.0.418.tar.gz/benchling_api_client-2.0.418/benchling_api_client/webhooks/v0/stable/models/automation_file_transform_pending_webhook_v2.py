...
from ..models.automation_file_transform_pending_webhook_v2_type import (
    AutomationFileTransformPendingWebhookV2Type,
)
from ..models.event_resource_schema import EventResourceSchema
from ..types import UNSET, Unset

T = TypeVar("T", bound="AutomationFileTransformPendingWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class AutomationFileTransformPendingWebhookV2:
    """ Sent when an automation file transform status changes to pending """

    _type: AutomationFileTransformPendingWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "AutomationFileTransformPendingWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> AutomationFileTransformPendingWebhookV2Type:
            _type = d.pop("type")
            try:
                type = AutomationFileTransformPendingWebhookV2Type(_type)
            except ValueError:
                type = AutomationFileTransformPendingWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(AutomationFileTransformPendingWebhookV2Type, UNSET)
        ...
        automation_file_transform_pending_webhook_v2 = cls(
            type=type,
        ...
        automation_file_transform_pending_webhook_v2.additional_properties = d
        return automation_file_transform_pending_webhook_v2
    ...
    @property
    def type(self) -> AutomationFileTransformPendingWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: AutomationFileTransformPendingWebhookV2Type) -> None:
        self._type = value
