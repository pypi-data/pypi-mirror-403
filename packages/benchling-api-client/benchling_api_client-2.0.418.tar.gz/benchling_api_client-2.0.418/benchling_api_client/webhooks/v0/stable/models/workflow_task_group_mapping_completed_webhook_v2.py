...
from ..models.workflow_task_group_mapping_completed_webhook_v2_type import (
    WorkflowTaskGroupMappingCompletedWebhookV2Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskGroupMappingCompletedWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class WorkflowTaskGroupMappingCompletedWebhookV2:
    """  """

    _type: WorkflowTaskGroupMappingCompletedWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskGroupMappingCompletedWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowTaskGroupMappingCompletedWebhookV2Type:
            _type = d.pop("type")
            try:
                type = WorkflowTaskGroupMappingCompletedWebhookV2Type(_type)
            except ValueError:
                type = WorkflowTaskGroupMappingCompletedWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowTaskGroupMappingCompletedWebhookV2Type, UNSET)
        ...
        workflow_task_group_mapping_completed_webhook_v2 = cls(
            type=type,
        ...
        workflow_task_group_mapping_completed_webhook_v2.additional_properties = d
        return workflow_task_group_mapping_completed_webhook_v2
    ...
    @property
    def type(self) -> WorkflowTaskGroupMappingCompletedWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowTaskGroupMappingCompletedWebhookV2Type) -> None:
        self._type = value
