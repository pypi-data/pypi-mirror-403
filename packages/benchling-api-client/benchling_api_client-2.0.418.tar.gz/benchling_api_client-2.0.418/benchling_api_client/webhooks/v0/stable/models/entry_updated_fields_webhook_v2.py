...
from ..models.entry_updated_fields_webhook_v2_type import EntryUpdatedFieldsWebhookV2Type
from ..models.event_resource_schema import EventResourceSchema
from ..types import UNSET, Unset

T = TypeVar("T", bound="EntryUpdatedFieldsWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class EntryUpdatedFieldsWebhookV2:
    """  """

    _type: EntryUpdatedFieldsWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "EntryUpdatedFieldsWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> EntryUpdatedFieldsWebhookV2Type:
            _type = d.pop("type")
            try:
                type = EntryUpdatedFieldsWebhookV2Type(_type)
            except ValueError:
                type = EntryUpdatedFieldsWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(EntryUpdatedFieldsWebhookV2Type, UNSET)
        ...
        entry_updated_fields_webhook_v2 = cls(
            type=type,
        ...
        entry_updated_fields_webhook_v2.additional_properties = d
        return entry_updated_fields_webhook_v2
    ...
    @property
    def type(self) -> EntryUpdatedFieldsWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: EntryUpdatedFieldsWebhookV2Type) -> None:
        self._type = value
