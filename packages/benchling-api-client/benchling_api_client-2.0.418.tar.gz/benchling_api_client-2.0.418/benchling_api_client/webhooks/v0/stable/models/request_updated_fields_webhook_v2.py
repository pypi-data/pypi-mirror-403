...
from ..models.request_updated_fields_webhook_v2_type import RequestUpdatedFieldsWebhookV2Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="RequestUpdatedFieldsWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class RequestUpdatedFieldsWebhookV2:
    """  """

    _type: RequestUpdatedFieldsWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "RequestUpdatedFieldsWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> RequestUpdatedFieldsWebhookV2Type:
            _type = d.pop("type")
            try:
                type = RequestUpdatedFieldsWebhookV2Type(_type)
            except ValueError:
                type = RequestUpdatedFieldsWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(RequestUpdatedFieldsWebhookV2Type, UNSET)
        ...
        request_updated_fields_webhook_v2 = cls(
            type=type,
        ...
        request_updated_fields_webhook_v2.additional_properties = d
        return request_updated_fields_webhook_v2
    ...
    @property
    def type(self) -> RequestUpdatedFieldsWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: RequestUpdatedFieldsWebhookV2Type) -> None:
        self._type = value
