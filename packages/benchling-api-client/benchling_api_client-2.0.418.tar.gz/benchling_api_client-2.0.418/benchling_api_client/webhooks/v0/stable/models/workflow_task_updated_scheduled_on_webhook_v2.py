...
from ..models.workflow_task_updated_scheduled_on_webhook_v2_type import (
    WorkflowTaskUpdatedScheduledOnWebhookV2Type,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskUpdatedScheduledOnWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class WorkflowTaskUpdatedScheduledOnWebhookV2:
    """  """

    _type: WorkflowTaskUpdatedScheduledOnWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskUpdatedScheduledOnWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowTaskUpdatedScheduledOnWebhookV2Type:
            _type = d.pop("type")
            try:
                type = WorkflowTaskUpdatedScheduledOnWebhookV2Type(_type)
            except ValueError:
                type = WorkflowTaskUpdatedScheduledOnWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowTaskUpdatedScheduledOnWebhookV2Type, UNSET)
        ...
        workflow_task_updated_scheduled_on_webhook_v2 = cls(
            type=type,
        ...
        workflow_task_updated_scheduled_on_webhook_v2.additional_properties = d
        return workflow_task_updated_scheduled_on_webhook_v2
    ...
    @property
    def type(self) -> WorkflowTaskUpdatedScheduledOnWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowTaskUpdatedScheduledOnWebhookV2Type) -> None:
        self._type = value
