...
T = TypeVar("T", bound="V3UpdateEventBase")


@attr.s(auto_attribs=True, repr=False)
class V3UpdateEventBase:
    """  """
    ...
    def __repr__(self):
        ...
        return "V3UpdateEventBase({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        try:
            ...
            if strict:
                raise
            properties = cast(List[str], UNSET)
        ...
        v3_update_event_base.additional_properties = d
        return v3_update_event_base
