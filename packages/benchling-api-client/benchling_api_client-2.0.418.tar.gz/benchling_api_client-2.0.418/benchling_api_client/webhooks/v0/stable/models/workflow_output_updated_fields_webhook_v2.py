...
from ..models.workflow_output_updated_fields_webhook_v2_type import WorkflowOutputUpdatedFieldsWebhookV2Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowOutputUpdatedFieldsWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class WorkflowOutputUpdatedFieldsWebhookV2:
    """  """

    _type: WorkflowOutputUpdatedFieldsWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowOutputUpdatedFieldsWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowOutputUpdatedFieldsWebhookV2Type:
            _type = d.pop("type")
            try:
                type = WorkflowOutputUpdatedFieldsWebhookV2Type(_type)
            except ValueError:
                type = WorkflowOutputUpdatedFieldsWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowOutputUpdatedFieldsWebhookV2Type, UNSET)
        ...
        workflow_output_updated_fields_webhook_v2 = cls(
            type=type,
        ...
        workflow_output_updated_fields_webhook_v2.additional_properties = d
        return workflow_output_updated_fields_webhook_v2
    ...
    @property
    def type(self) -> WorkflowOutputUpdatedFieldsWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowOutputUpdatedFieldsWebhookV2Type) -> None:
        self._type = value
