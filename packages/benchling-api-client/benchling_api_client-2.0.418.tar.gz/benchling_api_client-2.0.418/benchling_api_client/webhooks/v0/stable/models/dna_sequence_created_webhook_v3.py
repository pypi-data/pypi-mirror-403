...
from ..models.dna_sequence_created_webhook_v3_type import DnaSequenceCreatedWebhookV3Type
from ..models.v3_event_base_stability import V3EventBaseStability
from ..types import UNSET, Unset

T = TypeVar("T", bound="DnaSequenceCreatedWebhookV3")


@attr.s(auto_attribs=True, repr=False)
class DnaSequenceCreatedWebhookV3:
    """  """

    _type: DnaSequenceCreatedWebhookV3Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "DnaSequenceCreatedWebhookV3({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> DnaSequenceCreatedWebhookV3Type:
            _type = d.pop("type")
            try:
                type = DnaSequenceCreatedWebhookV3Type(_type)
            except ValueError:
                type = DnaSequenceCreatedWebhookV3Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(DnaSequenceCreatedWebhookV3Type, UNSET)
        ...
        dna_sequence_created_webhook_v3 = cls(
            type=type,
        ...
        dna_sequence_created_webhook_v3.additional_properties = d
        return dna_sequence_created_webhook_v3
    ...
    @property
    def type(self) -> DnaSequenceCreatedWebhookV3Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: DnaSequenceCreatedWebhookV3Type) -> None:
        self._type = value
