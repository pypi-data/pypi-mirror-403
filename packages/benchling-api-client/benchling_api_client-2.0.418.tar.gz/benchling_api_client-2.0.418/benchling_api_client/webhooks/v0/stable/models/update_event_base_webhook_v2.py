...
T = TypeVar("T", bound="UpdateEventBaseWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class UpdateEventBaseWebhookV2:
    """  """
    ...
    def __repr__(self):
        ...
        return "UpdateEventBaseWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        update_event_base_webhook_v2 = cls(
            updates=updates,
        ...
        update_event_base_webhook_v2.additional_properties = d
        return update_event_base_webhook_v2
