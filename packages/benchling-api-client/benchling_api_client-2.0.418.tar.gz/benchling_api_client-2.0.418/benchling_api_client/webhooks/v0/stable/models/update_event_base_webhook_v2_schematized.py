...
T = TypeVar("T", bound="UpdateEventBaseWebhookV2Schematized")


@attr.s(auto_attribs=True, repr=False)
class UpdateEventBaseWebhookV2Schematized:
    """  """
    ...
    def __repr__(self):
        ...
        return "UpdateEventBaseWebhookV2Schematized({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        update_event_base_webhook_v2_schematized = cls(
        ...
        update_event_base_webhook_v2_schematized.additional_properties = d
        return update_event_base_webhook_v2_schematized
