...
from ..models.workflow_task_created_webhook_v2_type import WorkflowTaskCreatedWebhookV2Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskCreatedWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class WorkflowTaskCreatedWebhookV2:
    """  """

    _type: WorkflowTaskCreatedWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskCreatedWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowTaskCreatedWebhookV2Type:
            _type = d.pop("type")
            try:
                type = WorkflowTaskCreatedWebhookV2Type(_type)
            except ValueError:
                type = WorkflowTaskCreatedWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowTaskCreatedWebhookV2Type, UNSET)
        ...
        workflow_task_created_webhook_v2 = cls(
            type=type,
        ...
        workflow_task_created_webhook_v2.additional_properties = d
        return workflow_task_created_webhook_v2
    ...
    @property
    def type(self) -> WorkflowTaskCreatedWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowTaskCreatedWebhookV2Type) -> None:
        self._type = value
