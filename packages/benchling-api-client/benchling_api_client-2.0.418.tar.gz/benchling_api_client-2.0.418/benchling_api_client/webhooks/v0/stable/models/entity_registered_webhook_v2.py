...
from ..models.entity_registered_webhook_v2_type import EntityRegisteredWebhookV2Type
from ..models.event_resource_schema import EventResourceSchema
from ..types import UNSET, Unset

T = TypeVar("T", bound="EntityRegisteredWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class EntityRegisteredWebhookV2:
    """  """

    _type: EntityRegisteredWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "EntityRegisteredWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> EntityRegisteredWebhookV2Type:
            _type = d.pop("type")
            try:
                type = EntityRegisteredWebhookV2Type(_type)
            except ValueError:
                type = EntityRegisteredWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(EntityRegisteredWebhookV2Type, UNSET)
        ...
        entity_registered_webhook_v2 = cls(
            type=type,
        ...
        entity_registered_webhook_v2.additional_properties = d
        return entity_registered_webhook_v2
    ...
    @property
    def type(self) -> EntityRegisteredWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: EntityRegisteredWebhookV2Type) -> None:
        self._type = value
