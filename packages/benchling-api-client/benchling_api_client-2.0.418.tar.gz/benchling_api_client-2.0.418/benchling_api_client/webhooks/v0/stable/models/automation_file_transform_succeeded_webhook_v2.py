...
from ..models.automation_file_transform_succeeded_webhook_v2_type import (
    AutomationFileTransformSucceededWebhookV2Type,
)
from ..models.event_resource_schema import EventResourceSchema
from ..types import UNSET, Unset

T = TypeVar("T", bound="AutomationFileTransformSucceededWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class AutomationFileTransformSucceededWebhookV2:
    """ Sent when an automation file transform status changes to succeeded """

    _type: AutomationFileTransformSucceededWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "AutomationFileTransformSucceededWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> AutomationFileTransformSucceededWebhookV2Type:
            _type = d.pop("type")
            try:
                type = AutomationFileTransformSucceededWebhookV2Type(_type)
            except ValueError:
                type = AutomationFileTransformSucceededWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(AutomationFileTransformSucceededWebhookV2Type, UNSET)
        ...
        automation_file_transform_succeeded_webhook_v2 = cls(
            type=type,
        ...
        automation_file_transform_succeeded_webhook_v2.additional_properties = d
        return automation_file_transform_succeeded_webhook_v2
    ...
    @property
    def type(self) -> AutomationFileTransformSucceededWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: AutomationFileTransformSucceededWebhookV2Type) -> None:
        self._type = value
