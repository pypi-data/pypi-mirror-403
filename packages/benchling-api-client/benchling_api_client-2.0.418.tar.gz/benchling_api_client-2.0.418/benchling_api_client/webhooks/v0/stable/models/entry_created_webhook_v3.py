...
from ..models.entry_created_webhook_v3_type import EntryCreatedWebhookV3Type
from ..models.v3_event_base_stability import V3EventBaseStability
from ..types import UNSET, Unset

T = TypeVar("T", bound="EntryCreatedWebhookV3")


@attr.s(auto_attribs=True, repr=False)
class EntryCreatedWebhookV3:
    """  """

    _type: EntryCreatedWebhookV3Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "EntryCreatedWebhookV3({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> EntryCreatedWebhookV3Type:
            _type = d.pop("type")
            try:
                type = EntryCreatedWebhookV3Type(_type)
            except ValueError:
                type = EntryCreatedWebhookV3Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(EntryCreatedWebhookV3Type, UNSET)
        ...
        entry_created_webhook_v3.additional_properties = d
        return entry_created_webhook_v3
    ...
    @property
    def type(self) -> EntryCreatedWebhookV3Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: EntryCreatedWebhookV3Type) -> None:
        self._type = value
