...
from ..models.workflow_task_updated_fields_webhook_v2_type import WorkflowTaskUpdatedFieldsWebhookV2Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskUpdatedFieldsWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class WorkflowTaskUpdatedFieldsWebhookV2:
    """  """

    _type: WorkflowTaskUpdatedFieldsWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskUpdatedFieldsWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> WorkflowTaskUpdatedFieldsWebhookV2Type:
            _type = d.pop("type")
            try:
                type = WorkflowTaskUpdatedFieldsWebhookV2Type(_type)
            except ValueError:
                type = WorkflowTaskUpdatedFieldsWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(WorkflowTaskUpdatedFieldsWebhookV2Type, UNSET)
        ...
        workflow_task_updated_fields_webhook_v2 = cls(
            type=type,
        ...
        workflow_task_updated_fields_webhook_v2.additional_properties = d
        return workflow_task_updated_fields_webhook_v2
    ...
    @property
    def type(self) -> WorkflowTaskUpdatedFieldsWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: WorkflowTaskUpdatedFieldsWebhookV2Type) -> None:
        self._type = value
