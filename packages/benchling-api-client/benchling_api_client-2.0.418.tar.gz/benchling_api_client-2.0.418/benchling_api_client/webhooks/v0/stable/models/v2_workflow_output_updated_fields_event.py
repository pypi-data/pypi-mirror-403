...
class V2WorkflowOutputUpdatedFieldsEvent:
    ...
    _event_type: V2WorkflowOutputUpdatedFieldsEventEventType
    _deprecated: bool
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> V2WorkflowOutputUpdatedFieldsEventEventType:
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(V2WorkflowOutputUpdatedFieldsEventEventType, UNSET)
