...
from ..models.request_created_webhook_v2_type import RequestCreatedWebhookV2Type
from ..types import UNSET, Unset

T = TypeVar("T", bound="RequestCreatedWebhookV2")


@attr.s(auto_attribs=True, repr=False)
class RequestCreatedWebhookV2:
    """  """

    _type: RequestCreatedWebhookV2Type
    _deprecated: bool
    ...
    def __repr__(self):
        ...
        return "RequestCreatedWebhookV2({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_type() -> RequestCreatedWebhookV2Type:
            _type = d.pop("type")
            try:
                type = RequestCreatedWebhookV2Type(_type)
            except ValueError:
                type = RequestCreatedWebhookV2Type.of_unknown(_type)
        ...
        try:
            ...
            if strict:
                raise
            type = cast(RequestCreatedWebhookV2Type, UNSET)
        ...
        request_created_webhook_v2 = cls(
            type=type,
        ...
        request_created_webhook_v2.additional_properties = d
        return request_created_webhook_v2
    ...
    @property
    def type(self) -> RequestCreatedWebhookV2Type:
        if isinstance(self._type, Unset):
            raise NotPresentError(self, "type")
        return self._type

    @type.setter
    def type(self, value: RequestCreatedWebhookV2Type) -> None:
        self._type = value
