...
class V2RequestUpdatedFieldsEvent:
    ...
    _event_type: V2RequestUpdatedFieldsEventEventType
    _deprecated: bool
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> V2RequestUpdatedFieldsEventEventType:
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(V2RequestUpdatedFieldsEventEventType, UNSET)
