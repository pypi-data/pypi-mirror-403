...
from ..models.nucleotide_alignment_base_mafft_options_adjust_direction import (
    NucleotideAlignmentBaseMafftOptionsAdjustDirection,
)
from ..models.nucleotide_alignment_base_mafft_options_strategy import (
    NucleotideAlignmentBaseMafftOptionsStrategy,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="NucleotideAlignmentBaseMafftOptions")


@attr.s(auto_attribs=True, repr=False)
class NucleotideAlignmentBaseMafftOptions:
    """ Options to pass to the MAFFT algorithm, only applicable for MAFFT. """

    _adjust_direction: Union[
        Unset, NucleotideAlignmentBaseMafftOptionsAdjustDirection
    ] = NucleotideAlignmentBaseMafftOptionsAdjustDirection.FAST
    ...
    _strategy: Union[
        Unset, NucleotideAlignmentBaseMafftOptionsStrategy
    ] = NucleotideAlignmentBaseMafftOptionsStrategy.AUTO
    ...
    def __repr__(self):
        ...
        return "NucleotideAlignmentBaseMafftOptions({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_adjust_direction() -> Union[Unset, NucleotideAlignmentBaseMafftOptionsAdjustDirection]:
            ...
            if _adjust_direction is not None and _adjust_direction is not UNSET:
                try:
                    adjust_direction = NucleotideAlignmentBaseMafftOptionsAdjustDirection(_adjust_direction)
                except ValueError:
                    adjust_direction = NucleotideAlignmentBaseMafftOptionsAdjustDirection.of_unknown(
                        _adjust_direction
                    )
        ...
        try:
            ...
            if strict:
                raise
            adjust_direction = cast(Union[Unset, NucleotideAlignmentBaseMafftOptionsAdjustDirection], UNSET)
        ...
        def get_strategy() -> Union[Unset, NucleotideAlignmentBaseMafftOptionsStrategy]:
            strategy = UNSET
            _strategy = d.pop("strategy")
            if _strategy is not None and _strategy is not UNSET:
                try:
                    strategy = NucleotideAlignmentBaseMafftOptionsStrategy(_strategy)
                except ValueError:
                    strategy = NucleotideAlignmentBaseMafftOptionsStrategy.of_unknown(_strategy)
        ...
        try:
            ...
            if strict:
                raise
            strategy = cast(Union[Unset, NucleotideAlignmentBaseMafftOptionsStrategy], UNSET)

        nucleotide_alignment_base_mafft_options = cls(
        ...
        nucleotide_alignment_base_mafft_options.additional_properties = d
        return nucleotide_alignment_base_mafft_options
    ...
    @property
    def adjust_direction(self) -> NucleotideAlignmentBaseMafftOptionsAdjustDirection:
        """Adjust direction:
    ...
    def adjust_direction(self, value: NucleotideAlignmentBaseMafftOptionsAdjustDirection) -> None:
    ...
    @property
    def strategy(self) -> NucleotideAlignmentBaseMafftOptionsStrategy:
        """MAFFT Strategy:
    ...
    @strategy.setter
    def strategy(self, value: NucleotideAlignmentBaseMafftOptionsStrategy) -> None:
