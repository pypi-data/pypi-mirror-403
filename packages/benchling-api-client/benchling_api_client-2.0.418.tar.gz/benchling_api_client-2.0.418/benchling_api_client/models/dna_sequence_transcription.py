...
T = TypeVar("T", bound="DnaSequenceTranscription")


@attr.s(auto_attribs=True, repr=False)
class DnaSequenceTranscription:
    """  """
    ...
    def __repr__(self):
        ...
        return "DnaSequenceTranscription({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        dna_sequence_transcription = cls(
            end=end,
        ...
        dna_sequence_transcription.additional_properties = d
        return dna_sequence_transcription
