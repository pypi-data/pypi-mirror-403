...
T = TypeVar("T", bound="ButtonUiBlockCreate")
...
class ButtonUiBlockCreate:
    ...
    def __repr__(self):
        ...
        return "ButtonUiBlockCreate({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        button_ui_block_create.additional_properties = d
        return button_ui_block_create
