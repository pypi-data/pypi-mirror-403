...
from ..models.workflow_task_group_mapping_completed_event_event_type import (
    WorkflowTaskGroupMappingCompletedEventEventType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="WorkflowTaskGroupMappingCompletedEvent")


@attr.s(auto_attribs=True, repr=False)
class WorkflowTaskGroupMappingCompletedEvent:
    """  """

    _event_type: Union[Unset, WorkflowTaskGroupMappingCompletedEventEventType] = UNSET
    ...
    def __repr__(self):
        ...
        return "WorkflowTaskGroupMappingCompletedEvent({})".format(", ".join(fields))
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any], strict: bool = False) -> T:
        ...
        def get_event_type() -> Union[Unset, WorkflowTaskGroupMappingCompletedEventEventType]:
            event_type = UNSET
            _event_type = d.pop("eventType")
            if _event_type is not None and _event_type is not UNSET:
                try:
                    event_type = WorkflowTaskGroupMappingCompletedEventEventType(_event_type)
                except ValueError:
                    event_type = WorkflowTaskGroupMappingCompletedEventEventType.of_unknown(_event_type)
        ...
        try:
            ...
            if strict:
                raise
            event_type = cast(Union[Unset, WorkflowTaskGroupMappingCompletedEventEventType], UNSET)
        ...
        workflow_task_group_mapping_completed_event = cls(
        ...
        workflow_task_group_mapping_completed_event.additional_properties = d
        return workflow_task_group_mapping_completed_event
    ...
    @property
    def event_type(self) -> WorkflowTaskGroupMappingCompletedEventEventType:
        if isinstance(self._event_type, Unset):
            raise NotPresentError(self, "event_type")
        return self._event_type

    @event_type.setter
    def event_type(self, value: WorkflowTaskGroupMappingCompletedEventEventType) -> None:
