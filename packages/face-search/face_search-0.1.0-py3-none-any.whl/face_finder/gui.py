...
def launch_gui(port: int = 7860, share: bool = False):
    ...
    try:
        ...
        raise ImportError(
            "Gradio not installed. Install with: pip install face-finder[gui]"
        )
    ...
    def handle_reference_upload(files) -> Tuple[str, List]:
        ...
        try:
            ref_dir = Path(tempfile.gettempdir()) / "face_finder_refs"
    ...
    def build_gallery_page(page: int) -> Tuple[List, str]:
        ...
        try:
            ...
            temp_dir = Path(tempfile.mkdtemp(prefix="face_finder_results_"))
