...
import unittest
from async43 import extract_domain


class TestExtractDomain(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_ipv6(self):
        ...
        extracted_domain = await extract_domain(url)
        self.assertEqual(domain, await extract_domain(extracted_domain))
    ...
    async def test_second_level_domain(self):
