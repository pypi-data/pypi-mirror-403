# TODO
#  - MAKE USE OF GENERATORS AND DRY RUNS. NO CLASSES FOR THIS PROJECT
#  - use placeholder directory
#  - so this tool would first off iterate through the directory
#  - next it will decide where the file should go depending on file type
#  - if appropriate file does not exist, make one in the root of the C drive
#  - dry run for testing and confirmation on file movement before actual movement
#  - after dry run implemented display to users amount of file types being moved to each location
#  - after users are able to view pre movement, ask user to begin movement or no
#  - ~/home/
#   Images/
#   Videos/
#   Documents/
