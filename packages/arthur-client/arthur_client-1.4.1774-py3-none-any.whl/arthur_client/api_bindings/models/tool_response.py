...
class ToolResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="ID of the tool.")
    name: StrictStr = Field(description="Name of the tool.")
    arguments: Optional[List[ToolArgumentResponse]] = Field(default=None, description="List of arguments for this tool.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "arguments": [ToolArgumentResponse.from_dict(_item) for _item in obj["arguments"]] if obj.get("arguments") is not None else None
        })
        return _obj
