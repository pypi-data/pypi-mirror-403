...
class SensitiveDataPlane(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["created_at", "updated_at", "id", "name", "workspace_id", "description", "user_id", "infrastructure", "last_check_in_time", "capabilities", "client_id", "client_secret"]
