...
class CustomAggregationTestResult(BaseModel):
    """
    CustomAggregationTestResult
    """ # noqa: E501
    test_run_id: StrictStr = Field(description="ID of the custom aggregation test run.")
    metric_name: StrictStr = Field(description="Name of the generated metric.")
    timestamp: datetime = Field(description="Timestamp for the time bucket the aggregation value is for.")
    value: Value
    dimensions: List[Dimension] = Field(description="List of dimensions for the value.")
    __properties: ClassVar[List[str]] = ["test_run_id", "metric_name", "timestamp", "value", "dimensions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "test_run_id": obj.get("test_run_id"),
