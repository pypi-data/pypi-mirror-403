...
class InfrastructureList(BaseModel):
    ...
    """ # noqa: E501
    infrastructures: List[Infrastructure] = Field(description="List of supported infrastructure values.")
    __properties: ClassVar[List[str]] = ["infrastructures"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "infrastructures": obj.get("infrastructures")
        })
        return _obj
