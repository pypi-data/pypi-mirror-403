...
class ProjectBoundResourceMetadata(BaseModel):
    """
    ProjectBoundResourceMetadata
    """ # noqa: E501
    workspace_id: StrictStr = Field(description="ID of the parent workspace.")
    workspace_name: StrictStr = Field(description="Name of the parent workspace.")
    __properties: ClassVar[List[str]] = ["workspace_id", "workspace_name"]
