# arthur_client.api_bindings.RolesV1Api

All URIs are relative to *http://localhost*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_role**](RolesV1Api.md#get_role) | **GET** /api/v1/roles/{role_id} | Get Role.


# **get_role**
> ExtendedRole get_role(role_id)
...
with arthur_client.api_bindings.ApiClient(configuration) as api_client:
    ...
    api_instance = arthur_client.api_bindings.RolesV1Api(api_client)
    role_id = 'role_id_example' # str | 

    try:
        # Get Role.
        api_response = api_instance.get_role(role_id)
        print("The response of RolesV1Api->get_role:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RolesV1Api->get_role: %s\n" % e)
```
