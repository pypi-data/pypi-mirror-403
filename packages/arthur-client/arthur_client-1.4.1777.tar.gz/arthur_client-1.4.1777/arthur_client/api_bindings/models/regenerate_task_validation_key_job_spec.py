...
class RegenerateTaskValidationKeyJobSpec(BaseModel):
    ...
    """ # noqa: E501
    job_type: Optional[StrictStr] = 'regenerate_validation_key'
    scope_model_id: StrictStr = Field(description="The ID of the model to regenerate the validation key for.")
    ...
    def job_type_validate_enum(cls, value):
        ...
        if value not in set(['regenerate_validation_key']):
            raise ValueError("must be one of enum values ('regenerate_validation_key')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "job_type": obj.get("job_type") if obj.get("job_type") is not None else 'regenerate_validation_key',
