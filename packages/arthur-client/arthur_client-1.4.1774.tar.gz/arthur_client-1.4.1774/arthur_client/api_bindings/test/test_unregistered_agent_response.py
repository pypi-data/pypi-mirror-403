...
class TestUnregisteredAgentResponse(unittest.TestCase):
    """UnregisteredAgentResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UnregisteredAgentResponse:
        """Test UnregisteredAgentResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UnregisteredAgentResponse`
        """
        model = UnregisteredAgentResponse()
        if include_optional:
            return UnregisteredAgentResponse(
    ...
    def testUnregisteredAgentResponse(self):
        """Test UnregisteredAgentResponse"""
