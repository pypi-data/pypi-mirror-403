...
class PostMetricsQueryTimeRange(BaseModel):
    """
    PostMetricsQueryTimeRange
    """ # noqa: E501
    start: datetime = Field(description="Start timestamp of the metrics range.")
    end: datetime = Field(description="End timestamp of the metrics range.")
