...
class SketchCustomAggregationTestResult(BaseModel):
    """
    ...
    def metric_kind_validate_enum(cls, value):
        ...
        if value not in set(['sketch']):
            raise ValueError("must be one of enum values ('sketch')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "metric_kind": obj.get("metric_kind") if obj.get("metric_kind") is not None else 'sketch',
