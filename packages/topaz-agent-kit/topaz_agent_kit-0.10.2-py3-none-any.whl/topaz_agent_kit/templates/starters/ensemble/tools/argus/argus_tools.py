...
def get_pending_journals(
    ...
    Note: Entries waiting for human review have status != 'pending' (e.g., 'needs_clarification',
    'processed', or 'rejected') and run_id IS NOT NULL, so they are automatically excluded.
