...
"""
    ...
    temp_path = Path("/tmp") / f"{sow_number}_informal_scope_temp.pdf"
...
def generate_pre_contract_data(
    ...
    if REPORTLAB_AVAILABLE:
        ...
        scope_doc_path.write_text(generate_informal_scope_doc(sow_number, contract_type, contract_value, seed))
        generated_files.append(scope_doc_path)
