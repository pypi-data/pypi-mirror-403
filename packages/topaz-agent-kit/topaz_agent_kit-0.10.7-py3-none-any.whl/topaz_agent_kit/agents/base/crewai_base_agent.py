...
class CrewAIBaseAgent(BaseAgent):
    ...
    def _build_multimodal_content(self, rendered_inputs: str, context: Dict[str, Any]) -> str:
        ...
        # Even though CrewAI uses LangChain (which handles encoding well), this provides defense-in-depth
        ...
        if rendered_inputs:
            ...
            self.logger.debug(
                "CrewAI prompt stats - Length: {} chars, Backslashes: {}, Single quotes (many): {}, JSON structures: {}",
