...
bulldozer_pipeline_params = {
    ...
    OPT_PARAM_KEY: [
        BulldozerParam(
            ...
            "dhm",
            "Generate DHM",
            "Generate the Digital Height Model (DHM=DSM-DTM).",
            bool,
            False,
        ),
        BulldozerParam(
            ...
            "max_size",
            "Max object size (m)",
            "Foreground max object size (in meter).",
            float,
            16,
            "<value>",
        ),
        BulldozerParam(
            ...
            "ground",
            "Ground mask path",
            "Path to the binary ground classification mask.",
            str,
            None,
            "<mask.tif>",
        ),
        BulldozerParam(
            ...
            "anchors",
            "Activate ground anchors",
            "Activate ground anchor detection (ground pre-detection).",
            bool,
            False,
        ),
        BulldozerParam(
    ...
    EXPERT_PARAM_KEY: [
        BulldozerParam(
            "reg_filtering_iter",
            "reg_it",
            "Number of regular mask filtering iterations",
            "Number of regular mask filtering iterations.",
            int,
            None,
            "<value>",
        ...
        BulldozerParam(
            "dsm_z_accuracy",
            "dsm_z",
            "DSM altimetric accuracy (m)",
            "Altimetric height accuracy of the input DSM (m). "
        ...
        BulldozerParam(
            ...
            "max_slope",
            "Max ground slope (%%)",
            "Maximum slope of the observed landscape terrain (%%).",
            float,
            20.0,
            "<value>",
        ),
        ...
        BulldozerParam(
            ...
            "Number of gravity step iterations.",
            int,
            25,
            "<value>",
        ),
