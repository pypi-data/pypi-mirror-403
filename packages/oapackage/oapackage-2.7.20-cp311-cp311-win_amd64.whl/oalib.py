...
def print_eigen_options_string():
    r"""print_eigen_options_string() -> std::string"""
    return _oalib.print_eigen_options_string()
...
class OAextend(object):
    ...
    * `j5structure` : `j5structure_t`
    ...
    check_maximal = property(_oalib.OAextend_check_maximal_get, _oalib.OAextend_check_maximal_set, doc=r"""maximum number of extentions to generate from a single array. if zero, generate all possible extentions""")
    maximum_duration = property(_oalib.OAextend_maximum_duration_get, _oalib.OAextend_maximum_duration_set, doc=r"""maximum duration of extention process for a single array, in seconds. if zero, no limit""")
