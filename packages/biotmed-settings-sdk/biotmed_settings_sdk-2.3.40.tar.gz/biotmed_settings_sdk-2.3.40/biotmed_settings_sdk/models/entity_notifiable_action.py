...
class EntityNotifiableAction(BaseModel):
    """
    ...
    """ # noqa: E501
    entity_name: StrictStr = Field(alias="entityName")
    entity_display_name: StrictStr = Field(alias="entityDisplayName")
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["entityName", "entityDisplayName", "actionName", "actionDisplayName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EntityNotifiableAction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EntityNotifiableAction from a dict"""
        if obj is None:
            return None
