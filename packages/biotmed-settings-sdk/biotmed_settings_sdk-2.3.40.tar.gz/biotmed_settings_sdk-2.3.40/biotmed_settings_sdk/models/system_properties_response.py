...
class SystemPropertiesResponse(BaseModel):
    ...
    """ # noqa: E501
    biot_version: Optional[StrictStr] = Field(default=None, description="System's main version", alias="biotVersion")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["biotVersion"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SystemPropertiesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SystemPropertiesResponse from a dict"""
        if obj is None:
            return None
