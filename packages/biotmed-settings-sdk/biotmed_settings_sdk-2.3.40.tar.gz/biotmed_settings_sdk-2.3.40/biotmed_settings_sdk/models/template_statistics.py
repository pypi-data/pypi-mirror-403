...
class TemplateStatistics(BaseModel):
    ...
    """ # noqa: E501
    entities_count: Optional[StrictInt] = Field(default=None, alias="entitiesCount")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["entitiesCount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TemplateStatistics from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TemplateStatistics from a dict"""
        if obj is None:
            return None
