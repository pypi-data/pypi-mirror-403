...
class ImportExecutionResponse(BaseModel):
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["id", "name", "description", "status", "importType", "errorMessage", "lastModifiedTime", "creationTime"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['IN_PROGRESS', 'FAILED', 'SUCCESS']):
            raise ValueError("must be one of enum values ('IN_PROGRESS', 'FAILED', 'SUCCESS')")
        return value
    ...
    def import_type_validate_enum(cls, value):
        ...
        if value not in set(['CLEAN_IMPORT']):
            raise ValueError("must be one of enum values ('CLEAN_IMPORT')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ImportExecutionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ImportExecutionResponse from a dict"""
        if obj is None:
            return None
