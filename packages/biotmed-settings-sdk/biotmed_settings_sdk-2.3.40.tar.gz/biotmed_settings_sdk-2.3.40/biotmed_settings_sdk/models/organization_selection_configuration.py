...
class OrganizationSelectionConfiguration(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationSelectionConfiguration from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in selected (list)
        _items = []
        if self.selected:
            for _item_selected in self.selected:
                if _item_selected:
                    _items.append(_item_selected.to_dict())
            _dict['selected'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationSelectionConfiguration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "selected": [SelectedOrganization.from_dict(_item) for _item in obj["selected"]] if obj.get("selected") is not None else None,
            "all": obj.get("all")
        })
