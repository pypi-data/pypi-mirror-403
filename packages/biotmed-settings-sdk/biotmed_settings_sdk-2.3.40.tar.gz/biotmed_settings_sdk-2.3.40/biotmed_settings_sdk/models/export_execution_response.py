...
class ExportExecutionResponse(BaseModel):
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["id", "name", "description", "status", "errorMessage", "lastModifiedTime", "creationTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExportExecutionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExportExecutionResponse from a dict"""
        if obj is None:
            return None
