...
class BackupResponse(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(min_length=0, strict=True, max_length=100)] = Field(description="The name of the backup, it will also be the folder in which the backup is saved")
    backup_version: StrictStr = Field(description="The biot version of the backup", alias="backupVersion")
    error_message: Optional[StrictStr] = Field(default=None, description="An error thrown in the backup/restore process", alias="errorMessage")
    build_number: StrictInt = Field(description="The build number of the backup/restore job in the pipeline", alias="buildNumber")
    ...
    status: StrictStr = Field(description="The status of the backup")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["name", "backupVersion", "errorMessage", "buildNumber", "lastModifiedTime", "creationTime", "description", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "backupVersion": obj.get("backupVersion"),
