...
class TemplateMinimizedResponse(BaseModel):
    """
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["displayName", "name", "description", "ownerOrganizationId", "analyticsDbConfiguration", "id", "entityTypeName", "removable", "creationTime", "lastModifiedTime", "parentTemplate", "parentTemplateId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TemplateMinimizedResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TemplateMinimizedResponse from a dict"""
        if obj is None:
            return None
