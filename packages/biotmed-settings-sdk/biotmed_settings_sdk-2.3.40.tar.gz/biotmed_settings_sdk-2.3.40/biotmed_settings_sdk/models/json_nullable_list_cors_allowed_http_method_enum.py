...
class JsonNullableListCorsAllowedHttpMethodEnum(BaseModel):
    """
    List of allowed HTTP methods for CORS. Only GET, PUT, POST, DELETE, HEAD, and PATCH are supported. Methods not included may be blocked by the browser during preflight or actual requests (even if the backend supports them). Omit this field to keep the current allowed methods. Sending [] removes all methods. Providing a list replaces the existing value.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JsonNullableListCorsAllowedHttpMethodEnum from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JsonNullableListCorsAllowedHttpMethodEnum from a dict"""
        if obj is None:
            return None
