...
class ValidationDefinitionObject(BaseModel):
    """
    ...
    min: Optional[Union[Annotated[float, Field(le=9223372036854775807, strict=True, ge=-9223372036854775808)], Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]]] = None
    max: Optional[Union[Annotated[float, Field(le=9223372036854775807, strict=True, ge=-9223372036854775808)], Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]]] = None
    regex: Optional[StrictStr] = None
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["mandatory", "defaultValue", "min", "max", "regex"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidationDefinitionObject from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidationDefinitionObject from a dict"""
        if obj is None:
            return None
