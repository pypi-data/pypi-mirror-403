...
class TemplateOverviewResponse(BaseModel):
    ...
    referenced_by_attributes: Optional[List[BasicAttributeData]] = Field(default=None, alias="referencedByAttributes")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["statistics", "referencedByAttributes"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in referenced_by_attributes (list)
        _items = []
        if self.referenced_by_attributes:
            for _item_referenced_by_attributes in self.referenced_by_attributes:
                if _item_referenced_by_attributes:
                    _items.append(_item_referenced_by_attributes.to_dict())
            _dict['referencedByAttributes'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "statistics": TemplateStatistics.from_dict(obj["statistics"]) if obj.get("statistics") is not None else None,
            "referencedByAttributes": [BasicAttributeData.from_dict(_item) for _item in obj["referencedByAttributes"]] if obj.get("referencedByAttributes") is not None else None
        })
