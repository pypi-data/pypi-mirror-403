...
class LocalesResponse(BaseModel):
    ...
    """ # noqa: E501
    available_locales: Optional[List[BaseLocale]] = Field(default=None, alias="availableLocales")
    default_locale_code: Optional[StrictStr] = Field(default=None, description="Locale in the following format: {language-ISO639}-{countryCode-ISO3166} lowercase.", alias="defaultLocaleCode")
    system_locale_code: Optional[StrictStr] = Field(default=None, alias="systemLocaleCode")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["availableLocales", "defaultLocaleCode", "systemLocaleCode"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in available_locales (list)
        _items = []
        if self.available_locales:
            for _item_available_locales in self.available_locales:
                if _item_available_locales:
                    _items.append(_item_available_locales.to_dict())
            _dict['availableLocales'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "availableLocales": [BaseLocale.from_dict(_item) for _item in obj["availableLocales"]] if obj.get("availableLocales") is not None else None,
            "defaultLocaleCode": obj.get("defaultLocaleCode"),
            "systemLocaleCode": obj.get("systemLocaleCode")
        })
