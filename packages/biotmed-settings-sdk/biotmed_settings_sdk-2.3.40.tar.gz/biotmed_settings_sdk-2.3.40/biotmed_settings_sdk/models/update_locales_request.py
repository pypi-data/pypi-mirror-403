...
class UpdateLocalesRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    available_locales: Optional[JsonNullableSetBaseLocale] = Field(default=None, alias="availableLocales")
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["availableLocales", "defaultLocaleCode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateLocalesRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of available_locales
        if self.available_locales:
            _dict['availableLocales'] = self.available_locales.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateLocalesRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "availableLocales": JsonNullableSetBaseLocale.from_dict(obj["availableLocales"]) if obj.get("availableLocales") is not None else None,
