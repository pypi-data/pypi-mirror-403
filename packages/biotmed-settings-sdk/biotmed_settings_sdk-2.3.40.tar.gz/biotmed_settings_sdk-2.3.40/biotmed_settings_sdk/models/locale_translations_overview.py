...
class LocaleTranslationsOverview(BaseModel):
    """
    ...
    coverage: Optional[LocaleTranslationsCoverage] = None
    last_translation_time: Optional[datetime] = Field(default=None, alias="lastTranslationTime")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["locale", "coverage", "lastTranslationTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LocaleTranslationsOverview from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LocaleTranslationsOverview from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "coverage": LocaleTranslationsCoverage.from_dict(obj["coverage"]) if obj.get("coverage") is not None else None,
            "lastTranslationTime": obj.get("lastTranslationTime")
        })
