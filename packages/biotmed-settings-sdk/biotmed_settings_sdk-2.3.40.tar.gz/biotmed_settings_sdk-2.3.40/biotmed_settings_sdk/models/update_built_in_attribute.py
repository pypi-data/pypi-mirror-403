...
class UpdateBuiltInAttribute(BaseModel):
    """
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["id", "displayName", "phi", "referenceConfiguration", "linkConfiguration", "validation", "numericMetaData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateBuiltInAttribute from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateBuiltInAttribute from a dict"""
        if obj is None:
            return None
