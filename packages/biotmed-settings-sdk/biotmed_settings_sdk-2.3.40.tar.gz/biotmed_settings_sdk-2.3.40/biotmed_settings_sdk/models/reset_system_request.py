...
class ResetSystemRequest(BaseModel):
    ...
    """ # noqa: E501
    primary_administrator: PrimaryAdministrator = Field(alias="primaryAdministrator")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["primaryAdministrator"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ResetSystemRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        if self.primary_administrator:
            _dict['primaryAdministrator'] = self.primary_administrator.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ResetSystemRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "primaryAdministrator": PrimaryAdministrator.from_dict(obj["primaryAdministrator"]) if obj.get("primaryAdministrator") is not None else None
        })
