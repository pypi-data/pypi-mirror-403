...
class ValidationDefinitionMetadataObject(BaseModel):
    """
    ...
    """ # noqa: E501
    mandatory_read_only: Optional[StrictBool] = Field(default=None, alias="mandatoryReadOnly")
    system_mandatory: Optional[StrictBool] = Field(default=None, alias="systemMandatory")
    phi_read_only: Optional[StrictBool] = Field(default=None, alias="phiReadOnly")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["mandatoryReadOnly", "systemMandatory", "phiReadOnly"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidationDefinitionMetadataObject from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidationDefinitionMetadataObject from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "mandatoryReadOnly": obj.get("mandatoryReadOnly"),
            "systemMandatory": obj.get("systemMandatory"),
            "phiReadOnly": obj.get("phiReadOnly")
        })
