...
class CodeSnippetResponse(BaseModel):
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["name", "description", "language", "code", "id", "lastModifiedTime", "creationTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CodeSnippetResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CodeSnippetResponse from a dict"""
        if obj is None:
            return None
