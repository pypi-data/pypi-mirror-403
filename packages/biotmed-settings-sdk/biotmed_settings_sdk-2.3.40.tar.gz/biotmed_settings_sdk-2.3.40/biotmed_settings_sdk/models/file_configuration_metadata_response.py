...
class FileConfigurationMetadataResponse(BaseModel):
    """
    ...
    biot_version: Optional[StrictStr] = Field(default=None, alias="biotVersion")
    creation_time: Optional[datetime] = Field(default=None, alias="creationTime")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["id", "environment", "name", "description", "biotVersion", "creationTime"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FileConfigurationMetadataResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FileConfigurationMetadataResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "biotVersion": obj.get("biotVersion"),
