...
class NumericMetaData(BaseModel):
    ...
    upper_range: Optional[Union[Annotated[float, Field(le=2147483647, strict=True, ge=-2147483648)], Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]]] = Field(default=None, alias="upperRange")
    lower_range: Optional[Union[Annotated[float, Field(le=2147483647, strict=True, ge=-2147483648)], Annotated[int, Field(le=2147483647, strict=True, ge=-2147483648)]]] = Field(default=None, alias="lowerRange")
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["units", "upperRange", "lowerRange", "subType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NumericMetaData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NumericMetaData from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "units": obj.get("units"),
            "upperRange": obj.get("upperRange"),
            "lowerRange": obj.get("lowerRange"),
