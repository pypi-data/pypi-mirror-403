...
class PrimaryAdministrator(BaseModel):
    """
    ...
    """ # noqa: E501
    email: StrictStr = Field(description="An email address in the RFC-5322 specification")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PrimaryAdministrator from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PrimaryAdministrator from a dict"""
        if obj is None:
            return None
