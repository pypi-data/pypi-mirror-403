...
class ExportsMetadataResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    files_metadata: Optional[List[FileConfigurationMetadataResponse]] = Field(default=None, alias="filesMetadata")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["filesMetadata"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExportsMetadataResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in files_metadata (list)
        _items = []
        if self.files_metadata:
            for _item_files_metadata in self.files_metadata:
                if _item_files_metadata:
                    _items.append(_item_files_metadata.to_dict())
            _dict['filesMetadata'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExportsMetadataResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "filesMetadata": [FileConfigurationMetadataResponse.from_dict(_item) for _item in obj["filesMetadata"]] if obj.get("filesMetadata") is not None else None
        })
