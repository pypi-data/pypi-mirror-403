...
class InvalidTranslation(BaseModel):
    """
    InvalidTranslation
    ...
    """ # noqa: E501
    translation_key: Optional[StrictStr] = Field(default=None, alias="translationKey")
    error: Optional[StrictStr] = None
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["translationKey", "error"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InvalidTranslation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InvalidTranslation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "translationKey": obj.get("translationKey"),
            "error": obj.get("error")
        })
