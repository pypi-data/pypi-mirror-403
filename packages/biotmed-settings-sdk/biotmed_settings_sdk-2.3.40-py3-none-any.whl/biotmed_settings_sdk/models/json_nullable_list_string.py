...
class JsonNullableListString(BaseModel):
    """
    List of response headers that should be readable by browser clients (via fetch/XHR). Without listing here, only CORS-safelisted headers are visible to client code. This does not gate access; it only controls header visibility. Omit this field to keep the current expose headers. Sending [] removes all headers. Providing a list replaces the existing value.
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JsonNullableListString from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JsonNullableListString from a dict"""
        if obj is None:
            return None
