...
class SelectableValue(BaseModel):
    """
    SelectableValue
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["name", "displayName", "id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SelectableValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SelectableValue from a dict"""
        if obj is None:
            return None
