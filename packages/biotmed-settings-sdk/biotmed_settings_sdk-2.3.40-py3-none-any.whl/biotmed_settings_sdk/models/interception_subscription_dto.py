...
class InterceptionSubscriptionDto(BaseModel):
    """
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="The type of interception to create for this plugin")
    api_id: Optional[StrictStr] = Field(default=None, description="The id of the api for which to create the interception. Check interception configuration API for supported values", alias="apiId")
    entity_type_name: Optional[StrictStr] = Field(default=None, description="The entity for which to create the interception. Check interception configuration API for supported values", alias="entityTypeName")
    order: Optional[StrictInt] = Field(default=None, description="An order to override for this specific interception. Must be a positive number")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["type", "apiId", "entityTypeName", "order"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InterceptionSubscriptionDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InterceptionSubscriptionDto from a dict"""
        if obj is None:
            return None
