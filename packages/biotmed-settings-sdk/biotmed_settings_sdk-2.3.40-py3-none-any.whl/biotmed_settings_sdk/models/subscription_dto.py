...
class SubscriptionDto(BaseModel):
    ...
    """ # noqa: E501
    interception_order: Optional[StrictInt] = Field(default=None, description="The order in which the all interceptions for this plugin will be run in their respective apis. This can be overridden in each interception's data. Must be a positive number. Default is 1", alias="interceptionOrder")
    interceptions: Optional[List[InterceptionSubscriptionDto]] = None
    notifications: Optional[List[NotificationSubscriptionDto]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in interceptions (list)
        _items = []
        if self.interceptions:
            for _item_interceptions in self.interceptions:
                if _item_interceptions:
                    _items.append(_item_interceptions.to_dict())
            _dict['interceptions'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "interceptions": [InterceptionSubscriptionDto.from_dict(_item) for _item in obj["interceptions"]] if obj.get("interceptions") is not None else None,
            "notifications": [NotificationSubscriptionDto.from_dict(_item) for _item in obj["notifications"]] if obj.get("notifications") is not None else None
        })
