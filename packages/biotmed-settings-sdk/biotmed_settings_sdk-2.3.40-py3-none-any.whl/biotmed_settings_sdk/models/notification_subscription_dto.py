...
class NotificationSubscriptionDto(BaseModel):
    ...
    """ # noqa: E501
    entity_type_name: StrictStr = Field(description="The entity for which to create the notification. Check get all notifiable actions API for supported values", alias="entityTypeName")
    action_name: StrictStr = Field(description="The action for which to create the notification. Check get all notifiable actions API for supported values", alias="actionName")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["entityTypeName", "actionName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NotificationSubscriptionDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NotificationSubscriptionDto from a dict"""
        if obj is None:
            return None
