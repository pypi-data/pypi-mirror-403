...
class InterceptionConfigurationResponse(BaseModel):
    """
    ...
    service_prefix: StrictStr = Field(alias="servicePrefix")
    api_id: Optional[StrictStr] = Field(default=None, alias="apiId")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["entityTypeName", "servicePrefix", "apiId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InterceptionConfigurationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InterceptionConfigurationResponse from a dict"""
        if obj is None:
            return None
