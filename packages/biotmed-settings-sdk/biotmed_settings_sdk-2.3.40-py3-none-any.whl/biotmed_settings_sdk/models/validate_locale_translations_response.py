...
class ValidateLocaleTranslationsResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    invalid_translations: Optional[List[InvalidTranslation]] = Field(default=None, alias="invalidTranslations")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["invalidTranslations"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidateLocaleTranslationsResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in invalid_translations (list)
        _items = []
        if self.invalid_translations:
            for _item_invalid_translations in self.invalid_translations:
                if _item_invalid_translations:
                    _items.append(_item_invalid_translations.to_dict())
            _dict['invalidTranslations'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidateLocaleTranslationsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "invalidTranslations": [InvalidTranslation.from_dict(_item) for _item in obj["invalidTranslations"]] if obj.get("invalidTranslations") is not None else None
        })
