...
class StartImportConfigurationRequest(BaseModel):
    """
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["exportId", "importType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of StartImportConfigurationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of StartImportConfigurationRequest from a dict"""
        if obj is None:
            return None
