...
class UpdateTemplateRequest(BaseModel):
    ...
    force_update: Optional[StrictBool] = Field(default=None, alias="forceUpdate")
    custom_attributes: Optional[List[UpdateCustomAttribute]] = Field(default=None, alias="customAttributes")
    built_in_attributes: Optional[List[UpdateBuiltInAttribute]] = Field(default=None, alias="builtInAttributes")
    template_attributes: Optional[List[UpdateTemplateAttribute]] = Field(default=None, alias="templateAttributes")
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["displayName", "name", "description", "ownerOrganizationId", "analyticsDbConfiguration", "forceUpdate", "customAttributes", "builtInAttributes", "templateAttributes", "parentTemplateId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customAttributes": [UpdateCustomAttribute.from_dict(_item) for _item in obj["customAttributes"]] if obj.get("customAttributes") is not None else None,
            "builtInAttributes": [UpdateBuiltInAttribute.from_dict(_item) for _item in obj["builtInAttributes"]] if obj.get("builtInAttributes") is not None else None,
            "templateAttributes": [UpdateTemplateAttribute.from_dict(_item) for _item in obj["templateAttributes"]] if obj.get("templateAttributes") is not None else None,
