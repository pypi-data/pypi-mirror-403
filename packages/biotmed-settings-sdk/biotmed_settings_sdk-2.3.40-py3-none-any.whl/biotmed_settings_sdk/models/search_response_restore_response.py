...
class SearchResponseRestoreResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    data: List[RestoreResponse] = Field(description="List of items that match the search request")
    metadata: Metadata
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchResponseRestoreResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchResponseRestoreResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": [RestoreResponse.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
