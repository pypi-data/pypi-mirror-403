...
class LocaleTranslationsCoverage(BaseModel):
    """
    ...
    """ # noqa: E501
    number_of_available_keys: Optional[StrictInt] = Field(default=None, alias="numberOfAvailableKeys")
    number_of_translated_keys: Optional[StrictInt] = Field(default=None, alias="numberOfTranslatedKeys")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["numberOfAvailableKeys", "numberOfTranslatedKeys"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LocaleTranslationsCoverage from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LocaleTranslationsCoverage from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "numberOfAvailableKeys": obj.get("numberOfAvailableKeys"),
            "numberOfTranslatedKeys": obj.get("numberOfTranslatedKeys")
        })
