...
class CreatePluginRequest(BaseModel):
    ...
    image_tag: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=128)]] = Field(default=None, description="Relevant only for deploymentPackageType = IMAGE. Specify the tag you used when you uploaded the image using the docker push command. After being attach to the plugin, the image will be managed by the server", alias="imageTag")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["name", "displayName", "version", "runtime", "handler", "timeout", "memorySize", "environmentVariables", "subscriptions", "enabledState", "cronSchedule", "deploymentPackageType", "analyticsDbAccess", "cors", "ephemeralStorage", "imageTag"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatePluginRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatePluginRequest from a dict"""
        if obj is None:
            return None
