...
class LinkConfiguration(BaseModel):
    ...
    """ # noqa: E501
    entity_type_name: Annotated[str, Field(min_length=0, strict=True, max_length=64)] = Field(alias="entityTypeName")
    template_id: UUID = Field(alias="templateId")
    attribute_id: UUID = Field(alias="attributeId")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["entityTypeName", "templateId", "attributeId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LinkConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LinkConfiguration from a dict"""
        if obj is None:
            return None
