...
class CreateCodeSnippetRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=100)]] = Field(default=None, description="The name of the code snippet")
    description: Optional[StrictStr] = Field(default=None, description="The description of the code snippet")
    language: StrictStr = Field(description="The code language")
    code: StrictStr = Field(description="The actual code snippet")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["name", "description", "language", "code"]

    @field_validator('language')
    def language_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['JAVASCRIPT']):
            raise ValueError("must be one of enum values ('JAVASCRIPT')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateCodeSnippetRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateCodeSnippetRequest from a dict"""
        if obj is None:
            return None
