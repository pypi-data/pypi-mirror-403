...
class RestoreResponse(BaseModel):
    ...
    status: StrictStr = Field(description="The status of the restore")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["name", "backupVersion", "errorMessage", "buildNumber", "lastModifiedTime", "creationTime", "status"]
