...
class EntityTypeBuiltInAction(BaseModel):
    """
    ...
    enable_notification: Optional[StrictBool] = Field(default=None, alias="enableNotification")
    enable_log: Optional[StrictBool] = Field(default=None, alias="enableLog")
    timeout_in_seconds: Optional[StrictInt] = Field(default=None, alias="timeoutInSeconds")
    source: Optional[StrictStr] = None
    category: Optional[Category] = None
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["name", "basePath", "displayName", "enableNotification", "enableLog", "timeoutInSeconds", "source", "category"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EntityTypeBuiltInAction from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EntityTypeBuiltInAction from a dict"""
        if obj is None:
            return None
