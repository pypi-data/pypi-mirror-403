...
class SearchResponsePluginResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    data: List[PluginResponse] = Field(description="List of items that match the search request")
    metadata: Metadata
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SearchResponsePluginResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SearchResponsePluginResponse from a dict"""
        if obj is None:
            return None
