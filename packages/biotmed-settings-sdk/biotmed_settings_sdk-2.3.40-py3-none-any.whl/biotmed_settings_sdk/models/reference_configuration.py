...
class ReferenceConfiguration(BaseModel):
    ...
    """ # noqa: E501
    uniquely: Optional[StrictBool] = None
    referenced_side_attribute_name: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=128)]] = Field(default=None, alias="referencedSideAttributeName")
    referenced_side_attribute_display_name: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=128)]] = Field(default=None, alias="referencedSideAttributeDisplayName")
    valid_templates_to_reference: Optional[List[UUID]] = Field(default=None, alias="validTemplatesToReference")
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["uniquely", "referencedSideAttributeName", "referencedSideAttributeDisplayName", "validTemplatesToReference", "entityType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReferenceConfiguration from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReferenceConfiguration from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "uniquely": obj.get("uniquely"),
            "referencedSideAttributeName": obj.get("referencedSideAttributeName"),
            "referencedSideAttributeDisplayName": obj.get("referencedSideAttributeDisplayName"),
            "validTemplatesToReference": obj.get("validTemplatesToReference"),
