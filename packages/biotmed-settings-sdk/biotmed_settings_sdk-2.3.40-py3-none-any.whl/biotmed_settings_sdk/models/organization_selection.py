...
class OrganizationSelection(BaseModel):
    ...
    configuration: Optional[OrganizationSelectionConfiguration] = None
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["allowed", "configuration"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationSelection from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationSelection from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "configuration": OrganizationSelectionConfiguration.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None
        })
