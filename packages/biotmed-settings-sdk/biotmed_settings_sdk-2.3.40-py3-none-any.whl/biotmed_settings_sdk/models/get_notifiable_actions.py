...
class GetNotifiableActions(BaseModel):
    """
    ...
    """ # noqa: E501
    entity_types: Optional[List[EntityNotifiableAction]] = Field(default=None, alias="entityTypes")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetNotifiableActions from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetNotifiableActions from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "entityTypes": [EntityNotifiableAction.from_dict(_item) for _item in obj["entityTypes"]] if obj.get("entityTypes") is not None else None
        })
