...
def create_reflection_toolset(
    ...
    *,
    ...
    def _get_next_hint() -> str:
        ...
        if uncritiqued:
            return f"Use critique_output on [{uncritiqued[0].output_id}] to identify improvements."
        ...
        if unrefined:
            return f"Use refine_output on [{unrefined[0]}] to address the critique."
    ...
    async def critique_output(critique: CritiqueOutputItem) -> str:
        ...
        if critique.output_id not in _storage.outputs:
            ...
            return (
                f"Error: Output '{critique.output_id}' not found. "
