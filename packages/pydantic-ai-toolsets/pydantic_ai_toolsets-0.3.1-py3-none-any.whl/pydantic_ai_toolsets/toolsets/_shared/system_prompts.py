...
def identify_toolset_type(toolset: AbstractToolset[Any]) -> str:
    ...
    if "cot" in toolset_id or "chain" in toolset_id or "chain" in toolset_label:
        return "cot"
    elif "tot" in toolset_id or "tree" in toolset_id or "tree" in toolset_label:
        return "tot"
    elif "got" in toolset_id or "graph" in toolset_label:
        return "got"
    elif "mcts" in toolset_id or "monte" in toolset_label:
        return "mcts"
    elif "beam" in toolset_id or "beam" in toolset_label:
        return "beam"
    elif "reflection" in toolset_id or "reflection" in toolset_label:
        return "reflection"
    elif "self_refine" in toolset_id or "self-refine" in toolset_label:
        return "self_refine"
    elif "self_ask" in toolset_id or "self-ask" in toolset_label:
        return "self_ask"
    elif "persona" in toolset_id or "persona" in toolset_label:
        if "debate" in toolset_id or "debate" in toolset_label:
            return "persona_debate"
        return "persona"
    elif "search" in toolset_id or "search" in toolset_label:
        return "search"
    elif "todo" in toolset_id or "todo" in toolset_label or "to_do" in toolset_id:
        return "todo"
