...
async def compare_multi_agent_toolsets(
    config: EvaluationConfig | None = None,
) -> dict[str, Any]:
    """Compare all multi-agent toolsets on the same test cases.
    ...
    evaluation_functions = [
        ("multi_personas", evaluate_multi_personas_toolset),
        ("persona_debate", evaluate_persona_debate_toolset),
    ]
