...
class StorageInspector:
    ...
    def extract_storage_state(storage: Any) -> dict[str, Any]:
        ...
        if hasattr(storage, "answers"):
            state["answers"] = [
                {
                    "answer_id": a.answer_id[:8] + "...",
                    "question_id": a.question_id[:8] + "...",
        ...
        if hasattr(storage, "final_answers"):
            state["final_answers"] = [
                {
                    "final_answer_id": fa.final_answer_id[:8] + "...",
                    "main_question_id": fa.main_question_id[:8] + "...",
...
class ToolsetEvaluator(ABC, Generic[T, S]):
    ...
    async def evaluate_case(
        ...
        result = EvaluationResult(
            case_name=prompt[:50] + "..." if len(prompt) > 50 else prompt,
