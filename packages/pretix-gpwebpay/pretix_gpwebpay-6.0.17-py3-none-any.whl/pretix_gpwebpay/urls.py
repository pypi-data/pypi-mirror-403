...
urlpatterns = [
    path('redirect/<str:order>/<int:payment>/<str:hash>/', views.RedirectView.as_view(), name='redirect'),
    ...
    path('sync/<str:order>/<int:payment>/<str:hash>/', views.ManualSyncView.as_view(), name='sync'),
]
