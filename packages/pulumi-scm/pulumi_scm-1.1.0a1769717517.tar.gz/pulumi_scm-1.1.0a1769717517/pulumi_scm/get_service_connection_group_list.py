...
def get_service_connection_group_list(device: Optional[_builtins.str] = None,
...
def get_service_connection_group_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
