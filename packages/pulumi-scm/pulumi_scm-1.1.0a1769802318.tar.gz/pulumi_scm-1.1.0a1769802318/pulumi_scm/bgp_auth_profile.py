...
__all__ = ['BgpAuthProfileArgs', 'BgpAuthProfile']

@pulumi.input_type
class BgpAuthProfileArgs:
...
@pulumi.type_token("scm:index/bgpAuthProfile:BgpAuthProfile")
class BgpAuthProfile(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param BgpAuthProfileArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BgpAuthProfileArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BgpAuthProfileArgs.__new__(BgpAuthProfileArgs)
        ...
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["encryptedValues", "secret"])
        opts = pulumi.ResourceOptions.merge(opts, secret_opts)
        super(BgpAuthProfile, __self__).__init__(
    ...
    def get(resource_name: str,
            ...
            secret: Optional[pulumi.Input[_builtins.str]] = None,
            snippet: Optional[pulumi.Input[_builtins.str]] = None,
            tfid: Optional[pulumi.Input[_builtins.str]] = None) -> 'BgpAuthProfile':
        """
        ...
        __props__ = _BgpAuthProfileState.__new__(_BgpAuthProfileState)
        ...
        return BgpAuthProfile(resource_name, opts=opts, __props__=__props__)
