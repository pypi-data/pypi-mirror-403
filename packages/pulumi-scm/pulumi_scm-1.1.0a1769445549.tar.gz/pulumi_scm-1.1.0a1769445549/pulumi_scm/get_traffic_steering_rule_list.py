...
def get_traffic_steering_rule_list(device: Optional[_builtins.str] = None,
...
def get_traffic_steering_rule_list_output(device: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
