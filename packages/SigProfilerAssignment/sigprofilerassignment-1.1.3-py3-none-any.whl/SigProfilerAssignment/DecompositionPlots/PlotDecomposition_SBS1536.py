...
def crop_margins(pdf_to_edit, num_bases):
    ...
    if num_bases == 1:
        ...
        page.mediabox.upper_Right = (792, 512)
        page.mediabox.upper_left = (0, 512)
        ...
        page.mediabox.lower_right = (792, 110)
        page.mediabox.lower_left = (0, 110)
        page.mediabox.upper_Right = (792, 512)
        page.mediabox.upper_left = (0, 512)
        writer.add_page(page)
        writer.write(output_plot_buff)
...
def gen_plot(
    ...
    if reconstruction:
        ...
        c.drawString(
            WIDTH_GRAPH - WIDTH_GAP - 38, LAYOUT_2_TEXT[1][Y_COORD] + 205, "Original"
        )
        c.drawImage(
            recon_image,
            WIDTH_GAP,
        ...
        c.drawImage(
            output_path + "/SBS_sub_plots/" + de_novo + "_" + project + ".png",
            WIDTH_GAP,
            MID_HEIGHT_LETTER - (HEIGHT_GRAPH),
            width=WIDTH_GRAPH,
            height=HEIGHT_GRAPH * 2.4,
        )
