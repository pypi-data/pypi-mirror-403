...
class PatientResponse(BaseModel):
    ...
    caregiver: BasicReferencedEntityDataUUIDId = Field(alias="_caregiver")
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["_name", "_description", "_email", "_phone", "_locale", "_gender", "_dateOfBirth", "_address", "_mfa", "_credentialType", "_additionalPhone", "_nationalId", "_id", "_ownerOrganization", "_caregiver", "_creationTime", "_lastModifiedTime", "_invitationAccepted", "_template", "_referencers", "_enabled", "_username", "_registrationSource", "_canLogin", "_nickname", "_caption"]
