...
class PatientSelfSignUpFacadeResponse(BaseModel):
    """
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["device", "patient"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatientSelfSignUpFacadeResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatientSelfSignUpFacadeResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "device": DeviceResponse.from_dict(obj["device"]) if obj.get("device") is not None else None,
            "patient": PatientResponse.from_dict(obj["patient"]) if obj.get("patient") is not None else None
        })
