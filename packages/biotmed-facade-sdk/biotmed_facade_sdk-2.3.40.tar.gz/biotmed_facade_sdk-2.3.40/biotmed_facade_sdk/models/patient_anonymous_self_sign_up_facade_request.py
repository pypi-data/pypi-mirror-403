...
class PatientAnonymousSelfSignUpFacadeRequest(BaseModel):
    """
    ...
    device_registration_code: StrictStr = Field(description="The registration code entity that is attached to the device", alias="_deviceRegistrationCode")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatientAnonymousSelfSignUpFacadeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatientAnonymousSelfSignUpFacadeRequest from a dict"""
        if obj is None:
            return None
