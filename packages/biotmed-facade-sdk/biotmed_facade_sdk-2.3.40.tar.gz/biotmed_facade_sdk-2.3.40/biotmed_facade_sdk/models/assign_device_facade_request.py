...
class AssignDeviceFacadeRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    device_registration_code: StrictStr = Field(description="The registration code entity that is attached to the device", alias="deviceRegistrationCode")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["deviceRegistrationCode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssignDeviceFacadeRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssignDeviceFacadeRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "deviceRegistrationCode": obj.get("deviceRegistrationCode")
        })
