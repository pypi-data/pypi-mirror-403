...
: ${AMENT_CURRENT_PREFIX:="/tmp/tmp19xfer_c/wheel/platlib/package"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pointcloudcrafter/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/pointcloudcrafter/environment/path.sh"
