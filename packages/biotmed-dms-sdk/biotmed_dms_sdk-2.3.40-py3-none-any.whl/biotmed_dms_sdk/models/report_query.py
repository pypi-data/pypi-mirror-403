...
class ReportQuery(BaseModel):
    ...
    """ # noqa: E501
    data_type: StrictStr = Field(description="Data Type to be exported.", alias="dataType")
    ...
    # BioT Code End
    __properties: ClassVar[List[str]] = ["dataType", "filter", "sort"]

    @field_validator('data_type')
    def data_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['device', 'device-alert', 'usage-session', 'command', 'organization', 'patient', 'organization-user', 'caregiver', 'patient-alert', 'generic-entity', 'measurements', 'registration-code']):
            raise ValueError("must be one of enum values ('device', 'device-alert', 'usage-session', 'command', 'organization', 'patient', 'organization-user', 'caregiver', 'patient-alert', 'generic-entity', 'measurements', 'registration-code')")
        return value
