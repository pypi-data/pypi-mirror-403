...
class ReportOutputMetadata(BaseModel):
    """
    ...
    """ # noqa: E501
    max_file_size_in_bytes: Optional[Annotated[int, Field(le=1000000000, strict=True, ge=50000)]] = Field(default=None, description="The maximum size (in bytes) that each output file should not exceed", alias="maxFileSizeInBytes")
    export_format: StrictStr = Field(description="The format in which to export the report", alias="exportFormat")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["maxFileSizeInBytes", "exportFormat"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReportOutputMetadata from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReportOutputMetadata from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "maxFileSizeInBytes": obj.get("maxFileSizeInBytes"),
