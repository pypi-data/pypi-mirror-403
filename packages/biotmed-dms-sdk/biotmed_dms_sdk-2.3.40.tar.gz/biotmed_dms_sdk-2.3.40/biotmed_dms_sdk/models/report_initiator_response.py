...
class ReportInitiatorResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    user_id: Optional[UUID] = Field(default=None, description="The user ID of the initiator of the report", alias="userId")
    owner_organization_id: Optional[UUID] = Field(default=None, description="The owner organization ID of the initiator of the report", alias="ownerOrganizationId")
    user_entity_type: Optional[StrictStr] = Field(default=None, description="The entity type of the initiator of the report", alias="userEntityType")
    template_id: Optional[UUID] = Field(default=None, description="The template ID of the initiator of the report", alias="templateId")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["userId", "ownerOrganizationId", "userEntityType", "templateId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReportInitiatorResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReportInitiatorResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "userEntityType": obj.get("userEntityType"),
