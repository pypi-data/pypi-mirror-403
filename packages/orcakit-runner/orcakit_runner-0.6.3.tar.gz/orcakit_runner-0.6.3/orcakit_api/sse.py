...
from orcakit_api.asyncio import SimpleTaskGroup, aclosing
...
class EventSourceResponse(sse_starlette.EventSourceResponse):
    ...
    async def __call__(self, scope: Scope, receive: Receive, send: Send) -> None:
        async with anyio.create_task_group() as task_group:
            ...
            # Note: _listen_for_exit_signal was removed in sse-starlette 2.x
            # The exit signal handling is now done differently in the new version
