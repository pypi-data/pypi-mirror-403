...
from orcakit_api.auth.custom import DotDict, ProxyUser
from orcakit_api.config import LANGGRAPH_AUTH, LANGGRAPH_AUTH_TYPE
from orcakit_api.js.base import BaseRemotePregel, RemoteInterrupt
from orcakit_api.js.errors import RemoteException
from orcakit_api.js.sse import SSEDecoder, aiter_lines_raw
from orcakit_api.route import ApiResponse
...
class CustomJsAuthBackend(AuthenticationBackend):
    ...
    def __init__(self, disable_studio_auth: bool = False):
        from orcakit_api.utils.cache import LRUCache

        self.ls_auth = None
        if not disable_studio_auth and LANGGRAPH_AUTH_TYPE == "langsmith":
            from orcakit_api.auth.langsmith.backend import LangsmithAuthBackend
