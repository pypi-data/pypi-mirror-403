...
from orcakit_api import config as lg_api_config
from orcakit_api.feature_flags import FF_USE_CORE_API, USE_RUNTIME_CONTEXT_API
from orcakit_api.js.base import BaseRemotePregel, is_js_path
from orcakit_api.schema import Config
from orcakit_api.utils.config import run_in_executor, var_child_runnable_config
from orcakit_api.utils.errors import GraphLoadError
...
async def register_graph(
    ...
    *,
    ...
    """Register a graph."""
    from orcakit_api.grpc.ops import Assistants as AssistantsGrpc
    from orcakit_runtime.database import connect
    from orcakit_runtime.ops import Assistants as AssistantsRuntime
...
async def get_graph(
    ...
    *,
    ...
    """Return the runnable."""
    from orcakit_api.utils import config as lg_config
...
async def collect_graphs_from_env(register: bool = False) -> None:
    ...
    if js_specs:
        ...
        from orcakit_api.js.remote import (
            RemotePregel,
            run_js_http_process,
            run_js_process,
