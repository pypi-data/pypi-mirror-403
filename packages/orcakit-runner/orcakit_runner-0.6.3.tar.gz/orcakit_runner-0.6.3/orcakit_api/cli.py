...
if typing.TYPE_CHECKING:
    ...
    from orcakit_api.config import AuthConfig, HttpConfig, StoreConfig
...
def _get_ls_origin() -> str | None:
    ...
    try:
        ...
        logger.debug("Failed to get LangSmith origin: %s", str(e))
        return None
...
def run_server(
    ...
    **kwargs: typing.Any,
    ...
    if tunnel:
        ...
        from orcakit_api.tunneling.cloudflare import start_tunnel
    ...
    to_patch = dict(
        ...
        ORCAKIT_RUNTIME_EDITION=runtime_edition,
...
"""
        ...
        uvicorn.run(
            ...
            log_config={
                ...
                "formatters": {
                    "simple": {
                        "class": "orcakit_api.logging.Formatter",
                    }
                },
                "handlers": {
                    "console": {
                ...
                "loggers": {
                    ...
                    "orcakit_api.server": {"level": server_level},
                },
