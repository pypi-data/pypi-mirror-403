...
from orcakit_api.auth.studio_user import StudioUser
...
async def handle_event(
    ...
    if auth == "js":
        from orcakit_api.js.remote import handle_js_auth_event
...
def _get_custom_auth_middleware(
    ...
    if auth_instance == "js":
        from orcakit_api.js.remote import CustomJsAuthBackend
