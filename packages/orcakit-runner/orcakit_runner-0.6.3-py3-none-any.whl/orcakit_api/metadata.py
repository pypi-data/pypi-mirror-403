...
from orcakit_api.auth.custom import get_auth_instance
...
from orcakit_api.graph import GRAPHS, is_js_graph
from orcakit_api.http import http_request
...
async def metadata_loop() -> None:
    ...
    base_tags = _ensure_strings(
        # Tag values must be strings.
        {
            ...
            "orcakit_api.version": __version__ or "",
