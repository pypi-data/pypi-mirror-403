...
class StreamThreadRequest(_message.Message):
    ...
    filters: _containers.MessageMap[str, AuthFilter]
    last_event_id: str
    stream_modes: _containers.RepeatedScalarFieldContainer[StreamMode]
    def __init__(self, thread_id: _Optional[_Union[UUID, _Mapping]] = ..., filters: _Optional[_Mapping[str, AuthFilter]] = ..., last_event_id: _Optional[str] = ..., stream_modes: _Optional[_Iterable[_Union[StreamMode, str]]] = ...) -> None: ...
...
class StreamRunRequest(_message.Message):
    ...
    def __init__(self, thread_id: _Optional[_Union[UUID, _Mapping]] = ..., run_id: _Optional[_Union[UUID, _Mapping]] = ..., filters: _Optional[_Mapping[str, AuthFilter]] = ..., last_event_id: _Optional[str] = ..., stream_modes: _Optional[_Iterable[_Union[StreamMode, str]]] = ..., ignore_run_not_found: bool = ..., cancel_on_disconnect: bool = ...) -> None: ...
