...
def test_parse_arguments_command_argument():
    ...
    assert parse_arguments(["version-list"])["command"] == "version-list"
...
def test_parse_arguments_version_list():
    assert parse_arguments(["version-list"])["format"] == "psql"
    assert parse_arguments(["version-list", "--format", "json"])["format"] == "json"
    assert parse_arguments(["version-list", "--format", "tsv"])["format"] == "tsv"
    assert parse_arguments(["version-list", "--format", "plain"])["format"] == "plain"
    assert parse_arguments(["version-list", "--format", "simple"])["format"] == "simple"
    assert parse_arguments(["version-list", "--format", "psql"])["format"] == "psql"
    assert parse_arguments(["version-list", "--format", "html"])["format"] == "html"
