...
class EntraIdTenantBrowseResult:
    ...
    Attributes:
        data (list[Union['EntraIdTenantAdminUnitBrowseModel', 'EntraIdTenantApplicationBrowseModel',
            'EntraIdTenantBitlockerKeyBrowseModel', 'EntraIdTenantConditionalAccessPolicyBrowseModel',
            'EntraIdTenantDeviceConfigurationBrowseModel', 'EntraIdTenantGroupBrowseModel', 'EntraIdTenantRoleBrowseModel',
            'EntraIdTenantUserBrowseModel']]): Array of Microsoft Entra ID items. To get the IDs, run the [Get Microsoft
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from ..models.entra_id_tenant_application_browse_model import EntraIdTenantApplicationBrowseModel
        from ..models.entra_id_tenant_bitlocker_key_browse_model import EntraIdTenantBitlockerKeyBrowseModel
        from ..models.entra_id_tenant_device_configuration_browse_model import (
            EntraIdTenantDeviceConfigurationBrowseModel,
        )
        from ..models.entra_id_tenant_group_browse_model import EntraIdTenantGroupBrowseModel
        from ..models.entra_id_tenant_role_browse_model import EntraIdTenantRoleBrowseModel
        ...
        for data_item_data in self.data:
            ...
            if isinstance(data_item_data, EntraIdTenantUserBrowseModel):
                ...
                data_item = data_item_data.to_dict()
            elif isinstance(data_item_data, EntraIdTenantDeviceConfigurationBrowseModel):
                data_item = data_item_data.to_dict()
            elif isinstance(data_item_data, EntraIdTenantBitlockerKeyBrowseModel):
                data_item = data_item_data.to_dict()
            else:
                data_item = data_item_data.to_dict()
        ...
        for data_item_data in _data:
            ...
            def _parse_data_item(
                ...
                try:
                    if not isinstance(data, dict):
                        raise TypeError()
                    componentsschemas_entra_id_tenant_browse_model_type_6 = (
                        EntraIdTenantBitlockerKeyBrowseModel.from_dict(data)
                    )
