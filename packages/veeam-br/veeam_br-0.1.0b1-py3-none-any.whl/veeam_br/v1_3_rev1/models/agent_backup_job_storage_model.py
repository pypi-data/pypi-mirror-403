...
class AgentBackupJobStorageModel:
    ...
    Attributes:
        ...
        source_backup_id (Union[Unset, UUID]): ID of a backup stored in the backup repository. Use this property to map
        ...
        gfs_policy (Union[Unset, GFSPolicySettingsModel]): GFS retention policy settings.
        advanced_settings (Union[Unset, AgentBackupJobAdvancedSettingsModel]): Advanced backup job settings.
    """
    ...
    gfs_policy: Union[Unset, "GFSPolicySettingsModel"] = UNSET
    advanced_settings: Union[Unset, "AgentBackupJobAdvancedSettingsModel"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gfs_policy: Union[Unset, GFSPolicySettingsModel]
        ...
        advanced_settings: Union[Unset, AgentBackupJobAdvancedSettingsModel]
