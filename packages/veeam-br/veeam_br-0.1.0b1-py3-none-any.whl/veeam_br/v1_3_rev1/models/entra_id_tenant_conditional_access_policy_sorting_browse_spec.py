...
class EntraIdTenantConditionalAccessPolicySortingBrowseSpec:
    ...
    Attributes:
        property_ (Union[Unset, EEntraIdTenantConditionalAccessPolicySortingProperty]): Sorting property.
        direction (Union[Unset, ESortExpressionDirectionType]): Sorting order.
    """

    property_: Union[Unset, EEntraIdTenantConditionalAccessPolicySortingProperty] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        property_: Union[Unset, EEntraIdTenantConditionalAccessPolicySortingProperty]
