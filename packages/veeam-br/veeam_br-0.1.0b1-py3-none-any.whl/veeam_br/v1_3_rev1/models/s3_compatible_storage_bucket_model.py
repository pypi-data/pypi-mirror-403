...
class S3CompatibleStorageBucketModel:
    ...
    Attributes:
        ...
        enable_auto_provision (Union[Unset, bool]): If `true`, automatic bucket creation is enabled.
        workloads_per_bucket_limit (Union[Unset, int]): Maximum number of workloads per bucket.
    ...
    bucket_name: str
    folder_name: str
    enable_auto_provision: Union[Unset, bool] = UNSET
    workloads_per_bucket_limit: Union[Unset, int] = UNSET
