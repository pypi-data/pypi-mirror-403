...
class ObjectStorageBackupJobPrimaryRepositoryModel:
    ...
    Attributes:
        backup_repository_id (Union[Unset, UUID]): Backup repository ID. To get the ID, run the [Get All
            Repositories](Repositories#operation/GetAllRepositories) request.
        source_backup_id (Union[Unset, UUID]): Source backup ID. To get the ID, run the [Get All
            Backups](Backups#operation/GetAllBackups) request.
        retention_policy (Union[Unset, UnstructuredDataRetentionPolicySettingsModel]): Retention policy settings for
            unstructured data backups.
        advanced_settings (Union[Unset, ObjectStorageBackupJobAdvancedSettingsModel]): Advanced settings for object
            storage backup job.
    """

    backup_repository_id: Union[Unset, UUID] = UNSET
    source_backup_id: Union[Unset, UUID] = UNSET
    retention_policy: Union[Unset, "UnstructuredDataRetentionPolicySettingsModel"] = UNSET
    advanced_settings: Union[Unset, "ObjectStorageBackupJobAdvancedSettingsModel"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        retention_policy: Union[Unset, UnstructuredDataRetentionPolicySettingsModel]
        ...
        advanced_settings: Union[Unset, ObjectStorageBackupJobAdvancedSettingsModel]
