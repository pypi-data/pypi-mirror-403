...
class CloudCredentialsImportSpecCollection:
    ...
    Attributes:
        azure_storage (Union[Unset, list['AzureStorageCloudCredentialsImportSpec']]): Array of Microsoft Azure storage
            accounts.
        azure_compute (Union[Unset, list['AzureComputeCloudCredentialsImportSpec']]): Array of Microsoft Azure compute
            accounts.
