...
class UploadingStreamSpec:
    ...
    Attributes:
        data (Union[Unset, File]): CSV file that contains a list of IDs of Microsoft Entra ID items that you want to
            upload. For users, you can also specify a list of user principal names.
    """
