...
class StorageLatencyControlOptions:
    ...
    Attributes:
        ...
        advanced_options (Union[Unset, list['DatastoresLatencySettingsModel']]): Array of custom latency thresholds for
            specific datastores.
    """

    latency_limit_ms: int = 20
    throttling_io_limit_ms: int = 30
    advanced_options: Union[Unset, list["DatastoresLatencySettingsModel"]] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        advanced_options: Union[Unset, list[dict[str, Any]]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for advanced_options_item_data in _advanced_options or []:
