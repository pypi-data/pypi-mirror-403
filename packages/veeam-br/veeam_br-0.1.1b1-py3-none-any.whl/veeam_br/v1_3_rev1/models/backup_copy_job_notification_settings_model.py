...
class BackupCopyJobNotificationSettingsModel:
    ...
    Attributes:
        ...
        email_notifications (Union[Unset, EmailNotificationSettingsBackupCopyModel]): Email notification settings for
            the job.
    """

    send_snmp_notifications: Union[Unset, bool] = UNSET
    email_notifications: Union[Unset, "EmailNotificationSettingsBackupCopyModel"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        email_notifications: Union[Unset, EmailNotificationSettingsBackupCopyModel]
