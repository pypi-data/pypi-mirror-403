...
class UnixPackageFilters:
    ...
    Attributes:
        ...
        order_asc (Union[Unset, bool]): Sorts Unix packages in ascending order by the `orderColumn` parameter.
        name_filter (Union[Unset, str]): Filters Unix packages by the `nameFilter` pattern. The pattern can match any
            Unix package parameter. To substitute one or more characters, use the asterisk (*) character at the beginning
            and/or at the end.
    """
