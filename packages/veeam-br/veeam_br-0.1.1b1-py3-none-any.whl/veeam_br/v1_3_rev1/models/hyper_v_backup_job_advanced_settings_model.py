...
class HyperVBackupJobAdvancedSettingsModel:
    ...
    Attributes:
        ...
        hyper_v (Union[Unset, BackupJobAdvancedSettingsHyperVModel]): Microsoft Hyper-V settings for the job.
    ...
    hyper_v: Union[Unset, "BackupJobAdvancedSettingsHyperVModel"] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        hyper_v: Union[Unset, dict[str, Any]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        hyper_v: Union[Unset, BackupJobAdvancedSettingsHyperVModel]
