    ...
    *,
    ...
    Args:
        ...
        body (Union['BackupCopyJobModel', 'BackupJobModel', 'CloudDirectorBackupJobModel',
            ...
            'EntraIDTenantBackupJobModel', 'FileBackupCopyJobModel', 'HyperVBackupJobModel',
            'LinuxAgentManagementBackupJobModel', 'VSphereReplicaJobModel',
            'WindowsAgentManagementBackupJobModel']): Job model.
