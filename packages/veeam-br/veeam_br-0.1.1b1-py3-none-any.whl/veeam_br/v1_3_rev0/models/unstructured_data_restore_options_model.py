...
class UnstructuredDataRestoreOptionsModel:
    ...
    Attributes:
        ...
        mount_server_id (Union[Unset, UUID]): Mount server ID.
        permissions (Union[Unset, UnstructuredDataRestorePermissionsModel]): Permissions for restoring unstructured
            data.
    """
