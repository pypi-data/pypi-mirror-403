...
class ProtectionGroupsResult:
    ...
    Attributes:
        data (list[Union['ADObjectsProtectionGroupModel', 'CSVFileProtectionGroupModel',
            'IndividualComputersProtectionGroupModel', 'ManuallyAddedProtectionGroupModel',
            'PreInstalledAgentsProtectionGroupModel']]): Array of protection groups.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        for data_item_data in self.data:
            ...
            if isinstance(data_item_data, ManuallyAddedProtectionGroupModel):
                data_item = data_item_data.to_dict()
            elif isinstance(data_item_data, IndividualComputersProtectionGroupModel):
                data_item = data_item_data.to_dict()
            elif isinstance(data_item_data, ADObjectsProtectionGroupModel):
                data_item = data_item_data.to_dict()
            elif isinstance(data_item_data, CSVFileProtectionGroupModel):
                data_item = data_item_data.to_dict()
            else:
                data_item = data_item_data.to_dict()
