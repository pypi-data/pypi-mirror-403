...
class BackupContentDiskPublicationInfo:
    ...
    Attributes:
        disk_id (Union[Unset, str]): Disk ID.
        disk_name (Union[Unset, str]): The path of the published disk.
        access_link (Union[Unset, str]): iSCSI Qualified Name (IQN) of the disk. Only available for the iSCSI mount
            mode.
        mount_points (Union[Unset, list[str]]): Array of mount point paths.
    """

    disk_id: Union[Unset, str] = UNSET
    disk_name: Union[Unset, str] = UNSET
    access_link: Union[Unset, str] = UNSET
    mount_points: Union[Unset, list[str]] = UNSET
