...
class BackupCopyJobObjectsModel:
    ...
    Attributes:
        ...
        excludes (Union[Unset, BackupCopyExcludeObjectsModel]): Excluded objects.
        enable_transaction_log_copy (Union[Unset, bool]): If `true`, backup copy job will process transaction logs of
            the source job.
    """

    includes: "BackupCopyIncludeObjectsModel"
    excludes: Union[Unset, "BackupCopyExcludeObjectsModel"] = UNSET
    enable_transaction_log_copy: Union[Unset, bool] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        excludes: Union[Unset, BackupCopyExcludeObjectsModel]
