...
class JobScriptsSettingsModel:
    ...
    the job</li></ul>
        ...
        Attributes:
            pre_command (Union[Unset, ScriptCommand]): Script settings.
            post_command (Union[Unset, ScriptCommand]): Script settings.
            periodicity_type (Union[Unset, EScriptPeriodicityType]): Type of script periodicity.
            run_script_every (Union[Unset, int]): Number of the backup job session after which the scripts must be executed.
            day_of_week (Union[Unset, list[EDayOfWeek]]): Days of the week when the scripts must be executed.
    """

    pre_command: Union[Unset, "ScriptCommand"] = UNSET
    post_command: Union[Unset, "ScriptCommand"] = UNSET
    periodicity_type: Union[Unset, EScriptPeriodicityType] = UNSET
    run_script_every: Union[Unset, int] = UNSET
    day_of_week: Union[Unset, list[EDayOfWeek]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pre_command: Union[Unset, ScriptCommand]
        ...
        post_command: Union[Unset, ScriptCommand]
        ...
        periodicity_type: Union[Unset, EScriptPeriodicityType]
