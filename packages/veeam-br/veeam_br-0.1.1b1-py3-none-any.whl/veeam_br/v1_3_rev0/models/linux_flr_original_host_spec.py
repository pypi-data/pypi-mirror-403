...
class LinuxFlrOriginalHostSpec:
    ...
    Attributes:
        credentials_id (Union[Unset, UUID]): ID of the credentials record that will be used for SSH connection to the
            original machine. Required if valid credentials are not found in the job that created the backup (or replica).
    """
