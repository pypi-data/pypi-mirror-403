...
class WindowsHostPortsModel:
    ...
    Attributes:
        components (Union[Unset, list['WindowsHostComponentPortModel']]): Array of Veeam Backup & Replication
            components.
    ...
    components: Union[Unset, list["WindowsHostComponentPortModel"]] = UNSET
