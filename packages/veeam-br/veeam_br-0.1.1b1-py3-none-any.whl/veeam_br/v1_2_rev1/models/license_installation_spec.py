...
class LicenseInstallationSpec:
    ...
    Attributes:
        ...
        force_standalone_mode (Union[Unset, bool]): This property is only used with backup servers managed by Veeam
            Backup Enterprise Manager.<ul><li>If `true`, the request will install the license.</li><li>If `false` or the
        ...
        promo (Union[Unset, LicenseInstallationPromoSpec]): Promo license settings.
    """
