...
class VmwareFcdInstantRecoverySpec:
    ...
    restore</li> <li>Write cache</li></ul>
        ...
        Attributes:
            ...
            destination_cluster (Union['CloudDirectorObjectModel', 'VmwareObjectModel']): Inventory object properties.
    ...
    destination_cluster: Union["CloudDirectorObjectModel", "VmwareObjectModel"]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_destination_cluster(data: object) -> Union["CloudDirectorObjectModel", "VmwareObjectModel"]:
            try:
