...
class BackupScriptSettingsModel:
    ...
    Attributes:
        ...
        windows_scripts (Union[Unset, BackupWindowsScriptModel]): Paths to pre-freeze and post-thaw scripts for
            Microsoft Windows VMs.
        linux_scripts (Union[Unset, BackupLinuxScriptModel]): Paths to pre-freeze and post-thaw scripts for Linux VMs.
    """

    script_processing_mode: EBackupScriptProcessingMode
    windows_scripts: Union[Unset, "BackupWindowsScriptModel"] = UNSET
    linux_scripts: Union[Unset, "BackupLinuxScriptModel"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        windows_scripts: Union[Unset, BackupWindowsScriptModel]
        ...
        linux_scripts: Union[Unset, BackupLinuxScriptModel]
