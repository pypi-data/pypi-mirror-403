...
class EntireCloudDirectorVMRestoreLocationModel:
    ...
    Browser/operation/GetInventoryObjects) request.
        ...
        Attributes:
            ...
            v_app (Union['CloudDirectorObjectModel', 'VmwareObjectModel']): Inventory object properties.
            restore_v_sphere_vm_tags (bool): If `true`, VMware vSphere tags will be restored for this VM.
    """

    new_name: str
    v_app: Union["CloudDirectorObjectModel", "VmwareObjectModel"]
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_v_app(data: object) -> Union["CloudDirectorObjectModel", "VmwareObjectModel"]:
            try:
