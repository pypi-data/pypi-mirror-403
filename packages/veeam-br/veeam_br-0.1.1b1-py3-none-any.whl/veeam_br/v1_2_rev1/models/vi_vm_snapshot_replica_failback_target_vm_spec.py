...
class ViVMSnapshotReplicaFailbackTargetVMSpec:
    ...
    Attributes:
        ...
        destination_vm (Union['CloudDirectorObjectModel', 'VmwareObjectModel', Unset]): Inventory object properties.
    """

    replica_point_id: Union[Unset, UUID] = UNSET
    destination_vm: Union["CloudDirectorObjectModel", "VmwareObjectModel", Unset] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_destination_vm(data: object) -> Union["CloudDirectorObjectModel", "VmwareObjectModel", Unset]:
