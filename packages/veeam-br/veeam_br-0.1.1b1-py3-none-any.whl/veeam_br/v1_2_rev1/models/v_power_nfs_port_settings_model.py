...
class VPowerNFSPortSettingsModel:
    ...
    Attributes:
        mount_port (Union[Unset, int]): Mount port.
        v_power_nfs_port (Union[Unset, int]): vPower NFS port.
    """

    mount_port: Union[Unset, int] = UNSET
    v_power_nfs_port: Union[Unset, int] = UNSET
