...
class ScheduleRetryModel:
    ...
    Attributes:
        ...
        retry_count (Union[Unset, int]): Number of retries set for the job. Must be greater than zero. Default: 3.
        await_minutes (Union[Unset, int]): Time interval between job retries in minutes. Must be greater than zero.
            Default: 10.
    """
