...
class PreInstalledAgentsProtectionGroupPackageSpec:
    ...
    Attributes:
        format_ (Union[Unset, PreInstalledAgentsProtectionGroupPackageSpecFormat]): Format of the Veeam Agent package.
        include_windows_packages (Union[Unset, bool]): If `true`, Microsoft Windows packages will be downloaded.
