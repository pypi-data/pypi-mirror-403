...
class AzureNetworkSecurityGroupBrowserModel:
    ...
    Attributes:
        network_security_id (Union[Unset, str]): Security group ID.
        network_security_name (Union[Unset, str]): Security group name.
    """

    network_security_id: Union[Unset, str] = UNSET
    network_security_name: Union[Unset, str] = UNSET
