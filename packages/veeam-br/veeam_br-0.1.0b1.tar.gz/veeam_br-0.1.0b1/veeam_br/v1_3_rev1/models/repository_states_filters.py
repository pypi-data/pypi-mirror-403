...
class RepositoryStatesFilters:
    ...
    Attributes:
        ...
        is_out_of_date_filter (Union[Unset, bool]): Filters repositories by repository components status.
        ...
        exclude_extents (Union[Unset, bool]): If `true`, filters out repositories that are a part of an extent for
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        sobr_id_filter: Union[Unset, str] = UNSET
        if not isinstance(self.sobr_id_filter, Unset):
            sobr_id_filter = str(self.sobr_id_filter)

        sobr_extent_type_filter: Union[Unset, list[str]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for sobr_extent_type_filter_item_data in _sobr_extent_type_filter or []:
