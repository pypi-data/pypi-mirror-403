...
class UpdateHostComponentsSpec:
    ...
    Attributes:
        ids (Union[Unset, list[UUID]]): Array of IDs of managed servers whose components must be updated. To get the
            IDs, run the [Get All Servers](Managed-Servers#operation/GetAllManagedServers) request.
    """
