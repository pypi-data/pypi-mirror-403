    ...
    machines that you want to verify with the SureBackup job.
        ...
        Attributes:
            ...
            excludes (Union[Unset, list[Union['AgentObjectModel', 'CloudDirectorObjectModel', 'HyperVObjectModel',
                'VmwareObjectModel']]]): Array of objects that the SureBackup job excludes from processing. Specify only
                machines that are added to the linked backup policies.
            max_concurrent_machines_count (Union[Unset, int]): Maximum number of machines that can be processed at the same
                time.
            process_random_machines (Union[Unset, bool]): If `true`, only a number of random machines are tested.
            max_random_machines_count (Union[Unset, int]): Maximum number of machines that must be randomly tested.
    """
