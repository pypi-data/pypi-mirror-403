...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/v1/restore/instantRecovery/hyperV/vm/{mount_id}",
    }
...
) -> Optional[Union[Error, InstantHvVMRecoveryMount]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, InstantHvVMRecoveryMount]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Error, InstantHvVMRecoveryMount]
    """
