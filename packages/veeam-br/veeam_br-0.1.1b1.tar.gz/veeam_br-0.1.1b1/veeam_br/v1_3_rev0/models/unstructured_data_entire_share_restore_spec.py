...
class UnstructuredDataEntireShareRestoreSpec:
    ...
    Attributes:
        ...
        destination (Union[Unset, UnstructuredDataShareRestoreDestinationModel]): Destination for restoring entire
            unstructured data share.
        restore_options (Union[Unset, UnstructuredDataShareRestoreOptionsModel]): Unstructured data restore options.
    """
