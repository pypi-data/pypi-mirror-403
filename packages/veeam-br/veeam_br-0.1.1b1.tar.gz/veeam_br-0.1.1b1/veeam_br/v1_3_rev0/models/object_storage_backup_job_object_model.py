...
class ObjectStorageBackupJobObjectModel:
    ...
    Attributes:
        object_storage_server_id (Union[Unset, UUID]): ID of the object storage server.
    ...
    object_storage_server_id: Union[Unset, UUID] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        object_storage_server_id: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        object_storage_server_id: Union[Unset, UUID]
