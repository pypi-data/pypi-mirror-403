...
class UnstructuredDataArchiveRetentionPolicySettingsModel:
    ...
    Attributes:
        type_ (Union[Unset, EUnstructuredDataArchiveRetentionPolicyType]): Type of retention policy.
        quantity (Union[Unset, int]): Number of days or months that you want to keep the backup in the archive
            repository.
    """

    type_: Union[Unset, EUnstructuredDataArchiveRetentionPolicyType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Union[Unset, EUnstructuredDataArchiveRetentionPolicyType]
