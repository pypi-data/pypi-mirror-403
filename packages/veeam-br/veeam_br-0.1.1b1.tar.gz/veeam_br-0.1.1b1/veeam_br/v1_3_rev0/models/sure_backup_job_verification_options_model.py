...
class SureBackupJobVerificationOptionsModel:
    ...
    Attributes:
        ...
        yara_scan_rule (Union[Unset, str]): Yara scan rule that will be used to scan VMs.
        entire_image_scan_enabled (Union[Unset, bool]): If `true`, the antivirus software will continue scanning VMs
            after the first malware is found.
        disk_content_validation_enabled (Union[Unset, bool]): If `true`, Veeam Backup & Replication will validate backup
