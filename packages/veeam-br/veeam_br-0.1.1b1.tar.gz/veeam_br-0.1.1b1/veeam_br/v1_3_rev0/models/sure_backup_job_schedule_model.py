...
class SureBackupJobScheduleModel:
    ...
    Attributes:
        ...
        wait_for_linked_jobs (Union[Unset, bool]): If `true`, the SureBackup job will wait for linked jobs to finish.
        wait_time_minutes (Union[Unset, int]): Number of minutes that the SureBackup job will wait for linked jobs to
            finish.
    """
