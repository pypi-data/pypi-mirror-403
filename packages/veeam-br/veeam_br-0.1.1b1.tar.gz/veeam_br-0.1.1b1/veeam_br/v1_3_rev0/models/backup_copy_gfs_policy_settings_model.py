...
class BackupCopyGFSPolicySettingsModel:
    ...
    Attributes:
        ...
        read_entire_restore_point (Union[Unset, bool]): If `true`, the entire restore point from source will be read
            instead of synthesizing it from increment.
    """
    ...
    read_entire_restore_point: Union[Unset, bool] = UNSET
