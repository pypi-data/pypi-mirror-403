...
class CreateDeploymentKitSpec:
    ...
    Attributes:
        validity_period_hours (Union[Unset, int]): Number of hours before the certificate in the deployment kit expires.
            If you do not provide a request body, the default value is 24 hours.
    """

    validity_period_hours: Union[Unset, int] = UNSET
