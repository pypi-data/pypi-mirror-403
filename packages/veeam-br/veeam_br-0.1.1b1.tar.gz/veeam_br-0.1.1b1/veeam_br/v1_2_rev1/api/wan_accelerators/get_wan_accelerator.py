...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/api/v1/backupInfrastructure/wanAccelerators/{id}",
    }
...
) -> Optional[Union[Error, WANAcceleratorModel]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, WANAcceleratorModel]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Error, WANAcceleratorModel]
    """
