...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": f"/api/v1/backupBrowser/entraIdTenant/{session_id}/checkProductionItems",
    }
...
) -> Optional[Union[EntraIdTenantCheckProductionItemsModel, Error]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[EntraIdTenantCheckProductionItemsModel, Error]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[EntraIdTenantCheckProductionItemsModel, Error]
    """
