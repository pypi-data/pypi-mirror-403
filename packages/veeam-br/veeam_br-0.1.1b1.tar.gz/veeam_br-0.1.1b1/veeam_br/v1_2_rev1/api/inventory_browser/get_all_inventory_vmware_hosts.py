...
) -> Optional[Union[Error, ViRootsResult]]:
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error, ViRootsResult]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        order_column (Union[Unset, EViRootFiltersOrderColumn]): Sorts VMware vSphere servers by
            one of the VMware vSphere server parameters.
