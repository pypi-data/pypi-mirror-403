...
class ViVMSnapshotReplicaFailbackTargetHostSpec:
    ...
    Attributes:
        ...
        host (Union['CloudDirectorObjectModel', 'VmwareObjectModel', Unset]): Inventory object properties.
    """

    replica_point_id: Union[Unset, UUID] = UNSET
    host: Union["CloudDirectorObjectModel", "VmwareObjectModel", Unset] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_host(data: object) -> Union["CloudDirectorObjectModel", "VmwareObjectModel", Unset]:
