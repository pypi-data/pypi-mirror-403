...
class BackupFilesFilters:
    ...
    Attributes:
        ...
        order_column (Union[Unset, EBackupFilesFiltersOrderColumn]): Sorts backup files by one of the backup file
            parameters.
        order_asc (Union[Unset, bool]): If `true`, sorts backup files in the ascending order by the `orderColumn`
            parameter.
        name_filter (Union[Unset, str]): Sorts backup files by the `nameFilter` pattern.
