...
class BackupJobExclusionsSpec:
    ...
    Attributes:
        vms (Union[Unset, list[Union['CloudDirectorObjectModel', 'VmwareObjectModel']]]): Array of VMs. To get a VM
            object, use the [Get Inventory Objects](#tag/Inventory-Browser/operation/GetInventoryObjects) request.
        disks (Union[Unset, list['VmwareObjectDiskModel']]): Array of disks.
        templates (Union[Unset, BackupJobExclusionsTemplates]): VM templates exclusion.
    """

    vms: Union[Unset, list[Union["CloudDirectorObjectModel", "VmwareObjectModel"]]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for vms_item_data in _vms or []:
            ...
            def _parse_vms_item(data: object) -> Union["CloudDirectorObjectModel", "VmwareObjectModel"]:
                try:
