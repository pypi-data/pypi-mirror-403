...
class WanAcceleratorSettingsModel:
    ...
    Attributes:
        ...
        source_wan_accelerator_id (Union[Unset, UUID]): ID of a WAN accelerator configured in the source site.
        target_wan_accelerator_id (Union[Unset, UUID]): ID of a WAN accelerator configured in the target site.
    """

    transfer_mode: EJobDataTransferModel
    source_wan_accelerator_id: Union[Unset, UUID] = UNSET
    target_wan_accelerator_id: Union[Unset, UUID] = UNSET
    additional_properties: dict[str, Any] = _attrs_field(init=False, factory=dict)

    def to_dict(self) -> dict[str, Any]:
        transfer_mode = self.transfer_mode.value

        source_wan_accelerator_id: Union[Unset, str] = UNSET
        if not isinstance(self.source_wan_accelerator_id, Unset):
            source_wan_accelerator_id = str(self.source_wan_accelerator_id)

        target_wan_accelerator_id: Union[Unset, str] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        source_wan_accelerator_id: Union[Unset, UUID]
        ...
        target_wan_accelerator_id: Union[Unset, UUID]
