...
class AzureComputeBrowserFilters:
    ...
    also the response time.
        ...
        Attributes:
            show_all_storage_accounts (Union[Unset, bool]): If `true`, the result contains compute resorces for all storage
                accounts. If *false*, the result contains compute resorces available for the specified storage account only.
                Default: False.
            subscription_id (Union[Unset, str]): Filters compute resorces by ID that Veeam Backup & Replication assigned to
                the Azure subscription.
            location (Union[Unset, str]): Filters compute resorces by Azure location name.
            has_networks (Union[Unset, bool]): If `true`, the result contains Azure resource groups with virtual networks
                only. Default: False.
    """
