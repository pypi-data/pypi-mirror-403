...
class ViVMQuickMigrationSpec:
    """
    Attributes:
        destination_host (Union['CloudDirectorObjectModel', 'VmwareObjectModel']): Inventory object properties.
        ...
        datastore (Union['CloudDirectorObjectModel', 'VmwareObjectModel', Unset]): Inventory object properties.
    ...
    destination_host: Union["CloudDirectorObjectModel", "VmwareObjectModel"]
    ...
    datastore: Union["CloudDirectorObjectModel", "VmwareObjectModel", Unset] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_destination_host(data: object) -> Union["CloudDirectorObjectModel", "VmwareObjectModel"]:
            try:
        ...
        def _parse_datastore(data: object) -> Union["CloudDirectorObjectModel", "VmwareObjectModel", Unset]:
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
