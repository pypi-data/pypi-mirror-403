...
class RestorePointCounterModel:
    ...
    Attributes:
        ...
        counter_type (Union[Unset, EEntraIDTenantItemCounterType]): Counter type.
        counter (Union[Unset, int]): Number of items.
    """

    item_type: Union[Unset, EEntraIdSavedTenantItemType] = UNSET
    counter_type: Union[Unset, EEntraIDTenantItemCounterType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        counter_type: Union[Unset, EEntraIDTenantItemCounterType]
