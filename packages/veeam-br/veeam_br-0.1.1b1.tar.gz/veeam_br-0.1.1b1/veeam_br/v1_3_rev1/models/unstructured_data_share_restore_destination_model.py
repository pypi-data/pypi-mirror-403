...
class UnstructuredDataShareRestoreDestinationModel:
    ...
    Attributes:
        unstructured_data_server_id (Union[Unset, UUID]): ID of the target file share. To get the ID, run the [Get All
            Unstructured Data Servers](Inventory-Browser#operation/GetAllUnstructuredDataServers) request.
        restore_to_backup_server (Union[Unset, bool]): If `true`, the contents of the file share will be restored to the
            backup server.
