...
class GeneralOptionsNotificationsModel:
    ...
    Attributes:
        ...
        datastore_space_threshold (Union[Unset, int]): Space threshold of a production datastore, in percent.
        skip_vm_space_threshold (Union[Unset, int]): Space threshold of a production datastore, in percent.
    """
