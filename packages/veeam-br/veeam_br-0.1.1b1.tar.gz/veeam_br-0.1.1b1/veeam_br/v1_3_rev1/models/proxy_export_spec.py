...
class ProxyExportSpec:
    ...
    Attributes:
        ids (Union[Unset, list[UUID]]): Array of backup proxy IDs.
        types (Union[Unset, list[EProxyType]]): Array of backup proxy types.
        names (Union[Unset, list[str]]): Array of backup proxy names. Wildcard characters are supported.
    """

    ids: Union[Unset, list[UUID]] = UNSET
    types: Union[Unset, list[EProxyType]] = UNSET
