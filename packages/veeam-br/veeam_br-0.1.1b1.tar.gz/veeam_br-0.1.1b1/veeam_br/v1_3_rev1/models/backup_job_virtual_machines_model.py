...
class BackupJobVirtualMachinesModel:
    ...
    Attributes:
        ...
        excludes (Union[Unset, BackupJobExclusions]): Objects excluded from the job.
    """

    includes: list[Union["AgentObjectModel", "CloudDirectorObjectModel", "HyperVObjectModel", "VmwareObjectModel"]]
    excludes: Union[Unset, "BackupJobExclusions"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        excludes: Union[Unset, BackupJobExclusions]
