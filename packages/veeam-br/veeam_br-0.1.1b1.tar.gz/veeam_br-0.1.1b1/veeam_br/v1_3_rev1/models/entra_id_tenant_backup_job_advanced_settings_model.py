...
class EntraIDTenantBackupJobAdvancedSettingsModel:
    ...
    Attributes:
        notifications (Union[Unset, EntraIDTenantNotificationSettingsModel]): Notification settings.
        encryption (Union[Unset, BackupStorageSettingsEncryptionModel]): Encryption of backup files.
    """

    notifications: Union[Unset, "EntraIDTenantNotificationSettingsModel"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        notifications: Union[Unset, EntraIDTenantNotificationSettingsModel]
