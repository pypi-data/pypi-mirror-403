...
class FileBackupNotificationSettingsModel:
    ...
    Attributes:
        ...
        trigger_issue_job_warning (Union[Unset, bool]): If `true`, you will receive a warning at the end of the job
            processing session in case of issues with processing files or folders.
        trigger_attribute_issue_job_warning (Union[Unset, bool]): If `true`, you will receive a warning at the end of
