...
class SmbRepositoryShareSettingsSpec:
    ...
    Attributes:
        ...
        gateway_server (Union[Unset, RepositoryShareGatewayImportSpec]): Import settings for the gateway server.
    """

    share_path: str
    credentials: "CredentialsImportModel"
    gateway_server: Union[Unset, "RepositoryShareGatewayImportSpec"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        gateway_server: Union[Unset, RepositoryShareGatewayImportSpec]
