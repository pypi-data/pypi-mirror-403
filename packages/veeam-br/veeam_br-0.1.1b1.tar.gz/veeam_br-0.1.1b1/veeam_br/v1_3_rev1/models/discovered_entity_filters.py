...
class DiscoveredEntityFilters:
    ...
    Attributes:
        ...
        order_column (Union[Unset, EDiscoveredEntityFiltersOrderColumn]): Sorts discovered entities by one of the
            parameters.
        order_asc (Union[Unset, bool]): Sorts discovered entities in ascending order by the `orderColumn` parameter.
        ...
        agent_status_filter (Union[Unset, EAgentStatus]): Status of the Veeam Agent on a discovered computer.
