...
class TasksResult:
    ...
    Attributes:
        data (list[Union['CommonTaskModel', 'DeploymentKitTaskModel', 'FlrDownloadTaskModel', 'FlrRestoreTaskModel',
            'FlrSearchTaskModel', 'HierarchyRescanTaskModel']]): Array of tasks.
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        for data_item_data in self.data:
            ...
            if isinstance(data_item_data, CommonTaskModel):
                ...
                data_item = data_item_data.to_dict()
            elif isinstance(data_item_data, HierarchyRescanTaskModel):
                data_item = data_item_data.to_dict()
            else:
                data_item = data_item_data.to_dict()
