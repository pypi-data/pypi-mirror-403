...
class BackupApplicationSettingsImportModel:
    ...
    Attributes:
        ...
        sql (Union[Unset, BackupSQLSettingsImportModel]): Microsoft SQL Server transaction log settings.
        oracle (Union[Unset, BackupOracleSettingsImportModel]): Oracle archived log settings.
        postgre_sql (Union[Unset, BackupPostgreSQLSettingsImportModel]): PostgreSQL WAL files settings.
    ...
    sql: Union[Unset, "BackupSQLSettingsImportModel"] = UNSET
    oracle: Union[Unset, "BackupOracleSettingsImportModel"] = UNSET
    postgre_sql: Union[Unset, "BackupPostgreSQLSettingsImportModel"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sql: Union[Unset, BackupSQLSettingsImportModel]
        ...
        oracle: Union[Unset, BackupOracleSettingsImportModel]
        ...
        postgre_sql: Union[Unset, BackupPostgreSQLSettingsImportModel]
