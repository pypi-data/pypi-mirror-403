const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/pages-Mc8wp_y-.js","assets/components-B0-DAhcS.js","assets/vendor-CrEOFTVD.js","assets/vendor-three-CmB8bl_y.js","assets/vendor-BGzfc4EU.css","assets/vendor-codemirror-CqHxtmit.js","assets/vendor-shiki-Bgf5Xnpl.js","assets/vendor-recharts-BYpwajz0.js"])))=>i.map(i=>d[i]);
import{h as e,j as o,ea as y,eb as x,ec as z,ed as w,i as g,cz as P,ee as l,db as n,r as k,O as S,ef as L}from"./vendor-CrEOFTVD.js";import{L as _,e as R,r as E,R as I,f as C,F as j,g as A,P as D,h as T,i as O,p as F,j as M,T as m,k as V,l as G,s as N,m as W,n as q,o as B,q as $,t as K,v as Q,w as U,D as H,x as p,E as u,y as J,z as X,B as Y,C as Z,G as oo,H as lo,I as ao,J as ro,K as co,M as go,N as eo,O as bo,Q as no,U as io,V as so,W as to,X as f,Y as mo,Z as po,_ as uo,$ as fo,a0 as ho,a1 as h,a2 as v,a3 as vo,a4 as yo,a5 as xo,a6 as zo,a7 as wo,a8 as Po,a9 as ko,aa as So,ab as Lo,ac as _o,ad as Ro,ae as Eo,af as Io,ag as Co,ah as jo,ai as Ao,aj as Do,ak as s,al as To,am as Oo,an as Fo,ao as Mo,ap as Vo,aq as Go,ar as No,as as Wo}from"./pages-Mc8wp_y-.js";import{cR as qo,fQ as Bo,R as $o,fR as Ko}from"./components-B0-DAhcS.js";import"./vendor-three-CmB8bl_y.js";import"./vendor-codemirror-CqHxtmit.js";import"./vendor-shiki-Bgf5Xnpl.js";import"./vendor-recharts-BYpwajz0.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const c of document.querySelectorAll('link[rel="modulepreload"]'))d(c);new MutationObserver(c=>{for(const b of c)if(b.type==="childList")for(const t of b.addedNodes)t.tagName==="LINK"&&t.rel==="modulepreload"&&d(t)}).observe(document,{childList:!0,subtree:!0});function i(c){const b={};return c.integrity&&(b.integrity=c.integrity),c.referrerPolicy&&(b.referrerPolicy=c.referrerPolicy),c.crossOrigin==="use-credentials"?b.credentials="include":c.crossOrigin==="anonymous"?b.credentials="omit":b.credentials="same-origin",b}function d(c){if(c.ep)return;c.ep=!0;const b=i(c);fetch(c.href,b)}})();const Qo=e`
  :root,
  .ac-theme {
...
`;function cl(){const{theme:a}=qo();return o(y,{styles:e(Ho,Uo,a==="dark"?Jo:Xo,Yo(a),Qo,Zo,ol,ll,al,rl)})}const gl=x(z(g(l,{path:"/",errorElement:o(s,{}),element:o(Vo,{}),children:[o(l,{path:"/v1/*",element:o(P,{to:"/",replace:!0})}),o(l,{path:"/login",element:o(_,{})}),o(l,{path:"/logout",element:o(R,{})}),o(l,{path:"/reset-password",element:o(I,{}),loader:E}),o(l,{path:"/reset-password-with-token",element:o(C,{})}),o(l,{path:"/forgot-password",element:o(j,{})}),o(l,{element:o(Mo,{}),loader:A,children:g(l,{element:o(Fo,{}),children:[o(l,{path:"/profile",handle:{crumb:()=>"profile"},element:o(D,{})}),o(l,{index:!0,loader:T}),g(l,{path:"/model",lazy:()=>n(()=>import("./pages-Mc8wp_y-.js").then(a=>a.at),__vite__mapDeps([0,1,2,3,4,5,6,7])).then(a=>({handle:{crumb:()=>"model"},element:o(a.ModelRoot,{})})),children:[o(l,{index:!0,lazy:()=>n(()=>import("./pages-Mc8wp_y-.js").then(a=>a.au),__vite__mapDeps([0,1,2,3,4,5,6,7])).then(a=>({element:o(a.ModelInferencesPage,{})}))}),o(l,{lazy:()=>n(()=>import("./pages-Mc8wp_y-.js").then(a=>a.au),__vite__mapDeps([0,1,2,3,4,5,6,7])).then(a=>({element:o(a.ModelInferencesPage,{})})),children:o(l,{path:"dimensions",children:o(l,{path:":dimensionId",lazy:()=>n(()=>import("./pages-Mc8wp_y-.js").then(a=>a.av),__vite__mapDeps([0,1,2,3,4,5,6,7])).then(a=>({element:o(a.DimensionPage,{}),loader:a.dimensionLoader}))})})}),o(l,{path:"embeddings",children:o(l,{path:":embeddingDimensionId",lazy:()=>n(()=>import("./pages-Mc8wp_y-.js").then(a=>a.aw),__vite__mapDeps([0,1,2,3,4,5,6,7])).then(a=>({element:o(a.EmbeddingPage,{}),loader:a.embeddingLoader,handle:{crumb:r=>r.embedding.name}}))})})]}),g(l,{path:"/projects",handle:{crumb:()=>"Projects"},element:o(U,{}),children:[o(l,{index:!0,element:o(O,{})}),g(l,{path:":projectId",loader:F,handle:{crumb:a=>{var r;return(r=a==null?void 0:a.project)==null?void 0:r.name}},element:o(Q,{}),children:[o(l,{index:!0,element:o(M,{})}),g(l,{element:o(K,{}),children:[o(l,{path:"traces",element:o(V,{}),children:o(l,{path:":traceId",element:o(m,{})})}),o(l,{path:"spans",element:o(G,{}),children:o(l,{path:":traceId",element:o(m,{})})}),o(l,{path:"sessions",element:o(q,{}),children:o(l,{path:":sessionId",element:o(W,{}),loader:N})}),o(l,{path:"config",element:o(B,{})}),o(l,{path:"metrics",element:o($,{})})]})]})]}),g(l,{path:"/datasets",handle:{crumb:()=>"Datasets"},children:[o(l,{index:!0,element:o(H,{})}),g(l,{path:":datasetId",loader:p,handle:{crumb:a=>{var r;return(r=a==null?void 0:a.dataset)==null?void 0:r.name}},children:[g(l,{element:o(ao,{}),loader:p,children:[o(l,{index:!0,element:o(u,{})}),o(l,{path:"experiments",element:o(u,{})}),o(l,{path:"examples",element:o(Y,{}),loader:J,children:o(l,{path:":exampleId",element:o(X,{})})}),o(l,{path:"versions",element:o(oo,{}),loader:Z}),o(l,{path:"evaluators",element:o(lo,{})})]}),o(l,{path:"compare",element:o(ro,{}),handle:{crumb:()=>"compare"}})]})]}),g(l,{path:"/playground",handle:{crumb:()=>"Playground"},children:[o(l,{index:!0,element:o(co,{})}),o(l,{path:"spans/:spanId",element:o(eo,{}),loader:go,handle:{crumb:a=>{var r;return(a==null?void 0:a.span.__typename)==="Span"?`span ${(r=a==null?void 0:a.span)==null?void 0:r.spanId}`:"span unknown"}}})]}),g(l,{path:"/prompts",handle:{crumb:()=>"Prompts"},children:[o(l,{index:!0,element:o(no,{}),loader:bo}),g(l,{path:":promptId",loader:io,shouldRevalidate:()=>!0,handle:{crumb:a=>{var r,i;return((r=a==null?void 0:a.prompt)==null?void 0:r.__typename)==="Prompt"?(i=a==null?void 0:a.prompt)==null?void 0:i.name:"prompt unknown"}},children:[g(l,{element:o(ho,{}),children:[o(l,{index:!0,element:o(so,{})}),o(l,{path:"versions",loader:to,element:o(po,{}),children:o(l,{path:":versionId",loader:f,element:o(mo,{})})}),o(l,{path:"config",element:o(fo,{}),loader:uo})]}),o(l,{path:"versions/:versionId",loader:f,handle:{crumb:a=>a==null?void 0:a.promptVersion.id},children:o(l,{path:"playground",element:o(v,{}),loader:h,handle:{crumb:()=>"playground"}})}),o(l,{path:"playground",element:o(v,{}),loader:h,handle:{crumb:()=>"playground"}})]})]}),o(l,{path:"/apis",element:o(vo,{}),handle:{crumb:()=>"APIs"}}),o(l,{path:"/support",element:o(yo,{}),handle:{crumb:()=>"Support"}}),g(l,{path:"/settings",element:o(Ao,{}),handle:{crumb:()=>"Settings"},children:[o(l,{path:"general",loader:xo,element:o(zo,{}),handle:{crumb:()=>"General"}}),o(l,{path:"providers",loader:wo,element:o(Po,{}),handle:{crumb:()=>"AI Providers"}}),o(l,{path:"models",loader:ko,element:o(So,{}),handle:{crumb:()=>"Models"}}),o(l,{path:"datasets",element:o(Lo,{}),handle:{crumb:()=>"Datasets"}}),o(l,{path:"annotations",loader:_o,element:o(Ro,{}),handle:{crumb:()=>"Annotations"}}),o(l,{path:"data",element:o(Io,{}),handle:{crumb:()=>"Data Retention"},loader:Eo}),o(l,{path:"prompts",element:o(jo,{}),loader:Co,handle:{crumb:()=>"Prompts"}})]}),o(l,{path:"/redirects/spans/:span_otel_id",loader:Do,errorElement:o(s,{})}),o(l,{path:"/redirects/traces/:trace_otel_id",loader:To,errorElement:o(s,{})}),o(l,{path:"/redirects/sessions/:session_id",loader:Oo,errorElement:o(s,{})})]})})]})),{basename:window.Config.basename});function el(){return o(w,{router:gl})}function bl(){return o(Go,{children:o(Bo,{children:o(nl,{})})})}function nl(){return g(S.RelayEnvironmentProvider,{environment:$o,children:[o(cl,{}),o(Wo,{children:o(Ko,{children:o(No,{children:o(k.Suspense,{children:o(el,{})})})})})]})}const il=document.getElementById("root"),sl=L.createRoot(il);sl.render(o(bl,{}));
