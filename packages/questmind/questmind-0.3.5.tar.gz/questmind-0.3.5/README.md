...
| `uv run questmind check` | Verify install | Tests imports, model loading, generation |
...
- **`questmind check` command** - Verify installation with sanity tests
- Self-contained inference (no mlx-vlm dependency)
