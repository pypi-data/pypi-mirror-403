...
from questmind.cache.vlm_cache import VLMPrefixCacheManager, VLMCacheManager
...
class MLXMultimodalLM:
    ...
    def load(self) -> None:
        ...
        try:
            from questmind.inference.utils import load, load_config
    ...
    def generate(
        ...
        **kwargs,
        ...
        from questmind.inference.generate import generate
        from questmind.models import cache as vlm_cache
        from questmind.inference.prompt_utils import apply_chat_template
    ...
    def stream_generate(
        ...
        **kwargs,
        ...
        try:
            from questmind.inference.generate import stream_generate
            from questmind.inference.prompt_utils import apply_chat_template
        except ImportError:
    ...
    def chat(
        ...
        **kwargs,
        ...
        from questmind.inference.generate import generate
        from questmind.inference.prompt_utils import get_chat_template
        ...
        from questmind.models import cache as vlm_cache
        from questmind.inference.utils import prepare_inputs
        import time
