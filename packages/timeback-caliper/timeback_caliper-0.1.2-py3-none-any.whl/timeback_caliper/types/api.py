...
class JobStatus(BaseModel):
    ...
    Matches TS JobStatus interface with state-based semantics.
    """
...
class StoredEvent(BaseModel):
    ...
    Matches TS StoredEvent interface. The API adds internal fields and
    transforms the original event ID to `external_id`.
    """
