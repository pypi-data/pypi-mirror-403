#!/usr/bin/env python3
"""
Example demonstrating TOON format integration with ScrapeGraph SDK.
...
This example shows how to use the `return_toon` parameter with various scraping methods.
"""
import os
...
def main():
    """Demonstrate TOON format with different scraping methods."""
    ...
    try:
        ...
        json_response = client.smartscraper(
        ...
        toon_response = client.smartscraper(
            website_url="https://example.com",
            user_prompt="Extract the page title and main heading",
            return_toon=True
        )
    ...
    try:
        ...
        toon_search_response = client.searchscraper(
    ...
    try:
        # Request with TOON format
        toon_markdown_response = client.markdownify(
            website_url="https://example.com",
            return_toon=True
        )
    ...
    print("\n\n✅ TOON Integration Examples Completed!")
    print("=" * 60)
