...
class DocumentManager:
    ...
    def list(
        ...
        Args:
            limit: Maximum number of documents to return (deprecated, use page_limit).
            offset: Number of documents to skip (deprecated, use page).
        ...
        """
        params: Dict[str, Any] = {}
        # Use pageLimit (preferred) or fall back to limit for backwards compatibility
        ...
        if isinstance(response, list):
            ...
            # API returns "data" array, not "items"
            items = [Document.from_dict(item) for item in response.get("data", response.get("items", []))]
