...
def print_usage() -> None:
    """Print CLI usage."""
    print(f"""pulse-workflow-mcp v{__version__} - MCP server for Pulse workflows
...
Usage:
    ...
    pulse-workflow-mcp --version        Show version
...
def main() -> None:
    ...
    if cmd in ("--help", "-h", "help"):
        ...
        print(f"pulse-workflow-mcp v{__version__}")
