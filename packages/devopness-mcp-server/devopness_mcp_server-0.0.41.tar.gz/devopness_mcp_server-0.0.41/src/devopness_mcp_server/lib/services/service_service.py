...
class ServiceService:
    ...
    async def tool_get_available_service_types(
        ...
        response = await ctx.devopness.static.get_static_service_options()
    ...
    async def tool_create_service(
        ...
        response = await ctx.devopness.services.add_environment_service(
            environment_id,
            {
                "type": service_type,
    ...
    async def tool_list_services(
        ...
        response = await ctx.devopness.services.list_environment_services(
            environment_id,
            page,
        ...
        formatted_data: list[FormattedData] = [
            {
                "ID": str(service.id),
                "Type": f"[{service.type}]({service.url_web_permalink})",
                "Version": f"**{service.version}**",
                "Last Action": render_action(service.last_action),
            }
