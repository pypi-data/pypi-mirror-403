...
class AIAgent:
    ...
    def _create_default_instructions(self):
        ...
        defaults = {
                'generator_instructions.txt': """1. PRIMARY FOCUS: The latest user query is your immediate task.
        ...
        7. Reference specific points from the context ONLY when relevant to the current topic.
        8. Provide a detailed, well-structured response that is self-contained and accurate.
        9. Include practical examples where relevant and consider multiple approaches.
        ...
        11. Rate your confidence in this solution (0-1).""",
                ...
                'analyzer_instructions.txt': """1. Review the conversation history and documents to understand the full context.
                2. CONTEXT POLLUTION CHECK: Verify if the solution accidentally mixed content from unrelated previous files or chat history into the current topic.
                3. RELEVANCE AUDIT: If the user query is new, ensure the assistant didn't over-rely on background documents that are no longer relevant.
                4. Identify factual errors, logical inconsistencies, or gaps.
                5. Spot missing information or gaps.
                6. Check if the solution addresses the LATEST user query as the priority.
                7. Spot "hallucinated connections" between the current topic and old uploaded files.
                8. Check if the solution maintains conversational continuity.
                9. Suggest area-specific improvements.
                10. Rate the overall quality (0-1).
                11. Be thorough but constructive.
    ...
    Format your response as JSON:
    {
        ...
        "note": "IMPORTANT: If data_visualization_needed is true, you MUST specifically instruct the Optimizer to 'Create 2-3 informative charts using <plot_config> based on the provided data tables' in the 'improvements_needed' list."
                ...
                'optimizer_instructions.txt': """1. Review the analysis feedback to fix all identified errors and "context pollution" (mixing unrelated topics).
    2. PRIORITY: Ensure the solution fulfills the current user intent. If the history contains unrelated files, DISCARD their influence.
    3. Address gaps, improve clarity, and ensure the response is significantly better.
    4. Reference specific improvements made based on the latest scope only.
    ...
    Format your response as JSON:
{
    "optimized_solution": "Your improved solution here with the <plot_config> block included",
