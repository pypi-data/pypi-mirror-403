...
**graphextract** could always use more documentation, whether as
part of the official **graphextract** docs, in docstrings, or even
...
Ready to contribute? Here's how to set up `graphextract` for local
development.

1. Fork the `graphextract` repo on 
   gitlab.com.
2. Clone your fork locally::

    $ git clone git@gitlab.com:your_name_here/graphextract.git
...
5. When you're done making changes, check that your changes pass flake8 and the
   tests, including testing other Python versions with tox::
    ...
    (dvlpt)$ cd graphextract
    (dvlpt) graphextract$ flake8
    (dvlpt) graphextract$ pytest
    
    (dvlpt) graphextract$ tox
...
.. _issues: https://gitlab.com/revesansparole/graphextract/issues
