...
/// @brief A spatial tree using OBB-RSS hybrid bounding volumes.
///
/// Alias for `tf::tree<Index, tf::obbrss<RealT, Dims>>`.
///
...
using obbrss_tree = tf::tree<Index, tf::obbrss<RealT, Dims>>;
