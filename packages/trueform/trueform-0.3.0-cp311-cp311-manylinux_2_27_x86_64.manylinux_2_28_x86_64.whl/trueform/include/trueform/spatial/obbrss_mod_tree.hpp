...
/// @brief A dynamic spatial tree using OBB-RSS hybrid bounding volumes.
///
/// Alias for `tf::mod_tree<Index, tf::obbrss<RealT, Dims>>`.
///
...
using obbrss_mod_tree = tf::mod_tree<Index, tf::obbrss<RealT, Dims>>;
