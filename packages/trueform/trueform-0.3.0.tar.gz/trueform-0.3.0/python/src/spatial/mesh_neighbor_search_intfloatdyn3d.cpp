...
auto register_mesh_neighbor_search_intdynfloat3d(nanobind::module_ &m) -> void {
  ...
  // Point queries
  m.def("neighbor_search_mesh_point_intdynfloat3d",
  ...
  // Segment queries
  m.def(
      "neighbor_search_mesh_segment_intdynfloat3d",
      [](mesh_wrapper<int, float, tf::dynamic_size, 3> &mesh,
  ...
  // Polygon queries
  m.def(
      "neighbor_search_mesh_polygon_intdynfloat3d",
      [](mesh_wrapper<int, float, tf::dynamic_size, 3> &mesh,
  ...
  // Ray queries
  m.def(
      "neighbor_search_mesh_ray_intdynfloat3d",
      [](mesh_wrapper<int, float, tf::dynamic_size, 3> &mesh,
         nanobind::ndarray<nanobind::numpy, const float, nanobind::shape<2, 3>>
             query,
         std::optional<float> radius) {
  ...
  // Line queries
  m.def(
      "neighbor_search_mesh_line_intdynfloat3d",
      [](mesh_wrapper<int, float, tf::dynamic_size, 3> &mesh,
         nanobind::ndarray<nanobind::numpy, const float, nanobind::shape<2, 3>>
             query,
         std::optional<float> radius) {
  ...
  // Plane queries
  m.def(
      "neighbor_search_mesh_plane_intdynfloat3d",
      [](mesh_wrapper<int, float, tf::dynamic_size, 3> &mesh,
  ...
  m.def("neighbor_search_mesh_knn_point_intdynfloat3d",
        [](mesh_wrapper<int, float, tf::dynamic_size, 3> &mesh,
           nanobind::ndarray<nanobind::numpy, const float, nanobind::shape<3>>
               query,
  ...
  m.def(
      "neighbor_search_mesh_knn_segment_intdynfloat3d",
      [](mesh_wrapper<int, float, tf::dynamic_size, 3> &mesh,
         nanobind::ndarray<nanobind::numpy, const float, nanobind::shape<2, 3>>
             query,
         int k, std::optional<float> radius) {
  ...
  m.def(
      "neighbor_search_mesh_knn_polygon_intdynfloat3d",
      [](mesh_wrapper<int, float, tf::dynamic_size, 3> &mesh,
         nanobind::ndarray<nanobind::numpy, const float, nanobind::shape<-1, 3>>
             query,
         int k, std::optional<float> radius) {
  ...
  m.def(
      "neighbor_search_mesh_knn_ray_intdynfloat3d",
      [](mesh_wrapper<int, float, tf::dynamic_size, 3> &mesh,
         nanobind::ndarray<nanobind::numpy, const float, nanobind::shape<2, 3>>
             query,
         int k, std::optional<float> radius) {
  ...
  m.def(
      "neighbor_search_mesh_knn_line_intdynfloat3d",
      [](mesh_wrapper<int, float, tf::dynamic_size, 3> &mesh,
         nanobind::ndarray<nanobind::numpy, const float, nanobind::shape<2, 3>>
             query,
         int k, std::optional<float> radius) {
  ...
  m.def(
      "neighbor_search_mesh_knn_plane_intdynfloat3d",
      [](mesh_wrapper<int, float, tf::dynamic_size, 3> &mesh,
         nanobind::ndarray<nanobind::numpy, const float, nanobind::shape<4>>
             query,
         int k, std::optional<float> radius) {
