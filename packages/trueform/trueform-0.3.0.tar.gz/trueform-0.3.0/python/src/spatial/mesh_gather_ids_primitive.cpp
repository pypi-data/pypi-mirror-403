...
// Forward declarations for mesh_gather_ids_primitive bindings split across multiple files
...
auto register_mesh_gather_ids_primitive(nanobind::module_ &m) -> void {
  // Register all mesh_gather_ids_primitive bindings
  // Split across multiple files for parallel compilation
  register_mesh_gather_ids_primitive_float2d(m);
  register_mesh_gather_ids_primitive_float3d(m);
  register_mesh_gather_ids_primitive_double2d(m);
  register_mesh_gather_ids_primitive_double3d(m);
}
