...
// Forward declarations for mesh_neighbor_search_mesh bindings split across multiple files
...
auto register_mesh_neighbor_search_mesh(nanobind::module_ &m) -> void {
  // Register all mesh_neighbor_search_mesh bindings
  // Split across multiple files for parallel compilation
  register_mesh_neighbor_search_mesh_float2d(m);
  register_mesh_neighbor_search_mesh_float3d(m);
  register_mesh_neighbor_search_mesh_double2d(m);
  register_mesh_neighbor_search_mesh_double3d(m);
}
