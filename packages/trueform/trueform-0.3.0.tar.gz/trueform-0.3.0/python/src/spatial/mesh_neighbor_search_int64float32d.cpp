...
auto register_mesh_neighbor_search_int643float2d(nanobind::module_ &m) -> void {
  ...
  // Point queries
  m.def("neighbor_search_mesh_point_int643float2d",
  ...
  // Segment queries
  m.def(
      "neighbor_search_mesh_segment_int643float2d",
      [](mesh_wrapper<int64_t, float, 3, 2> &mesh,
  ...
  // Polygon queries
  m.def(
      "neighbor_search_mesh_polygon_int643float2d",
      [](mesh_wrapper<int64_t, float, 3, 2> &mesh,
  ...
  // Ray queries
  m.def(
      "neighbor_search_mesh_ray_int643float2d",
      [](mesh_wrapper<int64_t, float, 3, 2> &mesh,
         nanobind::ndarray<nanobind::numpy, const float, nanobind::shape<2, 2>>
             query,
         std::optional<float> radius) {
  ...
  // Line queries
  m.def(
      "neighbor_search_mesh_line_int643float2d",
      [](mesh_wrapper<int64_t, float, 3, 2> &mesh,
         nanobind::ndarray<nanobind::numpy, const float, nanobind::shape<2, 2>>
             query,
         std::optional<float> radius) {
  ...
  m.def("neighbor_search_mesh_knn_point_int643float2d",
        [](mesh_wrapper<int64_t, float, 3, 2> &mesh,
           nanobind::ndarray<nanobind::numpy, const float, nanobind::shape<2>>
               query,
  ...
  m.def(
      "neighbor_search_mesh_knn_segment_int643float2d",
      [](mesh_wrapper<int64_t, float, 3, 2> &mesh,
         nanobind::ndarray<nanobind::numpy, const float, nanobind::shape<2, 2>>
             query,
         int k, std::optional<float> radius) {
  ...
  m.def(
      "neighbor_search_mesh_knn_polygon_int643float2d",
      [](mesh_wrapper<int64_t, float, 3, 2> &mesh,
         nanobind::ndarray<nanobind::numpy, const float, nanobind::shape<-1, 2>>
             query,
         int k, std::optional<float> radius) {
  ...
  m.def(
      "neighbor_search_mesh_knn_ray_int643float2d",
      [](mesh_wrapper<int64_t, float, 3, 2> &mesh,
         nanobind::ndarray<nanobind::numpy, const float, nanobind::shape<2, 2>>
             query,
         int k, std::optional<float> radius) {
  ...
  m.def(
      "neighbor_search_mesh_knn_line_int643float2d",
      [](mesh_wrapper<int64_t, float, 3, 2> &mesh,
         nanobind::ndarray<nanobind::numpy, const float, nanobind::shape<2, 2>>
             query,
         int k, std::optional<float> radius) {
