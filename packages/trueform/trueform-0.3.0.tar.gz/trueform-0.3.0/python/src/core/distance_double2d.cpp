...
auto register_core_distance_double2d(nanobind::module_ &m) -> void {
  ...
  m.def("distance_point_point_double2d",
  ...
  m.def("distance2_point_point_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2>>
               pt0_data,
           nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2>>
               pt1_data) {
  ...
  m.def("distance_point_aabb_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2>>
               pt_data,
  ...
  m.def("distance2_point_aabb_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2>>
               pt_data,
           nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
  ...
  m.def("distance_point_line_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2>>
               pt_data,
           nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
  ...
  m.def("distance2_point_line_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2>>
               pt_data,
           nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
  ...
  m.def("distance_point_ray_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2>>
               pt_data,
  ...
  m.def("distance2_point_ray_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2>>
               pt_data,
           nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2, 2>>
               ray_data) {
  ...
  m.def("distance_point_segment_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2>>
               pt_data,
           nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
  ...
  m.def("distance2_point_segment_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2>>
               pt_data,
           nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
  ...
  m.def("distance_point_polygon_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2>>
               pt_data,
           nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<-1, 2>>
  ...
  m.def("distance2_point_polygon_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2>>
               pt_data,
           nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<-1, 2>>
  ...
  m.def("distance_aabb_aabb_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
               aabb0_data,
           nanobind::ndarray<nanobind::numpy, const double,
  ...
  m.def("distance2_aabb_aabb_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
               aabb0_data,
           nanobind::ndarray<nanobind::numpy, const double,
  ...
  m.def("distance_line_line_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
               line0_data,
           nanobind::ndarray<nanobind::numpy, const double,
  ...
  m.def("distance2_line_line_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
               line0_data,
           nanobind::ndarray<nanobind::numpy, const double,
  ...
  m.def("distance_line_ray_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
               line_data,
           nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2, 2>>
  ...
  m.def("distance2_line_ray_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
               line_data,
           nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2, 2>>
  ...
  m.def("distance_line_segment_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
               line_data,
           nanobind::ndarray<nanobind::numpy, const double,
  ...
  m.def("distance2_line_segment_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
               line_data,
           nanobind::ndarray<nanobind::numpy, const double,
  ...
  m.def("distance_line_polygon_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
               line_data,
           nanobind::ndarray<nanobind::numpy, const double,
  ...
  m.def("distance2_line_polygon_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
               line_data,
           nanobind::ndarray<nanobind::numpy, const double,
  ...
  m.def("distance_ray_ray_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2, 2>>
               ray0_data,
           nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2, 2>>
               ray1_data) {
  ...
  m.def("distance2_ray_ray_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2, 2>>
               ray0_data,
           nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2, 2>>
               ray1_data) {
  ...
  m.def("distance_ray_segment_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2, 2>>
               ray_data,
           nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2, 2>>
               seg_data) {
  ...
  m.def("distance2_ray_segment_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2, 2>>
               ray_data,
           nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2, 2>>
               seg_data) {
  ...
  m.def("distance_ray_polygon_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2, 2>>
               ray_data,
           nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<-1, 2>>
  ...
  m.def("distance2_ray_polygon_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double, nanobind::shape<2, 2>>
               ray_data,
           nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<-1, 2>>
  ...
  m.def("distance_segment_segment_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
               seg0_data,
           nanobind::ndarray<nanobind::numpy, const double,
  ...
  m.def("distance2_segment_segment_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
               seg0_data,
           nanobind::ndarray<nanobind::numpy, const double,
  ...
  m.def("distance_segment_polygon_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
               seg_data,
           nanobind::ndarray<nanobind::numpy, const double,
  ...
  m.def("distance2_segment_polygon_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<2, 2>>
               seg_data,
           nanobind::ndarray<nanobind::numpy, const double,
  ...
  m.def("distance_polygon_polygon_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<-1, 2>>
               poly0_data,
           nanobind::ndarray<nanobind::numpy, const double,
  ...
  m.def("distance2_polygon_polygon_double2d",
        [](nanobind::ndarray<nanobind::numpy, const double,
                            nanobind::shape<-1, 2>>
               poly0_data,
           nanobind::ndarray<nanobind::numpy, const double,
