...
auto register_boolean_int64int6433float3d(nanobind::module_ &m) -> void {
  ...
  // Without curves
  m.def("boolean_mesh_mesh_int64int6433float3d",
  ...
  // With curves
  m.def("boolean_curves_mesh_mesh_int64int6433float3d",
        [](mesh_wrapper<int64_t, float, 3, 3> &mesh0,
           mesh_wrapper<int64_t, float, 3, 3> &mesh1, int op) {
          return boolean(mesh0, mesh1, int_to_boolean_op(op),
                         tf::return_curves);
  ...
  m.def("boolean_mesh_mesh_int64int643dynfloat3d",
        [](mesh_wrapper<int64_t, float, 3, 3> &mesh0,
  ...
  // 3×dyn with curves
  m.def("boolean_curves_mesh_mesh_int64int643dynfloat3d",
        [](mesh_wrapper<int64_t, float, 3, 3> &mesh0,
           mesh_wrapper<int64_t, float, dynamic_size, 3> &mesh1, int op) {
          return boolean(mesh0, mesh1, int_to_boolean_op(op),
                         tf::return_curves);
  ...
  m.def("boolean_mesh_mesh_int64int64dyn3float3d",
  ...
  // dyn×3 with curves
  m.def("boolean_curves_mesh_mesh_int64int64dyn3float3d",
        [](mesh_wrapper<int64_t, float, dynamic_size, 3> &mesh0,
           mesh_wrapper<int64_t, float, 3, 3> &mesh1, int op) {
          return boolean(mesh0, mesh1, int_to_boolean_op(op),
                         tf::return_curves);
  ...
  m.def("boolean_mesh_mesh_int64int64dyndynfloat3d",
        [](mesh_wrapper<int64_t, float, dynamic_size, 3> &mesh0,
           mesh_wrapper<int64_t, float, dynamic_size, 3> &mesh1, int op) {
          return boolean(mesh0, mesh1, int_to_boolean_op(op));
        },
  ...
  // dyn×dyn with curves
  m.def("boolean_curves_mesh_mesh_int64int64dyndynfloat3d",
        [](mesh_wrapper<int64_t, float, dynamic_size, 3> &mesh0,
           mesh_wrapper<int64_t, float, dynamic_size, 3> &mesh1, int op) {
          return boolean(mesh0, mesh1, int_to_boolean_op(op),
                         tf::return_curves);
