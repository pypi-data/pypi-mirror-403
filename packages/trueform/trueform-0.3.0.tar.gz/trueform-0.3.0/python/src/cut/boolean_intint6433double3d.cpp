...
auto register_boolean_intint6433double3d(nanobind::module_ &m) -> void {
  ...
  // Without curves
  m.def("boolean_mesh_mesh_intint6433double3d",
  ...
  // With curves
  m.def("boolean_curves_mesh_mesh_intint6433double3d",
        [](mesh_wrapper<int, double, 3, 3> &mesh0,
           mesh_wrapper<int64_t, double, 3, 3> &mesh1, int op) {
          return boolean(mesh0, mesh1, int_to_boolean_op(op),
                         tf::return_curves);
  ...
  m.def("boolean_mesh_mesh_intint643dyndouble3d",
        [](mesh_wrapper<int, double, 3, 3> &mesh0,
  ...
  // 3×dyn with curves
  m.def("boolean_curves_mesh_mesh_intint643dyndouble3d",
        [](mesh_wrapper<int, double, 3, 3> &mesh0,
           mesh_wrapper<int64_t, double, dynamic_size, 3> &mesh1, int op) {
          return boolean(mesh0, mesh1, int_to_boolean_op(op),
                         tf::return_curves);
  ...
  m.def("boolean_mesh_mesh_intint64dyn3double3d",
  ...
  // dyn×3 with curves
  m.def("boolean_curves_mesh_mesh_intint64dyn3double3d",
        [](mesh_wrapper<int, double, dynamic_size, 3> &mesh0,
           mesh_wrapper<int64_t, double, 3, 3> &mesh1, int op) {
          return boolean(mesh0, mesh1, int_to_boolean_op(op),
                         tf::return_curves);
  ...
  m.def("boolean_mesh_mesh_intint64dyndyndouble3d",
        [](mesh_wrapper<int, double, dynamic_size, 3> &mesh0,
           mesh_wrapper<int64_t, double, dynamic_size, 3> &mesh1, int op) {
          return boolean(mesh0, mesh1, int_to_boolean_op(op));
        },
  ...
  // dyn×dyn with curves
  m.def("boolean_curves_mesh_mesh_intint64dyndyndouble3d",
        [](mesh_wrapper<int, double, dynamic_size, 3> &mesh0,
           mesh_wrapper<int64_t, double, dynamic_size, 3> &mesh1, int op) {
          return boolean(mesh0, mesh1, int_to_boolean_op(op),
                         tf::return_curves);
