...
auto register_boolean_intint33float3d(nanobind::module_ &m) -> void {
  ...
  // With curves
  m.def("boolean_curves_mesh_mesh_intint33float3d",
        [](mesh_wrapper<int, float, 3, 3> &mesh0,
           mesh_wrapper<int, float, 3, 3> &mesh1, int op) {
          return boolean(mesh0, mesh1, int_to_boolean_op(op),
                         tf::return_curves);
  ...
  m.def("boolean_mesh_mesh_intint3dynfloat3d",
        [](mesh_wrapper<int, float, 3, 3> &mesh0,
           mesh_wrapper<int, float, dynamic_size, 3> &mesh1, int op) {
          return boolean(mesh0, mesh1, int_to_boolean_op(op));
        },
        nanobind::arg("mesh0"), nanobind::arg("mesh1"), nanobind::arg("op"));

  // 3×dyn with curves
  m.def("boolean_curves_mesh_mesh_intint3dynfloat3d",
        [](mesh_wrapper<int, float, 3, 3> &mesh0,
           mesh_wrapper<int, float, dynamic_size, 3> &mesh1, int op) {
          return boolean(mesh0, mesh1, int_to_boolean_op(op),
                         tf::return_curves);
  ...
  m.def("boolean_mesh_mesh_intintdyn3float3d",
  ...
  // dyn×3 with curves
  m.def("boolean_curves_mesh_mesh_intintdyn3float3d",
        [](mesh_wrapper<int, float, dynamic_size, 3> &mesh0,
           mesh_wrapper<int, float, 3, 3> &mesh1, int op) {
          return boolean(mesh0, mesh1, int_to_boolean_op(op),
                         tf::return_curves);
  ...
  m.def("boolean_mesh_mesh_intintdyndynfloat3d",
        [](mesh_wrapper<int, float, dynamic_size, 3> &mesh0,
           mesh_wrapper<int, float, dynamic_size, 3> &mesh1, int op) {
          return boolean(mesh0, mesh1, int_to_boolean_op(op));
        },
  ...
  // dyn×dyn with curves
  m.def("boolean_curves_mesh_mesh_intintdyndynfloat3d",
        [](mesh_wrapper<int, float, dynamic_size, 3> &mesh0,
           mesh_wrapper<int, float, dynamic_size, 3> &mesh1, int op) {
          return boolean(mesh0, mesh1, int_to_boolean_op(op),
                         tf::return_curves);
