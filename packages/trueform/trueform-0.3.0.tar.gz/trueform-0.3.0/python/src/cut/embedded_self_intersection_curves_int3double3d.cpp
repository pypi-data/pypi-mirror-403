...
auto register_embedded_self_intersection_curves_int3double3d(nanobind::module_ &m) -> void {
  ...
  // Without curves
  m.def("embedded_self_intersection_curves_mesh_int3double3d",
  ...
  // With curves
  m.def("embedded_self_intersection_curves_curves_mesh_int3double3d",
        [](mesh_wrapper<int, double, 3, 3> &mesh) {
  ...
  // Without curves
  m.def("embedded_self_intersection_curves_mesh_intdyndouble3d",
  ...
  // With curves
  m.def("embedded_self_intersection_curves_curves_mesh_intdyndouble3d",
        [](mesh_wrapper<int, double, dynamic_size, 3> &mesh) {
          return embedded_self_intersection_curves(mesh, tf::return_curves);
        },
        nanobind::arg("mesh"));
