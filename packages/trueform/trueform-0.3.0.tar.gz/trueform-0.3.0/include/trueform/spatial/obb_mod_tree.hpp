...
/// @brief A dynamic spatial tree using oriented bounding boxes (OBBs).
///
/// Alias for `tf::mod_tree<Index, tf::obb<RealT, Dims>>`.
///
...
using obb_mod_tree = tf::mod_tree<Index, tf::obb<RealT, Dims>>;
