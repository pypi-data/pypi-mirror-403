...
class Localizable(java.io.Serializable):
    ...
    def getLocalizedString(self, locale: java.util.Locale) -> str:
        """
            ...
            Parameters:
                baseName (:class:`~org.hipparchus.exception.https:.docs.oracle.com.javase.8.docs.api.java.lang.String?is`): base name of the resource bundle
                key (:class:`~org.hipparchus.exception.https:.docs.oracle.com.javase.8.docs.api.java.lang.String?is`): key of the item in the bundle
                locale (:class:`~org.hipparchus.exception.https:.docs.oracle.com.javase.8.docs.api.java.util.Locale?is`): locale into which to get the string.
