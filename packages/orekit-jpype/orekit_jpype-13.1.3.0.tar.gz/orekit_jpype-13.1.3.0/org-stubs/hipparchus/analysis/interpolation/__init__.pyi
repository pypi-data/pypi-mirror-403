...
class FieldBilinearInterpolatingFunction(org.hipparchus.analysis.CalculusFieldBivariateFunction[_FieldBilinearInterpolatingFunction__T], typing.Generic[_FieldBilinearInterpolatingFunction__T]):
    """
    public class FieldBilinearInterpolatingFunction<T extends :class:`~org.hipparchus.CalculusFieldElement`<T>> extends :class:`~org.hipparchus.analysis.interpolation.https:.docs.oracle.com.javase.8.docs.api.java.lang.Object?is` implements :class:`~org.hipparchus.analysis.CalculusFieldBivariateFunction`<T>
...
class FieldBivariateGridInterpolator(typing.Generic[_FieldBivariateGridInterpolator__T]):
    """
    public interface FieldBivariateGridInterpolator<T extends :class:`~org.hipparchus.CalculusFieldElement`<T>>
...
class FieldGridAxis(typing.Generic[_FieldGridAxis__T]):
    """
    public class FieldGridAxis<T extends :class:`~org.hipparchus.CalculusFieldElement`<T>> extends :class:`~org.hipparchus.analysis.interpolation.https:.docs.oracle.com.javase.8.docs.api.java.lang.Object?is`
...
class FieldBilinearInterpolator(FieldBivariateGridInterpolator[_FieldBilinearInterpolator__T], typing.Generic[_FieldBilinearInterpolator__T]):
    """
    public class FieldBilinearInterpolator<T extends :class:`~org.hipparchus.CalculusFieldElement`<T>> extends :class:`~org.hipparchus.analysis.interpolation.https:.docs.oracle.com.javase.8.docs.api.java.lang.Object?is` implements :class:`~org.hipparchus.analysis.interpolation.FieldBivariateGridInterpolator`<T>
