...
setup(
    ...
    description="A comprehensive Python utility library with 220+ functions across 18 modules",
    ...
    python_requires=">=3.7",
    keywords="utilities tools parser string math list validators date random file config encryption console",
    project_urls={
