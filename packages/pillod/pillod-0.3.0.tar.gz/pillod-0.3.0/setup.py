...
setup(
    ...
    description="A comprehensive Python utility library with 200+ functions across 17 modules",
    ...
    python_requires=">=3.7",
    keywords="utilities tools parser string math list validators date random file config encryption",
    project_urls={
