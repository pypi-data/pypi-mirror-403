---
name: "intent"
description: "Intent clarification skill - Forces exhaustive questioning until user intent converges to a single unambiguous requirement"
version: 1.0.0
category: "workflow"
user-invocable: true
tags: ['intent', 'clarification', 'requirements', 'questions']
updated: 2025-01-24
status: "active"
allowed-tools:
  - AskUserQuestion
...
AI typically picks the most probable interpretation. This skill does the opposite:
...
**User request:** "Add order cancellation"
