...
from .cached_item import TTLCachedItem

# --------------------------------------------------------------------------------
class TTLCache:
    def __init__(self, max_size: int):
        self.max_size     : int                      = max_size
        self._cached_items: Dict[Any, TTLCachedItem] = {}
        self.head         : TTLCachedItem            = None
        self.tail         : TTLCachedItem            = None

    # --------------------------------------------------------------------------------
    def __insert(self, key: Any, value: Any):
        new_node           = TTLCachedItem()
        new_node.empty     = False
        new_node.key       = key
        new_node.value     = value
        new_node.timestamp = time.time()
    ...
    # --------------------------------------------------------------------------------
    def __list_move_to_end(self, cached_item: TTLCachedItem, empty: bool = False):
    ...
    # --------------------------------------------------------------------------------
    def __list_move_to_front(self, cached_item: TTLCachedItem):
