...
class AutoScaler:
    ...
    def scale_dimensions(
        ...
        Args:
            ...
            dtype: Framework-specific data type. Uses default if None.
            scalable_indices: Tuple of indices of dimensions that ARE allowed to be scaled. 
                              If None, all dimensions are scalable.
            maximize: If True, allows scaling UP if available memory permits. 
                      Defaults to False (only scales down to preventing OOM).
    ...
    def create_scaled_tensor(
        ...
        Args:
            ...
            scalable_indices: Tuple of indices of dimensions that CAN be scaled.
            maximize: Whether to scale up if memory permits.
        ...
        scaled_dims = self.scale_dimensions(
            dimensions, 
            dtype, 
            scalable_indices=scalable_indices, 
            maximize=maximize
