"""Initialize Velbus message package.
...
__all__ = [
    ...
    "ReadDataBlockFromMemoryMessage",
    "ReadDataFromMemoryMessage",
    "RealtimeClockStatusRequest",
