...
class CreateProjectShareResponse(BaseModel):
    """
    CreateProjectShareResponse
    """ # noqa: E501
    share_token: StrictStr = Field(alias="shareToken")
    share_url: StrictStr = Field(alias="shareUrl")
    share_entity: ShareEntity = Field(alias="shareEntity")
    __properties: ClassVar[List[str]] = ["shareToken", "shareUrl", "shareEntity"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateProjectShareResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateProjectShareResponse from a dict"""
        if obj is None:
            return None
