...
class CallEvent(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["callId", "timestamp", "kind", "data", "call"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallEvent from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallEvent from a dict"""
        if obj is None:
            return None
...
CallEvent.model_rebuild(raise_errors=False)
