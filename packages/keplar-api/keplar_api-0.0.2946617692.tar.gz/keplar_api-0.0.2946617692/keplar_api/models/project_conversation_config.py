...
class ProjectConversationConfig(BaseModel):
    ...
    video_recording_enabled: Optional[StrictBool] = Field(default=False, alias="videoRecordingEnabled")
    __properties: ClassVar[List[str]] = ["firstMessage", "endCallMessage", "maxDurationSeconds", "voice", "language", "videoRecordingEnabled"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "videoRecordingEnabled": obj.get("videoRecordingEnabled") if obj.get("videoRecordingEnabled") is not None else False
        })
        return _obj
