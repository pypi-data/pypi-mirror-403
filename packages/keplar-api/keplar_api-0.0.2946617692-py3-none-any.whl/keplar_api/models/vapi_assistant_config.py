...
class VapiAssistantConfig(BaseModel):
    ...
    artifact_plan: Optional[VapiAssistantConfigArtifactPlan] = Field(default=None, alias="artifactPlan")
    compliance_plan: Optional[VapiAssistantConfigCompliancePlan] = Field(default=None, alias="compliancePlan")
    __properties: ClassVar[List[str]] = ["systemPrompt", "model", "firstMessage", "endCallMessage", "maxDurationSeconds", "voice", "tools", "language", "artifactPlan", "compliancePlan"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.tools:
            ...
            _dict['tools'] = _items
        # override the default output from pydantic by calling `to_dict()` of artifact_plan
        if self.artifact_plan:
            _dict['artifactPlan'] = self.artifact_plan.to_dict()
        # override the default output from pydantic by calling `to_dict()` of compliance_plan
        if self.compliance_plan:
            _dict['compliancePlan'] = self.compliance_plan.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "artifactPlan": VapiAssistantConfigArtifactPlan.from_dict(obj["artifactPlan"]) if obj.get("artifactPlan") is not None else None,
            "compliancePlan": VapiAssistantConfigCompliancePlan.from_dict(obj["compliancePlan"]) if obj.get("compliancePlan") is not None else None
        })
        return _obj
