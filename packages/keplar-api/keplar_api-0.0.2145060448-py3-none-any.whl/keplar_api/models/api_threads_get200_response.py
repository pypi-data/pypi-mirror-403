...
class ApiThreadsGet200Response(BaseModel):
    """
    ...
    limit: StrictInt
    offset: StrictInt
    __properties: ClassVar[List[str]] = ["threads", "total", "limit", "offset"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ApiThreadsGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ApiThreadsGet200Response from a dict"""
        if obj is None:
            return None
