...
class CallSummary(BaseModel):
    ...
    duration_ms: Optional[StrictInt] = Field(alias="durationMs")
    __properties: ClassVar[List[str]] = ["id", "status", "metadata", "durationMs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CallSummary from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CallSummary from a dict"""
        if obj is None:
            return None
