...
class OWIntensityFilter(Ewoks3DXRDPeaksPlotter, ewokstaskclass=FilterByIntensity):
    ...
    def __init__(self):
        ...
        self._thermalFactor.setRange(0.0, 1e8)
        self._thermalFactor.setToolTip("""
            Factor to compensate the thermal decrease of intensity of high-angle rings.
            The higher this is, the more low-angle rings will be filtered by intensity
            and the less high-angle rings will be filtered by intensity.
            Typical range: 0.1 - 2
        """)
