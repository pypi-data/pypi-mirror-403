...
LIMA_SEGMENTER_TOOLTIPS: Dict[str, str] = {
    "lower_bound_cut": """
        Pixel intensity threshold. Pixels with intensity lower than this value will be discarded.
        Typical values: 1 (low/no background) - 5 (high background like air scattering, quartz tube, etc.)
        """,
    "max_pixels_per_frame": """
        Limit the total number of pixels in a single frame.
        You normally don't need to modify this.
        """,
    "num_pixels_in_spot": """
        The minimum number of pixels a spot should have to survive the thresholding.
        Typical values: 3 (recommended) or more depending on background
        """,
}
