...
from apsfuncs.Toolbox.db_connections import get_db_connection, get_user_program_ids, write_user_feedback_entry
        ...
        if not self.bb.offline_mode:
            ...
            try:
                ...
                try:
                    ...
                    # Create a user feedback entry in the database
                    ...
                    self.bb.logger.exception('Failed to create feedback entry in database: {}'.format(db_e))
