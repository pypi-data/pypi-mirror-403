...
from timeback_common import validate_fields, validate_sourced_id, validate_with_schema
...
def _build_params(
    *,
    ...
    # Convert where clause to filter string, with fallback to raw filter
...
class ClassesResource(CRUDResource[Class]):
    """
