...
class AcademicSessionsResource(CRUDResource[AcademicSession]):
    """
...
class TermsResource(CRUDResource[AcademicSession]):
    """
...
class GradingPeriodsResource(CRUDResource[AcademicSession]):
    """
