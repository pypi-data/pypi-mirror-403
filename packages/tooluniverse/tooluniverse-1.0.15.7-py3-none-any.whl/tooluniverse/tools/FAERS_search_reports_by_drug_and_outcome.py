...
def FAERS_search_reports_by_drug_and_outcome(
    ...
    *,
    ...
    medicinalproduct : str
        Drug name (required).
    reactionoutcome : str
        Optional: Filter by reaction outcome. Omit this parameter if you don't want t...
    limit : int
...
__all__ = ["FAERS_search_reports_by_drug_and_outcome"]
