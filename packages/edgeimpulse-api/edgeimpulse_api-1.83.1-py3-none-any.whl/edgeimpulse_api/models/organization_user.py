...
class OrganizationUser(BaseModel):
    ...
    __properties = ["id", "username", "name", "email", "photo", "created", "lastSeen", "staffInfo", "pending", "jobTitle", "permissions", "companyName", "activated", "mfaConfigured", "stripeCustomerId", "hasPendingPayments", "tier", "idps", "added", "role", "projectCount", "datasets", "lastAccessToOrganization", "lastOrganizationProjectAccessed"]
