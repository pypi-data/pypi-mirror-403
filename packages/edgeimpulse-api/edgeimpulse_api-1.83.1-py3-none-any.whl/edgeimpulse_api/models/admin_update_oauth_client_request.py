...
class AdminUpdateOauthClientRequest(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdminUpdateOauthClientRequest:
        """Create an instance of AdminUpdateOauthClientRequest from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdminUpdateOauthClientRequest:
        """Create an instance of AdminUpdateOauthClientRequest from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AdminUpdateOauthClientRequest.construct(**obj)

        _obj = AdminUpdateOauthClientRequest.construct(**{
            "name": obj.get("name"),
