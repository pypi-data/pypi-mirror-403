...
class GetPostProcessingResultsForSampleResponseAllOf(BaseModel):
    ...
    __properties = ["hasResults", "results", "jobIsRunning"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPostProcessingResultsForSampleResponseAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPostProcessingResultsForSampleResponseAllOf:
        """Create an instance of GetPostProcessingResultsForSampleResponseAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetPostProcessingResultsForSampleResponseAllOf.construct(**obj)

        _obj = GetPostProcessingResultsForSampleResponseAllOf.construct(**{
