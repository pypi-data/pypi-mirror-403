...
class GetAllTransferLearningModelsResponseAllOf(BaseModel):
    transfer_learning_models: List[TransferLearningModel] = Field(..., alias="transferLearningModels")
    __properties = ["transferLearningModels"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAllTransferLearningModelsResponseAllOf:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAllTransferLearningModelsResponseAllOf:
        """Create an instance of GetAllTransferLearningModelsResponseAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetAllTransferLearningModelsResponseAllOf.construct(**obj)

        _obj = GetAllTransferLearningModelsResponseAllOf.construct(**{
