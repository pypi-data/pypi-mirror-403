...
class AdminGetOauthClientsResponseAllOf(BaseModel):
    ...
    __properties = ["oauthClients", "totalCount"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AdminGetOauthClientsResponseAllOf:
        """Create an instance of AdminGetOauthClientsResponseAllOf from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AdminGetOauthClientsResponseAllOf:
        """Create an instance of AdminGetOauthClientsResponseAllOf from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return AdminGetOauthClientsResponseAllOf.construct(**obj)

        _obj = AdminGetOauthClientsResponseAllOf.construct(**{
