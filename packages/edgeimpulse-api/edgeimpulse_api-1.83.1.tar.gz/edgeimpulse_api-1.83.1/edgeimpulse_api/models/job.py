...
class Job(BaseModel):
    ...
    __properties = ["id", "category", "categoryKey", "key", "created", "started", "finished", "finishedSuccessful", "jobNotificationUids", "additionalInfo", "computeTime", "createdByUser", "categoryCount", "metadata"]
