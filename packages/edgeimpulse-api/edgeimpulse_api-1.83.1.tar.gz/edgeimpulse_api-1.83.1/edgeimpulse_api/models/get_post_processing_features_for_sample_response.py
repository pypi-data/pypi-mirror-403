...
class GetPostProcessingFeaturesForSampleResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetPostProcessingFeaturesForSampleResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetPostProcessingFeaturesForSampleResponse:
        """Create an instance of GetPostProcessingFeaturesForSampleResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetPostProcessingFeaturesForSampleResponse.construct(**obj)

        _obj = GetPostProcessingFeaturesForSampleResponse.construct(**{
