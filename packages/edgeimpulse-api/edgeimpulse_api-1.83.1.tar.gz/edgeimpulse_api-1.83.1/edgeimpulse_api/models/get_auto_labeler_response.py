...
class GetAutoLabelerResponse(BaseModel):
    ...
    __properties = ["success", "error", "hasResults", "clusters", "simThreshold", "minObjectSizePx", "maxObjectSizePx", "whichItemsToInclude"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAutoLabelerResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAutoLabelerResponse:
        """Create an instance of GetAutoLabelerResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetAutoLabelerResponse.construct(**obj)

        _obj = GetAutoLabelerResponse.construct(**{
