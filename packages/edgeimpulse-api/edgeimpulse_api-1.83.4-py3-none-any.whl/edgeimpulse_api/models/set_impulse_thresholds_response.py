...
class SetImpulseThresholdsResponse(BaseModel):
    ...
    __properties = ["success", "error", "hadModelTestingResults", "regenerateModelTestingStatus", "regenerateModelTestingResultsJobId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SetImpulseThresholdsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SetImpulseThresholdsResponse:
        """Create an instance of SetImpulseThresholdsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return SetImpulseThresholdsResponse.construct(**obj)

        _obj = SetImpulseThresholdsResponse.construct(**{
