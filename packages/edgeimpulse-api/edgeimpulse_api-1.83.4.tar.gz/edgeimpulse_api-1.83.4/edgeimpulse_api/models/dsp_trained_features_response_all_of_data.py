...
class DspTrainedFeaturesResponseAllOfData(BaseModel):
    ...
    structured_y_label: Optional[Dict[str, StrictStr]] = Field(None, alias="structuredYLabel", description="All key/value label pairs for samples with multiple labels (i.e. label map datasets).")
    sample: Optional[DspTrainedFeaturesResponseAllOfSample] = None
    __properties = ["X", "y", "yLabel", "structuredYLabel", "sample"]
    ...
    def from_dict(cls, obj: dict) -> DspTrainedFeaturesResponseAllOfData:
        ...
        _obj = DspTrainedFeaturesResponseAllOfData.construct(**{
            ...
            "structured_y_label": obj.get("structuredYLabel"),
