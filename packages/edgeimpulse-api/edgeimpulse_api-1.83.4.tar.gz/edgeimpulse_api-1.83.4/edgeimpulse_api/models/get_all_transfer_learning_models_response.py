...
class GetAllTransferLearningModelsResponse(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GetAllTransferLearningModelsResponse:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GetAllTransferLearningModelsResponse:
        """Create an instance of GetAllTransferLearningModelsResponse from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return GetAllTransferLearningModelsResponse.construct(**obj)

        _obj = GetAllTransferLearningModelsResponse.construct(**{
