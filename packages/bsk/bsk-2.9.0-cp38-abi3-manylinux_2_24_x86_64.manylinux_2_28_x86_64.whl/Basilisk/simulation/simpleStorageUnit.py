...
class BasiliskError(object):
    ...
    def __init__(self, *args):
        _simpleStorageUnit.BasiliskError_swiginit(self, _simpleStorageUnit.new_BasiliskError(*args))
    __swig_destroy__ = _simpleStorageUnit.delete_BasiliskError

# Register BasiliskError in _simpleStorageUnit:
_simpleStorageUnit.BasiliskError_swigregister(BasiliskError)
