...
class SwigPyIterator(object):
    ...
    __repr__ = _swig_repr
    __swig_destroy__ = _rwNullSpace.delete_SwigPyIterator

    def value(self):
        return _rwNullSpace.SwigPyIterator_value(self)

    def incr(self, n=1):
        return _rwNullSpace.SwigPyIterator_incr(self, n)

    def decr(self, n=1):
        return _rwNullSpace.SwigPyIterator_decr(self, n)

    def distance(self, x):
        return _rwNullSpace.SwigPyIterator_distance(self, x)

    def equal(self, x):
        return _rwNullSpace.SwigPyIterator_equal(self, x)

    def copy(self):
        return _rwNullSpace.SwigPyIterator_copy(self)

    def next(self):
        return _rwNullSpace.SwigPyIterator_next(self)

    def __next__(self):
        return _rwNullSpace.SwigPyIterator___next__(self)

    def previous(self):
        return _rwNullSpace.SwigPyIterator_previous(self)

    def advance(self, n):
        return _rwNullSpace.SwigPyIterator_advance(self, n)

    def __eq__(self, x):
        return _rwNullSpace.SwigPyIterator___eq__(self, x)

    def __ne__(self, x):
        return _rwNullSpace.SwigPyIterator___ne__(self, x)

    def __iadd__(self, n):
        return _rwNullSpace.SwigPyIterator___iadd__(self, n)

    def __isub__(self, n):
        return _rwNullSpace.SwigPyIterator___isub__(self, n)

    def __add__(self, n):
        return _rwNullSpace.SwigPyIterator___add__(self, n)

    def __sub__(self, *args):
        return _rwNullSpace.SwigPyIterator___sub__(self, *args)
    def __iter__(self):
        return self

# Register SwigPyIterator in _rwNullSpace:
_rwNullSpace.SwigPyIterator_swigregister(SwigPyIterator)
...
class BasiliskError(object):
    ...
    def __init__(self, *args):
        _rwNullSpace.BasiliskError_swiginit(self, _rwNullSpace.new_BasiliskError(*args))
    __swig_destroy__ = _rwNullSpace.delete_BasiliskError

# Register BasiliskError in _rwNullSpace:
_rwNullSpace.BasiliskError_swigregister(BasiliskError)
