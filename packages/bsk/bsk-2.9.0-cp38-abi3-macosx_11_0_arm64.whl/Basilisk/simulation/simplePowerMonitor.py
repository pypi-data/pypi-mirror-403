...
class SwigPyIterator(object):
    ...
    __repr__ = _swig_repr
    __swig_destroy__ = _simplePowerMonitor.delete_SwigPyIterator

    def value(self):
        return _simplePowerMonitor.SwigPyIterator_value(self)

    def incr(self, n=1):
        return _simplePowerMonitor.SwigPyIterator_incr(self, n)

    def decr(self, n=1):
        return _simplePowerMonitor.SwigPyIterator_decr(self, n)

    def distance(self, x):
        return _simplePowerMonitor.SwigPyIterator_distance(self, x)

    def equal(self, x):
        return _simplePowerMonitor.SwigPyIterator_equal(self, x)

    def copy(self):
        return _simplePowerMonitor.SwigPyIterator_copy(self)

    def next(self):
        return _simplePowerMonitor.SwigPyIterator_next(self)

    def __next__(self):
        return _simplePowerMonitor.SwigPyIterator___next__(self)

    def previous(self):
        return _simplePowerMonitor.SwigPyIterator_previous(self)

    def advance(self, n):
        return _simplePowerMonitor.SwigPyIterator_advance(self, n)

    def __eq__(self, x):
        return _simplePowerMonitor.SwigPyIterator___eq__(self, x)

    def __ne__(self, x):
        return _simplePowerMonitor.SwigPyIterator___ne__(self, x)

    def __iadd__(self, n):
        return _simplePowerMonitor.SwigPyIterator___iadd__(self, n)

    def __isub__(self, n):
        return _simplePowerMonitor.SwigPyIterator___isub__(self, n)

    def __add__(self, n):
        return _simplePowerMonitor.SwigPyIterator___add__(self, n)

    def __sub__(self, *args):
        return _simplePowerMonitor.SwigPyIterator___sub__(self, *args)
    def __iter__(self):
        return self

# Register SwigPyIterator in _simplePowerMonitor:
_simplePowerMonitor.SwigPyIterator_swigregister(SwigPyIterator)
MAX_LOGGING_LENGTH = _simplePowerMonitor.MAX_LOGGING_LENGTH
BSK_DEBUG = _simplePowerMonitor.BSK_DEBUG
BSK_INFORMATION = _simplePowerMonitor.BSK_INFORMATION
BSK_WARNING = _simplePowerMonitor.BSK_WARNING
BSK_ERROR = _simplePowerMonitor.BSK_ERROR
BSK_SILENT = _simplePowerMonitor.BSK_SILENT

def printDefaultLogLevel():
    return _simplePowerMonitor.printDefaultLogLevel()

def setDefaultLogLevel(logLevel):
    return _simplePowerMonitor.setDefaultLogLevel(logLevel)

def getDefaultLogLevel():
    return _simplePowerMonitor.getDefaultLogLevel()
class BasiliskError(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _simplePowerMonitor.BasiliskError_swiginit(self, _simplePowerMonitor.new_BasiliskError(*args))
    __swig_destroy__ = _simplePowerMonitor.delete_BasiliskError

# Register BasiliskError in _simplePowerMonitor:
_simplePowerMonitor.BasiliskError_swigregister(BasiliskError)
cvar = _simplePowerMonitor.cvar
...
class BSKLogger(object):
    ...
    def __init__(self, *args):
        _simplePowerMonitor.BSKLogger_swiginit(self, _simplePowerMonitor.new_BSKLogger(*args))
    __swig_destroy__ = _simplePowerMonitor.delete_BSKLogger

    def setLogLevel(self, logLevel):
        return _simplePowerMonitor.BSKLogger_setLogLevel(self, logLevel)

    def printLogLevel(self):
        return _simplePowerMonitor.BSKLogger_printLogLevel(self)

    def getLogLevel(self):
        return _simplePowerMonitor.BSKLogger_getLogLevel(self)

    def bskLog(self, targetLevel, info):
        return _simplePowerMonitor.BSKLogger_bskLog(self, targetLevel, info)
    logLevelMap = property(_simplePowerMonitor.BSKLogger_logLevelMap_get, _simplePowerMonitor.BSKLogger_logLevelMap_set)

# Register BSKLogger in _simplePowerMonitor:
_simplePowerMonitor.BSKLogger_swigregister(BSKLogger)

def _BSKLogger():
    return _simplePowerMonitor._BSKLogger()

def _BSKLogger_d(arg1):
    return _simplePowerMonitor._BSKLogger_d(arg1)

def _printLogLevel(arg1):
    return _simplePowerMonitor._printLogLevel(arg1)

def _setLogLevel(arg1, arg2):
    return _simplePowerMonitor._setLogLevel(arg1, arg2)

def _bskLog(arg1, arg2, arg3):
    return _simplePowerMonitor._bskLog(arg1, arg2, arg3)
