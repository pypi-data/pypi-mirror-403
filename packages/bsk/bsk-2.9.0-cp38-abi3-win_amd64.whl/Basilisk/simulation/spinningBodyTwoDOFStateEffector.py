...
class BasiliskError(object):
    ...
    def __init__(self, *args):
        _spinningBodyTwoDOFStateEffector.BasiliskError_swiginit(self, _spinningBodyTwoDOFStateEffector.new_BasiliskError(*args))
    __swig_destroy__ = _spinningBodyTwoDOFStateEffector.delete_BasiliskError

# Register BasiliskError in _spinningBodyTwoDOFStateEffector:
_spinningBodyTwoDOFStateEffector.BasiliskError_swigregister(BasiliskError)
...
class StateData(object):
    ...
    stateName = property(_spinningBodyTwoDOFStateEffector.StateData_stateName_get)
    ...
    def __init__(self, inName, newState):
        _spinningBodyTwoDOFStateEffector.StateData_swiginit(self, _spinningBodyTwoDOFStateEffector.new_StateData(inName, newState))
    ...
    def getDerivativeRowSize(self):
        return _spinningBodyTwoDOFStateEffector.StateData_getDerivativeRowSize(self)

    def getDerivativeColumnSize(self):
        return _spinningBodyTwoDOFStateEffector.StateData_getDerivativeColumnSize(self)
    ...
    def addState(self, other):
        return _spinningBodyTwoDOFStateEffector.StateData_addState(self, other)
...
class StateVector(object):
    ...
    def __init__(self, *args):
        _spinningBodyTwoDOFStateEffector.StateVector_swiginit(self, _spinningBodyTwoDOFStateEffector.new_StateVector(*args))

    def setStates(self, operand):
        return _spinningBodyTwoDOFStateEffector.StateVector_setStates(self, operand)

    def addStates(self, operand):
        return _spinningBodyTwoDOFStateEffector.StateVector_addStates(self, operand)

    def scaleStates(self, scaleFactor):
        return _spinningBodyTwoDOFStateEffector.StateVector_scaleStates(self, scaleFactor)

    def propagateStates(self, dt):
        return _spinningBodyTwoDOFStateEffector.StateVector_propagateStates(self, dt)
...
class StateEffector(object):
    ...
    def setStateNameOfPosition(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setStateNameOfPosition(self, value)

    def getStateNameOfPosition(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getStateNameOfPosition(self)

    def setStateNameOfVelocity(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setStateNameOfVelocity(self, value)

    def getStateNameOfVelocity(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getStateNameOfVelocity(self)

    def setStateNameOfSigma(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setStateNameOfSigma(self, value)

    def getStateNameOfSigma(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getStateNameOfSigma(self)

    def setStateNameOfOmega(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setStateNameOfOmega(self, value)

    def getStateNameOfOmega(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getStateNameOfOmega(self)

    def setPropName_m_SC(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setPropName_m_SC(self, value)

    def getPropName_m_SC(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getPropName_m_SC(self)

    def setPropName_mDot_SC(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setPropName_mDot_SC(self, value)

    def getPropName_mDot_SC(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getPropName_mDot_SC(self)

    def setPropName_centerOfMassSC(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setPropName_centerOfMassSC(self, value)

    def getPropName_centerOfMassSC(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getPropName_centerOfMassSC(self)

    def setPropName_inertiaSC(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setPropName_inertiaSC(self, value)

    def getPropName_inertiaSC(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getPropName_inertiaSC(self)

    def setPropName_inertiaPrimeSC(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setPropName_inertiaPrimeSC(self, value)

    def getPropName_inertiaPrimeSC(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getPropName_inertiaPrimeSC(self)

    def setPropName_centerOfMassPrimeSC(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setPropName_centerOfMassPrimeSC(self, value)

    def getPropName_centerOfMassPrimeSC(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getPropName_centerOfMassPrimeSC(self)

    def setPropName_centerOfMassDotSC(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setPropName_centerOfMassDotSC(self, value)

    def getPropName_centerOfMassDotSC(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getPropName_centerOfMassDotSC(self)

    def setPropName_inertialPosition(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setPropName_inertialPosition(self, value)

    def getPropName_inertialPosition(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getPropName_inertialPosition(self)

    def setPropName_inertialVelocity(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setPropName_inertialVelocity(self, value)

    def getPropName_inertialVelocity(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getPropName_inertialVelocity(self)

    def setPropName_vehicleGravity(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setPropName_vehicleGravity(self, value)

    def getPropName_vehicleGravity(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getPropName_vehicleGravity(self)

    def setPropName_prescribedPosition(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setPropName_prescribedPosition(self, value)

    def getPropName_prescribedPosition(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getPropName_prescribedPosition(self)

    def setPropName_prescribedVelocity(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setPropName_prescribedVelocity(self, value)

    def getPropName_prescribedVelocity(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getPropName_prescribedVelocity(self)

    def setPropName_prescribedAcceleration(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setPropName_prescribedAcceleration(self, value)

    def getPropName_prescribedAcceleration(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getPropName_prescribedAcceleration(self)

    def setPropName_prescribedAttitude(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setPropName_prescribedAttitude(self, value)

    def getPropName_prescribedAttitude(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getPropName_prescribedAttitude(self)

    def setPropName_prescribedAngVelocity(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setPropName_prescribedAngVelocity(self, value)

    def getPropName_prescribedAngVelocity(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getPropName_prescribedAngVelocity(self)

    def setPropName_prescribedAngAcceleration(self, value):
        return _spinningBodyTwoDOFStateEffector.StateEffector_setPropName_prescribedAngAcceleration(self, value)

    def getPropName_prescribedAngAcceleration(self):
        return _spinningBodyTwoDOFStateEffector.StateEffector_getPropName_prescribedAngAcceleration(self)
    ...
    def addPrescribedMotionCouplingContributions(self, backSubContr):
        return _spinningBodyTwoDOFStateEffector.StateEffector_addPrescribedMotionCouplingContributions(self, backSubContr)
    ...
    def registerProperties(self, states):
        return _spinningBodyTwoDOFStateEffector.StateEffector_registerProperties(self, states)

    def addDynamicEffector(self, newDynamicEffector, segment):
        return _spinningBodyTwoDOFStateEffector.StateEffector_addDynamicEffector(self, newDynamicEffector, segment)
    ...
    def linkInPrescribedMotionProperties(self, properties):
        return _spinningBodyTwoDOFStateEffector.StateEffector_linkInPrescribedMotionProperties(self, properties)
...
class SpinningBodyTwoDOFStateEffector(StateEffector, SysModel):
    ...
    nameOfInertialPositionProperty1 = property(_spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_nameOfInertialPositionProperty1_get, _spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_nameOfInertialPositionProperty1_set)
    nameOfInertialVelocityProperty1 = property(_spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_nameOfInertialVelocityProperty1_get, _spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_nameOfInertialVelocityProperty1_set)
    nameOfInertialAttitudeProperty1 = property(_spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_nameOfInertialAttitudeProperty1_get, _spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_nameOfInertialAttitudeProperty1_set)
    nameOfInertialAngVelocityProperty1 = property(_spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_nameOfInertialAngVelocityProperty1_get, _spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_nameOfInertialAngVelocityProperty1_set)
    nameOfInertialPositionProperty2 = property(_spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_nameOfInertialPositionProperty2_get, _spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_nameOfInertialPositionProperty2_set)
    nameOfInertialVelocityProperty2 = property(_spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_nameOfInertialVelocityProperty2_get, _spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_nameOfInertialVelocityProperty2_set)
    nameOfInertialAttitudeProperty2 = property(_spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_nameOfInertialAttitudeProperty2_get, _spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_nameOfInertialAttitudeProperty2_set)
    nameOfInertialAngVelocityProperty2 = property(_spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_nameOfInertialAngVelocityProperty2_get, _spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_nameOfInertialAngVelocityProperty2_set)
    ...
    dynEffectors = property(_spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_dynEffectors_get, _spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_dynEffectors_set)
    ...
    def addDynamicEffector(self, newDynamicEffector, segment):
        return _spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_addDynamicEffector(self, newDynamicEffector, segment)

    def registerProperties(self, states):
        return _spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_registerProperties(self, states)

    def linkInPrescribedMotionProperties(self, states):
        return _spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_linkInPrescribedMotionProperties(self, states)
    ...
    def addPrescribedMotionCouplingContributions(self, backSubContr):
        return _spinningBodyTwoDOFStateEffector.SpinningBodyTwoDOFStateEffector_addPrescribedMotionCouplingContributions(self, backSubContr)
...
class SCStatesMsgPayload(object):
    ...
    TotalAccumDV_CN_N = property(_spinningBodyTwoDOFStateEffector.SCStatesMsgPayload_TotalAccumDV_CN_N_get, _spinningBodyTwoDOFStateEffector.SCStatesMsgPayload_TotalAccumDV_CN_N_set)
