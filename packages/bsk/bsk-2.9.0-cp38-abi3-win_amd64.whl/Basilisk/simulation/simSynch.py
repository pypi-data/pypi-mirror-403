...
def new_doubleArray(nelements):
    return _simSynch.new_doubleArray(nelements)

def delete_doubleArray(ary):
    return _simSynch.delete_doubleArray(ary)

def doubleArray_getitem(ary, index):
    return _simSynch.doubleArray_getitem(ary, index)

def doubleArray_setitem(ary, index, value):
    return _simSynch.doubleArray_setitem(ary, index, value)

def new_longArray(nelements):
    return _simSynch.new_longArray(nelements)

def delete_longArray(ary):
    return _simSynch.delete_longArray(ary)

def longArray_getitem(ary, index):
    return _simSynch.longArray_getitem(ary, index)

def longArray_setitem(ary, index, value):
    return _simSynch.longArray_setitem(ary, index, value)

def new_intArray(nelements):
    return _simSynch.new_intArray(nelements)

def delete_intArray(ary):
    return _simSynch.delete_intArray(ary)

def intArray_getitem(ary, index):
    return _simSynch.intArray_getitem(ary, index)

def intArray_setitem(ary, index, value):
    return _simSynch.intArray_setitem(ary, index, value)

def new_shortArray(nelements):
    return _simSynch.new_shortArray(nelements)

def delete_shortArray(ary):
    return _simSynch.delete_shortArray(ary)

def shortArray_getitem(ary, index):
    return _simSynch.shortArray_getitem(ary, index)

def shortArray_setitem(ary, index, value):
    return _simSynch.shortArray_setitem(ary, index, value)
...
class SwigPyIterator(object):
    ...
    __repr__ = _swig_repr
    __swig_destroy__ = _simSynch.delete_SwigPyIterator

    def value(self):
        return _simSynch.SwigPyIterator_value(self)

    def incr(self, n=1):
        return _simSynch.SwigPyIterator_incr(self, n)

    def decr(self, n=1):
        return _simSynch.SwigPyIterator_decr(self, n)

    def distance(self, x):
        return _simSynch.SwigPyIterator_distance(self, x)

    def equal(self, x):
        return _simSynch.SwigPyIterator_equal(self, x)

    def copy(self):
        return _simSynch.SwigPyIterator_copy(self)

    def next(self):
        return _simSynch.SwigPyIterator_next(self)

    def __next__(self):
        return _simSynch.SwigPyIterator___next__(self)

    def previous(self):
        return _simSynch.SwigPyIterator_previous(self)

    def advance(self, n):
        return _simSynch.SwigPyIterator_advance(self, n)

    def __eq__(self, x):
        return _simSynch.SwigPyIterator___eq__(self, x)

    def __ne__(self, x):
        return _simSynch.SwigPyIterator___ne__(self, x)

    def __iadd__(self, n):
        return _simSynch.SwigPyIterator___iadd__(self, n)

    def __isub__(self, n):
        return _simSynch.SwigPyIterator___isub__(self, n)

    def __add__(self, n):
        return _simSynch.SwigPyIterator___add__(self, n)

    def __sub__(self, *args):
        return _simSynch.SwigPyIterator___sub__(self, *args)
    def __iter__(self):
        return self

# Register SwigPyIterator in _simSynch:
_simSynch.SwigPyIterator_swigregister(SwigPyIterator)
MAX_LOGGING_LENGTH = _simSynch.MAX_LOGGING_LENGTH
BSK_DEBUG = _simSynch.BSK_DEBUG
BSK_INFORMATION = _simSynch.BSK_INFORMATION
BSK_WARNING = _simSynch.BSK_WARNING
BSK_ERROR = _simSynch.BSK_ERROR
BSK_SILENT = _simSynch.BSK_SILENT

def printDefaultLogLevel():
    return _simSynch.printDefaultLogLevel()

def setDefaultLogLevel(logLevel):
    return _simSynch.setDefaultLogLevel(logLevel)

def getDefaultLogLevel():
    return _simSynch.getDefaultLogLevel()
class BasiliskError(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _simSynch.BasiliskError_swiginit(self, _simSynch.new_BasiliskError(*args))
    __swig_destroy__ = _simSynch.delete_BasiliskError

# Register BasiliskError in _simSynch:
_simSynch.BasiliskError_swigregister(BasiliskError)
cvar = _simSynch.cvar
...
class BSKLogger(object):
    ...
    def __init__(self, *args):
        _simSynch.BSKLogger_swiginit(self, _simSynch.new_BSKLogger(*args))
    __swig_destroy__ = _simSynch.delete_BSKLogger

    def setLogLevel(self, logLevel):
        return _simSynch.BSKLogger_setLogLevel(self, logLevel)

    def printLogLevel(self):
        return _simSynch.BSKLogger_printLogLevel(self)

    def getLogLevel(self):
        return _simSynch.BSKLogger_getLogLevel(self)

    def bskLog(self, targetLevel, info):
        return _simSynch.BSKLogger_bskLog(self, targetLevel, info)
    logLevelMap = property(_simSynch.BSKLogger_logLevelMap_get, _simSynch.BSKLogger_logLevelMap_set)

# Register BSKLogger in _simSynch:
_simSynch.BSKLogger_swigregister(BSKLogger)

def _BSKLogger():
    return _simSynch._BSKLogger()

def _BSKLogger_d(arg1):
    return _simSynch._BSKLogger_d(arg1)

def _printLogLevel(arg1):
    return _simSynch._printLogLevel(arg1)

def _setLogLevel(arg1, arg2):
    return _simSynch._setLogLevel(arg1, arg2)

def _bskLog(arg1, arg2, arg3):
    return _simSynch._bskLog(arg1, arg2, arg3)
