...
class SwigPyIterator(object):
    ...
    __repr__ = _swig_repr
    __swig_destroy__ = _simpleInstrument.delete_SwigPyIterator

    def value(self):
        return _simpleInstrument.SwigPyIterator_value(self)

    def incr(self, n=1):
        return _simpleInstrument.SwigPyIterator_incr(self, n)

    def decr(self, n=1):
        return _simpleInstrument.SwigPyIterator_decr(self, n)

    def distance(self, x):
        return _simpleInstrument.SwigPyIterator_distance(self, x)

    def equal(self, x):
        return _simpleInstrument.SwigPyIterator_equal(self, x)

    def copy(self):
        return _simpleInstrument.SwigPyIterator_copy(self)

    def next(self):
        return _simpleInstrument.SwigPyIterator_next(self)

    def __next__(self):
        return _simpleInstrument.SwigPyIterator___next__(self)

    def previous(self):
        return _simpleInstrument.SwigPyIterator_previous(self)

    def advance(self, n):
        return _simpleInstrument.SwigPyIterator_advance(self, n)

    def __eq__(self, x):
        return _simpleInstrument.SwigPyIterator___eq__(self, x)

    def __ne__(self, x):
        return _simpleInstrument.SwigPyIterator___ne__(self, x)

    def __iadd__(self, n):
        return _simpleInstrument.SwigPyIterator___iadd__(self, n)

    def __isub__(self, n):
        return _simpleInstrument.SwigPyIterator___isub__(self, n)

    def __add__(self, n):
        return _simpleInstrument.SwigPyIterator___add__(self, n)

    def __sub__(self, *args):
        return _simpleInstrument.SwigPyIterator___sub__(self, *args)
    def __iter__(self):
        return self

# Register SwigPyIterator in _simpleInstrument:
_simpleInstrument.SwigPyIterator_swigregister(SwigPyIterator)
...
class BasiliskError(object):
    ...
    def __init__(self, *args):
        _simpleInstrument.BasiliskError_swiginit(self, _simpleInstrument.new_BasiliskError(*args))
    __swig_destroy__ = _simpleInstrument.delete_BasiliskError

# Register BasiliskError in _simpleInstrument:
_simpleInstrument.BasiliskError_swigregister(BasiliskError)
...
class SimpleInstrument(DataNodeBase):
    ...
    bskLogger = property(_simpleInstrument.SimpleInstrument_bskLogger_get, _simpleInstrument.SimpleInstrument_bskLogger_set)
