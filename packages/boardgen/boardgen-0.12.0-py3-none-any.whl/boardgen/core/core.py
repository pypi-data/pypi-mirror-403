...
class Core(CoreCache, CoreGetters):
    ...
    def __init__(self) -> None:
        ...
        self.set_base_dir(join(dirname(__file__), "..", "res"))
        self.shape_ctors = {
            ShapeType.RECT: Rect,
    ...
    def set_base_dir(self, dir_base: str):
        self.dir_base = dir_base
        self._dirs_boards.insert(0, join(self.dir_base, "boards"))
        self._dirs_shapes.insert(0, join(self.dir_base, "shapes"))
        self._dirs_templates.insert(0, join(self.dir_base, "templates"))
