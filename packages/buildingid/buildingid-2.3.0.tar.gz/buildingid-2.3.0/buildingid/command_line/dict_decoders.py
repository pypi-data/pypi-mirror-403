...
from buildingid.command_line.dict_pipe import DictDecoder
...
class LatLngDictDecoder(DictDecoder[DictDatum]):
    def __init__(
        ...
        fieldname_north_latitude: str | None = None,
        fieldname_south_latitude: str | None = None,
        fieldname_west_longitude: str | None = None,
        fieldname_east_longitude: str | None = None,
    ) -> None:
        super().__init__()
    ...
    def decode(self, row: dict[str, str]) -> DictDatum:
