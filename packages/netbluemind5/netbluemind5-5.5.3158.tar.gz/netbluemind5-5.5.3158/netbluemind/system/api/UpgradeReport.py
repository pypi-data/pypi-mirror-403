...
class __UpgradeReportSerDer__:
    ...
    def parseInternal(self, value, instance):
        ...
        instance.upgraders = serder.ListSerDer(
            __UpgradeReportUpgraderReportSerDer__()).parse(upgradersValue)
        return instance
    ...
    def encodeInternal(self, value, instance):
        ...
        upgradersValue = value.upgraders
        instance["upgraders"] = serder.ListSerDer(
            __UpgradeReportUpgraderReportSerDer__()).encode(upgradersValue)
        return instance
