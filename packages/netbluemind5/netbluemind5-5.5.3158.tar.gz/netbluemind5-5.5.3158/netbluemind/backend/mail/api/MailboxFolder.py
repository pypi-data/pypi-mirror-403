...
class __MailboxFolderSerDer__:
    ...
    def parseInternal(self, value, instance):
        ...
        virtualFolderValue = value['virtualFolder']
        instance.virtualFolder = serder.BOOLEAN.parse(virtualFolderValue)
        return instance
    ...
    def encodeInternal(self, value, instance):
        ...
        virtualFolderValue = value.virtualFolder
        instance["virtualFolder"] = serder.BOOLEAN.encode(virtualFolderValue)
        return instance
