...
class __SearchQuerySerDer__:
    ...
    def parseInternal(self, value, instance):
        ...
        trackScoresValue = value['trackScores']
        instance.trackScores = serder.BOOLEAN.parse(trackScoresValue)
        return instance
    ...
    def encodeInternal(self, value, instance):
        ...
        instance["logicalOperator"] = __SearchQueryLogicalOperatorSerDer__().encode(
            logicalOperatorValue)
        trackScoresValue = value.trackScores
        instance["trackScores"] = serder.BOOLEAN.encode(trackScoresValue)
        return instance
