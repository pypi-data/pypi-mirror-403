...
class ITodoList(BaseEndpoint):
    ...
    def multipleGetByRange(self, range):
        postUri = "/_mget_range"
        __data__ = None
        __encoded__ = None
        from netbluemind.todolist.api.VTodoRange import VTodoRange
        from netbluemind.todolist.api.VTodoRange import __VTodoRangeSerDer__
        __data__ = __VTodoRangeSerDer__().encode(range)
        __encoded__ = json.dumps(__data__)
        queryParams = {}
    ...
    def multipleGetWithOffset(self, from_, size):
        postUri = "/_mget_offset"
        __data__ = None
        __encoded__ = None
        queryParams = {'from': from_, 'size': size}
