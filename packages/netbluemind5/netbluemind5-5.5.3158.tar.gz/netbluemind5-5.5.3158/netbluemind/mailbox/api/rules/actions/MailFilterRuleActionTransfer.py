...
class MailFilterRuleActionTransfer (MailFilterRuleAction):
    def __init__(self):
        MailFilterRuleAction.__init__(self)
        self.emails = None
        self.asAttachment = None
        self.keepCopy = None
        pass


class __MailFilterRuleActionTransferSerDer__:
    def __init__(self):
        pass
    ...
    def parse(self, value):
        if (value == None):
            return None
        instance = MailFilterRuleActionTransfer()
    ...
    def parseInternal(self, value, instance):
        ...
        asAttachmentValue = value['asAttachment']
        instance.asAttachment = serder.BOOLEAN.parse(asAttachmentValue)
    ...
    def encodeInternal(self, value, instance):
        ...
        asAttachmentValue = value.asAttachment
        instance["asAttachment"] = serder.BOOLEAN.encode(asAttachmentValue)
        keepCopyValue = value.keepCopy
