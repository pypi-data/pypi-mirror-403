...
class MailFilterRuleActionAddHeaders (MailFilterRuleAction):
    def __init__(self):
...
class __MailFilterRuleActionAddHeadersSerDer__:
    def __init__(self):
        pass
    ...
    def parse(self, value):
        if (value == None):
            return None
        instance = MailFilterRuleActionAddHeaders()
    ...
    def parseInternal(self, value, instance):
        ...
        instance.headers = serder.MapSerDer(serder.STRING).parse(headersValue)
        return instance
    ...
    def encodeInternal(self, value, instance):
        ...
        headersValue = value.headers
        instance["headers"] = serder.MapSerDer(
            serder.STRING).encode(headersValue)
        return instance
