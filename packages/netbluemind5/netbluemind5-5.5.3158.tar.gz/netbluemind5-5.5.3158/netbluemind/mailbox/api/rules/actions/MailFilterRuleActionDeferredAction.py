...
class MailFilterRuleActionDeferredAction (MailFilterRuleAction):
    def __init__(self):
        MailFilterRuleAction.__init__(self)
        pass


class __MailFilterRuleActionDeferredActionSerDer__:
    def __init__(self):
        pass
    ...
    def parse(self, value):
        if (value == None):
            return None
        instance = MailFilterRuleActionDeferredAction()
