...
class TestBaseAgentInitialization:
    ...
    def test_initialization_basic(self):
        ...
        from easy_sgr.sgr_agent_core.agent_definition import ExecutionConfig
...
class TestBaseAgentLogging:
    ...
    def test_save_agent_log_with_enum_serializes_correctly(self, tmp_path):
        ...
        with patch("easy_sgr.sgr_agent_core.agent_config.GlobalConfig", return_value=mock_config):
