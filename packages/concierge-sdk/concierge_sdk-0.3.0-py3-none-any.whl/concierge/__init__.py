...
class Concierge:
    ...
    def __init__(self, server, *, config=Config(), assets_dir: str | None = None, **fastmcp_kwargs):
        if isinstance(server, FastMCP):
            ...
            self._server = FastMCP(server, **fastmcp_kwargs)  # All kwargs flow through
        self._config = config
        ...
        self._default_stage: str | None = None        # First stage (for new sessions)
    ...
    def _get_session_stage(self, session_id: str | None) -> str:
    ...
    def _set_session_stage(self, session_id: str | None, stage: str) -> None:
