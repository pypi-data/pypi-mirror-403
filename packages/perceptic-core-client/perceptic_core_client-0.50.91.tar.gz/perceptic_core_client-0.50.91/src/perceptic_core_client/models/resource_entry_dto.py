...
class ResourceEntryDto(BaseModel):
    """
    ResourceEntryDto
    """ # noqa: E501
    resource_id: Optional[StrictStr] = Field(default=None, alias="resourceId")
    metadata: Optional[ResourceMetadataDto] = None
    __properties: ClassVar[List[str]] = ["resourceId", "metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "metadata": ResourceMetadataDto.from_dict(obj["metadata"]) if obj.get("metadata") is not None else None
        })
        return _obj
