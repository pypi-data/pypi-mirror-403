...
class CreateFileSystemResponse(BaseModel):
    ...
    """ # noqa: E501
    file_system_rid: Optional[StrictStr] = Field(default=None, alias="fileSystemRid")
    __properties: ClassVar[List[str]] = ["fileSystemRid"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fileSystemRid": obj.get("fileSystemRid")
        })
        return _obj
