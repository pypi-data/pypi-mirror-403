...
class CreateIndexingTaskResponse(BaseModel):
    ...
    task: Optional[IndexingTaskDto] = None
    created: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["taskRid", "task", "created"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "task": IndexingTaskDto.from_dict(obj["task"]) if obj.get("task") is not None else None,
