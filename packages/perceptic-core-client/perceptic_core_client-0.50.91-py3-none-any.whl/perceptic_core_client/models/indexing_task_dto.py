...
class IndexingTaskDto(BaseModel):
    """
    IndexingTaskDto
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["taskRid", "indexerRid", "folderUri", "namespace", "targetMinimumVersion", "settings", "createdAt", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "status": IndexingTaskStatus.from_dict(obj["status"]) if obj.get("status") is not None else None
        })
        return _obj
