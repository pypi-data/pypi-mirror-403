...
class S3ConnectionSettingsApiDto(BaseModel):
    """
    S3ConnectionSettingsApiDto
    """ # noqa: E501
    region: Annotated[str, Field(strict=True)]
    access_key: Annotated[str, Field(strict=True)] = Field(alias="accessKey")
    secret_key: Annotated[str, Field(strict=True)] = Field(alias="secretKey")
    url: Annotated[str, Field(strict=True)]
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["region", "accessKey", "secretKey", "url", "type"]
