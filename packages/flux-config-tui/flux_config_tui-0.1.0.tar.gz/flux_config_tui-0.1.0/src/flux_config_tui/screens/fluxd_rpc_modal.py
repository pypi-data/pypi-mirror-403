...
class FluxdRpcModal(ModalScreen[None]):
    """Display FluxD RPC data (getfluxnodestatus)."""
    ...
    def __init__(self) -> None:
        """Initialize FluxD RPC modal screen."""
        super().__init__()
    ...
    def compose(self) -> ComposeResult:
        ...
        container = Container(id="fluxd_rpc_container")
        container.border_title = "Fluxd Status"
    ...
    async def on_mount(self) -> None:
        ...
        try:
            ...
            logger.error(f"Error fetching FluxD RPC data: {e}", exc_info=True)
            self.error_message = "RPC offline"
