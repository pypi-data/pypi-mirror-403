...
class EventFightPlanYYYYMMDD(Event, NormalFightPlan):
    def __init__(
        self,
        timer: Timer,
        plan_path,
...
class EventFightInfoYYYYMMDD(Event, NormalFightInfo):
    def __init__(self, timer: Timer, chapter_id, map_id, event='YYYYMMDD') -> None:
