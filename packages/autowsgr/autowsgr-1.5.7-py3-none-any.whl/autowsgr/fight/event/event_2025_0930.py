...
class EventFightPlan20250930(Event, NormalFightPlan):
    def __init__(
        self,
        timer: Timer,
        plan_path,
    ...
    def _load_fight_info(self):
        self.info = EventFightInfo20250930(self.timer, self.config.chapter, self.config.map)
...
class EventFightInfo20250930(Event, NormalFightInfo):
    def __init__(self, timer: Timer, chapter_id, map_id, event='20250930') -> None:
