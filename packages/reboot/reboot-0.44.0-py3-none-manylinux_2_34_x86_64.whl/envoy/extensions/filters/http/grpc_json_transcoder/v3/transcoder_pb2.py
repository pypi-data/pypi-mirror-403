...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_GRPCJSONTRANSCODER_PRINTOPTIONS']._loaded_options = None
  _globals['_GRPCJSONTRANSCODER_PRINTOPTIONS']._serialized_options = b'\232\305\210\036H\nFenvoy.config.filter.http.transcoder.v2.GrpcJsonTranscoder.PrintOptions'
  _globals['_GRPCJSONTRANSCODER'].oneofs_by_name['descriptor_set']._loaded_options = None
  _globals['_GRPCJSONTRANSCODER'].oneofs_by_name['descriptor_set']._serialized_options = b'\370B\001'
  _globals['_GRPCJSONTRANSCODER'].fields_by_name['url_unescape_spec']._loaded_options = None
  _globals['_GRPCJSONTRANSCODER'].fields_by_name['url_unescape_spec']._serialized_options = b'\372B\005\202\001\002\020\001'
  _globals['_GRPCJSONTRANSCODER'].fields_by_name['max_request_body_size']._loaded_options = None
  _globals['_GRPCJSONTRANSCODER'].fields_by_name['max_request_body_size']._serialized_options = b'\372B\004*\002 \000'
  _globals['_GRPCJSONTRANSCODER'].fields_by_name['max_response_body_size']._loaded_options = None
  _globals['_GRPCJSONTRANSCODER'].fields_by_name['max_response_body_size']._serialized_options = b'\372B\004*\002 \000'
  _globals['_GRPCJSONTRANSCODER']._loaded_options = None
  _globals['_GRPCJSONTRANSCODER']._serialized_options = b'\232\305\210\036;\n9envoy.config.filter.http.transcoder.v2.GrpcJsonTranscoder'
  _globals['_GRPCJSONTRANSCODER']._serialized_start=253
  _globals['_GRPCJSONTRANSCODER']._serialized_end=1755
  _globals['_GRPCJSONTRANSCODER_PRINTOPTIONS']._serialized_start=1149
  _globals['_GRPCJSONTRANSCODER_PRINTOPTIONS']._serialized_end=1411
  _globals['_GRPCJSONTRANSCODER_REQUESTVALIDATIONOPTIONS']._serialized_start=1414
  _globals['_GRPCJSONTRANSCODER_REQUESTVALIDATIONOPTIONS']._serialized_end=1558
  _globals['_GRPCJSONTRANSCODER_URLUNESCAPESPEC']._serialized_start=1560
  _globals['_GRPCJSONTRANSCODER_URLUNESCAPESPEC']._serialized_end=1666
