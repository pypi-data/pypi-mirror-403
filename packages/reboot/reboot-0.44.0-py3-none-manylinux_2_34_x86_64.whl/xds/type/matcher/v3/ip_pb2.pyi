...
class IPMatcher(google.protobuf.message.Message):
    ...
    class IPRangeMatcher(google.protobuf.message.Message):
        ...
        def __init__(
            self,
            *,
            ranges: collections.abc.Iterable[xds.core.v3.cidr_pb2.CidrRange] | None = ...,
        ...
        def ClearField(self, field_name: typing.Literal["exclusive", b"exclusive", "on_match", b"on_match", "ranges", b"ranges"]) -> None: ...
    ...
    def __init__(
        self,
        *,
        range_matchers: collections.abc.Iterable[global___IPMatcher.IPRangeMatcher] | None = ...,
    ) -> None: ...
