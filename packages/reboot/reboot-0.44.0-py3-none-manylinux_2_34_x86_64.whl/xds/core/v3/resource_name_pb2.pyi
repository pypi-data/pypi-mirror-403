...
class ResourceName(google.protobuf.message.Message):
    ...
    def __init__(
        ...
        *,
        ...
        authority: builtins.str = ...,
        resource_type: builtins.str = ...,
        context: xds.core.v3.context_params_pb2.ContextParams | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["context", b"context"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["authority", b"authority", "context", b"context", "id", b"id", "resource_type", b"resource_type"]) -> None: ...
