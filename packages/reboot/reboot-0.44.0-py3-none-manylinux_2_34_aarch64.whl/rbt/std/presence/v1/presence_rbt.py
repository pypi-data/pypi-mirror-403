...
def PresenceSubscribeRequestFromInputFields(
    subscriber_id: IMPORT_typing.Optional[str] | Unset,
):
    assert Presence.SubscribeRequest is not None

    if not isinstance(subscriber_id, Unset) and subscriber_id is not None and not isinstance(
        subscriber_id,
        str,
    ):
        raise TypeError(
    ...
    if not isinstance(subscriber_id, Unset):
        __args__['subscriber_id'] = subscriber_id

    return Presence.SubscribeRequest(
        **__args__,
    )
...
def PresenceListRequestFromInputFields(
):
    assert Presence.ListRequest is not None
...
def PresenceWatchRequestFromInputFields(
    subscriber_id: IMPORT_typing.Optional[str] | Unset,
):
    assert Presence.WatchRequest is not None
...
class PresenceServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):
        ...
        *,
        ...
        if 'Subscribe' == task.method_name:
            if only_validate:
                ...
                return (rbt.std.presence.v1.presence_pb2.SubscribeResponse(), None)
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return (rbt.std.presence.v1.presence_pb2.ListResponse(), None)
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return (rbt.std.presence.v1.presence_pb2.WatchResponse(), None)
    ...
    async def __Subscribe(
        ...
        *,
        ...
        try:
            typed_state: Presence.State = PresenceFromProto(state, is_initial_state=(context.state_id in states_being_constructed))
...
class PresenceReaderStub(_PresenceStub):
    ...
    async def List(
        ...
        *,
        ...
        proto_request = PresenceListRequestToProto(
            request,
        )
...
class PresenceWriterStub(_PresenceStub):
    ...
    async def Subscribe(
        ...
        *,
        ...
        proto_request = PresenceSubscribeRequestToProto(
            request,
        )
...
class PresenceTasksStub(_PresenceStub):
    ...
    async def Watch(
        ...
        *,
        ...
        idempotency_key: IMPORT_typing.Optional[IMPORT_uuid.UUID]
        proto_request = PresenceWatchRequestToProto(
            request,
        )
    ...
    async def Subscribe(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            request=PresenceSubscribeRequestToProto(
                request,
            ),
    ...
    async def Watch(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            state_ref=self._state_ref,
            method_name='Watch',
            request=PresenceWatchRequestToProto(
                request,
            ),
            schedule=(IMPORT_reboot_time_DateTimeWithTimeZone.now() + schedule) if isinstance(
                schedule, IMPORT_datetime_timedelta
...
class PresenceBaseServicer(IMPORT_reboot_aio_servicers.Servicer):
    ...
    __servicer__: IMPORT_contextvars.ContextVar[IMPORT_typing.Optional[PresenceBaseServicer]] = IMPORT_contextvars.ContextVar(
        ...
        class _Idempotently:
            ...
            async def _read(
                ...
                with context.idempotently(
                    ...
                    return PresenceFromProto(protobuf_state)
                    ...
                    with servicer._middleware.use_context(
                        ...
                        async with servicer._middleware._state_manager.transactionally(
                            ...
                            async with servicer._middleware._state_manager.writer(
                                ...
                                typed_state = PresenceFromProto(protobuf_state)

                                result = await writer(state=typed_state)

                                PresenceToProto(typed_state, protobuf_state)
...
class PresenceSingletonServicer(PresenceBaseServicer):
    ...
    async def _Subscribe(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return PresenceSubscribeResponseToProto(
    ...
    async def _Watch(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return PresenceWatchResponseToProto(
                await self.Watch(
                    context,
                    typed_request,
                )
    ...
    async def _List(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                return PresenceListResponseToProto(
                    await instance.List(
                        context,
                        typed_request,
                    )
...
class Presence:
    ...
    class WeakReference(IMPORT_typing.Generic[Presence_ScheduleTypeVar]):
        ...
        class _Reactively:
            ...
            async def List( # type: ignore[misc]
                ...
                if isinstance(__request_or_options__, Presence.ListRequest):
                    ...
                    __request__ = PresenceListRequestFromInputFields(
                    )
                ...
                while True:
                    ...
                    try:
                        ...
                        if error.code() == IMPORT_grpc.StatusCode.ABORTED:
                            ...
                            if status is not None:
                                raise Presence.ListAborted.from_status(
                                    status
                                ) from None
                            raise Presence.ListAborted.from_grpc_aio_rpc_error(
                                error
                            ) from None
        ...
        class _Idempotently(IMPORT_typing.Generic[Presence_IdempotentlyScheduleTypeVar]):
            ...
            async def Subscribe(
                ...
                __request_or_options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
                *,
                subscriber_id: IMPORT_typing.Optional[str] | Unset = UNSET,
            ) -> Presence.SubscribeResponse:
                ...
            ...
            async def Subscribe( # type: ignore[misc]
                ...
                *,
                ...
                if isinstance(__request_or_options__, Presence.SubscribeRequest):
                    ...
                    __request__ = PresenceSubscribeRequestFromInputFields(
                ...
                *,
                ...
                if isinstance(__request_or_options__, Presence.WatchRequest):
                    ...
                    return await (
                        await __this__.spawn().Watch(
                            __context__,
                            PresenceWatchRequestFromInputFields(
                                subscriber_id=subscriber_id,
                            ),
                            __options__,
                        )
            ...
            async def Watch( # type: ignore[misc]
                ...
                *,
                ...
                if isinstance(__request_or_options__, Presence.WatchRequest):
                    ...
                    __request__ = PresenceWatchRequestFromInputFields(
                        subscriber_id=subscriber_id,
                    )
                ...
                return await IMPORT_asyncio.gather(
                    *[
                        Presence.ref(
                            ...
                            __context__,
                            PresenceSubscribeRequestFromInputFields(
                                subscriber_id=subscriber_id,
                            ),
                            __options__,
                        ) for id in __this__._ids
                ...
                return await IMPORT_asyncio.gather(
                    *[
                        Presence.ref(
                            ...
                            __context__,
                            PresenceListRequestFromInputFields(
                            ),
                            __options__,
                        ) for id in __this__._ids
                    ]
    ...
    def ref(
        ...
        *,
        bearer_token: IMPORT_typing.Optional[str] = None,
    ) -> Presence.WeakReference[Presence.WeakReference._Schedule] | Presence.WeakReference[Presence.WeakReference._WriterSchedule]:
        # We support calling `Presence.ref()` with
        ...
        if state_id is None:
            ...
            servicer = PresenceBaseServicer.__servicer__.get()
