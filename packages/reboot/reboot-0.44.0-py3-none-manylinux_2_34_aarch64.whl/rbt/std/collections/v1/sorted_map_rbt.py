...
def SortedMapInsertRequestFromInputFields(
    entries: IMPORT_typing.Optional[dict[str, bytes]] | Unset,
):
    assert SortedMap.InsertRequest is not None

    if not isinstance(entries, Unset) and entries is not None and not isinstance(
        entries,
        dict,
    ):
        raise TypeError(
    ...
    if not isinstance(entries, Unset):
        __args__['entries'] = entries

    return SortedMap.InsertRequest(
        **__args__,
    )
...
def SortedMapRemoveRequestFromInputFields(
    keys: IMPORT_typing.Optional[IMPORT_typing.Iterable[str]] | Unset,
):
    assert SortedMap.RemoveRequest is not None
    ...
    return SortedMap.RemoveRequest(
        **__args__,
    )
...
def SortedMapGetRequestFromInputFields(
    key: IMPORT_typing.Optional[str] | Unset,
):
    assert SortedMap.GetRequest is not None
...
def SortedMapRangeRequestFromInputFields(
    start_key: IMPORT_typing.Optional[str] | Unset,
    end_key: IMPORT_typing.Optional[str] | Unset,
    limit: IMPORT_typing.Optional[int] | Unset,
):
    assert SortedMap.RangeRequest is not None
    ...
    if not isinstance(end_key, Unset) and end_key is not None and not isinstance(
        end_key,
        str,
    ):
        raise TypeError(
    ...
    if not isinstance(end_key, Unset):
        __args__['end_key'] = end_key
    if not isinstance(limit, Unset):
        __args__['limit'] = limit

    return SortedMap.RangeRequest(
        **__args__,
    )
...
def SortedMapReverseRangeRequestFromInputFields(
    start_key: IMPORT_typing.Optional[str] | Unset,
    end_key: IMPORT_typing.Optional[str] | Unset,
    limit: IMPORT_typing.Optional[int] | Unset,
):
    assert SortedMap.ReverseRangeRequest is not None
    ...
    return SortedMap.ReverseRangeRequest(
        **__args__,
    )
...
class SortedMapServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):
        ...
        *,
        ...
        if 'Insert' == task.method_name:
            if only_validate:
                ...
                return (rbt.std.collections.v1.sorted_map_pb2.InsertResponse(), None)
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return (rbt.std.collections.v1.sorted_map_pb2.RemoveResponse(), None)
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return (rbt.std.collections.v1.sorted_map_pb2.GetResponse(), None)
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return (rbt.std.collections.v1.sorted_map_pb2.RangeResponse(), None)
            ...
            if only_validate:
                # TODO(benh): validate 'task.request' is correct type.
                return (rbt.std.collections.v1.sorted_map_pb2.ReverseRangeResponse(), None)
    ...
    async def __Insert(
        ...
        *,
        ...
        try:
            typed_state: SortedMap.State = SortedMapFromProto(state, is_initial_state=(context.state_id in states_being_constructed))
...
class SortedMapReaderStub(_SortedMapStub):
    ...
    async def Get(
        ...
        *,
        ...
        proto_request = SortedMapGetRequestToProto(
            request,
        )
    ...
    async def Range(
        ...
        *,
        ...
        proto_request = SortedMapRangeRequestToProto(
            request,
        )
    ...
    async def ReverseRange(
        ...
        *,
        ...
        proto_request = SortedMapReverseRangeRequestToProto(
            request,
        )
...
class SortedMapWriterStub(_SortedMapStub):
    ...
    async def Insert(
        ...
        *,
        ...
        proto_request = SortedMapInsertRequestToProto(
            request,
        )
    ...
    async def Remove(
        ...
        *,
        ...
        proto_request = SortedMapRemoveRequestToProto(
            request,
        )
        with self._idempotency_manager.idempotently(
            state_type_name=IMPORT_reboot_aio_types.StateTypeName('rbt.std.collections.v1.SortedMap'),
    ...
    async def ReverseRange(
        ...
        *,
        ...
        async with self._call(
            ...
            'ReverseRange',
            self._rbt_std_collections_v1_sortedmapmethods_stub.ReverseRange,
            SortedMapReverseRangeRequestToProto(
                request,
            ),
            unary=True,
            reader=True,
    ...
    async def Insert(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            method_name='Insert',
            request=SortedMapInsertRequestToProto(
                request,
            ),
    ...
    async def Remove(
        ...
        *,
        ...
        task = IMPORT_reboot_aio_tasks.TaskEffect(
            ...
            state_ref=self._state_ref,
            method_name='Remove',
            request=SortedMapRemoveRequestToProto(
                request,
            ),
            schedule=(IMPORT_reboot_time_DateTimeWithTimeZone.now() + schedule) if isinstance(
                schedule, IMPORT_datetime_timedelta
...
class SortedMapBaseServicer(IMPORT_reboot_aio_servicers.Servicer):
    ...
    __servicer__: IMPORT_contextvars.ContextVar[IMPORT_typing.Optional[SortedMapBaseServicer]] = IMPORT_contextvars.ContextVar(
        ...
        class _Idempotently:
            ...
            async def _read(
                ...
                with context.idempotently(
                    ...
                    return SortedMapFromProto(protobuf_state)
                    ...
                    with servicer._middleware.use_context(
                        ...
                        async with servicer._middleware._state_manager.transactionally(
                            ...
                            async with servicer._middleware._state_manager.writer(
                                ...
                                typed_state = SortedMapFromProto(protobuf_state)

                                result = await writer(state=typed_state)

                                SortedMapToProto(typed_state, protobuf_state)
...
class SortedMapSingletonServicer(SortedMapBaseServicer):
    ...
    async def _Insert(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return SortedMapInsertResponseToProto(
                await self.Insert(
                    context,
                    state,
                    typed_request
    ...
    async def _Remove(
        ...
        with IMPORT_reboot_aio_tracing.span(
            ...
            return SortedMapRemoveResponseToProto(
                await self.Remove(
                    context,
                    state,
                    typed_request
    ...
    async def _Get(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                return SortedMapGetResponseToProto(
                    await instance.Get(
                        context,
                        typed_request,
                    )
    ...
    async def _Range(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                return SortedMapRangeResponseToProto(
    ...
    async def _ReverseRange(
        ...
        try:
            ...
            with IMPORT_reboot_aio_tracing.span(
                ...
                return SortedMapReverseRangeResponseToProto(
...
class SortedMap:
    ...
    class WeakReference(IMPORT_typing.Generic[SortedMap_ScheduleTypeVar]):
        ...
        class _Reactively:
            ...
            async def Get( # type: ignore[misc]
                ...
                *,
                ...
                if isinstance(__request_or_options__, SortedMap.GetRequest):
                    ...
                    __request__ = SortedMapGetRequestFromInputFields(
                        key=key,
                    )
                ...
                while True:
                    ...
                    try:
                        ...
                        if error.code() == IMPORT_grpc.StatusCode.ABORTED:
                            ...
                            if status is not None:
                                raise SortedMap.GetAborted.from_status(
                                    status
                                ) from None
                            raise SortedMap.GetAborted.from_grpc_aio_rpc_error(
                                error
                            ) from None
            ...
            async def Range(
                ...
                *,
                ...
                end_key: IMPORT_typing.Optional[str] | Unset = UNSET,
            ...
            async def Range( # type: ignore[misc]
                ...
                *,
                ...
                if isinstance(__request_or_options__, SortedMap.RangeRequest):
                    ...
                    __request__ = SortedMapRangeRequestFromInputFields(
                        start_key=start_key,
                        end_key=end_key,
                        limit=limit,
                    )
                ...
                while True:
                    ...
                    try:
                        ...
                        if error.code() == IMPORT_grpc.StatusCode.ABORTED:
                            ...
                            status = await IMPORT_rpc_status_async.from_call(__call__)
                            if status is not None:
                                raise SortedMap.RangeAborted.from_status(
                                    status
                                ) from None
                            raise SortedMap.RangeAborted.from_grpc_aio_rpc_error(
                                error
                            ) from None
            ...
            async def ReverseRange( # type: ignore[misc]
                ...
                *,
                ...
                if isinstance(__request_or_options__, SortedMap.ReverseRangeRequest):
                    ...
                    __request__ = SortedMapReverseRangeRequestFromInputFields(
                        start_key=start_key,
                        end_key=end_key,
                        limit=limit,
                    )
                ...
                while True:
                    ...
                    try:
                        ...
                        if error.code() == IMPORT_grpc.StatusCode.ABORTED:
                            ...
                            status = await IMPORT_rpc_status_async.from_call(__call__)
                            if status is not None:
                                raise SortedMap.ReverseRangeAborted.from_status(
                                    status
                                ) from None
                            raise SortedMap.ReverseRangeAborted.from_grpc_aio_rpc_error(
                                error
                            ) from None
        ...
        class _Idempotently(IMPORT_typing.Generic[SortedMap_IdempotentlyScheduleTypeVar]):
            ...
            async def Insert(
                ...
                __request_or_options__: IMPORT_typing.Optional[IMPORT_reboot_aio_call.Options] = None,
                *,
                entries: IMPORT_typing.Optional[dict[str, bytes]] | Unset = UNSET,
            ) -> SortedMap.InsertResponse:
                ...
            ...
            async def Insert( # type: ignore[misc]
                ...
                *,
                ...
                if isinstance(__request_or_options__, SortedMap.InsertRequest):
                    ...
                    __request__ = SortedMapInsertRequestFromInputFields(
                        entries=entries,
                    )
                IMPORT_reboot_aio_types.assert_type(__options__, [IMPORT_reboot_aio_call.Options])
                if __options__.idempotency is not None:
            ...
            async def Remove( # type: ignore[misc]
                ...
                *,
                ...
                if isinstance(__request_or_options__, SortedMap.RemoveRequest):
                    ...
                    __request__ = SortedMapRemoveRequestFromInputFields(
                        keys=keys,
                    )
                IMPORT_reboot_aio_types.assert_type(__options__, [IMPORT_reboot_aio_call.Options])
                if __options__.idempotency is not None:
                ...
                return await IMPORT_asyncio.gather(
                    *[
                        SortedMap.ref(
                            ...
                            __context__,
                            SortedMapInsertRequestFromInputFields(
                                entries=entries,
                            ),
                            __options__,
                        ) for id in __this__._ids
                ...
                return await IMPORT_asyncio.gather(
                    *[
                        SortedMap.ref(
                            ...
                            __context__,
                            SortedMapRemoveRequestFromInputFields(
                                keys=keys,
                            ),
                            __options__,
                        ) for id in __this__._ids
                ...
                return await IMPORT_asyncio.gather(
                    *[
                        SortedMap.ref(
                            ...
                            __context__,
                            SortedMapGetRequestFromInputFields(
                                key=key,
                            ),
                            __options__,
                        ) for id in __this__._ids
                ...
                return await IMPORT_asyncio.gather(
                    *[
                        SortedMap.ref(
                            ...
                            __context__,
                            SortedMapRangeRequestFromInputFields(
                                start_key=start_key,
                                end_key=end_key,
                                limit=limit,
                            ),
                ...
                return await IMPORT_asyncio.gather(
                    *[
                        SortedMap.ref(
                            ...
                            __context__,
                            SortedMapReverseRangeRequestFromInputFields(
                                start_key=start_key,
                                end_key=end_key,
                                limit=limit,
                            ),
    ...
    def ref(
        ...
        *,
        bearer_token: IMPORT_typing.Optional[str] = None,
    ) -> SortedMap.WeakReference[SortedMap.WeakReference._Schedule] | SortedMap.WeakReference[SortedMap.WeakReference._WriterSchedule]:
        # We support calling `SortedMap.ref()` with
        ...
        if state_id is None:
            ...
            servicer = SortedMapBaseServicer.__servicer__.get()
