...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_OUTLIERDETECTION'].fields_by_name['max_ejection_time']._loaded_options = None
  _globals['_OUTLIERDETECTION'].fields_by_name['max_ejection_time']._serialized_options = b'\372B\005\252\001\002*\000'
  _globals['_OUTLIERDETECTION']._loaded_options = None
  _globals['_OUTLIERDETECTION']._serialized_options = b'\232\305\210\036\'\n%envoy.api.v2.cluster.OutlierDetection'
  _globals['_OUTLIERDETECTION']._serialized_start=232
  _globals['_OUTLIERDETECTION']._serialized_end=1841
