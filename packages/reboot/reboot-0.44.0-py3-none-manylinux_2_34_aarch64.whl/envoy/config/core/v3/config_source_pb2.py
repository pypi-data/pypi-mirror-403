...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_APIVERSION'].values_by_name["AUTO"]._serialized_options = b'\010\001\212\364\233\263\005\0033.0'
  _globals['_APIVERSION'].values_by_name["V2"]._loaded_options = None
  _globals['_APIVERSION'].values_by_name["V2"]._serialized_options = b'\010\001\212\364\233\263\005\0033.0'
  _globals['_APICONFIGSOURCE_APITYPE'].values_by_name["DEPRECATED_AND_UNAVAILABLE_DO_NOT_USE"]._loaded_options = None
  _globals['_APICONFIGSOURCE_APITYPE'].values_by_name["DEPRECATED_AND_UNAVAILABLE_DO_NOT_USE"]._serialized_options = b'\010\001\250\367\264\213\002\001'
  ...
  _globals['_APICONFIGSOURCE']._loaded_options = None
  _globals['_APICONFIGSOURCE']._serialized_options = b'\232\305\210\036#\n!envoy.api.v2.core.ApiConfigSource'
  _globals['_AGGREGATEDCONFIGSOURCE']._loaded_options = None
  _globals['_AGGREGATEDCONFIGSOURCE']._serialized_options = b'\232\305\210\036*\n(envoy.api.v2.core.AggregatedConfigSource'
  ...
  _globals['_SELFCONFIGSOURCE']._loaded_options = None
  _globals['_SELFCONFIGSOURCE']._serialized_options = b'\232\305\210\036$\n\"envoy.api.v2.core.SelfConfigSource'
  ...
  _globals['_RATELIMITSETTINGS']._loaded_options = None
  _globals['_RATELIMITSETTINGS']._serialized_options = b'\232\305\210\036%\n#envoy.api.v2.core.RateLimitSettings'
  _globals['_PATHCONFIGSOURCE'].fields_by_name['path']._loaded_options = None
  _globals['_PATHCONFIGSOURCE'].fields_by_name['path']._serialized_options = b'\372B\004r\002\020\001'
  ...
  _globals['_CONFIGSOURCE'].fields_by_name['path']._loaded_options = None
  _globals['_CONFIGSOURCE'].fields_by_name['path']._serialized_options = b'\030\001\222\307\206\330\004\0033.0'
  ...
  _globals['_CONFIGSOURCE']._loaded_options = None
  _globals['_CONFIGSOURCE']._serialized_options = b'\232\305\210\036 \n\036envoy.api.v2.core.ConfigSource'
  _globals['_EXTENSIONCONFIGSOURCE'].fields_by_name['config_source']._loaded_options = None
  _globals['_EXTENSIONCONFIGSOURCE'].fields_by_name['config_source']._serialized_options = b'\372B\005\242\001\002\010\001'
  _globals['_EXTENSIONCONFIGSOURCE'].fields_by_name['type_urls']._loaded_options = None
  _globals['_EXTENSIONCONFIGSOURCE'].fields_by_name['type_urls']._serialized_options = b'\372B\005\222\001\002\010\001'
  _globals['_APIVERSION']._serialized_start=2431
  _globals['_APIVERSION']._serialized_end=2495
