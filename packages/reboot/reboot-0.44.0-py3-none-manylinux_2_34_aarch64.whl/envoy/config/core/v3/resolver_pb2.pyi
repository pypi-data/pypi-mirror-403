...
class DnsResolverOptions(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["no_default_search_domain", b"no_default_search_domain", "use_tcp_for_dns_lookups", b"use_tcp_for_dns_lookups"]) -> None: ...
...
class DnsResolutionConfig(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["dns_resolver_options", b"dns_resolver_options"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["dns_resolver_options", b"dns_resolver_options", "resolvers", b"resolvers"]) -> None: ...
