...
class UdpSocketConfig(google.protobuf.message.Message):
    ...
    def __init__(
        self,
        *,
        max_rx_datagram_size: google.protobuf.wrappers_pb2.UInt64Value | None = ...,
        prefer_gro: google.protobuf.wrappers_pb2.BoolValue | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing.Literal["max_rx_datagram_size", b"max_rx_datagram_size", "prefer_gro", b"prefer_gro"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["max_rx_datagram_size", b"max_rx_datagram_size", "prefer_gro", b"prefer_gro"]) -> None: ...
