...
class SubstitutionFormatString(google.protobuf.message.Message):
    ...
    * for ``json_format`` the keys with null values are omitted in the output structure.
    ...
    def HasField(self, field_name: typing.Literal["format", b"format", "json_format", b"json_format", "text_format", b"text_format", "text_format_source", b"text_format_source"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["content_type", b"content_type", "format", b"format", "formatters", b"formatters", "json_format", b"json_format", "omit_empty_values", b"omit_empty_values", "text_format", b"text_format", "text_format_source", b"text_format_source"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["format", b"format"]) -> typing.Literal["text_format", "json_format", "text_format_source"] | None: ...
