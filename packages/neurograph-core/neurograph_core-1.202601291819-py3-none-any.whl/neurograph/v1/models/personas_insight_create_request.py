...
class PersonasInsightCreateRequest(BaseModel):
    ...
    persona_instance_id: Optional[StrictStr] = Field(default=None, description="Deprecated: use persona_seed_id")
    persona_seed_id: Optional[StrictStr] = Field(default=None, description="Preferred: the stable persona seed ID")
    __properties: ClassVar[List[str]] = ["data", "key", "persona_instance_id", "persona_seed_id"]
