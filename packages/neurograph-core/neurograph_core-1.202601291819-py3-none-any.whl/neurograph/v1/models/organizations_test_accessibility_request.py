...
class OrganizationsTestAccessibilityRequest(BaseModel):
    """
    ...
    level: Optional[StrictStr] = Field(default=None, description="\"AA\" or \"AAA\"")
    primary_color: Optional[StrictStr] = None
    secondary_color: Optional[StrictStr] = None
    tertiary_color: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["color1", "color2", "color3", "color4", "color5", "level", "primary_color", "secondary_color", "tertiary_color"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationsTestAccessibilityRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationsTestAccessibilityRequest from a dict"""
        if obj is None:
            return None
