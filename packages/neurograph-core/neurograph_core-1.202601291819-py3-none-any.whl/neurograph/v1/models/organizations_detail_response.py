...
class OrganizationsDetailResponse(BaseModel):
    ...
    client_count: Optional[StrictInt] = None
    ...
    __properties: ClassVar[List[str]] = ["branding", "client_count", "description", "error", "id", "image_url", "is_active", "name", "ts_created", "ts_updated", "uid", "url", "workbench"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "client_count": obj.get("client_count"),
