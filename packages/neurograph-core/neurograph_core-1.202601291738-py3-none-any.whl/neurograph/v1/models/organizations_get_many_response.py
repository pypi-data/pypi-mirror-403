...
class OrganizationsGetManyResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data", "error", "limit", "offset", "total_rows"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [OrganizationsOrganization.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "error": obj.get("error"),
            "limit": obj.get("limit"),
