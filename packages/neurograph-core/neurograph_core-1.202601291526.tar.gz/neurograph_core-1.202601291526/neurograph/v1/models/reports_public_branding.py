...
class ReportsPublicBranding(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["background_url", "logo_url", "primary_color", "secondary_color", "tertiary_color"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReportsPublicBranding from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReportsPublicBranding from a dict"""
        if obj is None:
            return None
