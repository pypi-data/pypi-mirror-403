...
class AdminUpsertUserResponse(BaseModel):
    ...
    temp_password: Optional[StrictStr] = Field(default=None, description="Only included for new users when password was generated")
    ts_created: Optional[StrictInt] = None
    ts_updated: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["display_name", "email", "error", "id", "role_name", "temp_password", "ts_created", "ts_updated"]
