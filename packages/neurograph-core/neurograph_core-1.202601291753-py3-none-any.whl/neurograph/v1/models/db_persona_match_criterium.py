...
class DbPersonaMatchCriterium(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["concept", "detail", "display", "id", "persona_instance_id", "sort_order"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DbPersonaMatchCriterium from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DbPersonaMatchCriterium from a dict"""
        if obj is None:
            return None
