...
class AdminUpsertUserRequest(BaseModel):
    ...
    password: Optional[StrictStr] = Field(default=None, description="Optional: if empty, generates a secure password for new users")
    __properties: ClassVar[List[str]] = ["display_name", "email", "id", "password"]
