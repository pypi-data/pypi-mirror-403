...
class OrganizationsThemePresetUpdateRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["category", "color1", "color2", "color3", "color4", "color5", "description", "id", "is_active", "name", "preview_url", "primary_color", "secondary_color", "tags", "tertiary_color"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationsThemePresetUpdateRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationsThemePresetUpdateRequest from a dict"""
        if obj is None:
            return None
