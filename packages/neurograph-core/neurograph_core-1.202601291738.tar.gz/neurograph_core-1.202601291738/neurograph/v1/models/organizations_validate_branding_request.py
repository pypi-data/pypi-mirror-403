...
class OrganizationsValidateBrandingRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["color1", "color2", "color3", "color4", "color5", "primary_color", "secondary_color", "tertiary_color"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OrganizationsValidateBrandingRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OrganizationsValidateBrandingRequest from a dict"""
        if obj is None:
            return None
