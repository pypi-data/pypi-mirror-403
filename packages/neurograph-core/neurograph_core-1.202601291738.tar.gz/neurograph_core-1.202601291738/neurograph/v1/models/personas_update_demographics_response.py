...
class PersonasUpdateDemographicsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["age", "error", "female", "id", "income", "male", "persona_seed_id"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PersonasUpdateDemographicsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PersonasUpdateDemographicsResponse from a dict"""
        if obj is None:
            return None
