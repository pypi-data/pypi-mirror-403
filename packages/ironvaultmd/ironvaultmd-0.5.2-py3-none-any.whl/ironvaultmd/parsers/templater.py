...
templater_var: ContextVar[Templater | None] = ContextVar('templater', default=None)
...
def get_templater() -> Templater:
    ...
    """
    templater_instance = templater_var.get()
    ...
    if templater_instance is None:
        ...
        templater_var.set(templater_instance)
...
def reset_templater() -> None:
    ...
    """
    templater_var.set(Templater())
    logger.debug(f"TEMPLATER: rst instance {templater_var.get()}")
