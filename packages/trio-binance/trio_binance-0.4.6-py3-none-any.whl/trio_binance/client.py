...
class AsyncClient(BaseClient):
    ...
    async def stream_close(self):
        return await self._delete("userDataStream", True, data={})
    ...
    async def futures_stream_close(self):
        return await self._request_futures_api("delete", "listenKey", signed=True, data={})
    ...
    async def futures_coin_stream_close(self):
        return await self._request_futures_coin_api("delete", "listenKey", signed=True, data={})
    ...
    async def portfolio_margin_stream_close(self) -> dict:
        ...
        @return: empty dict {}
        """
        return await self._request_portfolio_margin_api("delete", "listenKey", signed=True, data={})
