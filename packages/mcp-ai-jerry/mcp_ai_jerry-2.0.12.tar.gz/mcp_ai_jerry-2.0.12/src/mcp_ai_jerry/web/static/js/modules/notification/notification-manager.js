...
(function() {
    ...
    NotificationManager.prototype.notifyNewSession = function(sessionId, projectPath) {
        ...
        try {
            const notification = new Notification(this.t('notification.browser.title', 'MCP AI Jerry - 新會話'), {
    ...
    NotificationManager.prototype.notifyCritical = function(type, message) {
        ...
        try {
            const notification = new Notification(this.t('notification.browser.criticalTitle', 'MCP AI Jerry - 警告'), {
                body: message,
                icon: '/static/icon-192.png',
                badge: '/static/icon-192.png',
                tag: 'mcp-critical',
