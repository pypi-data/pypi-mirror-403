...
import textwrap
import macer.externals.dynaphopy_bundled
...
if __name__ == 'test_gui.py':
    import macer.externals.dynaphopy_bundled as controller
    import macer.externals.dynaphopy_bundled.functions.iofunctions as reading
