...
from macer.externals.dynaphopy_bundled.c import mem
from macer.externals.dynaphopy_bundled.c import correlation
...
def mem_coefficient_scan_analysis(vq, trajectory, parameters):
    from macer.externals.dynaphopy_bundled.analysis.fitting import fitting_functions
