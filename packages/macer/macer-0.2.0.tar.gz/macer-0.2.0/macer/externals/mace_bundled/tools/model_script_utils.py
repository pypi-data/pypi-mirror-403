...
from macer.externals.mace_bundled import modules
from macer.externals.mace_bundled.modules.wrapper_ops import CuEquivarianceConfig
from macer.externals.mace_bundled.tools.finetuning_utils import load_foundations_elements
from macer.externals.mace_bundled.tools.scripts_utils import extract_config_mace_model
...
def _build_model(
    ...
    if args.model == "FoundationMACELES":
        from macer.externals.mace_bundled.modules.extensions import MACELES
