...
from macer.externals.mace_bundled.calculators import LAMMPS_MACE
from macer.externals.mace_bundled.calculators.lammps_mliap_mace import LAMMPS_MLIAP_MACE
