# Deliver Code Hinting with Annotations
...
In the naming conventions section, we group related methods together in the same class. By doing this, developers can type and see a popup list of available methods in a class to discover functionality they seek.
