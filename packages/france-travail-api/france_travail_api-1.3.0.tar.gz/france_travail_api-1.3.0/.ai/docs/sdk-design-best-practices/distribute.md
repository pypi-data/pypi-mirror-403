# SDK Distribution with Package Publishing
...
|---|---|---|---|---|---|
| Maven | NuGet | PyPi | Packagist | NPM | RubyGems |
...
There are several popular formats for change logs, such as Keep a Changelog, which provides a standardized structure for documenting changes. Following a standard format makes it easier for developers to understand the changes made.
