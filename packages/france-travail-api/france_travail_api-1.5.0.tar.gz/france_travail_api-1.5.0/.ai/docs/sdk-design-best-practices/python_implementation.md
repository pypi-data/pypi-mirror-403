...
and`azure.core.pipeline.policies.AsyncRetryPolicy`
...
Any Enums defined in the SDK should be interchangeable with case-insensitive strings. This is achieved by using the `CaseInsensitiveEnumMeta`
