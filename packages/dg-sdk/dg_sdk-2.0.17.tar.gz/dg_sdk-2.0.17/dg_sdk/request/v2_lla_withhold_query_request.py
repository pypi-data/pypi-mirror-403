...
from dg_sdk.request.request_api_urls import V2_LLA_WITHHOLD_QUERY



class V2LlaWithholdQueryRequest(object):
    """
    代运营佣金代扣查询
    """
    ...
    def post(self, extend_infos):
        ...
        return request_post(V2_LLA_WITHHOLD_QUERY, required_params)
