...
from dg_sdk.request.request_api_urls import V3_TRADE_PAYMENT_SCANPAY_REFUNDQUERY



class V3TradePaymentScanpayRefundqueryRequest(object):
    """
    扫码交易退款查询
    """
    ...
    def post(self, extend_infos):
        ...
        return request_post(V3_TRADE_PAYMENT_SCANPAY_REFUNDQUERY, required_params)
