...
```bash
pip install biotmed_generic_entity_sdk
```
...
with biotmed_generic_entity_sdk.ApiClient(configuration) as api_client:
    ...
    api = biotmed_generic_entity_sdk.YourAPIClass(api_client)  # Replace with your actual API class name
    # Use the API...
```
...
create_request = biotmed_generic_entity_sdk.CreateResourceRequest(  # Replace with your actual request model name
    _name="My Resource",
...
```python
create_request = biotmed_generic_entity_sdk.CreateResourceRequest.model_validate({  # Replace with your actual request model name
    "_name": "My Resource",
    "_ownerOrganization": {
...
```python
from biotmed_generic_entity_sdk import SearchRequestV2, FilterV2, Order
...
```python
from biotmed_generic_entity_sdk import ApiException
...
try:
    ...
    if isinstance(error_response, biotmed_generic_entity_sdk.ErrorResponse):
...
with biotmed_generic_entity_sdk.ApiClient(configuration) as api_client:
    ...
    try:
        search_request = biotmed_generic_entity_sdk.SearchRequestV2(
            filter={
                "_name": biotmed_generic_entity_sdk.FilterV2(like="test")
            },
            limit=10,
            page=0
        )
