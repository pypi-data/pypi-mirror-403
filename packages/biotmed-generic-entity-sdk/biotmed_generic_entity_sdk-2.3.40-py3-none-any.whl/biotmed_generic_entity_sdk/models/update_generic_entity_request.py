...
class UpdateGenericEntityRequest(BaseModel):
    """
    ...
    """ # noqa: E501
    name: Annotated[str, Field(min_length=0, strict=True, max_length=32)] = Field(alias="_name")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateGenericEntityRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateGenericEntityRequest from a dict"""
        if obj is None:
            return None
