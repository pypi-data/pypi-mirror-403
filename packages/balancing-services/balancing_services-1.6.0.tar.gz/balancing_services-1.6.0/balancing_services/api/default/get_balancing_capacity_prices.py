...
from ...models.balancing_capacity_prices_response import BalancingCapacityPricesResponse
...
) -> BalancingCapacityPricesResponse | Problem | None:
    if response.status_code == 200:
        response_200 = BalancingCapacityPricesResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[BalancingCapacityPricesResponse | Problem]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        BalancingCapacityPricesResponse | Problem
    """
