...
if TYPE_CHECKING:
    from ..models.balancing_energy_bids import BalancingEnergyBids
    from ..models.period import Period


T = TypeVar("T", bound="BalancingEnergyBidsResponse")


@_attrs_define
class BalancingEnergyBidsResponse:
    """
    Attributes:
        queried_period (Period):
        data (list[BalancingEnergyBids]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = BalancingEnergyBids.from_dict(data_item_data)
        ...
        balancing_energy_bids_response = cls(
        ...
        balancing_energy_bids_response.additional_properties = d
        return balancing_energy_bids_response
