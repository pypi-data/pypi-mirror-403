...
if TYPE_CHECKING:
    from ..models.balancing_capacity_bids import BalancingCapacityBids
    from ..models.period import Period


T = TypeVar("T", bound="BalancingCapacityBidsResponse")


@_attrs_define
class BalancingCapacityBidsResponse:
    """
    Attributes:
        queried_period (Period):
        data (list[BalancingCapacityBids]):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = BalancingCapacityBids.from_dict(data_item_data)
        ...
        balancing_capacity_bids_response = cls(
        ...
        balancing_capacity_bids_response.additional_properties = d
        return balancing_capacity_bids_response
