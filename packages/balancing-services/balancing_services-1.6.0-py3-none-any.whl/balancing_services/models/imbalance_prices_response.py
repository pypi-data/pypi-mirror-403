...
if TYPE_CHECKING:
    from ..models.imbalance_prices import ImbalancePrices
    from ..models.period import Period


T = TypeVar("T", bound="ImbalancePricesResponse")


@_attrs_define
class ImbalancePricesResponse:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = ImbalancePrices.from_dict(data_item_data)
        ...
        imbalance_prices_response.additional_properties = d
        return imbalance_prices_response
