...
Provides the 10 core event types required for Agentic-OS integration:
- started, thinking, message, tool_use, tool_result
- subagent_spawn, cost_update, progress, completed, error

See: ADR-013 Specialist System, TODO-203 Task/Skill Tools, TODO-204 Agentic-OS Streaming
"""
...
class EventType(Enum):
    ...
    Core Agentic-OS events (10 types):
...
class SubagentSpawnEvent(ExecutionEvent):
    ...
    This is the critical event for Agentic-OS integration, enabling:
...
# ============================================================================
# Agentic-OS Core Event Types (TODO-204)
# ============================================================================
...
class StartedEvent(ExecutionEvent):
    ...
    Agentic-OS uses this to initialize the execution UI.
