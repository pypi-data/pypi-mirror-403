...
from kaizen.runtime.specialist_registry import SpecialistRegistry, SkillRegistry
...
class TestLocalKaizenAdapterWithKaizenOptions:
    ...
    def test_adapter_with_filesystem_sources(self, tmp_path: Path):
        ...
        (specialists_dir / "test-specialist.md").write_text("""# Test Specialist
...
""")
    ...
    def test_context_injected_into_system_prompt(self, tmp_path: Path):
        ...
        kaizen_dir = tmp_path / ".kaizen"
        kaizen_dir.mkdir()
        (kaizen_dir / "KAIZEN.md").write_text("""# Important Context
