    ...
    async def handle(
        ...
        try:
            ...
            if request.method not in self.PUBLIC_METHODS:
                if not auth_token:
                    from kaizen.trust.a2a.exceptions import AuthenticationError
...
class A2AMethodHandlers:
    ...
    async def handle_delegate(
        ...
        try:
            ...
            from kaizen.trust.a2a.exceptions import DelegationError
    ...
    async def handle_audit_query(
        ...
        # Query audit service
        try:
            from kaizen.trust.audit_service import AuditQueryService
