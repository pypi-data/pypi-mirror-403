...
from kaizen.trust.crypto import verify_signature
from kaizen.trust.exceptions import TrustChainNotFoundError
from kaizen.trust.messaging.envelope import SecureMessageEnvelope
from kaizen.trust.messaging.exceptions import PublicKeyNotFoundError
...
class MessageVerifier:
    ...
    async def _verify_signature(
        ...
        try:
            ...
            # Verify signature
            is_valid = verify_signature(signing_payload, signature, public_key)
