...
class CreateMeasurementPeriodDto(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the measurement period. Ideally, it should match the UUID of the corresponding instrument from the instrument table", alias="_id")
