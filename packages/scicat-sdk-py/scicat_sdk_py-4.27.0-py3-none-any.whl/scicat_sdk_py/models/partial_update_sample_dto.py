...
class PartialUpdateSampleDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["ownerGroup", "accessGroups", "instrumentGroup", "owner", "description", "type", "proposalId", "parentSampleId", "sampleCharacteristics", "isPublished"]
