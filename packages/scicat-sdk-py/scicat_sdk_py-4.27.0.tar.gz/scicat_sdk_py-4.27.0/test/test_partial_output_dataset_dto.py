...
class TestPartialOutputDatasetDto(unittest.TestCase):
    """PartialOutputDatasetDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PartialOutputDatasetDto:
        """Test PartialOutputDatasetDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PartialOutputDatasetDto`
        """
        model = PartialOutputDatasetDto()
        if include_optional:
            return PartialOutputDatasetDto(
                owner_group = '',
                access_groups = [
                    ''
                    ],
    ...
    def testPartialOutputDatasetDto(self):
        """Test PartialOutputDatasetDto"""
