...
class TestOutputDatasetDto(unittest.TestCase):
    """OutputDatasetDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutputDatasetDto:
        """Test OutputDatasetDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutputDatasetDto`
        """
        model = OutputDatasetDto()
        if include_optional:
