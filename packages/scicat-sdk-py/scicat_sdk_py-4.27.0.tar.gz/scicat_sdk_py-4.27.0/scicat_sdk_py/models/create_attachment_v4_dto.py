...
class CreateAttachmentV4Dto(BaseModel):
    """
    ...
    caption: StrictStr
    relationships: Optional[List[AttachmentRelationshipsV4Dto]] = None
    is_published: StrictBool = Field(alias="isPublished")
    aid: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["ownerGroup", "accessGroups", "instrumentGroup", "thumbnail", "caption", "relationships", "isPublished", "aid"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateAttachmentV4Dto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateAttachmentV4Dto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "relationships": [AttachmentRelationshipsV4Dto.from_dict(_item) for _item in obj["relationships"]] if obj.get("relationships") is not None else None,
