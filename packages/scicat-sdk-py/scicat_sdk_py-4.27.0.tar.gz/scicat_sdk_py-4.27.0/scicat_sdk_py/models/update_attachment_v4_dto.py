...
class UpdateAttachmentV4Dto(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["ownerGroup", "accessGroups", "instrumentGroup", "thumbnail", "caption", "relationships", "isPublished"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdateAttachmentV4Dto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdateAttachmentV4Dto from a dict"""
        if obj is None:
            return None
