...
class OutputOrigDatablockDto(BaseModel):
    """
    ...
    version: StrictStr = Field(description="Version of the API used when the origdatablock was created or last updated. API version is defined in code for each release. Managed by the system.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OutputOrigDatablockDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OutputOrigDatablockDto from a dict"""
        if obj is None:
            return None
