...
class OutputAttachmentV3Dto(BaseModel):
    """
    ...
    caption: StrictStr
    __properties: ClassVar[List[str]] = ["ownerGroup", "accessGroups", "instrumentGroup", "createdAt", "updatedAt", "id", "datasetId", "proposalId", "sampleId", "thumbnail", "caption"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OutputAttachmentV3Dto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OutputAttachmentV3Dto from a dict"""
        if obj is None:
            return None
