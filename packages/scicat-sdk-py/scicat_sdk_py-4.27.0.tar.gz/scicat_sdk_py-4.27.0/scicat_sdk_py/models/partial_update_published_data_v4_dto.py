...
class PartialUpdatePublishedDataV4Dto(BaseModel):
    """
    PartialUpdatePublishedDataV4Dto
    """ # noqa: E501
    title: Optional[StrictStr] = Field(default=None, description="A name or title by which a resource is known. This field has the semantics of Dublin Core [dcmi:title](https://www.dublincore.org/specifications/dublin-core/dcmi-terms/terms/title/) and [DataCite title](https://datacite-metadata-schema.readthedocs.io/en/4.6/properties/title/).")
    abstract: Optional[StrictStr] = Field(default=None, description="A brief description of the resource and the context in which the resource was created. This field has the semantics of [DataCite description](https://datacite-metadata-schema.readthedocs.io/en/4.6/properties/description/) with [Abstract](https://datacite-metadata-schema.readthedocs.io/en/4.6/appendices/appendix-1/descriptionType/#abstract).")
    dataset_pids: Optional[List[StrictStr]] = Field(default=None, description="Array of one or more Dataset persistent identifier (pid) values that make up the published data.", alias="datasetPids")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PartialUpdatePublishedDataV4Dto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PartialUpdatePublishedDataV4Dto from a dict"""
        if obj is None:
            return None
