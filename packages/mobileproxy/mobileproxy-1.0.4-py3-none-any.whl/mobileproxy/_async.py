...
class MobileProxy:
    def __init__(self, api_key: Optional[str] = None):
        ...
        self.session: requests.AsyncSession = requests.AsyncSession()
        self.session.headers = Headers({"Authorization": f"Bearer {self.api_key}"})
    ...
    async def request(
        ...
        response = await self.session.request(method=method, url=self.url, params=params, data=data, headers=headers)
        try:
    ...
    async def get_ip(self, proxy_id: ProxyIdLike, check_spam: Optional[bool] = None) -> Dict[str, Any]:
        """
    ...
    async def change_ip(self, proxy_key: str, user_agent: str, format: str = "json") -> Dict[str, Any]:
        """
    ...
    async def get_price(
        ...
        return await self.request(params, headers=headers)

    async def get_black_list(self, proxy_id: ProxyIdLike) -> Dict[str, Any]:
        """
    ...
    async def add_operator_to_black_list(self, proxy_id: ProxyIdLike, operator_id: int) -> Dict[str, Any]:
        """
    ...
    async def remove_operator_from_black_list(self, proxy_id: ProxyIdLike, operator_id: int) -> Dict[str, Any]:
        """
    ...
    async def get_my_proxy(self, proxy_id: Optional[ProxyIdLike] = None) -> Dict[str, Any]:
        """
    ...
    async def change_proxy_login_password(
        self, proxy_id: ProxyIdLike, proxy_login: str, proxy_pass: str
    ) -> Dict[str, Any]:
        """
    ...
    async def reboot_proxy(self, proxy_id: int) -> Dict[str, Any]:
        """
        Перезагрузка прокси.
    ...
    async def get_operators_list(self, geoid: Optional[ProxyIdLike] = None) -> Dict[str, Any]:
        """
    ...
    async def get_id_city(self, accept_language: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    async def get_ipstat(self) -> Dict[str, Any]:
        """
    ...
    async def see_the_url_from_different_IPs(self, url: str, id_country: Optional[str] = None) -> Dict[str, Any]:
        """
    ...
    async def get_task_result(self, tasks_id: Optional[int] = None) -> Dict[str, Any]:
        """
    ...
    async def eid_available(self, eid: ProxyIdLike) -> Dict[str, Any]:
        """
    ...
    async def get_history(self, start: int = 0, length: int = 50) -> Dict[str, Any]:
        """
