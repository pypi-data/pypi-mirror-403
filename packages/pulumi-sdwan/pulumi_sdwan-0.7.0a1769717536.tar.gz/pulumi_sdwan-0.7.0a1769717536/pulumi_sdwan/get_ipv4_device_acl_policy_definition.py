...
def get_ipv4_device_acl_policy_definition(id: Optional[_builtins.str] = None,
...
def get_ipv4_device_acl_policy_definition_output(id: Optional[pulumi.Input[_builtins.str]] = None,
