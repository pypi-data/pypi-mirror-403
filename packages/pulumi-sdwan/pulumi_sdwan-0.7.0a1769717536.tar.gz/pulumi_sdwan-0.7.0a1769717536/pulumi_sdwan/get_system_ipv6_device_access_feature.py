...
def get_system_ipv6_device_access_feature(feature_profile_id: Optional[_builtins.str] = None,
...
def get_system_ipv6_device_access_feature_output(feature_profile_id: Optional[pulumi.Input[_builtins.str]] = None,
