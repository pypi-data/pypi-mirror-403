...
class ServiceLanVpnFeatureAssociateRoutingOspfv3Ipv4FeatureArgs:
    ...
    def service_routing_ospfv3_ipv4_feature_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def service_routing_ospfv3_ipv4_feature_id(self, value: pulumi.Input[_builtins.str]):
...
class ServiceLanVpnFeatureAssociateRoutingOspfv3Ipv4Feature(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="serviceRoutingOspfv3Ipv4FeatureId")
    def service_routing_ospfv3_ipv4_feature_id(self) -> pulumi.Output[_builtins.str]:
        """
        Service Routing OSPFv3 IPv4 Feature ID
        """
        return pulumi.get(self, "service_routing_ospfv3_ipv4_feature_id")
