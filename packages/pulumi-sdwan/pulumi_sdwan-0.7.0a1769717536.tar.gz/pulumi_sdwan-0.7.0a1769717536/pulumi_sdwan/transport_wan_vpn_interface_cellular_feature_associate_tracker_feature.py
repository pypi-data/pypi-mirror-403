...
class TransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureArgs:
    def __init__(__self__, *,
                 ...
                 transport_wan_vpn_interface_cellular_feature_id: pulumi.Input[_builtins.str]):
        """
        ...
        :param pulumi.Input[_builtins.str] transport_wan_vpn_interface_cellular_feature_id: Transport WAN VPN Interface Cellular Feature ID
        """
    ...
    def transport_wan_vpn_interface_cellular_feature_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def transport_wan_vpn_interface_cellular_feature_id(self, value: pulumi.Input[_builtins.str]):
...
class _TransportWanVpnInterfaceCellularFeatureAssociateTrackerFeatureState:
    def __init__(__self__, *,
                 ...
                 transport_wan_vpn_interface_cellular_feature_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="transportWanVpnInterfaceCellularFeatureId")
    def transport_wan_vpn_interface_cellular_feature_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Transport WAN VPN Interface Cellular Feature ID
        """
        return pulumi.get(self, "transport_wan_vpn_interface_cellular_feature_id")
    ...
    @transport_wan_vpn_interface_cellular_feature_id.setter
    def transport_wan_vpn_interface_cellular_feature_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "transport_wan_vpn_interface_cellular_feature_id", value)
...
class TransportWanVpnInterfaceCellularFeatureAssociateTrackerFeature(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            transport_wan_vpn_feature_id: Optional[pulumi.Input[_builtins.str]] = None,
            transport_wan_vpn_interface_cellular_feature_id: Optional[pulumi.Input[_builtins.str]] = None,
            version: Optional[pulumi.Input[_builtins.int]] = None) -> 'TransportWanVpnInterfaceCellularFeatureAssociateTrackerFeature':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="transportWanVpnInterfaceCellularFeatureId")
    def transport_wan_vpn_interface_cellular_feature_id(self) -> pulumi.Output[_builtins.str]:
        """
        Transport WAN VPN Interface Cellular Feature ID
        """
        return pulumi.get(self, "transport_wan_vpn_interface_cellular_feature_id")
