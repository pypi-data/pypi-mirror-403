...
class GetServiceLanVpnFeatureAssociateRoutingOspfv3Ipv6FeatureResult:
    ...
    def service_routing_ospfv3_ipv6_feature_id(self) -> _builtins.str:
        """
...
def get_service_lan_vpn_feature_associate_routing_ospfv3_ipv6_feature(feature_profile_id: Optional[_builtins.str] = None,
