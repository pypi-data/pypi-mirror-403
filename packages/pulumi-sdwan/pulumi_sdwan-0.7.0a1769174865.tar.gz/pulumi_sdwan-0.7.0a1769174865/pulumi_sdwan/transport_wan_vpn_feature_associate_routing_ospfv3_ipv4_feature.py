...
class TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4FeatureArgs:
    def __init__(__self__, *,
                 ...
                 transport_routing_ospfv3_ipv4_feature_id: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] transport_routing_ospfv3_ipv4_feature_id: Transport Routing OSPFv4 IPv4 Feature ID
    ...
    def transport_routing_ospfv3_ipv4_feature_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def transport_routing_ospfv3_ipv4_feature_id(self, value: pulumi.Input[_builtins.str]):
...
class _TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4FeatureState:
    def __init__(__self__, *,
                 ...
                 transport_routing_ospfv3_ipv4_feature_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="transportRoutingOspfv3Ipv4FeatureId")
    def transport_routing_ospfv3_ipv4_feature_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Transport Routing OSPFv4 IPv4 Feature ID
        """
        return pulumi.get(self, "transport_routing_ospfv3_ipv4_feature_id")
    ...
    @transport_routing_ospfv3_ipv4_feature_id.setter
    def transport_routing_ospfv3_ipv4_feature_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "transport_routing_ospfv3_ipv4_feature_id", value)
...
class TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4Feature(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            transport_routing_ospfv3_ipv4_feature_id: Optional[pulumi.Input[_builtins.str]] = None,
            transport_wan_vpn_feature_id: Optional[pulumi.Input[_builtins.str]] = None,
            version: Optional[pulumi.Input[_builtins.int]] = None) -> 'TransportWanVpnFeatureAssociateRoutingOspfv3Ipv4Feature':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="transportRoutingOspfv3Ipv4FeatureId")
    def transport_routing_ospfv3_ipv4_feature_id(self) -> pulumi.Output[_builtins.str]:
        """
        Transport Routing OSPFv4 IPv4 Feature ID
        """
        return pulumi.get(self, "transport_routing_ospfv3_ipv4_feature_id")
