...
class GetServiceLanVpnInterfaceEthernetFeatureAssociateTrackerFeatureResult:
    ...
    def service_tracker_feature_id(self) -> _builtins.str:
        """
...
def get_service_lan_vpn_interface_ethernet_feature_associate_tracker_feature(feature_profile_id: Optional[_builtins.str] = None,
