...
class GetServiceLanVpnFeatureAssociateMulticastFeatureResult:
    ...
    def service_multicast_feature_id(self) -> _builtins.str:
        """
...
def get_service_lan_vpn_feature_associate_multicast_feature(feature_profile_id: Optional[_builtins.str] = None,
...
def get_service_lan_vpn_feature_associate_multicast_feature_output(feature_profile_id: Optional[pulumi.Input[_builtins.str]] = None,
