...
def get_policy_object_security_identity_list(feature_profile_id: Optional[_builtins.str] = None,
...
def get_policy_object_security_identity_list_output(feature_profile_id: Optional[pulumi.Input[_builtins.str]] = None,
