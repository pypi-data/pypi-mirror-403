...
def get_application_aware_routing_policy_definition(id: Optional[_builtins.str] = None,
...
def get_application_aware_routing_policy_definition_output(id: Optional[pulumi.Input[_builtins.str]] = None,
