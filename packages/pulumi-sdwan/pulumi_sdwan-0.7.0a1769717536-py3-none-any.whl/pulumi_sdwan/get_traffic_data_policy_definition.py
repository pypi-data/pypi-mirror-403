...
def get_traffic_data_policy_definition(id: Optional[_builtins.str] = None,
...
def get_traffic_data_policy_definition_output(id: Optional[pulumi.Input[_builtins.str]] = None,
