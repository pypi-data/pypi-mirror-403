...
def get_ips_signature_list_policy_object(id: Optional[_builtins.str] = None,
...
def get_ips_signature_list_policy_object_output(id: Optional[pulumi.Input[_builtins.str]] = None,
