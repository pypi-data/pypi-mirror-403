...
def get_service_ipv4_acl_feature(feature_profile_id: Optional[_builtins.str] = None,
...
def get_service_ipv4_acl_feature_output(feature_profile_id: Optional[pulumi.Input[_builtins.str]] = None,
