...
from lite_code.tools import list_files, read_file, search_code, generate_diff
...
Available tools:
- list_files: List Python (.py) and JavaScript/TypeScript (.js, .ts) files in a directory
...
class RefactoringAgent:
    ...
    def refactor(self, task: str, context: List[str] = None) -> Dict[str, Any]:
        """Execute refactoring task with context."""
