...
class Cluster(Scpi):
    ...
    def set_ip_config(self, config: str) -> None:
        """
        Reconfigures the IP address of this device.The configuration will go into effect immediately.
    ...
    def _get_ip_status(self, slot: int) -> Any:
        ...
        -------
        Any
            Reads the DAC/ADC tile and block configuration
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:DUCDDC:STATus?")
    ...
    def _sync_all(self, slot: int) -> Any:
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:DUCDDC:SYNC:ALL?")
    ...
    def _sync_dac(self, slot: int, tile_bitmask: int, tile_target_latency: int) -> Any:
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:SYNC:DAC? {tile_bitmask},{tile_target_latency}"
        )
    ...
    def _sync_adc(self, slot: int, tile_bitmask: int, tile_target_latency: int) -> Any:
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:SYNC:ADC? {tile_bitmask},{tile_target_latency}"
        )
    ...
    def _set_dac_current(
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:DAC:CURRENT? {tile_id},{block_id},{current}"
        )
    ...
    def _set_sysref_state(self, slot: int, state: bool) -> Any:
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:SET:SYSREF:STATE? {0 if state == False else 1}"
        )
    ...
    def _reset_duc_phase_dac(self, slot: int, tile_id: int, block_id: int) -> Any:
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:DUCDDC:DAC:RESET:DUC? {tile_id},{block_id}")
    ...
    def _reset_duc_phase_adc(self, slot: int, tile_id: int, block_id: int) -> Any:
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:DUCDDC:ADC:RESET:DUC? {tile_id},{block_id}")
    ...
    def _reset_duc_phase_all(self, slot: int) -> Any:
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:DUCDDC:RESET:DUC?")
    ...
    def _set_inv_sync_filter(
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:DAC:SET:INV:SYNC:FILT? {tile_id},{block_id},{Mode}"
        )
    ...
    def _set_mixer_settings_freq_dac(
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:DAC:SET:MIXER:FREQ? {tile_id},{block_id},{NCO_frequency}"
        )
    ...
    def _set_mixer_settings_freq_adc(
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:ADC:SET:MIXER:FREQ? {tile_id},{block_id},{NCO_frequency}"
        )
    ...
    def _get_mixer_settings_freq_adc(
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:ADC:GET:MIXER:FREQ? {tile_id},{block_id}"
        )
    ...
    def _set_mixer_settings_mode(
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:DAC:SET:MIXER:MODE? {tile_id},{block_id},{Mixer_mode}"
        )
    ...
    def _set_mixer_settings_coarse_delay_dac(
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:DAC:SET:MIXER:COARSE:DELAY? {tile_id},{block_id},{delay}"
        )
    ...
    def _set_mixer_settings_coarse_delay_adc(
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:ADC:SET:MIXER:COARSE:DELAY? {tile_id},{block_id},{delay}"
        )
    ...
    def _set_mixer_settings_nco_phase_offset(
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:DAC:SET:MIXER:NCO:PHASE:OFFSET? {tile_id},{block_id},{nco_phase_offset}"
        )
    ...
    def _set_nyquist_zone_dac(
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:DAC:SET:RFDC:NYQUIST:ZONE? {tile_id},{block_id},{DAC_Nyquist_zone}"
        )
    ...
    def _set_nyquist_zone_adc(
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:ADC:SET:RFDC:NYQUIST:ZONE? {tile_id},{block_id},{ADC_Nyquist_zone}"
        )
    ...
    def _set_pll_fsample(
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:DAC:SET:FSAMPLE? {clock_source},{ref_clock_frequency},{sampling_rate},{tile_id}"
        )
    ...
    def _set_decoder_mode(
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:SET:DECODER:MODE? {tile_id},{block_id},{mode}"
        )
    ...
    def _set_dac_comp_mode(
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:SET:DAC:COMP:MODE? {tile_id},{block_id},{mode}"
        )
    ...
    def _set_adc_dsa(
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:DUCDDC:SET:ADC:DSA? {tile_id},{block_id},{attenuation}"
        )
    ...
    def _get_adc_dsa(self, slot: int, tile_id: int, block_id: int) -> Any:
        ...
        -------
        Any
            DDC ADC attenuation value for block/tile pair.
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:DUCDDC:ADC:GET:DSA? {tile_id},{block_id}")
    ...
    def _get_interrupts_adc(self, slot: int) -> Any:
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:DUCDDC:ADC:GET:INTERRUPTS?")

        return json.loads(var0.decode("utf-8"))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_interrupts_dac(self, slot: int) -> Any:
        """
        Get DAC interupt status
        ...
        -------
        Any
            Interrupt status of all enabled DAC tiles
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:DUCDDC:DAC:GET:INTERRUPTS?")
    ...
    def _clear_interrupts(self, slot: int) -> Any:
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:DUCDDC:ADC:CLEAR:INTERRUPTS?")
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_out_lo_en(self, slot: int, channel_id: int, value: int) -> Any:
        """
        Set the value of lo_en GPIO line(s)
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:AFE:OUT:LO:EN:SET:DEBUG? {channel_id},{value}"
        )
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_out_lo_en(self, slot: int, channel_id: int) -> Any:
        """
        Get the value of lo_en GPIO line(s)
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:AFE:OUT:LO:EN:GET:DEBUG? {channel_id}")
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_in_pwr_ctrl(self, slot: int, channel_id: int, value: int) -> Any:
        """
        Set the value of pwr_ctrl GPIO line(s)
        ...
        # SCPI call
        var0 = self._read_bin(
            f"SLOT{slot}:AFE:IN:PWR:CTRL:SET:DEBUG? {channel_id},{value}"
        )
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _get_in_pwr_ctrl(self, slot: int, channel_id: int) -> Any:
        """
        Get the value of pwr_ctrl GPIO line(s)
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}AFE:IN:PWR:CTRL:GET:DEBUG? {channel_id}")
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_out_dsa(self, slot: int, channel: int, attenuation: float) -> Any:
        """
        Set the absolute attenuation value for a given channel in steps of 0.5 dB
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:AFE:OUT:DSA:SET? {channel},{attenuation}")
    ...
    def _set_out_att(self, slot: int, channel: int, attenuation: float) -> Any:
        """
        Set the relative attenuation value for a given channel in steps of 0.5 dB
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_in_dsa1(self, slot: int, channel: int, attenuation: float) -> Any:
        """
        Set the absolute dsa 1 value for a given channel in steps of 0.5 dB
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:AFE:IN:DSA1:SET? {channel},{attenuation}")

        return json.loads(var0.decode("utf-8"))

    # -------------------------------------------------------------------------
    @scpi_error_check
    def _set_in_dsa2(self, slot: int, channel: int, attenuation: float) -> Any:
        """
        Set the absolute dsa 2 value for a given channel in steps of 0.5 dB
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:AFE:IN:DSA2:SET? {channel},{attenuation}")
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _download_freq_plan(self, slot: int) -> Any:
        """
        Download frequency plan settings
        ...
        # SCPI call
        var0 = self._read_bin(f"SLOT{slot}:AFE:GET:FREQ:SETTINGS?")
    ...
    # -------------------------------------------------------------------------
    @scpi_error_check
    def _measure_current(self, slot: int, io_channels: Any) -> Any:
        """
        ...
        slot : int
            slot index.
        io_channels : Any
            Channel numbers for the measurement.

        Returns
        -------
        Any
            The measured currents for all requested channels in amperes.
        ...
        # SCPI call
        var0 = self._write_read_bin(
            f"SLOT{slot}:IO:CHANnels:MEASurement:CURRent?",
            json.dumps(io_channels).encode("utf-8"),
        )
