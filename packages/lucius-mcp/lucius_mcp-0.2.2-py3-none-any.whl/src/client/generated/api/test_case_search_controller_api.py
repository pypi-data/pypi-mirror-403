...
class TestCaseSearchControllerApi:
    ...
    @validate_call
    async def search1_with_http_info(
        self,
        project_id: StrictInt,
        rql: StrictStr,
        deleted: Optional[StrictBool] = None,
    ...
    @validate_call
    async def search1_without_preload_content(
        self,
        project_id: StrictInt,
        rql: StrictStr,
        deleted: Optional[StrictBool] = None,
    ...
    def _search1_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/testcase/__search',
    ...
    async def validate_query1(
        ...
        _param = self._validate_query1_serialize(
            project_id=project_id,
            rql=rql,
            deleted=deleted,
            _request_auth=_request_auth,
    ...
    @validate_call
    async def validate_query1_with_http_info(
        self,
        project_id: StrictInt,
        rql: StrictStr,
        deleted: Optional[StrictBool] = None,
    ...
    @validate_call
    async def validate_query1_without_preload_content(
        self,
        project_id: StrictInt,
        rql: StrictStr,
        deleted: Optional[StrictBool] = None,
    ...
    def _validate_query1_serialize(
        self,
        project_id,
        rql,
        deleted,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/testcase/query/validate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
