...
class TestResultTreeLeafDtoV2(TestResultTreeNodeDto):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "type", "assignee", "createdDate", "duration", "flaky", "hidden", "lastModifiedDate", "layerName", "manual", "start", "status", "stop", "testCaseId", "testedBy"]
