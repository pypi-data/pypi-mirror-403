...
class ScenarioExportFieldMapping(BaseModel):
    ...
    steps_separator: StrictStr = Field(alias="stepsSeparator")
    __properties: ClassVar[List[str]] = ["field", "name", "stepsIndent", "stepsSeparator"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "field": obj.get("field"),
            "name": obj.get("name"),
            "stepsIndent": obj.get("stepsIndent"),
            "stepsSeparator": obj.get("stepsSeparator")
        })
        return _obj
