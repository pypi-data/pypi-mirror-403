...
class AccessGroupDto(BaseModel):
    ...
    users: Optional[List[AccessGroupUserDto]] = None
    users_count: Optional[StrictInt] = Field(default=None, alias="usersCount")
    __properties: ClassVar[List[str]] = ["id", "name", "projectsCount", "users", "usersCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "users": [AccessGroupUserDto.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
