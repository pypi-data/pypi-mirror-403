...
class ProjectMetricDto(BaseModel):
    ...
    metric_date: Optional[StrictInt] = Field(default=None, alias="metricDate")
    ...
    __properties: ClassVar[List[str]] = ["labels", "metricDate", "metricId", "projectId", "value"]
