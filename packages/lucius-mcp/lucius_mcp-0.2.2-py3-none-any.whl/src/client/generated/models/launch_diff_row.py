...
class LaunchDiffRow(BaseModel):
    ...
    LaunchDiffRow
    """ # noqa: E501
    cells: Optional[List[LaunchDiffCell]] = None
    ...
    __properties: ClassVar[List[str]] = ["cells", "testCaseId", "testCaseName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cells": [LaunchDiffCell.from_dict(_item) for _item in obj["cells"]] if obj.get("cells") is not None else None,
