...
class TestCaseFullTreeNodeDto(BaseModel):
    ...
    """ # noqa: E501
    children: Optional[PageTestCaseTreeNodeDto] = None
    custom_field_value_id: Optional[StrictInt] = Field(default=None, alias="customFieldValueId")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "children": PageTestCaseTreeNodeDto.from_dict(obj["children"]) if obj.get("children") is not None else None,
