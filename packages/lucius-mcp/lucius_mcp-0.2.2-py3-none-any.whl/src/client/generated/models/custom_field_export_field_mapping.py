...
class CustomFieldExportFieldMapping(BaseModel):
    ...
    items_separator: StrictStr = Field(alias="itemsSeparator")
    __properties: ClassVar[List[str]] = ["field", "name", "customFieldId", "itemsSeparator"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "itemsSeparator": obj.get("itemsSeparator")
        })
        return _obj
