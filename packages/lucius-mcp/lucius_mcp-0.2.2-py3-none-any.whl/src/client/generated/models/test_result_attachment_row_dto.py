...
class TestResultAttachmentRowDto(AttachmentRow):
    ...
    """ # noqa: E501
    from_test_case: Optional[StrictBool] = Field(default=None, alias="fromTestCase")
    missed: Optional[StrictBool] = None
    storage_key: Optional[StrictStr] = Field(default=None, alias="storageKey")
    __properties: ClassVar[List[str]] = ["contentLength", "contentType", "entity", "id", "name", "fromTestCase", "missed", "storageKey"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "fromTestCase": obj.get("fromTestCase"),
