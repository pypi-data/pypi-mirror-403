...
class TreeDtoV2(BaseModel):
    ...
    TreeDtoV2
    """ # noqa: E501
    custom_fields_project: Optional[List[TreeCustomFieldProjectDto]] = Field(default=None, alias="customFieldsProject")
    id: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    project_id: Optional[StrictInt] = Field(default=None, alias="projectId")
    __properties: ClassVar[List[str]] = ["customFieldsProject", "id", "name", "projectId"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in custom_fields_project (list)
        _items = []
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customFieldsProject": [TreeCustomFieldProjectDto.from_dict(_item) for _item in obj["customFieldsProject"]] if obj.get("customFieldsProject") is not None else None,
            "id": obj.get("id"),
            "name": obj.get("name"),
