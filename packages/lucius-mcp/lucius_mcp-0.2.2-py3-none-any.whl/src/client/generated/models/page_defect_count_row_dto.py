...
class PageDefectCountRowDto(BaseModel):
    ...
    """ # noqa: E501
    content: Optional[List[DefectCountRowDto]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "content": [DefectCountRowDto.from_dict(_item) for _item in obj["content"]] if obj.get("content") is not None else None,
            "empty": obj.get("empty"),
            "first": obj.get("first"),
            "last": obj.get("last"),
