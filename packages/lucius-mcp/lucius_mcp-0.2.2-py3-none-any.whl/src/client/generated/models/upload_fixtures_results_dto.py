...
class UploadFixturesResultsDto(BaseModel):
    ...
    """ # noqa: E501
    fixtures: Optional[Annotated[List[UploadTestFixtureResultDto], Field(min_length=0, max_length=100)]] = None
    __properties: ClassVar[List[str]] = ["fixtures"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fixtures": [UploadTestFixtureResultDto.from_dict(_item) for _item in obj["fixtures"]] if obj.get("fixtures") is not None else None
        })
        return _obj
