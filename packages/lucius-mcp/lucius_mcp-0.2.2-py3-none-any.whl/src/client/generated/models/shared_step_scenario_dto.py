...
class SharedStepScenarioDto(BaseModel):
    ...
    """ # noqa: E501
    steps: Optional[List[SharedStepScenarioDtoStepsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "steps": [SharedStepScenarioDtoStepsInner.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None
        })
        return _obj
