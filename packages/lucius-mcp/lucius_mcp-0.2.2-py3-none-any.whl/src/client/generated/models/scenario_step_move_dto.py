...
class ScenarioStepMoveDto(BaseModel):
    ...
    ScenarioStepMoveDto
    """ # noqa: E501
    after_id: Optional[StrictInt] = Field(default=None, alias="afterId")
    before_id: Optional[StrictInt] = Field(default=None, alias="beforeId")
    parent_id: Optional[StrictInt] = Field(default=None, alias="parentId")
    __properties: ClassVar[List[str]] = ["afterId", "beforeId", "parentId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "afterId": obj.get("afterId"),
            "beforeId": obj.get("beforeId"),
