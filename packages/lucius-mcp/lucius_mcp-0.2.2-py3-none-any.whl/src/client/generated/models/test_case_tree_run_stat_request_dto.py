...
class TestCaseTreeRunStatRequestDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["deleted", "filterId", "groupsExclude", "groupsInclude", "inverted", "jobsMapping", "leafsExclude", "leafsInclude", "path", "projectId", "search", "treeId"]
