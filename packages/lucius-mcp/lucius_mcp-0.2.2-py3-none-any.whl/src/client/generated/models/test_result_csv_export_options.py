...
class TestResultCsvExportOptions(BaseModel):
    ...
    mapping: Optional[List[TestResultCsvExportOptionsMappingInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mapping": [TestResultCsvExportOptionsMappingInner.from_dict(_item) for _item in obj["mapping"]] if obj.get("mapping") is not None else None,
            "name": obj.get("name"),
