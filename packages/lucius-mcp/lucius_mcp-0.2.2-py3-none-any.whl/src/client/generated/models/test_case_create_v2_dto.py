...
class TestCaseCreateV2Dto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["automated", "customFields", "deleted", "description", "expectedResult", "external", "fullName", "links", "members", "name", "precondition", "projectId", "scenario", "statusId", "tags", "testLayerId", "workflowId"]
