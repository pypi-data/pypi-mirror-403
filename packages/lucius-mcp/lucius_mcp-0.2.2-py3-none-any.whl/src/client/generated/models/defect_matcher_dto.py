...
class DefectMatcherDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdBy", "createdDate", "defectId", "id", "lastModifiedBy", "lastModifiedDate", "messageRegex", "name", "traceRegex"]
