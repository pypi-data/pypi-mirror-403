...
class TestCaseExampleDto(BaseModel):
    ...
    parameters: Optional[List[ParameterValueDto]] = None
    status: Optional[TestStatus] = None
    __properties: ClassVar[List[str]] = ["id", "parameters", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "parameters": [ParameterValueDto.from_dict(_item) for _item in obj["parameters"]] if obj.get("parameters") is not None else None,
