...
class ImportRequestInfoDto(BaseModel):
    ...
    """ # noqa: E501
    headers: Optional[List[OrderedValueDtoString]] = None
    records_count: Optional[StrictInt] = Field(default=None, alias="recordsCount")
    values: Optional[List[OrderedValueDtoString]] = None
    __properties: ClassVar[List[str]] = ["headers", "recordsCount", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "headers": [OrderedValueDtoString.from_dict(_item) for _item in obj["headers"]] if obj.get("headers") is not None else None,
            "recordsCount": obj.get("recordsCount"),
            "values": [OrderedValueDtoString.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
