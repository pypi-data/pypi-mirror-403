...
class FilterDto(BaseModel):
    ...
    type: Optional[FilterTypeDto] = None
    __properties: ClassVar[List[str]] = ["base", "body", "createdBy", "createdDate", "editable", "id", "lastModifiedBy", "lastModifiedDate", "name", "projectId", "shared", "type"]
