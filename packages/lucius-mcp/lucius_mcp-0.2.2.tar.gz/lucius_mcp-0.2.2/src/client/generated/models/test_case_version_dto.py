...
class TestCaseVersionDto(BaseModel):
    ...
    test_case_last_modified_date: Optional[StrictInt] = Field(default=None, alias="testCaseLastModifiedDate")
    title: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["createdBy", "createdDate", "description", "id", "testCaseLastModifiedDate", "title"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "testCaseLastModifiedDate": obj.get("testCaseLastModifiedDate"),
            "title": obj.get("title")
        })
        return _obj
