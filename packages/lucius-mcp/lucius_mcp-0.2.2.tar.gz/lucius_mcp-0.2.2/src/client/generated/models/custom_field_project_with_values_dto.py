...
class CustomFieldProjectWithValuesDto(BaseModel):
    ...
    """ # noqa: E501
    custom_field: Optional[CustomFieldProjectDto] = Field(default=None, alias="customField")
    values: Optional[List[CustomFieldValueDto]] = None
    __properties: ClassVar[List[str]] = ["customField", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customField": CustomFieldProjectDto.from_dict(obj["customField"]) if obj.get("customField") is not None else None,
            "values": [CustomFieldValueDto.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
