...
class DashboardCopyDto(BaseModel):
    ...
    preserve_widget_aql: StrictBool = Field(alias="preserveWidgetAql")
    project_id: Optional[StrictInt] = Field(default=None, alias="projectId")
    __properties: ClassVar[List[str]] = ["name", "preserveWidgetAql", "projectId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "preserveWidgetAql": obj.get("preserveWidgetAql"),
