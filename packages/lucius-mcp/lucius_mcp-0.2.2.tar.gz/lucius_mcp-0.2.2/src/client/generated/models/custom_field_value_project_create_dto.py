...
class CustomFieldValueProjectCreateDto(BaseModel):
    ...
    """ # noqa: E501
    custom_field: IdOnlyDto = Field(alias="customField")
    default: Optional[StrictBool] = None
    name: Annotated[str, Field(min_length=1, strict=True, max_length=255)]
    project_id: Optional[StrictInt] = Field(default=None, alias="projectId")
    __properties: ClassVar[List[str]] = ["customField", "default", "name", "projectId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customField": IdOnlyDto.from_dict(obj["customField"]) if obj.get("customField") is not None else None,
