...
class TestResultPatchDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["customFields", "description", "expectedResult", "fullName", "links", "members", "name", "precondition", "scenario", "tags", "testLayerId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scenario": TestResultScenarioDto.from_dict(obj["scenario"]) if obj.get("scenario") is not None else None,
