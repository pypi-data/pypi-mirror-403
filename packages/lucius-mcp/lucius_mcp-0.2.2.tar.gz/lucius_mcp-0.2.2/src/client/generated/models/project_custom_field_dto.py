...
class ProjectCustomFieldDto(BaseModel):
    ...
    custom_field_locked: Optional[StrictBool] = Field(default=None, alias="customFieldLocked")
    custom_field_name: Optional[StrictStr] = Field(default=None, alias="customFieldName")
    custom_field_required: Optional[StrictBool] = Field(default=None, alias="customFieldRequired")
    ...
    __properties: ClassVar[List[str]] = ["createdBy", "createdDate", "customFieldId", "customFieldLocked", "customFieldName", "customFieldRequired", "id", "isPublic", "lastModifiedBy", "lastModifiedDate", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "customFieldLocked": obj.get("customFieldLocked"),
            "customFieldName": obj.get("customFieldName"),
            "customFieldRequired": obj.get("customFieldRequired"),
            "id": obj.get("id"),
