...
class UploadTestResultAttachmentStepDto(UploadTestResultStepDto):
    ...
    """ # noqa: E501
    attachment: Optional[UploadAttachmentDto] = None
    duration: Optional[StrictInt] = None
    start: Optional[StrictInt] = None
    status: Optional[UploadTestStatus] = None
    stop: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["type", "attachment", "duration", "start", "status", "stop"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "attachment": UploadAttachmentDto.from_dict(obj["attachment"]) if obj.get("attachment") is not None else None,
