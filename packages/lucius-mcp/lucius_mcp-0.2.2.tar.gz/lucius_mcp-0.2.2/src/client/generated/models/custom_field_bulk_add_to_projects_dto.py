...
class CustomFieldBulkAddToProjectsDto(BaseModel):
    ...
    """ # noqa: E501
    custom_fields_ids: List[StrictInt] = Field(alias="customFieldsIds")
    projects_ids: List[StrictInt] = Field(alias="projectsIds")
    __properties: ClassVar[List[str]] = ["customFieldsIds", "projectsIds"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customFieldsIds": obj.get("customFieldsIds"),
            "projectsIds": obj.get("projectsIds")
        })
        return _obj
