...
class EnvVarSchemaDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdBy", "createdDate", "envVar", "id", "key", "lastModifiedBy", "lastModifiedDate", "projectId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "envVar": EnvVarDto.from_dict(obj["envVar"]) if obj.get("envVar") is not None else None,
            "id": obj.get("id"),
            "key": obj.get("key"),
