...
class SharedStepDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["archived", "attachmentsCount", "createdBy", "createdDate", "id", "lastModifiedBy", "lastModifiedDate", "name", "projectId", "stepsCount", "testCasesCount"]
