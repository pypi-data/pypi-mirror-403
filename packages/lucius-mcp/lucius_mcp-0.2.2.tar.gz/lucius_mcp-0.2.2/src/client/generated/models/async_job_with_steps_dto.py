...
class AsyncJobWithStepsDto(BaseModel):
    ...
    steps: Optional[List[AsyncJobStepDto]] = None
    __properties: ClassVar[List[str]] = ["createdDate", "id", "lastModifiedDate", "name", "status", "steps"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "steps": [AsyncJobStepDto.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None
        })
        return _obj
