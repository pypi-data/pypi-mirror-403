...
class CustomFieldDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["archived", "createdBy", "createdDate", "defaultCustomFieldValueId", "id", "lastModifiedBy", "lastModifiedDate", "locked", "name", "required", "singleSelect"]
