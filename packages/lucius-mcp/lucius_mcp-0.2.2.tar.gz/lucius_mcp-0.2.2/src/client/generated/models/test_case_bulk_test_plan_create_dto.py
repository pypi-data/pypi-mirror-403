...
class TestCaseBulkTestPlanCreateDto(BaseModel):
    ...
    test_plan_name: Annotated[str, Field(min_length=1, strict=True, max_length=255)] = Field(alias="testPlanName")
    tree: Optional[IdAndNameOnlyDto] = None
    __properties: ClassVar[List[str]] = ["selection", "testPlanName", "tree"]
