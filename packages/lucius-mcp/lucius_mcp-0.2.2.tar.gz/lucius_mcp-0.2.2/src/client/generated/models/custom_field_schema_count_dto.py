...
class CustomFieldSchemaCountDto(BaseModel):
    ...
    mappings_count: Optional[StrictInt] = Field(default=None, alias="mappingsCount")
    __properties: ClassVar[List[str]] = ["id", "mappingsCount"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "mappingsCount": obj.get("mappingsCount")
        })
        return _obj
