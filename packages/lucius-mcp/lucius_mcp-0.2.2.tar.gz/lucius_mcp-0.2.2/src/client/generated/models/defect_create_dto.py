...
class DefectCreateDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["description", "issue", "linkIssue", "matcher", "name", "projectId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "matcher": Matcher.from_dict(obj["matcher"]) if obj.get("matcher") is not None else None,
            "name": obj.get("name"),
