...
class ExtFormFieldText(ExtFormField):
    ...
    with_confirmation: Optional[StrictBool] = Field(default=None, alias="withConfirmation")
    __properties: ClassVar[List[str]] = ["dependsOnFields", "deprecated", "name", "required", "type", "defaultValue", "description", "labelName", "withConfirmation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "withConfirmation": obj.get("withConfirmation")
        })
        return _obj
