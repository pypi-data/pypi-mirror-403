...
class LaunchDiffCell(BaseModel):
    ...
    results: Optional[List[LaunchDiffTestResult]] = None
    status: Optional[TestStatus] = None
    __properties: ClassVar[List[str]] = ["launchId", "launchName", "results", "status"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [LaunchDiffTestResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
