...
class TreeCreateDto(BaseModel):
    ...
    TreeCreateDto
    """ # noqa: E501
    fields: Annotated[List[IdOnlyDto], Field(min_length=1, max_length=2147483647)]
    name: Annotated[str, Field(min_length=1, strict=True)]
    project_id: StrictInt = Field(alias="projectId")
    __properties: ClassVar[List[str]] = ["fields", "name", "projectId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fields": [IdOnlyDto.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,
            "name": obj.get("name"),
