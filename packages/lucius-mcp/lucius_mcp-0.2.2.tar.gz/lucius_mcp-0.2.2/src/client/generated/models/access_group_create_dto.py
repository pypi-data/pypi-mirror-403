...
class AccessGroupCreateDto(BaseModel):
    ...
    projects: Optional[List[AccessGroupProjectAccessDto]] = None
    users: Optional[List[NameOnlyDto]] = None
    __properties: ClassVar[List[str]] = ["name", "projects", "users"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "projects": [AccessGroupProjectAccessDto.from_dict(_item) for _item in obj["projects"]] if obj.get("projects") is not None else None,
            "users": [NameOnlyDto.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
