...
class RoleSchemaDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["createdBy", "createdDate", "id", "key", "lastModifiedBy", "lastModifiedDate", "projectId", "role"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "role": RoleDto.from_dict(obj["role"]) if obj.get("role") is not None else None
        })
        return _obj
