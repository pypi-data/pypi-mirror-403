...
class TestCaseBulkDragAndDropDtoV2(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["nodeId", "selection"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "selection": TestCaseTreeSelectionDtoV2.from_dict(obj["selection"]) if obj.get("selection") is not None else None
        })
        return _obj
