...
class TreeCustomFieldProjectDto(BaseModel):
    ...
    """ # noqa: E501
    custom_field: Optional[CustomFieldRawDto] = Field(default=None, alias="customField")
    ...
    __properties: ClassVar[List[str]] = ["customField", "defaultCustomFieldValueId", "id", "locked", "required"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "customField": CustomFieldRawDto.from_dict(obj["customField"]) if obj.get("customField") is not None else None,
