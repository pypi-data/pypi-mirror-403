...
class TestResultFlatDto(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["assignee", "createdDate", "duration", "flaky", "hidden", "id", "lastModifiedDate", "layerName", "manual", "name", "start", "status", "stop", "testCaseId", "testedBy"]
