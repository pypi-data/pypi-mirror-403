...
class DefaultWebhookSettings(WebhookSettings):
    ...
    subjects: Annotated[List[DefaultWebhookSettingsAllOfSubjects], Field(min_length=1)]
    __properties: ClassVar[List[str]] = ["type", "headers", "subjects"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subjects": [DefaultWebhookSettingsAllOfSubjects.from_dict(_item) for _item in obj["subjects"]] if obj.get("subjects") is not None else None
        })
        return _obj
