...
class TreePathDto(BaseModel):
    ...
    items: Optional[List[TreePathItemDto]] = None
    tree_id: Optional[StrictInt] = Field(default=None, alias="treeId")
    __properties: ClassVar[List[str]] = ["favorite", "id", "items", "treeId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "items": [TreePathItemDto.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
