...
class IntegrationInfoDto(BaseModel):
    ...
    operations: Optional[List[IntegrationOperationTypeDto]] = None
    routines: Optional[List[IntegrationRoutineTypeDto]] = None
    type: Optional[IntegrationTypeDto] = None
    __properties: ClassVar[List[str]] = ["description", "name", "operations", "routines", "type"]
