...
test_case_patch_v2_dto_instance = TestCasePatchV2Dto.from_json(json)
# print the JSON string representation of the object
print(TestCasePatchV2Dto.to_json())

# convert the object into a dict
test_case_patch_v2_dto_dict = test_case_patch_v2_dto_instance.to_dict()
# create an instance of TestCasePatchV2Dto from a dict
test_case_patch_v2_dto_from_dict = TestCasePatchV2Dto.from_dict(test_case_patch_v2_dto_dict)
```
