...
json = "{}"
# create an instance of PageTestCaseTreeNodeDto from a JSON string
page_test_case_tree_node_dto_instance = PageTestCaseTreeNodeDto.from_json(json)
# print the JSON string representation of the object
print(PageTestCaseTreeNodeDto.to_json())

# convert the object into a dict
page_test_case_tree_node_dto_dict = page_test_case_tree_node_dto_instance.to_dict()
# create an instance of PageTestCaseTreeNodeDto from a dict
