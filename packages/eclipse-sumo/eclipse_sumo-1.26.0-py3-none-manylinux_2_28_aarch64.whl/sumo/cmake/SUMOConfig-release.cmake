...
set_target_properties(SUMO::libsumocpp PROPERTIES
  IMPORTED_LINK_DEPENDENT_LIBRARIES_RELEASE "Parquet::parquet_shared"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libsumocpp.so"
  IMPORTED_SONAME_RELEASE "libsumocpp.so"
  )

list(APPEND _cmake_import_check_targets SUMO::libsumocpp )
list(APPEND _cmake_import_check_files_for_SUMO::libsumocpp "${_IMPORT_PREFIX}/lib64/libsumocpp.so" )
...
set_target_properties(SUMO::libtracicpp PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib64/libtracicpp.so"
  IMPORTED_SONAME_RELEASE "libtracicpp.so"
  )

list(APPEND _cmake_import_check_targets SUMO::libtracicpp )
list(APPEND _cmake_import_check_files_for_SUMO::libtracicpp "${_IMPORT_PREFIX}/lib64/libtracicpp.so" )
