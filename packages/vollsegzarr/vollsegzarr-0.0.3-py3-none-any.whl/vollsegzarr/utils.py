...
from .zarr_io import imread, imwrite, get_acceptable_formats
...
from vollsegzarr.matching import matching
from vollsegzarr.nmslabel import NMSLabel
from vollsegzarr.seedpool import SeedPool
from vollsegzarr.unetstarmask import UnetStarMask
...
class SegCorrect:
    def __init__(self, imagedir, segmentationdir):
        ...
        self.acceptable_formats = get_acceptable_formats()
