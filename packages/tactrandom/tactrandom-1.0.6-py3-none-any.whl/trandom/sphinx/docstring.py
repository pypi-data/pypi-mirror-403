...
from trandom.config import AVAILABLE_LOCALES, DEFAULT_LOCALE
from trandom.sphinx.validator import SampleCodeValidator

logger = logging.getLogger(__name__)
_fake = TRandom(AVAILABLE_LOCALES)
_base_provider_method_pattern: Pattern = re.compile(r"^trandom\.providers\.BaseProvider\.(?P<method>\w+)$")
_standard_provider_method_pattern: Pattern = re.compile(r"^trandom\.providers\.\w+\.Provider\.(?P<method>\w+)$")
