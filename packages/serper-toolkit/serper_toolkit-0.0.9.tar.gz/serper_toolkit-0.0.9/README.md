...
- `SERPER_MCP_ENABLE_STDIO`: <0/1>
- `SERPER_MCP_ENABLE_HTTP`: <0/1>
- `SERPER_MCP_ENABLE_SSE`: <0/1>
- `SERPER_MCP_HTTP_HOST`: <str, 127.0.0.1>
- `SERPER_MCP_HTTP_PORT`: <str, 7001>
- `SERPER_MCP_SSE_HOST`: <str, 127.0.0.1>
- `SERPER_MCP_SSE_PORT`: <str, 7001>
