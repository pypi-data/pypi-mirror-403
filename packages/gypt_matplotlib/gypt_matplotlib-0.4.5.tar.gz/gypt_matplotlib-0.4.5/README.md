...
[![pre-commit](https://codeberg.org/AlbertUnruh/gypt-matplotlib/badges/workflows/pre-commit.yaml/badge.svg)](https://codeberg.org/AlbertUnruh/gypt-matplotlib/actions?workflow=pre-commit.yaml)
[![PyTest](https://codeberg.org/AlbertUnruh/gypt-matplotlib/badges/workflows/pytest.yaml/badge.svg)](https://codeberg.org/AlbertUnruh/gypt-matplotlib/actions?workflow=pytest.yaml)
[![Publish](https://codeberg.org/AlbertUnruh/gypt-matplotlib/badges/workflows/publish.yaml/badge.svg)](https://codeberg.org/AlbertUnruh/gypt-matplotlib/actions?workflow=publish.yaml)
</br>
