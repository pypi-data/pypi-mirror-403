...
class Bool2():
    ...
    y : bool = json_element("y", bool, default=MISSING)
...
class Bool3():
    x : bool = json_element("x", bool, default=MISSING)
    y : bool = json_element("y", bool, default=MISSING)
    z : bool = json_element("z", bool, default=MISSING)
...
class Bool4():
    ...
    y : bool = json_element("y", bool, default=MISSING)
    z : bool = json_element("z", bool, default=MISSING)
    w : bool = json_element("w", bool, default=MISSING)


@json_model(internal_type_name="t_byte2")
class Byte2():
    x : int = json_element("x", int, default=MISSING)
    y : int = json_element("y", int, default=MISSING)
...
class Byte3():
    x : int = json_element("x", int, default=MISSING)
    y : int = json_element("y", int, default=MISSING)
    z : int = json_element("z", int, default=MISSING)
...
class Byte4():
    ...
    y : int = json_element("y", int, default=MISSING)
    z : int = json_element("z", int, default=MISSING)
    w : int = json_element("w", int, default=MISSING)
