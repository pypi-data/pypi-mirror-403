...
**Important: This package is no longer updated. Please install sopel-sports for use with Sopel 8.0 and higher.**

.. code-block::

    pip uninstall sopel_modules.sports
    pip install sopel-sports
