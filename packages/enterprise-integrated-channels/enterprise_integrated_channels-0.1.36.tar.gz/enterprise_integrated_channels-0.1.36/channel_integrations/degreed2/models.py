...
from channel_integrations.degreed2.transmitters.learner_data import Degreed2LearnerTransmitter
...
class Degreed2EnterpriseCustomerConfiguration(EnterpriseCustomerPluginConfiguration):
    ...
    enterprise_customer = models.ForeignKey(
        EnterpriseCustomer,
        related_name='degreed2_enterprisecustomerpluginconfiguration',
        blank=False,
        null=False,
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name='degreed2_ch_unique_enrollment_course_id'
            )
        ]
        indexes = [
