...
from channel_integrations.canvas.transmitters.learner_data import CanvasLearnerTransmitter
...
class CanvasEnterpriseCustomerConfiguration(EnterpriseCustomerPluginConfiguration):
    ...
    enterprise_customer = models.ForeignKey(
        EnterpriseCustomer,
        related_name='canvas_enterprisecustomerpluginconfiguration',
        blank=False,
        null=False,
