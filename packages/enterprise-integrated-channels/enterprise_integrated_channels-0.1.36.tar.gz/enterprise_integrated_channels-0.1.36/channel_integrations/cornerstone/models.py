...
from channel_integrations.cornerstone.transmitters.learner_data import CornerstoneLearnerTransmitter
...
class CornerstoneGlobalConfiguration(ConfigurationModel):
    ...
    changed_by = models.ForeignKey(
        ...
        related_name='cornerstone_global_configuration_changed_by'
    )
...
class CornerstoneEnterpriseCustomerConfiguration(EnterpriseCustomerPluginConfiguration):
    ...
    enterprise_customer = models.ForeignKey(
        EnterpriseCustomer,
        related_name='cornerstone_enterprisecustomerpluginconfiguration',
        blank=False,
        null=False,
...
class CornerstoneLearnerDataTransmissionAudit(LearnerDataTransmissionAudit):
    ...
    user = models.ForeignKey(
        ...
        blank=False,
        null=False,
        related_name='cornerstone_ch_transmission_audit',
