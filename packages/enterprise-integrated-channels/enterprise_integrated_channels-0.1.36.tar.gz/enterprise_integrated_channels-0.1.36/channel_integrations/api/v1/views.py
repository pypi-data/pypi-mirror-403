...
from channel_integrations.api.v1.moodle.serializers import MoodleConfigSerializer
from channel_integrations.api.v1.sap_success_factors.serializers import SAPSuccessFactorsConfigSerializer
...
from channel_integrations.integrated_channel.client import IntegratedChannelHealthStatus
from channel_integrations.integrated_channel.models import EnterpriseCustomerPluginConfiguration
...
from channel_integrations.utils import get_enterprise_client_by_channel_code


class IntegratedChannelsBaseViewSet(viewsets.ViewSet):
    """
    API views for the ``channel_integrations`` base configurations endpoint.
    """
    ...
    def list(self, request, *arg, **kwargs):
        ...
        response = blackboard_serializer.data + canvas_serializer.data + cornerstone_serializer.data + \
            degreed2_serializer.data + moodle_serializer.data + sap_serializer.data
