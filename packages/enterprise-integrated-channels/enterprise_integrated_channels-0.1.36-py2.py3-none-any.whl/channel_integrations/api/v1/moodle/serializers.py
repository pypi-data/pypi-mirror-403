...
class MoodleConfigSerializer(EnterpriseCustomerPluginConfigSerializer):
    ...
    password = serializers.CharField(required=False, allow_blank=True, write_only=False)
    username = serializers.CharField(required=False, allow_blank=True, write_only=False)
    token = serializers.CharField(required=False, allow_blank=True, write_only=False)
