# Generated by Django 4.2.17 on 2025-02-21 14:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('canvas_completed_timestamp', models.CharField(blank=True, help_text='Represents the canvas representation of a timestamp: yyyy-mm-dd, which is always 10 characters. Can be left unset for audit transmissions.', max_length=10, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decrypted_client_id', fernet_fields.fields.EncryptedCharField(blank=True, default='', help_text='The encrypted API Client ID provided to edX by the enterprise customer to be used to make API calls to Canvas on behalf of the customer. It will be encrypted when stored in the database.', max_length=255, null=True, verbose_name='Encrypted API Client ID')),
                ('decrypted_client_secret', fernet_fields.fields.EncryptedCharField(blank=True, default='', help_text='The encrypted API Client Secret provided to edX by the enterprise customer to be used to make  API calls to Canvas on behalf of the customer. It will be encrypted when stored in the database.', max_length=255, null=True, verbose_name='Encrypted API Client Secret')),
                ('canvas_account_id', models.BigIntegerField(blank=True, help_text='Account number to use during api calls. Called account_id in canvas.  Required to create courses etc.', null=True, verbose_name='Canvas Account Number')),
                ('canvas_base_url', models.CharField(blank=True, default='', help_text='The base URL used for API requests to Canvas, i.e. https://instructure.com.', max_length=255, verbose_name='Canvas Base URL')),
                ('refresh_token', models.CharField(blank=True, help_text='The refresh token provided by Canvas along with the access token request, used to re-request the access tokens over multiple client sessions.', max_length=255, verbose_name='Oauth2 Refresh Token')),
                ...
                ('enterprise_customer', models.ForeignKey(help_text='Enterprise Customer associated with the configuration.', on_delete=django.db.models.deletion.CASCADE, related_name='canvas_enterprisecustomerpluginconfiguration', to='enterprise.enterprisecustomer')),
            ],
        ),
        migrations.AddConstraint(
            model_name='canvaslearnerdatatransmissionaudit',
            constraint=models.UniqueConstraint(fields=('enterprise_course_enrollment_id', 'course_id'), name='canvas_channel_unique_enrollment_course_id'),
        ),
