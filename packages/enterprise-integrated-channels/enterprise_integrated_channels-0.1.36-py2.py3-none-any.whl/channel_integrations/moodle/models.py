...
from channel_integrations.moodle.transmitters.content_metadata import MoodleContentMetadataTransmitter
from channel_integrations.moodle.transmitters.learner_data import MoodleLearnerTransmitter
...
class MoodleEnterpriseCustomerConfiguration(EnterpriseCustomerPluginConfiguration):
    ...
    enterprise_customer = models.ForeignKey(
        EnterpriseCustomer,
        related_name='moodle_enterprisecustomerpluginconfiguration',
        blank=False,
        null=False,
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(
                ...
                name='moodle_ch_unique_enrollment_course_id'
            )
        ]
        indexes = [
