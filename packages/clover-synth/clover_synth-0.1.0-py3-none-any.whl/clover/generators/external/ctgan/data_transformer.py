...
class DataTransformer(object):
    ...
    def _fit_discrete(self, data, categories="auto"):
        ...
        if not isinstance(categories, str) or categories != "auto":
            ...
            ohe._dummy_na = null.any()
            ohe._num_dummies = len(ohe._uniques)
            ohe._indexer = list(range(ohe._num_dummies))
            ohe.dummies = ohe._uniques.copy()
    ...
    def fit(self, raw_data, discrete_columns=(), categories_dict={}):
        ...
        for column_name in raw_data.columns:
            if column_name in discrete_columns:
                if column_name in categories_dict.keys():
                    column_transform_info = self._fit_discrete(
                        raw_data[[column_name]], categories=categories_dict[column_name]
                    )
                else:
