...
**Embed 4D (3D + time)** — lightweight GLB/GLTF animation viewer with:
...
#### 2. 🤗 [Gradio](https://www.gradio.app/) integration

The file `embed4d/viewer.py` contains a small demo that compares:
...
Display 3D GLB/GLTF models directly in Jupyter notebook cells using `notebbok_viewer`. This function embeds the viewer as an iframe, making it easy to visualize models alongside your code.
...
notebbok_viewer("path/to/model.glb")

# Display with custom height
notebbok_viewer("model.glb", height=800)
