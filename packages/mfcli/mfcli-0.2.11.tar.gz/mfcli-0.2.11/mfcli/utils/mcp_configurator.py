...
def verify_and_prompt_mcp_setup() -> None:
    ...
    # Config files exist or Claude CLI exists, but mfcli-mcp is not configured
    assistant_count = len(config_paths) + (1 if has_claude_cli else 0)
    print(f"\n  ⚠️  Found {assistant_count} AI coding assistant(s) but mfcli-mcp")
