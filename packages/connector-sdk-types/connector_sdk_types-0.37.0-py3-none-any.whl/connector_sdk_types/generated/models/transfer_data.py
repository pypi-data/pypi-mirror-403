...
class TransferData(BaseModel):
    """
    Request payload for transferring data between accounts
    """

    source_account_id: StrictStr = Field(
        description="The unique identifier for the account in the third-party system that should be transferred",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransferData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransferData from a dict"""
        if obj is None:
            return None
