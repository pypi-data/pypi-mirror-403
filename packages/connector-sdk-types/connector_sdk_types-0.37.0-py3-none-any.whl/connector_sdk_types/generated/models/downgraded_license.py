...
class DowngradedLicense(BaseModel):
    """
    Details about the released resources
    """ # noqa: E501
    success: StrictBool = Field(description="Whether the license was successfully downgraded")
    reason: Optional[StrictStr] = Field(default=None, description="A message providing additional information about the downgrade status, optional, but if the status was not successful, this should contain details about the failure.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DowngradedLicense from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DowngradedLicense from a dict"""
        if obj is None:
            return None
