...
class CreatedEffect(BaseModel):
    """
    Effect indicating a new record was created in the target system.
    """

    kind: StrictStr = Field(default="created")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreatedEffect from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreatedEffect from a dict"""
        if obj is None:
            return None
        if not isinstance(obj, dict):
            return cls.model_validate(obj)
        _obj = cls.model_validate(
            {"kind": obj.get("kind") if obj.get("kind") is not None else "created"}
        )
        return _obj
