...
class ActivityRecordEntitlement(BaseModel):
    """
    Entitlement affected by the activity. This could represent a role, permission, feature, etc.
    """

    id: StrictStr = Field(
        description="Unique ID of the entitlement (e.g., ARN, internal ID)",
        json_schema_extra={"x-semantic": "entitlement-id"},
    )
    type: StrictStr = Field(
        description='Type of the entitlement (e.g., "Role", "Permission", "Feature")'
    )
    resource_id: Optional[StrictStr] = Field(
        default=None,
        description="Optional ID of the associated resource (e.g., AWS account ID)",
        json_schema_extra={"x-semantic": "resource-id"},
    )
    resource_type: Optional[StrictStr] = Field(
        default=None,
        description='Optional type of the associated resource (e.g., "AWSAccount", "Application")',
    )
    __properties: ClassVar[List[str]] = ["id", "type", "resource_id", "resource_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ActivityRecordEntitlement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ActivityRecordEntitlement from a dict"""
        if obj is None:
            return None
