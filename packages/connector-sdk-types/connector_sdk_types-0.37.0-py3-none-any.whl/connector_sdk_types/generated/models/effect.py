...
EFFECT_ANY_OF_SCHEMAS = ["CreatedEffect", "DeletedEffect", "NoopEffect", "UpdatedEffect"]

class Effect(BaseModel):
    """
    Discriminated union of all possible execution effects.  The discriminator field 'kind' determines which effect type is present.
    """

    # data type: CreatedEffect
    anyof_schema_1_validator: Optional[CreatedEffect] = None
    # data type: UpdatedEffect
    anyof_schema_2_validator: Optional[UpdatedEffect] = None
    # data type: DeletedEffect
    anyof_schema_3_validator: Optional[DeletedEffect] = None
    # data type: NoopEffect
    anyof_schema_4_validator: Optional[NoopEffect] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[CreatedEffect, DeletedEffect, NoopEffect, UpdatedEffect]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "CreatedEffect", "DeletedEffect", "NoopEffect", "UpdatedEffect" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        error_messages = []
        # validate data type: CreatedEffect
        if not isinstance(v, CreatedEffect):
            error_messages.append(f"Error! Input type `{type(v)}` is not `CreatedEffect`")
        else:
            return v

        # validate data type: UpdatedEffect
        if not isinstance(v, UpdatedEffect):
            error_messages.append(f"Error! Input type `{type(v)}` is not `UpdatedEffect`")
        else:
            return v

        # validate data type: DeletedEffect
        if not isinstance(v, DeletedEffect):
            error_messages.append(f"Error! Input type `{type(v)}` is not `DeletedEffect`")
        else:
            return v

        # validate data type: NoopEffect
        if not isinstance(v, NoopEffect):
            error_messages.append(f"Error! Input type `{type(v)}` is not `NoopEffect`")
        else:
            return v

        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in Effect with anyOf schemas: CreatedEffect, DeletedEffect, NoopEffect, UpdatedEffect. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[CreatedEffect] = None
        try:
            instance.actual_instance = CreatedEffect.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_2_validator: Optional[UpdatedEffect] = None
        try:
            instance.actual_instance = UpdatedEffect.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_3_validator: Optional[DeletedEffect] = None
        try:
            instance.actual_instance = DeletedEffect.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        # anyof_schema_4_validator: Optional[NoopEffect] = None
        try:
            instance.actual_instance = NoopEffect.from_json(json_str)
            return instance
        except (ValidationError, ValueError) as e:
             error_messages.append(str(e))
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into Effect with anyOf schemas: CreatedEffect, DeletedEffect, NoopEffect, UpdatedEffect. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], CreatedEffect, DeletedEffect, NoopEffect, UpdatedEffect]]:
