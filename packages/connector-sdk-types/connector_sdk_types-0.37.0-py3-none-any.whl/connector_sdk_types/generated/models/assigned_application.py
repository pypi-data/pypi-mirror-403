...
class AssignedApplication(BaseModel):
    """
    Details about the assigned application
    """ # noqa: E501
    assigned: StrictBool = Field(description="Indicates if an account is assigned to an application via the integration. This does not reflect if the account has actually been created in the application.")
    provisioned: StrictBool = Field(description="Indicates if an account has been created in the application via the integration This does not indicate if the integration account has been assigned via the integration")
    __properties: ClassVar[List[str]] = ["assigned", "provisioned"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssignedApplication from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssignedApplication from a dict"""
        if obj is None:
            return None
