...
class ValidatedCredentials(BaseModel):
    ...
    """ # noqa: E501
    valid: StrictBool = Field(description="Indicates whether the provided credentials are valid and active.  - true: Credentials are valid and can be used for API operations - false: Credentials are invalid, expired, or revoked")
    unique_tenant_id: StrictStr = Field(description="The unique identifier for the customer's tenant/organization in the integrated application. This ID is used to scope operations and resources to the correct tenant.  The format varies by connector: - AWS: Account ID - GitHub: Organization name - PagerDuty: Subdomain - Azure: Tenant ID - Google Workspace: Domain name  This ID should be stable and not change for the lifetime of the tenant.")
