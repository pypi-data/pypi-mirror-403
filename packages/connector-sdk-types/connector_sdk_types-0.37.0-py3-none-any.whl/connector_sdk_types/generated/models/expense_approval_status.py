...
from connector_sdk_types.generated.models.normalized_expense_approval_status import NormalizedExpenseApprovalStatus
from typing import Optional, Set
from typing_extensions import Self

class ExpenseApprovalStatus(BaseModel):
    """
    ExpenseApprovalStatus
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="A unique, stable identifier for the approval status, in the source system. This will often exist when the source system has a concept of \"custom\" statuses")
    display_value: Optional[StrictStr] = Field(default=None, description="A user-friendly display value for the approval status")
    value: Optional[StrictStr] = Field(default=None, description="The raw value used in the source system")
    normalized_value: NormalizedExpenseApprovalStatus = Field(description="A normalized representation of approval status")
    __properties: ClassVar[List[str]] = ["id", "display_value", "value", "normalized_value"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExpenseApprovalStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExpenseApprovalStatus from a dict"""
        if obj is None:
            return None
