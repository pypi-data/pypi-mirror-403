...
class ListExpensesResponse(BaseModel):
    """
    Response containing information about the expenses
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": [Expense.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
