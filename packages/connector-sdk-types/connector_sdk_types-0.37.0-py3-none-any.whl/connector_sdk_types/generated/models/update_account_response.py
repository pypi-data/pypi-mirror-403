...
class UpdateAccountResponse(BaseModel):
    """
    Response containing the result of the account update.  The returned type should be the same as the input.
    """ # noqa: E501
    response: UpdateableAccount
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": UpdateableAccount.from_dict(obj["response"]) if obj.get("response") is not None else None,
