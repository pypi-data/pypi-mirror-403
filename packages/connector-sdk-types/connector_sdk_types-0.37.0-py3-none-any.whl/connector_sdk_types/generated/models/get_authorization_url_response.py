...
class GetAuthorizationUrlResponse(BaseModel):
    """
    Response containing the OAuth authorization URL and related data.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAuthorizationUrlResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAuthorizationUrlResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "response": AuthorizationUrl.from_dict(obj["response"]) if obj.get("response") is not None else None,
