...
class OAuthClientCredentialAuthorization(BaseModel):
    """
    OAuth Client Credential Authorization model. This is a model exclusively used by authorization capabilities.
    """

    client_id: StrictStr = HiddenField(description="The OAuth client id.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OAuthClientCredentialAuthorization from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OAuthClientCredentialAuthorization from a dict"""
        if obj is None:
            return None
