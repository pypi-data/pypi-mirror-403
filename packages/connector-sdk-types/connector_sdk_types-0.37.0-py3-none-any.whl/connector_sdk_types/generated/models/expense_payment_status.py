...
from connector_sdk_types.generated.models.normalized_expense_payment_status import NormalizedExpensePaymentStatus
...
class ExpensePaymentStatus(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="A unique, stable identifier for the payment status, in the source system. This will often exist when the source system has a concept of \"custom\" statuses")
    display_value: Optional[StrictStr] = Field(default=None, description="A user-friendly display value for the payment status")
    value: Optional[StrictStr] = Field(default=None, description="The raw value used in the source system")
    normalized_value: NormalizedExpensePaymentStatus = Field(description="A normalized representation of payment status")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExpensePaymentStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExpensePaymentStatus from a dict"""
        if obj is None:
            return None
