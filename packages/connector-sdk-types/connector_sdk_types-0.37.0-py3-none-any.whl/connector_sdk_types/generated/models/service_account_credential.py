...
class ServiceAccountCredential(BaseModel):
    ...
    scopes: List[StrictStr] = HiddenField(
    ...
    model_config = ConfigDict(
        ...
        json_schema_extra={"x-credential-type": "service_account"},
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServiceAccountCredential from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServiceAccountCredential from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "key": obj.get("key"),
                "impersonation_email": obj.get("impersonation_email"),
