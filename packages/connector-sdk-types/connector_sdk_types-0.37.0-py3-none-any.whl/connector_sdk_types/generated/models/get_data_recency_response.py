...
from connector_sdk_types.generated.models.data_recency import DataRecency
...
class GetDataRecencyResponse(BaseModel):
    """
    Response containing data recency information for standard capabilities.  This response model wraps the DataRecency data and provides standard response metadata including success status and any error information.
    """ # noqa: E501
    response: DataRecency
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDataRecencyResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDataRecencyResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "response": DataRecency.from_dict(obj["response"]) if obj.get("response") is not None else None,
