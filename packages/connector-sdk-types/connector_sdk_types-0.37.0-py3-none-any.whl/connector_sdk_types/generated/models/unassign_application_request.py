...
from connector_sdk_types.generated.models.unassign_application import UnassignApplication
from typing import Optional, Set
from typing_extensions import Self

class UnassignApplicationRequest(BaseModel):
    """
    ...
    request: UnassignApplication = Field(description="The main request payload.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UnassignApplicationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UnassignApplicationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "request": UnassignApplication.from_dict(obj["request"]) if obj.get("request") is not None else None,
