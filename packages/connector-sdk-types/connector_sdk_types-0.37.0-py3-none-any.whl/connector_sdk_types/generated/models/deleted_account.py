...
class DeletedAccount(BaseModel):
    """
    Details about the deleted account
    """ # noqa: E501
    status: AccountStatus = Field(description="The current status of the account after deletion")
    deleted: StrictBool = Field(description="Legacy flag indicating successful account deletion")
    __properties: ClassVar[List[str]] = ["status", "deleted"]
