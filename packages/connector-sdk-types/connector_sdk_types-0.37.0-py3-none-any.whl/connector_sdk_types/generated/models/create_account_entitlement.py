...
class CreateAccountEntitlement(BaseModel):
    ...
    integration_specific_resource_id: Optional[StrictStr] = Field(
        default=None,
        description="The unique identifier for the resource in the third-party system that the entitlement will be assigned to. For global resources (e.g. global roles), this should be an empty string or leave blank. For scoped resources (e.g. workspace-specific roles), this should be the resource ID (e.g. workspace ID).",
    )
