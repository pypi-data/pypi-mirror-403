...
class ListActivityRecords(BaseModel):
    """
    Request payload for listing activity records.
    """

    since_date: StrictStr = Field(description="Date to look back from (ISO 8601 format)")
    actors: List[ActivityRecordActor]
    __properties: ClassVar[List[str]] = ["since_date", "actors"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListActivityRecords from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListActivityRecords from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "actors": [ActivityRecordActor.from_dict(_item) for _item in obj["actors"]]
