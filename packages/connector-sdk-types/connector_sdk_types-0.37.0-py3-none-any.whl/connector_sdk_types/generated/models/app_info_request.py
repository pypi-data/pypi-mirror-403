...
class AppInfoRequest(BaseModel):
    """
    Optionally authenticated app_info request. Used for the app_info capability to optionally supply a authentication model.
    """ # noqa: E501
    ...
    request: AppInfoRequestPayload = Field(description="The main request payload.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppInfoRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppInfoRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "request": AppInfoRequestPayload.from_dict(obj["request"]) if obj.get("request") is not None else None,
