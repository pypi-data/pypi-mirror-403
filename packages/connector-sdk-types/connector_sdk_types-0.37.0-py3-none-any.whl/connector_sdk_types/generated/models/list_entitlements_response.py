...
class ListEntitlementsResponse(BaseModel):
    ...
    """ # noqa: E501
    response: List[FoundEntitlementData]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListEntitlementsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListEntitlementsResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "response": [FoundEntitlementData.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
