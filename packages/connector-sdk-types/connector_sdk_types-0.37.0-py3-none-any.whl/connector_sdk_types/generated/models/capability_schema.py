...
class CapabilitySchema(BaseModel):
    ...
    display_name: Optional[StrictStr] = Field(default=None, description="An optional text to display for the integration capability, in place of the default behavior, which is to use the capability name.")
    ...
    __properties: ClassVar[List[str]] = ["argument", "output", "display_name", "description"]
