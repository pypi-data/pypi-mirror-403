...
class JWTHeaders(BaseModel):
    ...
    JWT headers model.
    """ # noqa: E501
    alg: StrictStr = Field(description="The JWT algorithm.")
    jku: StrictStr = Field(description="JWK Set URL.")
    jwk: StrictStr = Field(description="JWK.")
    typ: StrictStr = Field(description="The JWT type.")
    kid: StrictStr = Field(description="The JWT key ID.")
    x5u: StrictStr = Field(description="The X509 URL.")
    x5c: StrictStr = Field(description="The X509 certificate chain.")
    x5t: StrictStr = Field(description="The X509 certificate SHA-1 thumbprint.")
    x5t_s256: StrictStr = Field(description="The X509 certificate SHA-256 thumbprint.", alias="x5t#S256")
    cty: StrictStr = Field(description="The content type of the JWT.")
    crit: List[StrictStr] = Field(description="The JWT critical extension.")
