...
class AssignedApplicationEntitlement(BaseModel):
    """
    Details about the application entitlement assignment result
    """ # noqa: E501
    assigned: StrictBool = Field(description="This should only ever be true. If the assignment can't happen we expect an error.")
    __properties: ClassVar[List[str]] = ["assigned"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssignedApplicationEntitlement from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssignedApplicationEntitlement from a dict"""
        if obj is None:
            return None
