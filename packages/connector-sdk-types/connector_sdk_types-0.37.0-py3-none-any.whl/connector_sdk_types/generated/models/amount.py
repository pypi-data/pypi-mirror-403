...
class Amount(BaseModel):
    """
    An amount used in a financial system
    """ # noqa: E501
    amount: StrictStr = Field(description="An amount, stored as a decimal string")
    currency: StrictStr = Field(description="A currency, in ISO 4217 format")
