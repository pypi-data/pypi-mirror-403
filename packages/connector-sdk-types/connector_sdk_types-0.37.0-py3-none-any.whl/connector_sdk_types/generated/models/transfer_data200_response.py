...
class TransferData200Response(BaseModel):
    ...
    # data type: TransferDataResponse
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        error_messages = []
        # validate data type: TransferDataResponse
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in TransferData200Response with anyOf schemas: ErrorResponse, TransferDataResponse. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into TransferData200Response with anyOf schemas: ErrorResponse, TransferDataResponse. Details: " + ", ".join(error_messages))
        else:
            return instance
