...
class OAuthScopes(BaseModel):
    """
    Map of capabilities to OAuth scopes.  This is used to determine the OAuth scopes required for a given capability.  If a capability is not listed, it is assumed to not require any OAuth scopes.  Scopes are a space-delimited list of scope names.
    """ # noqa: E501
    activate_account: Optional[StrictStr] = None
    assign_entitlement: Optional[StrictStr] = None
    create_account: Optional[StrictStr] = None
    deactivate_account: Optional[StrictStr] = None
    delete_account: Optional[StrictStr] = None
    find_entitlement_associations: Optional[StrictStr] = None
    get_last_activity: Optional[StrictStr] = None
    list_accounts: Optional[StrictStr] = None
    list_custom_attributes_schema: Optional[StrictStr] = None
    list_entitlements: Optional[StrictStr] = None
    list_resources: Optional[StrictStr] = None
    unassign_entitlement: Optional[StrictStr] = None
    validate_credentials: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["activate_account", "assign_entitlement", "create_account", "deactivate_account", "delete_account", "find_entitlement_associations", "get_last_activity", "list_accounts", "list_custom_attributes_schema", "list_entitlements", "list_resources", "unassign_entitlement", "validate_credentials"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OAuthScopes from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OAuthScopes from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "activate_account": obj.get("activate_account"),
            "assign_entitlement": obj.get("assign_entitlement"),
            "create_account": obj.get("create_account"),
            "deactivate_account": obj.get("deactivate_account"),
            "delete_account": obj.get("delete_account"),
            "find_entitlement_associations": obj.get("find_entitlement_associations"),
            "get_last_activity": obj.get("get_last_activity"),
            "list_accounts": obj.get("list_accounts"),
            "list_custom_attributes_schema": obj.get("list_custom_attributes_schema"),
            "list_entitlements": obj.get("list_entitlements"),
            "list_resources": obj.get("list_resources"),
            "unassign_entitlement": obj.get("unassign_entitlement"),
            "validate_credentials": obj.get("validate_credentials")
        })
        return _obj
