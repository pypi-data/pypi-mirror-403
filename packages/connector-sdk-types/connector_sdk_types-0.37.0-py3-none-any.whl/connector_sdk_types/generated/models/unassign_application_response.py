...
from connector_sdk_types.generated.models.unassigned_application import UnassignedApplication
from typing import Optional, Set
from typing_extensions import Self

class UnassignApplicationResponse(BaseModel):
    """
    Response containing the result of the unassignment
    """ # noqa: E501
    response: UnassignedApplication
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UnassignApplicationResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UnassignApplicationResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "response": UnassignedApplication.from_dict(obj["response"]) if obj.get("response") is not None else None,
