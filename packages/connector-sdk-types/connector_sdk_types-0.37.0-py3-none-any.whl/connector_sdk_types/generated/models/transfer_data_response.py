...
class TransferDataResponse(BaseModel):
    """
    Response containing the status of the transfer.
    """ # noqa: E501
    response: TransferDataStatus
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransferDataResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransferDataResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "response": TransferDataStatus.from_dict(obj["response"]) if obj.get("response") is not None else None,
