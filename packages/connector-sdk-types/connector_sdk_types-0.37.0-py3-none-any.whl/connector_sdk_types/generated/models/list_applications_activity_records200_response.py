...
from connector_sdk_types.generated.models.list_applications_activity_records_response import ListApplicationsActivityRecordsResponse
from typing import Union, Any, List, Set, TYPE_CHECKING, Optional, Dict
from typing_extensions import Literal, Self
from pydantic import Field

LISTAPPLICATIONSACTIVITYRECORDS200RESPONSE_ANY_OF_SCHEMAS = ["ErrorResponse", "ListApplicationsActivityRecordsResponse"]

class ListApplicationsActivityRecords200Response(BaseModel):
    """
    ListApplicationsActivityRecords200Response
    """

    # data type: ListApplicationsActivityRecordsResponse
    anyof_schema_1_validator: Optional[ListApplicationsActivityRecordsResponse] = None
    # data type: ErrorResponse
    anyof_schema_2_validator: Optional[ErrorResponse] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[ErrorResponse, ListApplicationsActivityRecordsResponse]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "ErrorResponse", "ListApplicationsActivityRecordsResponse" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ListApplicationsActivityRecords200Response.model_construct()
        error_messages = []
        # validate data type: ListApplicationsActivityRecordsResponse
        if not isinstance(v, ListApplicationsActivityRecordsResponse):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ListApplicationsActivityRecordsResponse`")
        else:
            return v
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ListApplicationsActivityRecords200Response with anyOf schemas: ErrorResponse, ListApplicationsActivityRecordsResponse. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[ListApplicationsActivityRecordsResponse] = None
        try:
            instance.actual_instance = ListApplicationsActivityRecordsResponse.from_json(json_str)
            return instance
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ListApplicationsActivityRecords200Response with anyOf schemas: ErrorResponse, ListApplicationsActivityRecordsResponse. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], ErrorResponse, ListApplicationsActivityRecordsResponse]]:
