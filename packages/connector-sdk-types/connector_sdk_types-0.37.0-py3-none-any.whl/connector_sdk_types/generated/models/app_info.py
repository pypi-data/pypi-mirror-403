...
class AppInfo(BaseModel):
    ...
    """ # noqa: E501
    app_id: StrictStr
    app_schema: Dict[str, Any] = Field(description="The connector OpenAPI specification")
    __properties: ClassVar[List[str]] = ["app_id", "app_schema"]
