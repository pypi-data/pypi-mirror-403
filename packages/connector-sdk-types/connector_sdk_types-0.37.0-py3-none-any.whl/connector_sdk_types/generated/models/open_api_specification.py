...
from connector_sdk_types.generated.models.open_api_specification_info import OpenAPISpecificationInfo
...
class OpenAPISpecification(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["openapi", "info", "servers", "paths", "components", "tags"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OpenAPISpecification from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OpenAPISpecification from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "info": OpenAPISpecificationInfo.from_dict(obj["info"]) if obj.get("info") is not None else None,
