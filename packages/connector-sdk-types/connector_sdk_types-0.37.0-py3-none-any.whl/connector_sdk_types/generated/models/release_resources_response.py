...
class ReleaseResourcesResponse(BaseModel):
    """
    Response containing the status of the released resources.
    """ # noqa: E501
    response: ReleaseResourcesStatus
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ReleaseResourcesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ReleaseResourcesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "response": ReleaseResourcesStatus.from_dict(obj["response"]) if obj.get("response") is not None else None,
