...
from connector_sdk_types.generated.models.list_updated_accounts import ListUpdatedAccounts
from connector_sdk_types.generated.models.page import Page
from typing import Optional, Set
from typing_extensions import Self

class ListUpdatedAccountsRequest(BaseModel):
    """
    ...
    request: ListUpdatedAccounts = Field(description="The main request payload.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListUpdatedAccountsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListUpdatedAccountsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "request": ListUpdatedAccounts.from_dict(obj["request"]) if obj.get("request") is not None else None,
