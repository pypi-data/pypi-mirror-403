...
class SpendUser(BaseModel):
    """
    SpendUser
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="An unique, stable identifier for the user, in the source system")
    email: Optional[StrictStr] = Field(default=None, description="An email for the user")
    full_name: Optional[StrictStr] = Field(default=None, description="The full name of the user")
    given_name: Optional[StrictStr] = Field(default=None, description="The given name of the user")
    family_name: Optional[StrictStr] = Field(default=None, description="The family name of the user")
    __properties: ClassVar[List[str]] = ["id", "email", "full_name", "given_name", "family_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SpendUser from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SpendUser from a dict"""
        if obj is None:
            return None
