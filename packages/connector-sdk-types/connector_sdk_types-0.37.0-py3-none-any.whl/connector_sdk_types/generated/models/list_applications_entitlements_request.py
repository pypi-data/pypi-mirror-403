...
from connector_sdk_types.generated.models.list_applications_entitlements import ListApplicationsEntitlements
from connector_sdk_types.generated.models.page import Page
from typing import Optional, Set
from typing_extensions import Self

class ListApplicationsEntitlementsRequest(BaseModel):
    """
    ...
    request: ListApplicationsEntitlements = Field(description="The main request payload.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListApplicationsEntitlementsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListApplicationsEntitlementsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "request": ListApplicationsEntitlements.from_dict(obj["request"]) if obj.get("request") is not None else None,
