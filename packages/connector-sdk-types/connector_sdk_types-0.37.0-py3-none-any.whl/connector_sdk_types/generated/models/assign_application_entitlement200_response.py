...
from connector_sdk_types.generated.models.assign_application_entitlement_response import AssignApplicationEntitlementResponse
from connector_sdk_types.generated.models.error_response import ErrorResponse
from typing import Union, Any, List, Set, TYPE_CHECKING, Optional, Dict
from typing_extensions import Literal, Self
from pydantic import Field

ASSIGNAPPLICATIONENTITLEMENT200RESPONSE_ANY_OF_SCHEMAS = ["AssignApplicationEntitlementResponse", "ErrorResponse"]

class AssignApplicationEntitlement200Response(BaseModel):
    """
    AssignApplicationEntitlement200Response
    """

    # data type: AssignApplicationEntitlementResponse
    anyof_schema_1_validator: Optional[AssignApplicationEntitlementResponse] = None
    # data type: ErrorResponse
    anyof_schema_2_validator: Optional[ErrorResponse] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[AssignApplicationEntitlementResponse, ErrorResponse]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "AssignApplicationEntitlementResponse", "ErrorResponse" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = AssignApplicationEntitlement200Response.model_construct()
        error_messages = []
        # validate data type: AssignApplicationEntitlementResponse
        if not isinstance(v, AssignApplicationEntitlementResponse):
            error_messages.append(f"Error! Input type `{type(v)}` is not `AssignApplicationEntitlementResponse`")
        else:
            return v
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in AssignApplicationEntitlement200Response with anyOf schemas: AssignApplicationEntitlementResponse, ErrorResponse. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[AssignApplicationEntitlementResponse] = None
        try:
            instance.actual_instance = AssignApplicationEntitlementResponse.from_json(json_str)
            return instance
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into AssignApplicationEntitlement200Response with anyOf schemas: AssignApplicationEntitlementResponse, ErrorResponse. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], AssignApplicationEntitlementResponse, ErrorResponse]]:
