...
class ExecutionEffect(str, Enum):
    """
    The outcome or result of executing a write operation (create, update, delete, etc.).  This enum describes what actually happened in the target system as a result of the operation.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ExecutionEffect from a JSON string"""
