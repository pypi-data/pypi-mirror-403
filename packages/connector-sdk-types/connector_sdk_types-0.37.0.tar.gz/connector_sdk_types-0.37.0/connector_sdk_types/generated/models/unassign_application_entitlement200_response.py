...
from connector_sdk_types.generated.models.unassign_application_entitlement_response import UnassignApplicationEntitlementResponse
from typing import Union, Any, List, Set, TYPE_CHECKING, Optional, Dict
from typing_extensions import Literal, Self
from pydantic import Field

UNASSIGNAPPLICATIONENTITLEMENT200RESPONSE_ANY_OF_SCHEMAS = ["ErrorResponse", "UnassignApplicationEntitlementResponse"]

class UnassignApplicationEntitlement200Response(BaseModel):
    """
    UnassignApplicationEntitlement200Response
    """

    # data type: UnassignApplicationEntitlementResponse
    anyof_schema_1_validator: Optional[UnassignApplicationEntitlementResponse] = None
    # data type: ErrorResponse
    anyof_schema_2_validator: Optional[ErrorResponse] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[ErrorResponse, UnassignApplicationEntitlementResponse]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "ErrorResponse", "UnassignApplicationEntitlementResponse" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = UnassignApplicationEntitlement200Response.model_construct()
        error_messages = []
        # validate data type: UnassignApplicationEntitlementResponse
        if not isinstance(v, UnassignApplicationEntitlementResponse):
            error_messages.append(f"Error! Input type `{type(v)}` is not `UnassignApplicationEntitlementResponse`")
        else:
            return v
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in UnassignApplicationEntitlement200Response with anyOf schemas: ErrorResponse, UnassignApplicationEntitlementResponse. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[UnassignApplicationEntitlementResponse] = None
        try:
            instance.actual_instance = UnassignApplicationEntitlementResponse.from_json(json_str)
            return instance
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into UnassignApplicationEntitlement200Response with anyOf schemas: ErrorResponse, UnassignApplicationEntitlementResponse. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], ErrorResponse, UnassignApplicationEntitlementResponse]]:
