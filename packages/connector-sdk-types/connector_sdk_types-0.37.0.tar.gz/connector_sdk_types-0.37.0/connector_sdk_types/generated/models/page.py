...
class Page(BaseModel):
    ...
    """ # noqa: E501
    token: Optional[StrictStr] = Field(default=None, description="Opaque token representing the next page of results. Include this token in subsequent requests to retrieve the next page.")
    size: Optional[StrictInt] = Field(default=None, description="Number of items to return per page. This should remain consistent throughout a pagination sequence.")
    __properties: ClassVar[List[str]] = ["token", "size"]
