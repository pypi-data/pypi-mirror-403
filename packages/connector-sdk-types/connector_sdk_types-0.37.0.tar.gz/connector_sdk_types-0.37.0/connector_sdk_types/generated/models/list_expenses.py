...
class ListExpenses(BaseModel):
    """
    Request parameters for listing expenses.
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListExpenses from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListExpenses from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "filters": ExpenseFilters.from_dict(obj["filters"]) if obj.get("filters") is not None else None
        })
        return _obj
