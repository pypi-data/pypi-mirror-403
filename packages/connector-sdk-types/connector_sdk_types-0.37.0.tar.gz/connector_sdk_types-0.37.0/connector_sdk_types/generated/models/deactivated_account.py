...
class DeactivatedAccount(BaseModel):
    """
    Details about the deactivated account
    """ # noqa: E501
    status: AccountStatus = Field(description="The current status of the account after deactivation")
    deactivated: StrictBool = Field(description="Legacy flag indicating successful account deactivation")
    __properties: ClassVar[List[str]] = ["status", "deactivated"]
