...
class ValidateCredentialConfig(BaseModel):
    """
    ...
    model_config = ConfigDict(
        ...
        json_schema_extra={"x-capability-level": "validation"},
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ValidateCredentialConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ValidateCredentialConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                "credential": AuthCredential.from_dict(obj["credential"])
