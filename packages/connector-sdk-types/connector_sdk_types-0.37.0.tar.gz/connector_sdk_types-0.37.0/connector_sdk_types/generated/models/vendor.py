...
class Vendor(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="An identifier for a company, in a source system")
    name: Optional[StrictStr] = Field(default=None, description="The name of a company")
    description: Optional[StrictStr] = Field(default=None, description="A description of a company")
