...
class EntitlementType(BaseModel):
    """
    All the things we need to know about an entitlement type in this app.
    """ # noqa: E501
    type_id: StrictStr = Field(description="A unique identifier for this entitlement type.")
    type_label: StrictStr = Field(description="A human-readable label for this entitlement type.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EntitlementType from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EntitlementType from a dict"""
        if obj is None:
            return None
