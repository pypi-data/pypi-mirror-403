...
class ActivateAccount200Response(BaseModel):
    ...
    # data type: ActivateAccountResponse
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        error_messages = []
        # validate data type: ActivateAccountResponse
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ActivateAccount200Response with anyOf schemas: ActivateAccountResponse, ErrorResponse. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ActivateAccount200Response with anyOf schemas: ActivateAccountResponse, ErrorResponse. Details: " + ", ".join(error_messages))
        else:
            return instance
