...
class JWTClaims(BaseModel):
    ...
    """ # noqa: E501
    iss: StrictStr = Field(description="The issuer of the JWT.")
    sub: StrictStr = Field(description="The subject of the JWT.")
    aud: StrictStr = Field(description="The audience of the JWT.")
    exp: StrictInt = Field(description="The expiration time of the JWT in seconds since the Unix epoch.")
    nbf: StrictInt = Field(description="The not before time of the JWT in seconds since the Unix epoch.")
    iat: StrictInt = Field(description="The issue time of the JWT in seconds since the Unix epoch.")
    jti: StrictStr = Field(description="The JWT ID.")
    act: StrictStr = Field(description="The Actor of the JWT.")
    scope: List[StrictStr] = Field(description="Scopes granted to the JWT.")
    client_id: StrictStr = Field(description="The client ID of the JWT.")
    may_act: StrictStr = Field(description="The may_act of the JWT.")
