...
class ResourceType(BaseModel):
    """
    A type of resource in the connector.
    """ # noqa: E501
    type_id: StrictStr = Field(description="A unique identifier for this resource type.")
    type_label: StrictStr = Field(description="A human-readable label for this resource type.")
    __properties: ClassVar[List[str]] = ["type_id", "type_label"]
