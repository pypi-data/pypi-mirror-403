...
class UpdatedEffect(BaseModel):
    """
    Effect indicating an existing record was modified in the target system.
    """

    kind: StrictStr = Field(default="updated")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpdatedEffect from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpdatedEffect from a dict"""
        if obj is None:
            return None
        if not isinstance(obj, dict):
            return cls.model_validate(obj)
        _obj = cls.model_validate(
            {"kind": obj.get("kind") if obj.get("kind") is not None else "updated"}
        )
        return _obj
