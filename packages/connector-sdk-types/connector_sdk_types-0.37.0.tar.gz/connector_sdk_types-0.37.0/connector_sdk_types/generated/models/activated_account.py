...
class ActivatedAccount(BaseModel):
    """
    Details about the activated account
    """ # noqa: E501
    status: AccountStatus = Field(description="The current status of the account after the activation attempt")
    activated: StrictBool = Field(description="Whether the account was successfully activated")
    __properties: ClassVar[List[str]] = ["status", "activated"]
