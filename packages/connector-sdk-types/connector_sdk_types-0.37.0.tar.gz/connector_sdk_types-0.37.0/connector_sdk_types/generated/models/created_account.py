...
class CreatedAccount(BaseModel):
    ...
    status: AccountStatus = Field(description="The current status of the created account")
    created: StrictBool = Field(description="Legacy flag indicating successful account creation")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate(
            {"id": obj.get("id"), "status": obj.get("status"), "created": obj.get("created")}
        )
        return _obj
