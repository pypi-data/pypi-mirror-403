...
class AppInfoRequestPayload(BaseModel):
    """
    ...
    model_config = ConfigDict(
        ...
        json_schema_extra={"x-capability-category": "specification"},
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AppInfoRequestPayload from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AppInfoRequestPayload from a dict"""
        if obj is None:
            return None
