...
class LastActivityData(BaseModel):
    """
    Last known activity data for a user account.
    """ # noqa: E501
    account_id: StrictStr = Field(description="The ID of the account.")
    event_type: StrictStr = Field(description="The type of activity event.")
    happened_at: StrictStr = Field(description="The timestamp when the activity occurred.")
    __properties: ClassVar[List[str]] = ["account_id", "event_type", "happened_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LastActivityData from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LastActivityData from a dict"""
        if obj is None:
            return None
