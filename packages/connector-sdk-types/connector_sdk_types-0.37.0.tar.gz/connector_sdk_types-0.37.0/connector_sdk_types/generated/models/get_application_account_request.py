...
from connector_sdk_types.generated.models.get_application_account import GetApplicationAccount
from connector_sdk_types.generated.models.page import Page
from typing import Optional, Set
from typing_extensions import Self

class GetApplicationAccountRequest(BaseModel):
    """
    ...
    request: GetApplicationAccount = Field(description="The main request payload.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetApplicationAccountRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetApplicationAccountRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "request": GetApplicationAccount.from_dict(obj["request"]) if obj.get("request") is not None else None,
