...
class GetAccountEntitlementAssociations(BaseModel):
    """
    Request parameters for finding entitlement associations for an account.
    """

    account_id: StrictStr = Field(
        description="The ID of the account to find entitlement associations for",
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetAccountEntitlementAssociations from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetAccountEntitlementAssociations from a dict"""
        if obj is None:
            return None
