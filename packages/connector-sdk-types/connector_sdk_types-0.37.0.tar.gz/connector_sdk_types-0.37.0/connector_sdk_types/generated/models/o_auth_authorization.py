...
class OAuthAuthorization(BaseModel):
    """
    OAuth authorization model. This is a model exclusively used by authorization capabilities.
    """

    client_id: StrictStr = Field(description="The OAuth client id.")
    client_secret: StrictStr = Field(description="The OAuth client secret.")
    state: Optional[StrictStr] = Field(default=None, description="The OAuth state variable.")
    scopes: List[StrictStr] = Field(description="The OAuth scopes list.")
    __properties: ClassVar[List[str]] = ["client_id", "client_secret", "state", "scopes"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OAuthAuthorization from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OAuthAuthorization from a dict"""
        if obj is None:
            return None
