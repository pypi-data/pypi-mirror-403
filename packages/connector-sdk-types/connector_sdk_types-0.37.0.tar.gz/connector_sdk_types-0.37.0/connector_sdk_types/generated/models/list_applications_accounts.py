...
class ListApplicationsAccounts(BaseModel):
    """
    Request parameters for listing application accounts.
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ListApplicationsAccounts from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ListApplicationsAccounts from a dict"""
        if obj is None:
            return None
