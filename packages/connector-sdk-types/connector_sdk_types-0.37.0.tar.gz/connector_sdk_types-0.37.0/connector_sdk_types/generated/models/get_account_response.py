...
class GetAccountResponse(BaseModel):
    """
    Response containing detailed information about the requested account.
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "response": FoundAccountData.from_dict(obj["response"]) if obj.get("response") is not None else None,
