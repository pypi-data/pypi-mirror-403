...
from connector_sdk_types.generated.models.find_entitlement_associations_response import FindEntitlementAssociationsResponse
from typing import Union, Any, List, Set, TYPE_CHECKING, Optional, Dict
from typing_extensions import Literal, Self
from pydantic import Field

FINDENTITLEMENTASSOCIATIONS200RESPONSE_ANY_OF_SCHEMAS = ["ErrorResponse", "FindEntitlementAssociationsResponse"]
...
class FindEntitlementAssociations200Response(BaseModel):
    ...
    # data type: FindEntitlementAssociationsResponse
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        error_messages = []
        # validate data type: FindEntitlementAssociationsResponse
        if not isinstance(v, FindEntitlementAssociationsResponse):
            error_messages.append(f"Error! Input type `{type(v)}` is not `FindEntitlementAssociationsResponse`")
        else:
            return v
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in FindEntitlementAssociations200Response with anyOf schemas: ErrorResponse, FindEntitlementAssociationsResponse. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into FindEntitlementAssociations200Response with anyOf schemas: ErrorResponse, FindEntitlementAssociationsResponse. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], ErrorResponse, FindEntitlementAssociationsResponse]]:
