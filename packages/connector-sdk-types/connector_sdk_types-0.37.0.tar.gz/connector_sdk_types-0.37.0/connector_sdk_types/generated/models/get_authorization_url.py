...
class GetAuthorizationUrl(BaseModel):
    ...
    credential_id: Optional[StrictStr] = Field(
        default=None, description="The credential ID assigned to these credentials."
    )
    ...
    form_data: Optional[Dict[str, StrictStr]] = Field(
        default=None, description="Form data to include in the authorization request."
    )
