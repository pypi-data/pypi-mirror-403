...
class TransferDataStatus(BaseModel):
    """
    Details about the transfer
    """ # noqa: E501
    success: StrictBool = Field(description="Whether the data was successfully transferred")
    reason: Optional[StrictStr] = Field(default=None, description="A message providing additional information about the transfer status, optional, but if the status was not successful, this should contain details about the failure.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TransferDataStatus from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TransferDataStatus from a dict"""
        if obj is None:
            return None
