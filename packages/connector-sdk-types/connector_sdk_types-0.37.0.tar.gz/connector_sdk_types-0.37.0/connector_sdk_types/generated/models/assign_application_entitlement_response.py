...
from connector_sdk_types.generated.models.assigned_application_entitlement import AssignedApplicationEntitlement
...
class AssignApplicationEntitlementResponse(BaseModel):
    """
    Response containing the result of the application entitlement assignment
    """ # noqa: E501
    response: AssignedApplicationEntitlement
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AssignApplicationEntitlementResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AssignApplicationEntitlementResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "response": AssignedApplicationEntitlement.from_dict(obj["response"]) if obj.get("response") is not None else None,
