...
from connector_sdk_types.generated.models.validate_credential_config_response import ValidateCredentialConfigResponse
from typing import Union, Any, List, Set, TYPE_CHECKING, Optional, Dict
from typing_extensions import Literal, Self
from pydantic import Field

VALIDATECREDENTIALCONFIG200RESPONSE_ANY_OF_SCHEMAS = ["ErrorResponse", "ValidateCredentialConfigResponse"]

class ValidateCredentialConfig200Response(BaseModel):
    """
    ValidateCredentialConfig200Response
    """

    # data type: ValidateCredentialConfigResponse
    anyof_schema_1_validator: Optional[ValidateCredentialConfigResponse] = None
    # data type: ErrorResponse
    anyof_schema_2_validator: Optional[ErrorResponse] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[ErrorResponse, ValidateCredentialConfigResponse]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "ErrorResponse", "ValidateCredentialConfigResponse" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ValidateCredentialConfig200Response.model_construct()
        error_messages = []
        # validate data type: ValidateCredentialConfigResponse
        if not isinstance(v, ValidateCredentialConfigResponse):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ValidateCredentialConfigResponse`")
        else:
            return v
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ValidateCredentialConfig200Response with anyOf schemas: ErrorResponse, ValidateCredentialConfigResponse. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[ValidateCredentialConfigResponse] = None
        try:
            instance.actual_instance = ValidateCredentialConfigResponse.from_json(json_str)
            return instance
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ValidateCredentialConfig200Response with anyOf schemas: ErrorResponse, ValidateCredentialConfigResponse. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], ErrorResponse, ValidateCredentialConfigResponse]]:
