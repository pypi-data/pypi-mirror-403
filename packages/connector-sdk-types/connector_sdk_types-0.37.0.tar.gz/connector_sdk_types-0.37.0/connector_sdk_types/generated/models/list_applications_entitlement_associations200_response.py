...
from connector_sdk_types.generated.models.list_applications_entitlement_associations_response import ListApplicationsEntitlementAssociationsResponse
from typing import Union, Any, List, Set, TYPE_CHECKING, Optional, Dict
from typing_extensions import Literal, Self
from pydantic import Field

LISTAPPLICATIONSENTITLEMENTASSOCIATIONS200RESPONSE_ANY_OF_SCHEMAS = ["ErrorResponse", "ListApplicationsEntitlementAssociationsResponse"]

class ListApplicationsEntitlementAssociations200Response(BaseModel):
    """
    ListApplicationsEntitlementAssociations200Response
    """

    # data type: ListApplicationsEntitlementAssociationsResponse
    anyof_schema_1_validator: Optional[ListApplicationsEntitlementAssociationsResponse] = None
    # data type: ErrorResponse
    anyof_schema_2_validator: Optional[ErrorResponse] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[ErrorResponse, ListApplicationsEntitlementAssociationsResponse]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: Set[str] = { "ErrorResponse", "ListApplicationsEntitlementAssociationsResponse" }
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ListApplicationsEntitlementAssociations200Response.model_construct()
        error_messages = []
        # validate data type: ListApplicationsEntitlementAssociationsResponse
        if not isinstance(v, ListApplicationsEntitlementAssociationsResponse):
            error_messages.append(f"Error! Input type `{type(v)}` is not `ListApplicationsEntitlementAssociationsResponse`")
        else:
            return v
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ListApplicationsEntitlementAssociations200Response with anyOf schemas: ErrorResponse, ListApplicationsEntitlementAssociationsResponse. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # anyof_schema_1_validator: Optional[ListApplicationsEntitlementAssociationsResponse] = None
        try:
            instance.actual_instance = ListApplicationsEntitlementAssociationsResponse.from_json(json_str)
            return instance
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ListApplicationsEntitlementAssociations200Response with anyOf schemas: ErrorResponse, ListApplicationsEntitlementAssociationsResponse. Details: " + ", ".join(error_messages))
        else:
            return instance
    ...
    def to_dict(self) -> Optional[Union[Dict[str, Any], ErrorResponse, ListApplicationsEntitlementAssociationsResponse]]:
