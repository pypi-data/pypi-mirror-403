...
class AuthorizationUrl(BaseModel):
    ...
    code_verifier: Optional[StrictStr] = Field(default=None, description="A code verifier for PKCE. This is the challenge that was sent in the authorization URL when using PKCE.")
    __properties: ClassVar[List[str]] = ["authorization_url", "code_verifier"]
