...
class GetLastActivityResponse(BaseModel):
    """
    Response containing last activity data for requested accounts
    """ # noqa: E501
    response: List[LastActivityData]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetLastActivityResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetLastActivityResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "response": [LastActivityData.from_dict(_item) for _item in obj["response"]] if obj.get("response") is not None else None,
