...
from connector_sdk_types.generated.models.unassigned_application_entitlement import UnassignedApplicationEntitlement
from typing import Optional, Set
from typing_extensions import Self

class UnassignApplicationEntitlementResponse(BaseModel):
    """
    Response containing the result of the unassign entitlement operation
    """ # noqa: E501
    response: UnassignedApplicationEntitlement
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UnassignApplicationEntitlementResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UnassignApplicationEntitlementResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "response": UnassignedApplicationEntitlement.from_dict(obj["response"]) if obj.get("response") is not None else None,
