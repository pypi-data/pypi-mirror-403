...
class GetDataRecency(BaseModel):
    """
    Request parameters for getting data recency information.  This is a simple request model as the capability doesn't require any specific parameters - it returns recency information for all standard capabilities that the connector supports.
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetDataRecency from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetDataRecency from a dict"""
        if obj is None:
            return None
