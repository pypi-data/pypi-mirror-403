...
class GetApplicationAccountResponse(BaseModel):
    """
    Response containing the information about an accounts assigned applications
    """ # noqa: E501
    response: ApplicationAccount
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GetApplicationAccountResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GetApplicationAccountResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "response": ApplicationAccount.from_dict(obj["response"]) if obj.get("response") is not None else None,
