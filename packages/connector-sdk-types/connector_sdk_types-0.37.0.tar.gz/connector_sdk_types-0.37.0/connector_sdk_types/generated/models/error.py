...
class Error(BaseModel):
    ...
    app_error_code: Optional[StrictStr] = Field(default=None, description="An application-specific code string that can tell us more details about the underlying application code or request that triggered the error.")
    error_code: ErrorCode = Field(description="A standard error code used by Lumos callers to respond to this error.")
    ...
    __properties: ClassVar[List[str]] = ["message", "status_code", "app_error_code", "error_code", "app_id", "raised_by", "raised_in"]
