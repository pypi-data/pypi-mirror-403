...
class TestFraud:
    ...
    @parametrize
    def test_method_analyze_transaction(self, client: Jocall3) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_analyze_transaction(self, client: Jocall3) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_analyze_transaction(self, client: Jocall3) -> None:
...
class TestAsyncFraud:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_analyze_transaction(self, async_client: AsyncJocall3) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_analyze_transaction(self, async_client: AsyncJocall3) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_analyze_transaction(self, async_client: AsyncJocall3) -> None:
