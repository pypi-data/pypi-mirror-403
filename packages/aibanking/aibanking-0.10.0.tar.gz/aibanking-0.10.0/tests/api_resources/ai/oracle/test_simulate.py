...
class TestSimulate:
    ...
    def test_streaming_response_create(self, client: Jocall3) -> None:
        with client.ai.oracle.simulate.with_streaming_response.create() as response:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_advanced_with_all_params(self, client: Jocall3) -> None:
        simulate = client.ai.oracle.simulate.advanced(
    ...
    def test_streaming_response_advanced(self, client: Jocall3) -> None:
        with client.ai.oracle.simulate.with_streaming_response.advanced() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncSimulate:
    ...
    async def test_streaming_response_create(self, async_client: AsyncJocall3) -> None:
        async with async_client.ai.oracle.simulate.with_streaming_response.create() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_advanced_with_all_params(self, async_client: AsyncJocall3) -> None:
        simulate = await async_client.ai.oracle.simulate.advanced(
            global_economic_factors={},
            personal_assumptions={},
        )
    ...
    async def test_streaming_response_advanced(self, async_client: AsyncJocall3) -> None:
        async with async_client.ai.oracle.simulate.with_streaming_response.advanced() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
