...
class TestPerformance:
    ...
    @parametrize
    def test_method_get_historical(self, client: Jocall3) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_method_get_historical_with_all_params(self, client: Jocall3) -> None:
        performance = client.investments.performance.get_historical(
            range="1m",
        )
        assert_matches_type(PerformanceGetHistoricalResponse, performance, path=["response"])
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_get_historical(self, client: Jocall3) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_get_historical(self, client: Jocall3) -> None:
...
class TestAsyncPerformance:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_get_historical(self, async_client: AsyncJocall3) -> None:
        performance = await async_client.investments.performance.get_historical()
        assert_matches_type(PerformanceGetHistoricalResponse, performance, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_get_historical_with_all_params(self, async_client: AsyncJocall3) -> None:
        performance = await async_client.investments.performance.get_historical(
            range="1m",
        )
        assert_matches_type(PerformanceGetHistoricalResponse, performance, path=["response"])
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_get_historical(self, async_client: AsyncJocall3) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_get_historical(self, async_client: AsyncJocall3) -> None:
