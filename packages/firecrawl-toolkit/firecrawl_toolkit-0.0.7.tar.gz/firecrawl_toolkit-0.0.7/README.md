...
FIRECRAWL_HTTP2=<0/1>
FIRECRAWL_MAX_WORKERS=<int, default 10>
FIRECRAWL_MAX_CONNECTIONS=<int, default 200>
FIRECRAWL_MAX_CONCURRENT_REQUESTS=<int, default 200>
FIRECRAWL_KEEPALIVE=<int, default 20>
FIRECRAWL_RETRY_COUNT=<int, default 3>
FIRECRAWL_MCP_ENABLE_STDIO=<0/1>
FIRECRAWL_MCP_ENABLE_HTTP=<0/1>
FIRECRAWL_MCP_ENABLE_SSE=<0/1>
FIRECRAWL_MCP_HTTP_HOST=<str, 127.0.0.1>
FIRECRAWL_MCP_HTTP_PORT=<str, 7001>
FIRECRAWL_MCP_SSE_HOST=<str, 127.0.0.1>
FIRECRAWL_MCP_SSE_PORT=<str, 7001>
```
