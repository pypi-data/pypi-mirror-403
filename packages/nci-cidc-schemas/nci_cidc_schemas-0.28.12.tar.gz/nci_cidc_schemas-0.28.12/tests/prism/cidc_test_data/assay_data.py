...
def clinical_data() -> PrismTestData:
    ...
    prismify_patch = {
        "clinical_data": {
            "assay_creator": "DFCI",
            "batch_id": "XYZ",
            "optional_id": "optional_submission_id",
            "records": [
                {
                    "clinical_file": {
            ...
            "elisa": [
                {
                    ...
                    "assay_creator": "DFCI",
                    "batch_id": "test_prism_trial_id_run_1",
                    "optional_id": "submission",
                    "assay_xlsx": {
...
@assay_data_generator
def olink_ht() -> PrismTestData:
    upload_type = "olink_ht"
    prismify_args = get_prismify_args(upload_type)
    prismify_patch = {
        "protocol_identifier": "test_prism_trial_id",
        "assays": {
            "olink_ht": [
                {
                    ...
                    "optional_id": "sub1",
                    "panel": "Olink HT",
                    "assay_panel_lot": "assay_panel_lot_3",
                    "study_level_combined_file": {
                        "upload_placeholder": "d658b480-ed78-4717-b622-3e2223"
                    },
                    "study_level_combined_npx_manager_version": "NPX Map 1.3.0",
                    "batch_level_combined_file": {
                        "upload_placeholder": "4e9d0a47-90dc-4134-9ad6-3e3dd8361"
                    },
                    "batch_level_combined_npx_manager_version": "NPX Map 1.3.0",
                    "records": [
                        {
                            "cimac_id": "C12312312.01",
                            "npx_run_file": {
                                "upload_placeholder": "4e9d0a47-90dc-4134-9ad6-3e3dd83113"
                            },
                            "instrument": "Formulatrix FAST",
                            "npx_manager_version": "NPX Map 1.3.0",
                            "comments": "a comment",
                        },
                        {
                            "cimac_id": "C12345612.01",
                            "npx_run_file": {
                                "upload_placeholder": "4e9d0a47-90dc-4134-9ad6-32222e3dd823112"
                            },
                            "instrument": "Formulatrix FAST",
                            "npx_manager_version": "NPX Map 1.3.0",
                        },
    ...
    upload_entries = [
        LocalFileUploadEntry(
            local_path="study_file.parquet",
            upload_placeholder="d658b480-ed78-4717-b622-3e2223",
            gs_key="test_prism_trial_id/olink_ht/batch_42/study_level_combined_file.xlsx",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="batch_file.parquet",
            upload_placeholder="4e9d0a47-90dc-4134-9ad6-3e3dd8361",
            gs_key="test_prism_trial_id/olink_ht/batch_42/batch_level_combined_file.xlsx",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="npx_run_file_1.parquet",
            upload_placeholder="4e9d0a47-90dc-4134-9ad6-3e3dd83113",
            gs_key="test_prism_trial_id/olink_ht/batch_42/C12312312.01/npx_run_file.xlsx",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="npx_run_file_2.parquet",
            upload_placeholder="4e9d0a47-90dc-4134-9ad6-32222e3dd823112",
            gs_key="test_prism_trial_id/olink_ht/batch_42/C12345612.01/npx_run_file.xlsx",
            metadata_availability=False,
            allow_empty=False,
        ),
    ]
    ...
    cimac_ids = [
        record["cimac_id"]
        for batch in prismify_patch["assays"]["olink_ht"]
        for record in batch["records"]
    ]
    base_trial = get_test_trial(cimac_ids)
...
@assay_data_generator
def tcrseq_rna() -> PrismTestData:
    upload_type = "tcrseq_rna"
    prismify_args = get_prismify_args(upload_type)
    prismify_patch = {
        "protocol_identifier": "test_prism_trial_id",
        "assays": {
            "tcrseq_rna": [
                {
                    ...
                    "batch_id": "test_batch",
                    "optional_id": "sub1",
                    "sequencer_platform": "Oxford Nanosphere",
                    "sequencing_run_date": "2019-12-12 00:00:00",
                    "records": [
                        {
                            "cimac_id": "CTTTPP121.01",
                            ...
                            "beta_results_file": {
                                "upload_placeholder": "d658b480-ed78-4717-621-3118675"
                            },
                        },
                        {
                            "cimac_id": "CTTTPP132.01",
                            "alpha_results_file": {
                                "upload_placeholder": "d658b480-ed78-4717-621-884444"
                            },
                            "beta_results_file": {
                                "upload_placeholder": "d658b480-ed78-4717-621-22111"
                            },
                        },
                    ],
                }
    ...
    upload_entries = [
        LocalFileUploadEntry(
            local_path="alpha1.csv",
            upload_placeholder="d658b480-ed78-4717-621-31122",
            gs_key="test_prism_trial_id/tcrseq_rna/test_batch/CTTTPP121.01/alpha.csv",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="beta1.csv",
            upload_placeholder="d658b480-ed78-4717-621-3118675",
            gs_key="test_prism_trial_id/tcrseq_rna/test_batch/CTTTPP121.01/beta.csv",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="alpha2.csv",
            upload_placeholder="d658b480-ed78-4717-621-884444",
            gs_key="test_prism_trial_id/tcrseq_rna/test_batch/CTTTPP132.01/alpha.csv",
            metadata_availability=False,
            allow_empty=False,
        ),
        LocalFileUploadEntry(
            local_path="beta2.csv",
            upload_placeholder="d658b480-ed78-4717-621-22111",
            gs_key="test_prism_trial_id/tcrseq_rna/test_batch/CTTTPP132.01/beta.csv",
            metadata_availability=False,
            allow_empty=False,
        ),
    ]
    ...
    cimac_ids = [
        record["cimac_id"]
        for batch in prismify_patch["assays"]["tcrseq_rna"]
        for record in batch["records"]
    ]
    base_trial = get_test_trial(cimac_ids)
