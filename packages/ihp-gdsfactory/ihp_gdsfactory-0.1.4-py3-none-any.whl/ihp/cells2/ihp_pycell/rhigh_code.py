...
class rhigh(DloGen):
    ...
    def genLayout(self):
        ...
        poly_cont_len = (
            consize + polyover
        )  # self.techparams['rhigh_poly_cont_len']   # 0.57
        ...
        dbCreateRect(
            ...
            Box(
                xpos1 - psdover,
                ypos1 + (contactpush - psdover) * dir,
                xpos2 + psdover,
                ypos2 + (contactpush + poly_cont_len + li_salblock + psdover) * dir,
            ),
        )
        dbCreateRect(
            self,
        ...
        dbCreateRect(
            ...
            Box(
                ...
                ypos2
                + (contactpush + consize + li_salblock + li_poly_over + metover) * dir,
            ),
        )
        MkPin(
            self,
        ...
        if contactpush > 0:
            ...
            dbCreateRect(
                ...
                Box(
                    xpos1 - psdover,
                    ypos1 - (contactpush - salblock_nsd_enc) * dir,
                    xpos1 + stripes * (w + ps) - ps + psdover,
                    ypos1 + (l + w + psdover) * dir,
                ),
            )
            ...
            dbCreateRect(
                ...
                Box(
                    xpos1 - nsdover,
                    ypos1 - (contactpush - salblock_nsd_enc) * dir,
                    xpos1 + stripes * (w + ps) - ps + nsdover,
                    ypos1 + (l + w + nsdover) * dir,
                ),
            )
            ...
            if lcor > 0:
                if oddp(stripes):
                    ...
                    dbCreateRect(
                        ...
                        sallayer,
                        Box(
                            xpos1 + stripes * (w + ps) - ps - w - salover,
                            ypos1 + l + w + salover,
                            xpos1 + stripes * (w + ps) - ps + salover,
                            ypos1 + l + w + salover + lcor,
                        ),
                    )
                    # 09.02.07 GGa added EXTBlock
                    dbCreateRect(
                    ...
                    dbCreateRect(
                        ...
                        psdlayer,
                        Box(
                            xpos1 + stripes * (w + ps) - ps - w - psdover,
                            ypos1 + l + w + salover - salblock_nsd_enc,
                            xpos1 + stripes * (w + ps) - ps + psdover,
                            ypos1 + l + w + salover + lcor - salblock_nsd_enc,
                        ),
                    )
                    # nSD
                    dbCreateRect(
                        ...
                        nsdlayer,
                        Box(
                            xpos1 + stripes * (w + ps) - ps - w - nsdover,
                            ypos1 + l + w + salover - salblock_nsd_enc,
                            xpos1 + stripes * (w + ps) - ps + nsdover,
                            ypos1 + l + w + salover + lcor - salblock_nsd_enc,
                        ),
                    ...
                    dbCreateRect(
                        ...
                        Box(
                            xpos1 + stripes * (w + ps) - ps - w - psdover,
                            ypos1 - contactpush - lcor + salblock_nsd_enc,
                            xpos1 + stripes * (w + ps) - ps + psdover,
                            ypos1 - contactpush + salblock_nsd_enc,
                        ),
                    )
                    dbCreateRect(
                        self,
        ...
        # *********************************************************
            ...
            if onep(stripes):  # only one Stripe->other nSD/pSD
                ...
                dbCreateRect(
                    ...
                    Box(
                        xpos1 - psdover,
                        ypos1 + salblock_nsd_enc * dir,
                        xpos1 + stripes * (w + ps) - ps + psdover,
                        ypos2 - salblock_nsd_enc,
                    ),
                )
                dbCreateRect(
                    self,
                ...
                if oddp(stripes):  # draw salblock and pSD over resistor
                    ...
                    dbCreateRect(
                        ...
                        Box(
                            xpos1 - salover,
                            ypos2,
                            xpos1 + (stripes - 1) * (w + ps) - ps + salover,
                            ypos2 + w + salover,
                        ),
                    )
                    dbCreateRect(
                    ...
                    dbCreateRect(
                        ...
                        Box(
                            xpos1 - psdover,
                            ypos2,
                            xpos1 + (stripes - 1) * (w + ps) - ps + psdover,
                            ypos2 + w + psdover,
                        ),
                    )
                    dbCreateRect(
                    ...
                    dbCreateRect(
                        ...
                        Box(
                            xpos1 - nsdover,
                            ypos2,
                            xpos1 + (stripes - 1) * (w + ps) - ps + nsdover,
                            ypos2 + w + nsdover,
                        ),
                    )
                    dbCreateRect(
        ...
        dbCreateRect(
            ...
            Box(
                xpos1 - psdover,
                ypos2 + (lcor + contactpush - psdover) * dir,
                xpos2 + psdover,
                ypos2
                + (lcor + contactpush + poly_cont_len + li_salblock + psdover) * dir,
            ),
        )
        dbCreateRect(
            self,
        ...
        if drawbar:
            ...
            lastCont = dbCreateRect(
                ...
                Box(
                    ...
                    xpos2 - contbar_poly_over,
                    ypos2
                    + (lcor + contactpush + consize + li_salblock + li_poly_over) * dir,
                ),
            )
        else:
            for i in range(ncont):
        ...
        labeltext = f"rpnd r={resistance:.3f}"
