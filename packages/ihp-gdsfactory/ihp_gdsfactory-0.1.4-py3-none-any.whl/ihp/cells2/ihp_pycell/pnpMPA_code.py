...
class pnpMPA(DloGen):
    ...
    def defineParamSpecs(self, specs):
        ...
        specs(
            "a",
            eng_string(CbDiodeCalc("a", 0, Numeric(defL), Numeric(defW), "pnpMPA"), 3),
            "Area",
        )
        specs(
            "p",
            eng_string(CbDiodeCalc("p", 0, Numeric(defL), Numeric(defW), "pnpMPA"), 3),
            "Perimeter",
        )
    ...
    def genLayout(self):
        ...
        contactArray(
            self, metal1Layer, contLayer, _xl, _yl, _xh, _yh, _ox, _oy, _ws, _ds
        )
        id1 = dbCreateRect(self, activLayer, Box(-w2act, -h2act, w2act, h2act))
        id2 = dbCreateRect(
            self,
            activLayer,
            Box(-w2act - dw2act, -h2act - dh2act, w2act + dw2act, h2act + dh2act),
        )
        ...
        id2 = dbCreateRect(
            self,
            metal1Layer,
            Box(-w2m1 - dw2m1, -h2m1 - dh2m1, w2m1 + dw2m1, h2m1 + dh2m1),
        )
        ...
        id2 = dbCreateRect(
            self,
            pSdLayer,
            Box(-w2psd - d2psd, -h2psd - d2psd, w2psd + d2psd, h2psd + d2psd),
        )
        ...
        id2 = dbCreateRect(
            self,
            activLayer,
            Box(-w3act - d3act, -h3act - d3act, w3act + d3act, h3act + d3act),
        )
        dbLayerXor(activLayer, id1, id2)
        id1.destroy()
        id2.destroy()
        ...
        if MetT:
            ...
            if idtie == 0:
                idtie = dbCreateRect(
                    self,
                    Layer("Metal1", "pin"),
                    Box(-w3act - d3act, h3act, w3act + d3act, h3act + d3act),
                )
                dbCreateLabel(
                    self,
                    textLayer,
                    Point(0, h3act + d3act / 2),
                    "TIE",
                    "centerCenter",
                    "R0",
                    Font.EURO_STYLE,
        ...
        if MetB:
            ...
            if idtie == 0:
                idtie = dbCreateRect(
                    self,
                    Layer("Metal1", "pin"),
                    Box(-w3act - d3act, -h3act - d3act, w3act + d3act, -h3act),
                )
                dbCreateLabel(
                    self,
                    textLayer,
        ...
        if MetL:
            ...
            if idtie == 0:
                idtie = dbCreateRect(
                    self,
                    Layer("Metal1", "pin"),
                    Box(-w3act - d3act, -h3act, -w3act, h3act),
                )
                dbCreateLabel(
                    self,
                    textLayer,
                    Point(-w3act - d3act / 2, 0),
                    "TIE",
                    "centerCenter",
                    "R90",
                    Font.EURO_STYLE,
        ...
        if MetR:
            ...
            if idtie == 0:
                idtie = dbCreateRect(
                    self,
                    Layer("Metal1", "pin"),
                    Box(w3act, -h3act, w3act + d3act, h3act),
                )
                dbCreateLabel(
                    self,
                    textLayer,
        ...
        id1 = dbCreateRect(
            self, Layer("Metal1", "pin"), Box(-w2m1 - dw2m1, -h2m1, -w2m1, h2m1)
        )
