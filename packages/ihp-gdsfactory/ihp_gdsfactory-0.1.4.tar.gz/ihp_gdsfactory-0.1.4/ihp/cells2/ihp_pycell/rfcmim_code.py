...
class rfcmim(DloGen):
    ...
    def genLayout(self):
        ...
        gnd_over_bm = (
            3 + gnd_width / 2
        )  # um, distance from ground frame to bottom plate
        ...
        dbCreateRect(
            self, tmlayer, Box(via_over, via_over, lu - via_over, wu - via_over)
        )
        dbCreateRect(
            self, bmlayer, Box(-mim_over, -mim_over, lu + mim_over, wu + mim_over)
        )
        dbCreateRect(
            self, bmlayer, Box(-mim_over, -mim_over, lu + mim_over, wu + mim_over)
        )
        ...
        id1 = dbCreateRect(
            self, Layer("TopMetal1", "pin"), Box(-5.6, feedoy, -3.6, feedoy + wf)
        )
        MkPin(self, "PLUS", 0, id1.bbox, id1.layer)
        dbCreateLabel(
            self,
            textlayer,
            Point(-4.6, feedoy + wf / 2),
            "PLUS",
            "centerCenter",
            "R90",
            Font.EURO_STYLE,
        ...
        dbCreateRect(
            self, Layer("Metal1", "noqrc"), Box(-5.6, -5.6, lu + 5.6, wu + 5.6)
        )
        dbCreateRect(
            self, Layer("Metal2", "noqrc"), Box(-5.6, -5.6, lu + 5.6, wu + 5.6)
        )
        dbCreateRect(
            self, Layer("Metal3", "noqrc"), Box(-5.6, -5.6, lu + 5.6, wu + 5.6)
        )

        dbCreateRect(
            self, Layer("Metal4", "noqrc"), Box(-5.6, -5.6, lu + 5.6, wu + 5.6)
        )
        dbCreateRect(
            self, Layer("Metal5", "noqrc"), Box(-5.6, -5.6, lu + 5.6, wu + 5.6)
        )
        dbCreateRect(
            self, Layer("TopMetal1", "noqrc"), Box(-5.6, -5.6, lu + 5.6, wu + 5.6)
        )
        ...
        id2 = dbCreateRect(
            self, Layer("Metal5", "pin"), Box(lu + 5.6, feedoy, lu + 3.6, feedoy + wf)
        )
        ...
        id1 = dbCreateRect(
            self, Layer("Metal1", "pin"), Box(-5.6, -5.6, lu + 5.6, -3.6)
        )
        y = -4.6
