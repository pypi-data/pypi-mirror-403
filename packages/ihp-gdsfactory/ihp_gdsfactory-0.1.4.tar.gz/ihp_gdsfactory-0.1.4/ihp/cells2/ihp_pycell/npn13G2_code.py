            ...
            for pcIndexY in range(int(math.floor(pcRepeatY))):
                ...
                pcInst = dbCreateRect(
                    ...
                    Box(
                        ...
                        (stepX * pcIndexX) - 0.11,
                        -(
                            (-0.11 - yOffset - leoffset - bipwinyoffset - empolyyoffset)
                            + (pcIndexY * pcStepY)
                        )
                        + 0.2,
                    ),
        ...
        if Nx > 1:
            MkPin(
                ...
                Box(
                    ...
                    (0.57 + we / 2 - leoffset - bipwinyoffset - empolyyoffset),
                    (stretchX + 0.89 + le / 2),
                    (1.01 + we / 2 - leoffset - bipwinyoffset - empolyyoffset),
                ),
                Layer("Metal1", "pin"),
                True,
            )
            ...
            MkPin(
                ...
                Box(
                    -0.89 - le / 2,
                    (0.56 + we / 2 + leoffset + bipwinyoffset + empolyyoffset),
                    (stretchX + 0.89 + le / 2),
                    (0.8 + we / 2 + leoffset + bipwinyoffset + empolyyoffset),
                ),
                Layer("Metal1", "pin"),
                True,
            )
