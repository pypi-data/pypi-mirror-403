...
class rsil(DloGen):
    ...
    def genLayout(self):
        ...
        dbCreateRect(
            self, contpolylayer, Box(xpos1, ypos1, xpos2, ypos2 + poly_cont_len * dir)
        )
        ...
        dbCreateRect(
            ...
            Box(
                ...
                ypos1,
                xpos2 + ext_over,
                ypos2 - ext_over + poly_cont_len * dir,
            ),
        )
        ...
        dbCreateRect(
            self, extBlocklayer, Box(xpos1 - ext_over, ypos1, xpos2 + ext_over, ypos2)
        )
        ...
        #  GatPoly Part
        dbCreateRect(
            self, contpolylayer, Box(xpos1, ypos2, xpos2, ypos2 + poly_cont_len * dir)
        )
