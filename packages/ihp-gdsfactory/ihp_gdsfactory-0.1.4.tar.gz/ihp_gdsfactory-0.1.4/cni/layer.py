...
class Layer:
    ...
    def __init__(self, name, purpose=None):
        ...
        layer, datatype = (
            cni.dlo.PyCellContext.getCurrentPyCellContext().tech.stream_layers()[
                namePurpose
            ]
        )

        self._name = namePurpose
        self._number = cni.dlo.PyCellContext.getCurrentPyCellContext().layout.layer(
            layer, datatype, namePurpose
        )
