...
class Transform:
    ...
    def _(
        ...
        arg1: float,
        arg2: float,
        arg3: Orientation = Orientation.R0,
        arg4: float = 1.0,
    ):
    ...
    def _internalInit(
        self, x: float, y: float, orientation: Orientation, magnification: float
    ) -> None:
        self._x = x
        self._y = y
        ...
        match orientation:
            ...
            case Orientation.MYR90:
                self._transform = (
                    pya.DCplxTrans(magnification, 90, False, x, y) * pya.DCplxTrans.M90
                )
            case Orientation.MXR90:
                self._transform = pya.DCplxTrans(magnification, 90, True, x, y)
            case Orientation.MY:
                self._transform = (
                    pya.DCplxTrans(magnification, 0, False, x, y) * pya.DCplxTrans.M90
                )
            case Orientation.MX:
