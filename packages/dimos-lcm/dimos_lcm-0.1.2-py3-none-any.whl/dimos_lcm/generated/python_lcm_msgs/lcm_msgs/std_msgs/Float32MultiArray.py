...
class Float32MultiArray(object):
    ...
    def _encode_one(self, buf):
        ...
        buf.write(
            struct.pack(">%df" % self.data_length, *self.data[: self.data_length])
        )
    ...
    def _decode_one(cls, buf):
        ...
        self.data = struct.unpack(
            ">%df" % self.data_length, buf.read(self.data_length * 4)
        )
        return self
    ...
    def _get_hash_recursive(cls, parents):
        ...
        tmphash = (
            0x7138323E2B24BE12 + MultiArrayLayout._get_hash_recursive(newparents)
        ) & 0xFFFFFFFFFFFFFFFF
        tmphash = (
