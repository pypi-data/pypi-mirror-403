...
class Float64MultiArray(object):
    ...
    def _encode_one(self, buf):
        ...
        buf.write(
            struct.pack(">%dd" % self.data_length, *self.data[: self.data_length])
        )
    ...
    def _decode_one(cls, buf):
        ...
        self.data = struct.unpack(
            ">%dd" % self.data_length, buf.read(self.data_length * 8)
        )
        return self
    ...
    def _get_hash_recursive(cls, parents):
        ...
        tmphash = (
            0x45A3940B9D17E120 + MultiArrayLayout._get_hash_recursive(newparents)
        ) & 0xFFFFFFFFFFFFFFFF
        tmphash = (
