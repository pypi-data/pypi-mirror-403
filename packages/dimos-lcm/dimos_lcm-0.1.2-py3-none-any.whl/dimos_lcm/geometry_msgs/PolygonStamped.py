...
class PolygonStamped(object):
    ...
    def _encode_one(self, buf):
        ...
        assert (
            self.polygon._get_packed_fingerprint() == Polygon._get_packed_fingerprint()
        )
    ...
    def _decode_one(cls, buf):
        ...
        self.polygon = cls._get_field_type("polygon")._decode_one(buf)
        return self
    ...
    def _get_hash_recursive(cls, parents):
        ...
        tmphash = (
            ...
            + Polygon._get_hash_recursive(newparents)
        ) & 0xFFFFFFFFFFFFFFFF
        tmphash = (
