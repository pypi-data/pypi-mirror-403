...
class InertiaStamped(object):
    ...
    def _encode_one(self, buf):
        ...
        assert (
            self.inertia._get_packed_fingerprint() == Inertia._get_packed_fingerprint()
        )
    ...
    def _decode_one(cls, buf):
        ...
        self.inertia = cls._get_field_type("inertia")._decode_one(buf)
        return self
    ...
    def _get_hash_recursive(cls, parents):
        ...
        tmphash = (
            ...
            + Inertia._get_hash_recursive(newparents)
        ) & 0xFFFFFFFFFFFFFFFF
        tmphash = (
