...
class DiagnosticArray(object):
    ...
    def _encode_one(self, buf):
        ...
        for i0 in range(self.status_length):
            assert (
                self.status[i0]._get_packed_fingerprint()
                == DiagnosticStatus._get_packed_fingerprint()
            )
    ...
    def _decode_one(cls, buf):
        ...
        self.status = []
        for i0 in range(self.status_length):
            self.status.append(cls._get_field_type("status")._decode_one(buf))
        return self
    ...
    def _get_hash_recursive(cls, parents):
        ...
        tmphash = (
            ...
            + DiagnosticStatus._get_hash_recursive(newparents)
        ) & 0xFFFFFFFFFFFFFFFF
        tmphash = (
