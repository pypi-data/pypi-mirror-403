...
class Int32MultiArray(object):
    ...
    def _encode_one(self, buf):
        ...
        buf.write(
            struct.pack(">%di" % self.data_length, *self.data[: self.data_length])
        )
    ...
    def _decode_one(cls, buf):
        ...
        self.data = struct.unpack(
            ">%di" % self.data_length, buf.read(self.data_length * 4)
        )
        return self
    ...
    def _get_hash_recursive(cls, parents):
        ...
        tmphash = (
            0xAA51366C8F222486 + MultiArrayLayout._get_hash_recursive(newparents)
        ) & 0xFFFFFFFFFFFFFFFF
        tmphash = (
