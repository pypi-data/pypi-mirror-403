...
class UInt16MultiArray(object):
    ...
    def _encode_one(self, buf):
        ...
        buf.write(
            struct.pack(">%dh" % self.data_length, *self.data[: self.data_length])
        )
    ...
    def _decode_one(cls, buf):
        ...
        self.data = struct.unpack(
            ">%dh" % self.data_length, buf.read(self.data_length * 2)
        )
        return self
    ...
    def _get_hash_recursive(cls, parents):
        ...
        tmphash = (
            0xAA51366C8F222C76 + MultiArrayLayout._get_hash_recursive(newparents)
        ) & 0xFFFFFFFFFFFFFFFF
        tmphash = (
