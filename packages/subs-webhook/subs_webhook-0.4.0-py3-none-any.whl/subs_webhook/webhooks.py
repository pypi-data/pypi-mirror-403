...
class WebhookManager:
    ...
    def register_webhook(self, url: str, email: str, api_key: str, currencies: list):
        ...
        try:
            ...
            conn.commit()
            logging.info(f"Webhook registered: {url} watching {len(currencies)} currencies")
    ...
    def _send_payload(self, url, alerts):
        ...
        try:
            ...
            self._record_failure(url)
            logging.error(f"Webhook timeout/error: {url}")
    ...
    def process_alerts(self, alerts_list: list):
        ...
        logging.info(f">> Dispatching alerts to {len(payloads)} webhooks...")
