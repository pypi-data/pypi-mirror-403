...
class DeployedDOModel_CPD21(object):
    ...
    def __init__(self, url=None, server=None, route=None, service_name=None, model_name=None, token=None, inputs=None,
        ...
        self.job_config_json = None  # Available after `execute_model_v1`
        self.execution_status_json = None  # Available after `monitor_execution_v1` has been able to get the first update from the running job. Will be updated while the job is running.
        self.execution_status = None  # Available after `monitor_execution_v1`
    ...
    def get_job_url(self):
        ...
        Can only be called after the call to `execute_model_v1`
        """
        url = None
