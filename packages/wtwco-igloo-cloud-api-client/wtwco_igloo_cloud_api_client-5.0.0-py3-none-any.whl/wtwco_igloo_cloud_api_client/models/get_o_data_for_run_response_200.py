...
class GetODataForRunResponse200:
    ...
    Attributes:
        ...
        value (list[GetODataForRunResponse200ValueItem] | Unset): The data for the table. The types of properties will
            depend on the table being selected from and the columns requested by $select
    """

    odata_context: str | Unset = UNSET
    value: list[GetODataForRunResponse200ValueItem] | Unset = UNSET
