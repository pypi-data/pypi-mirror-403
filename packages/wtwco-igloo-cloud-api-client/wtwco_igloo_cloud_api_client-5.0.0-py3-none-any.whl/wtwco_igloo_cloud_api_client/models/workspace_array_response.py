...
class WorkspaceArrayResponse:
    ...
    Attributes:
        ...
        result (list[Workspace] | None | Unset):
    """

    messages: list[Message] | None | Unset = UNSET
    result: list[Workspace] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_result(data: object) -> list[Workspace] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                pass
            return cast(list[Workspace] | None | Unset, data)
