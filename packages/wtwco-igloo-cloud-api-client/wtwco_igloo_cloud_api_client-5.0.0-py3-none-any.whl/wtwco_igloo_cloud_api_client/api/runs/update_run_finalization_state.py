...
from ...models.update_run_finalization_state import UpdateRunFinalizationState
...
def _get_kwargs(
    ...
    run_id: int,
    *,
    body: UpdateRunFinalizationState,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": f"/api/v3/workspaces/{workspace_id}/projects/{project_id}/runs/{run_id}/finalization-state",
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Change the finalization state of a run.
