...
) -> Any | ResponseWrapper | ResultTableNodeArrayResponse | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | ResponseWrapper | ResultTableNodeArrayResponse]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | ResponseWrapper | ResultTableNodeArrayResponse
    """
