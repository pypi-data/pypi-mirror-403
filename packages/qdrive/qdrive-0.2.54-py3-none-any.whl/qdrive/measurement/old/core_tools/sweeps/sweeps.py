...
from qdrive.measurement.core_tools.measurement import Measurement
...
class scan_generic(metaclass=job_meta):
    ...
    '''
    def __init__(self, *args, name='', reset_param=False, silent=False, core_tools_shadow=True):
        '''
        ...
        self.name = name
        self.silent = silent
        self.meas = Measurement(self.name, silent, core_tools_shadow)
...
def do0D(*m_instr, name='', silent=False, core_tools_shadow=True):
    '''
    do a 0D scan
...
def do1D(param, start, stop, n_points, delay, *m_instr, name='', reset_param=False, silent=False, core_tools_shadow=True):
    '''
    do a 1D scan
    ...
    return scan_generic(m_param, *m_instr,name=name, reset_param=reset_param, silent=silent, core_tools_shadow=True)

def do2D(param_1, start_1, stop_1, n_points_1, delay_1,
            param_2, start_2, stop_2, n_points_2, delay_2, *m_instr, name='',
            reset_param=False, silent=False, core_tools_shadow=True):
    '''
    do a 2D scan
