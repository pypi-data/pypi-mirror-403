...
SAMPLE_TOOLS = [
    "weather_query_001",
    "calendar_manager_002",
    "email_sender_003",
    "file_search_004",
    "database_query_005",
    "api_caller_006",
    "calculator_basic_007",
    "translator_text_008",
    "image_analyzer_009",
    "web_scraper_010",
    "data_formatter_011",
    "code_executor_012",
    "document_parser_013",
    "oscilloscope_log_014",
    "logic_analyzer_015",
    "network_monitor_016",
    "system_diagnostics_017",
    "performance_profiler_018",
    "security_scanner_019",
    "backup_manager_020",
    "travel_search_021",
    ...
    "news_aggregator_024",
    "recipe_finder_025",
    "movie_recommender_026",
    "music_player_027",
    "calendar_reminder_028",
    "task_manager_029",
    "note_taker_030",
]
...
def generate_assistant_turn(tool_id: str, step: int) -> dict[str, Any]:
    ...
    return {"role": "assistant", "content": random.choice(responses)}
...
def generate_dialog(dialog_id: int, scenario: dict[str, Any], split: str) -> dict[str, Any]:
    ...
    return {
        ...
        "goal": goal,
        "turns": turns,
        "target_tools": sorted(set(selected_tools)),
        "metadata": {
