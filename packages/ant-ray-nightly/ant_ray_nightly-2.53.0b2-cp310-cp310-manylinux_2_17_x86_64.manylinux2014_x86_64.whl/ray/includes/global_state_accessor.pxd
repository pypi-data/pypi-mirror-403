...
cdef extern from "ray/gcs_rpc_client/global_state_accessor.h" nogil:
    cdef cppclass CGlobalStateAccessor "ray::gcs::GlobalStateAccessor":
        ...
        CJobID GetNextJobID()
        c_vector[c_string] GetAllNodeInfo(const optional[c_string] virtual_cluster_id)
        c_vector[c_string] GetAllAvailableResources(const optional[c_string] virtual_cluster_id)
        c_vector[c_string] GetAllTotalResources(const optional[c_string] virtual_cluster_id)
