...
from deezspot.libutils.librespot import apply_device_info_overrides
...
class SpoLogin:
	def __init__(
		...
		device_info: typing.Optional[dict] = None,
	...
	def __initialize_session(self) -> None:
		try:
			...
			if isfile(self.credentials_path):
				apply_device_info_overrides(session_builder, self.device_info)
