...
import truefoundry.ml._autogen.client.models
from truefoundry.ml._autogen.client import rest
...
from truefoundry.ml._autogen.client.exceptions import ApiException, ApiValueError
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(truefoundry.ml._autogen.client.models, klass)
