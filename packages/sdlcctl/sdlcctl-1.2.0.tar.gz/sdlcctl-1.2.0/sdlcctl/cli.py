...
SDLC Orchestrator - Sprint 125

Version: 3.3.0
Date: January 30, 2026
Status: ACTIVE - Sprint 125 Multi-Frontend Alignment
Authority: Backend Team + CTO Approved
Reference: SPEC-0002-Specification-Standard, SPEC-0014-CLI-Extension-Upgrade

Purpose:
- Main entry point for the sdlcctl command-line tool
- Structure validation, fixing, and initialization
- YAML frontmatter validation (SDLC 6.0.0)
