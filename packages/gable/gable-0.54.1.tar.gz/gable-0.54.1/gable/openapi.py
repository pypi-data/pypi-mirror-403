...
class GetComponentsHistoryResponseItem(BaseModel):
    runId: str = Field(
    ...
    namespace: Optional[str] = Field(
        default=None,
        description="The environment associated with the run (e.g. prod, staging, dev).",
    )
...
class GetComponentsHistoryResponse(RootModel["List[GetComponentsHistoryResponseItem]"]):
    root: List[GetComponentsHistoryResponseItem]
