...
def parse_arguments(explicit_args: Sequence[str] | None = None) -> Namespace:
  ...
  parser.add_argument("--classname", required=False, type=str,
    help="If the callable is a class function, specify the class name"
  )
  parser.add_argument("--classparams", required=False, type=str,
