...
def load_env_file():
    ...
    if not env_file.exists():
        ...
        os.environ.setdefault("SANDBOX_ROOT", str(Path.cwd() / "sandbox"))
        os.environ.setdefault("TEMP_DIR", str(Path.cwd() / "temp"))
        os.environ.setdefault("TOOLS_ENABLE_SYSTEM", "false")
        os.environ.setdefault("TOOLS_ENABLE_FILE", "true")
        os.environ.setdefault("TOOLS_ENABLE_WEB", "true")
        os.environ.setdefault("TOOLS_ENABLE_KB", "false")
        os.environ.setdefault("TOOLS_ENABLE_LIST", "true")
        return
