...
class ContentArtifactApi:
    ...
    def create(
        self,
        maven_maven_artifact: MavenMavenArtifact,
        ...
        :param maven_maven_artifact: (required)
        :type maven_maven_artifact: MavenMavenArtifact
        ...
        _param = self._create_serialize(
            ...
            maven_maven_artifact=maven_maven_artifact,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "MavenMavenArtifactResponse",
        }
    ...
    def create_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[MavenMavenArtifactResponse]:
        """Create a maven artifact
    ...
    def _create_serialize(
        ...
        if maven_maven_artifact is not None:
            _body_params = maven_maven_artifact
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/pulp/{pulp_domain}/api/v3/content/maven/artifact/',
    ...
    def list(
        self,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        artifact_id: Annotated[Optional[StrictStr], Field(description="Filter results where artifact_id matches value")] = None,
        filename: Annotated[Optional[StrictStr], Field(description="Filter results where filename matches value")] = None,
        group_id: Annotated[Optional[StrictStr], Field(description="Filter results where group_id matches value")] = None,
        ...
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param artifact_id: Filter results where artifact_id matches value
        :type artifact_id: str
        :param filename: Filter results where filename matches value
        :type filename: str
        :param group_id: Filter results where group_id matches value
        :type group_id: str
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PaginatedmavenMavenArtifactResponseList",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedmavenMavenArtifactResponseList]:
        """List maven artifacts
    ...
    def _list_serialize(
        ...
        if artifact_id is not None:
            ...
            _query_params.append(('artifact_id', artifact_id))
    ...
    def read(
        self,
        maven_maven_artifact_href: StrictStr,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to include in the response.")] = None,
        exclude_fields: Annotated[Optional[List[StrictStr]], Field(description="A list of fields to exclude from the response.")] = None,
        _request_timeout: Union[
        ...
        :param maven_maven_artifact_href: (required)
        :type maven_maven_artifact_href: str
        :param x_task_diagnostics: List of profilers to use on tasks.
        :type x_task_diagnostics: List[str]
        :param fields: A list of fields to include in the response.
        :type fields: List[str]
        ...
        _param = self._read_serialize(
            maven_maven_artifact_href=maven_maven_artifact_href,
            x_task_diagnostics=x_task_diagnostics,
            fields=fields,
            exclude_fields=exclude_fields,
            _request_auth=_request_auth,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "MavenMavenArtifactResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def _read_serialize(
        ...
        # process the path parameters
        if maven_maven_artifact_href is not None:
            _path_params['maven_maven_artifact_href'] = maven_maven_artifact_href
        # process the query parameters
        if fields is not None:
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='{maven_maven_artifact_href}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _set_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{maven_maven_artifact_href}set_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _unset_label_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='{maven_maven_artifact_href}unset_label/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
