...
class TestPatchedmavenMavenRemote(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PatchedmavenMavenRemote:
        """Test PatchedmavenMavenRemote
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatchedmavenMavenRemote`
        """
        model = PatchedmavenMavenRemote()
        if include_optional:
