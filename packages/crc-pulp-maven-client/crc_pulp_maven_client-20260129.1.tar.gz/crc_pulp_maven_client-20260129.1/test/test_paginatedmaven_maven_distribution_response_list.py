...
class TestPaginatedmavenMavenDistributionResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginatedmavenMavenDistributionResponseList:
        """Test PaginatedmavenMavenDistributionResponseList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedmavenMavenDistributionResponseList`
        """
        model = PaginatedmavenMavenDistributionResponseList()
        if include_optional:
