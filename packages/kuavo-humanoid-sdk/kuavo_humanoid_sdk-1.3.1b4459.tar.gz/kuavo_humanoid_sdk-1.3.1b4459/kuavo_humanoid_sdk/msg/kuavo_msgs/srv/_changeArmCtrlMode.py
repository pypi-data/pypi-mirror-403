...
class changeArmCtrlModeRequest(genpy.Message):
  _md5sum = "74741028b3e1f6696b9920b6be6f48c9"
  _type = "kuavo_msgs/changeArmCtrlModeRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int32 ik_ultra_fast_mode=3
int32 control_mode # 0: keep pose, 1: auto_swing_arm, 2: external_control, 3: ik_ultra_fast_mode 
"""
  # Pseudo-constants
  ik_ultra_fast_mode = 3
...
class changeArmCtrlMode(object):
  ...
  _md5sum = 'c9b154cca802a6580a2e018ad49b7c5b'
