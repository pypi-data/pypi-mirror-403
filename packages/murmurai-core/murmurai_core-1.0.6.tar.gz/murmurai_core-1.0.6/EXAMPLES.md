...
### French
    murmurai-core --model large --language fr examples/sample_fr_01.wav
...
### German
    murmurai-core --model large --language de examples/sample_de_01.wav
...
### Italian
    murmurai-core --model large --language it examples/sample_it_01.wav
...
### Japanese
    murmurai-core --model large --language ja examples/sample_ja_01.wav
