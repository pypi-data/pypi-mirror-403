"""Synchronous Pigeon client for sending emails."""
...
class PigeonSync:
    ...
    Example:
        ...
        >>> pigeon = PigeonSync(api_key="pk_xxx")
        >>> try:
        ...     result = pigeon.send(
        ...         to="user@example.com",
        ...         subject="Hello!",
    ...
    def __init__(
        ...
        *,
        ...
        """
        Initialize the synchronous Pigeon client.
    ...
    def send(
        ...
        *,
        ...
        Raises:
            PigeonRateLimitError: If client-side rate limit exceeded
        ...
        data = self._request("POST", "/v1/send", json=payload)
    ...
    def get_template(self, template_id: str) -> Template:
        ...
        Returns:
            Template object
        """
        data = self._request("GET", f"/v1/templates/{template_id}")
    ...
    def get_template_by_name(self, name: str) -> Template:
        ...
        Returns:
            Template object
        """
        data = self._request("GET", f"/v1/templates/name/{name}")
        return Template.from_dict(data)
    ...
    def list_emails(
        ...
        *,
        ...
        data = self._request("GET", "/v1/emails", params=params)
    ...
    def send_batch(
        ...
        *,
        ...
        data = self._request("POST", "/v1/send/batch", json=payload)
