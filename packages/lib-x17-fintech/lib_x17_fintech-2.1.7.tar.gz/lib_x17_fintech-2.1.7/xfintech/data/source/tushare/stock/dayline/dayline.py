...
class Dayline(TushareJob):
    """
    描述:
    - 获取A股日线行情数据, 每天15点-16点之间入库
    - 本接口是未复权行情，停牌期间不提供数据
    - 基础积分每分钟内可调取500次
    ...
    属性:
    - name: str, 作业名称 'dayline'。
    - key: str, 作业键 '/tushare/dayline'。
    ...
    ```python
        ...
        from xfintech.data.source.tushare.stock.dayline import Dayline
