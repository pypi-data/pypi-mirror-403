...
modify the contents of the `src/ost_builder/lib/` and `examples/` directories.
...
```sh
$ pip install git+ssh://git@github.com/cinojosa0705/ost-builder-python-test.git
```
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/cinojosa0705/ost-builder-python-test/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
