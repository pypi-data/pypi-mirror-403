...
Examples
--------
>>> import pygraphx.algorithms.isomorphism as iso
...
>>> from pygraphx.algorithms.isomorphism.matchhelpers import close
>>> from pygraphx.algorithms.isomorphism import generic_node_match
