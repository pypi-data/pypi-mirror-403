...
from pygraphx.utils.decorators import argmap
from pygraphx.algorithms.community.community_utils import is_partition
...
def modularity(G, communities, weight="weight", resolution=1):
    ...
    Examples
    --------
    >>> import pygraphx.algorithms.community as nx_comm
