...
def is_threshold_graph(G):
    ...
    Examples
    --------
    >>> from pygraphx.algorithms.threshold import is_threshold_graph
    >>> G = nx.path_graph(3)
...
def make_compact(creation_sequence):
    ...
    Examples
    --------
    >>> from pygraphx.algorithms.threshold import make_compact
...
def find_threshold_graph(G, create_using=None):
    ...
    Examples
    --------
    >>> from pygraphx.algorithms.threshold import find_threshold_graph
    >>> G = nx.barbell_graph(3, 3)
