import time
from pygraphx.algorithms.assortativity import degree_mixing_dict
from pygraphx.generators import powerlaw_cluster_graph, gnm_random_graph
from pygraphx.generators.joint_degree_seq import (
