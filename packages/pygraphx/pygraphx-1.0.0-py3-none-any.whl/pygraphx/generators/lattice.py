...
from pygraphx.classes import set_node_attributes
from pygraphx.exception import NetworkXError
from pygraphx.relabel import relabel_nodes
from pygraphx.utils import flatten, nodes_or_number, pairwise
from pygraphx.generators.classic import cycle_graph
from pygraphx.generators.classic import empty_graph
from pygraphx.generators.classic import path_graph
...
def grid_graph(dim, periodic=False):
    ...
    >>> from pygraphx import grid_graph
    ...
    6
    """
    from pygraphx.algorithms.operators.product import cartesian_product
...
def triangular_lattice_graph(
    ...
    from pygraphx.algorithms.minors import contracted_nodes
