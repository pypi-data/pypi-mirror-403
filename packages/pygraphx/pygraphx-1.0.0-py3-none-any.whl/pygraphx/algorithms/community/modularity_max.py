...
from pygraphx.algorithms.community.quality import modularity

from pygraphx.utils.mapped_queue import MappedQueue
...
def greedy_modularity_communities(G, weight=None, resolution=1):
    ...
    Examples
    --------
    >>> from pygraphx.algorithms.community import greedy_modularity_communities
