...
class ShapefileDriver(aspose.gis.FileDriver):
    '''A driver for the Shapefile format.'''
    
    @overload
    def open_layer(self, path : str, options : aspose.gis.formats.shapefile.ShapefileOptions) -> aspose.gis.VectorLayer:
    ...
    @overload
    def open_layer(self, path : aspose.gis.AbstractPath, options : aspose.gis.formats.shapefile.ShapefileOptions) -> aspose.gis.VectorLayer:
        '''Opens a layer for reading.
    ...
    @overload
    def create_layer(self, path : str, options : aspose.gis.formats.shapefile.ShapefileOptions) -> aspose.gis.VectorLayer:
    ...
    @overload
    def create_layer(self, path : aspose.gis.AbstractPath, options : aspose.gis.formats.shapefile.ShapefileOptions) -> aspose.gis.VectorLayer:
        '''Creates a layer and opens it for adding new features.
    ...
    @overload
    def create_layer(self, path : aspose.gis.AbstractPath, options : aspose.gis.formats.shapefile.ShapefileOptions, spatial_reference_system : aspose.gis.spatialreferencing.SpatialReferenceSystem) -> aspose.gis.VectorLayer:
        '''Creates a layer and opens it for adding new features.
...
class ShapefileOptions(aspose.gis.DriverOptions):
