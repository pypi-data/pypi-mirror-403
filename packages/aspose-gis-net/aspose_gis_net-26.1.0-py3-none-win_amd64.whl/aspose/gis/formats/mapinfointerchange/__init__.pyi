...
class MapInfoInterchangeDriver(aspose.gis.FileDriver):
    '''A driver for the MapInfo Interchange Format.'''
    
    @overload
    def open_layer(self, path : str, options : aspose.gis.formats.mapinfointerchange.MapInfoInterchangeOptions) -> aspose.gis.VectorLayer:
    ...
    @overload
    def open_layer(self, path : aspose.gis.AbstractPath, options : aspose.gis.formats.mapinfointerchange.MapInfoInterchangeOptions) -> aspose.gis.VectorLayer:
        '''Opens a layer for reading.
    ...
    @overload
    def create_layer(self, path : str, options : aspose.gis.formats.mapinfointerchange.MapInfoInterchangeOptions) -> aspose.gis.VectorLayer:
