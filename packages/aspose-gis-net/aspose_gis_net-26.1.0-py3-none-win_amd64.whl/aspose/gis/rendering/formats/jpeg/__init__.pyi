...
class JpegRenderer(aspose.gis.rendering.Renderer):
    '''A :py:class:`aspose.gis.rendering.Renderer` that renders :py:class:`aspose.gis.rendering.Map` into JPEG file.'''
