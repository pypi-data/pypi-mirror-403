...
class Brush:
    ...
    @property
    def fore_color(self) -> aspose.gis.common.formats.mapinfo.styling.Color:
        raise NotImplementedError()
    
    @property
    def back_color(self) -> Optional[aspose.gis.common.formats.mapinfo.styling.Color]:
        raise NotImplementedError()
...
class Pen:
    ...
    @property
    def color(self) -> aspose.gis.common.formats.mapinfo.styling.Color:
        raise NotImplementedError()
