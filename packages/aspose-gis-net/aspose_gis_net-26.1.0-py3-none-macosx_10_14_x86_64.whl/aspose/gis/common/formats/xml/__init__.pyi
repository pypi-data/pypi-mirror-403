...
class XmlIndex2:
    ...
    @overload
    def build(self, root_name : aspose.gis.common.formats.xml.XmlName, split_names : List[aspose.gis.common.formats.xml.XmlName], symbol_to_replace_illegal : str) -> None:
        raise NotImplementedError()
