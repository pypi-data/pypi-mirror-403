...
class PostGisDriver(aspose.gis.DatabaseDriver):
    ...
    def from_definition(self, table_name : str) -> aspose.gis.formats.database.fromdefinition.FromDefinitionDataSourceBuilder:
        '''Allows the start of the process of configuring the data source :py:class:`aspose.gis.formats.database.fromdefinition.IFromDefinitionDataSource` for further work with it.
        
        :param table_name: Name of the database table from which the data will be extracted
        :returns: :py:class:`aspose.gis.formats.database.fromdefinition.FromDefinitionDataSourceBuilder`'''
        raise NotImplementedError()
    

class PostGisOptions(aspose.gis.DatabaseDriverOptions):
