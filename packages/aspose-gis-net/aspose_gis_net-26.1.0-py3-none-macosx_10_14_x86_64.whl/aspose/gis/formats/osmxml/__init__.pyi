...
class OsmXmlDriver(aspose.gis.FileDriver):
    '''A driver for the OSM XML format.'''
    
    @overload
    def open_layer(self, path : str, options : aspose.gis.formats.osmxml.OsmXmlOptions) -> aspose.gis.VectorLayer:
    ...
    @overload
    def open_layer(self, path : aspose.gis.AbstractPath, options : aspose.gis.formats.osmxml.OsmXmlOptions) -> aspose.gis.VectorLayer:
        '''Opens a layer for reading.
    ...
    @overload
    def create_layer(self, path : str, options : aspose.gis.formats.osmxml.OsmXmlOptions) -> aspose.gis.VectorLayer:
    ...
    @overload
    def create_layer(self, path : str, options : aspose.gis.formats.osmxml.OsmXmlOptions, spatial_reference_system : aspose.gis.spatialreferencing.SpatialReferenceSystem) -> aspose.gis.VectorLayer:
        '''Creates a layer and opens it for adding new features.
    ...
    @overload
    def create_layer(self, path : aspose.gis.AbstractPath, options : aspose.gis.formats.osmxml.OsmXmlOptions, spatial_reference_system : aspose.gis.spatialreferencing.SpatialReferenceSystem) -> aspose.gis.VectorLayer:
        '''Creates a layer and opens it for adding new features.
...
class OsmXmlOptions(aspose.gis.DriverOptions):
    ...
    @property
    def report_all_nodes(self) -> bool:
        '''Report all nodes as features, even if they don\'t have any significant tags.'''
        raise NotImplementedError()
    
    @report_all_nodes.setter
    def report_all_nodes(self, value : bool) -> None:
        '''Report all nodes as features, even if they don\'t have any significant tags.'''
        raise NotImplementedError()
    
    @property
    def report_all_ways(self) -> bool:
        '''Report all ways as features, even if they don\'t have any significant tags or don\'t have any nodes.'''
        raise NotImplementedError()
    
    @report_all_ways.setter
    def report_all_ways(self, value : bool) -> None:
        '''Report all ways as features, even if they don\'t have any significant tags or don\'t have any nodes.'''
        raise NotImplementedError()
    
    @property
    def report_common_attributes(self) -> bool:
    ...
    @report_common_attributes.setter
    def report_common_attributes(self, value : bool) -> None:
        '''Report common OSM attributes: visible, version, changeset, timestamp, user and uid.
        Common attributes will be reported as feature attributes with "osm_" prefix, e.g. osm_user, osm_timestamp, etc.'''
        raise NotImplementedError()
    
    @property
    def write_common_attributes(self) -> bool:
        '''Write common OSM attributes: visible, version, changeset, timestamp, user and uid.'''
        raise NotImplementedError()
    
    @write_common_attributes.setter
    def write_common_attributes(self, value : bool) -> None:
        '''Write common OSM attributes: visible, version, changeset, timestamp, user and uid.'''
        raise NotImplementedError()
