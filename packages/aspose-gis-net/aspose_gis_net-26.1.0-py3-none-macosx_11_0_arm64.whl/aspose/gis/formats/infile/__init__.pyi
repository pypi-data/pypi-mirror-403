...
class InFileDriver(aspose.gis.FileDriver):
    '''A driver for work with data and temporary save in file.'''
    
    @overload
    def open_layer(self, path : str, options : aspose.gis.formats.infile.InFileOptions) -> aspose.gis.VectorLayer:
    ...
    @overload
    def open_layer(self, path : aspose.gis.AbstractPath, options : aspose.gis.formats.infile.InFileOptions) -> aspose.gis.VectorLayer:
        '''Opens a layer for reading.
    ...
    @overload
    def create_layer(self, path : str, options : aspose.gis.formats.infile.InFileOptions) -> aspose.gis.VectorLayer:
    ...
    @overload
    def create_layer(self, path : aspose.gis.AbstractPath, options : aspose.gis.formats.infile.InFileOptions) -> aspose.gis.VectorLayer:
        '''Creates a layer and opens it for adding new features.
    ...
    @overload
    def create_layer(self, path : aspose.gis.AbstractPath, options : aspose.gis.formats.infile.InFileOptions, spatial_reference_system : aspose.gis.spatialreferencing.SpatialReferenceSystem) -> aspose.gis.VectorLayer:
        '''Creates a layer and opens it for adding new features.
...
class InFileOptions(aspose.gis.DriverOptions):
    ...
    @property
    def count_of_feature_in_part(self) -> int:
        '''Max count of features in every part of the file'''
        raise NotImplementedError()
    
    @count_of_feature_in_part.setter
    def count_of_feature_in_part(self, value : int) -> None:
        '''Max count of features in every part of the file'''
        raise NotImplementedError()
