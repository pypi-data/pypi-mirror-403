...
class MapInfoTabDriver(aspose.gis.FileDriver):
    '''A driver for the MapInfo Tab format.'''
    
    @overload
    def open_layer(self, path : str, options : aspose.gis.formats.mapinfotab.MapInfoTabOptions) -> aspose.gis.VectorLayer:
    ...
    @overload
    def open_layer(self, path : aspose.gis.AbstractPath, options : aspose.gis.formats.mapinfotab.MapInfoTabOptions) -> aspose.gis.VectorLayer:
        '''Opens a layer for reading.
    ...
    @overload
    def create_layer(self, path : str, options : aspose.gis.formats.mapinfotab.MapInfoTabOptions) -> aspose.gis.VectorLayer:
    ...
    @overload
    def create_layer(self, path : aspose.gis.AbstractPath, options : aspose.gis.formats.mapinfotab.MapInfoTabOptions) -> aspose.gis.VectorLayer:
        '''Creates a layer and opens it for adding new features.
    ...
    @overload
    def create_layer(self, path : aspose.gis.AbstractPath, options : aspose.gis.formats.mapinfotab.MapInfoTabOptions, spatial_reference_system : aspose.gis.spatialreferencing.SpatialReferenceSystem) -> aspose.gis.VectorLayer:
        '''Creates a layer and opens it for adding new features.
...
class MapInfoTabOptions(aspose.gis.DriverOptions):
    ...
    @property
    def text_string_attribute(self) -> str:
        '''Specifies name of the attribute that represents text of \'Text\' graphical object.'''
        raise NotImplementedError()
    
    @text_string_attribute.setter
    def text_string_attribute(self, value : str) -> None:
        '''Specifies name of the attribute that represents text of \'Text\' graphical object.'''
        raise NotImplementedError()
    ...
    @property
    def is_ignore_wrong_data(self) -> bool:
        '''Determines should we throw exception while work with wrong data or set default values for it'''
        raise NotImplementedError()
    
    @is_ignore_wrong_data.setter
    def is_ignore_wrong_data(self, value : bool) -> None:
        '''Determines should we throw exception while work with wrong data or set default values for it'''
        raise NotImplementedError()
