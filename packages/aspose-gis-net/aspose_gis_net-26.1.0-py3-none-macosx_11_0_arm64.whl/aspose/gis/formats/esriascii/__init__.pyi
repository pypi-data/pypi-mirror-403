...
class EsriAsciiDriver(aspose.gis.RasterDriver):
    ...
    @overload
    def open_layer(self, path : str, options : aspose.gis.formats.esriascii.EsriAsciiOptions) -> aspose.gis.raster.RasterLayer:
    ...
    @overload
    def open_layer(self, path : aspose.gis.AbstractPath, options : aspose.gis.formats.esriascii.EsriAsciiOptions) -> aspose.gis.raster.RasterLayer:
        '''Opens a layer for reading.
