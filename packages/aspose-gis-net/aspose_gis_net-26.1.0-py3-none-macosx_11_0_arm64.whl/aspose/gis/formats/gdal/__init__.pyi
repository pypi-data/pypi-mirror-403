...
class GdalDriver(aspose.gis.FileDriver):
    '''A driver for the GDAL format.'''
    
    @overload
    def open_layer(self, path : str, options : aspose.gis.formats.gdal.GdalOptions) -> aspose.gis.VectorLayer:
...
class GdalOptions(aspose.gis.DriverOptions):
    ...
    @property
    def path_to_temp_file(self) -> str:
