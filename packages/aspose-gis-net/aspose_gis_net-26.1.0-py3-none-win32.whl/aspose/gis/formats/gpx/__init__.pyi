...
class GpxDriver(aspose.gis.FileDriver):
    '''A driver for the GPX format.'''
    
    @overload
    def open_layer(self, path : str, options : aspose.gis.formats.gpx.GpxOptions) -> aspose.gis.VectorLayer:
    ...
    @overload
    def open_layer(self, path : aspose.gis.AbstractPath, options : aspose.gis.formats.gpx.GpxOptions) -> aspose.gis.VectorLayer:
        '''Opens a layer for reading.
    ...
    @overload
    def create_layer(self, path : str, options : aspose.gis.formats.gpx.GpxOptions) -> aspose.gis.VectorLayer:
    ...
    @overload
    def create_layer(self, path : aspose.gis.AbstractPath, options : aspose.gis.formats.gpx.GpxOptions) -> aspose.gis.VectorLayer:
        '''Creates a layer and opens it for adding new features.
    ...
    @overload
    def create_layer(self, path : aspose.gis.AbstractPath, options : aspose.gis.formats.gpx.GpxOptions, spatial_reference_system : aspose.gis.spatialreferencing.SpatialReferenceSystem) -> aspose.gis.VectorLayer:
        '''Creates a layer and opens it for adding new features.
...
class GpxOptions(aspose.gis.DriverOptions):
    ...
    @z_attribute.setter
    def z_attribute(self, value : str) -> None:
        '''Determines which GPX attribute will be exported as \'Z\' coordinate of waypoints, route points and track points.
        If  - no attribute will be exported as \'Z\' coordinate.
        Defaults to "ele".
        Possible values are names of all GPX XML attribute that can be represented as double (e.g. "speed", "magvar", "geoidheight" etc.)'''
    ...
    @property
    def m_attribute(self) -> str:
        '''Determines which GPX attribute will be exported as \'M\' coordinate of waypoints, route points and track points.
        Behavior is same with :py:attr:`aspose.gis.formats.gpx.GpxOptions.z_attribute`, defaults to .'''
        raise NotImplementedError()
    
    @m_attribute.setter
    def m_attribute(self, value : str) -> None:
        '''Determines which GPX attribute will be exported as \'M\' coordinate of waypoints, route points and track points.
        Behavior is same with :py:attr:`aspose.gis.formats.gpx.GpxOptions.z_attribute`, defaults to .'''
        raise NotImplementedError()
    
    @property
    def read_nested_attributes(self) -> bool:
        '''Determines if GPX points, such as \'trkpt\' and \'rtept\', contain inner attributes and if it should be read. Defaults to .'''
        raise NotImplementedError()
    
    @read_nested_attributes.setter
    def read_nested_attributes(self, value : bool) -> None:
        '''Determines if GPX points, such as \'trkpt\' and \'rtept\', contain inner attributes and if it should be read. Defaults to .'''
        raise NotImplementedError()
    
    @property
    def nested_attribute_separator(self) -> str:
