...
class GmlDriver(aspose.gis.FileDriver):
    '''A driver for the GML format.'''
    
    @overload
    def open_layer(self, path : str, options : aspose.gis.formats.gml.GmlOptions) -> aspose.gis.VectorLayer:
    ...
    @overload
    def open_layer(self, path : aspose.gis.AbstractPath, options : aspose.gis.formats.gml.GmlOptions) -> aspose.gis.VectorLayer:
        '''Opens a layer for reading.
    ...
    @overload
    def create_layer(self, path : str, options : aspose.gis.formats.gml.GmlOptions) -> aspose.gis.VectorLayer:
    ...
    @overload
    def create_layer(self, path : str, options : aspose.gis.formats.gml.GmlOptions, spatial_reference_system : aspose.gis.spatialreferencing.SpatialReferenceSystem) -> aspose.gis.VectorLayer:
        '''Creates a layer and opens it for adding new features.
...
class GmlOptions(aspose.gis.DriverOptions):
    ...
    def schema_location(self) -> str:
        ...
        If set to , :py:class:`aspose.gis.formats.gml.GmlDriver` will try read schemaLocation from the root element of the document.
        Default is .'''
        raise NotImplementedError()
