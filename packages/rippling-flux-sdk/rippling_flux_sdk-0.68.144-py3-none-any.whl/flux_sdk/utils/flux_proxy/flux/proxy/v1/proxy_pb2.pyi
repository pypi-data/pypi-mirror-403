...
class _CredentialTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_CredentialType.ValueType], builtins.type):
...
class _AuthenticationTypeEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_AuthenticationType.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
    AUTHENTICATION_TYPE_UNSPECIFIED: _AuthenticationType.ValueType  # 0
    AUTHENTICATION_TYPE_BASIC_AUTH: _AuthenticationType.ValueType  # 1
    AUTHENTICATION_TYPE_IN_BODY: _AuthenticationType.ValueType  # 2

class AuthenticationType(_AuthenticationType, metaclass=_AuthenticationTypeEnumTypeWrapper):
    """This details the authentication mechanism for how the clientId/clientSecret should be injected into the request
    for Oauth2.0 Client credential token exchange
    """

AUTHENTICATION_TYPE_UNSPECIFIED: AuthenticationType.ValueType  # 0
AUTHENTICATION_TYPE_BASIC_AUTH: AuthenticationType.ValueType  # 1
AUTHENTICATION_TYPE_IN_BODY: AuthenticationType.ValueType  # 2
...
class StartSessionRequest(google.protobuf.message.Message):
    ...
    def allow_hosts(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
        ...
        Hosts are exact matches, so if a session is allowed to connect to "example.com", it will not be allowed to connect
        to "www.example.com".  No wildcards are supported.
    ...
    def ClearField(self, field_name: typing.Literal["allow_hosts", b"allow_hosts", "credential_ids", b"credential_ids", "expires_at", b"expires_at", "headers", b"headers"]) -> None: ...
...
class OAuthCredential(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["expires_at", b"expires_at"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["access_token", b"access_token", "client_id", b"client_id", "client_secret", b"client_secret", "expires_at", b"expires_at", "refresh_token", b"refresh_token", "token_type", b"token_type", "token_url", b"token_url"]) -> None: ...
...
class OAuthClientCredential(google.protobuf.message.Message):
    ...
    client_secret: builtins.str
    token_url: builtins.str
    auth_type: global___AuthenticationType.ValueType
    def __init__(
        self,
        *,
        client_id: builtins.str = ...,
    ...
    def ClearField(self, field_name: typing.Literal["auth_type", b"auth_type", "client_id", b"client_id", "client_secret", b"client_secret", "token_url", b"token_url"]) -> None: ...
...
class AWSAccessKeyCredential(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["access_key_id", b"access_key_id", "access_key_secret", b"access_key_secret", "account_id", b"account_id"]) -> None: ...
...
class AWSAssumeRoleCredential(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["account_id", b"account_id", "duration", b"duration", "external_id", b"external_id", "role_arn", b"role_arn"]) -> None: ...

global___AWSAssumeRoleCredential = AWSAssumeRoleCredential

@typing.final
class RequesterInfo(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    COMPANY_ID_FIELD_NUMBER: builtins.int
    ROLE_ID_FIELD_NUMBER: builtins.int
    REQUEST_ID_FIELD_NUMBER: builtins.int
    company_id: builtins.str
    ...
    def ClearField(self, field_name: typing.Literal["company_id", b"company_id", "request_id", b"request_id", "role_id", b"role_id"]) -> None: ...

global___RequesterInfo = RequesterInfo
...
class NewCredentialRequest(google.protobuf.message.Message):
    ...
    REQUESTER_INFO_FIELD_NUMBER: builtins.int
    @property
    ...
    def domains(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]:
        ...
        For example, if a domain is "example.com", it will match "example.com" and "www.example.com" but not "example.org"
        or "myexample.org".  This acts as a protection mechanism to prevent credentials from accidentally being sent to the
        wrong host.
    ...
    @property
    def requester_info(self) -> global___RequesterInfo:
        """Information about who is requesting the credential creation. Using a high
        ID so we can add more credential types in the future above.
        """
    ...
    def WhichOneof(self, oneof_group: typing.Literal["credential", b"credential"]) -> typing.Literal["basic_credential", "api_keys_credential", "oauth_credential", "google_json_credential", "bearer_token_credential", "authorization_header_credential", "oauth_client_credential", "aws_access_key_credential", "aws_assume_role_credential"] | None: ...
...
class CheckCredentialResponse(google.protobuf.message.Message):
    ...
    @property
    def expires_at(self) -> google.protobuf.timestamp_pb2.Timestamp:
        """expires_at is optionally set if there is a known expiry for the credential.  This field will currently only set for
        oauth tokens.
        """
    ...
    def HasField(self, field_name: typing.Literal["expires_at", b"expires_at", "invalid_as_of", b"invalid_as_of"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["credential_id", b"credential_id", "domains", b"domains", "expires_at", b"expires_at", "invalid_as_of", b"invalid_as_of", "type", b"type"]) -> None: ...
...
class UpdateCredentialRequest(google.protobuf.message.Message):
    ...
    @property
    def requester_info(self) -> global___RequesterInfo:
        """Information about who is requesting the credential update. Using a high
        ID so we can add more credential types in the future above.
        """
