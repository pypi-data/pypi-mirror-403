...
class EquityGrant(BaseModel):
    ...
    grant_quantity: the total quantity granted
    ...
    extras: fields that are specific to some third parties and might not be needed in every use case
    """
...
class PollingPayload(BaseModel):
    in_progress_condition: dict
    success_condition: dict
    polling_payload: dict
