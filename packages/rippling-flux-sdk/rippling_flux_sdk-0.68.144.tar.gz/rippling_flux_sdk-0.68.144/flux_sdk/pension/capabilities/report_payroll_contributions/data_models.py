...
class PayrollRunContribution:
    ...
    """
    amount_before_catchup: Optional[Decimal]
    """
    amount_before_catchup: This field contains the contribution amount before any catchup contribution is applied
    """
...
class EoyInfo:
    ...
    """
    year_to_date_roth_deferral_before_catchup: This field contains the year to date total roth deferral
    contribution before catchup
    """
    year_to_date_roth_deferral_before_catchup: Optional[Decimal]
    """
    year_to_date_pretax_deferral_before_catchup: This field contains the year to date total pre-tax deferral
    contribution before catchup
    """
    year_to_date_pretax_deferral_before_catchup: Optional[Decimal]
...
class EmployeeDeduction:
    ...
    """
    amount_before_catchup: This field contains the deduction amount before any catchup contribution is applied
    """
    amount_before_catchup: Optional[Decimal]
    """
    is_percentage_before_catchup: This field indicates whether the deduction amount before catchup is a percentage
    """
    is_percentage_before_catchup: Optional[bool]
