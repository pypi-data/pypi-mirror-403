//Autogenerated PPP header from /panda/panda/plugins/hooks2/hooks2_ppp.h

// Hook functions must be of this type
typedef bool (*hooks2_func_t)(CPUState *, TranslationBlock *, void *);
void ppp_add_cb_hooks2_func(hooks2_func_t);
bool ppp_remove_cb_hooks2_func(hooks2_func_t);
...
void ppp_add_cb__add_hooks2(_add_hooks2_t);
bool ppp_remove_cb__add_hooks2(_add_hooks2_t);
