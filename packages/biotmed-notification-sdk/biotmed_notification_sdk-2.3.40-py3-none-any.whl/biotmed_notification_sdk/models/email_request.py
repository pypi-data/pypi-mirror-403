...
class EmailRequest(BaseModel):
    ...
    addresses_to: Optional[List[StrictStr]] = Field(default=None, alias="addressesTo")
    addresses_cc: Optional[List[StrictStr]] = Field(default=None, alias="addressesCC")
    addresses_bcc: Optional[List[StrictStr]] = Field(default=None, alias="addressesBCC")
    email_template: Optional[EmailTemplate] = Field(default=None, alias="emailTemplate")
    attachments_keys_and_names: Optional[Dict[str, StrictStr]] = Field(default=None, alias="attachmentsKeysAndNames")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["subject", "locale", "addressesTo", "addressesCC", "addressesBCC", "emailTemplate", "attachmentsKeysAndNames"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "addressesTo": obj.get("addressesTo"),
            "addressesCC": obj.get("addressesCC"),
            "addressesBCC": obj.get("addressesBCC"),
            "emailTemplate": EmailTemplate.from_dict(obj["emailTemplate"]) if obj.get("emailTemplate") is not None else None,
            "attachmentsKeysAndNames": obj.get("attachmentsKeysAndNames")
        })
