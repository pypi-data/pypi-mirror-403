...
class ConfigurationRequest(BaseModel):
    ...
    """ # noqa: E501
    email_sender_display_name: Annotated[str, Field(min_length=0, strict=True, max_length=500)] = Field(alias="emailSenderDisplayName")
    email_sender_address: Annotated[str, Field(min_length=0, strict=True, max_length=500)] = Field(alias="emailSenderAddress")
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["emailSenderDisplayName", "emailSenderAddress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ConfigurationRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ConfigurationRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "emailSenderDisplayName": obj.get("emailSenderDisplayName"),
            "emailSenderAddress": obj.get("emailSenderAddress")
        })
