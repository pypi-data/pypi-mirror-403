...
class EmailTemplate(BaseModel):
    ...
    marking_fields: Optional[Dict[str, StrictStr]] = Field(default=None, alias="markingFields")
    components: Optional[List[EmailTemplate]] = None
    # BioT Code Start: Store custom attributes in a dedicated dict (safe default)
    additional_properties: Dict[str, Any] = Field(default_factory=dict)
    # BioT Code End
    __properties: ClassVar[List[str]] = ["templateId", "markingFields", "components"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "markingFields": obj.get("markingFields"),
            "components": [EmailTemplate.from_dict(_item) for _item in obj["components"]] if obj.get("components") is not None else None
        })
...
EmailTemplate.model_rebuild(raise_errors=False)
