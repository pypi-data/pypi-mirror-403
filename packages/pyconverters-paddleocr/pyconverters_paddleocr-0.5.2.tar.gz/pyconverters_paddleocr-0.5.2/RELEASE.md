...
This document guides a contributor through creating a release of pyconverters_paddleocr.
...
[GitHub actions](https://github.com/oterrier/pyconverters_paddleocr/actions?query=branch%3Amaster+workflow%3Atests).
