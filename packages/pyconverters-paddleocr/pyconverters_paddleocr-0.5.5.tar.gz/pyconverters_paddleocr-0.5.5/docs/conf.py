...
import pyconverters_paddleocr


# -- Project information -----------------------------------------------------

project = "pyconverters_paddleocr"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyconverters_paddleocr.__version__
release = pyconverters_paddleocr.__version__
...
apidoc_module_dir = os.path.dirname(pyconverters_paddleocr.__file__)
