...
class TestHelpers(unittest.TestCase):
    def test0_documentation_examples(self):
        ...
        i18nMyInstance = Translator(os.path.join(CURRENT_PATH, "path_of_languages"), "test", debug=True)
        ...
        if os.path.exists(os.path.join(CURRENT_PATH, "helpers_out", "new_sass.sass")):
            os.remove(os.path.join(CURRENT_PATH, "helpers_out", "new_sass.sass"))
        self.assertRaises(SyntaxError, lambda: DIV().sass_vars)
        self.assertEqual(
            instanceDIV.sass_file(os.path.join(CURRENT_PATH, "helpers_out", "my_sass.sass"), {"COLOR": "orange", "BORDERRADIUS": "100%"}, os.path.join(CURRENT_PATH, "helpers_out", "new_sass.sass")),
            sample_sass
        )
        with open(os.path.join(CURRENT_PATH, "helpers_out", 'new_sass.sass'), 'r', encoding='utf-8') as f:
            c = f.read()
            self.assertEqual(
                c,
                sample_sass
        ...
        with open(os.path.join(CURRENT_PATH, "helpers_out", 'my_sass.sass'), 'r', encoding='utf-8') as f:
            c = f.read()
            self.assertEqual(
                c,
                instanceDIV.sass_file(os.path.join(CURRENT_PATH, "helpers_out", "my_sass.sass"))
            )
    ...
    def test9_i18n(self):
        ...
        Trans = Translator(os.path.join(CURRENT_PATH, "test_helpers_languages"), "test")
