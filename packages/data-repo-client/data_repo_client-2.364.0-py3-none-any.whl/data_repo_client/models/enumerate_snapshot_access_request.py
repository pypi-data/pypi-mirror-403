...
class EnumerateSnapshotAccessRequest(object):
    ...
    def __init__(self, items=None, local_vars_configuration=None):  # noqa: E501
        """EnumerateSnapshotAccessRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EnumerateSnapshotAccessRequest):
            return False
