...
class DRSPassportRequestModel(object):
    ...
    def __init__(self, expand=False, passports=None, local_vars_configuration=None):  # noqa: E501
        """DRSPassportRequestModel - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def passports(self):
        """Gets the passports of this DRSPassportRequestModel.  # noqa: E501
        ...
        :return: The passports of this DRSPassportRequestModel.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def passports(self, passports):
        """Sets the passports of this DRSPassportRequestModel.

        the encoded JWT GA4GH Passport that contains embedded Visas.  The overall JWT is signed as are the individual Passport Visas.  # noqa: E501

        :param passports: The passports of this DRSPassportRequestModel.  # noqa: E501
        :type: list[str]
        """
        if self.local_vars_configuration.client_side_validation and passports is None:  # noqa: E501
            raise ValueError("Invalid value for `passports`, must not be `None`")  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DRSPassportRequestModel):
            return False
