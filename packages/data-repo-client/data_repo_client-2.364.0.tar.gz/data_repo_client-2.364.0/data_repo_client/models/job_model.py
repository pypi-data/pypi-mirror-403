...
class JobModel(object):
    ...
    openapi_types = {
        ...
        'completed': 'str',
        'class_name': 'str',
        'target_iam_resource': 'JobTargetResourceModel'
    }
    ...
    attribute_map = {
        ...
        'target_iam_resource': 'target_iam_resource'
    }

    def __init__(self, id=None, description=None, job_status=None, status_code=None, submitted=None, completed=None, class_name=None, target_iam_resource=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._target_iam_resource = None
        ...
        if target_iam_resource is not None:
            self.target_iam_resource = target_iam_resource
    ...
    @property
    def target_iam_resource(self):
        """Gets the target_iam_resource of this JobModel.  # noqa: E501


        :return: The target_iam_resource of this JobModel.  # noqa: E501
        :rtype: JobTargetResourceModel
        """
        return self._target_iam_resource

    @target_iam_resource.setter
    def target_iam_resource(self, target_iam_resource):
        """Sets the target_iam_resource of this JobModel.


        :param target_iam_resource: The target_iam_resource of this JobModel.  # noqa: E501
        :type: JobTargetResourceModel
        """

        self._target_iam_resource = target_iam_resource
