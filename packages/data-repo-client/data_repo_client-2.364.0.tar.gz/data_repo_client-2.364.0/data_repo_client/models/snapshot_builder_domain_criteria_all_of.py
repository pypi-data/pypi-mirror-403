...
class SnapshotBuilderDomainCriteriaAllOf(object):
    ...
    def __init__(self, concept_id=None, local_vars_configuration=None):  # noqa: E501
        """SnapshotBuilderDomainCriteriaAllOf - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SnapshotBuilderDomainCriteriaAllOf):
            return False
