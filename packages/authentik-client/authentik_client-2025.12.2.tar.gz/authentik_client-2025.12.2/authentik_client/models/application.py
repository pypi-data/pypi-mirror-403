...
class Application(BaseModel):
    ...
    meta_icon_themed_urls: Optional[ThemedUrls]
    ...
    __properties: ClassVar[List[str]] = ["pk", "name", "slug", "provider", "provider_obj", "backchannel_providers", "backchannel_providers_obj", "launch_url", "open_in_new_tab", "meta_launch_url", "meta_icon", "meta_icon_url", "meta_icon_themed_urls", "meta_description", "meta_publisher", "policy_engine_mode", "group"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of meta_icon_themed_urls
        if self.meta_icon_themed_urls:
            _dict['meta_icon_themed_urls'] = self.meta_icon_themed_urls.to_dict()
        ...
        # set to None if meta_icon_themed_urls (nullable) is None
        # and model_fields_set contains the field
        if self.meta_icon_themed_urls is None and "meta_icon_themed_urls" in self.model_fields_set:
            _dict['meta_icon_themed_urls'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "meta_icon_themed_urls": ThemedUrls.from_dict(obj["meta_icon_themed_urls"]) if obj.get("meta_icon_themed_urls") is not None else None,
