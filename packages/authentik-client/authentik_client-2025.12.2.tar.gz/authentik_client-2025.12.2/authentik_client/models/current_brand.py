...
class CurrentBrand(BaseModel):
    ...
    branding_logo_themed_urls: Optional[ThemedUrls]
    branding_favicon: StrictStr
    branding_favicon_themed_urls: Optional[ThemedUrls]
    ...
    __properties: ClassVar[List[str]] = ["matched_domain", "branding_title", "branding_logo", "branding_logo_themed_urls", "branding_favicon", "branding_favicon_themed_urls", "branding_custom_css", "ui_footer_links", "ui_theme", "flow_authentication", "flow_invalidation", "flow_recovery", "flow_unenrollment", "flow_user_settings", "flow_device_code", "default_locale", "flags"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of branding_logo_themed_urls
        if self.branding_logo_themed_urls:
            _dict['branding_logo_themed_urls'] = self.branding_logo_themed_urls.to_dict()
        # override the default output from pydantic by calling `to_dict()` of branding_favicon_themed_urls
        if self.branding_favicon_themed_urls:
            _dict['branding_favicon_themed_urls'] = self.branding_favicon_themed_urls.to_dict()
        ...
        # set to None if branding_logo_themed_urls (nullable) is None
        # and model_fields_set contains the field
        if self.branding_logo_themed_urls is None and "branding_logo_themed_urls" in self.model_fields_set:
            _dict['branding_logo_themed_urls'] = None

        # set to None if branding_favicon_themed_urls (nullable) is None
        # and model_fields_set contains the field
        if self.branding_favicon_themed_urls is None and "branding_favicon_themed_urls" in self.model_fields_set:
            _dict['branding_favicon_themed_urls'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "branding_logo_themed_urls": ThemedUrls.from_dict(obj["branding_logo_themed_urls"]) if obj.get("branding_logo_themed_urls") is not None else None,
            "branding_favicon": obj.get("branding_favicon"),
            "branding_favicon_themed_urls": ThemedUrls.from_dict(obj["branding_favicon_themed_urls"]) if obj.get("branding_favicon_themed_urls") is not None else None,
