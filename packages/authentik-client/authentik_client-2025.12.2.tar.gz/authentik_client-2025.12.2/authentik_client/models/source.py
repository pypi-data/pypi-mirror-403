...
class Source(BaseModel):
    ...
    icon_themed_urls: Optional[ThemedUrls]
    __properties: ClassVar[List[str]] = ["pk", "name", "slug", "enabled", "promoted", "authentication_flow", "enrollment_flow", "user_property_mappings", "group_property_mappings", "component", "verbose_name", "verbose_name_plural", "meta_model_name", "policy_engine_mode", "user_matching_mode", "managed", "user_path_template", "icon", "icon_url", "icon_themed_urls"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of icon_themed_urls
        if self.icon_themed_urls:
            _dict['icon_themed_urls'] = self.icon_themed_urls.to_dict()
        ...
        # set to None if icon_themed_urls (nullable) is None
        # and model_fields_set contains the field
        if self.icon_themed_urls is None and "icon_themed_urls" in self.model_fields_set:
            _dict['icon_themed_urls'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "icon_themed_urls": ThemedUrls.from_dict(obj["icon_themed_urls"]) if obj.get("icon_themed_urls") is not None else None
        })
        return _obj
