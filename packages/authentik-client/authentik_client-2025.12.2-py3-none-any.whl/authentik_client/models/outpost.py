...
class Outpost(BaseModel):
    ...
    service_connection_obj: Optional[ServiceConnection]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if service_connection_obj (nullable) is None
        # and model_fields_set contains the field
        if self.service_connection_obj is None and "service_connection_obj" in self.model_fields_set:
            _dict['service_connection_obj'] = None
