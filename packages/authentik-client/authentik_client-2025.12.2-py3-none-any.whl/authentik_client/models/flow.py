...
class Flow(BaseModel):
    ...
    background_themed_urls: Optional[ThemedUrls]
    stages: List[UUID]
    policies: List[UUID]
    ...
    __properties: ClassVar[List[str]] = ["pk", "policybindingmodel_ptr_id", "name", "slug", "title", "designation", "background", "background_url", "background_themed_urls", "stages", "policies", "cache_count", "policy_engine_mode", "compatibility_mode", "export_url", "layout", "denied_action", "authentication"]
