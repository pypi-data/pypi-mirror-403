...
def main():
    ...
    # Configure search for Copernicus DEM (MPC)
    ...
    save_params = SaveParams(
        output_path='examples/cop30dem/data',
        save_to_local=True,
    ...
    print("Searching and downloading Copernicus DEM (MPC) imagery...")
    # Download
    ...
    save_data(
        ...
        identifier='copenhagen_copdem30',
        datetime=date_str,
        satellite='CopDEM30MPC',
        provider='MPC',
