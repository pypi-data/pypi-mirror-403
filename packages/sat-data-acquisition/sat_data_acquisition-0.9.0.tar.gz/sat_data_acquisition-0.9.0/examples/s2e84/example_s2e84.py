...
def main():
    ...
    # Configure search for Sentinel-2 Element84
    ...
    save_params = SaveParams(
        output_path='examples/s2e84/data',
        save_to_local=True,
    ...
    print("Searching and downloading Sentinel-2 (Element84) imagery...")
    # Download
