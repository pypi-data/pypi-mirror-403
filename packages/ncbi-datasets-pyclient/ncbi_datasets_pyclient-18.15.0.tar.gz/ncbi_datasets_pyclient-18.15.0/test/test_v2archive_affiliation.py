...
class TestV2archiveAffiliation(unittest.TestCase):
    """V2archiveAffiliation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2archiveAffiliation:
        """Test V2archiveAffiliation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2archiveAffiliation`
        """
        model = V2archiveAffiliation()
        if include_optional:
            return V2archiveAffiliation(
                affiliation = '',
                division = '',
    ...
    def testV2archiveAffiliation(self):
        """Test V2archiveAffiliation"""
