...
class TestV2SeqRange(unittest.TestCase):
    """V2SeqRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V2SeqRange:
        """Test V2SeqRange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V2SeqRange`
        """
        model = V2SeqRange()
        if include_optional:
            return V2SeqRange(
