...
class DocumentSearchResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["bm25", b"bm25", "facets", b"facets", "next_page", b"next_page", "query", b"query", "result_per_page", b"result_per_page", "results", b"results", "total", b"total"]) -> None: ...
...
class ParagraphSearchResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["bm25", b"bm25", "ematches", b"ematches", "facets", b"facets", "fuzzy_distance", b"fuzzy_distance", "next_page", b"next_page", "query", b"query", "result_per_page", b"result_per_page", "results", b"results", "total", b"total"]) -> None: ...
...
class VectorSearchResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["documents", b"documents", "result_per_page", b"result_per_page"]) -> None: ...
