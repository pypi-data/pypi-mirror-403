...
class NewShardRequest(google.protobuf.message.Message):
    ...
    @typing.final
    class RelationNodeVectorsetsConfigsEntry(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    @typing.final
    class RelationEdgeVectorsetsConfigsEntry(google.protobuf.message.Message):
        DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    RELATION_NODE_VECTORSETS_CONFIGS_FIELD_NUMBER: builtins.int
    RELATION_EDGE_VECTORSETS_CONFIGS_FIELD_NUMBER: builtins.int
    kbid: builtins.str
    ...
    @property
    def relation_node_vectorsets_configs(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___VectorIndexConfig]: ...
    @property
    def relation_edge_vectorsets_configs(self) -> google.protobuf.internal.containers.MessageMap[builtins.str, global___VectorIndexConfig]: ...
    def __init__(
        self,
        *,
        kbid: builtins.str = ...,
        ...
        prewarm_enabled: builtins.bool = ...,
        relation_node_vectorsets_configs: collections.abc.Mapping[builtins.str, global___VectorIndexConfig] | None = ...,
        relation_edge_vectorsets_configs: collections.abc.Mapping[builtins.str, global___VectorIndexConfig] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing.Literal["kbid", b"kbid", "prewarm_enabled", b"prewarm_enabled", "relation_edge_vectorsets_configs", b"relation_edge_vectorsets_configs", "relation_node_vectorsets_configs", b"relation_node_vectorsets_configs", "vectorsets_configs", b"vectorsets_configs"]) -> None: ...
