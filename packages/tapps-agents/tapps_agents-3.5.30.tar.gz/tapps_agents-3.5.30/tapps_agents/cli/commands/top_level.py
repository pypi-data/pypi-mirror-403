"""
Top-level command handlers (create, init, workflow, score, doctor, setup-experts, customize)
"""
import asyncio
import json
import logging
...
def _print_next_steps(project_root: Path | None = None) -> None:
    ...
    print("  @simple-mode *enhance \"prompt\"        # Prompt enhancement")
    print("  @simple-mode *breakdown \"goal\"        # Task breakdown")
    print("  @simple-mode *todo ready              # Beads todo (when bd available)")
    print()
    print("-" * 60)
    print()
