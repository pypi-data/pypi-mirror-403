...
def offer_context7_setup(project_root: Path, interactive: bool = True) -> bool:
    ...
    print("=" * 60)
    print()
    print("Context7 provides library documentation lookup for agents (e.g. FastAPI, React).")
    print("Benefits: agents get current library docs, better suggestions, optional caching.")
    print("This is optional; the framework works without it.")
    print()
