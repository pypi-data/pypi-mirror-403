...
class RefreshQueue:
    ...
    def __init__(
        self, queue_file: Path, policy_manager: StalenessPolicyManager | None = None
    ):
        """
    ...
    def remove_task(self, library: str, topic: str | None = None) -> bool:
        """
    ...
    def get_next_task(self, max_priority: int = 10) -> RefreshTask | None:
        """
    ...
    def mark_task_completed(
        self, library: str, topic: str | None = None, error: str | None = None
    ):
        """
    ...
    def queue_stale_entries(
        ...
        library_type_map: dict[str, str] | None = None,
        ...
        for entry in entries:
            ...
            if is_stale:
                ...
                self.add_task(
                    library=library, topic=topic, priority=priority, reason="staleness"
                )
                queued += 1
