...
User Experience (UX) design principles guide the creation of products that are useful, usable, and desirable. These principles help designers create experiences that meet user needs and business goals.
...
2. **Simple**: Remove complexity
3. **Consistent**: Use standard patterns
4. **Clear**: Communicate clearly
5. **Accessible**: Include all users
6. **Feedback**: Provide immediate feedback
7. **Error Prevention**: Prevent mistakes
8. **Testing**: Test with real users
9. **Iteration**: Continuous improvement
10. **Documentation**: Document decisions
