# Language list taken from:
# https://github.com/mastodon/mastodon/blob/main/app/helpers/languages_helper.rb
...
LANGUAGES = [
    ...
    ["mn-Mong", "Traditional Mongolian", "ᠮᠣᠩᠭᠣᠯ ᠬᠡᠯᠡ"],
    ["mr", "Marathi", "मराठी"],
    ...
    ["gsw", "Swiss German", "Schwiizertütsch"],
...
class LanguageSelect(Select[str]):
    def __init__(self, value: str, compact: bool = False):
        super().__init__(
            [(self._label(name, en_name), code) for code, en_name, name in LANGUAGES],
            prompt="Langauge",
            value=value,
            allow_blank=False,
            compact=compact,
    ...
    def _label(self, name: str, en_name: str) -> str:
        if en_name == name:
            return name
        return f"{name} ({en_name})"
