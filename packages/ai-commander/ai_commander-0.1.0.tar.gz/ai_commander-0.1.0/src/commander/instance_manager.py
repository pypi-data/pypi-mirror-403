...
from commander.frameworks.base import (
    BaseFramework,
    InstanceInfo,
    RegisteredInstance,
)
from commander.frameworks.claude_code import ClaudeCodeFramework
from commander.frameworks.mpm import MPMFramework
from commander.git.worktree_manager import WorktreeManager
...
if TYPE_CHECKING:
    ...
    from commander.persistence.state_store import StateStore
