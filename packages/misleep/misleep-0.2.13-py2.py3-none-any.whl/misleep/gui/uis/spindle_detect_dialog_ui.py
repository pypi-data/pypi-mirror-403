...
class Ui_SpindleDetectDialog(object):
    def setupUi(self, SpindleDetectDialog):
        ...
        self.durationThresholdEditor = QtWidgets.QDoubleSpinBox(self.groupBox)
        self.durationThresholdEditor.setProperty("value", 0.2)
        self.durationThresholdEditor.setObjectName("durationThresholdEditor")
    ...
    def retranslateUi(self, SpindleDetectDialog):
        ...
        self.label_6.setText(_translate("SpindleDetectDialog", "Spindle duration threshold"))
        self.label_7.setText(_translate("SpindleDetectDialog", "*STD + MEAN"))
