...
data_df = pd.read_pickle('/Users/matt/Desktop/low_wells.pkl').reset_index()
...
for plate_name in data_df['Plate'].unique():
    ...
    generate_new_plate_from_slat_handle_df(plate_subset, '/Users/matt/Desktop', 'test_file.xlsx',
