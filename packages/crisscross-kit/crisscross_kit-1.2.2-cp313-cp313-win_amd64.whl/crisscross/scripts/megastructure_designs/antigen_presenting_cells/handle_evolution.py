...
##CHANGE AS NECESSARY!!!
root_folder = '/Users/matt/Documents/Shih_Lab_Postdoc/research_projects/CAPCs/version_1_peripheral'
design_folder = root_folder
batch_file_folder = os.path.join(root_folder, 'handle_evolution_low_random')
server_base_folder = '/home/maa2818/capc_evolution'
...
design_1 = 'capc_v1_design.xlsx'

all_sbatch_commands = []

server_experiment_folder = os.path.join(server_base_folder, f'handle_evolution_low_random')
