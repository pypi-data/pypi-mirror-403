...
experiment_folder = '/Users/matt/Partners HealthCare Dropbox/Matthew Aquilina/Origami Crisscross Team Docs/Crisscross Designs/SW151_aarhus_rectwindow/'
...
design_file = os.path.join(experiment_folder, 'design_with_evolved_handles.xlsx')
...
megastructure.patch_placeholder_handles(main_plates + (src_004, P3510))
...
if generate_echo:
    commands = convert_slats_into_echo_commands(slat_dict=megastructure.slats,
                                                destination_plate_name=f'bionwire_rect',
                                                reference_transfer_volume_nl=75,
                                                output_folder=echo_folder,
                                                center_only_well_pattern=False,
                                                plate_viz_type='barcode',
                                                normalize_volumes=True,
                                                output_filename=f'bionwire_rect_echo.csv')

    prepare_all_standard_sheets(megastructure.slats, os.path.join(lab_helper_folder, f'bionwire_rect_helpers.xlsx'),
