...
class AsyncVectorDBChangesetAdmin:
    """Async admin client for vector database changeset management endpoints."""

    def __init__(self, client: AsyncVectorBridgeClient):
        self.client = client

    async def get_changeset_diff(self, integration_name: str | None = None) -> list[StateFullSchema]:
        """
    ...
    async def delete_schema(self, schema_name: str, integration_name: str | None = None) -> list[StateFullSchema]:
        """
