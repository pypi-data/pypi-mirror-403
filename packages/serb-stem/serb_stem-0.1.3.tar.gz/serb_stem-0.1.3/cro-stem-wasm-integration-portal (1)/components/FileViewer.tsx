...
version = "1.3.0"
edition = "2021"
authors = ["Denis <github.com/Ja1Denis>"]
description = "Fast Croatian stemmer compiled to WebAssembly"
...
[dependencies]
wasm-bindgen = "0.2"
# Serde nam treba za batch obradu nizova
serde = { version = "1.0", features = ["derive"] }
serde-wasm-bindgen = "0.4"
console_error_panic_hook = "0.1.7"

[profile.release]
opt-level = "z"     # Optimizacija za veličinu (bitno za web)
...
pub fn stem_batch(text: &str, is_aggressive: bool) -> JsValue {
  ...
  },
  {
    ...
    icon: FileCode,
    language: 'rust',
    content: `// Primjer kako povezati wasm modul
pub mod wasm;
...
impl CroStem {
    pub fn aggressive() -> Self {
        // Inicijalizacija s agresivnim pravilima
        Self {}
    }
    
    pub fn conservative() -> Self {
        // Inicijalizacija s konzervativnim pravilima
        Self {}
    }

    pub fn stem(&self, word: &str) -> String {
        // Ovdje ide tvoja prava logika iz repozitorija
        // Referenca: https://github.com/Ja1Denis/Cro-Stem
        word.to_string() 
    }
}`
  }
