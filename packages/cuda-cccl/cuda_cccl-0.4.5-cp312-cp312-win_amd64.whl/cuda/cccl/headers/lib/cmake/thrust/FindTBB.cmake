...
macro(findpkg_finish PREFIX TARGET_NAME)
  ...
  if (NOT TARGET "TBB::${TARGET_NAME}")
    ...
    set_target_properties(
      TBB::${TARGET_NAME}
      PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${${PREFIX}_INCLUDE_DIR}"
    )
    ...
    elseif (${PREFIX}_LIBRARY_RELEASE)
      set_target_properties(
        TBB::${TARGET_NAME}
        PROPERTIES IMPORTED_LOCATION "${real_release}"
      )
    elseif (${PREFIX}_LIBRARY_DEBUG)
      set_target_properties(
        TBB::${TARGET_NAME}
        PROPERTIES IMPORTED_LOCATION "${real_debug}"
      )
    endif()
  endif()
...
if (
  ...
  AND NOT CMAKE_SYSTEM_VERSION VERSION_LESS 13.0
)
  set(USE_LIBCXX OFF)
...
find_path(TBB_INCLUDE_DIR NAMES tbb/tbb.h PATHS ${TBB_INC_SEARCH_PATH})
