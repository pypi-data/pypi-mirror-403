...
struct is_trivially_copy_assignable
    : bool_constant<_CCCL_BUILTIN_IS_TRIVIALLY_ASSIGNABLE(
        add_lvalue_reference_t<_Tp>, add_lvalue_reference_t<add_const_t<_Tp>>)>
{};

template <class _Tp>
inline constexpr bool is_trivially_copy_assignable_v =
  _CCCL_BUILTIN_IS_TRIVIALLY_ASSIGNABLE(add_lvalue_reference_t<_Tp>, add_lvalue_reference_t<add_const_t<_Tp>>);
