...
#ifndef _CUDA_STD___ALGORITHM_SORT_H
#define _CUDA_STD___ALGORITHM_SORT_H
...
{
  using _Ops = _IterOps<_AlgPolicy>;
  ::cuda::std::__sort3<_AlgPolicy, _Compare>(__x1, __x2, __x3, __c);
  if (__c(*__x4, *__x3))
  {
  ...
  _Comp __comp)
{
  ...
  ::cuda::std::__sort4<_AlgPolicy, _Comp>(__x1, __x2, __x3, __x4, __comp);
  if (__comp(*__x5, *__x4))
  {
...
template <class _Tp>
inline constexpr bool __is_simple_comparator = false;

template <>
inline constexpr bool __is_simple_comparator<__less&> = true;

template <class _Tp>
inline constexpr bool __is_simple_comparator<less<_Tp>&> = true;

template <class _Tp>
inline constexpr bool __is_simple_comparator<greater<_Tp>&> = true;

template <class _Compare, class _Iter, class _Tp = typename iterator_traits<_Iter>::value_type>
inline constexpr bool __use_branchless_sort =
  __has_contiguous_traversal<_Iter> && sizeof(_Tp) <= sizeof(void*)
  && is_arithmetic_v<_Tp> && __is_simple_comparator<_Compare>;
...
{
  if constexpr (__use_branchless_sort<_Compare, _RandomAccessIterator>)
  {
    ::cuda::std::__cond_swap<_Compare>(__x2, __x3, __c);
    ::cuda::std::__partially_sorted_swap<_Compare>(__x1, __x2, __x3, __c);
  }
  else
  {
    ::cuda::std::__sort3<_AlgPolicy, _Compare>(__x1, __x2, __x3, __c);
  ...
  _Compare __c)
{
  if constexpr (__use_branchless_sort<_Compare, _RandomAccessIterator>)
  {
    ::cuda::std::__cond_swap<_Compare>(__x1, __x3, __c);
    ::cuda::std::__cond_swap<_Compare>(__x2, __x4, __c);
    ::cuda::std::__cond_swap<_Compare>(__x1, __x2, __c);
    ::cuda::std::__cond_swap<_Compare>(__x3, __x4, __c);
    ::cuda::std::__cond_swap<_Compare>(__x2, __x3, __c);
  }
  else
  {
    ::cuda::std::__sort4<_AlgPolicy, _Compare>(__x1, __x2, __x3, __x4, __c);
  }
}
  ...
  _Compare __c)
{
  ...
  {
    ::cuda::std::__cond_swap<_Compare>(__x1, __x2, __c);
    ::cuda::std::__cond_swap<_Compare>(__x4, __x5, __c);
    ::cuda::std::__partially_sorted_swap<_Compare>(__x3, __x4, __x5, __c);
    ::cuda::std::__cond_swap<_Compare>(__x2, __x5, __c);
    ::cuda::std::__partially_sorted_swap<_Compare>(__x1, __x3, __x4, __c);
    ::cuda::std::__partially_sorted_swap<_Compare>(__x2, __x3, __x4, __c);
  }
  else
  {
    ::cuda::std::__sort5<_AlgPolicy, _Compare, _RandomAccessIterator>(
      ::cuda::std::move(__x1),
      ::cuda::std::move(__x2),
      ::cuda::std::move(__x3),
      ::cuda::std::move(__x4),
...
_CCCL_API constexpr void __selection_sort(_BidirectionalIterator __first, _BidirectionalIterator __last, _Compare __comp)
{
  ...
  {
    _BidirectionalIterator __i = ::cuda::std::__min_element<_Compare>(__first, __last, __comp);
    if (__i != __first)
    {
...
_CCCL_API bool __insertion_sort_incomplete(_RandomAccessIterator __first, _RandomAccessIterator __last, _Comp __comp)
{
  ...
  switch (__last - __first)
  {
    ...
    case 2:
      ...
      return true;
    case 3:
      ::cuda::std::__sort3_maybe_branchless<_AlgPolicy, _Comp>(__first, __first + difference_type(1), --__last, __comp);
      return true;
    case 4:
      ::cuda::std::__sort4_maybe_branchless<_AlgPolicy, _Comp>(
        __first, __first + difference_type(1), __first + difference_type(2), --__last, __comp);
      return true;
    case 5:
      ::cuda::std::__sort5_maybe_branchless<_AlgPolicy, _Comp>(
        __first,
  ...
  ::cuda::std::__sort3_maybe_branchless<_AlgPolicy, _Comp>(__first, __first + difference_type(1), __j, __comp);
  ...
  _RandomAccessIterator __first, _RandomAccessIterator __last, uint64_t& __left_bitset, uint64_t& __right_bitset)
{
  ...
  {
    difference_type __tz_left  = ::cuda::std::countr_zero(__left_bitset);
    __left_bitset              = ::cuda::std::__cccl_blsr(__left_bitset);
    difference_type __tz_right = ::cuda::std::countr_zero(__right_bitset);
    __right_bitset             = ::cuda::std::__cccl_blsr(__right_bitset);
...
_CCCL_API ::cuda::std::pair<_RandomAccessIterator, bool>
__bitset_partition(_RandomAccessIterator __first, _RandomAccessIterator __last, _Compare __comp)
{
  ...
  while (__lm1 - __first >= 2 * __detail::__block_size - 1)
  {
    ...
    if (__left_bitset == 0)
    {
      ::cuda::std::__populate_left_bitset<_Compare>(__first, __comp, __pivot, __left_bitset);
    }
    // Record the comparison outcomes for the elements currently on the right
    // side.
    if (__right_bitset == 0)
    {
      ::cuda::std::__populate_right_bitset<_Compare>(__lm1, __comp, __pivot, __right_bitset);
    }
  ...
  // sides.
  ::cuda::std::__bitset_partition_partial_blocks<_AlgPolicy, _Compare>(
  ...
  ::cuda::std::__swap_bitmap_pos_within<_AlgPolicy>(__first, __lm1, __left_bitset, __right_bitset);
  ...
  *__pivot_pos = ::cuda::std::move(__pivot);
  return ::cuda::std::make_pair(__pivot_pos, __already_partitioned);
}
  ...
  while (true)
  {
    ...
    switch (__len)
    {
      ...
      case 2:
        ...
        return;
      case 3:
        ::cuda::std::__sort3_maybe_branchless<_AlgPolicy, _Compare>(
          __first, __first + difference_type(1), --__last, __comp);
        return;
      case 4:
        ::cuda::std::__sort4_maybe_branchless<_AlgPolicy, _Compare>(
          __first, __first + difference_type(1), __first + difference_type(2), --__last, __comp);
        return;
      case 5:
        ::cuda::std::__sort5_maybe_branchless<_AlgPolicy, _Compare>(
          __first,
          __first + difference_type(1),
          __first + difference_type(2),
          __first + difference_type(3),
    ...
    if (__len < __limit)
    {
      ...
      {
        ::cuda::std::__insertion_sort_unguarded<_AlgPolicy, _Compare>(__first, __last, __comp);
      }
      return;
    }
    if (__depth == 0)
    {
      ...
      ::cuda::std::__partial_sort<_AlgPolicy, _Compare>(__first, __last, __last, __comp);
      return;
    }
    --__depth;
    {
      ...
      {
        ::cuda::std::__sort3<_AlgPolicy, _Compare>(__first, __first + __half_len, __last - difference_type(1), __comp);
        ::cuda::std::__sort3<_AlgPolicy, _Compare>(
      ...
      {
        ::cuda::std::__sort3<_AlgPolicy, _Compare>(__first + __half_len, __first, __last - difference_type(1), __comp);
      }
    }
    ...
    {
      __first = ::cuda::std::__partition_with_equals_on_left<_AlgPolicy, _RandomAccessIterator, _Comp_ref>(
    ...
    if (__ret.second)
    {
      bool __fs = ::cuda::std::__insertion_sort_incomplete<_AlgPolicy, _Compare>(__first, __i, __comp);
      if (::cuda::std::__insertion_sort_incomplete<_AlgPolicy, _Compare>(__i + difference_type(1), __last, __comp))
      {
        if (__fs)
        {
          return;
    ...
    ::cuda::std::__introsort<_AlgPolicy, _Compare, _RandomAccessIterator, _UseBitSetPartition>(
...
_CCCL_API _Number __log2i(_Number __n)
{
  ...
  {
    return sizeof(uint32_t) * CHAR_BIT - 1 - ::cuda::std::countl_zero(static_cast<uint32_t>(__n));
  }
  if (sizeof(__n) <= sizeof(uint64_t))
  {
    return sizeof(uint64_t) * CHAR_BIT - 1 - ::cuda::std::countl_zero(static_cast<uint64_t>(__n));
  }
...
{
  using difference_type         = typename iterator_traits<_RandomAccessIterator>::difference_type;
  difference_type __depth_limit = 2 * ::cuda::std::__log2i(__last - __first);

  // Only use bitset partitioning for arithmetic types.  We should also check
  // that the default comparator is in use so that we are sure that there are no
  // branches in the comparator.
  ::cuda::std::
    __introsort<_AlgPolicy, _Comp&, _RandomAccessIterator, __use_branchless_sort<_Comp, _RandomAccessIterator>>(
...
{
  __less __comp{};
  ::cuda::std::__sort<__less&, _Type*>(__first, __last, __comp);
}
...
_CCCL_API constexpr void __sort_impl(_RandomAccessIterator __first, _RandomAccessIterator __last, _Comp& __comp)
{
  _CCCL_IF_CONSTEVAL
  {
    ::cuda::std::__partial_sort<_AlgPolicy>(
      ...
      ::cuda::std::__unwrap_iter(__last),
      ::cuda::std::__unwrap_iter(__last),
      __comp);
  }
  else
  {
    ::cuda::std::__sort_dispatch<_AlgPolicy>(
      ::cuda::std::__unwrap_iter(__first), ::cuda::std::__unwrap_iter(__last), __comp);
  }
}
...
{
  ::cuda::std::__sort_impl<_ClassicAlgPolicy>(::cuda::std::move(__first), ::cuda::std::move(__last), __comp);
}

template <class _RandomAccessIterator>
_CCCL_API constexpr void sort(_RandomAccessIterator __first, _RandomAccessIterator __last)
{
  ::cuda::std::sort(__first, __last, __less());
}
...
#endif // _CUDA_STD___ALGORITHM_SORT_H
