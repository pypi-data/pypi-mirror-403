...
class ElectronicInvoice(inv.Invoice):
    ...
    def __init__(self, document_code):
        ...
        self.codigoTipoComprobante = None
        self.fechaEmision = None
        self.idImpositivo = None
        self.codigoPais = None
        self.domicilioReceptor = None
        self.codigoRelacionEmisorReceptor = None
        self.importeGravado = None
        self.importeOtrosTributos = None
        self.importeTotal = None
        self.Items = list()
        self.document_code = document_code
        self.arrayComprobantesAsociados = None
        self.arrayOtrosTributos = None
        self.arraySubtotalesIVA = None
