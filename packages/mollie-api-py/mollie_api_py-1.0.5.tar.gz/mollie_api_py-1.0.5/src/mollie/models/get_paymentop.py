...
class GetPaymentGlobalsTypedDict(TypedDict):
...
class GetPaymentGlobals(BaseModel):
    testmode: Annotated[
        Optional[bool],
...
class GetPaymentRequest(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["include", "embed", "testmode", "idempotency-key"]
        nullable_fields = ["include", "embed"]
        null_default_fields = []
