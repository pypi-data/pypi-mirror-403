...
from linkdb import CheckResult, LinkResult, LinkStatus
...
class TestCheckResult:
    ...
    def test_no_issues_when_ok(self):
        ...
        result = CheckResult(
            ...
            repo_result=LinkResult(
                url="https://github.com/test/test", status=LinkStatus.OK
            ),
        )
    ...
    def test_has_issues_when_not_found(self):
        ...
        result = CheckResult(
            entry_name="test",
            url_result=LinkResult(
                url="https://example.com", status=LinkStatus.NOT_FOUND
            ),
        )
    ...
    def test_has_issues_when_error(self):
        ...
        result = CheckResult(
            entry_name="test",
            repo_result=LinkResult(
                url="https://github.com/test/test", status=LinkStatus.ERROR
            ),
        )
        assert result.has_issues
