...
class SubtitleGenerator:
    ...
    def __init__(self, settings: "Settings") -> None:
        ...
        self.default_style = SubtitleStyle(
            ...
            primary_color=settings.subtitle_primary_color,
        ...
        self.highlight_color = settings.subtitle_highlight_color
...
"""
    ...
    def generate_subtitles(
        ...
        logger.info(
            f"Generating subtitles: {len(transcription.words)} words, "
            f"{words_per_line} words/line"
        )
