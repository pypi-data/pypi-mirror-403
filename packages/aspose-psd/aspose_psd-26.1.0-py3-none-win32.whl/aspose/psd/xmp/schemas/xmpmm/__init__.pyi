...
class XmpMediaManagementPackage(aspose.psd.xmp.XmpPackage):
    ...
    def set_derived_from(self, resource_ref : aspose.psd.xmp.types.complex.resourceref.ResourceRef) -> None:
