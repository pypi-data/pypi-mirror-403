...
class ISmartFilterRenderer:
    '''The interface for a specific smart filter renderer.'''
    
    def render(self, pixels_data: aspose.psd.PixelsData) -> aspose.psd.PixelsData:
        '''Renders the current smart filter on the pixels data.
        
        :param pixels_data: The pixels data.
        :returns: Returns processed pixels data.'''
        ...
