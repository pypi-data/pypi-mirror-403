...
class Thumbnail(aspose.psd.xmp.types.complex.ComplexTypeBase):
    '''Represents thumbnail image for a file.'''
    
    @overload
    def __init__(self) -> None:
        '''Initializes a new instance of the :py:class:`aspose.psd.xmp.types.complex.thumbnail.Thumbnail` class.'''
