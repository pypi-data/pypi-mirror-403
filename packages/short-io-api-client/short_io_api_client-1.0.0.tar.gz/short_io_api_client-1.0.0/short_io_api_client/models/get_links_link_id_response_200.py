...
from ..models.get_links_link_id_response_200_redirect_type import GetLinksLinkIdResponse200RedirectType
from ..models.get_links_link_id_response_200_source import GetLinksLinkIdResponse200Source
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_links_link_id_response_200_user import GetLinksLinkIdResponse200User


T = TypeVar("T", bound="GetLinksLinkIdResponse200")


@_attrs_define
class GetLinksLinkIdResponse200:
    """
    Attributes:
        ...
        redirect_type (GetLinksLinkIdResponse200RedirectType | Unset): HTTP code for redirect
        ...
        source (GetLinksLinkIdResponse200Source | Unset): Link source
        user (GetLinksLinkIdResponse200User | Unset):
    """
    ...
    redirect_type: GetLinksLinkIdResponse200RedirectType | Unset = UNSET
    folder_id: None | str | Unset = UNSET
    domain_id: int | Unset = UNSET
    owner_id: int | Unset = UNSET
    has_password: bool | Unset = False
    source: GetLinksLinkIdResponse200Source | Unset = UNSET
    user: GetLinksLinkIdResponse200User | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        redirect_type: GetLinksLinkIdResponse200RedirectType | Unset
        if isinstance(_redirect_type, Unset):
            redirect_type = UNSET
        else:
            redirect_type = GetLinksLinkIdResponse200RedirectType(_redirect_type)
        ...
        source: GetLinksLinkIdResponse200Source | Unset
        if isinstance(_source, Unset):
            source = UNSET
        else:
            source = GetLinksLinkIdResponse200Source(_source)
        ...
        if isinstance(_user, Unset):
            ...
            user = GetLinksLinkIdResponse200User.from_dict(_user)

        get_links_link_id_response_200 = cls(
        ...
        get_links_link_id_response_200.additional_properties = d
        return get_links_link_id_response_200
