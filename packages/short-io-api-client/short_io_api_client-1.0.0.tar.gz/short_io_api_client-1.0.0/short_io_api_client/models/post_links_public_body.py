...
from ..models.post_links_public_body_redirect_type import PostLinksPublicBodyRedirectType
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostLinksPublicBody")


@_attrs_define
class PostLinksPublicBody:
    """
    Attributes:
        original_url (str): Original URL Example: https://example.com.
        domain (str):
        cloaking (bool | Unset): Cloaking
        password (str | Unset): Link password Example: s3cur3p@ssw0rd.
        redirect_type (PostLinksPublicBodyRedirectType | Unset): HTTP code for redirect Example: 301.
    ...
    redirect_type: PostLinksPublicBodyRedirectType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        redirect_type: PostLinksPublicBodyRedirectType | Unset
        if isinstance(_redirect_type, Unset):
            redirect_type = UNSET
        else:
            redirect_type = PostLinksPublicBodyRedirectType(_redirect_type)
        ...
        post_links_public_body.additional_properties = d
        return post_links_public_body
