...
from ..models.post_domains_response_200_https_level import PostDomainsResponse200HttpsLevel
from ..models.post_domains_response_200_link_type import PostDomainsResponse200LinkType
from ..models.post_domains_response_200_robots import PostDomainsResponse200Robots
from ..models.post_domains_response_200_state import PostDomainsResponse200State
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_domains_response_200_client_storage import PostDomainsResponse200ClientStorage


T = TypeVar("T", bound="PostDomainsResponse200")


@_attrs_define
class PostDomainsResponse200:
    """
    Attributes:
        id (int): Domain ID Example: 12345.
        hostname (str):
        unicode_hostname (str):
        state (PostDomainsResponse200State):
        created_at (datetime.datetime):
        updated_at (datetime.datetime):
        has_favicon (bool):
        hide_referer (bool):
        link_type (PostDomainsResponse200LinkType):
        ...
        https_level (PostDomainsResponse200HttpsLevel):
        https_links (bool | None):
        client_storage (PostDomainsResponse200ClientStorage):
        case_sensitive (bool):
        increment_counter (str):
        robots (PostDomainsResponse200Robots):
        export_enabled (bool):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        state = PostDomainsResponse200State(d.pop("state"))
        ...
        link_type = PostDomainsResponse200LinkType(d.pop("linkType"))
        ...
        https_level = PostDomainsResponse200HttpsLevel(d.pop("httpsLevel"))
        ...
        client_storage = PostDomainsResponse200ClientStorage.from_dict(d.pop("clientStorage"))

        case_sensitive = d.pop("caseSensitive")

        increment_counter = d.pop("incrementCounter")

        robots = PostDomainsResponse200Robots(d.pop("robots"))
        ...
        post_domains_response_200.additional_properties = d
        return post_domains_response_200
