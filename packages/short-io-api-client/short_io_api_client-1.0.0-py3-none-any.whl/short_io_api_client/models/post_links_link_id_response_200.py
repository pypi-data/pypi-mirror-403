...
from ..models.post_links_link_id_response_200_redirect_type import PostLinksLinkIdResponse200RedirectType
from ..models.post_links_link_id_response_200_source import PostLinksLinkIdResponse200Source
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_links_link_id_response_200_user import PostLinksLinkIdResponse200User


T = TypeVar("T", bound="PostLinksLinkIdResponse200")


@_attrs_define
class PostLinksLinkIdResponse200:
    """
    Attributes:
        ...
        redirect_type (PostLinksLinkIdResponse200RedirectType | Unset): HTTP code for redirect
        ...
        source (PostLinksLinkIdResponse200Source | Unset): Link source
        user (PostLinksLinkIdResponse200User | Unset):
    """
    ...
    redirect_type: PostLinksLinkIdResponse200RedirectType | Unset = UNSET
    folder_id: None | str | Unset = UNSET
    domain_id: int | Unset = UNSET
    owner_id: int | Unset = UNSET
    has_password: bool | Unset = False
    source: PostLinksLinkIdResponse200Source | Unset = UNSET
    user: PostLinksLinkIdResponse200User | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        redirect_type: PostLinksLinkIdResponse200RedirectType | Unset
        if isinstance(_redirect_type, Unset):
            redirect_type = UNSET
        else:
            redirect_type = PostLinksLinkIdResponse200RedirectType(_redirect_type)
        ...
        source: PostLinksLinkIdResponse200Source | Unset
        if isinstance(_source, Unset):
            source = UNSET
        else:
            source = PostLinksLinkIdResponse200Source(_source)
        ...
        if isinstance(_user, Unset):
            ...
            user = PostLinksLinkIdResponse200User.from_dict(_user)

        post_links_link_id_response_200 = cls(
        ...
        post_links_link_id_response_200.additional_properties = d
        return post_links_link_id_response_200
