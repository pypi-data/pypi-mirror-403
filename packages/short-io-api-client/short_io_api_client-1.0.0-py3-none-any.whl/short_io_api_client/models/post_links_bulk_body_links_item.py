...
from ..models.post_links_bulk_body_links_item_redirect_type import PostLinksBulkBodyLinksItemRedirectType
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostLinksBulkBodyLinksItem")


@_attrs_define
class PostLinksBulkBodyLinksItem:
    """
    Attributes:
        original_url (str): Original URL
        allow_duplicates (bool | Unset):
        cloaking (bool | Unset): Cloaking
        password (str | Unset): Link password
        redirect_type (PostLinksBulkBodyLinksItemRedirectType | Unset): HTTP code for redirect
    ...
    original_url: str
    allow_duplicates: bool | Unset = UNSET
    cloaking: bool | Unset = UNSET
    password: str | Unset = UNSET
    redirect_type: PostLinksBulkBodyLinksItemRedirectType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        redirect_type: PostLinksBulkBodyLinksItemRedirectType | Unset
        if isinstance(_redirect_type, Unset):
            redirect_type = UNSET
        else:
            redirect_type = PostLinksBulkBodyLinksItemRedirectType(_redirect_type)
        ...
        post_links_bulk_body_links_item = cls(
        ...
        post_links_bulk_body_links_item.additional_properties = d
        return post_links_bulk_body_links_item
