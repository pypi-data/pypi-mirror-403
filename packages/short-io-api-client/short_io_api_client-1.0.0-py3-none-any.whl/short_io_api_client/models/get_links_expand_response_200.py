...
from ..models.get_links_expand_response_200_redirect_type import GetLinksExpandResponse200RedirectType
from ..models.get_links_expand_response_200_source import GetLinksExpandResponse200Source
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_links_expand_response_200_user import GetLinksExpandResponse200User


T = TypeVar("T", bound="GetLinksExpandResponse200")


@_attrs_define
class GetLinksExpandResponse200:
    """
    Attributes:
        ...
        redirect_type (GetLinksExpandResponse200RedirectType | Unset): HTTP code for redirect
        ...
        source (GetLinksExpandResponse200Source | Unset): Link source
        user (GetLinksExpandResponse200User | Unset):
    """
    ...
    redirect_type: GetLinksExpandResponse200RedirectType | Unset = UNSET
    folder_id: None | str | Unset = UNSET
    domain_id: int | Unset = UNSET
    owner_id: int | Unset = UNSET
    has_password: bool | Unset = False
    source: GetLinksExpandResponse200Source | Unset = UNSET
    user: GetLinksExpandResponse200User | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        redirect_type: GetLinksExpandResponse200RedirectType | Unset
        if isinstance(_redirect_type, Unset):
            redirect_type = UNSET
        else:
            redirect_type = GetLinksExpandResponse200RedirectType(_redirect_type)
        ...
        source: GetLinksExpandResponse200Source | Unset
        if isinstance(_source, Unset):
            source = UNSET
        else:
            source = GetLinksExpandResponse200Source(_source)
        ...
        if isinstance(_user, Unset):
            ...
            user = GetLinksExpandResponse200User.from_dict(_user)

        get_links_expand_response_200 = cls(
        ...
        get_links_expand_response_200.additional_properties = d
        return get_links_expand_response_200
