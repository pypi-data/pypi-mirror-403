...
@click.command(context_settings={"auto_envvar_prefix": "UVICORN"}, help="Run a development server.")
@click.option(
    "--host",
    type=str,
    default="127.0.0.1",
...
cli = StarGroup(
    ...
    help="""\
        ...
        An application to load must be given with the 'xxx:app', or with a 'asgi.py' file
