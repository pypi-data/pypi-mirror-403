"""Deorbitalized r2SCAN-L correlation functional."""

from __future__ import annotations

from . import mgga_c_r2scan as _base_module
...
def pol(p, r, s=(None, None, None), l=(None, None), tau=(None, None)):
  base = prepare_base_params("mgga_c_r2scan", True, p.params, _BASE_FIELDS)
  pc07 = prepare_pc07_params(True, p.params)
  return evaluate_deorbitalized(_base_module, base, pc07, r, s, l, polarized=True)


def unpol(p, r, s=None, l=None, tau=None):
  base = prepare_base_params("mgga_c_r2scan", False, p.params, _BASE_FIELDS)
