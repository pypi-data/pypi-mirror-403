"""Deorbitalized revSCAN-L exchange functional."""

from __future__ import annotations

from . import mgga_x_revscan as _base_module
...
_BASE_FIELDS = ("c1", "c2", "d", "k1")


def pol(p, r, s=(None, None, None), l=(None, None), tau=(None, None)):
  base = prepare_base_params("mgga_x_revscan", True, p.params, _BASE_FIELDS)
  pc07 = prepare_pc07_params(True, p.params)
  return evaluate_deorbitalized(_base_module, base, pc07, r, s, l, polarized=True)


def unpol(p, r, s=None, l=None, tau=None):
  base = prepare_base_params("mgga_x_revscan", False, p.params, _BASE_FIELDS)
