...
class Aperture(object):
    ...
    set_width = _swig_new_instance_method(_RF_Track.Aperture_set_width)
    set_height = _swig_new_instance_method(_RF_Track.Aperture_set_height)
    get_width = _swig_new_instance_method(_RF_Track.Aperture_get_width)
    get_height = _swig_new_instance_method(_RF_Track.Aperture_get_height)
...
class Element(Aperture):
    ...
    insert_after = _swig_new_instance_method(_RF_Track.Element_insert_after)
    insert_ref_after = _swig_new_instance_method(_RF_Track.Element_insert_ref_after)
...
class Undulator(GenericField):
    ...
    get_B = _swig_new_instance_method(_RF_Track.Undulator_get_B)
    set_B = _swig_new_instance_method(_RF_Track.Undulator_set_B)
