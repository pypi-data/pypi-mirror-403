...
class HorizontalEquation:
    ...
    def build(
        ...
        for level_1 in level_1_items[:-2]:
            HorizontalEquation.__add_text_block(
                background_color, level_1, level_1_font_color, level_1_font_size, t
            )
            HorizontalEquation.__add_plus(
                level_1_font_size, lighter_background_color, t
            )

        # add final element on left-hand side
        HorizontalEquation.__add_text_block(
            background_color,
            level_1_items[-2],
            level_1_font_color,
        ...
        # add equals sign
        HorizontalEquation.__add_equals(level_1_font_size, lighter_background_color, t)

        # add element on left hand side
        HorizontalEquation.__add_text_block(
            background_color,
            level_1_items[-1],
            level_1_font_color,
