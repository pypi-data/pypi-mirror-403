...
class TextArea(FormField):
    ...
    def __init__(
        ...
        assert number_of_lines > 0, "The number_of_lines must be a non-negative value."
        super().__init__(
        ...
        self.__number_of_lines: int = number_of_lines
    ...
    def get_size(
        ...
        return (
            ...
            int(self.__number_of_lines * 1.2 * self.__font_size)
