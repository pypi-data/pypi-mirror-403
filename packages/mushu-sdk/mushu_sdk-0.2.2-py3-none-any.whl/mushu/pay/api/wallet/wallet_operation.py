...
from ...models.wallet_operation_request import WalletOperationRequest
...
def sync_detailed(
    ...
    *,
    ...
    """Wallet Operation
     ...
     Deposit or charge funds from the organization's wallet.

    Args:
        org_id (str):
        x_api_key (str):
        body (WalletOperationRequest): Request to deposit or charge the wallet.
