...
T = TypeVar("T", bound="UpdateAuthProviderRequest")


@_attrs_define
class UpdateAuthProviderRequest:
    """Request to update an auth provider configuration.

    Attributes:
        enabled (bool | None | Unset): Whether the provider is enabled
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        update_auth_provider_request = cls(
            enabled=enabled,
        ...
        update_auth_provider_request.additional_properties = d
        return update_auth_provider_request
