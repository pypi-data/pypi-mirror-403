...
from ...models.create_org_billing_request import CreateOrgBillingRequest
...
def sync_detailed(
    ...
    *,
    ...
    """Create Org Billing
     ...
     Create billing config for an organization.

    Args:
        org_id (str):
        authorization (str):
        body (CreateOrgBillingRequest): Request to create billing config for an organization.
