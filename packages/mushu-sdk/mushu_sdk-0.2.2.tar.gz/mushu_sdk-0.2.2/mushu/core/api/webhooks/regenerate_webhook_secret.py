...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/apps/{app_id}/webhooks/{endpoint_id}/regenerate-secret".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Regenerate Webhook Secret
     ...
     Regenerate webhook signing secret. Requires admin role in org.
    The new secret is returned - store it securely.
