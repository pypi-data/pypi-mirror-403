...
T = TypeVar("T", bound="AlertPayload")


@_attrs_define
class AlertPayload:
    """Alert payload for push notification.

    Attributes:
        title (None | str | Unset): Notification title
        body (None | str | Unset): Notification body
        subtitle (None | str | Unset): Notification subtitle
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        alert_payload.additional_properties = d
