...
if TYPE_CHECKING:
    ...
    from ..models.bulk_push_request_data_type_0 import BulkPushRequestDataType0


T = TypeVar("T", bound="BulkPushRequest")


@_attrs_define
class BulkPushRequest:
    ...
    Attributes:
        ...
        data (BulkPushRequestDataType0 | None | Unset): Custom data payload
    """
    ...
    data: BulkPushRequestDataType0 | None | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.data, Unset):
            data = UNSET
        elif isinstance(self.data, BulkPushRequestDataType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_data(data: object) -> BulkPushRequestDataType0 | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                data_type_0 = BulkPushRequestDataType0.from_dict(data)

                return data_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(BulkPushRequestDataType0 | None | Unset, data)

        data = _parse_data(d.pop("data", UNSET))

        bulk_push_request = cls(
            user_ids=user_ids,
            alert=alert,
            badge=badge,
            sound=sound,
        ...
        bulk_push_request.additional_properties = d
        return bulk_push_request
