...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/apps/{app_id}/analytics/timeseries".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Timeseries
     ...
     Get daily notification analytics for charting.

    Returns daily breakdown of events for time series visualization.
