...
#define CONFIGURE_ARGS " '--prefix=/project/pgbuild/../src/pgembed/pginstall' '--without-readline' '--without-icu' 'PKG_CONFIG_PATH=/usr/local/lib/pkgconfig'"
...
#define PG_VERSION_STR "PostgreSQL 17.7 on x86_64-pc-linux-gnu, compiled by gcc (GCC) 14.2.1 20250110 (Red Hat 14.2.1-10), 64-bit"
