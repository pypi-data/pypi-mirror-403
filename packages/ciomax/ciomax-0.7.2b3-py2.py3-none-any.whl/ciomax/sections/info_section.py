...
class InfoSection(CollapsibleSection):
    ...
    def __init__(self, dialog):
        ...
        self.frame_info_component = TextFieldGrp(label="Frame info")
        self.scout_info_component = TextFieldGrp(label="Scout info")
        self.resolved_chunk_size_component = IntFieldGrp(label="Resolved chunk size")
        
        self.frame_info_component.field.setEnabled(False)
        self.scout_info_component.field.setEnabled(False)
        self.resolved_chunk_size_component.field.setEnabled(False)

        self.content_layout.addWidget(self.frame_info_component)
        self.content_layout.addWidget(self.scout_info_component)
        self.content_layout.addWidget(self.resolved_chunk_size_component)
    ...
    def update(self, main_sequence, scout_sequence):
        if not main_sequence:
            ...
            self.resolved_chunk_size_component.field.setValue(1)
            return
        ...
        resolved_chunk_size= main_sequence.chunk_size
        ...
        self.resolved_chunk_size_component.field.setValue(resolved_chunk_size)
