from ciomax import QtWidgets, QtCore, QtGui

EXPANDED_STYLESHEET = (
    "CollapsibleSection { border: 1px solid #555; border-radius: 2px;}"
)
...
class CollapsibleSection(QtWidgets.QFrame):
    ...
    def _configure_main_layout(self):
        ...
        layout.addWidget(self.toggle_button, 0, 0, 1, 1, QtCore.Qt.AlignLeft)
