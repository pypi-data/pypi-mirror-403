...
class CPU(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if core_units (nullable) is None
        # and model_fields_set contains the field
        if self.core_units is None and "core_units" in self.model_fields_set:
            _dict['core_units'] = None

        # set to None if die_size (nullable) is None
        # and model_fields_set contains the field
        if self.die_size is None and "die_size" in self.model_fields_set:
            _dict['die_size'] = None

        # set to None if die_size_per_core (nullable) is None
        # and model_fields_set contains the field
        if self.die_size_per_core is None and "die_size_per_core" in self.model_fields_set:
            _dict['die_size_per_core'] = None
        ...
        # set to None if model_range (nullable) is None
        # and model_fields_set contains the field
        if self.model_range is None and "model_range" in self.model_fields_set:
            _dict['model_range'] = None
