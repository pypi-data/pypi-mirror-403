...
class IoT(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.functional_blocks:
            for _item_functional_blocks in self.functional_blocks:
                if _item_functional_blocks:
                    _items.append(_item_functional_blocks.to_dict())
            _dict['functional_blocks'] = _items
        # override the default output from pydantic by calling `to_dict()` of usage
        if self.usage:
            _dict['usage'] = self.usage.to_dict()
        # set to None if functional_blocks (nullable) is None
        # and model_fields_set contains the field
        if self.functional_blocks is None and "functional_blocks" in self.model_fields_set:
            _dict['functional_blocks'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "functional_blocks": [FunctionalBlock.from_dict(_item) for _item in obj["functional_blocks"]] if obj.get("functional_blocks") is not None else None,
