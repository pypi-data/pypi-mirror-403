...
class ConsumptionProfileCPU(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        _items = []
        if self.workload:
            for _item_workload in self.workload:
                if _item_workload:
                    _items.append(_item_workload.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "workload": [WorkloadPower.from_dict(_item) for _item in obj["workload"]] if obj.get("workload") is not None else None,
