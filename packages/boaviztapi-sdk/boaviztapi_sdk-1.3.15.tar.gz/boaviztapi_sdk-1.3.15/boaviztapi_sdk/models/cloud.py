...
class Cloud(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "model": ModelServer.from_dict(obj["model"]) if obj.get("model") is not None else None,
            "configuration": ConfigurationServer.from_dict(obj["configuration"]) if obj.get("configuration") is not None else None,
            "usage": UsageCloud.from_dict(obj["usage"]) if obj.get("usage") is not None else None,
