...
class TestVrHeadset(unittest.TestCase):
    """VrHeadset unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VrHeadset:
        """Test VrHeadset
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VrHeadset`
        """
        model = VrHeadset()
        if include_optional:
            return VrHeadset(
