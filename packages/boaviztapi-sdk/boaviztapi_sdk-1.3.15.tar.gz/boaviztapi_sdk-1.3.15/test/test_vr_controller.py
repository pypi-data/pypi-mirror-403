...
class TestVrController(unittest.TestCase):
    """VrController unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VrController:
        """Test VrController
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VrController`
        """
        model = VrController()
        if include_optional:
            return VrController(
