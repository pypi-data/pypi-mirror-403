const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CmoWAUf3.js","assets/index-D0ivrRjO.js","assets/index-UFXyfirV.css","assets/index-DnW_KC_I.js","assets/client-DVyEsdNe.js","assets/index-BCJxPfM5.js","assets/graphic-walker.es-kBTlj4CF.js"])))=>i.map(i=>d[i]);
import { d as defineComponent, J as onMounted, al as __vitePreload, x as onUnmounted, c as createElementBlock, t as toDisplayString, e as createCommentVNode, h as withDirectives, at as vShow, a as createBaseVNode, r as ref, aB as toRaw, o as openBlock, g as _export_sfc } from "./index-D0ivrRjO.js";
    ...
    onMounted(async () => {
      ...
      try {
        const [reactModule, reactDomModule, gwModule] = await Promise.all([
          __vitePreload(() => import("./index-CmoWAUf3.js").then((n) => n.t), true ? __vite__mapDeps([0,1,2,3]) : void 0),
          __vitePreload(() => import("./client-DVyEsdNe.js").then((n) => n.c), true ? __vite__mapDeps([4,1,2,5,3]) : void 0),
          __vitePreload(() => import("./graphic-walker.es-kBTlj4CF.js"), true ? __vite__mapDeps([6,0,1,2,3,5]) : void 0)
        ]);
