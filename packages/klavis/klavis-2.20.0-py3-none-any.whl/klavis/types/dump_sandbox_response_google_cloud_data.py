...
class DumpSandboxResponseGoogleCloudData(UniversalBaseModel):
    ...
    data: GoogleCloudDataOutput = pydantic.Field()
    """
...
update_forward_refs(DumpSandboxResponseGoogleCloudData)
