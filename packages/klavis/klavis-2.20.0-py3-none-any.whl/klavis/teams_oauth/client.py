...
from .raw_client import AsyncRawTeamsOauthClient, RawTeamsOauthClient


class TeamsOauthClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._raw_client = RawTeamsOauthClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> RawTeamsOauthClient:
        """
...
class AsyncTeamsOauthClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._raw_client = AsyncRawTeamsOauthClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> AsyncRawTeamsOauthClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        AsyncRawTeamsOauthClient
        """
        return self._raw_client
    ...
    async def refresh_token(
        ...
        async def main() -> None:
            await client.teams_oauth.refresh_token(
                instance_id="instance_id",
            )
