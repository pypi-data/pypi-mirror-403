"""
tokmor-pos: TokMor POS (ParSon axes + EAR hint) + legacy POS8 tools.

In this project, "TokMor POS" means:
- **ParSon axes**: P/A/R/S/O/N (token profiling)
- **EAR hint**: E/A/R (+ blank allowed) derived from the axes
