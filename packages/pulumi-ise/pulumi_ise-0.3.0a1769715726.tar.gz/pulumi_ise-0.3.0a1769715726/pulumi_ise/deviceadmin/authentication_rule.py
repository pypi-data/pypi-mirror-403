...
class AuthenticationRuleArgs:
    def __init__(__self__, *,
                 if_auth_fail: pulumi.Input[_builtins.str],
    ...
    @if_auth_fail.setter
    def if_auth_fail(self, value: pulumi.Input[_builtins.str]):
    ...
    def if_process_fail(self, value: pulumi.Input[_builtins.str]):
    ...
    def if_user_not_found(self, value: pulumi.Input[_builtins.str]):
...
class AuthenticationRule(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="identitySourceName")
    def identity_source_name(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Identity source name from the identity stores
        """
        return pulumi.get(self, "identity_source_name")
