...
class AuthorizationGlobalExceptionRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] profiles: The authorization profile(s)
        :param pulumi.Input[_builtins.int] rank: The rank (priority) in relation to other rules. Lower rank is higher priority.
        :param pulumi.Input[_builtins.str] security_group: Security group used in authorization policies
...
class AuthorizationGlobalExceptionRule(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter
    def profiles(self) -> pulumi.Output[Optional[Sequence[_builtins.str]]]:
        """
        The authorization profile(s)
        """
        return pulumi.get(self, "profiles")
    ...
    @_builtins.property
    @pulumi.getter(name="securityGroup")
    def security_group(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Security group used in authorization policies
        """
        return pulumi.get(self, "security_group")
