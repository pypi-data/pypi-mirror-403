...
class RpmPruneApi:
    ...
    def prune_packages(
        ...
        :param prune_packages: (required)
        :type prune_packages: PrunePackages
        ...
        _param = self._prune_packages_serialize(
    ...
    @validate_call
    def prune_packages_with_http_info(
        self,
        prune_packages: PrunePackages,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        pulp_domain: StrictStr = "default",
    ...
    @validate_call
    def prune_packages_without_preload_content(
        self,
        prune_packages: PrunePackages,
        x_task_diagnostics: Annotated[Optional[List[StrictStr]], Field(description="List of profilers to use on tasks.")] = None,
        pulp_domain: StrictStr = "default",
    ...
    def _prune_packages_serialize(
        ...
        if prune_packages is not None:
            _body_params = prune_packages
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/pulp/{pulp_domain}/api/v3/rpm/prune/',
