...
class TestPaginatedrpmRpmAlternateContentSourceResponseList(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PaginatedrpmRpmAlternateContentSourceResponseList:
        """Test PaginatedrpmRpmAlternateContentSourceResponseList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedrpmRpmAlternateContentSourceResponseList`
        """
        model = PaginatedrpmRpmAlternateContentSourceResponseList()
        if include_optional:
