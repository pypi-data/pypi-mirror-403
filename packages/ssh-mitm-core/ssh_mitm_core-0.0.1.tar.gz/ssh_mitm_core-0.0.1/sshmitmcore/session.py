...
from sshmitmcore.exceptions import SessionStartError
from sshmitmcore.forwarders.base import BaseForwarder
from sshmitmcore.interfaces.server import ProxySFTPServer
from sshmitmcore.logger import THREAD_DATA, Colors
from sshmitmcore.moduleparser import BaseModule
...
if TYPE_CHECKING:
    ...
    from sshmitmcore.interfaces.server import BaseServerInterface
...
class Session(BaseSession):
    ...
    :param proxyserver: Instance of 'sshmitmcore.server.SSHProxyServer' class
    ...
    def __init__(  # pylint: disable=too-many-arguments
        self,
        proxyserver: "sshmitmcore.server.SSHProxyServer",
        client_socket: socket.socket,
        client_address: Union[Tuple[str, int], Tuple[str, int, int, int]],
        authenticator_class: Type["sshmitmcore.authentication.Authenticator"],
        ...
        self.proxyserver: "sshmitmcore.server.SSHProxyServer" = proxyserver
        ...
        self.ssh_client: Optional[sshmitmcore.clients.ssh.SSHClient] = None
        ...
        self.sftp_client: Optional[sshmitmcore.clients.sftp.SFTPClient] = None
        ...
        self.authenticator: "sshmitmcore.authentication.Authenticator" = (
