...
from sshmitmcore.compat import metadata
from sshmitmcore.moduleparser.baseparser import BaseModuleArgumentParser
from sshmitmcore.moduleparser.exceptions import ModuleError
from sshmitmcore.moduleparser.formatter import ModuleFormatter
from sshmitmcore.moduleparser.modules import BaseModule, SubCommand
from sshmitmcore.moduleparser.utils import load_module, set_module_kwargs
            ...
            if (
                ...
                if self.ARGCONF.has_section(default_value):
                    ...
                    try:
                        ...
                        msg = f"Module not found {default_value}"
                        raise ModuleError(message=msg) from exc
