...
from sshmitmcore.compat import resources
from sshmitmcore.logger import Colors, FailSaveLogStream, PlainJsonFormatter
from sshmitmcore.moduleparser import ModuleParser
from sshmitmcore.workarounds import monkeypatch, transport
...
def get_config() -> ConfigParser:
    ...
    conf = resources.files("sshmitmcore") / "data/default.ini"
