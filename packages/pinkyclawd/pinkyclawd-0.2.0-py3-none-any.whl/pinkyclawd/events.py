...
class EventBus:
    ...
    Note: This class is managed by the StateFactory. Use get_event_bus()
    ...
    def clear(self) -> None:
        """Clear all handlers and history (for testing/reset)."""
...
def get_event_bus() -> EventBus:
    ...
    Prefer using pinkyclawd.core.get_event_bus() for consistency.
    """
