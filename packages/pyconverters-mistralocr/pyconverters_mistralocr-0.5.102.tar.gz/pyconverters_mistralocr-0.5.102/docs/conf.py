...
import pyconverters_mistralocr


# -- Project information -----------------------------------------------------

project = "pyconverters_mistralocr"
copyright = "2021, Olivier Terrier"
author = "Olivier Terrier"
version = pyconverters_mistralocr.__version__
release = pyconverters_mistralocr.__version__
...
apidoc_module_dir = os.path.dirname(pyconverters_mistralocr.__file__)
