...
def add_widget_cmd(
    ...
    width: Annotated[
        Optional[int],
        typer.Option("--width", "-w", help="Widget width (1-10)"),
    ] = None,
    format: Annotated[
        OutputFormat,
        typer.Option("--format", "-f", help="Output format"),
    ...
    to the specified page and section.
    ...
    Examples:
        ...
        metricly dashboards add-widget abc123 -t bar_chart --title "By Region" -m revenue -d region
    """
    user = require_auth()
