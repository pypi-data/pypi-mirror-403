...
class PivotConfig(BaseModel):
    """Pivot configuration for table widgets."""

    on: str = Field(description="Dimension name to pivot on (creates columns from dimension values)")
    show_totals: Optional[bool] = Field(default=False, description="Whether to show row and column totals")
...
class WidgetDefinition(BaseModel):
    ...
    pivot: Optional[PivotConfig] = Field(default=None, description="Table: pivot configuration to transform rows into columns")
