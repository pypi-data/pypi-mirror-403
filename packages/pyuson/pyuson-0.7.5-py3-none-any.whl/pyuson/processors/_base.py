...
class BaseProcessor(tBaseProcessor):
    ...
    def _init(self):
        ...
        self.data_raw = DataRaw(attr=attr_raw)  # ty:ignore[invalid-assignment]
        self.data_processed = DataProcessed(  # ty:ignore[invalid-assignment]
    ...
    def compute_field(self):
        raise NotImplementedError(
            "Subclasses must implement this method using the _compute_field() method"
        )
