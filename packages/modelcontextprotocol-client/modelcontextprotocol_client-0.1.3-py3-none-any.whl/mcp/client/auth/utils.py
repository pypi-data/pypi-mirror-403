...
from .exceptions import OAuthRegistrationError, OAuthTokenError
...
def create_oauth_metadata_request(url: str) -> Request:
    return Request("GET", url) # Removed version header dependency for now as generic Client doesn't export version easily here
