...
def get_confluence_markdown(page_id: str) -> str:
    ...
    CONFLUENCE_USER = dbutils.secrets.get("DATAPLATTFORM_CONFLUENCE", "user")
    CONFLUENCE_API_TOKEN = dbutils.secrets.get("DATAPLATTFORM_CONFLUENCE", "token")
    CONFLUENCE_BASE_URL = dbutils.secrets.get("DATAPLATTFORM_CONFLUENCE", "url")
...
def push_data_products_to_datahub_from_yml(yml_path: str) -> None:
    ...
    DATAHUB_URL = dbutils.secrets.get("DATAPLATTFORM_DATAHUB", "url")
    DATAHUB_TOKEN = dbutils.secrets.get("DATAPLATTFORM_DATAHUB", "token")
...
def report_table_freshness(
    ...
    if gms_url is None or gms_token is None:
        gms_url = gms_url or f"https://{dbutils.secrets.get('DATAPLATTFORM_DATAHUB', 'url')}/api/gms"
        gms_token = gms_token or dbutils.secrets.get("DATAPLATTFORM_DATAHUB", "token")
