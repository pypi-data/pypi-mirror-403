...
class Day:
    ...
    class ColorBox:
        ...
        def __init__(self, minutes: Mapping[int, Set[Path]], width: None | int = None) -> None:
            """Initializes a ColorBox with given @minutes and @width"""
            self.minutes = minutes
            self.width = width

        def __rich_console__(self, _console: Console, options: ConsoleOptions) -> RenderResult:
            """Returns rich console representation for a ColorBox instance"""
        ...
        def __rich_measure__(self, _console: "Console", options: ConsoleOptions) -> Measurement:
            """Returns rich console console dimensions of a ColorBox instance"""
    ...
    def __str__(self) -> str:
        """Returns a nice to read Day representation"""
